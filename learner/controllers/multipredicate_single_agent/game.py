...
class SAct(typing.NamedTuple):
    # List[pred_name: str, num_of_args: int, [[nd1,...,ndk], n_coeff, n_const, DisjConj, Coeff, Const, Null, Timeout]]
    data: typing.List[typing.Tuple[str, int, typing.Tuple[typing.List[int],int,int,typing.Optional[int],bool,bool,bool,bool,bool]]]
