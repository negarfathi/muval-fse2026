...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (A_a_fun_a_a_fun_fun_tree$ (node$a (selecth$ A_a_fun_a_a_fun_fun$) (selecti$ A_a_fun_a_a_fun_fun_tree$) (selectj$ A_a_fun_a_a_fun_fun_tree$)))
  (A_a_fun_a_fun_tree$ (node$b (selectk$ A_a_fun_a_fun$) (selectl$ A_a_fun_a_fun_tree$) (selectm$ A_a_fun_a_fun_tree$)))
  (A_a_a_fun_fun_tree$ (node$c (selectn$ A_a_a_fun_fun$) (selecto$ A_a_a_fun_fun_tree$) (selectp$ A_a_a_fun_fun_tree$)))
  (A_a_fun_tree$ (node$d (selectq$ A_a_fun$) (selectr$ A_a_fun_tree$) (selects$ A_a_fun_tree$)))
  (A_a_stream_fun_stream$ (sCons$f (selectt$ A_a_stream_fun$) (selectu$ A_a_stream_fun_stream$)))
  (A_stream_a_fun_stream$ (sCons$g (selectv$ A_stream_a_fun$) (selectw$ A_stream_a_fun_stream$)))
  (A_stream_a_stream_fun_stream$ (sCons$h (selectx$ A_stream_a_stream_fun$) (selecty$ A_stream_a_stream_fun_stream$)))
  (A_a_fun_a_stream_fun_stream$ (sCons$i (selectz$ A_a_fun_a_stream_fun$) (selecua$ A_a_fun_a_stream_fun_stream$)))
  (A_stream_a_a_fun_fun_stream$ (sCons$j (selecub$ A_stream_a_a_fun_fun$) (selecuc$ A_stream_a_a_fun_fun_stream$)))
  (A_a_a_fun_a_fun_fun_stream$ (sCons$k (selecud$ A_a_a_fun_a_fun_fun$) (selecue$ A_a_a_fun_a_fun_fun_stream$)))))
(declare-datatypes () ((Dir$ (l$) (r$))
  (Dir_list$ (nil$) (cons$ (hd$ Dir$) (tl$ Dir_list$)))))
(declare-codatatypes () ((A_a_fun_stream_stream$ (sCons$l (shd$b A_a_fun_stream$) (stl$b A_a_fun_stream_stream$)))
  (A_stream_stream_stream$ (sCons$m (shd$c A_stream_stream$) (stl$c A_stream_stream_stream$)))
  (A_a_a_fun_a_fun_fun_tree$ (node$e (selecuf$ A_a_a_fun_a_fun_fun$) (selecug$ A_a_a_fun_a_fun_fun_tree$) (selecuh$ A_a_a_fun_a_fun_fun_tree$)))
  (A_a_a_a_fun_fun_fun_tree$ (node$f (selecui$ A_a_a_a_fun_fun_fun$) (selecuj$ A_a_a_a_fun_fun_fun_tree$) (selecuk$ A_a_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_fun_a_fun_tree$ (node$g (selecul$ A_a_fun_a_fun_a_fun$) (selecum$ A_a_fun_a_fun_a_fun_tree$) (selecun$ A_a_fun_a_fun_a_fun_tree$)))
  (A_a_a_fun_fun_a_fun_tree$ (node$h (selecuo$ A_a_a_fun_fun_a_fun$) (selecup$ A_a_a_fun_fun_a_fun_tree$) (selecuq$ A_a_a_fun_fun_a_fun_tree$)))
  (A_a_a_fun_a_a_fun_fun_fun_tree$ (node$i (selecur$ A_a_a_fun_a_a_fun_fun_fun$) (selecus$ A_a_a_fun_a_a_fun_fun_fun_tree$) (selecut$ A_a_a_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_a_fun_fun_tree$ (node$j (selecuu$ A_a_fun_a_a_fun_a_fun_fun$) (selecuv$ A_a_fun_a_a_fun_a_fun_fun_tree$) (selecuw$ A_a_fun_a_a_fun_a_fun_fun_tree$)))))
(declare-fun x$ () A$)
