...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (B_a_fun_stream$ (sCons$a (selectc$ B_a_fun$) (selectd$ B_a_fun_stream$)))
  (B_stream$ (sCons$b (shd$a B$) (stl$a B_stream$)))
  (A_a_a_fun_fun_tree$ (node$c (selecte$ A_a_a_fun_fun$) (selectf$ A_a_a_fun_fun_tree$) (selectg$ A_a_a_fun_fun_tree$)))
  (A_a_fun_tree$ (node$d (selecth$ A_a_fun$) (selecti$ A_a_fun_tree$) (selectj$ A_a_fun_tree$)))
  (A_b_fun_tree$ (node$e (selectk$ A_b_fun$) (selectl$ A_b_fun_tree$) (selectm$ A_b_fun_tree$)))
  (B_b_a_fun_fun_tree$ (node$f (selectn$ B_b_a_fun_fun$) (selecto$ B_b_a_fun_fun_tree$) (selectp$ B_b_a_fun_fun_tree$)))
  (B_a_a_fun_fun_tree$ (node$g (selectq$ B_a_a_fun_fun$) (selectr$ B_a_a_fun_fun_tree$) (selects$ B_a_a_fun_fun_tree$)))
  (B_b_fun_tree$ (node$h (selectt$ B_b_fun$) (selectu$ B_b_fun_tree$) (selectv$ B_b_fun_tree$)))
  (A_b_a_fun_fun_tree$ (node$i (selectw$ A_b_a_fun_fun$) (selectx$ A_b_a_fun_fun_tree$) (selecty$ A_b_a_fun_fun_tree$)))
  (B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ (node$j (selectz$ B_a_a_fun_fun_a_b_a_fun_fun_fun$) (selecua$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$) (selecub$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)))
  (B_b_b_a_fun_fun_fun_tree$ (node$k (selecuc$ B_b_b_a_fun_fun_fun$) (selecud$ B_b_b_a_fun_fun_fun_tree$) (selecue$ B_b_b_a_fun_fun_fun_tree$)))
  (B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ (node$l (selecuf$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun$) (selecug$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$) (selecuh$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)))
  (B_a_b_a_fun_fun_fun_tree$ (node$m (selecui$ B_a_b_a_fun_fun_fun$) (selecuj$ B_a_b_a_fun_fun_fun_tree$) (selecuk$ B_a_b_a_fun_fun_fun_tree$)))
  (A_b_b_a_fun_fun_fun_tree$ (node$n (selecul$ A_b_b_a_fun_fun_fun$) (selecum$ A_b_b_a_fun_fun_fun_tree$) (selecun$ A_b_b_a_fun_fun_fun_tree$)))
  (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$ (node$o (selecuo$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun$) (selecup$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$) (selecuq$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)))
  (B_b_a_a_fun_fun_fun_tree$ (node$p (selecur$ B_b_a_a_fun_fun_fun$) (selecus$ B_b_a_a_fun_fun_fun_tree$) (selecut$ B_b_a_a_fun_fun_fun_tree$)))
  (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$ (node$q (selecuu$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun$) (selecuv$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$) (selecuw$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)))
  (B_b_b_fun_fun_tree$ (node$r (selecux$ B_b_b_fun_fun$) (selecuy$ B_b_b_fun_fun_tree$) (selecuz$ B_b_b_fun_fun_tree$)))
  (B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ (node$s (selecva$ B_b_b_fun_fun_b_b_b_fun_fun_fun$) (selecvb$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$) (selecvc$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)))
  (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ (node$t (selecvd$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun$) (selecve$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$) (selecvf$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)))
  (A_a_b_a_fun_fun_fun_tree$ (node$u (selecvg$ A_a_b_a_fun_fun_fun$) (selecvh$ A_a_b_a_fun_fun_fun_tree$) (selecvi$ A_a_b_a_fun_fun_fun_tree$)))
  (A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$ (node$v (selecvj$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun$) (selecvk$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$) (selecvl$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ (node$w (selecvm$ A_a_a_fun_fun_a_a_a_fun_fun_fun$) (selecvn$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$) (selecvo$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)))
  (A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$ (node$x (selecvp$ A_b_a_fun_fun_b_a_a_fun_fun_fun$) (selecvq$ A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$) (selecvr$ A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)))
  (B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ (node$y (selecvs$ B_b_a_fun_fun_b_b_a_fun_fun_fun$) (selecvt$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$) (selecvu$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)))
  (B_a_fun_b_a_fun_fun_tree$ (node$z (selecvv$ B_a_fun_b_a_fun_fun$) (selecvw$ B_a_fun_b_a_fun_fun_tree$) (selecvx$ B_a_fun_b_a_fun_fun_tree$)))
  (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$aa (selecvy$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun$) (selecvz$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$) (selecwa$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)))
  (B_b_fun_b_a_fun_fun_tree$ (node$ab (selecwb$ B_b_fun_b_a_fun_fun$) (selecwc$ B_b_fun_b_a_fun_fun_tree$) (selecwd$ B_b_fun_b_a_fun_fun_tree$)))
  (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ (node$ac (selecwe$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun$) (selecwf$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$) (selecwg$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)))
  (B_a_b_fun_fun_tree$ (node$ad (selecwh$ B_a_b_fun_fun$) (selecwi$ B_a_b_fun_fun_tree$) (selecwj$ B_a_b_fun_fun_tree$)))
  (B_a_fun_b_b_fun_fun_tree$ (node$ae (selecwk$ B_a_fun_b_b_fun_fun$) (selecwl$ B_a_fun_b_b_fun_fun_tree$) (selecwm$ B_a_fun_b_b_fun_fun_tree$)))
  (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ (node$af (selecwn$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun$) (selecwo$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$) (selecwp$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)))
  (B_b_fun_b_b_fun_fun_tree$ (node$ag (selecwq$ B_b_fun_b_b_fun_fun$) (selecwr$ B_b_fun_b_b_fun_fun_tree$) (selecws$ B_b_fun_b_b_fun_fun_tree$)))
  (B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$ (node$ah (selecwt$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun$) (selecwu$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$) (selecwv$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$)))
  (A_b_fun_a_a_fun_fun_tree$ (node$ai (selecww$ A_b_fun_a_a_fun_fun$) (selecwx$ A_b_fun_a_a_fun_fun_tree$) (selecwy$ A_b_fun_a_a_fun_fun_tree$)))
  (A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$ (node$aj (selecwz$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun$) (selecxa$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$) (selecxb$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_tree$ (node$ak (selecxc$ A_a_fun_a_a_fun_fun$) (selecxd$ A_a_fun_a_a_fun_fun_tree$) (selecxe$ A_a_fun_a_a_fun_fun_tree$)))
  (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$al (selecxf$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$) (selecxg$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecxh$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (B_b_a_fun_a_fun_fun_tree$ (node$am (selecxi$ B_b_a_fun_a_fun_fun$) (selecxj$ B_b_a_fun_a_fun_fun_tree$) (selecxk$ B_b_a_fun_a_fun_fun_tree$)))
  (B_b_a_fun_fun_b_a_fun_fun_tree$ (node$an (selecxl$ B_b_a_fun_fun_b_a_fun_fun$) (selecxm$ B_b_a_fun_fun_b_a_fun_fun_tree$) (selecxn$ B_b_a_fun_fun_b_a_fun_fun_tree$)))
  (B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$ao (selecxo$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun$) (selecxp$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$) (selecxq$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$)))
  (B_a_fun_a_fun_tree$ (node$ap (selecxr$ B_a_fun_a_fun$) (selecxs$ B_a_fun_a_fun_tree$) (selecxt$ B_a_fun_a_fun_tree$)))
  (B_a_a_fun_a_fun_fun_tree$ (node$aq (selecxu$ B_a_a_fun_a_fun_fun$) (selecxv$ B_a_a_fun_a_fun_fun_tree$) (selecxw$ B_a_a_fun_a_fun_fun_tree$)))
  (B_a_a_fun_fun_b_a_fun_fun_tree$ (node$ar (selecxx$ B_a_a_fun_fun_b_a_fun_fun$) (selecxy$ B_a_a_fun_fun_b_a_fun_fun_tree$) (selecxz$ B_a_a_fun_fun_b_a_fun_fun_tree$)))
  (B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$ (node$as (selecya$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun$) (selecyb$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$) (selecyc$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$)))
  (A_a_fun_a_fun_tree$ (node$at (selecyd$ A_a_fun_a_fun$) (selecye$ A_a_fun_a_fun_tree$) (selecyf$ A_a_fun_a_fun_tree$)))
  (B_b_fun_b_b_a_fun_fun_fun_tree$ (node$au (selecyg$ B_b_fun_b_b_a_fun_fun_fun$) (selecyh$ B_b_fun_b_b_a_fun_fun_fun_tree$) (selecyi$ B_b_fun_b_b_a_fun_fun_fun_tree$)))
  (B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$ (node$av (selecyj$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun$) (selecyk$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$) (selecyl$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$)))
  (B_a_fun_b_b_a_fun_fun_fun_tree$ (node$aw (selecym$ B_a_fun_b_b_a_fun_fun_fun$) (selecyn$ B_a_fun_b_b_a_fun_fun_fun_tree$) (selecyo$ B_a_fun_b_b_a_fun_fun_fun_tree$)))
  (B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ (node$ax (selecyp$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun$) (selecyq$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$) (selecyr$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$)))
  (A_a_fun_b_a_a_fun_fun_fun_tree$ (node$ay (selecys$ A_a_fun_b_a_a_fun_fun_fun$) (selecyt$ A_a_fun_b_a_a_fun_fun_fun_tree$) (selecyu$ A_a_fun_b_a_a_fun_fun_fun_tree$)))
...
(declare-codatatypes () ((B_a_fun_b_fun_tree$ (node$ba (selecyy$ B_a_fun_b_fun$) (selecyz$ B_a_fun_b_fun_tree$) (selecza$ B_a_fun_b_fun_tree$)))
  (B_a_fun_b_a_fun_fun_stream$ (sCons$c (seleczb$ B_a_fun_b_a_fun_fun$) (seleczc$ B_a_fun_b_a_fun_fun_stream$)))
  (B_a_fun_b_fun_stream$ (sCons$d (seleczd$ B_a_fun_b_fun$) (selecze$ B_a_fun_b_fun_stream$)))
  (B_a_fun_a_fun_stream$ (sCons$e (seleczf$ B_a_fun_a_fun$) (seleczg$ B_a_fun_a_fun_stream$)))
  (B_b_a_fun_fun_stream$ (sCons$f (seleczh$ B_b_a_fun_fun$) (seleczi$ B_b_a_fun_fun_stream$)))
  (B_b_fun_stream$ (sCons$g (seleczj$ B_b_fun$) (seleczk$ B_b_fun_stream$)))
  (A_b_a_fun_fun_stream$ (sCons$h (seleczl$ A_b_a_fun_fun$) (seleczm$ A_b_a_fun_fun_stream$)))
  (A_b_fun_stream$ (sCons$i (seleczn$ A_b_fun$) (seleczo$ A_b_fun_stream$)))
  (A_a_fun_stream$ (sCons$j (seleczp$ A_a_fun$) (seleczq$ A_a_fun_stream$)))))
