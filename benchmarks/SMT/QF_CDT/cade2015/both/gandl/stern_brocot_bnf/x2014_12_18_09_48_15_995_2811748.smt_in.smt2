...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (A_stream_tree$ (node$d (root$d A_stream$) (left$d A_stream_tree$) (right$d A_stream_tree$)))
  (A_stream_tree_tree$ (node$e (root$e A_stream_tree$) (left$e A_stream_tree_tree$) (right$e A_stream_tree_tree$)))
  (A_stream_tree_tree_tree$ (node$f (root$f A_stream_tree_tree$) (left$f A_stream_tree_tree_tree$) (right$f A_stream_tree_tree_tree$)))))
