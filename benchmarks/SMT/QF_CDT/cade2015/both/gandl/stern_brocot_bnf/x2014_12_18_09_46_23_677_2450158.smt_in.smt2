...
(assert (! (not (fun_app$ (less$ zero$) (snd$ (mediant$ (mulmat$ (mulmat$ x$ lLmat$) y$))))) :named a0))
...
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_prod$)) (=> (fun_app$ (less$ zero$) (snd$ (mediant$ ?v0))) (fun_app$ (less$ zero$) (snd$ (mediant$ (mulmat$ ?v0 lLmat$)))))) :named a5))
...
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_prod$)) (=> (fun_app$ (less$ zero$) (snd$ (mediant$ ?v0))) (fun_app$ (less$ zero$) (snd$ (mediant$ (mulmat$ ?v0 uRmat$)))))) :named a9))
