; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 453
...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$ (sCons$b (selectb$ A_a_fun_a_a_fun_a_a_fun_fun_fun$) (selectc$ A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$)))
  (A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun_stream$ (sCons$c (selectd$ A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun$) (selecte$ A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun_stream$)))
  (A_a_fun_a_fun_stream$ (sCons$d (selectf$ A_a_fun_a_fun$) (selectg$ A_a_fun_a_fun_stream$)))
  (A_a_fun_a_fun_a_a_fun_a_fun_fun_stream$ (sCons$e (selecth$ A_a_fun_a_fun_a_a_fun_a_fun_fun$) (selecti$ A_a_fun_a_fun_a_a_fun_a_fun_fun_stream$)))
  (A_a_a_fun_tree_fun_stream$ (sCons$f (selectj$ A_a_a_fun_tree_fun$) (selectk$ A_a_a_fun_tree_fun_stream$)))
  (A_a_fun_tree$ (node$ (selectl$ A_a_fun$) (selectm$ A_a_fun_tree$) (selectn$ A_a_fun_tree$)))
  (A_a_a_fun_tree_fun_a_a_a_fun_tree_fun_fun_stream$ (sCons$g (selecto$ A_a_a_fun_tree_fun_a_a_a_fun_tree_fun_fun$) (selectp$ A_a_a_fun_tree_fun_a_a_a_fun_tree_fun_fun_stream$)))
  (A_a_a_fun_a_a_fun_fun_fun_stream$ (sCons$h (selectq$ A_a_a_fun_a_a_fun_fun_fun$) (selectr$ A_a_a_fun_a_a_fun_fun_fun_stream$)))
  (A_a_a_fun_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_stream$ (sCons$i (selects$ A_a_a_fun_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun$) (selectt$ A_a_a_fun_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_stream$)))
  (A_a_a_fun_fun_stream$ (sCons$j (selectu$ A_a_a_fun_fun$) (selectv$ A_a_a_fun_fun_stream$)))
  (A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$ (sCons$k (selectw$ A_a_a_fun_fun_a_a_a_fun_fun_fun$) (selectx$ A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$)))
  (A_a_fun_a_a_fun_fun_stream$ (sCons$l (selecty$ A_a_fun_a_a_fun_fun$) (selectz$ A_a_fun_a_a_fun_fun_stream$)))
  (A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_stream$ (sCons$m (selecua$ A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$) (selecub$ A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_stream$)))
  (A_a_fun_tree_stream$ (sCons$n (shd$a A_a_fun_tree$) (stl$a A_a_fun_tree_stream$)))
  (A_a_fun_tree_a_a_fun_tree_fun_stream$ (sCons$o (selecuc$ A_a_fun_tree_a_a_fun_tree_fun$) (selecud$ A_a_fun_tree_a_a_fun_tree_fun_stream$)))
  (A_a_fun_stream_stream$ (sCons$p (shd$b A_a_fun_stream$) (stl$b A_a_fun_stream_stream$)))
  (A_stream_stream$ (sCons$q (shd$c A_stream$) (stl$c A_stream_stream$)))
  (A_a_fun_stream_stream_stream$ (sCons$r (shd$d A_a_fun_stream_stream$) (stl$d A_a_fun_stream_stream_stream$)))
  (A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$a (selecue$ A_a_fun_a_a_fun_a_a_fun_fun_fun$) (selecuf$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecug$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_fun_tree$ (node$b (selecuh$ A_a_fun_a_fun$) (selecui$ A_a_fun_a_fun_tree$) (selecuj$ A_a_fun_a_fun_tree$)))
  (A_a_a_fun_tree_fun_tree$ (node$c (selecuk$ A_a_a_fun_tree_fun$) (selecul$ A_a_a_fun_tree_fun_tree$) (selecum$ A_a_a_fun_tree_fun_tree$)))
  (A_a_a_fun_a_a_fun_fun_fun_tree$ (node$d (selecun$ A_a_a_fun_a_a_fun_fun_fun$) (selecuo$ A_a_a_fun_a_a_fun_fun_fun_tree$) (selecup$ A_a_a_fun_a_a_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_tree$ (node$e (selecuq$ A_a_a_fun_fun$) (selecur$ A_a_a_fun_fun_tree$) (selecus$ A_a_a_fun_fun_tree$)))
  (A_tree$ (node$f (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  (A_a_fun_a_a_fun_fun_tree$ (node$g (selecut$ A_a_fun_a_a_fun_fun$) (selecuu$ A_a_fun_a_a_fun_fun_tree$) (selecuv$ A_a_fun_a_a_fun_fun_tree$)))
  (A_a_fun_tree_tree$ (node$h (root$a A_a_fun_tree$) (left$a A_a_fun_tree_tree$) (right$a A_a_fun_tree_tree$)))))
