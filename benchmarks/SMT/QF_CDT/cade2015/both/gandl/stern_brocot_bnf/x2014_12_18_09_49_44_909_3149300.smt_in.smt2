...
(declare-codatatypes () ((Nat_stream_stream$ (sCons$b (shd$b Nat_stream$) (stl$b Nat_stream_stream$)))
  (Nat_stream_stream_stream$ (sCons$c (shd$c Nat_stream_stream$) (stl$c Nat_stream_stream_stream$)))
  (Nat_stream_stream_stream_stream$ (sCons$d (shd$d Nat_stream_stream_stream$) (stl$d Nat_stream_stream_stream_stream$)))))
