...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (B_b_fun_stream$ (sCons$c (selectb$ B_b_fun$) (selectc$ B_b_fun_stream$)))
  (A_a_fun_stream$ (sCons$d (selectd$ A_a_fun$) (selecte$ A_a_fun_stream$)))
  (B_a_fun_b_a_fun_fun_stream$ (sCons$e (selectf$ B_a_fun_b_a_fun_fun$) (selectg$ B_a_fun_b_a_fun_fun_stream$)))
  (B_b_fun_b_b_fun_fun_stream$ (sCons$f (selecth$ B_b_fun_b_b_fun_fun$) (selecti$ B_b_fun_b_b_fun_fun_stream$)))
  (A_b_fun_stream$ (sCons$g (selectj$ A_b_fun$) (selectk$ A_b_fun_stream$)))
  (A_b_fun_a_b_fun_fun_stream$ (sCons$h (selectl$ A_b_fun_a_b_fun_fun$) (selectm$ A_b_fun_a_b_fun_fun_stream$)))
  (A_a_fun_a_a_fun_fun_stream$ (sCons$i (selectn$ A_a_fun_a_a_fun_fun$) (selecto$ A_a_fun_a_a_fun_fun_stream$)))
  (B_b_a_fun_fun_stream$ (sCons$j (selectp$ B_b_a_fun_fun$) (selectq$ B_b_a_fun_fun_stream$)))
  (B_b_a_fun_fun_b_b_a_fun_fun_fun_stream$ (sCons$k (selectr$ B_b_a_fun_fun_b_b_a_fun_fun_fun$) (selects$ B_b_a_fun_fun_b_b_a_fun_fun_fun_stream$)))
  (A_b_a_fun_fun_stream$ (sCons$l (selectt$ A_b_a_fun_fun$) (selectu$ A_b_a_fun_fun_stream$)))
  (A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$ (sCons$m (selectv$ A_b_a_fun_fun_a_b_a_fun_fun_fun$) (selectw$ A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$)))
  (A_b_b_fun_fun_stream$ (sCons$n (selectx$ A_b_b_fun_fun$) (selecty$ A_b_b_fun_fun_stream$)))
  (A_b_b_fun_fun_a_b_b_fun_fun_fun_stream$ (sCons$o (selectz$ A_b_b_fun_fun_a_b_b_fun_fun_fun$) (selecua$ A_b_b_fun_fun_a_b_b_fun_fun_fun_stream$)))
  (A_a_b_fun_fun_stream$ (sCons$p (selecub$ A_a_b_fun_fun$) (selecuc$ A_a_b_fun_fun_stream$)))
  (A_a_b_fun_fun_a_a_b_fun_fun_fun_stream$ (sCons$q (selecud$ A_a_b_fun_fun_a_a_b_fun_fun_fun$) (selecue$ A_a_b_fun_fun_a_a_b_fun_fun_fun_stream$)))
  (B_stream_stream$ (sCons$r (shd$b B_stream$) (stl$b B_stream_stream$)))
  (A_stream_stream$ (sCons$s (shd$c A_stream$) (stl$c A_stream_stream$)))
  (B_b_a_fun_fun_tree$ (node$ (selecuf$ B_b_a_fun_fun$) (selecug$ B_b_a_fun_fun_tree$) (selecuh$ B_b_a_fun_fun_tree$)))
  (B_b_fun_tree$ (node$a (selecui$ B_b_fun$) (selecuj$ B_b_fun_tree$) (selecuk$ B_b_fun_tree$)))
  (A_b_a_fun_fun_tree$ (node$b (selecul$ A_b_a_fun_fun$) (selecum$ A_b_a_fun_fun_tree$) (selecun$ A_b_a_fun_fun_tree$)))
  (A_b_fun_tree$ (node$c (selecuo$ A_b_fun$) (selecup$ A_b_fun_tree$) (selecuq$ A_b_fun_tree$)))
  (A_a_fun_tree$ (node$d (selecur$ A_a_fun$) (selecus$ A_a_fun_tree$) (selecut$ A_a_fun_tree$)))
  (B_a_fun_tree$ (node$e (selecuu$ B_a_fun$) (selecuv$ B_a_fun_tree$) (selecuw$ B_a_fun_tree$)))
  (B_tree$ (node$f (root$ B$) (left$ B_tree$) (right$ B_tree$)))
