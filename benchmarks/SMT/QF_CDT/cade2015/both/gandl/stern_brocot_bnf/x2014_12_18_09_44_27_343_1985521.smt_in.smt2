...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (A_b_a_fun_fun_tree$ (node$e (selecti$ A_b_a_fun_fun$) (selectj$ A_b_a_fun_fun_tree$) (selectk$ A_b_a_fun_fun_tree$)))
  (B_a_fun_b_a_fun_fun_tree$ (node$f (selectl$ B_a_fun_b_a_fun_fun$) (selectm$ B_a_fun_b_a_fun_fun_tree$) (selectn$ B_a_fun_b_a_fun_fun_tree$)))
  (A_b_fun_tree$ (node$g (selecto$ A_b_fun$) (selectp$ A_b_fun_tree$) (selectq$ A_b_fun_tree$)))
  (B_b_fun_tree$ (node$h (selectr$ B_b_fun$) (selects$ B_b_fun_tree$) (selectt$ B_b_fun_tree$)))
  (B_a_fun_b_fun_tree$ (node$i (selectu$ B_a_fun_b_fun$) (selectv$ B_a_fun_b_fun_tree$) (selectw$ B_a_fun_b_fun_tree$)))
  (A_a_a_fun_fun_tree$ (node$j (selectx$ A_a_a_fun_fun$) (selecty$ A_a_a_fun_fun_tree$) (selectz$ A_a_a_fun_fun_tree$)))
  (B_b_a_fun_fun_tree$ (node$k (selecua$ B_b_a_fun_fun$) (selecub$ B_b_a_fun_fun_tree$) (selecuc$ B_b_a_fun_fun_tree$)))
  (A_b_fun_b_fun_tree$ (node$l (selecud$ A_b_fun_b_fun$) (selecue$ A_b_fun_b_fun_tree$) (selecuf$ A_b_fun_b_fun_tree$)))
  (A_b_a_fun_fun_b_a_fun_fun_tree$ (node$m (selecug$ A_b_a_fun_fun_b_a_fun_fun$) (selecuh$ A_b_a_fun_fun_b_a_fun_fun_tree$) (selecui$ A_b_a_fun_fun_b_a_fun_fun_tree$)))
  (A_a_fun_a_fun_tree$ (node$n (selecuj$ A_a_fun_a_fun$) (selecuk$ A_a_fun_a_fun_tree$) (selecul$ A_a_fun_a_fun_tree$)))
  (B_b_a_fun_fun_b_a_fun_fun_tree$ (node$o (selecum$ B_b_a_fun_fun_b_a_fun_fun$) (selecun$ B_b_a_fun_fun_b_a_fun_fun_tree$) (selecuo$ B_b_a_fun_fun_b_a_fun_fun_tree$)))
  (B_a_a_fun_fun_tree$ (node$p (selecup$ B_a_a_fun_fun$) (selecuq$ B_a_a_fun_fun_tree$) (selecur$ B_a_a_fun_fun_tree$)))
  (B_a_a_fun_fun_a_a_fun_fun_tree$ (node$q (selecus$ B_a_a_fun_fun_a_a_fun_fun$) (selecut$ B_a_a_fun_fun_a_a_fun_fun_tree$) (selecuu$ B_a_a_fun_fun_a_a_fun_fun_tree$)))
  (B_b_fun_b_fun_tree$ (node$r (selecuv$ B_b_fun_b_fun$) (selecuw$ B_b_fun_b_fun_tree$) (selecux$ B_b_fun_b_fun_tree$)))
  (B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ (node$s (selecuy$ B_a_a_fun_fun_a_b_a_fun_fun_fun$) (selecuz$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$) (selecva$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)))
  (B_b_b_a_fun_fun_fun_tree$ (node$t (selecvb$ B_b_b_a_fun_fun_fun$) (selecvc$ B_b_b_a_fun_fun_fun_tree$) (selecvd$ B_b_b_a_fun_fun_fun_tree$)))
  (B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ (node$u (selecve$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun$) (selecvf$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$) (selecvg$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)))
  (B_a_b_a_fun_fun_fun_tree$ (node$v (selecvh$ B_a_b_a_fun_fun_fun$) (selecvi$ B_a_b_a_fun_fun_fun_tree$) (selecvj$ B_a_b_a_fun_fun_fun_tree$)))
  (A_b_b_a_fun_fun_fun_tree$ (node$w (selecvk$ A_b_b_a_fun_fun_fun$) (selecvl$ A_b_b_a_fun_fun_fun_tree$) (selecvm$ A_b_b_a_fun_fun_fun_tree$)))
  (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$ (node$x (selecvn$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun$) (selecvo$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$) (selecvp$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)))
  (B_b_a_a_fun_fun_fun_tree$ (node$y (selecvq$ B_b_a_a_fun_fun_fun$) (selecvr$ B_b_a_a_fun_fun_fun_tree$) (selecvs$ B_b_a_a_fun_fun_fun_tree$)))
  (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$ (node$z (selecvt$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun$) (selecvu$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$) (selecvv$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)))
  (B_b_b_fun_fun_tree$ (node$aa (selecvw$ B_b_b_fun_fun$) (selecvx$ B_b_b_fun_fun_tree$) (selecvy$ B_b_b_fun_fun_tree$)))
  (B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ (node$ab (selecvz$ B_b_b_fun_fun_b_b_b_fun_fun_fun$) (selecwa$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$) (selecwb$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)))
  (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ (node$ac (selecwc$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun$) (selecwd$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$) (selecwe$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)))
  (A_a_b_a_fun_fun_fun_tree$ (node$ad (selecwf$ A_a_b_a_fun_fun_fun$) (selecwg$ A_a_b_a_fun_fun_fun_tree$) (selecwh$ A_a_b_a_fun_fun_fun_tree$)))
  (A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$ (node$ae (selecwi$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun$) (selecwj$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$) (selecwk$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ (node$af (selecwl$ A_a_a_fun_fun_a_a_a_fun_fun_fun$) (selecwm$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$) (selecwn$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)))
  (A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$ (node$ag (selecwo$ A_b_a_fun_fun_b_a_a_fun_fun_fun$) (selecwp$ A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$) (selecwq$ A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)))
  (B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ (node$ah (selecwr$ B_b_a_fun_fun_b_b_a_fun_fun_fun$) (selecws$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$) (selecwt$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)))
  (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$ai (selecwu$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun$) (selecwv$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$) (selecww$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)))
  (B_b_fun_b_a_fun_fun_tree$ (node$aj (selecwx$ B_b_fun_b_a_fun_fun$) (selecwy$ B_b_fun_b_a_fun_fun_tree$) (selecwz$ B_b_fun_b_a_fun_fun_tree$)))
  (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ (node$ak (selecxa$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun$) (selecxb$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$) (selecxc$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)))
  (B_a_b_fun_fun_tree$ (node$al (selecxd$ B_a_b_fun_fun$) (selecxe$ B_a_b_fun_fun_tree$) (selecxf$ B_a_b_fun_fun_tree$)))
  (B_a_fun_b_b_fun_fun_tree$ (node$am (selecxg$ B_a_fun_b_b_fun_fun$) (selecxh$ B_a_fun_b_b_fun_fun_tree$) (selecxi$ B_a_fun_b_b_fun_fun_tree$)))
  (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ (node$an (selecxj$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun$) (selecxk$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$) (selecxl$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)))
  (B_b_fun_b_b_fun_fun_tree$ (node$ao (selecxm$ B_b_fun_b_b_fun_fun$) (selecxn$ B_b_fun_b_b_fun_fun_tree$) (selecxo$ B_b_fun_b_b_fun_fun_tree$)))
  ...
  (A_b_fun_a_a_fun_fun_tree$ (node$aq (selecxs$ A_b_fun_a_a_fun_fun$) (selecxt$ A_b_fun_a_a_fun_fun_tree$) (selecxu$ A_b_fun_a_a_fun_fun_tree$)))
  (A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$ (node$ar (selecxv$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun$) (selecxw$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$) (selecxx$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_tree$ (node$as (selecxy$ A_a_fun_a_a_fun_fun$) (selecxz$ A_a_fun_a_a_fun_fun_tree$) (selecya$ A_a_fun_a_a_fun_fun_tree$)))
  (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$at (selecyb$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$) (selecyc$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecyd$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (B_b_a_fun_a_fun_fun_tree$ (node$au (selecye$ B_b_a_fun_a_fun_fun$) (selecyf$ B_b_a_fun_a_fun_fun_tree$) (selecyg$ B_b_a_fun_a_fun_fun_tree$)))
  (B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$av (selecyh$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun$) (selecyi$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$) (selecyj$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$)))
  (B_a_a_fun_a_fun_fun_tree$ (node$aw (selecyk$ B_a_a_fun_a_fun_fun$) (selecyl$ B_a_a_fun_a_fun_fun_tree$) (selecym$ B_a_a_fun_a_fun_fun_tree$)))
  (B_a_a_fun_fun_b_a_fun_fun_tree$ (node$ax (selecyn$ B_a_a_fun_fun_b_a_fun_fun$) (selecyo$ B_a_a_fun_fun_b_a_fun_fun_tree$) (selecyp$ B_a_a_fun_fun_b_a_fun_fun_tree$)))
  (B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$ (node$ay (selecyq$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun$) (selecyr$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$) (selecys$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$)))
  (B_b_fun_b_b_a_fun_fun_fun_tree$ (node$az (selecyt$ B_b_fun_b_b_a_fun_fun_fun$) (selecyu$ B_b_fun_b_b_a_fun_fun_fun_tree$) (selecyv$ B_b_fun_b_b_a_fun_fun_fun_tree$)))
  (B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$ (node$ba (selecyw$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun$) (selecyx$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$) (selecyy$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$)))
  (B_a_fun_b_b_a_fun_fun_fun_tree$ (node$bb (selecyz$ B_a_fun_b_b_a_fun_fun_fun$) (selecza$ B_a_fun_b_b_a_fun_fun_fun_tree$) (seleczb$ B_a_fun_b_b_a_fun_fun_fun_tree$)))
  (B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ (node$bc (seleczc$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun$) (seleczd$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$) (selecze$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$)))
  (A_a_fun_b_a_a_fun_fun_fun_tree$ (node$bd (seleczf$ A_a_fun_b_a_a_fun_fun_fun$) (seleczg$ A_a_fun_b_a_a_fun_fun_fun_tree$) (seleczh$ A_a_fun_b_a_a_fun_fun_fun_tree$)))
  (B_a_fun_a_b_a_fun_fun_fun_tree$ (node$be (seleczi$ B_a_fun_a_b_a_fun_fun_fun$) (seleczj$ B_a_fun_a_b_a_fun_fun_fun_tree$) (seleczk$ B_a_fun_a_b_a_fun_fun_fun_tree$)))
  (A_b_a_fun_a_fun_fun_tree$ (node$bf (seleczl$ A_b_a_fun_a_fun_fun$) (seleczm$ A_b_a_fun_a_fun_fun_tree$) (seleczn$ A_b_a_fun_a_fun_fun_tree$)))
  (B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$bg (seleczo$ B_a_fun_b_a_fun_b_a_fun_fun_fun$) (seleczp$ B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$) (seleczq$ B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$)))))
(declare-fun c$ () A$)
