...
(declare-codatatypes () ((A_bool_fun_tree$ (node$ (select$ A_bool_fun$) (selecta$ A_bool_fun_tree$) (selectb$ A_bool_fun_tree$)))
  ...
  (Bool_a_a_a_fun_fun_fun_tree$ (node$h (selectu$ Bool_a_a_a_fun_fun_fun$) (selectv$ Bool_a_a_a_fun_fun_fun_tree$) (selectw$ Bool_a_a_a_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_bool_fun_tree$ (node$i (selectx$ A_a_a_fun_fun_bool_fun$) (selecty$ A_a_a_fun_fun_bool_fun_tree$) (selectz$ A_a_a_fun_fun_bool_fun_tree$)))
  (A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ (node$j (selecua$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun$) (selecub$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$) (selecuc$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$)))
  ...
  (A_a_a_a_fun_fun_fun_tree$ (node$y (selecvk$ A_a_a_a_fun_fun_fun$) (selecvl$ A_a_a_a_fun_fun_fun_tree$) (selecvm$ A_a_a_a_fun_fun_fun_tree$)))
  (A_a_a_fun_a_bool_fun_fun_fun_tree$ (node$z (selecvn$ A_a_a_fun_a_bool_fun_fun_fun$) (selecvo$ A_a_a_fun_a_bool_fun_fun_fun_tree$) (selecvp$ A_a_a_fun_a_bool_fun_fun_fun_tree$)))
  ...
  (A_a_a_a_fun_a_fun_fun_fun_tree$ (node$ad (selecvz$ A_a_a_a_fun_a_fun_fun_fun$) (selecwa$ A_a_a_a_fun_a_fun_fun_fun_tree$) (selecwb$ A_a_a_a_fun_a_fun_fun_fun_tree$)))
  (A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$ae (selecwc$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun$) (selecwd$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$) (selecwe$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)))
  (A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ (node$af (selecwf$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun$) (selecwg$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$) (selecwh$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$ (node$ag (selecwi$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun$) (selecwj$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$) (selecwk$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)))
  (A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$ah (selecwl$ A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun$) (selecwm$ A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecwn$ A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_bool_fun_fun_fun_tree$ (node$ai (selecwo$ A_a_fun_a_a_bool_fun_fun_fun$) (selecwp$ A_a_fun_a_a_bool_fun_fun_fun_tree$) (selecwq$ A_a_fun_a_a_bool_fun_fun_fun_tree$)))
  (A_a_fun_a_a_bool_fun_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$ (node$aj (selecwr$ A_a_fun_a_a_bool_fun_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun$) (selecws$ A_a_fun_a_a_bool_fun_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$) (selecwt$ A_a_fun_a_a_bool_fun_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$)))
  ...
  (A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$al (selecwx$ A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun$) (selecwy$ A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$) (selecwz$ A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$)))
  (A_a_a_fun_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$am (selecxa$ A_a_a_fun_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun$) (selecxb$ A_a_a_fun_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$) (selecxc$ A_a_a_fun_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$)))
  ...
  (A_bool_bool_fun_fun_tree$ (node$ao (selecxg$ A_bool_bool_fun_fun$) (selecxh$ A_bool_bool_fun_fun_tree$) (selecxi$ A_bool_bool_fun_fun_tree$)))
  (A_bool_fun_a_bool_fun_fun_tree$ (node$ap (selecxj$ A_bool_fun_a_bool_fun_fun$) (selecxk$ A_bool_fun_a_bool_fun_fun_tree$) (selecxl$ A_bool_fun_a_bool_fun_fun_tree$)))
  (A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$aq (selecxm$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun$) (selecxn$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$) (selecxo$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$)))
  (A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ (node$ar (selecxp$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun$) (selecxq$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$) (selecxr$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$)))
  (A_bool_a_fun_fun_tree$ (node$as (selecxs$ A_bool_a_fun_fun$) (selecxt$ A_bool_a_fun_fun_tree$) (selecxu$ A_bool_a_fun_fun_tree$)))
  (A_bool_fun_a_a_fun_fun_tree$ (node$at (selecxv$ A_bool_fun_a_a_fun_fun$) (selecxw$ A_bool_fun_a_a_fun_fun_tree$) (selecxx$ A_bool_fun_a_a_fun_fun_tree$)))
  ...
  (Bool_a_fun_tree$ (node$av (selecyb$ Bool_a_fun$) (selecyc$ Bool_a_fun_tree$) (selecyd$ Bool_a_fun_tree$)))
  (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$aw (selecye$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$) (selecyf$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecyg$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (A_a_bool_fun_bool_fun_fun_tree$ (node$ax (selecyh$ A_a_bool_fun_bool_fun_fun$) (selecyi$ A_a_bool_fun_bool_fun_fun_tree$) (selecyj$ A_a_bool_fun_bool_fun_fun_tree$)))
  (A_a_bool_fun_fun_a_bool_fun_fun_tree$ (node$ay (selecyk$ A_a_bool_fun_fun_a_bool_fun_fun$) (selecyl$ A_a_bool_fun_fun_a_bool_fun_fun_tree$) (selecym$ A_a_bool_fun_fun_a_bool_fun_fun_tree$)))
  (A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ (node$az (selecyn$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun$) (selecyo$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$) (selecyp$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$)))
  (A_bool_fun_bool_fun_tree$ (node$ba (selecyq$ A_bool_fun_bool_fun$) (selecyr$ A_bool_fun_bool_fun_tree$) (selecys$ A_bool_fun_bool_fun_tree$)))
  (A_a_a_fun_bool_fun_fun_tree$ (node$bb (selecyt$ A_a_a_fun_bool_fun_fun$) (selecyu$ A_a_a_fun_bool_fun_fun_tree$) (selecyv$ A_a_a_fun_bool_fun_fun_tree$)))
  ...
  (A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ (node$bd (selecyz$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun$) (selecza$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$) (seleczb$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$)))
  (A_a_fun_bool_fun_tree$ (node$be (seleczc$ A_a_fun_bool_fun$) (seleczd$ A_a_fun_bool_fun_tree$) (selecze$ A_a_fun_bool_fun_tree$)))
  (A_bool_a_bool_fun_fun_fun_tree$ (node$bf (seleczf$ A_bool_a_bool_fun_fun_fun$) (seleczg$ A_bool_a_bool_fun_fun_fun_tree$) (seleczh$ A_bool_a_bool_fun_fun_fun_tree$)))
  (A_bool_fun_a_a_bool_fun_fun_fun_tree$ (node$bg (seleczi$ A_bool_fun_a_a_bool_fun_fun_fun$) (seleczj$ A_bool_fun_a_a_bool_fun_fun_fun_tree$) (seleczk$ A_bool_fun_a_a_bool_fun_fun_fun_tree$)))
  (A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$bh (seleczl$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun$) (seleczm$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$) (seleczn$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$)))
  (Bool_a_bool_fun_fun_tree$ (node$bi (seleczo$ Bool_a_bool_fun_fun$) (seleczp$ Bool_a_bool_fun_fun_tree$) (seleczq$ Bool_a_bool_fun_fun_tree$)))
  (A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$bj (seleczr$ A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun$) (seleczs$ A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$) (seleczt$ A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$)))
  (A_a_bool_fun_a_fun_fun_tree$ (node$bk (seleczu$ A_a_bool_fun_a_fun_fun$) (seleczv$ A_a_bool_fun_a_fun_fun_tree$) (seleczw$ A_a_bool_fun_a_fun_fun_tree$)))
  ...
  (A_a_bool_fun_a_fun_fun_a_a_bool_fun_fun_a_a_fun_fun_fun_tree$ (node$bm (seledaa$ A_a_bool_fun_a_fun_fun_a_a_bool_fun_fun_a_a_fun_fun_fun$) (seledab$ A_a_bool_fun_a_fun_fun_a_a_bool_fun_fun_a_a_fun_fun_fun_tree$) (seledac$ A_a_bool_fun_a_fun_fun_a_a_bool_fun_fun_a_a_fun_fun_fun_tree$)))
  (A_bool_fun_a_fun_tree$ (node$bn (seledad$ A_bool_fun_a_fun$) (seledae$ A_bool_fun_a_fun_tree$) (seledaf$ A_bool_fun_a_fun_tree$)))
  (A_a_a_fun_fun_a_a_fun_fun_tree$ (node$bo (seledag$ A_a_a_fun_fun_a_a_fun_fun$) (seledah$ A_a_a_fun_fun_a_a_fun_fun_tree$) (seledai$ A_a_a_fun_fun_a_a_fun_fun_tree$)))
  (A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ (node$bp (seledaj$ A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun$) (seledak$ A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$) (seledal$ A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ (node$bq (seledam$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun$) (seledan$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$) (seledao$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$)))
  (A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$br (seledap$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun$) (seledaq$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$) (seledar$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ (node$bs (seledas$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun$) (seledat$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$) (seledau$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$ (node$bt (seledav$ A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun$) (seledaw$ A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$) (seledax$ A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$bu (seleday$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun$) (seledaz$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$) (seledba$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$)))))
