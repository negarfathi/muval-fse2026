...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (A_a_a_fun_fun_tree$ (node$l (selectj$ A_a_a_fun_fun$) (selectk$ A_a_a_fun_fun_tree$) (selectl$ A_a_a_fun_fun_tree$)))
  (A_a_a_fun_fun_stream$ (sCons$l (selectm$ A_a_a_fun_fun$) (selectn$ A_a_a_fun_fun_stream$)))
  (A_a_fun_a_a_fun_fun_tree$ (node$m (selecto$ A_a_fun_a_a_fun_fun$) (selectp$ A_a_fun_a_a_fun_fun_tree$) (selectq$ A_a_fun_a_a_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_stream$ (sCons$m (selectr$ A_a_fun_a_a_fun_fun$) (selects$ A_a_fun_a_a_fun_fun_stream$)))
  (A_a_tree_fun_tree$ (node$n (selectt$ A_a_tree_fun$) (selectu$ A_a_tree_fun_tree$) (selectv$ A_a_tree_fun_tree$)))
  (A_a_tree_fun_stream$ (sCons$n (selectw$ A_a_tree_fun$) (selectx$ A_a_tree_fun_stream$)))
  (A_a_stream_fun_tree$ (node$o (selecty$ A_a_stream_fun$) (selectz$ A_a_stream_fun_tree$) (selecua$ A_a_stream_fun_tree$)))
  (A_a_stream_fun_stream$ (sCons$o (selecub$ A_a_stream_fun$) (selecuc$ A_a_stream_fun_stream$)))
  (A_a_a_fun_fun_a_fun_tree$ (node$p (selecud$ A_a_a_fun_fun_a_fun$) (selecue$ A_a_a_fun_fun_a_fun_tree$) (selecuf$ A_a_a_fun_fun_a_fun_tree$)))
  (A_a_a_fun_fun_a_fun_stream$ (sCons$p (selecug$ A_a_a_fun_fun_a_fun$) (selecuh$ A_a_a_fun_fun_a_fun_stream$)))
  (A_a_fun_a_fun_a_fun_tree$ (node$q (selecui$ A_a_fun_a_fun_a_fun$) (selecuj$ A_a_fun_a_fun_a_fun_tree$) (selecuk$ A_a_fun_a_fun_a_fun_tree$)))
  (A_a_fun_a_fun_a_fun_stream$ (sCons$q (selecul$ A_a_fun_a_fun_a_fun$) (selecum$ A_a_fun_a_fun_a_fun_stream$)))
  (A_a_a_a_fun_fun_fun_tree$ (node$r (selecun$ A_a_a_a_fun_fun_fun$) (selecuo$ A_a_a_a_fun_fun_fun_tree$) (selecup$ A_a_a_a_fun_fun_fun_tree$)))
  (A_a_a_a_fun_fun_fun_stream$ (sCons$r (selecuq$ A_a_a_a_fun_fun_fun$) (selecur$ A_a_a_a_fun_fun_fun_stream$)))
  (A_a_a_fun_a_fun_fun_tree$ (node$s (selecus$ A_a_a_fun_a_fun_fun$) (selecut$ A_a_a_fun_a_fun_fun_tree$) (selecuu$ A_a_a_fun_a_fun_fun_tree$)))
  (A_a_a_fun_a_fun_fun_stream$ (sCons$s (selecuv$ A_a_a_fun_a_fun_fun$) (selecuw$ A_a_a_fun_a_fun_fun_stream$)))
  (A_stream_a_stream_fun_stream$ (sCons$t (selecux$ A_stream_a_stream_fun$) (selecuy$ A_stream_a_stream_fun_stream$)))
  (A_stream_a_fun_stream$ (sCons$u (selecuz$ A_stream_a_fun$) (selecva$ A_stream_a_fun_stream$)))
  (A_stream_a_fun_tree$ (node$t (selecvb$ A_stream_a_fun$) (selecvc$ A_stream_a_fun_tree$) (selecvd$ A_stream_a_fun_tree$)))
  (A_tree_a_fun_tree$ (node$u (selecve$ A_tree_a_fun$) (selecvf$ A_tree_a_fun_tree$) (selecvg$ A_tree_a_fun_tree$)))
  (A_stream_a_stream_fun_tree$ (node$v (selecvh$ A_stream_a_stream_fun$) (selecvi$ A_stream_a_stream_fun_tree$) (selecvj$ A_stream_a_stream_fun_tree$)))
  (A_stream_a_tree_fun_tree$ (node$w (selecvk$ A_stream_a_tree_fun$) (selecvl$ A_stream_a_tree_fun_tree$) (selecvm$ A_stream_a_tree_fun_tree$)))
  (A_tree_a_stream_fun_tree$ (node$x (selecvn$ A_tree_a_stream_fun$) (selecvo$ A_tree_a_stream_fun_tree$) (selecvp$ A_tree_a_stream_fun_tree$)))
  (A_tree_a_tree_fun_tree$ (node$y (selecvq$ A_tree_a_tree_fun$) (selecvr$ A_tree_a_tree_fun_tree$) (selecvs$ A_tree_a_tree_fun_tree$)))
  (A_tree_a_fun_stream$ (sCons$v (selecvt$ A_tree_a_fun$) (selecvu$ A_tree_a_fun_stream$)))
  (A_stream_a_tree_fun_stream$ (sCons$w (selecvv$ A_stream_a_tree_fun$) (selecvw$ A_stream_a_tree_fun_stream$)))
