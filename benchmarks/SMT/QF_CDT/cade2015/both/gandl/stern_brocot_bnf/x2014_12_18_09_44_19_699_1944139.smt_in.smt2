...
(declare-codatatypes () ((A_b_fun_tree$ (node$ (select$ A_b_fun$) (selecta$ A_b_fun_tree$) (selectb$ A_b_fun_tree$)))
  (A_c_fun_a_b_fun_fun_tree$ (node$a (selectc$ A_c_fun_a_b_fun_fun$) (selectd$ A_c_fun_a_b_fun_fun_tree$) (selecte$ A_c_fun_a_b_fun_fun_tree$)))
  (A_c_fun_tree$ (node$b (selectf$ A_c_fun$) (selectg$ A_c_fun_tree$) (selecth$ A_c_fun_tree$)))
  (A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$ (node$c (selecti$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun$) (selectj$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$) (selectk$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$)))
  (A_c_b_fun_fun_tree$ (node$d (selectl$ A_c_b_fun_fun$) (selectm$ A_c_b_fun_fun_tree$) (selectn$ A_c_b_fun_fun_tree$)))
  (A_tree$ (node$e (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  (B_tree$ (node$f (root$a B$) (left$a B_tree$) (right$a B_tree$)))
  (C_b_fun_tree$ (node$g (selecto$ C_b_fun$) (selectp$ C_b_fun_tree$) (selectq$ C_b_fun_tree$)))
  (C_tree$ (node$h (root$b C$) (left$b C_tree$) (right$b C_tree$)))
  (A_c_fun_a_fun_tree$ (node$i (selectr$ A_c_fun_a_fun$) (selects$ A_c_fun_a_fun_tree$) (selectt$ A_c_fun_a_fun_tree$)))
  (A_c_fun_b_fun_tree$ (node$j (selectu$ A_c_fun_b_fun$) (selectv$ A_c_fun_b_fun_tree$) (selectw$ A_c_fun_b_fun_tree$)))
  (A_c_fun_a_fun_a_c_fun_b_fun_fun_tree$ (node$k (selectx$ A_c_fun_a_fun_a_c_fun_b_fun_fun$) (selecty$ A_c_fun_a_fun_a_c_fun_b_fun_fun_tree$) (selectz$ A_c_fun_a_fun_a_c_fun_b_fun_fun_tree$)))
  (A_c_fun_a_b_fun_fun_a_c_fun_a_fun_a_c_fun_b_fun_fun_fun_tree$ (node$l (selecua$ A_c_fun_a_b_fun_fun_a_c_fun_a_fun_a_c_fun_b_fun_fun_fun$) (selecub$ A_c_fun_a_b_fun_fun_a_c_fun_a_fun_a_c_fun_b_fun_fun_fun_tree$) (selecuc$ A_c_fun_a_b_fun_fun_a_c_fun_a_fun_a_c_fun_b_fun_fun_fun_tree$)))
  (A_c_fun_a_b_fun_a_b_fun_fun_fun_tree$ (node$m (selecud$ A_c_fun_a_b_fun_a_b_fun_fun_fun$) (selecue$ A_c_fun_a_b_fun_a_b_fun_fun_fun_tree$) (selecuf$ A_c_fun_a_b_fun_a_b_fun_fun_fun_tree$)))
  (A_c_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$ (node$n (selecug$ A_c_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_fun$) (selecuh$ A_c_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$) (selecui$ A_c_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$)))
  ...
  (A_b_fun_a_b_fun_fun_tree$ (node$p (selecum$ A_b_fun_a_b_fun_fun$) (selecun$ A_b_fun_a_b_fun_fun_tree$) (selecuo$ A_b_fun_a_b_fun_fun_tree$)))
  (A_c_fun_a_c_fun_a_b_fun_fun_fun_tree$ (node$q (selecup$ A_c_fun_a_c_fun_a_b_fun_fun_fun$) (selecuq$ A_c_fun_a_c_fun_a_b_fun_fun_fun_tree$) (selecur$ A_c_fun_a_c_fun_a_b_fun_fun_fun_tree$)))
  (A_c_fun_a_c_fun_fun_tree$ (node$r (selecus$ A_c_fun_a_c_fun_fun$) (selecut$ A_c_fun_a_c_fun_fun_tree$) (selecuu$ A_c_fun_a_c_fun_fun_tree$)))
  (A_c_fun_a_c_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$ (node$s (selecuv$ A_c_fun_a_c_fun_fun_a_c_fun_a_b_fun_fun_fun$) (selecuw$ A_c_fun_a_c_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$) (selecux$ A_c_fun_a_c_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$)))
  ...
  (A_c_b_fun_fun_a_c_fun_fun_tree$ (node$u (selecvb$ A_c_b_fun_fun_a_c_fun_fun$) (selecvc$ A_c_b_fun_fun_a_c_fun_fun_tree$) (selecvd$ A_c_b_fun_fun_a_c_fun_fun_tree$)))
  (A_c_b_fun_fun_a_b_fun_fun_tree$ (node$v (selecve$ A_c_b_fun_fun_a_b_fun_fun$) (selecvf$ A_c_b_fun_fun_a_b_fun_fun_tree$) (selecvg$ A_c_b_fun_fun_a_b_fun_fun_tree$)))
  (A_c_b_fun_fun_a_c_fun_fun_a_c_b_fun_fun_a_b_fun_fun_fun_tree$ (node$w (selecvh$ A_c_b_fun_fun_a_c_fun_fun_a_c_b_fun_fun_a_b_fun_fun_fun$) (selecvi$ A_c_b_fun_fun_a_c_fun_fun_a_c_b_fun_fun_a_b_fun_fun_fun_tree$) (selecvj$ A_c_b_fun_fun_a_c_fun_fun_a_c_b_fun_fun_a_b_fun_fun_fun_tree$)))
  (A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_b_fun_fun_a_c_fun_fun_a_c_b_fun_fun_a_b_fun_fun_fun_fun_tree$ (node$x (selecvk$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_b_fun_fun_a_c_fun_fun_a_c_b_fun_fun_a_b_fun_fun_fun_fun$) (selecvl$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_b_fun_fun_a_c_fun_fun_a_c_b_fun_fun_a_b_fun_fun_fun_fun_tree$) (selecvm$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_b_fun_fun_a_c_fun_fun_a_c_b_fun_fun_a_b_fun_fun_fun_fun_tree$)))
  (A_c_b_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$ (node$y (selecvn$ A_c_b_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun$) (selecvo$ A_c_b_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$) (selecvp$ A_c_b_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$)))
  (A_c_b_fun_fun_a_c_b_fun_fun_fun_tree$ (node$z (selecvq$ A_c_b_fun_fun_a_c_b_fun_fun_fun$) (selecvr$ A_c_b_fun_fun_a_c_b_fun_fun_fun_tree$) (selecvs$ A_c_b_fun_fun_a_c_b_fun_fun_fun_tree$)))
  ...
  (B_a_b_fun_fun_tree$ (node$af (selecwi$ B_a_b_fun_fun$) (selecwj$ B_a_b_fun_fun_tree$) (selecwk$ B_a_b_fun_fun_tree$)))
  (B_a_fun_tree$ (node$ag (selecwl$ B_a_fun$) (selecwm$ B_a_fun_tree$) (selecwn$ B_a_fun_tree$)))
  (B_b_fun_tree$ (node$ah (selecwo$ B_b_fun$) (selecwp$ B_b_fun_tree$) (selecwq$ B_b_fun_tree$)))
  (B_a_fun_b_b_fun_fun_tree$ (node$ai (selecwr$ B_a_fun_b_b_fun_fun$) (selecws$ B_a_fun_b_b_fun_fun_tree$) (selecwt$ B_a_fun_b_b_fun_fun_tree$)))
  (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ (node$aj (selecwu$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun$) (selecwv$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$) (selecww$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)))
  (C_b_b_fun_fun_tree$ (node$ak (selecwx$ C_b_b_fun_fun$) (selecwy$ C_b_b_fun_fun_tree$) (selecwz$ C_b_b_fun_fun_tree$)))
  (C_b_fun_c_b_fun_fun_tree$ (node$al (selecxa$ C_b_fun_c_b_fun_fun$) (selecxb$ C_b_fun_c_b_fun_fun_tree$) (selecxc$ C_b_fun_c_b_fun_fun_tree$)))
  (C_b_b_fun_fun_c_b_fun_c_b_fun_fun_fun_tree$ (node$am (selecxd$ C_b_b_fun_fun_c_b_fun_c_b_fun_fun_fun$) (selecxe$ C_b_b_fun_fun_c_b_fun_c_b_fun_fun_fun_tree$) (selecxf$ C_b_b_fun_fun_c_b_fun_c_b_fun_fun_fun_tree$)))
  (C_c_b_fun_fun_tree$ (node$an (selecxg$ C_c_b_fun_fun$) (selecxh$ C_c_b_fun_fun_tree$) (selecxi$ C_c_b_fun_fun_tree$)))
  (C_c_fun_tree$ (node$ao (selecxj$ C_c_fun$) (selecxk$ C_c_fun_tree$) (selecxl$ C_c_fun_tree$)))
  (C_c_fun_c_b_fun_fun_tree$ (node$ap (selecxm$ C_c_fun_c_b_fun_fun$) (selecxn$ C_c_fun_c_b_fun_fun_tree$) (selecxo$ C_c_fun_c_b_fun_fun_tree$)))
  (C_c_b_fun_fun_c_c_fun_c_b_fun_fun_fun_tree$ (node$aq (selecxp$ C_c_b_fun_fun_c_c_fun_c_b_fun_fun_fun$) (selecxq$ C_c_b_fun_fun_c_c_fun_c_b_fun_fun_fun_tree$) (selecxr$ C_c_b_fun_fun_c_c_fun_c_b_fun_fun_fun_tree$)))
  (C_b_fun_b_fun_tree$ (node$ar (selecxs$ C_b_fun_b_fun$) (selecxt$ C_b_fun_b_fun_tree$) (selecxu$ C_b_fun_b_fun_tree$)))
  (B_a_b_fun_fun_a_b_fun_fun_tree$ (node$as (selecxv$ B_a_b_fun_fun_a_b_fun_fun$) (selecxw$ B_a_b_fun_fun_a_b_fun_fun_tree$) (selecxx$ B_a_b_fun_fun_a_b_fun_fun_tree$)))
  (A_c_b_fun_fun_c_b_fun_fun_tree$ (node$at (selecxy$ A_c_b_fun_fun_c_b_fun_fun$) (selecxz$ A_c_b_fun_fun_c_b_fun_fun_tree$) (selecya$ A_c_b_fun_fun_c_b_fun_fun_tree$)))
  (A_c_fun_c_fun_tree$ (node$au (selecyb$ A_c_fun_c_fun$) (selecyc$ A_c_fun_c_fun_tree$) (selecyd$ A_c_fun_c_fun_tree$)))
  (A_b_fun_b_fun_tree$ (node$av (selecye$ A_b_fun_b_fun$) (selecyf$ A_b_fun_b_fun_tree$) (selecyg$ A_b_fun_b_fun_tree$)))
  (A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$ (node$aw (selecyh$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_fun_a_b_fun_fun_fun$) (selecyi$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$) (selecyj$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_fun_a_b_fun_fun_fun_tree$)))
  (A_c_fun_a_b_fun_fun_a_b_fun_fun_tree$ (node$ax (selecyk$ A_c_fun_a_b_fun_fun_a_b_fun_fun$) (selecyl$ A_c_fun_a_b_fun_fun_a_b_fun_fun_tree$) (selecym$ A_c_fun_a_b_fun_fun_a_b_fun_fun_tree$)))
  (A_b_fun_a_c_fun_fun_tree$ (node$ay (selecyn$ A_b_fun_a_c_fun_fun$) (selecyo$ A_b_fun_a_c_fun_fun_tree$) (selecyp$ A_b_fun_a_c_fun_fun_tree$)))
  (A_b_fun_a_c_b_fun_fun_fun_tree$ (node$az (selecyq$ A_b_fun_a_c_b_fun_fun_fun$) (selecyr$ A_b_fun_a_c_b_fun_fun_fun_tree$) (selecys$ A_b_fun_a_c_b_fun_fun_fun_tree$)))
  (A_c_fun_a_b_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$ (node$ba (selecyt$ A_c_fun_a_b_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun$) (selecyu$ A_c_fun_a_b_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$) (selecyv$ A_c_fun_a_b_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$)))
  (A_b_fun_a_c_fun_a_b_fun_fun_fun_tree$ (node$bb (selecyw$ A_b_fun_a_c_fun_a_b_fun_fun_fun$) (selecyx$ A_b_fun_a_c_fun_a_b_fun_fun_fun_tree$) (selecyy$ A_b_fun_a_c_fun_a_b_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_a_b_fun_fun_fun_tree$ (node$bc (selecyz$ A_b_fun_a_b_fun_a_b_fun_fun_fun$) (selecza$ A_b_fun_a_b_fun_a_b_fun_fun_fun_tree$) (seleczb$ A_b_fun_a_b_fun_a_b_fun_fun_fun_tree$)))
  (B_c_b_fun_fun_tree$ (node$bd (seleczc$ B_c_b_fun_fun$) (seleczd$ B_c_b_fun_fun_tree$) (selecze$ B_c_b_fun_fun_tree$)))
  (C_b_fun_a_c_b_fun_fun_fun_tree$ (node$be (seleczf$ C_b_fun_a_c_b_fun_fun_fun$) (seleczg$ C_b_fun_a_c_b_fun_fun_fun_tree$) (seleczh$ C_b_fun_a_c_b_fun_fun_fun_tree$)))
  (C_a_c_fun_fun_tree$ (node$bf (seleczi$ C_a_c_fun_fun$) (seleczj$ C_a_c_fun_fun_tree$) (seleczk$ C_a_c_fun_fun_tree$)))
  (A_b_fun_b_a_b_fun_fun_fun_tree$ (node$bg (seleczl$ A_b_fun_b_a_b_fun_fun_fun$) (seleczm$ A_b_fun_b_a_b_fun_fun_fun_tree$) (seleczn$ A_b_fun_b_a_b_fun_fun_fun_tree$)))
  (C_a_fun_tree$ (node$bh (seleczo$ C_a_fun$) (seleczp$ C_a_fun_tree$) (seleczq$ C_a_fun_tree$)))
  (B_c_fun_tree$ (node$bi (seleczr$ B_c_fun$) (seleczs$ B_c_fun_tree$) (seleczt$ B_c_fun_tree$)))
  (C_b_fun_a_c_fun_a_b_fun_fun_fun_tree$ (node$bj (seleczu$ C_b_fun_a_c_fun_a_b_fun_fun_fun$) (seleczv$ C_b_fun_a_c_fun_a_b_fun_fun_fun_tree$) (seleczw$ C_b_fun_a_c_fun_a_b_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$ (node$bk (seleczx$ A_b_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun$) (seleczy$ A_b_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$) (seleczz$ A_b_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$)))
  (A_c_fun_a_b_fun_fun_a_c_fun_a_c_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$ (node$bl (seledaa$ A_c_fun_a_b_fun_fun_a_c_fun_a_c_fun_fun_a_c_fun_a_b_fun_fun_fun_fun$) (seledab$ A_c_fun_a_b_fun_fun_a_c_fun_a_c_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$) (seledac$ A_c_fun_a_b_fun_fun_a_c_fun_a_c_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_tree$)))
  (A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_b_fun_fun_a_c_b_fun_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_fun_tree$ (node$bm (seledad$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_b_fun_fun_a_c_b_fun_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_fun$) (seledae$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_b_fun_fun_a_c_b_fun_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_fun_tree$) (seledaf$ A_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_a_c_b_fun_fun_a_c_b_fun_fun_fun_a_c_b_fun_fun_a_c_fun_a_b_fun_fun_fun_fun_fun_tree$)))
  ...
  (B_b_fun_c_b_fun_c_b_fun_fun_fun_tree$ (node$bo (seledaj$ B_b_fun_c_b_fun_c_b_fun_fun_fun$) (seledak$ B_b_fun_c_b_fun_c_b_fun_fun_fun_tree$) (seledal$ B_b_fun_c_b_fun_c_b_fun_fun_fun_tree$)))
  (C_b_fun_c_c_fun_c_b_fun_fun_fun_tree$ (node$bp (seledam$ C_b_fun_c_c_fun_c_b_fun_fun_fun$) (seledan$ C_b_fun_c_c_fun_c_b_fun_fun_fun_tree$) (seledao$ C_b_fun_c_c_fun_c_b_fun_fun_fun_tree$)))
  (C_a_fun_c_b_fun_fun_tree$ (node$bq (seledap$ C_a_fun_c_b_fun_fun$) (seledaq$ C_a_fun_c_b_fun_fun_tree$) (seledar$ C_a_fun_c_b_fun_fun_tree$)))
  (A_b_fun_c_a_fun_c_b_fun_fun_fun_tree$ (node$br (seledas$ A_b_fun_c_a_fun_c_b_fun_fun_fun$) (seledat$ A_b_fun_c_a_fun_c_b_fun_fun_fun_tree$) (seledau$ A_b_fun_c_a_fun_c_b_fun_fun_fun_tree$)))
  (C_c_fun_a_c_fun_a_c_fun_fun_fun_tree$ (node$bs (seledav$ C_c_fun_a_c_fun_a_c_fun_fun_fun$) (seledaw$ C_c_fun_a_c_fun_a_c_fun_fun_fun_tree$) (seledax$ C_c_fun_a_c_fun_a_c_fun_fun_fun_tree$)))
  (B_c_fun_a_b_fun_a_c_fun_fun_fun_tree$ (node$bt (seleday$ B_c_fun_a_b_fun_a_c_fun_fun_fun$) (seledaz$ B_c_fun_a_b_fun_a_c_fun_fun_fun_tree$) (seledba$ B_c_fun_a_b_fun_a_c_fun_fun_fun_tree$)))))
