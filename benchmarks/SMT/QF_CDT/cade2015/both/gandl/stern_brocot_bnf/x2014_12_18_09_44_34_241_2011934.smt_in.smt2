...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (A_a_a_fun_a_fun_fun_tree$ (node$f (selecto$ A_a_a_fun_a_fun_fun$) (selectp$ A_a_a_fun_a_fun_fun_tree$) (selectq$ A_a_a_fun_a_fun_fun_tree$)))
  ...
  (A_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$ (node$k (selecud$ A_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun$) (selecue$ A_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$) (selecuf$ A_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)))
  (A_tree_tree$ (node$l (root$a A_tree$) (left$a A_tree_tree$) (right$a A_tree_tree$)))
  (A_tree_tree_tree$ (node$m (root$b A_tree_tree$) (left$b A_tree_tree_tree$) (right$b A_tree_tree_tree$)))
  (A_tree_tree_a_tree_tree_fun_tree$ (node$n (selecug$ A_tree_tree_a_tree_tree_fun$) (selecuh$ A_tree_tree_a_tree_tree_fun_tree$) (selecui$ A_tree_tree_a_tree_tree_fun_tree$)))
  (A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ (node$o (selecuj$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun$) (selecuk$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$) (selecul$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$)))
  (A_tree_a_tree_fun_tree$ (node$p (selecum$ A_tree_a_tree_fun$) (selecun$ A_tree_a_tree_fun_tree$) (selecuo$ A_tree_a_tree_fun_tree$)))
  (A_tree_a_tree_a_tree_fun_fun_tree$ (node$q (selecup$ A_tree_a_tree_a_tree_fun_fun$) (selecuq$ A_tree_a_tree_a_tree_fun_fun_tree$) (selecur$ A_tree_a_tree_a_tree_fun_fun_tree$)))
  (A_a_a_a_fun_a_fun_fun_fun_tree$ (node$r (selecus$ A_a_a_a_fun_a_fun_fun_fun$) (selecut$ A_a_a_a_fun_a_fun_fun_fun_tree$) (selecuu$ A_a_a_a_fun_a_fun_fun_fun_tree$)))
  (A_a_a_a_a_fun_fun_fun_fun_tree$ (node$s (selecuv$ A_a_a_a_a_fun_fun_fun_fun$) (selecuw$ A_a_a_a_a_fun_fun_fun_fun_tree$) (selecux$ A_a_a_a_a_fun_fun_fun_fun_tree$)))
  (A_a_a_fun_a_a_fun_a_fun_fun_fun_tree$ (node$t (selecuy$ A_a_a_fun_a_a_fun_a_fun_fun_fun$) (selecuz$ A_a_a_fun_a_a_fun_a_fun_fun_fun_tree$) (selecva$ A_a_a_fun_a_a_fun_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_a_fun_fun_tree$ (node$u (selecvb$ A_a_fun_a_a_fun_a_fun_fun$) (selecvc$ A_a_fun_a_a_fun_a_fun_fun_tree$) (selecvd$ A_a_fun_a_a_fun_a_fun_fun_tree$)))
  (A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ (node$v (selecve$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun$) (selecvf$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$) (selecvg$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$)))
  (A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$w (selecvh$ A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun$) (selecvi$ A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecvj$ A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$ (node$x (selecvk$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun$) (selecvl$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$) (selecvm$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_a_fun_fun_fun_tree$ (node$y (selecvn$ A_a_fun_a_a_a_fun_fun_fun$) (selecvo$ A_a_fun_a_a_a_fun_fun_fun_tree$) (selecvp$ A_a_fun_a_a_a_fun_fun_fun_tree$)))
  (A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ (node$z (selecvq$ A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun$) (selecvr$ A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$) (selecvs$ A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$aa (selecvt$ A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun$) (selecvu$ A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$) (selecvv$ A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$)))
  ...
  (A_a_a_a_fun_a_fun_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun_tree$ (node$ac (selecvz$ A_a_a_a_fun_a_fun_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun$) (selecwa$ A_a_a_a_fun_a_fun_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun_tree$) (selecwb$ A_a_a_a_fun_a_fun_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun_tree$)))
  (A_a_a_a_a_fun_fun_fun_fun_a_a_a_a_a_fun_fun_fun_fun_fun_tree$ (node$ad (selecwc$ A_a_a_a_a_fun_fun_fun_fun_a_a_a_a_a_fun_fun_fun_fun_fun$) (selecwd$ A_a_a_a_a_fun_fun_fun_fun_a_a_a_a_a_fun_fun_fun_fun_fun_tree$) (selecwe$ A_a_a_a_a_fun_fun_fun_fun_a_a_a_a_a_fun_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$ae (selecwf$ A_a_fun_a_a_fun_a_a_fun_fun_fun$) (selecwg$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecwh$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$af (selecwi$ A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun$) (selecwj$ A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$) (selecwk$ A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$ag (selecwl$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$) (selecwm$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecwn$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ (node$ah (selecwo$ A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun$) (selecwp$ A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$) (selecwq$ A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)))
  (A_a_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ (node$ai (selecwr$ A_a_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun$) (selecws$ A_a_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$) (selecwt$ A_a_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$)))
  ...
  (A_a_a_a_fun_fun_a_fun_fun_tree$ (node$aq (selecxp$ A_a_a_a_fun_fun_a_fun_fun$) (selecxq$ A_a_a_a_fun_fun_a_fun_fun_tree$) (selecxr$ A_a_a_a_fun_fun_a_fun_fun_tree$)))
  (A_a_a_a_fun_fun_fun_a_a_fun_fun_tree$ (node$ar (selecxs$ A_a_a_a_fun_fun_fun_a_a_fun_fun$) (selecxt$ A_a_a_a_fun_fun_fun_a_a_fun_fun_tree$) (selecxu$ A_a_a_a_fun_fun_fun_a_a_fun_fun_tree$)))
  (A_a_a_a_fun_fun_a_fun_fun_a_a_a_a_fun_fun_fun_a_a_fun_fun_fun_tree$ (node$as (selecxv$ A_a_a_a_fun_fun_a_fun_fun_a_a_a_a_fun_fun_fun_a_a_fun_fun_fun$) (selecxw$ A_a_a_a_fun_fun_a_fun_fun_a_a_a_a_fun_fun_fun_a_a_fun_fun_fun_tree$) (selecxx$ A_a_a_a_fun_fun_a_fun_fun_a_a_a_a_fun_fun_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$at (selecxy$ A_a_fun_a_fun_a_a_fun_a_a_fun_fun_fun$) (selecxz$ A_a_fun_a_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecya$ A_a_fun_a_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$au (selecyb$ A_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_fun_a_a_fun_a_a_fun_fun_fun_fun$) (selecyc$ A_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$) (selecyd$ A_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_a_a_fun_a_fun_fun_tree$ (node$av (selecye$ A_a_fun_a_a_fun_fun_a_a_fun_a_fun_fun$) (selecyf$ A_a_fun_a_a_fun_fun_a_a_fun_a_fun_fun_tree$) (selecyg$ A_a_fun_a_a_fun_fun_a_a_fun_a_fun_fun_tree$)))
  ...
  (A_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ (node$ax (selecyk$ A_a_fun_a_a_a_fun_a_fun_fun_fun$) (selecyl$ A_a_fun_a_a_a_fun_a_fun_fun_fun_tree$) (selecym$ A_a_fun_a_a_a_fun_a_fun_fun_fun_tree$)))
  (A_a_a_a_fun_a_fun_fun_fun_a_a_fun_a_a_a_fun_a_fun_fun_fun_fun_tree$ (node$ay (selecyn$ A_a_a_a_fun_a_fun_fun_fun_a_a_fun_a_a_a_fun_a_fun_fun_fun_fun$) (selecyo$ A_a_a_a_fun_a_fun_fun_fun_a_a_fun_a_a_a_fun_a_fun_fun_fun_fun_tree$) (selecyp$ A_a_a_a_fun_a_fun_fun_fun_a_a_fun_a_a_a_fun_a_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ (node$az (selecyq$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun$) (selecyr$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$) (selecys$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ (node$ba (selecyt$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun$) (selecyu$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$) (selecyv$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$bb (selecyw$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun$) (selecyx$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$) (selecyy$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$)))
  (A_a_a_fun_a_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun_tree$ (node$bc (selecyz$ A_a_a_fun_a_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun$) (selecza$ A_a_a_fun_a_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun_tree$) (seleczb$ A_a_a_fun_a_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun_tree$)))
  (A_a_a_a_fun_fun_fun_a_a_a_a_a_fun_fun_fun_fun_fun_tree$ (node$bd (seleczc$ A_a_a_a_fun_fun_fun_a_a_a_a_a_fun_fun_fun_fun_fun$) (seleczd$ A_a_a_a_fun_fun_fun_a_a_a_a_a_fun_fun_fun_fun_fun_tree$) (selecze$ A_a_a_a_fun_fun_fun_a_a_a_a_a_fun_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_a_fun_fun_a_a_a_fun_a_a_fun_a_fun_fun_fun_fun_tree$ (node$be (seleczf$ A_a_fun_a_a_fun_a_fun_fun_a_a_a_fun_a_a_fun_a_fun_fun_fun_fun$) (seleczg$ A_a_fun_a_a_fun_a_fun_fun_a_a_a_fun_a_a_fun_a_fun_fun_fun_fun_tree$) (seleczh$ A_a_fun_a_a_fun_a_fun_fun_a_a_a_fun_a_a_fun_a_fun_fun_fun_fun_tree$)))))
