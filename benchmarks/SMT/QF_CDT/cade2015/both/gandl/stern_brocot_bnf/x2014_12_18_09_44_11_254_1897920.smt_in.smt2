...
(declare-codatatypes () ((A_b_fun_tree$ (node$ (select$ A_b_fun$) (selecta$ A_b_fun_tree$) (selectb$ A_b_fun_tree$)))
  ...
  (A_a_a_fun_fun_tree$ (node$l (selecud$ A_a_a_fun_fun$) (selecue$ A_a_a_fun_fun_tree$) (selecuf$ A_a_a_fun_fun_tree$)))
  (A_a_fun_a_fun_tree$ (node$m (selecug$ A_a_fun_a_fun$) (selecuh$ A_a_fun_a_fun_tree$) (selecui$ A_a_fun_a_fun_tree$)))
  (A_a_fun_b_fun_tree$ (node$n (selecuj$ A_a_fun_b_fun$) (selecuk$ A_a_fun_b_fun_tree$) (selecul$ A_a_fun_b_fun_tree$)))
  (B_a_a_fun_fun_tree$ (node$o (selecum$ B_a_a_fun_fun$) (selecun$ B_a_a_fun_fun_tree$) (selecuo$ B_a_a_fun_fun_tree$)))
  (A_b_fun_a_b_fun_fun_a_fun_tree$ (node$p (selecup$ A_b_fun_a_b_fun_fun_a_fun$) (selecuq$ A_b_fun_a_b_fun_fun_a_fun_tree$) (selecur$ A_b_fun_a_b_fun_fun_a_fun_tree$)))
  (A_a_b_fun_a_b_fun_fun_fun_tree$ (node$q (selecus$ A_a_b_fun_a_b_fun_fun_fun$) (selecut$ A_a_b_fun_a_b_fun_fun_fun_tree$) (selecuu$ A_a_b_fun_a_b_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_fun_b_fun_tree$ (node$r (selecuv$ A_b_fun_a_b_fun_fun_b_fun$) (selecuw$ A_b_fun_a_b_fun_fun_b_fun_tree$) (selecux$ A_b_fun_a_b_fun_fun_b_fun_tree$)))
  (A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$ (node$s (selecuy$ A_b_fun_a_b_fun_fun_a_b_fun_fun$) (selecuz$ A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$) (selecva$ A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$)))))
