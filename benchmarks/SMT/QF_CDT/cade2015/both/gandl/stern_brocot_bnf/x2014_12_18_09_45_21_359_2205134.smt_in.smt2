...
(assert (! (not (and (= (root$ ba$) (root$ ca$)) (and (exists ((?v0 A_tree$) (?v1 A_tree$) (?v2 A_tree$)) (and (= (left$ ba$) ?v1) (and (= (left$ ca$) ?v2) (= (plus$ ?v0 ?v1) (plus$ ?v0 ?v2))))) (exists ((?v0 A_tree$) (?v1 A_tree$) (?v2 A_tree$)) (and (= (right$ ba$) ?v1) (and (= (right$ ca$) ?v2) (= (plus$ ?v0 ?v1) (plus$ ?v0 ?v2)))))))) :named a0))
(assert (! (= (plus$ a$ b$) (plus$ a$ c$)) :named a1))
(assert (! (= (plus$ aa$ ba$) (plus$ aa$ ca$)) :named a2))
...
(assert (! (forall ((?v0 A_tree_tree_tree$) (?v1 A_tree_tree_tree$) (?v2 A_tree_tree_tree$)) (= (= (plus$a ?v0 ?v1) (plus$a ?v2 ?v1)) (= ?v0 ?v2))) :named a22))
(assert (! (forall ((?v0 A$) (?v1 A$) (?v2 A$)) (= (= (plus$d ?v0 ?v1) (plus$d ?v2 ?v1)) (= ?v0 ?v2))) :named a23))
(assert (! (forall ((?v0 A_tree_tree$) (?v1 A_tree_tree$) (?v2 A_tree_tree$)) (= (= (plus$b ?v0 ?v1) (plus$b ?v2 ?v1)) (= ?v0 ?v2))) :named a24))
(assert (! (forall ((?v0 A_tree$) (?v1 A_tree$) (?v2 A_tree$)) (= (= (plus$ ?v0 ?v1) (plus$ ?v2 ?v1)) (= ?v0 ?v2))) :named a25))
(assert (! (forall ((?v0 A_tree_tree_tree$) (?v1 A_tree_tree_tree$) (?v2 A_tree_tree_tree$)) (= (= (plus$a ?v0 ?v1) (plus$a ?v0 ?v2)) (= ?v1 ?v2))) :named a26))
(assert (! (forall ((?v0 A$) (?v1 A$) (?v2 A$)) (= (= (plus$d ?v0 ?v1) (plus$d ?v0 ?v2)) (= ?v1 ?v2))) :named a27))
(assert (! (forall ((?v0 A_tree_tree$) (?v1 A_tree_tree$) (?v2 A_tree_tree$)) (= (= (plus$b ?v0 ?v1) (plus$b ?v0 ?v2)) (= ?v1 ?v2))) :named a28))
(assert (! (forall ((?v0 A_tree$) (?v1 A_tree$) (?v2 A_tree$)) (= (= (plus$ ?v0 ?v1) (plus$ ?v0 ?v2)) (= ?v1 ?v2))) :named a29))
(assert (! (forall ((?v0 A_tree_tree_tree$)) (= (node$b (root$b ?v0) (left$b ?v0) (right$b ?v0)) ?v0)) :named a30))
(assert (! (forall ((?v0 A_tree_tree$)) (= (node$a (root$a ?v0) (left$a ?v0) (right$a ?v0)) ?v0)) :named a31))
(assert (! (forall ((?v0 A_tree$)) (= (node$ (root$ ?v0) (left$ ?v0) (right$ ?v0)) ?v0)) :named a32))
(assert (! (forall ((?v0 A_tree_tree_tree$) (?v1 A_tree_tree$)) (=> (= ?v0 (tree_pure$ ?v1)) (and (= (root$b ?v0) ?v1) (and (= (left$b ?v0) (tree_pure$ ?v1)) (= (right$b ?v0) (tree_pure$ ?v1)))))) :named a33))
(assert (! (forall ((?v0 A_tree_tree$) (?v1 A_tree$)) (=> (= ?v0 (tree_pure$a ?v1)) (and (= (root$a ?v0) ?v1) (and (= (left$a ?v0) (tree_pure$a ?v1)) (= (right$a ?v0) (tree_pure$a ?v1)))))) :named a34))
(assert (! (forall ((?v0 A_tree$) (?v1 A$)) (=> (= ?v0 (tree_pure$b ?v1)) (and (= (root$ ?v0) ?v1) (and (= (left$ ?v0) (tree_pure$b ?v1)) (= (right$ ?v0) (tree_pure$b ?v1)))))) :named a35))
(assert (! (forall ((?v0 A_tree_tree$) (?v1 A_tree_tree_tree$) (?v2 A_tree_tree_a_tree_tree_tree_bool_fun_fun$)) (=> (and (member$ ?v0 (set_tree$ ?v1)) (and (forall ((?v3 A_tree_tree_tree$)) (fun_app$ (fun_app$f ?v2 (root$b ?v3)) ?v3)) (and (forall ((?v3 A_tree_tree$) (?v4 A_tree_tree_tree$)) (=> (and (member$ ?v3 (set_tree$ (left$b ?v4))) (fun_app$ (fun_app$f ?v2 ?v3) (left$b ?v4))) (fun_app$ (fun_app$f ?v2 ?v3) ?v4))) (forall ((?v3 A_tree_tree$) (?v4 A_tree_tree_tree$)) (=> (and (member$ ?v3 (set_tree$ (right$b ?v4))) (fun_app$ (fun_app$f ?v2 ?v3) (right$b ?v4))) (fun_app$ (fun_app$f ?v2 ?v3) ?v4)))))) (fun_app$ (fun_app$f ?v2 ?v0) ?v1))) :named a36))
(assert (! (forall ((?v0 A_tree$) (?v1 A_tree_tree$) (?v2 A_tree_a_tree_tree_bool_fun_fun$)) (=> (and (member$a ?v0 (set_tree$a ?v1)) (and (forall ((?v3 A_tree_tree$)) (fun_app$b (fun_app$g ?v2 (root$a ?v3)) ?v3)) (and (forall ((?v3 A_tree$) (?v4 A_tree_tree$)) (=> (and (member$a ?v3 (set_tree$a (left$a ?v4))) (fun_app$b (fun_app$g ?v2 ?v3) (left$a ?v4))) (fun_app$b (fun_app$g ?v2 ?v3) ?v4))) (forall ((?v3 A_tree$) (?v4 A_tree_tree$)) (=> (and (member$a ?v3 (set_tree$a (right$a ?v4))) (fun_app$b (fun_app$g ?v2 ?v3) (right$a ?v4))) (fun_app$b (fun_app$g ?v2 ?v3) ?v4)))))) (fun_app$b (fun_app$g ?v2 ?v0) ?v1))) :named a37))
(assert (! (forall ((?v0 A$) (?v1 A_tree$) (?v2 A_a_tree_bool_fun_fun$)) (=> (and (member$b ?v0 (set_tree$b ?v1)) (and (forall ((?v3 A_tree$)) (fun_app$d (fun_app$h ?v2 (root$ ?v3)) ?v3)) (and (forall ((?v3 A$) (?v4 A_tree$)) (=> (and (member$b ?v3 (set_tree$b (left$ ?v4))) (fun_app$d (fun_app$h ?v2 ?v3) (left$ ?v4))) (fun_app$d (fun_app$h ?v2 ?v3) ?v4))) (forall ((?v3 A$) (?v4 A_tree$)) (=> (and (member$b ?v3 (set_tree$b (right$ ?v4))) (fun_app$d (fun_app$h ?v2 ?v3) (right$ ?v4))) (fun_app$d (fun_app$h ?v2 ?v3) ?v4)))))) (fun_app$d (fun_app$h ?v2 ?v0) ?v1))) :named a38))
(assert (! (forall ((?v0 A_tree_tree_tree$)) (=> (=> (= ?v0 (node$b (root$b ?v0) (left$b ?v0) (right$b ?v0))) false) false)) :named a39))
(assert (! (forall ((?v0 A_tree_tree$)) (=> (=> (= ?v0 (node$a (root$a ?v0) (left$a ?v0) (right$a ?v0))) false) false)) :named a40))
(assert (! (forall ((?v0 A_tree$)) (=> (=> (= ?v0 (node$ (root$ ?v0) (left$ ?v0) (right$ ?v0))) false) false)) :named a41))
(assert (! (forall ((?v0 A_tree_tree_a_tree_tree_bool_fun_fun$) (?v1 A_tree_tree_tree$) (?v2 A_tree_tree_tree$)) (= (fun_app$ (rel_tree$ ?v0 ?v1) ?v2) (and (fun_app$b (fun_app$c ?v0 (root$b ?v1)) (root$b ?v2)) (and (fun_app$ (rel_tree$ ?v0 (left$b ?v1)) (left$b ?v2)) (fun_app$ (rel_tree$ ?v0 (right$b ?v1)) (right$b ?v2)))))) :named a42))
(assert (! (forall ((?v0 A_tree_tree_a_bool_fun_fun$) (?v1 A_tree_tree_tree$) (?v2 A_tree$)) (= (fun_app$d (rel_tree$a ?v0 ?v1) ?v2) (and (fun_app$i (fun_app$j ?v0 (root$b ?v1)) (root$ ?v2)) (and (fun_app$d (rel_tree$a ?v0 (left$b ?v1)) (left$ ?v2)) (fun_app$d (rel_tree$a ?v0 (right$b ?v1)) (right$ ?v2)))))) :named a43))
(assert (! (forall ((?v0 A_tree_tree_a_tree_bool_fun_fun$) (?v1 A_tree_tree_tree$) (?v2 A_tree_tree$)) (= (fun_app$b (rel_tree$b ?v0 ?v1) ?v2) (and (fun_app$d (fun_app$k ?v0 (root$b ?v1)) (root$a ?v2)) (and (fun_app$b (rel_tree$b ?v0 (left$b ?v1)) (left$a ?v2)) (fun_app$b (rel_tree$b ?v0 (right$b ?v1)) (right$a ?v2)))))) :named a44))
(assert (! (forall ((?v0 A_a_tree_tree_bool_fun_fun$) (?v1 A_tree$) (?v2 A_tree_tree_tree$)) (= (fun_app$ (rel_tree$c ?v0 ?v1) ?v2) (and (fun_app$b (fun_app$l ?v0 (root$ ?v1)) (root$b ?v2)) (and (fun_app$ (rel_tree$c ?v0 (left$ ?v1)) (left$b ?v2)) (fun_app$ (rel_tree$c ?v0 (right$ ?v1)) (right$b ?v2)))))) :named a45))
(assert (! (forall ((?v0 A_tree_a_tree_tree_bool_fun_fun$) (?v1 A_tree_tree$) (?v2 A_tree_tree_tree$)) (= (fun_app$ (rel_tree$d ?v0 ?v1) ?v2) (and (fun_app$b (fun_app$g ?v0 (root$a ?v1)) (root$b ?v2)) (and (fun_app$ (rel_tree$d ?v0 (left$a ?v1)) (left$b ?v2)) (fun_app$ (rel_tree$d ?v0 (right$a ?v1)) (right$b ?v2)))))) :named a46))
(assert (! (forall ((?v0 A_tree_a_tree_bool_fun_fun$) (?v1 A_tree_tree$) (?v2 A_tree_tree$)) (= (fun_app$b (rel_tree$e ?v0 ?v1) ?v2) (and (fun_app$d (fun_app$e ?v0 (root$a ?v1)) (root$a ?v2)) (and (fun_app$b (rel_tree$e ?v0 (left$a ?v1)) (left$a ?v2)) (fun_app$b (rel_tree$e ?v0 (right$a ?v1)) (right$a ?v2)))))) :named a47))
(assert (! (forall ((?v0 A_tree_a_bool_fun_fun$) (?v1 A_tree_tree$) (?v2 A_tree$)) (= (fun_app$d (rel_tree$f ?v0 ?v1) ?v2) (and (fun_app$i (fun_app$m ?v0 (root$a ?v1)) (root$ ?v2)) (and (fun_app$d (rel_tree$f ?v0 (left$a ?v1)) (left$ ?v2)) (fun_app$d (rel_tree$f ?v0 (right$a ?v1)) (right$ ?v2)))))) :named a48))
(assert (! (forall ((?v0 A_a_tree_bool_fun_fun$) (?v1 A_tree$) (?v2 A_tree_tree$)) (= (fun_app$b (rel_tree$g ?v0 ?v1) ?v2) (and (fun_app$d (fun_app$h ?v0 (root$ ?v1)) (root$a ?v2)) (and (fun_app$b (rel_tree$g ?v0 (left$ ?v1)) (left$a ?v2)) (fun_app$b (rel_tree$g ?v0 (right$ ?v1)) (right$a ?v2)))))) :named a49))
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 A_tree$) (?v2 A_tree$)) (= (fun_app$d (rel_tree$h ?v0 ?v1) ?v2) (and (fun_app$i (fun_app$n ?v0 (root$ ?v1)) (root$ ?v2)) (and (fun_app$d (rel_tree$h ?v0 (left$ ?v1)) (left$ ?v2)) (fun_app$d (rel_tree$h ?v0 (right$ ?v1)) (right$ ?v2)))))) :named a50))
