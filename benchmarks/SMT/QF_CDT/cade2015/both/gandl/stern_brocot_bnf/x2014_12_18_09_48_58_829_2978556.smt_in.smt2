...
(declare-codatatypes () ((Nat_nat_prod_tree$ (node$b (root$a Nat_nat_prod$) (left$a Nat_nat_prod_tree$) (right$a Nat_nat_prod_tree$)))
  ...
  (Nat_nat_nat_prod_fun_tree$ (node$d (selectf$ Nat_nat_nat_prod_fun$) (selectg$ Nat_nat_nat_prod_fun_tree$) (selecth$ Nat_nat_nat_prod_fun_tree$)))
  ...
  (Nat_nat_fun_nat_fun_tree$ (node$f (selectl$ Nat_nat_fun_nat_fun$) (selectm$ Nat_nat_fun_nat_fun_tree$) (selectn$ Nat_nat_fun_nat_fun_tree$)))
  ...
  (Nat_nat_nat_prod_fun_nat_fun_tree$ (node$h (selectr$ Nat_nat_nat_prod_fun_nat_fun$) (selects$ Nat_nat_nat_prod_fun_nat_fun_tree$) (selectt$ Nat_nat_nat_prod_fun_nat_fun_tree$)))
  (Nat_nat_prod_nat_fun_nat_fun_tree$ (node$i (selectu$ Nat_nat_prod_nat_fun_nat_fun$) (selectv$ Nat_nat_prod_nat_fun_nat_fun_tree$) (selectw$ Nat_nat_prod_nat_fun_nat_fun_tree$)))
  (Nat_nat_fun_nat_nat_prod_fun_tree$ (node$j (selectx$ Nat_nat_fun_nat_nat_prod_fun$) (selecty$ Nat_nat_fun_nat_nat_prod_fun_tree$) (selectz$ Nat_nat_fun_nat_nat_prod_fun_tree$)))
  (Nat_nat_nat_nat_prod_fun_fun_tree$ (node$k (selecua$ Nat_nat_nat_nat_prod_fun_fun$) (selecub$ Nat_nat_nat_nat_prod_fun_fun_tree$) (selecuc$ Nat_nat_nat_nat_prod_fun_fun_tree$)))
  ...
  (Nat_nat_nat_prod_nat_fun_fun_tree$ (node$n (selecuj$ Nat_nat_nat_prod_nat_fun_fun$) (selecuk$ Nat_nat_nat_prod_nat_fun_fun_tree$) (selecul$ Nat_nat_nat_prod_nat_fun_fun_tree$)))
  (Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$ (node$o (selecum$ Nat_nat_prod_nat_fun_nat_nat_prod_fun$) (selecun$ Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$) (selecuo$ Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$)))
  (Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$ (node$p (selecup$ Nat_nat_prod_nat_nat_prod_nat_fun_fun$) (selecuq$ Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$) (selecur$ Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$)))
  (Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$ (node$q (selecus$ Nat_nat_nat_prod_nat_fun_nat_fun_fun$) (selecut$ Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$) (selecuu$ Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$)))
  (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$ (node$r (selecuv$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun$) (selecuw$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$) (selecux$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$)))
  (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$ (node$s (selecuy$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun$) (selecuz$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$) (selecva$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$)))
  (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$ (node$t (selecvb$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun$) (selecvc$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$) (selecvd$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)))
  (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$ (node$u (selecve$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun$) (selecvf$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$) (selecvg$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)))
  ...
  (Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$ (node$w (selecvk$ Nat_nat_nat_prod_fun_nat_nat_prod_fun$) (selecvl$ Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$) (selecvm$ Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$)))
  (Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$ (node$x (selecvn$ Nat_nat_prod_nat_fun_nat_fun_nat_fun$) (selecvo$ Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$) (selecvp$ Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$)))
  (Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$ (node$y (selecvq$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun$) (selecvr$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$) (selecvs$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$)))
  (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$ (node$z (selecvt$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun$) (selecvu$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$) (selecvv$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$)))
  ...
  (Nat_tree_tree$ (node$ad (root$b Nat_tree$) (left$b Nat_tree_tree$) (right$b Nat_tree_tree$)))
  (Nat_tree_tree_tree$ (node$ae (root$c Nat_tree_tree$) (left$c Nat_tree_tree_tree$) (right$c Nat_tree_tree_tree$)))))
