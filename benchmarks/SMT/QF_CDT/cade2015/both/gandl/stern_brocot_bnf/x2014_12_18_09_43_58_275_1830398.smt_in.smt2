...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (B_a_fun_b_a_fun_fun_tree$ (node$c (selectc$ B_a_fun_b_a_fun_fun$) (selectd$ B_a_fun_b_a_fun_fun_tree$) (selecte$ B_a_fun_b_a_fun_fun_tree$)))
  (B_b_a_fun_fun_tree$ (node$d (selectf$ B_b_a_fun_fun$) (selectg$ B_b_a_fun_fun_tree$) (selecth$ B_b_a_fun_fun_tree$)))
  (B_b_fun_tree$ (node$e (selecti$ B_b_fun$) (selectj$ B_b_fun_tree$) (selectk$ B_b_fun_tree$)))
  (A_b_a_fun_fun_tree$ (node$f (selectl$ A_b_a_fun_fun$) (selectm$ A_b_a_fun_fun_tree$) (selectn$ A_b_a_fun_fun_tree$)))
