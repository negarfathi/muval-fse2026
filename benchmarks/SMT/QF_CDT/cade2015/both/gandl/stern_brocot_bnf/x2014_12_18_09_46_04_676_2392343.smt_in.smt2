...
(declare-codatatypes () ((Nat_nat_prod_tree$ (node$b (root$a Nat_nat_prod$) (left$a Nat_nat_prod_tree$) (right$a Nat_nat_prod_tree$)))
  ...
  (Rat_nat_nat_prod_fun_tree$ (node$d (selectf$ Rat_nat_nat_prod_fun$) (selectg$ Rat_nat_nat_prod_fun_tree$) (selecth$ Rat_nat_nat_prod_fun_tree$)))
  ...
  (Rat_rat_fun_rat_fun_tree$ (node$f (selectl$ Rat_rat_fun_rat_fun$) (selectm$ Rat_rat_fun_rat_fun_tree$) (selectn$ Rat_rat_fun_rat_fun_tree$)))
  (Rat_rat_rat_fun_fun_tree$ (node$g (selecto$ Rat_rat_rat_fun_fun$) (selectp$ Rat_rat_rat_fun_fun_tree$) (selectq$ Rat_rat_rat_fun_fun_tree$)))
  (Rat_nat_nat_prod_fun_rat_fun_tree$ (node$h (selectr$ Rat_nat_nat_prod_fun_rat_fun$) (selects$ Rat_nat_nat_prod_fun_rat_fun_tree$) (selectt$ Rat_nat_nat_prod_fun_rat_fun_tree$)))
  (Nat_nat_prod_rat_fun_rat_fun_tree$ (node$i (selectu$ Nat_nat_prod_rat_fun_rat_fun$) (selectv$ Nat_nat_prod_rat_fun_rat_fun_tree$) (selectw$ Nat_nat_prod_rat_fun_rat_fun_tree$)))
  (Rat_rat_fun_nat_nat_prod_fun_tree$ (node$j (selectx$ Rat_rat_fun_nat_nat_prod_fun$) (selecty$ Rat_rat_fun_nat_nat_prod_fun_tree$) (selectz$ Rat_rat_fun_nat_nat_prod_fun_tree$)))
  (Rat_rat_nat_nat_prod_fun_fun_tree$ (node$k (selecua$ Rat_rat_nat_nat_prod_fun_fun$) (selecub$ Rat_rat_nat_nat_prod_fun_fun_tree$) (selecuc$ Rat_rat_nat_nat_prod_fun_fun_tree$)))
  (Int_tree$ (node$l (root$b Int) (left$b Int_tree$) (right$b Int_tree$)))
  (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_tree$ (node$m (selecud$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun$) (selecue$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_tree$) (selecuf$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_tree$)))
  (Rat_int_fun_tree$ (node$n (selecug$ Rat_int_fun$) (selecuh$ Rat_int_fun_tree$) (selecui$ Rat_int_fun_tree$)))
  (Int_rat_fun_tree$ (node$o (selecuj$ Int_rat_fun$) (selecuk$ Int_rat_fun_tree$) (selecul$ Int_rat_fun_tree$)))
  (Int_int_fun_tree$ (node$p (selecum$ Int_int_fun$) (selecun$ Int_int_fun_tree$) (selecuo$ Int_int_fun_tree$)))
  (Nat_nat_prod_int_fun_tree$ (node$q (selecup$ Nat_nat_prod_int_fun$) (selecuq$ Nat_nat_prod_int_fun_tree$) (selecur$ Nat_nat_prod_int_fun_tree$)))
  (Int_nat_nat_prod_fun_tree$ (node$r (selecus$ Int_nat_nat_prod_fun$) (selecut$ Int_nat_nat_prod_fun_tree$) (selecuu$ Int_nat_nat_prod_fun_tree$)))
  (Nat_nat_prod_rat_fun_int_fun_tree$ (node$s (selecuv$ Nat_nat_prod_rat_fun_int_fun$) (selecuw$ Nat_nat_prod_rat_fun_int_fun_tree$) (selecux$ Nat_nat_prod_rat_fun_int_fun_tree$)))
  ...
  (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$ (node$u (selecvb$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun$) (selecvc$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$) (selecvd$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$)))
  (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ (node$v (selecve$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun$) (selecvf$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$) (selecvg$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)))
  (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ (node$w (selecvh$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun$) (selecvi$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$) (selecvj$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)))
  (Rat_nat_nat_prod_fun_nat_nat_prod_fun_tree$ (node$x (selecvk$ Rat_nat_nat_prod_fun_nat_nat_prod_fun$) (selecvl$ Rat_nat_nat_prod_fun_nat_nat_prod_fun_tree$) (selecvm$ Rat_nat_nat_prod_fun_nat_nat_prod_fun_tree$)))
  (Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$ (node$y (selecvn$ Nat_nat_prod_rat_fun_rat_fun_rat_fun$) (selecvo$ Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$) (selecvp$ Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$)))
  (Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$ (node$z (selecvq$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun$) (selecvr$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$) (selecvs$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$)))
  (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_rat_fun_rat_fun_tree$ (node$aa (selecvt$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_rat_fun_rat_fun$) (selecvu$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_rat_fun_rat_fun_tree$) (selecvv$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_rat_fun_rat_fun_tree$)))
  (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$ (node$ab (selecvw$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun$) (selecvx$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$) (selecvy$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$)))
  ...
  (Rat_tree_tree$ (node$ae (root$c Rat_tree$) (left$c Rat_tree_tree$) (right$c Rat_tree_tree$)))
  (Int_tree_tree$ (node$af (root$d Int_tree$) (left$d Int_tree_tree$) (right$d Int_tree_tree$)))
  (Int_tree_tree_tree$ (node$ag (root$e Int_tree_tree$) (left$e Int_tree_tree_tree$) (right$e Int_tree_tree_tree$)))))
(declare-fun ma$ () Nat$)
(declare-fun na$ () Nat$)
