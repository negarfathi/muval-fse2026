...
(declare-codatatypes () ((Nat_tree$ (node$ (root$ Nat$) (left$ Nat_tree$) (right$ Nat_tree$)))
  ...
  (Natural_tree$ (node$d (root$d Natural$) (left$d Natural_tree$) (right$d Natural_tree$)))
  (Natural_tree_tree$ (node$e (root$e Natural_tree$) (left$e Natural_tree_tree$) (right$e Natural_tree_tree$)))))
