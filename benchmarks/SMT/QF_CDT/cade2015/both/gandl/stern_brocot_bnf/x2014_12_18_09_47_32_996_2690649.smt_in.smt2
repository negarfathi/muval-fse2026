...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (A_b_fun_stream$ (sCons$d (selectd$ A_b_fun$) (selecte$ A_b_fun_stream$)))
  (A_b_a_fun_fun_stream$ (sCons$e (selectf$ A_b_a_fun_fun$) (selectg$ A_b_a_fun_fun_stream$)))
  (B_b_fun_stream$ (sCons$f (selecth$ B_b_fun$) (selecti$ B_b_fun_stream$)))
  (B_a_fun_b_fun_stream$ (sCons$g (selectj$ B_a_fun_b_fun$) (selectk$ B_a_fun_b_fun_stream$)))
  (B_a_fun_a_fun_stream$ (sCons$h (selectl$ B_a_fun_a_fun$) (selectm$ B_a_fun_a_fun_stream$)))
  (B_b_a_fun_fun_stream$ (sCons$i (selectn$ B_b_a_fun_fun$) (selecto$ B_b_a_fun_fun_stream$)))
  (B_a_fun_b_a_fun_fun_stream$ (sCons$j (selectp$ B_a_fun_b_a_fun_fun$) (selectq$ B_a_fun_b_a_fun_fun_stream$)))
  (A_a_fun_b_fun_stream$ (sCons$k (selectr$ A_a_fun_b_fun$) (selects$ A_a_fun_b_fun_stream$)))
  (A_b_fun_b_fun_stream$ (sCons$l (selectt$ A_b_fun_b_fun$) (selectu$ A_b_fun_b_fun_stream$)))
  (A_b_fun_a_fun_stream$ (sCons$m (selectv$ A_b_fun_a_fun$) (selectw$ A_b_fun_a_fun_stream$)))
  (A_a_fun_a_fun_stream$ (sCons$n (selectx$ A_a_fun_a_fun$) (selecty$ A_a_fun_a_fun_stream$)))
  (B_a_b_fun_fun_stream$ (sCons$o (selectz$ B_a_b_fun_fun$) (selecua$ B_a_b_fun_fun_stream$)))
  (B_a_a_fun_fun_stream$ (sCons$p (selecub$ B_a_a_fun_fun$) (selecuc$ B_a_a_fun_fun_stream$)))
  (B_b_fun_b_b_fun_fun_stream$ (sCons$q (selecud$ B_b_fun_b_b_fun_fun$) (selecue$ B_b_fun_b_b_fun_fun_stream$)))
  (A_a_b_a_fun_fun_fun_stream$ (sCons$r (selecuf$ A_a_b_a_fun_fun_fun$) (selecug$ A_a_b_a_fun_fun_fun_stream$)))
  (A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_stream$ (sCons$s (selecuh$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun$) (selecui$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_stream$)))
  (A_a_b_fun_fun_stream$ (sCons$t (selecuj$ A_a_b_fun_fun$) (selecuk$ A_a_b_fun_fun_stream$)))
  (A_a_b_fun_fun_a_a_b_fun_fun_fun_stream$ (sCons$u (selecul$ A_a_b_fun_fun_a_a_b_fun_fun_fun$) (selecum$ A_a_b_fun_fun_a_a_b_fun_fun_fun_stream$)))
  (A_a_a_fun_fun_stream$ (sCons$v (selecun$ A_a_a_fun_fun$) (selecuo$ A_a_a_fun_fun_stream$)))
  (A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$ (sCons$w (selecup$ A_a_a_fun_fun_a_a_a_fun_fun_fun$) (selecuq$ A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$)))
  ...
  (A_b_fun_a_b_fun_fun_stream$ (sCons$y (selecut$ A_b_fun_a_b_fun_fun$) (selecuu$ A_b_fun_a_b_fun_fun_stream$)))
  (A_a_fun_a_a_fun_fun_stream$ (sCons$z (selecuv$ A_a_fun_a_a_fun_fun$) (selecuw$ A_a_fun_a_a_fun_fun_stream$)))))
