...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (A_a_fun_stream$ (sCons$c (selectb$ A_a_fun$) (selectc$ A_a_fun_stream$)))
  (B_a_fun_a_fun_stream$ (sCons$d (selectd$ B_a_fun_a_fun$) (selecte$ B_a_fun_a_fun_stream$)))
  (A_b_a_fun_fun_stream$ (sCons$e (selectf$ A_b_a_fun_fun$) (selectg$ A_b_a_fun_fun_stream$)))
  (B_a_fun_b_a_fun_fun_stream$ (sCons$f (selecth$ B_a_fun_b_a_fun_fun$) (selecti$ B_a_fun_b_a_fun_fun_stream$)))
  (A_b_fun_stream$ (sCons$g (selectj$ A_b_fun$) (selectk$ A_b_fun_stream$)))
  (B_b_fun_stream$ (sCons$h (selectl$ B_b_fun$) (selectm$ B_b_fun_stream$)))
  (B_a_fun_b_fun_stream$ (sCons$i (selectn$ B_a_fun_b_fun$) (selecto$ B_a_fun_b_fun_stream$)))
  (A_a_a_fun_fun_stream$ (sCons$j (selectp$ A_a_a_fun_fun$) (selectq$ A_a_a_fun_fun_stream$)))
  (B_b_a_fun_fun_stream$ (sCons$k (selectr$ B_b_a_fun_fun$) (selects$ B_b_a_fun_fun_stream$)))
  (A_b_a_fun_a_fun_fun_stream$ (sCons$l (selectt$ A_b_a_fun_a_fun_fun$) (selectu$ A_b_a_fun_a_fun_fun_stream$)))
  (A_b_a_fun_a_fun_fun_b_a_fun_a_fun_fun_stream$ (sCons$m (selectv$ A_b_a_fun_a_fun_fun_b_a_fun_a_fun_fun$) (selectw$ A_b_a_fun_a_fun_fun_b_a_fun_a_fun_fun_stream$)))
  (A_a_b_a_fun_fun_fun_stream$ (sCons$n (selectx$ A_a_b_a_fun_fun_fun$) (selecty$ A_a_b_a_fun_fun_fun_stream$)))
  (A_a_b_a_fun_fun_fun_a_b_a_fun_fun_fun_stream$ (sCons$o (selectz$ A_a_b_a_fun_fun_fun_a_b_a_fun_fun_fun$) (selecua$ A_a_b_a_fun_fun_fun_a_b_a_fun_fun_fun_stream$)))
  (A_a_a_fun_fun_a_a_fun_fun_stream$ (sCons$p (selecub$ A_a_a_fun_fun_a_a_fun_fun$) (selecuc$ A_a_a_fun_fun_a_a_fun_fun_stream$)))
  (A_b_fun_b_fun_stream$ (sCons$q (selecud$ A_b_fun_b_fun$) (selecue$ A_b_fun_b_fun_stream$)))
  (A_a_fun_a_fun_stream$ (sCons$r (selecuf$ A_a_fun_a_fun$) (selecug$ A_a_fun_a_fun_stream$)))
  (A_b_a_fun_fun_b_a_fun_fun_stream$ (sCons$s (selecuh$ A_b_a_fun_fun_b_a_fun_fun$) (selecui$ A_b_a_fun_fun_b_a_fun_fun_stream$)))
  (B_a_fun_a_fun_a_fun_stream$ (sCons$t (selecuj$ B_a_fun_a_fun_a_fun$) (selecuk$ B_a_fun_a_fun_a_fun_stream$)))
  ...
  (B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_stream$ (sCons$v (selecun$ B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun$) (selecuo$ B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_stream$)))
  (B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$ (sCons$w (selecup$ B_a_fun_a_fun_b_a_fun_a_fun_fun$) (selecuq$ B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$)))
  (A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$ (sCons$x (selecur$ A_b_a_fun_fun_a_b_a_fun_fun_fun$) (selecus$ A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$)))
  (A_a_fun_a_a_fun_fun_stream$ (sCons$y (selecut$ A_a_fun_a_a_fun_fun$) (selecuu$ A_a_fun_a_a_fun_fun_stream$)))
  (A_stream_stream$ (sCons$z (shd$b A_stream$) (stl$b A_stream_stream$)))
  (B_a_fun_stream_stream$ (sCons$aa (shd$c B_a_fun_stream$) (stl$c B_a_fun_stream_stream$)))
  (B_a_fun_b_a_fun_fun_tree$ (node$ (selecuv$ B_a_fun_b_a_fun_fun$) (selecuw$ B_a_fun_b_a_fun_fun_tree$) (selecux$ B_a_fun_b_a_fun_fun_tree$)))
  (B_a_fun_a_fun_tree$ (node$a (selecuy$ B_a_fun_a_fun$) (selecuz$ B_a_fun_a_fun_tree$) (selecva$ B_a_fun_a_fun_tree$)))
  (A_b_a_fun_fun_tree$ (node$b (selecvb$ A_b_a_fun_fun$) (selecvc$ A_b_a_fun_fun_tree$) (selecvd$ A_b_a_fun_fun_tree$)))
  (A_a_fun_tree$ (node$c (selecve$ A_a_fun$) (selecvf$ A_a_fun_tree$) (selecvg$ A_a_fun_tree$)))
  (B_tree$ (node$d (root$ B$) (left$ B_tree$) (right$ B_tree$)))
  (B_a_fun_tree$ (node$e (selecvh$ B_a_fun$) (selecvi$ B_a_fun_tree$) (selecvj$ B_a_fun_tree$)))
  (A_tree$ (node$f (root$a A$) (left$a A_tree$) (right$a A_tree$)))))
(declare-fun c$ () A$)
