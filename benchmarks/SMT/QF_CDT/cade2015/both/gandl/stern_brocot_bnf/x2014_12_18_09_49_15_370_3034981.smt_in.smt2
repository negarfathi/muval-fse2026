...
(declare-codatatypes () ((B_tree$ (node$ (root$ B$) (left$ B_tree$) (right$ B_tree$)))
  ...
  (A_b_bool_fun_fun_tree$ (node$c (selectc$ A_b_bool_fun_fun$) (selectd$ A_b_bool_fun_fun_tree$) (selecte$ A_b_bool_fun_fun_tree$)))
  (B_bool_fun_tree$ (node$d (selectf$ B_bool_fun$) (selectg$ B_bool_fun_tree$) (selecth$ B_bool_fun_tree$)))
  (A_b_b_fun_fun_tree$ (node$e (selecti$ A_b_b_fun_fun$) (selectj$ A_b_b_fun_fun_tree$) (selectk$ A_b_b_fun_fun_tree$)))
  (B_b_fun_tree$ (node$f (selectl$ B_b_fun$) (selectm$ B_b_fun_tree$) (selectn$ B_b_fun_tree$)))
  (A_a_bool_fun_fun_tree$ (node$g (selecto$ A_a_bool_fun_fun$) (selectp$ A_a_bool_fun_fun_tree$) (selectq$ A_a_bool_fun_fun_tree$)))
  (A_bool_fun_tree$ (node$h (selectr$ A_bool_fun$) (selects$ A_bool_fun_tree$) (selectt$ A_bool_fun_tree$)))
  (A_a_b_fun_fun_tree$ (node$i (selectu$ A_a_b_fun_fun$) (selectv$ A_a_b_fun_fun_tree$) (selectw$ A_a_b_fun_fun_tree$)))
  (A_a_fun_tree$ (node$j (selectx$ A_a_fun$) (selecty$ A_a_fun_tree$) (selectz$ A_a_fun_tree$)))
  (A_b_fun_a_bool_fun_fun_tree$ (node$k (selecua$ A_b_fun_a_bool_fun_fun$) (selecub$ A_b_fun_a_bool_fun_fun_tree$) (selecuc$ A_b_fun_a_bool_fun_fun_tree$)))
  (A_b_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$l (selecud$ A_b_fun_a_b_fun_a_bool_fun_fun_fun$) (selecue$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_tree$) (selecuf$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_tree$)))
  (A_a_b_fun_fun_a_a_b_fun_fun_fun_tree$ (node$m (selecug$ A_a_b_fun_fun_a_a_b_fun_fun_fun$) (selecuh$ A_a_b_fun_fun_a_a_b_fun_fun_fun_tree$) (selecui$ A_a_b_fun_fun_a_a_b_fun_fun_fun_tree$)))
  (A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ (node$n (selecuj$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun$) (selecuk$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$) (selecul$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$)))
  (A_b_fun_bool_fun_tree$ (node$o (selecum$ A_b_fun_bool_fun$) (selecun$ A_b_fun_bool_fun_tree$) (selecuo$ A_b_fun_bool_fun_tree$)))
  (A_a_b_fun_bool_fun_fun_tree$ (node$p (selecup$ A_a_b_fun_bool_fun_fun$) (selecuq$ A_a_b_fun_bool_fun_fun_tree$) (selecur$ A_a_b_fun_bool_fun_fun_tree$)))
  (A_b_fun_a_bool_fun_fun_a_a_b_fun_bool_fun_fun_fun_tree$ (node$q (selecus$ A_b_fun_a_bool_fun_fun_a_a_b_fun_bool_fun_fun_fun$) (selecut$ A_b_fun_a_bool_fun_fun_a_a_b_fun_bool_fun_fun_fun_tree$) (selecuu$ A_b_fun_a_bool_fun_fun_a_a_b_fun_bool_fun_fun_fun_tree$)))
  (A_a_b_fun_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$r (selecuv$ A_a_b_fun_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun$) (selecuw$ A_a_b_fun_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$) (selecux$ A_a_b_fun_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$)))
  ...
  (A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$t (selecvb$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun$) (selecvc$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$) (selecvd$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$ (node$u (selecve$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun$) (selecvf$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$) (selecvg$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$)))
  (B_a_bool_fun_fun_tree$ (node$v (selecvh$ B_a_bool_fun_fun$) (selecvi$ B_a_bool_fun_fun_tree$) (selecvj$ B_a_bool_fun_fun_tree$)))
  (B_a_bool_fun_fun_a_b_bool_fun_fun_fun_tree$ (node$w (selecvk$ B_a_bool_fun_fun_a_b_bool_fun_fun_fun$) (selecvl$ B_a_bool_fun_fun_a_b_bool_fun_fun_fun_tree$) (selecvm$ B_a_bool_fun_fun_a_b_bool_fun_fun_fun_tree$)))
  (B_a_b_fun_fun_tree$ (node$x (selecvn$ B_a_b_fun_fun$) (selecvo$ B_a_b_fun_fun_tree$) (selecvp$ B_a_b_fun_fun_tree$)))
  (B_a_b_fun_fun_a_b_b_fun_fun_fun_tree$ (node$y (selecvq$ B_a_b_fun_fun_a_b_b_fun_fun_fun$) (selecvr$ B_a_b_fun_fun_a_b_b_fun_fun_fun_tree$) (selecvs$ B_a_b_fun_fun_a_b_b_fun_fun_fun_tree$)))
  (A_b_b_fun_fun_b_a_b_fun_fun_fun_tree$ (node$z (selecvt$ A_b_b_fun_fun_b_a_b_fun_fun_fun$) (selecvu$ A_b_b_fun_fun_b_a_b_fun_fun_fun_tree$) (selecvv$ A_b_b_fun_fun_b_a_b_fun_fun_fun_tree$)))
  (A_b_bool_fun_fun_b_a_bool_fun_fun_fun_tree$ (node$aa (selecvw$ A_b_bool_fun_fun_b_a_bool_fun_fun_fun$) (selecvx$ A_b_bool_fun_fun_b_a_bool_fun_fun_fun_tree$) (selecvy$ A_b_bool_fun_fun_b_a_bool_fun_fun_fun_tree$)))
  (Bool_bool_fun_tree$ (node$ab (selecvz$ Bool_bool_fun$) (selecwa$ Bool_bool_fun_tree$) (selecwb$ Bool_bool_fun_tree$)))
  (A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun_tree$ (node$ac (selecwc$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun$) (selecwd$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun_tree$) (selecwe$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun_tree$)))
  ...
  (Bool_b_fun_tree$ (node$ae (selecwi$ Bool_b_fun$) (selecwj$ Bool_b_fun_tree$) (selecwk$ Bool_b_fun_tree$)))
  (Bool_a_fun_tree$ (node$af (selecwl$ Bool_a_fun$) (selecwm$ Bool_a_fun_tree$) (selecwn$ Bool_a_fun_tree$)))
  (A_b_fun_a_b_fun_fun_tree$ (node$ag (selecwo$ A_b_fun_a_b_fun_fun$) (selecwp$ A_b_fun_a_b_fun_fun_tree$) (selecwq$ A_b_fun_a_b_fun_fun_tree$)))
  (A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ (node$ah (selecwr$ A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun$) (selecws$ A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$) (selecwt$ A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$)))
  (A_bool_b_fun_fun_tree$ (node$ai (selecwu$ A_bool_b_fun_fun$) (selecwv$ A_bool_b_fun_fun_tree$) (selecww$ A_bool_b_fun_fun_tree$)))
  ...
  (A_a_fun_a_b_fun_fun_tree$ (node$al (selecxd$ A_a_fun_a_b_fun_fun$) (selecxe$ A_a_fun_a_b_fun_fun_tree$) (selecxf$ A_a_fun_a_b_fun_fun_tree$)))
  (A_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$ (node$am (selecxg$ A_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun$) (selecxh$ A_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$) (selecxi$ A_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$)))
  (A_bool_bool_fun_fun_tree$ (node$an (selecxj$ A_bool_bool_fun_fun$) (selecxk$ A_bool_bool_fun_fun_tree$) (selecxl$ A_bool_bool_fun_fun_tree$)))
  (A_bool_fun_a_bool_fun_fun_tree$ (node$ao (selecxm$ A_bool_fun_a_bool_fun_fun$) (selecxn$ A_bool_fun_a_bool_fun_fun_tree$) (selecxo$ A_bool_fun_a_bool_fun_fun_tree$)))
  (A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$ap (selecxp$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun$) (selecxq$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$) (selecxr$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$)))
  (A_a_fun_a_bool_fun_fun_tree$ (node$aq (selecxs$ A_a_fun_a_bool_fun_fun$) (selecxt$ A_a_fun_a_bool_fun_fun_tree$) (selecxu$ A_a_fun_a_bool_fun_fun_tree$)))
  ...
  (A_b_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$as (selecxy$ A_b_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun$) (selecxz$ A_b_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$) (selecya$ A_b_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$)))
  (A_b_fun_a_fun_tree$ (node$at (selecyb$ A_b_fun_a_fun$) (selecyc$ A_b_fun_a_fun_tree$) (selecyd$ A_b_fun_a_fun_tree$)))
  (A_b_fun_a_fun_a_b_fun_bool_fun_fun_tree$ (node$au (selecye$ A_b_fun_a_fun_a_b_fun_bool_fun_fun$) (selecyf$ A_b_fun_a_fun_a_b_fun_bool_fun_fun_tree$) (selecyg$ A_b_fun_a_fun_a_b_fun_bool_fun_fun_tree$)))
  (A_b_fun_a_bool_fun_fun_a_b_fun_a_fun_a_b_fun_bool_fun_fun_fun_tree$ (node$av (selecyh$ A_b_fun_a_bool_fun_fun_a_b_fun_a_fun_a_b_fun_bool_fun_fun_fun$) (selecyi$ A_b_fun_a_bool_fun_fun_a_b_fun_a_fun_a_b_fun_bool_fun_fun_fun_tree$) (selecyj$ A_b_fun_a_bool_fun_fun_a_b_fun_a_fun_a_b_fun_bool_fun_fun_fun_tree$)))
  (A_b_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$aw (selecyk$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun$) (selecyl$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun_tree$) (selecym$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun_tree$)))
  (A_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$ax (selecyn$ A_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun$) (selecyo$ A_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$) (selecyp$ A_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$)))
  (A_b_fun_a_bool_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$ay (selecyq$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun$) (selecyr$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$) (selecys$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$az (selecyt$ A_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun$) (selecyu$ A_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$) (selecyv$ A_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$ba (selecyw$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun$) (selecyx$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$) (selecyy$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ (node$bb (selecyz$ A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun$) (selecza$ A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun_tree$) (seleczb$ A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$bc (seleczc$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun$) (seleczd$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$) (selecze$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$)))
  ...
  (A_b_fun_a_bool_fun_fun_a_bool_fun_fun_tree$ (node$be (seleczi$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun$) (seleczj$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun_tree$) (seleczk$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun_tree$)))
  (B_bool_fun_a_b_bool_fun_fun_fun_tree$ (node$bf (seleczl$ B_bool_fun_a_b_bool_fun_fun_fun$) (seleczm$ B_bool_fun_a_b_bool_fun_fun_fun_tree$) (seleczn$ B_bool_fun_a_b_bool_fun_fun_fun_tree$)))
  (B_b_fun_a_b_b_fun_fun_fun_tree$ (node$bg (seleczo$ B_b_fun_a_b_b_fun_fun_fun$) (seleczp$ B_b_fun_a_b_b_fun_fun_fun_tree$) (seleczq$ B_b_fun_a_b_b_fun_fun_fun_tree$)))
  (A_bool_fun_a_a_bool_fun_fun_fun_tree$ (node$bh (seleczr$ A_bool_fun_a_a_bool_fun_fun_fun$) (seleczs$ A_bool_fun_a_a_bool_fun_fun_fun_tree$) (seleczt$ A_bool_fun_a_a_bool_fun_fun_fun_tree$)))
  (A_b_fun_a_a_b_fun_fun_fun_tree$ (node$bi (seleczu$ A_b_fun_a_a_b_fun_fun_fun$) (seleczv$ A_b_fun_a_a_b_fun_fun_fun_tree$) (seleczw$ A_b_fun_a_a_b_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_tree$ (node$bj (seleczx$ A_a_a_fun_fun$) (seleczy$ A_a_a_fun_fun_tree$) (seleczz$ A_a_a_fun_fun_tree$)))
  (Bool_a_bool_fun_fun_tree$ (node$bk (seledaa$ Bool_a_bool_fun_fun$) (seledab$ Bool_a_bool_fun_fun_tree$) (seledac$ Bool_a_bool_fun_fun_tree$)))
  (A_bool_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$bl (seledad$ A_bool_fun_a_b_fun_a_bool_fun_fun_fun$) (seledae$ A_bool_fun_a_b_fun_a_bool_fun_fun_fun_tree$) (seledaf$ A_bool_fun_a_b_fun_a_bool_fun_fun_fun_tree$)))
  (A_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$bm (seledag$ A_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun$) (seledah$ A_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$) (seledai$ A_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$)))
  (B_a_fun_tree$ (node$bn (seledaj$ B_a_fun$) (seledak$ B_a_fun_tree$) (seledal$ B_a_fun_tree$)))
  (A_bool_fun_b_fun_tree$ (node$bo (seledam$ A_bool_fun_b_fun$) (seledan$ A_bool_fun_b_fun_tree$) (seledao$ A_bool_fun_b_fun_tree$)))
  (A_bool_fun_a_fun_tree$ (node$bp (seledap$ A_bool_fun_a_fun$) (seledaq$ A_bool_fun_a_fun_tree$) (seledar$ A_bool_fun_a_fun_tree$)))
  (A_b_fun_b_fun_tree$ (node$bq (seledas$ A_b_fun_b_fun$) (seledat$ A_b_fun_b_fun_tree$) (seledau$ A_b_fun_b_fun_tree$)))))
