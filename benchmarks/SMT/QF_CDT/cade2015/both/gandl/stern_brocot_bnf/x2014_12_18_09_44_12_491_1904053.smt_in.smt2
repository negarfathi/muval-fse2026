...
(declare-codatatypes () ((A_b_fun_tree$ (node$ (select$ A_b_fun$) (selecta$ A_b_fun_tree$) (selectb$ A_b_fun_tree$)))
  ...
  (A_a_fun_a_b_fun_fun_tree$ (node$c (selectc$ A_a_fun_a_b_fun_fun$) (selectd$ A_a_fun_a_b_fun_fun_tree$) (selecte$ A_a_fun_a_b_fun_fun_tree$)))
  (A_a_fun_tree$ (node$d (selectf$ A_a_fun$) (selectg$ A_a_fun_tree$) (selecth$ A_a_fun_tree$)))
  (A_b_fun_a_a_fun_a_b_fun_fun_fun_tree$ (node$e (selecti$ A_b_fun_a_a_fun_a_b_fun_fun_fun$) (selectj$ A_b_fun_a_a_fun_a_b_fun_fun_fun_tree$) (selectk$ A_b_fun_a_a_fun_a_b_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_fun_tree$ (node$f (selectl$ A_b_fun_a_b_fun_fun$) (selectm$ A_b_fun_a_b_fun_fun_tree$) (selectn$ A_b_fun_a_b_fun_fun_tree$)))
  (B_b_fun_tree$ (node$g (selecto$ B_b_fun$) (selectp$ B_b_fun_tree$) (selectq$ B_b_fun_tree$)))
  (B_a_fun_tree$ (node$h (selectr$ B_a_fun$) (selects$ B_a_fun_tree$) (selectt$ B_a_fun_tree$)))
  ...
  (B_a_b_fun_fun_tree$ (node$l (selecud$ B_a_b_fun_fun$) (selecue$ B_a_b_fun_fun_tree$) (selecuf$ B_a_b_fun_fun_tree$)))
  (B_b_fun_a_b_fun_a_b_fun_fun_fun_tree$ (node$m (selecug$ B_b_fun_a_b_fun_a_b_fun_fun_fun$) (selecuh$ B_b_fun_a_b_fun_a_b_fun_fun_fun_tree$) (selecui$ B_b_fun_a_b_fun_a_b_fun_fun_fun_tree$)))
  (B_a_fun_b_b_fun_fun_tree$ (node$n (selecuj$ B_a_fun_b_b_fun_fun$) (selecuk$ B_a_fun_b_b_fun_fun_tree$) (selecul$ B_a_fun_b_b_fun_fun_tree$)))
  (A_b_fun_b_a_fun_b_b_fun_fun_fun_tree$ (node$o (selecum$ A_b_fun_b_a_fun_b_b_fun_fun_fun$) (selecun$ A_b_fun_b_a_fun_b_b_fun_fun_fun_tree$) (selecuo$ A_b_fun_b_a_fun_b_b_fun_fun_fun_tree$)))
  (B_b_fun_b_b_fun_fun_tree$ (node$p (selecup$ B_b_fun_b_b_fun_fun$) (selecuq$ B_b_fun_b_b_fun_fun_tree$) (selecur$ B_b_fun_b_b_fun_fun_tree$)))
  (B_b_fun_b_b_fun_b_b_fun_fun_fun_tree$ (node$q (selecus$ B_b_fun_b_b_fun_b_b_fun_fun_fun$) (selecut$ B_b_fun_b_b_fun_b_b_fun_fun_fun_tree$) (selecuu$ B_b_fun_b_b_fun_b_b_fun_fun_fun_tree$)))
  ...
  (B_a_fun_a_b_fun_a_a_fun_fun_fun_tree$ (node$s (selecuy$ B_a_fun_a_b_fun_a_a_fun_fun_fun$) (selecuz$ B_a_fun_a_b_fun_a_a_fun_fun_fun_tree$) (selecva$ B_a_fun_a_b_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_tree$ (node$t (selecvb$ A_a_fun_a_a_fun_fun$) (selecvc$ A_a_fun_a_a_fun_fun_tree$) (selecvd$ A_a_fun_a_a_fun_fun_tree$)))
  (A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$u (selecve$ A_a_fun_a_a_fun_a_a_fun_fun_fun$) (selecvf$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecvg$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ (node$v (selecvh$ A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_fun$) (selecvi$ A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$) (selecvj$ A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_fun_fun_tree$ (node$w (selecvk$ A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_fun_fun$) (selecvl$ A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_fun_fun_tree$) (selecvm$ A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_fun_fun_fun_tree$)))
  (A_b_fun_a_a_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ (node$x (selecvn$ A_b_fun_a_a_fun_fun_a_b_fun_a_b_fun_fun_fun$) (selecvo$ A_b_fun_a_a_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$) (selecvp$ A_b_fun_a_a_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$)))
  (A_a_fun_a_b_fun_fun_a_b_fun_a_a_fun_fun_a_b_fun_a_b_fun_fun_fun_fun_tree$ (node$y (selecvq$ A_a_fun_a_b_fun_fun_a_b_fun_a_a_fun_fun_a_b_fun_a_b_fun_fun_fun_fun$) (selecvr$ A_a_fun_a_b_fun_fun_a_b_fun_a_a_fun_fun_a_b_fun_a_b_fun_fun_fun_fun_tree$) (selecvs$ A_a_fun_a_b_fun_fun_a_b_fun_a_a_fun_fun_a_b_fun_a_b_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$ (node$z (selecvt$ A_a_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun$) (selecvu$ A_a_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$) (selecvv$ A_a_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$)))
  (A_b_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_fun_tree$ (node$aa (selecvw$ A_b_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_fun$) (selecvx$ A_b_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_fun_tree$) (selecvy$ A_b_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$ (node$ab (selecvz$ A_a_fun_a_a_fun_fun_a_a_fun_a_b_fun_fun_fun$) (selecwa$ A_a_fun_a_a_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$) (selecwb$ A_a_fun_a_a_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$)))
  (A_a_fun_a_b_fun_fun_a_a_fun_a_a_fun_fun_a_a_fun_a_b_fun_fun_fun_fun_tree$ (node$ac (selecwc$ A_a_fun_a_b_fun_fun_a_a_fun_a_a_fun_fun_a_a_fun_a_b_fun_fun_fun_fun$) (selecwd$ A_a_fun_a_b_fun_fun_a_a_fun_a_a_fun_fun_a_a_fun_a_b_fun_fun_fun_fun_tree$) (selecwe$ A_a_fun_a_b_fun_fun_a_a_fun_a_a_fun_fun_a_a_fun_a_b_fun_fun_fun_fun_tree$)))))
