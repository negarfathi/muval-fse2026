...
(declare-codatatypes () ((A_a_fun_stream$ (sCons$a (selectb$ A_a_fun$) (selectc$ A_a_fun_stream$)))
  (A_stream_stream$ (sCons$b (shd$a A_stream$) (stl$a A_stream_stream$)))
  ...
  (A_a_fun_a_a_fun_fun_stream$ (sCons$e (selecth$ A_a_fun_a_a_fun_fun$) (selecti$ A_a_fun_a_a_fun_fun_stream$)))
  (A_stream_a_fun_stream$ (sCons$f (selectj$ A_stream_a_fun$) (selectk$ A_stream_a_fun_stream$)))
  (A_a_stream_fun_stream$ (sCons$g (selectl$ A_a_stream_fun$) (selectm$ A_a_stream_fun_stream$)))
  (A_stream_a_stream_fun_stream$ (sCons$h (selectn$ A_stream_a_stream_fun$) (selecto$ A_stream_a_stream_fun_stream$)))
  (A_stream_a_a_fun_fun_stream$ (sCons$i (selectp$ A_stream_a_a_fun_fun$) (selectq$ A_stream_a_a_fun_fun_stream$)))
  (A_a_fun_a_stream_fun_stream$ (sCons$j (selectr$ A_a_fun_a_stream_fun$) (selects$ A_a_fun_a_stream_fun_stream$)))
  (A_a_a_fun_fun_a_fun_stream$ (sCons$k (selectt$ A_a_a_fun_fun_a_fun$) (selectu$ A_a_a_fun_fun_a_fun_stream$)))
  (A_stream_tree$ (node$ (root$ A_stream$) (left$ A_stream_tree$) (right$ A_stream_tree$)))
  (A_stream_tree_tree$ (node$a (root$a A_stream_tree$) (left$a A_stream_tree_tree$) (right$a A_stream_tree_tree$)))
  (A_stream_tree_tree_tree$ (node$b (root$b A_stream_tree_tree$) (left$b A_stream_tree_tree_tree$) (right$b A_stream_tree_tree_tree$)))
  (A_tree$ (node$c (root$c A$) (left$c A_tree$) (right$c A_tree$)))
