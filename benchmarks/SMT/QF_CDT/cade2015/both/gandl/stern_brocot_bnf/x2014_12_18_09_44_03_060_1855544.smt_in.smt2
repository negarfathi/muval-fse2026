...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (B_a_fun_b_fun_tree$ (node$h (selectr$ B_a_fun_b_fun$) (selects$ B_a_fun_b_fun_tree$) (selectt$ B_a_fun_b_fun_tree$)))
  (B_a_fun_a_fun_tree$ (node$i (selectu$ B_a_fun_a_fun$) (selectv$ B_a_fun_a_fun_tree$) (selectw$ B_a_fun_a_fun_tree$)))
