...
(declare-codatatypes () ((A_bool_fun_tree$ (node$ (select$ A_bool_fun$) (selecta$ A_bool_fun_tree$) (selectb$ A_bool_fun_tree$)))
  ...
  (A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$e (selectl$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun$) (selectm$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$) (selectn$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$f (selecto$ A_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun$) (selectp$ A_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$) (selectq$ A_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)))
  ...
  (A_a_fun_a_a_bool_fun_fun_fun_tree$ (node$i (selectx$ A_a_fun_a_a_bool_fun_fun_fun$) (selecty$ A_a_fun_a_a_bool_fun_fun_fun_tree$) (selectz$ A_a_fun_a_a_bool_fun_fun_fun_tree$)))
  (A_a_bool_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$j (selecua$ A_a_bool_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun$) (selecub$ A_a_bool_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$) (selecuc$ A_a_bool_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$)))
  (A_a_fun_tree$ (node$k (selecud$ A_a_fun$) (selecue$ A_a_fun_tree$) (selecuf$ A_a_fun_tree$)))
  ...
  (Bool_bool_fun_tree$ (node$m (selecuj$ Bool_bool_fun$) (selecuk$ Bool_bool_fun_tree$) (selecul$ Bool_bool_fun_tree$)))
  (A_a_bool_fun_fun_bool_fun_tree$ (node$n (selecum$ A_a_bool_fun_fun_bool_fun$) (selecun$ A_a_bool_fun_fun_bool_fun_tree$) (selecuo$ A_a_bool_fun_fun_bool_fun_tree$)))
  (Bool_a_a_bool_fun_fun_fun_tree$ (node$o (selecup$ Bool_a_a_bool_fun_fun_fun$) (selecuq$ Bool_a_a_bool_fun_fun_fun_tree$) (selecur$ Bool_a_a_bool_fun_fun_fun_tree$)))
  (Bool_a_a_a_fun_fun_fun_tree$ (node$p (selecus$ Bool_a_a_a_fun_fun_fun$) (selecut$ Bool_a_a_a_fun_fun_fun_tree$) (selecuu$ Bool_a_a_a_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_bool_fun_tree$ (node$q (selecuv$ A_a_a_fun_fun_bool_fun$) (selecuw$ A_a_a_fun_fun_bool_fun_tree$) (selecux$ A_a_a_fun_fun_bool_fun_tree$)))
  ...
  (A_tree_tree_tree_tree$ (node$t (root$c A_tree_tree_tree$) (left$c A_tree_tree_tree_tree$) (right$c A_tree_tree_tree_tree$)))
  (A_tree_tree_tree_a_tree_tree_tree_fun_tree$ (node$u (selecuy$ A_tree_tree_tree_a_tree_tree_tree_fun$) (selecuz$ A_tree_tree_tree_a_tree_tree_tree_fun_tree$) (selecva$ A_tree_tree_tree_a_tree_tree_tree_fun_tree$)))
  (A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$ (node$v (selecvb$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun$) (selecvc$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$) (selecvd$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$)))
  (A_tree_tree_a_tree_tree_fun_tree$ (node$w (selecve$ A_tree_tree_a_tree_tree_fun$) (selecvf$ A_tree_tree_a_tree_tree_fun_tree$) (selecvg$ A_tree_tree_a_tree_tree_fun_tree$)))
  (A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ (node$x (selecvh$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun$) (selecvi$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$) (selecvj$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$)))
  (A_tree_a_tree_fun_tree$ (node$y (selecvk$ A_tree_a_tree_fun$) (selecvl$ A_tree_a_tree_fun_tree$) (selecvm$ A_tree_a_tree_fun_tree$)))
  (A_tree_a_tree_a_tree_fun_fun_tree$ (node$z (selecvn$ A_tree_a_tree_a_tree_fun_fun$) (selecvo$ A_tree_a_tree_a_tree_fun_fun_tree$) (selecvp$ A_tree_a_tree_a_tree_fun_fun_tree$)))
  (A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ (node$aa (selecvq$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun$) (selecvr$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$) (selecvs$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$)))
