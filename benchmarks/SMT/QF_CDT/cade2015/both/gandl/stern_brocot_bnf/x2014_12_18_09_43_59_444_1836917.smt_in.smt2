...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (A_b_fun_tree$ (node$d (selectf$ A_b_fun$) (selectg$ A_b_fun_tree$) (selecth$ A_b_fun_tree$)))
  ...
  (B_a_fun_b_fun_tree$ (node$g (selecto$ B_a_fun_b_fun$) (selectp$ B_a_fun_b_fun_tree$) (selectq$ B_a_fun_b_fun_tree$)))
  (B_a_fun_a_fun_tree$ (node$h (selectr$ B_a_fun_a_fun$) (selects$ B_a_fun_a_fun_tree$) (selectt$ B_a_fun_a_fun_tree$)))
  (B_b_a_fun_fun_tree$ (node$i (selectu$ B_b_a_fun_fun$) (selectv$ B_b_a_fun_fun_tree$) (selectw$ B_b_a_fun_fun_tree$)))
  (B_a_fun_b_a_fun_fun_tree$ (node$j (selectx$ B_a_fun_b_a_fun_fun$) (selecty$ B_a_fun_b_a_fun_fun_tree$) (selectz$ B_a_fun_b_a_fun_fun_tree$)))
