...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (B_c_fun_b_a_fun_fun_stream$ (sCons$c (selectb$ B_c_fun_b_a_fun_fun$) (selectc$ B_c_fun_b_a_fun_fun_stream$)))
  (B_c_fun_stream$ (sCons$d (selectd$ B_c_fun$) (selecte$ B_c_fun_stream$)))
  (C_a_fun_b_c_fun_b_a_fun_fun_fun_stream$ (sCons$e (selectf$ C_a_fun_b_c_fun_b_a_fun_fun_fun$) (selectg$ C_a_fun_b_c_fun_b_a_fun_fun_fun_stream$)))
  (C_a_fun_stream$ (sCons$f (selecth$ C_a_fun$) (selecti$ C_a_fun_stream$)))
  (C_stream$ (sCons$g (shd$b C$) (stl$b C_stream$)))
  ...
  (A_a_fun_stream$ (sCons$j (selectn$ A_a_fun$) (selecto$ A_a_fun_stream$)))
  (A_a_fun_a_a_fun_fun_stream$ (sCons$k (selectp$ A_a_fun_a_a_fun_fun$) (selectq$ A_a_fun_a_a_fun_fun_stream$)))
  (C_c_fun_stream$ (sCons$l (selectr$ C_c_fun$) (selects$ C_c_fun_stream$)))
  (B_b_fun_stream$ (sCons$m (selectt$ B_b_fun$) (selectu$ B_b_fun_stream$)))
  (C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_stream$ (sCons$n (selectv$ C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun$) (selectw$ C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_stream$)))
  ...
  (B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun_stream$ (sCons$p (selectz$ B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun$) (selecua$ B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun_stream$)))))
