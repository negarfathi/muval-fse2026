...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (A_tree_a_fun_stream$ (sCons$b (selectb$ A_tree_a_fun$) (selectc$ A_tree_a_fun_stream$)))
  (A_tree_stream$ (sCons$c (shd$a A_tree$) (stl$a A_tree_stream$)))
  (A_a_tree_fun_stream$ (sCons$d (selectd$ A_a_tree_fun$) (selecte$ A_a_tree_fun_stream$)))
  (A_tree_a_tree_fun_stream$ (sCons$e (selectf$ A_tree_a_tree_fun$) (selectg$ A_tree_a_tree_fun_stream$)))
  (A_a_a_fun_fun_stream$ (sCons$f (selecth$ A_a_a_fun_fun$) (selecti$ A_a_a_fun_fun_stream$)))
  (A_a_fun_a_fun_stream$ (sCons$g (selectj$ A_a_fun_a_fun$) (selectk$ A_a_fun_a_fun_stream$)))
  (A_tree_a_a_fun_fun_stream$ (sCons$h (selectl$ A_tree_a_a_fun_fun$) (selectm$ A_tree_a_a_fun_fun_stream$)))
  (A_a_fun_a_tree_fun_stream$ (sCons$i (selectn$ A_a_fun_a_tree_fun$) (selecto$ A_a_fun_a_tree_fun_stream$)))
  (A_a_fun_a_a_fun_fun_stream$ (sCons$j (selectp$ A_a_fun_a_a_fun_fun$) (selectq$ A_a_fun_a_a_fun_fun_stream$)))
  ...
  (A_a_fun_a_tree_fun_tree$ (node$a (selectt$ A_a_fun_a_tree_fun$) (selectu$ A_a_fun_a_tree_fun_tree$) (selectv$ A_a_fun_a_tree_fun_tree$)))
  (A_a_fun_a_a_fun_fun_tree$ (node$b (selectw$ A_a_fun_a_a_fun_fun$) (selectx$ A_a_fun_a_a_fun_fun_tree$) (selecty$ A_a_fun_a_a_fun_fun_tree$)))
  (A_a_fun_a_fun_tree$ (node$c (selectz$ A_a_fun_a_fun$) (selecua$ A_a_fun_a_fun_tree$) (selecub$ A_a_fun_a_fun_tree$)))
  (A_a_tree_fun_tree$ (node$d (selecuc$ A_a_tree_fun$) (selecud$ A_a_tree_fun_tree$) (selecue$ A_a_tree_fun_tree$)))
  (A_a_a_fun_fun_tree$ (node$e (selecuf$ A_a_a_fun_fun$) (selecug$ A_a_a_fun_fun_tree$) (selecuh$ A_a_a_fun_fun_tree$)))
  (A_a_fun_tree$ (node$f (selecui$ A_a_fun$) (selecuj$ A_a_fun_tree$) (selecuk$ A_a_fun_tree$)))
  (A_tree_tree$ (node$g (root$a A_tree$) (left$a A_tree_tree$) (right$a A_tree_tree$)))))
(declare-fun x$ () A$)
(declare-fun y$ () A$)
