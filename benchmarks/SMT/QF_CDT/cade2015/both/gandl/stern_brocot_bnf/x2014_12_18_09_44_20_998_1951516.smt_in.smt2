...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (C_b_a_fun_fun_tree$ (node$c (selectc$ C_b_a_fun_fun$) (selectd$ C_b_a_fun_fun_tree$) (selecte$ C_b_a_fun_fun_tree$)))
  (C_tree$ (node$d (root$b C$) (left$b C_tree$) (right$b C_tree$)))
  (B_c_a_fun_fun_c_b_a_fun_fun_fun_tree$ (node$e (selectf$ B_c_a_fun_fun_c_b_a_fun_fun_fun$) (selectg$ B_c_a_fun_fun_c_b_a_fun_fun_fun_tree$) (selecth$ B_c_a_fun_fun_c_b_a_fun_fun_fun_tree$)))
  (B_c_a_fun_fun_tree$ (node$f (selecti$ B_c_a_fun_fun$) (selectj$ B_c_a_fun_fun_tree$) (selectk$ B_c_a_fun_fun_tree$)))
  (C_a_fun_tree$ (node$g (selectl$ C_a_fun$) (selectm$ C_a_fun_tree$) (selectn$ C_a_fun_tree$)))
  (B_c_fun_tree$ (node$h (selecto$ B_c_fun$) (selectp$ B_c_fun_tree$) (selectq$ B_c_fun_tree$)))
  (B_b_fun_tree$ (node$i (selectr$ B_b_fun$) (selects$ B_b_fun_tree$) (selectt$ B_b_fun_tree$)))
  (A_c_a_fun_fun_tree$ (node$j (selectu$ A_c_a_fun_fun$) (selectv$ A_c_a_fun_fun_tree$) (selectw$ A_c_a_fun_fun_tree$)))
  (A_b_a_fun_fun_tree$ (node$k (selectx$ A_b_a_fun_fun$) (selecty$ A_b_a_fun_fun_tree$) (selectz$ A_b_a_fun_fun_tree$)))
  (A_a_fun_tree$ (node$l (selecua$ A_a_fun$) (selecub$ A_a_fun_tree$) (selecuc$ A_a_fun_tree$)))
  (B_a_a_fun_fun_tree$ (node$m (selecud$ B_a_a_fun_fun$) (selecue$ B_a_a_fun_fun_tree$) (selecuf$ B_a_a_fun_fun_tree$)))
  (B_a_fun_b_a_fun_fun_tree$ (node$n (selecug$ B_a_fun_b_a_fun_fun$) (selecuh$ B_a_fun_b_a_fun_fun_tree$) (selecui$ B_a_fun_b_a_fun_fun_tree$)))
  (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$o (selecuj$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun$) (selecuk$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$) (selecul$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)))
  (B_b_a_fun_fun_tree$ (node$p (selecum$ B_b_a_fun_fun$) (selecun$ B_b_a_fun_fun_tree$) (selecuo$ B_b_a_fun_fun_tree$)))
  (B_b_fun_b_a_fun_fun_tree$ (node$q (selecup$ B_b_fun_b_a_fun_fun$) (selecuq$ B_b_fun_b_a_fun_fun_tree$) (selecur$ B_b_fun_b_a_fun_fun_tree$)))
  (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ (node$r (selecus$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun$) (selecut$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$) (selecuu$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)))
  (B_c_fun_b_a_fun_fun_tree$ (node$s (selecuv$ B_c_fun_b_a_fun_fun$) (selecuw$ B_c_fun_b_a_fun_fun_tree$) (selecux$ B_c_fun_b_a_fun_fun_tree$)))
  (B_c_a_fun_fun_b_c_fun_b_a_fun_fun_fun_tree$ (node$t (selecuy$ B_c_a_fun_fun_b_c_fun_b_a_fun_fun_fun$) (selecuz$ B_c_a_fun_fun_b_c_fun_b_a_fun_fun_fun_tree$) (selecva$ B_c_a_fun_fun_b_c_fun_b_a_fun_fun_fun_tree$)))
  (C_a_a_fun_fun_tree$ (node$u (selecvb$ C_a_a_fun_fun$) (selecvc$ C_a_a_fun_fun_tree$) (selecvd$ C_a_a_fun_fun_tree$)))
  (C_a_fun_c_a_fun_fun_tree$ (node$v (selecve$ C_a_fun_c_a_fun_fun$) (selecvf$ C_a_fun_c_a_fun_fun_tree$) (selecvg$ C_a_fun_c_a_fun_fun_tree$)))
  (C_a_a_fun_fun_c_a_fun_c_a_fun_fun_fun_tree$ (node$w (selecvh$ C_a_a_fun_fun_c_a_fun_c_a_fun_fun_fun$) (selecvi$ C_a_a_fun_fun_c_a_fun_c_a_fun_fun_fun_tree$) (selecvj$ C_a_a_fun_fun_c_a_fun_c_a_fun_fun_fun_tree$)))
  (C_b_fun_tree$ (node$x (selecvk$ C_b_fun$) (selecvl$ C_b_fun_tree$) (selecvm$ C_b_fun_tree$)))
  (C_b_fun_c_a_fun_fun_tree$ (node$y (selecvn$ C_b_fun_c_a_fun_fun$) (selecvo$ C_b_fun_c_a_fun_fun_tree$) (selecvp$ C_b_fun_c_a_fun_fun_tree$)))
  (C_b_a_fun_fun_c_b_fun_c_a_fun_fun_fun_tree$ (node$z (selecvq$ C_b_a_fun_fun_c_b_fun_c_a_fun_fun_fun$) (selecvr$ C_b_a_fun_fun_c_b_fun_c_a_fun_fun_fun_tree$) (selecvs$ C_b_a_fun_fun_c_b_fun_c_a_fun_fun_fun_tree$)))
  (C_c_a_fun_fun_tree$ (node$aa (selecvt$ C_c_a_fun_fun$) (selecvu$ C_c_a_fun_fun_tree$) (selecvv$ C_c_a_fun_fun_tree$)))
  (C_c_fun_tree$ (node$ab (selecvw$ C_c_fun$) (selecvx$ C_c_fun_tree$) (selecvy$ C_c_fun_tree$)))
  (C_c_fun_c_a_fun_fun_tree$ (node$ac (selecvz$ C_c_fun_c_a_fun_fun$) (selecwa$ C_c_fun_c_a_fun_fun_tree$) (selecwb$ C_c_fun_c_a_fun_fun_tree$)))
  (C_c_a_fun_fun_c_c_fun_c_a_fun_fun_fun_tree$ (node$ad (selecwc$ C_c_a_fun_fun_c_c_fun_c_a_fun_fun_fun$) (selecwd$ C_c_a_fun_fun_c_c_fun_c_a_fun_fun_fun_tree$) (selecwe$ C_c_a_fun_fun_c_c_fun_c_a_fun_fun_fun_tree$)))
  (B_c_a_fun_a_fun_fun_tree$ (node$ae (selecwf$ B_c_a_fun_a_fun_fun$) (selecwg$ B_c_a_fun_a_fun_fun_tree$) (selecwh$ B_c_a_fun_a_fun_fun_tree$)))
  (B_c_a_fun_fun_b_a_fun_fun_tree$ (node$af (selecwi$ B_c_a_fun_fun_b_a_fun_fun$) (selecwj$ B_c_a_fun_fun_b_a_fun_fun_tree$) (selecwk$ B_c_a_fun_fun_b_a_fun_fun_tree$)))
  (B_c_a_fun_a_fun_fun_b_c_a_fun_fun_b_a_fun_fun_fun_tree$ (node$ag (selecwl$ B_c_a_fun_a_fun_fun_b_c_a_fun_fun_b_a_fun_fun_fun$) (selecwm$ B_c_a_fun_a_fun_fun_b_c_a_fun_fun_b_a_fun_fun_fun_tree$) (selecwn$ B_c_a_fun_a_fun_fun_b_c_a_fun_fun_b_a_fun_fun_fun_tree$)))
  (C_a_fun_a_fun_tree$ (node$ah (selecwo$ C_a_fun_a_fun$) (selecwp$ C_a_fun_a_fun_tree$) (selecwq$ C_a_fun_a_fun_tree$)))
  (C_a_b_a_fun_fun_fun_tree$ (node$ai (selecwr$ C_a_b_a_fun_fun_fun$) (selecws$ C_a_b_a_fun_fun_fun_tree$) (selecwt$ C_a_b_a_fun_fun_fun_tree$)))
  (C_a_fun_c_b_a_fun_fun_fun_tree$ (node$aj (selecwu$ C_a_fun_c_b_a_fun_fun_fun$) (selecwv$ C_a_fun_c_b_a_fun_fun_fun_tree$) (selecww$ C_a_fun_c_b_a_fun_fun_fun_tree$)))
  (C_a_b_a_fun_fun_fun_c_a_fun_c_b_a_fun_fun_fun_fun_tree$ (node$ak (selecwx$ C_a_b_a_fun_fun_fun_c_a_fun_c_b_a_fun_fun_fun_fun$) (selecwy$ C_a_b_a_fun_fun_fun_c_a_fun_c_b_a_fun_fun_fun_fun_tree$) (selecwz$ C_a_b_a_fun_fun_fun_c_a_fun_c_b_a_fun_fun_fun_fun_tree$)))
  (C_c_b_a_fun_fun_fun_tree$ (node$al (selecxa$ C_c_b_a_fun_fun_fun$) (selecxb$ C_c_b_a_fun_fun_fun_tree$) (selecxc$ C_c_b_a_fun_fun_fun_tree$)))
  (C_c_fun_c_b_a_fun_fun_fun_tree$ (node$am (selecxd$ C_c_fun_c_b_a_fun_fun_fun$) (selecxe$ C_c_fun_c_b_a_fun_fun_fun_tree$) (selecxf$ C_c_fun_c_b_a_fun_fun_fun_tree$)))
  (C_c_b_a_fun_fun_fun_c_c_fun_c_b_a_fun_fun_fun_fun_tree$ (node$an (selecxg$ C_c_b_a_fun_fun_fun_c_c_fun_c_b_a_fun_fun_fun_fun$) (selecxh$ C_c_b_a_fun_fun_fun_c_c_fun_c_b_a_fun_fun_fun_fun_tree$) (selecxi$ C_c_b_a_fun_fun_fun_c_c_fun_c_b_a_fun_fun_fun_fun_tree$)))
  (C_b_a_fun_a_fun_fun_tree$ (node$ao (selecxj$ C_b_a_fun_a_fun_fun$) (selecxk$ C_b_a_fun_a_fun_fun_tree$) (selecxl$ C_b_a_fun_a_fun_fun_tree$)))
  (C_b_a_fun_fun_c_a_fun_fun_tree$ (node$ap (selecxm$ C_b_a_fun_fun_c_a_fun_fun$) (selecxn$ C_b_a_fun_fun_c_a_fun_fun_tree$) (selecxo$ C_b_a_fun_fun_c_a_fun_fun_tree$)))
  (C_b_a_fun_a_fun_fun_c_b_a_fun_fun_c_a_fun_fun_fun_tree$ (node$aq (selecxp$ C_b_a_fun_a_fun_fun_c_b_a_fun_fun_c_a_fun_fun_fun$) (selecxq$ C_b_a_fun_a_fun_fun_c_b_a_fun_fun_c_a_fun_fun_fun_tree$) (selecxr$ C_b_a_fun_a_fun_fun_c_b_a_fun_fun_c_a_fun_fun_fun_tree$)))
  (B_a_fun_a_fun_tree$ (node$ar (selecxs$ B_a_fun_a_fun$) (selecxt$ B_a_fun_a_fun_tree$) (selecxu$ B_a_fun_a_fun_tree$)))
  (C_b_c_fun_fun_tree$ (node$as (selecxv$ C_b_c_fun_fun$) (selecxw$ C_b_c_fun_fun_tree$) (selecxx$ C_b_c_fun_fun_tree$)))
  (B_b_b_fun_fun_tree$ (node$at (selecxy$ B_b_b_fun_fun$) (selecxz$ B_b_b_fun_fun_tree$) (selecya$ B_b_b_fun_fun_tree$)))
  (C_a_fun_a_c_a_fun_fun_fun_tree$ (node$au (selecyb$ C_a_fun_a_c_a_fun_fun_fun$) (selecyc$ C_a_fun_a_c_a_fun_fun_fun_tree$) (selecyd$ C_a_fun_a_c_a_fun_fun_fun_tree$)))
  (B_a_fun_a_b_a_fun_fun_fun_tree$ (node$av (selecye$ B_a_fun_a_b_a_fun_fun_fun$) (selecyf$ B_a_fun_a_b_a_fun_fun_fun_tree$) (selecyg$ B_a_fun_a_b_a_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_tree$ (node$aw (selecyh$ A_a_a_fun_fun$) (selecyi$ A_a_a_fun_fun_tree$) (selecyj$ A_a_a_fun_fun_tree$)))
  (B_a_fun_c_b_a_fun_fun_fun_tree$ (node$ax (selecyk$ B_a_fun_c_b_a_fun_fun_fun$) (selecyl$ B_a_fun_c_b_a_fun_fun_fun_tree$) (selecym$ B_a_fun_c_b_a_fun_fun_fun_tree$)))
  (C_b_a_fun_fun_b_c_a_fun_fun_c_b_a_fun_fun_fun_fun_tree$ (node$ay (selecyn$ C_b_a_fun_fun_b_c_a_fun_fun_c_b_a_fun_fun_fun_fun$) (selecyo$ C_b_a_fun_fun_b_c_a_fun_fun_c_b_a_fun_fun_fun_fun_tree$) (selecyp$ C_b_a_fun_fun_b_c_a_fun_fun_c_b_a_fun_fun_fun_fun_tree$)))
  ...
  (A_a_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$ba (selecyt$ A_a_fun_b_a_fun_b_a_fun_fun_fun$) (selecyu$ A_a_fun_b_a_fun_b_a_fun_fun_fun_tree$) (selecyv$ A_a_fun_b_a_fun_b_a_fun_fun_fun_tree$)))
  (B_a_fun_b_b_fun_b_a_fun_fun_fun_tree$ (node$bb (selecyw$ B_a_fun_b_b_fun_b_a_fun_fun_fun$) (selecyx$ B_a_fun_b_b_fun_b_a_fun_fun_fun_tree$) (selecyy$ B_a_fun_b_b_fun_b_a_fun_fun_fun_tree$)))
  (C_a_fun_b_c_fun_b_a_fun_fun_fun_tree$ (node$bc (selecyz$ C_a_fun_b_c_fun_b_a_fun_fun_fun$) (selecza$ C_a_fun_b_c_fun_b_a_fun_fun_fun_tree$) (seleczb$ C_a_fun_b_c_fun_b_a_fun_fun_fun_tree$)))
  (A_a_fun_c_a_fun_c_a_fun_fun_fun_tree$ (node$bd (seleczc$ A_a_fun_c_a_fun_c_a_fun_fun_fun$) (seleczd$ A_a_fun_c_a_fun_c_a_fun_fun_fun_tree$) (selecze$ A_a_fun_c_a_fun_c_a_fun_fun_fun_tree$)))
  (B_a_fun_c_b_fun_c_a_fun_fun_fun_tree$ (node$be (seleczf$ B_a_fun_c_b_fun_c_a_fun_fun_fun$) (seleczg$ B_a_fun_c_b_fun_c_a_fun_fun_fun_tree$) (seleczh$ B_a_fun_c_b_fun_c_a_fun_fun_fun_tree$)))
  (C_a_fun_c_c_fun_c_a_fun_fun_fun_tree$ (node$bf (seleczi$ C_a_fun_c_c_fun_c_a_fun_fun_fun$) (seleczj$ C_a_fun_c_c_fun_c_a_fun_fun_fun_tree$) (seleczk$ C_a_fun_c_c_fun_c_a_fun_fun_fun_tree$)))
  (C_a_fun_a_fun_b_c_a_fun_fun_b_a_fun_fun_fun_tree$ (node$bg (seleczl$ C_a_fun_a_fun_b_c_a_fun_fun_b_a_fun_fun_fun$) (seleczm$ C_a_fun_a_fun_b_c_a_fun_fun_b_a_fun_fun_fun_tree$) (seleczn$ C_a_fun_a_fun_b_c_a_fun_fun_b_a_fun_fun_fun_tree$)))
  (A_b_a_fun_fun_c_a_fun_c_b_a_fun_fun_fun_fun_tree$ (node$bh (seleczo$ A_b_a_fun_fun_c_a_fun_c_b_a_fun_fun_fun_fun$) (seleczp$ A_b_a_fun_fun_c_a_fun_c_b_a_fun_fun_fun_fun_tree$) (seleczq$ A_b_a_fun_fun_c_a_fun_c_b_a_fun_fun_fun_fun_tree$)))
  (C_b_a_fun_fun_c_c_fun_c_b_a_fun_fun_fun_fun_tree$ (node$bi (seleczr$ C_b_a_fun_fun_c_c_fun_c_b_a_fun_fun_fun_fun$) (seleczs$ C_b_a_fun_fun_c_c_fun_c_b_a_fun_fun_fun_fun_tree$) (seleczt$ C_b_a_fun_fun_c_c_fun_c_b_a_fun_fun_fun_fun_tree$)))
  (B_a_fun_a_fun_c_b_a_fun_fun_c_a_fun_fun_fun_tree$ (node$bj (seleczu$ B_a_fun_a_fun_c_b_a_fun_fun_c_a_fun_fun_fun$) (seleczv$ B_a_fun_a_fun_c_b_a_fun_fun_c_a_fun_fun_fun_tree$) (seleczw$ B_a_fun_a_fun_c_b_a_fun_fun_c_a_fun_fun_fun_tree$)))
  (C_a_fun_b_c_a_fun_fun_fun_c_a_fun_c_a_fun_fun_fun_tree$ (node$bk (seleczx$ C_a_fun_b_c_a_fun_fun_fun_c_a_fun_c_a_fun_fun_fun$) (seleczy$ C_a_fun_b_c_a_fun_fun_fun_c_a_fun_c_a_fun_fun_fun_tree$) (seleczz$ C_a_fun_b_c_a_fun_fun_fun_c_a_fun_c_a_fun_fun_fun_tree$)))
  ...
  (C_a_fun_b_c_a_fun_fun_c_a_fun_fun_fun_tree$ (node$bm (seledad$ C_a_fun_b_c_a_fun_fun_c_a_fun_fun_fun$) (seledae$ C_a_fun_b_c_a_fun_fun_c_a_fun_fun_fun_tree$) (seledaf$ C_a_fun_b_c_a_fun_fun_c_a_fun_fun_fun_tree$)))
  (A_c_a_fun_fun_a_a_fun_fun_tree$ (node$bn (seledag$ A_c_a_fun_fun_a_a_fun_fun$) (seledah$ A_c_a_fun_fun_a_a_fun_fun_tree$) (seledai$ A_c_a_fun_fun_a_a_fun_fun_tree$)))
  (A_c_a_fun_a_fun_fun_a_c_a_fun_fun_a_a_fun_fun_fun_tree$ (node$bo (seledaj$ A_c_a_fun_a_fun_fun_a_c_a_fun_fun_a_a_fun_fun_fun$) (seledak$ A_c_a_fun_a_fun_fun_a_c_a_fun_fun_a_a_fun_fun_fun_tree$) (seledal$ A_c_a_fun_a_fun_fun_a_c_a_fun_fun_a_a_fun_fun_fun_tree$)))
  (A_c_a_fun_a_fun_fun_tree$ (node$bp (seledam$ A_c_a_fun_a_fun_fun$) (seledan$ A_c_a_fun_a_fun_fun_tree$) (seledao$ A_c_a_fun_a_fun_fun_tree$)))
  (C_b_a_fun_fun_c_b_a_fun_fun_fun_tree$ (node$bq (seledap$ C_b_a_fun_fun_c_b_a_fun_fun_fun$) (seledaq$ C_b_a_fun_fun_c_b_a_fun_fun_fun_tree$) (seledar$ C_b_a_fun_fun_c_b_a_fun_fun_fun_tree$)))
  ...
  (C_b_a_fun_fun_b_c_a_fun_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_fun_tree$ (node$bt (seleday$ C_b_a_fun_fun_b_c_a_fun_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_fun$) (seledaz$ C_b_a_fun_fun_b_c_a_fun_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_fun_tree$) (seledba$ C_b_a_fun_fun_b_c_a_fun_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_fun_tree$)))
  (B_a_fun_c_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$bu (seledbb$ B_a_fun_c_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun$) (seledbc$ B_a_fun_c_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$) (seledbd$ B_a_fun_c_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)))
  ...
  (B_a_fun_c_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$bw (seledbh$ B_a_fun_c_b_a_fun_fun_b_a_fun_fun_fun$) (seledbi$ B_a_fun_c_b_a_fun_fun_b_a_fun_fun_fun_tree$) (seledbj$ B_a_fun_c_b_a_fun_fun_b_a_fun_fun_fun_tree$)))
  (A_b_a_fun_fun_a_a_fun_fun_tree$ (node$bx (seledbk$ A_b_a_fun_fun_a_a_fun_fun$) (seledbl$ A_b_a_fun_fun_a_a_fun_fun_tree$) (seledbm$ A_b_a_fun_fun_a_a_fun_fun_tree$)))
  (A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun_tree$ (node$by (seledbn$ A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun$) (seledbo$ A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun_tree$) (seledbp$ A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun_tree$)))
  (A_b_a_fun_a_fun_fun_tree$ (node$bz (seledbq$ A_b_a_fun_a_fun_fun$) (seledbr$ A_b_a_fun_a_fun_fun_tree$) (seledbs$ A_b_a_fun_a_fun_fun_tree$)))
  (A_c_fun_tree$ (node$ca (seledbt$ A_c_fun$) (seledbu$ A_c_fun_tree$) (seledbv$ A_c_fun_tree$)))))
