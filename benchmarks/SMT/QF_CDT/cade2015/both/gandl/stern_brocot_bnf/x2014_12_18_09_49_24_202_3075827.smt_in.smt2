...
(declare-codatatypes () ((Nat_tree$ (node$ (root$ Nat$) (left$ Nat_tree$) (right$ Nat_tree$)))
  (Int_tree$ (node$a (root$a Int) (left$a Int_tree$) (right$a Int_tree$)))
  (Int_int_fun_tree$ (node$b (select$ Int_int_fun$) (selecta$ Int_int_fun_tree$) (selectb$ Int_int_fun_tree$)))
  (Nat_int_fun_tree$ (node$c (selectc$ Nat_int_fun$) (selectd$ Nat_int_fun_tree$) (selecte$ Nat_int_fun_tree$)))
  (Int_nat_fun_tree$ (node$d (selectf$ Int_nat_fun$) (selectg$ Int_nat_fun_tree$) (selecth$ Int_nat_fun_tree$)))
  (Nat_nat_fun_tree$ (node$e (selecti$ Nat_nat_fun$) (selectj$ Nat_nat_fun_tree$) (selectk$ Nat_nat_fun_tree$)))))
(declare-datatypes () ((Dir$ (l$) (r$))
  (Dir_list$ (nil$) (cons$ (hd$ Dir$) (tl$ Dir_list$)))))
(declare-codatatypes () ((Int_int_fun_int_fun_tree$ (node$f (selectl$ Int_int_fun_int_fun$) (selectm$ Int_int_fun_int_fun_tree$) (selectn$ Int_int_fun_int_fun_tree$)))
  (Int_int_fun_nat_nat_fun_fun_tree$ (node$g (selecto$ Int_int_fun_nat_nat_fun_fun$) (selectp$ Int_int_fun_nat_nat_fun_fun_tree$) (selectq$ Int_int_fun_nat_nat_fun_fun_tree$)))
  (Int_int_fun_nat_int_fun_fun_tree$ (node$h (selectr$ Int_int_fun_nat_int_fun_fun$) (selects$ Int_int_fun_nat_int_fun_fun_tree$) (selectt$ Int_int_fun_nat_int_fun_fun_tree$)))
  (Int_int_fun_int_nat_fun_fun_tree$ (node$i (selectu$ Int_int_fun_int_nat_fun_fun$) (selectv$ Int_int_fun_int_nat_fun_fun_tree$) (selectw$ Int_int_fun_int_nat_fun_fun_tree$)))
  (Int_int_fun_nat_fun_tree$ (node$j (selectx$ Int_int_fun_nat_fun$) (selecty$ Int_int_fun_nat_fun_tree$) (selectz$ Int_int_fun_nat_fun_tree$)))
  (Nat_int_fun_nat_fun_tree$ (node$k (selecua$ Nat_int_fun_nat_fun$) (selecub$ Nat_int_fun_nat_fun_tree$) (selecuc$ Nat_int_fun_nat_fun_tree$)))
  (Int_nat_fun_nat_fun_tree$ (node$l (selecud$ Int_nat_fun_nat_fun$) (selecue$ Int_nat_fun_nat_fun_tree$) (selecuf$ Int_nat_fun_nat_fun_tree$)))
  (Nat_nat_fun_nat_fun_tree$ (node$m (selecug$ Nat_nat_fun_nat_fun$) (selecuh$ Nat_nat_fun_nat_fun_tree$) (selecui$ Nat_nat_fun_nat_fun_tree$)))
  (Nat_int_fun_int_fun_tree$ (node$n (selecuj$ Nat_int_fun_int_fun$) (selecuk$ Nat_int_fun_int_fun_tree$) (selecul$ Nat_int_fun_int_fun_tree$)))
  (Int_nat_nat_fun_fun_tree$ (node$o (selecum$ Int_nat_nat_fun_fun$) (selecun$ Int_nat_nat_fun_fun_tree$) (selecuo$ Int_nat_nat_fun_fun_tree$)))
  (Int_int_nat_fun_fun_tree$ (node$p (selecup$ Int_int_nat_fun_fun$) (selecuq$ Int_int_nat_fun_fun_tree$) (selecur$ Int_int_nat_fun_fun_tree$)))
  (Int_nat_int_fun_fun_tree$ (node$q (selecus$ Int_nat_int_fun_fun$) (selecut$ Int_nat_int_fun_fun_tree$) (selecuu$ Int_nat_int_fun_fun_tree$)))
  (Int_int_int_fun_fun_tree$ (node$r (selecuv$ Int_int_int_fun_fun$) (selecuw$ Int_int_int_fun_fun_tree$) (selecux$ Int_int_int_fun_fun_tree$)))
  (Nat_nat_nat_fun_fun_tree$ (node$s (selecuy$ Nat_nat_nat_fun_fun$) (selecuz$ Nat_nat_nat_fun_fun_tree$) (selecva$ Nat_nat_nat_fun_fun_tree$)))
  (Nat_int_nat_fun_fun_tree$ (node$t (selecvb$ Nat_int_nat_fun_fun$) (selecvc$ Nat_int_nat_fun_fun_tree$) (selecvd$ Nat_int_nat_fun_fun_tree$)))))
