...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (B_a_fun_stream$ (sCons$b (select$ B_a_fun$) (selecta$ B_a_fun_stream$)))
  (A_b_a_fun_stream_fun_stream$ (sCons$c (selectb$ A_b_a_fun_stream_fun$) (selectc$ A_b_a_fun_stream_fun_stream$)))
  (A_b_a_fun_b_a_fun_fun_fun_stream$ (sCons$d (selectd$ A_b_a_fun_b_a_fun_fun_fun$) (selecte$ A_b_a_fun_b_a_fun_fun_fun_stream$)))
  (A_b_a_fun_fun_stream$ (sCons$e (selectf$ A_b_a_fun_fun$) (selectg$ A_b_a_fun_fun_stream$)))
  (A_b_fun_stream$ (sCons$f (selecth$ A_b_fun$) (selecti$ A_b_fun_stream$)))
  (A_a_fun_stream$ (sCons$g (selectj$ A_a_fun$) (selectk$ A_a_fun_stream$)))
  (B_a_fun_stream_stream$ (sCons$h (shd$b B_a_fun_stream$) (stl$b B_a_fun_stream_stream$)))
  (B_a_fun_b_a_fun_fun_stream$ (sCons$i (selectl$ B_a_fun_b_a_fun_fun$) (selectm$ B_a_fun_b_a_fun_fun_stream$)))
  (B_b_fun_stream$ (sCons$j (selectn$ B_b_fun$) (selecto$ B_b_fun_stream$)))
  (B_a_fun_b_fun_stream$ (sCons$k (selectp$ B_a_fun_b_fun$) (selectq$ B_a_fun_b_fun_stream$)))
  (B_a_fun_a_fun_stream$ (sCons$l (selectr$ B_a_fun_a_fun$) (selects$ B_a_fun_a_fun_stream$)))
  (B_b_a_fun_fun_stream$ (sCons$m (selectt$ B_b_a_fun_fun$) (selectu$ B_b_a_fun_fun_stream$)))
  (B_a_fun_stream_b_fun_stream$ (sCons$n (selectv$ B_a_fun_stream_b_fun$) (selectw$ B_a_fun_stream_b_fun_stream$)))
  (A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun_stream$ (sCons$o (selectx$ A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun$) (selecty$ A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun_stream$)))
  (A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun_stream$ (sCons$p (selectz$ A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun$) (selecua$ A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun_stream$)))
  (A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$ (sCons$q (selecub$ A_b_a_fun_fun_a_b_a_fun_fun_fun$) (selecuc$ A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$)))
  (A_b_fun_a_b_fun_fun_stream$ (sCons$r (selecud$ A_b_fun_a_b_fun_fun$) (selecue$ A_b_fun_a_b_fun_fun_stream$)))
  (A_a_fun_a_a_fun_fun_stream$ (sCons$s (selecuf$ A_a_fun_a_a_fun_fun$) (selecug$ A_a_fun_a_a_fun_fun_stream$)))
  (B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_stream$ (sCons$t (selecuh$ B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun$) (selecui$ B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_stream$)))
  (B_a_fun_stream_b_a_fun_stream_fun_stream$ (sCons$u (selecuj$ B_a_fun_stream_b_a_fun_stream_fun$) (selecuk$ B_a_fun_stream_b_a_fun_stream_fun_stream$)))))
