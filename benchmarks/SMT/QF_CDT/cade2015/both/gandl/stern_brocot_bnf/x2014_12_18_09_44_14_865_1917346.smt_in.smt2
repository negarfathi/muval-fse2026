...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (A_b_a_fun_fun_tree$ (node$c (selectc$ A_b_a_fun_fun$) (selectd$ A_b_a_fun_fun_tree$) (selecte$ A_b_a_fun_fun_tree$)))
  (A_a_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$d (selectf$ A_a_fun_b_a_fun_b_a_fun_fun_fun$) (selectg$ A_a_fun_b_a_fun_b_a_fun_fun_fun_tree$) (selecth$ A_a_fun_b_a_fun_b_a_fun_fun_fun_tree$)))
  ...
  (A_a_fun_a_b_a_fun_fun_fun_tree$ (node$g (selecto$ A_a_fun_a_b_a_fun_fun_fun$) (selectp$ A_a_fun_a_b_a_fun_fun_fun_tree$) (selectq$ A_a_fun_a_b_a_fun_fun_fun_tree$)))
  (B_b_a_fun_fun_tree$ (node$h (selectr$ B_b_a_fun_fun$) (selects$ B_b_a_fun_fun_tree$) (selectt$ B_b_a_fun_fun_tree$)))
  (B_b_fun_tree$ (node$i (selectu$ B_b_fun$) (selectv$ B_b_fun_tree$) (selectw$ B_b_fun_tree$)))
  (A_b_fun_tree$ (node$j (selectx$ A_b_fun$) (selecty$ A_b_fun_tree$) (selectz$ A_b_fun_tree$)))
  (B_a_fun_b_fun_tree$ (node$k (selecua$ B_a_fun_b_fun$) (selecub$ B_a_fun_b_fun_tree$) (selecuc$ B_a_fun_b_fun_tree$)))
  (B_a_fun_a_fun_tree$ (node$l (selecud$ B_a_fun_a_fun$) (selecue$ B_a_fun_a_fun_tree$) (selecuf$ B_a_fun_a_fun_tree$)))
  (A_b_a_fun_fun_b_fun_tree$ (node$m (selecug$ A_b_a_fun_fun_b_fun$) (selecuh$ A_b_a_fun_fun_b_fun_tree$) (selecui$ A_b_a_fun_fun_b_fun_tree$)))
  (A_a_b_a_fun_fun_fun_tree$ (node$n (selecuj$ A_a_b_a_fun_fun_fun$) (selecuk$ A_a_b_a_fun_fun_fun_tree$) (selecul$ A_a_b_a_fun_fun_fun_tree$)))
  (A_b_a_fun_a_fun_fun_a_a_fun_fun_tree$ (node$o (selecum$ A_b_a_fun_a_fun_fun_a_a_fun_fun$) (selecun$ A_b_a_fun_a_fun_fun_a_a_fun_fun_tree$) (selecuo$ A_b_a_fun_a_fun_fun_a_a_fun_fun_tree$)))
  (A_b_a_fun_a_fun_fun_tree$ (node$p (selecup$ A_b_a_fun_a_fun_fun$) (selecuq$ A_b_a_fun_a_fun_fun_tree$) (selecur$ A_b_a_fun_a_fun_fun_tree$)))
  (A_b_a_fun_a_fun_a_fun_fun_a_b_a_fun_a_fun_fun_a_a_fun_fun_fun_tree$ (node$q (selecus$ A_b_a_fun_a_fun_a_fun_fun_a_b_a_fun_a_fun_fun_a_a_fun_fun_fun$) (selecut$ A_b_a_fun_a_fun_a_fun_fun_a_b_a_fun_a_fun_fun_a_a_fun_fun_fun_tree$) (selecuu$ A_b_a_fun_a_fun_a_fun_fun_a_b_a_fun_a_fun_fun_a_a_fun_fun_fun_tree$)))
  (A_b_a_fun_a_fun_a_fun_fun_tree$ (node$r (selecuv$ A_b_a_fun_a_fun_a_fun_fun$) (selecuw$ A_b_a_fun_a_fun_a_fun_fun_tree$) (selecux$ A_b_a_fun_a_fun_a_fun_fun_tree$)))
  (A_b_a_fun_fun_a_a_fun_fun_tree$ (node$s (selecuy$ A_b_a_fun_fun_a_a_fun_fun$) (selecuz$ A_b_a_fun_fun_a_a_fun_fun_tree$) (selecva$ A_b_a_fun_fun_a_a_fun_fun_tree$)))
  (A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun_tree$ (node$t (selecvb$ A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun$) (selecvc$ A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun_tree$) (selecvd$ A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun_tree$)))
  (B_b_fun_b_a_fun_fun_tree$ (node$u (selecve$ B_b_fun_b_a_fun_fun$) (selecvf$ B_b_fun_b_a_fun_fun_tree$) (selecvg$ B_b_fun_b_a_fun_fun_tree$)))
  (B_a_fun_b_b_fun_b_a_fun_fun_fun_tree$ (node$v (selecvh$ B_a_fun_b_b_fun_b_a_fun_fun_fun$) (selecvi$ B_a_fun_b_b_fun_b_a_fun_fun_fun_tree$) (selecvj$ B_a_fun_b_b_fun_b_a_fun_fun_fun_tree$)))
  (B_a_fun_b_b_a_fun_fun_fun_tree$ (node$w (selecvk$ B_a_fun_b_b_a_fun_fun_fun$) (selecvl$ B_a_fun_b_b_a_fun_fun_fun_tree$) (selecvm$ B_a_fun_b_b_a_fun_fun_fun_tree$)))
  (A_b_a_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ (node$x (selecvn$ A_b_a_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun$) (selecvo$ A_b_a_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$) (selecvp$ A_b_a_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$)))
  (A_b_a_fun_fun_a_a_fun_a_b_a_fun_fun_fun_fun_tree$ (node$y (selecvq$ A_b_a_fun_fun_a_a_fun_a_b_a_fun_fun_fun_fun$) (selecvr$ A_b_a_fun_fun_a_a_fun_a_b_a_fun_fun_fun_fun_tree$) (selecvs$ A_b_a_fun_fun_a_a_fun_a_b_a_fun_fun_fun_fun_tree$)))
  (A_b_a_fun_fun_a_b_a_fun_fun_fun_tree$ (node$z (selecvt$ A_b_a_fun_fun_a_b_a_fun_fun_fun$) (selecvu$ A_b_a_fun_fun_a_b_a_fun_fun_fun_tree$) (selecvv$ A_b_a_fun_fun_a_b_a_fun_fun_fun_tree$)))
  (B_a_fun_b_a_fun_fun_a_b_a_fun_fun_a_b_a_fun_fun_fun_fun_tree$ (node$aa (selecvw$ B_a_fun_b_a_fun_fun_a_b_a_fun_fun_a_b_a_fun_fun_fun_fun$) (selecvx$ B_a_fun_b_a_fun_fun_a_b_a_fun_fun_a_b_a_fun_fun_fun_fun_tree$) (selecvy$ B_a_fun_b_a_fun_fun_a_b_a_fun_fun_a_b_a_fun_fun_fun_fun_tree$)))
  (B_a_fun_b_b_fun_fun_tree$ (node$ab (selecvz$ B_a_fun_b_b_fun_fun$) (selecwa$ B_a_fun_b_b_fun_fun_tree$) (selecwb$ B_a_fun_b_b_fun_fun_tree$)))
  (A_b_fun_b_a_fun_b_b_fun_fun_fun_tree$ (node$ac (selecwc$ A_b_fun_b_a_fun_b_b_fun_fun_fun$) (selecwd$ A_b_fun_b_a_fun_b_b_fun_fun_fun_tree$) (selecwe$ A_b_fun_b_a_fun_b_b_fun_fun_fun_tree$)))
  (B_b_fun_b_b_fun_fun_tree$ (node$ad (selecwf$ B_b_fun_b_b_fun_fun$) (selecwg$ B_b_fun_b_b_fun_fun_tree$) (selecwh$ B_b_fun_b_b_fun_fun_tree$)))
  (B_b_fun_b_b_fun_b_b_fun_fun_fun_tree$ (node$ae (selecwi$ B_b_fun_b_b_fun_b_b_fun_fun_fun$) (selecwj$ B_b_fun_b_b_fun_b_b_fun_fun_fun_tree$) (selecwk$ B_b_fun_b_b_fun_b_b_fun_fun_fun_tree$)))
  (A_b_fun_a_a_fun_fun_tree$ (node$af (selecwl$ A_b_fun_a_a_fun_fun$) (selecwm$ A_b_fun_a_a_fun_fun_tree$) (selecwn$ A_b_fun_a_a_fun_fun_tree$)))
  (B_a_fun_a_b_fun_a_a_fun_fun_fun_tree$ (node$ag (selecwo$ B_a_fun_a_b_fun_a_a_fun_fun_fun$) (selecwp$ B_a_fun_a_b_fun_a_a_fun_fun_fun_tree$) (selecwq$ B_a_fun_a_b_fun_a_a_fun_fun_fun_tree$)))
  (A_a_fun_a_a_fun_fun_tree$ (node$ah (selecwr$ A_a_fun_a_a_fun_fun$) (selecws$ A_a_fun_a_a_fun_fun_tree$) (selecwt$ A_a_fun_a_a_fun_fun_tree$)))
  (A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$ai (selecwu$ A_a_fun_a_a_fun_a_a_fun_fun_fun$) (selecwv$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$) (selecww$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$)))
  (B_b_a_fun_fun_b_a_fun_fun_tree$ (node$aj (selecwx$ B_b_a_fun_fun_b_a_fun_fun$) (selecwy$ B_b_a_fun_fun_b_a_fun_fun_tree$) (selecwz$ B_b_a_fun_fun_b_a_fun_fun_tree$)))
  (B_a_fun_a_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$ak (selecxa$ B_a_fun_a_fun_b_b_a_fun_fun_b_a_fun_fun_fun$) (selecxb$ B_a_fun_a_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$) (selecxc$ B_a_fun_a_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$)))))
