...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (A_a_a_fun_fun_stream$ (sCons$d (selectf$ A_a_a_fun_fun$) (selectg$ A_a_a_fun_fun_stream$)))
  (A_stream_stream$ (sCons$e (shd$a A_stream$) (stl$a A_stream_stream$)))
  (A_a_fun_a_a_fun_fun_stream$ (sCons$f (selecth$ A_a_fun_a_a_fun_fun$) (selecti$ A_a_fun_a_a_fun_fun_stream$)))
  (A_stream_a_stream_a_stream_fun_fun_stream$ (sCons$g (selectj$ A_stream_a_stream_a_stream_fun_fun$) (selectk$ A_stream_a_stream_a_stream_fun_fun_stream$)))
  (A_stream_a_stream_fun_a_fun_stream$ (sCons$h (selectl$ A_stream_a_stream_fun_a_fun$) (selectm$ A_stream_a_stream_fun_a_fun_stream$)))
  (A_a_fun_a_fun_a_fun_stream$ (sCons$i (selectn$ A_a_fun_a_fun_a_fun$) (selecto$ A_a_fun_a_fun_a_fun_stream$)))
  (A_a_stream_a_stream_fun_fun_stream$ (sCons$j (selectp$ A_a_stream_a_stream_fun_fun$) (selectq$ A_a_stream_a_stream_fun_fun_stream$)))
  ...
  (A_stream_tree_stream$ (sCons$l (shd$b A_stream_tree$) (stl$b A_stream_tree_stream$)))
  ...
  (A_tree_stream$ (sCons$m (shd$c A_tree$) (stl$c A_tree_stream$)))
  (A_tree_stream_tree$ (node$g (root$g A_tree_stream$) (left$g A_tree_stream_tree$) (right$g A_tree_stream_tree$)))
  (A_stream_stream_stream$ (sCons$n (shd$d A_stream_stream$) (stl$d A_stream_stream_stream$)))
  ...
  (A_tree_a_tree_fun_stream$ (sCons$o (selectt$ A_tree_a_tree_fun$) (selectu$ A_tree_a_tree_fun_stream$)))
  (A_tree_a_tree_a_tree_fun_fun_stream$ (sCons$p (selectv$ A_tree_a_tree_a_tree_fun_fun$) (selectw$ A_tree_a_tree_a_tree_fun_fun_stream$)))
  (A_stream_tree_a_stream_tree_fun_stream$ (sCons$q (selectx$ A_stream_tree_a_stream_tree_fun$) (selecty$ A_stream_tree_a_stream_tree_fun_stream$)))
  (A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_stream$ (sCons$r (selectz$ A_stream_tree_a_stream_tree_a_stream_tree_fun_fun$) (selecua$ A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_stream$)))
  (A_stream_stream_a_stream_stream_fun_stream$ (sCons$s (selecub$ A_stream_stream_a_stream_stream_fun$) (selecuc$ A_stream_stream_a_stream_stream_fun_stream$)))
  (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$ (sCons$t (selecud$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun$) (selecue$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$)))
  (A_tree_tree_stream$ (sCons$u (shd$e A_tree_tree$) (stl$e A_tree_tree_stream$)))
  (A_tree_tree_a_tree_tree_fun_stream$ (sCons$v (selecuf$ A_tree_tree_a_tree_tree_fun$) (selecug$ A_tree_tree_a_tree_tree_fun_stream$)))
  (A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_stream$ (sCons$w (selecuh$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun$) (selecui$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_stream$)))
  (A_tree_stream_stream$ (sCons$x (shd$f A_tree_stream$) (stl$f A_tree_stream_stream$)))
  (A_tree_stream_a_tree_stream_fun_stream$ (sCons$y (selecuj$ A_tree_stream_a_tree_stream_fun$) (selecuk$ A_tree_stream_a_tree_stream_fun_stream$)))
  (A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_stream$ (sCons$z (selecul$ A_tree_stream_a_tree_stream_a_tree_stream_fun_fun$) (selecum$ A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_stream$)))
  (A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$ (sCons$aa (selecun$ A_a_fun_a_a_fun_a_a_fun_fun_fun$) (selecuo$ A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$)))
  (A_stream_stream_tree_stream$ (sCons$ab (shd$g A_stream_stream_tree$) (stl$g A_stream_stream_tree_stream$)))
  (A_stream_stream_tree_a_stream_stream_tree_fun_stream$ (sCons$ac (selecup$ A_stream_stream_tree_a_stream_stream_tree_fun$) (selecuq$ A_stream_stream_tree_a_stream_stream_tree_fun_stream$)))
  (A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_stream$ (sCons$ad (selecur$ A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun$) (selecus$ A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_stream$)))
  (A_stream_tree_stream_stream$ (sCons$ae (shd$h A_stream_tree_stream$) (stl$h A_stream_tree_stream_stream$)))
  (A_stream_tree_stream_a_stream_tree_stream_fun_stream$ (sCons$af (selecut$ A_stream_tree_stream_a_stream_tree_stream_fun$) (selecuu$ A_stream_tree_stream_a_stream_tree_stream_fun_stream$)))
  (A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_stream$ (sCons$ag (selecuv$ A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun$) (selecuw$ A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_stream$)))
  (A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$ (sCons$ah (selecux$ A_a_a_fun_fun_a_a_a_fun_fun_fun$) (selecuy$ A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$)))
  (A_a_a_fun_fun_a_fun_stream$ (sCons$ai (selecuz$ A_a_a_fun_fun_a_fun$) (selecva$ A_a_a_fun_fun_a_fun_stream$)))
  (A_a_stream_a_stream_a_stream_fun_fun_fun_stream$ (sCons$aj (selecvb$ A_a_stream_a_stream_a_stream_fun_fun_fun$) (selecvc$ A_a_stream_a_stream_a_stream_fun_fun_fun_stream$)))
  (A_a_a_a_fun_fun_fun_stream$ (sCons$ak (selecvd$ A_a_a_a_fun_fun_fun$) (selecve$ A_a_a_a_fun_fun_fun_stream$)))
  (A_stream_a_stream_a_stream_fun_fun_a_fun_stream$ (sCons$al (selecvf$ A_stream_a_stream_a_stream_fun_fun_a_fun$) (selecvg$ A_stream_a_stream_a_stream_fun_fun_a_fun_stream$)))
  (A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$ (sCons$am (selecvh$ A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun$) (selecvi$ A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$)))
  (A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$ (sCons$an (selecvj$ A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun$) (selecvk$ A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$)))
  (A_stream_a_stream_a_stream_a_stream_fun_fun_fun_stream$ (sCons$ao (selecvl$ A_stream_a_stream_a_stream_a_stream_fun_fun_fun$) (selecvm$ A_stream_a_stream_a_stream_a_stream_fun_fun_fun_stream$)))))
