...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (B_c_fun_b_a_fun_fun_tree$ (node$c (selectc$ B_c_fun_b_a_fun_fun$) (selectd$ B_c_fun_b_a_fun_fun_tree$) (selecte$ B_c_fun_b_a_fun_fun_tree$)))
  (B_c_fun_tree$ (node$d (selectf$ B_c_fun$) (selectg$ B_c_fun_tree$) (selecth$ B_c_fun_tree$)))
  (B_c_a_fun_fun_b_c_fun_b_a_fun_fun_fun_tree$ (node$e (selecti$ B_c_a_fun_fun_b_c_fun_b_a_fun_fun_fun$) (selectj$ B_c_a_fun_fun_b_c_fun_b_a_fun_fun_fun_tree$) (selectk$ B_c_a_fun_fun_b_c_fun_b_a_fun_fun_fun_tree$)))
  (B_c_a_fun_fun_tree$ (node$f (selectl$ B_c_a_fun_fun$) (selectm$ B_c_a_fun_fun_tree$) (selectn$ B_c_a_fun_fun_tree$)))
  (C_a_fun_tree$ (node$g (selecto$ C_a_fun$) (selectp$ C_a_fun_tree$) (selectq$ C_a_fun_tree$)))
  ...
  (A_c_fun_tree$ (node$l (selecua$ A_c_fun$) (selecub$ A_c_fun_tree$) (selecuc$ A_c_fun_tree$)))
  (A_a_fun_tree$ (node$m (selecud$ A_a_fun$) (selecue$ A_a_fun_tree$) (selecuf$ A_a_fun_tree$)))
  (B_b_b_fun_fun_tree$ (node$n (selecug$ B_b_b_fun_fun$) (selecuh$ B_b_b_fun_fun_tree$) (selecui$ B_b_b_fun_fun_tree$)))
  (C_a_fun_a_c_a_fun_fun_fun_tree$ (node$o (selecuj$ C_a_fun_a_c_a_fun_fun_fun$) (selecuk$ C_a_fun_a_c_a_fun_fun_fun_tree$) (selecul$ C_a_fun_a_c_a_fun_fun_fun_tree$)))
  (B_a_fun_a_b_a_fun_fun_fun_tree$ (node$p (selecum$ B_a_fun_a_b_a_fun_fun_fun$) (selecun$ B_a_fun_a_b_a_fun_fun_fun_tree$) (selecuo$ B_a_fun_a_b_a_fun_fun_fun_tree$)))
  (C_a_c_fun_fun_tree$ (node$q (selecup$ C_a_c_fun_fun$) (selecuq$ C_a_c_fun_fun_tree$) (selecur$ C_a_c_fun_fun_tree$)))
  (A_a_a_fun_fun_tree$ (node$r (selecus$ A_a_a_fun_fun$) (selecut$ A_a_a_fun_fun_tree$) (selecuu$ A_a_a_fun_fun_tree$)))
  (B_a_fun_b_c_fun_b_a_fun_fun_fun_tree$ (node$s (selecuv$ B_a_fun_b_c_fun_b_a_fun_fun_fun$) (selecuw$ B_a_fun_b_c_fun_b_a_fun_fun_fun_tree$) (selecux$ B_a_fun_b_c_fun_b_a_fun_fun_fun_tree$)))
  (C_a_fun_b_c_a_fun_fun_fun_tree$ (node$t (selecuy$ C_a_fun_b_c_a_fun_fun_fun$) (selecuz$ C_a_fun_b_c_a_fun_fun_fun_tree$) (selecva$ C_a_fun_b_c_a_fun_fun_fun_tree$)))
  (C_b_c_fun_fun_tree$ (node$u (selecvb$ C_b_c_fun_fun$) (selecvc$ C_b_c_fun_fun_tree$) (selecvd$ C_b_c_fun_fun_tree$)))
  ...
  (A_a_fun_c_a_fun_c_a_fun_fun_fun_tree$ (node$w (selecvh$ A_a_fun_c_a_fun_c_a_fun_fun_fun$) (selecvi$ A_a_fun_c_a_fun_c_a_fun_fun_fun_tree$) (selecvj$ A_a_fun_c_a_fun_c_a_fun_fun_fun_tree$)))
  (C_c_fun_tree$ (node$x (selecvk$ C_c_fun$) (selecvl$ C_c_fun_tree$) (selecvm$ C_c_fun_tree$)))
  (C_c_fun_c_a_fun_fun_tree$ (node$y (selecvn$ C_c_fun_c_a_fun_fun$) (selecvo$ C_c_fun_c_a_fun_fun_tree$) (selecvp$ C_c_fun_c_a_fun_fun_tree$)))
  (C_a_fun_c_c_fun_c_a_fun_fun_fun_tree$ (node$z (selecvq$ C_a_fun_c_c_fun_c_a_fun_fun_fun$) (selecvr$ C_a_fun_c_c_fun_c_a_fun_fun_fun_tree$) (selecvs$ C_a_fun_c_c_fun_c_a_fun_fun_fun_tree$)))
  (C_b_fun_tree$ (node$aa (selecvt$ C_b_fun$) (selecvu$ C_b_fun_tree$) (selecvv$ C_b_fun_tree$)))
  (C_b_fun_c_a_fun_fun_tree$ (node$ab (selecvw$ C_b_fun_c_a_fun_fun$) (selecvx$ C_b_fun_c_a_fun_fun_tree$) (selecvy$ C_b_fun_c_a_fun_fun_tree$)))
  (B_a_fun_c_b_fun_c_a_fun_fun_fun_tree$ (node$ac (selecvz$ B_a_fun_c_b_fun_c_a_fun_fun_fun$) (selecwa$ B_a_fun_c_b_fun_c_a_fun_fun_fun_tree$) (selecwb$ B_a_fun_c_b_fun_c_a_fun_fun_fun_tree$)))
  (B_c_fun_b_c_fun_fun_tree$ (node$ad (selecwc$ B_c_fun_b_c_fun_fun$) (selecwd$ B_c_fun_b_c_fun_fun_tree$) (selecwe$ B_c_fun_b_c_fun_fun_tree$)))
  (C_c_fun_b_c_fun_b_c_fun_fun_fun_tree$ (node$ae (selecwf$ C_c_fun_b_c_fun_b_c_fun_fun_fun$) (selecwg$ C_c_fun_b_c_fun_b_c_fun_fun_fun_tree$) (selecwh$ C_c_fun_b_c_fun_b_c_fun_fun_fun_tree$)))
  (B_a_fun_b_c_fun_fun_tree$ (node$af (selecwi$ B_a_fun_b_c_fun_fun$) (selecwj$ B_a_fun_b_c_fun_fun_tree$) (selecwk$ B_a_fun_b_c_fun_fun_tree$)))
  (A_c_fun_b_a_fun_b_c_fun_fun_fun_tree$ (node$ag (selecwl$ A_c_fun_b_a_fun_b_c_fun_fun_fun$) (selecwm$ A_c_fun_b_a_fun_b_c_fun_fun_fun_tree$) (selecwn$ A_c_fun_b_a_fun_b_c_fun_fun_fun_tree$)))
  (B_b_fun_b_c_fun_fun_tree$ (node$ah (selecwo$ B_b_fun_b_c_fun_fun$) (selecwp$ B_b_fun_b_c_fun_fun_tree$) (selecwq$ B_b_fun_b_c_fun_fun_tree$)))
  (B_c_fun_b_b_fun_b_c_fun_fun_fun_tree$ (node$ai (selecwr$ B_c_fun_b_b_fun_b_c_fun_fun_fun$) (selecws$ B_c_fun_b_b_fun_b_c_fun_fun_fun_tree$) (selecwt$ B_c_fun_b_b_fun_b_c_fun_fun_fun_tree$)))
  (B_a_fun_b_a_fun_fun_tree$ (node$aj (selecwu$ B_a_fun_b_a_fun_fun$) (selecwv$ B_a_fun_b_a_fun_fun_tree$) (selecww$ B_a_fun_b_a_fun_fun_tree$)))
  (A_a_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$ak (selecwx$ A_a_fun_b_a_fun_b_a_fun_fun_fun$) (selecwy$ A_a_fun_b_a_fun_b_a_fun_fun_fun_tree$) (selecwz$ A_a_fun_b_a_fun_b_a_fun_fun_fun_tree$)))
  (B_b_fun_b_a_fun_fun_tree$ (node$al (selecxa$ B_b_fun_b_a_fun_fun$) (selecxb$ B_b_fun_b_a_fun_fun_tree$) (selecxc$ B_b_fun_b_a_fun_fun_tree$)))
  (B_a_fun_b_b_fun_b_a_fun_fun_fun_tree$ (node$am (selecxd$ B_a_fun_b_b_fun_b_a_fun_fun_fun$) (selecxe$ B_a_fun_b_b_fun_b_a_fun_fun_fun_tree$) (selecxf$ B_a_fun_b_b_fun_b_a_fun_fun_fun_tree$)))
  (C_a_fun_b_c_fun_b_a_fun_fun_fun_tree$ (node$an (selecxg$ C_a_fun_b_c_fun_b_a_fun_fun_fun$) (selecxh$ C_a_fun_b_c_fun_b_a_fun_fun_fun_tree$) (selecxi$ C_a_fun_b_c_fun_b_a_fun_fun_fun_tree$)))
  (C_c_a_fun_fun_tree$ (node$ao (selecxj$ C_c_a_fun_fun$) (selecxk$ C_c_a_fun_fun_tree$) (selecxl$ C_c_a_fun_fun_tree$)))
  (B_c_fun_b_c_a_fun_fun_fun_tree$ (node$ap (selecxm$ B_c_fun_b_c_a_fun_fun_fun$) (selecxn$ B_c_fun_b_c_a_fun_fun_fun_tree$) (selecxo$ B_c_fun_b_c_a_fun_fun_fun_tree$)))
  (C_c_a_fun_fun_b_c_fun_b_c_a_fun_fun_fun_fun_tree$ (node$aq (selecxp$ C_c_a_fun_fun_b_c_fun_b_c_a_fun_fun_fun_fun$) (selecxq$ C_c_a_fun_fun_b_c_fun_b_c_a_fun_fun_fun_fun_tree$) (selecxr$ C_c_a_fun_fun_b_c_fun_b_c_a_fun_fun_fun_fun_tree$)))
  (A_b_a_fun_fun_a_a_fun_fun_tree$ (node$ar (selecxs$ A_b_a_fun_fun_a_a_fun_fun$) (selecxt$ A_b_a_fun_fun_a_a_fun_fun_tree$) (selecxu$ A_b_a_fun_fun_a_a_fun_fun_tree$)))
  (A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun_tree$ (node$as (selecxv$ A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun$) (selecxw$ A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun_tree$) (selecxx$ A_b_a_fun_a_fun_fun_a_b_a_fun_fun_a_a_fun_fun_fun_tree$)))
  (A_b_a_fun_a_fun_fun_tree$ (node$at (selecxy$ A_b_a_fun_a_fun_fun$) (selecxz$ A_b_a_fun_a_fun_fun_tree$) (selecya$ A_b_a_fun_a_fun_fun_tree$)))
  (C_b_c_fun_fun_c_c_fun_fun_tree$ (node$au (selecyb$ C_b_c_fun_fun_c_c_fun_fun$) (selecyc$ C_b_c_fun_fun_c_c_fun_fun_tree$) (selecyd$ C_b_c_fun_fun_c_c_fun_fun_tree$)))
  (C_b_c_fun_c_fun_fun_c_b_c_fun_fun_c_c_fun_fun_fun_tree$ (node$av (selecye$ C_b_c_fun_c_fun_fun_c_b_c_fun_fun_c_c_fun_fun_fun$) (selecyf$ C_b_c_fun_c_fun_fun_c_b_c_fun_fun_c_c_fun_fun_fun_tree$) (selecyg$ C_b_c_fun_c_fun_fun_c_b_c_fun_fun_c_c_fun_fun_fun_tree$)))
  (C_b_c_fun_c_fun_fun_tree$ (node$aw (selecyh$ C_b_c_fun_c_fun_fun$) (selecyi$ C_b_c_fun_c_fun_fun_tree$) (selecyj$ C_b_c_fun_c_fun_fun_tree$)))
  (C_a_fun_b_c_a_fun_fun_fun_c_a_fun_c_a_fun_fun_fun_tree$ (node$ax (selecyk$ C_a_fun_b_c_a_fun_fun_fun_c_a_fun_c_a_fun_fun_fun$) (selecyl$ C_a_fun_b_c_a_fun_fun_fun_c_a_fun_c_a_fun_fun_fun_tree$) (selecym$ C_a_fun_b_c_a_fun_fun_fun_c_a_fun_c_a_fun_fun_fun_tree$)))
  ...
  (C_a_fun_b_c_a_fun_fun_c_a_fun_fun_fun_tree$ (node$az (selecyq$ C_a_fun_b_c_a_fun_fun_c_a_fun_fun_fun$) (selecyr$ C_a_fun_b_c_a_fun_fun_c_a_fun_fun_fun_tree$) (selecys$ C_a_fun_b_c_a_fun_fun_c_a_fun_fun_fun_tree$)))
  (A_c_a_fun_fun_a_a_fun_fun_tree$ (node$ba (selecyt$ A_c_a_fun_fun_a_a_fun_fun$) (selecyu$ A_c_a_fun_fun_a_a_fun_fun_tree$) (selecyv$ A_c_a_fun_fun_a_a_fun_fun_tree$)))
  (A_c_a_fun_a_fun_fun_a_c_a_fun_fun_a_a_fun_fun_fun_tree$ (node$bb (selecyw$ A_c_a_fun_a_fun_fun_a_c_a_fun_fun_a_a_fun_fun_fun$) (selecyx$ A_c_a_fun_a_fun_fun_a_c_a_fun_fun_a_a_fun_fun_fun_tree$) (selecyy$ A_c_a_fun_a_fun_fun_a_c_a_fun_fun_a_a_fun_fun_fun_tree$)))
  (A_c_a_fun_a_fun_fun_tree$ (node$bc (selecyz$ A_c_a_fun_a_fun_fun$) (selecza$ A_c_a_fun_a_fun_fun_tree$) (seleczb$ A_c_a_fun_a_fun_fun_tree$)))
  (B_a_fun_b_c_fun_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$bd (seleczc$ B_a_fun_b_c_fun_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun$) (seleczd$ B_a_fun_b_c_fun_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$) (selecze$ B_a_fun_b_c_fun_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)))
  (B_a_fun_b_c_fun_b_a_fun_fun_b_a_fun_fun_fun_b_a_fun_b_c_fun_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun_fun_tree$ (node$be (seleczf$ B_a_fun_b_c_fun_b_a_fun_fun_b_a_fun_fun_fun_b_a_fun_b_c_fun_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun_fun$) (seleczg$ B_a_fun_b_c_fun_b_a_fun_fun_b_a_fun_fun_fun_b_a_fun_b_c_fun_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun_fun_tree$) (seleczh$ B_a_fun_b_c_fun_b_a_fun_fun_b_a_fun_fun_fun_b_a_fun_b_c_fun_b_a_fun_fun_fun_b_a_fun_b_a_fun_fun_fun_fun_tree$)))
  (B_a_fun_b_c_fun_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$bf (seleczi$ B_a_fun_b_c_fun_b_a_fun_fun_b_a_fun_fun_fun$) (seleczj$ B_a_fun_b_c_fun_b_a_fun_fun_b_a_fun_fun_fun_tree$) (seleczk$ B_a_fun_b_c_fun_b_a_fun_fun_b_a_fun_fun_fun_tree$)))
  (A_b_fun_tree$ (node$bg (seleczl$ A_b_fun$) (seleczm$ A_b_fun_tree$) (seleczn$ A_b_fun_tree$)))
  (B_a_fun_a_fun_tree$ (node$bh (seleczo$ B_a_fun_a_fun$) (seleczp$ B_a_fun_a_fun_tree$) (seleczq$ B_a_fun_a_fun_tree$)))
  (B_c_fun_b_a_fun_fun_b_a_fun_fun_tree$ (node$bi (seleczr$ B_c_fun_b_a_fun_fun_b_a_fun_fun$) (seleczs$ B_c_fun_b_a_fun_fun_b_a_fun_fun_tree$) (seleczt$ B_c_fun_b_a_fun_fun_b_a_fun_fun_tree$)))
  (C_a_fun_a_fun_tree$ (node$bj (seleczu$ C_a_fun_a_fun$) (seleczv$ C_a_fun_a_fun_tree$) (seleczw$ C_a_fun_a_fun_tree$)))
  (B_c_a_fun_fun_c_a_fun_fun_tree$ (node$bk (seleczx$ B_c_a_fun_fun_c_a_fun_fun$) (seleczy$ B_c_a_fun_fun_c_a_fun_fun_tree$) (seleczz$ B_c_a_fun_fun_c_a_fun_fun_tree$)))
  (B_c_fun_c_fun_tree$ (node$bl (seledaa$ B_c_fun_c_fun$) (seledab$ B_c_fun_c_fun_tree$) (seledac$ B_c_fun_c_fun_tree$)))))
