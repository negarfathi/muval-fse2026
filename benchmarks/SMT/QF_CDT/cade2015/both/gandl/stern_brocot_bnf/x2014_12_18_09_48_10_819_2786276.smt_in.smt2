...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (A_a_fun_a_a_a_fun_fun_fun_tree$ (node$bb (selecyz$ A_a_fun_a_a_a_fun_fun_fun$) (selecza$ A_a_fun_a_a_a_fun_fun_fun_tree$) (seleczb$ A_a_fun_a_a_a_fun_fun_fun_tree$)))
  (B_a_fun_a_fun_a_b_a_fun_a_fun_fun_fun_tree$ (node$bc (seleczc$ B_a_fun_a_fun_a_b_a_fun_a_fun_fun_fun$) (seleczd$ B_a_fun_a_fun_a_b_a_fun_a_fun_fun_fun_tree$) (selecze$ B_a_fun_a_fun_a_b_a_fun_a_fun_fun_fun_tree$)))))
