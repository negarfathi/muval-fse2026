...
(declare-codatatypes () ((A_stream$ (sCons$ (shd$ A$) (stl$ A_stream$)))
  ...
  (C_b_a_fun_fun_stream$ (sCons$c (selectb$ C_b_a_fun_fun$) (selectc$ C_b_a_fun_fun_stream$)))
  (C_stream$ (sCons$d (shd$b C$) (stl$b C_stream$)))
  (C_a_fun_stream$ (sCons$e (selectd$ C_a_fun$) (selecte$ C_a_fun_stream$)))
  (C_b_a_fun_fun_b_a_fun_fun_stream$ (sCons$f (selectf$ C_b_a_fun_fun_b_a_fun_fun$) (selectg$ C_b_a_fun_fun_b_a_fun_fun_stream$)))
  (C_a_fun_c_b_a_fun_fun_fun_stream$ (sCons$g (selecth$ C_a_fun_c_b_a_fun_fun_fun$) (selecti$ C_a_fun_c_b_a_fun_fun_fun_stream$)))
  (C_a_fun_c_a_fun_fun_stream$ (sCons$h (selectj$ C_a_fun_c_a_fun_fun$) (selectk$ C_a_fun_c_a_fun_fun_stream$)))
  (C_a_fun_a_fun_stream$ (sCons$i (selectl$ C_a_fun_a_fun$) (selectm$ C_a_fun_a_fun_stream$)))
  (B_a_fun_a_fun_stream$ (sCons$j (selectn$ B_a_fun_a_fun$) (selecto$ B_a_fun_a_fun_stream$)))
  (C_b_a_fun_fun_c_a_fun_fun_stream$ (sCons$k (selectp$ C_b_a_fun_fun_c_a_fun_fun$) (selectq$ C_b_a_fun_fun_c_a_fun_fun_stream$)))
  (C_b_a_fun_fun_c_b_a_fun_fun_fun_stream$ (sCons$l (selectr$ C_b_a_fun_fun_c_b_a_fun_fun_fun$) (selects$ C_b_a_fun_fun_c_b_a_fun_fun_fun_stream$)))
  (C_c_fun_stream$ (sCons$m (selectt$ C_c_fun$) (selectu$ C_c_fun_stream$)))
  (C_b_fun_stream$ (sCons$n (selectv$ C_b_fun$) (selectw$ C_b_fun_stream$)))
  (B_c_fun_stream$ (sCons$o (selectx$ B_c_fun$) (selecty$ B_c_fun_stream$)))
  (C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_stream$ (sCons$p (selectz$ C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun$) (selecua$ C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_stream$)))
  (C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_stream$ (sCons$q (selecub$ C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun$) (selecuc$ C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_stream$)))
  (C_a_fun_c_a_fun_fun_c_a_fun_fun_stream$ (sCons$r (selecud$ C_a_fun_c_a_fun_fun_c_a_fun_fun$) (selecue$ C_a_fun_c_a_fun_fun_c_a_fun_fun_stream$)))
  (C_a_fun_a_fun_a_fun_stream$ (sCons$s (selecuf$ C_a_fun_a_fun_a_fun$) (selecug$ C_a_fun_a_fun_a_fun_stream$)))
  (B_a_fun_a_fun_a_fun_stream$ (sCons$t (selecuh$ B_a_fun_a_fun_a_fun$) (selecui$ B_a_fun_a_fun_a_fun_stream$)))
  (B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$ (sCons$u (selecuj$ B_a_fun_a_fun_b_a_fun_a_fun_fun$) (selecuk$ B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$)))
  (B_a_fun_b_a_fun_fun_stream$ (sCons$v (selecul$ B_a_fun_b_a_fun_fun$) (selecum$ B_a_fun_b_a_fun_fun_stream$)))
  (B_b_fun_stream$ (sCons$w (selecun$ B_b_fun$) (selecuo$ B_b_fun_stream$)))
  (A_a_fun_stream$ (sCons$x (selecup$ A_a_fun$) (selecuq$ A_a_fun_stream$)))
  (C_a_fun_stream_stream$ (sCons$y (shd$c C_a_fun_stream$) (stl$c C_a_fun_stream_stream$)))
  (C_b_a_fun_fun_stream_stream$ (sCons$z (shd$d C_b_a_fun_fun_stream$) (stl$d C_b_a_fun_fun_stream_stream$)))
  (B_a_fun_tree$ (node$ (selecur$ B_a_fun$) (selecus$ B_a_fun_tree$) (selecut$ B_a_fun_tree$)))
  (C_tree$ (node$a (root$ C$) (left$ C_tree$) (right$ C_tree$)))
  (B_tree$ (node$b (root$a B$) (left$a B_tree$) (right$a B_tree$)))
  (A_tree$ (node$c (root$b A$) (left$b A_tree$) (right$b A_tree$)))
  (C_b_a_fun_fun_tree$ (node$d (selecuu$ C_b_a_fun_fun$) (selecuv$ C_b_a_fun_fun_tree$) (selecuw$ C_b_a_fun_fun_tree$)))
  (C_a_fun_tree$ (node$e (selecux$ C_a_fun$) (selecuy$ C_a_fun_tree$) (selecuz$ C_a_fun_tree$)))))
