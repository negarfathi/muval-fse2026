...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (B_a_fun_a_fun_tree$ (node$c (selectc$ B_a_fun_a_fun$) (selectd$ B_a_fun_a_fun_tree$) (selecte$ B_a_fun_a_fun_tree$)))
  (B_b_fun_tree$ (node$d (selectf$ B_b_fun$) (selectg$ B_b_fun_tree$) (selecth$ B_b_fun_tree$)))
  (B_b_a_fun_a_fun_fun_tree$ (node$e (selecti$ B_b_a_fun_a_fun_fun$) (selectj$ B_b_a_fun_a_fun_fun_tree$) (selectk$ B_b_a_fun_a_fun_fun_tree$)))
  (B_a_fun_a_fun_b_fun_tree$ (node$f (selectl$ B_a_fun_a_fun_b_fun$) (selectm$ B_a_fun_a_fun_b_fun_tree$) (selectn$ B_a_fun_a_fun_b_fun_tree$)))
  ...
  (A_a_fun_tree$ (node$i (selectu$ A_a_fun$) (selectv$ A_a_fun_tree$) (selectw$ A_a_fun_tree$)))
  (B_b_b_fun_fun_tree$ (node$j (selectx$ B_b_b_fun_fun$) (selecty$ B_b_b_fun_fun_tree$) (selectz$ B_b_b_fun_fun_tree$)))
  (B_b_a_fun_fun_tree$ (node$k (selecua$ B_b_a_fun_fun$) (selecub$ B_b_a_fun_fun_tree$) (selecuc$ B_b_a_fun_fun_tree$)))
  (B_a_fun_b_fun_tree$ (node$l (selecud$ B_a_fun_b_fun$) (selecue$ B_a_fun_b_fun_tree$) (selecuf$ B_a_fun_b_fun_tree$)))
  (A_b_a_fun_fun_tree$ (node$m (selecug$ A_b_a_fun_fun$) (selecuh$ A_b_a_fun_fun_tree$) (selecui$ A_b_a_fun_fun_tree$)))
  (B_a_fun_b_a_fun_fun_tree$ (node$n (selecuj$ B_a_fun_b_a_fun_fun$) (selecuk$ B_a_fun_b_a_fun_fun_tree$) (selecul$ B_a_fun_b_a_fun_fun_tree$)))
  (A_b_a_fun_a_fun_fun_tree$ (node$o (selecum$ A_b_a_fun_a_fun_fun$) (selecun$ A_b_a_fun_a_fun_fun_tree$) (selecuo$ A_b_a_fun_a_fun_fun_tree$)))))
