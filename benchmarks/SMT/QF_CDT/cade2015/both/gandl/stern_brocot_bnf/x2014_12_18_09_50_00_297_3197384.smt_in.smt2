...
(declare-codatatypes () ((Nat_stream_stream$ (sCons$k (shd$a Nat_stream$) (stl$a Nat_stream_stream$)))
  (Nat_stream_stream_stream$ (sCons$l (shd$b Nat_stream_stream$) (stl$b Nat_stream_stream_stream$)))
  (Nat_tree_stream$ (sCons$m (shd$c Nat_tree$) (stl$c Nat_tree_stream$)))
  (Nat_tree_stream_stream$ (sCons$n (shd$d Nat_tree_stream$) (stl$d Nat_tree_stream_stream$)))
  (Nat_tree_stream_stream_stream$ (sCons$o (shd$e Nat_tree_stream_stream$) (stl$e Nat_tree_stream_stream_stream$)))
  (Nat_nat_nat_fun_nat_nat_fun_fun_fun_stream$ (sCons$p (selecuz$ Nat_nat_nat_fun_nat_nat_fun_fun_fun$) (selecva$ Nat_nat_nat_fun_nat_nat_fun_fun_fun_stream$)))
