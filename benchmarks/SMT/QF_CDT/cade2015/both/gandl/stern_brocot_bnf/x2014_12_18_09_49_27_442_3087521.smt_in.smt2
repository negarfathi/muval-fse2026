...
(declare-codatatypes () ((Nat_tree$ (node$a (root$a Nat$) (left$a Nat_tree$) (right$a Nat_tree$)))
  (Int_tree_tree$ (node$b (root$b Int_tree$) (left$b Int_tree_tree$) (right$b Int_tree_tree$)))
  (Nat_tree_tree$ (node$c (root$c Nat_tree$) (left$c Nat_tree_tree$) (right$c Nat_tree_tree$)))
  (Int_tree_tree_tree$ (node$d (root$d Int_tree_tree$) (left$d Int_tree_tree_tree$) (right$d Int_tree_tree_tree$)))
  (Nat_tree_tree_tree$ (node$e (root$e Nat_tree_tree$) (left$e Nat_tree_tree_tree$) (right$e Nat_tree_tree_tree$)))))
