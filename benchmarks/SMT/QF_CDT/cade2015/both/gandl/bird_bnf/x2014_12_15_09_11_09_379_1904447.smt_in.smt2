...
(assert (! (forall ((?v0 Nat$) (?v1 Nat$)) (! (= (fun_app$ (fun_app$a uu$ ?v0) ?v1) (pair$ (plus$ ?v0 ?v1) ?v1)) :pattern ((fun_app$ (fun_app$a uu$ ?v0) ?v1)))) :named a0))
...
(assert (! (not (= (fun_app$f (comp$ (fun_app$f (comp$ (fun_app$f (comp$ (case_prod$ uu$)) (case_prod$ uua$))) (case_prod$ uua$))) (case_prod$ uu$)) (fun_app$f (comp$ (case_prod$ uu$)) (case_prod$ uu$)))) :named a8))
(assert (! (= (fun_app$f (comp$ (fun_app$f (comp$ (fun_app$f (comp$ (fun_app$f (comp$ (fun_app$f (comp$ (case_prod$ uua$)) (case_prod$ uu$))) (case_prod$ uua$))) (case_prod$ uua$))) (case_prod$ uu$))) (case_prod$ uua$)) (fun_app$f (comp$ (fun_app$f (comp$ (fun_app$f (comp$ (case_prod$ uua$)) (case_prod$ uu$))) (case_prod$ uu$))) (case_prod$ uua$))) :named a9))
(assert (! (= (fun_app$f (comp$ (fun_app$f (comp$ (case_prod$ uua$)) (case_prod$ uu$))) (case_prod$ uua$)) (case_prod$ uub$)) :named a10))
...
(assert (! (forall ((?v0 Nat_nat_bool_fun_fun$) (?v1 Nat_nat_nat_nat_prod_fun_fun$) (?v2 Nat_nat_prod$)) (= (fun_app$e (case_prod$a ?v0) (fun_app$b (case_prod$ ?v1) ?v2)) (fun_app$e (case_prod$a (uuc$ ?v0 ?v1)) ?v2))) :named a12))
(assert (! (forall ((?v0 Nat_nat_nat_nat_prod_fun_fun$) (?v1 Nat_nat_nat_nat_prod_fun_fun$) (?v2 Nat_nat_prod$)) (= (fun_app$b (case_prod$ ?v0) (fun_app$b (case_prod$ ?v1) ?v2)) (fun_app$b (case_prod$ (uud$ ?v0 ?v1)) ?v2))) :named a13))
...
(assert (! (forall ((?v0 Nat_nat_prod$)) (! (= (fun_app$b (case_prod$ uue$) ?v0) ?v0) :pattern ((fun_app$b (case_prod$ uue$) ?v0)))) :named a16))
...
(assert (! (forall ((?v0 Nat_nat_prod_bool_fun$)) (= (case_prod$a (uuf$ ?v0)) ?v0)) :named a19))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun$)) (= (case_prod$ (uug$ ?v0)) ?v0)) :named a20))
(assert (! (forall ((?v0 Nat_nat_bool_fun_fun$) (?v1 Nat_nat_prod_bool_fun$)) (=> (forall ((?v2 Nat$) (?v3 Nat$)) (= (fun_app$c (fun_app$d ?v0 ?v2) ?v3) (fun_app$e ?v1 (pair$ ?v2 ?v3)))) (= (case_prod$a ?v0) ?v1))) :named a21))
(assert (! (forall ((?v0 Nat_nat_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun$)) (=> (forall ((?v2 Nat$) (?v3 Nat$)) (= (fun_app$ (fun_app$a ?v0 ?v2) ?v3) (fun_app$b ?v1 (pair$ ?v2 ?v3)))) (= (case_prod$ ?v0) ?v1))) :named a22))
...
(assert (! (forall ((?v0 Nat_nat_bool_fun_fun$) (?v1 Nat$) (?v2 Nat$)) (! (= (fun_app$e (case_prod$a ?v0) (pair$ ?v1 ?v2)) (fun_app$c (fun_app$d ?v0 ?v1) ?v2)) :pattern ((fun_app$e (case_prod$a ?v0) (pair$ ?v1 ?v2))))) :named a25))
(assert (! (forall ((?v0 Nat_nat_nat_nat_prod_fun_fun$) (?v1 Nat$) (?v2 Nat$)) (! (= (fun_app$b (case_prod$ ?v0) (pair$ ?v1 ?v2)) (fun_app$ (fun_app$a ?v0 ?v1) ?v2)) :pattern ((fun_app$b (case_prod$ ?v0) (pair$ ?v1 ?v2))))) :named a26))
