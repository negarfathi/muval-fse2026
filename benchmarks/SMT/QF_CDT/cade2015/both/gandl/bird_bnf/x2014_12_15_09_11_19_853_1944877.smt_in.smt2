...
(declare-codatatypes () ((Nat_nat_prod_tree$ (node$ (root$ Nat_nat_prod$) (left$ Nat_nat_prod_tree$) (right$ Nat_nat_prod_tree$)))
  (Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun_tree$ (node$a (select$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun$) (selecta$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun_tree$) (selectb$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun_tree$)))
  ...
  (Nat_nat_prod_stream$ (sCons$ (shd$ Nat_nat_prod$) (stl$ Nat_nat_prod_stream$)))))
...
(assert (! (= (root$ bird$) (pair$ one$ one$)) :named a37))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun_tree$)) (= (right$a (fun_app$a odd_mirror$a ?v0)) (even_mirror$ (right$a ?v0)))) :named a38))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_nat_nat_prod_fun_fun_tree$)) (= (right$b (fun_app$b odd_mirror$b ?v0)) (even_mirror$a (right$b ?v0)))) :named a39))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$)) (= (right$c (fun_app$c odd_mirror$c ?v0)) (even_mirror$b (right$c ?v0)))) :named a40))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_tree$)) (= (right$d (fun_app$d odd_mirror$d ?v0)) (even_mirror$c (right$d ?v0)))) :named a41))
(assert (! (forall ((?v0 Nat_nat_prod_tree$)) (= (right$ (fun_app$ odd_mirror$ ?v0)) (even_mirror$d (right$ ?v0)))) :named a42))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun_tree$)) (= (left$a (fun_app$a odd_mirror$a ?v0)) (even_mirror$ (left$a ?v0)))) :named a43))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_nat_nat_prod_fun_fun_tree$)) (= (left$b (fun_app$b odd_mirror$b ?v0)) (even_mirror$a (left$b ?v0)))) :named a44))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$)) (= (left$c (fun_app$c odd_mirror$c ?v0)) (even_mirror$b (left$c ?v0)))) :named a45))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_tree$)) (= (left$d (fun_app$d odd_mirror$d ?v0)) (even_mirror$c (left$d ?v0)))) :named a46))
(assert (! (forall ((?v0 Nat_nat_prod_tree$)) (= (left$ (fun_app$ odd_mirror$ ?v0)) (even_mirror$d (left$ ?v0)))) :named a47))
(assert (! (= (stream$ stern_brocot$) stern_brocot_loopless$) :named a48))
(assert (! (forall ((?v0 Dir_list$) (?v1 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun_tree$)) (= (root$a (traverse_tree$ ?v0 (fun_app$a odd_mirror$a ?v1))) (root$a (traverse_tree$ (odd_mirror_path$ ?v0) ?v1)))) :named a49))
(assert (! (forall ((?v0 Dir_list$) (?v1 Nat_nat_prod_nat_nat_prod_nat_nat_prod_fun_fun_tree$)) (= (root$b (traverse_tree$a ?v0 (fun_app$b odd_mirror$b ?v1))) (root$b (traverse_tree$a (odd_mirror_path$ ?v0) ?v1)))) :named a50))
(assert (! (forall ((?v0 Dir_list$) (?v1 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$)) (= (root$c (traverse_tree$b ?v0 (fun_app$c odd_mirror$c ?v1))) (root$c (traverse_tree$b (odd_mirror_path$ ?v0) ?v1)))) :named a51))
(assert (! (forall ((?v0 Dir_list$) (?v1 Nat_nat_prod_nat_nat_prod_fun_tree$)) (= (root$d (traverse_tree$c ?v0 (fun_app$d odd_mirror$d ?v1))) (root$d (traverse_tree$c (odd_mirror_path$ ?v0) ?v1)))) :named a52))
(assert (! (forall ((?v0 Dir_list$) (?v1 Nat_nat_prod_tree$)) (= (root$ (traverse_tree$d ?v0 (fun_app$ odd_mirror$ ?v1))) (root$ (traverse_tree$d (odd_mirror_path$ ?v0) ?v1)))) :named a53))
(assert (! (= (root$ stern_brocot$) (pair$ one$ one$)) :named a54))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod$)) (= (tree_ap$b (tree_pure$a ?v0) (tree_pure$d ?v1)) (tree_pure$c (fun_app$e ?v0 ?v1)))) :named a55))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun$)) (= (tree_ap$a (tree_pure$b ?v0) (tree_pure$c ?v1)) (tree_pure$d (fun_app$f ?v0 ?v1)))) :named a56))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun$)) (= (tree_ap$c (tree_pure$ ?v0) (tree_pure$c ?v1)) (tree_pure$c (fun_app$g ?v0 ?v1)))) :named a57))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun$) (?v1 Nat_nat_prod$)) (= (tree_ap$ (tree_pure$c ?v0) (tree_pure$d ?v1)) (tree_pure$d (fun_app$h ?v0 ?v1)))) :named a58))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun_tree$)) (= (root$d (map_tree$c ?v0 ?v1)) (fun_app$g ?v0 (root$d ?v1)))) :named a59))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun_tree$)) (= (root$ (map_tree$b ?v0 ?v1)) (fun_app$f ?v0 (root$d ?v1)))) :named a60))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod_tree$)) (= (root$d (map_tree$a ?v0 ?v1)) (fun_app$e ?v0 (root$ ?v1)))) :named a61))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun$) (?v1 Nat_nat_prod_tree$)) (= (root$ (map_tree$ ?v0 ?v1)) (fun_app$h ?v0 (root$ ?v1)))) :named a62))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun_tree$)) (= (root$d (map_tree$c ?v0 ?v1)) (fun_app$g ?v0 (root$d ?v1)))) :named a63))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun_tree$)) (= (root$ (map_tree$b ?v0 ?v1)) (fun_app$f ?v0 (root$d ?v1)))) :named a64))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod_tree$)) (= (root$d (map_tree$a ?v0 ?v1)) (fun_app$e ?v0 (root$ ?v1)))) :named a65))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun$) (?v1 Nat_nat_prod_tree$)) (= (root$ (map_tree$ ?v0 ?v1)) (fun_app$h ?v0 (root$ ?v1)))) :named a66))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun$)) (= (map_tree$c ?v0 (tree_pure$c ?v1)) (tree_pure$c (fun_app$g ?v0 ?v1)))) :named a67))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun$)) (= (map_tree$b ?v0 (tree_pure$c ?v1)) (tree_pure$d (fun_app$f ?v0 ?v1)))) :named a68))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod$)) (= (map_tree$a ?v0 (tree_pure$d ?v1)) (tree_pure$c (fun_app$e ?v0 ?v1)))) :named a69))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun$) (?v1 Nat_nat_prod$)) (= (map_tree$ ?v0 (tree_pure$d ?v1)) (tree_pure$d (fun_app$h ?v0 ?v1)))) :named a70))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun_tree$)) (= (left$d (map_tree$c ?v0 ?v1)) (map_tree$c ?v0 (left$d ?v1)))) :named a71))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun$) (?v1 Nat_nat_prod_nat_nat_prod_fun_tree$)) (= (left$ (map_tree$b ?v0 ?v1)) (map_tree$b ?v0 (left$d ?v1)))) :named a72))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_nat_nat_prod_fun_fun$) (?v1 Nat_nat_prod_tree$)) (= (left$d (map_tree$a ?v0 ?v1)) (map_tree$a ?v0 (left$ ?v1)))) :named a73))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun$) (?v1 Nat_nat_prod_tree$)) (= (left$ (map_tree$ ?v0 ?v1)) (map_tree$ ?v0 (left$ ?v1)))) :named a74))
(check-sat)
;(get-unsat-core)
