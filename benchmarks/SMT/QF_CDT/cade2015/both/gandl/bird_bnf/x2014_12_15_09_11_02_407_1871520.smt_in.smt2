...
(declare-codatatypes () ((A_tree$ (node$ (root$ A$) (left$ A_tree$) (right$ A_tree$)))
  ...
  (A_a_b_a_fun_fun_fun_tree$ (node$c (selectc$ A_a_b_a_fun_fun_fun$) (selectd$ A_a_b_a_fun_fun_fun_tree$) (selecte$ A_a_b_a_fun_fun_fun_tree$)))
  (A_b_a_fun_fun_tree$ (node$d (selectf$ A_b_a_fun_fun$) (selectg$ A_b_a_fun_fun_tree$) (selecth$ A_b_a_fun_fun_tree$)))
  (A_a_a_fun_fun_tree$ (node$e (selecti$ A_a_a_fun_fun$) (selectj$ A_a_a_fun_fun_tree$) (selectk$ A_a_a_fun_fun_tree$)))
  ...
  (B_b_a_fun_fun_tree$ (node$h (selectr$ B_b_a_fun_fun$) (selects$ B_b_a_fun_fun_tree$) (selectt$ B_b_a_fun_fun_tree$)))
  (B_a_a_fun_fun_tree$ (node$i (selectu$ B_a_a_fun_fun$) (selectv$ B_a_a_fun_fun_tree$) (selectw$ B_a_a_fun_fun_tree$)))
  (B_b_fun_tree$ (node$j (selectx$ B_b_fun$) (selecty$ B_b_fun_tree$) (selectz$ B_b_fun_tree$)))
  (B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ (node$k (selecua$ B_a_a_fun_fun_a_b_a_fun_fun_fun$) (selecub$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$) (selecuc$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)))
  (B_b_b_a_fun_fun_fun_tree$ (node$l (selecud$ B_b_b_a_fun_fun_fun$) (selecue$ B_b_b_a_fun_fun_fun_tree$) (selecuf$ B_b_b_a_fun_fun_fun_tree$)))
  ...
  (A_b_b_a_fun_fun_fun_tree$ (node$o (selecum$ A_b_b_a_fun_fun_fun$) (selecun$ A_b_b_a_fun_fun_fun_tree$) (selecuo$ A_b_b_a_fun_fun_fun_tree$)))
  (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$ (node$p (selecup$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun$) (selecuq$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$) (selecur$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)))
  (B_b_a_a_fun_fun_fun_tree$ (node$q (selecus$ B_b_a_a_fun_fun_fun$) (selecut$ B_b_a_a_fun_fun_fun_tree$) (selecuu$ B_b_a_a_fun_fun_fun_tree$)))
  (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$ (node$r (selecuv$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun$) (selecuw$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$) (selecux$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)))
  (B_b_b_fun_fun_tree$ (node$s (selecuy$ B_b_b_fun_fun$) (selecuz$ B_b_b_fun_fun_tree$) (selecva$ B_b_b_fun_fun_tree$)))
  (B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ (node$t (selecvb$ B_b_b_fun_fun_b_b_b_fun_fun_fun$) (selecvc$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$) (selecvd$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)))
  (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ (node$u (selecve$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun$) (selecvf$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$) (selecvg$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)))
  (A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$ (node$v (selecvh$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun$) (selecvi$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$) (selecvj$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$)))
  (A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ (node$w (selecvk$ A_a_a_fun_fun_a_a_a_fun_fun_fun$) (selecvl$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$) (selecvm$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)))
  (A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$ (node$x (selecvn$ A_b_a_fun_fun_b_a_a_fun_fun_fun$) (selecvo$ A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$) (selecvp$ A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)))
  (B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ (node$y (selecvq$ B_b_a_fun_fun_b_b_a_fun_fun_fun$) (selecvr$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$) (selecvs$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)))
  (B_a_fun_b_a_fun_fun_tree$ (node$z (selecvt$ B_a_fun_b_a_fun_fun$) (selecvu$ B_a_fun_b_a_fun_fun_tree$) (selecvv$ B_a_fun_b_a_fun_fun_tree$)))
  (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$aa (selecvw$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun$) (selecvx$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$) (selecvy$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)))
  (B_b_fun_b_a_fun_fun_tree$ (node$ab (selecvz$ B_b_fun_b_a_fun_fun$) (selecwa$ B_b_fun_b_a_fun_fun_tree$) (selecwb$ B_b_fun_b_a_fun_fun_tree$)))
  (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ (node$ac (selecwc$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun$) (selecwd$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$) (selecwe$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)))
  (B_a_b_fun_fun_tree$ (node$ad (selecwf$ B_a_b_fun_fun$) (selecwg$ B_a_b_fun_fun_tree$) (selecwh$ B_a_b_fun_fun_tree$)))
  (B_a_fun_b_b_fun_fun_tree$ (node$ae (selecwi$ B_a_fun_b_b_fun_fun$) (selecwj$ B_a_fun_b_b_fun_fun_tree$) (selecwk$ B_a_fun_b_b_fun_fun_tree$)))
  (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ (node$af (selecwl$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun$) (selecwm$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$) (selecwn$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)))
