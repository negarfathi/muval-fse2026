...
(declare-datatypes () ((A_treeFI_treeFI_treeFI_list$ (nil$b) (cons$b (hd$b A_treeFI_treeFI_treeFI$) (tl$b A_treeFI_treeFI_treeFI_list$)))
  (A_treeFI_stream_treeFI_list$ (nil$c) (cons$c (hd$c A_treeFI_stream_treeFI$) (tl$c A_treeFI_stream_treeFI_list$)))
  (A_list$ (nil$d) (cons$d (hd$d A$) (tl$d A_list$)))
  (A_treeFI_stream_list$ (nil$e) (cons$e (hd$e A_treeFI_stream$) (tl$e A_treeFI_stream_list$)))))
