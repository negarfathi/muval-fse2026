...
(declare-codatatypes () ((A_treeFI_stream$ (sCons$a (shd$a A_treeFI$) (stl$a A_treeFI_stream$)))))
(declare-datatypes () ((A_treeFI_treeFI_list$ (nil$a) (cons$a (hd$a A_treeFI_treeFI$) (tl$a A_treeFI_treeFI_list$)))
  ...
  (A_stream_treeFI_list$ (nil$c) (cons$c (hd$c A_stream_treeFI$) (tl$c A_stream_treeFI_list$)))
  (A_treeFI_stream_treeFI_list$ (nil$d) (cons$d (hd$d A_treeFI_stream_treeFI$) (tl$d A_treeFI_stream_treeFI_list$)))
  (A_list$ (nil$e) (cons$e (hd$e A$) (tl$e A_list$)))
  (A_stream_list$ (nil$f) (cons$f (hd$f A_stream$) (tl$f A_stream_list$)))
  (A_treeFI_stream_list$ (nil$g) (cons$g (hd$g A_treeFI_stream$) (tl$g A_treeFI_stream_list$)))))
(declare-codatatypes () ((A_treeFI_treeFI_stream$ (sCons$b (shd$b A_treeFI_treeFI$) (stl$b A_treeFI_treeFI_stream$)))
  (A_stream_stream$ (sCons$c (shd$c A_stream$) (stl$c A_stream_stream$)))
  (A_treeFI_stream_stream$ (sCons$d (shd$d A_treeFI_stream$) (stl$d A_treeFI_stream_stream$)))))
