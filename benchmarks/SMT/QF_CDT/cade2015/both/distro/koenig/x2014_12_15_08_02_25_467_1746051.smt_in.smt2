...
(declare-codatatypes () ((A_treeFI_stream$ (sCons$b (shd$b A_treeFI$) (stl$b A_treeFI_stream$)))))
(declare-datatypes () ((A_treeFI_treeFI_list$ (nil$a) (cons$a (hd$a A_treeFI_treeFI$) (tl$a A_treeFI_treeFI_list$)))
...
(declare-datatypes () ((A_bool_fun_a_stream_prod$ (pair$b (select$ A_bool_fun$) (selecta$ A_stream$)))
  ...
  (A_list$ (nil$h) (cons$h (hd$h A$) (tl$h A_list$)))
  (Nat_list$ (nil$i) (cons$i (hd$i Nat$) (tl$i Nat_list$)))))
