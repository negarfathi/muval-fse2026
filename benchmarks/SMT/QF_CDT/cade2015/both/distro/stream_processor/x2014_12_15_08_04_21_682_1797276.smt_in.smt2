...
(declare-datatypes () ((B_stream_b_stream_prod$ (pair$ (fst$ B_stream$) (snd$ B_stream$)))
  (C_stream_c_stream_prod$ (pair$a (fst$a C_stream$) (snd$a C_stream$)))
  (C_stream_b_stream_prod$ (pair$b (fst$b C_stream$) (snd$b B_stream$)))
  (B_stream_c_stream_prod$ (pair$c (fst$c B_stream$) (snd$c C_stream$)))))
