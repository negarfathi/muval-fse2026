; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 32
...
(declare-codatatypes () ((B_stream$ (sCons$ (shd$ B$) (stl$ B_stream$)))
  ...
  (C_b_c_b_sp_nu_sp_mu_stream$ (sCons$c (shd$c C_b_c_b_sp_nu_sp_mu$) (stl$c C_b_c_b_sp_nu_sp_mu_stream$)))))
...
(declare-codatatypes () ((B_stream_stream$ (sCons$d (shd$d B_stream$) (stl$d B_stream_stream$)))
  (C_b_c_b_sp_nu_sp_mu_stream_stream$ (sCons$e (shd$e C_b_c_b_sp_nu_sp_mu_stream$) (stl$e C_b_c_b_sp_nu_sp_mu_stream_stream$)))
  (C_b_sp_nu_stream$ (sCons$f (shd$f C_b_sp_nu$) (stl$f C_b_sp_nu_stream$)))))
