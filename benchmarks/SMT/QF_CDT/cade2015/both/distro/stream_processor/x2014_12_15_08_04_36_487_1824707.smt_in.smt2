...
(declare-datatypes () ((C_a_d_sp_nu_prod$ (pair$ (fst$ C$) (snd$ A_d_sp_nu$)))
  (A_d_a_d_sp_nu_sp_mu_a_b_c_a_d_sp_nu_prod_sp_mu_fun_a_d_a_d_sp_nu_sp_mu_a_b_c_a_d_sp_nu_prod_sp_mu_fun_prod$ (pair$a (select$ A_d_a_d_sp_nu_sp_mu_a_b_c_a_d_sp_nu_prod_sp_mu_fun$) (selecta$ A_d_a_d_sp_nu_sp_mu_a_b_c_a_d_sp_nu_prod_sp_mu_fun$)))
  (D_b_c_sp_mu_d_b_c_sp_mu_prod$ (pair$b (fst$a D_b_c_sp_mu$) (snd$a D_b_c_sp_mu$)))
  (D_b_c_sp_mu_a_d_a_d_sp_nu_sp_mu_prod$ (pair$c (fst$b D_b_c_sp_mu$) (snd$b A_d_a_d_sp_nu_sp_mu$)))
  (A_d_a_d_sp_nu_sp_mu_a_d_a_d_sp_nu_sp_mu_prod$ (pair$d (fst$c A_d_a_d_sp_nu_sp_mu$) (snd$c A_d_a_d_sp_nu_sp_mu$)))
  (A_b_c_a_d_sp_nu_prod_sp_mu_a_b_c_a_d_sp_nu_prod_sp_mu_prod$ (pair$e (fst$d A_b_c_a_d_sp_nu_prod_sp_mu$) (snd$d A_b_c_a_d_sp_nu_prod_sp_mu$)))
  (B_c_prod$ (pair$f (fst$e B$) (snd$e C$)))))
(declare-codatatypes () ((D_stream$ (sCons$ (shd$ D$) (stl$ D_stream$)))))
(declare-datatypes () ((B_c_prod_d_stream_prod$ (pair$g (fst$f B_c_prod$) (snd$f D_stream$)))
  (D_a_d_sp_nu_prod$ (pair$h (fst$g D$) (snd$g A_d_sp_nu$)))
  (C_c_prod$ (pair$i (fst$h C$) (snd$h C$)))
  (B_c_a_d_sp_nu_prod_prod$ (pair$j (fst$i B$) (snd$i C_a_d_sp_nu_prod$)))))
(declare-codatatypes () ((A_stream$ (sCons$a (shd$a A$) (stl$a A_stream$)))))
(declare-datatypes () ((D_a_d_sp_nu_prod_a_stream_prod$ (pair$k (fst$j D_a_d_sp_nu_prod$) (snd$j A_stream$)))
  (B_c_a_d_sp_nu_prod_prod_a_stream_prod$ (pair$l (fst$k B_c_a_d_sp_nu_prod_prod$) (snd$k A_stream$)))
  (A_d_a_d_sp_nu_sp_mu_a_a_a_a_sp_nu_sp_mu_prod$ (pair$m (fst$l A_d_a_d_sp_nu_sp_mu$) (snd$l A_a_a_a_sp_nu_sp_mu$)))
  (A_b_c_a_d_sp_nu_prod_sp_mu_a_a_a_a_sp_nu_sp_mu_prod$ (pair$n (fst$m A_b_c_a_d_sp_nu_prod_sp_mu$) (snd$m A_a_a_a_sp_nu_sp_mu$)))
  (D_b_c_sp_mu_d_d_d_d_sp_nu_sp_mu_prod$ (pair$o (fst$n D_b_c_sp_mu$) (snd$n D_d_d_d_sp_nu_sp_mu$)))
  (D_d_d_d_sp_nu_sp_mu_a_d_a_d_sp_nu_sp_mu_prod$ (pair$p (fst$o D_d_d_d_sp_nu_sp_mu$) (snd$o A_d_a_d_sp_nu_sp_mu$)))
  (D_b_c_sp_mu_a_d_a_d_sp_nu_sp_mu_prod_d_b_c_sp_mu_a_d_a_d_sp_nu_sp_mu_prod_prod$ (pair$q (fst$p D_b_c_sp_mu_a_d_a_d_sp_nu_sp_mu_prod$) (snd$p D_b_c_sp_mu_a_d_a_d_sp_nu_sp_mu_prod$)))
  (C_a_d_sp_nu_prod_c_a_d_sp_nu_prod_prod$ (pair$r (fst$q C_a_d_sp_nu_prod$) (snd$q C_a_d_sp_nu_prod$)))
  (A_d_sp_nu_a_d_sp_nu_prod$ (pair$s (fst$r A_d_sp_nu$) (snd$r A_d_sp_nu$)))
  (A_d_a_d_sp_nu_sp_mu_d_b_c_sp_mu_prod$ (pair$t (fst$s A_d_a_d_sp_nu_sp_mu$) (snd$s D_b_c_sp_mu$)))
  (A_d_sp_nu_c_prod$ (pair$u (fst$t A_d_sp_nu$) (snd$t C$)))
  (D_d_prod$ (pair$v (fst$u D$) (snd$u D$)))
  (D_d_sp_nu_a_d_sp_nu_prod$ (pair$w (fst$v D_d_sp_nu$) (snd$v A_d_sp_nu$)))
  (A_d_sp_nu_a_a_sp_nu_prod$ (pair$x (fst$w A_d_sp_nu$) (snd$w A_a_sp_nu$)))
  (D_d_sum$ (inl$ (projl$ D$)) (inr$ (projr$ D$)))
  (D_a_d_a_d_sp_nu_sp_mu_prod$ (pair$y (fst$x D$) (snd$x A_d_a_d_sp_nu_sp_mu$)))))
