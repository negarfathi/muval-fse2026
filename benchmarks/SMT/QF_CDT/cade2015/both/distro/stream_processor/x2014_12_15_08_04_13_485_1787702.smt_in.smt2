...
(declare-datatypes () ((C_b_c_b_sp_nu_sp_mu_c_b_c_b_sp_nu_sp_mu_prod$ (pair$a (fst$a C_b_c_b_sp_nu_sp_mu$) (snd$a C_b_c_b_sp_nu_sp_mu$)))))
(declare-codatatypes () ((C_b_c_b_sp_nu_sp_mu_c_b_c_b_sp_nu_sp_mu_prod_stream$ (sCons$e (shd$e C_b_c_b_sp_nu_sp_mu_c_b_c_b_sp_nu_sp_mu_prod$) (stl$e C_b_c_b_sp_nu_sp_mu_c_b_c_b_sp_nu_sp_mu_prod_stream$)))))
(declare-datatypes () ((C_b_sp_nu_a_c_sp_nu_prod$ (pair$b (fst$b C_b_sp_nu$) (snd$b A_c_sp_nu$)))
  (C_a_c_sp_nu_prod$ (pair$c (fst$c C$) (snd$c A_c_sp_nu$)))
  (C_a_c_sp_nu_prod_a_stream_prod$ (pair$d (fst$d C_a_c_sp_nu_prod$) (snd$d A_stream$)))
  (B_c_b_sp_nu_a_c_sp_nu_prod_prod$ (pair$e (fst$e B$) (snd$e C_b_sp_nu_a_c_sp_nu_prod$)))
  (B_c_b_sp_nu_a_c_sp_nu_prod_prod_a_stream_prod$ (pair$f (fst$f B_c_b_sp_nu_a_c_sp_nu_prod_prod$) (snd$f A_stream$)))
  (B_c_b_sp_nu_prod$ (pair$g (fst$g B$) (snd$g C_b_sp_nu$)))
  (B_c_b_sp_nu_prod_c_stream_prod$ (pair$h (fst$h B_c_b_sp_nu_prod$) (snd$h C_stream$)))
  (C_b_c_b_sp_nu_sp_mu_a_c_a_c_sp_nu_sp_mu_prod$ (pair$i (fst$i C_b_c_b_sp_nu_sp_mu$) (snd$i A_c_a_c_sp_nu_sp_mu$)))
  (B_bool_fun_b_stream_prod$ (pair$j (select$ B_bool_fun$) (selecta$ B_stream$)))))
(declare-fun b$ () C$)
