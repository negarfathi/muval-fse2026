...
(declare-datatypes () ((C_a_c_sp_nu_prod$ (pair$ (fst$ C$) (snd$ A_c_sp_nu$)))
  (C_a_c_sp_nu_prod_a_stream_prod$ (pair$a (fst$a C_a_c_sp_nu_prod$) (snd$a A_stream$)))
  (B_c_b_sp_nu_prod$ (pair$b (fst$b B$) (snd$b C_b_sp_nu$)))
  (B_c_b_sp_nu_prod_c_stream_prod$ (pair$c (fst$c B_c_b_sp_nu_prod$) (snd$c C_stream$)))
  (C_b_c_b_sp_nu_sp_mu_a_c_a_c_sp_nu_sp_mu_prod$ (pair$d (fst$d C_b_c_b_sp_nu_sp_mu$) (snd$d A_c_a_c_sp_nu_sp_mu$)))
  (A_c_a_c_sp_nu_sp_mu_a_c_a_c_sp_nu_sp_mu_prod$ (pair$e (fst$e A_c_a_c_sp_nu_sp_mu$) (snd$e A_c_a_c_sp_nu_sp_mu$)))
  (C_b_c_b_sp_nu_sp_mu_c_b_c_b_sp_nu_sp_mu_prod$ (pair$f (fst$f C_b_c_b_sp_nu_sp_mu$) (snd$f C_b_c_b_sp_nu_sp_mu$)))
...
(declare-datatypes () ((C_b_sp_nu_a_c_sp_nu_prod$ (pair$k (fst$k C_b_sp_nu$) (snd$k A_c_sp_nu$)))
  (A_bool_fun_a_stream_prod$ (pair$l (select$ A_bool_fun$) (selecta$ A_stream$)))
  (B_bool_fun_b_stream_prod$ (pair$m (selectb$ B_bool_fun$) (selectc$ B_stream$)))))
