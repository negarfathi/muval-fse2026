...
(assert (! (not (exists ((?v0 Dtree$) (?v1 Dtree$) (?v2 Dtree$)) (and (= trA$ (par$ (pair$ (par$ (pair$ ?v0 ?v1)) ?v2))) (= (par$ (pair$ tr1$ (par$ (pair$ tr2$ tr3$)))) (par$ (pair$ ?v0 (par$ (pair$ ?v1 ?v2)))))))) :named a0))
(assert (! (= trA$ (par$ (pair$ (par$ (pair$ tr1$ tr2$)) tr3$))) :named a1))
(assert (! (member$ (inr$ tr1$) (cont$ tr1a$)) :named a2))
(assert (! (member$ (inr$ tr2$) (cont$ tr2a$)) :named a3))
(assert (! (member$ (inr$ tr3$) (cont$ tr3a$)) :named a4))
(assert (! (exists ((?v0 Dtree$) (?v1 Dtree$) (?v2 Dtree$)) (and (= trA$a (par$ (pair$ (par$ (pair$ ?v0 ?v1)) ?v2))) (= trB$ (par$ (pair$ ?v0 (par$ (pair$ ?v1 ?v2))))))) :named a5))
(assert (! (member$ (inr$ tr1$) (cont$ tr1a$)) :named a6))
(assert (! (member$ (inr$ tr2$) (cont$ tr2a$)) :named a7))
(assert (! (member$ (inr$ tr3$) (cont$ tr3a$)) :named a8))
(assert (! (= trA$ (par$ (pair$ (par$ (pair$ tr1$ tr2$)) tr3$))) :named a9))
(assert (! (member$ (inr$ trA$) (cont$ (par$ (pair$ (par$ (pair$ tr1a$ tr2a$)) tr3a$)))) :named a10))
(assert (! (=> (forall ((?v0 Dtree$) (?v1 Dtree$) (?v2 Dtree$)) (=> (and (= trA$ (par$ (pair$ (par$ (pair$ ?v0 ?v1)) ?v2))) (and (member$ (inr$ ?v0) (cont$ tr1a$)) (and (member$ (inr$ ?v1) (cont$ tr2a$)) (member$ (inr$ ?v2) (cont$ tr3a$))))) false)) false) :named a11))
