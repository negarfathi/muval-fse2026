...
(assert (! (not (= (nplus$ (root$ tr1a$) (root$ tr2a$)) (nplus$ (root$ tr2a$) (root$ tr1a$)))) :named a0))
...
(assert (! (exists ((?v0 Dtree$) (?v1 Dtree$)) (and (= trA$ (par$ (pair$ ?v0 ?v1))) (= trB$ (par$ (pair$ ?v1 ?v0))))) :named a11))
