...
(declare-datatypes () ((Char_list_a_process_term$ (var$ (select$ A$)) (proc$ (selecta$ Char_list_process$)) (act$ (selectb$ Char_list$) (selectc$ Char_list_a_process_term$)) (ch$ (selectd$ Char_list_a_process_term$) (selecte$ Char_list_a_process_term$)))
  (A_char_list_a_process_term_fun_char_list_a_process_term_prod$ (pair$ (selecth$ A_char_list_a_process_term_fun$) (selecti$ Char_list_a_process_term$)))))
