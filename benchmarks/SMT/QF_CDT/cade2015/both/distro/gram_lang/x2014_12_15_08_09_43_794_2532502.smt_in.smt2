...
(assert (! (inFr$ nsa$ tr1$ ta$) :named a9))
(assert (! (forall ((?v0 Dtree$)) (! (= (hsubst_c$ tr0$ ?v0) (ite (= (root$ ?v0) (root$ tr0$)) (cont$ tr0$) (cont$ ?v0))) :pattern ((hsubst_c$ tr0$ ?v0)))) :named a10))
(assert (! (= (root$ tr1a$) (root$ tra$)) :named a11))
(assert (! (forall ((?v0 N_set$) (?v1 Dtree$) (?v2 T$)) (=> (inFr$ ?v0 ?v1 ?v2) (member$a (root$ ?v1) ?v0))) :named a12))
(assert (! (forall ((?v0 Dtree$) (?v1 N_set$) (?v2 T$)) (=> (and (member$a (root$ ?v0) ?v1) (member$b (inl$ ?v2) (cont$ ?v0))) (inFr$ ?v1 ?v0 ?v2))) :named a13))
(assert (! (forall ((?v0 Dtree$) (?v1 N_set$) (?v2 T$)) (=> (not (member$a (root$ ?v0) ?v1)) (not (inFr$ ?v1 ?v0 ?v2)))) :named a14))
(assert (! (forall ((?v0 Dtree$)) (=> (= tr1$ (hsubst$ tr0$ ?v0)) (or (member$ ta$ (vimage$ uu$ (cont$ tr0$))) (or (inFrr$ (fun_app$d (minus$ nsa$) (insert$ (root$ tr0$) bot$)) tr0$ ta$) (inFr$ (fun_app$d (minus$ nsa$) (insert$ (root$ tr0$) bot$)) ?v0 ta$))))) :named a15))
...
(assert (! (forall ((?v0 T_dtree_sum$)) (= (collect$ (uua$ ?v0)) (insert$a ?v0 bot$a))) :named a19))
(assert (! (forall ((?v0 T$)) (= (collect$a (uub$ ?v0)) (insert$b ?v0 bot$b))) :named a20))
(assert (! (forall ((?v0 N$)) (= (collect$b (uuc$ ?v0)) (insert$ ?v0 bot$))) :named a21))
(assert (! (forall ((?v0 T_dtree_sum$)) (= (collect$ (uud$ ?v0)) (insert$a ?v0 bot$a))) :named a22))
(assert (! (forall ((?v0 T$)) (= (collect$a (uue$ ?v0)) (insert$b ?v0 bot$b))) :named a23))
(assert (! (forall ((?v0 N$)) (= (collect$b (uuf$ ?v0)) (insert$ ?v0 bot$))) :named a24))
(assert (! (= tr1a$ (hsubst$ tr0$ tra$)) :named a25))
