; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 124
...
(assert (! (not (exists ((?v0 A_set$)) (and (exists ((?v1 Dtree$)) (and (= ?v0 (k$ ?v1)) (member$ (inr$ ?v1) (cont$ tr$)))) (member$a x$ ?v0)))) :named a0))
...
(assert (! (forall ((?v0 N_set$) (?v1 Dtree$) (?v2 T$)) (= (fun_app$b (fun_app$c (inFrr$ ?v0) ?v1) ?v2) (exists ((?v3 Dtree$)) (and (member$ (inr$ ?v3) (cont$ ?v1)) (fun_app$b (fun_app$c (inFr$ ?v0) ?v3) ?v2))))) :named a10))
(assert (! (forall ((?v0 T_bool_fun$) (?v1 Dtree_bool_fun$) (?v2 Dtree$)) (! (= (pred_sum$ ?v0 ?v1 (inr$ ?v2)) (fun_app$a ?v1 ?v2)) :pattern ((pred_sum$ ?v0 ?v1 (inr$ ?v2))))) :named a11))
(assert (! (forall ((?v0 T_dtree_sum$) (?v1 Dtree$)) (= (fun_app$a (setrp$ ?v0) ?v1) (exists ((?v2 Dtree$)) (and (= ?v1 ?v2) (= ?v0 (inr$ ?v2)))))) :named a12))
(assert (! (forall ((?v0 T_dtree_sum$) (?v1 Dtree$)) (=> (= ?v0 (inr$ ?v1)) (fun_app$a (setrp$ ?v0) ?v1))) :named a13))
(assert (! (forall ((?v0 T_dtree_sum$) (?v1 Dtree$)) (=> (and (fun_app$a (setrp$ ?v0) ?v1) (forall ((?v2 Dtree$)) (=> (and (= ?v1 ?v2) (= ?v0 (inr$ ?v2))) false))) false)) :named a14))
(check-sat)
;(get-unsat-core)
