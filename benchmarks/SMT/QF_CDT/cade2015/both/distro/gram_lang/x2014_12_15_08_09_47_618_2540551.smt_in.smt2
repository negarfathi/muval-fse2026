...
(assert (! (= (root$ tr1a$) (root$ tr0$)) :named a8))
(assert (! (member$a (root$ tr1a$) nsa$) :named a9))
(assert (! (inFr$ nsa$ tr1$ ta$) :named a10))
(assert (! (forall ((?v0 Dtree$)) (! (= (hsubst_c$ tr0$ ?v0) (ite (= (root$ ?v0) (root$ tr0$)) (cont$ tr0$) (cont$ ?v0))) :pattern ((hsubst_c$ tr0$ ?v0)))) :named a11))
...
(assert (! (= (root$ tr1a$) (root$ tra$)) :named a15))
...
(assert (! (forall ((?v0 Dtree$)) (=> (= tr1$ (hsubst$ tr0$ ?v0)) (or (member$ ta$ (vimage$ uu$ (cont$ tr0$))) (or (inFrr$ (fun_app$d (minus$ nsa$) (insert$ (root$ tr0$) bot$)) tr0$ ta$) (inFr$ (fun_app$d (minus$ nsa$) (insert$ (root$ tr0$) bot$)) ?v0 ta$))))) :named a19))
