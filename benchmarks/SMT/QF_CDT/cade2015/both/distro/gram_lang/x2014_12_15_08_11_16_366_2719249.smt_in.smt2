...
(assert (! (not (and (= (k$ (fun_app$ (subtrOf$ tr$) (fun_app$a root$ tr$a))) (k$ (fun_app$ (subtrOf$ tr$) (fun_app$a root$ tr$a)))) (member$ (inr$ (fun_app$a root$ tr$a)) (image$ (fun_app$b (map_sum$ id$) root$) (cont$ tr$))))) :named a0))
