...
(assert (! (forall ((?v0 Dtree$)) (=> (exists ((?v1 Dtree$)) (and (wf$ ?v1) (= ?v0 (fun_app$d (hsubst$ tr0$) ?v1)))) (wf$ ?v0))) :named a6))
...
(assert (! (forall ((?v0 T_dtree_sum_set_T_set_fun$) (?v1 T_dtree_sum_set_T_dtree_sum_set_fun$) (?v2 T_dtree_sum_set_T_set_fun$) (?v3 T_dtree_sum_set$)) (=> (= (fun_app$v (comp$a ?v0) ?v1) ?v2) (= (fun_app$i ?v0 (fun_app$n ?v1 ?v3)) (fun_app$i ?v2 ?v3)))) :named a73))
(assert (! (forall ((?v0 Dtree_set_dtree_set_fun$) (?v1 N_set_dtree_set_fun$) (?v2 N_set_dtree_set_fun$) (?v3 N_set$)) (=> (= (fun_app$w (comp$b ?v0) ?v1) ?v2) (= (fun_app$r ?v0 (fun_app$s ?v1 ?v3)) (fun_app$s ?v2 ?v3)))) :named a74))
(assert (! (forall ((?v0 T_set_T_set_fun$) (?v1 T_dtree_sum_set_T_set_fun$) (?v2 T_dtree_sum_set_T_set_fun$) (?v3 T_dtree_sum_set$)) (=> (= (fun_app$x (comp$c ?v0) ?v1) ?v2) (= (fun_app$t ?v0 (fun_app$i ?v1 ?v3)) (fun_app$i ?v2 ?v3)))) :named a75))
(assert (! (forall ((?v0 T_T_dtree_sum_fun$) (?v1 T_T_fun$) (?v2 T_T_dtree_sum_fun$) (?v3 T$)) (=> (= (fun_app$y (comp$d ?v0) ?v1) ?v2) (= (fun_app$ ?v0 (fun_app$u ?v1 ?v3)) (fun_app$ ?v2 ?v3)))) :named a76))
(assert (! (forall ((?v0 N_N_fun$) (?v1 Dtree_N_fun$) (?v2 Dtree_N_fun$) (?v3 Dtree$)) (=> (= (fun_app$z (comp$e ?v0) ?v1) ?v2) (= (fun_app$k ?v0 (fun_app$e ?v1 ?v3)) (fun_app$e ?v2 ?v3)))) :named a77))
(assert (! (forall ((?v0 Dtree_N_fun$) (?v1 Dtree_dtree_fun$) (?v2 Dtree_N_fun$) (?v3 Dtree$)) (=> (= (fun_app$h (comp$ ?v0) ?v1) ?v2) (= (fun_app$e ?v0 (fun_app$d ?v1 ?v3)) (fun_app$e ?v2 ?v3)))) :named a78))
(assert (! (forall ((?v0 Dtree_N_fun$) (?v1 Dtree_dtree_fun$) (?v2 N_N_fun$) (?v3 Dtree_N_fun$) (?v4 Dtree$)) (=> (= (fun_app$h (comp$ ?v0) ?v1) (fun_app$z (comp$e ?v2) ?v3)) (= (fun_app$e ?v0 (fun_app$d ?v1 ?v4)) (fun_app$k ?v2 (fun_app$e ?v3 ?v4))))) :named a79))
(assert (! (forall ((?v0 T_dtree_sum_set_T_set_fun$) (?v1 T_dtree_sum_set_T_dtree_sum_set_fun$) (?v2 T_dtree_sum_set_T_set_fun$) (?v3 T_dtree_sum_set_T_dtree_sum_set_fun$) (?v4 T_dtree_sum_set$)) (=> (= (fun_app$v (comp$a ?v0) ?v1) (fun_app$v (comp$a ?v2) ?v3)) (= (fun_app$i ?v0 (fun_app$n ?v1 ?v4)) (fun_app$i ?v2 (fun_app$n ?v3 ?v4))))) :named a80))
(assert (! (forall ((?v0 T_dtree_sum_set_T_set_fun$) (?v1 T_dtree_sum_set_T_dtree_sum_set_fun$) (?v2 T_set_T_set_fun$) (?v3 T_dtree_sum_set_T_set_fun$) (?v4 T_dtree_sum_set$)) (=> (= (fun_app$v (comp$a ?v0) ?v1) (fun_app$x (comp$c ?v2) ?v3)) (= (fun_app$i ?v0 (fun_app$n ?v1 ?v4)) (fun_app$t ?v2 (fun_app$i ?v3 ?v4))))) :named a81))
(assert (! (forall ((?v0 Dtree_set_dtree_set_fun$) (?v1 N_set_dtree_set_fun$) (?v2 Dtree_set_dtree_set_fun$) (?v3 N_set_dtree_set_fun$) (?v4 N_set$)) (=> (= (fun_app$w (comp$b ?v0) ?v1) (fun_app$w (comp$b ?v2) ?v3)) (= (fun_app$r ?v0 (fun_app$s ?v1 ?v4)) (fun_app$r ?v2 (fun_app$s ?v3 ?v4))))) :named a82))
(assert (! (forall ((?v0 T_set_T_set_fun$) (?v1 T_dtree_sum_set_T_set_fun$) (?v2 T_dtree_sum_set_T_set_fun$) (?v3 T_dtree_sum_set_T_dtree_sum_set_fun$) (?v4 T_dtree_sum_set$)) (=> (= (fun_app$x (comp$c ?v0) ?v1) (fun_app$v (comp$a ?v2) ?v3)) (= (fun_app$t ?v0 (fun_app$i ?v1 ?v4)) (fun_app$i ?v2 (fun_app$n ?v3 ?v4))))) :named a83))
(assert (! (forall ((?v0 T_set_T_set_fun$) (?v1 T_dtree_sum_set_T_set_fun$) (?v2 T_set_T_set_fun$) (?v3 T_dtree_sum_set_T_set_fun$) (?v4 T_dtree_sum_set$)) (=> (= (fun_app$x (comp$c ?v0) ?v1) (fun_app$x (comp$c ?v2) ?v3)) (= (fun_app$t ?v0 (fun_app$i ?v1 ?v4)) (fun_app$t ?v2 (fun_app$i ?v3 ?v4))))) :named a84))
(assert (! (forall ((?v0 T_T_dtree_sum_fun$) (?v1 T_T_fun$) (?v2 T_T_dtree_sum_fun$) (?v3 T_T_fun$) (?v4 T$)) (=> (= (fun_app$y (comp$d ?v0) ?v1) (fun_app$y (comp$d ?v2) ?v3)) (= (fun_app$ ?v0 (fun_app$u ?v1 ?v4)) (fun_app$ ?v2 (fun_app$u ?v3 ?v4))))) :named a85))
(assert (! (forall ((?v0 N_N_fun$) (?v1 Dtree_N_fun$) (?v2 Dtree_N_fun$) (?v3 Dtree_dtree_fun$) (?v4 Dtree$)) (=> (= (fun_app$z (comp$e ?v0) ?v1) (fun_app$h (comp$ ?v2) ?v3)) (= (fun_app$k ?v0 (fun_app$e ?v1 ?v4)) (fun_app$e ?v2 (fun_app$d ?v3 ?v4))))) :named a86))
(assert (! (forall ((?v0 N_N_fun$) (?v1 Dtree_N_fun$) (?v2 N_N_fun$) (?v3 Dtree_N_fun$) (?v4 Dtree$)) (=> (= (fun_app$z (comp$e ?v0) ?v1) (fun_app$z (comp$e ?v2) ?v3)) (= (fun_app$k ?v0 (fun_app$e ?v1 ?v4)) (fun_app$k ?v2 (fun_app$e ?v3 ?v4))))) :named a87))
(assert (! (forall ((?v0 Dtree_N_fun$) (?v1 Dtree_dtree_fun$) (?v2 Dtree_N_fun$) (?v3 Dtree_dtree_fun$) (?v4 Dtree$)) (=> (= (fun_app$h (comp$ ?v0) ?v1) (fun_app$h (comp$ ?v2) ?v3)) (= (fun_app$e ?v0 (fun_app$d ?v1 ?v4)) (fun_app$e ?v2 (fun_app$d ?v3 ?v4))))) :named a88))
(assert (! (forall ((?v0 Dtree_N_fun$) (?v1 Dtree_dtree_fun$) (?v2 N_N_fun$) (?v3 Dtree_N_fun$)) (=> (and (= (fun_app$h (comp$ ?v0) ?v1) (fun_app$z (comp$e ?v2) ?v3)) (=> (forall ((?v4 Dtree$)) (= (fun_app$e ?v0 (fun_app$d ?v1 ?v4)) (fun_app$k ?v2 (fun_app$e ?v3 ?v4)))) false)) false)) :named a89))
(assert (! (forall ((?v0 T_dtree_sum_set_T_set_fun$) (?v1 T_dtree_sum_set_T_dtree_sum_set_fun$) (?v2 T_dtree_sum_set_T_set_fun$) (?v3 T_dtree_sum_set_T_dtree_sum_set_fun$)) (=> (and (= (fun_app$v (comp$a ?v0) ?v1) (fun_app$v (comp$a ?v2) ?v3)) (=> (forall ((?v4 T_dtree_sum_set$)) (= (fun_app$i ?v0 (fun_app$n ?v1 ?v4)) (fun_app$i ?v2 (fun_app$n ?v3 ?v4)))) false)) false)) :named a90))
(assert (! (forall ((?v0 T_dtree_sum_set_T_set_fun$) (?v1 T_dtree_sum_set_T_dtree_sum_set_fun$) (?v2 T_set_T_set_fun$) (?v3 T_dtree_sum_set_T_set_fun$)) (=> (and (= (fun_app$v (comp$a ?v0) ?v1) (fun_app$x (comp$c ?v2) ?v3)) (=> (forall ((?v4 T_dtree_sum_set$)) (= (fun_app$i ?v0 (fun_app$n ?v1 ?v4)) (fun_app$t ?v2 (fun_app$i ?v3 ?v4)))) false)) false)) :named a91))
(assert (! (forall ((?v0 Dtree_set_dtree_set_fun$) (?v1 N_set_dtree_set_fun$) (?v2 Dtree_set_dtree_set_fun$) (?v3 N_set_dtree_set_fun$)) (=> (and (= (fun_app$w (comp$b ?v0) ?v1) (fun_app$w (comp$b ?v2) ?v3)) (=> (forall ((?v4 N_set$)) (= (fun_app$r ?v0 (fun_app$s ?v1 ?v4)) (fun_app$r ?v2 (fun_app$s ?v3 ?v4)))) false)) false)) :named a92))
(assert (! (forall ((?v0 T_set_T_set_fun$) (?v1 T_dtree_sum_set_T_set_fun$) (?v2 T_dtree_sum_set_T_set_fun$) (?v3 T_dtree_sum_set_T_dtree_sum_set_fun$)) (=> (and (= (fun_app$x (comp$c ?v0) ?v1) (fun_app$v (comp$a ?v2) ?v3)) (=> (forall ((?v4 T_dtree_sum_set$)) (= (fun_app$t ?v0 (fun_app$i ?v1 ?v4)) (fun_app$i ?v2 (fun_app$n ?v3 ?v4)))) false)) false)) :named a93))
(assert (! (forall ((?v0 T_set_T_set_fun$) (?v1 T_dtree_sum_set_T_set_fun$) (?v2 T_set_T_set_fun$) (?v3 T_dtree_sum_set_T_set_fun$)) (=> (and (= (fun_app$x (comp$c ?v0) ?v1) (fun_app$x (comp$c ?v2) ?v3)) (=> (forall ((?v4 T_dtree_sum_set$)) (= (fun_app$t ?v0 (fun_app$i ?v1 ?v4)) (fun_app$t ?v2 (fun_app$i ?v3 ?v4)))) false)) false)) :named a94))
(assert (! (forall ((?v0 T_T_dtree_sum_fun$) (?v1 T_T_fun$) (?v2 T_T_dtree_sum_fun$) (?v3 T_T_fun$)) (=> (and (= (fun_app$y (comp$d ?v0) ?v1) (fun_app$y (comp$d ?v2) ?v3)) (=> (forall ((?v4 T$)) (= (fun_app$ ?v0 (fun_app$u ?v1 ?v4)) (fun_app$ ?v2 (fun_app$u ?v3 ?v4)))) false)) false)) :named a95))
(assert (! (forall ((?v0 N_N_fun$) (?v1 Dtree_N_fun$) (?v2 Dtree_N_fun$) (?v3 Dtree_dtree_fun$)) (=> (and (= (fun_app$z (comp$e ?v0) ?v1) (fun_app$h (comp$ ?v2) ?v3)) (=> (forall ((?v4 Dtree$)) (= (fun_app$k ?v0 (fun_app$e ?v1 ?v4)) (fun_app$e ?v2 (fun_app$d ?v3 ?v4)))) false)) false)) :named a96))
(assert (! (forall ((?v0 N_N_fun$) (?v1 Dtree_N_fun$) (?v2 N_N_fun$) (?v3 Dtree_N_fun$)) (=> (and (= (fun_app$z (comp$e ?v0) ?v1) (fun_app$z (comp$e ?v2) ?v3)) (=> (forall ((?v4 Dtree$)) (= (fun_app$k ?v0 (fun_app$e ?v1 ?v4)) (fun_app$k ?v2 (fun_app$e ?v3 ?v4)))) false)) false)) :named a97))
(assert (! (forall ((?v0 Dtree_N_fun$) (?v1 Dtree_dtree_fun$) (?v2 Dtree_N_fun$) (?v3 Dtree_dtree_fun$)) (=> (and (= (fun_app$h (comp$ ?v0) ?v1) (fun_app$h (comp$ ?v2) ?v3)) (=> (forall ((?v4 Dtree$)) (= (fun_app$e ?v0 (fun_app$d ?v1 ?v4)) (fun_app$e ?v2 (fun_app$d ?v3 ?v4)))) false)) false)) :named a98))
(assert (! (forall ((?v0 T_dtree_sum_set_T_set_fun$) (?v1 T_dtree_sum_set_T_dtree_sum_set_fun$) (?v2 T_dtree_sum_set$)) (! (= (fun_app$i (fun_app$v (comp$a ?v0) ?v1) ?v2) (fun_app$i ?v0 (fun_app$n ?v1 ?v2))) :pattern ((fun_app$i (fun_app$v (comp$a ?v0) ?v1) ?v2)))) :named a99))
(assert (! (forall ((?v0 Dtree_set_dtree_set_fun$) (?v1 N_set_dtree_set_fun$) (?v2 N_set$)) (! (= (fun_app$s (fun_app$w (comp$b ?v0) ?v1) ?v2) (fun_app$r ?v0 (fun_app$s ?v1 ?v2))) :pattern ((fun_app$s (fun_app$w (comp$b ?v0) ?v1) ?v2)))) :named a100))
(assert (! (forall ((?v0 T_set_T_set_fun$) (?v1 T_dtree_sum_set_T_set_fun$) (?v2 T_dtree_sum_set$)) (! (= (fun_app$i (fun_app$x (comp$c ?v0) ?v1) ?v2) (fun_app$t ?v0 (fun_app$i ?v1 ?v2))) :pattern ((fun_app$i (fun_app$x (comp$c ?v0) ?v1) ?v2)))) :named a101))
(assert (! (forall ((?v0 T_T_dtree_sum_fun$) (?v1 T_T_fun$) (?v2 T$)) (! (= (fun_app$ (fun_app$y (comp$d ?v0) ?v1) ?v2) (fun_app$ ?v0 (fun_app$u ?v1 ?v2))) :pattern ((fun_app$ (fun_app$y (comp$d ?v0) ?v1) ?v2)))) :named a102))
(assert (! (forall ((?v0 N_N_fun$) (?v1 Dtree_N_fun$) (?v2 Dtree$)) (! (= (fun_app$e (fun_app$z (comp$e ?v0) ?v1) ?v2) (fun_app$k ?v0 (fun_app$e ?v1 ?v2))) :pattern ((fun_app$e (fun_app$z (comp$e ?v0) ?v1) ?v2)))) :named a103))
(assert (! (forall ((?v0 Dtree_N_fun$) (?v1 Dtree_dtree_fun$) (?v2 Dtree$)) (! (= (fun_app$e (fun_app$h (comp$ ?v0) ?v1) ?v2) (fun_app$e ?v0 (fun_app$d ?v1 ?v2))) :pattern ((fun_app$e (fun_app$h (comp$ ?v0) ?v1) ?v2)))) :named a104))
(assert (! (forall ((?v0 N_N_fun$) (?v1 Dtree_N_fun$) (?v2 Dtree_dtree_fun$)) (= (fun_app$h (comp$ (fun_app$z (comp$e ?v0) ?v1)) ?v2) (fun_app$z (comp$e ?v0) (fun_app$h (comp$ ?v1) ?v2)))) :named a105))
(assert (! (forall ((?v0 Dtree_N_fun$) (?v1 Dtree_dtree_fun$) (?v2 Dtree_dtree_fun$)) (= (fun_app$h (comp$ (fun_app$h (comp$ ?v0) ?v1)) ?v2) (fun_app$h (comp$ ?v0) (fun_app$ac (comp$h ?v1) ?v2)))) :named a106))
(assert (! (forall ((?v0 Dtree_N_fun$) (?v1 N_dtree_fun$) (?v2 Dtree_N_fun$)) (= (fun_app$z (comp$e (fun_app$ab (comp$g ?v0) ?v1)) ?v2) (fun_app$h (comp$ ?v0) (fun_app$ad (comp$i ?v1) ?v2)))) :named a107))
(assert (! (forall ((?v0 N_N_fun$) (?v1 N_N_fun$) (?v2 Dtree_N_fun$)) (= (fun_app$z (comp$e (fun_app$af (comp$k ?v0) ?v1)) ?v2) (fun_app$z (comp$e ?v0) (fun_app$z (comp$e ?v1) ?v2)))) :named a108))
(assert (! (forall ((?v0 T_T_dtree_sum_fun$) (?v1 T_T_fun$) (?v2 T_T_fun$)) (= (fun_app$y (comp$d (fun_app$y (comp$d ?v0) ?v1)) ?v2) (fun_app$y (comp$d ?v0) (fun_app$ae (comp$j ?v1) ?v2)))) :named a109))
(assert (! (forall ((?v0 Dtree_set_dtree_set_fun$) (?v1 N_set_dtree_set_fun$) (?v2 N_set_N_set_fun$)) (= (fun_app$ah (comp$m (fun_app$w (comp$b ?v0) ?v1)) ?v2) (fun_app$w (comp$b ?v0) (fun_app$ah (comp$m ?v1) ?v2)))) :named a110))
(assert (! (forall ((?v0 Dtree_set_dtree_set_fun$) (?v1 Dtree_set_dtree_set_fun$) (?v2 N_set_dtree_set_fun$)) (= (fun_app$w (comp$b (fun_app$ai (comp$n ?v0) ?v1)) ?v2) (fun_app$w (comp$b ?v0) (fun_app$w (comp$b ?v1) ?v2)))) :named a111))
(assert (! (forall ((?v0 T_dtree_sum_T_dtree_sum_fun$) (?v1 T_T_dtree_sum_fun$) (?v2 T_T_fun$)) (= (fun_app$y (comp$d (fun_app$aa (comp$f ?v0) ?v1)) ?v2) (fun_app$aa (comp$f ?v0) (fun_app$y (comp$d ?v1) ?v2)))) :named a112))
(assert (! (forall ((?v0 T_set_T_set_fun$) (?v1 T_set_T_set_fun$) (?v2 T_dtree_sum_set_T_set_fun$)) (= (fun_app$x (comp$c (fun_app$aj (comp$o ?v0) ?v1)) ?v2) (fun_app$x (comp$c ?v0) (fun_app$x (comp$c ?v1) ?v2)))) :named a113))
(assert (! (forall ((?v0 T_set_T_set_fun$) (?v1 T_dtree_sum_set_T_set_fun$) (?v2 T_dtree_sum_set_T_dtree_sum_set_fun$)) (= (fun_app$v (comp$a (fun_app$x (comp$c ?v0) ?v1)) ?v2) (fun_app$x (comp$c ?v0) (fun_app$v (comp$a ?v1) ?v2)))) :named a114))
(assert (! (forall ((?v0 N_N_fun$) (?v1 N$) (?v2 N_set$)) (=> (member$b (fun_app$k ?v0 ?v1) ?v2) (member$b ?v1 (fun_app$j (vimage$a ?v0) ?v2)))) :named a115))
(assert (! (forall ((?v0 T_dtree_sum_N_fun$) (?v1 T_dtree_sum$) (?v2 N_set$)) (=> (member$b (fun_app$m ?v0 ?v1) ?v2) (member$ ?v1 (vimage$c ?v0 ?v2)))) :named a116))
(assert (! (forall ((?v0 N_T_dtree_sum_fun$) (?v1 N$) (?v2 T_dtree_sum_set$)) (=> (member$ (fun_app$l ?v0 ?v1) ?v2) (member$b ?v1 (vimage$b ?v0 ?v2)))) :named a117))
(assert (! (forall ((?v0 T_T_dtree_sum_fun$) (?v1 T$) (?v2 T_dtree_sum_set$)) (=> (member$ (fun_app$ ?v0 ?v1) ?v2) (member$a ?v1 (fun_app$i (vimage$ ?v0) ?v2)))) :named a118))
(assert (! (forall ((?v0 T_dtree_sum_T_dtree_sum_fun$) (?v1 T_dtree_sum$) (?v2 T_dtree_sum_set$)) (=> (member$ (fun_app$o ?v0 ?v1) ?v2) (member$ ?v1 (fun_app$n (vimage$d ?v0) ?v2)))) :named a119))
(assert (! (forall ((?v0 T_N_fun$) (?v1 T$) (?v2 N_set$)) (=> (member$b (fun_app$q ?v0 ?v1) ?v2) (member$a ?v1 (vimage$f ?v0 ?v2)))) :named a120))
(assert (! (forall ((?v0 N_T_fun$) (?v1 N$) (?v2 T_set$)) (=> (member$a (fun_app$p ?v0 ?v1) ?v2) (member$b ?v1 (vimage$e ?v0 ?v2)))) :named a121))
(assert (! (forall ((?v0 Dtree_dtree_fun$) (?v1 Dtree$) (?v2 Dtree_set$)) (=> (member$c (fun_app$d ?v0 ?v1) ?v2) (member$c ?v1 (fun_app$r (vimage$g ?v0) ?v2)))) :named a122))
(assert (! (forall ((?v0 Dtree_N_fun$) (?v1 Dtree$) (?v2 N_set$)) (=> (member$b (fun_app$e ?v0 ?v1) ?v2) (member$c ?v1 (fun_app$s (vimage$h ?v0) ?v2)))) :named a123))
(assert (! (forall ((?v0 T_T_fun$) (?v1 T$) (?v2 T_set$)) (=> (member$a (fun_app$u ?v0 ?v1) ?v2) (member$a ?v1 (fun_app$t (vimage$i ?v0) ?v2)))) :named a124))
(assert (! (forall ((?v0 T_dtree_sum_bool_fun$) (?v1 T_dtree_sum_bool_fun$)) (=> (forall ((?v2 T_dtree_sum$)) (= (fun_app$a ?v0 ?v2) (fun_app$a ?v1 ?v2))) (= (collect$ ?v0) (collect$ ?v1)))) :named a125))
(assert (! (forall ((?v0 N_bool_fun$) (?v1 N_bool_fun$)) (=> (forall ((?v2 N$)) (= (fun_app$c ?v0 ?v2) (fun_app$c ?v1 ?v2))) (= (collect$a ?v0) (collect$a ?v1)))) :named a126))
(assert (! (forall ((?v0 T_bool_fun$) (?v1 T_bool_fun$)) (=> (forall ((?v2 T$)) (= (fun_app$b ?v0 ?v2) (fun_app$b ?v1 ?v2))) (= (collect$b ?v0) (collect$b ?v1)))) :named a127))
(assert (! (forall ((?v0 T_set$)) (= (collect$b (uua$ ?v0)) ?v0)) :named a128))
(assert (! (forall ((?v0 N_set$)) (= (collect$a (uub$ ?v0)) ?v0)) :named a129))
(assert (! (forall ((?v0 T_dtree_sum_set$)) (= (collect$ (uuc$ ?v0)) ?v0)) :named a130))
(assert (! (forall ((?v0 T$) (?v1 T_bool_fun$)) (= (member$a ?v0 (collect$b ?v1)) (fun_app$b ?v1 ?v0))) :named a131))
(assert (! (forall ((?v0 N$) (?v1 N_bool_fun$)) (= (member$b ?v0 (collect$a ?v1)) (fun_app$c ?v1 ?v0))) :named a132))
(assert (! (forall ((?v0 T_dtree_sum$) (?v1 T_dtree_sum_bool_fun$)) (= (member$ ?v0 (collect$ ?v1)) (fun_app$a ?v1 ?v0))) :named a133))
(assert (! (forall ((?v0 N$) (?v1 N_N_fun$) (?v2 N_set$)) (=> (member$b ?v0 (fun_app$j (vimage$a ?v1) ?v2)) (member$b (fun_app$k ?v1 ?v0) ?v2))) :named a134))
(assert (! (forall ((?v0 N$) (?v1 N_T_dtree_sum_fun$) (?v2 T_dtree_sum_set$)) (=> (member$b ?v0 (vimage$b ?v1 ?v2)) (member$ (fun_app$l ?v1 ?v0) ?v2))) :named a135))
(assert (! (forall ((?v0 T_dtree_sum$) (?v1 T_dtree_sum_N_fun$) (?v2 N_set$)) (=> (member$ ?v0 (vimage$c ?v1 ?v2)) (member$b (fun_app$m ?v1 ?v0) ?v2))) :named a136))
(assert (! (forall ((?v0 T$) (?v1 T_T_dtree_sum_fun$) (?v2 T_dtree_sum_set$)) (=> (member$a ?v0 (fun_app$i (vimage$ ?v1) ?v2)) (member$ (fun_app$ ?v1 ?v0) ?v2))) :named a137))
(assert (! (forall ((?v0 T_dtree_sum$) (?v1 T_dtree_sum_T_dtree_sum_fun$) (?v2 T_dtree_sum_set$)) (=> (member$ ?v0 (fun_app$n (vimage$d ?v1) ?v2)) (member$ (fun_app$o ?v1 ?v0) ?v2))) :named a138))
(assert (! (forall ((?v0 N$) (?v1 N_T_fun$) (?v2 T_set$)) (=> (member$b ?v0 (vimage$e ?v1 ?v2)) (member$a (fun_app$p ?v1 ?v0) ?v2))) :named a139))
(assert (! (forall ((?v0 T$) (?v1 T_N_fun$) (?v2 N_set$)) (=> (member$a ?v0 (vimage$f ?v1 ?v2)) (member$b (fun_app$q ?v1 ?v0) ?v2))) :named a140))
(assert (! (forall ((?v0 Dtree$) (?v1 Dtree_dtree_fun$) (?v2 Dtree_set$)) (=> (member$c ?v0 (fun_app$r (vimage$g ?v1) ?v2)) (member$c (fun_app$d ?v1 ?v0) ?v2))) :named a141))
(assert (! (forall ((?v0 Dtree$) (?v1 Dtree_N_fun$) (?v2 N_set$)) (=> (member$c ?v0 (fun_app$s (vimage$h ?v1) ?v2)) (member$b (fun_app$e ?v1 ?v0) ?v2))) :named a142))
(assert (! (forall ((?v0 T$) (?v1 T_T_fun$) (?v2 T_set$)) (=> (member$a ?v0 (fun_app$t (vimage$i ?v1) ?v2)) (member$a (fun_app$u ?v1 ?v0) ?v2))) :named a143))
(assert (! (forall ((?v0 Dtree$) (?v1 Dtree_N_fun$) (?v2 N_set$)) (=> (and (member$c ?v0 (fun_app$s (vimage$h ?v1) ?v2)) (forall ((?v3 N$)) (=> (and (= (fun_app$e ?v1 ?v0) ?v3) (member$b ?v3 ?v2)) false))) false)) :named a144))
(assert (! (forall ((?v0 T$) (?v1 T_T_fun$) (?v2 T_set$)) (=> (and (member$a ?v0 (fun_app$t (vimage$i ?v1) ?v2)) (forall ((?v3 T$)) (=> (and (= (fun_app$u ?v1 ?v0) ?v3) (member$a ?v3 ?v2)) false))) false)) :named a145))
(assert (! (forall ((?v0 N$) (?v1 N_N_fun$) (?v2 N_set$)) (=> (and (member$b ?v0 (fun_app$j (vimage$a ?v1) ?v2)) (forall ((?v3 N$)) (=> (and (= (fun_app$k ?v1 ?v0) ?v3) (member$b ?v3 ?v2)) false))) false)) :named a146))
(assert (! (forall ((?v0 N$) (?v1 N_T_dtree_sum_fun$) (?v2 T_dtree_sum_set$)) (=> (and (member$b ?v0 (vimage$b ?v1 ?v2)) (forall ((?v3 T_dtree_sum$)) (=> (and (= (fun_app$l ?v1 ?v0) ?v3) (member$ ?v3 ?v2)) false))) false)) :named a147))
(assert (! (forall ((?v0 T_dtree_sum$) (?v1 T_dtree_sum_N_fun$) (?v2 N_set$)) (=> (and (member$ ?v0 (vimage$c ?v1 ?v2)) (forall ((?v3 N$)) (=> (and (= (fun_app$m ?v1 ?v0) ?v3) (member$b ?v3 ?v2)) false))) false)) :named a148))
(assert (! (forall ((?v0 T_dtree_sum$) (?v1 T_dtree_sum_T_dtree_sum_fun$) (?v2 T_dtree_sum_set$)) (=> (and (member$ ?v0 (fun_app$n (vimage$d ?v1) ?v2)) (forall ((?v3 T_dtree_sum$)) (=> (and (= (fun_app$o ?v1 ?v0) ?v3) (member$ ?v3 ?v2)) false))) false)) :named a149))
(assert (! (forall ((?v0 T$) (?v1 T_T_dtree_sum_fun$) (?v2 T_dtree_sum_set$)) (=> (and (member$a ?v0 (fun_app$i (vimage$ ?v1) ?v2)) (forall ((?v3 T_dtree_sum$)) (=> (and (= (fun_app$ ?v1 ?v0) ?v3) (member$ ?v3 ?v2)) false))) false)) :named a150))
(assert (! (forall ((?v0 T_dtree_sum_bool_fun$) (?v1 T_T_dtree_sum_fun$) (?v2 T_bool_fun$)) (=> (forall ((?v3 T$)) (= (fun_app$a ?v0 (fun_app$ ?v1 ?v3)) (fun_app$b ?v2 ?v3))) (= (fun_app$i (vimage$ ?v1) (collect$ ?v0)) (collect$b ?v2)))) :named a151))
(assert (! (forall ((?v0 T$) (?v1 T$)) (=> (= (inl$ ?v0) (inl$ ?v1)) (= ?v0 ?v1))) :named a152))
(assert (! (forall ((?v0 Dtree_dtree_fun$) (?v1 Dtree_N_fun$)) (= (fun_app$w (comp$b (vimage$g ?v0)) (vimage$h ?v1)) (vimage$h (fun_app$h (comp$ ?v1) ?v0)))) :named a153))
(assert (! (forall ((?v0 T_T_fun$) (?v1 T_T_dtree_sum_fun$)) (= (fun_app$x (comp$c (vimage$i ?v0)) (vimage$ ?v1)) (vimage$ (fun_app$y (comp$d ?v1) ?v0)))) :named a154))
(assert (! (forall ((?v0 T_T_dtree_sum_fun$) (?v1 T_dtree_sum_T_dtree_sum_fun$)) (= (fun_app$v (comp$a (vimage$ ?v0)) (vimage$d ?v1)) (vimage$ (fun_app$aa (comp$f ?v1) ?v0)))) :named a155))
(assert (! (forall ((?v0 Dtree_dtree_fun$) (?v1 Dtree_N_fun$) (?v2 N_set$)) (= (fun_app$r (vimage$g ?v0) (fun_app$s (vimage$h ?v1) ?v2)) (fun_app$s (vimage$h (fun_app$h (comp$ ?v1) ?v0)) ?v2))) :named a156))
(assert (! (forall ((?v0 T_T_fun$) (?v1 T_T_dtree_sum_fun$) (?v2 T_dtree_sum_set$)) (= (fun_app$t (vimage$i ?v0) (fun_app$i (vimage$ ?v1) ?v2)) (fun_app$i (vimage$ (fun_app$y (comp$d ?v1) ?v0)) ?v2))) :named a157))
(assert (! (forall ((?v0 T_T_dtree_sum_fun$) (?v1 T_dtree_sum_T_dtree_sum_fun$) (?v2 T_dtree_sum_set$)) (= (fun_app$i (vimage$ ?v0) (fun_app$n (vimage$d ?v1) ?v2)) (fun_app$i (vimage$ (fun_app$aa (comp$f ?v1) ?v0)) ?v2))) :named a158))
