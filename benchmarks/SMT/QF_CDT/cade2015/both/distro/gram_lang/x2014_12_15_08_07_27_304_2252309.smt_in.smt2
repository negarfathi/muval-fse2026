; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 42
...
(declare-datatypes () ((N_T_N_sum_set_prod$ (pair$ (fst$ N$) (snd$ T_N_sum_set$)))
  ...
  (T_set_dtree_sum$ (inl$e (projl$e T_set$)) (inr$e (projr$e Dtree$)))
  (T_set_N_sum$ (inl$f (projl$f T_set$)) (inr$f (projr$f N$)))
