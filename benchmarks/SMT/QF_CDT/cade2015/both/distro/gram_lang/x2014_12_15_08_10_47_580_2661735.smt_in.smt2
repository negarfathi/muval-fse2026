...
(declare-datatypes () ((N_N_sum$ (inl$ (projl$ N$)) (inr$ (projr$ N$)))
  (N_N_sum_N_sum$ (inl$a (projl$a N_N_sum$)) (inr$a (projr$a N$)))
  (N_option$ (none$) (some$ (the$ N$)))
  (N_N_option_sum$ (inl$b (projl$b N$)) (inr$b (projr$b N_option$)))
  (N_N_N_sum_sum$ (inl$c (projl$c N$)) (inr$c (projr$c N_N_sum$)))))
