...
(assert (! (not (forall ((?v0 A$)) (=> (fun_app$ (inItr$ ns$ tr$) n$) (fun_app$ (inItr$ ns$ tr1$) n$)))) :named a0))
(assert (! (fun_app$a (fun_app$b (fun_app$c subtr$ ns$) tr$) tr1$) :named a1))
(assert (! (fun_app$a (fun_app$b (fun_app$c subtr$ ns$) tr$) tr1$) :named a2))
(assert (! (fun_app$ (inItr$ ns$ tr$) n$) :named a3))
