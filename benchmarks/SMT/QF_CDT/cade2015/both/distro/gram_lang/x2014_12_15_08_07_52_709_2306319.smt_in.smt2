...
(assert (! (forall ((?v0 N_set$) (?v1 Dtree$) (?v2 Dtree$)) (=> (fun_app$ (subtr$ ?v0 ?v1) ?v2) (member$a (root$ ?v1) ?v0))) :named a18))
(assert (! (forall ((?v0 N_set$) (?v1 Dtree$) (?v2 Dtree$)) (=> (fun_app$ (subtr$ ?v0 ?v1) ?v2) (member$a (root$ ?v2) ?v0))) :named a19))
(assert (! (forall ((?v0 T_dtree_sum$)) (member$ ?v0 top$a)) :named a20))
(assert (! (forall ((?v0 N$)) (member$a ?v0 top$)) :named a21))
(assert (! (forall ((?v0 T_dtree_sum$)) (= (member$ ?v0 top$a) true)) :named a22))
(assert (! (forall ((?v0 N$)) (= (member$a ?v0 top$) true)) :named a23))
(assert (! (forall ((?v0 T_dtree_sum$)) (! (= (fun_app$c top$b ?v0) top$c) :pattern ((fun_app$c top$b ?v0)))) :named a24))
(assert (! (forall ((?v0 N$)) (! (= (fun_app$d top$d ?v0) top$c) :pattern ((fun_app$d top$d ?v0)))) :named a25))
(assert (! (forall ((?v0 Dtree$) (?v1 Dtree$)) (=> (and (= (root$ ?v0) (root$ ?v1)) (= (cont$ ?v0) (cont$ ?v1))) (= ?v0 ?v1))) :named a26))
(assert (! (forall ((?v0 N_set$) (?v1 Dtree$) (?v2 T$) (?v3 Dtree$)) (=> (and (fun_app$e (fun_app$f (fun_app$g inFr2$ ?v0) ?v1) ?v2) (and (member$a (root$ ?v3) ?v0) (member$ (inr$ ?v1) (cont$ ?v3)))) (fun_app$e (fun_app$f (fun_app$g inFr2$ ?v0) ?v3) ?v2))) :named a27))
(assert (! (forall ((?v0 Dtree$) (?v1 N_set$) (?v2 Dtree$) (?v3 N$)) (=> (and (member$a (root$ ?v0) ?v1) (and (member$ (inr$ ?v2) (cont$ ?v0)) (inItr$ ?v1 ?v2 ?v3))) (inItr$ ?v1 ?v0 ?v3))) :named a28))
(assert (! (forall ((?v0 N_set$) (?v1 Dtree$) (?v2 N$)) (=> (and (inItr$ ?v0 ?v1 ?v2) (and (forall ((?v3 Dtree$) (?v4 N_set$)) (=> (and (= ?v0 ?v4) (and (= ?v1 ?v3) (and (= ?v2 (root$ ?v3)) (member$a (root$ ?v3) ?v4)))) false)) (forall ((?v3 Dtree$) (?v4 N_set$) (?v5 Dtree$) (?v6 N$)) (=> (and (= ?v0 ?v4) (and (= ?v1 ?v3) (and (= ?v2 ?v6) (and (member$a (root$ ?v3) ?v4) (and (member$ (inr$ ?v5) (cont$ ?v3)) (inItr$ ?v4 ?v5 ?v6)))))) false)))) false)) :named a29))
(assert (! (forall ((?v0 N_set$) (?v1 Dtree$) (?v2 N$)) (= (inItr$ ?v0 ?v1 ?v2) (or (exists ((?v3 Dtree$) (?v4 N_set$)) (and (= ?v0 ?v4) (and (= ?v1 ?v3) (and (= ?v2 (root$ ?v3)) (member$a (root$ ?v3) ?v4))))) (exists ((?v3 Dtree$) (?v4 N_set$) (?v5 Dtree$) (?v6 N$)) (and (= ?v0 ?v4) (and (= ?v1 ?v3) (and (= ?v2 ?v6) (and (member$a (root$ ?v3) ?v4) (and (member$ (inr$ ?v5) (cont$ ?v3)) (inItr$ ?v4 ?v5 ?v6)))))))))) :named a30))
(assert (! (forall ((?v0 Dtree$) (?v1 N_set$) (?v2 Dtree$) (?v3 T$)) (=> (and (member$a (root$ ?v0) ?v1) (and (member$ (inr$ ?v2) (cont$ ?v0)) (fun_app$e (fun_app$f (fun_app$g inFr$ ?v1) ?v2) ?v3))) (fun_app$e (fun_app$f (fun_app$g inFr$ ?v1) ?v0) ?v3))) :named a31))
(assert (! (= inFr$ inFr2$) :named a32))
(assert (! (= top$a (collect$ top$b)) :named a33))
(assert (! (= top$ (collect$a top$d)) :named a34))
(assert (! (forall ((?v0 N_set$) (?v1 Dtree$) (?v2 T$)) (=> (fun_app$e (fun_app$f (fun_app$g inFr$ ?v0) ?v1) ?v2) (member$a (root$ ?v1) ?v0))) :named a35))
(assert (! (forall ((?v0 Dtree$) (?v1 N_set$) (?v2 T$)) (=> (not (member$a (root$ ?v0) ?v1)) (not (fun_app$e (fun_app$f (fun_app$g inFr$ ?v1) ?v0) ?v2)))) :named a36))
(assert (! (forall ((?v0 N_set$) (?v1 Dtree$) (?v2 T$) (?v3 Dtree$)) (=> (and (fun_app$e (fun_app$f (fun_app$g inFr$ ?v0) ?v1) ?v2) (fun_app$ (subtr$ ?v0 ?v1) ?v3)) (fun_app$e (fun_app$f (fun_app$g inFr$ ?v0) ?v3) ?v2))) :named a37))
(assert (! (forall ((?v0 N_set$) (?v1 Dtree$) (?v2 N$)) (=> (inItr$ ?v0 ?v1 ?v2) (member$a (root$ ?v1) ?v0))) :named a38))
(check-sat)
;(get-unsat-core)
