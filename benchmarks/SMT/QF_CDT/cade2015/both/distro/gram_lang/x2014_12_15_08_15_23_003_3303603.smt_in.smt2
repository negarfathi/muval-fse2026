...
(assert (! (not (= (fun_app$ root$ (fun_app$a (subtrOf$ tr$) n$)) n$)) :named a0))
(assert (! (member$ (inr$ n$) (image$ (fun_app$b (map_sum$ id$) root$) (cont$ tr$))) :named a1))
(assert (! (wf$ tr$) :named a2))
(assert (! (regular$ tr$) :named a3))
(assert (! (wf$ tr$) :named a4))
(assert (! (regular$ tr$) :named a5))
(assert (! (= (fun_app$ root$ tr$) n$a) :named a6))
(assert (! (member$ (inr$ n$) tns$) :named a7))
(assert (! (= tns$ (image$ (fun_app$b (map_sum$ id$) root$) (cont$ tr$))) :named a8))
(assert (! (forall ((?v0 N$) (?v1 Dtree$)) (=> (member$ (inr$ ?v0) (image$ (fun_app$b (map_sum$ id$) root$) (cont$ ?v1))) (= (fun_app$ root$ (fun_app$a (subtrOf$ ?v1) ?v0)) ?v0))) :named a9))
(assert (! (forall ((?v0 Dtree$) (?v1 N$)) (=> (and (wf$ ?v0) (member$ (inr$ ?v1) (image$ (fun_app$b (map_sum$ id$) root$) (cont$ ?v0)))) (wf$ (fun_app$a (subtrOf$ ?v0) ?v1)))) :named a10))
...
(assert (! (forall ((?v0 Dtree$) (?v1 N_dtree_fun$) (?v2 T_N_sum_set$)) (= (member$a (inr$a ?v0) (image$b (fun_app$f (map_sum$b id$) ?v1) ?v2)) (exists ((?v3 N$)) (and (member$ (inr$ ?v3) ?v2) (= (fun_app$a ?v1 ?v3) ?v0))))) :named a12))
...
(assert (! (forall ((?v0 N$) (?v1 Dtree_N_fun$) (?v2 T_dtree_sum_set$)) (= (member$ (inr$ ?v0) (image$ (fun_app$b (map_sum$ id$) ?v1) ?v2)) (exists ((?v3 Dtree$)) (and (member$a (inr$a ?v3) ?v2) (= (fun_app$ ?v1 ?v3) ?v0))))) :named a14))
...
(assert (! (forall ((?v0 Dtree$) (?v1 N_dtree_fun$) (?v2 T_N_sum_set$)) (=> (member$a (inr$a ?v0) (image$b (fun_app$f (map_sum$b id$) ?v1) ?v2)) (exists ((?v3 N$)) (and (member$ (inr$ ?v3) ?v2) (= (fun_app$a ?v1 ?v3) ?v0))))) :named a23))
...
(assert (! (forall ((?v0 N$) (?v1 Dtree_N_fun$) (?v2 T_dtree_sum_set$)) (=> (member$ (inr$ ?v0) (image$ (fun_app$b (map_sum$ id$) ?v1) ?v2)) (exists ((?v3 Dtree$)) (and (member$a (inr$a ?v3) ?v2) (= (fun_app$ ?v1 ?v3) ?v0))))) :named a25))
...
(assert (! (forall ((?v0 Dtree$) (?v1 Dtree$)) (=> (and (wf$ ?v0) (member$a (inr$a ?v1) (cont$ ?v0))) (exists ((?v2 N$)) (and (member$ (inr$ ?v2) (image$ (fun_app$b (map_sum$ id$) root$) (cont$ ?v0))) (= (fun_app$a (subtrOf$ ?v0) ?v2) ?v1))))) :named a30))
...
(assert (! (forall ((?v0 N$) (?v1 Dtree$)) (=> (member$ (inr$ ?v0) (image$ (fun_app$b (map_sum$ id$) root$) (cont$ ?v1))) (and (member$a (inr$a (fun_app$a (subtrOf$ ?v1) ?v0)) (cont$ ?v1)) (= (fun_app$ root$ (fun_app$a (subtrOf$ ?v1) ?v0)) ?v0)))) :named a48))
(assert (! (forall ((?v0 N$) (?v1 Dtree$)) (=> (member$ (inr$ ?v0) (image$ (fun_app$b (map_sum$ id$) root$) (cont$ ?v1))) (member$a (inr$a (fun_app$a (subtrOf$ ?v1) ?v0)) (cont$ ?v1)))) :named a49))
(check-sat)
;(get-unsat-core)
