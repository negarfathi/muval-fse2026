; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 197
...
(assert (! (not (or (member$ t$ (vimage$ uu$ (cont$ tr0$))) (inFrr$ (minus$ ns$ (insert$ (root$ tr0$) bot$)) tr0$ t$))) :named a1))
(assert (! (inFr$ ns$ (hsubst$ tr0$ tr0$) t$) :named a2))
