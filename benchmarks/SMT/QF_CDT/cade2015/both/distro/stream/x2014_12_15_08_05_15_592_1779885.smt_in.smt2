...
(declare-codatatypes () ((A_stream_stream$ (sCons$a (shd$a A_stream$) (stl$a A_stream_stream$)))
  (A_list_stream$ (sCons$b (shd$b A_list$) (stl$b A_list_stream$)))
  (A_list_stream_stream$ (sCons$c (shd$c A_list_stream$) (stl$c A_list_stream_stream$)))
...
(declare-codatatypes () ((A_list_list_stream$ (sCons$e (shd$e A_list_list$) (stl$e A_list_list_stream$)))))
(declare-datatypes () ((A_stream_list$ (nil$b) (cons$b (hd$b A_stream$) (tl$b A_stream_list$)))))
(declare-codatatypes () ((A_stream_list_stream$ (sCons$f (shd$f A_stream_list$) (stl$f A_stream_list_stream$)))
  (A_list_list_stream_stream$ (sCons$g (shd$g A_list_list_stream$) (stl$g A_list_list_stream_stream$)))))
(declare-datatypes () ((A_stream_stream_list$ (nil$c) (cons$c (hd$c A_stream_stream$) (tl$c A_stream_stream_list$)))))
(declare-codatatypes () ((A_stream_stream_list_stream$ (sCons$h (shd$h A_stream_stream_list$) (stl$h A_stream_stream_list_stream$)))))
(declare-datatypes () ((A_list_stream_list$ (nil$d) (cons$d (hd$d A_list_stream$) (tl$d A_list_stream_list$)))))
(declare-codatatypes () ((A_list_stream_list_stream$ (sCons$i (shd$i A_list_stream_list$) (stl$i A_list_stream_list_stream$)))))
(declare-datatypes () ((A_list_list_list$ (nil$e) (cons$e (hd$e A_list_list$) (tl$e A_list_list_list$)))
  (A_stream_list_list$ (nil$f) (cons$f (hd$f A_stream_list$) (tl$f A_stream_list_list$)))
  (A_list_list_stream_list$ (nil$g) (cons$g (hd$g A_list_list_stream$) (tl$g A_list_list_stream_list$)))
  (A_stream_stream_list_list$ (nil$h) (cons$h (hd$h A_stream_stream_list$) (tl$h A_stream_stream_list_list$)))
  (A_list_stream_list_list$ (nil$i) (cons$i (hd$i A_list_stream_list$) (tl$i A_list_stream_list_list$)))))
(declare-fun a$ () A_set$)
