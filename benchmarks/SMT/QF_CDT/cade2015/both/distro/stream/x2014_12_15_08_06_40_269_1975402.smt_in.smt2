...
(assert (! (not (= (snth$ (sdrop$ n$ s$) m$) (snth$ s$ (plus$ n$ m$)))) :named a0))
(assert (! (forall ((?v0 Nat$) (?v1 Nat$) (?v2 A_stream$)) (= (sdrop$ ?v0 (sdrop$ ?v1 ?v2)) (sdrop$ (plus$ ?v1 ?v0) ?v2))) :named a1))
...
(assert (! (forall ((?v0 Nat$) (?v1 A_stream$)) (= (shd$ (sdrop$ ?v0 ?v1)) (snth$ ?v1 ?v0))) :named a4))
