; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 242
...
(declare-codatatypes () ((A_b_b_prod_prod_stream$ (sCons$k (shd$k A_b_b_prod_prod$) (stl$k A_b_b_prod_prod_stream$)))))
(declare-fun n$ () Nat$)
