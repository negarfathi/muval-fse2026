; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 168
...
(declare-codatatypes () ((A_list_stream$ (sCons$b (shd$b A_list$) (stl$b A_list_stream$)))
  (Nat_stream$ (sCons$c (shd$c Nat$) (stl$c Nat_stream$)))))
(declare-datatypes () ((A_stream_list$ (nil$a) (cons$a (hd$a A_stream$) (tl$a A_stream_list$)))
  (A_list_list$ (nil$b) (cons$b (hd$b A_list$) (tl$b A_list_list$)))
  (Nat_list$ (nil$c) (cons$c (hd$c Nat$) (tl$c Nat_list$)))))
(declare-codatatypes () ((A_stream_stream_stream$ (sCons$d (shd$d A_stream_stream$) (stl$d A_stream_stream_stream$)))
  (A_stream_list_stream$ (sCons$e (shd$e A_stream_list$) (stl$e A_stream_list_stream$)))
  (Nat_stream_stream$ (sCons$f (shd$f Nat_stream$) (stl$f Nat_stream_stream$)))
  (Nat_list_stream$ (sCons$g (shd$g Nat_list$) (stl$g Nat_list_stream$)))
  (A_list_stream_stream$ (sCons$h (shd$h A_list_stream$) (stl$h A_list_stream_stream$)))
  (A_list_list_stream$ (sCons$i (shd$i A_list_list$) (stl$i A_list_list_stream$)))
  (A_stream_stream_stream_stream$ (sCons$j (shd$j A_stream_stream_stream$) (stl$j A_stream_stream_stream_stream$)))
...
(declare-datatypes () ((A_list_stream_stream_list$ (nil$k) (cons$k (hd$k A_list_stream_stream$) (tl$k A_list_stream_stream_list$)))
  (A_stream_stream_list$ (nil$l) (cons$l (hd$l A_stream_stream$) (tl$l A_stream_stream_list$)))))
