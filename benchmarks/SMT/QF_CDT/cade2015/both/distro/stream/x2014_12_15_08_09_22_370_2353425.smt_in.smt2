...
(declare-datatypes () ((B_a_b_prod_prod_list$ (nil$) (cons$ (hd$ B_a_b_prod_prod$) (tl$ B_a_b_prod_prod_list$)))
  (B_b_prod_list$ (nil$a) (cons$a (hd$a B_b_prod$) (tl$a B_b_prod_list$)))
  (B_a_prod_list$ (nil$b) (cons$b (hd$b B_a_prod$) (tl$b B_a_prod_list$)))
  (A_a_b_prod_prod_list$ (nil$c) (cons$c (hd$c A_a_b_prod_prod$) (tl$c A_a_b_prod_prod_list$)))
  (A_a_prod_list$ (nil$d) (cons$d (hd$d A_a_prod$) (tl$d A_a_prod_list$)))
  (A_b_prod_list$ (nil$e) (cons$e (hd$e A_b_prod$) (tl$e A_b_prod_list$)))
  (A_list$ (nil$f) (cons$f (hd$f A$) (tl$f A_list$)))
  (B_list$ (nil$g) (cons$g (hd$g B$) (tl$g B_list$)))
...
(declare-datatypes () ((A_b_prod_b_prod_list$ (nil$h) (cons$h (hd$h A_b_prod_b_prod$) (tl$h A_b_prod_b_prod_list$)))
  ...
  (A_b_prod_a_b_prod_prod_list$ (nil$j) (cons$j (hd$j A_b_prod_a_b_prod_prod$) (tl$j A_b_prod_a_b_prod_prod_list$)))
  (B_b_b_prod_prod_list$ (nil$k) (cons$k (hd$k B_b_b_prod_prod$) (tl$k B_b_b_prod_prod_list$)))))
(declare-fun n$ () Nat$)
