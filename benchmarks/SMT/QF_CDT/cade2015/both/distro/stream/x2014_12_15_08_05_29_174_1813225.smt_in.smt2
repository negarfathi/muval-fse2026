...
(declare-datatypes () ((A_stream_list$ (nil$) (cons$ (hd$ A_stream$) (tl$ A_stream_list$)))))
...
(declare-codatatypes () ((A_stream_list_stream$ (sCons$b (shd$b A_stream_list$) (stl$b A_stream_list_stream$)))
  (A_stream_stream_stream$ (sCons$c (shd$c A_stream_stream$) (stl$c A_stream_stream_stream$)))
  (A_stream_stream_stream_stream$ (sCons$d (shd$d A_stream_stream_stream$) (stl$d A_stream_stream_stream_stream$)))
  (A_list_stream$ (sCons$e (shd$e A_list$) (stl$e A_list_stream$)))
  (A_list_stream_stream$ (sCons$f (shd$f A_list_stream$) (stl$f A_list_stream_stream$)))))
(declare-datatypes () ((A_stream_stream_list$ (nil$b) (cons$b (hd$b A_stream_stream$) (tl$b A_stream_stream_list$)))
  (A_list_list$ (nil$c) (cons$c (hd$c A_list$) (tl$c A_list_list$)))))
(declare-fun a$ () A_set$)
