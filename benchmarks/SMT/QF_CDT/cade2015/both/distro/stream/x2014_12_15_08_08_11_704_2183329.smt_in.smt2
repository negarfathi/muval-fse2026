...
(declare-codatatypes () ((A_list_list_stream$ (sCons$b (shd$b A_list_list$) (stl$b A_list_list_stream$)))
  (A_list_list_list_stream$ (sCons$c (shd$c A_list_list_list$) (stl$c A_list_list_list_stream$)))
...
(declare-datatypes () ((A_list_list_list_list$ (nil$c) (cons$c (hd$c A_list_list_list$) (tl$c A_list_list_list_list$)))
  (A_list_stream_list$ (nil$d) (cons$d (hd$d A_list_stream$) (tl$d A_list_stream_list$)))))
(declare-codatatypes () ((A_list_list_list_list_stream$ (sCons$e (shd$e A_list_list_list_list$) (stl$e A_list_list_list_list_stream$)))
  (A_list_stream_list_stream$ (sCons$f (shd$f A_list_stream_list$) (stl$f A_list_stream_list_stream$)))
  ...
  (A_list_stream_stream_stream$ (sCons$i (shd$i A_list_stream_stream$) (stl$i A_list_stream_stream_stream$)))))
