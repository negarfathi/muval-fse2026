...
(declare-codatatypes () ((A_b_prod_stream$ (sCons$ (shd$ A_b_prod$) (stl$ A_b_prod_stream$)))
  (A_b_prod_stream_stream$ (sCons$a (shd$a A_b_prod_stream$) (stl$a A_b_prod_stream_stream$)))
  (A_stream$ (sCons$b (shd$b A$) (stl$b A_stream$)))
  (B_stream$ (sCons$c (shd$c B$) (stl$c B_stream$)))
  (A_b_prod_stream_stream_stream$ (sCons$d (shd$d A_b_prod_stream_stream$) (stl$d A_b_prod_stream_stream_stream$)))
  (A_b_prod_stream_stream_stream_stream$ (sCons$e (shd$e A_b_prod_stream_stream_stream$) (stl$e A_b_prod_stream_stream_stream_stream$)))
  (A_b_prod_stream_stream_stream_stream_stream$ (sCons$f (shd$f A_b_prod_stream_stream_stream_stream$) (stl$f A_b_prod_stream_stream_stream_stream_stream$)))
  (A_stream_stream$ (sCons$g (shd$g A_stream$) (stl$g A_stream_stream$)))
  (A_stream_stream_stream$ (sCons$h (shd$h A_stream_stream$) (stl$h A_stream_stream_stream$)))
  (A_stream_stream_stream_stream$ (sCons$i (shd$i A_stream_stream_stream$) (stl$i A_stream_stream_stream_stream$)))
  (B_stream_stream$ (sCons$j (shd$j B_stream$) (stl$j B_stream_stream$)))
  (B_stream_stream_stream$ (sCons$k (shd$k B_stream_stream$) (stl$k B_stream_stream_stream$)))
  (B_stream_stream_stream_stream$ (sCons$l (shd$l B_stream_stream_stream$) (stl$l B_stream_stream_stream_stream$)))))
(declare-datatypes () ((B_b_prod$ (pair$a (fst$a B$) (snd$a B$)))
  (B_a_prod$ (pair$b (fst$b B$) (snd$b A$)))
  (A_a_prod$ (pair$c (fst$c A$) (snd$c A$)))
  (B_a_b_prod_prod$ (pair$d (fst$d B$) (snd$d A_b_prod$)))
  (A_a_b_prod_prod$ (pair$e (fst$e A$) (snd$e A_b_prod$)))
  (A_b_prod_b_prod$ (pair$f (fst$f A_b_prod$) (snd$f B$)))
  (A_b_prod_a_prod$ (pair$g (fst$g A_b_prod$) (snd$g A$)))
  (B_a_b_prod_stream_prod$ (pair$h (fst$h B$) (snd$h A_b_prod_stream$)))
  (A_a_b_prod_stream_prod$ (pair$i (fst$i A$) (snd$i A_b_prod_stream$)))))
(declare-codatatypes () ((B_b_prod_stream$ (sCons$m (shd$m B_b_prod$) (stl$m B_b_prod_stream$)))
  (B_b_prod_stream_stream$ (sCons$n (shd$n B_b_prod_stream$) (stl$n B_b_prod_stream_stream$)))
  (B_a_prod_stream$ (sCons$o (shd$o B_a_prod$) (stl$o B_a_prod_stream$)))
  (B_a_prod_stream_stream$ (sCons$p (shd$p B_a_prod_stream$) (stl$p B_a_prod_stream_stream$)))
  (A_a_b_prod_stream_prod_stream$ (sCons$q (shd$q A_a_b_prod_stream_prod$) (stl$q A_a_b_prod_stream_prod_stream$)))
  (A_a_b_prod_stream_prod_stream_stream$ (sCons$r (shd$r A_a_b_prod_stream_prod_stream$) (stl$r A_a_b_prod_stream_prod_stream_stream$)))
  (A_a_b_prod_prod_stream$ (sCons$s (shd$s A_a_b_prod_prod$) (stl$s A_a_b_prod_prod_stream$)))
  (A_a_b_prod_prod_stream_stream$ (sCons$t (shd$t A_a_b_prod_prod_stream$) (stl$t A_a_b_prod_prod_stream_stream$)))
  (A_a_prod_stream$ (sCons$u (shd$u A_a_prod$) (stl$u A_a_prod_stream$)))
  (A_a_prod_stream_stream$ (sCons$v (shd$v A_a_prod_stream$) (stl$v A_a_prod_stream_stream$)))))
