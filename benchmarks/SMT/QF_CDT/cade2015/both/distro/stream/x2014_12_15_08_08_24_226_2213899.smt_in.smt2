...
(declare-codatatypes () ((A_list_list_list_stream$ (sCons$b (shd$b A_list_list_list$) (stl$b A_list_list_list_stream$)))
  (A_list_list_stream$ (sCons$c (shd$c A_list_list$) (stl$c A_list_list_stream$)))))
