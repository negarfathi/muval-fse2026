...
(declare-codatatypes () ((A_a_prod_stream$ (sCons$g (shd$g A_a_prod$) (stl$g A_a_prod_stream$)))
  (B_stream_stream$ (sCons$h (shd$h B_stream$) (stl$h B_stream_stream$)))
  (A_stream_stream$ (sCons$i (shd$i A_stream$) (stl$i A_stream_stream$)))
  (B_stream_stream_stream$ (sCons$j (shd$j B_stream_stream$) (stl$j B_stream_stream_stream$)))
  (A_stream_stream_stream$ (sCons$k (shd$k A_stream_stream$) (stl$k A_stream_stream_stream$)))
  (B_b_prod_stream_stream$ (sCons$l (shd$l B_b_prod_stream$) (stl$l B_b_prod_stream_stream$)))
  (B_a_prod_stream_stream$ (sCons$m (shd$m B_a_prod_stream$) (stl$m B_a_prod_stream_stream$)))
  (A_c_prod_stream_stream$ (sCons$n (shd$n A_c_prod_stream$) (stl$n A_c_prod_stream_stream$)))
  (A_b_prod_stream_stream$ (sCons$o (shd$o A_b_prod_stream$) (stl$o A_b_prod_stream_stream$)))
  (A_a_prod_stream_stream$ (sCons$p (shd$p A_a_prod_stream$) (stl$p A_a_prod_stream_stream$)))
  (C_stream_stream$ (sCons$q (shd$q C_stream$) (stl$q C_stream_stream$)))))
