...
(assert (! (forall ((?v0 Nat$) (?v1 Nat$)) (=> (and (= x$ (nth$ (snth$ s$ ?v0) ?v1)) (less$ ?v1 (size$ (snth$ s$ ?v0)))) thesis$)) :named a1))
(assert (! (forall ((?v0 A_list$)) (=> (member$ ?v0 (sset$ s$)) (not (= ?v0 nil$)))) :named a2))
(assert (! (= x$ (snth$a (flat$ s$) m$)) :named a3))
(assert (! (=> (forall ((?v0 Nat$)) (=> (= x$ (snth$a (flat$ s$) ?v0)) false)) false) :named a4))
(assert (! (member$a x$ (sset$a (flat$ s$))) :named a5))
...
(assert (! (forall ((?v0 A_list_list_bool_fun$) (?v1 A_list_list$)) (=> (forall ((?v2 A_list_list$)) (=> (forall ((?v3 A_list_list$)) (=> (less$ (size$a ?v3) (size$a ?v2)) (fun_app$d ?v0 ?v3))) (fun_app$d ?v0 ?v2))) (fun_app$d ?v0 ?v1))) :named a12))
(assert (! (forall ((?v0 A_list_bool_fun$) (?v1 A_list$)) (=> (forall ((?v2 A_list$)) (=> (forall ((?v3 A_list$)) (=> (less$ (size$ ?v3) (size$ ?v2)) (fun_app$ ?v0 ?v3))) (fun_app$ ?v0 ?v2))) (fun_app$ ?v0 ?v1))) :named a13))
(assert (! (forall ((?v0 A_list_stream$) (?v1 Nat$)) (member$ (snth$ ?v0 ?v1) (sset$ ?v0))) :named a14))
(assert (! (forall ((?v0 A_stream$) (?v1 Nat$)) (member$a (snth$a ?v0 ?v1) (sset$a ?v0))) :named a15))
(assert (! (forall ((?v0 Nat$) (?v1 A_list_list$) (?v2 A_list_stream$)) (=> (less$ ?v0 (size$a ?v1)) (= (snth$ (shift$ ?v1 ?v2) ?v0) (nth$a ?v1 ?v0)))) :named a16))
(assert (! (forall ((?v0 Nat$) (?v1 A_list$) (?v2 A_stream$)) (=> (less$ ?v0 (size$ ?v1)) (= (snth$a (shift$a ?v1 ?v2) ?v0) (nth$ ?v1 ?v0)))) :named a17))
(assert (! (forall ((?v0 A_list_list$) (?v1 A_list_list$)) (=> (not (= (size$a ?v0) (size$a ?v1))) (= (= ?v0 ?v1) false))) :named a18))
(assert (! (forall ((?v0 A_list$) (?v1 A_list$)) (=> (not (= (size$ ?v0) (size$ ?v1))) (= (= ?v0 ?v1) false))) :named a19))
(assert (! (forall ((?v0 Nat$)) (exists ((?v1 A_list_list$)) (= (size$a ?v1) ?v0))) :named a20))
(assert (! (forall ((?v0 Nat$)) (exists ((?v1 A_list$)) (= (size$ ?v1) ?v0))) :named a21))
(assert (! (forall ((?v0 A_list_list$) (?v1 A_list_list$)) (=> (not (= (size$a ?v0) (size$a ?v1))) (not (= ?v0 ?v1)))) :named a22))
(assert (! (forall ((?v0 A_list$) (?v1 A_list$)) (=> (not (= (size$ ?v0) (size$ ?v1))) (not (= ?v0 ?v1)))) :named a23))
(assert (! (forall ((?v0 Nat$) (?v1 Nat$)) (= (not (= ?v0 ?v1)) (or (less$ ?v0 ?v1) (less$ ?v1 ?v0)))) :named a24))
(assert (! (forall ((?v0 Nat$) (?v1 Nat$) (?v2 Nat_nat_bool_fun_fun$)) (=> (and (=> (less$ ?v0 ?v1) (fun_app$e (fun_app$f ?v2 ?v1) ?v0)) (and (=> (= ?v0 ?v1) (fun_app$e (fun_app$f ?v2 ?v1) ?v0)) (=> (less$ ?v1 ?v0) (fun_app$e (fun_app$f ?v2 ?v1) ?v0)))) (fun_app$e (fun_app$f ?v2 ?v1) ?v0))) :named a25))
