...
(assert (! (not (= (member$ (pair$ k$ v$) (set$ (entries$ (rbt_del_from_right$ less$ xx$ aa$ yy$ ss$ (branch$ r$ vaa$ vbb$ vdd$ vc$))))) (or false (and (not (= xx$ k$)) (member$ (pair$ k$ v$) (set$ (entries$ (branch$ c$ aa$ yy$ ss$ (branch$ r$ vaa$ vbb$ vdd$ vc$))))))))) :named a0))
