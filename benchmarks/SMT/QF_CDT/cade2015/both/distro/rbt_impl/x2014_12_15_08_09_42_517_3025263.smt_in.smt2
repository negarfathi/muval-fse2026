; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 205
...
(assert (! (not (and (fun_app$ (fun_app$a less$ k$) x$) (rbt_less$ less$ k$ (branch$ b$ va$ vb$ vd$ vc$)))) :named a0))
