...
(declare-datatypes () ((Color$ (r$) (b$))
  ...
  (Nat_nat_rbt$ (empty$a) (branch$a (selecte$ Color$) (selectf$ Nat_nat_rbt$) (selectg$ Nat$) (selecth$ Nat$) (selecti$ Nat_nat_rbt$)))
  ...
  (Typerep_list$ (nil$) (cons$ (hd$ Typerep$) (tl$ Typerep_list$)))
  (Char$ (char$ (selectl$ Nibble$) (selectm$ Nibble$)))
  (Char_list$ (nil$a) (cons$a (hd$a Char$) (tl$a Char_list$)))
  (Literal$ (str$ (explode$ Char_list$)))
  (Typerep$ (typerep$ (selectj$ Literal$) (selectk$ Typerep_list$)))
  (Nibble_option$ (none$) (some$ (the$ Nibble$)))
  (Unit_option$ (none$a) (some$a (the$a Unit$)))))
