...
(assert (! (not (rbt_sorted$ less$ (balance_right$ a$ ka$ x$ (branch$ r$ b$a s$ y$ c$)))) :named a0))
(assert (! (rbt_sorted$ less$ a$) :named a1))
(assert (! (rbt_sorted$ less$ (branch$ r$ b$a s$ y$ c$)) :named a2))
(assert (! (rbt_less$ less$ ka$ a$) :named a3))
(assert (! (rbt_greater$ less$ ka$ (branch$ r$ b$a s$ y$ c$)) :named a4))
