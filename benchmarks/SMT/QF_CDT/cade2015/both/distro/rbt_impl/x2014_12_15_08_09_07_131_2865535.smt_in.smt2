; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 123
...
(assert (! (not (rbt_greater$ less$ x$ (combine$ b$a c$))) :named a0))
