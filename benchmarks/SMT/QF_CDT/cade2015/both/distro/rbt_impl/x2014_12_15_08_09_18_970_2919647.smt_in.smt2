; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 179
...
(assert (! (not (rbt_greater$ less$ x$ d$)) :named a0))
