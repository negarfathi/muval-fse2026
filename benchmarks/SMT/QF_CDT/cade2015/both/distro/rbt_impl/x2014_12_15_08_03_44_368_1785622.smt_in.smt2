...
(assert (! (not (= (dom$ (rbt_lookup$ less$ (branch$ c$ t1$ k$ v$ t2$))) (insert$ k$ (sup$ (dom$ (rbt_lookup$ less$ t1$)) (dom$ (rbt_lookup$ less$ t2$)))))) :named a0))
(assert (! (rbt_sorted$ less$ (branch$ c$ t1$ k$ v$ t2$)) :named a1))
