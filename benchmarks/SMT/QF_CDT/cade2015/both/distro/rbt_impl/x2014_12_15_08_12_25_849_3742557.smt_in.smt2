...
(declare-fun restrict_map$ (A_b_option_fun$ A_set$ A$) B_option$)
(assert (! (not (= (fun_app$ (rbt_lookup$ less$ (rbt_delete$ less$ k$ t$)) x$) (restrict_map$ (rbt_lookup$ less$ t$) (uminus$ (insert$ k$ bot$)) x$))) :named a0))
