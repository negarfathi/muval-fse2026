...
(assert (! (not (= (member$ (pair$ k$ v$) (set$ (entries$ (rbt_del_from_right$ less$ xx$ aa$ yy$ ss$ mt$)))) (or (member$ (pair$ k$ v$) (set$ (entries$ aa$))) (or (and (= k$ yy$) (= v$ ss$)) (or false (and (not (= xx$ k$)) (member$ (pair$ k$ v$) (set$ (entries$ mt$))))))))) :named a0))
