...
(assert (! (not (rbt_sorted$ less$ (balance_left$ (branch$ r$ a$ ka$ x$ b$a) s$ y$ c$))) :named a0))
(assert (! (rbt_sorted$ less$ (branch$ r$ a$ ka$ x$ b$a)) :named a1))
(assert (! (rbt_sorted$ less$ c$) :named a2))
(assert (! (rbt_less$ less$ s$ (branch$ r$ a$ ka$ x$ b$a)) :named a3))
(assert (! (rbt_greater$ less$ s$ c$) :named a4))
...
(assert (! (forall ((?v0 A$) (?v1 A$) (?v2 Bool)) (=> (fun_app$ (fun_app$a less$ ?v0) ?v1) (= (=> (fun_app$ (fun_app$a less$ ?v1) ?v0) ?v2) true))) :named a18))
(assert (! (forall ((?v0 A$) (?v1 A$)) (=> (fun_app$ (fun_app$a less$ ?v0) ?v1) (= (not (fun_app$ (fun_app$a less$ ?v1) ?v0)) true))) :named a19))
(assert (! (forall ((?v0 A$) (?v1 A$)) (=> (fun_app$ (fun_app$a less$ ?v0) ?v1) (not (fun_app$ (fun_app$a less$ ?v1) ?v0)))) :named a20))
(assert (! (forall ((?v0 A$) (?v1 A$)) (=> (fun_app$ (fun_app$a less$ ?v0) ?v1) (not (= ?v0 ?v1)))) :named a21))
(check-sat)
;(get-unsat-core)
