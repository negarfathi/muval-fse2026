...
(assert (! (not (= (member$ (pair$ k$ v$) (set$ (entries$ (rbt_del_from_left$ less$ xx$ (branch$ b$ lta$ zz$ vv$ rta$) yy$ ss$ bb$)))) (or false (and (not (= xx$ k$)) (member$ (pair$ k$ v$) (set$ (entries$ (branch$ c$ (branch$ b$ lta$ zz$ vv$ rta$) yy$ ss$ bb$)))))))) :named a0))
