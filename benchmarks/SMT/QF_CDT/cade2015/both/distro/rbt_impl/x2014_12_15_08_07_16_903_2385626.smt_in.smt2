; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 142
...
(declare-datatypes () ((A_b_prod$ (pair$ (fst$ A$) (snd$ B$)))
  ...
  (B_a_prod$ (pair$a (fst$a B$) (snd$a A$)))
  (B_a_rbt$ (empty$a) (branch$a (selecte$ Color$) (selectf$ B_a_rbt$) (selectg$ B$) (selecth$ A$) (selecti$ B_a_rbt$)))
