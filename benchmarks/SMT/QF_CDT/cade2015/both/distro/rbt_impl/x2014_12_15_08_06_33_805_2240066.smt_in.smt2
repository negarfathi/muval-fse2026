...
(assert (! (not (rbt_sorted$ less$ (balance$ (branch$ b$ va$ vb$ vd$ vc$) x$ w$ (branch$ r$ b$a y$ s$ (branch$ r$ c$ z$ t$ dd$))))) :named a0))
...
(assert (! (rbt_greater$ less$ k$ r$a) :named a31))
(assert (! (rbt_less$ less$ k$ l$) :named a32))
(assert (! (rbt_sorted$ less$ (branch$ b$ va$ vb$ vd$ vc$)) :named a33))
(assert (! (rbt_less$ less$ y$ (branch$ b$ va$ vb$ vd$ vc$)) :named a34))
(assert (! (rbt_less$ less$ x$ (branch$ b$ va$ vb$ vd$ vc$)) :named a35))
(check-sat)
;(get-unsat-core)
