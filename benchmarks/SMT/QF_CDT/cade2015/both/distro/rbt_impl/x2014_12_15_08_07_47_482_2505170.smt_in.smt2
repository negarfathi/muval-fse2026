; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 11
...
(assert (! (not (rbt_sorted$ less$ (rbt_insert_with$ less$ f$ k$ v$ t$))) :named a0))
