; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 115
...
(assert (! (not (= (rbt_less$ less$ v$ (rbt_ins$ less$ f$ k$ x$ t$)) (and (rbt_less$ less$ v$ t$) (fun_app$ (fun_app$a less$ k$) v$)))) :named a0))
