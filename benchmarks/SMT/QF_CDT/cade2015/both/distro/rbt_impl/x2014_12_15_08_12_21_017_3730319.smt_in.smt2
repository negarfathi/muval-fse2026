...
(declare-fun restrict_map$ (A_b_option_fun$ A_set$) A_b_option_fun$)
(assert (! (not (= (rbt_lookup$ less$ (rbt_delete$ less$ k$ t$)) (restrict_map$ (rbt_lookup$ less$ t$) (uminus$ (insert$ k$ bot$))))) :named a0))
