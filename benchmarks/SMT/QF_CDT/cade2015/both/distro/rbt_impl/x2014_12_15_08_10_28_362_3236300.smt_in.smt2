...
(assert (! (not (and (inv2$ (rbt_del_from_right$ less$ y$ a$ y$a ss$ (branch$ b$ lta$ z$ va$ rta$))) (and (= (bheight$ (rbt_del_from_right$ less$ y$ a$ y$a ss$ (branch$ b$ lta$ z$ va$ rta$))) (bheight$ a$)) (or (and (= (color_of$ a$) b$) (and (= (color_of$ (branch$ b$ lta$ z$ va$ rta$)) b$) (inv1$ (rbt_del_from_right$ less$ y$ a$ y$a ss$ (branch$ b$ lta$ z$ va$ rta$))))) (and (or (not (= (color_of$ a$) b$)) (not (= (color_of$ (branch$ b$ lta$ z$ va$ rta$)) b$))) (inv1l$ (rbt_del_from_right$ less$ y$ a$ y$a ss$ (branch$ b$ lta$ z$ va$ rta$)))))))) :named a0))
(assert (! (inv1$ lt$) :named a1))
(assert (! (inv2$ lt$) :named a2))
(assert (! (inv1$ a$) :named a3))
(assert (! (inv2$ a$) :named a4))
