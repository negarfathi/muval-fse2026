...
(assert (! (not (= (rbt_lookup$ less$ (rbt_map_entry$ less$ k$ f$ t$)) (fun_upd$ (rbt_lookup$ less$ t$) k$ (map_option$ f$ (fun_app$ (rbt_lookup$ less$ t$) k$))))) :named a0))
...
(assert (! (forall ((?v0 A$) (?v1 A$)) (=> (fun_app$a (fun_app$b less$ ?v0) ?v1) (not (= ?v1 ?v0)))) :named a19))
(assert (! (forall ((?v0 A$) (?v1 A$) (?v2 A$)) (=> (and (= ?v0 ?v1) (fun_app$a (fun_app$b less$ ?v1) ?v2)) (fun_app$a (fun_app$b less$ ?v0) ?v2))) :named a20))
(assert (! (forall ((?v0 A$) (?v1 A$)) (=> (not (fun_app$a (fun_app$b less$ ?v0) ?v1)) (= (not (fun_app$a (fun_app$b less$ ?v1) ?v0)) (= ?v1 ?v0)))) :named a21))
(assert (! (forall ((?v0 A$) (?v1 A$)) (=> (and (not (= ?v0 ?v1)) (and (=> (fun_app$a (fun_app$b less$ ?v0) ?v1) false) (=> (fun_app$a (fun_app$b less$ ?v1) ?v0) false))) false)) :named a22))
(assert (! (forall ((?v0 A$) (?v1 A$)) (or (fun_app$a (fun_app$b less$ ?v0) ?v1) (or (= ?v0 ?v1) (fun_app$a (fun_app$b less$ ?v1) ?v0)))) :named a23))
(assert (! (forall ((?v0 A$)) (not (fun_app$a (fun_app$b less$ ?v0) ?v0))) :named a24))
(check-sat)
;(get-unsat-core)
