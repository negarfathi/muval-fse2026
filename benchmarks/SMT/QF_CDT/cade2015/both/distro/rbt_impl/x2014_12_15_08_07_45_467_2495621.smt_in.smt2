...
(assert (! (not (= (fun_app$c (rbt_lookup$ less$ (paint$ b$ (rbt_ins$ less$ f$ k$ v$ t$))) x$) (fun_upd$ (rbt_lookup$ less$ t$) k$ (some$ (case_option$ v$ uu$ (fun_app$c (rbt_lookup$ less$ t$) k$))) x$))) :named a1))
