...
(assert (! (not (and (inv1$ (paint$ b$ (rbt_ins$ less$ f$ k$ x$ t$))) (and (inv2$ (paint$ b$ (rbt_ins$ less$ f$ k$ x$ t$))) (and (= (color_of$ (paint$ b$ (rbt_ins$ less$ f$ k$ x$ t$))) b$) (rbt_sorted$ less$ (paint$ b$ (rbt_ins$ less$ f$ k$ x$ t$))))))) :named a0))
