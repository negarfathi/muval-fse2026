; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 256
...
(assert (! (not (= (member$ (pair$ k$ v$) (set$ (entries$ (rbt_del_from_left$ less$ xx$ (branch$ r$ vaa$ vbb$ vdd$ vc$) yy$ ss$ bb$)))) (or false (and (not (= xx$ k$)) (member$ (pair$ k$ v$) (set$ (entries$ (branch$ c$ (branch$ r$ vaa$ vbb$ vdd$ vc$) yy$ ss$ bb$)))))))) :named a0))
