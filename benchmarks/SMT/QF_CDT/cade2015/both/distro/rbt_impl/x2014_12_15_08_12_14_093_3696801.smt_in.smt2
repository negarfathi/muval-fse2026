...
(assert (! (not (and (inv2$ (rbt_del$ less$ k$ t$)) (or (and (= (color_of$ t$) r$) (and (= (bheight$ (rbt_del$ less$ k$ t$)) (bheight$ t$)) (inv1$ (rbt_del$ less$ k$ t$)))) (and (= (color_of$ t$) b$) (and (= (bheight$ (rbt_del$ less$ k$ t$)) (minus$ (bheight$ t$) one$)) (inv1l$ (rbt_del$ less$ k$ t$))))))) :named a0))
