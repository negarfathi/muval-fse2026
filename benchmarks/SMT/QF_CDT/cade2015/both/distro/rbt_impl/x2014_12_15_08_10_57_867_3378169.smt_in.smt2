; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 78
...
(assert (! (not (rbt_greater$ less$ yy$ (rbt_del$ less$ xa$ (branch$ r$ vaa$ vbb$ vdd$ vc$)))) :named a0))
