...
(assert (! (not (= (member$ (pair$ k$ v$) (set$ (entries$ (rbt_del_from_left$ less$ xx$ empty$ yy$ ss$ bb$)))) (or false (and (not (= xx$ k$)) (member$ (pair$ k$ v$) (set$ (entries$ (branch$ c$ empty$ yy$ ss$ bb$)))))))) :named a0))
