; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 56
...
(assert (! (not (rbt_sorted$ less$ (combine$ l$ r$a))) :named a0))
