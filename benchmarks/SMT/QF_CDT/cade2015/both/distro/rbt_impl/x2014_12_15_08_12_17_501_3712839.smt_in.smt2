...
(assert (! (not (and (inv1$ (paint$ b$ (rbt_del$ less$ k$ t$))) (and (inv2$ (paint$ b$ (rbt_del$ less$ k$ t$))) (and (= (color_of$ (paint$ b$ (rbt_del$ less$ k$ t$))) b$) (rbt_sorted$ less$ (paint$ b$ (rbt_del$ less$ k$ t$))))))) :named a0))
