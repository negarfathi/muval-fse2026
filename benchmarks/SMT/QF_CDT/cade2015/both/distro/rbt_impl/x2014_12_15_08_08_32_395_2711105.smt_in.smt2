...
(assert (! (not (rbt_sorted$ less$ (balance_right$ l$ k$ v$ r$a))) :named a0))
(assert (! (rbt_sorted$ less$ l$) :named a1))
(assert (! (rbt_sorted$ less$ r$a) :named a2))
(assert (! (rbt_less$ less$ k$ l$) :named a3))
(assert (! (rbt_greater$ less$ k$ r$a) :named a4))
