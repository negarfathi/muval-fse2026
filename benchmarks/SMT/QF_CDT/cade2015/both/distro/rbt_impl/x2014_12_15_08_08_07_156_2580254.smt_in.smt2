...
(assert (! (not (inv1$ (balance_left$ a$ k$ x$ b$a))) :named a0))
(assert (! (inv1l$ a$) :named a1))
(assert (! (inv1$ b$a) :named a2))
(assert (! (= (color_of$ b$a) b$) :named a3))
(assert (! (forall ((?v0 A_b_rbt$)) (=> (inv1l$ ?v0) (inv1$ (paint$ b$ ?v0)))) :named a4))
(assert (! (forall ((?v0 A_b_rbt$)) (= (color_of$ (paint$ b$ ?v0)) b$)) :named a5))
...
(assert (! (forall ((?v0 A_b_rbt$) (?v1 A_b_rbt$) (?v2 A$) (?v3 B$)) (=> (and (inv1l$ ?v0) (inv1l$ ?v1)) (inv1$ (fun_app$ (balance$ ?v0 ?v2 ?v3) ?v1)))) :named a7))
(assert (! (forall ((?v0 Color$) (?v1 A_b_rbt$) (?v2 A$) (?v3 B$) (?v4 A_b_rbt$)) (! (= (inv1l$ (branch$ ?v0 ?v1 ?v2 ?v3 ?v4)) (and (inv1$ ?v1) (inv1$ ?v4))) :pattern ((branch$ ?v0 ?v1 ?v2 ?v3 ?v4)))) :named a8))
...
(assert (! (forall ((?v0 A_b_rbt$) (?v1 Color$)) (=> (inv1l$ ?v0) (inv1l$ (paint$ ?v1 ?v0)))) :named a11))
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 A_b_rbt$)) (! (= (is_rbt$ ?v0 ?v1) (and (inv1$ ?v1) (and (inv2$ ?v1) (and (= (color_of$ ?v1) b$) (rbt_sorted$ ?v0 ?v1))))) :pattern ((is_rbt$ ?v0 ?v1)))) :named a12))
