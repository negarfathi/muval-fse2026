...
(declare-datatypes () ((A_list$ (nil$) (cons$ (hd$ A$) (tl$ A_list$)))
  ...
  (A_b_prod_option$ (none$) (some$ (the$ A_b_prod$)))
  (A_list_option$ (none$a) (some$a (the$a A_list$)))
  (A_option$ (none$b) (some$b (the$b A$)))
  (B_list$ (nil$c) (cons$c (hd$c B$) (tl$c B_list$)))
  (A_b_prod_list_list$ (nil$d) (cons$d (hd$d A_b_prod_list$) (tl$d A_b_prod_list_list$)))
  (A_list_list_list$ (nil$e) (cons$e (hd$e A_list_list$) (tl$e A_list_list_list$)))))
