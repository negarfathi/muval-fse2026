...
(assert (! (not (rbt_sorted$ less$ (balance$ (branch$ r$ (branch$ b$ vd$ ve$ vg$ vf$) x$ w$ (branch$ r$ b$a y$ s$ c$)) z$ t$ (branch$ b$ va$ vb$ vii$ vc$)))) :named a0))
...
(assert (! (rbt_sorted$ less$ (branch$ b$ va$ vb$ vii$ vc$)) :named a33))
(assert (! (rbt_less$ less$ y$ (branch$ b$ vd$ ve$ vg$ vf$)) :named a34))
(assert (! (rbt_greater$ less$ y$ (branch$ b$ va$ vb$ vii$ vc$)) :named a35))
(assert (! (rbt_greater$ less$ z$ (branch$ b$ va$ vb$ vii$ vc$)) :named a36))
(assert (! (rbt_sorted$ less$ (branch$ r$ (branch$ b$ vd$ ve$ vg$ vf$) x$ w$ (branch$ r$ b$a y$ s$ c$))) :named a37))
(assert (! (forall ((?v0 Color$) (?v1 A_b_rbt$) (?v2 A$) (?v3 B$) (?v4 A_b_rbt$)) (! (= (rbt_sorted$ less$ (branch$ ?v0 ?v1 ?v2 ?v3 ?v4)) (and (rbt_less$ less$ ?v2 ?v1) (and (rbt_greater$ less$ ?v2 ?v4) (and (rbt_sorted$ less$ ?v1) (rbt_sorted$ less$ ?v4))))) :pattern ((branch$ ?v0 ?v1 ?v2 ?v3 ?v4)))) :named a38))
(assert (! (rbt_less$ less$ z$ (branch$ r$ (branch$ b$ vd$ ve$ vg$ vf$) x$ w$ (branch$ r$ b$a y$ s$ c$))) :named a39))
(assert (! (forall ((?v0 A_b_rbt$)) (=> (is_rbt$ less$ ?v0) (rbt_sorted$ less$ ?v0))) :named a40))
(assert (! (and (fun_app$ (fun_app$a less$ x$) y$) (rbt_less$ less$ x$ (branch$ b$ vd$ ve$ vg$ vf$))) :named a41))
(assert (! (and (fun_app$ (fun_app$a less$ y$) z$) (rbt_greater$ less$ z$ (branch$ b$ va$ vb$ vii$ vc$))) :named a42))
...
(assert (! (forall ((?v0 A_b_rbt$) (?v1 A$) (?v2 B$) (?v3 A_b_rbt$) (?v4 A$) (?v5 B$) (?v6 A_b_rbt$) (?v7 A$) (?v8 B$) (?v9 A_b_rbt$) (?v10 A$) (?v11 B$) (?v12 A_b_rbt$)) (! (= (balance$ (branch$ b$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 ?v6) ?v7 ?v8 (branch$ b$ ?v9 ?v10 ?v11 ?v12)) (branch$ b$ (branch$ b$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 ?v6) ?v7 ?v8 (branch$ b$ ?v9 ?v10 ?v11 ?v12))) :pattern ((balance$ (branch$ b$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 ?v6) ?v7 ?v8 (branch$ b$ ?v9 ?v10 ?v11 ?v12))))) :named a44))
...
(assert (! (forall ((?v0 A_b_rbt$) (?v1 A$) (?v2 B$) (?v3 A_b_rbt$) (?v4 A$) (?v5 B$) (?v6 A_b_rbt$) (?v7 A$) (?v8 B$) (?v9 A_b_rbt$) (?v10 A$) (?v11 B$) (?v12 A_b_rbt$)) (! (= (balance$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 (branch$ b$ ?v6 ?v7 ?v8 (branch$ b$ ?v9 ?v10 ?v11 ?v12))) (branch$ b$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 (branch$ b$ ?v6 ?v7 ?v8 (branch$ b$ ?v9 ?v10 ?v11 ?v12)))) :pattern ((balance$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 (branch$ b$ ?v6 ?v7 ?v8 (branch$ b$ ?v9 ?v10 ?v11 ?v12)))))) :named a46))
(assert (! (forall ((?v0 A_b_rbt$) (?v1 A$) (?v2 B$) (?v3 A_b_rbt$) (?v4 A$) (?v5 B$) (?v6 A_b_rbt$) (?v7 A$) (?v8 B$) (?v9 A_b_rbt$)) (! (= (balance$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 (branch$ b$ ?v6 ?v7 ?v8 ?v9)) (branch$ b$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 (branch$ b$ ?v6 ?v7 ?v8 ?v9))) :pattern ((balance$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 (branch$ b$ ?v6 ?v7 ?v8 ?v9))))) :named a47))
(assert (! (forall ((?v0 A_b_rbt$) (?v1 A$) (?v2 B$) (?v3 A_b_rbt$) (?v4 A$) (?v5 B$) (?v6 A_b_rbt$) (?v7 A$) (?v8 B$) (?v9 A_b_rbt$)) (! (= (balance$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 (branch$ b$ ?v6 ?v7 ?v8 ?v9)) (branch$ b$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 (branch$ b$ ?v6 ?v7 ?v8 ?v9))) :pattern ((balance$ (branch$ b$ ?v0 ?v1 ?v2 ?v3) ?v4 ?v5 (branch$ b$ ?v6 ?v7 ?v8 ?v9))))) :named a48))
(check-sat)
;(get-unsat-core)
