...
(declare-datatypes () ((A_list$ (nil$) (cons$ (hd$ A$) (tl$ A_list$)))
  ...
  (B_list$ (nil$d) (cons$d (hd$d B$) (tl$d B_list$)))
  (A_b_prod_a_prod$ (pair$c (fst$c A_b_prod$) (snd$c A$)))
  (A_b_prod_a_prod_list$ (nil$e) (cons$e (hd$e A_b_prod_a_prod$) (tl$e A_b_prod_a_prod_list$)))
  (A_a_b_prod_prod$ (pair$d (fst$d A$) (snd$d A_b_prod$)))
  (A_a_b_prod_prod_list$ (nil$f) (cons$f (hd$f A_a_b_prod_prod$) (tl$f A_a_b_prod_prod_list$)))
  (A_b_prod_a_b_prod_prod_option$ (none$) (some$ (the$ A_b_prod_a_b_prod_prod$)))
  (A_a_prod_option$ (none$a) (some$a (the$a A_a_prod$)))
  (B_option$ (none$b) (some$b (the$b B$)))
  (A_b_prod_a_prod_option$ (none$c) (some$c (the$c A_b_prod_a_prod$)))
  (A_a_b_prod_prod_option$ (none$d) (some$d (the$d A_a_b_prod_prod$)))
  (A_option$ (none$e) (some$e (the$e A$)))
  (A_b_prod_option$ (none$f) (some$f (the$f A_b_prod$)))
  (A_b_prod_nat_fun_list$ (nil$g) (cons$g (selecte$ A_b_prod_nat_fun$) (selectf$ A_b_prod_nat_fun_list$)))
