...
(declare-codatatypes () ((A_a_prod_a_a_prod_prod_stream$ (sCons$b (shd$b A_a_prod_a_a_prod_prod$) (stl$b A_a_prod_a_a_prod_prod_stream$)))))
(declare-datatypes () ((A_a_prod_a_prod$ (pair$b (fst$b A_a_prod$) (snd$b A$)))))
(declare-codatatypes () ((A_a_prod_a_prod_stream$ (sCons$c (shd$c A_a_prod_a_prod$) (stl$c A_a_prod_a_prod_stream$)))))
(declare-datatypes () ((A_a_a_prod_prod$ (pair$c (fst$c A$) (snd$c A_a_prod$)))))
(declare-codatatypes () ((A_a_a_prod_prod_stream$ (sCons$d (shd$d A_a_a_prod_prod$) (stl$d A_a_a_prod_prod_stream$)))))
