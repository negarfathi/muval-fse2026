...
(declare-codatatypes () ((A_a_b_prod_prod_stream$ (sCons$e (shd$e A_a_b_prod_prod$) (stl$e A_a_b_prod_prod_stream$)))))
(declare-datatypes () ((A_a_prod$ (pair$d (fst$d A$) (snd$d A$)))
  (A_a_a_prod_prod$ (pair$e (fst$e A$) (snd$e A_a_prod$)))))
(declare-codatatypes () ((A_a_a_prod_prod_stream$ (sCons$f (shd$f A_a_a_prod_prod$) (stl$f A_a_a_prod_prod_stream$)))
  (A_stream_stream$ (sCons$g (shd$g A_stream$) (stl$g A_stream_stream$)))
  (A_a_prod_stream$ (sCons$h (shd$h A_a_prod$) (stl$h A_a_prod_stream$)))))
(declare-datatypes () ((B_a_a_prod_prod$ (pair$f (fst$f B$) (snd$f A_a_prod$)))))
(declare-codatatypes () ((A_b_prod_stream_stream$ (sCons$i (shd$i A_b_prod_stream$) (stl$i A_b_prod_stream_stream$)))
  (B_stream_stream$ (sCons$j (shd$j B_stream$) (stl$j B_stream_stream$)))
  (A_stream_stream_stream$ (sCons$k (shd$k A_stream_stream$) (stl$k A_stream_stream_stream$)))))
(declare-datatypes () ((B_a_b_prod_prod$ (pair$g (fst$g B$) (snd$g A_b_prod$)))))
(declare-codatatypes () ((B_a_b_prod_prod_stream$ (sCons$l (shd$l B_a_b_prod_prod$) (stl$l B_a_b_prod_prod_stream$)))
  (B_a_a_prod_prod_stream$ (sCons$m (shd$m B_a_a_prod_prod$) (stl$m B_a_a_prod_prod_stream$)))))
(declare-datatypes () ((A_b_prod_a_prod$ (pair$h (fst$h A_b_prod$) (snd$h A$)))))
(declare-codatatypes () ((A_b_prod_a_prod_stream$ (sCons$n (shd$n A_b_prod_a_prod$) (stl$n A_b_prod_a_prod_stream$)))))
(declare-datatypes () ((A_b_prod_b_prod$ (pair$i (fst$i A_b_prod$) (snd$i B$)))))
(declare-codatatypes () ((A_b_prod_b_prod_stream$ (sCons$o (shd$o A_b_prod_b_prod$) (stl$o A_b_prod_b_prod_stream$)))))
(declare-datatypes () ((A_a_a_b_prod_prod_prod$ (pair$j (fst$j A$) (snd$j A_a_b_prod_prod$)))))
(declare-codatatypes () ((A_a_a_b_prod_prod_prod_stream$ (sCons$p (shd$p A_a_a_b_prod_prod_prod$) (stl$p A_a_a_b_prod_prod_prod_stream$)))))
(declare-datatypes () ((A_stream_b_prod$ (pair$k (fst$k A_stream$) (snd$k B$)))))
(declare-codatatypes () ((A_stream_b_prod_stream$ (sCons$q (shd$q A_stream_b_prod$) (stl$q A_stream_b_prod_stream$)))))
(declare-fun a$ () A$)
