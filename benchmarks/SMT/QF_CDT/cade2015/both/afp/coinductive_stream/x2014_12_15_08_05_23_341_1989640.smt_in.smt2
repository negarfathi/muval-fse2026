...
(declare-datatypes () ((A_list$ (nil$) (cons$ (hd$ A$) (tl$ A_list$)))
  ...
  (Nat_a_prod$ (pair$a (fst$a Nat$) (snd$a A$)))
  (Nat_a_prod_list$ (nil$c) (cons$c (hd$c Nat_a_prod$) (tl$c Nat_a_prod_list$)))
  (B_b_prod$ (pair$b (fst$b B$) (snd$b B$)))
  ...
  (A_a_prod$ (pair$d (fst$d A$) (snd$d A$)))
  (A_a_prod_list$ (nil$f) (cons$f (hd$f A_a_prod$) (tl$f A_a_prod_list$)))
  (Nat_list$ (nil$g) (cons$g (hd$g Nat$) (tl$g Nat_list$)))
  (A_b_b_prod_prod$ (pair$e (fst$e A$) (snd$e B_b_prod$)))
  (A_b_b_prod_prod_list$ (nil$h) (cons$h (hd$h A_b_b_prod_prod$) (tl$h A_b_b_prod_prod_list$)))
  (A_b_a_prod_prod$ (pair$f (fst$f A$) (snd$f B_a_prod$)))
  (A_b_a_prod_prod_list$ (nil$i) (cons$i (hd$i A_b_a_prod_prod$) (tl$i A_b_a_prod_prod_list$)))
  (A_nat_a_prod_prod$ (pair$g (fst$g A$) (snd$g Nat_a_prod$)))
  (A_nat_a_prod_prod_list$ (nil$j) (cons$j (hd$j A_nat_a_prod_prod$) (tl$j A_nat_a_prod_prod_list$)))
  (A_a_b_prod_prod$ (pair$h (fst$h A$) (snd$h A_b_prod$)))
  (A_a_b_prod_prod_list$ (nil$k) (cons$k (hd$k A_a_b_prod_prod$) (tl$k A_a_b_prod_prod_list$)))
  (A_a_a_prod_prod$ (pair$i (fst$i A$) (snd$i A_a_prod$)))
  (A_a_a_prod_prod_list$ (nil$l) (cons$l (hd$l A_a_a_prod_prod$) (tl$l A_a_a_prod_prod_list$)))))
(declare-codatatypes () ((A_a_prod_stream$ (sCons$c (shd$c A_a_prod$) (stl$c A_a_prod_stream$)))
  (B_a_prod_stream$ (sCons$d (shd$d B_a_prod$) (stl$d B_a_prod_stream$)))
  (B_b_prod_stream$ (sCons$e (shd$e B_b_prod$) (stl$e B_b_prod_stream$)))))
(declare-datatypes () ((A_b_prod_a_prod$ (pair$j (fst$j A_b_prod$) (snd$j A$)))
  (A_b_prod_a_prod_list$ (nil$m) (cons$m (hd$m A_b_prod_a_prod$) (tl$m A_b_prod_a_prod_list$)))))
(declare-codatatypes () ((A_b_prod_a_prod_stream$ (sCons$f (shd$f A_b_prod_a_prod$) (stl$f A_b_prod_a_prod_stream$)))))
(declare-datatypes () ((A_b_prod_b_prod$ (pair$k (fst$k A_b_prod$) (snd$k B$)))
  (A_b_prod_b_prod_list$ (nil$n) (cons$n (hd$n A_b_prod_b_prod$) (tl$n A_b_prod_b_prod_list$)))))
(declare-codatatypes () ((A_b_prod_b_prod_stream$ (sCons$g (shd$g A_b_prod_b_prod$) (stl$g A_b_prod_b_prod_stream$)))
  (A_a_b_prod_prod_stream$ (sCons$h (shd$h A_a_b_prod_prod$) (stl$h A_a_b_prod_prod_stream$)))))
(declare-datatypes () ((B_a_b_prod_prod$ (pair$l (fst$l B$) (snd$l A_b_prod$)))
  (B_a_b_prod_prod_list$ (nil$o) (cons$o (hd$o B_a_b_prod_prod$) (tl$o B_a_b_prod_prod_list$)))))
(declare-codatatypes () ((B_a_b_prod_prod_stream$ (sCons$i (shd$i B_a_b_prod_prod$) (stl$i B_a_b_prod_prod_stream$)))))
(declare-datatypes () ((A_b_prod_a_b_prod_prod$ (pair$m (fst$m A_b_prod$) (snd$m A_b_prod$)))
  (A_b_prod_a_b_prod_prod_list$ (nil$p) (cons$p (hd$p A_b_prod_a_b_prod_prod$) (tl$p A_b_prod_a_b_prod_prod_list$)))))
(declare-codatatypes () ((A_b_prod_a_b_prod_prod_stream$ (sCons$j (shd$j A_b_prod_a_b_prod_prod$) (stl$j A_b_prod_a_b_prod_prod_stream$)))
  (Nat_a_prod_stream$ (sCons$k (shd$k Nat_a_prod$) (stl$k Nat_a_prod_stream$)))
  (A_nat_a_prod_prod_stream$ (sCons$l (shd$l A_nat_a_prod_prod$) (stl$l A_nat_a_prod_prod_stream$)))))
(declare-datatypes () ((Nat_b_prod$ (pair$n (fst$n Nat$) (snd$n B$)))
  (Nat_b_prod_list$ (nil$q) (cons$q (hd$q Nat_b_prod$) (tl$q Nat_b_prod_list$)))
  (Nat_nat_a_prod_prod$ (pair$o (fst$o Nat$) (snd$o Nat_a_prod$)))
  (Nat_nat_a_prod_prod_list$ (nil$r) (cons$r (hd$r Nat_nat_a_prod_prod$) (tl$r Nat_nat_a_prod_prod_list$)))
  (Nat_b_b_prod_prod$ (pair$p (fst$p Nat$) (snd$p B_b_prod$)))
  (Nat_b_b_prod_prod_list$ (nil$s) (cons$s (hd$s Nat_b_b_prod_prod$) (tl$s Nat_b_b_prod_prod_list$)))
  (Nat_b_a_prod_prod$ (pair$q (fst$q Nat$) (snd$q B_a_prod$)))
  (Nat_b_a_prod_prod_list$ (nil$t) (cons$t (hd$t Nat_b_a_prod_prod$) (tl$t Nat_b_a_prod_prod_list$)))
  (Nat_a_b_prod_prod$ (pair$r (fst$r Nat$) (snd$r A_b_prod$)))
  (Nat_a_b_prod_prod_list$ (nil$u) (cons$u (hd$u Nat_a_b_prod_prod$) (tl$u Nat_a_b_prod_prod_list$)))
  (Nat_a_a_prod_prod$ (pair$s (fst$s Nat$) (snd$s A_a_prod$)))
  (Nat_a_a_prod_prod_list$ (nil$v) (cons$v (hd$v Nat_a_a_prod_prod$) (tl$v Nat_a_a_prod_prod_list$)))
  (Nat_nat_prod$ (pair$t (fst$t Nat$) (snd$t Nat$)))
  (Nat_nat_prod_list$ (nil$w) (cons$w (hd$w Nat_nat_prod$) (tl$w Nat_nat_prod_list$)))
  (Nat_a_b_b_prod_prod_prod$ (pair$u (fst$u Nat$) (snd$u A_b_b_prod_prod$)))
  (Nat_a_b_b_prod_prod_prod_list$ (nil$x) (cons$x (hd$x Nat_a_b_b_prod_prod_prod$) (tl$x Nat_a_b_b_prod_prod_prod_list$)))
  (Nat_a_b_a_prod_prod_prod$ (pair$v (fst$v Nat$) (snd$v A_b_a_prod_prod$)))
  (Nat_a_b_a_prod_prod_prod_list$ (nil$y) (cons$y (hd$y Nat_a_b_a_prod_prod_prod$) (tl$y Nat_a_b_a_prod_prod_prod_list$)))))
