...
(declare-codatatypes () ((A_b_prod_stream$ (sCons$ (shd$ A_b_prod$) (stl$ A_b_prod_stream$)))
  ...
  (D_stream$ (sCons$d (shd$d D$) (stl$d D_stream$)))))
(declare-datatypes () ((C_d_prod$ (pair$a (fst$a C$) (snd$a D$)))))
(declare-codatatypes () ((C_d_prod_stream$ (sCons$e (shd$e C_d_prod$) (stl$e C_d_prod_stream$)))))
(declare-datatypes () ((C_b_prod$ (pair$b (fst$b C$) (snd$b B$)))))
(declare-codatatypes () ((C_b_prod_stream$ (sCons$f (shd$f C_b_prod$) (stl$f C_b_prod_stream$)))))
(declare-datatypes () ((A_d_prod$ (pair$c (fst$c A$) (snd$c D$)))))
(declare-codatatypes () ((A_d_prod_stream$ (sCons$g (shd$g A_d_prod$) (stl$g A_d_prod_stream$)))))
(declare-datatypes () ((A_b_prod_d_prod$ (pair$d (fst$d A_b_prod$) (snd$d D$)))))
(declare-codatatypes () ((A_b_prod_d_prod_stream$ (sCons$h (shd$h A_b_prod_d_prod$) (stl$h A_b_prod_d_prod_stream$)))))
(declare-datatypes () ((A_b_prod_b_prod$ (pair$e (fst$e A_b_prod$) (snd$e B$)))))
(declare-codatatypes () ((A_b_prod_b_prod_stream$ (sCons$i (shd$i A_b_prod_b_prod$) (stl$i A_b_prod_b_prod_stream$)))))
(declare-datatypes () ((D_d_prod$ (pair$f (fst$f D$) (snd$f D$)))))
(declare-codatatypes () ((D_d_prod_stream$ (sCons$j (shd$j D_d_prod$) (stl$j D_d_prod_stream$)))))
(declare-datatypes () ((D_c_prod$ (pair$g (fst$g D$) (snd$g C$)))))
(declare-codatatypes () ((D_c_prod_stream$ (sCons$k (shd$k D_c_prod$) (stl$k D_c_prod_stream$)))))
(declare-datatypes () ((D_b_prod$ (pair$h (fst$h D$) (snd$h B$)))))
(declare-codatatypes () ((D_b_prod_stream$ (sCons$l (shd$l D_b_prod$) (stl$l D_b_prod_stream$)))))
(declare-datatypes () ((D_a_prod$ (pair$i (fst$i D$) (snd$i A$)))))
(declare-codatatypes () ((D_a_prod_stream$ (sCons$m (shd$m D_a_prod$) (stl$m D_a_prod_stream$)))))
(declare-datatypes () ((C_c_prod$ (pair$j (fst$j C$) (snd$j C$)))))
(declare-codatatypes () ((C_c_prod_stream$ (sCons$n (shd$n C_c_prod$) (stl$n C_c_prod_stream$)))))
(declare-datatypes () ((C_a_prod$ (pair$k (fst$k C$) (snd$k A$)))))
(declare-codatatypes () ((C_a_prod_stream$ (sCons$o (shd$o C_a_prod$) (stl$o C_a_prod_stream$)))))
(declare-datatypes () ((B_d_prod$ (pair$l (fst$l B$) (snd$l D$)))))
(declare-codatatypes () ((B_d_prod_stream$ (sCons$p (shd$p B_d_prod$) (stl$p B_d_prod_stream$)))))
