...
(declare-codatatypes () ((B_b_prod_stream$ (sCons$e (shd$e B_b_prod$) (stl$e B_b_prod_stream$)))))
...
(declare-codatatypes () ((A_a_b_prod_prod_stream$ (sCons$g (shd$g A_a_b_prod_prod$) (stl$g A_a_b_prod_prod_stream$)))))
(declare-datatypes () ((A_a_prod$ (pair$f (fst$f A$) (snd$f A$)))))
(declare-codatatypes () ((A_a_prod_stream$ (sCons$h (shd$h A_a_prod$) (stl$h A_a_prod_stream$)))
  (B_stream_stream$ (sCons$i (shd$i B_stream$) (stl$i B_stream_stream$)))
  (A_b_prod_stream_stream$ (sCons$j (shd$j A_b_prod_stream$) (stl$j A_b_prod_stream_stream$)))
  (B_stream_stream_stream$ (sCons$k (shd$k B_stream_stream$) (stl$k B_stream_stream_stream$)))
  (A_stream_stream$ (sCons$l (shd$l A_stream$) (stl$l A_stream_stream$)))))
...
(declare-codatatypes () ((A_b_prod_b_prod_stream$ (sCons$n (shd$n A_b_prod_b_prod$) (stl$n A_b_prod_b_prod_stream$)))))
(declare-datatypes () ((A_b_prod_a_prod$ (pair$i (fst$i A_b_prod$) (snd$i A$)))))
(declare-codatatypes () ((A_b_prod_a_prod_stream$ (sCons$o (shd$o A_b_prod_a_prod$) (stl$o A_b_prod_a_prod_stream$)))))
(declare-fun b$ () B$)
