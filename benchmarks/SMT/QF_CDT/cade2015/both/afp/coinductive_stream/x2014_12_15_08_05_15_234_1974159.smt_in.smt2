...
(declare-codatatypes () ((A_a_b_prod_prod_stream$ (sCons$d (shd$d A_a_b_prod_prod$) (stl$d A_a_b_prod_prod_stream$)))))
(declare-datatypes () ((A_b_prod_b_prod$ (pair$c (fst$c A_b_prod$) (snd$c B$)))))
(declare-codatatypes () ((A_b_prod_b_prod_stream$ (sCons$e (shd$e A_b_prod_b_prod$) (stl$e A_b_prod_b_prod_stream$)))))
(declare-datatypes () ((A_b_prod_a_b_prod_prod$ (pair$d (fst$d A_b_prod$) (snd$d A_b_prod$)))))
(declare-codatatypes () ((A_b_prod_a_b_prod_prod_stream$ (sCons$f (shd$f A_b_prod_a_b_prod_prod$) (stl$f A_b_prod_a_b_prod_prod_stream$)))))
(declare-datatypes () ((A_b_prod_a_prod$ (pair$e (fst$e A_b_prod$) (snd$e A$)))))
(declare-codatatypes () ((A_b_prod_a_prod_stream$ (sCons$g (shd$g A_b_prod_a_prod$) (stl$g A_b_prod_a_prod_stream$)))))
(declare-datatypes () ((A_b_prod_b_prod_b_prod$ (pair$f (fst$f A_b_prod_b_prod$) (snd$f B$)))))
(declare-codatatypes () ((A_b_prod_b_prod_b_prod_stream$ (sCons$h (shd$h A_b_prod_b_prod_b_prod$) (stl$h A_b_prod_b_prod_b_prod_stream$)))))
(declare-datatypes () ((A_b_prod_b_prod_a_b_prod_prod$ (pair$g (fst$g A_b_prod_b_prod$) (snd$g A_b_prod$)))))
(declare-codatatypes () ((A_b_prod_b_prod_a_b_prod_prod_stream$ (sCons$i (shd$i A_b_prod_b_prod_a_b_prod_prod$) (stl$i A_b_prod_b_prod_a_b_prod_prod_stream$)))))
...
(declare-datatypes () ((B_a_prod$ (pair$i (fst$i B$) (snd$i A$)))))
(declare-codatatypes () ((B_a_prod_stream$ (sCons$k (shd$k B_a_prod$) (stl$k B_a_prod_stream$)))))
