; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 6
...
(declare-codatatypes () ((A_llist$ (lNil$) (lCons$ (lhd$ A$) (ltl$ A_llist$)))
  ...
  (A_llist_stream$ (sCons$b (shd$b A_llist$) (stl$b A_llist_stream$)))))
(declare-fun x$ () B$)
