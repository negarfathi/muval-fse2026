...
(declare-codatatypes () ((A_a_prod_a_a_prod_prod_stream$ (sCons$a (shd$a A_a_prod_a_a_prod_prod$) (stl$a A_a_prod_a_a_prod_prod_stream$)))
  (A_a_prod_a_a_prod_prod_llist$ (lNil$a) (lCons$a (lhd$a A_a_prod_a_a_prod_prod$) (ltl$a A_a_prod_a_a_prod_prod_llist$)))))
(declare-datatypes () ((A_a_prod_a_prod$ (pair$b (fst$b A_a_prod$) (snd$b A$)))))
(declare-codatatypes () ((A_a_prod_a_prod_stream$ (sCons$b (shd$b A_a_prod_a_prod$) (stl$b A_a_prod_a_prod_stream$)))
  (A_a_prod_a_prod_llist$ (lNil$b) (lCons$b (lhd$b A_a_prod_a_prod$) (ltl$b A_a_prod_a_prod_llist$)))))
(declare-datatypes () ((A_a_a_prod_prod$ (pair$c (fst$c A$) (snd$c A_a_prod$)))))
(declare-codatatypes () ((A_a_a_prod_prod_stream$ (sCons$c (shd$c A_a_a_prod_prod$) (stl$c A_a_a_prod_prod_stream$)))
  (A_a_a_prod_prod_llist$ (lNil$c) (lCons$c (lhd$c A_a_a_prod_prod$) (ltl$c A_a_a_prod_prod_llist$)))
