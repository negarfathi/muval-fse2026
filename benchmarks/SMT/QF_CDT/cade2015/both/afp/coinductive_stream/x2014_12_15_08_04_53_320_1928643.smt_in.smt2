...
(declare-codatatypes () ((B_stream$ (sCons$a (shd$a B$) (stl$a B_stream$)))
  (A_a_prod_stream$ (sCons$b (shd$b A_a_prod$) (stl$b A_a_prod_stream$)))))
(declare-datatypes () ((A_b_prod$ (pair$a (fst$a A$) (snd$a B$)))
  ...
  (B_b_prod$ (pair$d (fst$d B$) (snd$d B$)))
  (B_a_a_prod_prod$ (pair$e (fst$e B$) (snd$e A_a_prod$)))
  (A_a_prod_a_prod$ (pair$f (fst$f A_a_prod$) (snd$f A$)))
  (A_a_prod_b_prod$ (pair$g (fst$g A_a_prod$) (snd$g B$)))
