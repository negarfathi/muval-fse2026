...
(assert (! (not (= (and (fun_app$ (fun_app$a lprefix$ xs$) ys$) (not (= xs$ ys$))) (and (fun_app$ (fun_app$a lprefix$ xs$) ys$) (not (fun_app$ (fun_app$a lprefix$ ys$) xs$))))) :named a0))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (! (= (fun_app$ (less_eq$ ?v0) ?v1) (fun_app$ (fun_app$a lprefix$ ?v0) ?v1)) :pattern ((fun_app$ (less_eq$ ?v0) ?v1)))) :named a9))
(assert (! (= finite_lprefix$ lprefix$) :named a10))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (! (= (fun_app$ (lstrict_prefix$ ?v0) ?v1) (and (fun_app$ (fun_app$a lprefix$ ?v0) ?v1) (not (= ?v0 ?v1)))) :pattern ((fun_app$ (lstrict_prefix$ ?v0) ?v1)))) :named a11))
(assert (! (forall ((?v0 Nat_a_fun$) (?v1 A_llist$)) (= (fun_app$ (fun_app$a lprefix$ (inf_llist$ ?v0)) ?v1) (= ?v1 (inf_llist$ ?v0)))) :named a12))
(assert (! (forall ((?v0 Nat_a_fun$) (?v1 Nat_a_fun$)) (= (= (inf_llist$ ?v0) (inf_llist$ ?v1)) (= ?v0 ?v1))) :named a13))
