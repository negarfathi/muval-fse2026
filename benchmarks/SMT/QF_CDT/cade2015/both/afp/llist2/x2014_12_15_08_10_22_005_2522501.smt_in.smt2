; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 525
...
(assert (! (not (= (ll2f$ (ldrop$ ta$ (suc$ k$)) j$) (ll2f$ ta$ (plus$ (suc$ k$) j$)))) :named a0))
(assert (! (forall ((?v0 A_llist$)) (= (ll2f$ (ldrop$ ?v0 k$) j$) (ll2f$ ?v0 (plus$ k$ j$)))) :named a1))
(assert (! (forall ((?v0 A_llist$) (?v1 Nat$) (?v2 Nat$)) (= (ldrop$ ?v0 (plus$ ?v1 ?v2)) (ldrop$ (ldrop$ ?v0 ?v1) ?v2))) :named a2))
(assert (! (forall ((?v0 Nat$) (?v1 Nat$)) (! (= (plus$ ?v0 (suc$ ?v1)) (suc$ (plus$ ?v0 ?v1))) :pattern ((plus$ ?v0 (suc$ ?v1))))) :named a3))
...
(assert (! (forall ((?v0 A_llist$) (?v1 Nat$) (?v2 Nat$)) (= (ltake$ (ldrop$ ?v0 ?v1) ?v2) (ldrop$ (ltake$ ?v0 (plus$ ?v2 ?v1)) ?v1))) :named a10))
...
(assert (! (forall ((?v0 Nat$) (?v1 Nat$) (?v2 Nat$) (?v3 Nat$)) (=> (and (= ?v0 ?v1) (= ?v2 ?v3)) (= (plus$ ?v0 ?v2) (plus$ ?v1 ?v3)))) :named a14))
