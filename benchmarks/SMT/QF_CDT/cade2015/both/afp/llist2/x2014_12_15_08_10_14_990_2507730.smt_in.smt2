...
(assert (! (not (= (ldrop$ t$ (plus$ i$ k$)) (ldrop$ (ldrop$ t$ i$) k$))) :named a0))
...
(assert (! (forall ((?v0 A_llist$) (?v1 Nat$) (?v2 Nat$)) (= (ltake$ (ldrop$ ?v0 ?v1) ?v2) (ldrop$ (ltake$ ?v0 (plus$ ?v2 ?v1)) ?v1))) :named a3))
