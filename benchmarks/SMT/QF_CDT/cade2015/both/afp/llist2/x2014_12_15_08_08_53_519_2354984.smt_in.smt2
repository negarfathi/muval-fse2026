...
(assert (! (forall ((?v0 A_llist_llist_set$)) (=> (forall ((?v1 A_llist_llist$)) (member$a ?v1 ?v0)) (= top$b ?v0))) :named a20))
(assert (! (forall ((?v0 A_llist_set$)) (=> (forall ((?v1 A_llist$)) (member$ ?v1 ?v0)) (= top$a ?v0))) :named a21))
(assert (! (forall ((?v0 A_set$)) (=> (forall ((?v1 A$)) (member$b ?v1 ?v0)) (= top$ ?v0))) :named a22))
(assert (! (exists ((?v0 A_llist_llist$)) (member$a ?v0 top$b)) :named a23))
(assert (! (exists ((?v0 A_llist$)) (member$ ?v0 top$a)) :named a24))
(assert (! (exists ((?v0 A$)) (member$b ?v0 top$)) :named a25))
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_set$)) (=> (member$a ?v0 (finlsts$a ?v1)) (member$a (lrev$ ?v0) (finlsts$a ?v1)))) :named a26))
(assert (! (forall ((?v0 A_llist$) (?v1 A_set$)) (=> (member$ ?v0 (finlsts$ ?v1)) (member$ (lrev$a ?v0) (finlsts$ ?v1)))) :named a27))
(assert (! (forall ((?v0 A_llist_llist$)) (=> (and (=> (member$a ?v0 (finlsts$a top$a)) false) (=> (member$a ?v0 (inflsts$ top$a)) false)) false)) :named a28))
(assert (! (forall ((?v0 A_llist$)) (=> (and (=> (member$ ?v0 (finlsts$ top$)) false) (=> (member$ ?v0 (inflsts$a top$)) false)) false)) :named a29))
(assert (! (forall ((?v0 A_llist_llist$)) (member$a ?v0 (alllsts$ top$a))) :named a30))
(assert (! (forall ((?v0 A_llist$)) (member$ ?v0 (alllsts$a top$))) :named a31))
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_set$)) (=> (and (member$a ?v0 (alllsts$ ?v1)) (=> (member$a ?v0 (finlsts$a top$a)) false)) (member$a ?v0 (inflsts$ ?v1)))) :named a32))
(assert (! (forall ((?v0 A_llist$) (?v1 A_set$)) (=> (and (member$ ?v0 (alllsts$a ?v1)) (=> (member$ ?v0 (finlsts$ top$)) false)) (member$ ?v0 (inflsts$a ?v1)))) :named a33))
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_set$)) (=> (member$a ?v0 (inflsts$ ?v1)) (member$a ?v0 (alllsts$ ?v1)))) :named a34))
(assert (! (forall ((?v0 A_llist$) (?v1 A_set$)) (=> (member$ ?v0 (inflsts$a ?v1)) (member$ ?v0 (alllsts$a ?v1)))) :named a35))
(check-sat)
;(get-unsat-core)
