...
(assert (! (= ta$ (lCons$ b$ ts$)) :named a5))
(assert (! (forall ((?v0 A_llist$)) (less_eq$ ?v0 ?v0)) :named a6))
(assert (! (not (less_eq$ ta$ (lCons$ a$ l$))) :named a7))
(assert (! (less_eq$ (lCons$ a$ l$) xa$) :named a8))
...
(assert (! (forall ((?v0 A_llist_set$)) (= (prefix_closed$ ?v0) (forall ((?v1 A_llist$)) (=> (member$a ?v1 ?v0) (forall ((?v2 A_llist$)) (=> (less_eq$ ?v2 ?v1) (member$a ?v2 ?v0))))))) :named a13))
(assert (! (forall ((?v0 A_llist_set$)) (= (suffix_closed$ ?v0) (forall ((?v1 A_llist$)) (=> (member$a ?v1 ?v0) (forall ((?v2 A_llist$)) (=> (less_eq$ ?v1 ?v2) (member$a ?v2 ?v0))))))) :named a14))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (= ?v0 ?v1) (and (less_eq$ ?v0 ?v1) (less_eq$ ?v1 ?v0)))) :named a17))
(check-sat)
;(get-unsat-core)
