...
(assert (! (forall ((?v0 A_llist_llist_llist$) (?v1 A_llist_llist_set$) (?v2 A_llist_llist$)) (=> (member$c ?v0 (finlsts$b ?v1)) (= (llast$ (lCons$b ?v2 ?v0)) (ite (= ?v0 lNil$b) ?v2 (llast$ ?v0))))) :named a32))
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_set$) (?v2 A_llist$)) (=> (member$d ?v0 (finlsts$c ?v1)) (= (llast$a (lCons$a ?v2 ?v0)) (ite (= ?v0 lNil$a) ?v2 (llast$a ?v0))))) :named a33))
(assert (! (forall ((?v0 A_llist$) (?v1 A_set$) (?v2 A$)) (=> (member$ ?v0 (finlsts$ ?v1)) (= (llast$b (lCons$ ?v2 ?v0)) (ite (= ?v0 lNil$) ?v2 (llast$b ?v0))))) :named a34))
(assert (! (forall ((?v0 A_llist_llist_llist$) (?v1 A_llist_llist_set$) (?v2 A_llist_llist$)) (=> (member$c ?v0 (finlsts$b ?v1)) (= (lbutlast$ (lCons$b ?v2 ?v0)) (ite (= ?v0 lNil$b) lNil$b (lCons$b ?v2 (lbutlast$ ?v0)))))) :named a35))
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_set$) (?v2 A_llist$)) (=> (member$d ?v0 (finlsts$c ?v1)) (= (lbutlast$a (lCons$a ?v2 ?v0)) (ite (= ?v0 lNil$a) lNil$a (lCons$a ?v2 (lbutlast$a ?v0)))))) :named a36))
(assert (! (forall ((?v0 A_llist$) (?v1 A_set$) (?v2 A$)) (=> (member$ ?v0 (finlsts$ ?v1)) (= (lbutlast$b (lCons$ ?v2 ?v0)) (ite (= ?v0 lNil$) lNil$ (lCons$ ?v2 (lbutlast$b ?v0)))))) :named a37))
(assert (! (= (llast$b (lappend$ l$ (lCons$ x$ lNil$))) x$) :named a38))
