...
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_llist$)) (=> (and (member$a ?v0 (finlsts$a top$a)) (member$a ?v1 (finlsts$a top$a))) (= (= (lrev$ ?v0) (lrev$ ?v1)) (= ?v0 ?v1)))) :named a14))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (and (member$ ?v0 (finlsts$ top$)) (member$ ?v1 (finlsts$ top$))) (= (= (lrev$a ?v0) (lrev$a ?v1)) (= ?v0 ?v1)))) :named a15))
(assert (! (forall ((?v0 A_llist_llist$)) (=> (member$a ?v0 (finlsts$a top$a)) (= (lrev$ (lrev$ ?v0)) ?v0))) :named a16))
(assert (! (forall ((?v0 A_llist$)) (=> (member$ ?v0 (finlsts$ top$)) (= (lrev$a (lrev$a ?v0)) ?v0))) :named a17))
(assert (! (forall ((?v0 A_llist$)) (=> (= (ll2f$ ?v0 n$) none$) (member$ ?v0 (finlsts$ top$)))) :named a18))
(assert (! (forall ((?v0 A_llist_llist$)) (= (not (member$a ?v0 (finlsts$a top$a))) (member$a ?v0 (inflsts$ top$a)))) :named a19))
(assert (! (forall ((?v0 A_llist$)) (= (not (member$ ?v0 (finlsts$ top$))) (member$ ?v0 (inflsts$a top$)))) :named a20))
(assert (! (forall ((?v0 A_llist_llist$)) (= (not (member$a ?v0 (inflsts$ top$a))) (member$a ?v0 (finlsts$a top$a)))) :named a21))
(assert (! (forall ((?v0 A_llist$)) (= (not (member$ ?v0 (inflsts$a top$))) (member$ ?v0 (finlsts$ top$)))) :named a22))
...
(assert (! (forall ((?v0 A_llist_llist$)) (=> (member$a ?v0 (finlsts$a top$a)) (= (= (lrev$ ?v0) lNil$a) (= ?v0 lNil$a)))) :named a29))
(assert (! (forall ((?v0 A_llist$)) (=> (member$ ?v0 (finlsts$ top$)) (= (= (lrev$a ?v0) lNil$) (= ?v0 lNil$)))) :named a30))
