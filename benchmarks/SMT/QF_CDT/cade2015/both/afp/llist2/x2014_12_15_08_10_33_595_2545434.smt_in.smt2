...
(assert (! (not (member$ (fun_app$ (ldrop$ ta$) (suc$ n$)) (finlsts$ a$))) :named a0))
(assert (! (member$ ta$ (finlsts$ a$)) :named a1))
(assert (! (forall ((?v0 A_llist$)) (=> (member$ ?v0 (finlsts$ a$)) (member$ (fun_app$ (ldrop$ ?v0) n$) (finlsts$ a$)))) :named a2))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_set$)) (=> (member$ ?v0 (finlsts$ ?v1)) (member$ (lrev$ ?v0) (finlsts$ ?v1)))) :named a7))
...
(assert (! (forall ((?v0 A_llist$)) (! (= (fun_app$ (ldrop$ ?v0) zero$) ?v0) :pattern ((ldrop$ ?v0)))) :named a10))
(assert (! (forall ((?v0 A_llist$) (?v1 A_set$) (?v2 A$)) (=> (member$ ?v0 (finlsts$ ?v1)) (= (llength$ (lCons$ ?v2 ?v0)) (suc$ (llength$ ?v0))))) :named a11))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_set$) (?v2 A_set$)) (=> (and (member$ ?v0 (finlsts$ ?v1)) (member$ ?v0 (alllsts$ ?v2))) (member$ ?v0 (finlsts$ ?v2)))) :named a13))
