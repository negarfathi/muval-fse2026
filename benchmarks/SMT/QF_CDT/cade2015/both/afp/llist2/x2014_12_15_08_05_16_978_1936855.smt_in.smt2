...
(assert (! (not (less_eq$ (finlsts$ a$) (finlsts$ b$))) :named a0))
...
(assert (! (forall ((?v0 A_llist_llist_llist_set$) (?v1 A_llist_llist_llist_set$)) (= (= ?v0 ?v1) (and (less_eq$b ?v0 ?v1) (less_eq$b ?v1 ?v0)))) :named a22))
(assert (! (forall ((?v0 A_llist_llist_set$) (?v1 A_llist_llist_set$)) (= (= ?v0 ?v1) (and (less_eq$c ?v0 ?v1) (less_eq$c ?v1 ?v0)))) :named a23))
(assert (! (forall ((?v0 A_llist_set$) (?v1 A_llist_set$)) (= (= ?v0 ?v1) (and (less_eq$ ?v0 ?v1) (less_eq$ ?v1 ?v0)))) :named a24))
(assert (! (forall ((?v0 A_set$) (?v1 A_set$)) (= (= ?v0 ?v1) (and (less_eq$a ?v0 ?v1) (less_eq$a ?v1 ?v0)))) :named a25))
...
(assert (! (forall ((?v0 A_llist_llist_llist_bool_fun$) (?v1 A_llist_llist_llist_bool_fun$)) (=> (forall ((?v2 A_llist_llist_llist$)) (=> (fun_app$ ?v0 ?v2) (fun_app$ ?v1 ?v2))) (less_eq$b (collect$ ?v0) (collect$ ?v1)))) :named a34))
(assert (! (forall ((?v0 A_llist_llist_bool_fun$) (?v1 A_llist_llist_bool_fun$)) (=> (forall ((?v2 A_llist_llist$)) (=> (fun_app$a ?v0 ?v2) (fun_app$a ?v1 ?v2))) (less_eq$c (collect$a ?v0) (collect$a ?v1)))) :named a35))
(assert (! (forall ((?v0 A_llist_bool_fun$) (?v1 A_llist_bool_fun$)) (=> (forall ((?v2 A_llist$)) (=> (fun_app$b ?v0 ?v2) (fun_app$b ?v1 ?v2))) (less_eq$ (collect$b ?v0) (collect$b ?v1)))) :named a36))
(assert (! (forall ((?v0 A_bool_fun$) (?v1 A_bool_fun$)) (=> (forall ((?v2 A$)) (=> (fun_app$c ?v0 ?v2) (fun_app$c ?v1 ?v2))) (less_eq$a (collect$c ?v0) (collect$c ?v1)))) :named a37))
(assert (! (forall ((?v0 A_llist_llist_llist_set$) (?v1 A_llist_llist_llist_set$)) (=> (and (= ?v0 ?v1) (=> (and (less_eq$b ?v0 ?v1) (less_eq$b ?v1 ?v0)) false)) false)) :named a38))
(assert (! (forall ((?v0 A_llist_llist_set$) (?v1 A_llist_llist_set$)) (=> (and (= ?v0 ?v1) (=> (and (less_eq$c ?v0 ?v1) (less_eq$c ?v1 ?v0)) false)) false)) :named a39))
(assert (! (forall ((?v0 A_llist_set$) (?v1 A_llist_set$)) (=> (and (= ?v0 ?v1) (=> (and (less_eq$ ?v0 ?v1) (less_eq$ ?v1 ?v0)) false)) false)) :named a40))
(assert (! (forall ((?v0 A_set$) (?v1 A_set$)) (=> (and (= ?v0 ?v1) (=> (and (less_eq$a ?v0 ?v1) (less_eq$a ?v1 ?v0)) false)) false)) :named a41))
(assert (! (forall ((?v0 A_llist_llist_llist_set$) (?v1 A_llist_llist_llist_set$)) (=> (= ?v0 ?v1) (less_eq$b ?v1 ?v0))) :named a42))
(assert (! (forall ((?v0 A_llist_llist_set$) (?v1 A_llist_llist_set$)) (=> (= ?v0 ?v1) (less_eq$c ?v1 ?v0))) :named a43))
(assert (! (forall ((?v0 A_llist_set$) (?v1 A_llist_set$)) (=> (= ?v0 ?v1) (less_eq$ ?v1 ?v0))) :named a44))
(assert (! (forall ((?v0 A_set$) (?v1 A_set$)) (=> (= ?v0 ?v1) (less_eq$a ?v1 ?v0))) :named a45))
(assert (! (forall ((?v0 A_llist_llist_llist_set$) (?v1 A_llist_llist_llist_set$)) (=> (= ?v0 ?v1) (less_eq$b ?v0 ?v1))) :named a46))
(assert (! (forall ((?v0 A_llist_llist_set$) (?v1 A_llist_llist_set$)) (=> (= ?v0 ?v1) (less_eq$c ?v0 ?v1))) :named a47))
(assert (! (forall ((?v0 A_llist_set$) (?v1 A_llist_set$)) (=> (= ?v0 ?v1) (less_eq$ ?v0 ?v1))) :named a48))
(assert (! (forall ((?v0 A_set$) (?v1 A_set$)) (=> (= ?v0 ?v1) (less_eq$a ?v0 ?v1))) :named a49))
(assert (! (forall ((?v0 A_llist_llist_llist$) (?v1 A_llist_llist_set$)) (=> (member$ ?v0 (finlsts$a ?v1)) (member$ ?v0 (alllsts$a ?v1)))) :named a50))
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_set$)) (=> (member$a ?v0 (finlsts$b ?v1)) (member$a ?v0 (alllsts$b ?v1)))) :named a51))
(assert (! (forall ((?v0 A_llist$) (?v1 A_set$)) (=> (member$b ?v0 (finlsts$ ?v1)) (member$b ?v0 (alllsts$c ?v1)))) :named a52))
