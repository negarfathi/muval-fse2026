...
(assert (! (not (forall ((?v0 A_llist$)) (=> (and (less_eq$ s$ ?v0) (less_eq$ ?v0 s$)) (= s$ ?v0)))) :named a0))
...
(assert (! (member$ s$ (alllsts$ top$)) :named a9))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (! (= (less$ ?v0 ?v1) (and (less_eq$ ?v0 ?v1) (not (= ?v0 ?v1)))) :pattern ((less$ ?v0 ?v1)))) :named a10))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (less_eq$ ?v0 ?v1) (exists ((?v2 A_llist$)) (= ?v1 (lappend$ ?v0 ?v2))))) :named a11))
(check-sat)
;(get-unsat-core)
