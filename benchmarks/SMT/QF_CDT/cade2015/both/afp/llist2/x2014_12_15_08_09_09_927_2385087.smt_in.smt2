...
(assert (! (forall ((?v0 Nat$)) (! (= (fun_app$ uu$ ?v0) (= (fun_app$a (ll2f$ l$) ?v0) none$)) :pattern ((fun_app$ uu$ ?v0)))) :named a0))
...
(assert (! (not (= (llength$ l$) (least$ uu$))) :named a3))
(assert (! (= l$ lNil$) :named a4))
(assert (! (forall ((?v0 Nat$)) (! (= (fun_app$a (ll2f$ lNil$) ?v0) none$) :pattern ((fun_app$a (ll2f$ lNil$) ?v0)))) :named a5))
(assert (! (forall ((?v0 Nat_bool_fun$) (?v1 Nat$)) (=> (fun_app$ ?v0 ?v1) (fun_app$ ?v0 (least$ ?v0)))) :named a6))
(assert (! (forall ((?v0 A_llist$) (?v1 A_set$)) (=> (member$a ?v0 (finlsts$ ?v1)) (= (fun_app$a (ll2f$ ?v0) (llength$ ?v0)) none$))) :named a7))
(assert (! (forall ((?v0 Nat_bool_fun$) (?v1 Nat_bool_fun$)) (=> (and (exists ((?v2 Nat$)) (fun_app$ ?v0 ?v2)) (forall ((?v2 Nat$)) (=> (fun_app$ ?v0 ?v2) (fun_app$ ?v1 ?v2)))) (fun_app$ ?v1 (least$ ?v0)))) :named a8))
(assert (! (forall ((?v0 Nat_bool_fun$)) (=> (exists ((?v1 Nat$)) (fun_app$ ?v0 ?v1)) (fun_app$ ?v0 (least$ ?v0)))) :named a9))
(assert (! (forall ((?v0 Nat_bool_fun$) (?v1 Nat$) (?v2 Nat_bool_fun$)) (=> (and (fun_app$ ?v0 ?v1) (forall ((?v3 Nat$)) (=> (fun_app$ ?v0 ?v3) (fun_app$ ?v2 ?v3)))) (fun_app$ ?v2 (least$ ?v0)))) :named a10))
(assert (! (forall ((?v0 A_option$)) (=> (and (=> (= ?v0 none$) false) (=> (not (= ?v0 none$)) false)) false)) :named a11))
...
(assert (! (= (llength$ lNil$) zero$) :named a16))
(assert (! (forall ((?v0 A_set$)) (member$a lNil$ (finlsts$ ?v0))) :named a17))
(check-sat)
;(get-unsat-core)
