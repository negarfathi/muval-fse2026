...
(declare-codatatypes () ((A_b_prod_c_d_prod_tllist$ (tNil$ (terminal$ C_d_prod$)) (tCons$ (thd$ A_b_prod$) (ttl$ A_b_prod_c_d_prod_tllist$)))
  ...
  (A_b_prod_a_b_prod_tllist$ (tNil$d (terminal$d A_b_prod$)) (tCons$d (thd$d A_b_prod$) (ttl$d A_b_prod_a_b_prod_tllist$)))))
(declare-datatypes () ((A_llist_c_prod$ (pair$b (fst$b A_llist$) (snd$b C$)))
  (B_llist_d_prod$ (pair$c (fst$c B_llist$) (snd$c D$)))
  (A_b_prod_a_b_prod_prod$ (pair$d (fst$d A_b_prod$) (snd$d A_b_prod$)))
  (C_d_prod_c_d_prod_prod$ (pair$e (fst$e C_d_prod$) (snd$e C_d_prod$)))))
(declare-codatatypes () ((A_b_prod_a_b_prod_prod_c_d_prod_c_d_prod_prod_tllist$ (tNil$e (terminal$e C_d_prod_c_d_prod_prod$)) (tCons$e (thd$e A_b_prod_a_b_prod_prod$) (ttl$e A_b_prod_a_b_prod_prod_c_d_prod_c_d_prod_prod_tllist$)))
  ...
  (C_d_prod_a_b_prod_tllist$ (tNil$i (terminal$i A_b_prod$)) (tCons$i (thd$i C_d_prod$) (ttl$i C_d_prod_a_b_prod_tllist$)))
  ...
  (C_d_prod_c_d_prod_tllist$ (tNil$l (terminal$l C_d_prod$)) (tCons$l (thd$l C_d_prod$) (ttl$l C_d_prod_c_d_prod_tllist$)))))
