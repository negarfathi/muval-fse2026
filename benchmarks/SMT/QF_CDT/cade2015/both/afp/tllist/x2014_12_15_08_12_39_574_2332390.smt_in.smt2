...
(declare-datatypes () ((A_a_prod$ (pair$ (fst$ A$) (snd$ A$)))
  (B_a_a_prod_prod$ (pair$a (fst$a B$) (snd$a A_a_prod$)))))
...
(declare-codatatypes () ((A_b_prod_llist$ (lNil$e) (lCons$e (lhd$e A_b_prod$) (ltl$e A_b_prod_llist$)))
  (A_a_prod_llist$ (lNil$f) (lCons$f (lhd$f A_a_prod$) (ltl$f A_a_prod_llist$)))
  (B_llist$ (lNil$g) (lCons$g (lhd$g B$) (ltl$g B_llist$)))))
