; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 1
...
(declare-codatatypes () ((A_c_tllist$ (tNil$ (terminal$ C$)) (tCons$ (thd$ A$) (ttl$ A_c_tllist$)))
  ...
  (A_llist_llist_c_tllist$ (tNil$b (terminal$b C$)) (tCons$b (thd$b A_llist_llist$) (ttl$b A_llist_llist_c_tllist$)))
  (B_llist$ (lNil$b) (lCons$b (lhd$b B$) (ltl$b B_llist$)))
  (B_llist_llist$ (lNil$c) (lCons$c (lhd$c B_llist$) (ltl$c B_llist_llist$)))
  (B_llist_llist_d_tllist$ (tNil$c (terminal$c D$)) (tCons$c (thd$c B_llist_llist$) (ttl$c B_llist_llist_d_tllist$)))
  (B_llist_d_tllist$ (tNil$d (terminal$d D$)) (tCons$d (thd$d B_llist$) (ttl$d B_llist_d_tllist$)))
  (A_llist_c_tllist$ (tNil$e (terminal$e C$)) (tCons$e (thd$e A_llist$) (ttl$e A_llist_c_tllist$)))
  (A_llist_llist_llist$ (lNil$d) (lCons$d (lhd$d A_llist_llist$) (ltl$d A_llist_llist_llist$)))
  (A_llist_llist_llist_c_tllist$ (tNil$f (terminal$f C$)) (tCons$f (thd$f A_llist_llist_llist$) (ttl$f A_llist_llist_llist_c_tllist$)))
  (B_llist_llist_llist$ (lNil$e) (lCons$e (lhd$e B_llist_llist$) (ltl$e B_llist_llist_llist$)))
  (B_llist_llist_llist_d_tllist$ (tNil$g (terminal$g D$)) (tCons$g (thd$g B_llist_llist_llist$) (ttl$g B_llist_llist_llist_d_tllist$)))))
(declare-fun b$ () C$)
