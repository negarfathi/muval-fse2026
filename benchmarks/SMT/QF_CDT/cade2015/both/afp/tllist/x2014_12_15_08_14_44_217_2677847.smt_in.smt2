...
(declare-codatatypes () ((A_e_tllist$ (tNil$ (terminal$ E$)) (tCons$ (thd$ A$) (ttl$ A_e_tllist$)))
  (B_f_tllist$ (tNil$a (terminal$a F$)) (tCons$a (thd$a B$) (ttl$a B_f_tllist$)))
  (A_c_tllist$ (tNil$b (terminal$b C$)) (tCons$b (thd$b A$) (ttl$b A_c_tllist$)))
  (B_d_tllist$ (tNil$c (terminal$c D$)) (tCons$c (thd$c B$) (ttl$c B_d_tllist$)))
  ...
  (B_c_tllist$ (tNil$e (terminal$e C$)) (tCons$e (thd$e B$) (ttl$e B_c_tllist$)))))
