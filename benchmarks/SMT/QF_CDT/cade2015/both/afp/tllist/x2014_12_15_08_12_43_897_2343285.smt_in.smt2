...
(declare-codatatypes () ((C_b_tllist$ (tNil$ (terminal$ B$)) (tCons$ (thd$ C$) (ttl$ C_b_tllist$)))
  (C_llist$ (lNil$a) (lCons$a (lhd$a C$) (ltl$a C_llist$)))))
(declare-datatypes () ((C_llist_b_prod$ (pair$a (fst$a C_llist$) (snd$a B$)))))
(declare-codatatypes () ((A_b_tllist$ (tNil$a (terminal$a B$)) (tCons$a (thd$a A$) (ttl$a A_b_tllist$)))))
