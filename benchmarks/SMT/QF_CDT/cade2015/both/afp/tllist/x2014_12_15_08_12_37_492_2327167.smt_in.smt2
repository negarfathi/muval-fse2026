...
(declare-codatatypes () ((A_b_tllist$ (tNil$ (terminal$ B$)) (tCons$ (thd$ A$) (ttl$ A_b_tllist$)))
  ...
  (A_a_b_tllist_b_fun_fun_llist$ (lNil$a) (lCons$a (select$ A_a_b_tllist_b_fun_fun$) (selecta$ A_a_b_tllist_b_fun_fun_llist$)))
  (B_llist$ (lNil$b) (lCons$b (lhd$a B$) (ltl$a B_llist$)))))
