...
(assert (! (not (= (lappendt$ lNil$ tr$) tr$)) :named a0))
...
(assert (! (forall ((?v0 Nat_set$)) (! (= (lsublist$ lNil$ ?v0) lNil$) :pattern ((lsublist$ lNil$ ?v0)))) :named a7))
...
(assert (! (forall ((?v0 A_llist$)) (= (lsublist$ ?v0 bot$) lNil$)) :named a12))
