; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 153
...
(declare-datatypes () ((A_llist_llist_b_prod$ (pair$a (fst$a A_llist_llist$) (snd$a B$)))))
(declare-fun b$ () B$)
