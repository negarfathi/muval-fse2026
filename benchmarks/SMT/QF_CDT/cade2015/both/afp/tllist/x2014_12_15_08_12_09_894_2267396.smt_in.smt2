...
(declare-codatatypes () ((A_b_prod_c_d_prod_tllist$ (tNil$ (terminal$ C_d_prod$)) (tCons$ (thd$ A_b_prod$) (ttl$ A_b_prod_c_d_prod_tllist$)))
  ...
  (A_c_tllist$ (tNil$b (terminal$b C$)) (tCons$b (thd$b A$) (ttl$b A_c_tllist$)))
  (A_b_prod_a_b_prod_tllist$ (tNil$c (terminal$c A_b_prod$)) (tCons$c (thd$c A_b_prod$) (ttl$c A_b_prod_a_b_prod_tllist$)))
  ...
  (C_d_prod_c_d_prod_tllist$ (tNil$e (terminal$e C_d_prod$)) (tCons$e (thd$e C_d_prod$) (ttl$e C_d_prod_c_d_prod_tllist$)))
...
(declare-codatatypes () ((A_b_prod_llist_a_llist_prod_llist$ (lNil$d) (lCons$d (lhd$d A_b_prod_llist_a_llist_prod$) (ltl$d A_b_prod_llist_a_llist_prod_llist$)))
  (A_b_prod_llist_a_llist_prod_c_d_prod_tllist$ (tNil$g (terminal$g C_d_prod$)) (tCons$g (thd$g A_b_prod_llist_a_llist_prod$) (ttl$g A_b_prod_llist_a_llist_prod_c_d_prod_tllist$)))
  ...
  (C_d_prod_a_b_prod_llist_a_llist_prod_tllist$ (tNil$i (terminal$i A_b_prod_llist_a_llist_prod$)) (tCons$i (thd$i C_d_prod$) (ttl$i C_d_prod_a_b_prod_llist_a_llist_prod_tllist$)))
  (A_b_prod_a_b_prod_llist_a_llist_prod_tllist$ (tNil$j (terminal$j A_b_prod_llist_a_llist_prod$)) (tCons$j (thd$j A_b_prod$) (ttl$j A_b_prod_a_b_prod_llist_a_llist_prod_tllist$)))
  (B_b_tllist$ (tNil$k (terminal$k B$)) (tCons$k (thd$k B$) (ttl$k B_b_tllist$)))
  (A_a_b_prod_llist_tllist$ (tNil$l (terminal$l A_b_prod_llist$)) (tCons$l (thd$l A$) (ttl$l A_a_b_prod_llist_tllist$)))
  (B_a_llist_tllist$ (tNil$m (terminal$m A_llist$)) (tCons$m (thd$m B$) (ttl$m B_a_llist_tllist$)))
  (C_a_b_prod_llist_tllist$ (tNil$n (terminal$n A_b_prod_llist$)) (tCons$n (thd$n C$) (ttl$n C_a_b_prod_llist_tllist$)))
  (D_a_llist_tllist$ (tNil$o (terminal$o A_llist$)) (tCons$o (thd$o D$) (ttl$o D_a_llist_tllist$)))
  (A_b_prod_llist_a_tllist$ (tNil$p (terminal$p A$)) (tCons$p (thd$p A_b_prod_llist$) (ttl$p A_b_prod_llist_a_tllist$)))
  (A_llist_b_tllist$ (tNil$q (terminal$q B$)) (tCons$q (thd$q A_llist$) (ttl$q A_llist_b_tllist$)))
  (A_b_prod_llist_c_tllist$ (tNil$r (terminal$r C$)) (tCons$r (thd$r A_b_prod_llist$) (ttl$r A_b_prod_llist_c_tllist$)))
  (A_llist_d_tllist$ (tNil$s (terminal$s D$)) (tCons$s (thd$s A_llist$) (ttl$s A_llist_d_tllist$)))
  (A_b_prod_llist_a_b_prod_llist_tllist$ (tNil$t (terminal$t A_b_prod_llist$)) (tCons$t (thd$t A_b_prod_llist$) (ttl$t A_b_prod_llist_a_b_prod_llist_tllist$)))
  (A_llist_a_llist_tllist$ (tNil$u (terminal$u A_llist$)) (tCons$u (thd$u A_llist$) (ttl$u A_llist_a_llist_tllist$)))
  (A_b_prod_llist_a_llist_prod_a_b_prod_llist_a_llist_prod_tllist$ (tNil$v (terminal$v A_b_prod_llist_a_llist_prod$)) (tCons$v (thd$v A_b_prod_llist_a_llist_prod$) (ttl$v A_b_prod_llist_a_llist_prod_a_b_prod_llist_a_llist_prod_tllist$)))
  (C_a_tllist$ (tNil$w (terminal$w A$)) (tCons$w (thd$w C$) (ttl$w C_a_tllist$)))
  (D_b_tllist$ (tNil$x (terminal$x B$)) (tCons$x (thd$x D$) (ttl$x D_b_tllist$)))
  (C_c_tllist$ (tNil$y (terminal$y C$)) (tCons$y (thd$y C$) (ttl$y C_c_tllist$)))
  (D_d_tllist$ (tNil$z (terminal$z D$)) (tCons$z (thd$z D$) (ttl$z D_d_tllist$)))))
