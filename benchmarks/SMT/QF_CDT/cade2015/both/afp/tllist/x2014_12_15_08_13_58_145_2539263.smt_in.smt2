...
(declare-datatypes () ((A_llist_b_prod$ (pair$ (fst$ A_llist$) (snd$ B$)))
  (C_llist_d_prod$ (pair$a (fst$a C_llist$) (snd$a D$)))))
(declare-codatatypes () ((A_b_tllist$ (tNil$ (terminal$ B$)) (tCons$ (thd$ A$) (ttl$ A_b_tllist$)))
  ...
  (C_llist_d_prod_llist$ (lNil$b) (lCons$b (lhd$b C_llist_d_prod$) (ltl$b C_llist_d_prod_llist$)))
  (C_d_tllist_llist$ (lNil$c) (lCons$c (lhd$c C_d_tllist$) (ltl$c C_d_tllist_llist$)))
