...
(declare-codatatypes () ((A_b_prod_llist$ (lNil$a) (lCons$a (lhd$a A_b_prod$) (ltl$a A_b_prod_llist$)))
  ...
  (B_d_tllist$ (tNil$ (terminal$ D$)) (tCons$ (thd$ B$) (ttl$ B_d_tllist$)))))
...
(declare-codatatypes () ((A_b_prod_c_d_prod_tllist$ (tNil$a (terminal$a C_d_prod$)) (tCons$a (thd$a A_b_prod$) (ttl$a A_b_prod_c_d_prod_tllist$)))
  ...
  (D_llist$ (lNil$d) (lCons$d (lhd$d D$) (ltl$d D_llist$)))))
...
(declare-datatypes () ((C_d_prod_llist_c_llist_prod$ (pair$c (fst$c C_d_prod_llist$) (snd$c C_llist$)))
  (A_b_prod_llist_b_llist_prod$ (pair$d (fst$d A_b_prod_llist$) (snd$d B_llist$)))
  (A_b_prod_llist_a_llist_prod$ (pair$e (fst$e A_b_prod_llist$) (snd$e A_llist$)))))
(declare-codatatypes () ((A_b_prod_llist_llist$ (lNil$f) (lCons$f (lhd$f A_b_prod_llist$) (ltl$f A_b_prod_llist_llist$)))
  (A_b_prod_llist_a_llist_prod_llist$ (lNil$g) (lCons$g (lhd$g A_b_prod_llist_a_llist_prod$) (ltl$g A_b_prod_llist_a_llist_prod_llist$)))))
...
(declare-codatatypes () ((C_d_prod_llist_llist$ (lNil$k) (lCons$k (lhd$k C_d_prod_llist$) (ltl$k C_d_prod_llist_llist$)))
  (D_llist_llist$ (lNil$l) (lCons$l (lhd$l D_llist$) (ltl$l D_llist_llist$)))
  (C_d_prod_llist_d_llist_prod_llist$ (lNil$m) (lCons$m (lhd$m C_d_prod_llist_d_llist_prod$) (ltl$m C_d_prod_llist_d_llist_prod_llist$)))
  (C_llist_llist$ (lNil$n) (lCons$n (lhd$n C_llist$) (ltl$n C_llist_llist$)))
  (C_d_prod_llist_c_llist_prod_llist$ (lNil$o) (lCons$o (lhd$o C_d_prod_llist_c_llist_prod$) (ltl$o C_d_prod_llist_c_llist_prod_llist$)))))
