...
(assert (! (not (= (= (tNil$ b$) (fun_app$f (tllist_of_llist$ b$a) xs$)) (and (= b$ b$a) (= xs$ lNil$)))) :named a3))
(assert (! (forall ((?v0 B$) (?v1 B$)) (= (= (tNil$ ?v0) (tNil$ ?v1)) (= ?v0 ?v1))) :named a4))
(assert (! (forall ((?v0 B$) (?v1 A_llist$) (?v2 B$)) (= (= (fun_app$f (tllist_of_llist$ ?v0) ?v1) (tNil$ ?v2)) (and (= ?v2 ?v0) (= ?v1 lNil$)))) :named a5))
(assert (! (forall ((?v0 B$)) (! (= (fun_app$f (tllist_of_llist$ ?v0) lNil$) (tNil$ ?v0)) :pattern ((tllist_of_llist$ ?v0)))) :named a6))
(assert (! (forall ((?v0 A_bool_fun$) (?v1 B_bool_fun$) (?v2 B$)) (! (= (pred_tllist$ ?v0 ?v1 (tNil$ ?v2)) (fun_app$b ?v1 ?v2)) :pattern ((pred_tllist$ ?v0 ?v1 (tNil$ ?v2))))) :named a7))
...
(assert (! (forall ((?v0 B$)) (! (= (terminal$ (tNil$ ?v0)) ?v0) :pattern ((tNil$ ?v0)))) :named a10))
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 B_b_bool_fun_fun$) (?v2 B$) (?v3 B$)) (! (= (fun_app$ (fun_app$a (tllist_all2$ ?v0 ?v1) (tNil$ ?v2)) (tNil$ ?v3)) (fun_app$b (fun_app$c ?v1 ?v2) ?v3)) :pattern ((fun_app$ (fun_app$a (tllist_all2$ ?v0 ?v1) (tNil$ ?v2)) (tNil$ ?v3))))) :named a11))
(assert (! (forall ((?v0 A_a_fun$) (?v1 B_b_fun$) (?v2 A_b_tllist$) (?v3 B$)) (= (= (tmap$ ?v0 ?v1 ?v2) (tNil$ ?v3)) (exists ((?v4 B$)) (and (= ?v2 (tNil$ ?v4)) (= (fun_app$g ?v1 ?v4) ?v3))))) :named a12))
(assert (! (forall ((?v0 B$) (?v1 A_a_fun$) (?v2 B_b_fun$) (?v3 A_b_tllist$)) (= (= (tNil$ ?v0) (tmap$ ?v1 ?v2 ?v3)) (exists ((?v4 B$)) (and (= ?v3 (tNil$ ?v4)) (= (fun_app$g ?v2 ?v4) ?v0))))) :named a13))
(assert (! (forall ((?v0 A_b_tllist$)) (= (fun_app$f (tllist_of_llist$ (terminal$ ?v0)) (llist_of_tllist$ ?v0)) ?v0)) :named a14))
