...
(declare-codatatypes () ((A_c_tllist$ (tNil$ (terminal$ C$)) (tCons$ (thd$ A$) (ttl$ A_c_tllist$)))
  ...
  (A_b_tllist$ (tNil$b (terminal$b B$)) (tCons$b (thd$b A$) (ttl$b A_b_tllist$)))
  ...
  (A_c_tllist_a_c_tllist_tllist$ (tNil$f (terminal$f A_c_tllist$)) (tCons$f (thd$f A_c_tllist$) (ttl$f A_c_tllist_a_c_tllist_tllist$)))
  (B_d_tllist_b_d_tllist_tllist$ (tNil$g (terminal$g B_d_tllist$)) (tCons$g (thd$g B_d_tllist$) (ttl$g B_d_tllist_b_d_tllist_tllist$)))
  (B_a_tllist$ (tNil$h (terminal$h A$)) (tCons$h (thd$h B$) (ttl$h B_a_tllist$)))
  (A_llist$ (lNil$a) (lCons$a (lhd$a A$) (ltl$a A_llist$)))
  (A_llist_c_tllist$ (tNil$i (terminal$i C$)) (tCons$i (thd$i A_llist$) (ttl$i A_llist_c_tllist$)))
  ...
  (D_b_tllist$ (tNil$m (terminal$m B$)) (tCons$m (thd$m D$) (ttl$m D_b_tllist$)))))
