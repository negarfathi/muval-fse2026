...
(declare-datatypes () ((Node_node_set_prod$ (pair$ (fst$ Node$) (snd$ Node_set$)))
  (Node_option$ (none$) (some$ (the$ Node$)))
  (Node_node_sum$ (inl$ (projl$ Node$)) (inr$ (projr$ Node$)))
  (Node_node_sum_node_option_sum$ (inl$a (projl$a Node_node_sum$)) (inr$a (projr$a Node_option$)))
  ...
  (Node_node_option_sum$ (inl$d (projl$d Node$)) (inr$d (projr$d Node_option$)))
