...
(declare-codatatypes () ((Node_llist$ (lNil$) (lCons$ (lhd$ Node$) (ltl$ Node_llist$)))
  (Node_llist_llist$ (lNil$a) (lCons$a (lhd$a Node_llist$) (ltl$a Node_llist_llist$)))
  (Node_llist_llist_llist$ (lNil$b) (lCons$b (lhd$b Node_llist_llist$) (ltl$b Node_llist_llist_llist$)))))
(declare-fun n$ () Node$)
