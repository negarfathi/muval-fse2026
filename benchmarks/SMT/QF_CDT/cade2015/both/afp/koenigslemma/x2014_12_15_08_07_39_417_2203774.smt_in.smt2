...
(declare-datatypes () ((Node_node_prod$ (pair$ (fst$ Node$) (snd$ Node$)))
  (Node_node_sum$ (inl$ (projl$ Node$)) (inr$ (projr$ Node$)))
  (Node_node_sum_node_node_prod_sum$ (inl$a (projl$a Node_node_sum$)) (inr$a (projr$a Node_node_prod$)))
  (Node_node_sum_node_node_sum_sum$ (inl$b (projl$b Node_node_sum$)) (inr$b (projr$b Node_node_sum$)))
  (Node_node_sum_node_sum$ (inl$c (projl$c Node_node_sum$)) (inr$c (projr$c Node$)))
  (Node_node_node_prod_sum$ (inl$d (projl$d Node$)) (inr$d (projr$d Node_node_prod$)))
  (Node_node_node_sum_sum$ (inl$e (projl$e Node$)) (inr$e (projr$e Node_node_sum$)))))
(declare-fun na$ () Node$)
