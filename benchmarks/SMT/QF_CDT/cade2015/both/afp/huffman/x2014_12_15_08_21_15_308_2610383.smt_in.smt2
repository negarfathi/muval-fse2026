...
(assert (! (not (= (weight$ (splitLeaf$ t$ w_a$ a$ w_b$ b$)) (weight$ t$))) :named a0))
...
(assert (! (forall ((?v0 A_tree$) (?v1 A$) (?v2 A$) (?v3 Nat$) (?v4 Nat$)) (=> (and (consistent$ ?v0) (not (= ?v1 ?v2))) (ite (member$ ?v1 (alphabet$ ?v0)) (ite (member$ ?v2 (alphabet$ ?v0)) (= (plus$ (plus$ (weight$ (fun_app$a (swapLeaves$ ?v0 ?v3 ?v1 ?v4) ?v2)) (fun_app$ (freq$ ?v0) ?v1)) (fun_app$ (freq$ ?v0) ?v2)) (plus$ (plus$ (weight$ ?v0) ?v3) ?v4)) (= (plus$ (weight$ (fun_app$a (swapLeaves$ ?v0 ?v3 ?v1 ?v4) ?v2)) (fun_app$ (freq$ ?v0) ?v1)) (plus$ (weight$ ?v0) ?v4))) (ite (member$ ?v2 (alphabet$ ?v0)) (= (plus$ (weight$ (fun_app$a (swapLeaves$ ?v0 ?v3 ?v1 ?v4) ?v2)) (fun_app$ (freq$ ?v0) ?v2)) (plus$ (weight$ ?v0) ?v3)) (= (weight$ (fun_app$a (swapLeaves$ ?v0 ?v3 ?v1 ?v4) ?v2)) (weight$ ?v0)))))) :named a10))
...
(assert (! (forall ((?v0 A_tree$) (?v1 A$)) (=> (consistent$ ?v0) (= (fun_app$a (swapLeaves$ ?v0 (fun_app$ (freq$ ?v0) ?v1) ?v1 (fun_app$ (freq$ ?v0) ?v1)) ?v1) ?v0))) :named a14))
...
(assert (! (forall ((?v0 A_tree$) (?v1 A$) (?v2 A$) (?v3 A$) (?v4 A$)) (=> (consistent$ ?v0) (consistent$ (swapFourSyms$ ?v0 ?v1 ?v2 ?v3 ?v4)))) :named a17))
(assert (! (forall ((?v0 Nat$) (?v1 Nat$) (?v2 Nat$) (?v3 Nat$)) (= (plus$ (plus$ ?v0 ?v1) (plus$ ?v2 ?v3)) (plus$ (plus$ ?v0 ?v2) (plus$ ?v1 ?v3)))) :named a18))
(assert (! (forall ((?v0 A$) (?v1 A_tree$) (?v2 Nat$) (?v3 Nat$)) (! (=> (not (member$ ?v0 (alphabet$ ?v1))) (= (fun_app$a (swapLeaves$ ?v1 ?v2 ?v0 ?v3) ?v0) ?v1)) :pattern ((swapLeaves$ ?v1 ?v2 ?v0 ?v3)))) :named a19))
(assert (! (forall ((?v0 A$) (?v1 A_tree$) (?v2 A$)) (=> (and (member$ ?v0 (alphabet$ ?v1)) (member$ ?v2 (alphabet$ ?v1))) (= (alphabet$ (swapSyms$ ?v1 ?v0 ?v2)) (alphabet$ ?v1)))) :named a20))
(check-sat)
;(get-unsat-core)
