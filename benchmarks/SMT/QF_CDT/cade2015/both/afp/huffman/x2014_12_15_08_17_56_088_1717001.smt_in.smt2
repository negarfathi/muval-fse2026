...
(declare-datatypes () ((A_tree$ (leaf$ (select$ Nat$) (selecta$ A$)) (innerNode$ (selectb$ Nat$) (selectc$ A_tree$) (selectd$ A_tree$)))
  (A_a_sum$ (inl$ (projl$ A$)) (inr$ (projr$ A$)))
  (A_a_sum_tree$ (leaf$a (selecte$ Nat$) (selectf$ A_a_sum$)) (innerNode$a (selectg$ Nat$) (selecth$ A_a_sum_tree$) (selecti$ A_a_sum_tree$)))
  (A_set_tree$ (leaf$b (selectj$ Nat$) (selectk$ A_set$)) (innerNode$b (selectl$ Nat$) (selectm$ A_set_tree$) (selectn$ A_set_tree$)))))
