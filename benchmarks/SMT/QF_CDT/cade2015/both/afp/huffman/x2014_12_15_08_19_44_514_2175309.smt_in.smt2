...
(assert (! (forall ((?v0 Nat$) (?v1 A_tree$) (?v2 A_tree$)) (! (= (weight$ (innerNode$ ?v0 ?v1 ?v2)) (plus$ (weight$ ?v1) (weight$ ?v2))) :pattern ((innerNode$ ?v0 ?v1 ?v2)))) :named a9))
(assert (! (forall ((?v0 Nat$) (?v1 A_tree$) (?v2 A_tree$) (?v3 A$)) (! (= (freq$ (innerNode$ ?v0 ?v1 ?v2) ?v3) (plus$ (freq$ ?v1 ?v3) (freq$ ?v2 ?v3))) :pattern ((freq$ (innerNode$ ?v0 ?v1 ?v2) ?v3)))) :named a10))
(assert (! (forall ((?v0 Nat$) (?v1 Nat$) (?v2 Nat$)) (= (= (plus$ ?v0 ?v1) (plus$ ?v2 ?v1)) (= ?v0 ?v2))) :named a11))
(assert (! (forall ((?v0 Nat$) (?v1 Nat$) (?v2 Nat$)) (= (= (plus$ ?v0 ?v1) (plus$ ?v0 ?v2)) (= ?v1 ?v2))) :named a12))
(assert (! (forall ((?v0 A_tree$) (?v1 Nat$) (?v2 A$) (?v3 Nat$) (?v4 A$)) (=> (consistent$ ?v0) (consistent$ (fun_app$ (swapLeaves$ ?v0 ?v1 ?v2 ?v3) ?v4)))) :named a13))
(assert (! (forall ((?v0 A_tree$) (?v1 A$) (?v2 A$) (?v3 A$) (?v4 Nat$) (?v5 Nat$)) (=> (and (consistent$ ?v0) (and (not (= ?v1 ?v2)) (not (= ?v1 ?v3)))) (= (depth$ (fun_app$ (swapLeaves$ ?v0 ?v4 ?v2 ?v5) ?v3) ?v1) (depth$ ?v0 ?v1)))) :named a14))
(assert (! (forall ((?v0 A_tree$) (?v1 A_tree$) (?v2 A$)) (= (freq$ (uniteTrees$ ?v0 ?v1) ?v2) (plus$ (freq$ ?v0 ?v2) (freq$ ?v1 ?v2)))) :named a15))
(assert (! (forall ((?v0 Nat$) (?v1 A_tree$) (?v2 A_tree$)) (! (= (cost$ (innerNode$ ?v0 ?v1 ?v2)) (plus$ (plus$ (plus$ (weight$ ?v1) (cost$ ?v1)) (weight$ ?v2)) (cost$ ?v2))) :pattern ((innerNode$ ?v0 ?v1 ?v2)))) :named a16))
