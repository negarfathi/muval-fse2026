...
(declare-datatypes () ((A_tree$ (leaf$ (select$ Nat$) (selecta$ A$)) (innerNode$ (selectb$ Nat$) (selectc$ A_tree$) (selectd$ A_tree$)))
  ...
  (A_tree_a_prod_list$ (nil$) (cons$ (hd$ A_tree_a_prod$) (tl$ A_tree_a_prod_list$)))
  (A_tree_a_prod_a_tree_a_prod_prod$ (pair$a (fst$a A_tree_a_prod$) (snd$a A_tree_a_prod$)))
  (A_tree_a_prod_a_tree_a_prod_prod_nat_fun_list$ (nil$a) (cons$a (selecte$ A_tree_a_prod_a_tree_a_prod_prod_nat_fun$) (selectf$ A_tree_a_prod_a_tree_a_prod_prod_nat_fun_list$)))
  (A_tree_nat_fun_list$ (nil$b) (cons$b (selectg$ A_tree_nat_fun$) (selecth$ A_tree_nat_fun_list$)))
  (A_nat_fun_list$ (nil$c) (cons$c (selecti$ A_nat_fun$) (selectj$ A_nat_fun_list$)))
  (A_tree_a_prod_list_nat_fun_list$ (nil$d) (cons$d (selectk$ A_tree_a_prod_list_nat_fun$) (selectl$ A_tree_a_prod_list_nat_fun_list$)))
  (A_tree_a_prod_set_nat_fun_list$ (nil$e) (cons$e (selectm$ A_tree_a_prod_set_nat_fun$) (selectn$ A_tree_a_prod_set_nat_fun_list$)))
  (A_tree_a_prod_nat_fun_list$ (nil$f) (cons$f (selecto$ A_tree_a_prod_nat_fun$) (selectp$ A_tree_a_prod_nat_fun_list$)))))
