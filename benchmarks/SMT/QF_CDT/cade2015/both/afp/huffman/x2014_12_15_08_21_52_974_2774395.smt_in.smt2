...
(assert (! (not (= w_a$ (fun_app$ (freq$ (swapFourSyms$ u$ a$ b$ c$ (sibling$ u$ c$))) a$))) :named a0))
...
(assert (! (forall ((?v0 A$)) (=> (member$ ?v0 (alphabet$ t$)) (and (less_eq$ w_a$ (fun_app$ (freq$ t$) ?v0)) (less_eq$ w_b$ (fun_app$ (freq$ t$) ?v0))))) :named a6))
...
(assert (! (= (sibling$ (swapFourSyms$ u$ a$ b$ c$ (sibling$ u$ c$)) a$) b$) :named a14))
(assert (! (consistent$ (swapFourSyms$ u$ a$ b$ c$ (sibling$ u$ c$))) :named a15))
(assert (! (= (alphabet$ (swapFourSyms$ u$ a$ b$ c$ (sibling$ u$ c$))) (alphabet$ u$)) :named a16))
