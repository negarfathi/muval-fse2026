...
(assert (! (not (member$ b$ (alphabet$ t_1$))) :named a2))
(assert (! (not (member$ a$ (alphabet$ t_1$))) :named a3))
(assert (! (member$ a$ (alphabet$ t_2$)) :named a4))
...
(assert (! (forall ((?v0 A_tree$) (?v1 A_tree$) (?v2 A$)) (= (freq$ (uniteTrees$ ?v0 ?v1) ?v2) (plus$ (freq$ ?v0 ?v2) (freq$ ?v1 ?v2)))) :named a17))
(check-sat)
;(get-unsat-core)
