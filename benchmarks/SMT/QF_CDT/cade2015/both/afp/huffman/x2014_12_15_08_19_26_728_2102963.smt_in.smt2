...
(assert (! (not (= (fun_app$ (freq$ (fun_app$a (swapLeaves$ t$ w_a$ a$ w_b$) b$)) c$) (ite (= c$ a$) (ite (member$ b$ (alphabet$ t$)) w_a$ zero$) (ite (= c$ b$) (ite (member$ a$ (alphabet$ t$)) w_b$ zero$) (fun_app$ (freq$ t$) c$))))) :named a0))
(assert (! (consistent$ t$) :named a1))
(assert (! (not (= a$ b$)) :named a2))
(assert (! (forall ((?v0 A$) (?v1 A_tree$) (?v2 Nat$) (?v3 Nat$)) (! (=> (not (member$ ?v0 (alphabet$ ?v1))) (= (fun_app$a (swapLeaves$ ?v1 ?v2 ?v0 ?v3) ?v0) ?v1)) :pattern ((swapLeaves$ ?v1 ?v2 ?v0 ?v3)))) :named a3))
(assert (! (forall ((?v0 A$) (?v1 A_tree$)) (! (=> (not (member$ ?v0 (alphabet$ ?v1))) (= (fun_app$ (freq$ ?v1) ?v0) zero$)) :pattern ((fun_app$ (freq$ ?v1) ?v0)))) :named a4))
...
(assert (! (forall ((?v0 A_tree$) (?v1 A$) (?v2 A$) (?v3 A$) (?v4 Nat$) (?v5 Nat$)) (=> (and (consistent$ ?v0) (and (not (= ?v1 ?v2)) (not (= ?v1 ?v3)))) (= (depth$ (fun_app$a (swapLeaves$ ?v0 ?v4 ?v2 ?v5) ?v3) ?v1) (depth$ ?v0 ?v1)))) :named a8))
(assert (! (= zero$ zero$) :named a9))
(assert (! (forall ((?v0 Nat$)) (=> (and (=> (= ?v0 zero$) false) (=> (not (= ?v0 zero$)) false)) false)) :named a10))
(assert (! (forall ((?v0 Nat$)) (= (= zero$ ?v0) (= ?v0 zero$))) :named a11))
(assert (! (forall ((?v0 Nat$) (?v1 A$) (?v2 A$)) (! (= (fun_app$ (freq$ (leaf$ ?v0 ?v1)) ?v2) (ite (= ?v2 ?v1) ?v0 zero$)) :pattern ((fun_app$ (freq$ (leaf$ ?v0 ?v1)) ?v2)))) :named a12))
(assert (! (forall ((?v0 Char$)) (! (= (size_char$ ?v0) zero$) :pattern ((size_char$ ?v0)))) :named a13))
(assert (! (forall ((?v0 A_tree$) (?v1 Nat$) (?v2 A$) (?v3 Nat$) (?v4 A$)) (= (height$ (fun_app$a (swapLeaves$ ?v0 ?v1 ?v2 ?v3) ?v4)) (height$ ?v0))) :named a14))
(assert (! (forall ((?v0 A_tree$) (?v1 A$)) (=> (consistent$ ?v0) (= (sibling$ ?v0 (sibling$ ?v0 ?v1)) ?v1))) :named a15))
(assert (! (forall ((?v0 A_tree$)) (= (optimum$ ?v0) (forall ((?v1 A_tree$)) (=> (and (consistent$ ?v1) (and (= (alphabet$ ?v0) (alphabet$ ?v1)) (= (freq$ ?v0) (freq$ ?v1)))) (less_eq$ (cost$ ?v0) (cost$ ?v1)))))) :named a16))
