; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 504
...
(assert (! (not (<= (am$ (node$ l$ b$ leaf$)) (+ (* 3.0 (- (log$ 2.0 (real$ (size1$ (node$ l$ b$ leaf$)))) 1.0)) 1.0))) :named a0))
(assert (! (not (= (node$ l$ b$ leaf$) leaf$)) :named a1))
(assert (! (bst$ (node$ l$ b$ leaf$)) :named a2))
