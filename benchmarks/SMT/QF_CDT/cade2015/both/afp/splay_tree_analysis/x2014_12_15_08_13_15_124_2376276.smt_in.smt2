...
(assert (! (not (<= (+ (phi$ l$) (+ (phi$ r$) (+ (real$ (t_splay$ a$ (node$ ls$ x$ rs$))) (log$ 2.0 (+ 2.0 (+ (real$ (size$ l$)) (real$ (size$ r$)))))))) (+ (phi$ ls$) (+ (phi$ rs$) (+ 2.0 (* 7.0 (log$ 2.0 (+ 2.0 (+ (real$ (size$ ls$)) (real$ (size$ rs$))))))))))) :named a0))
(assert (! (not (= e$ a$)) :named a1))
(assert (! (<= (+ (phi$ l$) (+ (phi$ r$) (+ (real$ (t_splay$ a$ (node$ ls$ x$ rs$))) (log$ 2.0 (+ 2.0 (+ (real$ (size$ l$)) (real$ (size$ r$)))))))) (+ 1.0 (+ (phi$ ls$) (+ (phi$ rs$) (* 4.0 (log$ 2.0 (+ 2.0 (+ (real$ (size$ ls$)) (real$ (size$ rs$)))))))))) :named a2))
(assert (! (not (= e$ a$)) :named a3))
(assert (! (<= 0.0 (log$ 2.0 (+ 2.0 (+ (real$ (size$ ls$)) (real$ (size$ rs$)))))) :named a4))
(assert (! (= (+ 1.0 1.0) 2.0) :named a5))
(assert (! (=> (forall ((?v0 A_tree$) (?v1 A$) (?v2 A_tree$)) (=> (= (splay$ a$ (node$ ls$ x$ rs$)) (node$ ?v0 ?v1 ?v2)) false)) false) :named a6))
...
(assert (! (= (splay$ a$ (node$ ls$ x$ rs$)) (node$ l$ e$ r$)) :named a10))
