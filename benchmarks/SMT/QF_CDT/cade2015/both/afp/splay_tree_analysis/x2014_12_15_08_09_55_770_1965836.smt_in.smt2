...
(assert (! (not (<= (+ (- (+ (log$ 2.0 (real$ (size1$ lr$))) (* 2.0 (log$ 2.0 (real$ (size1$ (node$ l$ c$ r$)))))) (* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$)))))) 1.0) (+ (- (* 3.0 (log$ 2.0 (real$ (size1$ (node$ l$ c$ r$))))) (* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$)))))) 1.0))) :named a0))
...
(assert (! (member$ (node$ la$ aa$ ra$) (subtrees$ (node$ l$ c$ r$))) :named a5))
(assert (! (bst$ (node$ l$ c$ r$)) :named a6))
(assert (! (<= (a$ aa$ (node$ l$ c$ r$)) (+ (- (+ (log$ 2.0 (real$ (size1$ lr$))) (* 2.0 (log$ 2.0 (real$ (size1$ (node$ l$ c$ r$)))))) (* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$)))))) 1.0)) :named a7))
