...
(assert (! (not (<= (log$ 2.0 (* 2.0 (+ (real$ (size1$ l$)) (real$ (size1$ r$))))) (+ (log$ 2.0 (+ (real$ (size1$ l$)) (real$ (size1$ r$)))) 1.0))) :named a0))
(assert (! (<= (log$ 2.0 (+ (real$ (size1$ l$)) 1.0)) (log$ 2.0 (+ (real$ (size1$ l$)) (real$ (size1$ r$))))) :named a1))
(assert (! (<= (log$ 2.0 (+ 1.0 (+ (real$ (size1$ l$)) (real$ (size1$ r$))))) (log$ 2.0 (* 2.0 (+ (real$ (size1$ l$)) (real$ (size1$ r$)))))) :named a2))
...
(assert (! (forall ((?v0 Real)) (= (* 2.0 ?v0) (+ ?v0 ?v0))) :named a13))
(assert (! (forall ((?v0 Real)) (= (* ?v0 2.0) (+ ?v0 ?v0))) :named a14))
