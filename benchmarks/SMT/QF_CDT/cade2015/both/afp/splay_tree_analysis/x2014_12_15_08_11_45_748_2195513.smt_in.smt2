...
(assert (! (not (<= (am$ t$) (+ (* 3.0 (log$ 2.0 (real$ (size1$ t$)))) 1.0))) :named a0))
...
(assert (! (forall ((?v0 Num$)) (= (= (bit1$ ?v0) one$) false)) :named a10))
(assert (! (forall ((?v0 Num$)) (= (= one$ (bit1$ ?v0)) false)) :named a11))
(assert (! (forall ((?v0 Num$) (?v1 Num$)) (= (= (bit0$ ?v0) (bit1$ ?v1)) false)) :named a12))
(assert (! (forall ((?v0 Num$) (?v1 Num$)) (= (= (bit1$ ?v0) (bit0$ ?v1)) false)) :named a13))
