...
(assert (! (not (= (a$ aa$ (node$ l$ c$ r$)) (+ (- (- (+ (+ (a$ aa$ rr$) (log$ 2.0 (real$ (size1$ (node$ (node$ l$ c$ rl$) b$ l$a))))) (log$ 2.0 (real$ (size1$ (node$ l$ c$ rl$))))) (log$ 2.0 (real$ (size1$ (node$ rl$ b$ rr$))))) (log$ 2.0 (real$ (size1$ (node$ l$a u$ r$a))))) 1.0))) :named a0))
...
(assert (! (= (splay$ aa$ rr$) (node$ l$a u$ r$a)) :named a7))
(assert (! (not (member$ b$ (set_tree$ l$))) :named a8))
(assert (! (=> (forall ((?v0 A_tree$) (?v1 A$) (?v2 A_tree$)) (=> (= (splay$ aa$ rr$) (node$ ?v0 ?v1 ?v2)) false)) false) :named a9))
