...
(assert (! (not (and (distinct$ (diff_sorted$ nil$ l2a$)) (and (sorted$ (diff_sorted$ nil$ l2a$)) (= (set$ (diff_sorted$ nil$ l2a$)) (minus$ (set$ nil$) (set$ l2a$)))))) :named a0))
...
(assert (! (forall ((?v0 A_list$)) (! (= (diff_sorted$ nil$ ?v0) nil$) :pattern ((diff_sorted$ nil$ ?v0)))) :named a5))
...
(assert (! (forall ((?v0 A$) (?v1 A_set$) (?v2 A_set$)) (= (member$ ?v0 (minus$ ?v1 ?v2)) (and (member$ ?v0 ?v1) (not (member$ ?v0 ?v2))))) :named a7))
(assert (! (forall ((?v0 A_set$) (?v1 A_set$)) (= (minus$ (minus$ ?v0 ?v1) ?v1) (minus$ ?v0 ?v1))) :named a8))
(assert (! (forall ((?v0 A$) (?v1 A_set$) (?v2 A_set$)) (=> (and (member$ ?v0 ?v1) (not (member$ ?v0 ?v2))) (member$ ?v0 (minus$ ?v1 ?v2)))) :named a9))
(assert (! (sorted$ nil$) :named a10))
(assert (! (= (distinct$ nil$) true) :named a11))
...
(assert (! (forall ((?v0 A$) (?v1 A_set$) (?v2 A_set$)) (=> (and (member$ ?v0 (minus$ ?v1 ?v2)) (=> (and (member$ ?v0 ?v1) (not (member$ ?v0 ?v2))) false)) false)) :named a13))
(assert (! (forall ((?v0 A$) (?v1 A_set$) (?v2 A_set$)) (=> (and (member$ ?v0 (minus$ ?v1 ?v2)) (member$ ?v0 ?v2)) false)) :named a14))
(assert (! (forall ((?v0 A$) (?v1 A_set$) (?v2 A_set$)) (=> (member$ ?v0 (minus$ ?v1 ?v2)) (member$ ?v0 ?v1))) :named a15))
