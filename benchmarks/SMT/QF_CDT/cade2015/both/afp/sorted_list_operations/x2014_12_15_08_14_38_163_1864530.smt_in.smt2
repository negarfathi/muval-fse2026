...
(assert (! (not (and (distinct$ (inter_sorted$ (cons$ x1$ l1a$) nil$)) (and (sorted$ (inter_sorted$ (cons$ x1$ l1a$) nil$)) (= (set$ (inter_sorted$ (cons$ x1$ l1a$) nil$)) (inf$ (set$ (cons$ x1$ l1a$)) (set$ nil$)))))) :named a0))
...
(assert (! (forall ((?v0 A_list$)) (=> (and (distinct$ ?v0) (sorted$ ?v0)) (and (distinct$ (inter_sorted$ l1a$ ?v0)) (and (sorted$ (inter_sorted$ l1a$ ?v0)) (= (set$ (inter_sorted$ l1a$ ?v0)) (inf$ (set$ l1a$) (set$ ?v0))))))) :named a8))
(assert (! (forall ((?v0 A_list$)) (=> (and (and (distinct$ l1a$) (sorted$ l1a$)) (and (distinct$ ?v0) (sorted$ ?v0))) (and (distinct$ (inter_sorted$ l1a$ ?v0)) (and (sorted$ (inter_sorted$ l1a$ ?v0)) (= (set$ (inter_sorted$ l1a$ ?v0)) (inf$ (set$ l1a$) (set$ ?v0))))))) :named a9))
(assert (! (forall ((?v0 A$) (?v1 A_list$)) (! (= (inter_sorted$ (cons$ ?v0 ?v1) nil$) nil$) :pattern ((cons$ ?v0 ?v1)))) :named a10))
(assert (! (forall ((?v0 A_list$)) (! (= (inter_sorted$ nil$ ?v0) nil$) :pattern ((inter_sorted$ nil$ ?v0)))) :named a11))
