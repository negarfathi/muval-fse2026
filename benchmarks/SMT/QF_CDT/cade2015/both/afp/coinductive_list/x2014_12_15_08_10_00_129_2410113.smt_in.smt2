...
(assert (! (forall ((?v0 A_llist$)) (! (= (fun_app$ uu$ ?v0) (and (lprefix$ ?v0 xsa$) (lfinite$ ?v0))) :pattern ((fun_app$ uu$ ?v0)))) :named a0))
(assert (! (not (= (lnull$ (lSup$ (collect$ uu$))) (lnull$ xsa$))) :named a1))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (and (lprefix$ ?v0 ?v1) (not (lnull$ ?v0))) (not (lnull$ ?v1)))) :named a12))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (and (lprefix$ ?v0 ?v1) (lnull$ ?v1)) (lnull$ ?v0))) :named a13))
(assert (! (forall ((?v0 A_llist_set$)) (=> (not (forall ((?v1 A_llist$)) (=> (member$ ?v1 ?v0) (lnull$ ?v1)))) (not (lnull$ (lSup$ ?v0))))) :named a14))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (! (=> (not (lfinite$ ?v0)) (= (lprefix$ ?v0 ?v1) (= ?v0 ?v1))) :pattern ((lprefix$ ?v0 ?v1)))) :named a15))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (! (=> (lnull$ ?v0) (= (lprefix$ ?v1 ?v0) (lnull$ ?v1))) :pattern ((lprefix$ ?v1 ?v0)))) :named a16))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (lnull$ ?v0) (lprefix$ ?v0 ?v1))) :named a17))
