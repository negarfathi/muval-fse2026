...
(assert (! (not (= (fun_app$ (ltake$ zero$) xs$) lNil$)) :named a0))
...
(assert (! (forall ((?v0 Enat$) (?v1 A_llist$)) (! (=> (or (= ?v0 zero$) (lnull$ ?v1)) (= (fun_app$ (ltake$ ?v0) ?v1) lNil$)) :pattern ((fun_app$ (ltake$ ?v0) ?v1)))) :named a5))
(assert (! (forall ((?v0 Enat$)) (= (= zero$ ?v0) (= ?v0 zero$))) :named a6))
(assert (! (forall ((?v0 A_set$)) (! (= (fun_app$b (gen_lset$ ?v0) lNil$) ?v0) :pattern ((gen_lset$ ?v0)))) :named a7))
...
(assert (! (forall ((?v0 A_llist$)) (! (=> (lnull$ ?v0) (= (llength$ ?v0) zero$)) :pattern ((llength$ ?v0)))) :named a13))
(assert (! (forall ((?v0 A_llist$)) (= (= (llength$ ?v0) zero$) (lnull$ ?v0))) :named a14))
