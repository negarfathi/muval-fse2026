...
(assert (! (not (= (ldropWhile$ p$ lNil$) lNil$)) :named a0))
...
(assert (! (forall ((?v0 A_bool_fun$)) (! (= (fun_app$b (ltakeWhile$ ?v0) lNil$) lNil$) :pattern ((ltakeWhile$ ?v0)))) :named a7))
(assert (! (ldistinct$ lNil$) :named a8))
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 A_llist$)) (fun_app$ (fun_app$c (llexord$ ?v0) lNil$) ?v1)) :named a9))
...
(assert (! (forall ((?v0 A_bool_fun$) (?v1 A$) (?v2 A_llist$)) (! (= (fun_app$b (ltakeWhile$ ?v0) (lCons$ ?v1 ?v2)) (ite (fun_app$d ?v0 ?v1) (lCons$ ?v1 (fun_app$b (ltakeWhile$ ?v0) ?v2)) lNil$)) :pattern ((fun_app$b (ltakeWhile$ ?v0) (lCons$ ?v1 ?v2))))) :named a13))
