...
(declare-datatypes () ((B_a_b_prod_prod_list$ (nil$c) (cons$c (hd$c B_a_b_prod_prod$) (tl$c B_a_b_prod_prod_list$)))
  ...
  (A_a_prod_list$ (nil$g) (cons$g (hd$g A_a_prod$) (tl$g A_a_prod_list$)))))
