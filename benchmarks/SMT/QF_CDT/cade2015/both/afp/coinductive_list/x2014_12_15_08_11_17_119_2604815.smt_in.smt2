...
(assert (! (not (mcont$ lSup$ lprefix$ lSup$ lprefix$ uu$)) :named a2))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (fun_app$a (fun_app$b lprefix$ ?v0) ?v1) (fun_app$a (fun_app$b lprefix$ (ltl$ ?v0)) (ltl$ ?v1)))) :named a10))
(assert (! (forall ((?v0 A$)) (mcont$ lSup$ lprefix$ lSup$ lprefix$ (uua$ ?v0))) :named a11))
(assert (! (cont$ lSup$ lprefix$ lSup$ lprefix$ uu$) :named a12))
(assert (! (forall ((?v0 A_llist_set_a_llist_fun$) (?v1 A_llist_a_llist_bool_fun_fun$) (?v2 A_llist_set_a_llist_fun$) (?v3 A_llist_a_llist_bool_fun_fun$) (?v4 A_llist_a_llist_fun$) (?v5 A_llist$) (?v6 A_llist$)) (=> (and (mcont$ ?v0 ?v1 ?v2 ?v3 ?v4) (fun_app$a (fun_app$b ?v1 ?v5) ?v6)) (fun_app$a (fun_app$b ?v3 (fun_app$ ?v4 ?v5)) (fun_app$ ?v4 ?v6)))) :named a13))
(assert (! (partial_function_definitions$ lprefix$ lSup$) :named a14))
(assert (! (forall ((?v0 A_llist_set$) (?v1 A_llist$)) (=> (and (chain$ lprefix$ ?v0) (forall ((?v2 A_llist$)) (=> (member$ ?v2 ?v0) (fun_app$a (fun_app$b lprefix$ ?v2) ?v1)))) (fun_app$a (fun_app$b lprefix$ (fun_app$c lSup$ ?v0)) ?v1))) :named a15))
(assert (! (forall ((?v0 A_llist_set$) (?v1 A_llist$)) (=> (and (chain$ lprefix$ ?v0) (forall ((?v2 A_llist$)) (=> (member$ ?v2 ?v0) (fun_app$a (fun_app$b lprefix$ ?v2) ?v1)))) (fun_app$a (fun_app$b lprefix$ (fun_app$c lSup$ ?v0)) ?v1))) :named a16))
(assert (! (forall ((?v0 A_llist_set$) (?v1 A_llist$)) (=> (and (chain$ lprefix$ ?v0) (member$ ?v1 ?v0)) (fun_app$a (fun_app$b lprefix$ ?v1) (fun_app$c lSup$ ?v0)))) :named a17))
(assert (! (forall ((?v0 A_llist_set$) (?v1 A_llist$)) (=> (and (chain$ lprefix$ ?v0) (member$ ?v1 ?v0)) (fun_app$a (fun_app$b lprefix$ ?v1) (fun_app$c lSup$ ?v0)))) :named a18))
(assert (! (lub_singleton$ lSup$) :named a19))
(check-sat)
;(get-unsat-core)
