...
(assert (! (not (fun_app$ (lsorted$ less_eq$) (ltl$ xs$))) :named a0))
...
(assert (! (forall ((?v0 A$) (?v1 A$) (?v2 A_llist$)) (=> (and (fun_app$a (fun_app$b less_eq$ ?v0) ?v1) (fun_app$ (lsorted$ less_eq$) (lCons$ ?v1 ?v2))) (fun_app$ (lsorted$ less_eq$) (lCons$ ?v0 (lCons$ ?v1 ?v2))))) :named a8))
(assert (! (forall ((?v0 A$) (?v1 A$)) (= (member$ ?v0 (atMost$ less_eq$ ?v1)) (fun_app$a (fun_app$b less_eq$ ?v0) ?v1))) :named a9))
(assert (! (forall ((?v0 A$) (?v1 A$)) (= (member$ ?v0 (atLeast$ less_eq$ ?v1)) (fun_app$a (fun_app$b less_eq$ ?v1) ?v0))) :named a10))
(assert (! (= (fun_app$ (lsorted$ less_eq$) lNil$) true) :named a11))
(assert (! (forall ((?v0 A$) (?v1 A$) (?v2 A_llist$)) (! (= (fun_app$ (lsorted$ less_eq$) (lCons$ ?v0 (lCons$ ?v1 ?v2))) (and (fun_app$a (fun_app$b less_eq$ ?v0) ?v1) (fun_app$ (lsorted$ less_eq$) (lCons$ ?v1 ?v2)))) :pattern ((lCons$ ?v0 (lCons$ ?v1 ?v2))))) :named a12))
(assert (! (forall ((?v0 A_llist_bool_fun$) (?v1 A_llist$)) (=> (and (fun_app$ ?v0 ?v1) (forall ((?v2 A_llist$)) (=> (and (fun_app$ ?v0 ?v2) (and (not (lnull$ ?v2)) (not (lnull$ (ltl$ ?v2))))) (and (fun_app$a (fun_app$b less_eq$ (lhd$ ?v2)) (lhd$ (ltl$ ?v2))) (or (fun_app$ ?v0 (ltl$ ?v2)) (fun_app$ (lsorted$ less_eq$) (ltl$ ?v2))))))) (fun_app$ (lsorted$ less_eq$) ?v1))) :named a13))
