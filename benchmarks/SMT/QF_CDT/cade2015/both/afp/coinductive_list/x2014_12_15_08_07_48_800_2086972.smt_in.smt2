...
(assert (! (not (= (lfinite$ (fun_app$ (lappend$ xs$) ys$)) (and (lfinite$ xs$) (lfinite$ ys$)))) :named a0))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (ltl$ (fun_app$ (lappend$ ?v0) ?v1)) (ite (lnull$ ?v0) (ltl$ ?v1) (fun_app$ (lappend$ (ltl$ ?v0)) ?v1)))) :named a15))
