...
(declare-datatypes () ((A_llist_a_llist_prod_a_llist_a_llist_prod_prod$ (pair$b (fst$b A_llist_a_llist_prod$) (snd$b A_llist_a_llist_prod$)))
  (A_llist_a_prod$ (pair$c (fst$c A_llist$) (snd$c A$)))
  (A_llist_a_prod_a_llist_a_prod_prod$ (pair$d (fst$d A_llist_a_prod$) (snd$d A_llist_a_prod$)))
  (A_a_llist_prod$ (pair$e (fst$e A$) (snd$e A_llist$)))
  (A_a_llist_prod_a_a_llist_prod_prod$ (pair$f (fst$f A_a_llist_prod$) (snd$f A_a_llist_prod$)))
  (A_a_prod_a_a_prod_prod$ (pair$g (fst$g A_a_prod$) (snd$g A_a_prod$)))
  (A_llist_llist_a_llist_llist_prod$ (pair$h (fst$h A_llist_llist$) (snd$h A_llist_llist$)))
  (A_llist_llist_llist_a_llist_llist_llist_prod$ (pair$i (fst$i A_llist_llist_llist$) (snd$i A_llist_llist_llist$)))))
(declare-codatatypes () ((A_llist_llist_llist_llist$ (lNil$c) (lCons$c (lhd$c A_llist_llist_llist$) (ltl$c A_llist_llist_llist_llist$)))))
(declare-datatypes () ((A_llist_llist_llist_llist_a_llist_llist_llist_llist_prod$ (pair$j (fst$j A_llist_llist_llist_llist$) (snd$j A_llist_llist_llist_llist$)))))
(declare-codatatypes () ((A_llist_a_llist_prod_llist$ (lNil$d) (lCons$d (lhd$d A_llist_a_llist_prod$) (ltl$d A_llist_a_llist_prod_llist$)))))
(declare-datatypes () ((A_llist_a_llist_prod_llist_a_llist_a_llist_prod_llist_prod$ (pair$k (fst$k A_llist_a_llist_prod_llist$) (snd$k A_llist_a_llist_prod_llist$)))))
(declare-codatatypes () ((A_llist_a_prod_llist$ (lNil$e) (lCons$e (lhd$e A_llist_a_prod$) (ltl$e A_llist_a_prod_llist$)))))
(declare-datatypes () ((A_llist_a_prod_llist_a_llist_a_prod_llist_prod$ (pair$l (fst$l A_llist_a_prod_llist$) (snd$l A_llist_a_prod_llist$)))))
(declare-codatatypes () ((A_a_llist_prod_llist$ (lNil$f) (lCons$f (lhd$f A_a_llist_prod$) (ltl$f A_a_llist_prod_llist$)))))
(declare-datatypes () ((A_a_llist_prod_llist_a_a_llist_prod_llist_prod$ (pair$m (fst$m A_a_llist_prod_llist$) (snd$m A_a_llist_prod_llist$)))))
(declare-codatatypes () ((A_a_prod_llist$ (lNil$g) (lCons$g (lhd$g A_a_prod$) (ltl$g A_a_prod_llist$)))))
(declare-datatypes () ((A_a_prod_llist_a_a_prod_llist_prod$ (pair$n (fst$n A_a_prod_llist$) (snd$n A_a_prod_llist$)))
  (A_a_prod_a_prod$ (pair$o (fst$o A_a_prod$) (snd$o A$)))
  (A_a_prod_a_prod_a_a_prod_a_prod_prod$ (pair$p (fst$p A_a_prod_a_prod$) (snd$p A_a_prod_a_prod$)))
  (A_a_a_prod_prod$ (pair$q (fst$q A$) (snd$q A_a_prod$)))
  (A_a_a_prod_prod_a_a_a_prod_prod_prod$ (pair$r (fst$r A_a_a_prod_prod$) (snd$r A_a_a_prod_prod$)))))
