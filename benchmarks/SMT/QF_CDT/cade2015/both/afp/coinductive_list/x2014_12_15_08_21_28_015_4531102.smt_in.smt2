...
(declare-datatypes () ((B_llist_a_b_prod_llist_prod$ (pair$b (fst$b B_llist$) (snd$b A_b_prod_llist$)))
  (B_llist_b_llist_prod$ (pair$c (fst$c B_llist$) (snd$c B_llist$)))
  (B_llist_a_llist_prod$ (pair$d (fst$d B_llist$) (snd$d A_llist$)))
  (A_llist_a_b_prod_llist_prod$ (pair$e (fst$e A_llist$) (snd$e A_b_prod_llist$)))
  (A_llist_a_llist_prod$ (pair$f (fst$f A_llist$) (snd$f A_llist$)))
  (A_b_prod_llist_a_b_prod_llist_prod$ (pair$g (fst$g A_b_prod_llist$) (snd$g A_b_prod_llist$)))))
