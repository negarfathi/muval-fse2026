...
(declare-datatypes () ((B_list$ (nil$) (cons$ (hd$ B$) (tl$ B_list$)))
  ...
  (A_a_prod_list$ (nil$b) (cons$b (hd$b A_a_prod$) (tl$b A_a_prod_list$)))
  (A_b_prod_list$ (nil$c) (cons$c (hd$c A_b_prod$) (tl$c A_b_prod_list$)))
  (B_a_prod_list$ (nil$d) (cons$d (hd$d B_a_prod$) (tl$d B_a_prod_list$)))
  (B_b_prod_list$ (nil$e) (cons$e (hd$e B_b_prod$) (tl$e B_b_prod_list$)))
  (B_a_a_prod_prod_list$ (nil$f) (cons$f (hd$f B_a_a_prod_prod$) (tl$f B_a_a_prod_prod_list$)))
  (A_b_b_prod_prod_list$ (nil$g) (cons$g (hd$g A_b_b_prod_prod$) (tl$g A_b_b_prod_prod_list$)))
  (A_b_a_prod_prod_list$ (nil$h) (cons$h (hd$h A_b_a_prod_prod$) (tl$h A_b_a_prod_prod_list$)))
