...
(assert (! (not (not (fun_app$ (fun_app$a lprefix$ xs$) ys$))) :named a0))
(assert (! (not (or (fun_app$ (fun_app$a lprefix$ xs$) ys$) (fun_app$ (fun_app$a lprefix$ ys$) xs$))) :named a1))
...
(assert (! (fun_app$ (fun_app$a lprefix$ xs$) (lappend$ ys$ zs$)) :named a9))
...
(assert (! (forall ((?v0 A_llist$)) (fun_app$ (fun_app$a lprefix$ lNil$) ?v0)) :named a15))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (and (fun_app$ (fun_app$a lprefix$ ?v0) ?v1) (not (lnull$ ?v0))) (not (lnull$ ?v1)))) :named a16))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (and (fun_app$ (fun_app$a lprefix$ ?v0) ?v1) (lnull$ ?v1)) (lnull$ ?v0))) :named a17))
(check-sat)
;(get-unsat-core)
