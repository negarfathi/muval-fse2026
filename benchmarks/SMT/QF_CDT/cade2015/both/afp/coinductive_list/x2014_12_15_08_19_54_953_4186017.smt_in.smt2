...
(assert (! (not (less$ (llength$ xs$) (llength$ ys$))) :named a9))
...
(assert (! (forall ((?v0 Enat$) (?v1 A_llist$)) (fun_app$ (fun_app$a lprefix$ (ltake$ ?v0 ?v1)) ?v1)) :named a13))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (and (fun_app$ (fun_app$a lprefix$ ?v0) ?v1) (= (llength$ ?v0) (llength$ ?v1))) (= ?v0 ?v1))) :named a16))
