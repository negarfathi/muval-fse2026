...
(assert (! (forall ((?v0 A_llist$)) (=> (= zs$ (fun_app$ (lappend$ xs$) ?v0)) thesis$)) :named a1))
(assert (! (forall ((?v0 A_llist$)) (=> (= zs$ (fun_app$ (lappend$ xs$) ?v0)) thesis$)) :named a2))
...
(assert (! (lprefix$ (fun_app$ (lappend$ xs$) ys$) zs$) :named a4))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (lprefix$ ?v0 ?v1) (exists ((?v2 A_llist$)) (= ?v1 (fun_app$ (lappend$ ?v0) ?v2))))) :named a15))
