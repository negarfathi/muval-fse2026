...
(assert (! (= (fun_app$a lset$ lNil$) bot$) :named a9))
...
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 A_llist$)) (fun_app$c (fun_app$d (llexord$ ?v0) lNil$) ?v1)) :named a13))
...
(assert (! (forall ((?v0 A_bool_fun$)) (= (= (collect$ ?v0) bot$) (forall ((?v1 A$)) (not (fun_app$b ?v0 ?v1))))) :named a16))
