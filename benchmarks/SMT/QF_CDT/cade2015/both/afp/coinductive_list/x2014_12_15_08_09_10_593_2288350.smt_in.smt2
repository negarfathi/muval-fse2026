...
(assert (! (not (lprefix$ (fun_app$ (lappend$ zs$) xs$) (fun_app$ (lappend$ zs$) ys$))) :named a0))
(assert (! (forall ((?v0 A_llist$)) (lprefix$ ?v0 ?v0)) :named a1))
(assert (! (lprefix$ xs$ ys$) :named a2))
...
(assert (! (forall ((?v0 A$) (?v1 A_llist$) (?v2 A$) (?v3 A_llist$)) (! (= (lprefix$ (lCons$ ?v0 ?v1) (lCons$ ?v2 ?v3)) (and (= ?v0 ?v2) (lprefix$ ?v1 ?v3))) :pattern ((lprefix$ (lCons$ ?v0 ?v1) (lCons$ ?v2 ?v3))))) :named a11))
...
(assert (! (forall ((?v0 A_llist$)) (lprefix$ lNil$ ?v0)) :named a15))
