...
(declare-datatypes () ((A_list$ (nil$b) (cons$b (hd$b A$) (tl$b A_list$)))
  (A_llist_llist_list$ (nil$c) (cons$c (hd$c A_llist_llist$) (tl$c A_llist_llist_list$)))
  (A_llist_llist_llist_list_list$ (nil$d) (cons$d (hd$d A_llist_llist_llist_list$) (tl$d A_llist_llist_llist_list_list$)))))
...
(declare-datatypes () ((A_llist_llist_llist_llist_list$ (nil$e) (cons$e (hd$e A_llist_llist_llist_llist$) (tl$e A_llist_llist_llist_llist_list$)))
  (A_llist_llist_list_list$ (nil$f) (cons$f (hd$f A_llist_llist_list$) (tl$f A_llist_llist_list_list$)))
  (A_llist_list_list$ (nil$g) (cons$g (hd$g A_llist_list$) (tl$g A_llist_list_list$)))
  (A_list_list$ (nil$h) (cons$h (hd$h A_list$) (tl$h A_list_list$)))))
...
(assert (! (not (fun_app$ lnull$ (lconcat$ xssa$))) :named a23))
(assert (! (less_eq$ (set$ xss$) (collect$ lnull$)) :named a24))
(assert (! (forall ((?v0 A_llist_llist_llist_list$)) (= (lnull$c (fun_app$b llist_of$a ?v0)) (= ?v0 nil$a))) :named a25))
(assert (! (forall ((?v0 A_llist_llist_list$)) (= (lnull$a (fun_app$d llist_of$c ?v0)) (= ?v0 nil$c))) :named a26))
(assert (! (forall ((?v0 A_llist_list$)) (= (lnull$b (fun_app$a llist_of$ ?v0)) (= ?v0 nil$))) :named a27))
(assert (! (forall ((?v0 A_list$)) (= (fun_app$ lnull$ (fun_app$c llist_of$b ?v0)) (= ?v0 nil$b))) :named a28))
(assert (! (forall ((?v0 A_llist_llist_llist_list$)) (= (list_of$ (fun_app$b llist_of$a ?v0)) ?v0)) :named a29))
(assert (! (forall ((?v0 A_list$)) (= (list_of$a (fun_app$c llist_of$b ?v0)) ?v0)) :named a30))
(assert (! (forall ((?v0 A_llist_llist_list$)) (= (list_of$b (fun_app$d llist_of$c ?v0)) ?v0)) :named a31))
(assert (! (forall ((?v0 A_llist_list$)) (= (list_of$c (fun_app$a llist_of$ ?v0)) ?v0)) :named a32))
(assert (! (forall ((?v0 A_llist_llist_llist_list_list$)) (= (lconcat$a (llist_of$d (map$ llist_of$a ?v0))) (fun_app$b llist_of$a (concat$ ?v0)))) :named a33))
(assert (! (forall ((?v0 A_llist_llist_list_list$)) (= (lconcat$b (fun_app$b llist_of$a (map$a llist_of$c ?v0))) (fun_app$d llist_of$c (concat$a ?v0)))) :named a34))
(assert (! (forall ((?v0 A_llist_list_list$)) (= (lconcat$c (fun_app$d llist_of$c (map$b llist_of$ ?v0))) (fun_app$a llist_of$ (concat$b ?v0)))) :named a35))
(assert (! (forall ((?v0 A_list_list$)) (= (lconcat$ (fun_app$a llist_of$ (map$c llist_of$b ?v0))) (fun_app$c llist_of$b (concat$c ?v0)))) :named a36))
(check-sat)
;(get-unsat-core)
