...
(assert (! (forall ((?v0 A_llist_a_llist_bool_fun_fun$) (?v1 A_llist$) (?v2 A_llist$)) (! (= (fun_app$ (fun_app$a (uuh$ ?v0) ?v1) ?v2) (not (fun_app$ (fun_app$a ?v0 ?v1) ?v2))) :pattern ((fun_app$ (fun_app$a (uuh$ ?v0) ?v1) ?v2)))) :named a7))
(assert (! (forall ((?v0 Bool) (?v1 A_llist$)) (! (= (fun_app$ (uuf$ ?v0) ?v1) ?v0) :pattern ((fun_app$ (uuf$ ?v0) ?v1)))) :named a8))
(assert (! (forall ((?v0 A_llist$)) (! (= (fun_app$ uug$ ?v0) true) :pattern ((fun_app$ uug$ ?v0)))) :named a9))
(assert (! (not (admissible$ lSup$ lprefix$ uu$)) :named a10))
(assert (! (fun_app$ (fun_app$c (compact$ lSup$) lprefix$) xs$) :named a11))
...
(assert (! (not (lfinite$ xs$)) :named a14))
