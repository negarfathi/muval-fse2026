...
(assert (! (not (and (= xs$ us$) (=> (lfinite$ xs$) (= ys$ vs$)))) :named a0))
(assert (! (= (llength$ xs$) (llength$ us$)) :named a1))
(assert (! (= (lappend$ xs$ ys$) (lappend$ us$ vs$)) :named a2))
(assert (! (forall ((?v0 Nat$) (?v1 A_llist$)) (= (lfinite$ (ldropn$ ?v0 ?v1)) (lfinite$ ?v1))) :named a3))
