; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 162
...
(declare-codatatypes () ((B_llist$ (lNil$a) (lCons$a (lhd$a B$) (ltl$a B_llist$)))
  (A_bool_prod_llist$ (lNil$b) (lCons$b (lhd$b A_bool_prod$) (ltl$b A_bool_prod_llist$)))))
