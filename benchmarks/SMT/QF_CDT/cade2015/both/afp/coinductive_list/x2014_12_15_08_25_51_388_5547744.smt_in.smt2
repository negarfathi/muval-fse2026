...
(assert (! (not (= (llast$ (lappend$ xs$ ys$)) (llast$ ys$))) :named a0))
(assert (! (not (lnull$ ys$)) :named a1))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (or (not (lnull$ ?v0)) (not (lnull$ ?v1))) (not (lnull$ (lappend$ ?v0 ?v1))))) :named a10))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (and (lnull$ ?v0) (lnull$ ?v1)) (lnull$ (lappend$ ?v0 ?v1)))) :named a11))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (! (=> (lnull$ ?v0) (= (lappend$ ?v1 ?v0) ?v1)) :pattern ((lappend$ ?v1 ?v0)))) :named a12))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (! (=> (lnull$ ?v0) (= (lappend$ ?v0 ?v1) ?v1)) :pattern ((lappend$ ?v0 ?v1)))) :named a13))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (lfinite$ (lappend$ ?v0 ?v1)) (and (lfinite$ ?v0) (lfinite$ ?v1)))) :named a14))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (! (=> (not (lfinite$ ?v0)) (= (lappend$ ?v0 ?v1) ?v0)) :pattern ((lappend$ ?v0 ?v1)))) :named a15))
(assert (! (forall ((?v0 A_llist$)) (=> (lnull$ ?v0) (lfinite$ ?v0))) :named a16))
(assert (! (forall ((?v0 A$) (?v1 A_llist$)) (! (= (llast$ (lCons$ ?v0 ?v1)) (ite (lnull$ ?v1) ?v0 (llast$ ?v1))) :pattern ((lCons$ ?v0 ?v1)))) :named a17))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (lstrict_prefix$ ?v0 (lappend$ ?v0 ?v1)) (and (lfinite$ ?v0) (not (lnull$ ?v1))))) :named a18))
(check-sat)
;(get-unsat-core)
