...
(declare-codatatypes () ((A_a_sum_llist$ (lNil$b) (lCons$b (lhd$b A_a_sum$) (ltl$b A_a_sum_llist$)))
  (A_llist_a_llist_sum_set_llist$ (lNil$c) (lCons$c (lhd$c A_llist_a_llist_sum_set$) (ltl$c A_llist_a_llist_sum_set_llist$)))
  (A_llist_set_set_llist$ (lNil$d) (lCons$d (lhd$d A_llist_set_set$) (ltl$d A_llist_set_set_llist$)))
...
(declare-codatatypes () ((A_llist_a_llist_sum_llist$ (lNil$g) (lCons$g (lhd$g A_llist_a_llist_sum$) (ltl$g A_llist_a_llist_sum_llist$)))
  (A_llist_llist$ (lNil$h) (lCons$h (lhd$h A_llist$) (ltl$h A_llist_llist$)))))
