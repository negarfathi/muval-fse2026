...
(assert (! (not (= (fun_app$ (llexord$ r$ (lCons$ x$ xs$)) (lCons$ y$ ys$)) (or (and (= x$ y$) (fun_app$ (llexord$ r$ xs$) ys$)) (fun_app$a (fun_app$b r$ x$) y$)))) :named a0))
...
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 A_llist$) (?v2 A_llist$) (?v3 A$)) (=> (fun_app$ (llexord$ ?v0 ?v1) ?v2) (fun_app$ (llexord$ ?v0 (lCons$ ?v3 ?v1)) (lCons$ ?v3 ?v2)))) :named a3))
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 A$) (?v2 A$) (?v3 A_llist$) (?v4 A_llist$)) (=> (fun_app$a (fun_app$b ?v0 ?v1) ?v2) (fun_app$ (llexord$ ?v0 (lCons$ ?v1 ?v3)) (lCons$ ?v2 ?v4)))) :named a4))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A$)) (= (fun_app$a (lsetp$ ?v0) ?v1) (or (exists ((?v2 A$) (?v3 A_llist$)) (and (= ?v0 (lCons$ ?v2 ?v3)) (= ?v1 ?v2))) (exists ((?v2 A_llist$) (?v3 A$) (?v4 A$)) (and (= ?v0 (lCons$ ?v4 ?v2)) (and (= ?v1 ?v3) (fun_app$a (lsetp$ ?v2) ?v3))))))) :named a11))
(assert (! (forall ((?v0 A_llist$) (?v1 A$)) (=> (and (fun_app$a (lsetp$ ?v0) ?v1) (and (forall ((?v2 A$) (?v3 A_llist$)) (=> (and (= ?v0 (lCons$ ?v2 ?v3)) (= ?v1 ?v2)) false)) (forall ((?v2 A_llist$) (?v3 A$) (?v4 A$)) (=> (and (= ?v0 (lCons$ ?v4 ?v2)) (and (= ?v1 ?v3) (fun_app$a (lsetp$ ?v2) ?v3))) false)))) false)) :named a12))
(assert (! (forall ((?v0 A_llist$) (?v1 A$) (?v2 A$)) (=> (fun_app$a (lsetp$ ?v0) ?v1) (fun_app$a (lsetp$ (lCons$ ?v2 ?v0)) ?v1))) :named a13))
(assert (! (forall ((?v0 A$) (?v1 A_llist$)) (fun_app$a (lsetp$ (lCons$ ?v0 ?v1)) ?v0)) :named a14))
