...
(declare-codatatypes () ((C_llist$ (lNil$) (lCons$ (lhd$ C$) (ltl$ C_llist$)))
  ...
  (C_llist_llist$ (lNil$b) (lCons$b (lhd$b C_llist$) (ltl$b C_llist_llist$)))
  (D_llist_llist$ (lNil$c) (lCons$c (lhd$c D_llist$) (ltl$c D_llist_llist$)))
  (C_llist_llist_llist$ (lNil$d) (lCons$d (lhd$d C_llist_llist$) (ltl$d C_llist_llist_llist$)))
  (D_llist_llist_llist$ (lNil$e) (lCons$e (lhd$e D_llist_llist$) (ltl$e D_llist_llist_llist$)))))
