...
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_llist$)) (=> (and (= xss$ (lappend$ ?v0 (lCons$a y$ ?v1))) (and (lfinite$ ?v0) (and (less_eq$ (lset$ ?v0) (collect$ lnull$)) (and (not (fun_app$ lnull$ y$)) (= ys$ (lfilter$ uu$ ?v1)))))) thesis$)) :named a6))
...
(assert (! (forall ((?v0 A_bool_fun$) (?v1 A_llist$)) (= (lfilter$a ?v0 (lfilter$a ?v0 ?v1)) (lfilter$a ?v0 ?v1))) :named a9))
(assert (! (forall ((?v0 A_llist_bool_fun$) (?v1 A_llist_llist$)) (= (lfilter$ ?v0 (lfilter$ ?v0 ?v1)) (lfilter$ ?v0 ?v1))) :named a10))
(assert (! (forall ((?v0 A_llist$)) (= (lfilter$a uua$ ?v0) ?v0)) :named a11))
(assert (! (forall ((?v0 A_llist_llist$)) (= (lfilter$ uub$ ?v0) ?v0)) :named a12))
(assert (! (= (lfilter$ uu$ xss$) (lCons$a y$ ys$)) :named a13))
(assert (! (=> (forall ((?v0 A_llist$) (?v1 A_llist_llist$)) (=> (= (lfilter$ uu$ xss$) (lCons$a ?v0 ?v1)) false)) false) :named a14))
(assert (! (exists ((?v0 A_llist_llist$) (?v1 A_llist_llist$)) (and (= xss$ (lappend$ ?v0 (lCons$a y$ ?v1))) (and (lfinite$ ?v0) (and (forall ((?v2 A_llist$)) (=> (member$ ?v2 (lset$ ?v0)) (not (not (fun_app$ lnull$ ?v2))))) (and (not (fun_app$ lnull$ y$)) (= ys$ (lfilter$ uu$ ?v1))))))) :named a15))
(assert (! (forall ((?v0 A$) (?v1 A_llist$) (?v2 A_llist$)) (! (= (lappend$a (lCons$ ?v0 ?v1) ?v2) (lCons$ ?v0 (lappend$a ?v1 ?v2))) :pattern ((lappend$a (lCons$ ?v0 ?v1) ?v2)))) :named a16))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist_llist$) (?v2 A_llist_llist$)) (! (= (lappend$ (lCons$a ?v0 ?v1) ?v2) (lCons$a ?v0 (lappend$ ?v1 ?v2))) :pattern ((lappend$ (lCons$a ?v0 ?v1) ?v2)))) :named a17))
...
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_llist$)) (= (not (lnull$a (lappend$ ?v0 ?v1))) (or (not (lnull$a ?v0)) (not (lnull$a ?v1))))) :named a22))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (not (fun_app$ lnull$ (lappend$a ?v0 ?v1))) (or (not (fun_app$ lnull$ ?v0)) (not (fun_app$ lnull$ ?v1))))) :named a23))
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_llist$)) (= (lnull$a (lappend$ ?v0 ?v1)) (and (lnull$a ?v0) (lnull$a ?v1)))) :named a24))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (fun_app$ lnull$ (lappend$a ?v0 ?v1)) (and (fun_app$ lnull$ ?v0) (fun_app$ lnull$ ?v1)))) :named a25))
(assert (! (forall ((?v0 A_bool_fun$) (?v1 A$) (?v2 A_llist$)) (! (= (lfilter$a ?v0 (lCons$ ?v1 ?v2)) (ite (fun_app$b ?v0 ?v1) (lCons$ ?v1 (lfilter$a ?v0 ?v2)) (lfilter$a ?v0 ?v2))) :pattern ((lfilter$a ?v0 (lCons$ ?v1 ?v2))))) :named a26))
(assert (! (forall ((?v0 A_llist_bool_fun$) (?v1 A_llist$) (?v2 A_llist_llist$)) (! (= (lfilter$ ?v0 (lCons$a ?v1 ?v2)) (ite (fun_app$ ?v0 ?v1) (lCons$a ?v1 (lfilter$ ?v0 ?v2)) (lfilter$ ?v0 ?v2))) :pattern ((lfilter$ ?v0 (lCons$a ?v1 ?v2))))) :named a27))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (lfinite$a (lappend$a ?v0 ?v1)) (and (lfinite$a ?v0) (lfinite$a ?v1)))) :named a28))
(assert (! (forall ((?v0 A_llist_llist$) (?v1 A_llist_llist$)) (= (lfinite$ (lappend$ ?v0 ?v1)) (and (lfinite$ ?v0) (lfinite$ ?v1)))) :named a29))
(assert (! (not (less_eq$ (lset$ xss$) (collect$ lnull$))) :named a30))
