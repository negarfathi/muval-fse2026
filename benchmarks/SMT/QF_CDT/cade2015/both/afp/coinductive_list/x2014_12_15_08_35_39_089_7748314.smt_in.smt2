...
(assert (! (not (= (iterates$ f$ a$) (inf_llist$ uu$))) :named a1))
...
(assert (! (forall ((?v0 A_a_fun$) (?v1 A$) (?v2 Nat$)) (= (fun_app$ (lnth$ (iterates$ ?v0 ?v1)) ?v2) (fun_app$a (fun_app$b (fun_app$c compow$ ?v2) ?v0) ?v1))) :named a3))
(assert (! (forall ((?v0 Nat$) (?v1 A_a_fun$) (?v2 A$)) (= (ldropn$ ?v0 (iterates$ ?v1 ?v2)) (iterates$ ?v1 (fun_app$a (fun_app$b (fun_app$c compow$ ?v0) ?v1) ?v2)))) :named a4))
(assert (! (= funpow$ compow$) :named a5))
(assert (! (forall ((?v0 Nat_a_fun$)) (not (= (inf_llist$ ?v0) lNil$))) :named a6))
(assert (! (forall ((?v0 Nat_a_fun$)) (not (lnull$ (inf_llist$ ?v0)))) :named a7))
(assert (! (forall ((?v0 Nat_a_fun$)) (not (lfinite$ (inf_llist$ ?v0)))) :named a8))
(assert (! (forall ((?v0 A_a_fun$) (?v1 A$)) (= (iterates$ ?v0 ?v1) (lCons$ ?v1 (iterates$ ?v0 (fun_app$a ?v0 ?v1))))) :named a9))
(assert (! (forall ((?v0 A_a_fun$) (?v1 A$)) (not (lnull$ (iterates$ ?v0 ?v1)))) :named a10))
(assert (! (forall ((?v0 A_a_fun$) (?v1 A$)) (= (ltl$ (iterates$ ?v0 ?v1)) (iterates$ ?v0 (fun_app$a ?v0 ?v1)))) :named a11))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (not (lnull$ (lappend$ ?v0 ?v1))) (or (not (lnull$ ?v0)) (not (lnull$ ?v1))))) :named a18))
(check-sat)
;(get-unsat-core)
