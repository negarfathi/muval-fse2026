...
(declare-datatypes () ((A_llist_b_llist_prod$ (pair$a (fst$a A_llist$) (snd$a B_llist$)))
  (A_b_prod_a_b_prod_prod$ (pair$b (fst$b A_b_prod$) (snd$b A_b_prod$)))))
(declare-codatatypes () ((A_b_prod_a_b_prod_prod_llist$ (lNil$c) (lCons$c (lhd$c A_b_prod_a_b_prod_prod$) (ltl$c A_b_prod_a_b_prod_prod_llist$)))))
...
(declare-datatypes () ((A_a_b_prod_a_b_prod_prod_prod$ (pair$e (fst$e A$) (snd$e A_b_prod_a_b_prod_prod$)))))
(declare-codatatypes () ((A_a_b_prod_a_b_prod_prod_prod_llist$ (lNil$f) (lCons$f (lhd$f A_a_b_prod_a_b_prod_prod_prod$) (ltl$f A_a_b_prod_a_b_prod_prod_prod_llist$)))))
...
(declare-datatypes () ((A_a_prod$ (pair$g (fst$g A$) (snd$g A$)))))
