...
(assert (! (not (llexord$ r$ ys$ zs$)) :named a0))
(assert (! (forall ((?v0 A$)) (=> (member$ ?v0 (lset$ xs$)) (not (fun_app$ (fun_app$a r$ ?v0) ?v0)))) :named a1))
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 A_llist$)) (llexord$ ?v0 ?v1 ?v1)) :named a2))
(assert (! (llexord$ r$ (lappend$ xs$ ys$) (lappend$ xs$ zs$)) :named a3))
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 A_llist$) (?v2 A_llist$) (?v3 A_llist$)) (=> (llexord$ ?v0 ?v1 ?v2) (llexord$ ?v0 (lappend$ ?v3 ?v1) (lappend$ ?v3 ?v2)))) :named a4))
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 A_llist$) (?v2 A_llist$)) (llexord$ ?v0 ?v1 (lappend$ ?v1 ?v2))) :named a5))
