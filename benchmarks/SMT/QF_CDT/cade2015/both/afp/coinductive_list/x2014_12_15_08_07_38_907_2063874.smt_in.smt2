...
(assert (! (not (= (fun_app$ (lappend$ xs$) ys$) ys$)) :named a0))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (! (=> (and (lnull$ ?v0) (lnull$ ?v1)) (= (fun_app$ (lappend$ ?v0) ?v1) lNil$)) :pattern ((fun_app$ (lappend$ ?v0) ?v1)))) :named a11))
