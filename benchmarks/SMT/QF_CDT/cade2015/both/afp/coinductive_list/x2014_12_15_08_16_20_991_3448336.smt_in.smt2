...
(assert (! (not (= (ldrop$ n$ lNil$) lNil$)) :named a0))
...
(assert (! (forall ((?v0 Nat$)) (! (= (fun_app$b (ldropn$ ?v0) lNil$) lNil$) :pattern ((ldropn$ ?v0)))) :named a3))
...
(assert (! (forall ((?v0 A_llist$)) (= (fun_app$b (ltake$ zero$) ?v0) lNil$)) :named a14))
(check-sat)
;(get-unsat-core)
