...
(declare-datatypes () ((Nat_option$ (none$) (some$ (the$ Nat$)))
  ...
  (B_b_prod$ (pair$ (fst$ B$) (snd$ B$)))
  (B_b_prod_b_b_prod_prod$ (pair$a (fst$a B_b_prod$) (snd$a B_b_prod$)))))
(declare-codatatypes () ((B_b_prod_b_b_prod_prod_llist$ (lNil$b) (lCons$b (lhd$b B_b_prod_b_b_prod_prod$) (ltl$b B_b_prod_b_b_prod_prod_llist$)))))
(declare-datatypes () ((B_b_prod_b_prod$ (pair$b (fst$b B_b_prod$) (snd$b B$)))))
(declare-codatatypes () ((B_b_prod_b_prod_llist$ (lNil$c) (lCons$c (lhd$c B_b_prod_b_prod$) (ltl$c B_b_prod_b_prod_llist$)))))
(declare-datatypes () ((B_b_b_prod_prod$ (pair$c (fst$c B$) (snd$c B_b_prod$)))))
(declare-codatatypes () ((B_b_b_prod_prod_llist$ (lNil$d) (lCons$d (lhd$d B_b_b_prod_prod$) (ltl$d B_b_b_prod_prod_llist$)))
  (B_b_prod_llist$ (lNil$e) (lCons$e (lhd$e B_b_prod$) (ltl$e B_b_prod_llist$)))))
(declare-datatypes () ((B_b_b_prod_b_prod_prod$ (pair$d (fst$d B$) (snd$d B_b_prod_b_prod$)))))
(declare-codatatypes () ((B_b_b_prod_b_prod_prod_llist$ (lNil$f) (lCons$f (lhd$f B_b_b_prod_b_prod_prod$) (ltl$f B_b_b_prod_b_prod_prod_llist$)))))
(declare-datatypes () ((B_b_b_b_prod_prod_prod$ (pair$e (fst$e B$) (snd$e B_b_b_prod_prod$)))))
(declare-codatatypes () ((B_b_b_b_prod_prod_prod_llist$ (lNil$g) (lCons$g (lhd$g B_b_b_b_prod_prod_prod$) (ltl$g B_b_b_b_prod_prod_prod_llist$)))))
(declare-datatypes () ((B_b_prod_b_prod_b_prod$ (pair$f (fst$f B_b_prod_b_prod$) (snd$f B$)))))
(declare-codatatypes () ((B_b_prod_b_prod_b_prod_llist$ (lNil$h) (lCons$h (lhd$h B_b_prod_b_prod_b_prod$) (ltl$h B_b_prod_b_prod_b_prod_llist$)))))
(declare-datatypes () ((B_b_b_prod_prod_b_prod$ (pair$g (fst$g B_b_b_prod_prod$) (snd$g B$)))))
(declare-codatatypes () ((B_b_b_prod_prod_b_prod_llist$ (lNil$i) (lCons$i (lhd$i B_b_b_prod_prod_b_prod$) (ltl$i B_b_b_prod_prod_b_prod_llist$)))))
(declare-datatypes () ((B_b_b_prod_b_b_prod_prod_prod$ (pair$h (fst$h B$) (snd$h B_b_prod_b_b_prod_prod$)))))
(declare-codatatypes () ((B_b_b_prod_b_b_prod_prod_prod_llist$ (lNil$j) (lCons$j (lhd$j B_b_b_prod_b_b_prod_prod_prod$) (ltl$j B_b_b_prod_b_b_prod_prod_prod_llist$)))))
(declare-datatypes () ((B_b_prod_b_b_prod_b_prod_prod$ (pair$i (fst$i B_b_prod$) (snd$i B_b_prod_b_prod$)))))
(declare-codatatypes () ((B_b_prod_b_b_prod_b_prod_prod_llist$ (lNil$k) (lCons$k (lhd$k B_b_prod_b_b_prod_b_prod_prod$) (ltl$k B_b_prod_b_b_prod_b_prod_prod_llist$)))))
