...
(assert (! (not (= (lfilter$ p$ lNil$) lNil$)) :named a0))
...
(assert (! (= (ldistinct$ lNil$) true) :named a7))
(assert (! (forall ((?v0 A_bool_fun$)) (! (= (fun_app$b (ldropWhile$ ?v0) lNil$) lNil$) :pattern ((ldropWhile$ ?v0)))) :named a8))
