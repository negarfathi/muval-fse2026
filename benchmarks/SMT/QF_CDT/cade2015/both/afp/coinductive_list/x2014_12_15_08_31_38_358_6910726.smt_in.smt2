...
(declare-datatypes () ((A_llist_list$ (nil$) (cons$ (hd$ A_llist$) (tl$ A_llist_list$)))
  ...
  (A_list_list_list$ (nil$c) (cons$c (hd$c A_list_list$) (tl$c A_list_list_list$)))))
(declare-codatatypes () ((A_list_list_llist$ (lNil$b) (lCons$b (lhd$b A_list_list$) (ltl$b A_list_list_llist$)))))
(declare-datatypes () ((A_llist_list_list$ (nil$d) (cons$d (hd$d A_llist_list$) (tl$d A_llist_list_list$)))))
(declare-codatatypes () ((A_llist_list_llist$ (lNil$c) (lCons$c (lhd$c A_llist_list$) (ltl$c A_llist_list_llist$)))
  (A_list_llist$ (lNil$d) (lCons$d (lhd$d A_list$) (ltl$d A_list_llist$)))))
(declare-datatypes () ((A_list_list_list_list$ (nil$e) (cons$e (hd$e A_list_list_list$) (tl$e A_list_list_list_list$)))
  (A_llist_list_list_list$ (nil$f) (cons$f (hd$f A_llist_list_list$) (tl$f A_llist_list_list_list$)))))
