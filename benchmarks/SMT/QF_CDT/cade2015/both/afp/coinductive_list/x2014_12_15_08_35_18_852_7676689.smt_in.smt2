...
(declare-datatypes () ((A_nat_prod_a_nat_prod_prod$ (pair$a (fst$a A_nat_prod$) (snd$a A_nat_prod$)))
  (A_nat_prod_a_prod$ (pair$b (fst$b A_nat_prod$) (snd$b A$)))
  (A_a_nat_prod_prod$ (pair$c (fst$c A$) (snd$c A_nat_prod$)))
  (A_a_prod$ (pair$d (fst$d A$) (snd$d A$)))))
(declare-codatatypes () ((A_a_prod_llist$ (lNil$c) (lCons$c (lhd$c A_a_prod$) (ltl$c A_a_prod_llist$)))
  (A_nat_prod_a_prod_llist$ (lNil$d) (lCons$d (lhd$d A_nat_prod_a_prod$) (ltl$d A_nat_prod_a_prod_llist$)))
  (A_a_nat_prod_prod_llist$ (lNil$e) (lCons$e (lhd$e A_a_nat_prod_prod$) (ltl$e A_a_nat_prod_prod_llist$)))
  (A_nat_prod_a_nat_prod_prod_llist$ (lNil$f) (lCons$f (lhd$f A_nat_prod_a_nat_prod_prod$) (ltl$f A_nat_prod_a_nat_prod_prod_llist$)))))
...
(declare-datatypes () ((A_a_nat_prod_a_prod_prod$ (pair$j (fst$j A$) (snd$j A_nat_prod_a_prod$)))
  (A_a_a_nat_prod_prod_prod$ (pair$k (fst$k A$) (snd$k A_a_nat_prod_prod$)))))
