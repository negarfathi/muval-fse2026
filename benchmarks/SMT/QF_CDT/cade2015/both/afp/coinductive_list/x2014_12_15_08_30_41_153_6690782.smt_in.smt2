...
(assert (! (lfinite$ (fun_app$c (lfilter$ p$) (ltl$ xsa$))) :named a5))
(assert (! (not (lfinite$ xs$)) :named a6))
(assert (! (forall ((?v0 A_bool_fun$) (?v1 A_llist$)) (= (fun_app$c (lfilter$ ?v0) (fun_app$c (lfilter$ ?v0) ?v1)) (fun_app$c (lfilter$ ?v0) ?v1))) :named a7))
