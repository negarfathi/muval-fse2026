...
(declare-codatatypes () ((Nat_nat_a_fun_fun_llist$ (lNil$a) (lCons$a (select$ Nat_nat_a_fun_fun$) (selecta$ Nat_nat_a_fun_fun_llist$)))
  (Nat_nat_fun_llist$ (lNil$b) (lCons$b (selectb$ Nat_nat_fun$) (selectc$ Nat_nat_fun_llist$)))
  (Nat_a_fun_llist$ (lNil$c) (lCons$c (selectd$ Nat_a_fun$) (selecte$ Nat_a_fun_llist$)))
  (Nat_llist$ (lNil$d) (lCons$d (lhd$a Nat$) (ltl$a Nat_llist$)))))
(declare-fun na$ () Nat$)
