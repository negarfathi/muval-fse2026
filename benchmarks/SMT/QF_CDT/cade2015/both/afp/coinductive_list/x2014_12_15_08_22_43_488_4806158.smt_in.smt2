...
(assert (! (not (monotone$ lprefix$ lprefix$ (ltakeWhile$ p$))) :named a1))
...
(assert (! (forall ((?v0 Enat$)) (monotone$ lprefix$ lprefix$ (ldrop$ ?v0))) :named a14))
(assert (! (forall ((?v0 A$)) (monotone$ lprefix$ lprefix$ (uu$ ?v0))) :named a15))
(assert (! (forall ((?v0 A_a_fun$)) (monotone$ lprefix$ lprefix$ (lmap$ ?v0))) :named a16))
(assert (! (forall ((?v0 Enat$)) (monotone$ lprefix$ lprefix$ (ltake$ ?v0))) :named a17))
(assert (! (forall ((?v0 A_llist$)) (monotone$ lprefix$ lprefix$ (lappend$ ?v0))) :named a18))
(check-sat)
;(get-unsat-core)
