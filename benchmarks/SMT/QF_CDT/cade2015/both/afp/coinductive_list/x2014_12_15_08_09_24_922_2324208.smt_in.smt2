...
(assert (! (not (=> (lfinite$ xs$) (lprefix$ ys$ zs$))) :named a0))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$) (?v2 A_llist$)) (=> (lprefix$ ?v0 ?v1) (lprefix$ (lappend$ ?v2 ?v0) (lappend$ ?v2 ?v1)))) :named a17))
(check-sat)
;(get-unsat-core)
