...
(assert (! (forall ((?v0 A_llist$) (?v1 A$)) (=> (and (member$ x$ (lset$ ?v0)) (p$ ?v0)) (p$ (lCons$ ?v1 ?v0)))) :named a3))
...
(assert (! (forall ((?v0 A_bool_fun$) (?v1 A$) (?v2 A_llist$)) (! (= (pred_llist$ ?v0 (lCons$ ?v1 ?v2)) (and (fun_app$b ?v0 ?v1) (pred_llist$ ?v0 ?v2))) :pattern ((pred_llist$ ?v0 (lCons$ ?v1 ?v2))))) :named a12))
(assert (! (forall ((?v0 A$) (?v1 A_llist$)) (! (= (lset$ (lCons$ ?v0 ?v1)) (insert$ ?v0 (lset$ ?v1))) :pattern ((lCons$ ?v0 ?v1)))) :named a13))
