; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 50
...
(declare-codatatypes () ((A_llist$ (lNil$) (lCons$ (lhd$ A$) (ltl$ A_llist$)))
  ...
  (C_llist$ (lNil$d) (lCons$d (lhd$d C$) (ltl$d C_llist$)))))
(declare-datatypes () ((A_a_prod$ (pair$ (fst$ A$) (snd$ A$)))
  (A_llist_a_llist_prod$ (pair$a (fst$a A_llist$) (snd$a A_llist$)))))
(declare-fun b$ () C$)
