...
(declare-codatatypes () ((A_list_llist$ (lNil$b) (lCons$b (lhd$b A_list$) (ltl$b A_list_llist$)))
  ...
  (A_list_llist_llist$ (lNil$d) (lCons$d (lhd$d A_list_llist$) (ltl$d A_list_llist_llist$)))
  (A_llist_llist_llist_llist$ (lNil$e) (lCons$e (lhd$e A_llist_llist_llist$) (ltl$e A_llist_llist_llist_llist$)))))
(declare-datatypes () ((A_llist_list$ (nil$b) (cons$b (hd$b A_llist$) (tl$b A_llist_list$)))
