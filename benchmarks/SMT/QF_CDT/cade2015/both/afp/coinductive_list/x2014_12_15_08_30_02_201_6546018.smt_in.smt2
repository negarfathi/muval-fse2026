...
(assert (! (forall ((?v0 A$) (?v1 A$)) (! (= (fun_app$ (fun_app$e uuf$ ?v0) ?v1) false) :pattern ((fun_app$ (fun_app$e uuf$ ?v0) ?v1)))) :named a4))
(assert (! (forall ((?v0 A$)) (! (= (fun_app$ uud$ ?v0) false) :pattern ((fun_app$ uud$ ?v0)))) :named a5))
(assert (! (forall ((?v0 A$)) (! (= (fun_app$ uua$ ?v0) true) :pattern ((fun_app$ uua$ ?v0)))) :named a6))
(assert (! (not (forall ((?v0 A_llist$)) (fun_app$f (fun_app$g lprefix$ (fun_app$c (lfilter$ p$) (fun_app$c (lfilter$ q$) ?v0))) (fun_app$c (lfilter$ uu$) ?v0)))) :named a7))
(assert (! (forall ((?v0 A_llist$)) (fun_app$f (fun_app$g lprefix$ ?v0) ?v0)) :named a8))
(assert (! (forall ((?v0 A_llist$)) (fun_app$f (fun_app$g lprefix$ ?v0) ?v0)) :named a9))
(assert (! (forall ((?v0 A_llist$)) (= (fun_app$c (lfilter$ uua$) ?v0) ?v0)) :named a10))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (and (fun_app$f (fun_app$g lprefix$ ?v0) ?v1) (fun_app$f (fun_app$g lprefix$ ?v1) ?v0)) (= ?v0 ?v1))) :named a12))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (and (fun_app$f (fun_app$g lprefix$ ?v0) ?v1) (fun_app$f (fun_app$g lprefix$ ?v1) ?v0)) (= ?v0 ?v1))) :named a13))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$) (?v2 A_llist$)) (=> (and (fun_app$f (fun_app$g lprefix$ ?v0) ?v1) (fun_app$f (fun_app$g lprefix$ ?v2) ?v1)) (or (fun_app$f (fun_app$g lprefix$ ?v0) ?v2) (fun_app$f (fun_app$g lprefix$ ?v2) ?v0)))) :named a14))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$) (?v2 A_llist$)) (=> (and (fun_app$f (fun_app$g lprefix$ ?v0) ?v1) (fun_app$f (fun_app$g lprefix$ ?v1) ?v2)) (fun_app$f (fun_app$g lprefix$ ?v0) ?v2))) :named a15))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$) (?v2 A_llist$)) (=> (and (fun_app$f (fun_app$g lprefix$ ?v0) ?v1) (fun_app$f (fun_app$g lprefix$ ?v1) ?v2)) (fun_app$f (fun_app$g lprefix$ ?v0) ?v2))) :named a16))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (! (= (lstrict_prefix$ ?v0 ?v1) (and (fun_app$f (fun_app$g lprefix$ ?v0) ?v1) (not (= ?v0 ?v1)))) :pattern ((lstrict_prefix$ ?v0 ?v1)))) :named a21))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (fun_app$f (llexord$ uuf$ ?v0) ?v1) (fun_app$f (fun_app$g lprefix$ ?v0) ?v1))) :named a24))
(check-sat)
;(get-unsat-core)
