...
(declare-codatatypes () ((A_a_a_prod_prod_llist$ (lNil$f) (lCons$f (lhd$f A_a_a_prod_prod$) (ltl$f A_a_a_prod_prod_llist$)))))
(declare-datatypes () ((A_a_nat_prod_prod$ (pair$e (fst$e A$) (snd$e A_nat_prod$)))))
(declare-codatatypes () ((A_a_nat_prod_prod_llist$ (lNil$g) (lCons$g (lhd$g A_a_nat_prod_prod$) (ltl$g A_a_nat_prod_prod_llist$)))))
...
(declare-codatatypes () ((A_nat_prod_a_prod_llist$ (lNil$j) (lCons$j (lhd$j A_nat_prod_a_prod$) (ltl$j A_nat_prod_a_prod_llist$)))))
(declare-datatypes () ((A_nat_prod_nat_prod$ (pair$i (fst$i A_nat_prod$) (snd$i Nat$)))))
(declare-codatatypes () ((A_nat_prod_nat_prod_llist$ (lNil$k) (lCons$k (lhd$k A_nat_prod_nat_prod$) (ltl$k A_nat_prod_nat_prod_llist$)))))
(declare-datatypes () ((Nat_a_a_prod_prod$ (pair$j (fst$j Nat$) (snd$j A_a_prod$)))))
(declare-codatatypes () ((Nat_a_a_prod_prod_llist$ (lNil$l) (lCons$l (lhd$l Nat_a_a_prod_prod$) (ltl$l Nat_a_a_prod_prod_llist$)))))
(declare-datatypes () ((A_nat_prod_a_nat_prod_prod$ (pair$k (fst$k A_nat_prod$) (snd$k A_nat_prod$)))))
(declare-codatatypes () ((A_nat_prod_a_nat_prod_prod_llist$ (lNil$m) (lCons$m (lhd$m A_nat_prod_a_nat_prod_prod$) (ltl$m A_nat_prod_a_nat_prod_prod_llist$)))))
