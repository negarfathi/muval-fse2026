...
(assert (! (not (= (lhd$ (ldropn$ n$ xs$)) (lnth$ xs$ n$))) :named a0))
...
(assert (! (forall ((?v0 Nat$) (?v1 A_llist$)) (= (llength$ (ldropn$ ?v0 ?v1)) (fun_app$a (minus$ (llength$ ?v1)) (enat$ ?v0)))) :named a5))
...
(assert (! (forall ((?v0 Nat$) (?v1 Enat_nat_fun$) (?v2 Enat$) (?v3 Enat$)) (=> (and (= ?v0 (fun_app$c ?v1 ?v2)) (and (fun_app$ (less$ ?v2) ?v3) (forall ((?v4 Enat$) (?v5 Enat$)) (=> (fun_app$ (less$ ?v4) ?v5) (fun_app$b (less$a (fun_app$c ?v1 ?v4)) (fun_app$c ?v1 ?v5)))))) (fun_app$b (less$a ?v0) (fun_app$c ?v1 ?v3)))) :named a16))
(assert (! (forall ((?v0 Enat$) (?v1 Nat_enat_fun$) (?v2 Nat$) (?v3 Nat$)) (=> (and (= ?v0 (fun_app$d ?v1 ?v2)) (and (fun_app$b (less$a ?v2) ?v3) (forall ((?v4 Nat$) (?v5 Nat$)) (=> (fun_app$b (less$a ?v4) ?v5) (fun_app$ (less$ (fun_app$d ?v1 ?v4)) (fun_app$d ?v1 ?v5)))))) (fun_app$ (less$ ?v0) (fun_app$d ?v1 ?v3)))) :named a17))
(assert (! (forall ((?v0 Nat$) (?v1 Nat_nat_fun$) (?v2 Nat$) (?v3 Nat$)) (=> (and (= ?v0 (fun_app$e ?v1 ?v2)) (and (fun_app$b (less$a ?v2) ?v3) (forall ((?v4 Nat$) (?v5 Nat$)) (=> (fun_app$b (less$a ?v4) ?v5) (fun_app$b (less$a (fun_app$e ?v1 ?v4)) (fun_app$e ?v1 ?v5)))))) (fun_app$b (less$a ?v0) (fun_app$e ?v1 ?v3)))) :named a18))
...
(assert (! (forall ((?v0 A$) (?v1 A_llist$)) (! (= (lhd$ (lCons$ ?v0 ?v1)) ?v0) :pattern ((lCons$ ?v0 ?v1)))) :named a21))
(assert (! (forall ((?v0 Enat$) (?v1 Nat$)) (=> (and (fun_app$ (less$ ?v0) (enat$ ?v1)) (forall ((?v2 Nat$)) (=> (and (= ?v0 (enat$ ?v2)) (fun_app$b (less$a ?v2) ?v1)) false))) false)) :named a22))
(assert (! (forall ((?v0 Enat$)) (not (fun_app$ (less$ ?v0) ?v0))) :named a23))
(assert (! (forall ((?v0 Nat$)) (not (fun_app$b (less$a ?v0) ?v0))) :named a24))
(check-sat)
;(get-unsat-core)
