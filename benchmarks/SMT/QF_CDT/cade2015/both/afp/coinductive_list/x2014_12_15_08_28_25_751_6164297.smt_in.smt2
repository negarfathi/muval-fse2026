...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$) (?v2 A$) (?v3 A_llist$)) (=> (and (lfinite$ ?v0) (and (= xs$ (fun_app$ (lappend$ ?v0) ?v1)) (= ys$ (fun_app$ (lappend$ ?v0) (lCons$ ?v2 ?v3))))) (and (not (= ?v1 lNil$)) (not (fun_app$a (fun_app$b r$ (lhd$ ?v1)) ?v2))))) :named a4))
(assert (! (llexord$ r$ xsa$ ysa$) :named a5))
