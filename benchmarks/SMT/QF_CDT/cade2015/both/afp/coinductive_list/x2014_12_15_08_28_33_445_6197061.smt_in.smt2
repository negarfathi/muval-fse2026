...
(assert (! (=> (forall ((?v0 A$) (?v1 A_llist$)) (=> (= ysa$ (lCons$ ?v0 ?v1)) false)) false) :named a4))
...
(assert (! (forall ((?v0 A$) (?v1 A_llist$) (?v2 A_llist$)) (! (= (fun_app$b (lappend$ (lCons$ ?v0 ?v1)) ?v2) (lCons$ ?v0 (fun_app$b (lappend$ ?v1) ?v2))) :pattern ((fun_app$b (lappend$ (lCons$ ?v0 ?v1)) ?v2)))) :named a7))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (not (lnull$ (fun_app$b (lappend$ ?v0) ?v1))) (or (not (lnull$ ?v0)) (not (lnull$ ?v1))))) :named a10))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (lnull$ (fun_app$b (lappend$ ?v0) ?v1)) (and (lnull$ ?v0) (lnull$ ?v1)))) :named a11))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (lfinite$ (fun_app$b (lappend$ ?v0) ?v1)) (and (lfinite$ ?v0) (lfinite$ ?v1)))) :named a16))
(assert (! (forall ((?v0 A_a_bool_fun_fun$) (?v1 A$) (?v2 A_llist$) (?v3 A$) (?v4 A_llist$)) (! (= (llexord$ ?v0 (lCons$ ?v1 ?v2) (lCons$ ?v3 ?v4)) (or (and (= ?v1 ?v3) (llexord$ ?v0 ?v2 ?v4)) (fun_app$ (fun_app$a ?v0 ?v1) ?v3))) :pattern ((llexord$ ?v0 (lCons$ ?v1 ?v2) (lCons$ ?v3 ?v4))))) :named a17))
(check-sat)
;(get-unsat-core)
