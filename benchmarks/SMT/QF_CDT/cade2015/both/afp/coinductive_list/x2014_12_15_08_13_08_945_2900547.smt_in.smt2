...
(assert (! (not (= (lnull$ (llist_of$ xs$)) (= xs$ nil$))) :named a0))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (not (lnull$a (lzip$ ?v0 ?v1))) (and (not (lnull$ ?v0)) (not (lnull$ ?v1))))) :named a27))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_llist$)) (= (not (lnull$c (lzip$a ?v0 ?v1))) (and (not (lnull$ ?v0)) (not (lnull$a ?v1))))) :named a28))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_llist$)) (= (not (lnull$b (lzip$b ?v0 ?v1))) (and (not (lnull$a ?v0)) (not (lnull$ ?v1))))) :named a29))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_a_prod_llist$)) (= (not (lnull$d (lzip$c ?v0 ?v1))) (and (not (lnull$a ?v0)) (not (lnull$a ?v1))))) :named a30))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_a_prod_llist$)) (= (not (lnull$e (lzip$d ?v0 ?v1))) (and (not (lnull$ ?v0)) (not (lnull$b ?v1))))) :named a31))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_a_prod_prod_llist$)) (= (not (lnull$f (lzip$e ?v0 ?v1))) (and (not (lnull$ ?v0)) (not (lnull$c ?v1))))) :named a32))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$) (?v1 A_llist$)) (= (not (lnull$g (lzip$f ?v0 ?v1))) (and (not (lnull$b ?v0)) (not (lnull$ ?v1))))) :named a33))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$) (?v1 A_llist$)) (= (not (lnull$h (lzip$g ?v0 ?v1))) (and (not (lnull$c ?v0)) (not (lnull$ ?v1))))) :named a34))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_a_a_prod_prod_llist$)) (= (not (lnull$i (lzip$h ?v0 ?v1))) (and (not (lnull$ ?v0)) (not (lnull$d ?v1))))) :named a35))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_a_prod_a_prod_llist$)) (= (not (lnull$j (lzip$i ?v0 ?v1))) (and (not (lnull$a ?v0)) (not (lnull$b ?v1))))) :named a36))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (= (lnull$a (lzip$ ?v0 ?v1)) (or (lnull$ ?v0) (lnull$ ?v1)))) :named a37))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_llist$)) (= (lnull$c (lzip$a ?v0 ?v1)) (or (lnull$ ?v0) (lnull$a ?v1)))) :named a38))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_llist$)) (= (lnull$b (lzip$b ?v0 ?v1)) (or (lnull$a ?v0) (lnull$ ?v1)))) :named a39))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_a_prod_llist$)) (= (lnull$d (lzip$c ?v0 ?v1)) (or (lnull$a ?v0) (lnull$a ?v1)))) :named a40))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_a_prod_llist$)) (= (lnull$e (lzip$d ?v0 ?v1)) (or (lnull$ ?v0) (lnull$b ?v1)))) :named a41))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_a_prod_prod_llist$)) (= (lnull$f (lzip$e ?v0 ?v1)) (or (lnull$ ?v0) (lnull$c ?v1)))) :named a42))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$) (?v1 A_llist$)) (= (lnull$g (lzip$f ?v0 ?v1)) (or (lnull$b ?v0) (lnull$ ?v1)))) :named a43))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$) (?v1 A_llist$)) (= (lnull$h (lzip$g ?v0 ?v1)) (or (lnull$c ?v0) (lnull$ ?v1)))) :named a44))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_a_a_prod_prod_llist$)) (= (lnull$i (lzip$h ?v0 ?v1)) (or (lnull$ ?v0) (lnull$d ?v1)))) :named a45))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_a_prod_a_prod_llist$)) (= (lnull$j (lzip$i ?v0 ?v1)) (or (lnull$a ?v0) (lnull$b ?v1)))) :named a46))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun$) (?v1 A_a_prod_a_a_prod_prod$)) (not (lnull$d (iterates$ ?v0 ?v1)))) :named a47))
(assert (! (forall ((?v0 A_a_prod_a_prod_a_a_prod_a_prod_fun$) (?v1 A_a_prod_a_prod$)) (not (lnull$b (iterates$a ?v0 ?v1)))) :named a48))
(assert (! (forall ((?v0 A_a_a_prod_prod_a_a_a_prod_prod_fun$) (?v1 A_a_a_prod_prod$)) (not (lnull$c (iterates$b ?v0 ?v1)))) :named a49))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_fun$) (?v1 A_a_prod$)) (not (lnull$a (iterates$c ?v0 ?v1)))) :named a50))
(assert (! (forall ((?v0 A_a_fun$) (?v1 A$)) (not (lnull$ (iterates$d ?v0 ?v1)))) :named a51))
(assert (! (= (llist_of$ nil$) lNil$) :named a52))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (or (lnull$ ?v0) (lnull$ ?v1)) (lnull$a (lzip$ ?v0 ?v1)))) :named a53))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_llist$)) (=> (or (lnull$ ?v0) (lnull$a ?v1)) (lnull$c (lzip$a ?v0 ?v1)))) :named a54))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_llist$)) (=> (or (lnull$a ?v0) (lnull$ ?v1)) (lnull$b (lzip$b ?v0 ?v1)))) :named a55))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_a_prod_llist$)) (=> (or (lnull$a ?v0) (lnull$a ?v1)) (lnull$d (lzip$c ?v0 ?v1)))) :named a56))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_a_prod_llist$)) (=> (or (lnull$ ?v0) (lnull$b ?v1)) (lnull$e (lzip$d ?v0 ?v1)))) :named a57))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_a_prod_prod_llist$)) (=> (or (lnull$ ?v0) (lnull$c ?v1)) (lnull$f (lzip$e ?v0 ?v1)))) :named a58))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$) (?v1 A_llist$)) (=> (or (lnull$b ?v0) (lnull$ ?v1)) (lnull$g (lzip$f ?v0 ?v1)))) :named a59))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$) (?v1 A_llist$)) (=> (or (lnull$c ?v0) (lnull$ ?v1)) (lnull$h (lzip$g ?v0 ?v1)))) :named a60))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_a_a_prod_prod_llist$)) (=> (or (lnull$ ?v0) (lnull$d ?v1)) (lnull$i (lzip$h ?v0 ?v1)))) :named a61))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_a_prod_a_prod_llist$)) (=> (or (lnull$a ?v0) (lnull$b ?v1)) (lnull$j (lzip$i ?v0 ?v1)))) :named a62))
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (and (not (lnull$ ?v0)) (not (lnull$ ?v1))) (not (lnull$a (lzip$ ?v0 ?v1))))) :named a63))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_llist$)) (=> (and (not (lnull$ ?v0)) (not (lnull$a ?v1))) (not (lnull$c (lzip$a ?v0 ?v1))))) :named a64))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_llist$)) (=> (and (not (lnull$a ?v0)) (not (lnull$ ?v1))) (not (lnull$b (lzip$b ?v0 ?v1))))) :named a65))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_a_prod_llist$)) (=> (and (not (lnull$a ?v0)) (not (lnull$a ?v1))) (not (lnull$d (lzip$c ?v0 ?v1))))) :named a66))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_a_prod_llist$)) (=> (and (not (lnull$ ?v0)) (not (lnull$b ?v1))) (not (lnull$e (lzip$d ?v0 ?v1))))) :named a67))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_a_prod_prod_llist$)) (=> (and (not (lnull$ ?v0)) (not (lnull$c ?v1))) (not (lnull$f (lzip$e ?v0 ?v1))))) :named a68))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$) (?v1 A_llist$)) (=> (and (not (lnull$b ?v0)) (not (lnull$ ?v1))) (not (lnull$g (lzip$f ?v0 ?v1))))) :named a69))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$) (?v1 A_llist$)) (=> (and (not (lnull$c ?v0)) (not (lnull$ ?v1))) (not (lnull$h (lzip$g ?v0 ?v1))))) :named a70))
(assert (! (forall ((?v0 A_llist$) (?v1 A_a_prod_a_a_prod_prod_llist$)) (=> (and (not (lnull$ ?v0)) (not (lnull$d ?v1))) (not (lnull$i (lzip$h ?v0 ?v1))))) :named a71))
(assert (! (forall ((?v0 A_a_prod_llist$) (?v1 A_a_prod_a_prod_llist$)) (=> (and (not (lnull$a ?v0)) (not (lnull$b ?v1))) (not (lnull$j (lzip$i ?v0 ?v1))))) :named a72))
(assert (! (forall ((?v0 A_list$)) (lfinite$ (llist_of$ ?v0))) :named a73))
(assert (! (= (lfinite$ lNil$) true) :named a74))
(check-sat)
;(get-unsat-core)
