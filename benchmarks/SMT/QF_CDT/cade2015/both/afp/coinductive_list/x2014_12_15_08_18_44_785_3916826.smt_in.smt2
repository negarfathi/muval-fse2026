...
(assert (! (not (= (lnth$ (llist_of$ xs$) n$) (nth$ xs$ n$))) :named a0))
...
(assert (! (forall ((?v0 A_list$) (?v1 Nat$)) (= (list_update$ ?v0 ?v1 (nth$ ?v0 ?v1)) ?v0)) :named a4))
(assert (! (forall ((?v0 Nat$) (?v1 Nat$) (?v2 A_list$) (?v3 A$)) (=> (not (= ?v0 ?v1)) (= (nth$ (list_update$ ?v2 ?v0 ?v3) ?v1) (nth$ ?v2 ?v1)))) :named a5))
...
(assert (! (forall ((?v0 A$) (?v1 A_llist$) (?v2 Nat$)) (! (= (lnth$ (lCons$ ?v0 ?v1) (suc$ ?v2)) (lnth$ ?v1 ?v2)) :pattern ((lnth$ (lCons$ ?v0 ?v1) (suc$ ?v2))))) :named a11))
