...
(declare-fun p$ (A_llist$ A_llist$) Bool)
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$)) (=> (p$ ?v0 ?v1) (and (=> (lnull$ ?v1) (lnull$ ?v0)) (=> (and (not (lnull$ ?v0)) (not (lnull$ ?v1))) (and (= (lhd$ ?v0) (lhd$ ?v1)) (or (p$ (ltl$ ?v0) (ltl$ ?v1)) (lprefix$ (ltl$ ?v0) (ltl$ ?v1)))))))) :named a4))
...
(assert (! (forall ((?v0 A_llist$)) (! (= (lnull$ ?v0) (= ?v0 lNil$)) :pattern ((lnull$ ?v0)))) :named a12))
...
(assert (! (= (ltl$ lNil$) lNil$) :named a15))
(assert (! (forall ((?v0 A_llist$)) (=> (and (=> (= ?v0 lNil$) false) (=> (= ?v0 (lCons$ (lhd$ ?v0) (ltl$ ?v0))) false)) false)) :named a16))
