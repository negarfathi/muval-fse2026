...
(assert (! (forall ((?v0 A_llist$)) (! (= (lprefix$ lNil$ ?v0) true) :pattern ((lprefix$ lNil$ ?v0)))) :named a10))
...
(assert (! (forall ((?v0 A_llist$) (?v1 A_llist$) (?v2 A_llist$)) (=> (lprefix$ ?v0 ?v1) (lprefix$ (lappend$ ?v2 ?v0) (lappend$ ?v2 ?v1)))) :named a15))
