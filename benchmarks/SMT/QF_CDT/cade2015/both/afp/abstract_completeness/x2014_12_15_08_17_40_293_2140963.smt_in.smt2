...
(assert (! (forall ((?v0 State_rule_prod_tree$) (?v1 State_rule_prod_stream$)) (=> (and (wf$ eff$ rules$ ?v0) (ipath$ ?v0 ?v1)) (epath$ eff$ rules$ ?v1))) :named a2))
...
(assert (! (forall ((?v0 State_rule_prod_stream$)) (= (saturated$ eff$ rules$ ?v0) (forall ((?v1 Rule$)) (=> (member$a ?v1 (sset$ rules$)) (saturated$a eff$ ?v1 ?v0))))) :named a4))
(assert (! (forall ((?v0 State_rule_prod_tree$)) (= (shd$a (konig$ ?v0)) (root$ ?v0))) :named a5))
(assert (! (forall ((?v0 Rule_state_state_fset_bool_fun_fun_fun$) (?v1 Rule_stream$) (?v2 State_rule_prod_tree$) (?v3 State_rule_prod_stream$)) (=> (and (wf$ ?v0 ?v1 ?v2) (ipath$ ?v2 ?v3)) (epath$ ?v0 ?v1 ?v3))) :named a6))
(assert (! (forall ((?v0 State_rule_prod_tree$) (?v1 State_rule_prod_stream$)) (=> (tfinite$ ?v0) (not (ipath$ ?v0 ?v1)))) :named a7))
...
(assert (! (forall ((?v0 State$)) (=> (member$ ?v0 s$a) (exists ((?v1 Rule$)) (and (member$a ?v1 (sset$ rules$)) (exists ((?v2 State_fset$)) (fun_app$ (fun_app$a (fun_app$b eff$ ?v1) ?v0) ?v2)))))) :named a10))
(assert (! (forall ((?v0 State$) (?v1 Rule_stream$)) (=> (and (member$ ?v0 s$a) (fair$ rules$ ?v1)) (wf$ eff$ rules$ (mkTree$ eff$ ?v1 ?v0)))) :named a11))
(assert (! (= (sset$ (fenum$ rules$)) (sset$ rules$)) :named a12))
(assert (! (forall ((?v0 State$) (?v1 Rule_stream$) (?v2 State_rule_prod_stream$)) (=> (and (member$ ?v0 s$a) (and (fair$ rules$ ?v1) (ipath$ (mkTree$ eff$ ?v1 ?v0) ?v2))) (saturated$ eff$ rules$ ?v2))) :named a13))
(assert (! (forall ((?v0 State$) (?v1 Rule_stream$) (?v2 State_rule_prod_stream$) (?v3 Rule$)) (=> (and (member$ ?v0 s$a) (and (fair$ rules$ ?v1) (and (ipath$ (mkTree$ eff$ ?v1 ?v0) ?v2) (member$a ?v3 (sset$ rules$))))) (saturated$a eff$ ?v3 ?v2))) :named a14))
(assert (! (forall ((?v0 Rule$)) (=> (member$a ?v0 (sset$ rules$)) (per$ eff$ rules$ s$a ?v0))) :named a15))
(assert (! (forall ((?v0 Rule_state_state_fset_bool_fun_fun_fun$) (?v1 Rule$) (?v2 State$)) (! (= (enabled$ ?v0 ?v1 ?v2) (exists ((?v3 State_fset$)) (fun_app$ (fun_app$a (fun_app$b ?v0 ?v1) ?v2) ?v3))) :pattern ((enabled$ ?v0 ?v1 ?v2)))) :named a16))
(check-sat)
;(get-unsat-core)
