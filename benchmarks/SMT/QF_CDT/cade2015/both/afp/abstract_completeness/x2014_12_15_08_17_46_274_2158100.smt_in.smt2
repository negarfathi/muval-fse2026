...
(assert (! (not (exists ((?v0 State_rule_prod_stream$)) (and (= (fst$ (shd$ ?v0)) s$) (and (epath$ eff$ rules$ ?v0) (saturated$ eff$ rules$ ?v0))))) :named a0))
(assert (! (and (= (fst$ (shd$ steps$)) s$) (and (epath$ eff$ rules$ steps$) (saturated$ eff$ rules$ steps$))) :named a1))
...
(assert (! (not (exists ((?v0 State_rule_prod_tree$)) (and (= (fst$ (root$ ?v0)) s$) (and (wf$ eff$ rules$ ?v0) (tfinite$ ?v0))))) :named a4))
...
(assert (! (forall ((?v0 State_rule_prod_tree$) (?v1 State_rule_prod_stream$)) (=> (and (wf$ eff$ rules$ ?v0) (ipath$ ?v0 ?v1)) (epath$ eff$ rules$ ?v1))) :named a6))
(assert (! (ipath$ (mkTree$ eff$ (fenum$ rules$) s$) steps$) :named a7))
(assert (! (not (tfinite$ (mkTree$ eff$ (fenum$ rules$) s$))) :named a8))
(assert (! (=> (forall ((?v0 State_rule_prod_stream$)) (=> (ipath$ (mkTree$ eff$ (fenum$ rules$) s$) ?v0) false)) false) :named a9))
...
(assert (! (forall ((?v0 State$)) (=> (member$ ?v0 s$a) (exists ((?v1 Rule$)) (and (member$a ?v1 (sset$ rules$)) (exists ((?v2 State_fset$)) (fun_app$ (fun_app$a (fun_app$b eff$ ?v1) ?v0) ?v2)))))) :named a12))
(assert (! (forall ((?v0 State_rule_prod_stream$)) (= (epath$ eff$ rules$ ?v0) (exists ((?v1 State_rule_prod_stream$) (?v2 State_fset$)) (and (= ?v0 ?v1) (and (member$a (snd$ (shd$ ?v1)) (sset$ rules$)) (and (fmember$ (fst$ (shd$ (stl$ ?v1))) ?v2) (and (fun_app$ (fun_app$a (fun_app$b eff$ (snd$ (shd$ ?v1))) (fst$ (shd$ ?v1))) ?v2) (epath$ eff$ rules$ (stl$ ?v1))))))))) :named a13))
(assert (! (forall ((?v0 State_rule_prod_stream$)) (=> (and (epath$ eff$ rules$ ?v0) (forall ((?v1 State_rule_prod_stream$) (?v2 State_fset$)) (=> (and (= ?v0 ?v1) (and (member$a (snd$ (shd$ ?v1)) (sset$ rules$)) (and (fmember$ (fst$ (shd$ (stl$ ?v1))) ?v2) (and (fun_app$ (fun_app$a (fun_app$b eff$ (snd$ (shd$ ?v1))) (fst$ (shd$ ?v1))) ?v2) (epath$ eff$ rules$ (stl$ ?v1)))))) false))) false)) :named a14))
(assert (! (= (sset$ (fenum$ rules$)) (sset$ rules$)) :named a15))
(assert (! (forall ((?v0 State$) (?v1 Rule$) (?v2 State_fset$) (?v3 State$)) (=> (and (member$ ?v0 s$a) (and (member$a ?v1 (sset$ rules$)) (and (fun_app$ (fun_app$a (fun_app$b eff$ ?v1) ?v0) ?v2) (fmember$ ?v3 ?v2)))) (member$ ?v3 s$a))) :named a16))
(assert (! (forall ((?v0 State$) (?v1 Rule_stream$)) (=> (and (member$ ?v0 s$a) (fair$ rules$ ?v1)) (wf$ eff$ rules$ (mkTree$ eff$ ?v1 ?v0)))) :named a17))
(check-sat)
;(get-unsat-core)
