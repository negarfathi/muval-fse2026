...
(declare-codatatypes () ((State_rule_prod_stream$ (sCons$a (shd$a State_rule_prod$) (stl$a State_rule_prod_stream$)))
  ...
  (State_stream_stream$ (sCons$c (shd$c State_stream$) (stl$c State_stream_stream$)))
  (State_stream_stream_stream$ (sCons$d (shd$d State_stream_stream$) (stl$d State_stream_stream_stream$)))
  (Rule_stream_stream$ (sCons$e (shd$e Rule_stream$) (stl$e Rule_stream_stream$)))
  (Rule_stream_stream_stream$ (sCons$f (shd$f Rule_stream_stream$) (stl$f Rule_stream_stream_stream$)))
  (State_stream_stream_stream_stream$ (sCons$g (shd$g State_stream_stream_stream$) (stl$g State_stream_stream_stream_stream$)))
