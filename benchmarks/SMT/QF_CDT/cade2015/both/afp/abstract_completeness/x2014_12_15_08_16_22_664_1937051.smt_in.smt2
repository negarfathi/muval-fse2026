...
(assert (! (forall ((?v0 Rule$)) (=> (and (member$ ?v0 (sset$ rules$)) (exists ((?v1 State_fset$)) (fun_app$ (fun_app$a (fun_app$b eff$ ?v0) s$) ?v1))) thesis$)) :named a1))
(assert (! (member$a s$ s$a) :named a2))
(assert (! (forall ((?v0 State$)) (=> (member$a ?v0 s$a) (exists ((?v1 Rule$)) (and (member$ ?v1 (sset$ rules$)) (exists ((?v2 State_fset$)) (fun_app$ (fun_app$a (fun_app$b eff$ ?v1) ?v0) ?v2)))))) :named a3))
...
(assert (! (forall ((?v0 State$) (?v1 Rule$) (?v2 State_fset$) (?v3 State$)) (=> (and (member$a ?v0 s$a) (and (member$ ?v1 (sset$ rules$)) (and (fun_app$ (fun_app$a (fun_app$b eff$ ?v1) ?v0) ?v2) (fmember$ ?v3 ?v2)))) (member$a ?v3 s$a))) :named a9))
(assert (! (countable$ (sset$ rules$)) :named a10))
(assert (! (forall ((?v0 State_stream$)) (= (sset$a (fenum$a ?v0)) (sset$a ?v0))) :named a11))
(assert (! (forall ((?v0 Rule_stream$)) (= (sset$ (fenum$ ?v0)) (sset$ ?v0))) :named a12))
(assert (! (fair$ rules$ (fenum$ rules$)) :named a13))
(assert (! (forall ((?v0 State_rule_rule_fset_bool_fun_fun_fun$) (?v1 State_stream$) (?v2 Rule_set$) (?v3 Rule$)) (=> (and (ruleSystem$ ?v0 ?v1 ?v2) (member$ ?v3 ?v2)) (exists ((?v4 State$)) (and (member$a ?v4 (sset$a ?v1)) (exists ((?v5 Rule_fset$)) (fun_app$c (fun_app$d (fun_app$e ?v0 ?v4) ?v3) ?v5)))))) :named a14))
(assert (! (forall ((?v0 State_state_state_fset_bool_fun_fun_fun$) (?v1 State_stream$) (?v2 State_set$) (?v3 State$)) (=> (and (ruleSystem$a ?v0 ?v1 ?v2) (member$a ?v3 ?v2)) (exists ((?v4 State$)) (and (member$a ?v4 (sset$a ?v1)) (exists ((?v5 State_fset$)) (fun_app$ (fun_app$a (fun_app$f ?v0 ?v4) ?v3) ?v5)))))) :named a15))
(assert (! (forall ((?v0 Rule_rule_rule_fset_bool_fun_fun_fun$) (?v1 Rule_stream$) (?v2 Rule_set$) (?v3 Rule$)) (=> (and (ruleSystem$b ?v0 ?v1 ?v2) (member$ ?v3 ?v2)) (exists ((?v4 Rule$)) (and (member$ ?v4 (sset$ ?v1)) (exists ((?v5 Rule_fset$)) (fun_app$c (fun_app$d (fun_app$g ?v0 ?v4) ?v3) ?v5)))))) :named a16))
(assert (! (forall ((?v0 Rule_state_state_fset_bool_fun_fun_fun$) (?v1 Rule_stream$) (?v2 State_set$) (?v3 State$)) (=> (and (ruleSystem$c ?v0 ?v1 ?v2) (member$a ?v3 ?v2)) (exists ((?v4 Rule$)) (and (member$ ?v4 (sset$ ?v1)) (exists ((?v5 State_fset$)) (fun_app$ (fun_app$a (fun_app$b ?v0 ?v4) ?v3) ?v5)))))) :named a17))
...
(assert (! (forall ((?v0 State_rule_prod_tree$) (?v1 State_rule_prod_stream$)) (=> (and (wf$ eff$ rules$ ?v0) (ipath$ ?v0 ?v1)) (epath$ eff$ rules$ ?v1))) :named a20))
(assert (! (forall ((?v0 Rule_stream$) (?v1 Nat$)) (=> (fair$ rules$ ?v0) (fair$ rules$ (sdrop$ ?v1 ?v0)))) :named a21))
(assert (! (forall ((?v0 Rule_state_state_fset_bool_fun_fun_fun$) (?v1 Rule_stream$) (?v2 State_rule_prod_tree$) (?v3 State_rule_prod_stream$)) (=> (and (wf$ ?v0 ?v1 ?v2) (ipath$ ?v2 ?v3)) (epath$ ?v0 ?v1 ?v3))) :named a22))
(check-sat)
;(get-unsat-core)
