; --full-saturate-quant --inst-when=full-last-call --inst-no-entail --term-db-mode=relevant --random-seed=1 --lang=smt2 --tlimit 219
...
(declare-datatypes () ((Rule_rule_prod$ (pair$ (fst$ Rule$) (snd$ Rule$)))
  (Rule_rule_prod_rule_rule_prod_prod$ (pair$a (fst$a Rule_rule_prod$) (snd$a Rule_rule_prod$)))))
(declare-codatatypes () ((Rule_rule_prod_rule_rule_prod_prod_stream$ (sCons$b (shd$b Rule_rule_prod_rule_rule_prod_prod$) (stl$b Rule_rule_prod_rule_rule_prod_prod_stream$)))))
(declare-datatypes () ((Rule_rule_prod_rule_prod$ (pair$b (fst$b Rule_rule_prod$) (snd$b Rule$)))))
(declare-codatatypes () ((Rule_rule_prod_rule_prod_stream$ (sCons$c (shd$c Rule_rule_prod_rule_prod$) (stl$c Rule_rule_prod_rule_prod_stream$)))))
(declare-datatypes () ((Rule_rule_rule_prod_prod$ (pair$c (fst$c Rule$) (snd$c Rule_rule_prod$)))))
(declare-codatatypes () ((Rule_rule_rule_prod_prod_stream$ (sCons$d (shd$d Rule_rule_rule_prod_prod$) (stl$d Rule_rule_rule_prod_prod_stream$)))
  (Rule_rule_prod_stream$ (sCons$e (shd$e Rule_rule_prod$) (stl$e Rule_rule_prod_stream$)))))
(declare-datatypes () ((Rule_state_prod$ (pair$d (fst$d Rule$) (snd$d State$)))))
(declare-codatatypes () ((Rule_state_prod_stream$ (sCons$f (shd$f Rule_state_prod$) (stl$f Rule_state_prod_stream$)))))
(declare-datatypes () ((State_rule_prod$ (pair$e (fst$e State$) (snd$e Rule$)))))
(declare-codatatypes () ((State_rule_prod_stream$ (sCons$g (shd$g State_rule_prod$) (stl$g State_rule_prod_stream$)))))
(declare-datatypes () ((State_state_prod$ (pair$f (fst$f State$) (snd$f State$)))))
(declare-codatatypes () ((State_state_prod_stream$ (sCons$h (shd$h State_state_prod$) (stl$h State_state_prod_stream$)))))
(declare-datatypes () ((Rule_rule_prod_state_prod$ (pair$g (fst$g Rule_rule_prod$) (snd$g State$)))))
(declare-codatatypes () ((Rule_rule_prod_state_prod_stream$ (sCons$i (shd$i Rule_rule_prod_state_prod$) (stl$i Rule_rule_prod_state_prod_stream$)))))
...
(declare-datatypes () ((Rule_rule_rule_prod_rule_prod_prod$ (pair$i (fst$i Rule$) (snd$i Rule_rule_prod_rule_prod$)))))
(declare-codatatypes () ((Rule_rule_rule_prod_rule_prod_prod_stream$ (sCons$k (shd$k Rule_rule_rule_prod_rule_prod_prod$) (stl$k Rule_rule_rule_prod_rule_prod_prod_stream$)))))
(declare-fun r$ () Rule$)
(declare-fun s$ () State$)
