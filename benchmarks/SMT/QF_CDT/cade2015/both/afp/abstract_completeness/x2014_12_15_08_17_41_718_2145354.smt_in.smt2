...
(assert (! (not (not (tfinite$ (mkTree$ eff$ (fenum$ rules$) s$)))) :named a0))
(assert (! (member$ s$ s$a) :named a1))
(assert (! (fair$ rules$ (fenum$ rules$)) :named a2))
(assert (! (forall ((?v0 State$) (?v1 Rule_stream$)) (=> (and (member$ ?v0 s$a) (fair$ rules$ ?v1)) (wf$ eff$ rules$ (mkTree$ eff$ ?v1 ?v0)))) :named a3))
(assert (! (not (exists ((?v0 State_rule_prod_tree$)) (and (= (fst$ (root$ ?v0)) s$) (and (wf$ eff$ rules$ ?v0) (tfinite$ ?v0))))) :named a4))
(assert (! (forall ((?v0 Rule_stream$)) (fair$ ?v0 (fenum$ ?v0))) :named a5))
(assert (! (= (sset$ (fenum$ rules$)) (sset$ rules$)) :named a6))
...
(assert (! (forall ((?v0 State$) (?v1 Rule_stream$)) (=> (and (member$ ?v0 s$a) (fair$ rules$ ?v1)) (fair$ rules$ (trim$ eff$ ?v1 ?v0)))) :named a8))
...
(assert (! (forall ((?v0 State_rule_prod_tree$) (?v1 State_rule_prod_stream$)) (=> (and (wf$ eff$ rules$ ?v0) (ipath$ ?v0 ?v1)) (epath$ eff$ rules$ ?v1))) :named a12))
(assert (! (forall ((?v0 State_rule_prod_tree$) (?v1 State_rule_prod_stream$)) (=> (tfinite$ ?v0) (not (ipath$ ?v0 ?v1)))) :named a13))
(assert (! (forall ((?v0 Rule$)) (=> (member$a ?v0 (sset$ rules$)) (per$ eff$ rules$ s$a ?v0))) :named a14))
(assert (! (forall ((?v0 Rule_stream$)) (=> (fair$ rules$ ?v0) (fair$ rules$ (stl$ ?v0)))) :named a15))
(assert (! (forall ((?v0 State_rule_prod_stream$)) (= (saturated$ eff$ rules$ ?v0) (forall ((?v1 Rule$)) (=> (member$a ?v1 (sset$ rules$)) (saturated$a eff$ ?v1 ?v0))))) :named a16))
