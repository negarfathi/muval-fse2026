...
(declare-codatatypes () ((Rule_rule_prod_rule_rule_prod_prod_stream$ (sCons$a (shd$a Rule_rule_prod_rule_rule_prod_prod$) (stl$a Rule_rule_prod_rule_rule_prod_prod_stream$)))))
(declare-datatypes () ((Rule_rule_prod_rule_prod$ (pair$b (fst$b Rule_rule_prod$) (snd$b Rule$)))))
(declare-codatatypes () ((Rule_rule_prod_rule_prod_stream$ (sCons$b (shd$b Rule_rule_prod_rule_prod$) (stl$b Rule_rule_prod_rule_prod_stream$)))))
(declare-datatypes () ((Rule_rule_rule_prod_prod$ (pair$c (fst$c Rule$) (snd$c Rule_rule_prod$)))))
(declare-codatatypes () ((Rule_rule_rule_prod_prod_stream$ (sCons$c (shd$c Rule_rule_rule_prod_prod$) (stl$c Rule_rule_rule_prod_prod_stream$)))))
(declare-datatypes () ((State_rule_prod$ (pair$d (fst$d State$) (snd$d Rule$)))))
(declare-codatatypes () ((State_rule_prod_stream$ (sCons$d (shd$d State_rule_prod$) (stl$d State_rule_prod_stream$)))
  (State_stream$ (sCons$e (shd$e State$) (stl$e State_stream$)))
...
(declare-datatypes () ((Rule_state_rule_prod_prod$ (pair$g (fst$g Rule$) (snd$g State_rule_prod$)))))
(declare-codatatypes () ((Rule_state_rule_prod_prod_stream$ (sCons$i (shd$i Rule_state_rule_prod_prod$) (stl$i Rule_state_rule_prod_prod_stream$)))))
(declare-datatypes () ((Rule_rule_prod_state_prod$ (pair$h (fst$h Rule_rule_prod$) (snd$h State$)))))
(declare-codatatypes () ((Rule_rule_prod_state_prod_stream$ (sCons$j (shd$j Rule_rule_prod_state_prod$) (stl$j Rule_rule_prod_state_prod_stream$)))))
(declare-datatypes () ((State_rule_prod_rule_prod$ (pair$i (fst$i State_rule_prod$) (snd$i Rule$)))))
(declare-codatatypes () ((State_rule_prod_rule_prod_stream$ (sCons$k (shd$k State_rule_prod_rule_prod$) (stl$k State_rule_prod_rule_prod_stream$)))))
(declare-datatypes () ((State_rule_prod_state_prod$ (pair$j (fst$j State_rule_prod$) (snd$j State$)))))
(declare-codatatypes () ((State_rule_prod_state_prod_stream$ (sCons$l (shd$l State_rule_prod_state_prod$) (stl$l State_rule_prod_state_prod_stream$)))))
(declare-fun s$ () State$)
