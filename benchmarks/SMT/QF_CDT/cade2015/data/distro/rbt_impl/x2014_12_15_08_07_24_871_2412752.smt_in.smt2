...
(assert (! (not (= (fun_app$ (rbt_less$ less$ v$ )(paint$ c$ t$ ))(fun_app$ (rbt_less$ less$ v$ )t$ ))):named a0 ))
...
(assert (! (forall ((?v0 A$ )(?v1 Color$ )(?v2 A_b_rbt$ ))(= (rbt_greater$ less$ ?v0 (paint$ ?v1 ?v2 ))(rbt_greater$ less$ ?v0 ?v2 ))):named a7 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_b_rbt$ )(?v2 A$ )(?v3 B$ )(?v4 A_b_rbt$ ))(= (fun_app$ (rbt_less$ less$ ?v0 )(balance$ ?v1 ?v2 ?v3 ?v4 ))(and (fun_app$ (rbt_less$ less$ ?v0 )?v1 )(and (fun_app$ (rbt_less$ less$ ?v0 )?v4 )(fun_app$a (fun_app$b less$ ?v2 )?v0 ))))):named a11 ))
(assert (! (forall ((?v0 A$ ))(! (= (fun_app$ (rbt_less$ less$ ?v0 )empty$ )true ):pattern ((rbt_less$ less$ ?v0 )))):named a12 ))
(assert (! (forall ((?v0 A$ )(?v1 Color$ )(?v2 A_b_rbt$ )(?v3 A$ )(?v4 B$ )(?v5 A_b_rbt$ ))(! (= (fun_app$ (rbt_less$ less$ ?v0 )(branch$ ?v1 ?v2 ?v3 ?v4 ?v5 ))(and (fun_app$a (fun_app$b less$ ?v3 )?v0 )(and (fun_app$ (rbt_less$ less$ ?v0 )?v2 )(fun_app$ (rbt_less$ less$ ?v0 )?v5 )))):pattern ((fun_app$ (rbt_less$ less$ ?v0 )(branch$ ?v1 ?v2 ?v3 ?v4 ?v5 ))))):named a13 ))
