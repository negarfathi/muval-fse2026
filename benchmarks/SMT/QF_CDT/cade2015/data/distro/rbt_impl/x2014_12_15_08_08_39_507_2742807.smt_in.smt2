...
(declare-datatypes ()((A_list$ (nil$ )(cons$ (hd$ A$ )(tl$ A_list$ )))(Color$ (r$ )(b$ ))(A_b_rbt$ (empty$ )(branch$ (select$ Color$ )(selecta$ A_b_rbt$ )(selectb$ A$ )(selectc$ B$ )(selectd$ A_b_rbt$ )))))
...
(assert (! (not (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ (keys$ a$ )))(fun_app$ (fun_app$a less$ ?v0 )s$ )))):named a0 ))
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ (keys$ a$ )))(fun_app$ (fun_app$a less$ ?v0 )ka$ ))):named a1 ))
(assert (! (fun_app$ (fun_app$a less$ ka$ )t$ ):named a2 ))
(assert (! (fun_app$ (fun_app$a less$ ka$ )s$ ):named a3 ))
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ (keys$ a$ )))(fun_app$ (fun_app$a less$ ?v0 )t$ ))):named a4 ))
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ (keys$ b$a )))(fun_app$ (fun_app$a less$ ka$ )?v0 ))):named a5 ))
(assert (! (fun_app$ (fun_app$a less$ s$ )t$ ):named a6 ))
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ (keys$ c$ )))(fun_app$ (fun_app$a less$ ka$ )?v0 ))):named a7 ))
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ (keys$ b$a )))(fun_app$ (fun_app$a less$ ?v0 )t$ ))):named a8 ))
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ (keys$ c$ )))(fun_app$ (fun_app$a less$ ?v0 )t$ ))):named a9 ))
(assert (! (rbt_sorted$ less$ a$ ):named a10 ))
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ (keys$ b$a )))(fun_app$ (fun_app$a less$ ?v0 )s$ ))):named a11 ))
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ (keys$ c$ )))(fun_app$ (fun_app$a less$ s$ )?v0 ))):named a12 ))
