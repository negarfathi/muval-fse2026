...
(declare-datatypes ()((A_b_prod$ (pair$ (fst$ A$ )(snd$ B$ )))(A_b_prod_list$ (nil$ )(cons$ (hd$ A_b_prod$ )(tl$ A_b_prod_list$ )))(B_b_prod$ (pair$a (fst$a B$ )(snd$a B$ )))(B_b_prod_list$ (nil$a )(cons$a (hd$a B_b_prod$ )(tl$a B_b_prod_list$ )))(B_a_prod$ (pair$b (fst$b B$ )(snd$b A$ )))(B_a_prod_list$ (nil$b )(cons$b (hd$b B_a_prod$ )(tl$b B_a_prod_list$ )))(A_b_prod_a_b_prod_prod$ (pair$c (fst$c A_b_prod$ )(snd$c A_b_prod$ )))(A_a_b_prod_a_b_prod_prod_prod$ (pair$d (fst$d A$ )(snd$d A_b_prod_a_b_prod_prod$ )))(A_a_b_prod_a_b_prod_prod_prod_list$ (nil$c )(cons$c (hd$c A_a_b_prod_a_b_prod_prod_prod$ )(tl$c A_a_b_prod_a_b_prod_prod_prod_list$ )))(A_a_b_prod_prod$ (pair$e (fst$e A$ )(snd$e A_b_prod$ )))(A_a_b_prod_prod_list$ (nil$d )(cons$d (hd$d A_a_b_prod_prod$ )(tl$d A_a_b_prod_prod_list$ )))(A_a_prod$ (pair$f (fst$f A$ )(snd$f A$ )))(A_a_prod_list$ (nil$e )(cons$e (hd$e A_a_prod$ )(tl$e A_a_prod_list$ )))(A_b_prod_a_b_prod_prod_list$ (nil$f )(cons$f (hd$f A_b_prod_a_b_prod_prod$ )(tl$f A_b_prod_a_b_prod_prod_list$ )))(A_list$ (nil$g )(cons$g (hd$g A$ )(tl$g A_list$ )))(B_list$ (nil$h )(cons$h (hd$h B$ )(tl$h B_list$ )))(A_b_prod_a_prod$ (pair$g (fst$g A_b_prod$ )(snd$g A$ )))(A_b_prod_a_prod_list$ (nil$i )(cons$i (hd$i A_b_prod_a_prod$ )(tl$i A_b_prod_a_prod_list$ )))(A_b_prod_b_prod$ (pair$h (fst$h A_b_prod$ )(snd$h B$ )))(A_b_prod_b_prod_list$ (nil$j )(cons$j (hd$j A_b_prod_b_prod$ )(tl$j A_b_prod_b_prod_list$ )))(B_a_b_prod_prod$ (pair$i (fst$i B$ )(snd$i A_b_prod$ )))(B_a_b_prod_prod_list$ (nil$k )(cons$k (hd$k B_a_b_prod_prod$ )(tl$k B_a_b_prod_prod_list$ )))(A_b_prod_a_b_prod_prod_a_prod$ (pair$j (fst$j A_b_prod_a_b_prod_prod$ )(snd$j A$ )))(A_b_prod_a_b_prod_prod_a_prod_list$ (nil$l )(cons$l (hd$l A_b_prod_a_b_prod_prod_a_prod$ )(tl$l A_b_prod_a_b_prod_prod_a_prod_list$ )))))
