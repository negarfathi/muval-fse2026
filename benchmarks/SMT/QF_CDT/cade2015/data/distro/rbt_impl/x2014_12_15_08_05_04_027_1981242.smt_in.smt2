...
(declare-datatypes ()((B_option$ (none$ )(some$ (the$ B$ )))(A_b_prod$ (pair$ (fst$ A$ )(snd$ B$ )))(A_b_prod_list$ (nil$ )(cons$ (hd$ A_b_prod$ )(tl$ A_b_prod_list$ )))(Color$ (r$ )(b$ ))(A_b_rbt$ (empty$ )(branch$ (select$ Color$ )(selecta$ A_b_rbt$ )(selectb$ A$ )(selectc$ B$ )(selectd$ A_b_rbt$ )))))
(declare-fun c$ ()Color$ )
(declare-fun k$ ()A$ )
(declare-fun v$ ()B$ )
...
(assert (! (not (= (map_of$ (entries$ (branch$ c$ t1$ k$ v$ t2$ )))(rbt_lookup$ less$ (branch$ c$ t1$ k$ v$ t2$ )))):named a0 ))
