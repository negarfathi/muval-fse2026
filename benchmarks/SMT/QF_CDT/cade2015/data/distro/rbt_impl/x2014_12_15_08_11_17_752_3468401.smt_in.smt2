...
(assert (! (not (= (member$ (pair$ k$ v$ )(set$ (entries$ (rbt_del_from_left$ less$ xx$ mt$ yy$ ss$ bb$ ))))(or false (or (and (not (= xx$ k$ ))(member$ (pair$ k$ v$ )(set$ (entries$ mt$ ))))(or (and (= k$ yy$ )(= v$ ss$ ))(member$ (pair$ k$ v$ )(set$ (entries$ bb$ )))))))):named a0 ))
