...
(assert (! (not (= (inv1$ (fun_app$ (rbt_map_entry$ less$ k$ f$ )t$ ))(inv1$ t$ ))):named a0 ))
...
(assert (! (forall ((?v0 A_b_rbt$ )(?v1 A_b_b_b_fun_fun_fun$ )(?v2 A$ )(?v3 B$ ))(=> (and (inv1$ ?v0 )(inv2$ ?v0 ))(inv2$ (rbt_ins$ less$ ?v1 ?v2 ?v3 ?v0 )))):named a12 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A$ )(?v2 B_b_fun$ )(?v3 A_b_rbt$ ))(= (color_of$ (fun_app$ (rbt_map_entry$ ?v0 ?v1 ?v2 )?v3 ))(color_of$ ?v3 ))):named a13 ))
