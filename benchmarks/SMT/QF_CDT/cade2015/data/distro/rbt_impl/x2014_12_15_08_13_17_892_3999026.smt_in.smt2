...
(declare-datatypes ()((B_option$ (none$ )(some$ (the$ B$ )))(Color$ (r$ )(b$ ))(A_b_rbt$ (empty$ )(branch$ (select$ Color$ )(selecta$ A_b_rbt$ )(selectb$ A$ )(selectc$ B$ )(selectd$ A_b_rbt$ )))(A_b_prod$ (pair$ (fst$ A$ )(snd$ B$ )))(A_b_prod_list$ (nil$ )(cons$ (hd$ A_b_prod$ )(tl$ A_b_prod_list$ )))))
...
(assert (! (not (= (rbt_lookup$ less$ (fold$ (case_prod$ (rbt_insert$ less$ ))(rev$ xs$ )empty$ ))(map_add$ (rbt_lookup$ less$ empty$ )(map_of$ xs$ )))):named a0 ))
(assert (! (is_rbt$ less$ empty$ ):named a1 ))
