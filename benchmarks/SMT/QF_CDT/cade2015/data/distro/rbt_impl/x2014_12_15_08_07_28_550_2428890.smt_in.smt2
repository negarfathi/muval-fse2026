...
(assert (! (not (inv2$ (rbt_ins$ less$ f$ k$ x$ t$ ))):named a0 ))
...
(assert (! (inv2$ t$ ):named a4 ))
(assert (! (forall ((?v0 A_list$ ))(lexordp_eq$ less$ ?v0 ?v0 )):named a5 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ )(?v2 A$ ))(= (member$ ?v0 (greaterThanLessThan$ less$ ?v1 ?v2 ))(and (fun_app$ (fun_app$a less$ ?v1 )?v0 )(fun_app$ (fun_app$a less$ ?v0 )?v2 )))):named a6 ))
(assert (! (forall ((?v0 A_list$ ))(=> (forall ((?v1 A$ ))(not (fun_app$ (fun_app$a less$ ?v1 )?v1 )))(not (lexordp$ less$ ?v0 ?v0 )))):named a7 ))
...
(assert (! (forall ((?v0 A_b_rbt$ )(?v1 Color$ ))(=> (inv2$ ?v0 )(inv2$ (paint$ ?v1 ?v0 )))):named a11 ))
(assert (! (forall ((?v0 A_b_b_b_fun_fun_fun$ )(?v1 A$ )(?v2 B$ )(?v3 A_b_rbt$ )(?v4 A$ )(?v5 B$ )(?v6 A_b_rbt$ ))(! (= (rbt_ins$ less$ ?v0 ?v1 ?v2 (branch$ r$ ?v3 ?v4 ?v5 ?v6 ))(ite (fun_app$ (fun_app$a less$ ?v1 )?v4 )(branch$ r$ (rbt_ins$ less$ ?v0 ?v1 ?v2 ?v3 )?v4 ?v5 ?v6 )(ite (fun_app$ (fun_app$a less$ ?v4 )?v1 )(branch$ r$ ?v3 ?v4 ?v5 (rbt_ins$ less$ ?v0 ?v1 ?v2 ?v6 ))(branch$ r$ ?v3 ?v4 (fun_app$b (fun_app$c (fun_app$d ?v0 ?v1 )?v5 )?v2 )?v6 )))):pattern ((rbt_ins$ less$ ?v0 ?v1 ?v2 (branch$ r$ ?v3 ?v4 ?v5 ?v6 ))))):named a12 ))
(assert (! (forall ((?v0 A_b_rbt$ )(?v1 Color$ ))(=> (rbt_sorted$ less$ ?v0 )(rbt_sorted$ less$ (paint$ ?v1 ?v0 )))):named a13 ))
(assert (! (is_rbt$ less$ empty$ ):named a14 ))
(assert (! (forall ((?v0 A_b_rbt$ ))(! (= (is_rbt$ less$ ?v0 )(and (inv1$ ?v0 )(and (inv2$ ?v0 )(and (= (color_of$ ?v0 )b$ )(rbt_sorted$ less$ ?v0 ))))):pattern ((is_rbt$ less$ ?v0 )))):named a15 ))
