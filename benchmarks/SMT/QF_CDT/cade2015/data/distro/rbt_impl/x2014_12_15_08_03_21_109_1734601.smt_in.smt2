...
(declare-datatypes ()((A_list$ (nil$ )(cons$ (hd$ A$ )(tl$ A_list$ )))(Color$ (r$ )(b$ ))(A_b_rbt$ (empty$ )(branch$ (select$ Color$ )(selecta$ A_b_rbt$ )(selectb$ A$ )(selectc$ B$ )(selectd$ A_b_rbt$ )))(A_b_prod$ (pair$ (fst$ A$ )(snd$ B$ )))(A_b_prod_list$ (nil$a )(cons$a (hd$a A_b_prod$ )(tl$a A_b_prod_list$ )))(A_b_prod_a_b_prod_rbt$ (empty$a )(branch$a (selecte$ Color$ )(selectf$ A_b_prod_a_b_prod_rbt$ )(selectg$ A_b_prod$ )(selecth$ A_b_prod$ )(selecti$ A_b_prod_a_b_prod_rbt$ )))(A_b_prod_a_b_prod_prod$ (pair$a (fst$a A_b_prod$ )(snd$a A_b_prod$ )))(A_b_prod_a_b_prod_prod_list$ (nil$b )(cons$b (hd$b A_b_prod_a_b_prod_prod$ )(tl$b A_b_prod_a_b_prod_prod_list$ )))(A_b_prod_a_rbt$ (empty$b )(branch$b (selectj$ Color$ )(selectk$ A_b_prod_a_rbt$ )(selectl$ A_b_prod$ )(selectm$ A$ )(selectn$ A_b_prod_a_rbt$ )))(A_b_prod_a_prod$ (pair$b (fst$b A_b_prod$ )(snd$b A$ )))(A_b_prod_a_prod_list$ (nil$c )(cons$c (hd$c A_b_prod_a_prod$ )(tl$c A_b_prod_a_prod_list$ )))(A_b_prod_list_a_b_prod_list_rbt$ (empty$c )(branch$c (selecto$ Color$ )(selectp$ A_b_prod_list_a_b_prod_list_rbt$ )(selectq$ A_b_prod_list$ )(selectr$ A_b_prod_list$ )(selects$ A_b_prod_list_a_b_prod_list_rbt$ )))(A_b_prod_list_a_b_prod_list_prod$ (pair$c (fst$c A_b_prod_list$ )(snd$c A_b_prod_list$ )))(A_b_prod_list_a_b_prod_list_prod_list$ (nil$d )(cons$d (hd$d A_b_prod_list_a_b_prod_list_prod$ )(tl$d A_b_prod_list_a_b_prod_list_prod_list$ )))(A_b_prod_list_list$ (nil$e )(cons$e (hd$e A_b_prod_list$ )(tl$e A_b_prod_list_list$ )))(A_list_a_list_rbt$ (empty$d )(branch$d (selectt$ Color$ )(selectu$ A_list_a_list_rbt$ )(selectv$ A_list$ )(selectw$ A_list$ )(selectx$ A_list_a_list_rbt$ )))(A_list_a_list_prod$ (pair$d (fst$d A_list$ )(snd$d A_list$ )))(A_list_a_list_prod_list$ (nil$f )(cons$f (hd$f A_list_a_list_prod$ )(tl$f A_list_a_list_prod_list$ )))(A_list_list$ (nil$g )(cons$g (hd$g A_list$ )(tl$g A_list_list$ )))(B_a_rbt$ (empty$e )(branch$e (selecty$ Color$ )(selectz$ B_a_rbt$ )(selecua$ B$ )(selecub$ A$ )(selecuc$ B_a_rbt$ )))(B_a_prod$ (pair$e (fst$e B$ )(snd$e A$ )))(B_a_prod_list$ (nil$h )(cons$h (hd$h B_a_prod$ )(tl$h B_a_prod_list$ )))(B_list$ (nil$i )(cons$i (hd$i B$ )(tl$i B_list$ )))(A_a_b_prod_rbt$ (empty$f )(branch$f (selecud$ Color$ )(selecue$ A_a_b_prod_rbt$ )(selecuf$ A$ )(selecug$ A_b_prod$ )(selecuh$ A_a_b_prod_rbt$ )))(A_a_b_prod_prod$ (pair$f (fst$f A$ )(snd$f A_b_prod$ )))(A_a_b_prod_prod_list$ (nil$j )(cons$j (hd$j A_a_b_prod_prod$ )(tl$j A_a_b_prod_prod_list$ )))(A_a_rbt$ (empty$g )(branch$g (selecui$ Color$ )(selecuj$ A_a_rbt$ )(selecuk$ A$ )(selecul$ A$ )(selecum$ A_a_rbt$ )))(A_a_prod$ (pair$g (fst$g A$ )(snd$g A$ )))(A_a_prod_list$ (nil$k )(cons$k (hd$k A_a_prod$ )(tl$k A_a_prod_list$ )))(B_b_prod$ (pair$h (fst$h B$ )(snd$h B$ )))(B_b_prod_list$ (nil$l )(cons$l (hd$l B_b_prod$ )(tl$l B_b_prod_list$ )))(B_a_prod_a_prod$ (pair$i (fst$i B_a_prod$ )(snd$i A$ )))(B_a_prod_a_prod_list$ (nil$m )(cons$m (hd$m B_a_prod_a_prod$ )(tl$m B_a_prod_a_prod_list$ )))(B_a_prod_b_prod$ (pair$j (fst$j B_a_prod$ )(snd$j B$ )))(B_a_prod_b_prod_list$ (nil$n )(cons$n (hd$n B_a_prod_b_prod$ )(tl$n B_a_prod_b_prod_list$ )))(A_b_a_prod_prod$ (pair$k (fst$k A$ )(snd$k B_a_prod$ )))(A_b_a_prod_prod_list$ (nil$o )(cons$o (hd$o A_b_a_prod_prod$ )(tl$o A_b_a_prod_prod_list$ )))(A_a_prod_a_a_prod_prod$ (pair$l (fst$l A_a_prod$ )(snd$l A_a_prod$ )))(A_a_prod_a_a_prod_prod_list$ (nil$p )(cons$p (hd$p A_a_prod_a_a_prod_prod$ )(tl$p A_a_prod_a_a_prod_prod_list$ )))))
(declare-fun k$ ()A$ )
