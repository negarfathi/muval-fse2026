...
(declare-datatypes ()((Color$ (r$ )(b$ ))(A_b_rbt$ (empty$ )(branch$ (select$ Color$ )(selecta$ A_b_rbt$ )(selectb$ A$ )(selectc$ B$ )(selectd$ A_b_rbt$ )))(Nat_nat_rbt$ (empty$a )(branch$a (selecte$ Color$ )(selectf$ Nat_nat_rbt$ )(selectg$ Nat$ )(selecth$ Nat$ )(selecti$ Nat_nat_rbt$ )))(Nibble$ (nibble0$ )(nibble1$ )(nibble2$ )(nibble3$ )(nibble4$ )(nibble5$ )(nibble6$ )(nibble7$ )(nibble8$ )(nibble9$ )(nibbleA$ )(nibbleB$ )(nibbleC$ )(nibbleD$ )(nibbleE$ )(nibbleF$ ))(Typerep_list$ (nil$ )(cons$ (hd$ Typerep$ )(tl$ Typerep_list$ )))(Char$ (char$ (selectl$ Nibble$ )(selectm$ Nibble$ )))(Char_list$ (nil$a )(cons$a (hd$a Char$ )(tl$a Char_list$ )))(Literal$ (str$ (explode$ Char_list$ )))(Typerep$ (typerep$ (selectj$ Literal$ )(selectk$ Typerep_list$ )))(Nibble_option$ (none$ )(some$ (the$ Nibble$ )))(Unit_option$ (none$a )(some$a (the$a Unit$ )))))
