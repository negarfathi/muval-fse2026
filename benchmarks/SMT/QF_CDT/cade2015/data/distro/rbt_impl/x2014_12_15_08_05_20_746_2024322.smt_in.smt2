...
(declare-datatypes ()((A_b_prod$ (pair$ (fst$ A$ )(snd$ B$ )))(A_b_prod_list$ (nil$ )(cons$ (hd$ A_b_prod$ )(tl$ A_b_prod_list$ )))(Color$ (r$ )(b$ ))(A_b_rbt$ (empty$ )(branch$ (select$ Color$ )(selecta$ A_b_rbt$ )(selectb$ A$ )(selectc$ B$ )(selectd$ A_b_rbt$ )))(B_option$ (none$ )(some$ (the$ B$ )))))
...
(assert (! (not (= (= (entries$ t1$ )(entries$ t2$ ))(= (rbt_lookup$ less$ t1$ )(rbt_lookup$ less$ t2$ )))):named a0 ))
