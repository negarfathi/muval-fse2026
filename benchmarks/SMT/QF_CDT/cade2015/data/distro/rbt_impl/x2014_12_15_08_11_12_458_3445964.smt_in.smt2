...
(assert (! (not (= (member$ (pair$ k$ v$ )(set$ (entries$ (rbt_del$ less$ xx$ (branch$ ca$ aa$ yy$ ss$ bb$ )))))(or false (and (not (= xx$ k$ ))(member$ (pair$ k$ v$ )(set$ (entries$ (branch$ ca$ aa$ yy$ ss$ bb$ )))))))):named a0 ))
