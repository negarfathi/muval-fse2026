...
(declare-datatypes ()((T_N_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ N$ )))(T_dtree_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a Dtree$ )))(T_T_dtree_sum_sum$ (inl$b (projl$b T$ ))(inr$b (projr$b T_dtree_sum$ )))(T_T_N_sum_sum$ (inl$c (projl$c T$ ))(inr$c (projr$c T_N_sum$ )))))
