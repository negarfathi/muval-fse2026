...
(declare-datatypes ()((T_dtree_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree$ )))(T_a_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a A$ )))(T_T_dtree_sum_sum$ (inl$b (projl$b T$ ))(inr$b (projr$b T_dtree_sum$ )))(T_T_a_sum_sum$ (inl$c (projl$c T$ ))(inr$c (projr$c T_a_sum$ )))))
(declare-fun n$ ()N$ )
