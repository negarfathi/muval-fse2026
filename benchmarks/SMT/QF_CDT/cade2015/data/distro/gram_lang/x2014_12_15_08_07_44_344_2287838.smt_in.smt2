...
(declare-datatypes ()((T_dtree_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree$ )))(T_N_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a N$ )))(T_T_sum$ (inl$b (projl$b T$ ))(inr$b (projr$b T$ )))(T_T_set_sum$ (inl$c (projl$c T$ ))(inr$c (projr$c T_set$ )))(T_set_T_sum$ (inl$d (projl$d T_set$ ))(inr$d (projr$d T$ )))(T_set_T_set_sum$ (inl$e (projl$e T_set$ ))(inr$e (projr$e T_set$ )))))
