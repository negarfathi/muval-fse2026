...
(declare-datatypes ()((N_T_N_sum_set_prod$ (pair$ (fst$ N$ )(snd$ T_N_sum_set$ )))(T_N_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ N$ )))(T_dtree_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a Dtree$ )))(T_T_sum$ (inl$b (projl$b T$ ))(inr$b (projr$b T$ )))(T_T_set_sum$ (inl$c (projl$c T$ ))(inr$c (projr$c T_set$ )))(T_set_T_sum$ (inl$d (projl$d T_set$ ))(inr$d (projr$d T$ )))(T_T_T_sum_sum$ (inl$e (projl$e T$ ))(inr$e (projr$e T_T_sum$ )))(T_set_T_set_sum$ (inl$f (projl$f T_set$ ))(inr$f (projr$f T_set$ )))(T_T_sum_T_sum$ (inl$g (projl$g T_T_sum$ ))(inr$g (projr$g T$ )))(T_set_T_T_sum_sum$ (inl$h (projl$h T_set$ ))(inr$h (projr$h T_T_sum$ )))(T_T_sum_T_set_sum$ (inl$i (projl$i T_T_sum$ ))(inr$i (projr$i T_set$ )))))
