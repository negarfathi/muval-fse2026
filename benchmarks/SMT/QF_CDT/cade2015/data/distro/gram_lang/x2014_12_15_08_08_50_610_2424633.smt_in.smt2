...
(declare-datatypes ()((T_dtree_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree$ )))(T_T_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a T$ )))(T_N_sum$ (inl$b (projl$b T$ ))(inr$b (projr$b N$ )))(T_T_N_sum_sum$ (inl$c (projl$c T$ ))(inr$c (projr$c T_N_sum$ )))(T_T_dtree_sum_sum$ (inl$d (projl$d T$ ))(inr$d (projr$d T_dtree_sum$ )))))
