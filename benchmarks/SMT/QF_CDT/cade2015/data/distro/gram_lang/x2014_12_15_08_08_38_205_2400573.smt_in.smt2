...
(declare-datatypes ()((T_dtree_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree$ )))(T_N_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a N$ )))(Dtree_dtree_sum$ (inl$b (projl$b Dtree$ ))(inr$b (projr$b Dtree$ )))(N_N_sum$ (inl$c (projl$c N$ ))(inr$c (projr$c N$ )))(Dtree_N_sum$ (inl$d (projl$d Dtree$ ))(inr$d (projr$d N$ )))(N_dtree_sum$ (inl$e (projl$e N$ ))(inr$e (projr$e Dtree$ )))(T_T_sum$ (inl$f (projl$f T$ ))(inr$f (projr$f T$ )))(N_T_sum$ (inl$g (projl$g N$ ))(inr$g (projr$g T$ )))(Dtree_T_sum$ (inl$h (projl$h Dtree$ ))(inr$h (projr$h T$ )))))
