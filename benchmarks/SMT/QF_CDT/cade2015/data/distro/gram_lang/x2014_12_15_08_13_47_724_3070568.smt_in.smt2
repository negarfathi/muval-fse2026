...
(declare-datatypes ()((T_N_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ N$ )))(T_dtree_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a Dtree$ )))(T_T_sum$ (inl$b (projl$b T$ ))(inr$b (projr$b T$ )))(Dtree_dtree_sum$ (inl$c (projl$c Dtree$ ))(inr$c (projr$c Dtree$ )))(N_N_sum$ (inl$d (projl$d N$ ))(inr$d (projr$d N$ )))(Dtree_N_sum$ (inl$e (projl$e Dtree$ ))(inr$e (projr$e N$ )))(N_dtree_sum$ (inl$f (projl$f N$ ))(inr$f (projr$f Dtree$ )))))
