...
(declare-datatypes ()((N_T_N_sum_set_prod$ (pair$ (fst$ N$ )(snd$ T_N_sum_set$ )))(T_N_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ N$ )))(T_dtree_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a Dtree$ )))(T_T_sum$ (inl$b (projl$b T$ ))(inr$b (projr$b T$ )))(T_T_N_sum_sum$ (inl$c (projl$c T$ ))(inr$c (projr$c T_N_sum$ )))(T_T_dtree_sum_sum$ (inl$d (projl$d T$ ))(inr$d (projr$d T_dtree_sum$ )))))
