...
(declare-datatypes ()((T_dtree_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree$ )))(T_dtree_sum_T_dtree_sum_sum$ (inl$a (projl$a T_dtree_sum$ ))(inr$a (projr$a T_dtree_sum$ )))(T_dtree_sum_N_sum$ (inl$b (projl$b T_dtree_sum$ ))(inr$b (projr$b N$ )))(N_T_dtree_sum_sum$ (inl$c (projl$c N$ ))(inr$c (projr$c T_dtree_sum$ )))(N_N_sum$ (inl$d (projl$d N$ ))(inr$d (projr$d N$ )))))
(declare-fun t$ ()T$ )
