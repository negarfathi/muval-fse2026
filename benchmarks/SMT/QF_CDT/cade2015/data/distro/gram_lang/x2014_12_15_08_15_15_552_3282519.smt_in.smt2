...
(declare-fun fun_app$ (T_T_N_sum_fun$ T$ )T_N_sum$ )
...
(declare-fun fun_app$c (N_T_N_sum_set_prod_set_bool_fun$ N_T_N_sum_set_prod_set$ )Bool )
(declare-fun fun_app$d (T_N_sum_set_bool_fun$ T_N_sum_set$ )Bool )
(declare-fun fun_app$e (T_set_set_bool_fun$ T_set_set$ )Bool )
(declare-fun fun_app$f (N_set_set_bool_fun$ N_set_set$ )Bool )
...
(assert (! (forall ((?v0 N_T_N_sum_set_prod$ )(?v1 N_T_N_sum_set_prod$ ))(! (= (fun_app$a (uui$ ?v0 )?v1 )(= ?v0 ?v1 )):pattern ((fun_app$a (uui$ ?v0 )?v1 )))):named a1 ))
(assert (! (forall ((?v0 T_N_sum$ )(?v1 T_N_sum$ ))(! (= (fun_app$b (uuh$ ?v0 )?v1 )(= ?v0 ?v1 )):pattern ((fun_app$b (uuh$ ?v0 )?v1 )))):named a2 ))
(assert (! (forall ((?v0 N_T_N_sum_set_prod_set$ )(?v1 N_T_N_sum_set_prod_set$ ))(! (= (fun_app$c (uub$ ?v0 )?v1 )(= ?v0 ?v1 )):pattern ((fun_app$c (uub$ ?v0 )?v1 )))):named a3 ))
(assert (! (forall ((?v0 T_N_sum_set$ )(?v1 T_N_sum_set$ ))(! (= (fun_app$d (uuc$ ?v0 )?v1 )(= ?v0 ?v1 )):pattern ((fun_app$d (uuc$ ?v0 )?v1 )))):named a4 ))
(assert (! (forall ((?v0 T_set_set$ )(?v1 T_set_set$ ))(! (= (fun_app$e (uue$ ?v0 )?v1 )(= ?v0 ?v1 )):pattern ((fun_app$e (uue$ ?v0 )?v1 )))):named a5 ))
(assert (! (forall ((?v0 N_set_set$ )(?v1 N_set_set$ ))(! (= (fun_app$f (uud$ ?v0 )?v1 )(= ?v0 ?v1 )):pattern ((fun_app$f (uud$ ?v0 )?v1 )))):named a6 ))
(assert (! (forall ((?v0 T_set$ )(?v1 T_set$ ))(! (= (fun_app$g (uuj$ ?v0 )?v1 )(= ?v0 ?v1 )):pattern ((fun_app$g (uuj$ ?v0 )?v1 )))):named a7 ))
(assert (! (forall ((?v0 N_set$ )(?v1 N_set$ ))(! (= (fun_app$h (uug$ ?v0 )?v1 )(= ?v0 ?v1 )):pattern ((fun_app$h (uug$ ?v0 )?v1 )))):named a8 ))
(assert (! (forall ((?v0 T$ )(?v1 T$ ))(! (= (fun_app$i (uuf$ ?v0 )?v1 )(= ?v0 ?v1 )):pattern ((fun_app$i (uuf$ ?v0 )?v1 )))):named a9 ))
(assert (! (forall ((?v0 N$ )(?v1 N$ ))(! (= (fun_app$j (uuk$ ?v0 )?v1 )(= ?v0 ?v1 )):pattern ((fun_app$j (uuk$ ?v0 )?v1 )))):named a10 ))
(assert (! (forall ((?v0 N_T_N_sum_set_prod$ )(?v1 N_T_N_sum_set_prod$ ))(! (= (fun_app$a (uus$ ?v0 )?v1 )(= ?v1 ?v0 )):pattern ((fun_app$a (uus$ ?v0 )?v1 )))):named a11 ))
(assert (! (forall ((?v0 T_N_sum$ )(?v1 T_N_sum$ ))(! (= (fun_app$b (uur$ ?v0 )?v1 )(= ?v1 ?v0 )):pattern ((fun_app$b (uur$ ?v0 )?v1 )))):named a12 ))
(assert (! (forall ((?v0 N_T_N_sum_set_prod_set$ )(?v1 N_T_N_sum_set_prod_set$ ))(! (= (fun_app$c (uul$ ?v0 )?v1 )(= ?v1 ?v0 )):pattern ((fun_app$c (uul$ ?v0 )?v1 )))):named a13 ))
(assert (! (forall ((?v0 T_N_sum_set$ )(?v1 T_N_sum_set$ ))(! (= (fun_app$d (uum$ ?v0 )?v1 )(= ?v1 ?v0 )):pattern ((fun_app$d (uum$ ?v0 )?v1 )))):named a14 ))
(assert (! (forall ((?v0 T_set_set$ )(?v1 T_set_set$ ))(! (= (fun_app$e (uuo$ ?v0 )?v1 )(= ?v1 ?v0 )):pattern ((fun_app$e (uuo$ ?v0 )?v1 )))):named a15 ))
(assert (! (forall ((?v0 N_set_set$ )(?v1 N_set_set$ ))(! (= (fun_app$f (uun$ ?v0 )?v1 )(= ?v1 ?v0 )):pattern ((fun_app$f (uun$ ?v0 )?v1 )))):named a16 ))
(assert (! (forall ((?v0 T_set$ )(?v1 T_set$ ))(! (= (fun_app$g (uut$ ?v0 )?v1 )(= ?v1 ?v0 )):pattern ((fun_app$g (uut$ ?v0 )?v1 )))):named a17 ))
(assert (! (forall ((?v0 N_set$ )(?v1 N_set$ ))(! (= (fun_app$h (uuq$ ?v0 )?v1 )(= ?v1 ?v0 )):pattern ((fun_app$h (uuq$ ?v0 )?v1 )))):named a18 ))
(assert (! (forall ((?v0 T$ )(?v1 T$ ))(! (= (fun_app$i (uup$ ?v0 )?v1 )(= ?v1 ?v0 )):pattern ((fun_app$i (uup$ ?v0 )?v1 )))):named a19 ))
(assert (! (forall ((?v0 N$ )(?v1 N$ ))(! (= (fun_app$j (uuu$ ?v0 )?v1 )(= ?v1 ?v0 )):pattern ((fun_app$j (uuu$ ?v0 )?v1 )))):named a20 ))
(assert (! (forall ((?v0 T_N_sum_set$ )(?v1 N_T_set_fun$ )(?v2 T_set$ ))(! (= (fun_app$g (uua$ ?v0 ?v1 )?v2 )(exists ((?v3 N$ ))(and (= ?v2 (fun_app$k ?v1 ?v3 ))(member$ (inr$ ?v3 )?v0 )))):pattern ((fun_app$g (uua$ ?v0 ?v1 )?v2 )))):named a21 ))
(assert (! (not (exists ((?v0 T_N_sum_set$ )(?v1 N_T_set_fun$ ))(and (= ts$ (fun_app$l (sup$ (vimage$ uu$ ?v0 ))(sup$a (collect$ (uua$ ?v0 ?v1 )))))(and (member$a (pair$ n$ ?v0 )p$ )(forall ((?v2 N$ ))(=> (member$ (inr$ ?v2 )?v0 )(member$b (fun_app$k ?v1 ?v2 )(lr$ (minus$ ns$ (insert$ n$ bot$ ))?v2 )))))))):named a22 ))
...
(assert (! (forall ((?v0 T_set$ )(?v1 T_set_set$ ))(= (sup$a (insert$h ?v0 ?v1 ))(fun_app$l (sup$ ?v0 )(sup$a ?v1 )))):named a34 ))
...
(assert (! (forall ((?v0 T$ )(?v1 T_set$ ))(= (fun_app$l (insert$i ?v0 )(fun_app$l (minus$f ?v1 )(fun_app$l (insert$i ?v0 )bot$g )))(fun_app$l (insert$i ?v0 )?v1 ))):named a46 ))
...
(assert (! (forall ((?v0 T$ ))(= (collect$e (uuf$ ?v0 ))(fun_app$l (insert$i ?v0 )bot$g ))):named a65 ))
...
(assert (! (forall ((?v0 T$ ))(= (collect$e (uup$ ?v0 ))(fun_app$l (insert$i ?v0 )bot$g ))):named a75 ))
...
(assert (! (forall ((?v0 T_T_fun$ )(?v1 T_set$ )(?v2 T_set$ ))(= (fun_app$l (vimage$a ?v0 )(fun_app$l (sup$ ?v1 )?v2 ))(fun_app$l (sup$ (fun_app$l (vimage$a ?v0 )?v1 ))(fun_app$l (vimage$a ?v0 )?v2 )))):named a83 ))
(assert (! (forall ((?v0 T_T_N_sum_fun$ )(?v1 T_N_sum_set$ )(?v2 T_N_sum_set$ ))(= (vimage$ ?v0 (sup$k ?v1 ?v2 ))(fun_app$l (sup$ (vimage$ ?v0 ?v1 ))(vimage$ ?v0 ?v2 )))):named a84 ))
(assert (! (forall ((?v0 N_N_fun$ )(?v1 N_set$ )(?v2 N_set$ ))(= (vimage$b ?v0 (sup$o ?v1 ?v2 ))(sup$o (vimage$b ?v0 ?v1 )(vimage$b ?v0 ?v2 )))):named a85 ))
(assert (! (forall ((?v0 T_set_T_fun$ )(?v1 T_set$ )(?v2 T_set$ ))(= (vimage$c ?v0 (fun_app$l (sup$ ?v1 )?v2 ))(sup$m (vimage$c ?v0 ?v1 )(vimage$c ?v0 ?v2 )))):named a86 ))
(assert (! (forall ((?v0 T_T_set_fun$ )(?v1 T_set_set$ )(?v2 T_set_set$ ))(= (vimage$d ?v0 (sup$m ?v1 ?v2 ))(fun_app$l (sup$ (vimage$d ?v0 ?v1 ))(vimage$d ?v0 ?v2 )))):named a87 ))
(assert (! (forall ((?v0 T_N_sum_T_fun$ )(?v1 T_set$ )(?v2 T_set$ ))(= (vimage$e ?v0 (fun_app$l (sup$ ?v1 )?v2 ))(sup$k (vimage$e ?v0 ?v1 )(vimage$e ?v0 ?v2 )))):named a88 ))
...
(assert (! (forall ((?v0 T_set_set$ )(?v1 T_set_set$ ))(= (sup$a (sup$m ?v0 ?v1 ))(fun_app$l (sup$ (sup$a ?v0 ))(sup$a ?v1 )))):named a100 ))
...
(assert (! (forall ((?v0 T_T_fun$ ))(= (fun_app$l (vimage$a ?v0 )bot$g )bot$g )):named a105 ))
