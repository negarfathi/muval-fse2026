...
(assert (! (not (exists ((?v0 T_N_sum_set$ )(?v1 N_T_set_fun$ ))(and (= (sup$ (vimage$ uu$ tns$ )(sup$a (collect$ uua$ )))(sup$ (vimage$ uu$ ?v0 )(sup$a (collect$ (uub$ ?v0 ?v1 )))))(and (member$a (pair$ na$ ?v0 )p$ )(forall ((?v2 N$ ))(=> (member$ (inr$ ?v2 )?v0 )(member$b (fun_app$k ?v1 ?v2 )(ll$ (minus$ nsa$ (insert$ na$ bot$ ))?v2 )))))))):named a23 ))
(assert (! (member$c na$ nsa$ ):named a24 ))
(assert (! (member$a (pair$ na$ tns$ )p$ ):named a25 ))
(assert (! (forall ((?v0 N$ ))(=> (member$ (inr$ ?v0 )tns$ )(member$b (k$ ?v0 )(lr$ (minus$ nsa$ (insert$ na$ bot$ ))?v0 )))):named a26 ))
