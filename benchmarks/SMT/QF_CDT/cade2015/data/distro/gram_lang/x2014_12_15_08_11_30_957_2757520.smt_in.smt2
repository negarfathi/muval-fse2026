...
(declare-datatypes ()((N_list$ (nil$ )(cons$ (hd$ N$ )(tl$ N_list$ )))(T_dtree_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree$ )))(N_list_list$ (nil$a )(cons$a (hd$a N_list$ )(tl$a N_list_list$ )))(N_list_list_list$ (nil$b )(cons$b (hd$b N_list_list$ )(tl$b N_list_list_list$ )))(N_list_list_list_list$ (nil$c )(cons$c (hd$c N_list_list_list$ )(tl$c N_list_list_list_list$ )))))
