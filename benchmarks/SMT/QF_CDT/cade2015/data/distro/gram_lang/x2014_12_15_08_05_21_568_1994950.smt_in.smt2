...
(assert (! (not (member$ (inr$ tr2$ )(cont$ tr3$ ))):named a0 ))
(assert (! (member$ (inr$ tr2$ )(cont$ tr3$ )):named a1 ))
(assert (! (fun_app$ (fun_app$a (subtr2$ ns$ )tr1$ )tr2$ ):named a2 ))
(assert (! (member$a (root$ tr3$ )ns$ ):named a3 ))
...
(assert (! (forall ((?v0 N_set$ )(?v1 Dtree$ )(?v2 N$ ))(=> (inItr$ ?v0 ?v1 ?v2 )(member$a (root$ ?v1 )?v0 ))):named a12 ))
(assert (! (forall ((?v0 N_set$ )(?v1 Dtree$ )(?v2 Dtree$ )(?v3 Dtree$ ))(=> (and (fun_app$ (fun_app$a (subtr2$ ?v0 )?v1 )?v2 )(fun_app$ (fun_app$a (subtr2$ ?v0 )?v2 )?v3 ))(fun_app$ (fun_app$a (subtr2$ ?v0 )?v1 )?v3 ))):named a13 ))
(assert (! (forall ((?v0 N_set$ )(?v1 Dtree$ )(?v2 Dtree$ ))(=> (fun_app$ (fun_app$a (subtr2$ ?v0 )?v1 )?v2 )(member$a (root$ ?v2 )?v0 ))):named a14 ))
(assert (! (forall ((?v0 N_set$ )(?v1 Dtree$ )(?v2 Dtree$ ))(=> (fun_app$ (fun_app$a (subtr2$ ?v0 )?v1 )?v2 )(member$a (root$ ?v1 )?v0 ))):named a15 ))
(check-sat )
;(get-unsat-core )
