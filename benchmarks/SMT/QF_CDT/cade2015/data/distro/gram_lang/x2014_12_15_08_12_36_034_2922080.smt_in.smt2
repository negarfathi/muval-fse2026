...
(declare-datatypes ()((N_list$ (nil$ )(cons$ (hd$ N$ )(tl$ N_list$ )))(N_list_list$ (nil$a )(cons$a (hd$a N_list$ )(tl$a N_list_list$ )))(N_list_list_list$ (nil$b )(cons$b (hd$b N_list_list$ )(tl$b N_list_list_list$ )))(N_list_list_list_list$ (nil$c )(cons$c (hd$c N_list_list_list$ )(tl$c N_list_list_list_list$ )))))
...
(assert (! (not (and (fun_app$ (path$ f$ )(cons$ (root$ tra$ )nil$ ))(= (fun_app$a f$ (root$ tra$ ))tra$ ))):named a0 ))
...
(assert (! (forall ((?v0 N_dtree_fun$ )(?v1 Dtree$ ))(=> (reg$ ?v0 ?v1 )(= (fun_app$a ?v0 (root$ ?v1 ))?v1 ))):named a6 ))
(assert (! (forall ((?v0 N_dtree_fun$ )(?v1 N$ )(?v2 N_list$ ))(=> (and (fun_app$ (path$ ?v0 )(cons$ ?v1 ?v2 ))(not (= ?v2 nil$ )))(fun_app$ (path$ ?v0 )?v2 ))):named a7 ))
(assert (! (forall ((?v0 N_dtree_fun$ )(?v1 N_list$ ))(=> (fun_app$ (path$ ?v0 )?v1 )(not (= ?v1 nil$ )))):named a8 ))
(assert (! (forall ((?v0 N_dtree_fun$ )(?v1 N$ ))(fun_app$ (path$ ?v0 )(cons$ ?v1 nil$ ))):named a9 ))
...
(assert (! (forall ((?v0 Dtree$ ))(= (regular$ ?v0 )(exists ((?v1 N_dtree_fun$ ))(and (reg$ ?v1 ?v0 )(forall ((?v2 N$ ))(= (root$ (fun_app$a ?v1 ?v2 ))?v2 )))))):named a13 ))
(assert (! (forall ((?v0 N_list_list_list$ ))(= (not (= ?v0 nil$b ))(exists ((?v1 N_list_list$ )(?v2 N_list_list_list$ ))(= ?v0 (cons$b ?v1 ?v2 ))))):named a14 ))
(assert (! (forall ((?v0 N_list_list$ ))(= (not (= ?v0 nil$a ))(exists ((?v1 N_list$ )(?v2 N_list_list$ ))(= ?v0 (cons$a ?v1 ?v2 ))))):named a15 ))
(assert (! (forall ((?v0 N_list$ ))(= (not (= ?v0 nil$ ))(exists ((?v1 N$ )(?v2 N_list$ ))(= ?v0 (cons$ ?v1 ?v2 ))))):named a16 ))
(assert (! (forall ((?v0 N_list_list_list$ ))(=> (and (=> (= ?v0 nil$b )false )(and (forall ((?v1 N_list_list$ ))(=> (= ?v0 (cons$b ?v1 nil$b ))false ))(forall ((?v1 N_list_list$ )(?v2 N_list_list$ )(?v3 N_list_list_list$ ))(=> (= ?v0 (cons$b ?v1 (cons$b ?v2 ?v3 )))false ))))false )):named a17 ))
(assert (! (forall ((?v0 N_list_list$ ))(=> (and (=> (= ?v0 nil$a )false )(and (forall ((?v1 N_list$ ))(=> (= ?v0 (cons$a ?v1 nil$a ))false ))(forall ((?v1 N_list$ )(?v2 N_list$ )(?v3 N_list_list$ ))(=> (= ?v0 (cons$a ?v1 (cons$a ?v2 ?v3 )))false ))))false )):named a18 ))
(assert (! (forall ((?v0 N_list$ ))(=> (and (=> (= ?v0 nil$ )false )(and (forall ((?v1 N$ ))(=> (= ?v0 (cons$ ?v1 nil$ ))false ))(forall ((?v1 N$ )(?v2 N$ )(?v3 N_list$ ))(=> (= ?v0 (cons$ ?v1 (cons$ ?v2 ?v3 )))false ))))false )):named a19 ))
(assert (! (forall ((?v0 N_list_list_list_list$ ))(=> (and (=> (= ?v0 nil$c )false )(and (forall ((?v1 N_list_list_list_list$ ))(=> (= ?v0 (cons$c nil$b ?v1 ))false ))(forall ((?v1 N_list_list$ )(?v2 N_list_list_list$ )(?v3 N_list_list_list_list$ ))(=> (= ?v0 (cons$c (cons$b ?v1 ?v2 )?v3 ))false ))))false )):named a20 ))
(assert (! (forall ((?v0 N_list_list_list$ ))(=> (and (=> (= ?v0 nil$b )false )(and (forall ((?v1 N_list_list_list$ ))(=> (= ?v0 (cons$b nil$a ?v1 ))false ))(forall ((?v1 N_list$ )(?v2 N_list_list$ )(?v3 N_list_list_list$ ))(=> (= ?v0 (cons$b (cons$a ?v1 ?v2 )?v3 ))false ))))false )):named a21 ))
(assert (! (forall ((?v0 N_list_list$ ))(=> (and (=> (= ?v0 nil$a )false )(and (forall ((?v1 N_list_list$ ))(=> (= ?v0 (cons$a nil$ ?v1 ))false ))(forall ((?v1 N$ )(?v2 N_list$ )(?v3 N_list_list$ ))(=> (= ?v0 (cons$a (cons$ ?v1 ?v2 )?v3 ))false ))))false )):named a22 ))
(assert (! (forall ((?v0 N_list_list_list$ ))(=> (and (=> (= ?v0 nil$b )false )(forall ((?v1 N_list_list$ )(?v2 N_list_list_list$ ))(=> (= ?v0 (cons$b ?v1 ?v2 ))false )))false )):named a23 ))
(assert (! (forall ((?v0 N_list_list$ ))(=> (and (=> (= ?v0 nil$a )false )(forall ((?v1 N_list$ )(?v2 N_list_list$ ))(=> (= ?v0 (cons$a ?v1 ?v2 ))false )))false )):named a24 ))
(assert (! (forall ((?v0 N_list$ ))(=> (and (=> (= ?v0 nil$ )false )(forall ((?v1 N$ )(?v2 N_list$ ))(=> (= ?v0 (cons$ ?v1 ?v2 ))false )))false )):named a25 ))
(assert (! (forall ((?v0 N_list_list_list$ )(?v1 N_list_list$ )(?v2 N_list_list_list$ ))(=> (= ?v0 (cons$b ?v1 ?v2 ))(not (= ?v0 nil$b )))):named a26 ))
(assert (! (forall ((?v0 N_list_list$ )(?v1 N_list$ )(?v2 N_list_list$ ))(=> (= ?v0 (cons$a ?v1 ?v2 ))(not (= ?v0 nil$a )))):named a27 ))
(assert (! (forall ((?v0 N_list$ )(?v1 N$ )(?v2 N_list$ ))(=> (= ?v0 (cons$ ?v1 ?v2 ))(not (= ?v0 nil$ )))):named a28 ))
(assert (! (forall ((?v0 N_list_list_list$ )(?v1 N_list_list_list_bool_fun$ ))(=> (and (not (= ?v0 nil$b ))(and (forall ((?v2 N_list_list$ ))(fun_app$b ?v1 (cons$b ?v2 nil$b )))(forall ((?v2 N_list_list$ )(?v3 N_list_list_list$ ))(=> (and (not (= ?v3 nil$b ))(fun_app$b ?v1 ?v3 ))(fun_app$b ?v1 (cons$b ?v2 ?v3 ))))))(fun_app$b ?v1 ?v0 ))):named a29 ))
(assert (! (forall ((?v0 N_list_list$ )(?v1 N_list_list_bool_fun$ ))(=> (and (not (= ?v0 nil$a ))(and (forall ((?v2 N_list$ ))(fun_app$c ?v1 (cons$a ?v2 nil$a )))(forall ((?v2 N_list$ )(?v3 N_list_list$ ))(=> (and (not (= ?v3 nil$a ))(fun_app$c ?v1 ?v3 ))(fun_app$c ?v1 (cons$a ?v2 ?v3 ))))))(fun_app$c ?v1 ?v0 ))):named a30 ))
(assert (! (forall ((?v0 N_list$ )(?v1 N_list_bool_fun$ ))(=> (and (not (= ?v0 nil$ ))(and (forall ((?v2 N$ ))(fun_app$ ?v1 (cons$ ?v2 nil$ )))(forall ((?v2 N$ )(?v3 N_list$ ))(=> (and (not (= ?v3 nil$ ))(fun_app$ ?v1 ?v3 ))(fun_app$ ?v1 (cons$ ?v2 ?v3 ))))))(fun_app$ ?v1 ?v0 ))):named a31 ))
...
(assert (! (forall ((?v0 N_list_list$ )(?v1 N_list_list_list$ ))(not (= nil$b (cons$b ?v0 ?v1 )))):named a41 ))
(assert (! (forall ((?v0 N_list$ )(?v1 N_list_list$ ))(not (= nil$a (cons$a ?v0 ?v1 )))):named a42 ))
(assert (! (forall ((?v0 N$ )(?v1 N_list$ ))(not (= nil$ (cons$ ?v0 ?v1 )))):named a43 ))
(check-sat )
;(get-unsat-core )
