...
(declare-datatypes ()((T_N_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ N$ )))(T_dtree_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a Dtree$ )))(T_T_sum$ (inl$b (projl$b T$ ))(inr$b (projr$b T$ )))(T_set_T_sum$ (inl$c (projl$c T_set$ ))(inr$c (projr$c T$ )))(T_set_T_set_sum$ (inl$d (projl$d T_set$ ))(inr$d (projr$d T_set$ )))(T_set_T_T_sum_sum$ (inl$e (projl$e T_set$ ))(inr$e (projr$e T_T_sum$ )))(T_T_sum_T_sum$ (inl$f (projl$f T_T_sum$ ))(inr$f (projr$f T$ )))(T_T_sum_T_set_sum$ (inl$g (projl$g T_T_sum$ ))(inr$g (projr$g T_set$ )))(T_T_sum_T_T_sum_sum$ (inl$h (projl$h T_T_sum$ ))(inr$h (projr$h T_T_sum$ )))))
