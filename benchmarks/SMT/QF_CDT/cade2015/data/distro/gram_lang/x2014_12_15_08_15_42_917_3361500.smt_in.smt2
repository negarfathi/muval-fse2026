...
(declare-datatypes ()((T_N_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ N$ )))(T_dtree_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a Dtree$ )))(T_T_N_sum_sum$ (inl$b (projl$b T$ ))(inr$b (projr$b T_N_sum$ )))(T_T_dtree_sum_sum$ (inl$c (projl$c T$ ))(inr$c (projr$c T_dtree_sum$ )))(T_T_sum$ (inl$d (projl$d T$ ))(inr$d (projr$d T$ )))(T_set_T_sum$ (inl$e (projl$e T_set$ ))(inr$e (projr$e T$ )))(T_set_dtree_sum$ (inl$f (projl$f T_set$ ))(inr$f (projr$f Dtree$ )))(T_set_N_sum$ (inl$g (projl$g T_set$ ))(inr$g (projr$g N$ )))(T_set_T_N_sum_sum$ (inl$h (projl$h T_set$ ))(inr$h (projr$h T_N_sum$ )))))
(declare-fun n$ ()N$ )
