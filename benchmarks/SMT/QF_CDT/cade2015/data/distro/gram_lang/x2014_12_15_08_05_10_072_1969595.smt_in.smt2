...
(assert (! (not (subtr2$ (fun_app$ (sup$ ns$ )ns23a$ )tr1a$ tr3aa$ )):named a0 ))
(assert (! (member$ (root$ tr1a$ )ns$ ):named a1 ))
(assert (! (member$a (inr$ tr1a$ )(cont$ tr2a$ )):named a2 ))
(assert (! (subtr2$ ns$ tr2a$ tr3a$ ):named a3 ))
(assert (! (forall ((?v0 N_set$ )(?v1 Dtree$ ))(=> (subtr2$ ?v0 tr3a$ ?v1 )(subtr2$ (fun_app$ (sup$ ns$ )?v0 )tr2a$ ?v1 ))):named a4 ))
(assert (! (subtr2$ ns23a$ tr3a$ tr3aa$ ):named a5 ))
(assert (! (subtr2$ ns12$ tr1$ tr2$ ):named a6 ))
(assert (! (subtr2$ ns23$ tr2$ tr3$ ):named a7 ))
(assert (! (forall ((?v0 N_set$ )(?v1 Dtree$ )(?v2 Dtree$ ))(= (subtr2$ ?v0 ?v1 ?v2 )(or (exists ((?v3 Dtree$ )(?v4 N_set$ ))(and (= ?v0 ?v4 )(and (= ?v1 ?v3 )(and (= ?v2 ?v3 )(member$ (root$ ?v3 )?v4 )))))(exists ((?v3 Dtree$ )(?v4 N_set$ )(?v5 Dtree$ )(?v6 Dtree$ ))(and (= ?v0 ?v4 )(and (= ?v1 ?v3 )(and (= ?v2 ?v6 )(and (member$ (root$ ?v3 )?v4 )(and (member$a (inr$ ?v3 )(cont$ ?v5 ))(subtr2$ ?v4 ?v5 ?v6 )))))))))):named a8 ))
(assert (! (forall ((?v0 N_set$ )(?v1 Dtree$ )(?v2 Dtree$ ))(=> (and (subtr2$ ?v0 ?v1 ?v2 )(and (forall ((?v3 Dtree$ )(?v4 N_set$ ))(=> (and (= ?v0 ?v4 )(and (= ?v1 ?v3 )(and (= ?v2 ?v3 )(member$ (root$ ?v3 )?v4 ))))false ))(forall ((?v3 Dtree$ )(?v4 N_set$ )(?v5 Dtree$ )(?v6 Dtree$ ))(=> (and (= ?v0 ?v4 )(and (= ?v1 ?v3 )(and (= ?v2 ?v6 )(and (member$ (root$ ?v3 )?v4 )(and (member$a (inr$ ?v3 )(cont$ ?v5 ))(subtr2$ ?v4 ?v5 ?v6 ))))))false ))))false )):named a9 ))
(assert (! (forall ((?v0 N_set$ )(?v1 Dtree$ )(?v2 Dtree$ ))(=> (subtr2$ ?v0 ?v1 ?v2 )(member$ (root$ ?v2 )?v0 ))):named a10 ))
(assert (! (forall ((?v0 N_set$ )(?v1 Dtree$ )(?v2 Dtree$ ))(=> (subtr2$ ?v0 ?v1 ?v2 )(member$ (root$ ?v1 )?v0 ))):named a11 ))
...
(assert (! (forall ((?v0 Dtree$ )(?v1 N_set$ ))(=> (member$ (root$ ?v0 )?v1 )(subtr2$ ?v1 ?v0 ?v0 ))):named a13 ))
