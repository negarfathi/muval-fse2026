...
(declare-datatypes ()((T_dtree_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree$ )))(T_N_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a N$ )))(N_N_sum$ (inl$b (projl$b N$ ))(inr$b (projr$b N$ )))(N_T_sum$ (inl$c (projl$c N$ ))(inr$c (projr$c T$ )))(T_T_sum$ (inl$d (projl$d T$ ))(inr$d (projr$d T$ )))(Dtree_dtree_sum$ (inl$e (projl$e Dtree$ ))(inr$e (projr$e Dtree$ )))(N_dtree_sum$ (inl$f (projl$f N$ ))(inr$f (projr$f Dtree$ )))(Dtree_N_sum$ (inl$g (projl$g Dtree$ ))(inr$g (projr$g N$ )))))
