...
(declare-datatypes ()((A_list$ (nil$ )(cons$ (hd$ A$ )(tl$ A_list$ )))(Nat_a_prod$ (pair$ (fst$ Nat$ )(snd$ A$ )))(Nat_nat_a_prod_prod$ (pair$a (fst$a Nat$ )(snd$a Nat_a_prod$ )))(Nat_nat_a_prod_prod_list$ (nil$a )(cons$a (hd$a Nat_nat_a_prod_prod$ )(tl$a Nat_nat_a_prod_prod_list$ )))(Nat_a_prod_list$ (nil$b )(cons$b (hd$b Nat_a_prod$ )(tl$b Nat_a_prod_list$ )))))
...
(declare-datatypes ()((Nat_nat_nat_a_prod_prod_prod$ (pair$b (fst$b Nat$ )(snd$b Nat_nat_a_prod_prod$ )))(Nat_nat_nat_a_prod_prod_prod_list$ (nil$c )(cons$c (hd$c Nat_nat_nat_a_prod_prod_prod$ )(tl$c Nat_nat_nat_a_prod_prod_prod_list$ )))))
(declare-fun i$ ()Nat$ )
