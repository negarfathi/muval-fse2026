...
(assert (! (not (= (snth$ (shift$ xs$ s$ )n$ )(ite (less$ n$ (size$ xs$ ))(nth$ xs$ n$ )(snth$ s$ (minus$ n$ (size$ xs$ )))))):named a0 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_stream$ )(?v2 A_stream$ ))(= (= (shift$ ?v0 ?v1 )(shift$ ?v0 ?v2 ))(= ?v1 ?v2 ))):named a1 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_list$ )(?v2 A_stream$ ))(=> (less$ ?v0 (size$ ?v1 ))(= (snth$ (shift$ ?v1 ?v2 )?v0 )(nth$ ?v1 ?v0 )))):named a2 ))
...
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ )(?v2 Nat$ ))(=> (and (less$ ?v0 ?v1 )(less$ ?v0 ?v2 ))(less$ (minus$ ?v2 ?v1 )(minus$ ?v2 ?v0 )))):named a6 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ )(?v2 Nat$ ))(=> (less$ ?v0 ?v1 )(less$ (minus$ ?v0 ?v2 )?v1 ))):named a7 ))
(assert (! (forall ((?v0 A_list_bool_fun$ )(?v1 A_list$ ))(=> (forall ((?v2 A_list$ ))(=> (forall ((?v3 A_list$ ))(=> (less$ (size$ ?v3 )(size$ ?v2 ))(fun_app$b ?v0 ?v3 )))(fun_app$b ?v0 ?v2 )))(fun_app$b ?v0 ?v1 ))):named a8 ))
(assert (! (forall ((?v0 A_list$ )(?v1 Nat$ )(?v2 A_stream$ ))(=> (less_eq$ (size$ ?v0 )?v1 )(= (snth$ (shift$ ?v0 ?v2 )?v1 )(snth$ ?v2 (minus$ ?v1 (size$ ?v0 )))))):named a9 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(=> (less_eq$ ?v0 ?v1 )(= (minus$ ?v1 (minus$ ?v1 ?v0 ))?v0 ))):named a10 ))
