...
(declare-datatypes ()((A_stream_stream_list$ (nil$b )(cons$b (hd$b A_stream_stream$ )(tl$b A_stream_stream_list$ )))(A_list_list$ (nil$c )(cons$c (hd$c A_list$ )(tl$c A_list_list$ )))))
(declare-fun a$ ()A_set$ )
