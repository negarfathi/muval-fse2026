...
(declare-datatypes ()((A_list_list_list_list$ (nil$c )(cons$c (hd$c A_list_list_list$ )(tl$c A_list_list_list_list$ )))(A_list_stream_list$ (nil$d )(cons$d (hd$d A_list_stream$ )(tl$d A_list_stream_list$ )))))
