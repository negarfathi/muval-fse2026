...
(declare-datatypes ()((A_stream_stream_list$ (nil$ )(cons$ (hd$ A_stream_stream$ )(tl$ A_stream_stream_list$ )))(A_stream_list$ (nil$a )(cons$a (hd$a A_stream$ )(tl$a A_stream_list$ )))(A_list$ (nil$b )(cons$b (hd$b A$ )(tl$b A_list$ )))))
