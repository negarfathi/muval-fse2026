...
(declare-datatypes ()((A_list_list_list$ (nil$e )(cons$e (hd$e A_list_list$ )(tl$e A_list_list_list$ )))(A_stream_list_list$ (nil$f )(cons$f (hd$f A_stream_list$ )(tl$f A_stream_list_list$ )))(A_list_list_stream_list$ (nil$g )(cons$g (hd$g A_list_list_stream$ )(tl$g A_list_list_stream_list$ )))(A_stream_stream_list_list$ (nil$h )(cons$h (hd$h A_stream_stream_list$ )(tl$h A_stream_stream_list_list$ )))(A_list_stream_list_list$ (nil$i )(cons$i (hd$i A_list_stream_list$ )(tl$i A_list_stream_list_list$ )))))
(declare-fun a$ ()A_set$ )
