...
(declare-datatypes ()((B_c_prod$ (pair$ (fst$ B$ )(snd$ C$ )))(B_c_prod_list$ (nil$a )(cons$a (hd$a B_c_prod$ )(tl$a B_c_prod_list$ )))(B_list$ (nil$b )(cons$b (hd$b B$ )(tl$b B_list$ )))(C_list$ (nil$c )(cons$c (hd$c C$ )(tl$c C_list$ )))(A_a_prod$ (pair$a (fst$a A$ )(snd$a A$ )))(A_a_prod_list$ (nil$d )(cons$d (hd$d A_a_prod$ )(tl$d A_a_prod_list$ )))))
...
(declare-datatypes ()((A_b_prod$ (pair$b (fst$b A$ )(snd$b B$ )))(A_b_prod_list$ (nil$e )(cons$e (hd$e A_b_prod$ )(tl$e A_b_prod_list$ )))))
...
(declare-datatypes ()((A_c_prod$ (pair$c (fst$c A$ )(snd$c C$ )))(A_c_prod_list$ (nil$f )(cons$f (hd$f A_c_prod$ )(tl$f A_c_prod_list$ )))))
...
(declare-datatypes ()((B_b_prod$ (pair$e (fst$e B$ )(snd$e B$ )))(B_b_prod_list$ (nil$h )(cons$h (hd$h B_b_prod$ )(tl$h B_b_prod_list$ )))))
...
(declare-datatypes ()((C_a_prod$ (pair$f (fst$f C$ )(snd$f A$ )))(C_a_prod_list$ (nil$i )(cons$i (hd$i C_a_prod$ )(tl$i C_a_prod_list$ )))))
...
(declare-datatypes ()((C_b_prod$ (pair$g (fst$g C$ )(snd$g B$ )))(C_b_prod_list$ (nil$j )(cons$j (hd$j C_b_prod$ )(tl$j C_b_prod_list$ )))))
...
(declare-datatypes ()((C_c_prod$ (pair$h (fst$h C$ )(snd$h C$ )))(C_c_prod_list$ (nil$k )(cons$k (hd$k C_c_prod$ )(tl$k C_c_prod_list$ )))))
...
(declare-datatypes ()((A_b_b_prod_prod$ (pair$i (fst$i A$ )(snd$i B_b_prod$ )))(A_b_b_prod_prod_list$ (nil$l )(cons$l (hd$l A_b_b_prod_prod$ )(tl$l A_b_b_prod_prod_list$ )))))
