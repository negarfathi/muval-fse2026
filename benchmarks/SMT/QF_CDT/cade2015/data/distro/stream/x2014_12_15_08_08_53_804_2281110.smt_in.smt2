...
(declare-sort A_b_prod_stream_stream_stream_stream_stream$ 0)
...
(declare-sort B_stream_stream_stream_stream$ 0)
...
(declare-fun shd$d (A_b_prod_stream_stream_stream$)A_b_prod_stream_stream$)
(declare-fun stl$d (A_b_prod_stream_stream_stream$)A_b_prod_stream_stream_stream$)
(declare-fun sCons$d (A_b_prod_stream_stream$ A_b_prod_stream_stream_stream$ )A_b_prod_stream_stream_stream$)
(declare-fun shd$e (A_b_prod_stream_stream_stream_stream$)A_b_prod_stream_stream_stream$)
(declare-fun stl$e (A_b_prod_stream_stream_stream_stream$)A_b_prod_stream_stream_stream_stream$)
(declare-fun sCons$e (A_b_prod_stream_stream_stream$ A_b_prod_stream_stream_stream_stream$ )A_b_prod_stream_stream_stream_stream$)
(declare-fun shd$f (A_b_prod_stream_stream_stream_stream_stream$)A_b_prod_stream_stream_stream_stream$)
(declare-fun stl$f (A_b_prod_stream_stream_stream_stream_stream$)A_b_prod_stream_stream_stream_stream_stream$)
(declare-fun sCons$f (A_b_prod_stream_stream_stream_stream$ A_b_prod_stream_stream_stream_stream_stream$ )A_b_prod_stream_stream_stream_stream_stream$)
...
(declare-fun sCons$h (A_stream_stream$ A_stream_stream_stream$ )A_stream_stream_stream$)
...
(declare-fun sCons$i (A_stream_stream_stream$ A_stream_stream_stream_stream$ )A_stream_stream_stream_stream$)
...
(declare-fun shd$l (B_stream_stream_stream_stream$)B_stream_stream_stream$)
(declare-fun stl$l (B_stream_stream_stream_stream$)B_stream_stream_stream_stream$)
(declare-fun sCons$l (B_stream_stream_stream$ B_stream_stream_stream_stream$ )B_stream_stream_stream_stream$)
(declare-datatypes ()((B_b_prod$ (pair$a (fst$a B$ )(snd$a B$ )))(B_a_prod$ (pair$b (fst$b B$ )(snd$b A$ )))(A_a_prod$ (pair$c (fst$c A$ )(snd$c A$ )))(B_a_b_prod_prod$ (pair$d (fst$d B$ )(snd$d A_b_prod$ )))(A_a_b_prod_prod$ (pair$e (fst$e A$ )(snd$e A_b_prod$ )))(A_b_prod_b_prod$ (pair$f (fst$f A_b_prod$ )(snd$f B$ )))(A_b_prod_a_prod$ (pair$g (fst$g A_b_prod$ )(snd$g A$ )))(B_a_b_prod_stream_prod$ (pair$h (fst$h B$ )(snd$h A_b_prod_stream$ )))(A_a_b_prod_stream_prod$ (pair$i (fst$i A$ )(snd$i A_b_prod_stream$ )))))
...
(declare-sort A_a_b_prod_stream_prod_stream_stream$ 0)
(declare-sort A_a_b_prod_prod_stream$ 0)
(declare-sort A_a_b_prod_prod_stream_stream$ 0)
...
(declare-fun shd$n (B_b_prod_stream_stream$)B_b_prod_stream$)
(declare-fun stl$n (B_b_prod_stream_stream$)B_b_prod_stream_stream$)
(declare-fun sCons$n (B_b_prod_stream$ B_b_prod_stream_stream$ )B_b_prod_stream_stream$)
(declare-fun shd$o (B_a_prod_stream$)B_a_prod$)
(declare-fun stl$o (B_a_prod_stream$)B_a_prod_stream$)
(declare-fun sCons$o (B_a_prod$ B_a_prod_stream$ )B_a_prod_stream$)
...
(declare-fun shd$q (A_a_b_prod_stream_prod_stream$)A_a_b_prod_stream_prod$)
(declare-fun stl$q (A_a_b_prod_stream_prod_stream$)A_a_b_prod_stream_prod_stream$)
(declare-fun sCons$q (A_a_b_prod_stream_prod$ A_a_b_prod_stream_prod_stream$ )A_a_b_prod_stream_prod_stream$)
(declare-fun shd$r (A_a_b_prod_stream_prod_stream_stream$)A_a_b_prod_stream_prod_stream$)
(declare-fun stl$r (A_a_b_prod_stream_prod_stream_stream$)A_a_b_prod_stream_prod_stream_stream$)
(declare-fun sCons$r (A_a_b_prod_stream_prod_stream$ A_a_b_prod_stream_prod_stream_stream$ )A_a_b_prod_stream_prod_stream_stream$)
(declare-fun shd$s (A_a_b_prod_prod_stream$)A_a_b_prod_prod$)
(declare-fun stl$s (A_a_b_prod_prod_stream$)A_a_b_prod_prod_stream$)
(declare-fun sCons$s (A_a_b_prod_prod$ A_a_b_prod_prod_stream$ )A_a_b_prod_prod_stream$)
(declare-fun shd$t (A_a_b_prod_prod_stream_stream$)A_a_b_prod_prod_stream$)
(declare-fun stl$t (A_a_b_prod_prod_stream_stream$)A_a_b_prod_prod_stream_stream$)
(declare-fun sCons$t (A_a_b_prod_prod_stream$ A_a_b_prod_prod_stream_stream$ )A_a_b_prod_prod_stream_stream$)
(declare-fun shd$u (A_a_prod_stream$)A_a_prod$)
(declare-fun stl$u (A_a_prod_stream$)A_a_prod_stream$)
(declare-fun sCons$u (A_a_prod$ A_a_prod_stream$ )A_a_prod_stream$)
(declare-fun shd$v (A_a_prod_stream_stream$)A_a_prod_stream$)
(declare-fun stl$v (A_a_prod_stream_stream$)A_a_prod_stream_stream$)
(declare-fun sCons$v (A_a_prod_stream$ A_a_prod_stream_stream$ )A_a_prod_stream_stream$)
