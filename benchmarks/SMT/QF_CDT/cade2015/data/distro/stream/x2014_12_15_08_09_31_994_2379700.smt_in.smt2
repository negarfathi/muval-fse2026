...
(declare-sort A_stream_set_stream$ 0)
(declare-sort B_c_prod_set_stream$ 0)
(declare-sort C_set_stream$ 0)
(declare-sort B_set_stream$ 0)
(declare-sort A_set_stream$ 0)
(declare-fun shd$n (A_b_a_prod_prod_stream$)A_b_a_prod_prod$)
(declare-fun stl$n (A_b_a_prod_prod_stream$)A_b_a_prod_prod_stream$)
(declare-fun sCons$n (A_b_a_prod_prod$ A_b_a_prod_prod_stream$ )A_b_a_prod_prod_stream$)
(declare-fun shd$o (A_stream_stream$)A_stream$)
(declare-fun stl$o (A_stream_stream$)A_stream_stream$)
(declare-fun sCons$o (A_stream$ A_stream_stream$ )A_stream_stream$)
(declare-fun shd$p (A_stream_set_stream$)A_stream_set$)
(declare-fun stl$p (A_stream_set_stream$)A_stream_set_stream$)
(declare-fun sCons$p (A_stream_set$ A_stream_set_stream$ )A_stream_set_stream$)
(declare-fun shd$q (B_c_prod_set_stream$)B_c_prod_set$)
(declare-fun stl$q (B_c_prod_set_stream$)B_c_prod_set_stream$)
(declare-fun sCons$q (B_c_prod_set$ B_c_prod_set_stream$ )B_c_prod_set_stream$)
(declare-fun shd$r (C_set_stream$)C_set$)
(declare-fun stl$r (C_set_stream$)C_set_stream$)
(declare-fun sCons$r (C_set$ C_set_stream$ )C_set_stream$)
(declare-fun shd$s (B_set_stream$)B_set$)
(declare-fun stl$s (B_set_stream$)B_set_stream$)
(declare-fun sCons$s (B_set$ B_set_stream$ )B_set_stream$)
(declare-fun shd$t (A_set_stream$)A_set$)
(declare-fun stl$t (A_set_stream$)A_set_stream$)
(declare-fun sCons$t (A_set$ A_set_stream$ )A_set_stream$)
