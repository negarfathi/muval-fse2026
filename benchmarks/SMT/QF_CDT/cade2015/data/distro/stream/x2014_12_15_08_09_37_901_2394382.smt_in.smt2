...
(declare-datatypes ()((B_b_prod_list$ (nil$ )(cons$ (hd$ B_b_prod$ )(tl$ B_b_prod_list$ )))(B_a_prod_list$ (nil$a )(cons$a (hd$a B_a_prod$ )(tl$a B_a_prod_list$ )))(A_c_prod_list$ (nil$b )(cons$b (hd$b A_c_prod$ )(tl$b A_c_prod_list$ )))(A_b_prod_list$ (nil$c )(cons$c (hd$c A_b_prod$ )(tl$c A_b_prod_list$ )))(A_a_prod_list$ (nil$d )(cons$d (hd$d A_a_prod$ )(tl$d A_a_prod_list$ )))(A_list$ (nil$e )(cons$e (hd$e A$ )(tl$e A_list$ )))(B_list$ (nil$f )(cons$f (hd$f B$ )(tl$f B_list$ )))(C_list$ (nil$g )(cons$g (hd$g C$ )(tl$g C_list$ )))))
