...
(declare-datatypes ()((A_bool_fun_a_stream_prod$ (pair$b (select$ A_bool_fun$ )(selecta$ A_stream$ )))(A_treeFI_a_treeFI_prod$ (pair$c (fst$b A_treeFI$ )(snd$b A_treeFI$ )))(A_treeFI_a_treeFI_prod_list$ (nil$g )(cons$g (hd$g A_treeFI_a_treeFI_prod$ )(tl$g A_treeFI_a_treeFI_prod_list$ )))(A_list$ (nil$h )(cons$h (hd$h A$ )(tl$h A_list$ )))(Nat_list$ (nil$i )(cons$i (hd$i Nat$ )(tl$i Nat_list$ )))))
