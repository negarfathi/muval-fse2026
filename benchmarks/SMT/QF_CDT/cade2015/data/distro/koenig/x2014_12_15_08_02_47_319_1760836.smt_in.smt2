...
(declare-datatypes ()((A_treeFI_treeFI_list$ (nil$a )(cons$a (hd$a A_treeFI_treeFI$ )(tl$a A_treeFI_treeFI_list$ )))(A_treeFI_treeFI_treeFI_list$ (nil$b )(cons$b (hd$b A_treeFI_treeFI_treeFI$ )(tl$b A_treeFI_treeFI_treeFI_list$ )))(A_stream_treeFI_list$ (nil$c )(cons$c (hd$c A_stream_treeFI$ )(tl$c A_stream_treeFI_list$ )))(A_treeFI_stream_treeFI_list$ (nil$d )(cons$d (hd$d A_treeFI_stream_treeFI$ )(tl$d A_treeFI_stream_treeFI_list$ )))(A_list$ (nil$e )(cons$e (hd$e A$ )(tl$e A_list$ )))(A_stream_list$ (nil$f )(cons$f (hd$f A_stream$ )(tl$f A_stream_list$ )))(A_treeFI_stream_list$ (nil$g )(cons$g (hd$g A_treeFI_stream$ )(tl$g A_treeFI_stream_list$ )))))
