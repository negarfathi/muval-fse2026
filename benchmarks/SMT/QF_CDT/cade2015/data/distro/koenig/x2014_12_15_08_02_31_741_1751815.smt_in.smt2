...
(declare-datatypes ()((A_a_prod_treeFI_list$ (nil$ )(cons$ (hd$ A_a_prod_treeFI$ )(tl$ A_a_prod_treeFI_list$ )))(A_treeFI_treeFI_list$ (nil$a )(cons$a (hd$a A_treeFI_treeFI$ )(tl$a A_treeFI_treeFI_list$ )))(A_treeFI_list$ (nil$b )(cons$b (hd$b A_treeFI$ )(tl$b A_treeFI_list$ )))(A_treeFI_list_a_treeFI_list_prod$ (pair$a (fst$a A_treeFI_list$ )(snd$a A_treeFI_list$ )))(A_treeFI_list_a_treeFI_list_prod_treeFI_list$ (nil$c )(cons$c (hd$c A_treeFI_list_a_treeFI_list_prod_treeFI$ )(tl$c A_treeFI_list_a_treeFI_list_prod_treeFI_list$ )))(A_treeFI_treeFI_treeFI_list$ (nil$d )(cons$d (hd$d A_treeFI_treeFI_treeFI$ )(tl$d A_treeFI_treeFI_treeFI_list$ )))(A_treeFI_stream_treeFI_list$ (nil$e )(cons$e (hd$e A_treeFI_stream_treeFI$ )(tl$e A_treeFI_stream_treeFI_list$ )))(A_stream_treeFI_list$ (nil$f )(cons$f (hd$f A_stream_treeFI$ )(tl$f A_stream_treeFI_list$ )))))
...
(declare-datatypes ()((A_bool_fun_a_stream_prod$ (pair$b (select$ A_bool_fun$ )(selecta$ A_stream$ )))(A_treeFI_a_treeFI_prod$ (pair$c (fst$b A_treeFI$ )(snd$b A_treeFI$ )))(A_treeFI_a_treeFI_prod_list$ (nil$g )(cons$g (hd$g A_treeFI_a_treeFI_prod$ )(tl$g A_treeFI_a_treeFI_prod_list$ )))))
