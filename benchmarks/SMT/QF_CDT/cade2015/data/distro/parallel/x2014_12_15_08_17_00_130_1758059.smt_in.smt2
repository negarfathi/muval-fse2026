...
(declare-datatypes ()((Dtree_dtree_prod$ (pair$ (fst$ Dtree$ )(snd$ Dtree$ )))(T_dtree_dtree_prod_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree_dtree_prod$ )))(T_dtree_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a Dtree$ )))))
