...
(assert (! (not (exists ((?v0 Dtree$ ))(and (member$ ?v0 (vimage$ uu$ (cont$ (par$ (pair$ tr1a$ (par$ (pair$ tr2a$ tr3a$ )))))))(exists ((?v1 Dtree$ )(?v2 Dtree$ )(?v3 Dtree$ ))(and (= trA$ (par$ (pair$ (par$ (pair$ ?v1 ?v2 ))?v3 )))(= ?v0 (par$ (pair$ ?v1 (par$ (pair$ ?v2 ?v3 )))))))))):named a1 ))
...
(assert (! (= trA$ (par$ (pair$ (par$ (pair$ tr1$ tr2$ ))tr3$ ))):named a5 ))
(assert (! (exists ((?v0 Dtree$ )(?v1 Dtree$ )(?v2 Dtree$ ))(and (= trA$a (par$ (pair$ (par$ (pair$ ?v0 ?v1 ))?v2 )))(= trB$ (par$ (pair$ ?v0 (par$ (pair$ ?v1 ?v2 ))))))):named a6 ))
(assert (! (member$a (inr$ trA$ )(cont$ (par$ (pair$ (par$ (pair$ tr1a$ tr2a$ ))tr3a$ )))):named a7 ))
(assert (! (=> (forall ((?v0 Dtree$ )(?v1 Dtree$ )(?v2 Dtree$ ))(=> (and (= trA$ (par$ (pair$ (par$ (pair$ ?v0 ?v1 ))?v2 )))(and (member$a (inr$ ?v0 )(cont$ tr1a$ ))(and (member$a (inr$ ?v1 )(cont$ tr2a$ ))(member$a (inr$ ?v2 )(cont$ tr3a$ )))))false ))false ):named a8 ))
