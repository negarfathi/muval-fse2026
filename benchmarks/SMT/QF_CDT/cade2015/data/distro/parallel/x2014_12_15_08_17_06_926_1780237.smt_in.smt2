...
(declare-datatypes ()((T_dtree_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree$ )))(Dtree_dtree_prod$ (pair$ (fst$ Dtree$ )(snd$ Dtree$ )))(T_dtree_dtree_prod_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a Dtree_dtree_prod$ )))(T_T_dtree_dtree_prod_sum_sum$ (inl$b (projl$b T$ ))(inr$b (projr$b T_dtree_dtree_prod_sum$ )))(T_T_sum$ (inl$c (projl$c T$ ))(inr$c (projr$c T$ )))(T_T_dtree_sum_sum$ (inl$d (projl$d T$ ))(inr$d (projr$d T_dtree_sum$ )))))
...
(declare-fun image$c (Dtree_dtree_prod_dtree_fun$ Dtree_dtree_prod_set$ )Dtree_set$ )
...
(declare-fun image$f (T_dtree_sum_T_dtree_dtree_prod_sum_fun$ T_dtree_sum_set$ )T_dtree_dtree_prod_sum_set$ )
...
(declare-fun image$x (T_dtree_sum_dtree_fun$ T_dtree_sum_set$ )Dtree_set$ )
(declare-fun image$y (T_dtree_sum_T_fun$ T_dtree_sum_set$ )T_set$ )
...
(declare-fun member$e (Dtree_dtree_prod$ Dtree_dtree_prod_set$ )Bool )
...
(declare-fun vimage$p (Dtree_dtree_fun$ Dtree_set$ )Dtree_set$ )
(declare-fun vimage$q (Dtree_dtree_dtree_prod_fun$ Dtree_dtree_prod_set$ )Dtree_set$ )
(declare-fun vimage$r (T_dtree_dtree_prod_fun$ Dtree_dtree_prod_set$ )T_set$ )
(declare-fun vimage$s (T_dtree_sum_dtree_fun$ Dtree_set$ )T_dtree_sum_set$ )
(declare-fun vimage$t (Dtree_dtree_prod_dtree_fun$ Dtree_set$ )Dtree_dtree_prod_set$ )
...
(declare-fun fun_app$x (T_dtree_dtree_prod_fun$ T$ )Dtree_dtree_prod$ )
...
(assert (! (forall ((?v0 Dtree$ ))(! (= (fun_app$ uud$ ?v0 )(vimage$ uu$ (cont$ tr2$ ))):pattern ((fun_app$ uud$ ?v0 )))):named a0 ))
(assert (! (forall ((?v0 Dtree_dtree_prod$ ))(! (= (fun_app$a uuc$ ?v0 )(inr$a ?v0 )):pattern ((fun_app$a uuc$ ?v0 )))):named a1 ))
...
(assert (! (forall ((?v0 T$ ))(! (= (fun_app$h uub$ ?v0 )(inl$ ?v0 )):pattern ((fun_app$h uub$ ?v0 )))):named a8 ))
(assert (! (forall ((?v0 T$ ))(! (= (fun_app$e uuh$ ?v0 )(inl$c ?v0 )):pattern ((fun_app$e uuh$ ?v0 )))):named a9 ))
(assert (! (forall ((?v0 Dtree$ )(?v1 Dtree$ ))(! (= (fun_app$ (uuj$ ?v0 )?v1 )(vimage$ uu$ (cont$ ?v0 ))):pattern ((fun_app$ (uuj$ ?v0 )?v1 )))):named a10 ))
(assert (! (not (= (vimage$ uu$ (image$ (fun_app$i (map_sum$ id$ )par$ )(sup$ (image$a uua$ (vimage$a uub$ (sup$a (cont$ tr1$ )(cont$ tr2$ ))))(image$b uuc$ (sigma$ (vimage$ uu$ (cont$ tr1$ ))uud$ )))))(image$c par$ (sigma$ (vimage$ uu$ (cont$ tr1$ ))uud$ )))):named a11 ))
(assert (! (forall ((?v0 Dtree_dtree_fun$ )(?v1 T_dtree_sum_set$ ))(= (vimage$ uu$ (fun_app$j (image$d (fun_app$k (map_sum$a id$ )?v0 ))?v1 ))(fun_app$l (image$e ?v0 )(vimage$ uu$ ?v1 )))):named a12 ))
(assert (! (forall ((?v0 Dtree_dtree_dtree_prod_fun$ )(?v1 T_dtree_sum_set$ ))(= (vimage$b uuc$ (image$f (fun_app$m (map_sum$b id$ )?v0 )?v1 ))(image$g ?v0 (vimage$ uu$ ?v1 )))):named a13 ))
(assert (! (forall ((?v0 Dtree_dtree_prod_dtree_fun$ )(?v1 T_dtree_dtree_prod_sum_set$ ))(= (vimage$ uu$ (image$ (fun_app$i (map_sum$ id$ )?v0 )?v1 ))(image$c ?v0 (vimage$b uuc$ ?v1 )))):named a14 ))
...
(assert (! (forall ((?v0 Dtree_dtree_prod_dtree_dtree_prod_fun$ )(?v1 T_dtree_dtree_prod_sum_set$ ))(= (vimage$b uuc$ (image$i (fun_app$n (map_sum$d id$ )?v0 )?v1 ))(image$j ?v0 (vimage$b uuc$ ?v1 )))):named a16 ))
...
(assert (! (forall ((?v0 Dtree_dtree_prod_T_dtree_dtree_prod_sum_fun$ )(?v1 T_dtree_dtree_prod_sum_set$ ))(= (vimage$c uue$ (image$l (map_sum$f id$ ?v0 )?v1 ))(image$b ?v0 (vimage$b uuc$ ?v1 )))):named a18 ))
(assert (! (forall ((?v0 T_dtree_fun$ )(?v1 T_T_sum_set$ ))(= (vimage$ uu$ (image$m (map_sum$g id$ ?v0 )?v1 ))(image$n ?v0 (vimage$d uuf$ ?v1 )))):named a19 ))
(assert (! (forall ((?v0 Dtree_T_fun$ )(?v1 T_dtree_sum_set$ ))(= (vimage$d uuf$ (image$o (map_sum$h id$ ?v0 )?v1 ))(image$p ?v0 (vimage$ uu$ ?v1 )))):named a20 ))
...
(assert (! (forall ((?v0 Dtree_dtree_fun$ )(?v1 T_dtree_sum_set$ ))(= (vimage$a uub$ (fun_app$j (image$d (fun_app$k (map_sum$a id$ )?v0 ))?v1 ))(vimage$a uub$ ?v1 ))):named a22 ))
(assert (! (forall ((?v0 Dtree_dtree_dtree_prod_fun$ )(?v1 T_dtree_sum_set$ ))(= (vimage$f uua$ (image$f (fun_app$m (map_sum$b id$ )?v0 )?v1 ))(vimage$a uub$ ?v1 ))):named a23 ))
(assert (! (forall ((?v0 Dtree_dtree_prod_dtree_fun$ )(?v1 T_dtree_dtree_prod_sum_set$ ))(= (vimage$a uub$ (image$ (fun_app$i (map_sum$ id$ )?v0 )?v1 ))(vimage$f uua$ ?v1 ))):named a24 ))
...
(assert (! (forall ((?v0 Dtree_T_fun$ )(?v1 T_dtree_sum_set$ ))(= (vimage$d uuh$ (image$o (map_sum$h id$ ?v0 )?v1 ))(vimage$a uub$ ?v1 ))):named a27 ))
(assert (! (forall ((?v0 T_dtree_fun$ )(?v1 T_T_sum_set$ ))(= (vimage$a uub$ (image$m (map_sum$g id$ ?v0 )?v1 ))(vimage$d uuh$ ?v1 ))):named a28 ))
...
(assert (! (forall ((?v0 T$ )(?v1 Dtree_dtree_prod_dtree_dtree_prod_fun$ )(?v2 T_dtree_dtree_prod_sum_set$ ))(= (member$d (inl$a ?v0 )(image$i (fun_app$n (map_sum$d id$ )?v1 )?v2 ))(member$d (inl$a ?v0 )?v2 ))):named a38 ))
(assert (! (forall ((?v0 T$ )(?v1 Dtree_dtree_dtree_prod_fun$ )(?v2 T_dtree_sum_set$ ))(= (member$d (inl$a ?v0 )(image$f (fun_app$m (map_sum$b id$ )?v1 )?v2 ))(member$b (inl$ ?v0 )?v2 ))):named a39 ))
(assert (! (forall ((?v0 T$ )(?v1 Dtree_dtree_fun$ )(?v2 T_dtree_sum_set$ ))(= (member$b (inl$ ?v0 )(fun_app$j (image$d (fun_app$k (map_sum$a id$ )?v1 ))?v2 ))(member$b (inl$ ?v0 )?v2 ))):named a40 ))
...
(assert (! (forall ((?v0 Dtree$ )(?v1 Dtree_dtree_fun$ )(?v2 T_dtree_sum_set$ ))(= (member$b (inr$ ?v0 )(fun_app$j (image$d (fun_app$k (map_sum$a id$ )?v1 ))?v2 ))(exists ((?v3 Dtree$ ))(and (member$b (inr$ ?v3 )?v2 )(= (fun_app$p ?v1 ?v3 )?v0 ))))):named a42 ))
(assert (! (forall ((?v0 Dtree_dtree_prod$ )(?v1 Dtree_dtree_dtree_prod_fun$ )(?v2 T_dtree_sum_set$ ))(= (member$d (inr$a ?v0 )(image$f (fun_app$m (map_sum$b id$ )?v1 )?v2 ))(exists ((?v3 Dtree$ ))(and (member$b (inr$ ?v3 )?v2 )(= (fun_app$q ?v1 ?v3 )?v0 ))))):named a43 ))
...
(assert (! (forall ((?v0 Dtree$ )(?v1 T_dtree_sum_dtree_fun$ )(?v2 T_T_dtree_sum_sum_set$ ))(= (member$b (inr$ ?v0 )(image$v (map_sum$m id$ ?v1 )?v2 ))(exists ((?v3 T_dtree_sum$ ))(and (member$ (inr$d ?v3 )?v2 )(= (fun_app$w ?v1 ?v3 )?v0 ))))):named a49 ))
(assert (! (forall ((?v0 Dtree_dtree_prod$ )(?v1 T_dtree_dtree_prod_fun$ )(?v2 T_T_sum_set$ ))(= (member$d (inr$a ?v0 )(image$t (map_sum$k id$ ?v1 )?v2 ))(exists ((?v3 T$ ))(and (member$a (inr$c ?v3 )?v2 )(= (fun_app$x ?v1 ?v3 )?v0 ))))):named a50 ))
...
(assert (! (forall ((?v0 T$ )(?v1 Dtree$ ))(= (= (inl$ ?v0 )(inr$ ?v1 ))false )):named a55 ))
(assert (! (forall ((?v0 T$ )(?v1 Dtree_dtree_prod$ ))(= (= (inl$a ?v0 )(inr$a ?v1 ))false )):named a56 ))
...
(assert (! (forall ((?v0 Dtree$ )(?v1 T$ ))(= (= (inr$ ?v0 )(inl$ ?v1 ))false )):named a60 ))
(assert (! (forall ((?v0 Dtree_dtree_prod$ )(?v1 T$ ))(= (= (inr$a ?v0 )(inl$a ?v1 ))false )):named a61 ))
(assert (! (= (vimage$h id$a )id$b ):named a62 ))
(assert (! (= (vimage$i id$c )id$d ):named a63 ))
(assert (! (= (vimage$j id$ )id$a ):named a64 ))
(assert (! (forall ((?v0 Dtree_T_dtree_sum_fun$ )(?v1 T_dtree_sum_set$ )(?v2 T_dtree_sum_set$ ))(= (vimage$ ?v0 (sup$a ?v1 ?v2 ))(sup$b (vimage$ ?v0 ?v1 )(vimage$ ?v0 ?v2 )))):named a65 ))
(assert (! (forall ((?v0 T_T_dtree_sum_fun$ )(?v1 T_dtree_sum_set$ )(?v2 T_dtree_sum_set$ ))(= (vimage$a ?v0 (sup$a ?v1 ?v2 ))(sup$c (vimage$a ?v0 ?v1 )(vimage$a ?v0 ?v2 )))):named a66 ))
...
(assert (! (forall ((?v0 T_T_fun$ )(?v1 T_set$ )(?v2 T_set$ ))(= (fun_app$o (vimage$j ?v0 )(sup$c ?v1 ?v2 ))(sup$c (fun_app$o (vimage$j ?v0 )?v1 )(fun_app$o (vimage$j ?v0 )?v2 )))):named a71 ))
(assert (! (forall ((?v0 Dtree_T_fun$ )(?v1 T_set$ )(?v2 T_set$ ))(= (vimage$n ?v0 (sup$c ?v1 ?v2 ))(sup$b (vimage$n ?v0 ?v1 )(vimage$n ?v0 ?v2 )))):named a72 ))
(assert (! (forall ((?v0 T_dtree_fun$ )(?v1 Dtree_set$ )(?v2 Dtree_set$ ))(= (vimage$o ?v0 (sup$b ?v1 ?v2 ))(sup$c (vimage$o ?v0 ?v1 )(vimage$o ?v0 ?v2 )))):named a73 ))
(assert (! (forall ((?v0 Dtree_dtree_fun$ )(?v1 Dtree_set$ )(?v2 Dtree_set$ ))(= (vimage$p ?v0 (sup$b ?v1 ?v2 ))(sup$b (vimage$p ?v0 ?v1 )(vimage$p ?v0 ?v2 )))):named a74 ))
(assert (! (= (image$w id$a )id$b ):named a75 ))
(assert (! (= (image$d id$c )id$d ):named a76 ))
(assert (! (= (image$e id$e )id$f ):named a77 ))
...
(assert (! (forall ((?v0 T$ )(?v1 Dtree_dtree_prod_dtree_dtree_prod_fun$ )(?v2 T_dtree_dtree_prod_sum_set$ ))(=> (member$d (inl$a ?v0 )(image$i (fun_app$n (map_sum$d id$ )?v1 )?v2 ))(member$d (inl$a ?v0 )?v2 ))):named a82 ))
(assert (! (forall ((?v0 T$ )(?v1 Dtree_dtree_dtree_prod_fun$ )(?v2 T_dtree_sum_set$ ))(=> (member$d (inl$a ?v0 )(image$f (fun_app$m (map_sum$b id$ )?v1 )?v2 ))(member$b (inl$ ?v0 )?v2 ))):named a83 ))
(assert (! (forall ((?v0 T$ )(?v1 Dtree_dtree_fun$ )(?v2 T_dtree_sum_set$ ))(=> (member$b (inl$ ?v0 )(fun_app$j (image$d (fun_app$k (map_sum$a id$ )?v1 ))?v2 ))(member$b (inl$ ?v0 )?v2 ))):named a84 ))
...
(assert (! (forall ((?v0 Dtree$ )(?v1 Dtree_dtree_fun$ )(?v2 T_dtree_sum_set$ ))(=> (member$b (inr$ ?v0 )(fun_app$j (image$d (fun_app$k (map_sum$a id$ )?v1 ))?v2 ))(exists ((?v3 Dtree$ ))(and (member$b (inr$ ?v3 )?v2 )(= (fun_app$p ?v1 ?v3 )?v0 ))))):named a86 ))
(assert (! (forall ((?v0 Dtree_dtree_prod$ )(?v1 Dtree_dtree_dtree_prod_fun$ )(?v2 T_dtree_sum_set$ ))(=> (member$d (inr$a ?v0 )(image$f (fun_app$m (map_sum$b id$ )?v1 )?v2 ))(exists ((?v3 Dtree$ ))(and (member$b (inr$ ?v3 )?v2 )(= (fun_app$q ?v1 ?v3 )?v0 ))))):named a87 ))
...
(assert (! (forall ((?v0 Dtree$ )(?v1 T_dtree_sum_dtree_fun$ )(?v2 T_T_dtree_sum_sum_set$ ))(=> (member$b (inr$ ?v0 )(image$v (map_sum$m id$ ?v1 )?v2 ))(exists ((?v3 T_dtree_sum$ ))(and (member$ (inr$d ?v3 )?v2 )(= (fun_app$w ?v1 ?v3 )?v0 ))))):named a93 ))
(assert (! (forall ((?v0 Dtree_dtree_prod$ )(?v1 T_dtree_dtree_prod_fun$ )(?v2 T_T_sum_set$ ))(=> (member$d (inr$a ?v0 )(image$t (map_sum$k id$ ?v1 )?v2 ))(exists ((?v3 T$ ))(and (member$a (inr$c ?v3 )?v2 )(= (fun_app$x ?v1 ?v3 )?v0 ))))):named a94 ))
...
(assert (! (forall ((?v0 Dtree$ )(?v1 Dtree$ ))(! (= (par_c$ (pair$ ?v0 ?v1 ))(sup$ (image$a uua$ (vimage$a uub$ (sup$a (cont$ ?v0 )(cont$ ?v1 ))))(image$b uuc$ (sigma$ (vimage$ uu$ (cont$ ?v0 ))(uuj$ ?v1 ))))):pattern ((pair$ ?v0 ?v1 )))):named a96 ))
(assert (! (forall ((?v0 Dtree$ )(?v1 Dtree_dtree_prod_dtree_fun$ )(?v2 Dtree_dtree_prod$ )(?v3 Dtree_dtree_prod_set$ ))(=> (and (= ?v0 (fun_app$r ?v1 ?v2 ))(member$e ?v2 ?v3 ))(member$f ?v0 (image$c ?v1 ?v3 )))):named a97 ))
(assert (! (forall ((?v0 T_dtree_dtree_prod_sum$ )(?v1 T_T_dtree_dtree_prod_sum_fun$ )(?v2 T$ )(?v3 T_set$ ))(=> (and (= ?v0 (fun_app$f ?v1 ?v2 ))(member$g ?v2 ?v3 ))(member$d ?v0 (image$a ?v1 ?v3 )))):named a98 ))
(assert (! (forall ((?v0 T_dtree_sum$ )(?v1 T_dtree_dtree_prod_sum_T_dtree_sum_fun$ )(?v2 T_dtree_dtree_prod_sum$ )(?v3 T_dtree_dtree_prod_sum_set$ ))(=> (and (= ?v0 (fun_app$z ?v1 ?v2 ))(member$d ?v2 ?v3 ))(member$b ?v0 (image$ ?v1 ?v3 )))):named a99 ))
(assert (! (forall ((?v0 T_dtree_dtree_prod_sum$ )(?v1 Dtree_dtree_prod_T_dtree_dtree_prod_sum_fun$ )(?v2 Dtree_dtree_prod$ )(?v3 Dtree_dtree_prod_set$ ))(=> (and (= ?v0 (fun_app$a ?v1 ?v2 ))(member$e ?v2 ?v3 ))(member$d ?v0 (image$b ?v1 ?v3 )))):named a100 ))
(assert (! (forall ((?v0 Dtree$ )(?v1 Dtree_dtree_fun$ )(?v2 Dtree$ )(?v3 Dtree_set$ ))(=> (and (= ?v0 (fun_app$p ?v1 ?v2 ))(member$f ?v2 ?v3 ))(member$f ?v0 (fun_app$l (image$e ?v1 )?v3 )))):named a101 ))
(assert (! (forall ((?v0 T$ )(?v1 Dtree_T_fun$ )(?v2 Dtree$ )(?v3 Dtree_set$ ))(=> (and (= ?v0 (fun_app$u ?v1 ?v2 ))(member$f ?v2 ?v3 ))(member$g ?v0 (image$p ?v1 ?v3 )))):named a102 ))
(assert (! (forall ((?v0 Dtree$ )(?v1 T_dtree_fun$ )(?v2 T$ )(?v3 T_set$ ))(=> (and (= ?v0 (fun_app$t ?v1 ?v2 ))(member$g ?v2 ?v3 ))(member$f ?v0 (image$n ?v1 ?v3 )))):named a103 ))
(assert (! (forall ((?v0 T$ )(?v1 T_T_fun$ )(?v2 T$ )(?v3 T_set$ ))(=> (and (= ?v0 (fun_app$v ?v1 ?v2 ))(member$g ?v2 ?v3 ))(member$g ?v0 (fun_app$o (image$r ?v1 )?v3 )))):named a104 ))
(assert (! (forall ((?v0 Dtree$ )(?v1 T_dtree_sum_dtree_fun$ )(?v2 T_dtree_sum$ )(?v3 T_dtree_sum_set$ ))(=> (and (= ?v0 (fun_app$w ?v1 ?v2 ))(member$b ?v2 ?v3 ))(member$f ?v0 (image$x ?v1 ?v3 )))):named a105 ))
(assert (! (forall ((?v0 T$ )(?v1 T_dtree_sum_T_fun$ )(?v2 T_dtree_sum$ )(?v3 T_dtree_sum_set$ ))(=> (and (= ?v0 (fun_app$aa ?v1 ?v2 ))(member$b ?v2 ?v3 ))(member$g ?v0 (image$y ?v1 ?v3 )))):named a106 ))
(assert (! (forall ((?v0 Dtree_dtree_prod$ )(?v1 Dtree_dtree_prod_set$ )(?v2 Dtree_dtree_prod_set$ ))(=> (=> (not (member$e ?v0 ?v1 ))(member$e ?v0 ?v2 ))(member$e ?v0 (sup$d ?v2 ?v1 )))):named a107 ))
(assert (! (forall ((?v0 T$ )(?v1 T_set$ )(?v2 T_set$ ))(=> (=> (not (member$g ?v0 ?v1 ))(member$g ?v0 ?v2 ))(member$g ?v0 (sup$c ?v2 ?v1 )))):named a108 ))
(assert (! (forall ((?v0 Dtree$ )(?v1 Dtree_set$ )(?v2 Dtree_set$ ))(=> (=> (not (member$f ?v0 ?v1 ))(member$f ?v0 ?v2 ))(member$f ?v0 (sup$b ?v2 ?v1 )))):named a109 ))
...
(assert (! (forall ((?v0 Dtree_dtree_prod$ )(?v1 Dtree_dtree_prod_set$ )(?v2 Dtree_dtree_prod_set$ ))(= (member$e ?v0 (sup$d ?v1 ?v2 ))(or (member$e ?v0 ?v1 )(member$e ?v0 ?v2 )))):named a112 ))
(assert (! (forall ((?v0 T$ )(?v1 T_set$ )(?v2 T_set$ ))(= (member$g ?v0 (sup$c ?v1 ?v2 ))(or (member$g ?v0 ?v1 )(member$g ?v0 ?v2 )))):named a113 ))
(assert (! (forall ((?v0 Dtree$ )(?v1 Dtree_set$ )(?v2 Dtree_set$ ))(= (member$f ?v0 (sup$b ?v1 ?v2 ))(or (member$f ?v0 ?v1 )(member$f ?v0 ?v2 )))):named a114 ))
...
(assert (! (forall ((?v0 Dtree_T_dtree_sum_fun$ )(?v1 Dtree$ )(?v2 T_dtree_sum$ )(?v3 T_dtree_sum_set$ ))(=> (and (= (fun_app$d ?v0 ?v1 )?v2 )(member$b ?v2 ?v3 ))(member$f ?v1 (vimage$ ?v0 ?v3 )))):named a119 ))
(assert (! (forall ((?v0 T_T_dtree_sum_fun$ )(?v1 T$ )(?v2 T_dtree_sum$ )(?v3 T_dtree_sum_set$ ))(=> (and (= (fun_app$h ?v0 ?v1 )?v2 )(member$b ?v2 ?v3 ))(member$g ?v1 (vimage$a ?v0 ?v3 )))):named a120 ))
(assert (! (forall ((?v0 Dtree_dtree_fun$ )(?v1 Dtree$ )(?v2 Dtree$ )(?v3 Dtree_set$ ))(=> (and (= (fun_app$p ?v0 ?v1 )?v2 )(member$f ?v2 ?v3 ))(member$f ?v1 (vimage$p ?v0 ?v3 )))):named a121 ))
(assert (! (forall ((?v0 T_dtree_fun$ )(?v1 T$ )(?v2 Dtree$ )(?v3 Dtree_set$ ))(=> (and (= (fun_app$t ?v0 ?v1 )?v2 )(member$f ?v2 ?v3 ))(member$g ?v1 (vimage$o ?v0 ?v3 )))):named a122 ))
(assert (! (forall ((?v0 Dtree_T_fun$ )(?v1 Dtree$ )(?v2 T$ )(?v3 T_set$ ))(=> (and (= (fun_app$u ?v0 ?v1 )?v2 )(member$g ?v2 ?v3 ))(member$f ?v1 (vimage$n ?v0 ?v3 )))):named a123 ))
(assert (! (forall ((?v0 T_T_fun$ )(?v1 T$ )(?v2 T$ )(?v3 T_set$ ))(=> (and (= (fun_app$v ?v0 ?v1 )?v2 )(member$g ?v2 ?v3 ))(member$g ?v1 (fun_app$o (vimage$j ?v0 )?v3 )))):named a124 ))
(assert (! (forall ((?v0 Dtree_dtree_dtree_prod_fun$ )(?v1 Dtree$ )(?v2 Dtree_dtree_prod$ )(?v3 Dtree_dtree_prod_set$ ))(=> (and (= (fun_app$q ?v0 ?v1 )?v2 )(member$e ?v2 ?v3 ))(member$f ?v1 (vimage$q ?v0 ?v3 )))):named a125 ))
(assert (! (forall ((?v0 T_dtree_dtree_prod_fun$ )(?v1 T$ )(?v2 Dtree_dtree_prod$ )(?v3 Dtree_dtree_prod_set$ ))(=> (and (= (fun_app$x ?v0 ?v1 )?v2 )(member$e ?v2 ?v3 ))(member$g ?v1 (vimage$r ?v0 ?v3 )))):named a126 ))
(assert (! (forall ((?v0 T_dtree_sum_dtree_fun$ )(?v1 T_dtree_sum$ )(?v2 Dtree$ )(?v3 Dtree_set$ ))(=> (and (= (fun_app$w ?v0 ?v1 )?v2 )(member$f ?v2 ?v3 ))(member$b ?v1 (vimage$s ?v0 ?v3 )))):named a127 ))
(assert (! (forall ((?v0 Dtree_dtree_prod_dtree_fun$ )(?v1 Dtree_dtree_prod$ )(?v2 Dtree$ )(?v3 Dtree_set$ ))(=> (and (= (fun_app$r ?v0 ?v1 )?v2 )(member$f ?v2 ?v3 ))(member$e ?v1 (vimage$t ?v0 ?v3 )))):named a128 ))
(check-sat )
;(get-unsat-core )
