...
(declare-datatypes ()((Dtree_dtree_prod$ (pair$ (fst$ Dtree$ )(snd$ Dtree$ )))(T_dtree_dtree_prod_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree_dtree_prod$ )))(T_dtree_sum$ (inl$a (projl$a T$ ))(inr$a (projr$a Dtree$ )))(T_dtree_dtree_prod_sum_T_dtree_dtree_prod_sum_prod$ (pair$a (fst$a T_dtree_dtree_prod_sum$ )(snd$a T_dtree_dtree_prod_sum$ )))(T_dtree_sum_dtree_prod$ (pair$b (fst$b T_dtree_sum$ )(snd$b Dtree$ )))(Dtree_T_dtree_dtree_prod_sum_T_dtree_dtree_prod_sum_prod_prod$ (pair$c (fst$c Dtree$ )(snd$c T_dtree_dtree_prod_sum_T_dtree_dtree_prod_sum_prod$ )))(Dtree_dtree_dtree_prod_prod$ (pair$d (fst$d Dtree$ )(snd$d Dtree_dtree_prod$ )))(Dtree_T_dtree_dtree_prod_sum_prod$ (pair$e (fst$e Dtree$ )(snd$e T_dtree_dtree_prod_sum$ )))))
