...
(assert (! (forall ((?v0 Dtree$ )(?v1 Dtree$ )(?v2 Dtree$ ))(=> (and (= trA$ (par$ (pair$ (par$ (pair$ ?v0 ?v1 ))?v2 )))(and (member$ (inr$ ?v0 )(cont$ tr1a$ ))(and (member$ (inr$ ?v1 )(cont$ tr2a$ ))(member$ (inr$ ?v2 )(cont$ tr3a$ )))))thesis$ )):named a1 ))
(assert (! (exists ((?v0 Dtree$ )(?v1 Dtree$ )(?v2 Dtree$ ))(and (= trA$a (par$ (pair$ (par$ (pair$ ?v0 ?v1 ))?v2 )))(= trB$ (par$ (pair$ ?v0 (par$ (pair$ ?v1 ?v2 ))))))):named a2 ))
(assert (! (member$ (inr$ trA$ )(cont$ (par$ (pair$ (par$ (pair$ tr1a$ tr2a$ ))tr3a$ )))):named a3 ))
