...
(declare-datatypes ()((T_dtree_sum$ (inl$ (projl$ T$ ))(inr$ (projr$ Dtree$ )))(Dtree_dtree_prod$ (pair$ (fst$ Dtree$ )(snd$ Dtree$ )))(T_dtree_sum_dtree_prod$ (pair$a (fst$a T_dtree_sum$ )(snd$a Dtree$ )))(Dtree_T_dtree_sum_prod$ (pair$b (fst$b Dtree$ )(snd$b T_dtree_sum$ )))(T_dtree_sum_T_dtree_sum_prod$ (pair$c (fst$c T_dtree_sum$ )(snd$c T_dtree_sum$ )))(Dtree_dtree_dtree_prod_prod$ (pair$d (fst$d Dtree$ )(snd$d Dtree_dtree_prod$ )))(Dtree_dtree_prod_dtree_prod$ (pair$e (fst$e Dtree_dtree_prod$ )(snd$e Dtree$ )))(T_dtree_sum_dtree_dtree_prod_prod$ (pair$f (fst$f T_dtree_sum$ )(snd$f Dtree_dtree_prod$ )))(Dtree_dtree_T_dtree_sum_prod_prod$ (pair$g (fst$g Dtree$ )(snd$g Dtree_T_dtree_sum_prod$ )))(Dtree_T_dtree_sum_dtree_prod_prod$ (pair$h (fst$h Dtree$ )(snd$h T_dtree_sum_dtree_prod$ )))(Dtree_dtree_prod_T_dtree_sum_prod$ (pair$i (fst$i Dtree_dtree_prod$ )(snd$i T_dtree_sum$ )))))
(declare-fun t$ ()Dtree$ )
