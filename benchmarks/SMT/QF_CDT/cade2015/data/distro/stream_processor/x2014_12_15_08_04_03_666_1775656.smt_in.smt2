...
(declare-datatypes ()((C_stream_b_stream_prod$ (pair$ (fst$ C_stream$ )(snd$ B_stream$ )))(B_stream_c_stream_prod$ (pair$a (fst$a B_stream$ )(snd$a C_stream$ )))(A_stream_b_stream_fun_a_stream_b_stream_fun_prod$ (pair$b (select$ A_stream_b_stream_fun$ )(selecta$ A_stream_b_stream_fun$ )))(B_b_prod$ (pair$c (fst$b B$ )(snd$b B$ )))(B_stream_b_stream_prod$ (pair$d (fst$c B_stream$ )(snd$c B_stream$ )))(C_stream_c_stream_prod$ (pair$e (fst$d C_stream$ )(snd$d C_stream$ )))))
...
(declare-datatypes ()((C_c_prod$ (pair$f (fst$e C$ )(snd$e C$ )))(B_stream_b_prod$ (pair$g (fst$f B_stream$ )(snd$f B$ )))(C_stream_c_prod$ (pair$h (fst$g C_stream$ )(snd$g C$ )))(B_stream_c_prod$ (pair$i (fst$h B_stream$ )(snd$h C$ )))(C_stream_b_prod$ (pair$j (fst$i C_stream$ )(snd$i B$ )))(A_stream_c_prod$ (pair$k (fst$j A_stream$ )(snd$j C$ )))(B_b_stream_prod$ (pair$l (fst$k B$ )(snd$k B_stream$ )))(C_c_stream_prod$ (pair$m (fst$l C$ )(snd$l C_stream$ )))(C_b_stream_prod$ (pair$n (fst$m C$ )(snd$m B_stream$ )))(B_c_stream_prod$ (pair$o (fst$n B$ )(snd$n C_stream$ )))(C_a_stream_prod$ (pair$p (fst$o C$ )(snd$o A_stream$ )))(A_stream_b_stream_prod$ (pair$q (fst$p A_stream$ )(snd$p B_stream$ )))(A_stream_c_stream_prod$ (pair$r (fst$q A_stream$ )(snd$q C_stream$ )))(A_stream_a_stream_prod$ (pair$s (fst$r A_stream$ )(snd$r A_stream$ )))))
