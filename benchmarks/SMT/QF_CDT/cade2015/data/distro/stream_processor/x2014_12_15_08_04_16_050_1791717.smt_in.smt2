...
(declare-datatypes ()((C_b_sp_nu_a_c_sp_nu_prod$ (pair$d (fst$d C_b_sp_nu$ )(snd$d A_c_sp_nu$ )))(B_c_b_sp_nu_a_c_sp_nu_prod_prod$ (pair$e (fst$e B$ )(snd$e C_b_sp_nu_a_c_sp_nu_prod$ )))(B_c_b_sp_nu_a_c_sp_nu_prod_prod_a_stream_prod$ (pair$f (fst$f B_c_b_sp_nu_a_c_sp_nu_prod_prod$ )(snd$f A_stream$ )))(C_a_c_sp_nu_prod$ (pair$g (fst$g C$ )(snd$g A_c_sp_nu$ )))(C_a_c_sp_nu_prod_a_stream_prod$ (pair$h (fst$h C_a_c_sp_nu_prod$ )(snd$h A_stream$ )))(B_c_b_sp_nu_prod$ (pair$i (fst$i B$ )(snd$i C_b_sp_nu$ )))(B_c_b_sp_nu_prod_c_stream_prod$ (pair$j (fst$j B_c_b_sp_nu_prod$ )(snd$j C_stream$ )))(A_c_a_c_sp_nu_sp_mu_a_c_a_c_sp_nu_sp_mu_prod$ (pair$k (fst$k A_c_a_c_sp_nu_sp_mu$ )(snd$k A_c_a_c_sp_nu_sp_mu$ )))(C_b_c_b_sp_nu_sp_mu_c_b_c_b_sp_nu_sp_mu_prod$ (pair$l (fst$l C_b_c_b_sp_nu_sp_mu$ )(snd$l C_b_c_b_sp_nu_sp_mu$ )))(A_bool_fun_a_stream_prod$ (pair$m (select$ A_bool_fun$ )(selecta$ A_stream$ )))(B_bool_fun_b_stream_prod$ (pair$n (selectb$ B_bool_fun$ )(selectc$ B_stream$ )))(C_b_c_b_sp_nu_sp_mu_a_c_a_c_sp_nu_sp_mu_prod$ (pair$o (fst$m C_b_c_b_sp_nu_sp_mu$ )(snd$m A_c_a_c_sp_nu_sp_mu$ )))))
