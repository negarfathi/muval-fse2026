...
(declare-datatypes ()((A_b_c_sp_mu_a_b_c_sp_mu_prod$ (pair$ (fst$ A_b_c_sp_mu$ )(snd$ A_b_c_sp_mu$ )))(B_c_prod$ (pair$a (fst$a B$ )(snd$a C$ )))))
(declare-sort A_stream$ 0)
(declare-fun shd$ (A_stream$)A$)
(declare-fun stl$ (A_stream$)A_stream$)
(declare-fun sCons$ (A$ A_stream$ )A_stream$)
(declare-datatypes ()((B_c_prod_a_stream_prod$ (pair$b (fst$b B_c_prod$ )(snd$b A_stream$ )))(A_stream_b_c_prod_prod$ (pair$c (fst$c A_stream$ )(snd$c B_c_prod$ )))(C_b_prod$ (pair$d (fst$d C$ )(snd$d B$ )))))
