...
(declare-datatypes ()((A_b_c_sp_mu_d_a_d_a_sp_nu_sp_mu_prod$ (pair$ (fst$ A_b_c_sp_mu$ )(snd$ D_a_d_a_sp_nu_sp_mu$ )))(C_d_a_sp_nu_prod$ (pair$a (fst$a C$ )(snd$a D_a_sp_nu$ )))(A_b_c_sp_mu_a_b_c_sp_mu_prod$ (pair$b (fst$b A_b_c_sp_mu$ )(snd$b A_b_c_sp_mu$ )))(D_a_d_a_sp_nu_sp_mu_d_a_d_a_sp_nu_sp_mu_prod$ (pair$c (fst$c D_a_d_a_sp_nu_sp_mu$ )(snd$c D_a_d_a_sp_nu_sp_mu$ )))(D_b_c_d_a_sp_nu_prod_sp_mu_d_b_c_d_a_sp_nu_prod_sp_mu_prod$ (pair$d (fst$d D_b_c_d_a_sp_nu_prod_sp_mu$ )(snd$d D_b_c_d_a_sp_nu_prod_sp_mu$ )))(B_c_prod$ (pair$e (fst$e B$ )(snd$e C$ )))))
(declare-sort A_stream$ 0)
(declare-fun shd$ (A_stream$)A$)
(declare-fun stl$ (A_stream$)A_stream$)
(declare-fun sCons$ (A$ A_stream$ )A_stream$)
(declare-datatypes ()((B_c_prod_a_stream_prod$ (pair$f (fst$f B_c_prod$ )(snd$f A_stream$ )))(A_d_a_sp_nu_prod$ (pair$g (fst$g A$ )(snd$g D_a_sp_nu$ )))))
...
(declare-datatypes ()((A_d_a_sp_nu_prod_d_stream_prod$ (pair$h (fst$h A_d_a_sp_nu_prod$ )(snd$h D_stream$ )))(B_c_d_a_sp_nu_prod_prod$ (pair$i (fst$i B$ )(snd$i C_d_a_sp_nu_prod$ )))(B_c_d_a_sp_nu_prod_prod_d_stream_prod$ (pair$j (fst$j B_c_d_a_sp_nu_prod_prod$ )(snd$j D_stream$ )))(A_b_c_sp_mu_d_a_d_a_sp_nu_sp_mu_prod_a_b_c_sp_mu_d_a_d_a_sp_nu_sp_mu_prod_prod$ (pair$k (fst$k A_b_c_sp_mu_d_a_d_a_sp_nu_sp_mu_prod$ )(snd$k A_b_c_sp_mu_d_a_d_a_sp_nu_sp_mu_prod$ )))(C_d_a_sp_nu_prod_c_d_a_sp_nu_prod_prod$ (pair$l (fst$l C_d_a_sp_nu_prod$ )(snd$l C_d_a_sp_nu_prod$ )))(D_a_sp_nu_c_prod$ (pair$m (fst$m D_a_sp_nu$ )(snd$m C$ )))(D_a_d_a_sp_nu_sp_mu_a_b_c_sp_mu_prod$ (pair$n (fst$n D_a_d_a_sp_nu_sp_mu$ )(snd$n A_b_c_sp_mu$ )))(C_b_prod$ (pair$o (fst$o C$ )(snd$o B$ )))(D_a_sp_nu_a_prod$ (pair$p (fst$p D_a_sp_nu$ )(snd$p A$ )))(A_stream_b_c_prod_prod$ (pair$q (fst$q A_stream$ )(snd$q B_c_prod$ )))(D_a_sp_nu_d_a_sp_nu_prod$ (pair$r (fst$r D_a_sp_nu$ )(snd$r D_a_sp_nu$ )))))
(declare-fun p$ ()Bool )
