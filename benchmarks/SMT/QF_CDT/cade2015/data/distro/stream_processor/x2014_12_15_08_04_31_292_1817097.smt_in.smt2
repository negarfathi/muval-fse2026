...
(declare-datatypes ()((C_b_sp_nu_a_c_sp_nu_prod$ (pair$ (fst$ C_b_sp_nu$ )(snd$ A_c_sp_nu$ )))(C_b_c_b_sp_nu_sp_mu_c_b_c_b_sp_nu_sp_mu_prod$ (pair$a (fst$a C_b_c_b_sp_nu_sp_mu$ )(snd$a C_b_c_b_sp_nu_sp_mu$ )))(B_c_b_sp_nu_prod$ (pair$b (fst$b B$ )(snd$b C_b_sp_nu$ )))(B_c_b_sp_nu_prod_c_stream_prod$ (pair$c (fst$c B_c_b_sp_nu_prod$ )(snd$c C_stream$ )))(C_b_c_b_sp_nu_sp_mu_a_c_a_c_sp_nu_sp_mu_prod$ (pair$d (fst$d C_b_c_b_sp_nu_sp_mu$ )(snd$d A_c_a_c_sp_nu_sp_mu$ )))(C_a_c_sp_nu_prod$ (pair$e (fst$e C$ )(snd$e A_c_sp_nu$ )))(C_a_c_sp_nu_prod_a_stream_prod$ (pair$f (fst$f C_a_c_sp_nu_prod$ )(snd$f A_stream$ )))))
(declare-fun b$ ()C$ )
