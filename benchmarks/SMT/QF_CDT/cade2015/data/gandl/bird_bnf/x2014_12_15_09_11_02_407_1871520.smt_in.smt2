...
(declare-fun selectc$ (A_a_b_a_fun_fun_fun_tree$)A_a_b_a_fun_fun_fun$)
(declare-fun selectd$ (A_a_b_a_fun_fun_fun_tree$)A_a_b_a_fun_fun_fun_tree$)
(declare-fun selecte$ (A_a_b_a_fun_fun_fun_tree$)A_a_b_a_fun_fun_fun_tree$)
(declare-fun node$c (A_a_b_a_fun_fun_fun$ A_a_b_a_fun_fun_fun_tree$ A_a_b_a_fun_fun_fun_tree$ )A_a_b_a_fun_fun_fun_tree$)
...
(declare-fun node$d (A_b_a_fun_fun$ A_b_a_fun_fun_tree$ A_b_a_fun_fun_tree$ )A_b_a_fun_fun_tree$)
...
(declare-fun selectu$ (B_a_a_fun_fun_tree$)B_a_a_fun_fun$)
(declare-fun selectv$ (B_a_a_fun_fun_tree$)B_a_a_fun_fun_tree$)
(declare-fun selectw$ (B_a_a_fun_fun_tree$)B_a_a_fun_fun_tree$)
(declare-fun node$i (B_a_a_fun_fun$ B_a_a_fun_fun_tree$ B_a_a_fun_fun_tree$ )B_a_a_fun_fun_tree$)
...
(declare-fun selecua$ (B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_a_b_a_fun_fun_fun$)
(declare-fun selecub$ (B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)
(declare-fun selecuc$ (B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)
(declare-fun node$k (B_a_a_fun_fun_a_b_a_fun_fun_fun$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ )B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)
(declare-fun selecud$ (B_b_b_a_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun$)
(declare-fun selecue$ (B_b_b_a_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_tree$)
(declare-fun selecuf$ (B_b_b_a_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_tree$)
(declare-fun node$l (B_b_b_a_fun_fun_fun$ B_b_b_a_fun_fun_fun_tree$ B_b_b_a_fun_fun_fun_tree$ )B_b_b_a_fun_fun_fun_tree$)
(declare-fun selecug$ (B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun$)
(declare-fun selecuh$ (B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecui$ (B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun node$m (B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ )B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecuj$ (B_a_b_a_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun$)
(declare-fun selecuk$ (B_a_b_a_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_tree$)
(declare-fun selecul$ (B_a_b_a_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_tree$)
(declare-fun node$n (B_a_b_a_fun_fun_fun$ B_a_b_a_fun_fun_fun_tree$ B_a_b_a_fun_fun_fun_tree$ )B_a_b_a_fun_fun_fun_tree$)
(declare-fun selecum$ (A_b_b_a_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun$)
(declare-fun selecun$ (A_b_b_a_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun_tree$)
(declare-fun selecuo$ (A_b_b_a_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun_tree$)
(declare-fun node$o (A_b_b_a_fun_fun_fun$ A_b_b_a_fun_fun_fun_tree$ A_b_b_a_fun_fun_fun_tree$ )A_b_b_a_fun_fun_fun_tree$)
(declare-fun selecup$ (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun$)
(declare-fun selecuq$ (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecur$ (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun node$p (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$ )B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecus$ (B_b_a_a_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun$)
(declare-fun selecut$ (B_b_a_a_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun_tree$)
(declare-fun selecuu$ (B_b_a_a_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun_tree$)
(declare-fun node$q (B_b_a_a_fun_fun_fun$ B_b_a_a_fun_fun_fun_tree$ B_b_a_a_fun_fun_fun_tree$ )B_b_a_a_fun_fun_fun_tree$)
(declare-fun selecuv$ (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun$)
(declare-fun selecuw$ (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecux$ (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)
(declare-fun node$r (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$ )B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecuy$ (B_b_b_fun_fun_tree$)B_b_b_fun_fun$)
(declare-fun selecuz$ (B_b_b_fun_fun_tree$)B_b_b_fun_fun_tree$)
(declare-fun selecva$ (B_b_b_fun_fun_tree$)B_b_b_fun_fun_tree$)
(declare-fun node$s (B_b_b_fun_fun$ B_b_b_fun_fun_tree$ B_b_b_fun_fun_tree$ )B_b_b_fun_fun_tree$)
(declare-fun selecvb$ (B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)B_b_b_fun_fun_b_b_b_fun_fun_fun$)
(declare-fun selecvc$ (B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)
(declare-fun selecvd$ (B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)
(declare-fun node$t (B_b_b_fun_fun_b_b_b_fun_fun_fun$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ )B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)
(declare-fun selecve$ (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun$)
(declare-fun selecvf$ (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecvg$ (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)
(declare-fun node$u (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ )A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)
...
(declare-fun selecvk$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun$)
(declare-fun selecvl$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)
...
(declare-fun selecvn$ (A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)A_b_a_fun_fun_b_a_a_fun_fun_fun$)
(declare-fun selecvo$ (A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)
(declare-fun selecvp$ (A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)
...
(declare-fun selecvq$ (B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_a_fun_fun_fun$)
(declare-fun selecvr$ (B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)
(declare-fun selecvs$ (B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)
...
(declare-fun selecvt$ (B_a_fun_b_a_fun_fun_tree$)B_a_fun_b_a_fun_fun$)
(declare-fun selecvu$ (B_a_fun_b_a_fun_fun_tree$)B_a_fun_b_a_fun_fun_tree$)
(declare-fun selecvv$ (B_a_fun_b_a_fun_fun_tree$)B_a_fun_b_a_fun_fun_tree$)
(declare-fun node$z (B_a_fun_b_a_fun_fun$ B_a_fun_b_a_fun_fun_tree$ B_a_fun_b_a_fun_fun_tree$ )B_a_fun_b_a_fun_fun_tree$)
(declare-fun selecvw$ (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun$)
(declare-fun selecvx$ (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)
(declare-fun selecvy$ (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)
...
(declare-fun selecvz$ (B_b_fun_b_a_fun_fun_tree$)B_b_fun_b_a_fun_fun$)
(declare-fun selecwa$ (B_b_fun_b_a_fun_fun_tree$)B_b_fun_b_a_fun_fun_tree$)
(declare-fun selecwb$ (B_b_fun_b_a_fun_fun_tree$)B_b_fun_b_a_fun_fun_tree$)
(declare-fun node$ab (B_b_fun_b_a_fun_fun$ B_b_fun_b_a_fun_fun_tree$ B_b_fun_b_a_fun_fun_tree$ )B_b_fun_b_a_fun_fun_tree$)
(declare-fun selecwc$ (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun$)
(declare-fun selecwd$ (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)
(declare-fun selecwe$ (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)
...
(declare-fun selecwi$ (B_a_fun_b_b_fun_fun_tree$)B_a_fun_b_b_fun_fun$)
(declare-fun selecwj$ (B_a_fun_b_b_fun_fun_tree$)B_a_fun_b_b_fun_fun_tree$)
(declare-fun selecwk$ (B_a_fun_b_b_fun_fun_tree$)B_a_fun_b_b_fun_fun_tree$)
(declare-fun node$ae (B_a_fun_b_b_fun_fun$ B_a_fun_b_b_fun_fun_tree$ B_a_fun_b_b_fun_fun_tree$ )B_a_fun_b_b_fun_fun_tree$)
(declare-fun selecwl$ (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun$)
(declare-fun selecwm$ (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)
(declare-fun selecwn$ (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)
