...
(declare-sort A_b_b_fun_fun_stream$ 0)
(declare-sort A_b_b_fun_fun_a_b_b_fun_fun_fun_stream$ 0)
...
(declare-fun sCons$c (B_b_fun$ B_b_fun_stream$ )B_b_fun_stream$)
(declare-fun selectd$ (A_a_fun_stream$)A_a_fun$)
(declare-fun selecte$ (A_a_fun_stream$)A_a_fun_stream$)
(declare-fun sCons$d (A_a_fun$ A_a_fun_stream$ )A_a_fun_stream$)
(declare-fun selectf$ (B_a_fun_b_a_fun_fun_stream$)B_a_fun_b_a_fun_fun$)
(declare-fun selectg$ (B_a_fun_b_a_fun_fun_stream$)B_a_fun_b_a_fun_fun_stream$)
(declare-fun sCons$e (B_a_fun_b_a_fun_fun$ B_a_fun_b_a_fun_fun_stream$ )B_a_fun_b_a_fun_fun_stream$)
(declare-fun selecth$ (B_b_fun_b_b_fun_fun_stream$)B_b_fun_b_b_fun_fun$)
(declare-fun selecti$ (B_b_fun_b_b_fun_fun_stream$)B_b_fun_b_b_fun_fun_stream$)
(declare-fun sCons$f (B_b_fun_b_b_fun_fun$ B_b_fun_b_b_fun_fun_stream$ )B_b_fun_b_b_fun_fun_stream$)
...
(declare-fun selectl$ (A_b_fun_a_b_fun_fun_stream$)A_b_fun_a_b_fun_fun$)
(declare-fun selectm$ (A_b_fun_a_b_fun_fun_stream$)A_b_fun_a_b_fun_fun_stream$)
(declare-fun sCons$h (A_b_fun_a_b_fun_fun$ A_b_fun_a_b_fun_fun_stream$ )A_b_fun_a_b_fun_fun_stream$)
(declare-fun selectn$ (A_a_fun_a_a_fun_fun_stream$)A_a_fun_a_a_fun_fun$)
(declare-fun selecto$ (A_a_fun_a_a_fun_fun_stream$)A_a_fun_a_a_fun_fun_stream$)
...
(declare-fun selectr$ (B_b_a_fun_fun_b_b_a_fun_fun_fun_stream$)B_b_a_fun_fun_b_b_a_fun_fun_fun$)
(declare-fun selects$ (B_b_a_fun_fun_b_b_a_fun_fun_fun_stream$)B_b_a_fun_fun_b_b_a_fun_fun_fun_stream$)
(declare-fun sCons$k (B_b_a_fun_fun_b_b_a_fun_fun_fun$ B_b_a_fun_fun_b_b_a_fun_fun_fun_stream$ )B_b_a_fun_fun_b_b_a_fun_fun_fun_stream$)
(declare-fun selectt$ (A_b_a_fun_fun_stream$)A_b_a_fun_fun$)
(declare-fun selectu$ (A_b_a_fun_fun_stream$)A_b_a_fun_fun_stream$)
(declare-fun sCons$l (A_b_a_fun_fun$ A_b_a_fun_fun_stream$ )A_b_a_fun_fun_stream$)
(declare-fun selectv$ (A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$)A_b_a_fun_fun_a_b_a_fun_fun_fun$)
(declare-fun selectw$ (A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$)A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$)
(declare-fun sCons$m (A_b_a_fun_fun_a_b_a_fun_fun_fun$ A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$ )A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$)
(declare-fun selectx$ (A_b_b_fun_fun_stream$)A_b_b_fun_fun$)
(declare-fun selecty$ (A_b_b_fun_fun_stream$)A_b_b_fun_fun_stream$)
(declare-fun sCons$n (A_b_b_fun_fun$ A_b_b_fun_fun_stream$ )A_b_b_fun_fun_stream$)
(declare-fun selectz$ (A_b_b_fun_fun_a_b_b_fun_fun_fun_stream$)A_b_b_fun_fun_a_b_b_fun_fun_fun$)
(declare-fun selecua$ (A_b_b_fun_fun_a_b_b_fun_fun_fun_stream$)A_b_b_fun_fun_a_b_b_fun_fun_fun_stream$)
(declare-fun sCons$o (A_b_b_fun_fun_a_b_b_fun_fun_fun$ A_b_b_fun_fun_a_b_b_fun_fun_fun_stream$ )A_b_b_fun_fun_a_b_b_fun_fun_fun_stream$)
(declare-fun selecub$ (A_a_b_fun_fun_stream$)A_a_b_fun_fun$)
(declare-fun selecuc$ (A_a_b_fun_fun_stream$)A_a_b_fun_fun_stream$)
(declare-fun sCons$p (A_a_b_fun_fun$ A_a_b_fun_fun_stream$ )A_a_b_fun_fun_stream$)
(declare-fun selecud$ (A_a_b_fun_fun_a_a_b_fun_fun_fun_stream$)A_a_b_fun_fun_a_a_b_fun_fun_fun$)
(declare-fun selecue$ (A_a_b_fun_fun_a_a_b_fun_fun_fun_stream$)A_a_b_fun_fun_a_a_b_fun_fun_fun_stream$)
(declare-fun sCons$q (A_a_b_fun_fun_a_a_b_fun_fun_fun$ A_a_b_fun_fun_a_a_b_fun_fun_fun_stream$ )A_a_b_fun_fun_a_a_b_fun_fun_fun_stream$)
(declare-fun shd$b (B_stream_stream$)B_stream$)
(declare-fun stl$b (B_stream_stream$)B_stream_stream$)
(declare-fun sCons$r (B_stream$ B_stream_stream$ )B_stream_stream$)
(declare-fun shd$c (A_stream_stream$)A_stream$)
(declare-fun stl$c (A_stream_stream$)A_stream_stream$)
(declare-fun sCons$s (A_stream$ A_stream_stream$ )A_stream_stream$)
(declare-fun selecuf$ (B_b_a_fun_fun_tree$)B_b_a_fun_fun$)
(declare-fun selecug$ (B_b_a_fun_fun_tree$)B_b_a_fun_fun_tree$)
(declare-fun selecuh$ (B_b_a_fun_fun_tree$)B_b_a_fun_fun_tree$)
(declare-fun node$ (B_b_a_fun_fun$ B_b_a_fun_fun_tree$ B_b_a_fun_fun_tree$ )B_b_a_fun_fun_tree$)
(declare-fun selecui$ (B_b_fun_tree$)B_b_fun$)
(declare-fun selecuj$ (B_b_fun_tree$)B_b_fun_tree$)
(declare-fun selecuk$ (B_b_fun_tree$)B_b_fun_tree$)
(declare-fun node$a (B_b_fun$ B_b_fun_tree$ B_b_fun_tree$ )B_b_fun_tree$)
(declare-fun selecul$ (A_b_a_fun_fun_tree$)A_b_a_fun_fun$)
(declare-fun selecum$ (A_b_a_fun_fun_tree$)A_b_a_fun_fun_tree$)
(declare-fun selecun$ (A_b_a_fun_fun_tree$)A_b_a_fun_fun_tree$)
(declare-fun node$b (A_b_a_fun_fun$ A_b_a_fun_fun_tree$ A_b_a_fun_fun_tree$ )A_b_a_fun_fun_tree$)
(declare-fun selecuo$ (A_b_fun_tree$)A_b_fun$)
(declare-fun selecup$ (A_b_fun_tree$)A_b_fun_tree$)
(declare-fun selecuq$ (A_b_fun_tree$)A_b_fun_tree$)
(declare-fun node$c (A_b_fun$ A_b_fun_tree$ A_b_fun_tree$ )A_b_fun_tree$)
(declare-fun selecur$ (A_a_fun_tree$)A_a_fun$)
(declare-fun selecus$ (A_a_fun_tree$)A_a_fun_tree$)
(declare-fun selecut$ (A_a_fun_tree$)A_a_fun_tree$)
(declare-fun node$d (A_a_fun$ A_a_fun_tree$ A_a_fun_tree$ )A_a_fun_tree$)
(declare-fun selecuu$ (B_a_fun_tree$)B_a_fun$)
(declare-fun selecuv$ (B_a_fun_tree$)B_a_fun_tree$)
(declare-fun selecuw$ (B_a_fun_tree$)B_a_fun_tree$)
