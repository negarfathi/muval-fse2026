...
(declare-sort Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$ 0)
...
(declare-sort Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$ 0)
(declare-sort Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$ 0)
(declare-sort Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$ 0)
(declare-sort Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun_tree$ 0)
(declare-sort Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$ 0)
(declare-sort Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$ 0)
...
(declare-fun selectf$ (Nat_nat_nat_prod_fun_tree$)Nat_nat_nat_prod_fun$)
(declare-fun selectg$ (Nat_nat_nat_prod_fun_tree$)Nat_nat_nat_prod_fun_tree$)
(declare-fun selecth$ (Nat_nat_nat_prod_fun_tree$)Nat_nat_nat_prod_fun_tree$)
(declare-fun node$d (Nat_nat_nat_prod_fun$ Nat_nat_nat_prod_fun_tree$ Nat_nat_nat_prod_fun_tree$ )Nat_nat_nat_prod_fun_tree$)
...
(declare-fun selectr$ (Nat_nat_nat_prod_fun_nat_fun_tree$)Nat_nat_nat_prod_fun_nat_fun$)
(declare-fun selects$ (Nat_nat_nat_prod_fun_nat_fun_tree$)Nat_nat_nat_prod_fun_nat_fun_tree$)
(declare-fun selectt$ (Nat_nat_nat_prod_fun_nat_fun_tree$)Nat_nat_nat_prod_fun_nat_fun_tree$)
(declare-fun node$h (Nat_nat_nat_prod_fun_nat_fun$ Nat_nat_nat_prod_fun_nat_fun_tree$ Nat_nat_nat_prod_fun_nat_fun_tree$ )Nat_nat_nat_prod_fun_nat_fun_tree$)
(declare-fun selectu$ (Nat_nat_prod_nat_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_fun$)
(declare-fun selectv$ (Nat_nat_prod_nat_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_fun_tree$)
(declare-fun selectw$ (Nat_nat_prod_nat_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_fun_tree$)
(declare-fun node$i (Nat_nat_prod_nat_fun_nat_fun$ Nat_nat_prod_nat_fun_nat_fun_tree$ Nat_nat_prod_nat_fun_nat_fun_tree$ )Nat_nat_prod_nat_fun_nat_fun_tree$)
...
(declare-fun selecua$ (Nat_nat_nat_nat_prod_fun_fun_tree$)Nat_nat_nat_nat_prod_fun_fun$)
(declare-fun selecub$ (Nat_nat_nat_nat_prod_fun_fun_tree$)Nat_nat_nat_nat_prod_fun_fun_tree$)
(declare-fun selecuc$ (Nat_nat_nat_nat_prod_fun_fun_tree$)Nat_nat_nat_nat_prod_fun_fun_tree$)
(declare-fun node$k (Nat_nat_nat_nat_prod_fun_fun$ Nat_nat_nat_nat_prod_fun_fun_tree$ Nat_nat_nat_nat_prod_fun_fun_tree$ )Nat_nat_nat_nat_prod_fun_fun_tree$)
...
(declare-fun selecuj$ (Nat_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_nat_prod_nat_fun_fun$)
(declare-fun selecuk$ (Nat_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun selecul$ (Nat_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun node$n (Nat_nat_nat_prod_nat_fun_fun$ Nat_nat_nat_prod_nat_fun_fun_tree$ Nat_nat_nat_prod_nat_fun_fun_tree$ )Nat_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun selecum$ (Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_fun$)
(declare-fun selecun$ (Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$)
(declare-fun selecuo$ (Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$)
(declare-fun node$o (Nat_nat_prod_nat_fun_nat_nat_prod_fun$ Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$ Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$ )Nat_nat_prod_nat_fun_nat_nat_prod_fun_tree$)
(declare-fun selecup$ (Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_prod_nat_nat_prod_nat_fun_fun$)
(declare-fun selecuq$ (Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun selecur$ (Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun node$p (Nat_nat_prod_nat_nat_prod_nat_fun_fun$ Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$ Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$ )Nat_nat_prod_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun selecus$ (Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$)Nat_nat_nat_prod_nat_fun_nat_fun_fun$)
(declare-fun selecut$ (Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$)Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$)
(declare-fun selecuu$ (Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$)Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$)
(declare-fun node$q (Nat_nat_nat_prod_nat_fun_nat_fun_fun$ Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$ Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$ )Nat_nat_nat_prod_nat_fun_nat_fun_fun_tree$)
(declare-fun selecuv$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun$)
(declare-fun selecuw$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$)
(declare-fun selecux$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$)
(declare-fun node$r (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$ )Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_tree$)
(declare-fun selecuy$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun$)
(declare-fun selecuz$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$)
(declare-fun selecva$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$)
(declare-fun node$s (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$ )Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_tree$)
(declare-fun selecvb$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun$)
(declare-fun selecvc$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun selecvd$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun node$t (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$ )Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun selecve$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun$)
(declare-fun selecvf$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)
(declare-fun selecvg$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)
(declare-fun node$u (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$ )Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)
(declare-fun selecvh$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_fun$)
(declare-fun selecvi$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_fun_tree$)
(declare-fun selecvj$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_fun_tree$)
(declare-fun node$v (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_fun$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_fun_tree$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_fun_tree$ )Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_fun_tree$)
(declare-fun selecvk$ (Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$)Nat_nat_nat_prod_fun_nat_nat_prod_fun$)
(declare-fun selecvl$ (Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$)Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$)
(declare-fun selecvm$ (Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$)Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$)
(declare-fun node$w (Nat_nat_nat_prod_fun_nat_nat_prod_fun$ Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$ Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$ )Nat_nat_nat_prod_fun_nat_nat_prod_fun_tree$)
(declare-fun selecvn$ (Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_fun_nat_fun$)
(declare-fun selecvo$ (Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$)
(declare-fun selecvp$ (Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$)
(declare-fun node$x (Nat_nat_prod_nat_fun_nat_fun_nat_fun$ Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$ Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$ )Nat_nat_prod_nat_fun_nat_fun_nat_fun_tree$)
...
(declare-fun node$y (Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$ Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$ )Nat_nat_prod_nat_nat_prod_fun_nat_nat_prod_fun_tree$)
(declare-fun selecvt$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun$)
(declare-fun selecvu$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$)
(declare-fun selecvv$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$)
(declare-fun node$z (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$ )Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_fun_nat_fun_tree$)
(declare-fun selecvw$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun$)
(declare-fun selecvx$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun_tree$)
(declare-fun selecvy$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun_tree$)
(declare-fun node$aa (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun_tree$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun_tree$ )Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_fun_nat_nat_prod_fun_tree$)
(declare-fun selecvz$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun$)
(declare-fun selecwa$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun selecwb$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun node$ab (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$ )Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_fun_tree$)
(declare-fun selecwc$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun$)
(declare-fun selecwd$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)
(declare-fun selecwe$ (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)
(declare-fun node$ac (Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$ Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$ )Nat_nat_prod_nat_fun_nat_nat_prod_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_nat_nat_prod_nat_fun_nat_fun_fun_tree$)
...
(declare-fun node$ad (Nat_tree$ Nat_tree_tree$ Nat_tree_tree$ )Nat_tree_tree$)
...
(declare-fun node$ae (Nat_tree_tree$ Nat_tree_tree_tree$ Nat_tree_tree_tree$ )Nat_tree_tree_tree$)
