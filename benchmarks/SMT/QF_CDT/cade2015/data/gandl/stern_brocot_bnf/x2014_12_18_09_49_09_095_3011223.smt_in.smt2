...
(declare-fun root$a (Int_tree_tree$)Int_tree$)
(declare-fun left$a (Int_tree_tree$)Int_tree_tree$)
(declare-fun right$a (Int_tree_tree$)Int_tree_tree$)
(declare-fun node$a (Int_tree$ Int_tree_tree$ Int_tree_tree$ )Int_tree_tree$)
(declare-fun root$b (Int_tree_tree_tree$)Int_tree_tree$)
(declare-fun left$b (Int_tree_tree_tree$)Int_tree_tree_tree$)
(declare-fun right$b (Int_tree_tree_tree$)Int_tree_tree_tree$)
(declare-fun node$b (Int_tree_tree$ Int_tree_tree_tree$ Int_tree_tree_tree$ )Int_tree_tree_tree$)
(declare-fun root$c (Int_tree_tree_tree_tree$)Int_tree_tree_tree$)
(declare-fun left$c (Int_tree_tree_tree_tree$)Int_tree_tree_tree_tree$)
(declare-fun right$c (Int_tree_tree_tree_tree$)Int_tree_tree_tree_tree$)
(declare-fun node$c (Int_tree_tree_tree$ Int_tree_tree_tree_tree$ Int_tree_tree_tree_tree$ )Int_tree_tree_tree_tree$)
