...
(declare-sort A_b_fun_a_b_fun_fun_b_fun_tree$ 0)
(declare-sort A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$ 0)
...
(declare-fun selectc$ (A_b_fun_a_b_fun_fun_tree$)A_b_fun_a_b_fun_fun$)
(declare-fun selectd$ (A_b_fun_a_b_fun_fun_tree$)A_b_fun_a_b_fun_fun_tree$)
(declare-fun selecte$ (A_b_fun_a_b_fun_fun_tree$)A_b_fun_a_b_fun_fun_tree$)
(declare-fun node$c (A_b_fun_a_b_fun_fun$ A_b_fun_a_b_fun_fun_tree$ A_b_fun_a_b_fun_fun_tree$ )A_b_fun_a_b_fun_fun_tree$)
(declare-fun selectf$ (B_b_fun_tree$)B_b_fun$)
(declare-fun selectg$ (B_b_fun_tree$)B_b_fun_tree$)
(declare-fun selecth$ (B_b_fun_tree$)B_b_fun_tree$)
...
(declare-fun selecto$ (B_a_b_fun_fun_tree$)B_a_b_fun_fun$)
(declare-fun selectp$ (B_a_b_fun_fun_tree$)B_a_b_fun_fun_tree$)
(declare-fun selectq$ (B_a_b_fun_fun_tree$)B_a_b_fun_fun_tree$)
(declare-fun node$g (B_a_b_fun_fun$ B_a_b_fun_fun_tree$ B_a_b_fun_fun_tree$ )B_a_b_fun_fun_tree$)
(declare-fun selectr$ (A_a_b_fun_fun_tree$)A_a_b_fun_fun$)
(declare-fun selects$ (A_a_b_fun_fun_tree$)A_a_b_fun_fun_tree$)
(declare-fun selectt$ (A_a_b_fun_fun_tree$)A_a_b_fun_fun_tree$)
(declare-fun node$h (A_a_b_fun_fun$ A_a_b_fun_fun_tree$ A_a_b_fun_fun_tree$ )A_a_b_fun_fun_tree$)
...
(declare-fun selecua$ (B_a_b_fun_a_b_fun_fun_fun_tree$)B_a_b_fun_a_b_fun_fun_fun$)
(declare-fun selecub$ (B_a_b_fun_a_b_fun_fun_fun_tree$)B_a_b_fun_a_b_fun_fun_fun_tree$)
(declare-fun selecuc$ (B_a_b_fun_a_b_fun_fun_fun_tree$)B_a_b_fun_a_b_fun_fun_fun_tree$)
(declare-fun node$k (B_a_b_fun_a_b_fun_fun_fun$ B_a_b_fun_a_b_fun_fun_fun_tree$ B_a_b_fun_a_b_fun_fun_fun_tree$ )B_a_b_fun_a_b_fun_fun_fun_tree$)
...
(declare-fun selecuj$ (A_a_fun_b_fun_tree$)A_a_fun_b_fun$)
(declare-fun selecuk$ (A_a_fun_b_fun_tree$)A_a_fun_b_fun_tree$)
(declare-fun selecul$ (A_a_fun_b_fun_tree$)A_a_fun_b_fun_tree$)
(declare-fun node$n (A_a_fun_b_fun$ A_a_fun_b_fun_tree$ A_a_fun_b_fun_tree$ )A_a_fun_b_fun_tree$)
(declare-fun selecum$ (B_a_a_fun_fun_tree$)B_a_a_fun_fun$)
(declare-fun selecun$ (B_a_a_fun_fun_tree$)B_a_a_fun_fun_tree$)
(declare-fun selecuo$ (B_a_a_fun_fun_tree$)B_a_a_fun_fun_tree$)
(declare-fun node$o (B_a_a_fun_fun$ B_a_a_fun_fun_tree$ B_a_a_fun_fun_tree$ )B_a_a_fun_fun_tree$)
(declare-fun selecup$ (A_b_fun_a_b_fun_fun_a_fun_tree$)A_b_fun_a_b_fun_fun_a_fun$)
(declare-fun selecuq$ (A_b_fun_a_b_fun_fun_a_fun_tree$)A_b_fun_a_b_fun_fun_a_fun_tree$)
(declare-fun selecur$ (A_b_fun_a_b_fun_fun_a_fun_tree$)A_b_fun_a_b_fun_fun_a_fun_tree$)
(declare-fun node$p (A_b_fun_a_b_fun_fun_a_fun$ A_b_fun_a_b_fun_fun_a_fun_tree$ A_b_fun_a_b_fun_fun_a_fun_tree$ )A_b_fun_a_b_fun_fun_a_fun_tree$)
(declare-fun selecus$ (A_a_b_fun_a_b_fun_fun_fun_tree$)A_a_b_fun_a_b_fun_fun_fun$)
(declare-fun selecut$ (A_a_b_fun_a_b_fun_fun_fun_tree$)A_a_b_fun_a_b_fun_fun_fun_tree$)
(declare-fun selecuu$ (A_a_b_fun_a_b_fun_fun_fun_tree$)A_a_b_fun_a_b_fun_fun_fun_tree$)
(declare-fun node$q (A_a_b_fun_a_b_fun_fun_fun$ A_a_b_fun_a_b_fun_fun_fun_tree$ A_a_b_fun_a_b_fun_fun_fun_tree$ )A_a_b_fun_a_b_fun_fun_fun_tree$)
(declare-fun selecuv$ (A_b_fun_a_b_fun_fun_b_fun_tree$)A_b_fun_a_b_fun_fun_b_fun$)
(declare-fun selecuw$ (A_b_fun_a_b_fun_fun_b_fun_tree$)A_b_fun_a_b_fun_fun_b_fun_tree$)
(declare-fun selecux$ (A_b_fun_a_b_fun_fun_b_fun_tree$)A_b_fun_a_b_fun_fun_b_fun_tree$)
(declare-fun node$r (A_b_fun_a_b_fun_fun_b_fun$ A_b_fun_a_b_fun_fun_b_fun_tree$ A_b_fun_a_b_fun_fun_b_fun_tree$ )A_b_fun_a_b_fun_fun_b_fun_tree$)
(declare-fun selecuy$ (A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$)A_b_fun_a_b_fun_fun_a_b_fun_fun$)
(declare-fun selecuz$ (A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$)A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$)
(declare-fun selecva$ (A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$)A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$)
(declare-fun node$s (A_b_fun_a_b_fun_fun_a_b_fun_fun$ A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$ A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$ )A_b_fun_a_b_fun_fun_a_b_fun_fun_tree$)
