...
(declare-fun node$h (A_stream_stream_tree$ A_stream_stream_tree_tree$ A_stream_stream_tree_tree$ )A_stream_stream_tree_tree$)
...
(declare-fun node$i (A_tree_tree_stream$ A_tree_tree_stream_tree$ A_tree_tree_stream_tree$ )A_tree_tree_stream_tree$)
...
(declare-fun selecte$ (A_stream_a_fun_stream$)A_stream_a_fun$)
(declare-fun selectf$ (A_stream_a_fun_stream$)A_stream_a_fun_stream$)
(declare-fun sCons$h (A_stream_a_fun$ A_stream_a_fun_stream$ )A_stream_a_fun_stream$)
(declare-fun selectg$ (A_a_tree_fun_stream$)A_a_tree_fun$)
(declare-fun selecth$ (A_a_tree_fun_stream$)A_a_tree_fun_stream$)
(declare-fun sCons$i (A_a_tree_fun$ A_a_tree_fun_stream$ )A_a_tree_fun_stream$)
...
(declare-fun node$j (A_a_fun_a_fun$ A_a_fun_a_fun_tree$ A_a_fun_a_fun_tree$ )A_a_fun_a_fun_tree$)
(declare-fun selectl$ (A_a_fun_a_fun_stream$)A_a_fun_a_fun$)
(declare-fun selectm$ (A_a_fun_a_fun_stream$)A_a_fun_a_fun_stream$)
(declare-fun sCons$j (A_a_fun_a_fun$ A_a_fun_a_fun_stream$ )A_a_fun_a_fun_stream$)
(declare-fun selectn$ (A_a_a_fun_fun_tree$)A_a_a_fun_fun$)
(declare-fun selecto$ (A_a_a_fun_fun_tree$)A_a_a_fun_fun_tree$)
...
(declare-fun selectq$ (A_a_a_fun_fun_stream$)A_a_a_fun_fun$)
(declare-fun selectr$ (A_a_a_fun_fun_stream$)A_a_a_fun_fun_stream$)
(declare-fun sCons$k (A_a_a_fun_fun$ A_a_a_fun_fun_stream$ )A_a_a_fun_fun_stream$)
(declare-fun selects$ (A_a_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun$)
...
(declare-fun selectv$ (A_a_fun_a_a_fun_fun_stream$)A_a_fun_a_a_fun_fun$)
(declare-fun selectw$ (A_a_fun_a_a_fun_fun_stream$)A_a_fun_a_a_fun_fun_stream$)
(declare-fun sCons$l (A_a_fun_a_a_fun_fun$ A_a_fun_a_a_fun_fun_stream$ )A_a_fun_a_a_fun_fun_stream$)
(declare-fun selectx$ (A_a_tree_fun_tree$)A_a_tree_fun$)
(declare-fun selecty$ (A_a_tree_fun_tree$)A_a_tree_fun_tree$)
(declare-fun selectz$ (A_a_tree_fun_tree$)A_a_tree_fun_tree$)
(declare-fun node$m (A_a_tree_fun$ A_a_tree_fun_tree$ A_a_tree_fun_tree$ )A_a_tree_fun_tree$)
...
(declare-fun node$n (A_a_stream_fun$ A_a_stream_fun_tree$ A_a_stream_fun_tree$ )A_a_stream_fun_tree$)
...
(declare-fun node$o (A_a_a_fun_fun_a_fun$ A_a_a_fun_fun_a_fun_tree$ A_a_a_fun_fun_a_fun_tree$ )A_a_a_fun_fun_a_fun_tree$)
...
(declare-fun sCons$n (A_a_a_fun_fun_a_fun$ A_a_a_fun_fun_a_fun_stream$ )A_a_a_fun_fun_a_fun_stream$)
...
(declare-fun node$p (A_a_fun_a_fun_a_fun$ A_a_fun_a_fun_a_fun_tree$ A_a_fun_a_fun_a_fun_tree$ )A_a_fun_a_fun_a_fun_tree$)
...
(declare-fun sCons$o (A_a_fun_a_fun_a_fun$ A_a_fun_a_fun_a_fun_stream$ )A_a_fun_a_fun_a_fun_stream$)
...
(declare-fun node$q (A_a_a_a_fun_fun_fun$ A_a_a_a_fun_fun_fun_tree$ A_a_a_a_fun_fun_fun_tree$ )A_a_a_a_fun_fun_fun_tree$)
...
(declare-fun sCons$p (A_a_a_a_fun_fun_fun$ A_a_a_a_fun_fun_fun_stream$ )A_a_a_a_fun_fun_fun_stream$)
...
(declare-fun node$r (A_a_a_fun_a_fun_fun$ A_a_a_fun_a_fun_fun_tree$ A_a_a_fun_a_fun_fun_tree$ )A_a_a_fun_a_fun_fun_tree$)
...
(declare-fun selecuz$ (A_tree_a_fun_stream$)A_tree_a_fun$)
(declare-fun selecva$ (A_tree_a_fun_stream$)A_tree_a_fun_stream$)
(declare-fun sCons$r (A_tree_a_fun$ A_tree_a_fun_stream$ )A_tree_a_fun_stream$)
(declare-fun selecvb$ (A_stream_a_stream_fun_stream$)A_stream_a_stream_fun$)
(declare-fun selecvc$ (A_stream_a_stream_fun_stream$)A_stream_a_stream_fun_stream$)
(declare-fun sCons$s (A_stream_a_stream_fun$ A_stream_a_stream_fun_stream$ )A_stream_a_stream_fun_stream$)
(declare-fun selecvd$ (A_tree_a_stream_fun_stream$)A_tree_a_stream_fun$)
(declare-fun selecve$ (A_tree_a_stream_fun_stream$)A_tree_a_stream_fun_stream$)
(declare-fun sCons$t (A_tree_a_stream_fun$ A_tree_a_stream_fun_stream$ )A_tree_a_stream_fun_stream$)
...
(declare-fun sCons$u (A_stream_a_tree_fun$ A_stream_a_tree_fun_stream$ )A_stream_a_tree_fun_stream$)
...
(declare-fun sCons$v (A_tree_a_tree_fun$ A_tree_a_tree_fun_stream$ )A_tree_a_tree_fun_stream$)
(declare-fun selecvj$ (A_tree_a_fun_tree$)A_tree_a_fun$)
(declare-fun selecvk$ (A_tree_a_fun_tree$)A_tree_a_fun_tree$)
(declare-fun selecvl$ (A_tree_a_fun_tree$)A_tree_a_fun_tree$)
(declare-fun node$s (A_tree_a_fun$ A_tree_a_fun_tree$ A_tree_a_fun_tree$ )A_tree_a_fun_tree$)
(declare-fun selecvm$ (A_stream_a_fun_tree$)A_stream_a_fun$)
(declare-fun selecvn$ (A_stream_a_fun_tree$)A_stream_a_fun_tree$)
(declare-fun selecvo$ (A_stream_a_fun_tree$)A_stream_a_fun_tree$)
(declare-fun node$t (A_stream_a_fun$ A_stream_a_fun_tree$ A_stream_a_fun_tree$ )A_stream_a_fun_tree$)
(declare-fun selecvp$ (A_tree_a_tree_fun_tree$)A_tree_a_tree_fun$)
(declare-fun selecvq$ (A_tree_a_tree_fun_tree$)A_tree_a_tree_fun_tree$)
...
(declare-fun selecvs$ (A_stream_a_tree_fun_tree$)A_stream_a_tree_fun$)
(declare-fun selecvt$ (A_stream_a_tree_fun_tree$)A_stream_a_tree_fun_tree$)
(declare-fun selecvu$ (A_stream_a_tree_fun_tree$)A_stream_a_tree_fun_tree$)
(declare-fun node$v (A_stream_a_tree_fun$ A_stream_a_tree_fun_tree$ A_stream_a_tree_fun_tree$ )A_stream_a_tree_fun_tree$)
(declare-fun selecvv$ (A_tree_a_stream_fun_tree$)A_tree_a_stream_fun$)
(declare-fun selecvw$ (A_tree_a_stream_fun_tree$)A_tree_a_stream_fun_tree$)
(declare-fun selecvx$ (A_tree_a_stream_fun_tree$)A_tree_a_stream_fun_tree$)
(declare-fun node$w (A_tree_a_stream_fun$ A_tree_a_stream_fun_tree$ A_tree_a_stream_fun_tree$ )A_tree_a_stream_fun_tree$)
(declare-fun selecvy$ (A_stream_a_stream_fun_tree$)A_stream_a_stream_fun$)
(declare-fun selecvz$ (A_stream_a_stream_fun_tree$)A_stream_a_stream_fun_tree$)
(declare-fun selecwa$ (A_stream_a_stream_fun_tree$)A_stream_a_stream_fun_tree$)
(declare-fun node$x (A_stream_a_stream_fun$ A_stream_a_stream_fun_tree$ A_stream_a_stream_fun_tree$ )A_stream_a_stream_fun_tree$)
