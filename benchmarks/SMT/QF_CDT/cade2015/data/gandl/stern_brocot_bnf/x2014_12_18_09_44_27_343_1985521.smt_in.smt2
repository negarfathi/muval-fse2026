...
(declare-sort B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$ 0)
...
(declare-fun selecug$ (A_b_a_fun_fun_b_a_fun_fun_tree$)A_b_a_fun_fun_b_a_fun_fun$)
(declare-fun selecuh$ (A_b_a_fun_fun_b_a_fun_fun_tree$)A_b_a_fun_fun_b_a_fun_fun_tree$)
(declare-fun selecui$ (A_b_a_fun_fun_b_a_fun_fun_tree$)A_b_a_fun_fun_b_a_fun_fun_tree$)
(declare-fun node$m (A_b_a_fun_fun_b_a_fun_fun$ A_b_a_fun_fun_b_a_fun_fun_tree$ A_b_a_fun_fun_b_a_fun_fun_tree$ )A_b_a_fun_fun_b_a_fun_fun_tree$)
...
(declare-fun selecum$ (B_b_a_fun_fun_b_a_fun_fun_tree$)B_b_a_fun_fun_b_a_fun_fun$)
(declare-fun selecun$ (B_b_a_fun_fun_b_a_fun_fun_tree$)B_b_a_fun_fun_b_a_fun_fun_tree$)
(declare-fun selecuo$ (B_b_a_fun_fun_b_a_fun_fun_tree$)B_b_a_fun_fun_b_a_fun_fun_tree$)
(declare-fun node$o (B_b_a_fun_fun_b_a_fun_fun$ B_b_a_fun_fun_b_a_fun_fun_tree$ B_b_a_fun_fun_b_a_fun_fun_tree$ )B_b_a_fun_fun_b_a_fun_fun_tree$)
(declare-fun selecup$ (B_a_a_fun_fun_tree$)B_a_a_fun_fun$)
(declare-fun selecuq$ (B_a_a_fun_fun_tree$)B_a_a_fun_fun_tree$)
(declare-fun selecur$ (B_a_a_fun_fun_tree$)B_a_a_fun_fun_tree$)
(declare-fun node$p (B_a_a_fun_fun$ B_a_a_fun_fun_tree$ B_a_a_fun_fun_tree$ )B_a_a_fun_fun_tree$)
(declare-fun selecus$ (B_a_a_fun_fun_a_a_fun_fun_tree$)B_a_a_fun_fun_a_a_fun_fun$)
(declare-fun selecut$ (B_a_a_fun_fun_a_a_fun_fun_tree$)B_a_a_fun_fun_a_a_fun_fun_tree$)
(declare-fun selecuu$ (B_a_a_fun_fun_a_a_fun_fun_tree$)B_a_a_fun_fun_a_a_fun_fun_tree$)
(declare-fun node$q (B_a_a_fun_fun_a_a_fun_fun$ B_a_a_fun_fun_a_a_fun_fun_tree$ B_a_a_fun_fun_a_a_fun_fun_tree$ )B_a_a_fun_fun_a_a_fun_fun_tree$)
(declare-fun selecuv$ (B_b_fun_b_fun_tree$)B_b_fun_b_fun$)
(declare-fun selecuw$ (B_b_fun_b_fun_tree$)B_b_fun_b_fun_tree$)
(declare-fun selecux$ (B_b_fun_b_fun_tree$)B_b_fun_b_fun_tree$)
(declare-fun node$r (B_b_fun_b_fun$ B_b_fun_b_fun_tree$ B_b_fun_b_fun_tree$ )B_b_fun_b_fun_tree$)
(declare-fun selecuy$ (B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_a_b_a_fun_fun_fun$)
(declare-fun selecuz$ (B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)
(declare-fun selecva$ (B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)
(declare-fun node$s (B_a_a_fun_fun_a_b_a_fun_fun_fun$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ )B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$)
(declare-fun selecvb$ (B_b_b_a_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun$)
(declare-fun selecvc$ (B_b_b_a_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_tree$)
(declare-fun selecvd$ (B_b_b_a_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_tree$)
(declare-fun node$t (B_b_b_a_fun_fun_fun$ B_b_b_a_fun_fun_fun_tree$ B_b_b_a_fun_fun_fun_tree$ )B_b_b_a_fun_fun_fun_tree$)
(declare-fun selecve$ (B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun$)
(declare-fun selecvf$ (B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecvg$ (B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun node$u (B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ )B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecvh$ (B_a_b_a_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun$)
(declare-fun selecvi$ (B_a_b_a_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_tree$)
(declare-fun selecvj$ (B_a_b_a_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_tree$)
(declare-fun node$v (B_a_b_a_fun_fun_fun$ B_a_b_a_fun_fun_fun_tree$ B_a_b_a_fun_fun_fun_tree$ )B_a_b_a_fun_fun_fun_tree$)
(declare-fun selecvk$ (A_b_b_a_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun$)
(declare-fun selecvl$ (A_b_b_a_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun_tree$)
(declare-fun selecvm$ (A_b_b_a_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun_tree$)
(declare-fun node$w (A_b_b_a_fun_fun_fun$ A_b_b_a_fun_fun_fun_tree$ A_b_b_a_fun_fun_fun_tree$ )A_b_b_a_fun_fun_fun_tree$)
(declare-fun selecvn$ (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun$)
(declare-fun selecvo$ (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecvp$ (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun node$x (B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$ )B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecvq$ (B_b_a_a_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun$)
(declare-fun selecvr$ (B_b_a_a_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun_tree$)
(declare-fun selecvs$ (B_b_a_a_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun_tree$)
(declare-fun node$y (B_b_a_a_fun_fun_fun$ B_b_a_a_fun_fun_fun_tree$ B_b_a_a_fun_fun_fun_tree$ )B_b_a_a_fun_fun_fun_tree$)
(declare-fun selecvt$ (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun$)
(declare-fun selecvu$ (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecvv$ (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)
(declare-fun node$z (B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$ )B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$)
...
(declare-fun selecvz$ (B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)B_b_b_fun_fun_b_b_b_fun_fun_fun$)
(declare-fun selecwa$ (B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)
(declare-fun selecwb$ (B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)
(declare-fun node$ab (B_b_b_fun_fun_b_b_b_fun_fun_fun$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ )B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$)
(declare-fun selecwc$ (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun$)
(declare-fun selecwd$ (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecwe$ (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)
(declare-fun node$ac (A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ )A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecwf$ (A_a_b_a_fun_fun_fun_tree$)A_a_b_a_fun_fun_fun$)
(declare-fun selecwg$ (A_a_b_a_fun_fun_fun_tree$)A_a_b_a_fun_fun_fun_tree$)
(declare-fun selecwh$ (A_a_b_a_fun_fun_fun_tree$)A_a_b_a_fun_fun_fun_tree$)
(declare-fun node$ad (A_a_b_a_fun_fun_fun$ A_a_b_a_fun_fun_fun_tree$ A_a_b_a_fun_fun_fun_tree$ )A_a_b_a_fun_fun_fun_tree$)
(declare-fun selecwi$ (A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$)A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun$)
(declare-fun selecwj$ (A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$)A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecwk$ (A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$)A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$)
(declare-fun node$ae (A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$ )A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$)
...
(declare-fun node$af (A_a_a_fun_fun_a_a_a_fun_fun_fun$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecwo$ (A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)A_b_a_fun_fun_b_a_a_fun_fun_fun$)
(declare-fun selecwp$ (A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)
(declare-fun selecwq$ (A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)
(declare-fun node$ag (A_b_a_fun_fun_b_a_a_fun_fun_fun$ A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$ A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$ )A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$)
(declare-fun selecwr$ (B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_a_fun_fun_fun$)
(declare-fun selecws$ (B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)
(declare-fun selecwt$ (B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)
(declare-fun node$ah (B_b_a_fun_fun_b_b_a_fun_fun_fun$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ )B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$)
(declare-fun selecwu$ (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun$)
(declare-fun selecwv$ (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)
(declare-fun selecww$ (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)
(declare-fun node$ai (B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ )B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$)
(declare-fun selecwx$ (B_b_fun_b_a_fun_fun_tree$)B_b_fun_b_a_fun_fun$)
(declare-fun selecwy$ (B_b_fun_b_a_fun_fun_tree$)B_b_fun_b_a_fun_fun_tree$)
(declare-fun selecwz$ (B_b_fun_b_a_fun_fun_tree$)B_b_fun_b_a_fun_fun_tree$)
(declare-fun node$aj (B_b_fun_b_a_fun_fun$ B_b_fun_b_a_fun_fun_tree$ B_b_fun_b_a_fun_fun_tree$ )B_b_fun_b_a_fun_fun_tree$)
(declare-fun selecxa$ (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun$)
(declare-fun selecxb$ (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)
(declare-fun selecxc$ (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)
(declare-fun node$ak (B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ )B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$)
(declare-fun selecxd$ (B_a_b_fun_fun_tree$)B_a_b_fun_fun$)
(declare-fun selecxe$ (B_a_b_fun_fun_tree$)B_a_b_fun_fun_tree$)
(declare-fun selecxf$ (B_a_b_fun_fun_tree$)B_a_b_fun_fun_tree$)
(declare-fun node$al (B_a_b_fun_fun$ B_a_b_fun_fun_tree$ B_a_b_fun_fun_tree$ )B_a_b_fun_fun_tree$)
(declare-fun selecxg$ (B_a_fun_b_b_fun_fun_tree$)B_a_fun_b_b_fun_fun$)
(declare-fun selecxh$ (B_a_fun_b_b_fun_fun_tree$)B_a_fun_b_b_fun_fun_tree$)
(declare-fun selecxi$ (B_a_fun_b_b_fun_fun_tree$)B_a_fun_b_b_fun_fun_tree$)
(declare-fun node$am (B_a_fun_b_b_fun_fun$ B_a_fun_b_b_fun_fun_tree$ B_a_fun_b_b_fun_fun_tree$ )B_a_fun_b_b_fun_fun_tree$)
(declare-fun selecxj$ (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun$)
(declare-fun selecxk$ (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)
(declare-fun selecxl$ (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)
(declare-fun node$an (B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ )B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$)
(declare-fun selecxm$ (B_b_fun_b_b_fun_fun_tree$)B_b_fun_b_b_fun_fun$)
(declare-fun selecxn$ (B_b_fun_b_b_fun_fun_tree$)B_b_fun_b_b_fun_fun_tree$)
(declare-fun selecxo$ (B_b_fun_b_b_fun_fun_tree$)B_b_fun_b_b_fun_fun_tree$)
(declare-fun node$ao (B_b_fun_b_b_fun_fun$ B_b_fun_b_b_fun_fun_tree$ B_b_fun_b_b_fun_fun_tree$ )B_b_fun_b_b_fun_fun_tree$)
(declare-fun selecxp$ (B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$)B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun$)
(declare-fun selecxq$ (B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$)B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$)
(declare-fun selecxr$ (B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$)B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$)
(declare-fun node$ap (B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$ )B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$)
(declare-fun selecxs$ (A_b_fun_a_a_fun_fun_tree$)A_b_fun_a_a_fun_fun$)
(declare-fun selecxt$ (A_b_fun_a_a_fun_fun_tree$)A_b_fun_a_a_fun_fun_tree$)
(declare-fun selecxu$ (A_b_fun_a_a_fun_fun_tree$)A_b_fun_a_a_fun_fun_tree$)
(declare-fun node$aq (A_b_fun_a_a_fun_fun$ A_b_fun_a_a_fun_fun_tree$ A_b_fun_a_a_fun_fun_tree$ )A_b_fun_a_a_fun_fun_tree$)
(declare-fun selecxv$ (A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$)A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun$)
(declare-fun selecxw$ (A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$)A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecxx$ (A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$)A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$)
(declare-fun node$ar (A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$ )A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecxy$ (A_a_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun$)
(declare-fun selecxz$ (A_a_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun_tree$)
(declare-fun selecya$ (A_a_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun_tree$)
(declare-fun node$as (A_a_fun_a_a_fun_fun$ A_a_fun_a_a_fun_fun_tree$ A_a_fun_a_a_fun_fun_tree$ )A_a_fun_a_a_fun_fun_tree$)
(declare-fun selecyb$ (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$)
(declare-fun selecyc$ (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecyd$ (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)
(declare-fun node$at (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecye$ (B_b_a_fun_a_fun_fun_tree$)B_b_a_fun_a_fun_fun$)
(declare-fun selecyf$ (B_b_a_fun_a_fun_fun_tree$)B_b_a_fun_a_fun_fun_tree$)
(declare-fun selecyg$ (B_b_a_fun_a_fun_fun_tree$)B_b_a_fun_a_fun_fun_tree$)
(declare-fun node$au (B_b_a_fun_a_fun_fun$ B_b_a_fun_a_fun_fun_tree$ B_b_a_fun_a_fun_fun_tree$ )B_b_a_fun_a_fun_fun_tree$)
(declare-fun selecyh$ (B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$)B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun$)
(declare-fun selecyi$ (B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$)B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$)
(declare-fun selecyj$ (B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$)B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$)
(declare-fun node$av (B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$)
(declare-fun selecyk$ (B_a_a_fun_a_fun_fun_tree$)B_a_a_fun_a_fun_fun$)
(declare-fun selecyl$ (B_a_a_fun_a_fun_fun_tree$)B_a_a_fun_a_fun_fun_tree$)
(declare-fun selecym$ (B_a_a_fun_a_fun_fun_tree$)B_a_a_fun_a_fun_fun_tree$)
(declare-fun node$aw (B_a_a_fun_a_fun_fun$ B_a_a_fun_a_fun_fun_tree$ B_a_a_fun_a_fun_fun_tree$ )B_a_a_fun_a_fun_fun_tree$)
(declare-fun selecyn$ (B_a_a_fun_fun_b_a_fun_fun_tree$)B_a_a_fun_fun_b_a_fun_fun$)
(declare-fun selecyo$ (B_a_a_fun_fun_b_a_fun_fun_tree$)B_a_a_fun_fun_b_a_fun_fun_tree$)
(declare-fun selecyp$ (B_a_a_fun_fun_b_a_fun_fun_tree$)B_a_a_fun_fun_b_a_fun_fun_tree$)
(declare-fun node$ax (B_a_a_fun_fun_b_a_fun_fun$ B_a_a_fun_fun_b_a_fun_fun_tree$ B_a_a_fun_fun_b_a_fun_fun_tree$ )B_a_a_fun_fun_b_a_fun_fun_tree$)
(declare-fun selecyq$ (B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$)B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun$)
(declare-fun selecyr$ (B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$)B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$)
(declare-fun selecys$ (B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$)B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$)
(declare-fun node$ay (B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$ )B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$)
(declare-fun selecyt$ (B_b_fun_b_b_a_fun_fun_fun_tree$)B_b_fun_b_b_a_fun_fun_fun$)
(declare-fun selecyu$ (B_b_fun_b_b_a_fun_fun_fun_tree$)B_b_fun_b_b_a_fun_fun_fun_tree$)
(declare-fun selecyv$ (B_b_fun_b_b_a_fun_fun_fun_tree$)B_b_fun_b_b_a_fun_fun_fun_tree$)
(declare-fun node$az (B_b_fun_b_b_a_fun_fun_fun$ B_b_fun_b_b_a_fun_fun_fun_tree$ B_b_fun_b_b_a_fun_fun_fun_tree$ )B_b_fun_b_b_a_fun_fun_fun_tree$)
(declare-fun selecyw$ (B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun$)
(declare-fun selecyx$ (B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecyy$ (B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$)B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun node$ba (B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$ )B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecyz$ (B_a_fun_b_b_a_fun_fun_fun_tree$)B_a_fun_b_b_a_fun_fun_fun$)
(declare-fun selecza$ (B_a_fun_b_b_a_fun_fun_fun_tree$)B_a_fun_b_b_a_fun_fun_fun_tree$)
(declare-fun seleczb$ (B_a_fun_b_b_a_fun_fun_fun_tree$)B_a_fun_b_b_a_fun_fun_fun_tree$)
(declare-fun node$bb (B_a_fun_b_b_a_fun_fun_fun$ B_a_fun_b_b_a_fun_fun_fun_tree$ B_a_fun_b_b_a_fun_fun_fun_tree$ )B_a_fun_b_b_a_fun_fun_fun_tree$)
(declare-fun seleczc$ (B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun$)
(declare-fun seleczd$ (B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun selecze$ (B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$)B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun node$bc (B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ )B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$)
(declare-fun seleczf$ (A_a_fun_b_a_a_fun_fun_fun_tree$)A_a_fun_b_a_a_fun_fun_fun$)
(declare-fun seleczg$ (A_a_fun_b_a_a_fun_fun_fun_tree$)A_a_fun_b_a_a_fun_fun_fun_tree$)
(declare-fun seleczh$ (A_a_fun_b_a_a_fun_fun_fun_tree$)A_a_fun_b_a_a_fun_fun_fun_tree$)
(declare-fun node$bd (A_a_fun_b_a_a_fun_fun_fun$ A_a_fun_b_a_a_fun_fun_fun_tree$ A_a_fun_b_a_a_fun_fun_fun_tree$ )A_a_fun_b_a_a_fun_fun_fun_tree$)
(declare-fun seleczi$ (B_a_fun_a_b_a_fun_fun_fun_tree$)B_a_fun_a_b_a_fun_fun_fun$)
(declare-fun seleczj$ (B_a_fun_a_b_a_fun_fun_fun_tree$)B_a_fun_a_b_a_fun_fun_fun_tree$)
(declare-fun seleczk$ (B_a_fun_a_b_a_fun_fun_fun_tree$)B_a_fun_a_b_a_fun_fun_fun_tree$)
(declare-fun node$be (B_a_fun_a_b_a_fun_fun_fun$ B_a_fun_a_b_a_fun_fun_fun_tree$ B_a_fun_a_b_a_fun_fun_fun_tree$ )B_a_fun_a_b_a_fun_fun_fun_tree$)
...
(declare-fun seleczo$ (B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$)B_a_fun_b_a_fun_b_a_fun_fun_fun$)
(declare-fun seleczp$ (B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$)B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$)
(declare-fun seleczq$ (B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$)B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$)
(declare-fun node$bg (B_a_fun_b_a_fun_b_a_fun_fun_fun$ B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$ B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$ )B_a_fun_b_a_fun_b_a_fun_fun_fun_tree$)
(declare-fun c$ ()A$ )
