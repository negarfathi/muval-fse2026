...
(declare-sort A_a_stream_a_stream_a_stream_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_fun_fun_fun_stream$ 0)
(declare-sort A_stream_a_stream_a_stream_fun_fun_a_fun_stream$ 0)
(declare-sort A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$ 0)
(declare-sort A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$ 0)
(declare-sort A_stream_a_stream_a_stream_a_stream_fun_fun_fun_stream$ 0)
...
(declare-fun sCons$f (A_a_fun_a_a_fun_fun$ A_a_fun_a_a_fun_fun_stream$ )A_a_fun_a_a_fun_fun_stream$)
...
(declare-fun sCons$g (A_stream_a_stream_a_stream_fun_fun$ A_stream_a_stream_a_stream_fun_fun_stream$ )A_stream_a_stream_a_stream_fun_fun_stream$)
...
(declare-fun sCons$h (A_stream_a_stream_fun_a_fun$ A_stream_a_stream_fun_a_fun_stream$ )A_stream_a_stream_fun_a_fun_stream$)
...
(declare-fun sCons$i (A_a_fun_a_fun_a_fun$ A_a_fun_a_fun_a_fun_stream$ )A_a_fun_a_fun_a_fun_stream$)
(declare-fun selectp$ (A_a_stream_a_stream_fun_fun_stream$)A_a_stream_a_stream_fun_fun$)
(declare-fun selectq$ (A_a_stream_a_stream_fun_fun_stream$)A_a_stream_a_stream_fun_fun_stream$)
(declare-fun sCons$j (A_a_stream_a_stream_fun_fun$ A_a_stream_a_stream_fun_fun_stream$ )A_a_stream_a_stream_fun_fun_stream$)
(declare-fun selectr$ (A_a_a_fun_a_fun_fun_stream$)A_a_a_fun_a_fun_fun$)
(declare-fun selects$ (A_a_a_fun_a_fun_fun_stream$)A_a_a_fun_a_fun_fun_stream$)
...
(declare-fun sCons$l (A_stream_tree$ A_stream_tree_stream$ )A_stream_tree_stream$)
...
(declare-fun sCons$m (A_tree$ A_tree_stream$ )A_tree_stream$)
...
(declare-fun sCons$n (A_stream_stream$ A_stream_stream_stream$ )A_stream_stream_stream$)
...
(declare-fun selectt$ (A_tree_a_tree_fun_stream$)A_tree_a_tree_fun$)
(declare-fun selectu$ (A_tree_a_tree_fun_stream$)A_tree_a_tree_fun_stream$)
(declare-fun sCons$o (A_tree_a_tree_fun$ A_tree_a_tree_fun_stream$ )A_tree_a_tree_fun_stream$)
(declare-fun selectv$ (A_tree_a_tree_a_tree_fun_fun_stream$)A_tree_a_tree_a_tree_fun_fun$)
(declare-fun selectw$ (A_tree_a_tree_a_tree_fun_fun_stream$)A_tree_a_tree_a_tree_fun_fun_stream$)
(declare-fun sCons$p (A_tree_a_tree_a_tree_fun_fun$ A_tree_a_tree_a_tree_fun_fun_stream$ )A_tree_a_tree_a_tree_fun_fun_stream$)
(declare-fun selectx$ (A_stream_tree_a_stream_tree_fun_stream$)A_stream_tree_a_stream_tree_fun$)
(declare-fun selecty$ (A_stream_tree_a_stream_tree_fun_stream$)A_stream_tree_a_stream_tree_fun_stream$)
(declare-fun sCons$q (A_stream_tree_a_stream_tree_fun$ A_stream_tree_a_stream_tree_fun_stream$ )A_stream_tree_a_stream_tree_fun_stream$)
(declare-fun selectz$ (A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_stream$)A_stream_tree_a_stream_tree_a_stream_tree_fun_fun$)
(declare-fun selecua$ (A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_stream$)A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_stream$)
(declare-fun sCons$r (A_stream_tree_a_stream_tree_a_stream_tree_fun_fun$ A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_stream$ )A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_stream$)
(declare-fun selecub$ (A_stream_stream_a_stream_stream_fun_stream$)A_stream_stream_a_stream_stream_fun$)
(declare-fun selecuc$ (A_stream_stream_a_stream_stream_fun_stream$)A_stream_stream_a_stream_stream_fun_stream$)
(declare-fun sCons$s (A_stream_stream_a_stream_stream_fun$ A_stream_stream_a_stream_stream_fun_stream$ )A_stream_stream_a_stream_stream_fun_stream$)
(declare-fun selecud$ (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$)A_stream_stream_a_stream_stream_a_stream_stream_fun_fun$)
(declare-fun selecue$ (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$)A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$)
(declare-fun sCons$t (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$ )A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$)
(declare-fun shd$e (A_tree_tree_stream$)A_tree_tree$)
(declare-fun stl$e (A_tree_tree_stream$)A_tree_tree_stream$)
(declare-fun sCons$u (A_tree_tree$ A_tree_tree_stream$ )A_tree_tree_stream$)
(declare-fun selecuf$ (A_tree_tree_a_tree_tree_fun_stream$)A_tree_tree_a_tree_tree_fun$)
(declare-fun selecug$ (A_tree_tree_a_tree_tree_fun_stream$)A_tree_tree_a_tree_tree_fun_stream$)
(declare-fun sCons$v (A_tree_tree_a_tree_tree_fun$ A_tree_tree_a_tree_tree_fun_stream$ )A_tree_tree_a_tree_tree_fun_stream$)
(declare-fun selecuh$ (A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_stream$)A_tree_tree_a_tree_tree_a_tree_tree_fun_fun$)
(declare-fun selecui$ (A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_stream$)A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_stream$)
(declare-fun sCons$w (A_tree_tree_a_tree_tree_a_tree_tree_fun_fun$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_stream$ )A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_stream$)
...
(declare-fun selecuj$ (A_tree_stream_a_tree_stream_fun_stream$)A_tree_stream_a_tree_stream_fun$)
(declare-fun selecuk$ (A_tree_stream_a_tree_stream_fun_stream$)A_tree_stream_a_tree_stream_fun_stream$)
...
(declare-fun selecul$ (A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_stream$)A_tree_stream_a_tree_stream_a_tree_stream_fun_fun$)
(declare-fun selecum$ (A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_stream$)A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_stream$)
...
(declare-fun selecun$ (A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$)A_a_fun_a_a_fun_a_a_fun_fun_fun$)
(declare-fun selecuo$ (A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$)A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$)
(declare-fun sCons$aa (A_a_fun_a_a_fun_a_a_fun_fun_fun$ A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$ )A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$)
...
(declare-fun sCons$ab (A_stream_stream_tree$ A_stream_stream_tree_stream$ )A_stream_stream_tree_stream$)
(declare-fun selecup$ (A_stream_stream_tree_a_stream_stream_tree_fun_stream$)A_stream_stream_tree_a_stream_stream_tree_fun$)
(declare-fun selecuq$ (A_stream_stream_tree_a_stream_stream_tree_fun_stream$)A_stream_stream_tree_a_stream_stream_tree_fun_stream$)
(declare-fun sCons$ac (A_stream_stream_tree_a_stream_stream_tree_fun$ A_stream_stream_tree_a_stream_stream_tree_fun_stream$ )A_stream_stream_tree_a_stream_stream_tree_fun_stream$)
(declare-fun selecur$ (A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_stream$)A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun$)
(declare-fun selecus$ (A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_stream$)A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_stream$)
(declare-fun sCons$ad (A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun$ A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_stream$ )A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_stream$)
(declare-fun shd$h (A_stream_tree_stream_stream$)A_stream_tree_stream$)
(declare-fun stl$h (A_stream_tree_stream_stream$)A_stream_tree_stream_stream$)
(declare-fun sCons$ae (A_stream_tree_stream$ A_stream_tree_stream_stream$ )A_stream_tree_stream_stream$)
(declare-fun selecut$ (A_stream_tree_stream_a_stream_tree_stream_fun_stream$)A_stream_tree_stream_a_stream_tree_stream_fun$)
(declare-fun selecuu$ (A_stream_tree_stream_a_stream_tree_stream_fun_stream$)A_stream_tree_stream_a_stream_tree_stream_fun_stream$)
(declare-fun sCons$af (A_stream_tree_stream_a_stream_tree_stream_fun$ A_stream_tree_stream_a_stream_tree_stream_fun_stream$ )A_stream_tree_stream_a_stream_tree_stream_fun_stream$)
(declare-fun selecuv$ (A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_stream$)A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun$)
(declare-fun selecuw$ (A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_stream$)A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_stream$)
(declare-fun sCons$ag (A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun$ A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_stream$ )A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_stream$)
...
(declare-fun sCons$ah (A_a_a_fun_fun_a_a_a_fun_fun_fun$ A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$ )A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$)
(declare-fun selecuz$ (A_a_a_fun_fun_a_fun_stream$)A_a_a_fun_fun_a_fun$)
(declare-fun selecva$ (A_a_a_fun_fun_a_fun_stream$)A_a_a_fun_fun_a_fun_stream$)
(declare-fun sCons$ai (A_a_a_fun_fun_a_fun$ A_a_a_fun_fun_a_fun_stream$ )A_a_a_fun_fun_a_fun_stream$)
(declare-fun selecvb$ (A_a_stream_a_stream_a_stream_fun_fun_fun_stream$)A_a_stream_a_stream_a_stream_fun_fun_fun$)
(declare-fun selecvc$ (A_a_stream_a_stream_a_stream_fun_fun_fun_stream$)A_a_stream_a_stream_a_stream_fun_fun_fun_stream$)
(declare-fun sCons$aj (A_a_stream_a_stream_a_stream_fun_fun_fun$ A_a_stream_a_stream_a_stream_fun_fun_fun_stream$ )A_a_stream_a_stream_a_stream_fun_fun_fun_stream$)
(declare-fun selecvd$ (A_a_a_a_fun_fun_fun_stream$)A_a_a_a_fun_fun_fun$)
(declare-fun selecve$ (A_a_a_a_fun_fun_fun_stream$)A_a_a_a_fun_fun_fun_stream$)
(declare-fun sCons$ak (A_a_a_a_fun_fun_fun$ A_a_a_a_fun_fun_fun_stream$ )A_a_a_a_fun_fun_fun_stream$)
(declare-fun selecvf$ (A_stream_a_stream_a_stream_fun_fun_a_fun_stream$)A_stream_a_stream_a_stream_fun_fun_a_fun$)
(declare-fun selecvg$ (A_stream_a_stream_a_stream_fun_fun_a_fun_stream$)A_stream_a_stream_a_stream_fun_fun_a_fun_stream$)
(declare-fun sCons$al (A_stream_a_stream_a_stream_fun_fun_a_fun$ A_stream_a_stream_a_stream_fun_fun_a_fun_stream$ )A_stream_a_stream_a_stream_fun_fun_a_fun_stream$)
(declare-fun selecvh$ (A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$)A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun$)
(declare-fun selecvi$ (A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$)A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$)
(declare-fun sCons$am (A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun$ A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$ )A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$)
(declare-fun selecvj$ (A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$)A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun$)
(declare-fun selecvk$ (A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$)A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$)
(declare-fun sCons$an (A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun$ A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$ )A_stream_a_stream_a_stream_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_stream$)
(declare-fun selecvl$ (A_stream_a_stream_a_stream_a_stream_fun_fun_fun_stream$)A_stream_a_stream_a_stream_a_stream_fun_fun_fun$)
(declare-fun selecvm$ (A_stream_a_stream_a_stream_a_stream_fun_fun_fun_stream$)A_stream_a_stream_a_stream_a_stream_fun_fun_fun_stream$)
(declare-fun sCons$ao (A_stream_a_stream_a_stream_a_stream_fun_fun_fun$ A_stream_a_stream_a_stream_a_stream_fun_fun_fun_stream$ )A_stream_a_stream_a_stream_a_stream_fun_fun_fun_stream$)
