...
(declare-fun root$d (Natural_tree$)Natural$)
(declare-fun left$d (Natural_tree$)Natural_tree$)
(declare-fun right$d (Natural_tree$)Natural_tree$)
(declare-fun node$d (Natural$ Natural_tree$ Natural_tree$ )Natural_tree$)
(declare-fun root$e (Natural_tree_tree$)Natural_tree$)
(declare-fun left$e (Natural_tree_tree$)Natural_tree_tree$)
(declare-fun right$e (Natural_tree_tree$)Natural_tree_tree$)
(declare-fun node$e (Natural_tree$ Natural_tree_tree$ Natural_tree_tree$ )Natural_tree_tree$)
