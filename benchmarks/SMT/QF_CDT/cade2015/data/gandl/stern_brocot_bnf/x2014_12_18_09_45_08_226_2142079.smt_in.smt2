...
(declare-sort Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$ 0)
(declare-sort Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$ 0)
...
(declare-fun selecto$ (Bool_bool_fun_tree$)Bool_bool_fun$)
(declare-fun selectp$ (Bool_bool_fun_tree$)Bool_bool_fun_tree$)
(declare-fun selectq$ (Bool_bool_fun_tree$)Bool_bool_fun_tree$)
(declare-fun node$f (Bool_bool_fun$ Bool_bool_fun_tree$ Bool_bool_fun_tree$ )Bool_bool_fun_tree$)
(declare-fun selectr$ (A_a_bool_fun_fun_bool_fun_tree$)A_a_bool_fun_fun_bool_fun$)
(declare-fun selects$ (A_a_bool_fun_fun_bool_fun_tree$)A_a_bool_fun_fun_bool_fun_tree$)
(declare-fun selectt$ (A_a_bool_fun_fun_bool_fun_tree$)A_a_bool_fun_fun_bool_fun_tree$)
(declare-fun node$g (A_a_bool_fun_fun_bool_fun$ A_a_bool_fun_fun_bool_fun_tree$ A_a_bool_fun_fun_bool_fun_tree$ )A_a_bool_fun_fun_bool_fun_tree$)
(declare-fun selectu$ (Bool_a_a_bool_fun_fun_fun_tree$)Bool_a_a_bool_fun_fun_fun$)
(declare-fun selectv$ (Bool_a_a_bool_fun_fun_fun_tree$)Bool_a_a_bool_fun_fun_fun_tree$)
(declare-fun selectw$ (Bool_a_a_bool_fun_fun_fun_tree$)Bool_a_a_bool_fun_fun_fun_tree$)
(declare-fun node$h (Bool_a_a_bool_fun_fun_fun$ Bool_a_a_bool_fun_fun_fun_tree$ Bool_a_a_bool_fun_fun_fun_tree$ )Bool_a_a_bool_fun_fun_fun_tree$)
(declare-fun selectx$ (Bool_a_a_a_fun_fun_fun_tree$)Bool_a_a_a_fun_fun_fun$)
(declare-fun selecty$ (Bool_a_a_a_fun_fun_fun_tree$)Bool_a_a_a_fun_fun_fun_tree$)
(declare-fun selectz$ (Bool_a_a_a_fun_fun_fun_tree$)Bool_a_a_a_fun_fun_fun_tree$)
(declare-fun node$i (Bool_a_a_a_fun_fun_fun$ Bool_a_a_a_fun_fun_fun_tree$ Bool_a_a_a_fun_fun_fun_tree$ )Bool_a_a_a_fun_fun_fun_tree$)
(declare-fun selecua$ (A_a_a_fun_fun_bool_fun_tree$)A_a_a_fun_fun_bool_fun$)
(declare-fun selecub$ (A_a_a_fun_fun_bool_fun_tree$)A_a_a_fun_fun_bool_fun_tree$)
(declare-fun selecuc$ (A_a_a_fun_fun_bool_fun_tree$)A_a_a_fun_fun_bool_fun_tree$)
(declare-fun node$j (A_a_a_fun_fun_bool_fun$ A_a_a_fun_fun_bool_fun_tree$ A_a_a_fun_fun_bool_fun_tree$ )A_a_a_fun_fun_bool_fun_tree$)
...
(declare-fun selecvh$ (A_bool_fun_bool_a_bool_fun_fun_fun_tree$)A_bool_fun_bool_a_bool_fun_fun_fun$)
(declare-fun selecvi$ (A_bool_fun_bool_a_bool_fun_fun_fun_tree$)A_bool_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun selecvj$ (A_bool_fun_bool_a_bool_fun_fun_fun_tree$)A_bool_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun node$x (A_bool_fun_bool_a_bool_fun_fun_fun$ A_bool_fun_bool_a_bool_fun_fun_fun_tree$ A_bool_fun_bool_a_bool_fun_fun_fun_tree$ )A_bool_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun selecvk$ (A_bool_fun_a_a_bool_fun_fun_fun_tree$)A_bool_fun_a_a_bool_fun_fun_fun$)
(declare-fun selecvl$ (A_bool_fun_a_a_bool_fun_fun_fun_tree$)A_bool_fun_a_a_bool_fun_fun_fun_tree$)
(declare-fun selecvm$ (A_bool_fun_a_a_bool_fun_fun_fun_tree$)A_bool_fun_a_a_bool_fun_fun_fun_tree$)
...
(declare-fun selecvn$ (A_a_fun_a_a_a_fun_fun_fun_tree$)A_a_fun_a_a_a_fun_fun_fun$)
(declare-fun selecvo$ (A_a_fun_a_a_a_fun_fun_fun_tree$)A_a_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecvp$ (A_a_fun_a_a_a_fun_fun_fun_tree$)A_a_fun_a_a_a_fun_fun_fun_tree$)
...
(declare-fun selecvt$ (A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun$)
(declare-fun selecvu$ (A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$)
(declare-fun selecvv$ (A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$)
(declare-fun node$ab (A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ )A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$)
(declare-fun selecvw$ (A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun$)
(declare-fun selecvx$ (A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecvy$ (A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun node$ac (A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecvz$ (A_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun$)
(declare-fun selecwa$ (A_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_tree$)
(declare-fun selecwb$ (A_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_tree$)
(declare-fun node$ad (A_a_a_a_fun_fun_fun$ A_a_a_a_fun_fun_fun_tree$ A_a_a_a_fun_fun_fun_tree$ )A_a_a_a_fun_fun_fun_tree$)
...
(declare-fun node$ae (A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ )A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecwf$ (A_a_fun_a_bool_fun_fun_tree$)A_a_fun_a_bool_fun_fun$)
(declare-fun selecwg$ (A_a_fun_a_bool_fun_fun_tree$)A_a_fun_a_bool_fun_fun_tree$)
(declare-fun selecwh$ (A_a_fun_a_bool_fun_fun_tree$)A_a_fun_a_bool_fun_fun_tree$)
...
(declare-fun node$ag (A_a_a_fun_a_bool_fun_fun_fun$ A_a_a_fun_a_bool_fun_fun_fun_tree$ A_a_a_fun_a_bool_fun_fun_fun_tree$ )A_a_a_fun_a_bool_fun_fun_fun_tree$)
(declare-fun selecwl$ (A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$)A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun$)
(declare-fun selecwm$ (A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$)A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecwn$ (A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$)A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$)
(declare-fun node$ah (A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun$ A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$ A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$ )A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecwo$ (A_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_a_fun_fun_fun$)
(declare-fun selecwp$ (A_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecwq$ (A_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_a_fun_fun_fun_tree$)
(declare-fun node$ai (A_a_a_fun_a_a_fun_fun_fun$ A_a_a_fun_a_a_fun_fun_fun_tree$ A_a_a_fun_a_a_fun_fun_fun_tree$ )A_a_a_fun_a_a_fun_fun_fun_tree$)
...
(declare-fun node$aj (A_a_fun_a_a_fun_fun$ A_a_fun_a_a_fun_fun_tree$ A_a_fun_a_a_fun_fun_tree$ )A_a_fun_a_a_fun_fun_tree$)
(declare-fun selecwu$ (A_bool_bool_fun_fun_tree$)A_bool_bool_fun_fun$)
(declare-fun selecwv$ (A_bool_bool_fun_fun_tree$)A_bool_bool_fun_fun_tree$)
(declare-fun selecww$ (A_bool_bool_fun_fun_tree$)A_bool_bool_fun_fun_tree$)
(declare-fun node$ak (A_bool_bool_fun_fun$ A_bool_bool_fun_fun_tree$ A_bool_bool_fun_fun_tree$ )A_bool_bool_fun_fun_tree$)
(declare-fun selecwx$ (Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$)Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun$)
(declare-fun selecwy$ (Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$)Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$)
(declare-fun selecwz$ (Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$)Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$)
(declare-fun node$al (Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun$ Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$ Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$ )Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$)
(declare-fun selecxa$ (A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$)A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun$)
(declare-fun selecxb$ (A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$)A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun selecxc$ (A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$)A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun node$am (A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun$ A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$ A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$ )A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun selecxd$ (A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$)A_a_bool_fun_fun_a_a_bool_fun_fun_fun$)
(declare-fun selecxe$ (A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$)A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$)
(declare-fun selecxf$ (A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$)A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$)
(declare-fun node$an (A_a_bool_fun_fun_a_a_bool_fun_fun_fun$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ )A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$)
(declare-fun selecxg$ (Bool_bool_a_bool_fun_fun_fun_tree$)Bool_bool_a_bool_fun_fun_fun$)
(declare-fun selecxh$ (Bool_bool_a_bool_fun_fun_fun_tree$)Bool_bool_a_bool_fun_fun_fun_tree$)
(declare-fun selecxi$ (Bool_bool_a_bool_fun_fun_fun_tree$)Bool_bool_a_bool_fun_fun_fun_tree$)
(declare-fun node$ao (Bool_bool_a_bool_fun_fun_fun$ Bool_bool_a_bool_fun_fun_fun_tree$ Bool_bool_a_bool_fun_fun_fun_tree$ )Bool_bool_a_bool_fun_fun_fun_tree$)
(declare-fun selecxj$ (Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$)Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun$)
(declare-fun selecxk$ (Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$)Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecxl$ (Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$)Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun node$ap (Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun$ Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$ Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$ )Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecxm$ (A_bool_a_bool_fun_fun_fun_tree$)A_bool_a_bool_fun_fun_fun$)
(declare-fun selecxn$ (A_bool_a_bool_fun_fun_fun_tree$)A_bool_a_bool_fun_fun_fun_tree$)
(declare-fun selecxo$ (A_bool_a_bool_fun_fun_fun_tree$)A_bool_a_bool_fun_fun_fun_tree$)
(declare-fun node$aq (A_bool_a_bool_fun_fun_fun$ A_bool_a_bool_fun_fun_fun_tree$ A_bool_a_bool_fun_fun_fun_tree$ )A_bool_a_bool_fun_fun_fun_tree$)
(declare-fun selecxp$ (Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$)Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun$)
(declare-fun selecxq$ (Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$)Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecxr$ (Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$)Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun node$ar (Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun$ Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$ Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$ )Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecxs$ (A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$)A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun$)
(declare-fun selecxt$ (A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$)A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecxu$ (A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$)A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun node$as (A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun$ A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$ A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$ )A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecxv$ (A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun$)
(declare-fun selecxw$ (A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecxx$ (A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun node$at (A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun selecxy$ (A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun$)
(declare-fun selecxz$ (A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecya$ (A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$)
...
(declare-fun selecyb$ (A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun$)
(declare-fun selecyc$ (A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)
(declare-fun selecyd$ (A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)
...
(declare-fun selecye$ (Bool_a_fun_tree$)Bool_a_fun$)
(declare-fun selecyf$ (Bool_a_fun_tree$)Bool_a_fun_tree$)
(declare-fun selecyg$ (Bool_a_fun_tree$)Bool_a_fun_tree$)
(declare-fun node$aw (Bool_a_fun$ Bool_a_fun_tree$ Bool_a_fun_tree$ )Bool_a_fun_tree$)
(declare-fun selecyh$ (Bool_a_fun_bool_bool_fun_fun_tree$)Bool_a_fun_bool_bool_fun_fun$)
(declare-fun selecyi$ (Bool_a_fun_bool_bool_fun_fun_tree$)Bool_a_fun_bool_bool_fun_fun_tree$)
(declare-fun selecyj$ (Bool_a_fun_bool_bool_fun_fun_tree$)Bool_a_fun_bool_bool_fun_fun_tree$)
(declare-fun node$ax (Bool_a_fun_bool_bool_fun_fun$ Bool_a_fun_bool_bool_fun_fun_tree$ Bool_a_fun_bool_bool_fun_fun_tree$ )Bool_a_fun_bool_bool_fun_fun_tree$)
(declare-fun selecyk$ (Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$)Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun$)
(declare-fun selecyl$ (Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$)Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$)
(declare-fun selecym$ (Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$)Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$)
(declare-fun node$ay (Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun$ Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$ Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$ )Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$)
(declare-fun selecyn$ (A_bool_fun_a_bool_fun_fun_tree$)A_bool_fun_a_bool_fun_fun$)
(declare-fun selecyo$ (A_bool_fun_a_bool_fun_fun_tree$)A_bool_fun_a_bool_fun_fun_tree$)
(declare-fun selecyp$ (A_bool_fun_a_bool_fun_fun_tree$)A_bool_fun_a_bool_fun_fun_tree$)
(declare-fun node$az (A_bool_fun_a_bool_fun_fun$ A_bool_fun_a_bool_fun_fun_tree$ A_bool_fun_a_bool_fun_fun_tree$ )A_bool_fun_a_bool_fun_fun_tree$)
(declare-fun selecyq$ (A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$)A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun$)
(declare-fun selecyr$ (A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$)A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$)
(declare-fun selecys$ (A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$)A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$)
(declare-fun node$ba (A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$)
(declare-fun selecyt$ (A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$)A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun$)
(declare-fun selecyu$ (A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$)A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$)
(declare-fun selecyv$ (A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$)A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$)
(declare-fun node$bb (A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$)
(declare-fun selecyw$ (A_bool_a_fun_fun_tree$)A_bool_a_fun_fun$)
(declare-fun selecyx$ (A_bool_a_fun_fun_tree$)A_bool_a_fun_fun_tree$)
(declare-fun selecyy$ (A_bool_a_fun_fun_tree$)A_bool_a_fun_fun_tree$)
(declare-fun node$bc (A_bool_a_fun_fun$ A_bool_a_fun_fun_tree$ A_bool_a_fun_fun_tree$ )A_bool_a_fun_fun_tree$)
(declare-fun selecyz$ (A_bool_fun_a_a_fun_fun_tree$)A_bool_fun_a_a_fun_fun$)
(declare-fun selecza$ (A_bool_fun_a_a_fun_fun_tree$)A_bool_fun_a_a_fun_fun_tree$)
(declare-fun seleczb$ (A_bool_fun_a_a_fun_fun_tree$)A_bool_fun_a_a_fun_fun_tree$)
(declare-fun node$bd (A_bool_fun_a_a_fun_fun$ A_bool_fun_a_a_fun_fun_tree$ A_bool_fun_a_a_fun_fun_tree$ )A_bool_fun_a_a_fun_fun_tree$)
(declare-fun seleczc$ (A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$)A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun$)
(declare-fun seleczd$ (A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$)A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecze$ (A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$)A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$)
(declare-fun node$be (A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ )A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$)
(declare-fun seleczf$ (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$)
(declare-fun seleczg$ (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)
(declare-fun seleczh$ (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)
(declare-fun node$bf (A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)
(declare-fun seleczi$ (A_a_bool_fun_bool_fun_fun_tree$)A_a_bool_fun_bool_fun_fun$)
(declare-fun seleczj$ (A_a_bool_fun_bool_fun_fun_tree$)A_a_bool_fun_bool_fun_fun_tree$)
(declare-fun seleczk$ (A_a_bool_fun_bool_fun_fun_tree$)A_a_bool_fun_bool_fun_fun_tree$)
(declare-fun node$bg (A_a_bool_fun_bool_fun_fun$ A_a_bool_fun_bool_fun_fun_tree$ A_a_bool_fun_bool_fun_fun_tree$ )A_a_bool_fun_bool_fun_fun_tree$)
(declare-fun seleczl$ (A_a_bool_fun_fun_a_bool_fun_fun_tree$)A_a_bool_fun_fun_a_bool_fun_fun$)
(declare-fun seleczm$ (A_a_bool_fun_fun_a_bool_fun_fun_tree$)A_a_bool_fun_fun_a_bool_fun_fun_tree$)
(declare-fun seleczn$ (A_a_bool_fun_fun_a_bool_fun_fun_tree$)A_a_bool_fun_fun_a_bool_fun_fun_tree$)
(declare-fun node$bh (A_a_bool_fun_fun_a_bool_fun_fun$ A_a_bool_fun_fun_a_bool_fun_fun_tree$ A_a_bool_fun_fun_a_bool_fun_fun_tree$ )A_a_bool_fun_fun_a_bool_fun_fun_tree$)
(declare-fun seleczo$ (A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$)A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun$)
(declare-fun seleczp$ (A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$)A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$)
(declare-fun seleczq$ (A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$)A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$)
(declare-fun node$bi (A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$)
(declare-fun seleczr$ (A_bool_fun_bool_fun_tree$)A_bool_fun_bool_fun$)
(declare-fun seleczs$ (A_bool_fun_bool_fun_tree$)A_bool_fun_bool_fun_tree$)
(declare-fun seleczt$ (A_bool_fun_bool_fun_tree$)A_bool_fun_bool_fun_tree$)
(declare-fun node$bj (A_bool_fun_bool_fun$ A_bool_fun_bool_fun_tree$ A_bool_fun_bool_fun_tree$ )A_bool_fun_bool_fun_tree$)
(declare-fun seleczu$ (A_a_a_fun_bool_fun_fun_tree$)A_a_a_fun_bool_fun_fun$)
(declare-fun seleczv$ (A_a_a_fun_bool_fun_fun_tree$)A_a_a_fun_bool_fun_fun_tree$)
(declare-fun seleczw$ (A_a_a_fun_bool_fun_fun_tree$)A_a_a_fun_bool_fun_fun_tree$)
(declare-fun node$bk (A_a_a_fun_bool_fun_fun$ A_a_a_fun_bool_fun_fun_tree$ A_a_a_fun_bool_fun_fun_tree$ )A_a_a_fun_bool_fun_fun_tree$)
(declare-fun seleczx$ (A_a_a_fun_fun_a_bool_fun_fun_tree$)A_a_a_fun_fun_a_bool_fun_fun$)
(declare-fun seleczy$ (A_a_a_fun_fun_a_bool_fun_fun_tree$)A_a_a_fun_fun_a_bool_fun_fun_tree$)
(declare-fun seleczz$ (A_a_a_fun_fun_a_bool_fun_fun_tree$)A_a_a_fun_fun_a_bool_fun_fun_tree$)
(declare-fun node$bl (A_a_a_fun_fun_a_bool_fun_fun$ A_a_a_fun_fun_a_bool_fun_fun_tree$ A_a_a_fun_fun_a_bool_fun_fun_tree$ )A_a_a_fun_fun_a_bool_fun_fun_tree$)
(declare-fun seledaa$ (A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$)A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun$)
(declare-fun seledab$ (A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$)A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$)
(declare-fun seledac$ (A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$)A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$)
(declare-fun node$bm (A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ )A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$)
(declare-fun seledad$ (A_a_fun_bool_fun_tree$)A_a_fun_bool_fun$)
(declare-fun seledae$ (A_a_fun_bool_fun_tree$)A_a_fun_bool_fun_tree$)
(declare-fun seledaf$ (A_a_fun_bool_fun_tree$)A_a_fun_bool_fun_tree$)
(declare-fun node$bn (A_a_fun_bool_fun$ A_a_fun_bool_fun_tree$ A_a_fun_bool_fun_tree$ )A_a_fun_bool_fun_tree$)
(declare-fun seledag$ (Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$)Bool_bool_fun_bool_a_bool_fun_fun_fun$)
(declare-fun seledah$ (Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$)Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun seledai$ (Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$)Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun node$bo (Bool_bool_fun_bool_a_bool_fun_fun_fun$ Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$ Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$ )Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun seledaj$ (Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$)Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun$)
(declare-fun seledak$ (Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$)Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun seledal$ (Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$)Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun node$bp (Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun$ Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$ Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$ )Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun seledam$ (Bool_a_fun_bool_a_bool_fun_fun_fun_tree$)Bool_a_fun_bool_a_bool_fun_fun_fun$)
(declare-fun seledan$ (Bool_a_fun_bool_a_bool_fun_fun_fun_tree$)Bool_a_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun seledao$ (Bool_a_fun_bool_a_bool_fun_fun_fun_tree$)Bool_a_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun node$bq (Bool_a_fun_bool_a_bool_fun_fun_fun$ Bool_a_fun_bool_a_bool_fun_fun_fun_tree$ Bool_a_fun_bool_a_bool_fun_fun_fun_tree$ )Bool_a_fun_bool_a_bool_fun_fun_fun_tree$)
(declare-fun seledap$ (Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$)Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun$)
(declare-fun seledaq$ (Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$)Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun seledar$ (Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$)Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun node$br (Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun$ Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$ Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$ )Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$)
(declare-fun seledas$ (A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$)A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun$)
(declare-fun seledat$ (A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$)A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun seledau$ (A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$)A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun node$bs (A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ )A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$)
(declare-fun seledav$ (A_bool_fun_a_fun_tree$)A_bool_fun_a_fun$)
(declare-fun seledaw$ (A_bool_fun_a_fun_tree$)A_bool_fun_a_fun_tree$)
(declare-fun seledax$ (A_bool_fun_a_fun_tree$)A_bool_fun_a_fun_tree$)
(declare-fun node$bt (A_bool_fun_a_fun$ A_bool_fun_a_fun_tree$ A_bool_fun_a_fun_tree$ )A_bool_fun_a_fun_tree$)
