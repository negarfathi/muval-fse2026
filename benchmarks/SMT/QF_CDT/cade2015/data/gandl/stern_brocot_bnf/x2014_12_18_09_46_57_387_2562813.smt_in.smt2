...
(declare-sort Nat$ 0 )
(declare-datatypes ()((Dir$ (l$ )(r$ ))(Nat_nat_prod$ (pair$ (fst$ Nat$ )(snd$ Nat$ )))(Nat_nat_prod_nat_nat_prod_prod$ (pair$a (fst$a Nat_nat_prod$ )(snd$a Nat_nat_prod$ )))(Dir_list$ (nil$ )(cons$ (hd$ Dir$ )(tl$ Dir_list$ )))))
(declare-fun d$ ()Dir$ )
(declare-fun d$a ()Dir$ )
