...
(declare-sort A_b_a_fun_stream_fun_stream$ 0)
...
(declare-sort B_a_fun_stream_b_fun_stream$ 0)
(declare-sort A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun_stream$ 0)
...
(declare-sort B_a_fun_stream_b_a_fun_stream_fun_stream$ 0)
...
(declare-fun selectb$ (A_b_a_fun_stream_fun_stream$)A_b_a_fun_stream_fun$)
(declare-fun selectc$ (A_b_a_fun_stream_fun_stream$)A_b_a_fun_stream_fun_stream$)
(declare-fun sCons$c (A_b_a_fun_stream_fun$ A_b_a_fun_stream_fun_stream$ )A_b_a_fun_stream_fun_stream$)
(declare-fun selectd$ (A_b_a_fun_b_a_fun_fun_fun_stream$)A_b_a_fun_b_a_fun_fun_fun$)
(declare-fun selecte$ (A_b_a_fun_b_a_fun_fun_fun_stream$)A_b_a_fun_b_a_fun_fun_fun_stream$)
(declare-fun sCons$d (A_b_a_fun_b_a_fun_fun_fun$ A_b_a_fun_b_a_fun_fun_fun_stream$ )A_b_a_fun_b_a_fun_fun_fun_stream$)
...
(declare-fun selecth$ (A_b_fun_stream$)A_b_fun$)
(declare-fun selecti$ (A_b_fun_stream$)A_b_fun_stream$)
(declare-fun sCons$f (A_b_fun$ A_b_fun_stream$ )A_b_fun_stream$)
...
(declare-fun sCons$h (B_a_fun_stream$ B_a_fun_stream_stream$ )B_a_fun_stream_stream$)
(declare-fun selectl$ (B_a_fun_b_a_fun_fun_stream$)B_a_fun_b_a_fun_fun$)
(declare-fun selectm$ (B_a_fun_b_a_fun_fun_stream$)B_a_fun_b_a_fun_fun_stream$)
(declare-fun sCons$i (B_a_fun_b_a_fun_fun$ B_a_fun_b_a_fun_fun_stream$ )B_a_fun_b_a_fun_fun_stream$)
(declare-fun selectn$ (B_b_fun_stream$)B_b_fun$)
(declare-fun selecto$ (B_b_fun_stream$)B_b_fun_stream$)
(declare-fun sCons$j (B_b_fun$ B_b_fun_stream$ )B_b_fun_stream$)
(declare-fun selectp$ (B_a_fun_b_fun_stream$)B_a_fun_b_fun$)
(declare-fun selectq$ (B_a_fun_b_fun_stream$)B_a_fun_b_fun_stream$)
(declare-fun sCons$k (B_a_fun_b_fun$ B_a_fun_b_fun_stream$ )B_a_fun_b_fun_stream$)
(declare-fun selectr$ (B_a_fun_a_fun_stream$)B_a_fun_a_fun$)
(declare-fun selects$ (B_a_fun_a_fun_stream$)B_a_fun_a_fun_stream$)
(declare-fun sCons$l (B_a_fun_a_fun$ B_a_fun_a_fun_stream$ )B_a_fun_a_fun_stream$)
(declare-fun selectt$ (B_b_a_fun_fun_stream$)B_b_a_fun_fun$)
(declare-fun selectu$ (B_b_a_fun_fun_stream$)B_b_a_fun_fun_stream$)
(declare-fun sCons$m (B_b_a_fun_fun$ B_b_a_fun_fun_stream$ )B_b_a_fun_fun_stream$)
(declare-fun selectv$ (B_a_fun_stream_b_fun_stream$)B_a_fun_stream_b_fun$)
(declare-fun selectw$ (B_a_fun_stream_b_fun_stream$)B_a_fun_stream_b_fun_stream$)
(declare-fun sCons$n (B_a_fun_stream_b_fun$ B_a_fun_stream_b_fun_stream$ )B_a_fun_stream_b_fun_stream$)
(declare-fun selectx$ (A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun_stream$)A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun$)
(declare-fun selecty$ (A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun_stream$)A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun_stream$)
(declare-fun sCons$o (A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun$ A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun_stream$ )A_b_a_fun_stream_fun_a_b_a_fun_stream_fun_fun_stream$)
(declare-fun selectz$ (A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun_stream$)A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun$)
(declare-fun selecua$ (A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun_stream$)A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun_stream$)
(declare-fun sCons$p (A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun$ A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun_stream$ )A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun_stream$)
...
(declare-fun sCons$q (A_b_a_fun_fun_a_b_a_fun_fun_fun$ A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$ )A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$)
...
(declare-fun sCons$r (A_b_fun_a_b_fun_fun$ A_b_fun_a_b_fun_fun_stream$ )A_b_fun_a_b_fun_fun_stream$)
...
(declare-fun sCons$s (A_a_fun_a_a_fun_fun$ A_a_fun_a_a_fun_fun_stream$ )A_a_fun_a_a_fun_fun_stream$)
...
(declare-fun sCons$t (B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun$ B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_stream$ )B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_stream$)
(declare-fun selecuj$ (B_a_fun_stream_b_a_fun_stream_fun_stream$)B_a_fun_stream_b_a_fun_stream_fun$)
(declare-fun selecuk$ (B_a_fun_stream_b_a_fun_stream_fun_stream$)B_a_fun_stream_b_a_fun_stream_fun_stream$)
(declare-fun sCons$u (B_a_fun_stream_b_a_fun_stream_fun$ B_a_fun_stream_b_a_fun_stream_fun_stream$ )B_a_fun_stream_b_a_fun_stream_fun_stream$)
