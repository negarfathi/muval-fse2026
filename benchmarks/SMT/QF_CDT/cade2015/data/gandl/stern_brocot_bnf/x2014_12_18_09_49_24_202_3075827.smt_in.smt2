...
(declare-fun node$a (Int Int_tree$ Int_tree$ )Int_tree$)
(declare-fun select$ (Int_int_fun_tree$)Int_int_fun$)
(declare-fun selecta$ (Int_int_fun_tree$)Int_int_fun_tree$)
(declare-fun selectb$ (Int_int_fun_tree$)Int_int_fun_tree$)
(declare-fun node$b (Int_int_fun$ Int_int_fun_tree$ Int_int_fun_tree$ )Int_int_fun_tree$)
(declare-fun selectc$ (Nat_int_fun_tree$)Nat_int_fun$)
(declare-fun selectd$ (Nat_int_fun_tree$)Nat_int_fun_tree$)
(declare-fun selecte$ (Nat_int_fun_tree$)Nat_int_fun_tree$)
(declare-fun node$c (Nat_int_fun$ Nat_int_fun_tree$ Nat_int_fun_tree$ )Nat_int_fun_tree$)
(declare-fun selectf$ (Int_nat_fun_tree$)Int_nat_fun$)
(declare-fun selectg$ (Int_nat_fun_tree$)Int_nat_fun_tree$)
(declare-fun selecth$ (Int_nat_fun_tree$)Int_nat_fun_tree$)
(declare-fun node$d (Int_nat_fun$ Int_nat_fun_tree$ Int_nat_fun_tree$ )Int_nat_fun_tree$)
...
(declare-sort Int_int_fun_nat_nat_fun_fun_tree$ 0)
(declare-sort Int_int_fun_nat_int_fun_fun_tree$ 0)
(declare-sort Int_int_fun_int_nat_fun_fun_tree$ 0)
(declare-sort Int_int_fun_nat_fun_tree$ 0)
(declare-sort Nat_int_fun_nat_fun_tree$ 0)
(declare-sort Int_nat_fun_nat_fun_tree$ 0)
(declare-sort Nat_nat_fun_nat_fun_tree$ 0)
(declare-sort Nat_int_fun_int_fun_tree$ 0)
(declare-sort Int_nat_nat_fun_fun_tree$ 0)
(declare-sort Int_int_nat_fun_fun_tree$ 0)
(declare-sort Int_nat_int_fun_fun_tree$ 0)
(declare-sort Int_int_int_fun_fun_tree$ 0)
(declare-sort Nat_nat_nat_fun_fun_tree$ 0)
(declare-sort Nat_int_nat_fun_fun_tree$ 0)
(declare-fun selectl$ (Int_int_fun_int_fun_tree$)Int_int_fun_int_fun$)
(declare-fun selectm$ (Int_int_fun_int_fun_tree$)Int_int_fun_int_fun_tree$)
(declare-fun selectn$ (Int_int_fun_int_fun_tree$)Int_int_fun_int_fun_tree$)
(declare-fun node$f (Int_int_fun_int_fun$ Int_int_fun_int_fun_tree$ Int_int_fun_int_fun_tree$ )Int_int_fun_int_fun_tree$)
(declare-fun selecto$ (Int_int_fun_nat_nat_fun_fun_tree$)Int_int_fun_nat_nat_fun_fun$)
(declare-fun selectp$ (Int_int_fun_nat_nat_fun_fun_tree$)Int_int_fun_nat_nat_fun_fun_tree$)
(declare-fun selectq$ (Int_int_fun_nat_nat_fun_fun_tree$)Int_int_fun_nat_nat_fun_fun_tree$)
(declare-fun node$g (Int_int_fun_nat_nat_fun_fun$ Int_int_fun_nat_nat_fun_fun_tree$ Int_int_fun_nat_nat_fun_fun_tree$ )Int_int_fun_nat_nat_fun_fun_tree$)
(declare-fun selectr$ (Int_int_fun_nat_int_fun_fun_tree$)Int_int_fun_nat_int_fun_fun$)
(declare-fun selects$ (Int_int_fun_nat_int_fun_fun_tree$)Int_int_fun_nat_int_fun_fun_tree$)
(declare-fun selectt$ (Int_int_fun_nat_int_fun_fun_tree$)Int_int_fun_nat_int_fun_fun_tree$)
(declare-fun node$h (Int_int_fun_nat_int_fun_fun$ Int_int_fun_nat_int_fun_fun_tree$ Int_int_fun_nat_int_fun_fun_tree$ )Int_int_fun_nat_int_fun_fun_tree$)
(declare-fun selectu$ (Int_int_fun_int_nat_fun_fun_tree$)Int_int_fun_int_nat_fun_fun$)
(declare-fun selectv$ (Int_int_fun_int_nat_fun_fun_tree$)Int_int_fun_int_nat_fun_fun_tree$)
(declare-fun selectw$ (Int_int_fun_int_nat_fun_fun_tree$)Int_int_fun_int_nat_fun_fun_tree$)
(declare-fun node$i (Int_int_fun_int_nat_fun_fun$ Int_int_fun_int_nat_fun_fun_tree$ Int_int_fun_int_nat_fun_fun_tree$ )Int_int_fun_int_nat_fun_fun_tree$)
(declare-fun selectx$ (Int_int_fun_nat_fun_tree$)Int_int_fun_nat_fun$)
(declare-fun selecty$ (Int_int_fun_nat_fun_tree$)Int_int_fun_nat_fun_tree$)
(declare-fun selectz$ (Int_int_fun_nat_fun_tree$)Int_int_fun_nat_fun_tree$)
(declare-fun node$j (Int_int_fun_nat_fun$ Int_int_fun_nat_fun_tree$ Int_int_fun_nat_fun_tree$ )Int_int_fun_nat_fun_tree$)
(declare-fun selecua$ (Nat_int_fun_nat_fun_tree$)Nat_int_fun_nat_fun$)
(declare-fun selecub$ (Nat_int_fun_nat_fun_tree$)Nat_int_fun_nat_fun_tree$)
(declare-fun selecuc$ (Nat_int_fun_nat_fun_tree$)Nat_int_fun_nat_fun_tree$)
(declare-fun node$k (Nat_int_fun_nat_fun$ Nat_int_fun_nat_fun_tree$ Nat_int_fun_nat_fun_tree$ )Nat_int_fun_nat_fun_tree$)
(declare-fun selecud$ (Int_nat_fun_nat_fun_tree$)Int_nat_fun_nat_fun$)
(declare-fun selecue$ (Int_nat_fun_nat_fun_tree$)Int_nat_fun_nat_fun_tree$)
(declare-fun selecuf$ (Int_nat_fun_nat_fun_tree$)Int_nat_fun_nat_fun_tree$)
(declare-fun node$l (Int_nat_fun_nat_fun$ Int_nat_fun_nat_fun_tree$ Int_nat_fun_nat_fun_tree$ )Int_nat_fun_nat_fun_tree$)
(declare-fun selecug$ (Nat_nat_fun_nat_fun_tree$)Nat_nat_fun_nat_fun$)
(declare-fun selecuh$ (Nat_nat_fun_nat_fun_tree$)Nat_nat_fun_nat_fun_tree$)
(declare-fun selecui$ (Nat_nat_fun_nat_fun_tree$)Nat_nat_fun_nat_fun_tree$)
(declare-fun node$m (Nat_nat_fun_nat_fun$ Nat_nat_fun_nat_fun_tree$ Nat_nat_fun_nat_fun_tree$ )Nat_nat_fun_nat_fun_tree$)
(declare-fun selecuj$ (Nat_int_fun_int_fun_tree$)Nat_int_fun_int_fun$)
(declare-fun selecuk$ (Nat_int_fun_int_fun_tree$)Nat_int_fun_int_fun_tree$)
(declare-fun selecul$ (Nat_int_fun_int_fun_tree$)Nat_int_fun_int_fun_tree$)
(declare-fun node$n (Nat_int_fun_int_fun$ Nat_int_fun_int_fun_tree$ Nat_int_fun_int_fun_tree$ )Nat_int_fun_int_fun_tree$)
(declare-fun selecum$ (Int_nat_nat_fun_fun_tree$)Int_nat_nat_fun_fun$)
(declare-fun selecun$ (Int_nat_nat_fun_fun_tree$)Int_nat_nat_fun_fun_tree$)
(declare-fun selecuo$ (Int_nat_nat_fun_fun_tree$)Int_nat_nat_fun_fun_tree$)
(declare-fun node$o (Int_nat_nat_fun_fun$ Int_nat_nat_fun_fun_tree$ Int_nat_nat_fun_fun_tree$ )Int_nat_nat_fun_fun_tree$)
(declare-fun selecup$ (Int_int_nat_fun_fun_tree$)Int_int_nat_fun_fun$)
(declare-fun selecuq$ (Int_int_nat_fun_fun_tree$)Int_int_nat_fun_fun_tree$)
(declare-fun selecur$ (Int_int_nat_fun_fun_tree$)Int_int_nat_fun_fun_tree$)
(declare-fun node$p (Int_int_nat_fun_fun$ Int_int_nat_fun_fun_tree$ Int_int_nat_fun_fun_tree$ )Int_int_nat_fun_fun_tree$)
(declare-fun selecus$ (Int_nat_int_fun_fun_tree$)Int_nat_int_fun_fun$)
(declare-fun selecut$ (Int_nat_int_fun_fun_tree$)Int_nat_int_fun_fun_tree$)
(declare-fun selecuu$ (Int_nat_int_fun_fun_tree$)Int_nat_int_fun_fun_tree$)
(declare-fun node$q (Int_nat_int_fun_fun$ Int_nat_int_fun_fun_tree$ Int_nat_int_fun_fun_tree$ )Int_nat_int_fun_fun_tree$)
(declare-fun selecuv$ (Int_int_int_fun_fun_tree$)Int_int_int_fun_fun$)
(declare-fun selecuw$ (Int_int_int_fun_fun_tree$)Int_int_int_fun_fun_tree$)
(declare-fun selecux$ (Int_int_int_fun_fun_tree$)Int_int_int_fun_fun_tree$)
(declare-fun node$r (Int_int_int_fun_fun$ Int_int_int_fun_fun_tree$ Int_int_int_fun_fun_tree$ )Int_int_int_fun_fun_tree$)
(declare-fun selecuy$ (Nat_nat_nat_fun_fun_tree$)Nat_nat_nat_fun_fun$)
(declare-fun selecuz$ (Nat_nat_nat_fun_fun_tree$)Nat_nat_nat_fun_fun_tree$)
(declare-fun selecva$ (Nat_nat_nat_fun_fun_tree$)Nat_nat_nat_fun_fun_tree$)
(declare-fun node$s (Nat_nat_nat_fun_fun$ Nat_nat_nat_fun_fun_tree$ Nat_nat_nat_fun_fun_tree$ )Nat_nat_nat_fun_fun_tree$)
(declare-fun selecvb$ (Nat_int_nat_fun_fun_tree$)Nat_int_nat_fun_fun$)
(declare-fun selecvc$ (Nat_int_nat_fun_fun_tree$)Nat_int_nat_fun_fun_tree$)
(declare-fun selecvd$ (Nat_int_nat_fun_fun_tree$)Nat_int_nat_fun_fun_tree$)
(declare-fun node$t (Nat_int_nat_fun_fun$ Nat_int_nat_fun_fun_tree$ Nat_int_nat_fun_fun_tree$ )Nat_int_nat_fun_fun_tree$)
