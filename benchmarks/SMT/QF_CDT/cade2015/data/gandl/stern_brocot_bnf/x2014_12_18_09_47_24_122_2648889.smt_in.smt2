...
(declare-sort B_c_fun_b_a_fun_fun_stream$ 0)
(declare-sort B_c_fun_stream$ 0)
(declare-sort C_a_fun_b_c_fun_b_a_fun_fun_fun_stream$ 0)
...
(declare-sort C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_stream$ 0)
(declare-sort C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_fun_stream$ 0)
(declare-sort B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun_stream$ 0)
...
(declare-fun selectb$ (B_c_fun_b_a_fun_fun_stream$)B_c_fun_b_a_fun_fun$)
(declare-fun selectc$ (B_c_fun_b_a_fun_fun_stream$)B_c_fun_b_a_fun_fun_stream$)
(declare-fun sCons$c (B_c_fun_b_a_fun_fun$ B_c_fun_b_a_fun_fun_stream$ )B_c_fun_b_a_fun_fun_stream$)
(declare-fun selectd$ (B_c_fun_stream$)B_c_fun$)
(declare-fun selecte$ (B_c_fun_stream$)B_c_fun_stream$)
(declare-fun sCons$d (B_c_fun$ B_c_fun_stream$ )B_c_fun_stream$)
(declare-fun selectf$ (C_a_fun_b_c_fun_b_a_fun_fun_fun_stream$)C_a_fun_b_c_fun_b_a_fun_fun_fun$)
(declare-fun selectg$ (C_a_fun_b_c_fun_b_a_fun_fun_fun_stream$)C_a_fun_b_c_fun_b_a_fun_fun_fun_stream$)
(declare-fun sCons$e (C_a_fun_b_c_fun_b_a_fun_fun_fun$ C_a_fun_b_c_fun_b_a_fun_fun_fun_stream$ )C_a_fun_b_c_fun_b_a_fun_fun_fun_stream$)
(declare-fun selecth$ (C_a_fun_stream$)C_a_fun$)
(declare-fun selecti$ (C_a_fun_stream$)C_a_fun_stream$)
(declare-fun sCons$f (C_a_fun$ C_a_fun_stream$ )C_a_fun_stream$)
(declare-fun shd$b (C_stream$)C$)
(declare-fun stl$b (C_stream$)C_stream$)
(declare-fun sCons$g (C$ C_stream$ )C_stream$)
...
(declare-fun sCons$k (A_a_fun_a_a_fun_fun$ A_a_fun_a_a_fun_fun_stream$ )A_a_fun_a_a_fun_fun_stream$)
(declare-fun selectr$ (C_c_fun_stream$)C_c_fun$)
(declare-fun selects$ (C_c_fun_stream$)C_c_fun_stream$)
(declare-fun sCons$l (C_c_fun$ C_c_fun_stream$ )C_c_fun_stream$)
(declare-fun selectt$ (B_b_fun_stream$)B_b_fun$)
(declare-fun selectu$ (B_b_fun_stream$)B_b_fun_stream$)
(declare-fun sCons$m (B_b_fun$ B_b_fun_stream$ )B_b_fun_stream$)
(declare-fun selectv$ (C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_stream$)C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun$)
(declare-fun selectw$ (C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_stream$)C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_stream$)
(declare-fun sCons$n (C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun$ C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_stream$ )C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_stream$)
(declare-fun selectx$ (C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_fun_stream$)C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_fun$)
(declare-fun selecty$ (C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_fun_stream$)C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_fun_stream$)
(declare-fun sCons$o (C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_fun$ C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_fun_stream$ )C_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_c_a_fun_b_c_fun_b_a_fun_fun_fun_fun_fun_stream$)
(declare-fun selectz$ (B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun_stream$)B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun$)
(declare-fun selecua$ (B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun_stream$)B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun_stream$)
(declare-fun sCons$p (B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun$ B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun_stream$ )B_c_fun_b_a_fun_fun_b_c_fun_b_a_fun_fun_fun_stream$)
