...
(declare-datatypes ()((Dir$ (l$ )(r$ ))(Nat_nat_prod$ (pair$ (fst$ Nat$ )(snd$ Nat$ )))(Nat_nat_prod_nat_nat_prod_prod$ (pair$a (fst$a Nat_nat_prod$ )(snd$a Nat_nat_prod$ )))))
(declare-fun d$ ()Dir$ )
...
(assert (! (not (case_dir$ (less$ (fun_app$e (case_prod$a uu$ )(mediant$ p_m$ ))(fun_app$e (case_prod$a uu$ )(mediant$ m$ )))(less$ (fun_app$e (case_prod$a uu$ )(mediant$ m$ ))(fun_app$e (case_prod$a uu$ )(mediant$ p_m$ )))d$ )):named a7 ))
(assert (! (= (det$ pm$ )one$ ):named a8 ))
(assert (! (not (= d$a d$ )):named a9 ))
(assert (! (= (mulmat$ (case_dir$a (mulmat$ m$ lLmat$ )(mulmat$ m$ uRmat$ )d$ )p_m$a )p_m$ ):named a10 ))
(assert (! (= (det$ m$ )one$ ):named a11 ))
(assert (! (= (det$ p_m$ )one$ ):named a12 ))
...
(assert (! (case_dir$ (less$ (fun_app$e (case_prod$a uu$ )(mediant$ pm$a ))(fun_app$e (case_prod$a uu$ )(mediant$ m$ )))(less$ (fun_app$e (case_prod$a uu$ )(mediant$ m$ ))(fun_app$e (case_prod$a uu$ )(mediant$ pm$a )))d$a ):named a16 ))
(assert (! (=> (forall ((?v0 Nat_nat_prod_nat_nat_prod_prod$ ))(=> (and (= (mulmat$ (case_dir$a (mulmat$ m$ lLmat$ )(mulmat$ m$ uRmat$ )d$ )?v0 )p_m$ )(= (det$ ?v0 )one$ ))false ))false ):named a17 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(= (= (of_nat$a ?v0 )(of_nat$a ?v1 ))(= ?v0 ?v1 ))):named a18 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(= (= (of_nat$b ?v0 )(of_nat$b ?v1 ))(= ?v0 ?v1 ))):named a19 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(= (= (of_nat$ ?v0 )(of_nat$ ?v1 ))(= ?v0 ?v1 ))):named a20 ))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_prod$ )(?v1 Nat_nat_prod_nat_nat_prod_prod$ )(?v2 Nat_nat_prod_nat_nat_prod_prod$ ))(= (mulmat$ (mulmat$ ?v0 ?v1 )?v2 )(mulmat$ ?v0 (mulmat$ ?v1 ?v2 )))):named a21 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(=> (less$a (of_nat$a ?v0 )(of_nat$a ?v1 ))(less$a ?v0 ?v1 ))):named a22 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(=> (less$ (of_nat$b ?v0 )(of_nat$b ?v1 ))(less$a ?v0 ?v1 ))):named a23 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(=> (< (of_nat$ ?v0 )(of_nat$ ?v1 ))(less$a ?v0 ?v1 ))):named a24 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(=> (less$a ?v0 ?v1 )(less$a (of_nat$a ?v0 )(of_nat$a ?v1 )))):named a25 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(=> (less$a ?v0 ?v1 )(less$ (of_nat$b ?v0 )(of_nat$b ?v1 )))):named a26 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(=> (less$a ?v0 ?v1 )(< (of_nat$ ?v0 )(of_nat$ ?v1 )))):named a27 ))
(assert (! (forall ((?v0 Rat$ ))(exists ((?v1 Nat$ ))(less$ ?v0 (of_nat$b ?v1 )))):named a28 ))
(assert (! (forall ((?v0 Nat_nat_nat_nat_prod_fun_fun$ )(?v1 Nat_nat_nat_nat_prod_fun_fun$ )(?v2 Nat_nat_prod$ ))(= (fun_app$d (case_prod$ ?v0 )(fun_app$d (case_prod$ ?v1 )?v2 ))(fun_app$d (case_prod$ (uua$ ?v0 ?v1 ))?v2 ))):named a29 ))
(assert (! (forall ((?v0 Nat_nat_rat_fun_fun$ )(?v1 Nat_nat_nat_nat_prod_fun_fun$ )(?v2 Nat_nat_prod$ ))(= (fun_app$e (case_prod$a ?v0 )(fun_app$d (case_prod$ ?v1 )?v2 ))(fun_app$e (case_prod$a (uub$ ?v0 ?v1 ))?v2 ))):named a30 ))
(assert (! (forall ((?v0 Rat_nat_nat_prod_fun$ )(?v1 Nat_nat_rat_fun_fun$ )(?v2 Nat_nat_prod$ ))(= (fun_app$f ?v0 (fun_app$e (case_prod$a ?v1 )?v2 ))(fun_app$d (case_prod$ (uuc$ ?v0 ?v1 ))?v2 ))):named a31 ))
(assert (! (forall ((?v0 Nat_nat_prod_rat_fun$ )(?v1 Nat_nat_nat_nat_prod_fun_fun$ )(?v2 Nat_nat_prod$ ))(= (fun_app$e ?v0 (fun_app$d (case_prod$ ?v1 )?v2 ))(fun_app$e (case_prod$a (uud$ ?v0 ?v1 ))?v2 ))):named a32 ))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun$ )(?v1 Nat_nat_nat_nat_prod_fun_fun$ )(?v2 Nat_nat_prod$ ))(= (fun_app$d ?v0 (fun_app$d (case_prod$ ?v1 )?v2 ))(fun_app$d (case_prod$ (uue$ ?v0 ?v1 ))?v2 ))):named a33 ))
(assert (! (forall ((?v0 Rat_rat_fun$ )(?v1 Nat_nat_rat_fun_fun$ )(?v2 Nat_nat_prod$ ))(= (fun_app$g ?v0 (fun_app$e (case_prod$a ?v1 )?v2 ))(fun_app$e (case_prod$a (uuf$ ?v0 ?v1 ))?v2 ))):named a34 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(= (= (of_nat$ ?v0 )(of_nat$ ?v1 ))(= ?v0 ?v1 ))):named a35 ))
(check-sat )
;(get-unsat-core )
