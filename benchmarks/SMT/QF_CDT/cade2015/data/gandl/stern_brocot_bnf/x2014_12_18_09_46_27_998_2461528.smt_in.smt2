...
(assert (! (not (fun_app$ (less$ (times$ (fst$ (mediant$ (mulmat$ (pair$a a$ (pair$ b$ c$ ))(mulmat$ lLmat$ (pair$a aa$ (pair$ ba$ ca$ ))))))(snd$ (mediant$ (pair$a a$ (pair$ b$ c$ ))))))(times$ (fst$ (mediant$ (pair$a a$ (pair$ b$ c$ ))))(snd$ (mediant$ (mulmat$ (pair$a a$ (pair$ b$ c$ ))(mulmat$ lLmat$ (pair$a aa$ (pair$ ba$ ca$ ))))))))):named a0 ))
(assert (! (= (det$ (pair$a a$ (pair$ b$ c$ )))(suc$ zero$ )):named a1 ))
(assert (! (= (det$ (pair$a aa$ (pair$ ba$ ca$ )))(suc$ zero$ )):named a2 ))
(assert (! (fun_app$ (less$ zero$ )(snd$ (mediant$ (pair$a a$ (pair$ b$ c$ ))))):named a3 ))
(assert (! (fun_app$ (less$ zero$ )(snd$ (mediant$ (mulmat$ (pair$a a$ (pair$ b$ c$ ))(mulmat$ lLmat$ (pair$a aa$ (pair$ ba$ ca$ ))))))):named a4 ))
(assert (! (= x$ (pair$a a$ (pair$ b$ c$ ))):named a5 ))
(assert (! (= y$ (pair$a aa$ (pair$ ba$ ca$ ))):named a6 ))
...
(assert (! (fun_app$ (less$ zero$ )(snd$ (mediant$ (mulmat$ (mulmat$ x$ lLmat$ )y$ )))):named a10 ))
...
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_prod$ ))(=> (fun_app$ (less$ zero$ )(snd$ (mediant$ ?v0 )))(fun_app$ (less$ zero$ )(snd$ (mediant$ (mulmat$ ?v0 lLmat$ )))))):named a13 ))
