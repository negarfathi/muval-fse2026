...
(declare-datatypes ()((Num$ (one$ )(bit0$ (select$ Num$ ))(bit1$ (selecta$ Num$ )))(Nat_nat_prod_nat_nat_prod_prod$ (pair$a (fst$a Nat_nat_prod$ )(snd$a Nat_nat_prod$ )))))
(declare-sort Nat_stream_stream$ 0)
(declare-sort Nat_stream_stream_stream$ 0)
(declare-sort Nat_stream_stream_stream_stream$ 0)
...
(declare-fun sCons$c (Nat_stream_stream$ Nat_stream_stream_stream$ )Nat_stream_stream_stream$)
(declare-fun shd$d (Nat_stream_stream_stream_stream$)Nat_stream_stream_stream$)
(declare-fun stl$d (Nat_stream_stream_stream_stream$)Nat_stream_stream_stream_stream$)
(declare-fun sCons$d (Nat_stream_stream_stream$ Nat_stream_stream_stream_stream$ )Nat_stream_stream_stream_stream$)
