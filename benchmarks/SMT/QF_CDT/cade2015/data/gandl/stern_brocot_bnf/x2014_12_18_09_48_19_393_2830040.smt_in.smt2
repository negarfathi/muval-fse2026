...
(declare-sort A_stream_a_stream_fun_a_fun_tree$ 0)
...
(declare-sort A_stream_stream_tree_a_stream_stream_tree_fun_tree$ 0)
(declare-sort A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$ 0)
...
(declare-sort A_stream_tree_stream_a_stream_tree_stream_fun_tree$ 0)
(declare-sort A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$ 0)
(declare-sort A_a_a_fun_fun_a_fun_tree$ 0)
(declare-sort A_a_stream_a_stream_fun_fun_tree$ 0)
(declare-sort A_a_a_a_fun_fun_fun_tree$ 0)
(declare-sort A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$ 0)
(declare-sort A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$ 0)
(declare-sort A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ 0)
(declare-sort A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$ 0)
(declare-sort A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$ 0)
...
(declare-fun selectj$ (A_stream_a_stream_fun_tree$)A_stream_a_stream_fun$)
(declare-fun selectk$ (A_stream_a_stream_fun_tree$)A_stream_a_stream_fun_tree$)
(declare-fun selectl$ (A_stream_a_stream_fun_tree$)A_stream_a_stream_fun_tree$)
(declare-fun node$l (A_stream_a_stream_fun$ A_stream_a_stream_fun_tree$ A_stream_a_stream_fun_tree$ )A_stream_a_stream_fun_tree$)
(declare-fun selectm$ (A_stream_a_stream_fun_stream$)A_stream_a_stream_fun$)
(declare-fun selectn$ (A_stream_a_stream_fun_stream$)A_stream_a_stream_fun_stream$)
(declare-fun sCons$l (A_stream_a_stream_fun$ A_stream_a_stream_fun_stream$ )A_stream_a_stream_fun_stream$)
...
(declare-fun selectr$ (A_a_a_fun_fun_stream$)A_a_a_fun_fun$)
(declare-fun selects$ (A_a_a_fun_fun_stream$)A_a_a_fun_fun_stream$)
(declare-fun sCons$m (A_a_a_fun_fun$ A_a_a_fun_fun_stream$ )A_a_a_fun_fun_stream$)
(declare-fun selectt$ (A_a_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun$)
(declare-fun selectu$ (A_a_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun_tree$)
(declare-fun selectv$ (A_a_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun_tree$)
(declare-fun node$n (A_a_fun_a_a_fun_fun$ A_a_fun_a_a_fun_fun_tree$ A_a_fun_a_a_fun_fun_tree$ )A_a_fun_a_a_fun_fun_tree$)
(declare-fun selectw$ (A_a_fun_a_a_fun_fun_stream$)A_a_fun_a_a_fun_fun$)
(declare-fun selectx$ (A_a_fun_a_a_fun_fun_stream$)A_a_fun_a_a_fun_fun_stream$)
(declare-fun sCons$n (A_a_fun_a_a_fun_fun$ A_a_fun_a_a_fun_fun_stream$ )A_a_fun_a_a_fun_fun_stream$)
(declare-fun selecty$ (A_tree_a_tree_a_tree_fun_fun_tree$)A_tree_a_tree_a_tree_fun_fun$)
(declare-fun selectz$ (A_tree_a_tree_a_tree_fun_fun_tree$)A_tree_a_tree_a_tree_fun_fun_tree$)
(declare-fun selecua$ (A_tree_a_tree_a_tree_fun_fun_tree$)A_tree_a_tree_a_tree_fun_fun_tree$)
(declare-fun node$o (A_tree_a_tree_a_tree_fun_fun$ A_tree_a_tree_a_tree_fun_fun_tree$ A_tree_a_tree_a_tree_fun_fun_tree$ )A_tree_a_tree_a_tree_fun_fun_tree$)
(declare-fun selecub$ (A_tree_a_tree_fun_stream$)A_tree_a_tree_fun$)
(declare-fun selecuc$ (A_tree_a_tree_fun_stream$)A_tree_a_tree_fun_stream$)
(declare-fun sCons$o (A_tree_a_tree_fun$ A_tree_a_tree_fun_stream$ )A_tree_a_tree_fun_stream$)
(declare-fun selecud$ (A_tree_a_tree_fun_tree$)A_tree_a_tree_fun$)
(declare-fun selecue$ (A_tree_a_tree_fun_tree$)A_tree_a_tree_fun_tree$)
(declare-fun selecuf$ (A_tree_a_tree_fun_tree$)A_tree_a_tree_fun_tree$)
(declare-fun node$p (A_tree_a_tree_fun$ A_tree_a_tree_fun_tree$ A_tree_a_tree_fun_tree$ )A_tree_a_tree_fun_tree$)
(declare-fun selecug$ (A_tree_a_tree_a_tree_fun_fun_stream$)A_tree_a_tree_a_tree_fun_fun$)
(declare-fun selecuh$ (A_tree_a_tree_a_tree_fun_fun_stream$)A_tree_a_tree_a_tree_fun_fun_stream$)
(declare-fun sCons$p (A_tree_a_tree_a_tree_fun_fun$ A_tree_a_tree_a_tree_fun_fun_stream$ )A_tree_a_tree_a_tree_fun_fun_stream$)
(declare-fun selecui$ (A_stream_a_stream_a_stream_fun_fun_tree$)A_stream_a_stream_a_stream_fun_fun$)
(declare-fun selecuj$ (A_stream_a_stream_a_stream_fun_fun_tree$)A_stream_a_stream_a_stream_fun_fun_tree$)
(declare-fun selecuk$ (A_stream_a_stream_a_stream_fun_fun_tree$)A_stream_a_stream_a_stream_fun_fun_tree$)
(declare-fun node$q (A_stream_a_stream_a_stream_fun_fun$ A_stream_a_stream_a_stream_fun_fun_tree$ A_stream_a_stream_a_stream_fun_fun_tree$ )A_stream_a_stream_a_stream_fun_fun_tree$)
(declare-fun selecul$ (A_stream_a_stream_a_stream_fun_fun_stream$)A_stream_a_stream_a_stream_fun_fun$)
(declare-fun selecum$ (A_stream_a_stream_a_stream_fun_fun_stream$)A_stream_a_stream_a_stream_fun_fun_stream$)
(declare-fun sCons$q (A_stream_a_stream_a_stream_fun_fun$ A_stream_a_stream_a_stream_fun_fun_stream$ )A_stream_a_stream_a_stream_fun_fun_stream$)
(declare-fun selecun$ (A_a_tree_fun_tree$)A_a_tree_fun$)
(declare-fun selecuo$ (A_a_tree_fun_tree$)A_a_tree_fun_tree$)
(declare-fun selecup$ (A_a_tree_fun_tree$)A_a_tree_fun_tree$)
(declare-fun node$r (A_a_tree_fun$ A_a_tree_fun_tree$ A_a_tree_fun_tree$ )A_a_tree_fun_tree$)
(declare-fun selecuq$ (A_a_tree_fun_stream$)A_a_tree_fun$)
(declare-fun selecur$ (A_a_tree_fun_stream$)A_a_tree_fun_stream$)
(declare-fun sCons$r (A_a_tree_fun$ A_a_tree_fun_stream$ )A_a_tree_fun_stream$)
(declare-fun selecus$ (A_a_stream_fun_tree$)A_a_stream_fun$)
(declare-fun selecut$ (A_a_stream_fun_tree$)A_a_stream_fun_tree$)
(declare-fun selecuu$ (A_a_stream_fun_tree$)A_a_stream_fun_tree$)
(declare-fun node$s (A_a_stream_fun$ A_a_stream_fun_tree$ A_a_stream_fun_tree$ )A_a_stream_fun_tree$)
(declare-fun selecuv$ (A_a_stream_fun_stream$)A_a_stream_fun$)
(declare-fun selecuw$ (A_a_stream_fun_stream$)A_a_stream_fun_stream$)
(declare-fun sCons$s (A_a_stream_fun$ A_a_stream_fun_stream$ )A_a_stream_fun_stream$)
(declare-fun selecux$ (A_stream_a_stream_fun_a_fun_tree$)A_stream_a_stream_fun_a_fun$)
(declare-fun selecuy$ (A_stream_a_stream_fun_a_fun_tree$)A_stream_a_stream_fun_a_fun_tree$)
(declare-fun selecuz$ (A_stream_a_stream_fun_a_fun_tree$)A_stream_a_stream_fun_a_fun_tree$)
(declare-fun node$t (A_stream_a_stream_fun_a_fun$ A_stream_a_stream_fun_a_fun_tree$ A_stream_a_stream_fun_a_fun_tree$ )A_stream_a_stream_fun_a_fun_tree$)
(declare-fun selecva$ (A_stream_a_stream_fun_a_fun_stream$)A_stream_a_stream_fun_a_fun$)
(declare-fun selecvb$ (A_stream_a_stream_fun_a_fun_stream$)A_stream_a_stream_fun_a_fun_stream$)
(declare-fun sCons$t (A_stream_a_stream_fun_a_fun$ A_stream_a_stream_fun_a_fun_stream$ )A_stream_a_stream_fun_a_fun_stream$)
(declare-fun selecvc$ (A_stream_tree_a_stream_tree_fun_tree$)A_stream_tree_a_stream_tree_fun$)
(declare-fun selecvd$ (A_stream_tree_a_stream_tree_fun_tree$)A_stream_tree_a_stream_tree_fun_tree$)
(declare-fun selecve$ (A_stream_tree_a_stream_tree_fun_tree$)A_stream_tree_a_stream_tree_fun_tree$)
(declare-fun node$u (A_stream_tree_a_stream_tree_fun$ A_stream_tree_a_stream_tree_fun_tree$ A_stream_tree_a_stream_tree_fun_tree$ )A_stream_tree_a_stream_tree_fun_tree$)
(declare-fun selecvf$ (A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$)A_stream_tree_a_stream_tree_a_stream_tree_fun_fun$)
(declare-fun selecvg$ (A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$)A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$)
(declare-fun selecvh$ (A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$)A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$)
(declare-fun node$v (A_stream_tree_a_stream_tree_a_stream_tree_fun_fun$ A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$ A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$ )A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$)
(declare-fun selecvi$ (A_tree_tree_a_tree_tree_fun_tree$)A_tree_tree_a_tree_tree_fun$)
(declare-fun selecvj$ (A_tree_tree_a_tree_tree_fun_tree$)A_tree_tree_a_tree_tree_fun_tree$)
(declare-fun selecvk$ (A_tree_tree_a_tree_tree_fun_tree$)A_tree_tree_a_tree_tree_fun_tree$)
...
(declare-fun selecvl$ (A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$)A_tree_tree_a_tree_tree_a_tree_tree_fun_fun$)
(declare-fun selecvm$ (A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$)A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$)
(declare-fun selecvn$ (A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$)A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$)
...
(declare-fun selecvo$ (A_stream_stream_a_stream_stream_fun_tree$)A_stream_stream_a_stream_stream_fun$)
(declare-fun selecvp$ (A_stream_stream_a_stream_stream_fun_tree$)A_stream_stream_a_stream_stream_fun_tree$)
(declare-fun selecvq$ (A_stream_stream_a_stream_stream_fun_tree$)A_stream_stream_a_stream_stream_fun_tree$)
(declare-fun node$y (A_stream_stream_a_stream_stream_fun$ A_stream_stream_a_stream_stream_fun_tree$ A_stream_stream_a_stream_stream_fun_tree$ )A_stream_stream_a_stream_stream_fun_tree$)
(declare-fun selecvr$ (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$)A_stream_stream_a_stream_stream_a_stream_stream_fun_fun$)
(declare-fun selecvs$ (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$)A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$)
(declare-fun selecvt$ (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$)A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$)
(declare-fun node$z (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$ )A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$)
(declare-fun selecvu$ (A_tree_stream_a_tree_stream_fun_tree$)A_tree_stream_a_tree_stream_fun$)
(declare-fun selecvv$ (A_tree_stream_a_tree_stream_fun_tree$)A_tree_stream_a_tree_stream_fun_tree$)
(declare-fun selecvw$ (A_tree_stream_a_tree_stream_fun_tree$)A_tree_stream_a_tree_stream_fun_tree$)
(declare-fun node$aa (A_tree_stream_a_tree_stream_fun$ A_tree_stream_a_tree_stream_fun_tree$ A_tree_stream_a_tree_stream_fun_tree$ )A_tree_stream_a_tree_stream_fun_tree$)
(declare-fun selecvx$ (A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$)A_tree_stream_a_tree_stream_a_tree_stream_fun_fun$)
(declare-fun selecvy$ (A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$)A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$)
(declare-fun selecvz$ (A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$)A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$)
(declare-fun node$ab (A_tree_stream_a_tree_stream_a_tree_stream_fun_fun$ A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$ A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$ )A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$)
(declare-fun selecwa$ (A_stream_stream_tree_a_stream_stream_tree_fun_tree$)A_stream_stream_tree_a_stream_stream_tree_fun$)
(declare-fun selecwb$ (A_stream_stream_tree_a_stream_stream_tree_fun_tree$)A_stream_stream_tree_a_stream_stream_tree_fun_tree$)
(declare-fun selecwc$ (A_stream_stream_tree_a_stream_stream_tree_fun_tree$)A_stream_stream_tree_a_stream_stream_tree_fun_tree$)
(declare-fun node$ac (A_stream_stream_tree_a_stream_stream_tree_fun$ A_stream_stream_tree_a_stream_stream_tree_fun_tree$ A_stream_stream_tree_a_stream_stream_tree_fun_tree$ )A_stream_stream_tree_a_stream_stream_tree_fun_tree$)
(declare-fun selecwd$ (A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$)A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun$)
(declare-fun selecwe$ (A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$)A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$)
(declare-fun selecwf$ (A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$)A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$)
(declare-fun node$ad (A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun$ A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$ A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$ )A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$)
(declare-fun selecwg$ (A_tree_tree_stream_a_tree_tree_stream_fun_tree$)A_tree_tree_stream_a_tree_tree_stream_fun$)
(declare-fun selecwh$ (A_tree_tree_stream_a_tree_tree_stream_fun_tree$)A_tree_tree_stream_a_tree_tree_stream_fun_tree$)
(declare-fun selecwi$ (A_tree_tree_stream_a_tree_tree_stream_fun_tree$)A_tree_tree_stream_a_tree_tree_stream_fun_tree$)
(declare-fun node$ae (A_tree_tree_stream_a_tree_tree_stream_fun$ A_tree_tree_stream_a_tree_tree_stream_fun_tree$ A_tree_tree_stream_a_tree_tree_stream_fun_tree$ )A_tree_tree_stream_a_tree_tree_stream_fun_tree$)
(declare-fun selecwj$ (A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$)A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun$)
(declare-fun selecwk$ (A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$)A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$)
(declare-fun selecwl$ (A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$)A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$)
(declare-fun node$af (A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun$ A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$ A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$ )A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$)
(declare-fun selecwm$ (A_stream_tree_stream_a_stream_tree_stream_fun_tree$)A_stream_tree_stream_a_stream_tree_stream_fun$)
(declare-fun selecwn$ (A_stream_tree_stream_a_stream_tree_stream_fun_tree$)A_stream_tree_stream_a_stream_tree_stream_fun_tree$)
(declare-fun selecwo$ (A_stream_tree_stream_a_stream_tree_stream_fun_tree$)A_stream_tree_stream_a_stream_tree_stream_fun_tree$)
(declare-fun node$ag (A_stream_tree_stream_a_stream_tree_stream_fun$ A_stream_tree_stream_a_stream_tree_stream_fun_tree$ A_stream_tree_stream_a_stream_tree_stream_fun_tree$ )A_stream_tree_stream_a_stream_tree_stream_fun_tree$)
(declare-fun selecwp$ (A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$)A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun$)
(declare-fun selecwq$ (A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$)A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$)
(declare-fun selecwr$ (A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$)A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$)
(declare-fun node$ah (A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun$ A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$ A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$ )A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$)
(declare-fun selecws$ (A_a_a_fun_fun_a_fun_tree$)A_a_a_fun_fun_a_fun$)
(declare-fun selecwt$ (A_a_a_fun_fun_a_fun_tree$)A_a_a_fun_fun_a_fun_tree$)
(declare-fun selecwu$ (A_a_a_fun_fun_a_fun_tree$)A_a_a_fun_fun_a_fun_tree$)
(declare-fun node$ai (A_a_a_fun_fun_a_fun$ A_a_a_fun_fun_a_fun_tree$ A_a_a_fun_fun_a_fun_tree$ )A_a_a_fun_fun_a_fun_tree$)
(declare-fun selecwv$ (A_a_stream_a_stream_fun_fun_tree$)A_a_stream_a_stream_fun_fun$)
(declare-fun selecww$ (A_a_stream_a_stream_fun_fun_tree$)A_a_stream_a_stream_fun_fun_tree$)
(declare-fun selecwx$ (A_a_stream_a_stream_fun_fun_tree$)A_a_stream_a_stream_fun_fun_tree$)
(declare-fun node$aj (A_a_stream_a_stream_fun_fun$ A_a_stream_a_stream_fun_fun_tree$ A_a_stream_a_stream_fun_fun_tree$ )A_a_stream_a_stream_fun_fun_tree$)
(declare-fun selecwy$ (A_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun$)
(declare-fun selecwz$ (A_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_tree$)
(declare-fun selecxa$ (A_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_tree$)
(declare-fun node$ak (A_a_a_a_fun_fun_fun$ A_a_a_a_fun_fun_fun_tree$ A_a_a_a_fun_fun_fun_tree$ )A_a_a_a_fun_fun_fun_tree$)
(declare-fun selecxb$ (A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$)A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun$)
(declare-fun selecxc$ (A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$)A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$)
(declare-fun selecxd$ (A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$)A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$)
(declare-fun node$al (A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun$ A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$ A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$ )A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$)
(declare-fun selecxe$ (A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$)A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun$)
(declare-fun selecxf$ (A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$)A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$)
(declare-fun selecxg$ (A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$)A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$)
(declare-fun node$am (A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun$ A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$ A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$ )A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$)
(declare-fun selecxh$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun$)
(declare-fun selecxi$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecxj$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$)
...
(declare-fun selecxk$ (A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$)A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun$)
(declare-fun selecxl$ (A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$)A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecxm$ (A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$)A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun node$ao (A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun$ A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$ A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$ )A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecxn$ (A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$)A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun$)
(declare-fun selecxo$ (A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$)A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecxp$ (A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$)A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun node$ap (A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun$ A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$ A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$ )A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecxq$ (A_stream_a_fun_stream$)A_stream_a_fun$)
(declare-fun selecxr$ (A_stream_a_fun_stream$)A_stream_a_fun_stream$)
(declare-fun sCons$u (A_stream_a_fun$ A_stream_a_fun_stream$ )A_stream_a_fun_stream$)
(declare-fun selecxs$ (A_tree_a_fun_stream$)A_tree_a_fun$)
(declare-fun selecxt$ (A_tree_a_fun_stream$)A_tree_a_fun_stream$)
(declare-fun sCons$v (A_tree_a_fun$ A_tree_a_fun_stream$ )A_tree_a_fun_stream$)
(declare-fun selecxu$ (A_tree_a_stream_fun_stream$)A_tree_a_stream_fun$)
(declare-fun selecxv$ (A_tree_a_stream_fun_stream$)A_tree_a_stream_fun_stream$)
(declare-fun sCons$w (A_tree_a_stream_fun$ A_tree_a_stream_fun_stream$ )A_tree_a_stream_fun_stream$)
(declare-fun selecxw$ (A_stream_a_tree_fun_stream$)A_stream_a_tree_fun$)
(declare-fun selecxx$ (A_stream_a_tree_fun_stream$)A_stream_a_tree_fun_stream$)
