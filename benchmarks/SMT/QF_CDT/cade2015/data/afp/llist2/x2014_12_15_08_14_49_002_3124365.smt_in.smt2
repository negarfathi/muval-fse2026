...
(declare-fun lNil$ ()A_set_llist$)
(declare-fun lhd$ (A_set_llist$)A_set$)
(declare-fun ltl$ (A_set_llist$)A_set_llist$)
(declare-fun lCons$ (A_set$ A_set_llist$ )A_set_llist$)
...
(declare-fun lNil$c ()A_set_set_llist$)
(declare-fun lhd$c (A_set_set_llist$)A_set_set$)
(declare-fun ltl$c (A_set_set_llist$)A_set_set_llist$)
(declare-fun lCons$c (A_set_set$ A_set_set_llist$ )A_set_set_llist$)
