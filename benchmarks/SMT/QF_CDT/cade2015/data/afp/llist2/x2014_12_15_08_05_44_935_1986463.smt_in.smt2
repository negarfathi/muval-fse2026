...
(declare-datatypes ()((B_llist_b_llist_prod$ (pair$ (fst$ B_llist$ )(snd$ B_llist$ )))(B_b_llist_b_llist_prod_prod$ (pair$a (fst$a B$ )(snd$a B_llist_b_llist_prod$ )))))
...
(declare-datatypes ()((B_b_prod$ (pair$b (fst$b B$ )(snd$b B$ )))(B_b_b_prod_prod$ (pair$c (fst$c B$ )(snd$c B_b_prod$ )))))
