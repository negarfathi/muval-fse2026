...
(declare-datatypes ()((A_llist_list$ (nil$ )(cons$ (hd$ A_llist$ )(tl$ A_llist_list$ )))(A_llist_list_list$ (nil$a )(cons$a (hd$a A_llist_list$ )(tl$a A_llist_list_list$ )))(A_llist_set_list$ (nil$b )(cons$b (hd$b A_llist_set$ )(tl$b A_llist_set_list$ )))(A_llist_a_llist_sum$ (inl$ (projl$ A_llist$ ))(inr$ (projr$ A_llist$ )))))
