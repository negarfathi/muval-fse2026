...
(assert (! (not (member$ (fun_app$ (ldrop$ ta$ )zero$ )(finlsts$ a$ ))):named a0 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_set$ )(?v2 Nat$ ))(=> (member$ ?v0 (alllsts$ ?v1 ))(member$ (fun_app$ (ldrop$ ?v0 )?v2 )(alllsts$ ?v1 )))):named a11 ))
