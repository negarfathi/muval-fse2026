...
(declare-sort A$ 0 )
(declare-datatypes ()((A_list$ (nil$ )(cons$ (hd$ A$ )(tl$ A_list$ )))(A_list_list$ (nil$a )(cons$a (hd$a A_list$ )(tl$a A_list_list$ )))(A_list_list_list$ (nil$b )(cons$b (hd$b A_list_list$ )(tl$b A_list_list_list$ )))(A_list_list_list_list$ (nil$c )(cons$c (hd$c A_list_list_list$ )(tl$c A_list_list_list_list$ )))))
