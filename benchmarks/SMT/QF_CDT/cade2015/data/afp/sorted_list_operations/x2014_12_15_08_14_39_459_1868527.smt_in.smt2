...
(assert (! (=> (and (distinct$ l2b$ )(sorted$ l2b$ ))(and (distinct$ (inter_sorted$ (cons$ x1$ l1a$ )l2b$ ))(and (sorted$ (inter_sorted$ (cons$ x1$ l1a$ )l2b$ ))(= (set$b (inter_sorted$ (cons$ x1$ l1a$ )l2b$ ))(inf$ (set$b (cons$ x1$ l1a$ ))(set$b l2b$ )))))):named a26 ))
