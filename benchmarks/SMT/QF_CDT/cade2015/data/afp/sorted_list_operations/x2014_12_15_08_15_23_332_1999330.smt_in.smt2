...
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ l1a$ ))(less_eq$a x1$ ?v0 ))):named a3 ))
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (set$ l2b$ ))(less_eq$a x2$ ?v0 ))):named a4 ))
(assert (! (= (subset_sorted$ l1a$ (cons$ x2$ l2b$ ))(less_eq$ (set$ l1a$ )(set$ (cons$ x2$ l2b$ )))):named a5 ))
(assert (! (not (member$ x2$ (set$ l2b$ ))):named a6 ))
(assert (! (= (subset_sorted$ (cons$ x1$ l1a$ )l2b$ )(less_eq$ (set$ (cons$ x1$ l1a$ ))(set$ l2b$ ))):named a7 ))
(assert (! (=> (and (distinct$ l2b$ )(sorted$ l2b$ ))(= (subset_sorted$ (cons$ x1$ l1a$ )l2b$ )(less_eq$ (set$ (cons$ x1$ l1a$ ))(set$ l2b$ )))):named a8 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A$ ))(less_eq$ (set$ ?v0 )(set$ (cons$ ?v1 ?v0 )))):named a9 ))
(assert (! (forall ((?v0 A$ )(?v1 A_list$ )(?v2 A$ )(?v3 A_list$ ))(! (= (subset_sorted$ (cons$ ?v0 ?v1 )(cons$ ?v2 ?v3 ))(ite (less$ ?v0 ?v2 )false (ite (= ?v0 ?v2 )(subset_sorted$ ?v1 ?v3 )(subset_sorted$ (cons$ ?v0 ?v1 )?v3 )))):pattern ((subset_sorted$ (cons$ ?v0 ?v1 )(cons$ ?v2 ?v3 ))))):named a10 ))
