...
(assert (! (=> (and (distinct$ l2b$ )(sorted$ l2b$ ))(= (subset_sorted$ (cons$ x1$ l1a$ )l2b$ )(less_eq$ (set$ (cons$ x1$ l1a$ ))(set$ l2b$ )))):named a23 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_list$ )(?v1 A_a_a_prod_prod_list$ ))(=> (and (sorted$a ?v0 )(and (distinct$b ?v0 )(and (sorted$a ?v1 )(and (distinct$b ?v1 )(= (set$a ?v0 )(set$a ?v1 ))))))(= ?v0 ?v1 ))):named a24 ))
(assert (! (forall ((?v0 A_a_prod_list$ )(?v1 A_a_prod_list$ ))(=> (and (sorted$b ?v0 )(and (distinct$g ?v0 )(and (sorted$b ?v1 )(and (distinct$g ?v1 )(= (set$b ?v0 )(set$b ?v1 ))))))(= ?v0 ?v1 ))):named a25 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_list$ ))(=> (and (sorted$ ?v0 )(and (distinct$ ?v0 )(and (sorted$ ?v1 )(and (distinct$ ?v1 )(= (set$ ?v0 )(set$ ?v1 ))))))(= ?v0 ?v1 ))):named a26 ))
...
(assert (! (forall ((?v0 A_a_a_prod_prod_list$ ))(and (distinct$b (mergesort_remdups$ ?v0 ))(and (sorted$a (mergesort_remdups$ ?v0 ))(= (set$a (mergesort_remdups$ ?v0 ))(set$a ?v0 ))))):named a61 ))
(assert (! (forall ((?v0 A_a_prod_list$ ))(and (distinct$g (mergesort_remdups$a ?v0 ))(and (sorted$b (mergesort_remdups$a ?v0 ))(= (set$b (mergesort_remdups$a ?v0 ))(set$b ?v0 ))))):named a62 ))
(assert (! (forall ((?v0 A_list$ ))(and (distinct$ (mergesort_remdups$b ?v0 ))(and (sorted$ (mergesort_remdups$b ?v0 ))(= (set$ (mergesort_remdups$b ?v0 ))(set$ ?v0 ))))):named a63 ))
