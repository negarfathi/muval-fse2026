...
(declare-datatypes ()((A_tree$ (leaf$ )(node$ (left$ A_tree$ )(val$ A$ )(right$ A_tree$ )))(A_tree_tree$ (leaf$a )(node$a (left$a A_tree_tree$ )(val$a A_tree$ )(right$a A_tree_tree$ )))(A_tree_tree_tree$ (leaf$b )(node$b (left$b A_tree_tree_tree$ )(val$b A_tree_tree$ )(right$b A_tree_tree_tree$ )))(A_tree_tree_tree_tree$ (leaf$c )(node$c (left$c A_tree_tree_tree_tree$ )(val$c A_tree_tree_tree$ )(right$c A_tree_tree_tree_tree$ )))))
(declare-fun a$ ()A$ )
