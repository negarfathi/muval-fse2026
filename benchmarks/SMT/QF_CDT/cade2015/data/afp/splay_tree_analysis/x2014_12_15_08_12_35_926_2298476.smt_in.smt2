...
(assert (! (not (<= (log$ 2.0 (+ (real$ (size1$ l$ ))1.0 ))(log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))):named a0 ))
...
(assert (! (forall ((?v0 Num$ )(?v1 Num$ )(?v2 Real ))(= (+ (numeral$ ?v0 )(+ (numeral$ ?v1 )?v2 ))(+ (numeral$ (plus$ ?v0 ?v1 ))?v2 ))):named a9 ))
(assert (! (forall ((?v0 Num$ )(?v1 Num$ ))(= (+ (numeral$ ?v0 )(numeral$ ?v1 ))(numeral$ (plus$ ?v0 ?v1 )))):named a10 ))
(assert (! (forall ((?v0 Num$ )(?v1 Num$ ))(= (<= (numeral$ ?v0 )(numeral$ ?v1 ))(less_eq$ ?v0 ?v1 ))):named a11 ))
