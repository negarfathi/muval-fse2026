...
(assert (! (<= (log$ 2.0 (+ 1.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))(log$ 2.0 (* 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))):named a1 ))
(assert (! (<= (log$ 2.0 (+ 2.0 (real$ (size$ r$ ))))(log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ ))))):named a2 ))
