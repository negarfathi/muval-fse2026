...
(assert (! (not (= (- (+ (t_s_t$ f$ s$ )(phi$ (nxt_s_t$ f$ s$ )))(phi$ s$ ))(+ (+ (- (+ (real$ (t_splay$ a$ s$ ))(+ (phi$ l$ )(phi$ r$ )))(phi$ s$ ))(log$ 2.0 (+ (real$ (size1$ l$ ))1.0 )))(log$ 2.0 (+ 1.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))))):named a0 ))
(assert (! (not (= e$ a$ )):named a1 ))
(assert (! (not (= s$ leaf$ )):named a2 ))
(assert (! (less$ e$ a$ ):named a3 ))
