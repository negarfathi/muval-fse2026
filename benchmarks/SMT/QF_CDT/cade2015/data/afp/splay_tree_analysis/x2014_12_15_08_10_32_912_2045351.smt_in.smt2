...
(assert (! (not (<= (+ (- (+ (log$ 2.0 (real$ (size1$ rl$ )))(* 2.0 (log$ 2.0 (real$ (size1$ (node$ l$ c$ r$ ))))))(* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$ ))))))1.0 )(+ (- (* 3.0 (log$ 2.0 (real$ (size1$ (node$ l$ c$ r$ )))))(* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$ ))))))1.0 ))):named a0 ))
...
(assert (! (<= (a$ aa$ (node$ l$ c$ r$ ))(+ (- (+ (log$ 2.0 (real$ (size1$ rl$ )))(* 2.0 (log$ 2.0 (real$ (size1$ (node$ l$ c$ r$ ))))))(* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$ ))))))1.0 )):named a7 ))
