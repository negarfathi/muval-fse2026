...
(declare-datatypes ()((A_tree$ (leaf$ )(node$ (left$ A_tree$ )(val$ A$ )(right$ A_tree$ )))(A_op_s_t$ (splay$ (select$ A$ ))(insert$ (selecta$ A$ ))(delete$ (selectb$ A$ )))(Num$ (one$ )(bit0$ (selectc$ Num$ ))(bit1$ (selectd$ Num$ )))))
