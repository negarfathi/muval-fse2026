...
(assert (! (not (<= (+ (- (- (+ (+ (a$ aa$ lr$ )(log$ 2.0 (real$ (size1$ (node$ ll$ b$ l$ )))))(log$ 2.0 (real$ (size1$ (node$ r$ c$ r$a )))))(log$ 2.0 (real$ (size1$ (node$ ll$ b$ lr$ )))))(log$ 2.0 (real$ (size1$ (node$ l$ u$ r$ )))))1.0 )(+ (- (- (- (+ (+ (* 3.0 (log$ 2.0 (real$ (size1$ lr$ ))))(log$ 2.0 (real$ (size1$ (node$ ll$ b$ l$ )))))(log$ 2.0 (real$ (size1$ (node$ r$ c$ r$a )))))(log$ 2.0 (real$ (size1$ (node$ ll$ b$ lr$ )))))(log$ 2.0 (real$ (size1$ (node$ l$ u$ r$ )))))(* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$ ))))))2.0 ))):named a0 ))
(assert (! (not (= lr$ leaf$ )):named a1 ))
(assert (! (not (= aa$ c$ )):named a2 ))
(assert (! (less$ b$ aa$ ):named a3 ))
...
(assert (! (and (not (member$ aa$ (set_tree$ ll$ )))(not (member$ aa$ (set_tree$ r$a )))):named a8 ))
...
(assert (! (member$ aa$ (set_tree$ lr$ )):named a13 ))
...
(assert (! (= (splay$ aa$ lr$ )(node$ l$ u$ r$ )):named a16 ))
(assert (! (= (a$ aa$ (node$ l$a c$ r$a ))(+ (- (- (+ (+ (a$ aa$ lr$ )(log$ 2.0 (real$ (size1$ (node$ ll$ b$ l$ )))))(log$ 2.0 (real$ (size1$ (node$ r$ c$ r$a )))))(log$ 2.0 (real$ (size1$ (node$ ll$ b$ lr$ )))))(log$ 2.0 (real$ (size1$ (node$ l$ u$ r$ )))))1.0 )):named a17 ))
(check-sat )
;(get-unsat-core )
