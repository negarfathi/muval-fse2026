...
(declare-sort A$ 0 )
(declare-sort Nat$ 0 )
(declare-datatypes ()((A_tree$ (leaf$ )(node$ (left$ A_tree$ )(val$ A$ )(right$ A_tree$ )))(Num$ (one$ )(bit0$ (select$ Num$ ))(bit1$ (selecta$ Num$ )))(A_op_s_t$ (splay$ (selectb$ A$ ))(insert$ (selectc$ A$ ))(delete$ (selectd$ A$ )))))
(declare-fun a$ ()A$ )
(declare-fun e$ ()A$ )
