...
(assert (! (forall ((?v0 A_tree$ )(?v1 A$ )(?v2 A_tree$ ))(=> (= (splay$ aa$ ll$ )(node$ ?v0 ?v1 ?v2 ))thesis$ )):named a1 ))
(assert (! (bst$ (node$ l$ c$ r$ )):named a2 ))
(assert (! (not (= aa$ c$ )):named a3 ))
(assert (! (member$ aa$ (set_tree$ ll$ )):named a4 ))
...
(assert (! (= l$ (node$ ll$ b$ lr$ )):named a12 ))
