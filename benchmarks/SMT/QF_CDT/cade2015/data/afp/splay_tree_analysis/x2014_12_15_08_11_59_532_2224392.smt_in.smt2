...
(assert (! (= f$ (splay$ a$ )):named a1 ))
(assert (! (bst$ (splay$a a$ s$ )):named a2 ))
(assert (! (bst$ s$ ):named a3 ))
(assert (! (forall ((?v0 A_tree$ )(?v1 A$ ))(=> (bst$ ?v0 )(bst$ (splay$a ?v1 ?v0 )))):named a4 ))
(assert (! (forall ((?v0 A$ )(?v1 A_tree$ ))(! (= (nxt_s_t$ (splay$ ?v0 )?v1 )(splay$a ?v0 ?v1 )):pattern ((nxt_s_t$ (splay$ ?v0 )?v1 )))):named a5 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_tree$ ))(! (= (nxt_s_t$ (delete$ ?v0 )?v1 )(delete$a ?v0 ?v1 )):pattern ((nxt_s_t$ (delete$ ?v0 )?v1 )))):named a9 ))
(assert (! (forall ((?v0 A$ )(?v1 A_tree$ ))(! (= (nxt_s_t$ (insert$ ?v0 )?v1 )(insert$a ?v0 ?v1 )):pattern ((nxt_s_t$ (insert$ ?v0 )?v1 )))):named a10 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A$ ))(= (= (splay$ ?v0 )(splay$ ?v1 ))(= ?v0 ?v1 ))):named a15 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ ))(= (= (delete$ ?v0 )(delete$ ?v1 ))(= ?v0 ?v1 ))):named a16 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ ))(= (= (insert$ ?v0 )(insert$ ?v1 ))(= ?v0 ?v1 ))):named a17 ))
(check-sat )
;(get-unsat-core )
