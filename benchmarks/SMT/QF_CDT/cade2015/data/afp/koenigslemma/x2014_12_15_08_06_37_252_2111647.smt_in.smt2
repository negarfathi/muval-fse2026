...
(declare-datatypes ()((Node_node_set_prod$ (pair$ (fst$ Node$ )(snd$ Node_set$ )))(Node_option$ (none$ )(some$ (the$ Node$ )))(Node_node_sum$ (inl$ (projl$ Node$ ))(inr$ (projr$ Node$ )))(Node_node_sum_node_option_sum$ (inl$a (projl$a Node_node_sum$ ))(inr$a (projr$a Node_option$ )))(Node_node_sum_node_node_sum_sum$ (inl$b (projl$b Node_node_sum$ ))(inr$b (projr$b Node_node_sum$ )))(Node_node_sum_node_sum$ (inl$c (projl$c Node_node_sum$ ))(inr$c (projr$c Node$ )))(Node_node_option_sum$ (inl$d (projl$d Node$ ))(inr$d (projr$d Node_option$ )))(Node_node_node_sum_sum$ (inl$e (projl$e Node$ ))(inr$e (projr$e Node_node_sum$ )))))
