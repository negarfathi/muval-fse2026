...
(assert (! (= (height$ (splitLeaf$ t$ w_a$ a$ w_b$ b$ ))zero$ ):named a3 ))
(assert (! (consistent$ t$ ):named a4 ))
(assert (! (consistent$ u$ ):named a5 ))
(assert (! (member$ a$ (alphabet$ t$ )):named a6 ))
(assert (! (not (member$ b$ (alphabet$ t$ ))):named a7 ))
(assert (! (= (freq$ (splitLeaf$ t$ w_a$ a$ w_b$ b$ ))(freq$ u$ )):named a8 ))
(assert (! (= (alphabet$ (splitLeaf$ t$ w_a$ a$ w_b$ b$ ))(alphabet$ u$ )):named a9 ))
(assert (! (= (fun_app$ (freq$ t$ )a$ )(plus$ w_a$ w_b$ )):named a10 ))
(assert (! (forall ((?v0 Nat$ ))(less_eq$ ?v0 ?v0 )):named a11 ))
(assert (! (forall ((?v0 A$ ))(=> (member$ ?v0 (alphabet$ t$ ))(and (less_eq$ w_a$ (fun_app$ (freq$ t$ )?v0 ))(less_eq$ w_b$ (fun_app$ (freq$ t$ )?v0 ))))):named a12 ))
(assert (! (forall ((?v0 A_tree$ ))(! (=> (= (height$ ?v0 )zero$ )(= (cost$ ?v0 )zero$ )):pattern ((cost$ ?v0 )))):named a13 ))
