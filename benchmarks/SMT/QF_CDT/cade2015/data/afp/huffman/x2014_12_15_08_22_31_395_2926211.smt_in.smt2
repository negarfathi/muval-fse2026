...
(assert (! (not (optimum$ (splitLeaf$ (huffman$ (fun_app$ (insortTree$ (leaf$ (plus$ w_a$ w_b$ )a$ ))ts$ ))w_a$ a$ w_b$ b$ ))):named a1 ))
...
(assert (! (= (huffman$ (fun_app$ (insortTree$ (uniteTrees$ t_a$ t_b$ ))ts$ ))(splitLeaf$ (huffman$ (fun_app$ (insortTree$ (leaf$ (plus$ w_a$ w_b$ )a$ ))ts$ ))w_a$ a$ w_b$ b$ )):named a24 ))
(assert (! (forall ((?v0 A_tree$ ))(! (= (fun_app$ (insortTree$ ?v0 )nil$ )(cons$ ?v0 nil$ )):pattern ((insortTree$ ?v0 )))):named a25 ))
(assert (! (forall ((?v0 A_tree$ ))(! (= (huffman$ (cons$ ?v0 nil$ ))?v0 ):pattern ((uu$ ?v0 )))):named a26 ))
