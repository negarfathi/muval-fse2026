...
(assert (! (forall ((?v0 A_tree$ )(?v1 A_tree$ )(?v2 A$ )(?v3 Nat$ ))(=> (and (consistent$ ?v0 )(and (consistent$ ?v1 )(and (= (fun_app$ (inf$ (alphabet$ ?v0 ))(alphabet$ ?v1 ))bot$ )(and (member$ ?v2 (alphabet$ ?v0 ))(and (not (member$ ?v2 (alphabet$ ?v1 )))(and (p$ ?v0 ?v2 )(p$ ?v1 ?v2 )))))))(p$ (innerNode$ ?v3 ?v0 ?v1 )?v2 ))):named a2 ))
(assert (! (forall ((?v0 A_tree$ )(?v1 A_tree$ )(?v2 A$ )(?v3 Nat$ ))(=> (and (consistent$ ?v0 )(and (consistent$ ?v1 )(and (= (fun_app$ (inf$ (alphabet$ ?v0 ))(alphabet$ ?v1 ))bot$ )(and (not (member$ ?v2 (alphabet$ ?v0 )))(and (member$ ?v2 (alphabet$ ?v1 ))(and (p$ ?v0 ?v2 )(p$ ?v1 ?v2 )))))))(p$ (innerNode$ ?v3 ?v0 ?v1 )?v2 ))):named a3 ))
(assert (! (forall ((?v0 A_tree$ )(?v1 A_tree$ )(?v2 A$ )(?v3 Nat$ ))(=> (and (consistent$ ?v0 )(and (consistent$ ?v1 )(and (= (fun_app$ (inf$ (alphabet$ ?v0 ))(alphabet$ ?v1 ))bot$ )(and (not (member$ ?v2 (alphabet$ ?v0 )))(and (not (member$ ?v2 (alphabet$ ?v1 )))(and (p$ ?v0 ?v2 )(p$ ?v1 ?v2 )))))))(p$ (innerNode$ ?v3 ?v0 ?v1 )?v2 ))):named a4 ))
