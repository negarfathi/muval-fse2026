...
(assert (! (not pa$ ):named a0 ))
(assert (! (consistent$ ta$ ):named a1 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A$ )(?v2 A$ ))(=> (and (= ta$ (leaf$ ?v0 ?v1 ))(= aa$ ?v2 ))pa$ )):named a2 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ )(?v2 Nat$ )(?v3 Nat$ )(?v4 Nat$ )(?v5 A$ ))(=> (and (not (= ?v0 ?v1 ))(and (= ta$ (innerNode$ ?v2 (leaf$ ?v3 ?v0 )(leaf$ ?v4 ?v1 )))(= aa$ ?v5 )))pa$ )):named a3 ))
(assert (! (forall ((?v0 A_tree$ )(?v1 A_tree$ )(?v2 A$ )(?v3 Nat$ ))(=> (and (consistent$ ?v0 )(and (consistent$ ?v1 )(and (= (inf$ (alphabet$ ?v0 )(alphabet$ ?v1 ))bot$ )(and (or (less$ zero$ (height$ ?v0 ))(less$ zero$ (height$ ?v1 )))(and (member$ ?v2 (alphabet$ ?v0 ))(and (member$ (sibling$ ?v0 ?v2 )(alphabet$ ?v0 ))(and (not (member$ ?v2 (alphabet$ ?v1 )))(and (not (member$ (sibling$ ?v0 ?v2 )(alphabet$ ?v1 )))(and (= ta$ (innerNode$ ?v3 ?v0 ?v1 ))(= aa$ ?v2 ))))))))))pa$ )):named a4 ))
(assert (! (forall ((?v0 A_tree$ )(?v1 A_tree$ )(?v2 A$ )(?v3 Nat$ ))(=> (and (consistent$ ?v0 )(and (consistent$ ?v1 )(and (= (inf$ (alphabet$ ?v0 )(alphabet$ ?v1 ))bot$ )(and (or (less$ zero$ (height$ ?v0 ))(less$ zero$ (height$ ?v1 )))(and (not (member$ ?v2 (alphabet$ ?v0 )))(and (not (member$ (sibling$ ?v1 ?v2 )(alphabet$ ?v0 )))(and (member$ ?v2 (alphabet$ ?v1 ))(and (member$ (sibling$ ?v1 ?v2 )(alphabet$ ?v1 ))(and (= ta$ (innerNode$ ?v3 ?v0 ?v1 ))(= aa$ ?v2 ))))))))))pa$ )):named a5 ))
(assert (! (forall ((?v0 A_tree$ )(?v1 A_tree$ )(?v2 A$ )(?v3 Nat$ ))(=> (and (consistent$ ?v0 )(and (consistent$ ?v1 )(and (= (inf$ (alphabet$ ?v0 )(alphabet$ ?v1 ))bot$ )(and (or (less$ zero$ (height$ ?v0 ))(less$ zero$ (height$ ?v1 )))(and (not (member$ ?v2 (alphabet$ ?v0 )))(and (not (member$ ?v2 (alphabet$ ?v1 )))(and (= ta$ (innerNode$ ?v3 ?v0 ?v1 ))(= aa$ ?v2 ))))))))pa$ )):named a6 ))
