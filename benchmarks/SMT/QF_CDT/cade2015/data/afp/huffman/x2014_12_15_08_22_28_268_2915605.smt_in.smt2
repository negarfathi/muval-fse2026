...
(assert (! (not (= (huffman$ (insortTree$ (uniteTrees$ t_a$ t_b$ )ts$ ))(splitLeaf$ (huffman$ (insortTree$ (leaf$ (plus$ w_a$ w_b$ )a$ )ts$ ))w_a$ a$ w_b$ b$ ))):named a0 ))
(assert (! (= tsa$ (cons$ t_a$ ts$a )):named a1 ))
(assert (! (= ts$a (cons$ t_b$ ts$ )):named a2 ))
...
(assert (! (forall ((?v0 A_tree$ )(?v1 A_tree$ )(?v2 A_tree_list$ ))(! (= (huffman$ (cons$ ?v0 (cons$ ?v1 ?v2 )))(huffman$ (insortTree$ (uniteTrees$ ?v0 ?v1 )?v2 ))):pattern ((cons$ ?v0 (cons$ ?v1 ?v2 ))))):named a8 ))
