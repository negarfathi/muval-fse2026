...
(assert (! (forall ((?v0 A$ )(?v1 A$ )(?v2 Nat$ )(?v3 Nat$ )(?v4 Nat$ )(?v5 A$ ))(=> (not (= ?v0 ?v1 ))(p$ (innerNode$ ?v2 (leaf$ ?v3 ?v0 )(leaf$ ?v4 ?v1 ))?v5 ))):named a3 ))
...
(assert (! (forall ((?v0 A_tree$ )(?v1 A_tree$ )(?v2 A$ )(?v3 Nat$ ))(=> (and (consistent$ ?v0 )(and (consistent$ ?v1 )(and (= (inf$ (alphabet$ ?v0 )(alphabet$ ?v1 ))bot$ )(and (or (less$ zero$ (height$ ?v0 ))(less$ zero$ (height$ ?v1 )))(and (not (member$ ?v2 (alphabet$ ?v0 )))(not (member$ ?v2 (alphabet$ ?v1 ))))))))(p$ (innerNode$ ?v3 ?v0 ?v1 )?v2 ))):named a6 ))
