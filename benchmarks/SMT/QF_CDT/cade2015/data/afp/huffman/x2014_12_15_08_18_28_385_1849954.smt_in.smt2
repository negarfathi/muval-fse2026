...
(assert (! (forall ((?v0 A$ ))(! (= (fun_app$ uu$ ?v0 )(times$ (fun_app$ (freq$ t$ )?v0 )(fun_app$ (depth$ t$ )?v0 ))):pattern ((fun_app$ uu$ ?v0 )))):named a0 ))
...
(assert (! (not (= (cost$ t$ )(setsum$ uu$ (alphabet$ t$ )))):named a9 ))
(assert (! (consistent$ t$ ):named a10 ))
(assert (! (forall ((?v0 A_tree$ ))(exists ((?v1 A$ ))(member$ ?v1 (alphabet$ ?v0 )))):named a11 ))
(assert (! (forall ((?v0 A_tree$ ))(! (=> (consistent$ ?v0 )(= (weight$ ?v0 )(setsum$ (freq$ ?v0 )(alphabet$ ?v0 )))):pattern ((weight$ ?v0 )))):named a12 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_nat_fun$ )(?v2 A_set$ ))(= (times$ ?v0 (setsum$ ?v1 ?v2 ))(setsum$ (fun_app$d (uua$ ?v0 )?v1 )?v2 ))):named a13 ))
(assert (! (forall ((?v0 A_nat_fun$ )(?v1 A_set$ )(?v2 A_nat_fun$ )(?v3 A_set$ ))(= (times$ (setsum$ ?v0 ?v1 )(setsum$ ?v2 ?v3 ))(setsum$ (fun_app$b (fun_app$e (uuc$ ?v0 )?v2 )?v3 )?v1 ))):named a14 ))
(assert (! (forall ((?v0 A_nat_fun$ )(?v1 A_set$ )(?v2 Nat$ ))(= (times$ (setsum$ ?v0 ?v1 )?v2 )(setsum$ (fun_app$c (uud$ ?v0 )?v2 )?v1 ))):named a15 ))
(assert (! (forall ((?v0 A_tree$ ))(=> (consistent$ ?v0 )(exists ((?v1 A$ ))(and (member$ ?v1 (alphabet$ ?v0 ))(= (fun_app$ (depth$ ?v0 )?v1 )(height$ ?v0 )))))):named a16 ))
(assert (! (forall ((?v0 A_a_nat_fun_fun$ )(?v1 A_set$ )(?v2 A_set$ ))(= (setsum$ (fun_app$b (uue$ ?v0 )?v1 )?v2 )(setsum$ (fun_app$b (uug$ ?v0 )?v2 )?v1 ))):named a17 ))
(assert (! (forall ((?v0 A$ )(?v1 A_tree$ ))(! (=> (not (member$ ?v0 (alphabet$ ?v1 )))(= (fun_app$ (freq$ ?v1 )?v0 )zero$ )):pattern ((fun_app$ (freq$ ?v1 )?v0 )))):named a18 ))
(assert (! (forall ((?v0 A_set$ )(?v1 A_a_fun$ )(?v2 A_a_fun$ )(?v3 A_set$ )(?v4 A_nat_fun$ )(?v5 A_nat_fun$ ))(=> (and (forall ((?v6 A$ ))(=> (member$ ?v6 ?v0 )(= (fun_app$g ?v1 (fun_app$g ?v2 ?v6 ))?v6 )))(and (forall ((?v6 A$ ))(=> (member$ ?v6 ?v0 )(member$ (fun_app$g ?v2 ?v6 )?v3 )))(and (forall ((?v6 A$ ))(=> (member$ ?v6 ?v3 )(= (fun_app$g ?v2 (fun_app$g ?v1 ?v6 ))?v6 )))(and (forall ((?v6 A$ ))(=> (member$ ?v6 ?v3 )(member$ (fun_app$g ?v1 ?v6 )?v0 )))(forall ((?v6 A$ ))(=> (member$ ?v6 ?v0 )(= (fun_app$ ?v4 (fun_app$g ?v2 ?v6 ))(fun_app$ ?v5 ?v6 ))))))))(= (setsum$ ?v5 ?v0 )(setsum$ ?v4 ?v3 )))):named a19 ))
(assert (! (forall ((?v0 A_set$ )(?v1 A_set$ )(?v2 A_nat_fun$ )(?v3 A_nat_fun$ ))(=> (and (= ?v0 ?v1 )(forall ((?v4 A$ ))(=> (member$ ?v4 ?v1 )(= (fun_app$ ?v2 ?v4 )(fun_app$ ?v3 ?v4 )))))(= (setsum$ ?v2 ?v0 )(setsum$ ?v3 ?v1 )))):named a20 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ )(?v2 Nat$ )(?v3 Nat$ ))(= (times$ (times$ ?v0 ?v1 )(times$ ?v2 ?v3 ))(times$ (times$ ?v0 ?v2 )(times$ ?v1 ?v3 )))):named a21 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ )(?v2 Nat$ ))(= (times$ (times$ ?v0 ?v1 )?v2 )(times$ (times$ ?v0 ?v2 )?v1 ))):named a22 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ )(?v2 Nat$ )(?v3 Nat$ ))(= (times$ (times$ ?v0 ?v1 )(times$ ?v2 ?v3 ))(times$ ?v2 (times$ (times$ ?v0 ?v1 )?v3 )))):named a23 ))
(assert (! (forall ((?v0 A_set$ ))(= (setsum$ uuh$ ?v0 )zero$ )):named a24 ))
(assert (! (forall ((?v0 Nat$ ))(= (times$ zero$ ?v0 )zero$ )):named a25 ))
(assert (! (forall ((?v0 Nat$ ))(= (times$ ?v0 zero$ )zero$ )):named a26 ))
(assert (! (forall ((?v0 A_nat_fun$ )(?v1 A_set$ ))(=> (and (not (= (setsum$ ?v0 ?v1 )zero$ ))(forall ((?v2 A$ ))(=> (and (member$ ?v2 ?v1 )(not (= (fun_app$ ?v0 ?v2 )zero$ )))false )))false )):named a27 ))
(check-sat )
;(get-unsat-core )
