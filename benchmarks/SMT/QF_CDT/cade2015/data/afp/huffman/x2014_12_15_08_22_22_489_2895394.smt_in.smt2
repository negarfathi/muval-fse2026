...
(assert (! (forall ((?v0 A_tree_list$ )(?v1 A_tree$ ))(=> (and (= (huffman$ ?v0 )?v1 )(and (forall ((?v2 A_tree$ ))(=> (and (= ?v0 (cons$ ?v2 nil$ ))(= ?v1 ?v2 ))false ))(and (forall ((?v2 A_tree$ )(?v3 A_tree$ )(?v4 A_tree_list$ ))(=> (and (= ?v0 (cons$ ?v2 (cons$ ?v3 ?v4 )))(= ?v1 (huffman$ (insortTree$ (uniteTrees$ ?v2 ?v3 )?v4 ))))false ))(=> (and (= ?v0 nil$ )(= ?v1 undefined$ ))false ))))false )):named a18 ))
(check-sat )
;(get-unsat-core )
