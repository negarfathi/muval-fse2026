...
(declare-sort B$ 0 )
(declare-sort Nat$ 0 )
(declare-datatypes ()((A_tree$ (leaf$ (select$ Nat$ )(selecta$ A$ ))(innerNode$ (selectb$ Nat$ )(selectc$ A_tree$ )(selectd$ A_tree$ )))(B_tree$ (leaf$a (selecte$ Nat$ )(selectf$ B$ ))(innerNode$a (selectg$ Nat$ )(selecth$ B_tree$ )(selecti$ B_tree$ )))))
(declare-fun a$ ()A$ )
(declare-fun p$ ()Bool )
