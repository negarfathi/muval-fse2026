...
(assert (! (less$ (set_of$ l$ )(set_of$ y$ )):named a3 ))
(assert (! (not (member$ a$ (set_of$ l$ ))):named a4 ))
(assert (! (less$ (set_of$ r$ )(set_of$ y$ )):named a5 ))
...
(assert (! (not (member$ a$ (set_of$ r$ ))):named a9 ))
(assert (! (less$a r$ y$ ):named a10 ))
