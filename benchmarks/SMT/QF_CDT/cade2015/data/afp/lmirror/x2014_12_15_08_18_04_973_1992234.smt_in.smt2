...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A_llist$ ))(= (fun_app$ (lmirror_aux$ (lappend$ ?v0 ?v1 ))?v2 )(lappend$ (fun_app$ (lmirror_aux$ ?v0 )?v2 )?v1 ))):named a2 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (lfinite$ (fun_app$ (lmirror_aux$ ?v0 )?v1 ))(and (lfinite$ ?v1 )(lfinite$ ?v0 )))):named a3 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(! (=> (not (lfinite$ ?v0 ))(= (fun_app$ (lmirror_aux$ ?v1 )?v0 )?v0 )):pattern ((fun_app$ (lmirror_aux$ ?v1 )?v0 )))):named a4 ))
...
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$ (lmirror_aux$ ?v0 )lNil$ )?v0 ):pattern ((lmirror_aux$ ?v0 )))):named a9 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (not (lnull$ (fun_app$ (lmirror_aux$ ?v0 )?v1 )))(or (not (lnull$ ?v1 ))(not (lnull$ ?v0 ))))):named a11 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (lnull$ (fun_app$ (lmirror_aux$ ?v0 )?v1 ))(and (lnull$ ?v1 )(lnull$ ?v0 )))):named a12 ))
