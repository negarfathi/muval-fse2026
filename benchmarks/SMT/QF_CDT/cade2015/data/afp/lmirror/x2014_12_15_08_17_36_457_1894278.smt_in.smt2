...
(assert (! (not (and (lfinite$ xs$ )(lfinite$ acc$ ))):named a0 ))
...
(assert (! (= (lfinite$a lNil$a )true ):named a7 ))
(assert (! (= (lfinite$b lNil$b )true ):named a8 ))
(assert (! (= (lfinite$c lNil$c )true ):named a9 ))
(assert (! (= (lfinite$d lNil$d )true ):named a10 ))
(assert (! (= (lfinite$ lNil$ )true ):named a11 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(= (lfinite$a (ldropn$ ?v0 ?v1 ))(lfinite$a ?v1 ))):named a12 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$b (ldropn$a ?v0 ?v1 ))(lfinite$b ?v1 ))):named a13 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_a_prod_prod_llist$ ))(= (lfinite$c (ldropn$b ?v0 ?v1 ))(lfinite$c ?v1 ))):named a14 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_llist$ ))(= (lfinite$d (ldropn$c ?v0 ?v1 ))(lfinite$d ?v1 ))):named a15 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_llist$ ))(= (lfinite$ (ldropn$d ?v0 ?v1 ))(lfinite$ ?v1 ))):named a16 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (lfinite$d (lzip$ ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$ ?v1 )))):named a17 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_a_prod_llist$ ))(= (lfinite$c (lzip$a ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$d ?v1 )))):named a18 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_llist$ ))(= (lfinite$b (lzip$b ?v0 ?v1 ))(or (lfinite$d ?v0 )(lfinite$ ?v1 )))):named a19 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_llist$ ))(= (lfinite$a (lzip$c ?v0 ?v1 ))(or (lfinite$d ?v0 )(lfinite$d ?v1 )))):named a20 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$e (lzip$d ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$b ?v1 )))):named a21 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_a_a_prod_prod_llist$ ))(= (lfinite$f (lzip$e ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$c ?v1 )))):named a22 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$ )(?v1 A_llist$ ))(= (lfinite$g (lzip$f ?v0 ?v1 ))(or (lfinite$b ?v0 )(lfinite$ ?v1 )))):named a23 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$ )(?v1 A_llist$ ))(= (lfinite$h (lzip$g ?v0 ?v1 ))(or (lfinite$c ?v0 )(lfinite$ ?v1 )))):named a24 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(= (lfinite$i (lzip$h ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$a ?v1 )))):named a25 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$j (lzip$i ?v0 ?v1 ))(or (lfinite$d ?v0 )(lfinite$b ?v1 )))):named a26 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(! (= (lfinite$a (lCons$a ?v0 ?v1 ))(lfinite$a ?v1 )):pattern ((lCons$a ?v0 ?v1 )))):named a27 ))
(assert (! (forall ((?v0 A_a_prod_a_prod$ )(?v1 A_a_prod_a_prod_llist$ ))(! (= (lfinite$b (lCons$b ?v0 ?v1 ))(lfinite$b ?v1 )):pattern ((lCons$b ?v0 ?v1 )))):named a28 ))
(assert (! (forall ((?v0 A_a_a_prod_prod$ )(?v1 A_a_a_prod_prod_llist$ ))(! (= (lfinite$c (lCons$c ?v0 ?v1 ))(lfinite$c ?v1 )):pattern ((lCons$c ?v0 ?v1 )))):named a29 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ ))(! (= (lfinite$d (lCons$d ?v0 ?v1 ))(lfinite$d ?v1 )):pattern ((lCons$d ?v0 ?v1 )))):named a30 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(! (= (lfinite$ (lCons$ ?v0 ?v1 ))(lfinite$ ?v1 )):pattern ((lCons$ ?v0 ?v1 )))):named a31 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(! (= (lfinite$a (lCons$a ?v0 ?v1 ))(lfinite$a ?v1 )):pattern ((lCons$a ?v0 ?v1 )))):named a32 ))
(assert (! (forall ((?v0 A_a_prod_a_prod$ )(?v1 A_a_prod_a_prod_llist$ ))(! (= (lfinite$b (lCons$b ?v0 ?v1 ))(lfinite$b ?v1 )):pattern ((lCons$b ?v0 ?v1 )))):named a33 ))
(assert (! (forall ((?v0 A_a_a_prod_prod$ )(?v1 A_a_a_prod_prod_llist$ ))(! (= (lfinite$c (lCons$c ?v0 ?v1 ))(lfinite$c ?v1 )):pattern ((lCons$c ?v0 ?v1 )))):named a34 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ ))(! (= (lfinite$d (lCons$d ?v0 ?v1 ))(lfinite$d ?v1 )):pattern ((lCons$d ?v0 ?v1 )))):named a35 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(! (= (lfinite$ (lCons$ ?v0 ?v1 ))(lfinite$ ?v1 )):pattern ((lCons$ ?v0 ?v1 )))):named a36 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun$ )(?v1 A_a_prod_a_a_prod_prod$ ))(not (lfinite$a (iterates$ ?v0 ?v1 )))):named a37 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_a_a_prod_a_prod_fun$ )(?v1 A_a_prod_a_prod$ ))(not (lfinite$b (iterates$a ?v0 ?v1 )))):named a38 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_a_a_a_prod_prod_fun$ )(?v1 A_a_a_prod_prod$ ))(not (lfinite$c (iterates$b ?v0 ?v1 )))):named a39 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_fun$ )(?v1 A_a_prod$ ))(not (lfinite$d (iterates$c ?v0 ?v1 )))):named a40 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A$ ))(not (lfinite$ (iterates$d ?v0 ?v1 )))):named a41 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_llist$ ))(= (lfinite$a (ltl$a ?v0 ))(lfinite$a ?v0 ))):named a42 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$ ))(= (lfinite$b (ltl$b ?v0 ))(lfinite$b ?v0 ))):named a43 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$ ))(= (lfinite$c (ltl$c ?v0 ))(lfinite$c ?v0 ))):named a44 ))
(assert (! (forall ((?v0 A_a_prod_llist$ ))(= (lfinite$d (ltl$d ?v0 ))(lfinite$d ?v0 ))):named a45 ))
(assert (! (forall ((?v0 A_llist$ ))(= (lfinite$ (ltl$ ?v0 ))(lfinite$ ?v0 ))):named a46 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_llist$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(= (lfinite$a (lappend$ ?v0 ?v1 ))(and (lfinite$a ?v0 )(lfinite$a ?v1 )))):named a47 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$b (lappend$a ?v0 ?v1 ))(and (lfinite$b ?v0 )(lfinite$b ?v1 )))):named a48 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$ )(?v1 A_a_a_prod_prod_llist$ ))(= (lfinite$c (lappend$b ?v0 ?v1 ))(and (lfinite$c ?v0 )(lfinite$c ?v1 )))):named a49 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_llist$ ))(= (lfinite$d (fun_app$ (lappend$c ?v0 )?v1 ))(and (lfinite$d ?v0 )(lfinite$d ?v1 )))):named a50 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (lfinite$ (fun_app$a (lappend$d ?v0 )?v1 ))(and (lfinite$ ?v0 )(lfinite$ ?v1 )))):named a51 ))
(assert (! (forall ((?v0 Nat_a_a_prod_a_a_prod_prod_fun$ ))(not (lfinite$a (inf_llist$ ?v0 )))):named a52 ))
(assert (! (forall ((?v0 Nat_a_a_prod_a_prod_fun$ ))(not (lfinite$b (inf_llist$a ?v0 )))):named a53 ))
(assert (! (forall ((?v0 Nat_a_a_a_prod_prod_fun$ ))(not (lfinite$c (inf_llist$b ?v0 )))):named a54 ))
(assert (! (forall ((?v0 Nat_a_a_prod_fun$ ))(not (lfinite$d (inf_llist$c ?v0 )))):named a55 ))
(assert (! (forall ((?v0 Nat_a_fun$ ))(not (lfinite$ (inf_llist$d ?v0 )))):named a56 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A_llist$ ))(= (lfinite$ (lmap$ ?v0 ?v1 ))(lfinite$ ?v1 ))):named a57 ))
(assert (! (forall ((?v0 A_a_prod_a_fun$ )(?v1 A_a_prod_llist$ ))(= (lfinite$ (lmap$a ?v0 ?v1 ))(lfinite$d ?v1 ))):named a58 ))
(assert (! (forall ((?v0 A_a_a_prod_fun$ )(?v1 A_llist$ ))(= (lfinite$d (lmap$b ?v0 ?v1 ))(lfinite$ ?v1 ))):named a59 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_fun$ )(?v1 A_a_prod_llist$ ))(= (lfinite$d (lmap$c ?v0 ?v1 ))(lfinite$d ?v1 ))):named a60 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_a_fun$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$ (lmap$d ?v0 ?v1 ))(lfinite$b ?v1 ))):named a61 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_a_fun$ )(?v1 A_a_a_prod_prod_llist$ ))(= (lfinite$ (lmap$e ?v0 ?v1 ))(lfinite$c ?v1 ))):named a62 ))
(assert (! (forall ((?v0 A_a_a_prod_a_prod_fun$ )(?v1 A_llist$ ))(= (lfinite$b (lmap$f ?v0 ?v1 ))(lfinite$ ?v1 ))):named a63 ))
(assert (! (forall ((?v0 A_a_a_a_prod_prod_fun$ )(?v1 A_llist$ ))(= (lfinite$c (lmap$g ?v0 ?v1 ))(lfinite$ ?v1 ))):named a64 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_a_fun$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(= (lfinite$ (lmap$h ?v0 ?v1 ))(lfinite$a ?v1 ))):named a65 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_a_a_prod_fun$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$d (lmap$i ?v0 ?v1 ))(lfinite$b ?v1 ))):named a66 ))
(assert (! (lfinite$a lNil$a ):named a67 ))
(assert (! (lfinite$b lNil$b ):named a68 ))
(assert (! (lfinite$c lNil$c ):named a69 ))
(assert (! (lfinite$d lNil$d ):named a70 ))
(assert (! (lfinite$ lNil$ ):named a71 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ )(?v2 A_a_prod$ )(?v3 A_a_prod_llist$ ))(= (= (lCons$d ?v0 ?v1 )(lCons$d ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a72 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(= (= (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a73 ))
(assert (! (forall ((?v0 Nat_a_a_prod_fun$ )(?v1 Nat_a_a_prod_fun$ ))(= (= (inf_llist$c ?v0 )(inf_llist$c ?v1 ))(= ?v0 ?v1 ))):named a74 ))
(assert (! (forall ((?v0 Nat_a_fun$ )(?v1 Nat_a_fun$ ))(= (= (inf_llist$d ?v0 )(inf_llist$d ?v1 ))(= ?v0 ?v1 ))):named a75 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ )(?v2 A_a_prod_llist$ ))(! (= (fun_app$ (lappend$c (lCons$d ?v0 ?v1 ))?v2 )(lCons$d ?v0 (fun_app$ (lappend$c ?v1 )?v2 ))):pattern ((fun_app$ (lappend$c (lCons$d ?v0 ?v1 ))?v2 )))):named a76 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist$ ))(! (= (fun_app$a (lappend$d (lCons$ ?v0 ?v1 ))?v2 )(lCons$ ?v0 (fun_app$a (lappend$d ?v1 )?v2 ))):pattern ((fun_app$a (lappend$d (lCons$ ?v0 ?v1 ))?v2 )))):named a77 ))
(assert (! (forall ((?v0 A_a_prod_llist$ ))(! (= (fun_app$ (lappend$c ?v0 )lNil$d )?v0 ):pattern ((lappend$c ?v0 )))):named a78 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$a (lappend$d ?v0 )lNil$ )?v0 ):pattern ((lappend$d ?v0 )))):named a79 ))
(check-sat )
;(get-unsat-core )
