...
(declare-datatypes ()((Rule_list_rule_sum$ (inl$a (projl$a Rule_list$ ))(inr$a (projr$a Rule$ )))(Rule_rule_rule_sum_sum$ (inl$b (projl$b Rule$ ))(inr$b (projr$b Rule_rule_sum$ )))(Rule_rule_list_sum$ (inl$c (projl$c Rule$ ))(inr$c (projr$c Rule_list$ )))(Rule_rule_sum_list$ (nil$a )(cons$a (hd$a Rule_rule_sum$ )(tl$a Rule_rule_sum_list$ )))(Rule_list_list$ (nil$b )(cons$b (hd$b Rule_list$ )(tl$b Rule_list_list$ )))))
