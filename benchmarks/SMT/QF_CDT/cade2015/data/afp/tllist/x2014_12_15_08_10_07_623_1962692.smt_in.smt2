...
(declare-fun terminal$i (B_c_tllist$)C$)
(declare-fun tNil$i (C$ )B_c_tllist$)
(declare-fun thd$i (B_c_tllist$)B$)
(declare-fun ttl$i (B_c_tllist$)B_c_tllist$)
(declare-fun tCons$i (B$ B_c_tllist$ )B_c_tllist$)
(declare-fun terminal$j (B_d_tllist$)D$)
(declare-fun tNil$j (D$ )B_d_tllist$)
(declare-fun thd$j (B_d_tllist$)B$)
(declare-fun ttl$j (B_d_tllist$)B_d_tllist$)
(declare-fun tCons$j (B$ B_d_tllist$ )B_d_tllist$)
...
(declare-fun terminal$m (D_c_tllist$)C$)
(declare-fun tNil$m (C$ )D_c_tllist$)
(declare-fun thd$m (D_c_tllist$)D$)
(declare-fun ttl$m (D_c_tllist$)D_c_tllist$)
(declare-fun tCons$m (D$ D_c_tllist$ )D_c_tllist$)
