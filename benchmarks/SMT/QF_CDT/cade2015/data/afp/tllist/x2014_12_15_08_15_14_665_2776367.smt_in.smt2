...
(declare-datatypes ()((A_llist_llist_llist_b_prod$ (pair$ (fst$ A_llist_llist_llist$ )(snd$ B$ )))(A_llist_llist_b_prod$ (pair$a (fst$a A_llist_llist$ )(snd$a B$ )))(A_llist_b_prod$ (pair$b (fst$b A_llist$ )(snd$b B$ )))))
