...
(declare-fun undefined$a ()A_llist_llist$ )
...
(assert (! (not (= (tnth$ (tNil$ b$ )n$ )(undefined$ n$ ))):named a3 ))
...
(assert (! (forall ((?v0 B$ )(?v1 B$ ))(! (= (tconcat$a ?v0 (tNil$a ?v1 ))(tNil$b ?v1 )):pattern ((tconcat$a ?v0 (tNil$a ?v1 ))))):named a11 ))
(assert (! (forall ((?v0 B$ )(?v1 B$ ))(! (= (tconcat$b ?v0 (tNil$b ?v1 ))(tNil$ ?v1 )):pattern ((tconcat$b ?v0 (tNil$b ?v1 ))))):named a12 ))
(assert (! (forall ((?v0 Unit_b_fun$ )(?v1 B$ ))(! (= (tconcat$c ?v0 (tNil$c ?v1 ))(tNil$a ?v1 )):pattern ((tconcat$c ?v0 (tNil$c ?v1 ))))):named a13 ))
(assert (! (forall ((?v0 Unit_b_fun$ )(?v1 B$ ))(! (= (tconcat$d ?v0 (tNil$a ?v1 ))(tNil$b ?v1 )):pattern ((tconcat$d ?v0 (tNil$a ?v1 ))))):named a14 ))
(assert (! (forall ((?v0 Unit_b_fun$ )(?v1 B$ ))(! (= (tconcat$e ?v0 (tNil$b ?v1 ))(tNil$ ?v1 )):pattern ((tconcat$e ?v0 (tNil$b ?v1 ))))):named a15 ))
(assert (! (forall ((?v0 Unit_b_fun$ )(?v1 A_llist_llist_bool_fun$ )(?v2 B$ ))(! (= (tfilter$ ?v0 ?v1 (tNil$a ?v2 ))(tNil$a ?v2 )):pattern ((tfilter$ ?v0 ?v1 (tNil$a ?v2 ))))):named a16 ))
(assert (! (forall ((?v0 Unit_b_fun$ )(?v1 A_llist_bool_fun$ )(?v2 B$ ))(! (= (tfilter$a ?v0 ?v1 (tNil$b ?v2 ))(tNil$b ?v2 )):pattern ((tfilter$a ?v0 ?v1 (tNil$b ?v2 ))))):named a17 ))
(assert (! (forall ((?v0 Unit_b_fun$ )(?v1 A_bool_fun$ )(?v2 B$ ))(! (= (tfilter$b ?v0 ?v1 (tNil$ ?v2 ))(tNil$ ?v2 )):pattern ((tfilter$b ?v0 ?v1 (tNil$ ?v2 ))))):named a18 ))
(assert (! (forall ((?v0 B$ ))(! (= (thd$a (tNil$a ?v0 ))undefined$a ):pattern ((tNil$a ?v0 )))):named a19 ))
(assert (! (forall ((?v0 B$ ))(! (= (thd$b (tNil$b ?v0 ))undefined$b ):pattern ((tNil$b ?v0 )))):named a20 ))
(assert (! (forall ((?v0 B$ ))(! (= (thd$ (tNil$ ?v0 ))undefined$c ):pattern ((tNil$ ?v0 )))):named a21 ))
(assert (! (forall ((?v0 B$ )(?v1 A_llist_llist_bool_fun$ )(?v2 B$ ))(! (= (tfilter$c ?v0 ?v1 (tNil$a ?v2 ))(tNil$a ?v2 )):pattern ((tfilter$c ?v0 ?v1 (tNil$a ?v2 ))))):named a22 ))
(assert (! (forall ((?v0 B$ )(?v1 A_llist_bool_fun$ )(?v2 B$ ))(! (= (tfilter$d ?v0 ?v1 (tNil$b ?v2 ))(tNil$b ?v2 )):pattern ((tfilter$d ?v0 ?v1 (tNil$b ?v2 ))))):named a23 ))
(assert (! (forall ((?v0 B$ )(?v1 A_bool_fun$ )(?v2 B$ ))(! (= (tfilter$e ?v0 ?v1 (tNil$ ?v2 ))(tNil$ ?v2 )):pattern ((tfilter$e ?v0 ?v1 (tNil$ ?v2 ))))):named a24 ))
(assert (! (forall ((?v0 B$ )(?v1 B_a_llist_b_tllist_fun$ ))(! (= (fun_app$d (tappend$ (tNil$b ?v0 ))?v1 )(fun_app$a ?v1 ?v0 )):pattern ((fun_app$d (tappend$ (tNil$b ?v0 ))?v1 )))):named a25 ))
(assert (! (forall ((?v0 B$ )(?v1 B_a_b_tllist_fun$ ))(! (= (fun_app$e (tappend$a (tNil$ ?v0 ))?v1 )(fun_app$b ?v1 ?v0 )):pattern ((fun_app$e (tappend$a (tNil$ ?v0 ))?v1 )))):named a26 ))
(assert (! (forall ((?v0 A_llist_llist_b_tllist$ ))(! (= (fun_app$f (tappend$b ?v0 )uu$ )?v0 ):pattern ((tappend$b ?v0 )))):named a27 ))
(assert (! (forall ((?v0 A_llist_b_tllist$ ))(! (= (fun_app$d (tappend$ ?v0 )uua$ )?v0 ):pattern ((tappend$ ?v0 )))):named a28 ))
