...
(declare-datatypes ()((A_b_prod_llist_a_llist_prod$ (pair$d (fst$d A_b_prod_llist$ )(snd$d A_llist$ )))(A_b_prod_llist_b_llist_prod$ (pair$e (fst$e A_b_prod_llist$ )(snd$e B_llist$ )))(A_b_prod_c_d_prod_tllist_a_c_tllist_prod$ (pair$f (fst$f A_b_prod_c_d_prod_tllist$ )(snd$f A_c_tllist$ )))(A_b_prod_c_d_prod_tllist_b_d_tllist_prod$ (pair$g (fst$g A_b_prod_c_d_prod_tllist$ )(snd$g B_d_tllist$ )))))
