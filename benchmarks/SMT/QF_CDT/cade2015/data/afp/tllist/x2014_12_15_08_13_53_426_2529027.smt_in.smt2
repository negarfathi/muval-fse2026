...
(declare-datatypes ()((C_llist_d_prod$ (pair$ (fst$ C_llist$ )(snd$ D$ )))(A_llist_b_prod$ (pair$a (fst$a A_llist$ )(snd$a B$ )))))
...
(declare-datatypes ()((A_b_prod$ (pair$b (fst$b A$ )(snd$b B$ )))(C_d_prod$ (pair$c (fst$c C$ )(snd$c D$ )))))
