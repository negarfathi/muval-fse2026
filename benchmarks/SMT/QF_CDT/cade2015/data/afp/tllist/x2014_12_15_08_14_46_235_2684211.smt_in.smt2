...
(declare-datatypes ()((B_llist_f_prod$ (pair$ (fst$ B_llist$ )(snd$ F$ )))(A_llist_e_prod$ (pair$a (fst$a A_llist$ )(snd$a E$ )))(A_llist_c_prod$ (pair$b (fst$b A_llist$ )(snd$b C$ )))(B_llist_d_prod$ (pair$c (fst$c B_llist$ )(snd$c D$ )))))
