...
(declare-datatypes ()((A_a_prod$ (pair$ (fst$ A$ )(snd$ A$ )))(B_a_a_prod_prod$ (pair$a (fst$a B$ )(snd$a A_a_prod$ )))))
(declare-sort B_a_a_prod_prod_llist$ 0)
(declare-fun lNil$a ()B_a_a_prod_prod_llist$)
(declare-fun lhd$a (B_a_a_prod_prod_llist$)B_a_a_prod_prod$)
(declare-fun ltl$a (B_a_a_prod_prod_llist$)B_a_a_prod_prod_llist$)
(declare-fun lCons$a (B_a_a_prod_prod$ B_a_a_prod_prod_llist$ )B_a_a_prod_prod_llist$)
...
(declare-datatypes ()((A_b_prod$ (pair$e (fst$e A$ )(snd$e B$ )))))
...
(declare-fun lhd$g (B_llist$)B$)
(declare-fun ltl$g (B_llist$)B_llist$)
...
(declare-datatypes ()((A_a_prod_b_prod$ (pair$g (fst$g A_a_prod$ )(snd$g B$ )))))
(declare-sort A_a_prod_b_prod_llist$ 0)
(declare-fun lNil$i ()A_a_prod_b_prod_llist$)
(declare-fun lhd$i (A_a_prod_b_prod_llist$)A_a_prod_b_prod$)
(declare-fun ltl$i (A_a_prod_b_prod_llist$)A_a_prod_b_prod_llist$)
(declare-fun lCons$i (A_a_prod_b_prod$ A_a_prod_b_prod_llist$ )A_a_prod_b_prod_llist$)
