...
(declare-fun terminal$c (A_b_prod_a_b_prod_tllist$)A_b_prod$)
(declare-fun tNil$c (A_b_prod$ )A_b_prod_a_b_prod_tllist$)
(declare-fun thd$c (A_b_prod_a_b_prod_tllist$)A_b_prod$)
(declare-fun ttl$c (A_b_prod_a_b_prod_tllist$)A_b_prod_a_b_prod_tllist$)
(declare-fun tCons$c (A_b_prod$ A_b_prod_a_b_prod_tllist$ )A_b_prod_a_b_prod_tllist$)
...
(declare-fun terminal$e (C_d_prod_c_d_prod_tllist$)C_d_prod$)
(declare-fun tNil$e (C_d_prod$ )C_d_prod_c_d_prod_tllist$)
(declare-fun thd$e (C_d_prod_c_d_prod_tllist$)C_d_prod$)
(declare-fun ttl$e (C_d_prod_c_d_prod_tllist$)C_d_prod_c_d_prod_tllist$)
(declare-fun tCons$e (C_d_prod$ C_d_prod_c_d_prod_tllist$ )C_d_prod_c_d_prod_tllist$)
...
(declare-datatypes ()((A_b_prod_llist_a_llist_prod$ (pair$b (fst$b A_b_prod_llist$ )(snd$b A_llist$ )))))
(declare-sort A_b_prod_llist_a_llist_prod_llist$ 0)
(declare-sort A_b_prod_llist_a_llist_prod_c_d_prod_tllist$ 0)
(declare-sort A_b_prod_llist_a_llist_prod_a_b_prod_tllist$ 0)
(declare-sort C_d_prod_a_b_prod_llist_a_llist_prod_tllist$ 0)
(declare-sort A_b_prod_a_b_prod_llist_a_llist_prod_tllist$ 0)
(declare-sort B_b_tllist$ 0)
(declare-sort A_a_b_prod_llist_tllist$ 0)
(declare-sort B_a_llist_tllist$ 0)
(declare-sort C_a_b_prod_llist_tllist$ 0)
(declare-sort D_a_llist_tllist$ 0)
(declare-sort A_b_prod_llist_a_tllist$ 0)
(declare-sort A_llist_b_tllist$ 0)
(declare-sort A_b_prod_llist_c_tllist$ 0)
(declare-sort A_llist_d_tllist$ 0)
(declare-sort A_b_prod_llist_a_b_prod_llist_tllist$ 0)
(declare-sort A_llist_a_llist_tllist$ 0)
(declare-sort A_b_prod_llist_a_llist_prod_a_b_prod_llist_a_llist_prod_tllist$ 0)
(declare-sort C_a_tllist$ 0)
(declare-sort D_b_tllist$ 0)
(declare-sort C_c_tllist$ 0)
(declare-sort D_d_tllist$ 0)
(declare-fun lNil$d ()A_b_prod_llist_a_llist_prod_llist$)
(declare-fun lhd$d (A_b_prod_llist_a_llist_prod_llist$)A_b_prod_llist_a_llist_prod$)
(declare-fun ltl$d (A_b_prod_llist_a_llist_prod_llist$)A_b_prod_llist_a_llist_prod_llist$)
(declare-fun lCons$d (A_b_prod_llist_a_llist_prod$ A_b_prod_llist_a_llist_prod_llist$ )A_b_prod_llist_a_llist_prod_llist$)
(declare-fun terminal$g (A_b_prod_llist_a_llist_prod_c_d_prod_tllist$)C_d_prod$)
(declare-fun tNil$g (C_d_prod$ )A_b_prod_llist_a_llist_prod_c_d_prod_tllist$)
(declare-fun thd$g (A_b_prod_llist_a_llist_prod_c_d_prod_tllist$)A_b_prod_llist_a_llist_prod$)
(declare-fun ttl$g (A_b_prod_llist_a_llist_prod_c_d_prod_tllist$)A_b_prod_llist_a_llist_prod_c_d_prod_tllist$)
(declare-fun tCons$g (A_b_prod_llist_a_llist_prod$ A_b_prod_llist_a_llist_prod_c_d_prod_tllist$ )A_b_prod_llist_a_llist_prod_c_d_prod_tllist$)
(declare-fun terminal$h (A_b_prod_llist_a_llist_prod_a_b_prod_tllist$)A_b_prod$)
(declare-fun tNil$h (A_b_prod$ )A_b_prod_llist_a_llist_prod_a_b_prod_tllist$)
(declare-fun thd$h (A_b_prod_llist_a_llist_prod_a_b_prod_tllist$)A_b_prod_llist_a_llist_prod$)
(declare-fun ttl$h (A_b_prod_llist_a_llist_prod_a_b_prod_tllist$)A_b_prod_llist_a_llist_prod_a_b_prod_tllist$)
(declare-fun tCons$h (A_b_prod_llist_a_llist_prod$ A_b_prod_llist_a_llist_prod_a_b_prod_tllist$ )A_b_prod_llist_a_llist_prod_a_b_prod_tllist$)
(declare-fun terminal$i (C_d_prod_a_b_prod_llist_a_llist_prod_tllist$)A_b_prod_llist_a_llist_prod$)
(declare-fun tNil$i (A_b_prod_llist_a_llist_prod$ )C_d_prod_a_b_prod_llist_a_llist_prod_tllist$)
(declare-fun thd$i (C_d_prod_a_b_prod_llist_a_llist_prod_tllist$)C_d_prod$)
(declare-fun ttl$i (C_d_prod_a_b_prod_llist_a_llist_prod_tllist$)C_d_prod_a_b_prod_llist_a_llist_prod_tllist$)
(declare-fun tCons$i (C_d_prod$ C_d_prod_a_b_prod_llist_a_llist_prod_tllist$ )C_d_prod_a_b_prod_llist_a_llist_prod_tllist$)
(declare-fun terminal$j (A_b_prod_a_b_prod_llist_a_llist_prod_tllist$)A_b_prod_llist_a_llist_prod$)
(declare-fun tNil$j (A_b_prod_llist_a_llist_prod$ )A_b_prod_a_b_prod_llist_a_llist_prod_tllist$)
(declare-fun thd$j (A_b_prod_a_b_prod_llist_a_llist_prod_tllist$)A_b_prod$)
(declare-fun ttl$j (A_b_prod_a_b_prod_llist_a_llist_prod_tllist$)A_b_prod_a_b_prod_llist_a_llist_prod_tllist$)
(declare-fun tCons$j (A_b_prod$ A_b_prod_a_b_prod_llist_a_llist_prod_tllist$ )A_b_prod_a_b_prod_llist_a_llist_prod_tllist$)
(declare-fun terminal$k (B_b_tllist$)B$)
(declare-fun tNil$k (B$ )B_b_tllist$)
(declare-fun thd$k (B_b_tllist$)B$)
(declare-fun ttl$k (B_b_tllist$)B_b_tllist$)
(declare-fun tCons$k (B$ B_b_tllist$ )B_b_tllist$)
(declare-fun terminal$l (A_a_b_prod_llist_tllist$)A_b_prod_llist$)
(declare-fun tNil$l (A_b_prod_llist$ )A_a_b_prod_llist_tllist$)
(declare-fun thd$l (A_a_b_prod_llist_tllist$)A$)
(declare-fun ttl$l (A_a_b_prod_llist_tllist$)A_a_b_prod_llist_tllist$)
(declare-fun tCons$l (A$ A_a_b_prod_llist_tllist$ )A_a_b_prod_llist_tllist$)
(declare-fun terminal$m (B_a_llist_tllist$)A_llist$)
(declare-fun tNil$m (A_llist$ )B_a_llist_tllist$)
(declare-fun thd$m (B_a_llist_tllist$)B$)
(declare-fun ttl$m (B_a_llist_tllist$)B_a_llist_tllist$)
(declare-fun tCons$m (B$ B_a_llist_tllist$ )B_a_llist_tllist$)
(declare-fun terminal$n (C_a_b_prod_llist_tllist$)A_b_prod_llist$)
(declare-fun tNil$n (A_b_prod_llist$ )C_a_b_prod_llist_tllist$)
(declare-fun thd$n (C_a_b_prod_llist_tllist$)C$)
(declare-fun ttl$n (C_a_b_prod_llist_tllist$)C_a_b_prod_llist_tllist$)
(declare-fun tCons$n (C$ C_a_b_prod_llist_tllist$ )C_a_b_prod_llist_tllist$)
(declare-fun terminal$o (D_a_llist_tllist$)A_llist$)
(declare-fun tNil$o (A_llist$ )D_a_llist_tllist$)
(declare-fun thd$o (D_a_llist_tllist$)D$)
(declare-fun ttl$o (D_a_llist_tllist$)D_a_llist_tllist$)
(declare-fun tCons$o (D$ D_a_llist_tllist$ )D_a_llist_tllist$)
(declare-fun terminal$p (A_b_prod_llist_a_tllist$)A$)
(declare-fun tNil$p (A$ )A_b_prod_llist_a_tllist$)
(declare-fun thd$p (A_b_prod_llist_a_tllist$)A_b_prod_llist$)
(declare-fun ttl$p (A_b_prod_llist_a_tllist$)A_b_prod_llist_a_tllist$)
(declare-fun tCons$p (A_b_prod_llist$ A_b_prod_llist_a_tllist$ )A_b_prod_llist_a_tllist$)
(declare-fun terminal$q (A_llist_b_tllist$)B$)
(declare-fun tNil$q (B$ )A_llist_b_tllist$)
(declare-fun thd$q (A_llist_b_tllist$)A_llist$)
(declare-fun ttl$q (A_llist_b_tllist$)A_llist_b_tllist$)
(declare-fun tCons$q (A_llist$ A_llist_b_tllist$ )A_llist_b_tllist$)
(declare-fun terminal$r (A_b_prod_llist_c_tllist$)C$)
(declare-fun tNil$r (C$ )A_b_prod_llist_c_tllist$)
(declare-fun thd$r (A_b_prod_llist_c_tllist$)A_b_prod_llist$)
(declare-fun ttl$r (A_b_prod_llist_c_tllist$)A_b_prod_llist_c_tllist$)
(declare-fun tCons$r (A_b_prod_llist$ A_b_prod_llist_c_tllist$ )A_b_prod_llist_c_tllist$)
(declare-fun terminal$s (A_llist_d_tllist$)D$)
(declare-fun tNil$s (D$ )A_llist_d_tllist$)
(declare-fun thd$s (A_llist_d_tllist$)A_llist$)
(declare-fun ttl$s (A_llist_d_tllist$)A_llist_d_tllist$)
(declare-fun tCons$s (A_llist$ A_llist_d_tllist$ )A_llist_d_tllist$)
(declare-fun terminal$t (A_b_prod_llist_a_b_prod_llist_tllist$)A_b_prod_llist$)
(declare-fun tNil$t (A_b_prod_llist$ )A_b_prod_llist_a_b_prod_llist_tllist$)
(declare-fun thd$t (A_b_prod_llist_a_b_prod_llist_tllist$)A_b_prod_llist$)
(declare-fun ttl$t (A_b_prod_llist_a_b_prod_llist_tllist$)A_b_prod_llist_a_b_prod_llist_tllist$)
(declare-fun tCons$t (A_b_prod_llist$ A_b_prod_llist_a_b_prod_llist_tllist$ )A_b_prod_llist_a_b_prod_llist_tllist$)
(declare-fun terminal$u (A_llist_a_llist_tllist$)A_llist$)
(declare-fun tNil$u (A_llist$ )A_llist_a_llist_tllist$)
(declare-fun thd$u (A_llist_a_llist_tllist$)A_llist$)
(declare-fun ttl$u (A_llist_a_llist_tllist$)A_llist_a_llist_tllist$)
(declare-fun tCons$u (A_llist$ A_llist_a_llist_tllist$ )A_llist_a_llist_tllist$)
(declare-fun terminal$v (A_b_prod_llist_a_llist_prod_a_b_prod_llist_a_llist_prod_tllist$)A_b_prod_llist_a_llist_prod$)
(declare-fun tNil$v (A_b_prod_llist_a_llist_prod$ )A_b_prod_llist_a_llist_prod_a_b_prod_llist_a_llist_prod_tllist$)
(declare-fun thd$v (A_b_prod_llist_a_llist_prod_a_b_prod_llist_a_llist_prod_tllist$)A_b_prod_llist_a_llist_prod$)
(declare-fun ttl$v (A_b_prod_llist_a_llist_prod_a_b_prod_llist_a_llist_prod_tllist$)A_b_prod_llist_a_llist_prod_a_b_prod_llist_a_llist_prod_tllist$)
(declare-fun tCons$v (A_b_prod_llist_a_llist_prod$ A_b_prod_llist_a_llist_prod_a_b_prod_llist_a_llist_prod_tllist$ )A_b_prod_llist_a_llist_prod_a_b_prod_llist_a_llist_prod_tllist$)
(declare-fun terminal$w (C_a_tllist$)A$)
(declare-fun tNil$w (A$ )C_a_tllist$)
(declare-fun thd$w (C_a_tllist$)C$)
(declare-fun ttl$w (C_a_tllist$)C_a_tllist$)
(declare-fun tCons$w (C$ C_a_tllist$ )C_a_tllist$)
(declare-fun terminal$x (D_b_tllist$)B$)
(declare-fun tNil$x (B$ )D_b_tllist$)
(declare-fun thd$x (D_b_tllist$)D$)
(declare-fun ttl$x (D_b_tllist$)D_b_tllist$)
(declare-fun tCons$x (D$ D_b_tllist$ )D_b_tllist$)
(declare-fun terminal$y (C_c_tllist$)C$)
(declare-fun tNil$y (C$ )C_c_tllist$)
(declare-fun thd$y (C_c_tllist$)C$)
(declare-fun ttl$y (C_c_tllist$)C_c_tllist$)
(declare-fun tCons$y (C$ C_c_tllist$ )C_c_tllist$)
(declare-fun terminal$z (D_d_tllist$)D$)
(declare-fun tNil$z (D$ )D_d_tllist$)
(declare-fun thd$z (D_d_tllist$)D$)
(declare-fun ttl$z (D_d_tllist$)D_d_tllist$)
(declare-fun tCons$z (D$ D_d_tllist$ )D_d_tllist$)
