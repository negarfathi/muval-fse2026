...
(declare-datatypes ()((A_a_b_prod_prod$ (pair$a (fst$a A$ )(snd$a A_b_prod$ )))(A_a_prod$ (pair$b (fst$b A$ )(snd$b A$ )))(B_a_prod$ (pair$c (fst$c B$ )(snd$c A$ )))(B_a_prod_a_prod$ (pair$d (fst$d B_a_prod$ )(snd$d A$ )))(A_b_a_prod_prod$ (pair$e (fst$e A$ )(snd$e B_a_prod$ )))(A_b_prod_a_prod$ (pair$f (fst$f A_b_prod$ )(snd$f A$ )))(B_b_prod$ (pair$g (fst$g B$ )(snd$g B$ )))))
(declare-fun a$ ()A$ )
(declare-fun b$ ()B$ )
