...
(declare-fun lNil$ ()B_stream_llist$)
(declare-fun lhd$ (B_stream_llist$)B_stream$)
(declare-fun ltl$ (B_stream_llist$)B_stream_llist$)
(declare-fun lCons$ (B_stream$ B_stream_llist$ )B_stream_llist$)
