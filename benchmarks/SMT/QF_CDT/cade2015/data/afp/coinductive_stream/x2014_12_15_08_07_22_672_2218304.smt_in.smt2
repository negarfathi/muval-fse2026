...
(declare-datatypes ()((A_b_prod_llist_a_llist_prod_stream_a_llist_stream_prod$ (pair$e (fst$e A_b_prod_llist_a_llist_prod_stream$ )(snd$e A_llist_stream$ )))(A_b_prod_stream_b_stream_prod_stream_a_b_prod_stream_stream_prod$ (pair$f (fst$f A_b_prod_stream_b_stream_prod_stream$ )(snd$f A_b_prod_stream_stream$ )))(A_b_prod_stream_b_stream_prod_stream_b_stream_stream_prod$ (pair$g (fst$g A_b_prod_stream_b_stream_prod_stream$ )(snd$g B_stream_stream$ )))(A_b_prod_stream_a_stream_prod_stream_a_b_prod_stream_stream_prod$ (pair$h (fst$h A_b_prod_stream_a_stream_prod_stream$ )(snd$h A_b_prod_stream_stream$ )))(A_b_prod_stream_a_stream_prod_stream_a_stream_stream_prod$ (pair$i (fst$i A_b_prod_stream_a_stream_prod_stream$ )(snd$i A_stream_stream$ )))))
