...
(declare-datatypes ()((A_b_prod$ (pair$a (fst$a A$ )(snd$a B$ )))(A_a_a_prod_prod$ (pair$b (fst$b A$ )(snd$b A_a_prod$ )))(B_a_prod$ (pair$c (fst$c B$ )(snd$c A$ )))(B_b_prod$ (pair$d (fst$d B$ )(snd$d B$ )))(B_a_a_prod_prod$ (pair$e (fst$e B$ )(snd$e A_a_prod$ )))(A_a_prod_a_prod$ (pair$f (fst$f A_a_prod$ )(snd$f A$ )))(A_a_prod_b_prod$ (pair$g (fst$g A_a_prod$ )(snd$g B$ )))(A_a_prod_a_a_prod_prod$ (pair$h (fst$h A_a_prod$ )(snd$h A_a_prod$ )))))
(declare-fun b$ ()B$ )
