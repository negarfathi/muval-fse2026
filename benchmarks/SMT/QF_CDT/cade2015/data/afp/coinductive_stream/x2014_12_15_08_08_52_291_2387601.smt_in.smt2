...
(assert (! (= (collect$ uu$ )bot$ ):named a8 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(= (= (enat$ ?v0 )(enat$ ?v1 ))(= ?v0 ?v1 ))):named a9 ))
(assert (! (fun_app$a (ev$ (alw$ uua$ ))omega$a ):named a10 ))
(assert (! (forall ((?v0 A_stream_bool_fun$ )(?v1 A_stream$ ))(= (fun_app$a (alw$ ?v0 )?v1 )(forall ((?v2 Nat$ ))(fun_app$a ?v0 (sdrop$ ?v2 ?v1 ))))):named a11 ))
(assert (! (forall ((?v0 A_stream_bool_fun$ )(?v1 A_stream$ )(?v2 Nat$ ))(=> (fun_app$a (alw$ ?v0 )?v1 )(fun_app$a (alw$ ?v0 )(sdrop$ ?v2 ?v1 )))):named a12 ))
(assert (! (forall ((?v0 A_stream_bool_fun$ )(?v1 A_stream$ ))(= (= (scount$ ?v0 ?v1 )zero$ )(fun_app$a (alw$ (uub$ ?v0 ))?v1 ))):named a13 ))
(assert (! (forall ((?v0 A_stream_bool_fun$ )(?v1 A_stream$ ))(=> (= (scount$ ?v0 ?v1 )zero$ )(fun_app$a (alw$ (uub$ ?v0 ))?v1 ))):named a14 ))
(assert (! (forall ((?v0 A_stream_bool_fun$ )(?v1 A_stream$ ))(! (=> (fun_app$a (alw$ (uub$ ?v0 ))?v1 )(= (scount$ ?v0 ?v1 )zero$ )):pattern ((scount$ ?v0 ?v1 )))):named a15 ))
(assert (! (forall ((?v0 A_stream_bool_fun$ )(?v1 A_stream$ ))(=> (not (fun_app$a ?v0 ?v1 ))(= (scount$ ?v0 ?v1 )(scount$ ?v0 (stl$ ?v1 ))))):named a16 ))
(assert (! (forall ((?v0 Nat$ ))(= (card$ (collect$ (uuc$ ?v0 )))?v0 )):named a17 ))
