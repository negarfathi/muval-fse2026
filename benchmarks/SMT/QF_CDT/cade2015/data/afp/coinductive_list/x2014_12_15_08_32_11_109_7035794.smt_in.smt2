...
(declare-sort B_llist_llist_llist_llist$ 0)
...
(declare-fun lhd$f (B_llist_llist_llist$)B_llist_llist$)
(declare-fun ltl$f (B_llist_llist_llist$)B_llist_llist_llist$)
(declare-fun lCons$f (B_llist_llist$ B_llist_llist_llist$ )B_llist_llist_llist$)
(declare-fun lNil$g ()B_llist_llist_llist_llist$)
(declare-fun lhd$g (B_llist_llist_llist_llist$)B_llist_llist_llist$)
(declare-fun ltl$g (B_llist_llist_llist_llist$)B_llist_llist_llist_llist$)
(declare-fun lCons$g (B_llist_llist_llist$ B_llist_llist_llist_llist$ )B_llist_llist_llist_llist$)
