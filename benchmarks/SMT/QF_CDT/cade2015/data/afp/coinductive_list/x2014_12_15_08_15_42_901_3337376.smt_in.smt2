...
(declare-datatypes ()((Enat_a_llist_prod$ (pair$ (fst$ Enat$ )(snd$ A_llist$ )))(A_llist_a_llist_prod$ (pair$a (fst$a A_llist$ )(snd$a A_llist$ )))(Enat_enat_prod$ (pair$b (fst$b Enat$ )(snd$b Enat$ )))(A_llist_enat_prod$ (pair$c (fst$c A_llist$ )(snd$c Enat$ )))))
