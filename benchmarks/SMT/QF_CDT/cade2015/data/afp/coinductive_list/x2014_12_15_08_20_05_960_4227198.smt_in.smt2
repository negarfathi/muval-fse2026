...
(declare-datatypes ()((B_llist_b_llist_prod$ (pair$ (fst$ B_llist$ )(snd$ B_llist$ )))(Nat_option$ (none$ )(some$ (the$ Nat$ )))(Enat$ (abs_enat$ (rep_enat$ Nat_option$ )))(Enat_enat_prod$ (pair$a (fst$a Enat$ )(snd$a Enat$ )))(Enat_list$ (nil$ )(cons$ (hd$ Enat$ )(tl$ Enat_list$ )))(Enat_list_enat_list_prod$ (pair$b (fst$b Enat_list$ )(snd$b Enat_list$ )))(B_llist_list$ (nil$a )(cons$a (hd$a B_llist$ )(tl$a B_llist_list$ )))(B_llist_list_b_llist_list_prod$ (pair$c (fst$c B_llist_list$ )(snd$c B_llist_list$ )))(Enat_enat_prod_enat_enat_prod_prod$ (pair$d (fst$d Enat_enat_prod$ )(snd$d Enat_enat_prod$ )))(Enat_b_llist_prod$ (pair$e (fst$e Enat$ )(snd$e B_llist$ )))(Enat_b_llist_prod_enat_b_llist_prod_prod$ (pair$f (fst$f Enat_b_llist_prod$ )(snd$f Enat_b_llist_prod$ )))(B_llist_enat_prod$ (pair$g (fst$g B_llist$ )(snd$g Enat$ )))(B_llist_enat_prod_b_llist_enat_prod_prod$ (pair$h (fst$h B_llist_enat_prod$ )(snd$h B_llist_enat_prod$ )))(Enat_list_list$ (nil$b )(cons$b (hd$b Enat_list$ )(tl$b Enat_list_list$ )))(Enat_list_list_enat_list_list_prod$ (pair$i (fst$i Enat_list_list$ )(snd$i Enat_list_list$ )))(Enat_enat_prod_list$ (nil$c )(cons$c (hd$c Enat_enat_prod$ )(tl$c Enat_enat_prod_list$ )))(Enat_enat_prod_list_enat_enat_prod_list_prod$ (pair$j (fst$j Enat_enat_prod_list$ )(snd$j Enat_enat_prod_list$ )))(B_llist_list_list$ (nil$d )(cons$d (hd$d B_llist_list$ )(tl$d B_llist_list_list$ )))(B_llist_list_list_b_llist_list_list_prod$ (pair$k (fst$k B_llist_list_list$ )(snd$k B_llist_list_list$ )))))
