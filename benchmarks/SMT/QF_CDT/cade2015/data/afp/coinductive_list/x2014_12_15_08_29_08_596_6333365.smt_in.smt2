...
(assert (! (lfinite$ (llist_of$ xs$a )):named a2 ))
...
(assert (! (or (= xs$ lNil$ )(r$ (lhd$ xs$ )y$ )):named a8 ))
...
(assert (! (= (llist_of$ xs$a )(lappend$ zs$ xs$ )):named a44 ))
...
(assert (! (=> (forall ((?v0 A_list$ ))(=> (= zs$ (llist_of$ ?v0 ))false ))false ):named a55 ))
...
(assert (! (forall ((?v0 A_a_prod_list$ )(?v1 A_a_prod_list$ ))(= (= (llist_of$d ?v0 )(llist_of$d ?v1 ))(= ?v0 ?v1 ))):named a58 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_list$ ))(= (= (llist_of$ ?v0 )(llist_of$ ?v1 ))(= ?v0 ?v1 ))):named a59 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ )(?v2 A_a_prod_llist$ ))(! (= (lappend$a (lCons$d ?v0 ?v1 )?v2 )(lCons$d ?v0 (lappend$a ?v1 ?v2 ))):pattern ((lappend$a (lCons$d ?v0 ?v1 )?v2 )))):named a60 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist$ ))(! (= (lappend$ (lCons$ ?v0 ?v1 )?v2 )(lCons$ ?v0 (lappend$ ?v1 ?v2 ))):pattern ((lappend$ (lCons$ ?v0 ?v1 )?v2 )))):named a61 ))
(check-sat )
;(get-unsat-core )
