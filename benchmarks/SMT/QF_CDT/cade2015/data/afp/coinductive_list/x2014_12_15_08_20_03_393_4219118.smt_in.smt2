...
(declare-datatypes ()((Enat_enat_prod$ (pair$ (fst$ Enat$ )(snd$ Enat$ )))(Nat_nat_prod$ (pair$a (fst$a Nat$ )(snd$a Nat$ )))(B_llist_b_llist_prod$ (pair$b (fst$b B_llist$ )(snd$b B_llist$ )))))
