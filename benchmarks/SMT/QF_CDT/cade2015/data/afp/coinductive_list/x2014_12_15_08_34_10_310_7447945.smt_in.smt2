...
(declare-datatypes ()((Nat_a_nat_prod_prod$ (pair$d (fst$d Nat$ )(snd$d A_nat_prod$ )))))
(declare-sort Nat_a_nat_prod_prod_llist$ 0)
(declare-fun lNil$f ()Nat_a_nat_prod_prod_llist$)
(declare-fun lhd$f (Nat_a_nat_prod_prod_llist$)Nat_a_nat_prod_prod$)
(declare-fun ltl$f (Nat_a_nat_prod_prod_llist$)Nat_a_nat_prod_prod_llist$)
(declare-fun lCons$f (Nat_a_nat_prod_prod$ Nat_a_nat_prod_prod_llist$ )Nat_a_nat_prod_prod_llist$)
...
(declare-datatypes ()((A_nat_nat_prod_prod$ (pair$f (fst$f A$ )(snd$f Nat_nat_prod$ )))))
(declare-sort A_nat_nat_prod_prod_llist$ 0)
(declare-fun lNil$h ()A_nat_nat_prod_prod_llist$)
(declare-fun lhd$h (A_nat_nat_prod_prod_llist$)A_nat_nat_prod_prod$)
(declare-fun ltl$h (A_nat_nat_prod_prod_llist$)A_nat_nat_prod_prod_llist$)
(declare-fun lCons$h (A_nat_nat_prod_prod$ A_nat_nat_prod_prod_llist$ )A_nat_nat_prod_prod_llist$)
(declare-datatypes ()((A_a_nat_prod_prod$ (pair$g (fst$g A$ )(snd$g A_nat_prod$ )))))
...
(declare-datatypes ()((A_nat_prod_a_nat_prod_prod$ (pair$h (fst$h A_nat_prod$ )(snd$h A_nat_prod$ )))))
(declare-sort A_nat_prod_a_nat_prod_prod_llist$ 0)
(declare-fun lNil$j ()A_nat_prod_a_nat_prod_prod_llist$)
(declare-fun lhd$j (A_nat_prod_a_nat_prod_prod_llist$)A_nat_prod_a_nat_prod_prod$)
(declare-fun ltl$j (A_nat_prod_a_nat_prod_prod_llist$)A_nat_prod_a_nat_prod_prod_llist$)
(declare-fun lCons$j (A_nat_prod_a_nat_prod_prod$ A_nat_prod_a_nat_prod_prod_llist$ )A_nat_prod_a_nat_prod_prod_llist$)
...
(declare-datatypes ()((Nat_nat_nat_prod_prod$ (pair$j (fst$j Nat$ )(snd$j Nat_nat_prod$ )))))
...
(declare-datatypes ()((Nat_nat_prod_nat_prod$ (pair$k (fst$k Nat_nat_prod$ )(snd$k Nat$ )))))
...
(declare-datatypes ()((Nat_nat_prod_a_prod$ (pair$l (fst$l Nat_nat_prod$ )(snd$l A$ )))))
