...
(declare-datatypes ()((A_llist_a_prod$ (pair$a (fst$a A_llist$ )(snd$a A$ )))))
...
(declare-datatypes ()((A_a_llist_prod$ (pair$b (fst$b A$ )(snd$b A_llist$ )))))
...
(declare-datatypes ()((A_llist_a_llist_prod$ (pair$c (fst$c A_llist$ )(snd$c A_llist$ )))))
...
(declare-datatypes ()((A_a_a_prod_prod$ (pair$e (fst$e A$ )(snd$e A_a_prod$ )))))
...
(declare-datatypes ()((A_a_llist_a_prod_prod$ (pair$f (fst$f A$ )(snd$f A_llist_a_prod$ )))))
...
(declare-datatypes ()((A_a_a_llist_prod_prod$ (pair$g (fst$g A$ )(snd$g A_a_llist_prod$ )))))
...
(declare-datatypes ()((A_llist_a_a_prod_prod$ (pair$h (fst$h A_llist$ )(snd$h A_a_prod$ )))))
...
(declare-datatypes ()((A_llist_a_prod_a_prod$ (pair$i (fst$i A_llist_a_prod$ )(snd$i A$ )))))
