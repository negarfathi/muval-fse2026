...
(declare-datatypes ()((A_llist_list$ (nil$b )(cons$b (hd$b A_llist$ )(tl$b A_llist_list$ )))(A_llist_llist_list$ (nil$c )(cons$c (hd$c A_llist_llist$ )(tl$c A_llist_llist_list$ )))(Nat_option$ (none$ )(some$ (the$ Nat$ )))(Enat$ (abs_enat$ (rep_enat$ Nat_option$ )))))
