...
(declare-datatypes ()((B_list$ (nil$ )(cons$ (hd$ B$ )(tl$ B_list$ )))(A_b_prod_list$ (nil$a )(cons$a (hd$a A_b_prod$ )(tl$a A_b_prod_list$ )))(A_list$ (nil$b )(cons$b (hd$b A$ )(tl$b A_list$ )))(Nat_list$ (nil$c )(cons$c (hd$c Nat$ )(tl$c Nat_list$ )))))
...
(declare-datatypes ()((A_b_prod_a_prod$ (pair$a (fst$a A_b_prod$ )(snd$a A$ )))(A_b_prod_a_prod_list$ (nil$d )(cons$d (hd$d A_b_prod_a_prod$ )(tl$d A_b_prod_a_prod_list$ )))))
...
(declare-datatypes ()((B_a_b_prod_prod$ (pair$b (fst$b B$ )(snd$b A_b_prod$ )))(B_a_b_prod_prod_list$ (nil$e )(cons$e (hd$e B_a_b_prod_prod$ )(tl$e B_a_b_prod_prod_list$ )))))
...
(declare-datatypes ()((B_b_prod$ (pair$c (fst$c B$ )(snd$c B$ )))(B_b_prod_list$ (nil$f )(cons$f (hd$f B_b_prod$ )(tl$f B_b_prod_list$ )))))
...
(declare-datatypes ()((B_a_prod$ (pair$d (fst$d B$ )(snd$d A$ )))(B_a_prod_list$ (nil$g )(cons$g (hd$g B_a_prod$ )(tl$g B_a_prod_list$ )))))
...
(declare-datatypes ()((A_b_prod_b_prod_list$ (nil$h )(cons$h (hd$h A_b_prod_b_prod$ )(tl$h A_b_prod_b_prod_list$ )))(A_b_prod_a_b_prod_prod$ (pair$f (fst$f A_b_prod$ )(snd$f A_b_prod$ )))))
...
(declare-datatypes ()((A_b_prod_a_b_prod_prod_list$ (nil$i )(cons$i (hd$i A_b_prod_a_b_prod_prod$ )(tl$i A_b_prod_a_b_prod_prod_list$ )))(A_a_prod$ (pair$g (fst$g A$ )(snd$g A$ )))))
...
(declare-datatypes ()((A_a_prod_list$ (nil$j )(cons$j (hd$j A_a_prod$ )(tl$j A_a_prod_list$ )))(B_b_b_prod_prod$ (pair$h (fst$h B$ )(snd$h B_b_prod$ )))))
...
(declare-datatypes ()((B_b_b_prod_prod_list$ (nil$k )(cons$k (hd$k B_b_b_prod_prod$ )(tl$k B_b_b_prod_prod_list$ )))(B_b_a_prod_prod$ (pair$i (fst$i B$ )(snd$i B_a_prod$ )))))
...
(declare-datatypes ()((B_b_a_prod_prod_list$ (nil$l )(cons$l (hd$l B_b_a_prod_prod$ )(tl$l B_b_a_prod_prod_list$ )))(Nat_a_prod$ (pair$j (fst$j Nat$ )(snd$j A$ )))))
...
(declare-datatypes ()((Nat_a_prod_list$ (nil$m )(cons$m (hd$m Nat_a_prod$ )(tl$m Nat_a_prod_list$ )))(Nat_b_prod$ (pair$k (fst$k Nat$ )(snd$k B$ )))))
...
(declare-datatypes ()((Nat_b_prod_list$ (nil$n )(cons$n (hd$n Nat_b_prod$ )(tl$n Nat_b_prod_list$ )))(B_b_prod_a_prod$ (pair$l (fst$l B_b_prod$ )(snd$l A$ )))))
...
(declare-datatypes ()((B_b_prod_a_prod_list$ (nil$o )(cons$o (hd$o B_b_prod_a_prod$ )(tl$o B_b_prod_a_prod_list$ )))(B_a_prod_a_prod$ (pair$m (fst$m B_a_prod$ )(snd$m A$ )))))
