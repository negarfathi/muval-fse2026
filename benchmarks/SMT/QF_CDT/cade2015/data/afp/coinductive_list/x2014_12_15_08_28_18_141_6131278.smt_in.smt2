...
(assert (! (not (= (llexord$ r$ xs$ ys$ )(or (= xs$ ys$ )(exists ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(and (lfinite$ ?v0 )(and (= xs$ (fun_app$ (lappend$ ?v0 )?v1 ))(and (= ys$ (fun_app$ (lappend$ ?v0 )(lCons$ ?v2 ?v3 )))(or (= ?v1 lNil$ )(fun_app$a (fun_app$b r$ (lhd$ ?v1 ))?v2 ))))))))):named a0 ))
...
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A_llist$ ))(! (= (llexord$ ?v0 lNil$ ?v1 )true ):pattern ((llexord$ ?v0 lNil$ ?v1 )))):named a11 ))
...
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A_llist$ )(?v2 A_llist$ ))(= (llexord$ ?v0 ?v1 ?v2 )(or (exists ((?v3 A_llist$ )(?v4 A_llist$ )(?v5 A$ ))(and (= ?v1 (lCons$ ?v5 ?v3 ))(and (= ?v2 (lCons$ ?v5 ?v4 ))(llexord$ ?v0 ?v3 ?v4 ))))(or (exists ((?v3 A$ )(?v4 A$ )(?v5 A_llist$ )(?v6 A_llist$ ))(and (= ?v1 (lCons$ ?v3 ?v5 ))(and (= ?v2 (lCons$ ?v4 ?v6 ))(fun_app$a (fun_app$b ?v0 ?v3 )?v4 ))))(exists ((?v3 A_llist$ ))(and (= ?v1 lNil$ )(= ?v2 ?v3 ))))))):named a14 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A$ )(?v2 A_llist$ )(?v3 A$ )(?v4 A_llist$ ))(! (= (llexord$ ?v0 (lCons$ ?v1 ?v2 )(lCons$ ?v3 ?v4 ))(or (fun_app$a (fun_app$b ?v0 ?v1 )?v3 )(and (= ?v1 ?v3 )(llexord$ ?v0 ?v2 ?v4 )))):pattern ((llexord$ ?v0 (lCons$ ?v1 ?v2 )(lCons$ ?v3 ?v4 ))))):named a15 ))
