...
(assert (! (less$ (enat$ n$ )(llength$ (lconcat$ xss$ ))):named a3 ))
(assert (! (less$ (enat$ (suc$ na$ ))(llength$ (lconcat$ xssa$ ))):named a4 ))
(assert (! (forall ((?v0 A_llist_llist$ ))(=> (less$ (enat$ na$ )(llength$ (lconcat$ ?v0 )))(exists ((?v1 Nat$ )(?v2 Nat$ ))(and (= (lnth$a (lconcat$ ?v0 )na$ )(lnth$a (lnth$ ?v0 ?v1 )?v2 ))(and (less$ (enat$ ?v2 )(llength$ (lnth$ ?v0 ?v1 )))(and (less$ (enat$ ?v1 )(llength$a ?v0 ))(= (enat$ na$ )(plus$ (setsum$ (uua$ ?v0 )(lessThan$ ?v1 ))(enat$ ?v2 ))))))))):named a5 ))
(assert (! (forall ((?v0 Nat_nat_fun$ )(?v1 Nat$ ))(= (setsum$a ?v0 (lessThan$ (suc$ ?v1 )))(fun_app$a (plus$a (setsum$a ?v0 (lessThan$ ?v1 )))(fun_app$a ?v0 ?v1 )))):named a6 ))
(assert (! (forall ((?v0 Nat_enat_fun$ )(?v1 Nat$ ))(= (setsum$ ?v0 (lessThan$ (suc$ ?v1 )))(plus$ (setsum$ ?v0 (lessThan$ ?v1 ))(fun_app$ ?v0 ?v1 )))):named a7 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Enat$ )(?v2 Enat$ ))(= (less$ (plus$ (enat$ ?v0 )?v1 )(plus$ (enat$ ?v0 )?v2 ))(less$ ?v1 ?v2 ))):named a8 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Enat$ )(?v2 Enat$ ))(= (= (plus$ (enat$ ?v0 )?v1 )(plus$ (enat$ ?v0 )?v2 ))(= ?v1 ?v2 ))):named a9 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Nat$ )(?v2 Enat$ ))(= (= (plus$ ?v0 (enat$ ?v1 ))(plus$ ?v2 (enat$ ?v1 )))(= ?v0 ?v2 ))):named a10 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ ))(= (member$ ?v0 (lessThan$a ?v1 ))(less$ ?v0 ?v1 ))):named a11 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(= (member$a ?v0 (lessThan$ ?v1 ))(less$a ?v0 ?v1 ))):named a12 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ )(?v2 Nat$ ))(= (less$a (fun_app$a (plus$a ?v0 )?v1 )(fun_app$a (plus$a ?v2 )?v1 ))(less$a ?v0 ?v2 ))):named a13 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ )(?v2 Nat$ ))(= (less$a (fun_app$a (plus$a ?v0 )?v1 )(fun_app$a (plus$a ?v0 )?v2 ))(less$a ?v1 ?v2 ))):named a14 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ ))(= (= (lessThan$a ?v0 )(lessThan$a ?v1 ))(= ?v0 ?v1 ))):named a15 ))
...
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ )(?v2 Nat$ ))(= (= (fun_app$a (plus$a ?v0 )?v1 )(fun_app$a (plus$a ?v2 )?v1 ))(= ?v0 ?v2 ))):named a21 ))
(check-sat )
;(get-unsat-core )
