...
(assert (! (not (monotone$ lprefix$ lprefix$ uu$ )):named a2 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (fun_app$a (fun_app$b lprefix$ ?v0 )?v1 )(fun_app$a (fun_app$b lprefix$ (ltl$ ?v0 ))(ltl$ ?v1 )))):named a11 ))
(assert (! (forall ((?v0 A$ ))(monotone$ lprefix$ lprefix$ (uua$ ?v0 ))):named a12 ))
...
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A_llist$ ))(= (ltl$ (fun_app$ (lmap$ ?v0 )?v1 ))(fun_app$ (lmap$ ?v0 )(ltl$ ?v1 )))):named a17 ))
(check-sat )
;(get-unsat-core )
