...
(declare-datatypes ()((A_llist_list$ (nil$ )(cons$ (hd$ A_llist$ )(tl$ A_llist_list$ )))(Nat_a_llist_prod$ (pair$ (fst$ Nat$ )(snd$ A_llist$ )))(Nat_nat_a_llist_prod_prod$ (pair$a (fst$a Nat$ )(snd$a Nat_a_llist_prod$ )))(Nat_nat_a_llist_prod_prod_list$ (nil$a )(cons$a (hd$a Nat_nat_a_llist_prod_prod$ )(tl$a Nat_nat_a_llist_prod_prod_list$ )))(Nat_a_llist_prod_list$ (nil$b )(cons$b (hd$b Nat_a_llist_prod$ )(tl$b Nat_a_llist_prod_list$ )))(Nat_option$ (none$ )(some$ (the$ Nat$ )))(Enat$ (abs_enat$ (rep_enat$ Nat_option$ )))))
(declare-sort A_llist_llist$ 0)
(declare-fun lNil$a ()A_llist_llist$)
(declare-fun lhd$a (A_llist_llist$)A_llist$)
(declare-fun ltl$a (A_llist_llist$)A_llist_llist$)
(declare-fun lCons$a (A_llist$ A_llist_llist$ )A_llist_llist$)
(declare-datatypes ()((Nat_nat_nat_a_llist_prod_prod_prod$ (pair$b (fst$b Nat$ )(snd$b Nat_nat_a_llist_prod_prod$ )))(Nat_nat_nat_a_llist_prod_prod_prod_list$ (nil$c )(cons$c (hd$c Nat_nat_nat_a_llist_prod_prod_prod$ )(tl$c Nat_nat_nat_a_llist_prod_prod_prod_list$ )))))
(declare-fun x$ ()A$ )
