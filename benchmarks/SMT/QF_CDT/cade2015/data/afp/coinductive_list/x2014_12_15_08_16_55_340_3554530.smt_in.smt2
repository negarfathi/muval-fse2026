...
(assert (! (not (= (fun_app$ (ldrop$ m$ )xs$ )lNil$ )):named a0 ))
(assert (! (less_eq$ (llength$ xs$ )m$ ):named a1 ))
(assert (! (forall ((?v0 Enat$ ))(! (= (fun_app$ (ldrop$ ?v0 )lNil$ )lNil$ ):pattern ((ldrop$ ?v0 )))):named a2 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ ))(= (= (fun_app$ (ldrop$ ?v0 )?v1 )lNil$ )(less_eq$ (llength$ ?v1 )?v0 ))):named a3 ))
...
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ ))(= (lnull$ (fun_app$ (ldrop$ ?v0 )?v1 ))(less_eq$ (llength$ ?v1 )?v0 ))):named a6 ))
...
(assert (! (forall ((?v0 Enat$ )(?v1 Enat_enat_fun$ )(?v2 Enat$ )(?v3 Enat$ ))(=> (and (= ?v0 (fun_app$d ?v1 ?v2 ))(and (less_eq$ ?v2 ?v3 )(forall ((?v4 Enat$ )(?v5 Enat$ ))(=> (less_eq$ ?v4 ?v5 )(less_eq$ (fun_app$d ?v1 ?v4 )(fun_app$d ?v1 ?v5 ))))))(less_eq$ ?v0 (fun_app$d ?v1 ?v3 )))):named a11 ))
