...
(declare-fun lNil$c ()A_a_b_prod_a_b_prod_prod_prod_llist$)
(declare-fun lhd$c (A_a_b_prod_a_b_prod_prod_prod_llist$)A_a_b_prod_a_b_prod_prod_prod$)
(declare-fun ltl$c (A_a_b_prod_a_b_prod_prod_prod_llist$)A_a_b_prod_a_b_prod_prod_prod_llist$)
(declare-fun lCons$c (A_a_b_prod_a_b_prod_prod_prod$ A_a_b_prod_a_b_prod_prod_prod_llist$ )A_a_b_prod_a_b_prod_prod_prod_llist$)
...
(declare-datatypes ()((Nat_option$ (none$ )(some$ (the$ Nat$ )))(Enat$ (abs_enat$ (rep_enat$ Nat_option$ )))(A_b_prod_a_prod$ (pair$g (fst$g A_b_prod$ )(snd$g A$ )))))
...
(declare-sort A_b_prod_a_b_prod_prod_a_prod_llist$ 0)
(declare-fun lNil$l ()A_b_prod_a_b_prod_prod_a_prod_llist$)
(declare-fun lhd$l (A_b_prod_a_b_prod_prod_a_prod_llist$)A_b_prod_a_b_prod_prod_a_prod$)
(declare-fun ltl$l (A_b_prod_a_b_prod_prod_a_prod_llist$)A_b_prod_a_b_prod_prod_a_prod_llist$)
(declare-fun lCons$l (A_b_prod_a_b_prod_prod_a_prod$ A_b_prod_a_b_prod_prod_a_prod_llist$ )A_b_prod_a_b_prod_prod_a_prod_llist$)
