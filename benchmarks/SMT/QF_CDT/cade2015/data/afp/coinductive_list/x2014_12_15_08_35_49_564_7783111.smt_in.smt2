...
(declare-datatypes ()((A_a_prod_list$ (nil$ )(cons$ (hd$ A_a_prod$ )(tl$ A_a_prod_list$ )))(A_list$ (nil$a )(cons$a (hd$a A$ )(tl$a A_list$ )))(A_a_a_prod_a_prod_prod$ (pair$d (fst$d A$ )(snd$d A_a_prod_a_prod$ )))))
...
(declare-fun fun_app$ (Nat_a_a_prod_fun$ Nat$ )A_a_prod$ )
...
(assert (! (not (= (inf_llist$ (lnth$ xs$ ))xs$ )):named a0 ))
(assert (! (not (lfinite$ xs$ )):named a1 ))
(assert (! (forall ((?v0 Nat_a_a_prod_fun$ )(?v1 Nat_a_a_prod_fun$ ))(= (= (inf_llist$a ?v0 )(inf_llist$a ?v1 ))(= ?v0 ?v1 ))):named a2 ))
(assert (! (forall ((?v0 Nat_a_fun$ )(?v1 Nat_a_fun$ ))(= (= (inf_llist$ ?v0 )(inf_llist$ ?v1 ))(= ?v0 ?v1 ))):named a3 ))
(assert (! (forall ((?v0 Nat_a_a_prod_fun$ )(?v1 Nat$ ))(= (fun_app$ (lnth$a (inf_llist$a ?v0 ))?v1 )(fun_app$ ?v0 ?v1 ))):named a4 ))
(assert (! (forall ((?v0 Nat_a_fun$ )(?v1 Nat$ ))(= (fun_app$a (lnth$ (inf_llist$ ?v0 ))?v1 )(fun_app$a ?v0 ?v1 ))):named a5 ))
(assert (! (forall ((?v0 Nat_a_a_prod_a_a_prod_prod_fun$ ))(not (lfinite$a (inf_llist$b ?v0 )))):named a6 ))
(assert (! (forall ((?v0 Nat_a_a_prod_a_prod_fun$ ))(not (lfinite$b (inf_llist$c ?v0 )))):named a7 ))
(assert (! (forall ((?v0 Nat_a_a_a_prod_prod_fun$ ))(not (lfinite$c (inf_llist$d ?v0 )))):named a8 ))
(assert (! (forall ((?v0 Nat_a_a_prod_fun$ ))(not (lfinite$d (inf_llist$a ?v0 )))):named a9 ))
(assert (! (forall ((?v0 Nat_a_fun$ ))(not (lfinite$ (inf_llist$ ?v0 )))):named a10 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_llist$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(=> (lstrict_prefix$ ?v0 ?v1 )(lfinite$a ?v0 ))):named a11 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$ )(?v1 A_a_prod_a_prod_llist$ ))(=> (lstrict_prefix$a ?v0 ?v1 )(lfinite$b ?v0 ))):named a12 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$ )(?v1 A_a_a_prod_prod_llist$ ))(=> (lstrict_prefix$b ?v0 ?v1 )(lfinite$c ?v0 ))):named a13 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_llist$ ))(=> (lstrict_prefix$c ?v0 ?v1 )(lfinite$d ?v0 ))):named a14 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (lstrict_prefix$d ?v0 ?v1 )(lfinite$ ?v0 ))):named a15 ))
(assert (! (forall ((?v0 Nat_a_a_prod_fun$ )(?v1 A_a_prod_llist$ ))(= (lprefix$ (inf_llist$a ?v0 )?v1 )(= ?v1 (inf_llist$a ?v0 )))):named a16 ))
(assert (! (forall ((?v0 Nat_a_fun$ )(?v1 A_llist$ ))(= (lprefix$a (inf_llist$ ?v0 )?v1 )(= ?v1 (inf_llist$ ?v0 )))):named a17 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(= (lfinite$a (ldropn$ ?v0 ?v1 ))(lfinite$a ?v1 ))):named a18 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$b (ldropn$a ?v0 ?v1 ))(lfinite$b ?v1 ))):named a19 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_a_prod_prod_llist$ ))(= (lfinite$c (ldropn$b ?v0 ?v1 ))(lfinite$c ?v1 ))):named a20 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_llist$ ))(= (lfinite$d (ldropn$c ?v0 ?v1 ))(lfinite$d ?v1 ))):named a21 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_llist$ ))(= (lfinite$ (ldropn$d ?v0 ?v1 ))(lfinite$ ?v1 ))):named a22 ))
(assert (! (= (lfinite$a lNil$b )true ):named a23 ))
(assert (! (= (lfinite$b lNil$c )true ):named a24 ))
(assert (! (= (lfinite$c lNil$d )true ):named a25 ))
(assert (! (= (lfinite$d lNil$a )true ):named a26 ))
(assert (! (= (lfinite$ lNil$ )true ):named a27 ))
(assert (! (forall ((?v0 A_a_prod_list$ )(?v1 Nat_a_a_prod_fun$ ))(not (= (llist_of$ ?v0 )(inf_llist$a ?v1 )))):named a28 ))
(assert (! (forall ((?v0 A_list$ )(?v1 Nat_a_fun$ ))(not (= (llist_of$a ?v0 )(inf_llist$ ?v1 )))):named a29 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (lfinite$d (lzip$ ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$ ?v1 )))):named a30 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_a_prod_llist$ ))(= (lfinite$c (lzip$a ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$d ?v1 )))):named a31 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_llist$ ))(= (lfinite$b (lzip$b ?v0 ?v1 ))(or (lfinite$d ?v0 )(lfinite$ ?v1 )))):named a32 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_llist$ ))(= (lfinite$a (lzip$c ?v0 ?v1 ))(or (lfinite$d ?v0 )(lfinite$d ?v1 )))):named a33 ))
...
(assert (! (forall ((?v0 Nat_a_a_prod_fun$ ))(not (= (inf_llist$a ?v0 )lNil$a ))):named a45 ))
(assert (! (forall ((?v0 Nat_a_fun$ ))(not (= (inf_llist$ ?v0 )lNil$ ))):named a46 ))
...
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(! (= (lfinite$a (lCons$b ?v0 ?v1 ))(lfinite$a ?v1 )):pattern ((lCons$b ?v0 ?v1 )))):named a52 ))
(assert (! (forall ((?v0 A_a_prod_a_prod$ )(?v1 A_a_prod_a_prod_llist$ ))(! (= (lfinite$b (lCons$c ?v0 ?v1 ))(lfinite$b ?v1 )):pattern ((lCons$c ?v0 ?v1 )))):named a53 ))
(assert (! (forall ((?v0 A_a_a_prod_prod$ )(?v1 A_a_a_prod_prod_llist$ ))(! (= (lfinite$c (lCons$d ?v0 ?v1 ))(lfinite$c ?v1 )):pattern ((lCons$d ?v0 ?v1 )))):named a54 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ ))(! (= (lfinite$d (lCons$a ?v0 ?v1 ))(lfinite$d ?v1 )):pattern ((lCons$a ?v0 ?v1 )))):named a55 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(! (= (lfinite$ (lCons$ ?v0 ?v1 ))(lfinite$ ?v1 )):pattern ((lCons$ ?v0 ?v1 )))):named a56 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_llist$ ))(= (lfinite$a (ltl$b ?v0 ))(lfinite$a ?v0 ))):named a57 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$ ))(= (lfinite$b (ltl$c ?v0 ))(lfinite$b ?v0 ))):named a58 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$ ))(= (lfinite$c (ltl$d ?v0 ))(lfinite$c ?v0 ))):named a59 ))
(assert (! (forall ((?v0 A_a_prod_llist$ ))(= (lfinite$d (ltl$a ?v0 ))(lfinite$d ?v0 ))):named a60 ))
(assert (! (forall ((?v0 A_llist$ ))(= (lfinite$ (ltl$ ?v0 ))(lfinite$ ?v0 ))):named a61 ))
(assert (! (forall ((?v0 Nat_a_a_prod_fun$ ))(not (lnull$ (inf_llist$a ?v0 )))):named a62 ))
(assert (! (forall ((?v0 Nat_a_fun$ ))(not (lnull$a (inf_llist$ ?v0 )))):named a63 ))
(assert (! (forall ((?v0 A_llist$ ))(lprefix$a ?v0 ?v0 )):named a64 ))
(assert (! (forall ((?v0 A_llist$ ))(lprefix$a ?v0 ?v0 )):named a65 ))
(check-sat )
;(get-unsat-core )
