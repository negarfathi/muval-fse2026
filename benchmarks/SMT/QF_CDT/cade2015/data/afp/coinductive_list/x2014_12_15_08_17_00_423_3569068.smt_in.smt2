...
(assert (! (not (= (fun_app$ (ldrop$ infinity$ )xs$ )lNil$ )):named a0 ))
(assert (! (forall ((?v0 Enat$ ))(! (= (fun_app$ (ldrop$ ?v0 )lNil$ )lNil$ ):pattern ((ldrop$ ?v0 )))):named a1 ))
(assert (! (forall ((?v0 A$ ))(! (= (fun_app$a (lmember$ ?v0 )lNil$ )false ):pattern ((lmember$ ?v0 )))):named a2 ))
(assert (! (forall ((?v0 A_set$ ))(! (= (fun_app$b (gen_lset$ ?v0 )lNil$ )?v0 ):pattern ((gen_lset$ ?v0 )))):named a3 ))
(assert (! (forall ((?v0 A_bool_fun$ ))(pred_llist$ ?v0 lNil$ )):named a4 ))
(assert (! (ldistinct$ lNil$ ):named a5 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 Enat$ ))(! (=> (lnull$ ?v0 )(= (fun_app$ (ldrop$ ?v1 )?v0 )lNil$ )):pattern ((fun_app$ (ldrop$ ?v1 )?v0 )))):named a6 ))
