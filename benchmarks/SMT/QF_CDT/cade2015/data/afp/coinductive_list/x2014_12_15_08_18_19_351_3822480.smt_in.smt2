...
(declare-fun lNil$a ()Nat_nat_a_fun_fun_llist$)
(declare-fun select$ (Nat_nat_a_fun_fun_llist$)Nat_nat_a_fun_fun$)
(declare-fun selecta$ (Nat_nat_a_fun_fun_llist$)Nat_nat_a_fun_fun_llist$)
(declare-fun lCons$a (Nat_nat_a_fun_fun$ Nat_nat_a_fun_fun_llist$ )Nat_nat_a_fun_fun_llist$)
(declare-fun lNil$b ()Nat_nat_fun_llist$)
(declare-fun selectb$ (Nat_nat_fun_llist$)Nat_nat_fun$)
(declare-fun selectc$ (Nat_nat_fun_llist$)Nat_nat_fun_llist$)
(declare-fun lCons$b (Nat_nat_fun$ Nat_nat_fun_llist$ )Nat_nat_fun_llist$)
(declare-fun lNil$c ()Nat_a_fun_llist$)
(declare-fun selectd$ (Nat_a_fun_llist$)Nat_a_fun$)
(declare-fun selecte$ (Nat_a_fun_llist$)Nat_a_fun_llist$)
