...
(declare-datatypes ()((A_llist_a_llist_prod$ (pair$ (fst$ A_llist$ )(snd$ A_llist$ )))(A_a_prod$ (pair$a (fst$a A$ )(snd$a A$ )))))
...
(declare-datatypes ()((A_llist_a_llist_prod_a_llist_a_llist_prod_prod$ (pair$b (fst$b A_llist_a_llist_prod$ )(snd$b A_llist_a_llist_prod$ )))(A_llist_a_prod$ (pair$c (fst$c A_llist$ )(snd$c A$ )))(A_llist_a_prod_a_llist_a_prod_prod$ (pair$d (fst$d A_llist_a_prod$ )(snd$d A_llist_a_prod$ )))(A_a_llist_prod$ (pair$e (fst$e A$ )(snd$e A_llist$ )))(A_a_llist_prod_a_a_llist_prod_prod$ (pair$f (fst$f A_a_llist_prod$ )(snd$f A_a_llist_prod$ )))(A_a_prod_a_a_prod_prod$ (pair$g (fst$g A_a_prod$ )(snd$g A_a_prod$ )))(A_llist_llist_a_llist_llist_prod$ (pair$h (fst$h A_llist_llist$ )(snd$h A_llist_llist$ )))(A_llist_llist_llist_a_llist_llist_llist_prod$ (pair$i (fst$i A_llist_llist_llist$ )(snd$i A_llist_llist_llist$ )))))
...
(declare-datatypes ()((A_a_prod_llist_a_a_prod_llist_prod$ (pair$n (fst$n A_a_prod_llist$ )(snd$n A_a_prod_llist$ )))(A_a_prod_a_prod$ (pair$o (fst$o A_a_prod$ )(snd$o A$ )))(A_a_prod_a_prod_a_a_prod_a_prod_prod$ (pair$p (fst$p A_a_prod_a_prod$ )(snd$p A_a_prod_a_prod$ )))(A_a_a_prod_prod$ (pair$q (fst$q A$ )(snd$q A_a_prod$ )))(A_a_a_prod_prod_a_a_a_prod_prod_prod$ (pair$r (fst$r A_a_a_prod_prod$ )(snd$r A_a_a_prod_prod$ )))))
