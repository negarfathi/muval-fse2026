...
(declare-datatypes ()((B_c_prod$ (pair$j (fst$j B$ )(snd$j C$ )))(B_b_prod$ (pair$k (fst$k B$ )(snd$k B$ )))(B_a_prod$ (pair$l (fst$l B$ )(snd$l A$ )))(A_c_prod$ (pair$m (fst$m A$ )(snd$m C$ )))(C_a_prod$ (pair$n (fst$n C$ )(snd$n A$ )))))
