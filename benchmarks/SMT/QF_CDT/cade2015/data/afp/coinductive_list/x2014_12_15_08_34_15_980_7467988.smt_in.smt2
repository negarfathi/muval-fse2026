...
(declare-datatypes ()((A_nat_prod$ (pair$ (fst$ A$ )(snd$ Nat$ )))(Nat_option$ (none$ )(some$ (the$ Nat$ )))(Enat$ (abs_enat$ (rep_enat$ Nat_option$ )))(A_a_prod$ (pair$a (fst$a A$ )(snd$a A$ )))(Nat_a_a_prod_prod$ (pair$b (fst$b Nat$ )(snd$b A_a_prod$ )))(Nat_nat_prod$ (pair$c (fst$c Nat$ )(snd$c Nat$ )))(Nat_a_prod$ (pair$d (fst$d Nat$ )(snd$d A$ )))(A_a_nat_prod_prod$ (pair$e (fst$e A$ )(snd$e A_nat_prod$ )))(A_a_a_prod_prod$ (pair$f (fst$f A$ )(snd$f A_a_prod$ )))))
