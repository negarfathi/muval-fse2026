...
(declare-datatypes ()((A_list$ (nil$ )(cons$ (hd$ A$ )(tl$ A_list$ )))(A_a_prod$ (pair$ (fst$ A$ )(snd$ A$ )))(A_a_prod_a_a_prod_prod$ (pair$a (fst$a A_a_prod$ )(snd$a A_a_prod$ )))(A_a_prod_a_a_prod_prod_list$ (nil$a )(cons$a (hd$a A_a_prod_a_a_prod_prod$ )(tl$a A_a_prod_a_a_prod_prod_list$ )))))
...
(declare-datatypes ()((A_a_prod_a_prod$ (pair$b (fst$b A_a_prod$ )(snd$b A$ )))(A_a_prod_a_prod_list$ (nil$b )(cons$b (hd$b A_a_prod_a_prod$ )(tl$b A_a_prod_a_prod_list$ )))))
...
(declare-datatypes ()((A_a_a_prod_prod$ (pair$c (fst$c A$ )(snd$c A_a_prod$ )))(A_a_a_prod_prod_list$ (nil$c )(cons$c (hd$c A_a_a_prod_prod$ )(tl$c A_a_a_prod_prod_list$ )))))
...
(declare-datatypes ()((A_a_a_prod_a_prod_prod_list$ (nil$e )(cons$e (hd$e A_a_a_prod_a_prod_prod$ )(tl$e A_a_a_prod_a_prod_prod_list$ )))(A_a_a_a_prod_prod_prod$ (pair$e (fst$e A$ )(snd$e A_a_a_prod_prod$ )))))
...
(declare-datatypes ()((A_a_a_a_prod_prod_prod_list$ (nil$f )(cons$f (hd$f A_a_a_a_prod_prod_prod$ )(tl$f A_a_a_a_prod_prod_prod_list$ )))(A_a_prod_a_prod_a_prod$ (pair$f (fst$f A_a_prod_a_prod$ )(snd$f A$ )))))
...
(declare-datatypes ()((A_a_prod_a_prod_a_prod_list$ (nil$g )(cons$g (hd$g A_a_prod_a_prod_a_prod$ )(tl$g A_a_prod_a_prod_a_prod_list$ )))(A_a_a_prod_prod_a_prod$ (pair$g (fst$g A_a_a_prod_prod$ )(snd$g A$ )))))
...
(declare-datatypes ()((A_a_a_prod_prod_a_prod_list$ (nil$h )(cons$h (hd$h A_a_a_prod_prod_a_prod$ )(tl$h A_a_a_prod_prod_a_prod_list$ )))(A_a_a_prod_a_a_prod_prod_prod$ (pair$h (fst$h A$ )(snd$h A_a_prod_a_a_prod_prod$ )))))
...
(declare-datatypes ()((A_a_a_prod_a_a_prod_prod_prod_list$ (nil$i )(cons$i (hd$i A_a_a_prod_a_a_prod_prod_prod$ )(tl$i A_a_a_prod_a_a_prod_prod_prod_list$ )))(A_a_prod_a_a_prod_a_prod_prod$ (pair$i (fst$i A_a_prod$ )(snd$i A_a_prod_a_prod$ )))))
