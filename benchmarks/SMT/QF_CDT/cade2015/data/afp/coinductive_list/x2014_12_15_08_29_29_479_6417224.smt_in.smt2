...
(assert (! (not (mcont$ lSup$ lprefix$ lSup$ lprefix$ (lfilter$ p$ ))):named a2 ))
...
(assert (! (forall ((?v0 A_bool_fun$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (ldropWhile$ ?v0 ))):named a10 ))
(assert (! (forall ((?v0 Nat$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (ldropn$ ?v0 ))):named a11 ))
(assert (! (forall ((?v0 Enat$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (ldrop$ ?v0 ))):named a12 ))
...
(assert (! (forall ((?v0 A_bool_fun$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (ltakeWhile$ ?v0 ))):named a15 ))
(assert (! (mcont$ lSup$ lprefix$ lSup$ lprefix$ uua$ ):named a16 ))
(assert (! (forall ((?v0 A_llist$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (lappend$ ?v0 ))):named a17 ))
(assert (! (forall ((?v0 Enat$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (ltake$ ?v0 ))):named a18 ))
(assert (! (forall ((?v0 A_a_fun$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (lmap$ ?v0 ))):named a19 ))
(check-sat )
;(get-unsat-core )
