...
(declare-datatypes ()((A_list$ (nil$ )(cons$ (hd$ A$ )(tl$ A_list$ )))(A_list_a_list_prod$ (pair$ (fst$ A_list$ )(snd$ A_list$ )))(A_a_prod$ (pair$a (fst$a A$ )(snd$a A$ )))(A_list_list$ (nil$a )(cons$a (hd$a A_list$ )(tl$a A_list_list$ )))(A_list_list_list$ (nil$b )(cons$b (hd$b A_list_list$ )(tl$b A_list_list_list$ )))(A_list_list_list_a_list_list_list_prod$ (pair$b (fst$b A_list_list_list$ )(snd$b A_list_list_list$ )))(A_list_list_a_list_list_prod$ (pair$c (fst$c A_list_list$ )(snd$c A_list_list$ )))(A_list_list_list_list$ (nil$c )(cons$c (hd$c A_list_list_list$ )(tl$c A_list_list_list_list$ )))(A_list_list_list_list_a_list_list_list_list_prod$ (pair$d (fst$d A_list_list_list_list$ )(snd$d A_list_list_list_list$ )))))
