...
(assert (! (lfinite$ (fun_app$ (ltake$ (enat$ n$a ))xs$ )):named a2 ))
(assert (! (=> (forall ((?v0 Nat$ ))(=> (= n$ (enat$ ?v0 ))false ))false ):named a3 ))
(assert (! (or (lfinite$ xs$ )(less$ n$ infinity$ )):named a4 ))
(assert (! (less$ n$ infinity$ ):named a5 ))
...
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ )(?v2 A_llist$ ))(= (fun_app$ (ltake$ ?v0 )(fun_app$ (ltake$ ?v1 )?v2 ))(fun_app$ (ltake$ (min$ ?v0 ?v1 ))?v2 ))):named a12 ))
