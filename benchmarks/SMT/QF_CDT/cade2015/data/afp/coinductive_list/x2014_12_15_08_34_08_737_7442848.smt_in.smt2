...
(declare-datatypes ()((A_nat_prod_a_nat_prod_prod$ (pair$b (fst$b A_nat_prod$ )(snd$b A_nat_prod$ )))))
...
(declare-datatypes ()((Nat_a_prod$ (pair$d (fst$d Nat$ )(snd$d A$ )))))
...
(declare-datatypes ()((A_nat_nat_prod_prod$ (pair$e (fst$e A$ )(snd$e Nat_nat_prod$ )))))
(declare-sort A_nat_nat_prod_prod_llist$ 0)
(declare-fun lNil$g ()A_nat_nat_prod_prod_llist$)
(declare-fun lhd$g (A_nat_nat_prod_prod_llist$)A_nat_nat_prod_prod$)
(declare-fun ltl$g (A_nat_nat_prod_prod_llist$)A_nat_nat_prod_prod_llist$)
(declare-fun lCons$g (A_nat_nat_prod_prod$ A_nat_nat_prod_prod_llist$ )A_nat_nat_prod_prod_llist$)
...
(declare-datatypes ()((Nat_a_nat_prod_prod$ (pair$g (fst$g Nat$ )(snd$g A_nat_prod$ )))))
...
(declare-datatypes ()((Nat_nat_prod_nat_prod$ (pair$h (fst$h Nat_nat_prod$ )(snd$h Nat$ )))))
(declare-sort Nat_nat_prod_nat_prod_llist$ 0)
(declare-fun lNil$j ()Nat_nat_prod_nat_prod_llist$)
(declare-fun lhd$j (Nat_nat_prod_nat_prod_llist$)Nat_nat_prod_nat_prod$)
(declare-fun ltl$j (Nat_nat_prod_nat_prod_llist$)Nat_nat_prod_nat_prod_llist$)
(declare-fun lCons$j (Nat_nat_prod_nat_prod$ Nat_nat_prod_nat_prod_llist$ )Nat_nat_prod_nat_prod_llist$)
(declare-datatypes ()((Nat_nat_prod_a_prod$ (pair$i (fst$i Nat_nat_prod$ )(snd$i A$ )))))
(declare-sort Nat_nat_prod_a_prod_llist$ 0)
(declare-fun lNil$k ()Nat_nat_prod_a_prod_llist$)
(declare-fun lhd$k (Nat_nat_prod_a_prod_llist$)Nat_nat_prod_a_prod$)
(declare-fun ltl$k (Nat_nat_prod_a_prod_llist$)Nat_nat_prod_a_prod_llist$)
(declare-fun lCons$k (Nat_nat_prod_a_prod$ Nat_nat_prod_a_prod_llist$ )Nat_nat_prod_a_prod_llist$)
(declare-datatypes ()((A_a_nat_prod_prod$ (pair$j (fst$j A$ )(snd$j A_nat_prod$ )))))
...
(declare-datatypes ()((A_a_nat_prod_a_nat_prod_prod_prod$ (pair$k (fst$k A$ )(snd$k A_nat_prod_a_nat_prod_prod$ )))))
(declare-fun n$ ()Nat$ )
