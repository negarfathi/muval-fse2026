...
(declare-datatypes ()((Nat_option$ (none$ )(some$ (the$ Nat$ )))(Enat$ (abs_enat$ (rep_enat$ Nat_option$ )))(Enat_a_llist_prod$ (pair$ (fst$ Enat$ )(snd$ A_llist$ )))(Enat_enat_prod$ (pair$a (fst$a Enat$ )(snd$a Enat$ )))(A_llist_enat_prod$ (pair$b (fst$b A_llist$ )(snd$b Enat$ )))(A_llist_a_llist_prod$ (pair$c (fst$c A_llist$ )(snd$c A_llist$ )))))
