...
(declare-datatypes ()((A_list$ (nil$ )(cons$ (hd$ A$ )(tl$ A_list$ )))(B_list$ (nil$a )(cons$a (hd$a B$ )(tl$a B_list$ )))(A_b_prod_list$ (nil$b )(cons$b (hd$b A_b_prod$ )(tl$b A_b_prod_list$ )))(A_a_prod$ (pair$a (fst$a A$ )(snd$a A$ )))(A_a_prod_list$ (nil$c )(cons$c (hd$c A_a_prod$ )(tl$c A_a_prod_list$ )))))
...
(declare-datatypes ()((B_a_a_prod_prod$ (pair$b (fst$b B$ )(snd$b A_a_prod$ )))(B_a_a_prod_prod_list$ (nil$d )(cons$d (hd$d B_a_a_prod_prod$ )(tl$d B_a_a_prod_prod_list$ )))(B_b_prod$ (pair$c (fst$c B$ )(snd$c B$ )))(B_b_prod_list$ (nil$e )(cons$e (hd$e B_b_prod$ )(tl$e B_b_prod_list$ )))(B_a_prod$ (pair$d (fst$d B$ )(snd$d A$ )))(B_a_prod_list$ (nil$f )(cons$f (hd$f B_a_prod$ )(tl$f B_a_prod_list$ )))(A_a_b_prod_prod$ (pair$e (fst$e A$ )(snd$e A_b_prod$ )))(A_a_b_prod_prod_list$ (nil$g )(cons$g (hd$g A_a_b_prod_prod$ )(tl$g A_a_b_prod_prod_list$ )))(A_a_a_prod_prod$ (pair$f (fst$f A$ )(snd$f A_a_prod$ )))(A_a_a_prod_prod_list$ (nil$h )(cons$h (hd$h A_a_a_prod_prod$ )(tl$h A_a_a_prod_prod_list$ )))))
...
(declare-fun lNil$d ()B_a_a_prod_prod_llist$)
(declare-fun lhd$d (B_a_a_prod_prod_llist$)B_a_a_prod_prod$)
(declare-fun ltl$d (B_a_a_prod_prod_llist$)B_a_a_prod_prod_llist$)
(declare-fun lCons$d (B_a_a_prod_prod$ B_a_a_prod_prod_llist$ )B_a_a_prod_prod_llist$)
...
(declare-datatypes ()((A_b_prod_a_prod$ (pair$g (fst$g A_b_prod$ )(snd$g A$ )))(A_b_prod_a_prod_list$ (nil$i )(cons$i (hd$i A_b_prod_a_prod$ )(tl$i A_b_prod_a_prod_list$ )))(A_b_prod_b_prod$ (pair$h (fst$h A_b_prod$ )(snd$h B$ )))(A_b_prod_b_prod_list$ (nil$j )(cons$j (hd$j A_b_prod_b_prod$ )(tl$j A_b_prod_b_prod_list$ )))(B_a_b_prod_prod$ (pair$i (fst$i B$ )(snd$i A_b_prod$ )))(B_a_b_prod_prod_list$ (nil$k )(cons$k (hd$k B_a_b_prod_prod$ )(tl$k B_a_b_prod_prod_list$ )))))
(declare-fun x$ ()A$ )
