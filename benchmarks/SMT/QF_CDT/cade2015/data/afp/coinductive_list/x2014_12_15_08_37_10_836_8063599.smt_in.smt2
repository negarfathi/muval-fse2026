...
(declare-fun lNil$h ()Nat_set_llist$)
(declare-fun lhd$f (Nat_set_llist$)Nat_set$)
(declare-fun ltl$f (Nat_set_llist$)Nat_set_llist$)
(declare-fun lCons$h (Nat_set$ Nat_set_llist$ )Nat_set_llist$)
