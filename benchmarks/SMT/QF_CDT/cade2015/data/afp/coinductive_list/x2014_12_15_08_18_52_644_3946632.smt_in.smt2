...
(assert (! (not (= (lnth$ (fun_app$ (lappend$ xs$ )ys$ )na$ )(lnth$ xs$ na$ ))):named a0 ))
...
(assert (! (forall ((?v0 A_llist$ ))(=> (less$ (enat$ na$ )(llength$ ?v0 ))(= (lnth$ (fun_app$ (lappend$ ?v0 )ys$ )na$ )(lnth$ ?v0 na$ )))):named a3 ))
...
(assert (! (=> (forall ((?v0 A$ )(?v1 A_llist$ ))(=> (and (= xsa$ (lCons$ ?v0 ?v1 ))(less$ (enat$ na$ )(llength$ ?v1 )))false ))false ):named a12 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (= lNil$ (fun_app$ (lappend$ ?v0 )?v1 ))(and (= ?v0 lNil$ )(= ?v1 lNil$ )))):named a13 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (= (fun_app$ (lappend$ ?v0 )?v1 )lNil$ )(and (= ?v0 lNil$ )(= ?v1 lNil$ )))):named a14 ))
