...
(declare-datatypes ()((A_a_prod_b_prod$ (pair$h (fst$h A_a_prod$ )(snd$h B$ )))))
(declare-sort A_a_prod_b_prod_llist$ 0)
(declare-fun lNil$j ()A_a_prod_b_prod_llist$)
(declare-fun lhd$j (A_a_prod_b_prod_llist$)A_a_prod_b_prod$)
(declare-fun ltl$j (A_a_prod_b_prod_llist$)A_a_prod_b_prod_llist$)
