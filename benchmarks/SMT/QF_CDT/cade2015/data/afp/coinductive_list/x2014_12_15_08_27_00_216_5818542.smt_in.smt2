...
(declare-datatypes ()((Nat_option$ (none$ )(some$ (the$ Nat$ )))(Enat$ (abs_enat$ (rep_enat$ Nat_option$ )))(B_list$ (nil$ )(cons$ (hd$ B$ )(tl$ B_list$ )))(A_b_prod_list$ (nil$a )(cons$a (hd$a A_b_prod$ )(tl$a A_b_prod_list$ )))(A_list$ (nil$b )(cons$b (hd$b A$ )(tl$b A_list$ )))(A_b_prod_a_prod$ (pair$f (fst$f A_b_prod$ )(snd$f A$ )))))
