...
(assert (! (member$ (pair$ xs$ ys$ )x$ ):named a1 ))
(assert (! (forall ((?v0 A_llist$ ))(lprefix$ lNil$ ?v0 )):named a2 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (member$ (pair$ ?v0 ?v1 )x$ )(or (lnull$ ?v0 )(exists ((?v2 A$ )(?v3 A_llist$ )(?v4 A_llist$ ))(and (= ?v0 (lCons$ ?v2 ?v3 ))(and (= ?v1 (lCons$ ?v2 ?v4 ))(or (member$ (pair$ ?v3 ?v4 )x$ )(lprefix$ ?v3 ?v4 )))))))):named a3 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A$ ))(=> (lprefix$ ?v0 ?v1 )(lprefix$ (lCons$ ?v2 ?v0 )(lCons$ ?v2 ?v1 )))):named a4 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (lprefix$ ?v0 ?v1 )(or (exists ((?v2 A_llist$ ))(and (= ?v0 lNil$ )(= ?v1 ?v2 )))(exists ((?v2 A_llist$ )(?v3 A_llist$ )(?v4 A$ ))(and (= ?v0 (lCons$ ?v4 ?v2 ))(and (= ?v1 (lCons$ ?v4 ?v3 ))(lprefix$ ?v2 ?v3 ))))))):named a5 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A$ )(?v2 A_llist$ ))(=> (= ?v0 (lCons$ ?v1 ?v2 ))(not (lnull$ ?v0 )))):named a15 ))
(assert (! (forall ((?v0 A_llist$ ))(=> (= ?v0 lNil$ )(lnull$ ?v0 ))):named a16 ))
