...
(declare-datatypes ()((B_llist_b_llist_prod$ (pair$ (fst$ B_llist$ )(snd$ B_llist$ )))(Nat_option$ (none$ )(some$ (the$ Nat$ )))(Enat$ (abs_enat$ (rep_enat$ Nat_option$ )))(Enat_enat_prod$ (pair$a (fst$a Enat$ )(snd$a Enat$ )))))
