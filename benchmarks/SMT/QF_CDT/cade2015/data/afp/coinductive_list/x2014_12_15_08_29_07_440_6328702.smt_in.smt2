...
(declare-datatypes ()((A_list$ (nil$ )(cons$ (hd$ A$ )(tl$ A_list$ )))(A_a_prod$ (pair$ (fst$ A$ )(snd$ A$ )))(A_a_prod_list$ (nil$a )(cons$a (hd$a A_a_prod$ )(tl$a A_a_prod_list$ )))))
...
(declare-datatypes ()((A_a_prod_a_a_prod_prod$ (pair$a (fst$a A_a_prod$ )(snd$a A_a_prod$ )))(A_a_prod_a_a_prod_prod_list$ (nil$b )(cons$b (hd$b A_a_prod_a_a_prod_prod$ )(tl$b A_a_prod_a_a_prod_prod_list$ )))))
...
(declare-datatypes ()((A_a_prod_a_prod$ (pair$b (fst$b A_a_prod$ )(snd$b A$ )))(A_a_prod_a_prod_list$ (nil$c )(cons$c (hd$c A_a_prod_a_prod$ )(tl$c A_a_prod_a_prod_list$ )))))
...
(declare-datatypes ()((A_a_a_prod_prod$ (pair$c (fst$c A$ )(snd$c A_a_prod$ )))(A_a_a_prod_prod_list$ (nil$d )(cons$d (hd$d A_a_a_prod_prod$ )(tl$d A_a_a_prod_prod_list$ )))))
