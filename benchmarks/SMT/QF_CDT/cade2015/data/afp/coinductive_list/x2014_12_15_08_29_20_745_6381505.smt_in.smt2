...
(declare-datatypes ()((A_list$ (nil$ )(cons$ (hd$ A$ )(tl$ A_list$ )))(A_list_a_list_prod$ (pair$ (fst$ A_list$ )(snd$ A_list$ )))(A_a_prod$ (pair$a (fst$a A$ )(snd$a A$ )))))
...
(assert (! (not (member$a (pair$ xs$ ys$ )(collect$a (case_prod$a uu$ )))):named a9 ))
(assert (! (or (exists ((?v0 A$ )(?v1 A_list$ ))(= ys$ (append$ xs$ (cons$ ?v0 ?v1 ))))(exists ((?v0 A_list$ )(?v1 A$ )(?v2 A$ ))(and (fun_app$i (fun_app$j r$ ?v1 )?v2 )(and (exists ((?v3 A_list$ ))(= xs$ (append$ ?v0 (cons$ ?v1 ?v3 ))))(exists ((?v3 A_list$ ))(= ys$ (append$ ?v0 (cons$ ?v2 ?v3 )))))))):named a10 ))
...
(assert (! (llexord$ r$ (llist_of$ xs$ )(llist_of$ ys$ )):named a19 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_list$ )(?v2 A_list$ ))(= (= (append$ ?v0 ?v1 )(append$ ?v0 ?v2 ))(= ?v1 ?v2 ))):named a20 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_list$ )(?v2 A_list$ ))(= (= (append$ ?v0 ?v1 )(append$ ?v2 ?v1 ))(= ?v0 ?v2 ))):named a21 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_list$ )(?v2 A_list$ ))(= (append$ (append$ ?v0 ?v1 )?v2 )(append$ ?v0 (append$ ?v1 ?v2 )))):named a22 ))
(assert (! (forall ((?v0 A$ )(?v1 A_list$ )(?v2 A$ )(?v3 A_list$ ))(= (= (cons$ ?v0 ?v1 )(cons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a23 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_list$ )(?v2 A_list$ )(?v3 A_list$ ))(= (= (pair$ ?v0 ?v1 )(pair$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a24 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ )(?v2 A$ )(?v3 A$ ))(= (= (pair$a ?v0 ?v1 )(pair$a ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a25 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_list$ )(?v2 A_list$ )(?v3 A_list$ ))(= (= (pair$ ?v0 ?v1 )(pair$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a26 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ )(?v2 A$ )(?v3 A$ ))(= (= (pair$a ?v0 ?v1 )(pair$a ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a27 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_set_fun$ ))(= (case_prod$b (uuc$ ?v0 ))?v0 )):named a28 ))
(assert (! (forall ((?v0 A_a_prod_a_list_a_list_prod_set_fun$ ))(= (case_prod$c (uud$ ?v0 ))?v0 )):named a29 ))
(assert (! (forall ((?v0 A_list_a_list_prod_a_a_prod_set_fun$ ))(= (case_prod$d (uue$ ?v0 ))?v0 )):named a30 ))
(assert (! (forall ((?v0 A_list_a_list_prod_a_list_a_list_prod_set_fun$ ))(= (case_prod$e (uuf$ ?v0 ))?v0 )):named a31 ))
(assert (! (forall ((?v0 A_list_a_list_prod_bool_fun$ ))(= (case_prod$a (uug$ ?v0 ))?v0 )):named a32 ))
(assert (! (forall ((?v0 A_a_prod_bool_fun$ ))(= (case_prod$ (uuh$ ?v0 ))?v0 )):named a33 ))
(assert (! (forall ((?v0 A_list_a_list_prod$ )(?v1 A_list_a_list_a_list_a_list_prod_set_fun_fun$ )(?v2 A_list$ )(?v3 A_list$ ))(=> (member$a ?v0 (fun_app$c (fun_app$d ?v1 ?v2 )?v3 ))(member$a ?v0 (fun_app$e (case_prod$e ?v1 )(pair$ ?v2 ?v3 ))))):named a34 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_list_a_list_a_a_prod_set_fun_fun$ )(?v2 A_list$ )(?v3 A_list$ ))(=> (member$ ?v0 (fun_app$f (fun_app$g ?v1 ?v2 )?v3 ))(member$ ?v0 (fun_app$h (case_prod$d ?v1 )(pair$ ?v2 ?v3 ))))):named a35 ))
(assert (! (forall ((?v0 A_list_a_list_prod$ )(?v1 A_a_a_list_a_list_prod_set_fun_fun$ )(?v2 A$ )(?v3 A$ ))(=> (member$a ?v0 (fun_app$l (fun_app$m ?v1 ?v2 )?v3 ))(member$a ?v0 (fun_app$n (case_prod$c ?v1 )(pair$a ?v2 ?v3 ))))):named a36 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_a_a_prod_set_fun_fun$ )(?v2 A$ )(?v3 A$ ))(=> (member$ ?v0 (fun_app$o (fun_app$p ?v1 ?v2 )?v3 ))(member$ ?v0 (fun_app$q (case_prod$b ?v1 )(pair$a ?v2 ?v3 ))))):named a37 ))
(assert (! (forall ((?v0 A_list_a_list_prod$ )(?v1 A_list_a_list_prod$ )(?v2 A_list_a_list_a_list_a_list_prod_set_fun_fun$ ))(=> (forall ((?v3 A_list$ )(?v4 A_list$ ))(=> (= ?v0 (pair$ ?v3 ?v4 ))(member$a ?v1 (fun_app$c (fun_app$d ?v2 ?v3 )?v4 ))))(member$a ?v1 (fun_app$e (case_prod$e ?v2 )?v0 )))):named a38 ))
(assert (! (forall ((?v0 A_list_a_list_prod$ )(?v1 A_a_prod$ )(?v2 A_list_a_list_a_a_prod_set_fun_fun$ ))(=> (forall ((?v3 A_list$ )(?v4 A_list$ ))(=> (= ?v0 (pair$ ?v3 ?v4 ))(member$ ?v1 (fun_app$f (fun_app$g ?v2 ?v3 )?v4 ))))(member$ ?v1 (fun_app$h (case_prod$d ?v2 )?v0 )))):named a39 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_list_a_list_prod$ )(?v2 A_a_a_list_a_list_prod_set_fun_fun$ ))(=> (forall ((?v3 A$ )(?v4 A$ ))(=> (= ?v0 (pair$a ?v3 ?v4 ))(member$a ?v1 (fun_app$l (fun_app$m ?v2 ?v3 )?v4 ))))(member$a ?v1 (fun_app$n (case_prod$c ?v2 )?v0 )))):named a40 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod$ )(?v2 A_a_a_a_prod_set_fun_fun$ ))(=> (forall ((?v3 A$ )(?v4 A$ ))(=> (= ?v0 (pair$a ?v3 ?v4 ))(member$ ?v1 (fun_app$o (fun_app$p ?v2 ?v3 )?v4 ))))(member$ ?v1 (fun_app$q (case_prod$b ?v2 )?v0 )))):named a41 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_list$ ))(= (= (llist_of$ ?v0 )(llist_of$ ?v1 ))(= ?v0 ?v1 ))):named a42 ))
(check-sat )
;(get-unsat-core )
