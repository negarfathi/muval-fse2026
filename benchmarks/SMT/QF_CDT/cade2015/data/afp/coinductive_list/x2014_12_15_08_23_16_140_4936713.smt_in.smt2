...
(declare-fun lNil$c ()B_llist_llist_llist_llist$)
(declare-fun lhd$c (B_llist_llist_llist_llist$)B_llist_llist_llist$)
(declare-fun ltl$c (B_llist_llist_llist_llist$)B_llist_llist_llist_llist$)
(declare-fun lCons$c (B_llist_llist_llist$ B_llist_llist_llist_llist$ )B_llist_llist_llist_llist$)
