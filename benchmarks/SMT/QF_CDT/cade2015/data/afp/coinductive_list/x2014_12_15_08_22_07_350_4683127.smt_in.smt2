...
(declare-sort A_b_a_b_prod_prod_prod_llist$ 0)
(declare-fun lNil$n ()A_b_a_b_prod_prod_prod_llist$)
(declare-fun lhd$n (A_b_a_b_prod_prod_prod_llist$)A_b_a_b_prod_prod_prod$)
(declare-fun ltl$n (A_b_a_b_prod_prod_prod_llist$)A_b_a_b_prod_prod_prod_llist$)
(declare-fun lCons$n (A_b_a_b_prod_prod_prod$ A_b_a_b_prod_prod_prod_llist$ )A_b_a_b_prod_prod_prod_llist$)
