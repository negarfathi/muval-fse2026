...
(declare-fun lNil$e ()A_b_prod_llist_llist$)
(declare-fun lhd$e (A_b_prod_llist_llist$)A_b_prod_llist$)
(declare-fun ltl$e (A_b_prod_llist_llist$)A_b_prod_llist_llist$)
(declare-fun lCons$e (A_b_prod_llist$ A_b_prod_llist_llist$ )A_b_prod_llist_llist$)
(declare-datatypes ()((A_b_prod_list$ (nil$ )(cons$ (hd$ A_b_prod$ )(tl$ A_b_prod_list$ )))(A_list$ (nil$a )(cons$a (hd$a A$ )(tl$a A_list$ )))(B_list$ (nil$b )(cons$b (hd$b B$ )(tl$b B_list$ )))(B_b_prod$ (pair$a (fst$a B$ )(snd$a B$ )))))
...
(declare-fun lNil$n ()A_b_b_prod_prod_llist$)
(declare-fun lhd$n (A_b_b_prod_prod_llist$)A_b_b_prod_prod$)
(declare-fun ltl$n (A_b_b_prod_prod_llist$)A_b_b_prod_prod_llist$)
(declare-fun lCons$n (A_b_b_prod_prod$ A_b_b_prod_prod_llist$ )A_b_b_prod_prod_llist$)
(declare-fun n$ ()Nat$ )
