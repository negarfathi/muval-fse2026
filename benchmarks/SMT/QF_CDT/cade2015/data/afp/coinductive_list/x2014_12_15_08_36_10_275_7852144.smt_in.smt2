...
(declare-datatypes ()((B_a_prod_a_prod_list$ (nil$q )(cons$q (hd$q B_a_prod_a_prod$ )(tl$q B_a_prod_a_prod_list$ )))(Nat_option$ (none$ )(some$ (the$ Nat$ )))(Enat$ (abs_enat$ (rep_enat$ Nat_option$ )))))
