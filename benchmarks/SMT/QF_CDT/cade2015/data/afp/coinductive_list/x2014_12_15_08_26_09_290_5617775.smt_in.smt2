...
(assert (! (not (= (ldistinct$ lNil$ )true )):named a0 ))
(assert (! (ldistinct$ lNil$ ):named a1 ))
...
(assert (! (forall ((?v0 Nat$ ))(! (= (fun_app$c (ldropn$ ?v0 )lNil$ )lNil$ ):pattern ((ldropn$ ?v0 )))):named a10 ))
(assert (! (forall ((?v0 A_llist_bool_fun$ )(?v1 A_llist$ ))(=> (forall ((?v2 A_llist$ ))(=> (forall ((?v3 A_llist$ ))(=> (fun_app$ (lstrict_prefix$ ?v3 )?v2 )(fun_app$ ?v0 ?v3 )))(fun_app$ ?v0 ?v2 )))(fun_app$ ?v0 ?v1 ))):named a11 ))
