...
(declare-fun uud$ (Bool )A_llist_bool_fun_a_llist_bool_fun_fun$ )
...
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$ uuc$ ?v0 )(and (not (lnull$ ?v0 ))(not (= (lhd$ ?v0 )x$ )))):pattern ((fun_app$ uuc$ ?v0 )))):named a0 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$ uu$ ?v0 )(not (fun_app$ (fun_app$a lprefix$ (lCons$ x$ xs$ ))?v0 ))):pattern ((fun_app$ uu$ ?v0 )))):named a1 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$ uub$ ?v0 )(not (fun_app$ (fun_app$a lprefix$ xs$ )(ltl$ ?v0 )))):pattern ((fun_app$ uub$ ?v0 )))):named a2 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$ uua$ ?v0 )(not (fun_app$ (fun_app$a lprefix$ xs$ )?v0 ))):pattern ((fun_app$ uua$ ?v0 )))):named a3 ))
(assert (! (forall ((?v0 A_llist_bool_fun$ )(?v1 A_llist_bool_fun$ )(?v2 A_llist$ ))(! (= (fun_app$ (fun_app$b (uue$ ?v0 )?v1 )?v2 )(=> (fun_app$ ?v0 ?v2 )(fun_app$ ?v1 ?v2 ))):pattern ((fun_app$ (fun_app$b (uue$ ?v0 )?v1 )?v2 )))):named a4 ))
(assert (! (forall ((?v0 A_llist_bool_fun$ )(?v1 A_llist_bool_fun$ )(?v2 A_llist$ ))(! (= (fun_app$ (fun_app$b (uuf$ ?v0 )?v1 )?v2 )(=> (fun_app$ ?v1 ?v2 )(fun_app$ ?v0 ?v2 ))):pattern ((fun_app$ (fun_app$b (uuf$ ?v0 )?v1 )?v2 )))):named a5 ))
(assert (! (forall ((?v0 A_llist_bool_fun$ )(?v1 A_llist_bool_fun$ )(?v2 A_llist$ ))(! (= (fun_app$ (fun_app$b (uug$ ?v0 )?v1 )?v2 )(= (fun_app$ ?v0 ?v2 )(fun_app$ ?v1 ?v2 ))):pattern ((fun_app$ (fun_app$b (uug$ ?v0 )?v1 )?v2 )))):named a6 ))
(assert (! (forall ((?v0 Bool )(?v1 A_llist_bool_fun$ )(?v2 A_llist$ ))(! (= (fun_app$ (fun_app$b (uud$ ?v0 )?v1 )?v2 )(=> ?v0 (fun_app$ ?v1 ?v2 ))):pattern ((fun_app$ (fun_app$b (uud$ ?v0 )?v1 )?v2 )))):named a7 ))
(assert (! (not (admissible$ lSup$ lprefix$ uu$ )):named a8 ))
...
(assert (! (admissible$ lSup$ lprefix$ uua$ ):named a13 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(! (= (fun_app$ (fun_app$a lprefix$ (lCons$ ?v0 ?v1 ))(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(fun_app$ (fun_app$a lprefix$ ?v1 )?v3 ))):pattern ((fun_app$ (fun_app$a lprefix$ (lCons$ ?v0 ?v1 ))(lCons$ ?v2 ?v3 ))))):named a14 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A$ ))(=> (fun_app$ (fun_app$a lprefix$ ?v0 )?v1 )(fun_app$ (fun_app$a lprefix$ (lCons$ ?v2 ?v0 ))(lCons$ ?v2 ?v1 )))):named a21 ))
(assert (! (admissible$ lSup$ lprefix$ uub$ ):named a22 ))
(assert (! (admissible$ lSup$ lprefix$ uuc$ ):named a23 ))
(assert (! (forall ((?v0 Bool )(?v1 A_llist_set_a_llist_fun$ )(?v2 A_llist_a_llist_bool_fun_fun$ )(?v3 A_llist_bool_fun$ ))(=> (=> ?v0 (admissible$ ?v1 ?v2 ?v3 ))(admissible$ ?v1 ?v2 (fun_app$b (uud$ ?v0 )?v3 )))):named a24 ))
(assert (! (forall ((?v0 A_llist_set_a_llist_fun$ )(?v1 A_llist_a_llist_bool_fun_fun$ )(?v2 A_llist_bool_fun$ )(?v3 A_llist_bool_fun$ ))(=> (and (admissible$ ?v0 ?v1 (fun_app$b (uue$ ?v2 )?v3 ))(admissible$ ?v0 ?v1 (fun_app$b (uuf$ ?v2 )?v3 )))(admissible$ ?v0 ?v1 (fun_app$b (uug$ ?v2 )?v3 )))):named a25 ))
(check-sat )
;(get-unsat-core )
