...
(declare-datatypes ()((Nat_option$ (none$ )(some$ (the$ Nat$ )))(Enat$ (abs_enat$ (rep_enat$ Nat_option$ )))(B_b_prod$ (pair$ (fst$ B$ )(snd$ B$ )))(B_b_prod_b_b_prod_prod$ (pair$a (fst$a B_b_prod$ )(snd$a B_b_prod$ )))))
