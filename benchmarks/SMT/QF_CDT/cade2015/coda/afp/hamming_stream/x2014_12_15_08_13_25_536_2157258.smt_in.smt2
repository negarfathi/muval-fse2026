...
(assert (! (not (less_eq$ (inf$ (llength$ (lmap$ (times$ (numeral$ (bit0$ one$ )))hamming$ ))(llength$ (lmerge$ (lmap$ (times$ (numeral$ (bit1$ one$ )))hamming$ )(lmap$ (times$ (numeral$ (bit1$ (bit0$ one$ ))))hamming$ ))))(llength$ (lmerge$ (lmap$ (times$ (numeral$ (bit0$ one$ )))hamming$ )(lmerge$ (lmap$ (times$ (numeral$ (bit1$ one$ )))hamming$ )(lmap$ (times$ (numeral$ (bit1$ (bit0$ one$ ))))hamming$ )))))):named a0 ))
(assert (! (lfinite$ hamming$ ):named a1 ))
(assert (! (less_eq$ (llength$ hamming$ )(llength$ (lmerge$ (lmap$ (times$ (numeral$ (bit1$ one$ )))hamming$ )(lmap$ (times$ (numeral$ (bit1$ (bit0$ one$ ))))hamming$ )))):named a2 ))
(assert (! (less_eq$ (inf$ (llength$ (lmap$ (times$ (numeral$ (bit1$ one$ )))hamming$ ))(llength$ (lmap$ (times$ (numeral$ (bit1$ (bit0$ one$ ))))hamming$ )))(llength$ (lmerge$ (lmap$ (times$ (numeral$ (bit1$ one$ )))hamming$ )(lmap$ (times$ (numeral$ (bit1$ (bit0$ one$ ))))hamming$ )))):named a3 ))
(assert (! (forall ((?v0 Nat_llist$ )(?v1 Nat_llist$ ))(less_eq$ (inf$ (llength$ ?v0 )(llength$ ?v1 ))(llength$ (lmerge$ ?v0 ?v1 )))):named a4 ))
...
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ )(?v2 Enat$ ))(= (less_eq$ ?v0 (inf$ ?v1 ?v2 ))(and (less_eq$ ?v0 ?v1 )(less_eq$ ?v0 ?v2 )))):named a16 ))
