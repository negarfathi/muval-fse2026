...
(declare-codatatypes ()((A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(A_set_llist$ (lNil$a )(lCons$a (lhd$a A_set$ )(ltl$a A_set_llist$ )))(A_llist_llist$ (lNil$b )(lCons$b (lhd$b A_llist$ )(ltl$b A_llist_llist$ )))(A_llist_set_llist$ (lNil$c )(lCons$c (lhd$c A_llist_set$ )(ltl$c A_llist_set_llist$ )))(A_set_set_llist$ (lNil$d )(lCons$d (lhd$d A_set_set$ )(ltl$d A_set_set_llist$ )))(A_llist_bool_fun_llist$ (lNil$e )(lCons$e (select$ A_llist_bool_fun$ )(selecta$ A_llist_bool_fun_llist$ )))(A_bool_fun_llist$ (lNil$f )(lCons$f (selectb$ A_bool_fun$ )(selectc$ A_bool_fun_llist$ )))))
