...
(assert (! (less_eq$ ta$ xa$ ):named a3 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (and (less_eq$ l$ ?v0 )(less_eq$ ?v1 ?v0 ))(or (less_eq$ l$ ?v1 )(less_eq$ ?v1 l$ )))):named a4 ))
(assert (! (forall ((?v0 A_llist$ ))(less_eq$ ?v0 ?v0 )):named a5 ))
(assert (! (not (less_eq$ ta$ (lCons$ a$ l$ ))):named a6 ))
(assert (! (less_eq$ (lCons$ a$ l$ )xa$ ):named a7 ))
...
(assert (! (member$ a$ top$ ):named a9 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (and (less_eq$ ?v0 ?v1 )(less_eq$ ?v1 ?v0 ))(= ?v0 ?v1 ))):named a10 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A_llist$ ))(=> (and (less_eq$ ?v0 ?v1 )(less_eq$ ?v1 ?v2 ))(less_eq$ ?v0 ?v2 ))):named a11 ))
...
(assert (! (forall ((?v0 A_llist$ ))(less_eq$ ?v0 ?v0 )):named a15 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (= ?v0 ?v1 )(and (less_eq$ ?v0 ?v1 )(less_eq$ ?v1 ?v0 )))):named a16 ))
(check-sat )
;(get-unsat-core )
