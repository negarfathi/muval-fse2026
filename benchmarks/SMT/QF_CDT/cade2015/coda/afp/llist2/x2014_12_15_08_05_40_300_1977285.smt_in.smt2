...
(declare-codatatypes ()((A_llist_a_llist_prod_llist$ (lNil$a )(lCons$a (lhd$a A_llist_a_llist_prod$ )(ltl$a A_llist_a_llist_prod_llist$ )))(A_llist_a_llist_prod_llist_llist$ (lNil$b )(lCons$b (lhd$b A_llist_a_llist_prod_llist$ )(ltl$b A_llist_a_llist_prod_llist_llist$ )))(A_llist_a_llist_prod_llist_llist_llist$ (lNil$c )(lCons$c (lhd$c A_llist_a_llist_prod_llist_llist$ )(ltl$c A_llist_a_llist_prod_llist_llist_llist$ )))(A_llist_llist$ (lNil$d )(lCons$d (lhd$d A_llist$ )(ltl$d A_llist_llist$ )))(A_llist_llist_llist$ (lNil$e )(lCons$e (lhd$e A_llist_llist$ )(ltl$e A_llist_llist_llist$ )))(A_llist_llist_llist_llist$ (lNil$f )(lCons$f (lhd$f A_llist_llist_llist$ )(ltl$f A_llist_llist_llist_llist$ )))))
(declare-fun a$ ()A$ )
