...
(declare-codatatypes ()((A_set_llist$ (lNil$ )(lCons$ (lhd$ A_set$ )(ltl$ A_set_llist$ )))(A_llist$ (lNil$a )(lCons$a (lhd$a A$ )(ltl$a A_llist$ )))(A_llist_llist$ (lNil$b )(lCons$b (lhd$b A_llist$ )(ltl$b A_llist_llist$ )))(A_set_set_llist$ (lNil$c )(lCons$c (lhd$c A_set_set$ )(ltl$c A_set_set_llist$ )))))
