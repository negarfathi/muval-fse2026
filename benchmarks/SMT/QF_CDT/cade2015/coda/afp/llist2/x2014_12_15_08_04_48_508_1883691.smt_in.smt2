...
(declare-codatatypes ()((A_llist_llist_llist$ (lNil$b )(lCons$b (lhd$b A_llist_llist$ )(ltl$b A_llist_llist_llist$ )))(A_list_llist$ (lNil$c )(lCons$c (lhd$c A_list$ )(ltl$c A_list_llist$ )))(A_llist_list_llist$ (lNil$d )(lCons$d (lhd$d A_llist_list$ )(ltl$d A_llist_list_llist$ )))(A_set_llist$ (lNil$e )(lCons$e (lhd$e A_set$ )(ltl$e A_set_llist$ )))(A_llist_set_llist$ (lNil$f )(lCons$f (lhd$f A_llist_set$ )(ltl$f A_llist_set_llist$ )))(A_llist_llist_llist_llist$ (lNil$g )(lCons$g (lhd$g A_llist_llist_llist$ )(ltl$g A_llist_llist_llist_llist$ )))))
