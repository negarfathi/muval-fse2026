...
(declare-codatatypes ()((B_llist_b_llist_prod_b_llist_b_llist_prod_prod_llist$ (lNil$c )(lCons$c (lhd$c B_llist_b_llist_prod_b_llist_b_llist_prod_prod$ )(ltl$c B_llist_b_llist_prod_b_llist_b_llist_prod_prod_llist$ )))(B_llist_b_llist_prod_llist$ (lNil$d )(lCons$d (lhd$d B_llist_b_llist_prod$ )(ltl$d B_llist_b_llist_prod_llist$ )))(B_llist_b_llist_prod_llist_llist$ (lNil$e )(lCons$e (lhd$e B_llist_b_llist_prod_llist$ )(ltl$e B_llist_b_llist_prod_llist_llist$ )))(B_b_prod_llist$ (lNil$f )(lCons$f (lhd$f B_b_prod$ )(ltl$f B_b_prod_llist$ )))(B_llist_llist$ (lNil$g )(lCons$g (lhd$g B_llist$ )(ltl$g B_llist_llist$ )))))
