...
(assert (! (= (height$ t_2$ )zero$ ):named a5 ))
...
(assert (! (=> (and (consistent$ t_2$ )(and (not (= (sibling$ t_2$ b$ )b$ ))(not (= a$ b$ ))))(= (sibling$ (swapLeaves$ t_2$ w_a$ a$ w_s$ (sibling$ t_2$ b$ ))a$ )b$ )):named a9 ))
(assert (! (=> (and (consistent$ t_1$ )(and (not (= (sibling$ t_1$ b$ )b$ ))(not (= a$ b$ ))))(= (sibling$ (swapLeaves$ t_1$ w_a$ a$ w_s$ (sibling$ t_1$ b$ ))a$ )b$ )):named a10 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_tree$ )(?v2 A_tree$ )(?v3 Nat$ )(?v4 A$ )(?v5 Nat$ )(?v6 A$ ))(! (= (swapLeaves$ (innerNode$ ?v0 ?v1 ?v2 )?v3 ?v4 ?v5 ?v6 )(innerNode$ ?v0 (swapLeaves$ ?v1 ?v3 ?v4 ?v5 ?v6 )(swapLeaves$ ?v2 ?v3 ?v4 ?v5 ?v6 ))):pattern ((swapLeaves$ (innerNode$ ?v0 ?v1 ?v2 )?v3 ?v4 ?v5 ?v6 )))):named a11 ))
(assert (! (forall ((?v0 A_tree$ )(?v1 A$ ))(=> (consistent$ ?v0 )(= (sibling$ ?v0 (sibling$ ?v0 ?v1 ))?v1 ))):named a12 ))
(assert (! (forall ((?v0 A_tree$ )(?v1 Nat$ )(?v2 A$ )(?v3 Nat$ )(?v4 A$ ))(= (height$ (swapLeaves$ ?v0 ?v1 ?v2 ?v3 ?v4 ))(height$ ?v0 ))):named a13 ))
