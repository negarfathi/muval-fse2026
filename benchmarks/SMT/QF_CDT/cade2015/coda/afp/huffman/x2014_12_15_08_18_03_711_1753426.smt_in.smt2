...
(declare-sort A_tree_a_prod_a_tree_a_prod_prod_nat_fun_list$ 0)
(declare-sort A_tree_nat_fun_list$ 0)
...
(declare-fun fst$a (A_tree_a_prod_a_tree_a_prod_prod$)A_tree_a_prod$)
(declare-fun snd$a (A_tree_a_prod_a_tree_a_prod_prod$)A_tree_a_prod$)
(declare-fun pair$a (A_tree_a_prod$ A_tree_a_prod$ )A_tree_a_prod_a_tree_a_prod_prod$)
(declare-fun nil$a ()A_tree_a_prod_a_tree_a_prod_prod_nat_fun_list$)
(declare-fun selecte$ (A_tree_a_prod_a_tree_a_prod_prod_nat_fun_list$)A_tree_a_prod_a_tree_a_prod_prod_nat_fun$)
(declare-fun selectf$ (A_tree_a_prod_a_tree_a_prod_prod_nat_fun_list$)A_tree_a_prod_a_tree_a_prod_prod_nat_fun_list$)
(declare-fun cons$a (A_tree_a_prod_a_tree_a_prod_prod_nat_fun$ A_tree_a_prod_a_tree_a_prod_prod_nat_fun_list$ )A_tree_a_prod_a_tree_a_prod_prod_nat_fun_list$)
(declare-fun nil$b ()A_tree_nat_fun_list$)
(declare-fun selectg$ (A_tree_nat_fun_list$)A_tree_nat_fun$)
(declare-fun selecth$ (A_tree_nat_fun_list$)A_tree_nat_fun_list$)
(declare-fun cons$b (A_tree_nat_fun$ A_tree_nat_fun_list$ )A_tree_nat_fun_list$)
(declare-fun nil$c ()A_nat_fun_list$)
(declare-fun selecti$ (A_nat_fun_list$)A_nat_fun$)
(declare-fun selectj$ (A_nat_fun_list$)A_nat_fun_list$)
(declare-fun cons$c (A_nat_fun$ A_nat_fun_list$ )A_nat_fun_list$)
(declare-fun nil$d ()A_tree_a_prod_list_nat_fun_list$)
(declare-fun selectk$ (A_tree_a_prod_list_nat_fun_list$)A_tree_a_prod_list_nat_fun$)
(declare-fun selectl$ (A_tree_a_prod_list_nat_fun_list$)A_tree_a_prod_list_nat_fun_list$)
(declare-fun cons$d (A_tree_a_prod_list_nat_fun$ A_tree_a_prod_list_nat_fun_list$ )A_tree_a_prod_list_nat_fun_list$)
(declare-fun nil$e ()A_tree_a_prod_set_nat_fun_list$)
(declare-fun selectm$ (A_tree_a_prod_set_nat_fun_list$)A_tree_a_prod_set_nat_fun$)
(declare-fun selectn$ (A_tree_a_prod_set_nat_fun_list$)A_tree_a_prod_set_nat_fun_list$)
(declare-fun cons$e (A_tree_a_prod_set_nat_fun$ A_tree_a_prod_set_nat_fun_list$ )A_tree_a_prod_set_nat_fun_list$)
(declare-fun nil$f ()A_tree_a_prod_nat_fun_list$)
...
(declare-fun cons$f (A_tree_a_prod_nat_fun$ A_tree_a_prod_nat_fun_list$ )A_tree_a_prod_nat_fun_list$)
