...
(assert (! (not (member$ (sibling$ u$ c$ )(alphabet$ u$ ))):named a0 ))
(assert (! (not (= (sibling$ u$ c$ )c$ )):named a1 ))
(assert (! (member$ c$ (alphabet$ u$ )):named a2 ))
(assert (! (optimum$ t$ ):named a3 ))
...
(assert (! (member$ b$ (alphabet$ u$ )):named a9 ))
(assert (! (member$ a$ (alphabet$ u$ )):named a10 ))
(assert (! (= (depth$ u$ c$ )(height$ u$ )):named a11 ))
(assert (! (not (member$ b$ (alphabet$ t$ ))):named a12 ))
...
(assert (! (member$ a$ (alphabet$ t$ )):named a14 ))
...
(assert (! (=> (forall ((?v0 A$ ))(=> (and (member$ ?v0 (alphabet$ u$ ))(= (depth$ u$ ?v0 )(height$ u$ )))false ))false ):named a16 ))
(assert (! (exists ((?v0 A$ ))(and (member$ ?v0 (alphabet$ u$ ))(= (depth$ u$ ?v0 )(height$ u$ )))):named a17 ))
(check-sat )
;(get-unsat-core )
