...
(assert (! (forall ((?v0 A_set$ ))(= (fun_app$ (inf$ ?v0 )bot$ )bot$ )):named a11 ))
(assert (! (forall ((?v0 A_set$ ))(= (fun_app$ (inf$ bot$ )?v0 )bot$ )):named a12 ))
(assert (! (forall ((?v0 A_tree$ )(?v1 A_tree$ ))(=> (and (consistent$ ?v0 )(and (consistent$ ?v1 )(= (fun_app$ (inf$ (alphabet$ ?v0 ))(alphabet$ ?v1 ))bot$ )))(consistent$ (uniteTrees$ ?v0 ?v1 )))):named a13 ))
(assert (! (forall ((?v0 A$ )(?v1 A_set$ )(?v2 A_set$ ))(= (member$ ?v0 (fun_app$ (inf$ ?v1 )?v2 ))(and (member$ ?v0 ?v1 )(member$ ?v0 ?v2 )))):named a14 ))
(assert (! (forall ((?v0 A$ )(?v1 A_set$ )(?v2 A_set$ ))(=> (and (member$ ?v0 ?v1 )(member$ ?v0 ?v2 ))(member$ ?v0 (fun_app$ (inf$ ?v1 )?v2 )))):named a15 ))
...
(assert (! (forall ((?v0 A$ ))(= (member$ ?v0 bot$ )false )):named a22 ))
(check-sat )
;(get-unsat-core )
