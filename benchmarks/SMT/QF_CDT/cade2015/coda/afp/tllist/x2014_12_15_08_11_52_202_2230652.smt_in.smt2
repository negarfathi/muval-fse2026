...
(declare-codatatypes ()((A_llist_a_llist_tllist$ (tNil$z (terminal$z A_llist$ ))(tCons$z (thd$z A_llist$ )(ttl$z A_llist_a_llist_tllist$ )))(A_b_prod_llist_a_b_prod_llist_tllist$ (tNil$aa (terminal$aa A_b_prod_llist$ ))(tCons$aa (thd$aa A_b_prod_llist$ )(ttl$aa A_b_prod_llist_a_b_prod_llist_tllist$ )))(A_llist_a_c_tllist_tllist$ (tNil$ab (terminal$ab A_c_tllist$ ))(tCons$ab (thd$ab A_llist$ )(ttl$ab A_llist_a_c_tllist_tllist$ )))(A_b_prod_llist_a_b_prod_c_d_prod_tllist_tllist$ (tNil$ac (terminal$ac A_b_prod_c_d_prod_tllist$ ))(tCons$ac (thd$ac A_b_prod_llist$ )(ttl$ac A_b_prod_llist_a_b_prod_c_d_prod_tllist_tllist$ )))(A_c_tllist_a_llist_tllist$ (tNil$ad (terminal$ad A_llist$ ))(tCons$ad (thd$ad A_c_tllist$ )(ttl$ad A_c_tllist_a_llist_tllist$ )))(A_b_prod_c_d_prod_tllist_a_b_prod_llist_tllist$ (tNil$ae (terminal$ae A_b_prod_llist$ ))(tCons$ae (thd$ae A_b_prod_c_d_prod_tllist$ )(ttl$ae A_b_prod_c_d_prod_tllist_a_b_prod_llist_tllist$ )))(A_c_tllist_a_c_tllist_tllist$ (tNil$af (terminal$af A_c_tllist$ ))(tCons$af (thd$af A_c_tllist$ )(ttl$af A_c_tllist_a_c_tllist_tllist$ )))(A_b_prod_c_d_prod_tllist_a_b_prod_c_d_prod_tllist_tllist$ (tNil$ag (terminal$ag A_b_prod_c_d_prod_tllist$ ))(tCons$ag (thd$ag A_b_prod_c_d_prod_tllist$ )(ttl$ag A_b_prod_c_d_prod_tllist_a_b_prod_c_d_prod_tllist_tllist$ )))(B_llist_b_llist_tllist$ (tNil$ah (terminal$ah B_llist$ ))(tCons$ah (thd$ah B_llist$ )(ttl$ah B_llist_b_llist_tllist$ )))(B_llist_b_d_tllist_tllist$ (tNil$ai (terminal$ai B_d_tllist$ ))(tCons$ai (thd$ai B_llist$ )(ttl$ai B_llist_b_d_tllist_tllist$ )))(B_d_tllist_b_llist_tllist$ (tNil$aj (terminal$aj B_llist$ ))(tCons$aj (thd$aj B_d_tllist$ )(ttl$aj B_d_tllist_b_llist_tllist$ )))(B_d_tllist_b_d_tllist_tllist$ (tNil$ak (terminal$ak B_d_tllist$ ))(tCons$ak (thd$ak B_d_tllist$ )(ttl$ak B_d_tllist_b_d_tllist_tllist$ )))))
