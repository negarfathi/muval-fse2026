...
(declare-codatatypes ()((B_a_tllist$ (tNil$ (terminal$ A$ ))(tCons$ (thd$ B$ )(ttl$ B_a_tllist$ )))(A_a_tllist$ (tNil$a (terminal$a A$ ))(tCons$a (thd$a A$ )(ttl$a A_a_tllist$ )))(A_b_tllist$ (tNil$b (terminal$b B$ ))(tCons$b (thd$b A$ )(ttl$b A_b_tllist$ )))(B_b_tllist$ (tNil$c (terminal$c B$ ))(tCons$c (thd$c B$ )(ttl$c B_b_tllist$ )))))
(declare-fun x$ ()B$ )
