...
(assert (! (forall ((?v0 B$ )(?v1 A_bool_fun$ )(?v2 B$ ))(! (= (tfilter$a ?v0 ?v1 (tNil$ ?v2 ))(tNil$ ?v2 )):pattern ((tfilter$a ?v0 ?v1 (tNil$ ?v2 ))))):named a7 ))
(assert (! (forall ((?v0 B$ )(?v1 B_a_b_tllist_fun$ ))(! (= (fun_app$g (tappend$ (tNil$ ?v0 ))?v1 )(fun_app$ ?v1 ?v0 )):pattern ((fun_app$g (tappend$ (tNil$ ?v0 ))?v1 )))):named a8 ))
(assert (! (forall ((?v0 A_b_tllist$ ))(! (= (fun_app$g (tappend$ ?v0 )uu$ )?v0 ):pattern ((tappend$ ?v0 )))):named a9 ))
(assert (! (forall ((?v0 B$ ))(member$ ?v0 (set2_tllist$ (tNil$ ?v0 )))):named a10 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 B_b_bool_fun_fun$ )(?v2 B$ )(?v3 B$ ))(! (= (fun_app$a (fun_app$b (tllist_all2$ ?v0 ?v1 )(tNil$ ?v2 ))(tNil$ ?v3 ))(fun_app$c (fun_app$d ?v1 ?v2 )?v3 )):pattern ((fun_app$a (fun_app$b (tllist_all2$ ?v0 ?v1 )(tNil$ ?v2 ))(tNil$ ?v3 ))))):named a11 ))
(assert (! (forall ((?v0 B$ ))(! (= (ttl$ (tNil$ ?v0 ))(tNil$ ?v0 )):pattern ((tNil$ ?v0 )))):named a12 ))
(assert (! (= (tllist_all2$ uua$ uub$ )uuc$ ):named a13 ))
(check-sat )
;(get-unsat-core )
