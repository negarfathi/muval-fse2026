...
(declare-codatatypes ()((A_c_tllist$ (tNil$ (terminal$ C$ ))(tCons$ (thd$ A$ )(ttl$ A_c_tllist$ )))(B_d_tllist$ (tNil$a (terminal$a D$ ))(tCons$a (thd$a B$ )(ttl$a B_d_tllist$ )))(E_f_tllist$ (tNil$b (terminal$b F$ ))(tCons$b (thd$b E$ )(ttl$b E_f_tllist$ )))))
