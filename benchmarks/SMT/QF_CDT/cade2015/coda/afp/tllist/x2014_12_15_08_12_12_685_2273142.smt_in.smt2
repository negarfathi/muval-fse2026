...
(declare-codatatypes ()((A_b_prod_c_d_prod_tllist$ (tNil$ (terminal$ C_d_prod$ ))(tCons$ (thd$ A_b_prod$ )(ttl$ A_b_prod_c_d_prod_tllist$ )))(B_d_tllist$ (tNil$a (terminal$a D$ ))(tCons$a (thd$a B$ )(ttl$a B_d_tllist$ )))(B_llist$ (lNil$b )(lCons$b (lhd$b B$ )(ltl$b B_llist$ )))(A_c_tllist$ (tNil$b (terminal$b C$ ))(tCons$b (thd$b A$ )(ttl$b A_c_tllist$ )))(A_a_tllist$ (tNil$c (terminal$c A$ ))(tCons$c (thd$c A$ )(ttl$c A_a_tllist$ )))(A_b_prod_a_b_prod_tllist$ (tNil$d (terminal$d A_b_prod$ ))(tCons$d (thd$d A_b_prod$ )(ttl$d A_b_prod_a_b_prod_tllist$ )))))
...
(declare-codatatypes ()((A_b_prod_a_b_prod_prod_c_d_prod_c_d_prod_prod_tllist$ (tNil$e (terminal$e C_d_prod_c_d_prod_prod$ ))(tCons$e (thd$e A_b_prod_a_b_prod_prod$ )(ttl$e A_b_prod_a_b_prod_prod_c_d_prod_c_d_prod_prod_tllist$ )))(B_b_tllist$ (tNil$f (terminal$f B$ ))(tCons$f (thd$f B$ )(ttl$f B_b_tllist$ )))(C_a_tllist$ (tNil$g (terminal$g A$ ))(tCons$g (thd$g C$ )(ttl$g C_a_tllist$ )))(D_b_tllist$ (tNil$h (terminal$h B$ ))(tCons$h (thd$h D$ )(ttl$h D_b_tllist$ )))(C_d_prod_a_b_prod_tllist$ (tNil$i (terminal$i A_b_prod$ ))(tCons$i (thd$i C_d_prod$ )(ttl$i C_d_prod_a_b_prod_tllist$ )))(C_c_tllist$ (tNil$j (terminal$j C$ ))(tCons$j (thd$j C$ )(ttl$j C_c_tllist$ )))(D_d_tllist$ (tNil$k (terminal$k D$ ))(tCons$k (thd$k D$ )(ttl$k D_d_tllist$ )))(C_d_prod_c_d_prod_tllist$ (tNil$l (terminal$l C_d_prod$ ))(tCons$l (thd$l C_d_prod$ )(ttl$l C_d_prod_c_d_prod_tllist$ )))))
