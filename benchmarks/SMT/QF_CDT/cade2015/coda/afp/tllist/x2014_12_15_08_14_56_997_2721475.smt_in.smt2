...
(declare-codatatypes ()((A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(A_b_tllist$ (tNil$ (terminal$ B$ ))(tCons$ (thd$ A$ )(ttl$ A_b_tllist$ )))(A_llist_b_tllist$ (tNil$a (terminal$a B$ ))(tCons$a (thd$a A_llist$ )(ttl$a A_llist_b_tllist$ )))))
