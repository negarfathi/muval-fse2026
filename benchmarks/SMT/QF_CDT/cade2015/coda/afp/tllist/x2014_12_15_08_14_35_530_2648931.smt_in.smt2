...
(assert (! (fun_app$m (less$ (enat$ n$ ))(tlength$ ys$ )):named a8 ))
...
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 C_c_bool_fun_fun$ )(?v2 A_c_tllist$ )(?v3 A_c_tllist$ )(?v4 Nat$ ))(=> (and (fun_app$b (fun_app$c (tllist_all2$b ?v0 ?v1 )?v2 )?v3 )(fun_app$m (less$ (enat$ ?v4 ))(tlength$a ?v2 )))(fun_app$j (fun_app$k ?v0 (tnth$ ?v2 ?v4 ))(tnth$ ?v3 ?v4 )))):named a15 ))
(assert (! (forall ((?v0 B_a_bool_fun_fun$ )(?v1 D_c_bool_fun_fun$ )(?v2 B_d_tllist$ )(?v3 A_c_tllist$ )(?v4 Nat$ ))(=> (and (tllist_all2$c ?v0 ?v1 ?v2 ?v3 )(fun_app$m (less$ (enat$ ?v4 ))(tlength$ ?v2 )))(fun_app$j (fun_app$n ?v0 (tnth$a ?v2 ?v4 ))(tnth$ ?v3 ?v4 )))):named a16 ))
(assert (! (forall ((?v0 B_b_bool_fun_fun$ )(?v1 D_d_bool_fun_fun$ )(?v2 B_d_tllist$ )(?v3 B_d_tllist$ )(?v4 Nat$ ))(=> (and (fun_app$ (fun_app$a (tllist_all2$a ?v0 ?v1 )?v2 )?v3 )(fun_app$m (less$ (enat$ ?v4 ))(tlength$ ?v2 )))(fun_app$h (fun_app$i ?v0 (tnth$a ?v2 ?v4 ))(tnth$a ?v3 ?v4 )))):named a17 ))
(assert (! (forall ((?v0 A_b_bool_fun_fun$ )(?v1 C_d_bool_fun_fun$ )(?v2 A_c_tllist$ )(?v3 B_d_tllist$ )(?v4 Nat$ ))(=> (and (tllist_all2$ ?v0 ?v1 ?v2 ?v3 )(fun_app$m (less$ (enat$ ?v4 ))(tlength$a ?v2 )))(fun_app$h (fun_app$l ?v0 (tnth$ ?v2 ?v4 ))(tnth$a ?v3 ?v4 )))):named a18 ))
(assert (! (forall ((?v0 B_a_bool_fun_fun$ )(?v1 D_c_bool_fun_fun$ )(?v2 B_d_tllist$ )(?v3 A_c_tllist$ ))(=> (tllist_all2$c ?v0 ?v1 ?v2 ?v3 )(= (tlength$ ?v2 )(tlength$a ?v3 )))):named a19 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 C_c_bool_fun_fun$ )(?v2 A_c_tllist$ )(?v3 A_c_tllist$ ))(=> (fun_app$b (fun_app$c (tllist_all2$b ?v0 ?v1 )?v2 )?v3 )(= (tlength$a ?v2 )(tlength$a ?v3 )))):named a20 ))
(assert (! (forall ((?v0 B_b_bool_fun_fun$ )(?v1 D_d_bool_fun_fun$ )(?v2 B_d_tllist$ )(?v3 B_d_tllist$ ))(=> (fun_app$ (fun_app$a (tllist_all2$a ?v0 ?v1 )?v2 )?v3 )(= (tlength$ ?v2 )(tlength$ ?v3 )))):named a21 ))
(assert (! (forall ((?v0 A_b_bool_fun_fun$ )(?v1 C_d_bool_fun_fun$ )(?v2 A_c_tllist$ )(?v3 B_d_tllist$ ))(=> (tllist_all2$ ?v0 ?v1 ?v2 ?v3 )(= (tlength$a ?v2 )(tlength$ ?v3 )))):named a22 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(= (= (enat$ ?v0 )(enat$ ?v1 ))(= ?v0 ?v1 ))):named a23 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Nat$ ))(=> (fun_app$m (less$ ?v0 )(enat$ ?v1 ))(exists ((?v2 Nat$ ))(= ?v0 (enat$ ?v2 ))))):named a24 ))
...
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ ))(= (not (= ?v0 ?v1 ))(or (fun_app$m (less$ ?v0 )?v1 )(fun_app$m (less$ ?v1 )?v0 )))):named a26 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(= (not (= ?v0 ?v1 ))(or (fun_app$q (less$a ?v0 )?v1 )(fun_app$q (less$a ?v1 )?v0 )))):named a27 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ ))(= (not (fun_app$m (less$ ?v0 )?v1 ))(or (fun_app$m (less$ ?v1 )?v0 )(= ?v0 ?v1 )))):named a28 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(= (not (fun_app$q (less$a ?v0 )?v1 ))(or (fun_app$q (less$a ?v1 )?v0 )(= ?v0 ?v1 )))):named a29 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ ))(=> (and (=> (fun_app$m (less$ ?v0 )?v1 )false )(and (=> (= ?v0 ?v1 )false )(=> (fun_app$m (less$ ?v1 )?v0 )false )))false )):named a30 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(=> (and (=> (fun_app$q (less$a ?v0 )?v1 )false )(and (=> (= ?v0 ?v1 )false )(=> (fun_app$q (less$a ?v1 )?v0 )false )))false )):named a31 ))
(assert (! (forall ((?v0 Enat_bool_fun$ )(?v1 Enat$ ))(=> (forall ((?v2 Enat$ ))(=> (forall ((?v3 Enat$ ))(=> (fun_app$m (less$ ?v3 )?v2 )(fun_app$m ?v0 ?v3 )))(fun_app$m ?v0 ?v2 )))(fun_app$m ?v0 ?v1 ))):named a32 ))
(assert (! (forall ((?v0 Nat_bool_fun$ )(?v1 Nat$ ))(=> (forall ((?v2 Nat$ ))(=> (forall ((?v3 Nat$ ))(=> (fun_app$q (less$a ?v3 )?v2 )(fun_app$q ?v0 ?v3 )))(fun_app$q ?v0 ?v2 )))(fun_app$q ?v0 ?v1 ))):named a33 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat_enat_fun$ )(?v2 Enat$ )(?v3 Enat$ ))(=> (and (= ?v0 (fun_app$r ?v1 ?v2 ))(and (fun_app$m (less$ ?v2 )?v3 )(forall ((?v4 Enat$ )(?v5 Enat$ ))(=> (fun_app$m (less$ ?v4 )?v5 )(fun_app$m (less$ (fun_app$r ?v1 ?v4 ))(fun_app$r ?v1 ?v5 ))))))(fun_app$m (less$ ?v0 )(fun_app$r ?v1 ?v3 )))):named a34 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Enat_nat_fun$ )(?v2 Enat$ )(?v3 Enat$ ))(=> (and (= ?v0 (fun_app$s ?v1 ?v2 ))(and (fun_app$m (less$ ?v2 )?v3 )(forall ((?v4 Enat$ )(?v5 Enat$ ))(=> (fun_app$m (less$ ?v4 )?v5 )(fun_app$q (less$a (fun_app$s ?v1 ?v4 ))(fun_app$s ?v1 ?v5 ))))))(fun_app$q (less$a ?v0 )(fun_app$s ?v1 ?v3 )))):named a35 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Nat_enat_fun$ )(?v2 Nat$ )(?v3 Nat$ ))(=> (and (= ?v0 (fun_app$t ?v1 ?v2 ))(and (fun_app$q (less$a ?v2 )?v3 )(forall ((?v4 Nat$ )(?v5 Nat$ ))(=> (fun_app$q (less$a ?v4 )?v5 )(fun_app$m (less$ (fun_app$t ?v1 ?v4 ))(fun_app$t ?v1 ?v5 ))))))(fun_app$m (less$ ?v0 )(fun_app$t ?v1 ?v3 )))):named a36 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat_nat_fun$ )(?v2 Nat$ )(?v3 Nat$ ))(=> (and (= ?v0 (fun_app$u ?v1 ?v2 ))(and (fun_app$q (less$a ?v2 )?v3 )(forall ((?v4 Nat$ )(?v5 Nat$ ))(=> (fun_app$q (less$a ?v4 )?v5 )(fun_app$q (less$a (fun_app$u ?v1 ?v4 ))(fun_app$u ?v1 ?v5 ))))))(fun_app$q (less$a ?v0 )(fun_app$u ?v1 ?v3 )))):named a37 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ )(?v2 Enat$ ))(=> (and (= ?v0 ?v1 )(fun_app$m (less$ ?v1 )?v2 ))(fun_app$m (less$ ?v0 )?v2 ))):named a38 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ )(?v2 Nat$ ))(=> (and (= ?v0 ?v1 )(fun_app$q (less$a ?v1 )?v2 ))(fun_app$q (less$a ?v0 )?v2 ))):named a39 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ ))(=> (and (fun_app$m (less$ ?v0 )?v1 )(=> (not false )(fun_app$m (less$ ?v1 )?v0 )))false )):named a40 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(=> (and (fun_app$q (less$a ?v0 )?v1 )(=> (not false )(fun_app$q (less$a ?v1 )?v0 )))false )):named a41 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(! (= (fun_app$m (less$ (enat$ ?v0 ))(enat$ ?v1 ))(fun_app$q (less$a ?v0 )?v1 )):pattern ((fun_app$m (less$ (enat$ ?v0 ))(enat$ ?v1 ))))):named a42 ))
(check-sat )
;(get-unsat-core )
