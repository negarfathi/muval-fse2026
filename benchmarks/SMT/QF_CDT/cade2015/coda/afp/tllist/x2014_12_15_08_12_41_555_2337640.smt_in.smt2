...
(declare-codatatypes ()((B_a_tllist$ (tNil$ (terminal$ A$ ))(tCons$ (thd$ B$ )(ttl$ B_a_tllist$ )))(B_llist$ (lNil$ )(lCons$ (lhd$ B$ )(ltl$ B_llist$ )))(A_llist$ (lNil$a )(lCons$a (lhd$a A$ )(ltl$a A_llist$ )))(A_b_tllist$ (tNil$a (terminal$a B$ ))(tCons$a (thd$a A$ )(ttl$a A_b_tllist$ )))(A_a_tllist$ (tNil$b (terminal$b A$ ))(tCons$b (thd$b A$ )(ttl$b A_a_tllist$ )))(B_b_tllist$ (tNil$c (terminal$c B$ ))(tCons$c (thd$c B$ )(ttl$c B_b_tllist$ )))))
(declare-fun y$ ()A$ )
