...
(declare-codatatypes ()((A_b_tllist$ (tNil$ (terminal$ B$ ))(tCons$ (thd$ A$ )(ttl$ A_b_tllist$ )))(A_c_tllist$ (tNil$a (terminal$a C$ ))(tCons$a (thd$a A$ )(ttl$a A_c_tllist$ )))(A_d_tllist$ (tNil$b (terminal$b D$ ))(tCons$b (thd$b A$ )(ttl$b A_d_tllist$ )))))
