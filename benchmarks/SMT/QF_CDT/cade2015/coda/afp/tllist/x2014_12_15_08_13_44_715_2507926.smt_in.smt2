...
(declare-codatatypes ()((A_c_tllist$ (tNil$ (terminal$ C$ ))(tCons$ (thd$ A$ )(ttl$ A_c_tllist$ )))(B_d_tllist$ (tNil$a (terminal$a D$ ))(tCons$a (thd$a B$ )(ttl$a B_d_tllist$ )))(B_llist$ (lNil$ )(lCons$ (lhd$ B$ )(ltl$ B_llist$ )))(B_llist_llist$ (lNil$a )(lCons$a (lhd$a B_llist$ )(ltl$a B_llist_llist$ )))(B_llist_llist_d_tllist$ (tNil$b (terminal$b D$ ))(tCons$b (thd$b B_llist_llist$ )(ttl$b B_llist_llist_d_tllist$ )))(A_llist$ (lNil$b )(lCons$b (lhd$b A$ )(ltl$b A_llist$ )))(A_llist_llist$ (lNil$c )(lCons$c (lhd$c A_llist$ )(ltl$c A_llist_llist$ )))(A_llist_llist_c_tllist$ (tNil$c (terminal$c C$ ))(tCons$c (thd$c A_llist_llist$ )(ttl$c A_llist_llist_c_tllist$ )))(A_llist_c_tllist$ (tNil$d (terminal$d C$ ))(tCons$d (thd$d A_llist$ )(ttl$d A_llist_c_tllist$ )))(B_llist_d_tllist$ (tNil$e (terminal$e D$ ))(tCons$e (thd$e B_llist$ )(ttl$e B_llist_d_tllist$ )))(B_llist_llist_llist$ (lNil$d )(lCons$d (lhd$d B_llist_llist$ )(ltl$d B_llist_llist_llist$ )))(B_llist_llist_llist_d_tllist$ (tNil$f (terminal$f D$ ))(tCons$f (thd$f B_llist_llist_llist$ )(ttl$f B_llist_llist_llist_d_tllist$ )))(A_llist_llist_llist$ (lNil$e )(lCons$e (lhd$e A_llist_llist$ )(ltl$e A_llist_llist_llist$ )))(A_llist_llist_llist_c_tllist$ (tNil$g (terminal$g C$ ))(tCons$g (thd$g A_llist_llist_llist$ )(ttl$g A_llist_llist_llist_c_tllist$ )))))
(declare-fun b$ ()D$ )
