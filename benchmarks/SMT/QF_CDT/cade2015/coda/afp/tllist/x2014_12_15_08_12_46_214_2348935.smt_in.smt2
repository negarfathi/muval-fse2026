...
(declare-codatatypes ()((D_c_tllist$ (tNil$ (terminal$ C$ ))(tCons$ (thd$ D$ )(ttl$ D_c_tllist$ )))(A_b_tllist$ (tNil$a (terminal$a B$ ))(tCons$a (thd$a A$ )(ttl$a A_b_tllist$ )))(A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(D_b_tllist$ (tNil$b (terminal$b B$ ))(tCons$b (thd$b D$ )(ttl$b D_b_tllist$ )))(A_c_tllist$ (tNil$c (terminal$c C$ ))(tCons$c (thd$c A$ )(ttl$c A_c_tllist$ )))(D_llist$ (lNil$a )(lCons$a (lhd$a D$ )(ltl$a D_llist$ )))))
