...
(declare-codatatypes ()((A_c_tllist$ (tNil$ (terminal$ C$ ))(tCons$ (thd$ A$ )(ttl$ A_c_tllist$ )))(B_d_tllist$ (tNil$a (terminal$a D$ ))(tCons$a (thd$a B$ )(ttl$a B_d_tllist$ )))(A_b_tllist$ (tNil$b (terminal$b B$ ))(tCons$b (thd$b A$ )(ttl$b A_b_tllist$ )))(A_a_tllist$ (tNil$c (terminal$c A$ ))(tCons$c (thd$c A$ )(ttl$c A_a_tllist$ )))(A_d_tllist$ (tNil$d (terminal$d D$ ))(tCons$d (thd$d A$ )(ttl$d A_d_tllist$ )))(B_llist$ (lNil$ )(lCons$ (lhd$ B$ )(ltl$ B_llist$ )))(B_llist_d_tllist$ (tNil$e (terminal$e D$ ))(tCons$e (thd$e B_llist$ )(ttl$e B_llist_d_tllist$ )))(A_c_tllist_a_c_tllist_tllist$ (tNil$f (terminal$f A_c_tllist$ ))(tCons$f (thd$f A_c_tllist$ )(ttl$f A_c_tllist_a_c_tllist_tllist$ )))(B_d_tllist_b_d_tllist_tllist$ (tNil$g (terminal$g B_d_tllist$ ))(tCons$g (thd$g B_d_tllist$ )(ttl$g B_d_tllist_b_d_tllist_tllist$ )))(B_a_tllist$ (tNil$h (terminal$h A$ ))(tCons$h (thd$h B$ )(ttl$h B_a_tllist$ )))(A_llist$ (lNil$a )(lCons$a (lhd$a A$ )(ltl$a A_llist$ )))(A_llist_c_tllist$ (tNil$i (terminal$i C$ ))(tCons$i (thd$i A_llist$ )(ttl$i A_llist_c_tllist$ )))(D_d_tllist$ (tNil$j (terminal$j D$ ))(tCons$j (thd$j D$ )(ttl$j D_d_tllist$ )))(D_c_tllist$ (tNil$k (terminal$k C$ ))(tCons$k (thd$k D$ )(ttl$k D_c_tllist$ )))(D_a_tllist$ (tNil$l (terminal$l A$ ))(tCons$l (thd$l D$ )(ttl$l D_a_tllist$ )))(D_b_tllist$ (tNil$m (terminal$m B$ ))(tCons$m (thd$m D$ )(ttl$m D_b_tllist$ )))))
