...
(declare-codatatypes ()((A_c_tllist$ (tNil$ (terminal$ C$ ))(tCons$ (thd$ A$ )(ttl$ A_c_tllist$ )))(B_d_tllist$ (tNil$a (terminal$a D$ ))(tCons$a (thd$a B$ )(ttl$a B_d_tllist$ )))(B_a_tllist$ (tNil$b (terminal$b A$ ))(tCons$b (thd$b B$ )(ttl$b B_a_tllist$ )))(A_d_tllist$ (tNil$c (terminal$c D$ ))(tCons$c (thd$c A$ )(ttl$c A_d_tllist$ )))(A_b_tllist$ (tNil$d (terminal$d B$ ))(tCons$d (thd$d A$ )(ttl$d A_b_tllist$ )))(A_a_tllist$ (tNil$e (terminal$e A$ ))(tCons$e (thd$e A$ )(ttl$e A_a_tllist$ )))))
...
(declare-codatatypes ()((B_b_tllist$ (tNil$f (terminal$f B$ ))(tCons$f (thd$f B$ )(ttl$f B_b_tllist$ )))(B_c_tllist$ (tNil$g (terminal$g C$ ))(tCons$g (thd$g B$ )(ttl$g B_c_tllist$ )))(D_b_tllist$ (tNil$h (terminal$h B$ ))(tCons$h (thd$h D$ )(ttl$h D_b_tllist$ )))(D_d_tllist$ (tNil$i (terminal$i D$ ))(tCons$i (thd$i D$ )(ttl$i D_d_tllist$ )))(D_a_tllist$ (tNil$j (terminal$j A$ ))(tCons$j (thd$j D$ )(ttl$j D_a_tllist$ )))(D_c_tllist$ (tNil$k (terminal$k C$ ))(tCons$k (thd$k D$ )(ttl$k D_c_tllist$ )))))
