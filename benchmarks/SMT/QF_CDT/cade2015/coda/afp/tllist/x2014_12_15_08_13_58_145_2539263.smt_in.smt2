...
(declare-codatatypes ()((A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(C_llist$ (lNil$a )(lCons$a (lhd$a C$ )(ltl$a C_llist$ )))))
...
(declare-codatatypes ()((A_b_tllist$ (tNil$ (terminal$ B$ ))(tCons$ (thd$ A$ )(ttl$ A_b_tllist$ )))(C_d_tllist$ (tNil$a (terminal$a D$ ))(tCons$a (thd$a C$ )(ttl$a C_d_tllist$ )))(C_llist_d_prod_llist$ (lNil$b )(lCons$b (lhd$b C_llist_d_prod$ )(ltl$b C_llist_d_prod_llist$ )))(C_d_tllist_llist$ (lNil$c )(lCons$c (lhd$c C_d_tllist$ )(ltl$c C_d_tllist_llist$ )))(A_llist_b_prod_llist$ (lNil$d )(lCons$d (lhd$d A_llist_b_prod$ )(ltl$d A_llist_b_prod_llist$ )))(A_b_tllist_llist$ (lNil$e )(lCons$e (lhd$e A_b_tllist$ )(ltl$e A_b_tllist_llist$ )))))
...
(declare-fun fun_app$u (C_llist_d_prod_bool_fun$ C_llist_d_prod$ )Bool )
(declare-fun fun_app$v (A_llist_b_prod_c_llist_d_prod_bool_fun_fun$ A_llist_b_prod$ )C_llist_d_prod_bool_fun$ )
...
(assert (! (not (fun_app$r (fun_app$s (fun_app$t llist_all2$ p$ )a$ )aa$ )):named a11 ))
(assert (! (fun_app$u (fun_app$v xa$ (pair$ a$ b$ ))(pair$a aa$ ba$ )):named a12 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 B$ )(?v2 C_llist$ )(?v3 D$ ))(=> (fun_app$u (fun_app$v xa$ (pair$ ?v0 ?v1 ))(pair$a ?v2 ?v3 ))(and (= (fun_app$w lnull$ ?v0 )(fun_app$r lnull$a ?v2 ))(and (=> (and (fun_app$w lnull$ ?v0 )(fun_app$r lnull$a ?v2 ))(r$ ?v1 ?v3 ))(=> (and (not (fun_app$w lnull$ ?v0 ))(not (fun_app$r lnull$a ?v2 )))(and (fun_app$l (fun_app$x p$ (lhd$ ?v0 ))(lhd$a ?v2 ))(or (fun_app$u (fun_app$v xa$ (pair$ (ltl$ ?v0 )?v1 ))(pair$a (ltl$a ?v2 )?v3 ))(and (fun_app$r (fun_app$s (fun_app$t llist_all2$ p$ )(ltl$ ?v0 ))(ltl$a ?v2 ))(=> (fun_app$w lfinite$ ?v0 )(r$ ?v1 ?v3 )))))))))):named a13 ))
...
(assert (! (forall ((?v0 A_llist$ ))(=> (and (=> (fun_app$w lnull$ ?v0 )false )(=> (not (fun_app$w lnull$ ?v0 ))false ))false )):named a18 ))
...
(assert (! (forall ((?v0 A_llist$ ))(= (fun_app$w lfinite$ (ltl$ ?v0 ))(fun_app$w lfinite$ ?v0 ))):named a22 ))
(assert (! (forall ((?v0 C_llist$ ))(= (fun_app$r lfinite$c (ltl$a ?v0 ))(fun_app$r lfinite$c ?v0 ))):named a23 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A_llist$ )(?v2 A_llist$ ))(= (fun_app$w (fun_app$ac (fun_app$ad llist_all2$a ?v0 )?v1 )?v2 )(and (= (fun_app$w lnull$ ?v1 )(fun_app$w lnull$ ?v2 ))(=> (and (not (fun_app$w lnull$ ?v1 ))(not (fun_app$w lnull$ ?v2 )))(and (fun_app$p (fun_app$q ?v0 (lhd$ ?v1 ))(lhd$ ?v2 ))(fun_app$w (fun_app$ac (fun_app$ad llist_all2$a ?v0 )(ltl$ ?v1 ))(ltl$ ?v2 ))))))):named a24 ))
(assert (! (forall ((?v0 C_a_bool_fun_fun$ )(?v1 C_llist$ )(?v2 A_llist$ ))(= (fun_app$w (fun_app$ae (fun_app$af llist_all2$b ?v0 )?v1 )?v2 )(and (= (fun_app$r lnull$a ?v1 )(fun_app$w lnull$ ?v2 ))(=> (and (not (fun_app$r lnull$a ?v1 ))(not (fun_app$w lnull$ ?v2 )))(and (fun_app$p (fun_app$ag ?v0 (lhd$a ?v1 ))(lhd$ ?v2 ))(fun_app$w (fun_app$ae (fun_app$af llist_all2$b ?v0 )(ltl$a ?v1 ))(ltl$ ?v2 ))))))):named a25 ))
...
(assert (! (forall ((?v0 A_c_bool_fun_fun$ )(?v1 A_llist$ )(?v2 C_llist$ ))(= (fun_app$r (fun_app$s (fun_app$t llist_all2$ ?v0 )?v1 )?v2 )(and (= (fun_app$w lnull$ ?v1 )(fun_app$r lnull$a ?v2 ))(=> (and (not (fun_app$w lnull$ ?v1 ))(not (fun_app$r lnull$a ?v2 )))(and (fun_app$l (fun_app$x ?v0 (lhd$ ?v1 ))(lhd$a ?v2 ))(fun_app$r (fun_app$s (fun_app$t llist_all2$ ?v0 )(ltl$ ?v1 ))(ltl$a ?v2 ))))))):named a27 ))
...
(assert (! (forall ((?v0 A_c_llist_d_prod_bool_fun_fun$ )(?v1 A_llist$ )(?v2 C_llist_d_prod_llist$ ))(= (fun_app$aa (fun_app$an (fun_app$ao llist_all2$e ?v0 )?v1 )?v2 )(and (= (fun_app$w lnull$ ?v1 )(fun_app$aa lnull$b ?v2 ))(=> (and (not (fun_app$w lnull$ ?v1 ))(not (fun_app$aa lnull$b ?v2 )))(and (fun_app$u (fun_app$ap ?v0 (lhd$ ?v1 ))(lhd$b ?v2 ))(fun_app$aa (fun_app$an (fun_app$ao llist_all2$e ?v0 )(ltl$ ?v1 ))(ltl$b ?v2 ))))))):named a29 ))
(assert (! (forall ((?v0 C_d_tllist_a_bool_fun_fun$ )(?v1 C_d_tllist_llist$ )(?v2 A_llist$ ))(= (fun_app$w (fun_app$aq (llist_all2$f ?v0 )?v1 )?v2 )(and (= (fun_app$ab lnull$c ?v1 )(fun_app$w lnull$ ?v2 ))(=> (and (not (fun_app$ab lnull$c ?v1 ))(not (fun_app$w lnull$ ?v2 )))(and (fun_app$p (fun_app$ar ?v0 (lhd$c ?v1 ))(lhd$ ?v2 ))(fun_app$w (fun_app$aq (llist_all2$f ?v0 )(ltl$c ?v1 ))(ltl$ ?v2 ))))))):named a30 ))
...
(assert (! (forall ((?v0 A_c_d_tllist_bool_fun_fun$ )(?v1 A_llist$ )(?v2 C_d_tllist_llist$ ))(= (fun_app$ab (llist_all2$h ?v0 ?v1 )?v2 )(and (= (fun_app$w lnull$ ?v1 )(fun_app$ab lnull$c ?v2 ))(=> (and (not (fun_app$w lnull$ ?v1 ))(not (fun_app$ab lnull$c ?v2 )))(and (fun_app$al (fun_app$au ?v0 (lhd$ ?v1 ))(lhd$c ?v2 ))(fun_app$ab (llist_all2$h ?v0 (ltl$ ?v1 ))(ltl$c ?v2 ))))))):named a32 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A_a_bool_fun_fun$ ))(=> (and (= (fun_app$w lnull$ ?v0 )(fun_app$w lnull$ ?v1 ))(=> (and (not (fun_app$w lnull$ ?v0 ))(not (fun_app$w lnull$ ?v1 )))(and (fun_app$p (fun_app$q ?v2 (lhd$ ?v0 ))(lhd$ ?v1 ))(fun_app$w (fun_app$ac (fun_app$ad llist_all2$a ?v2 )(ltl$ ?v0 ))(ltl$ ?v1 )))))(fun_app$w (fun_app$ac (fun_app$ad llist_all2$a ?v2 )?v0 )?v1 ))):named a34 ))
(assert (! (forall ((?v0 C_llist$ )(?v1 A_llist$ )(?v2 C_a_bool_fun_fun$ ))(=> (and (= (fun_app$r lnull$a ?v0 )(fun_app$w lnull$ ?v1 ))(=> (and (not (fun_app$r lnull$a ?v0 ))(not (fun_app$w lnull$ ?v1 )))(and (fun_app$p (fun_app$ag ?v2 (lhd$a ?v0 ))(lhd$ ?v1 ))(fun_app$w (fun_app$ae (fun_app$af llist_all2$b ?v2 )(ltl$a ?v0 ))(ltl$ ?v1 )))))(fun_app$w (fun_app$ae (fun_app$af llist_all2$b ?v2 )?v0 )?v1 ))):named a35 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 C_llist_d_prod_llist$ )(?v2 A_c_llist_d_prod_bool_fun_fun$ ))(=> (and (= (fun_app$w lnull$ ?v0 )(fun_app$aa lnull$b ?v1 ))(=> (and (not (fun_app$w lnull$ ?v0 ))(not (fun_app$aa lnull$b ?v1 )))(and (fun_app$u (fun_app$ap ?v2 (lhd$ ?v0 ))(lhd$b ?v1 ))(fun_app$aa (fun_app$an (fun_app$ao llist_all2$e ?v2 )(ltl$ ?v0 ))(ltl$b ?v1 )))))(fun_app$aa (fun_app$an (fun_app$ao llist_all2$e ?v2 )?v0 )?v1 ))):named a39 ))
(assert (! (forall ((?v0 C_d_tllist_llist$ )(?v1 A_llist$ )(?v2 C_d_tllist_a_bool_fun_fun$ ))(=> (and (= (fun_app$ab lnull$c ?v0 )(fun_app$w lnull$ ?v1 ))(=> (and (not (fun_app$ab lnull$c ?v0 ))(not (fun_app$w lnull$ ?v1 )))(and (fun_app$p (fun_app$ar ?v2 (lhd$c ?v0 ))(lhd$ ?v1 ))(fun_app$w (fun_app$aq (llist_all2$f ?v2 )(ltl$c ?v0 ))(ltl$ ?v1 )))))(fun_app$w (fun_app$aq (llist_all2$f ?v2 )?v0 )?v1 ))):named a40 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 C_d_tllist_llist$ )(?v2 A_c_d_tllist_bool_fun_fun$ ))(=> (and (= (fun_app$w lnull$ ?v0 )(fun_app$ab lnull$c ?v1 ))(=> (and (not (fun_app$w lnull$ ?v0 ))(not (fun_app$ab lnull$c ?v1 )))(and (fun_app$al (fun_app$au ?v2 (lhd$ ?v0 ))(lhd$c ?v1 ))(fun_app$ab (llist_all2$h ?v2 (ltl$ ?v0 ))(ltl$c ?v1 )))))(fun_app$ab (llist_all2$h ?v2 ?v0 )?v1 ))):named a42 ))
...
(assert (! (forall ((?v0 A_llist_a_llist_bool_fun_fun$ )(?v1 A_llist$ )(?v2 A_llist$ )(?v3 A_a_bool_fun_fun$ ))(=> (and (fun_app$w (fun_app$ac ?v0 ?v1 )?v2 )(and (forall ((?v4 A_llist$ )(?v5 A_llist$ ))(=> (fun_app$w (fun_app$ac ?v0 ?v4 )?v5 )(= (fun_app$w lnull$ ?v4 )(fun_app$w lnull$ ?v5 ))))(forall ((?v4 A_llist$ )(?v5 A_llist$ ))(=> (and (fun_app$w (fun_app$ac ?v0 ?v4 )?v5 )(and (not (fun_app$w lnull$ ?v4 ))(not (fun_app$w lnull$ ?v5 ))))(and (fun_app$p (fun_app$q ?v3 (lhd$ ?v4 ))(lhd$ ?v5 ))(or (fun_app$w (fun_app$ac ?v0 (ltl$ ?v4 ))(ltl$ ?v5 ))(fun_app$w (fun_app$ac (fun_app$ad llist_all2$a ?v3 )(ltl$ ?v4 ))(ltl$ ?v5 ))))))))(fun_app$w (fun_app$ac (fun_app$ad llist_all2$a ?v3 )?v1 )?v2 ))):named a44 ))
(assert (! (forall ((?v0 C_llist_a_llist_bool_fun_fun$ )(?v1 C_llist$ )(?v2 A_llist$ )(?v3 C_a_bool_fun_fun$ ))(=> (and (fun_app$w (fun_app$ae ?v0 ?v1 )?v2 )(and (forall ((?v4 C_llist$ )(?v5 A_llist$ ))(=> (fun_app$w (fun_app$ae ?v0 ?v4 )?v5 )(= (fun_app$r lnull$a ?v4 )(fun_app$w lnull$ ?v5 ))))(forall ((?v4 C_llist$ )(?v5 A_llist$ ))(=> (and (fun_app$w (fun_app$ae ?v0 ?v4 )?v5 )(and (not (fun_app$r lnull$a ?v4 ))(not (fun_app$w lnull$ ?v5 ))))(and (fun_app$p (fun_app$ag ?v3 (lhd$a ?v4 ))(lhd$ ?v5 ))(or (fun_app$w (fun_app$ae ?v0 (ltl$a ?v4 ))(ltl$ ?v5 ))(fun_app$w (fun_app$ae (fun_app$af llist_all2$b ?v3 )(ltl$a ?v4 ))(ltl$ ?v5 ))))))))(fun_app$w (fun_app$ae (fun_app$af llist_all2$b ?v3 )?v1 )?v2 ))):named a45 ))
...
(assert (! (forall ((?v0 A_llist_c_llist_d_prod_llist_bool_fun_fun$ )(?v1 A_llist$ )(?v2 C_llist_d_prod_llist$ )(?v3 A_c_llist_d_prod_bool_fun_fun$ ))(=> (and (fun_app$aa (fun_app$an ?v0 ?v1 )?v2 )(and (forall ((?v4 A_llist$ )(?v5 C_llist_d_prod_llist$ ))(=> (fun_app$aa (fun_app$an ?v0 ?v4 )?v5 )(= (fun_app$w lnull$ ?v4 )(fun_app$aa lnull$b ?v5 ))))(forall ((?v4 A_llist$ )(?v5 C_llist_d_prod_llist$ ))(=> (and (fun_app$aa (fun_app$an ?v0 ?v4 )?v5 )(and (not (fun_app$w lnull$ ?v4 ))(not (fun_app$aa lnull$b ?v5 ))))(and (fun_app$u (fun_app$ap ?v3 (lhd$ ?v4 ))(lhd$b ?v5 ))(or (fun_app$aa (fun_app$an ?v0 (ltl$ ?v4 ))(ltl$b ?v5 ))(fun_app$aa (fun_app$an (fun_app$ao llist_all2$e ?v3 )(ltl$ ?v4 ))(ltl$b ?v5 ))))))))(fun_app$aa (fun_app$an (fun_app$ao llist_all2$e ?v3 )?v1 )?v2 ))):named a49 ))
(assert (! (forall ((?v0 C_d_tllist_llist_a_llist_bool_fun_fun$ )(?v1 C_d_tllist_llist$ )(?v2 A_llist$ )(?v3 C_d_tllist_a_bool_fun_fun$ ))(=> (and (fun_app$w (fun_app$aq ?v0 ?v1 )?v2 )(and (forall ((?v4 C_d_tllist_llist$ )(?v5 A_llist$ ))(=> (fun_app$w (fun_app$aq ?v0 ?v4 )?v5 )(= (fun_app$ab lnull$c ?v4 )(fun_app$w lnull$ ?v5 ))))(forall ((?v4 C_d_tllist_llist$ )(?v5 A_llist$ ))(=> (and (fun_app$w (fun_app$aq ?v0 ?v4 )?v5 )(and (not (fun_app$ab lnull$c ?v4 ))(not (fun_app$w lnull$ ?v5 ))))(and (fun_app$p (fun_app$ar ?v3 (lhd$c ?v4 ))(lhd$ ?v5 ))(or (fun_app$w (fun_app$aq ?v0 (ltl$c ?v4 ))(ltl$ ?v5 ))(fun_app$w (fun_app$aq (llist_all2$f ?v3 )(ltl$c ?v4 ))(ltl$ ?v5 ))))))))(fun_app$w (fun_app$aq (llist_all2$f ?v3 )?v1 )?v2 ))):named a50 ))
...
(assert (! (forall ((?v0 C_llist_d_prod_llist_a_llist_bool_fun_fun$ )(?v1 C_llist_d_prod_llist$ )(?v2 A_llist$ )(?v3 C_llist_d_prod_a_bool_fun_fun$ ))(=> (and (fun_app$w (fun_app$ay ?v0 ?v1 )?v2 )(forall ((?v4 C_llist_d_prod_llist$ )(?v5 A_llist$ ))(=> (fun_app$w (fun_app$ay ?v0 ?v4 )?v5 )(and (= (fun_app$aa lnull$b ?v4 )(fun_app$w lnull$ ?v5 ))(=> (and (not (fun_app$aa lnull$b ?v4 ))(not (fun_app$w lnull$ ?v5 )))(and (fun_app$p (fun_app$az ?v3 (lhd$b ?v4 ))(lhd$ ?v5 ))(fun_app$w (fun_app$ay ?v0 (ltl$b ?v4 ))(ltl$ ?v5 ))))))))(fun_app$w (fun_app$ay (llist_all2$j ?v3 )?v1 )?v2 ))):named a55 ))
(assert (! (forall ((?v0 C_llist_c_llist_d_prod_llist_bool_fun_fun$ )(?v1 C_llist$ )(?v2 C_llist_d_prod_llist$ )(?v3 C_c_llist_d_prod_bool_fun_fun$ ))(=> (and (fun_app$aa (fun_app$ba ?v0 ?v1 )?v2 )(forall ((?v4 C_llist$ )(?v5 C_llist_d_prod_llist$ ))(=> (fun_app$aa (fun_app$ba ?v0 ?v4 )?v5 )(and (= (fun_app$r lnull$a ?v4 )(fun_app$aa lnull$b ?v5 ))(=> (and (not (fun_app$r lnull$a ?v4 ))(not (fun_app$aa lnull$b ?v5 )))(and (fun_app$u (fun_app$bb ?v3 (lhd$a ?v4 ))(lhd$b ?v5 ))(fun_app$aa (fun_app$ba ?v0 (ltl$a ?v4 ))(ltl$b ?v5 ))))))))(fun_app$aa (llist_all2$k ?v3 ?v1 )?v2 ))):named a56 ))
(assert (! (forall ((?v0 A_llist_c_d_tllist_llist_bool_fun_fun$ )(?v1 A_llist$ )(?v2 C_d_tllist_llist$ )(?v3 A_c_d_tllist_bool_fun_fun$ ))(=> (and (fun_app$ab (fun_app$ax ?v0 ?v1 )?v2 )(forall ((?v4 A_llist$ )(?v5 C_d_tllist_llist$ ))(=> (fun_app$ab (fun_app$ax ?v0 ?v4 )?v5 )(and (= (fun_app$w lnull$ ?v4 )(fun_app$ab lnull$c ?v5 ))(=> (and (not (fun_app$w lnull$ ?v4 ))(not (fun_app$ab lnull$c ?v5 )))(and (fun_app$al (fun_app$au ?v3 (lhd$ ?v4 ))(lhd$c ?v5 ))(fun_app$ab (fun_app$ax ?v0 (ltl$ ?v4 ))(ltl$c ?v5 ))))))))(fun_app$ab (llist_all2$h ?v3 ?v1 )?v2 ))):named a57 ))
...
(assert (! (forall ((?v0 A_llist_c_llist_d_prod_llist_bool_fun_fun$ )(?v1 A_llist$ )(?v2 C_llist_d_prod_llist$ )(?v3 A_c_llist_d_prod_bool_fun_fun$ ))(=> (and (fun_app$aa (fun_app$an ?v0 ?v1 )?v2 )(forall ((?v4 A_llist$ )(?v5 C_llist_d_prod_llist$ ))(=> (fun_app$aa (fun_app$an ?v0 ?v4 )?v5 )(and (= (fun_app$w lnull$ ?v4 )(fun_app$aa lnull$b ?v5 ))(=> (and (not (fun_app$w lnull$ ?v4 ))(not (fun_app$aa lnull$b ?v5 )))(and (fun_app$u (fun_app$ap ?v3 (lhd$ ?v4 ))(lhd$b ?v5 ))(fun_app$aa (fun_app$an ?v0 (ltl$ ?v4 ))(ltl$b ?v5 ))))))))(fun_app$aa (fun_app$an (fun_app$ao llist_all2$e ?v3 )?v1 )?v2 ))):named a59 ))
(assert (! (forall ((?v0 A_llist_a_llist_bool_fun_fun$ )(?v1 A_llist$ )(?v2 A_llist$ )(?v3 A_a_bool_fun_fun$ ))(=> (and (fun_app$w (fun_app$ac ?v0 ?v1 )?v2 )(forall ((?v4 A_llist$ )(?v5 A_llist$ ))(=> (fun_app$w (fun_app$ac ?v0 ?v4 )?v5 )(and (= (fun_app$w lnull$ ?v4 )(fun_app$w lnull$ ?v5 ))(=> (and (not (fun_app$w lnull$ ?v4 ))(not (fun_app$w lnull$ ?v5 )))(and (fun_app$p (fun_app$q ?v3 (lhd$ ?v4 ))(lhd$ ?v5 ))(fun_app$w (fun_app$ac ?v0 (ltl$ ?v4 ))(ltl$ ?v5 ))))))))(fun_app$w (fun_app$ac (fun_app$ad llist_all2$a ?v3 )?v1 )?v2 ))):named a60 ))
(assert (! (forall ((?v0 C_llist_a_llist_bool_fun_fun$ )(?v1 C_llist$ )(?v2 A_llist$ )(?v3 C_a_bool_fun_fun$ ))(=> (and (fun_app$w (fun_app$ae ?v0 ?v1 )?v2 )(forall ((?v4 C_llist$ )(?v5 A_llist$ ))(=> (fun_app$w (fun_app$ae ?v0 ?v4 )?v5 )(and (= (fun_app$r lnull$a ?v4 )(fun_app$w lnull$ ?v5 ))(=> (and (not (fun_app$r lnull$a ?v4 ))(not (fun_app$w lnull$ ?v5 )))(and (fun_app$p (fun_app$ag ?v3 (lhd$a ?v4 ))(lhd$ ?v5 ))(fun_app$w (fun_app$ae ?v0 (ltl$a ?v4 ))(ltl$ ?v5 ))))))))(fun_app$w (fun_app$ae (fun_app$af llist_all2$b ?v3 )?v1 )?v2 ))):named a61 ))
...
(assert (! (forall ((?v0 A_llist_c_llist_bool_fun_fun$ )(?v1 A_llist$ )(?v2 C_llist$ )(?v3 A_c_bool_fun_fun$ ))(=> (and (fun_app$r (fun_app$s ?v0 ?v1 )?v2 )(forall ((?v4 A_llist$ )(?v5 C_llist$ ))(=> (fun_app$r (fun_app$s ?v0 ?v4 )?v5 )(and (= (fun_app$w lnull$ ?v4 )(fun_app$r lnull$a ?v5 ))(=> (and (not (fun_app$w lnull$ ?v4 ))(not (fun_app$r lnull$a ?v5 )))(and (fun_app$l (fun_app$x ?v3 (lhd$ ?v4 ))(lhd$a ?v5 ))(fun_app$r (fun_app$s ?v0 (ltl$ ?v4 ))(ltl$a ?v5 ))))))))(fun_app$r (fun_app$s (fun_app$t llist_all2$ ?v3 )?v1 )?v2 ))):named a63 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (and (= (fun_app$w lnull$ ?v0 )(fun_app$w lnull$ ?v1 ))(=> (and (not (fun_app$w lnull$ ?v0 ))(not (fun_app$w lnull$ ?v1 )))(and (= (lhd$ ?v0 )(lhd$ ?v1 ))(= (ltl$ ?v0 )(ltl$ ?v1 )))))(= ?v0 ?v1 ))):named a64 ))
...
(assert (! (forall ((?v0 A_llist_a_llist_bool_fun_fun$ )(?v1 A_llist$ )(?v2 A_llist$ ))(=> (and (fun_app$w (fun_app$ac ?v0 ?v1 )?v2 )(forall ((?v3 A_llist$ )(?v4 A_llist$ ))(=> (fun_app$w (fun_app$ac ?v0 ?v3 )?v4 )(and (= (fun_app$w lnull$ ?v3 )(fun_app$w lnull$ ?v4 ))(=> (and (not (fun_app$w lnull$ ?v3 ))(not (fun_app$w lnull$ ?v4 )))(and (= (lhd$ ?v3 )(lhd$ ?v4 ))(or (fun_app$w (fun_app$ac ?v0 (ltl$ ?v3 ))(ltl$ ?v4 ))(= (ltl$ ?v3 )(ltl$ ?v4 )))))))))(= ?v1 ?v2 ))):named a66 ))
...
(assert (! (forall ((?v0 A_llist_a_llist_bool_fun_fun$ )(?v1 A_llist$ )(?v2 A_llist$ ))(=> (and (fun_app$w (fun_app$ac ?v0 ?v1 )?v2 )(forall ((?v3 A_llist$ )(?v4 A_llist$ ))(=> (fun_app$w (fun_app$ac ?v0 ?v3 )?v4 )(and (= (fun_app$w lnull$ ?v3 )(fun_app$w lnull$ ?v4 ))(=> (and (not (fun_app$w lnull$ ?v3 ))(not (fun_app$w lnull$ ?v4 )))(and (= (lhd$ ?v3 )(lhd$ ?v4 ))(fun_app$w (fun_app$ac ?v0 (ltl$ ?v3 ))(ltl$ ?v4 ))))))))(= ?v1 ?v2 ))):named a68 ))
...
(assert (! (forall ((?v0 A_c_llist_d_prod_bool_fun_fun$ )(?v1 A_llist$ )(?v2 C_llist_d_prod_llist$ ))(=> (and (fun_app$aa (fun_app$an (fun_app$ao llist_all2$e ?v0 )?v1 )?v2 )(not (fun_app$aa lnull$b ?v2 )))(fun_app$u (fun_app$ap ?v0 (lhd$ ?v1 ))(lhd$b ?v2 )))):named a79 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A_llist$ )(?v2 A_llist$ ))(=> (and (fun_app$w (fun_app$ac (fun_app$ad llist_all2$a ?v0 )?v1 )?v2 )(not (fun_app$w lnull$ ?v2 )))(fun_app$p (fun_app$q ?v0 (lhd$ ?v1 ))(lhd$ ?v2 )))):named a80 ))
(assert (! (forall ((?v0 C_a_bool_fun_fun$ )(?v1 C_llist$ )(?v2 A_llist$ ))(=> (and (fun_app$w (fun_app$ae (fun_app$af llist_all2$b ?v0 )?v1 )?v2 )(not (fun_app$w lnull$ ?v2 )))(fun_app$p (fun_app$ag ?v0 (lhd$a ?v1 ))(lhd$ ?v2 )))):named a81 ))
...
(assert (! (forall ((?v0 A_c_llist_d_prod_bool_fun_fun$ )(?v1 A_llist$ )(?v2 C_llist_d_prod_llist$ ))(=> (and (fun_app$aa (fun_app$an (fun_app$ao llist_all2$e ?v0 )?v1 )?v2 )(not (fun_app$w lnull$ ?v1 )))(fun_app$u (fun_app$ap ?v0 (lhd$ ?v1 ))(lhd$b ?v2 )))):named a85 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A_llist$ )(?v2 A_llist$ ))(=> (and (fun_app$w (fun_app$ac (fun_app$ad llist_all2$a ?v0 )?v1 )?v2 )(not (fun_app$w lnull$ ?v1 )))(fun_app$p (fun_app$q ?v0 (lhd$ ?v1 ))(lhd$ ?v2 )))):named a86 ))
(assert (! (forall ((?v0 C_a_bool_fun_fun$ )(?v1 C_llist$ )(?v2 A_llist$ ))(=> (and (fun_app$w (fun_app$ae (fun_app$af llist_all2$b ?v0 )?v1 )?v2 )(not (fun_app$r lnull$a ?v1 )))(fun_app$p (fun_app$ag ?v0 (lhd$a ?v1 ))(lhd$ ?v2 )))):named a87 ))
...
(assert (! (forall ((?v0 A_c_bool_fun_fun$ )(?v1 A_llist$ )(?v2 C_llist$ ))(=> (and (fun_app$r (fun_app$s (fun_app$t llist_all2$ ?v0 )?v1 )?v2 )(not (fun_app$w lnull$ ?v1 )))(fun_app$l (fun_app$x ?v0 (lhd$ ?v1 ))(lhd$a ?v2 )))):named a89 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist_bool_fun$ ))(=> (and (fun_app$w lfinite$ ?v0 )(and (forall ((?v2 A_llist$ ))(=> (fun_app$w lnull$ ?v2 )(fun_app$w ?v1 ?v2 )))(forall ((?v2 A_llist$ ))(=> (and (fun_app$w lfinite$ ?v2 )(and (not (fun_app$w lnull$ ?v2 ))(fun_app$w ?v1 (ltl$ ?v2 ))))(fun_app$w ?v1 ?v2 )))))(fun_app$w ?v1 ?v0 ))):named a90 ))
...
(assert (! (forall ((?v0 A_llist$ ))(=> (and (=> (fun_app$w lnull$ ?v0 )false )(=> (not (fun_app$w lnull$ ?v0 ))false ))false )):named a129 ))
(assert (! (forall ((?v0 C_llist$ ))(=> (and (=> (fun_app$r lnull$a ?v0 )false )(=> (not (fun_app$r lnull$a ?v0 ))false ))false )):named a130 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (and (=> (and (fun_app$w lnull$ ?v0 )(fun_app$w lnull$ ?v1 ))false )(=> (or (not (fun_app$w lnull$ ?v0 ))(not (fun_app$w lnull$ ?v1 )))false ))false )):named a131 ))
...
(assert (! (forall ((?v0 A_llist_set$ ))(=> (and (=> (forall ((?v1 A_llist$ ))(=> (member$ ?v1 ?v0 )(fun_app$w lnull$ ?v1 )))false )(=> (not (forall ((?v1 A_llist$ ))(=> (member$ ?v1 ?v0 )(fun_app$w lnull$ ?v1 ))))false ))false )):named a133 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (and (=> (or (fun_app$w lnull$ ?v0 )(fun_app$w lnull$ ?v1 ))false )(=> (and (not (fun_app$w lnull$ ?v0 ))(not (fun_app$w lnull$ ?v1 )))false ))false )):named a135 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 C_llist$ ))(=> (and (=> (or (fun_app$w lnull$ ?v0 )(fun_app$r lnull$a ?v1 ))false )(=> (and (not (fun_app$w lnull$ ?v0 ))(not (fun_app$r lnull$a ?v1 )))false ))false )):named a136 ))
(assert (! (forall ((?v0 C_llist$ )(?v1 A_llist$ ))(=> (and (=> (or (fun_app$r lnull$a ?v0 )(fun_app$w lnull$ ?v1 ))false )(=> (and (not (fun_app$r lnull$a ?v0 ))(not (fun_app$w lnull$ ?v1 )))false ))false )):named a137 ))
