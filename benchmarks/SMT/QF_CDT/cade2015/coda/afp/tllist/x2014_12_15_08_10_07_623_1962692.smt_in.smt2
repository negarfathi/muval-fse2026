...
(declare-codatatypes ()((A_b_tllist$ (tNil$ (terminal$ B$ ))(tCons$ (thd$ A$ )(ttl$ A_b_tllist$ )))(C_d_tllist$ (tNil$a (terminal$a D$ ))(tCons$a (thd$a C$ )(ttl$a C_d_tllist$ )))(B_b_tllist$ (tNil$b (terminal$b B$ ))(tCons$b (thd$b B$ )(ttl$b B_b_tllist$ )))(B_a_tllist$ (tNil$c (terminal$c A$ ))(tCons$c (thd$c B$ )(ttl$c B_a_tllist$ )))(A_d_tllist$ (tNil$d (terminal$d D$ ))(tCons$d (thd$d A$ )(ttl$d A_d_tllist$ )))(A_c_tllist$ (tNil$e (terminal$e C$ ))(tCons$e (thd$e A$ )(ttl$e A_c_tllist$ )))(A_a_tllist$ (tNil$f (terminal$f A$ ))(tCons$f (thd$f A$ )(ttl$f A_a_tllist$ )))(C_c_tllist$ (tNil$g (terminal$g C$ ))(tCons$g (thd$g C$ )(ttl$g C_c_tllist$ )))(C_a_tllist$ (tNil$h (terminal$h A$ ))(tCons$h (thd$h C$ )(ttl$h C_a_tllist$ )))(B_c_tllist$ (tNil$i (terminal$i C$ ))(tCons$i (thd$i B$ )(ttl$i B_c_tllist$ )))(B_d_tllist$ (tNil$j (terminal$j D$ ))(tCons$j (thd$j B$ )(ttl$j B_d_tllist$ )))(C_b_tllist$ (tNil$k (terminal$k B$ ))(tCons$k (thd$k C$ )(ttl$k C_b_tllist$ )))(D_a_tllist$ (tNil$l (terminal$l A$ ))(tCons$l (thd$l D$ )(ttl$l D_a_tllist$ )))(D_c_tllist$ (tNil$m (terminal$m C$ ))(tCons$m (thd$m D$ )(ttl$m D_c_tllist$ )))(D_d_tllist$ (tNil$n (terminal$n D$ ))(tCons$n (thd$n D$ )(ttl$n D_d_tllist$ )))(D_b_tllist$ (tNil$o (terminal$o B$ ))(tCons$o (thd$o D$ )(ttl$o D_b_tllist$ )))))
