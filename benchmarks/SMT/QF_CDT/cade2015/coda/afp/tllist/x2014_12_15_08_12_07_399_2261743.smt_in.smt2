...
(declare-codatatypes ()((A_b_prod_llist$ (lNil$a )(lCons$a (lhd$a A_b_prod$ )(ltl$a A_b_prod_llist$ )))(B_llist$ (lNil$b )(lCons$b (lhd$b B$ )(ltl$b B_llist$ )))(B_d_tllist$ (tNil$ (terminal$ D$ ))(tCons$ (thd$ B$ )(ttl$ B_d_tllist$ )))))
(declare-sort C_d_prod$ 0)
(declare-fun fst$a (C_d_prod$)C$)
(declare-fun snd$a (C_d_prod$)D$)
(declare-fun pair$a (C$ D$ )C_d_prod$)
(declare-codatatypes ()((A_b_prod_c_d_prod_tllist$ (tNil$a (terminal$a C_d_prod$ ))(tCons$a (thd$a A_b_prod$ )(ttl$a A_b_prod_c_d_prod_tllist$ )))(A_c_tllist$ (tNil$b (terminal$b C$ ))(tCons$b (thd$b A$ )(ttl$b A_c_tllist$ )))(C_d_prod_llist$ (lNil$c )(lCons$c (lhd$c C_d_prod$ )(ltl$c C_d_prod_llist$ )))(D_llist$ (lNil$d )(lCons$d (lhd$d D$ )(ltl$d D_llist$ )))))
(declare-sort C_d_prod_llist_d_llist_prod$ 0)
(declare-fun fst$b (C_d_prod_llist_d_llist_prod$)C_d_prod_llist$)
(declare-fun snd$b (C_d_prod_llist_d_llist_prod$)D_llist$)
(declare-fun pair$b (C_d_prod_llist$ D_llist$ )C_d_prod_llist_d_llist_prod$)
(declare-codatatypes ()((C_llist$ (lNil$e )(lCons$e (lhd$e C$ )(ltl$e C_llist$ )))))
(declare-sort C_d_prod_llist_c_llist_prod$ 0)
(declare-sort A_b_prod_llist_b_llist_prod$ 0)
(declare-sort A_b_prod_llist_a_llist_prod$ 0)
(declare-fun fst$c (C_d_prod_llist_c_llist_prod$)C_d_prod_llist$)
(declare-fun snd$c (C_d_prod_llist_c_llist_prod$)C_llist$)
(declare-fun pair$c (C_d_prod_llist$ C_llist$ )C_d_prod_llist_c_llist_prod$)
(declare-fun fst$d (A_b_prod_llist_b_llist_prod$)A_b_prod_llist$)
(declare-fun snd$d (A_b_prod_llist_b_llist_prod$)B_llist$)
(declare-fun pair$d (A_b_prod_llist$ B_llist$ )A_b_prod_llist_b_llist_prod$)
(declare-fun fst$e (A_b_prod_llist_a_llist_prod$)A_b_prod_llist$)
(declare-fun snd$e (A_b_prod_llist_a_llist_prod$)A_llist$)
(declare-fun pair$e (A_b_prod_llist$ A_llist$ )A_b_prod_llist_a_llist_prod$)
(declare-codatatypes ()((A_b_prod_llist_llist$ (lNil$f )(lCons$f (lhd$f A_b_prod_llist$ )(ltl$f A_b_prod_llist_llist$ )))(A_b_prod_llist_a_llist_prod_llist$ (lNil$g )(lCons$g (lhd$g A_b_prod_llist_a_llist_prod$ )(ltl$g A_b_prod_llist_a_llist_prod_llist$ )))))
(declare-sort A_b_prod_llist_a_llist_prod_llist_a_b_prod_llist_llist_prod$ 0)
(declare-fun fst$f (A_b_prod_llist_a_llist_prod_llist_a_b_prod_llist_llist_prod$)A_b_prod_llist_a_llist_prod_llist$)
(declare-fun snd$f (A_b_prod_llist_a_llist_prod_llist_a_b_prod_llist_llist_prod$)A_b_prod_llist_llist$)
(declare-fun pair$f (A_b_prod_llist_a_llist_prod_llist$ A_b_prod_llist_llist$ )A_b_prod_llist_a_llist_prod_llist_a_b_prod_llist_llist_prod$)
(declare-codatatypes ()((A_llist_llist$ (lNil$h )(lCons$h (lhd$h A_llist$ )(ltl$h A_llist_llist$ )))))
(declare-sort A_b_prod_llist_a_llist_prod_llist_a_llist_llist_prod$ 0)
(declare-fun fst$g (A_b_prod_llist_a_llist_prod_llist_a_llist_llist_prod$)A_b_prod_llist_a_llist_prod_llist$)
(declare-fun snd$g (A_b_prod_llist_a_llist_prod_llist_a_llist_llist_prod$)A_llist_llist$)
(declare-fun pair$g (A_b_prod_llist_a_llist_prod_llist$ A_llist_llist$ )A_b_prod_llist_a_llist_prod_llist_a_llist_llist_prod$)
(declare-codatatypes ()((A_b_prod_llist_b_llist_prod_llist$ (lNil$i )(lCons$i (lhd$i A_b_prod_llist_b_llist_prod$ )(ltl$i A_b_prod_llist_b_llist_prod_llist$ )))))
(declare-sort A_b_prod_llist_b_llist_prod_llist_a_b_prod_llist_llist_prod$ 0)
(declare-fun fst$h (A_b_prod_llist_b_llist_prod_llist_a_b_prod_llist_llist_prod$)A_b_prod_llist_b_llist_prod_llist$)
(declare-fun snd$h (A_b_prod_llist_b_llist_prod_llist_a_b_prod_llist_llist_prod$)A_b_prod_llist_llist$)
(declare-fun pair$h (A_b_prod_llist_b_llist_prod_llist$ A_b_prod_llist_llist$ )A_b_prod_llist_b_llist_prod_llist_a_b_prod_llist_llist_prod$)
(declare-codatatypes ()((B_llist_llist$ (lNil$j )(lCons$j (lhd$j B_llist$ )(ltl$j B_llist_llist$ )))))
(declare-sort A_b_prod_llist_b_llist_prod_llist_b_llist_llist_prod$ 0)
(declare-fun fst$i (A_b_prod_llist_b_llist_prod_llist_b_llist_llist_prod$)A_b_prod_llist_b_llist_prod_llist$)
(declare-fun snd$i (A_b_prod_llist_b_llist_prod_llist_b_llist_llist_prod$)B_llist_llist$)
(declare-fun pair$i (A_b_prod_llist_b_llist_prod_llist$ B_llist_llist$ )A_b_prod_llist_b_llist_prod_llist_b_llist_llist_prod$)
(declare-codatatypes ()((C_d_prod_llist_llist$ (lNil$k )(lCons$k (lhd$k C_d_prod_llist$ )(ltl$k C_d_prod_llist_llist$ )))(D_llist_llist$ (lNil$l )(lCons$l (lhd$l D_llist$ )(ltl$l D_llist_llist$ )))(C_d_prod_llist_d_llist_prod_llist$ (lNil$m )(lCons$m (lhd$m C_d_prod_llist_d_llist_prod$ )(ltl$m C_d_prod_llist_d_llist_prod_llist$ )))(C_llist_llist$ (lNil$n )(lCons$n (lhd$n C_llist$ )(ltl$n C_llist_llist$ )))(C_d_prod_llist_c_llist_prod_llist$ (lNil$o )(lCons$o (lhd$o C_d_prod_llist_c_llist_prod$ )(ltl$o C_d_prod_llist_c_llist_prod_llist$ )))))
