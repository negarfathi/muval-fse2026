...
(declare-codatatypes ()((A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(A_b_tllist$ (tNil$ (terminal$ B$ ))(tCons$ (thd$ A$ )(ttl$ A_b_tllist$ )))(C_d_tllist$ (tNil$a (terminal$a D$ ))(tCons$a (thd$a C$ )(ttl$a C_d_tllist$ )))(C_llist$ (lNil$a )(lCons$a (lhd$a C$ )(ltl$a C_llist$ )))(B_llist$ (lNil$b )(lCons$b (lhd$b B$ )(ltl$b B_llist$ )))(B_a_tllist$ (tNil$b (terminal$b A$ ))(tCons$b (thd$b B$ )(ttl$b B_a_tllist$ )))(A_a_tllist$ (tNil$c (terminal$c A$ ))(tCons$c (thd$c A$ )(ttl$c A_a_tllist$ )))(A_c_tllist$ (tNil$d (terminal$d C$ ))(tCons$d (thd$d A$ )(ttl$d A_c_tllist$ )))(A_d_tllist$ (tNil$e (terminal$e D$ ))(tCons$e (thd$e A$ )(ttl$e A_d_tllist$ )))(B_b_tllist$ (tNil$f (terminal$f B$ ))(tCons$f (thd$f B$ )(ttl$f B_b_tllist$ )))(B_c_tllist$ (tNil$g (terminal$g C$ ))(tCons$g (thd$g B$ )(ttl$g B_c_tllist$ )))(B_d_tllist$ (tNil$h (terminal$h D$ ))(tCons$h (thd$h B$ )(ttl$h B_d_tllist$ )))(C_a_tllist$ (tNil$i (terminal$i A$ ))(tCons$i (thd$i C$ )(ttl$i C_a_tllist$ )))(C_b_tllist$ (tNil$j (terminal$j B$ ))(tCons$j (thd$j C$ )(ttl$j C_b_tllist$ )))(C_c_tllist$ (tNil$k (terminal$k C$ ))(tCons$k (thd$k C$ )(ttl$k C_c_tllist$ )))(D_c_tllist$ (tNil$l (terminal$l C$ ))(tCons$l (thd$l D$ )(ttl$l D_c_tllist$ )))(D_d_tllist$ (tNil$m (terminal$m D$ ))(tCons$m (thd$m D$ )(ttl$m D_d_tllist$ )))(D_a_tllist$ (tNil$n (terminal$n A$ ))(tCons$n (thd$n D$ )(ttl$n D_a_tllist$ )))(D_b_tllist$ (tNil$o (terminal$o B$ ))(tCons$o (thd$o D$ )(ttl$o D_b_tllist$ )))))
