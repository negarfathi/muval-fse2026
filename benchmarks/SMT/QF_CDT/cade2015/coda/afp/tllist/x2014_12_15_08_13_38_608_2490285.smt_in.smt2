...
(declare-codatatypes ()((B_a_tllist$ (tNil$ (terminal$ A$ ))(tCons$ (thd$ B$ )(ttl$ B_a_tllist$ )))(B_llist$ (lNil$ )(lCons$ (lhd$ B$ )(ltl$ B_llist$ )))(B_llist_a_tllist$ (tNil$a (terminal$a A$ ))(tCons$a (thd$a B_llist$ )(ttl$a B_llist_a_tllist$ )))(B_llist_llist$ (lNil$a )(lCons$a (lhd$a B_llist$ )(ltl$a B_llist_llist$ )))(B_llist_llist_a_tllist$ (tNil$b (terminal$b A$ ))(tCons$b (thd$b B_llist_llist$ )(ttl$b B_llist_llist_a_tllist$ )))(B_llist_llist_llist$ (lNil$b )(lCons$b (lhd$b B_llist_llist$ )(ltl$b B_llist_llist_llist$ )))(B_llist_llist_llist_a_tllist$ (tNil$c (terminal$c A$ ))(tCons$c (thd$c B_llist_llist_llist$ )(ttl$c B_llist_llist_llist_a_tllist$ )))))
