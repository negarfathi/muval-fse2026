...
(declare-codatatypes ()((A_c_tllist$ (tNil$ (terminal$ C$ ))(tCons$ (thd$ A$ )(ttl$ A_c_tllist$ )))(B_d_tllist$ (tNil$a (terminal$a D$ ))(tCons$a (thd$a B$ )(ttl$a B_d_tllist$ )))(B_llist$ (lNil$ )(lCons$ (lhd$ B$ )(ltl$ B_llist$ )))(A_llist$ (lNil$a )(lCons$a (lhd$a A$ )(ltl$a A_llist$ )))(A_d_tllist$ (tNil$b (terminal$b D$ ))(tCons$b (thd$b A$ )(ttl$b A_d_tllist$ )))(B_c_tllist$ (tNil$c (terminal$c C$ ))(tCons$c (thd$c B$ )(ttl$c B_c_tllist$ )))))
