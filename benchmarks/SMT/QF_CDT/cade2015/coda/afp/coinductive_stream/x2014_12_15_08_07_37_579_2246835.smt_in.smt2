...
(declare-codatatypes ()((A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(B_stream$ (sCons$a (shd$a B$ )(stl$a B_stream$ )))(B_stream_stream$ (sCons$b (shd$b B_stream$ )(stl$b B_stream_stream$ )))(A_stream_stream$ (sCons$c (shd$c A_stream$ )(stl$c A_stream_stream$ )))(B_stream_llist$ (lNil$ )(lCons$ (lhd$ B_stream$ )(ltl$ B_stream_llist$ )))(A_stream_llist$ (lNil$a )(lCons$a (lhd$a A_stream$ )(ltl$a A_stream_llist$ )))(A_llist$ (lNil$b )(lCons$b (lhd$b A$ )(ltl$b A_llist$ )))(B_llist$ (lNil$c )(lCons$c (lhd$c B$ )(ltl$c B_llist$ )))(B_stream_stream_stream$ (sCons$d (shd$d B_stream_stream$ )(stl$d B_stream_stream_stream$ )))(A_stream_stream_stream$ (sCons$e (shd$e A_stream_stream$ )(stl$e A_stream_stream_stream$ )))))
