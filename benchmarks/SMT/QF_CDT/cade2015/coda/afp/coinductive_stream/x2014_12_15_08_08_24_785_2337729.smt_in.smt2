...
(declare-codatatypes ()((A_a_prod_stream$ (sCons$h (shd$h A_a_prod$ )(stl$h A_a_prod_stream$ )))(B_stream_stream$ (sCons$i (shd$i B_stream$ )(stl$i B_stream_stream$ )))(A_b_prod_stream_stream$ (sCons$j (shd$j A_b_prod_stream$ )(stl$j A_b_prod_stream_stream$ )))(B_stream_stream_stream$ (sCons$k (shd$k B_stream_stream$ )(stl$k B_stream_stream_stream$ )))(A_stream_stream$ (sCons$l (shd$l A_stream$ )(stl$l A_stream_stream$ )))))
