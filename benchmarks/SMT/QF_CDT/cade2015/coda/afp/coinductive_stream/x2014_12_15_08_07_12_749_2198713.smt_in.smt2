...
(declare-codatatypes ()((B_stream$ (sCons$ (shd$ B$ )(stl$ B_stream$ )))(A_stream$ (sCons$a (shd$a A$ )(stl$a A_stream$ )))(A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(B_llist$ (lNil$a )(lCons$a (lhd$a B$ )(ltl$a B_llist$ )))(B_stream_llist$ (lNil$b )(lCons$b (lhd$b B_stream$ )(ltl$b B_stream_llist$ )))(B_stream_stream$ (sCons$b (shd$b B_stream$ )(stl$b B_stream_stream$ )))(A_stream_llist$ (lNil$c )(lCons$c (lhd$c A_stream$ )(ltl$c A_stream_llist$ )))(A_stream_stream$ (sCons$c (shd$c A_stream$ )(stl$c A_stream_stream$ )))))
