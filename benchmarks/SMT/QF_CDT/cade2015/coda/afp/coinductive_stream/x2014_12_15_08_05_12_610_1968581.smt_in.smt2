...
(declare-codatatypes ()((A_b_prod_stream$ (sCons$ (shd$ A_b_prod$ )(stl$ A_b_prod_stream$ )))(A_stream$ (sCons$a (shd$a A$ )(stl$a A_stream$ )))(B_stream$ (sCons$b (shd$b B$ )(stl$b B_stream$ )))(C_stream$ (sCons$c (shd$c C$ )(stl$c C_stream$ )))(D_stream$ (sCons$d (shd$d D$ )(stl$d D_stream$ )))))
