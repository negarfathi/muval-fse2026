...
(declare-codatatypes ()((A_a_a_prod_prod_stream$ (sCons$f (shd$f A_a_a_prod_prod$ )(stl$f A_a_a_prod_prod_stream$ )))(A_stream_stream$ (sCons$g (shd$g A_stream$ )(stl$g A_stream_stream$ )))(A_a_prod_stream$ (sCons$h (shd$h A_a_prod$ )(stl$h A_a_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_prod_stream_stream$ (sCons$i (shd$i A_b_prod_stream$ )(stl$i A_b_prod_stream_stream$ )))(B_stream_stream$ (sCons$j (shd$j B_stream$ )(stl$j B_stream_stream$ )))(A_stream_stream_stream$ (sCons$k (shd$k A_stream_stream$ )(stl$k A_stream_stream_stream$ )))))
...
(declare-codatatypes ()((B_a_b_prod_prod_stream$ (sCons$l (shd$l B_a_b_prod_prod$ )(stl$l B_a_b_prod_prod_stream$ )))(B_a_a_prod_prod_stream$ (sCons$m (shd$m B_a_a_prod_prod$ )(stl$m B_a_a_prod_prod_stream$ )))))
