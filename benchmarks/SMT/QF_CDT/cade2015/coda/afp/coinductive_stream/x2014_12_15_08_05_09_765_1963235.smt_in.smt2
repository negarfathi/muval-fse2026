...
(declare-codatatypes ()((A_b_prod_stream$ (sCons$ (shd$ A_b_prod$ )(stl$ A_b_prod_stream$ )))(A_stream$ (sCons$a (shd$a A$ )(stl$a A_stream$ )))(B_stream$ (sCons$b (shd$b B$ )(stl$b B_stream$ )))(C_stream$ (sCons$c (shd$c C$ )(stl$c C_stream$ )))))
(declare-sort A_c_prod$ 0)
(declare-fun fst$a (A_c_prod$)A$)
(declare-fun snd$a (A_c_prod$)C$)
(declare-fun pair$a (A$ C$ )A_c_prod$)
(declare-codatatypes ()((A_c_prod_stream$ (sCons$d (shd$d A_c_prod$ )(stl$d A_c_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_prod_c_prod_stream$ (sCons$f (shd$f A_b_prod_c_prod$ )(stl$f A_b_prod_c_prod_stream$ )))))
...
(declare-codatatypes ()((B_c_prod_stream$ (sCons$h (shd$h B_c_prod$ )(stl$h B_c_prod_stream$ )))))
(declare-sort C_c_prod$ 0)
(declare-fun fst$f (C_c_prod$)C$)
(declare-fun snd$f (C_c_prod$)C$)
(declare-fun pair$f (C$ C$ )C_c_prod$)
(declare-codatatypes ()((C_c_prod_stream$ (sCons$i (shd$i C_c_prod$ )(stl$i C_c_prod_stream$ )))))
