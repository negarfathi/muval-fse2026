...
(declare-codatatypes ()((A_b_prod_stream$ (sCons$a (shd$a A_b_prod$ )(stl$a A_b_prod_stream$ )))(B_stream$ (sCons$b (shd$b B$ )(stl$b B_stream$ )))(A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(A_b_prod_llist$ (lNil$a )(lCons$a (lhd$a A_b_prod$ )(ltl$a A_b_prod_llist$ )))(B_llist$ (lNil$b )(lCons$b (lhd$b B$ )(ltl$b B_llist$ )))))
...
(declare-codatatypes ()((A_b_prod_stream_a_stream_prod_llist$ (lNil$c )(lCons$c (lhd$c A_b_prod_stream_a_stream_prod$ )(ltl$c A_b_prod_stream_a_stream_prod_llist$ )))(A_b_prod_stream_a_stream_prod_stream$ (sCons$c (shd$c A_b_prod_stream_a_stream_prod$ )(stl$c A_b_prod_stream_a_stream_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_prod_stream_b_stream_prod_llist$ (lNil$d )(lCons$d (lhd$d A_b_prod_stream_b_stream_prod$ )(ltl$d A_b_prod_stream_b_stream_prod_llist$ )))(A_b_prod_stream_b_stream_prod_stream$ (sCons$d (shd$d A_b_prod_stream_b_stream_prod$ )(stl$d A_b_prod_stream_b_stream_prod_stream$ )))(A_stream_stream$ (sCons$e (shd$e A_stream$ )(stl$e A_stream_stream$ )))(A_stream_llist$ (lNil$e )(lCons$e (lhd$e A_stream$ )(ltl$e A_stream_llist$ )))(A_b_prod_stream_stream$ (sCons$f (shd$f A_b_prod_stream$ )(stl$f A_b_prod_stream_stream$ )))(B_stream_stream$ (sCons$g (shd$g B_stream$ )(stl$g B_stream_stream$ )))))
