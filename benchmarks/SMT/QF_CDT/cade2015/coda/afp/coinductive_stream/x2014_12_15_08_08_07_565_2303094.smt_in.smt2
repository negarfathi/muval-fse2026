...
(assert (! (not (= (sset$ (of_seq$ f$ ))(image$ f$ top$ ))):named a0 ))
...
(assert (! (forall ((?v0 A_set$ ))(=> (forall ((?v1 A$ ))(member$ ?v1 ?v0 ))(= top$a ?v0 ))):named a36 ))
(assert (! (forall ((?v0 Nat_set$ ))(=> (forall ((?v1 Nat$ ))(member$a ?v1 ?v0 ))(= top$ ?v0 ))):named a37 ))
