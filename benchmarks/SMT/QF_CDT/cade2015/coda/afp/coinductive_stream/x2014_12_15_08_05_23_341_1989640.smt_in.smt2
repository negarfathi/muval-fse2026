...
(declare-codatatypes ()((A_a_prod_stream$ (sCons$c (shd$c A_a_prod$ )(stl$c A_a_prod_stream$ )))(B_a_prod_stream$ (sCons$d (shd$d B_a_prod$ )(stl$d B_a_prod_stream$ )))(B_b_prod_stream$ (sCons$e (shd$e B_b_prod$ )(stl$e B_b_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_prod_b_prod_stream$ (sCons$g (shd$g A_b_prod_b_prod$ )(stl$g A_b_prod_b_prod_stream$ )))(A_a_b_prod_prod_stream$ (sCons$h (shd$h A_a_b_prod_prod$ )(stl$h A_a_b_prod_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_prod_a_b_prod_prod_stream$ (sCons$j (shd$j A_b_prod_a_b_prod_prod$ )(stl$j A_b_prod_a_b_prod_prod_stream$ )))(Nat_a_prod_stream$ (sCons$k (shd$k Nat_a_prod$ )(stl$k Nat_a_prod_stream$ )))(A_nat_a_prod_prod_stream$ (sCons$l (shd$l A_nat_a_prod_prod$ )(stl$l A_nat_a_prod_prod_stream$ )))))
