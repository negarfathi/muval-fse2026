...
(declare-codatatypes ()((A_b_prod_llist$ (lNil$a )(lCons$a (lhd$a A_b_prod$ )(ltl$a A_b_prod_llist$ )))(B_llist$ (lNil$b )(lCons$b (lhd$b B$ )(ltl$b B_llist$ )))(A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(A_b_prod_stream$ (sCons$a (shd$a A_b_prod$ )(stl$a A_b_prod_stream$ )))(B_stream$ (sCons$b (shd$b B$ )(stl$b B_stream$ )))))
...
(declare-codatatypes ()((A_b_prod_llist_a_llist_prod_llist$ (lNil$c )(lCons$c (lhd$c A_b_prod_llist_a_llist_prod$ )(ltl$c A_b_prod_llist_a_llist_prod_llist$ )))(A_b_prod_llist_a_llist_prod_stream$ (sCons$c (shd$c A_b_prod_llist_a_llist_prod$ )(stl$c A_b_prod_llist_a_llist_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_prod_llist_b_llist_prod_llist$ (lNil$d )(lCons$d (lhd$d A_b_prod_llist_b_llist_prod$ )(ltl$d A_b_prod_llist_b_llist_prod_llist$ )))(A_b_prod_llist_b_llist_prod_stream$ (sCons$d (shd$d A_b_prod_llist_b_llist_prod$ )(stl$d A_b_prod_llist_b_llist_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_prod_stream_a_stream_prod_llist$ (lNil$e )(lCons$e (lhd$e A_b_prod_stream_a_stream_prod$ )(ltl$e A_b_prod_stream_a_stream_prod_llist$ )))(A_b_prod_stream_a_stream_prod_stream$ (sCons$e (shd$e A_b_prod_stream_a_stream_prod$ )(stl$e A_b_prod_stream_a_stream_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_prod_stream_b_stream_prod_llist$ (lNil$f )(lCons$f (lhd$f A_b_prod_stream_b_stream_prod$ )(ltl$f A_b_prod_stream_b_stream_prod_llist$ )))(A_b_prod_stream_b_stream_prod_stream$ (sCons$f (shd$f A_b_prod_stream_b_stream_prod$ )(stl$f A_b_prod_stream_b_stream_prod_stream$ )))(A_stream_stream$ (sCons$g (shd$g A_stream$ )(stl$g A_stream_stream$ )))(A_stream_llist$ (lNil$g )(lCons$g (lhd$g A_stream$ )(ltl$g A_stream_llist$ )))(A_b_prod_stream_stream$ (sCons$h (shd$h A_b_prod_stream$ )(stl$h A_b_prod_stream_stream$ )))(B_stream_stream$ (sCons$i (shd$i B_stream$ )(stl$i B_stream_stream$ )))(A_b_prod_llist_stream$ (sCons$j (shd$j A_b_prod_llist$ )(stl$j A_b_prod_llist_stream$ )))(B_llist_stream$ (sCons$k (shd$k B_llist$ )(stl$k B_llist_stream$ )))(A_llist_stream$ (sCons$l (shd$l A_llist$ )(stl$l A_llist_stream$ )))))
