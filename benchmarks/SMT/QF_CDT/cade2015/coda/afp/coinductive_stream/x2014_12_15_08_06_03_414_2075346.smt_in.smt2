...
(declare-codatatypes ()((A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(A_llist_stream$ (sCons$a (shd$a A_llist$ )(stl$a A_llist_stream$ )))(A_llist_llist$ (lNil$a )(lCons$a (lhd$a A_llist$ )(ltl$a A_llist_llist$ )))))
