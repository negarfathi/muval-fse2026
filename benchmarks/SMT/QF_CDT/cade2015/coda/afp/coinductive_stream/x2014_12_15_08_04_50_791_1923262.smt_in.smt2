...
(declare-codatatypes ()((A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(B_stream$ (sCons$a (shd$a B$ )(stl$a B_stream$ )))(B_stream_stream$ (sCons$b (shd$b B_stream$ )(stl$b B_stream_stream$ )))(A_stream_stream$ (sCons$c (shd$c A_stream$ )(stl$c A_stream_stream$ )))(C_stream$ (sCons$d (shd$d C$ )(stl$d C_stream$ )))))
...
(declare-fun fst$a (A_stream_a_stream_prod$)A_stream$)
(declare-fun snd$a (A_stream_a_stream_prod$)A_stream$)
(declare-fun pair$a (A_stream$ A_stream$ )A_stream_a_stream_prod$)
(declare-fun b$ ()C$ )
