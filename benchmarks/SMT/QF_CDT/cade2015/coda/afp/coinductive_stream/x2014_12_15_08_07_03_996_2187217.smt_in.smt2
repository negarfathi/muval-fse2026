...
(declare-codatatypes ()((B_llist$ (lNil$ )(lCons$ (lhd$ B$ )(ltl$ B_llist$ )))(A_llist$ (lNil$a )(lCons$a (lhd$a A$ )(ltl$a A_llist$ )))(D_stream$ (sCons$ (shd$ D$ )(stl$ D_stream$ )))(C_stream$ (sCons$a (shd$a C$ )(stl$a C_stream$ )))(D_llist$ (lNil$b )(lCons$b (lhd$b D$ )(ltl$b D_llist$ )))(C_llist$ (lNil$c )(lCons$c (lhd$c C$ )(ltl$c C_llist$ )))(A_stream$ (sCons$b (shd$b A$ )(stl$b A_stream$ )))(B_stream$ (sCons$c (shd$c B$ )(stl$c B_stream$ )))))
