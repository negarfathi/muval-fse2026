...
(declare-codatatypes ()((A_a_prod_stream$ (sCons$b (shd$b A_a_prod$ )(stl$b A_a_prod_stream$ )))(A_stream_stream_stream$ (sCons$c (shd$c A_stream_stream$ )(stl$c A_stream_stream_stream$ )))(A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))))
...
(declare-codatatypes ()((A_a_stream_prod_stream$ (sCons$d (shd$d A_a_stream_prod$ )(stl$d A_a_stream_prod_stream$ )))))
(declare-sort A_stream_a_prod$ 0)
(declare-fun fst$b (A_stream_a_prod$)A_stream$)
(declare-fun snd$b (A_stream_a_prod$)A$)
(declare-fun pair$b (A_stream$ A$ )A_stream_a_prod$)
(declare-codatatypes ()((A_stream_a_prod_stream$ (sCons$e (shd$e A_stream_a_prod$ )(stl$e A_stream_a_prod_stream$ )))))
...
(declare-codatatypes ()((A_a_prod_a_prod_stream$ (sCons$g (shd$g A_a_prod_a_prod$ )(stl$g A_a_prod_a_prod_stream$ )))))
...
(declare-codatatypes ()((A_a_prod_a_a_prod_prod_stream$ (sCons$h (shd$h A_a_prod_a_a_prod_prod$ )(stl$h A_a_prod_a_a_prod_prod_stream$ )))))
