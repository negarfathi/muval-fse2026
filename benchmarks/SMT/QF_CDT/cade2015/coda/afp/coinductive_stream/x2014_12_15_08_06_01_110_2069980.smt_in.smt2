...
(declare-codatatypes ()((A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(B_llist$ (lNil$a )(lCons$a (lhd$a B$ )(ltl$a B_llist$ )))(B_stream$ (sCons$ (shd$ B$ )(stl$ B_stream$ )))(A_stream$ (sCons$a (shd$a A$ )(stl$a A_stream$ )))))
(declare-sort B_b_prod$ 0)
(declare-fun fst$ (B_b_prod$)B$)
(declare-fun snd$ (B_b_prod$)B$)
(declare-fun pair$ (B$ B$ )B_b_prod$)
(declare-codatatypes ()((B_b_prod_stream$ (sCons$b (shd$b B_b_prod$ )(stl$b B_b_prod_stream$ )))))
(declare-sort B_a_prod$ 0)
(declare-fun fst$a (B_a_prod$)B$)
(declare-fun snd$a (B_a_prod$)A$)
(declare-fun pair$a (B$ A$ )B_a_prod$)
(declare-codatatypes ()((B_a_prod_stream$ (sCons$c (shd$c B_a_prod$ )(stl$c B_a_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_b_prod_prod_stream$ (sCons$f (shd$f A_b_b_prod_prod$ )(stl$f A_b_b_prod_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_a_prod_prod_stream$ (sCons$g (shd$g A_b_a_prod_prod$ )(stl$g A_b_a_prod_prod_stream$ )))))
...
(declare-codatatypes ()((A_a_b_prod_prod_stream$ (sCons$h (shd$h A_a_b_prod_prod$ )(stl$h A_a_b_prod_prod_stream$ )))))
...
(declare-codatatypes ()((A_a_a_prod_prod_stream$ (sCons$i (shd$i A_a_a_prod_prod$ )(stl$i A_a_a_prod_prod_stream$ )))))
...
(declare-codatatypes ()((B_b_b_prod_prod_stream$ (sCons$j (shd$j B_b_b_prod_prod$ )(stl$j B_b_b_prod_prod_stream$ )))))
...
(declare-codatatypes ()((B_b_a_prod_prod_stream$ (sCons$k (shd$k B_b_a_prod_prod$ )(stl$k B_b_a_prod_prod_stream$ )))))
