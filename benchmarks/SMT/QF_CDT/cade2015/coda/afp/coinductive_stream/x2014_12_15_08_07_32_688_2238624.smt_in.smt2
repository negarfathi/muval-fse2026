...
(declare-codatatypes ()((A_b_prod_llist$ (lNil$ )(lCons$ (lhd$ A_b_prod$ )(ltl$ A_b_prod_llist$ )))(A_llist$ (lNil$a )(lCons$a (lhd$a A$ )(ltl$a A_llist$ )))(A_b_prod_stream$ (sCons$ (shd$ A_b_prod$ )(stl$ A_b_prod_stream$ )))(A_stream$ (sCons$a (shd$a A$ )(stl$a A_stream$ )))(B_stream$ (sCons$b (shd$b B$ )(stl$b B_stream$ )))(B_llist$ (lNil$b )(lCons$b (lhd$b B$ )(ltl$b B_llist$ )))))
