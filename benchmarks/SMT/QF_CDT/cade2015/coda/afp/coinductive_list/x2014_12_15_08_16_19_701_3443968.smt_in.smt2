...
(assert (! (not (= (ltl$ (fun_app$ (ldropn$ (suc$ na$ ))xsa$ ))(fun_app$ (ldropn$ (suc$ na$ ))(ltl$ xsa$ )))):named a1 ))
(assert (! (forall ((?v0 A_llist$ ))(= (ltl$ (fun_app$ (ldropn$ na$ )?v0 ))(fun_app$ (ldropn$ na$ )(ltl$ ?v0 )))):named a2 ))
...
(assert (! (forall ((?v0 Nat$ )(?v1 A$ )(?v2 A_llist$ ))(! (= (fun_app$ (ldropn$ (suc$ ?v0 ))(lCons$ ?v1 ?v2 ))(fun_app$ (ldropn$ ?v0 )?v2 )):pattern ((fun_app$ (ldropn$ (suc$ ?v0 ))(lCons$ ?v1 ?v2 ))))):named a8 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A$ ))(= (ltl$ (iterates$ ?v0 ?v1 ))(iterates$ ?v0 (fun_app$a ?v0 ?v1 )))):named a9 ))
