...
(assert (! (not (= (fun_app$ (ldrop$ n$ )xs$ )lNil$ )):named a0 ))
(assert (! (lnull$ xs$ ):named a1 ))
(assert (! (forall ((?v0 Enat$ ))(! (= (fun_app$a (ldrop$a ?v0 )lNil$a )lNil$a ):pattern ((ldrop$a ?v0 )))):named a2 ))
...
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_llist$ )(?v1 Nat$ ))(! (=> (lnull$a ?v0 )(= (ldropn$ ?v1 ?v0 )lNil$b )):pattern ((ldropn$ ?v1 ?v0 )))):named a49 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$ )(?v1 Nat$ ))(! (=> (lnull$b ?v0 )(= (ldropn$a ?v1 ?v0 )lNil$c )):pattern ((ldropn$a ?v1 ?v0 )))):named a50 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$ )(?v1 Nat$ ))(! (=> (lnull$c ?v0 )(= (ldropn$b ?v1 ?v0 )lNil$d )):pattern ((ldropn$b ?v1 ?v0 )))):named a51 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 Nat$ ))(! (=> (lnull$d ?v0 )(= (fun_app$a (ldropn$c ?v1 )?v0 )lNil$a )):pattern ((fun_app$a (ldropn$c ?v1 )?v0 )))):named a52 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 Nat$ ))(! (=> (lnull$ ?v0 )(= (fun_app$ (ldropn$d ?v1 )?v0 )lNil$ )):pattern ((fun_app$ (ldropn$d ?v1 )?v0 )))):named a53 ))
(assert (! (forall ((?v0 A_a_prod$ ))(! (= (fun_app$b (lmember$ ?v0 )lNil$a )false ):pattern ((lmember$ ?v0 )))):named a54 ))
(assert (! (forall ((?v0 A$ ))(! (= (fun_app$c (lmember$a ?v0 )lNil$ )false ):pattern ((lmember$a ?v0 )))):named a55 ))
(assert (! (forall ((?v0 A_a_prod_set$ ))(! (= (fun_app$d (gen_lset$ ?v0 )lNil$a )?v0 ):pattern ((gen_lset$ ?v0 )))):named a56 ))
(assert (! (forall ((?v0 A_set$ ))(! (= (fun_app$e (gen_lset$a ?v0 )lNil$ )?v0 ):pattern ((gen_lset$a ?v0 )))):named a57 ))
(assert (! (forall ((?v0 Nat$ ))(! (= (fun_app$a (ldropn$c ?v0 )lNil$a )lNil$a ):pattern ((ldropn$c ?v0 )))):named a58 ))
(assert (! (forall ((?v0 Nat$ ))(! (= (fun_app$ (ldropn$d ?v0 )lNil$ )lNil$ ):pattern ((ldropn$d ?v0 )))):named a59 ))
...
(assert (! (forall ((?v0 A_a_prod_bool_fun$ ))(pred_llist$ ?v0 lNil$a )):named a80 ))
(assert (! (forall ((?v0 A_bool_fun$ ))(pred_llist$a ?v0 lNil$ )):named a81 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun$ )(?v1 A_a_prod_a_a_prod_prod$ ))(not (lnull$a (iterates$ ?v0 ?v1 )))):named a82 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_a_a_prod_a_prod_fun$ )(?v1 A_a_prod_a_prod$ ))(not (lnull$b (iterates$a ?v0 ?v1 )))):named a83 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_a_a_a_prod_prod_fun$ )(?v1 A_a_a_prod_prod$ ))(not (lnull$c (iterates$b ?v0 ?v1 )))):named a84 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_fun$ )(?v1 A_a_prod$ ))(not (lnull$d (iterates$c ?v0 ?v1 )))):named a85 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A$ ))(not (lnull$ (iterates$d ?v0 ?v1 )))):named a86 ))
(check-sat )
;(get-unsat-core )
