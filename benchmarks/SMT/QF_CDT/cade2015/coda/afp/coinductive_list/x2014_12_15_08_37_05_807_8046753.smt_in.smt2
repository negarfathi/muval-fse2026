...
(declare-codatatypes ()((A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(B_llist$ (lNil$a )(lCons$a (lhd$a B$ )(ltl$a B_llist$ )))(Nat_llist$ (lNil$b )(lCons$b (lhd$b Nat$ )(ltl$b Nat_llist$ )))(Nat_a_fun_llist$ (lNil$c )(lCons$c (select$ Nat_a_fun$ )(selecta$ Nat_a_fun_llist$ )))(Nat_b_fun_llist$ (lNil$d )(lCons$d (selectb$ Nat_b_fun$ )(selectc$ Nat_b_fun_llist$ )))(B_llist_llist$ (lNil$e )(lCons$e (lhd$c B_llist$ )(ltl$c B_llist_llist$ )))(A_llist_llist$ (lNil$f )(lCons$f (lhd$d A_llist$ )(ltl$d A_llist_llist$ )))))
