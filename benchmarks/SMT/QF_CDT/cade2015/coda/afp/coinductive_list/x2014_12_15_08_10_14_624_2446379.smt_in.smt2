...
(assert (! (lfinite$ zsa$ ):named a7 ))
(assert (! (lprefix$ zsa$ xs$a ):named a8 ))
(assert (! (= xsa$ (lCons$ z$ xs$a )):named a9 ))
...
(assert (! (forall ((?v0 A_llist$ ))(=> (lprefix$ zsa$ ?v0 )(= (lSup$ (collect$ (uua$ ?v0 )))?v0 ))):named a14 ))
...
(assert (! (=> (forall ((?v0 A_llist$ ))(=> (and (= xsa$ (lCons$ z$ ?v0 ))(lprefix$ zsa$ ?v0 ))false ))false ):named a18 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist$ ))(= (lprefix$ (lCons$ ?v0 ?v1 )?v2 )(exists ((?v3 A_llist$ ))(and (= ?v2 (lCons$ ?v0 ?v3 ))(lprefix$ ?v1 ?v3 ))))):named a19 ))
(assert (! (forall ((?v0 A_llist$ ))(= (lSup$ (collect$ (uub$ ?v0 )))?v0 )):named a20 ))
(check-sat )
;(get-unsat-core )
