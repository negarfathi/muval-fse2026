...
(assert (! (not (llexord$ r$ xs$ (fun_app$ (lappend$ xs$ )ys$ ))):named a0 ))
...
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A$ )(?v2 A_llist$ )(?v3 A$ )(?v4 A_llist$ ))(! (= (llexord$ ?v0 (lCons$ ?v1 ?v2 )(lCons$ ?v3 ?v4 ))(or (and (= ?v1 ?v3 )(llexord$ ?v0 ?v2 ?v4 ))(fun_app$a (fun_app$b ?v0 ?v1 )?v3 ))):pattern ((llexord$ ?v0 (lCons$ ?v1 ?v2 )(lCons$ ?v3 ?v4 ))))):named a3 ))
...
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A$ )(?v2 A_llist$ )(?v3 A_llist$ ))(= (llexord$ ?v0 (lCons$ ?v1 ?v2 )?v3 )(exists ((?v4 A$ )(?v5 A_llist$ ))(and (= ?v3 (lCons$ ?v4 ?v5 ))(or (and (= ?v1 ?v4 )(llexord$ ?v0 ?v2 ?v5 ))(fun_app$a (fun_app$b ?v0 ?v1 )?v4 )))))):named a14 ))
