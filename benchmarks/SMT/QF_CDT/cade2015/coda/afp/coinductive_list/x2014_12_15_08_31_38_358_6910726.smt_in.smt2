...
(declare-codatatypes ()((A_llist_list_llist$ (lNil$c )(lCons$c (lhd$c A_llist_list$ )(ltl$c A_llist_list_llist$ )))(A_list_llist$ (lNil$d )(lCons$d (lhd$d A_list$ )(ltl$d A_list_llist$ )))))
...
(declare-fun nil$f ()A_llist_list_list_list$)
(declare-fun hd$f (A_llist_list_list_list$)A_llist_list_list$)
(declare-fun tl$f (A_llist_list_list_list$)A_llist_list_list_list$)
(declare-fun cons$f (A_llist_list_list$ A_llist_list_list_list$ )A_llist_list_list_list$)
