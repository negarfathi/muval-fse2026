...
(assert (! (or (less_eq$ n$ m$ )(less_eq$ (llength$ xs$ )m$ )):named a3 ))
...
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ )(?v2 A_llist$ )(?v3 Enat$ ))(=> (and (= (fun_app$b (ltake$ ?v0 )?v1 )(fun_app$b (ltake$ ?v0 )?v2 ))(less_eq$ ?v3 ?v0 ))(= (fun_app$b (ltake$ ?v3 )?v1 )(fun_app$b (ltake$ ?v3 )?v2 )))):named a11 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 Enat$ ))(! (=> (less_eq$ (llength$ ?v0 )?v1 )(= (fun_app$b (ltake$ ?v1 )?v0 )?v0 )):pattern ((fun_app$b (ltake$ ?v1 )?v0 )))):named a12 ))
