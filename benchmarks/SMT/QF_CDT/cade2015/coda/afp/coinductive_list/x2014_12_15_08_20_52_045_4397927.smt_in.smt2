...
(declare-sort A_a_llist_set_sum$ 0)
(declare-fun projl$ (A_a_llist_set_sum$)A$)
(declare-fun inl$ (A$ )A_a_llist_set_sum$)
(declare-fun projr$ (A_a_llist_set_sum$)A_llist_set$)
(declare-fun inr$ (A_llist_set$ )A_a_llist_set_sum$)
(declare-codatatypes ()((A_a_llist_set_sum_llist$ (lNil$a )(lCons$a (lhd$a A_a_llist_set_sum$ )(ltl$a A_a_llist_set_sum_llist$ )))))
(declare-sort A_a_sum$ 0)
(declare-fun projl$a (A_a_sum$)A$)
(declare-fun inl$a (A$ )A_a_sum$)
(declare-fun projr$a (A_a_sum$)A$)
(declare-fun inr$a (A$ )A_a_sum$)
(declare-codatatypes ()((A_a_sum_llist$ (lNil$b )(lCons$b (lhd$b A_a_sum$ )(ltl$b A_a_sum_llist$ )))(A_llist_a_llist_sum_set_llist$ (lNil$c )(lCons$c (lhd$c A_llist_a_llist_sum_set$ )(ltl$c A_llist_a_llist_sum_set_llist$ )))(A_llist_set_set_llist$ (lNil$d )(lCons$d (lhd$d A_llist_set_set$ )(ltl$d A_llist_set_set_llist$ )))(A_set_llist$ (lNil$e )(lCons$e (lhd$e A_set$ )(ltl$e A_set_llist$ )))(A_llist_set_llist$ (lNil$f )(lCons$f (lhd$f A_llist_set$ )(ltl$f A_llist_set_llist$ )))))
(declare-sort A_llist_a_llist_sum$ 0)
(declare-fun projl$b (A_llist_a_llist_sum$)A_llist$)
(declare-fun inl$b (A_llist$ )A_llist_a_llist_sum$)
(declare-fun projr$b (A_llist_a_llist_sum$)A_llist$)
(declare-fun inr$b (A_llist$ )A_llist_a_llist_sum$)
(declare-codatatypes ()((A_llist_a_llist_sum_llist$ (lNil$g )(lCons$g (lhd$g A_llist_a_llist_sum$ )(ltl$g A_llist_a_llist_sum_llist$ )))(A_llist_llist$ (lNil$h )(lCons$h (lhd$h A_llist$ )(ltl$h A_llist_llist$ )))))
