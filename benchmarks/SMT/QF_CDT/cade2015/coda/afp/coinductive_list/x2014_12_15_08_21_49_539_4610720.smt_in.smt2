...
(declare-codatatypes ()((A_a_prod_llist$ (lNil$g )(lCons$g (lhd$g A_a_prod$ )(ltl$g A_a_prod_llist$ )))(A_b_prod_a_b_prod_prod_llist$ (lNil$h )(lCons$h (lhd$h A_b_prod_a_b_prod_prod$ )(ltl$h A_b_prod_a_b_prod_prod_llist$ )))))
...
(declare-fun lset$g (B_llist$ )B_set$ )
(declare-fun lset$h (A_b_prod_llist$ )A_b_prod_set$ )
(declare-fun lsetp$ (A_b_prod_llist$ A_b_prod$ )Bool )
...
(declare-fun lsetp$b (A_b_prod_a_b_prod_prod_llist$ A_b_prod_a_b_prod_prod$ )Bool )
(declare-fun lsetp$c (B_llist$ B$ )Bool )
...
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B_b_llist_bool_fun_fun$ ))(=> (and (member$g ?v0 (lset$g ?v1 ))(and (forall ((?v3 B$ )(?v4 B_llist$ ))(fun_app$l (fun_app$m ?v2 ?v3 )(lCons$b ?v3 ?v4 )))(forall ((?v3 B$ )(?v4 B_llist$ )(?v5 B$ ))(=> (and (member$g ?v5 (lset$g ?v4 ))(fun_app$l (fun_app$m ?v2 ?v5 )?v4 ))(fun_app$l (fun_app$m ?v2 ?v5 )(lCons$b ?v3 ?v4 ))))))(fun_app$l (fun_app$m ?v2 ?v0 )?v1 ))):named a8 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_a_llist_bool_fun_fun$ ))(=> (and (member$ ?v0 (lset$ ?v1 ))(and (forall ((?v3 A$ )(?v4 A_llist$ ))(fun_app$n (fun_app$o ?v2 ?v3 )(lCons$ ?v3 ?v4 )))(forall ((?v3 A$ )(?v4 A_llist$ )(?v5 A$ ))(=> (and (member$ ?v5 (lset$ ?v4 ))(fun_app$n (fun_app$o ?v2 ?v5 )?v4 ))(fun_app$n (fun_app$o ?v2 ?v5 )(lCons$ ?v3 ?v4 ))))))(fun_app$n (fun_app$o ?v2 ?v0 )?v1 ))):named a9 ))
...
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ ))(=> (and (member$g ?v0 (lset$g ?v1 ))(and (forall ((?v2 B_llist$ ))(=> (= ?v1 (lCons$b ?v0 ?v2 ))false ))(forall ((?v2 B$ )(?v3 B_llist$ ))(=> (and (= ?v1 (lCons$b ?v2 ?v3 ))(member$g ?v0 (lset$g ?v3 )))false ))))false )):named a17 ))
...
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B_llist_bool_fun$ ))(=> (and (member$g ?v0 (lset$g ?v1 ))(and (forall ((?v3 B_llist$ ))(fun_app$l ?v2 (lCons$b ?v0 ?v3 )))(forall ((?v3 B$ )(?v4 B_llist$ ))(=> (and (member$g ?v0 (lset$g ?v4 ))(fun_app$l ?v2 ?v4 ))(fun_app$l ?v2 (lCons$b ?v3 ?v4 ))))))(fun_app$l ?v2 ?v1 ))):named a26 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist_bool_fun$ ))(=> (and (member$ ?v0 (lset$ ?v1 ))(and (forall ((?v3 A_llist$ ))(fun_app$n ?v2 (lCons$ ?v0 ?v3 )))(forall ((?v3 A$ )(?v4 A_llist$ ))(=> (and (member$ ?v0 (lset$ ?v4 ))(fun_app$n ?v2 ?v4 ))(fun_app$n ?v2 (lCons$ ?v3 ?v4 ))))))(fun_app$n ?v2 ?v1 ))):named a27 ))
...
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B_llist_bool_fun$ ))(=> (and (member$g ?v0 (lset$g ?v1 ))(and (forall ((?v3 B_llist$ ))(fun_app$l ?v2 (lCons$b ?v0 ?v3 )))(forall ((?v3 B$ )(?v4 B_llist$ ))(=> (and (member$g ?v0 (lset$g ?v4 ))(and (not (= ?v0 ?v3 ))(fun_app$l ?v2 ?v4 )))(fun_app$l ?v2 (lCons$b ?v3 ?v4 ))))))(fun_app$l ?v2 ?v1 ))):named a35 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist_bool_fun$ ))(=> (and (member$ ?v0 (lset$ ?v1 ))(and (forall ((?v3 A_llist$ ))(fun_app$n ?v2 (lCons$ ?v0 ?v3 )))(forall ((?v3 A$ )(?v4 A_llist$ ))(=> (and (member$ ?v0 (lset$ ?v4 ))(and (not (= ?v0 ?v3 ))(fun_app$n ?v2 ?v4 )))(fun_app$n ?v2 (lCons$ ?v3 ?v4 ))))))(fun_app$n ?v2 ?v1 ))):named a36 ))
...
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ ))(=> (and (member$g ?v0 (lset$g ?v1 ))(and (forall ((?v2 B_llist$ ))(=> (= ?v1 (lCons$b ?v0 ?v2 ))false ))(forall ((?v2 B$ )(?v3 B_llist$ ))(=> (and (= ?v1 (lCons$b ?v2 ?v3 ))(member$g ?v0 (lset$g ?v3 )))false ))))false )):named a44 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(=> (and (member$ ?v0 (lset$ ?v1 ))(and (forall ((?v2 A_llist$ ))(=> (= ?v1 (lCons$ ?v0 ?v2 ))false ))(forall ((?v2 A$ )(?v3 A_llist$ ))(=> (and (= ?v1 (lCons$ ?v2 ?v3 ))(member$ ?v0 (lset$ ?v3 )))false ))))false )):named a45 ))
...
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B$ ))(=> (member$g ?v0 (lset$g ?v1 ))(member$g ?v0 (lset$g (lCons$b ?v2 ?v1 ))))):named a53 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ ))(=> (member$ ?v0 (lset$ ?v1 ))(member$ ?v0 (lset$ (lCons$ ?v2 ?v1 ))))):named a54 ))
...
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B$ ))(=> (member$g ?v0 (lset$g ?v1 ))(member$g ?v0 (lset$g (lCons$b ?v2 ?v1 ))))):named a62 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ ))(=> (member$ ?v0 (lset$ ?v1 ))(member$ ?v0 (lset$ (lCons$ ?v2 ?v1 ))))):named a63 ))
...
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ ))(member$g ?v0 (lset$g (lCons$b ?v0 ?v1 )))):named a71 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(member$ ?v0 (lset$ (lCons$ ?v0 ?v1 )))):named a72 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ ))(member$h ?v0 (lset$h (lCons$a ?v0 ?v1 )))):named a73 ))
(assert (! (forall ((?v0 B_a_prod$ )(?v1 B_a_prod_llist$ ))(member$b ?v0 (lset$b (lCons$d ?v0 ?v1 )))):named a74 ))
(assert (! (forall ((?v0 A_a_b_prod_a_b_prod_prod_prod$ )(?v1 A_a_b_prod_a_b_prod_prod_prod_llist$ ))(member$c ?v0 (lset$c (lCons$e ?v0 ?v1 )))):named a75 ))
(assert (! (forall ((?v0 A_a_b_prod_prod$ )(?v1 A_a_b_prod_prod_llist$ ))(member$d ?v0 (lset$d (lCons$f ?v0 ?v1 )))):named a76 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ ))(member$e ?v0 (lset$e (lCons$g ?v0 ?v1 )))):named a77 ))
(assert (! (forall ((?v0 A_b_prod_a_b_prod_prod$ )(?v1 A_b_prod_a_b_prod_prod_llist$ ))(member$f ?v0 (lset$f (lCons$h ?v0 ?v1 )))):named a78 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ ))(member$g ?v0 (lset$g (lCons$b ?v0 ?v1 )))):named a79 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(member$ ?v0 (lset$ (lCons$ ?v0 ?v1 )))):named a80 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ ))(member$h ?v0 (lset$h (lCons$a ?v0 ?v1 )))):named a81 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ ))(= (member$h ?v0 (lset$h ?v1 ))(fun_app$p (lmember$ ?v0 )?v1 ))):named a82 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(= (member$ ?v0 (lset$ ?v1 ))(fun_app$n (lmember$a ?v0 )?v1 ))):named a83 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(= (= (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a84 ))
(assert (! (forall ((?v0 A_b_prod_a_b_prod_prod$ )(?v1 A_b_prod_a_b_prod_prod_llist$ )(?v2 A_b_prod_a_b_prod_prod$ )(?v3 A_b_prod_a_b_prod_prod_llist$ ))(= (= (lCons$h ?v0 ?v1 )(lCons$h ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a85 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B$ )(?v3 B_llist$ ))(= (= (lCons$b ?v0 ?v1 )(lCons$b ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a86 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ )(?v2 A_b_prod$ )(?v3 A_b_prod_llist$ ))(= (= (lCons$a ?v0 ?v1 )(lCons$a ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a87 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ ))(=> (member$h ?v0 (lset$h ?v1 ))(lsetp$ ?v1 ?v0 ))):named a88 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(=> (member$ ?v0 (lset$ ?v1 ))(lsetp$a ?v1 ?v0 ))):named a89 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 B$ )(?v3 B_llist$ ))(! (= (lzip$ (lCons$ ?v0 ?v1 )(lCons$b ?v2 ?v3 ))(lCons$a (pair$ ?v0 ?v2 )(lzip$ ?v1 ?v3 ))):pattern ((lzip$ (lCons$ ?v0 ?v1 )(lCons$b ?v2 ?v3 ))))):named a90 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ )(?v2 A_b_prod$ )(?v3 A_b_prod_llist$ ))(! (= (lzip$a (lCons$a ?v0 ?v1 )(lCons$a ?v2 ?v3 ))(lCons$h (pair$c ?v0 ?v2 )(lzip$a ?v1 ?v3 ))):pattern ((lzip$a (lCons$a ?v0 ?v1 )(lCons$a ?v2 ?v3 ))))):named a91 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(! (= (lzip$b (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(lCons$g (pair$f ?v0 ?v2 )(lzip$b ?v1 ?v3 ))):pattern ((lzip$b (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))))):named a92 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 A$ )(?v3 A_llist$ ))(! (= (lzip$c (lCons$b ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(lCons$d (pair$b ?v0 ?v2 )(lzip$c ?v1 ?v3 ))):pattern ((lzip$c (lCons$b ?v0 ?v1 )(lCons$ ?v2 ?v3 ))))):named a93 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B$ )(?v3 B_llist$ ))(! (= (lzip$d (lCons$b ?v0 ?v1 )(lCons$b ?v2 ?v3 ))(lCons$c (pair$a ?v0 ?v2 )(lzip$d ?v1 ?v3 ))):pattern ((lzip$d (lCons$b ?v0 ?v1 )(lCons$b ?v2 ?v3 ))))):named a94 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ )(?v2 A$ )(?v3 A_llist$ ))(! (= (lzip$e (lCons$a ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(lCons$i (pair$g ?v0 ?v2 )(lzip$e ?v1 ?v3 ))):pattern ((lzip$e (lCons$a ?v0 ?v1 )(lCons$ ?v2 ?v3 ))))):named a95 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ )(?v2 B$ )(?v3 B_llist$ ))(! (= (lzip$f (lCons$a ?v0 ?v1 )(lCons$b ?v2 ?v3 ))(lCons$j (pair$h ?v0 ?v2 )(lzip$f ?v1 ?v3 ))):pattern ((lzip$f (lCons$a ?v0 ?v1 )(lCons$b ?v2 ?v3 ))))):named a96 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_b_prod$ )(?v3 A_b_prod_llist$ ))(! (= (lzip$g (lCons$ ?v0 ?v1 )(lCons$a ?v2 ?v3 ))(lCons$f (pair$e ?v0 ?v2 )(lzip$g ?v1 ?v3 ))):pattern ((lzip$g (lCons$ ?v0 ?v1 )(lCons$a ?v2 ?v3 ))))):named a97 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 A_b_prod$ )(?v3 A_b_prod_llist$ ))(! (= (lzip$h (lCons$b ?v0 ?v1 )(lCons$a ?v2 ?v3 ))(lCons$k (pair$i ?v0 ?v2 )(lzip$h ?v1 ?v3 ))):pattern ((lzip$h (lCons$b ?v0 ?v1 )(lCons$a ?v2 ?v3 ))))):named a98 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_b_prod_a_b_prod_prod$ )(?v3 A_b_prod_a_b_prod_prod_llist$ ))(! (= (lzip$i (lCons$ ?v0 ?v1 )(lCons$h ?v2 ?v3 ))(lCons$e (pair$d ?v0 ?v2 )(lzip$i ?v1 ?v3 ))):pattern ((lzip$i (lCons$ ?v0 ?v1 )(lCons$h ?v2 ?v3 ))))):named a99 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A$ ))(= (lsetp$a ?v0 ?v1 )(or (exists ((?v2 A$ )(?v3 A_llist$ ))(and (= ?v0 (lCons$ ?v2 ?v3 ))(= ?v1 ?v2 )))(exists ((?v2 A_llist$ )(?v3 A$ )(?v4 A$ ))(and (= ?v0 (lCons$ ?v4 ?v2 ))(and (= ?v1 ?v3 )(lsetp$a ?v2 ?v3 ))))))):named a100 ))
(assert (! (forall ((?v0 A_b_prod_a_b_prod_prod_llist$ )(?v1 A_b_prod_a_b_prod_prod$ ))(= (lsetp$b ?v0 ?v1 )(or (exists ((?v2 A_b_prod_a_b_prod_prod$ )(?v3 A_b_prod_a_b_prod_prod_llist$ ))(and (= ?v0 (lCons$h ?v2 ?v3 ))(= ?v1 ?v2 )))(exists ((?v2 A_b_prod_a_b_prod_prod_llist$ )(?v3 A_b_prod_a_b_prod_prod$ )(?v4 A_b_prod_a_b_prod_prod$ ))(and (= ?v0 (lCons$h ?v4 ?v2 ))(and (= ?v1 ?v3 )(lsetp$b ?v2 ?v3 ))))))):named a101 ))
(assert (! (forall ((?v0 B_llist$ )(?v1 B$ ))(= (lsetp$c ?v0 ?v1 )(or (exists ((?v2 B$ )(?v3 B_llist$ ))(and (= ?v0 (lCons$b ?v2 ?v3 ))(= ?v1 ?v2 )))(exists ((?v2 B_llist$ )(?v3 B$ )(?v4 B$ ))(and (= ?v0 (lCons$b ?v4 ?v2 ))(and (= ?v1 ?v3 )(lsetp$c ?v2 ?v3 ))))))):named a102 ))
(assert (! (forall ((?v0 A_b_prod_llist$ )(?v1 A_b_prod$ ))(= (lsetp$ ?v0 ?v1 )(or (exists ((?v2 A_b_prod$ )(?v3 A_b_prod_llist$ ))(and (= ?v0 (lCons$a ?v2 ?v3 ))(= ?v1 ?v2 )))(exists ((?v2 A_b_prod_llist$ )(?v3 A_b_prod$ )(?v4 A_b_prod$ ))(and (= ?v0 (lCons$a ?v4 ?v2 ))(and (= ?v1 ?v3 )(lsetp$ ?v2 ?v3 ))))))):named a103 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 B_llist$ )(?v2 A_b_prod$ )(?v3 A_b_prod_llist$ ))(= (= (lzip$ ?v0 ?v1 )(lCons$a ?v2 ?v3 ))(exists ((?v4 A$ )(?v5 A_llist$ )(?v6 B$ )(?v7 B_llist$ ))(and (= ?v0 (lCons$ ?v4 ?v5 ))(and (= ?v1 (lCons$b ?v6 ?v7 ))(and (= ?v2 (pair$ ?v4 ?v6 ))(= ?v3 (lzip$ ?v5 ?v7 )))))))):named a104 ))
(assert (! (forall ((?v0 A_b_prod_llist$ )(?v1 A_b_prod_llist$ )(?v2 A_b_prod_a_b_prod_prod$ )(?v3 A_b_prod_a_b_prod_prod_llist$ ))(= (= (lzip$a ?v0 ?v1 )(lCons$h ?v2 ?v3 ))(exists ((?v4 A_b_prod$ )(?v5 A_b_prod_llist$ )(?v6 A_b_prod$ )(?v7 A_b_prod_llist$ ))(and (= ?v0 (lCons$a ?v4 ?v5 ))(and (= ?v1 (lCons$a ?v6 ?v7 ))(and (= ?v2 (pair$c ?v4 ?v6 ))(= ?v3 (lzip$a ?v5 ?v7 )))))))):named a105 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A_a_prod$ )(?v3 A_a_prod_llist$ ))(= (= (lzip$b ?v0 ?v1 )(lCons$g ?v2 ?v3 ))(exists ((?v4 A$ )(?v5 A_llist$ )(?v6 A$ )(?v7 A_llist$ ))(and (= ?v0 (lCons$ ?v4 ?v5 ))(and (= ?v1 (lCons$ ?v6 ?v7 ))(and (= ?v2 (pair$f ?v4 ?v6 ))(= ?v3 (lzip$b ?v5 ?v7 )))))))):named a106 ))
(assert (! (forall ((?v0 B_llist$ )(?v1 A_llist$ )(?v2 B_a_prod$ )(?v3 B_a_prod_llist$ ))(= (= (lzip$c ?v0 ?v1 )(lCons$d ?v2 ?v3 ))(exists ((?v4 B$ )(?v5 B_llist$ )(?v6 A$ )(?v7 A_llist$ ))(and (= ?v0 (lCons$b ?v4 ?v5 ))(and (= ?v1 (lCons$ ?v6 ?v7 ))(and (= ?v2 (pair$b ?v4 ?v6 ))(= ?v3 (lzip$c ?v5 ?v7 )))))))):named a107 ))
(assert (! (forall ((?v0 B_llist$ )(?v1 B_llist$ )(?v2 B_b_prod$ )(?v3 B_b_prod_llist$ ))(= (= (lzip$d ?v0 ?v1 )(lCons$c ?v2 ?v3 ))(exists ((?v4 B$ )(?v5 B_llist$ )(?v6 B$ )(?v7 B_llist$ ))(and (= ?v0 (lCons$b ?v4 ?v5 ))(and (= ?v1 (lCons$b ?v6 ?v7 ))(and (= ?v2 (pair$a ?v4 ?v6 ))(= ?v3 (lzip$d ?v5 ?v7 )))))))):named a108 ))
(assert (! (forall ((?v0 A_b_prod_llist$ )(?v1 A_llist$ )(?v2 A_b_prod_a_prod$ )(?v3 A_b_prod_a_prod_llist$ ))(= (= (lzip$e ?v0 ?v1 )(lCons$i ?v2 ?v3 ))(exists ((?v4 A_b_prod$ )(?v5 A_b_prod_llist$ )(?v6 A$ )(?v7 A_llist$ ))(and (= ?v0 (lCons$a ?v4 ?v5 ))(and (= ?v1 (lCons$ ?v6 ?v7 ))(and (= ?v2 (pair$g ?v4 ?v6 ))(= ?v3 (lzip$e ?v5 ?v7 )))))))):named a109 ))
(assert (! (forall ((?v0 A_b_prod_llist$ )(?v1 B_llist$ )(?v2 A_b_prod_b_prod$ )(?v3 A_b_prod_b_prod_llist$ ))(= (= (lzip$f ?v0 ?v1 )(lCons$j ?v2 ?v3 ))(exists ((?v4 A_b_prod$ )(?v5 A_b_prod_llist$ )(?v6 B$ )(?v7 B_llist$ ))(and (= ?v0 (lCons$a ?v4 ?v5 ))(and (= ?v1 (lCons$b ?v6 ?v7 ))(and (= ?v2 (pair$h ?v4 ?v6 ))(= ?v3 (lzip$f ?v5 ?v7 )))))))):named a110 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_b_prod_llist$ )(?v2 A_a_b_prod_prod$ )(?v3 A_a_b_prod_prod_llist$ ))(= (= (lzip$g ?v0 ?v1 )(lCons$f ?v2 ?v3 ))(exists ((?v4 A$ )(?v5 A_llist$ )(?v6 A_b_prod$ )(?v7 A_b_prod_llist$ ))(and (= ?v0 (lCons$ ?v4 ?v5 ))(and (= ?v1 (lCons$a ?v6 ?v7 ))(and (= ?v2 (pair$e ?v4 ?v6 ))(= ?v3 (lzip$g ?v5 ?v7 )))))))):named a111 ))
(assert (! (forall ((?v0 B_llist$ )(?v1 A_b_prod_llist$ )(?v2 B_a_b_prod_prod$ )(?v3 B_a_b_prod_prod_llist$ ))(= (= (lzip$h ?v0 ?v1 )(lCons$k ?v2 ?v3 ))(exists ((?v4 B$ )(?v5 B_llist$ )(?v6 A_b_prod$ )(?v7 A_b_prod_llist$ ))(and (= ?v0 (lCons$b ?v4 ?v5 ))(and (= ?v1 (lCons$a ?v6 ?v7 ))(and (= ?v2 (pair$i ?v4 ?v6 ))(= ?v3 (lzip$h ?v5 ?v7 )))))))):named a112 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_b_prod_a_b_prod_prod_llist$ )(?v2 A_a_b_prod_a_b_prod_prod_prod$ )(?v3 A_a_b_prod_a_b_prod_prod_prod_llist$ ))(= (= (lzip$i ?v0 ?v1 )(lCons$e ?v2 ?v3 ))(exists ((?v4 A$ )(?v5 A_llist$ )(?v6 A_b_prod_a_b_prod_prod$ )(?v7 A_b_prod_a_b_prod_prod_llist$ ))(and (= ?v0 (lCons$ ?v4 ?v5 ))(and (= ?v1 (lCons$h ?v6 ?v7 ))(and (= ?v2 (pair$d ?v4 ?v6 ))(= ?v3 (lzip$i ?v5 ?v7 )))))))):named a113 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A$ ))(=> (and (lsetp$a ?v0 ?v1 )(and (forall ((?v2 A$ )(?v3 A_llist$ ))(=> (and (= ?v0 (lCons$ ?v2 ?v3 ))(= ?v1 ?v2 ))false ))(forall ((?v2 A_llist$ )(?v3 A$ )(?v4 A$ ))(=> (and (= ?v0 (lCons$ ?v4 ?v2 ))(and (= ?v1 ?v3 )(lsetp$a ?v2 ?v3 )))false ))))false )):named a114 ))
(assert (! (forall ((?v0 A_b_prod_a_b_prod_prod_llist$ )(?v1 A_b_prod_a_b_prod_prod$ ))(=> (and (lsetp$b ?v0 ?v1 )(and (forall ((?v2 A_b_prod_a_b_prod_prod$ )(?v3 A_b_prod_a_b_prod_prod_llist$ ))(=> (and (= ?v0 (lCons$h ?v2 ?v3 ))(= ?v1 ?v2 ))false ))(forall ((?v2 A_b_prod_a_b_prod_prod_llist$ )(?v3 A_b_prod_a_b_prod_prod$ )(?v4 A_b_prod_a_b_prod_prod$ ))(=> (and (= ?v0 (lCons$h ?v4 ?v2 ))(and (= ?v1 ?v3 )(lsetp$b ?v2 ?v3 )))false ))))false )):named a115 ))
(assert (! (forall ((?v0 B_llist$ )(?v1 B$ ))(=> (and (lsetp$c ?v0 ?v1 )(and (forall ((?v2 B$ )(?v3 B_llist$ ))(=> (and (= ?v0 (lCons$b ?v2 ?v3 ))(= ?v1 ?v2 ))false ))(forall ((?v2 B_llist$ )(?v3 B$ )(?v4 B$ ))(=> (and (= ?v0 (lCons$b ?v4 ?v2 ))(and (= ?v1 ?v3 )(lsetp$c ?v2 ?v3 )))false ))))false )):named a116 ))
(assert (! (forall ((?v0 A_b_prod_llist$ )(?v1 A_b_prod$ ))(=> (and (lsetp$ ?v0 ?v1 )(and (forall ((?v2 A_b_prod$ )(?v3 A_b_prod_llist$ ))(=> (and (= ?v0 (lCons$a ?v2 ?v3 ))(= ?v1 ?v2 ))false ))(forall ((?v2 A_b_prod_llist$ )(?v3 A_b_prod$ )(?v4 A_b_prod$ ))(=> (and (= ?v0 (lCons$a ?v4 ?v2 ))(and (= ?v1 ?v3 )(lsetp$ ?v2 ?v3 )))false ))))false )):named a117 ))
(check-sat )
;(get-unsat-core )
