...
(declare-codatatypes ()((Nat_nat_prod_llist$ (lNil$c )(lCons$c (lhd$c Nat_nat_prod$ )(ltl$c Nat_nat_prod_llist$ )))))
...
(declare-codatatypes ()((Nat_a_prod_llist$ (lNil$d )(lCons$d (lhd$d Nat_a_prod$ )(ltl$d Nat_a_prod_llist$ )))))
...
(declare-codatatypes ()((Nat_nat_nat_prod_prod_llist$ (lNil$f )(lCons$f (lhd$f Nat_nat_nat_prod_prod$ )(ltl$f Nat_nat_nat_prod_prod_llist$ )))))
...
(declare-codatatypes ()((Nat_a_nat_prod_prod_llist$ (lNil$g )(lCons$g (lhd$g Nat_a_nat_prod_prod$ )(ltl$g Nat_a_nat_prod_prod_llist$ )))))
...
(declare-codatatypes ()((Nat_nat_prod_nat_prod_llist$ (lNil$h )(lCons$h (lhd$h Nat_nat_prod_nat_prod$ )(ltl$h Nat_nat_prod_nat_prod_llist$ )))))
...
(declare-codatatypes ()((Nat_nat_prod_a_prod_llist$ (lNil$i )(lCons$i (lhd$i Nat_nat_prod_a_prod$ )(ltl$i Nat_nat_prod_a_prod_llist$ )))))
...
(declare-codatatypes ()((A_nat_prod_nat_prod_llist$ (lNil$j )(lCons$j (lhd$j A_nat_prod_nat_prod$ )(ltl$j A_nat_prod_nat_prod_llist$ )))))
...
(declare-fun fst$j (A_nat_nat_prod_prod$)A$)
(declare-fun snd$j (A_nat_nat_prod_prod$)Nat_nat_prod$)
(declare-fun pair$j (A$ Nat_nat_prod$ )A_nat_nat_prod_prod$)
(declare-codatatypes ()((A_nat_nat_prod_prod_llist$ (lNil$l )(lCons$l (lhd$l A_nat_nat_prod_prod$ )(ltl$l A_nat_nat_prod_prod_llist$ )))))
...
(declare-codatatypes ()((A_a_nat_prod_prod_llist$ (lNil$m )(lCons$m (lhd$m A_a_nat_prod_prod$ )(ltl$m A_a_nat_prod_prod_llist$ )))))
(declare-fun k$ ()Nat$ )
