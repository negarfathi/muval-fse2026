...
(declare-codatatypes ()((A_b_prod_llist$ (lNil$ )(lCons$ (lhd$ A_b_prod$ )(ltl$ A_b_prod_llist$ )))(A_llist$ (lNil$a )(lCons$a (lhd$a A$ )(ltl$a A_llist$ )))(B_llist$ (lNil$b )(lCons$b (lhd$b B$ )(ltl$b B_llist$ )))(C_llist$ (lNil$c )(lCons$c (lhd$c C$ )(ltl$c C_llist$ )))(D_llist$ (lNil$d )(lCons$d (lhd$d D$ )(ltl$d D_llist$ )))))
(declare-sort C_d_prod$ 0)
(declare-fun fst$a (C_d_prod$)C$)
(declare-fun snd$a (C_d_prod$)D$)
(declare-fun pair$a (C$ D$ )C_d_prod$)
(declare-codatatypes ()((C_d_prod_llist$ (lNil$e )(lCons$e (lhd$e C_d_prod$ )(ltl$e C_d_prod_llist$ )))))
