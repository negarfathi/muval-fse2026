...
(assert (! (exists ((?v0 A_llist$ ))(= ys$ (lappend$ xs$ ?v0 ))):named a1 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A_llist$ ))(=> (fun_app$ (fun_app$a lprefix$ ?v0 )?v1 )(fun_app$ (fun_app$a lprefix$ (lappend$ ?v2 ?v0 ))(lappend$ ?v2 ?v1 )))):named a9 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(fun_app$ (fun_app$a lprefix$ ?v0 )(lappend$ ?v0 ?v1 ))):named a10 ))
...
(assert (! (transp$ lprefix$ ):named a12 ))
...
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ ))(fun_app$ (fun_app$a lprefix$ (ltake$ ?v0 ?v1 ))?v1 )):named a15 ))
