...
(declare-codatatypes ()((A_list_llist$ (lNil$b )(lCons$b (lhd$b A_list$ )(ltl$b A_list_llist$ )))(A_llist_llist_llist$ (lNil$c )(lCons$c (lhd$c A_llist_llist$ )(ltl$c A_llist_llist_llist$ )))(A_list_llist_llist$ (lNil$d )(lCons$d (lhd$d A_list_llist$ )(ltl$d A_list_llist_llist$ )))(A_llist_llist_llist_llist$ (lNil$e )(lCons$e (lhd$e A_llist_llist_llist$ )(ltl$e A_llist_llist_llist_llist$ )))))
