...
(assert (! (not (fun_app$ (fun_app$a lprefix$ (fun_app$b (lfilter$ p$ )xs$ ))(fun_app$b (lfilter$ p$ )ys$ ))):named a0 ))
...
(assert (! (forall ((?v0 A_bool_fun$ )(?v1 A$ )(?v2 A_llist$ ))(! (= (fun_app$b (lfilter$ ?v0 )(lCons$ ?v1 ?v2 ))(ite (fun_app$c ?v0 ?v1 )(lCons$ ?v1 (fun_app$b (lfilter$ ?v0 )?v2 ))(fun_app$b (lfilter$ ?v0 )?v2 ))):pattern ((fun_app$b (lfilter$ ?v0 )(lCons$ ?v1 ?v2 ))))):named a14 ))
(assert (! (transp$ lprefix$ ):named a15 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_bool_fun$ ))(=> (ldistinct$ ?v0 )(ldistinct$ (fun_app$b (lfilter$ ?v1 )?v0 )))):named a16 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$ (fun_app$a lprefix$ lNil$ )?v0 )true ):pattern ((fun_app$ (fun_app$a lprefix$ lNil$ )?v0 )))):named a17 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(! (= (fun_app$ (fun_app$a lprefix$ (lCons$ ?v0 ?v1 ))(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(fun_app$ (fun_app$a lprefix$ ?v1 )?v3 ))):pattern ((fun_app$ (fun_app$a lprefix$ (lCons$ ?v0 ?v1 ))(lCons$ ?v2 ?v3 ))))):named a18 ))
(check-sat )
;(get-unsat-core )
