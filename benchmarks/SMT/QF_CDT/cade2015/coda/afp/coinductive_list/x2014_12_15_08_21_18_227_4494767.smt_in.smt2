...
(declare-fun fst$m (A_a_a_b_prod_prod_prod$)A$)
(declare-fun snd$m (A_a_a_b_prod_prod_prod$)A_a_b_prod_prod$)
(declare-fun pair$m (A$ A_a_b_prod_prod$ )A_a_a_b_prod_prod_prod$)
