...
(assert (! (not (= (fun_app$ (ldrop$ (eSuc$ n$ ))xs$ )(ltl$ (fun_app$ (ldrop$ n$ )xs$ )))):named a0 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ ))(= (= (eSuc$ ?v0 )(eSuc$ ?v1 ))(= ?v0 ?v1 ))):named a1 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ ))(= (= (eSuc$ ?v0 )(eSuc$ ?v1 ))(= ?v0 ?v1 ))):named a2 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A$ )(?v2 A_llist$ ))(= (fun_app$ (ldrop$ (eSuc$ ?v0 ))(lCons$ ?v1 ?v2 ))(fun_app$ (ldrop$ ?v0 )?v2 ))):named a3 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A$ ))(= (ltl$ (iterates$ ?v0 ?v1 ))(iterates$ ?v0 (fun_app$a ?v0 ?v1 )))):named a4 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ ))(= (fun_app$ (ltake$ ?v0 )(ltl$ ?v1 ))(ltl$ (fun_app$ (ltake$ (eSuc$ ?v0 ))?v1 )))):named a5 ))
...
(assert (! (forall ((?v0 Enat$ ))(! (= (fun_app$ (ltake$ ?v0 )lNil$ )lNil$ ):pattern ((ltake$ ?v0 )))):named a15 ))
(check-sat )
;(get-unsat-core )
