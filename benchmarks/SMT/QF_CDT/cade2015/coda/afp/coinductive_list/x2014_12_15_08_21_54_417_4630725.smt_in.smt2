...
(declare-fun lzip$c (A_llist$ A_b_prod_a_b_prod_prod_llist$ )A_a_b_prod_a_b_prod_prod_prod_llist$ )
...
(declare-fun lzip$h (A_b_prod_llist$ A_llist$ )A_b_prod_a_prod_llist$ )
...
(declare-fun lmember$ (A_b_prod_a_b_prod_prod$ )A_b_prod_a_b_prod_prod_llist_bool_fun$ )
...
(assert (! (forall ((?v0 A_llist$ )(?v1 B_llist$ ))(=> (= zs$ (lzip$ ?v0 ?v1 ))(member$ y$ (lset$ ?v1 )))):named a3 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_a_llist_bool_fun_fun$ ))(=> (and (member$h ?v0 (lset$h ?v1 ))(and (forall ((?v3 A$ )(?v4 A_llist$ ))(fun_app$l (fun_app$m ?v2 ?v3 )(lCons$b ?v3 ?v4 )))(forall ((?v3 A$ )(?v4 A_llist$ )(?v5 A$ ))(=> (and (member$h ?v5 (lset$h ?v4 ))(fun_app$l (fun_app$m ?v2 ?v5 )?v4 ))(fun_app$l (fun_app$m ?v2 ?v5 )(lCons$b ?v3 ?v4 ))))))(fun_app$l (fun_app$m ?v2 ?v0 )?v1 ))):named a11 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B_b_llist_bool_fun_fun$ ))(=> (and (member$ ?v0 (lset$ ?v1 ))(and (forall ((?v3 B$ )(?v4 B_llist$ ))(fun_app$n (fun_app$o ?v2 ?v3 )(lCons$ ?v3 ?v4 )))(forall ((?v3 B$ )(?v4 B_llist$ )(?v5 B$ ))(=> (and (member$ ?v5 (lset$ ?v4 ))(fun_app$n (fun_app$o ?v2 ?v5 )?v4 ))(fun_app$n (fun_app$o ?v2 ?v5 )(lCons$ ?v3 ?v4 ))))))(fun_app$n (fun_app$o ?v2 ?v0 )?v1 ))):named a12 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(=> (and (member$h ?v0 (lset$h ?v1 ))(and (forall ((?v2 A_llist$ ))(=> (= ?v1 (lCons$b ?v0 ?v2 ))false ))(forall ((?v2 A$ )(?v3 A_llist$ ))(=> (and (= ?v1 (lCons$b ?v2 ?v3 ))(member$h ?v0 (lset$h ?v3 )))false ))))false )):named a20 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ ))(=> (and (member$ ?v0 (lset$ ?v1 ))(and (forall ((?v2 B_llist$ ))(=> (= ?v1 (lCons$ ?v0 ?v2 ))false ))(forall ((?v2 B$ )(?v3 B_llist$ ))(=> (and (= ?v1 (lCons$ ?v2 ?v3 ))(member$ ?v0 (lset$ ?v3 )))false ))))false )):named a21 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist_bool_fun$ ))(=> (and (member$h ?v0 (lset$h ?v1 ))(and (forall ((?v3 A_llist$ ))(fun_app$l ?v2 (lCons$b ?v0 ?v3 )))(forall ((?v3 A$ )(?v4 A_llist$ ))(=> (and (member$h ?v0 (lset$h ?v4 ))(fun_app$l ?v2 ?v4 ))(fun_app$l ?v2 (lCons$b ?v3 ?v4 ))))))(fun_app$l ?v2 ?v1 ))):named a29 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B_llist_bool_fun$ ))(=> (and (member$ ?v0 (lset$ ?v1 ))(and (forall ((?v3 B_llist$ ))(fun_app$n ?v2 (lCons$ ?v0 ?v3 )))(forall ((?v3 B$ )(?v4 B_llist$ ))(=> (and (member$ ?v0 (lset$ ?v4 ))(fun_app$n ?v2 ?v4 ))(fun_app$n ?v2 (lCons$ ?v3 ?v4 ))))))(fun_app$n ?v2 ?v1 ))):named a30 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist_bool_fun$ ))(=> (and (member$h ?v0 (lset$h ?v1 ))(and (forall ((?v3 A_llist$ ))(fun_app$l ?v2 (lCons$b ?v0 ?v3 )))(forall ((?v3 A$ )(?v4 A_llist$ ))(=> (and (member$h ?v0 (lset$h ?v4 ))(and (not (= ?v0 ?v3 ))(fun_app$l ?v2 ?v4 )))(fun_app$l ?v2 (lCons$b ?v3 ?v4 ))))))(fun_app$l ?v2 ?v1 ))):named a38 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B_llist_bool_fun$ ))(=> (and (member$ ?v0 (lset$ ?v1 ))(and (forall ((?v3 B_llist$ ))(fun_app$n ?v2 (lCons$ ?v0 ?v3 )))(forall ((?v3 B$ )(?v4 B_llist$ ))(=> (and (member$ ?v0 (lset$ ?v4 ))(and (not (= ?v0 ?v3 ))(fun_app$n ?v2 ?v4 )))(fun_app$n ?v2 (lCons$ ?v3 ?v4 ))))))(fun_app$n ?v2 ?v1 ))):named a39 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(=> (and (member$h ?v0 (lset$h ?v1 ))(and (forall ((?v2 A_llist$ ))(=> (= ?v1 (lCons$b ?v0 ?v2 ))false ))(forall ((?v2 A$ )(?v3 A_llist$ ))(=> (and (= ?v1 (lCons$b ?v2 ?v3 ))(member$h ?v0 (lset$h ?v3 )))false ))))false )):named a47 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ ))(=> (and (member$ ?v0 (lset$ ?v1 ))(and (forall ((?v2 B_llist$ ))(=> (= ?v1 (lCons$ ?v0 ?v2 ))false ))(forall ((?v2 B$ )(?v3 B_llist$ ))(=> (and (= ?v1 (lCons$ ?v2 ?v3 ))(member$ ?v0 (lset$ ?v3 )))false ))))false )):named a48 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ ))(=> (member$h ?v0 (lset$h ?v1 ))(member$h ?v0 (lset$h (lCons$b ?v2 ?v1 ))))):named a56 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B$ ))(=> (member$ ?v0 (lset$ ?v1 ))(member$ ?v0 (lset$ (lCons$ ?v2 ?v1 ))))):named a57 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ ))(=> (member$h ?v0 (lset$h ?v1 ))(member$h ?v0 (lset$h (lCons$b ?v2 ?v1 ))))):named a65 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B$ ))(=> (member$ ?v0 (lset$ ?v1 ))(member$ ?v0 (lset$ (lCons$ ?v2 ?v1 ))))):named a66 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(member$h ?v0 (lset$h (lCons$b ?v0 ?v1 )))):named a74 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ ))(member$ ?v0 (lset$ (lCons$ ?v0 ?v1 )))):named a75 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(member$h ?v0 (lset$h (lCons$b ?v0 ?v1 )))):named a83 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ ))(member$ ?v0 (lset$ (lCons$ ?v0 ?v1 )))):named a84 ))
...
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B$ )(?v3 B_llist$ ))(= (= (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a91 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(= (= (lCons$b ?v0 ?v1 )(lCons$b ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a93 ))
...
(assert (! (forall ((?v0 A_b_prod_a_b_prod_prod$ )(?v1 A_b_prod_a_b_prod_prod_llist$ ))(= (member$g ?v0 (lset$g ?v1 ))(fun_app$j (lmember$ ?v0 )?v1 ))):named a95 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(= (member$h ?v0 (lset$h ?v1 ))(fun_app$l (lmember$a ?v0 )?v1 ))):named a96 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ ))(= (member$ ?v0 (lset$ ?v1 ))(fun_app$n (lmember$b ?v0 )?v1 ))):named a97 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ ))(= (member$a ?v0 (lset$a ?v1 ))(fun_app$p (lmember$c ?v0 )?v1 ))):named a98 ))
(assert (! (forall ((?v0 B$ )(?v1 B$ )(?v2 B_llist$ )(?v3 B_llist$ ))(=> (member$b (pair$a ?v0 ?v1 )(lset$b (lzip$a ?v2 ?v3 )))(member$ ?v0 (lset$ ?v2 )))):named a99 ))
(assert (! (forall ((?v0 B$ )(?v1 A$ )(?v2 B_llist$ )(?v3 A_llist$ ))(=> (member$c (pair$b ?v0 ?v1 )(lset$c (lzip$b ?v2 ?v3 )))(member$ ?v0 (lset$ ?v2 )))):named a100 ))
(assert (! (forall ((?v0 A$ )(?v1 A_b_prod_a_b_prod_prod$ )(?v2 A_llist$ )(?v3 A_b_prod_a_b_prod_prod_llist$ ))(=> (member$d (pair$d ?v0 ?v1 )(lset$d (lzip$c ?v2 ?v3 )))(member$h ?v0 (lset$h ?v2 )))):named a101 ))
(assert (! (forall ((?v0 A$ )(?v1 A_b_prod$ )(?v2 A_llist$ )(?v3 A_b_prod_llist$ ))(=> (member$e (pair$e ?v0 ?v1 )(lset$e (lzip$d ?v2 ?v3 )))(member$h ?v0 (lset$h ?v2 )))):named a102 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ )(?v2 A_llist$ )(?v3 A_llist$ ))(=> (member$f (pair$f ?v0 ?v1 )(lset$f (lzip$e ?v2 ?v3 )))(member$h ?v0 (lset$h ?v2 )))):named a103 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod$ )(?v2 A_b_prod_llist$ )(?v3 A_b_prod_llist$ ))(=> (member$g (pair$c ?v0 ?v1 )(lset$g (lzip$f ?v2 ?v3 )))(member$a ?v0 (lset$a ?v2 )))):named a104 ))
(assert (! (forall ((?v0 A$ )(?v1 B$ )(?v2 A_llist$ )(?v3 B_llist$ ))(=> (member$a (pair$ ?v0 ?v1 )(lset$a (lzip$ ?v2 ?v3 )))(member$h ?v0 (lset$h ?v2 )))):named a105 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 B$ )(?v3 B_llist$ ))(! (= (lzip$ (lCons$b ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(lCons$a (pair$ ?v0 ?v2 )(lzip$ ?v1 ?v3 ))):pattern ((lzip$ (lCons$b ?v0 ?v1 )(lCons$ ?v2 ?v3 ))))):named a106 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ )(?v2 A_b_prod$ )(?v3 A_b_prod_llist$ ))(! (= (lzip$f (lCons$a ?v0 ?v1 )(lCons$a ?v2 ?v3 ))(lCons$h (pair$c ?v0 ?v2 )(lzip$f ?v1 ?v3 ))):pattern ((lzip$f (lCons$a ?v0 ?v1 )(lCons$a ?v2 ?v3 ))))):named a107 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B$ )(?v3 B_llist$ ))(! (= (lzip$a (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(lCons$c (pair$a ?v0 ?v2 )(lzip$a ?v1 ?v3 ))):pattern ((lzip$a (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))))):named a108 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 A$ )(?v3 A_llist$ ))(! (= (lzip$b (lCons$ ?v0 ?v1 )(lCons$b ?v2 ?v3 ))(lCons$d (pair$b ?v0 ?v2 )(lzip$b ?v1 ?v3 ))):pattern ((lzip$b (lCons$ ?v0 ?v1 )(lCons$b ?v2 ?v3 ))))):named a109 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(! (= (lzip$e (lCons$b ?v0 ?v1 )(lCons$b ?v2 ?v3 ))(lCons$g (pair$f ?v0 ?v2 )(lzip$e ?v1 ?v3 ))):pattern ((lzip$e (lCons$b ?v0 ?v1 )(lCons$b ?v2 ?v3 ))))):named a110 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ )(?v2 B$ )(?v3 B_llist$ ))(! (= (lzip$g (lCons$a ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(lCons$i (pair$g ?v0 ?v2 )(lzip$g ?v1 ?v3 ))):pattern ((lzip$g (lCons$a ?v0 ?v1 )(lCons$ ?v2 ?v3 ))))):named a111 ))
(assert (! (forall ((?v0 A_b_prod$ )(?v1 A_b_prod_llist$ )(?v2 A$ )(?v3 A_llist$ ))(! (= (lzip$h (lCons$a ?v0 ?v1 )(lCons$b ?v2 ?v3 ))(lCons$j (pair$h ?v0 ?v2 )(lzip$h ?v1 ?v3 ))):pattern ((lzip$h (lCons$a ?v0 ?v1 )(lCons$b ?v2 ?v3 ))))):named a112 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 A_b_prod$ )(?v3 A_b_prod_llist$ ))(! (= (lzip$i (lCons$ ?v0 ?v1 )(lCons$a ?v2 ?v3 ))(lCons$k (pair$i ?v0 ?v2 )(lzip$i ?v1 ?v3 ))):pattern ((lzip$i (lCons$ ?v0 ?v1 )(lCons$a ?v2 ?v3 ))))):named a113 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_b_prod$ )(?v3 A_b_prod_llist$ ))(! (= (lzip$d (lCons$b ?v0 ?v1 )(lCons$a ?v2 ?v3 ))(lCons$f (pair$e ?v0 ?v2 )(lzip$d ?v1 ?v3 ))):pattern ((lzip$d (lCons$b ?v0 ?v1 )(lCons$a ?v2 ?v3 ))))):named a114 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 A_b_prod_a_b_prod_prod$ )(?v3 A_b_prod_a_b_prod_prod_llist$ ))(! (= (lzip$j (lCons$ ?v0 ?v1 )(lCons$h ?v2 ?v3 ))(lCons$l (pair$j ?v0 ?v2 )(lzip$j ?v1 ?v3 ))):pattern ((lzip$j (lCons$ ?v0 ?v1 )(lCons$h ?v2 ?v3 ))))):named a115 ))
(check-sat )
;(get-unsat-core )
