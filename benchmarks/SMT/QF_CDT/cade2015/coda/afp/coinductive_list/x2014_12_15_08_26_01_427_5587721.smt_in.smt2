...
(declare-fun fun_app$i (A_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun$ A_a_prod_a_a_prod_prod$ )A_a_prod_a_a_prod_prod$ )
(declare-fun fun_app$j (A_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun_a_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun_fun$ A_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun$ )A_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun$ )
(declare-fun fun_app$k (A_a_prod_a_prod_a_a_prod_a_prod_fun$ A_a_prod_a_prod$ )A_a_prod_a_prod$ )
(declare-fun fun_app$l (A_a_prod_a_prod_a_a_prod_a_prod_fun_a_a_prod_a_prod_a_a_prod_a_prod_fun_fun$ A_a_prod_a_prod_a_a_prod_a_prod_fun$ )A_a_prod_a_prod_a_a_prod_a_prod_fun$ )
(declare-fun fun_app$m (A_a_a_prod_prod_a_a_a_prod_prod_fun$ A_a_a_prod_prod$ )A_a_a_prod_prod$ )
(declare-fun fun_app$n (A_a_a_prod_prod_a_a_a_prod_prod_fun_a_a_a_prod_prod_a_a_a_prod_prod_fun_fun$ A_a_a_prod_prod_a_a_a_prod_prod_fun$ )A_a_a_prod_prod_a_a_a_prod_prod_fun$ )
(declare-fun fun_app$o (A_a_prod_a_a_prod_fun$ A_a_prod$ )A_a_prod$ )
(declare-fun fun_app$p (A_a_prod_a_a_prod_fun_a_a_prod_a_a_prod_fun_fun$ A_a_prod_a_a_prod_fun$ )A_a_prod_a_a_prod_fun$ )
...
(assert (! (not (= (llast$ (fun_app$ (ldrop$ (enat$ n$ ))xs$ ))(llast$ xs$ ))):named a0 ))
...
(assert (! (less$ n$a (llength$ xs$ )):named a4 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(! (= (fun_app$a (ldrop$a (enat$ ?v0 ))?v1 )(ldropn$ ?v0 ?v1 )):pattern ((fun_app$a (ldrop$a (enat$ ?v0 ))?v1 )))):named a5 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_a_prod_llist$ ))(! (= (fun_app$b (ldrop$b (enat$ ?v0 ))?v1 )(ldropn$a ?v0 ?v1 )):pattern ((fun_app$b (ldrop$b (enat$ ?v0 ))?v1 )))):named a6 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_a_prod_prod_llist$ ))(! (= (fun_app$c (ldrop$c (enat$ ?v0 ))?v1 )(ldropn$b ?v0 ?v1 )):pattern ((fun_app$c (ldrop$c (enat$ ?v0 ))?v1 )))):named a7 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_llist$ ))(! (= (fun_app$d (ldrop$d (enat$ ?v0 ))?v1 )(ldropn$c ?v0 ?v1 )):pattern ((fun_app$d (ldrop$d (enat$ ?v0 ))?v1 )))):named a8 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_llist$ ))(! (= (fun_app$ (ldrop$ (enat$ ?v0 ))?v1 )(ldropn$d ?v0 ?v1 )):pattern ((fun_app$ (ldrop$ (enat$ ?v0 ))?v1 )))):named a9 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_llist$ ))(= (fun_app$a (ldrop$a zero$ )?v0 )?v0 )):named a10 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$ ))(= (fun_app$b (ldrop$b zero$ )?v0 )?v0 )):named a11 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$ ))(= (fun_app$c (ldrop$c zero$ )?v0 )?v0 )):named a12 ))
(assert (! (forall ((?v0 A_a_prod_llist$ ))(= (fun_app$d (ldrop$d zero$ )?v0 )?v0 )):named a13 ))
(assert (! (forall ((?v0 A_llist$ ))(= (fun_app$ (ldrop$ zero$ )?v0 )?v0 )):named a14 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ )(?v2 A_llist$ ))(! (= (llast$ (lCons$ ?v0 (lCons$ ?v1 ?v2 )))(llast$ (lCons$ ?v1 ?v2 ))):pattern ((lCons$ ?v0 (lCons$ ?v1 ?v2 ))))):named a15 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ )(?v2 A_a_prod_a_a_prod_prod_llist$ ))(= (fun_app$a (ldrop$a ?v0 )(fun_app$a (ldrop$a ?v1 )?v2 ))(fun_app$a (ldrop$a (plus$ ?v0 ?v1 ))?v2 ))):named a16 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ )(?v2 A_a_prod_a_prod_llist$ ))(= (fun_app$b (ldrop$b ?v0 )(fun_app$b (ldrop$b ?v1 )?v2 ))(fun_app$b (ldrop$b (plus$ ?v0 ?v1 ))?v2 ))):named a17 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ )(?v2 A_a_a_prod_prod_llist$ ))(= (fun_app$c (ldrop$c ?v0 )(fun_app$c (ldrop$c ?v1 )?v2 ))(fun_app$c (ldrop$c (plus$ ?v0 ?v1 ))?v2 ))):named a18 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ )(?v2 A_a_prod_llist$ ))(= (fun_app$d (ldrop$d ?v0 )(fun_app$d (ldrop$d ?v1 )?v2 ))(fun_app$d (ldrop$d (plus$ ?v0 ?v1 ))?v2 ))):named a19 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ )(?v2 A_llist$ ))(= (fun_app$ (ldrop$ ?v0 )(fun_app$ (ldrop$ ?v1 )?v2 ))(fun_app$ (ldrop$ (plus$ ?v0 ?v1 ))?v2 ))):named a20 ))
(assert (! (forall ((?v0 Enat$ ))(! (= (fun_app$a (ldrop$a ?v0 )lNil$a )lNil$a ):pattern ((ldrop$a ?v0 )))):named a21 ))
(assert (! (forall ((?v0 Enat$ ))(! (= (fun_app$b (ldrop$b ?v0 )lNil$b )lNil$b ):pattern ((ldrop$b ?v0 )))):named a22 ))
(assert (! (forall ((?v0 Enat$ ))(! (= (fun_app$c (ldrop$c ?v0 )lNil$c )lNil$c ):pattern ((ldrop$c ?v0 )))):named a23 ))
(assert (! (forall ((?v0 Enat$ ))(! (= (fun_app$d (ldrop$d ?v0 )lNil$d )lNil$d ):pattern ((ldrop$d ?v0 )))):named a24 ))
(assert (! (forall ((?v0 Enat$ ))(! (= (fun_app$ (ldrop$ ?v0 )lNil$ )lNil$ ):pattern ((ldrop$ ?v0 )))):named a25 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ )(?v2 A_llist$ ))(= (fun_app$d (ldrop$d ?v0 )(fun_app$e (lzip$ ?v1 )?v2 ))(fun_app$e (lzip$ (fun_app$ (ldrop$ ?v0 )?v1 ))(fun_app$ (ldrop$ ?v0 )?v2 )))):named a26 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ )(?v2 A_a_prod_llist$ ))(= (fun_app$c (ldrop$c ?v0 )(fun_app$f (lzip$a ?v1 )?v2 ))(fun_app$f (lzip$a (fun_app$ (ldrop$ ?v0 )?v1 ))(fun_app$d (ldrop$d ?v0 )?v2 )))):named a27 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_prod_llist$ )(?v2 A_llist$ ))(= (fun_app$b (ldrop$b ?v0 )(fun_app$g (lzip$b ?v1 )?v2 ))(fun_app$g (lzip$b (fun_app$d (ldrop$d ?v0 )?v1 ))(fun_app$ (ldrop$ ?v0 )?v2 )))):named a28 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_prod_llist$ )(?v2 A_a_prod_llist$ ))(= (fun_app$a (ldrop$a ?v0 )(fun_app$h (lzip$c ?v1 )?v2 ))(fun_app$h (lzip$c (fun_app$d (ldrop$d ?v0 )?v1 ))(fun_app$d (ldrop$d ?v0 )?v2 )))):named a29 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ )(?v2 A_a_prod_a_prod_llist$ ))(= (ldrop$e ?v0 (lzip$d ?v1 ?v2 ))(lzip$d (fun_app$ (ldrop$ ?v0 )?v1 )(fun_app$b (ldrop$b ?v0 )?v2 )))):named a30 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ )(?v2 A_a_a_prod_prod_llist$ ))(= (ldrop$f ?v0 (lzip$e ?v1 ?v2 ))(lzip$e (fun_app$ (ldrop$ ?v0 )?v1 )(fun_app$c (ldrop$c ?v0 )?v2 )))):named a31 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_prod_a_prod_llist$ )(?v2 A_llist$ ))(= (ldrop$g ?v0 (lzip$f ?v1 ?v2 ))(lzip$f (fun_app$b (ldrop$b ?v0 )?v1 )(fun_app$ (ldrop$ ?v0 )?v2 )))):named a32 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_a_prod_prod_llist$ )(?v2 A_llist$ ))(= (ldrop$h ?v0 (lzip$g ?v1 ?v2 ))(lzip$g (fun_app$c (ldrop$c ?v0 )?v1 )(fun_app$ (ldrop$ ?v0 )?v2 )))):named a33 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ )(?v2 A_a_prod_a_a_prod_prod_llist$ ))(= (ldrop$i ?v0 (lzip$h ?v1 ?v2 ))(lzip$h (fun_app$ (ldrop$ ?v0 )?v1 )(fun_app$a (ldrop$a ?v0 )?v2 )))):named a34 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_prod_llist$ )(?v2 A_a_prod_a_prod_llist$ ))(= (ldrop$j ?v0 (lzip$i ?v1 ?v2 ))(lzip$i (fun_app$d (ldrop$d ?v0 )?v1 )(fun_app$b (ldrop$b ?v0 )?v2 )))):named a35 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_fun$ )(?v2 A_llist$ ))(= (fun_app$ (ldrop$ ?v0 )(lmap$ ?v1 ?v2 ))(lmap$ ?v1 (fun_app$ (ldrop$ ?v0 )?v2 )))):named a36 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_prod_a_fun$ )(?v2 A_a_prod_llist$ ))(= (fun_app$ (ldrop$ ?v0 )(lmap$a ?v1 ?v2 ))(lmap$a ?v1 (fun_app$d (ldrop$d ?v0 )?v2 )))):named a37 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_a_prod_fun$ )(?v2 A_llist$ ))(= (fun_app$d (ldrop$d ?v0 )(lmap$b ?v1 ?v2 ))(lmap$b ?v1 (fun_app$ (ldrop$ ?v0 )?v2 )))):named a38 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_prod_a_a_prod_fun$ )(?v2 A_a_prod_llist$ ))(= (fun_app$d (ldrop$d ?v0 )(lmap$c ?v1 ?v2 ))(lmap$c ?v1 (fun_app$d (ldrop$d ?v0 )?v2 )))):named a39 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_prod_a_prod_a_fun$ )(?v2 A_a_prod_a_prod_llist$ ))(= (fun_app$ (ldrop$ ?v0 )(lmap$d ?v1 ?v2 ))(lmap$d ?v1 (fun_app$b (ldrop$b ?v0 )?v2 )))):named a40 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_a_prod_prod_a_fun$ )(?v2 A_a_a_prod_prod_llist$ ))(= (fun_app$ (ldrop$ ?v0 )(lmap$e ?v1 ?v2 ))(lmap$e ?v1 (fun_app$c (ldrop$c ?v0 )?v2 )))):named a41 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_a_prod_a_prod_fun$ )(?v2 A_llist$ ))(= (fun_app$b (ldrop$b ?v0 )(lmap$f ?v1 ?v2 ))(lmap$f ?v1 (fun_app$ (ldrop$ ?v0 )?v2 )))):named a42 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_a_a_prod_prod_fun$ )(?v2 A_llist$ ))(= (fun_app$c (ldrop$c ?v0 )(lmap$g ?v1 ?v2 ))(lmap$g ?v1 (fun_app$ (ldrop$ ?v0 )?v2 )))):named a43 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_prod_a_a_prod_prod_a_fun$ )(?v2 A_a_prod_a_a_prod_prod_llist$ ))(= (fun_app$ (ldrop$ ?v0 )(lmap$h ?v1 ?v2 ))(lmap$h ?v1 (fun_app$a (ldrop$a ?v0 )?v2 )))):named a44 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_a_prod_a_prod_a_a_prod_fun$ )(?v2 A_a_prod_a_prod_llist$ ))(= (fun_app$d (ldrop$d ?v0 )(lmap$i ?v1 ?v2 ))(lmap$i ?v1 (fun_app$b (ldrop$b ?v0 )?v2 )))):named a45 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun$ )(?v2 A_a_prod_a_a_prod_prod$ ))(= (fun_app$a (ldrop$a (enat$ ?v0 ))(iterates$ ?v1 ?v2 ))(iterates$ ?v1 (fun_app$i (fun_app$j (compow$ ?v0 )?v1 )?v2 )))):named a46 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_a_prod_a_a_prod_a_prod_fun$ )(?v2 A_a_prod_a_prod$ ))(= (fun_app$b (ldrop$b (enat$ ?v0 ))(iterates$a ?v1 ?v2 ))(iterates$a ?v1 (fun_app$k (fun_app$l (compow$a ?v0 )?v1 )?v2 )))):named a47 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_a_prod_prod_a_a_a_prod_prod_fun$ )(?v2 A_a_a_prod_prod$ ))(= (fun_app$c (ldrop$c (enat$ ?v0 ))(iterates$b ?v1 ?v2 ))(iterates$b ?v1 (fun_app$m (fun_app$n (compow$b ?v0 )?v1 )?v2 )))):named a48 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_a_a_prod_fun$ )(?v2 A_a_prod$ ))(= (fun_app$d (ldrop$d (enat$ ?v0 ))(iterates$c ?v1 ?v2 ))(iterates$c ?v1 (fun_app$o (fun_app$p (compow$c ?v0 )?v1 )?v2 )))):named a49 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_fun$ )(?v2 A$ ))(= (fun_app$ (ldrop$ (enat$ ?v0 ))(iterates$d ?v1 ?v2 ))(iterates$d ?v1 (fun_app$q (fun_app$r (compow$d ?v0 )?v1 )?v2 )))):named a50 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(= (= (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a51 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_fun$ )(?v1 A_a_prod_llist$ ))(= (llength$a (lmap$c ?v0 ?v1 ))(llength$a ?v1 ))):named a52 ))
(assert (! (forall ((?v0 A_a_a_prod_fun$ )(?v1 A_llist$ ))(= (llength$a (lmap$b ?v0 ?v1 ))(llength$ ?v1 ))):named a53 ))
(assert (! (forall ((?v0 A_a_prod_a_fun$ )(?v1 A_a_prod_llist$ ))(= (llength$ (lmap$a ?v0 ?v1 ))(llength$a ?v1 ))):named a54 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A_llist$ ))(= (llength$ (lmap$ ?v0 ?v1 ))(llength$ ?v1 ))):named a55 ))
(assert (! (forall ((?v0 A_a_prod_llist$ ))(! (= (fun_app$g (lzip$b ?v0 )lNil$ )lNil$b ):pattern ((lzip$b ?v0 )))):named a56 ))
(assert (! (forall ((?v0 A_a_prod_llist$ ))(! (= (fun_app$h (lzip$c ?v0 )lNil$d )lNil$a ):pattern ((lzip$c ?v0 )))):named a57 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$f (lzip$a ?v0 )lNil$d )lNil$c ):pattern ((lzip$a ?v0 )))):named a58 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$e (lzip$ ?v0 )lNil$ )lNil$d ):pattern ((lzip$ ?v0 )))):named a59 ))
(check-sat )
;(get-unsat-core )
