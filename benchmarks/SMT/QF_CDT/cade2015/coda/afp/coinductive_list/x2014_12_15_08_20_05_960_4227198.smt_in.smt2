...
(declare-sort Enat_list_enat_list_prod$ 0)
(declare-sort B_llist_list$ 0)
(declare-sort B_llist_list_b_llist_list_prod$ 0)
(declare-sort Enat_enat_prod_enat_enat_prod_prod$ 0)
(declare-sort Enat_b_llist_prod$ 0)
(declare-sort Enat_b_llist_prod_enat_b_llist_prod_prod$ 0)
(declare-sort B_llist_enat_prod$ 0)
(declare-sort B_llist_enat_prod_b_llist_enat_prod_prod$ 0)
(declare-sort Enat_list_list$ 0)
(declare-sort Enat_list_list_enat_list_list_prod$ 0)
(declare-sort Enat_enat_prod_list$ 0)
(declare-sort Enat_enat_prod_list_enat_enat_prod_list_prod$ 0)
(declare-sort B_llist_list_list$ 0)
(declare-sort B_llist_list_list_b_llist_list_list_prod$ 0)
...
(declare-fun fst$b (Enat_list_enat_list_prod$)Enat_list$)
(declare-fun snd$b (Enat_list_enat_list_prod$)Enat_list$)
(declare-fun pair$b (Enat_list$ Enat_list$ )Enat_list_enat_list_prod$)
(declare-fun nil$a ()B_llist_list$)
(declare-fun hd$a (B_llist_list$)B_llist$)
(declare-fun tl$a (B_llist_list$)B_llist_list$)
(declare-fun cons$a (B_llist$ B_llist_list$ )B_llist_list$)
(declare-fun fst$c (B_llist_list_b_llist_list_prod$)B_llist_list$)
(declare-fun snd$c (B_llist_list_b_llist_list_prod$)B_llist_list$)
(declare-fun pair$c (B_llist_list$ B_llist_list$ )B_llist_list_b_llist_list_prod$)
(declare-fun fst$d (Enat_enat_prod_enat_enat_prod_prod$)Enat_enat_prod$)
(declare-fun snd$d (Enat_enat_prod_enat_enat_prod_prod$)Enat_enat_prod$)
(declare-fun pair$d (Enat_enat_prod$ Enat_enat_prod$ )Enat_enat_prod_enat_enat_prod_prod$)
...
(declare-fun fst$f (Enat_b_llist_prod_enat_b_llist_prod_prod$)Enat_b_llist_prod$)
(declare-fun snd$f (Enat_b_llist_prod_enat_b_llist_prod_prod$)Enat_b_llist_prod$)
(declare-fun pair$f (Enat_b_llist_prod$ Enat_b_llist_prod$ )Enat_b_llist_prod_enat_b_llist_prod_prod$)
(declare-fun fst$g (B_llist_enat_prod$)B_llist$)
(declare-fun snd$g (B_llist_enat_prod$)Enat$)
(declare-fun pair$g (B_llist$ Enat$ )B_llist_enat_prod$)
(declare-fun fst$h (B_llist_enat_prod_b_llist_enat_prod_prod$)B_llist_enat_prod$)
(declare-fun snd$h (B_llist_enat_prod_b_llist_enat_prod_prod$)B_llist_enat_prod$)
(declare-fun pair$h (B_llist_enat_prod$ B_llist_enat_prod$ )B_llist_enat_prod_b_llist_enat_prod_prod$)
(declare-fun nil$b ()Enat_list_list$)
(declare-fun hd$b (Enat_list_list$)Enat_list$)
(declare-fun tl$b (Enat_list_list$)Enat_list_list$)
(declare-fun cons$b (Enat_list$ Enat_list_list$ )Enat_list_list$)
(declare-fun fst$i (Enat_list_list_enat_list_list_prod$)Enat_list_list$)
(declare-fun snd$i (Enat_list_list_enat_list_list_prod$)Enat_list_list$)
(declare-fun pair$i (Enat_list_list$ Enat_list_list$ )Enat_list_list_enat_list_list_prod$)
(declare-fun nil$c ()Enat_enat_prod_list$)
(declare-fun hd$c (Enat_enat_prod_list$)Enat_enat_prod$)
(declare-fun tl$c (Enat_enat_prod_list$)Enat_enat_prod_list$)
(declare-fun cons$c (Enat_enat_prod$ Enat_enat_prod_list$ )Enat_enat_prod_list$)
(declare-fun fst$j (Enat_enat_prod_list_enat_enat_prod_list_prod$)Enat_enat_prod_list$)
(declare-fun snd$j (Enat_enat_prod_list_enat_enat_prod_list_prod$)Enat_enat_prod_list$)
(declare-fun pair$j (Enat_enat_prod_list$ Enat_enat_prod_list$ )Enat_enat_prod_list_enat_enat_prod_list_prod$)
(declare-fun nil$d ()B_llist_list_list$)
(declare-fun hd$d (B_llist_list_list$)B_llist_list$)
(declare-fun tl$d (B_llist_list_list$)B_llist_list_list$)
(declare-fun cons$d (B_llist_list$ B_llist_list_list$ )B_llist_list_list$)
(declare-fun fst$k (B_llist_list_list_b_llist_list_list_prod$)B_llist_list_list$)
(declare-fun snd$k (B_llist_list_list_b_llist_list_list_prod$)B_llist_list_list$)
(declare-fun pair$k (B_llist_list_list$ B_llist_list_list$ )B_llist_list_list_b_llist_list_list_prod$)
