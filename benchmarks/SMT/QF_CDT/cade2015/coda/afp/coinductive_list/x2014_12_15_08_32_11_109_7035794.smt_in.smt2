...
(declare-codatatypes ()((A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(A_llist_llist$ (lNil$a )(lCons$a (lhd$a A_llist$ )(ltl$a A_llist_llist$ )))(B_llist$ (lNil$b )(lCons$b (lhd$b B$ )(ltl$b B_llist$ )))(B_llist_llist$ (lNil$c )(lCons$c (lhd$c B_llist$ )(ltl$c B_llist_llist$ )))(A_llist_llist_llist$ (lNil$d )(lCons$d (lhd$d A_llist_llist$ )(ltl$d A_llist_llist_llist$ )))(A_llist_llist_llist_llist$ (lNil$e )(lCons$e (lhd$e A_llist_llist_llist$ )(ltl$e A_llist_llist_llist_llist$ )))(B_llist_llist_llist$ (lNil$f )(lCons$f (lhd$f B_llist_llist$ )(ltl$f B_llist_llist_llist$ )))(B_llist_llist_llist_llist$ (lNil$g )(lCons$g (lhd$g B_llist_llist_llist$ )(ltl$g B_llist_llist_llist_llist$ )))))
