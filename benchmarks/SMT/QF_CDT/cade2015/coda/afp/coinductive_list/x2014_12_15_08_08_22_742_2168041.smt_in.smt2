...
(assert (! (not (exists ((?v0 A_llist$ )(?v1 A_llist$ ))(and (= xs$ (lappend$ ?v0 (lCons$ x$ ?v1 )))(lfinite$ ?v0 )))):named a0 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(=> (member$ ?v0 (lset$ ?v1 ))(exists ((?v2 A_llist$ )(?v3 A_llist$ ))(and (= ?v1 (lappend$ ?v2 (lCons$ ?v0 ?v3 )))(and (lfinite$ ?v2 )(not (member$ ?v0 (lset$ ?v2 )))))))):named a16 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(! (=> (not (lfinite$ ?v0 ))(= (lappend$ ?v0 ?v1 )?v0 )):pattern ((lappend$ ?v0 ?v1 )))):named a17 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A$ ))(=> (lfinite$ ?v0 )(lfinite$ (lCons$ ?v1 ?v0 )))):named a18 ))
(check-sat )
;(get-unsat-core )
