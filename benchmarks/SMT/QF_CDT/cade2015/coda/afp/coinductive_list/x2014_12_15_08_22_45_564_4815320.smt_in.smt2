...
(declare-fun uut$ (C_llist_c_llist_fun$ )C_bool_fun_c_llist_c_llist_fun_fun$ )
(declare-fun uuu$ (B_llist_b_llist_fun$ )B_bool_fun_b_llist_b_llist_fun_fun$ )
...
(assert (! (forall ((?v0 A_b_llist_fun$ ))(! (= (fun_app$ uu$ ?v0 )(fun_app$a (ltakeWhile$ p$ )(fun_app$ f$ ?v0 ))):pattern ((fun_app$ uu$ ?v0 )))):named a0 ))
(assert (! (forall ((?v0 A$ )(?v1 A_b_llist_fun$ ))(! (= (fun_app$b (uvi$ ?v0 )?v1 )(fun_app$c ?v1 ?v0 )):pattern ((fun_app$b (uvi$ ?v0 )?v1 )))):named a1 ))
(assert (! (forall ((?v0 C_llist_c_llist_fun$ )(?v1 C_bool_fun$ )(?v2 C_llist$ ))(! (= (fun_app$a (fun_app$d (uut$ ?v0 )?v1 )?v2 )(fun_app$a (ltakeWhile$ ?v1 )(fun_app$a ?v0 ?v2 ))):pattern ((fun_app$a (fun_app$d (uut$ ?v0 )?v1 )?v2 )))):named a2 ))
(assert (! (forall ((?v0 C_llist_b_llist_fun$ )(?v1 B_bool_fun$ )(?v2 C_llist$ ))(! (= (fun_app$e (fun_app$f (uuv$ ?v0 )?v1 )?v2 )(fun_app$g (ltakeWhile$a ?v1 )(fun_app$e ?v0 ?v2 ))):pattern ((fun_app$e (fun_app$f (uuv$ ?v0 )?v1 )?v2 )))):named a3 ))
(assert (! (forall ((?v0 B_llist_c_llist_fun$ )(?v1 C_bool_fun$ )(?v2 B_llist$ ))(! (= (fun_app$h (fun_app$i (uux$ ?v0 )?v1 )?v2 )(fun_app$a (ltakeWhile$ ?v1 )(fun_app$h ?v0 ?v2 ))):pattern ((fun_app$h (fun_app$i (uux$ ?v0 )?v1 )?v2 )))):named a4 ))
(assert (! (forall ((?v0 B_llist_b_llist_fun$ )(?v1 B_bool_fun$ )(?v2 B_llist$ ))(! (= (fun_app$g (fun_app$j (uuu$ ?v0 )?v1 )?v2 )(fun_app$g (ltakeWhile$a ?v1 )(fun_app$g ?v0 ?v2 ))):pattern ((fun_app$g (fun_app$j (uuu$ ?v0 )?v1 )?v2 )))):named a5 ))
(assert (! (forall ((?v0 A_b_llist_fun_c_llist_fun$ )(?v1 C_bool_fun$ )(?v2 A_b_llist_fun$ ))(! (= (fun_app$ (fun_app$k (uuy$ ?v0 )?v1 )?v2 )(fun_app$a (ltakeWhile$ ?v1 )(fun_app$ ?v0 ?v2 ))):pattern ((fun_app$ (fun_app$k (uuy$ ?v0 )?v1 )?v2 )))):named a6 ))
(assert (! (forall ((?v0 A_b_llist_fun_b_llist_fun$ )(?v1 B_bool_fun$ )(?v2 A_b_llist_fun$ ))(! (= (fun_app$b (fun_app$l (uuw$ ?v0 )?v1 )?v2 )(fun_app$g (ltakeWhile$a ?v1 )(fun_app$b ?v0 ?v2 ))):pattern ((fun_app$b (fun_app$l (uuw$ ?v0 )?v1 )?v2 )))):named a7 ))
...
(assert (! (monotone$ (fun_ord$ lprefix$ )lprefix$a f$ ):named a37 ))
...
(assert (! (forall ((?v0 C_llist_c_llist_bool_fun_fun$ )(?v1 C_llist_c_llist_fun$ )(?v2 C_bool_fun$ ))(=> (monotone$g ?v0 lprefix$a ?v1 )(monotone$g ?v0 lprefix$a (fun_app$d (uut$ ?v1 )?v2 )))):named a66 ))
(assert (! (forall ((?v0 B_llist_b_llist_bool_fun_fun$ )(?v1 B_llist_b_llist_fun$ )(?v2 B_bool_fun$ ))(=> (monotone$d ?v0 lprefix$ ?v1 )(monotone$d ?v0 lprefix$ (fun_app$j (uuu$ ?v1 )?v2 )))):named a67 ))
