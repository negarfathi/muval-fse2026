...
(declare-codatatypes ()((A_b_prod_llist$ (lNil$ )(lCons$ (lhd$ A_b_prod$ )(ltl$ A_b_prod_llist$ )))(A_llist$ (lNil$a )(lCons$a (lhd$a A$ )(ltl$a A_llist$ )))(B_llist$ (lNil$b )(lCons$b (lhd$b B$ )(ltl$b B_llist$ )))(B_llist_llist$ (lNil$c )(lCons$c (lhd$c B_llist$ )(ltl$c B_llist_llist$ )))(A_llist_llist$ (lNil$d )(lCons$d (lhd$d A_llist$ )(ltl$d A_llist_llist$ )))(A_b_prod_llist_llist$ (lNil$e )(lCons$e (lhd$e A_b_prod_llist$ )(ltl$e A_b_prod_llist_llist$ )))))
