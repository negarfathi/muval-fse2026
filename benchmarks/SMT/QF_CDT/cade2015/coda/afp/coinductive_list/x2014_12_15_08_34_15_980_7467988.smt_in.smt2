...
(declare-codatatypes ()((Nat_llist$ (lNil$a )(lCons$a (lhd$a Nat$ )(ltl$a Nat_llist$ )))(A_nat_prod_llist$ (lNil$b )(lCons$b (lhd$b A_nat_prod$ )(ltl$b A_nat_prod_llist$ )))(A_a_prod_llist$ (lNil$c )(lCons$c (lhd$c A_a_prod$ )(ltl$c A_a_prod_llist$ )))(Nat_a_prod_llist$ (lNil$d )(lCons$d (lhd$d Nat_a_prod$ )(ltl$d Nat_a_prod_llist$ )))(Nat_nat_prod_llist$ (lNil$e )(lCons$e (lhd$e Nat_nat_prod$ )(ltl$e Nat_nat_prod_llist$ )))))
...
(declare-codatatypes ()((A_nat_prod_nat_prod_llist$ (lNil$i )(lCons$i (lhd$i A_nat_prod_nat_prod$ )(ltl$i A_nat_prod_nat_prod_llist$ )))(A_a_a_prod_prod_llist$ (lNil$j )(lCons$j (lhd$j A_a_a_prod_prod$ )(ltl$j A_a_a_prod_prod_llist$ )))(A_a_nat_prod_prod_llist$ (lNil$k )(lCons$k (lhd$k A_a_nat_prod_prod$ )(ltl$k A_a_nat_prod_prod_llist$ )))(Nat_a_a_prod_prod_llist$ (lNil$l )(lCons$l (lhd$l Nat_a_a_prod_prod$ )(ltl$l Nat_a_a_prod_prod_llist$ )))))
(declare-fun i$ ()Nat$ )
