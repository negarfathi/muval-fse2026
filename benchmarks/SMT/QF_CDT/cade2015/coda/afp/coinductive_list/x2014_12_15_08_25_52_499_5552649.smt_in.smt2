...
(assert (! (=> (not (lnull$ ys$ ))(= (llast$ (lappend$ xs$ ys$ ))(llast$ ys$ ))):named a2 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(! (=> (not (lfinite$ ?v0 ))(= (lappend$ ?v0 ?v1 )?v0 )):pattern ((lappend$ ?v0 ?v1 )))):named a12 ))
(assert (! (forall ((?v0 A_llist$ ))(! (=> (not (lfinite$ ?v0 ))(= (llast$ ?v0 )undefined$ )):pattern ((llast$ ?v0 )))):named a13 ))
