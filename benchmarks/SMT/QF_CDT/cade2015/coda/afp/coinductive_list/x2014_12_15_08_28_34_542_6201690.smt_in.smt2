...
(assert (! (or (= xsa$ ysa$ )(exists ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(and (lfinite$ ?v0 )(and (= xsa$ (fun_app$b (lappend$ ?v0 )?v1 ))(and (= ysa$ (fun_app$b (lappend$ ?v0 )(lCons$ ?v2 ?v3 )))(or (= ?v1 lNil$ )(fun_app$ (fun_app$a r$ (lhd$ ?v1 ))?v2 ))))))):named a8 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist$ ))(! (= (fun_app$b (lappend$ (lCons$ ?v0 ?v1 ))?v2 )(lCons$ ?v0 (fun_app$b (lappend$ ?v1 )?v2 ))):pattern ((fun_app$b (lappend$ (lCons$ ?v0 ?v1 ))?v2 )))):named a9 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (not (lnull$ (fun_app$b (lappend$ ?v0 )?v1 )))(or (not (lnull$ ?v0 ))(not (lnull$ ?v1 ))))):named a12 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (lnull$ (fun_app$b (lappend$ ?v0 )?v1 ))(and (lnull$ ?v0 )(lnull$ ?v1 )))):named a13 ))
