...
(declare-codatatypes ()((A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(B_llist$ (lNil$a )(lCons$a (lhd$a B$ )(ltl$a B_llist$ )))(B_llist_llist$ (lNil$b )(lCons$b (lhd$b B_llist$ )(ltl$b B_llist_llist$ )))(A_llist_llist$ (lNil$c )(lCons$c (lhd$c A_llist$ )(ltl$c A_llist_llist$ )))(C_llist$ (lNil$d )(lCons$d (lhd$d C$ )(ltl$d C_llist$ )))))
