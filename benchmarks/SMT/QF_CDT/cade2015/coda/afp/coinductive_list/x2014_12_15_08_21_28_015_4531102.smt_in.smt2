...
(declare-fun fst$b (B_llist_a_b_prod_llist_prod$)B_llist$)
(declare-fun snd$b (B_llist_a_b_prod_llist_prod$)A_b_prod_llist$)
(declare-fun pair$b (B_llist$ A_b_prod_llist$ )B_llist_a_b_prod_llist_prod$)
...
(declare-fun fst$d (B_llist_a_llist_prod$)B_llist$)
(declare-fun snd$d (B_llist_a_llist_prod$)A_llist$)
(declare-fun pair$d (B_llist$ A_llist$ )B_llist_a_llist_prod$)
(declare-fun fst$e (A_llist_a_b_prod_llist_prod$)A_llist$)
(declare-fun snd$e (A_llist_a_b_prod_llist_prod$)A_b_prod_llist$)
(declare-fun pair$e (A_llist$ A_b_prod_llist$ )A_llist_a_b_prod_llist_prod$)
...
(declare-fun fst$g (A_b_prod_llist_a_b_prod_llist_prod$)A_b_prod_llist$)
(declare-fun snd$g (A_b_prod_llist_a_b_prod_llist_prod$)A_b_prod_llist$)
(declare-fun pair$g (A_b_prod_llist$ A_b_prod_llist$ )A_b_prod_llist_a_b_prod_llist_prod$)
