...
(assert (! (not (less_eq$ (lset$ (lfilter$ p$ xs$ ))(fun_app$b (inf$ (lset$ xs$ ))(collect$ p$ )))):named a2 ))
(assert (! (forall ((?v0 A_llist$ ))(= (lfilter$ uu$ ?v0 )?v0 )):named a3 ))
(assert (! (forall ((?v0 A_bool_fun$ )(?v1 A_llist$ ))(= (lset$ (lfilter$ ?v0 ?v1 ))(collect$ (fun_app$a (uua$ ?v0 )?v1 )))):named a4 ))
(assert (! (forall ((?v0 A_set$ )(?v1 A_set$ )(?v2 A_set$ ))(= (less_eq$ ?v0 (fun_app$b (inf$ ?v1 )?v2 ))(and (less_eq$ ?v0 ?v1 )(less_eq$ ?v0 ?v2 )))):named a5 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_set$ )(?v2 A_set$ ))(= (member$ ?v0 (fun_app$b (inf$ ?v1 )?v2 ))(and (member$ ?v0 ?v1 )(member$ ?v0 ?v2 )))):named a8 ))
(assert (! (forall ((?v0 A$ )(?v1 A_set$ )(?v2 A_set$ ))(=> (and (member$ ?v0 ?v1 )(member$ ?v0 ?v2 ))(member$ ?v0 (fun_app$b (inf$ ?v1 )?v2 )))):named a9 ))
(assert (! (forall ((?v0 A_set$ )(?v1 A_set$ ))(= (fun_app$b (inf$ (fun_app$b (inf$ ?v0 )?v1 ))?v1 )(fun_app$b (inf$ ?v0 )?v1 ))):named a10 ))
(assert (! (forall ((?v0 A_set$ )(?v1 A_set$ ))(= (fun_app$b (inf$ (fun_app$b (inf$ ?v0 )?v1 ))?v1 )(fun_app$b (inf$ ?v0 )?v1 ))):named a11 ))
(assert (! (forall ((?v0 A_set$ )(?v1 A_set$ ))(= (fun_app$b (inf$ ?v0 )(fun_app$b (inf$ ?v0 )?v1 ))(fun_app$b (inf$ ?v0 )?v1 ))):named a12 ))
(assert (! (forall ((?v0 A_set$ )(?v1 A_set$ ))(= (fun_app$b (inf$ ?v0 )(fun_app$b (inf$ ?v0 )?v1 ))(fun_app$b (inf$ ?v0 )?v1 ))):named a13 ))
(assert (! (forall ((?v0 A_set$ ))(! (= (fun_app$b (inf$ ?v0 )?v0 )?v0 ):pattern ((inf$ ?v0 )))):named a14 ))
...
(assert (! (forall ((?v0 A_set$ )(?v1 A_set$ ))(=> (forall ((?v2 A$ ))(=> (member$ ?v2 ?v0 )(member$ ?v2 ?v1 )))(less_eq$ ?v0 ?v1 ))):named a17 ))
(check-sat )
;(get-unsat-core )
