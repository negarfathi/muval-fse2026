...
(declare-fun nil$d ()B_a_a_prod_prod_list$)
(declare-fun hd$d (B_a_a_prod_prod_list$)B_a_a_prod_prod$)
(declare-fun tl$d (B_a_a_prod_prod_list$)B_a_a_prod_prod_list$)
(declare-fun cons$d (B_a_a_prod_prod$ B_a_a_prod_prod_list$ )B_a_a_prod_prod_list$)
...
(declare-fun nil$h ()A_a_a_prod_prod_list$)
(declare-fun hd$h (A_a_a_prod_prod_list$)A_a_a_prod_prod$)
(declare-fun tl$h (A_a_a_prod_prod_list$)A_a_a_prod_prod_list$)
(declare-fun cons$h (A_a_a_prod_prod$ A_a_a_prod_prod_list$ )A_a_a_prod_prod_list$)
(declare-codatatypes ()((B_a_a_prod_prod_llist$ (lNil$d )(lCons$d (lhd$d B_a_a_prod_prod$ )(ltl$d B_a_a_prod_prod_llist$ )))(B_b_prod_llist$ (lNil$e )(lCons$e (lhd$e B_b_prod$ )(ltl$e B_b_prod_llist$ )))(B_a_prod_llist$ (lNil$f )(lCons$f (lhd$f B_a_prod$ )(ltl$f B_a_prod_llist$ )))(A_a_b_prod_prod_llist$ (lNil$g )(lCons$g (lhd$g A_a_b_prod_prod$ )(ltl$g A_a_b_prod_prod_llist$ )))(A_a_a_prod_prod_llist$ (lNil$h )(lCons$h (lhd$h A_a_a_prod_prod$ )(ltl$h A_a_a_prod_prod_llist$ )))))
