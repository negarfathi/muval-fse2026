...
(declare-codatatypes ()((A_a_prod_llist$ (lNil$c )(lCons$c (lhd$c A_a_prod$ )(ltl$c A_a_prod_llist$ )))(A_nat_prod_a_prod_llist$ (lNil$d )(lCons$d (lhd$d A_nat_prod_a_prod$ )(ltl$d A_nat_prod_a_prod_llist$ )))(A_a_nat_prod_prod_llist$ (lNil$e )(lCons$e (lhd$e A_a_nat_prod_prod$ )(ltl$e A_a_nat_prod_prod_llist$ )))(A_nat_prod_a_nat_prod_prod_llist$ (lNil$f )(lCons$f (lhd$f A_nat_prod_a_nat_prod_prod$ )(ltl$f A_nat_prod_a_nat_prod_prod_llist$ )))))
...
(declare-codatatypes ()((Nat_nat_prod_llist$ (lNil$h )(lCons$h (lhd$h Nat_nat_prod$ )(ltl$h Nat_nat_prod_llist$ )))))
...
(declare-fun fst$h (A_a_prod_nat_prod$)A_a_prod$)
(declare-fun snd$h (A_a_prod_nat_prod$)Nat$)
(declare-fun pair$h (A_a_prod$ Nat$ )A_a_prod_nat_prod$)
(declare-codatatypes ()((A_a_prod_nat_prod_llist$ (lNil$j )(lCons$j (lhd$j A_a_prod_nat_prod$ )(ltl$j A_a_prod_nat_prod_llist$ )))))
...
(declare-codatatypes ()((A_a_a_prod_prod_llist$ (lNil$k )(lCons$k (lhd$k A_a_a_prod_prod$ )(ltl$k A_a_a_prod_prod_llist$ )))))
(declare-sort A_a_nat_prod_a_prod_prod$ 0)
(declare-sort A_a_a_nat_prod_prod_prod$ 0)
(declare-fun fst$j (A_a_nat_prod_a_prod_prod$)A$)
(declare-fun snd$j (A_a_nat_prod_a_prod_prod$)A_nat_prod_a_prod$)
(declare-fun pair$j (A$ A_nat_prod_a_prod$ )A_a_nat_prod_a_prod_prod$)
(declare-fun fst$k (A_a_a_nat_prod_prod_prod$)A$)
(declare-fun snd$k (A_a_a_nat_prod_prod_prod$)A_a_nat_prod_prod$)
(declare-fun pair$k (A$ A_a_nat_prod_prod$ )A_a_a_nat_prod_prod_prod$)
...
(assert (! (or (lfinite$ xs$ )(finite$ (collect$ uua$ ))):named a9 ))
(assert (! (forall ((?v0 Bool )(?v1 A_nat_prod_a_nat_prod_bool_fun_fun$ )(?v2 A_nat_prod_a_nat_prod_prod$ ))(= (case_prod$a (uuc$ ?v0 ?v1 )?v2 )(and ?v0 (case_prod$a ?v1 ?v2 )))):named a10 ))
(assert (! (forall ((?v0 Bool )(?v1 A_nat_prod_a_bool_fun_fun$ )(?v2 A_nat_prod_a_prod$ ))(= (case_prod$b (uud$ ?v0 ?v1 )?v2 )(and ?v0 (case_prod$b ?v1 ?v2 )))):named a11 ))
(assert (! (forall ((?v0 Bool )(?v1 A_a_nat_prod_bool_fun_fun$ )(?v2 A_a_nat_prod_prod$ ))(= (case_prod$c (uue$ ?v0 ?v1 )?v2 )(and ?v0 (case_prod$c ?v1 ?v2 )))):named a12 ))
(assert (! (forall ((?v0 Bool )(?v1 A_a_bool_fun_fun$ )(?v2 A_a_prod$ ))(= (case_prod$d (uuf$ ?v0 ?v1 )?v2 )(and ?v0 (case_prod$d ?v1 ?v2 )))):named a13 ))
(assert (! (forall ((?v0 Bool )(?v1 A_nat_bool_fun_fun$ )(?v2 A_nat_prod$ ))(= (case_prod$ (uug$ ?v0 ?v1 )?v2 )(and ?v0 (case_prod$ ?v1 ?v2 )))):named a14 ))
...
(assert (! (lfinite$ (lsublist$ xs$ a$ )):named a18 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_llist$ )(?v2 Nat_llist$ ))(=> (and (less$ (enat$ ?v0 )(llength$ ?v1 ))(less$ (enat$ ?v0 )(llength$a ?v2 )))(= (lnth$ (lzip$ ?v1 ?v2 )?v0 )(pair$ (lnth$a ?v1 ?v0 )(lnth$b ?v2 ?v0 ))))):named a19 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_llist$ )(?v2 A_llist$ ))(=> (and (less$ (enat$ ?v0 )(llength$ ?v1 ))(less$ (enat$ ?v0 )(llength$ ?v2 )))(= (lnth$c (lzip$a ?v1 ?v2 )?v0 )(pair$d (lnth$a ?v1 ?v0 )(lnth$a ?v2 ?v0 ))))):named a20 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_nat_prod_llist$ )(?v2 A_llist$ ))(=> (and (less$ (enat$ ?v0 )(llength$b ?v1 ))(less$ (enat$ ?v0 )(llength$ ?v2 )))(= (lnth$d (lzip$b ?v1 ?v2 )?v0 )(pair$b (lnth$ ?v1 ?v0 )(lnth$a ?v2 ?v0 ))))):named a21 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_llist$ )(?v2 A_nat_prod_llist$ ))(=> (and (less$ (enat$ ?v0 )(llength$ ?v1 ))(less$ (enat$ ?v0 )(llength$b ?v2 )))(= (lnth$e (lzip$c ?v1 ?v2 )?v0 )(pair$c (lnth$a ?v1 ?v0 )(lnth$ ?v2 ?v0 ))))):named a22 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_nat_prod_llist$ )(?v2 A_nat_prod_llist$ ))(=> (and (less$ (enat$ ?v0 )(llength$b ?v1 ))(less$ (enat$ ?v0 )(llength$b ?v2 )))(= (lnth$f (lzip$d ?v1 ?v2 )?v0 )(pair$a (lnth$ ?v1 ?v0 )(lnth$ ?v2 ?v0 ))))):named a23 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat_llist$ )(?v2 A_llist$ ))(=> (and (less$ (enat$ ?v0 )(llength$a ?v1 ))(less$ (enat$ ?v0 )(llength$ ?v2 )))(= (lnth$g (lzip$e ?v1 ?v2 )?v0 )(pair$e (lnth$b ?v1 ?v0 )(lnth$a ?v2 ?v0 ))))):named a24 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat_llist$ )(?v2 Nat_llist$ ))(=> (and (less$ (enat$ ?v0 )(llength$a ?v1 ))(less$ (enat$ ?v0 )(llength$a ?v2 )))(= (lnth$h (lzip$f ?v1 ?v2 )?v0 )(pair$f (lnth$b ?v1 ?v0 )(lnth$b ?v2 ?v0 ))))):named a25 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_llist$ )(?v2 A_llist$ ))(=> (and (less$ (enat$ ?v0 )(llength$c ?v1 ))(less$ (enat$ ?v0 )(llength$ ?v2 )))(= (lnth$i (lzip$g ?v1 ?v2 )?v0 )(pair$g (lnth$c ?v1 ?v0 )(lnth$a ?v2 ?v0 ))))):named a26 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_a_prod_llist$ )(?v2 Nat_llist$ ))(=> (and (less$ (enat$ ?v0 )(llength$c ?v1 ))(less$ (enat$ ?v0 )(llength$a ?v2 )))(= (lnth$j (lzip$h ?v1 ?v2 )?v0 )(pair$h (lnth$c ?v1 ?v0 )(lnth$b ?v2 ?v0 ))))):named a27 ))
(assert (! (forall ((?v0 Nat$ )(?v1 A_llist$ )(?v2 A_a_prod_llist$ ))(=> (and (less$ (enat$ ?v0 )(llength$ ?v1 ))(less$ (enat$ ?v0 )(llength$c ?v2 )))(= (lnth$k (lzip$i ?v1 ?v2 )?v0 )(pair$i (lnth$a ?v1 ?v0 )(lnth$c ?v2 ?v0 ))))):named a28 ))
(assert (! (forall ((?v0 Enat$ )(?v1 Nat$ ))(=> (less$ ?v0 (enat$ ?v1 ))(exists ((?v2 Nat$ ))(= ?v0 (enat$ ?v2 ))))):named a29 ))
