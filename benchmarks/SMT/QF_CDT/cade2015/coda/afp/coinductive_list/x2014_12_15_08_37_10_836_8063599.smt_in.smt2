...
(declare-codatatypes ()((A_nat_prod_llist$ (lNil$b )(lCons$b (lhd$b A_nat_prod$ )(ltl$b A_nat_prod_llist$ )))(Nat_llist$ (lNil$c )(lCons$c (lhd$c Nat$ )(ltl$c Nat_llist$ )))))
...
(declare-codatatypes ()((B_nat_prod_llist$ (lNil$d )(lCons$d (lhd$d B_nat_prod$ )(ltl$d B_nat_prod_llist$ )))(Nat_set_a_llist_fun_llist$ (lNil$e )(lCons$e (select$ Nat_set_a_llist_fun$ )(selecta$ Nat_set_a_llist_fun_llist$ )))(Nat_set_b_llist_fun_llist$ (lNil$f )(lCons$f (selectb$ Nat_set_b_llist_fun$ )(selectc$ Nat_set_b_llist_fun_llist$ )))(A_llist_llist$ (lNil$g )(lCons$g (lhd$e A_llist$ )(ltl$e A_llist_llist$ )))(Nat_set_llist$ (lNil$h )(lCons$h (lhd$f Nat_set$ )(ltl$f Nat_set_llist$ )))(B_llist_llist$ (lNil$i )(lCons$i (lhd$g B_llist$ )(ltl$g B_llist_llist$ )))))
