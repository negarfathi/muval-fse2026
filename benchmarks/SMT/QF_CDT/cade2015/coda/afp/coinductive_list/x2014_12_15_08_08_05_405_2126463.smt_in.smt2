...
(assert (! (not (= (lset$ (lappend$ xs$ ys$ ))(fun_app$ (sup$ (lset$ xs$ ))(lset$ ys$ )))):named a0 ))
...
(assert (! (forall ((?v0 A_set$ )(?v1 A_set$ )(?v2 A_bool_fun$ ))(= (exists ((?v3 A$ ))(and (member$ ?v3 (fun_app$ (sup$ ?v0 )?v1 ))(fun_app$a ?v2 ?v3 )))(or (exists ((?v3 A$ ))(and (member$ ?v3 ?v0 )(fun_app$a ?v2 ?v3 )))(exists ((?v3 A$ ))(and (member$ ?v3 ?v1 )(fun_app$a ?v2 ?v3 )))))):named a14 ))
(assert (! (forall ((?v0 A_set$ )(?v1 A_set$ )(?v2 A_bool_fun$ ))(= (forall ((?v3 A$ ))(=> (member$ ?v3 (fun_app$ (sup$ ?v0 )?v1 ))(fun_app$a ?v2 ?v3 )))(and (forall ((?v3 A$ ))(=> (member$ ?v3 ?v0 )(fun_app$a ?v2 ?v3 )))(forall ((?v3 A$ ))(=> (member$ ?v3 ?v1 )(fun_app$a ?v2 ?v3 )))))):named a15 ))
(assert (! (forall ((?v0 A_set$ )(?v1 A_set$ ))(= (fun_app$ (sup$ ?v0 )?v1 )(fun_app$ (sup$ ?v1 )?v0 ))):named a16 ))
(check-sat )
;(get-unsat-core )
