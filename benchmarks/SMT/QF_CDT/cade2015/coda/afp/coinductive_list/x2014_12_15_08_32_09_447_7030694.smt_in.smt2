...
(declare-codatatypes ()((A_llist$ (lNil$ )(lCons$ (lhd$ A$ )(ltl$ A_llist$ )))(B_llist$ (lNil$a )(lCons$a (lhd$a B$ )(ltl$a B_llist$ )))(A_llist_llist$ (lNil$b )(lCons$b (lhd$b A_llist$ )(ltl$b A_llist_llist$ )))(B_llist_llist$ (lNil$c )(lCons$c (lhd$c B_llist$ )(ltl$c B_llist_llist$ )))))
