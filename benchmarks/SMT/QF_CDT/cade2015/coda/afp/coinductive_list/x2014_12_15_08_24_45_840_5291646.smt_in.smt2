...
(declare-codatatypes ()((A_b_prod_llist$ (lNil$c )(lCons$c (lhd$c A_b_prod$ )(ltl$c A_b_prod_llist$ )))))
...
(declare-codatatypes ()((B_a_b_prod_prod_llist$ (lNil$j )(lCons$j (lhd$j B_a_b_prod_prod$ )(ltl$j B_a_b_prod_prod_llist$ )))))
...
(declare-sort B_a_a_prod_prod_list$ 0)
...
(declare-fun nil$f ()B_a_a_prod_prod_list$)
(declare-fun hd$f (B_a_a_prod_prod_list$)B_a_a_prod_prod$)
(declare-fun tl$f (B_a_a_prod_prod_list$)B_a_a_prod_prod_list$)
(declare-fun cons$f (B_a_a_prod_prod$ B_a_a_prod_prod_list$ )B_a_a_prod_prod_list$)
(declare-fun nil$g ()A_b_b_prod_prod_list$)
(declare-fun hd$g (A_b_b_prod_prod_list$)A_b_b_prod_prod$)
(declare-fun tl$g (A_b_b_prod_prod_list$)A_b_b_prod_prod_list$)
(declare-fun cons$g (A_b_b_prod_prod$ A_b_b_prod_prod_list$ )A_b_b_prod_prod_list$)
(declare-fun nil$h ()A_b_a_prod_prod_list$)
(declare-fun hd$h (A_b_a_prod_prod_list$)A_b_a_prod_prod$)
(declare-fun tl$h (A_b_a_prod_prod_list$)A_b_a_prod_prod_list$)
(declare-fun cons$h (A_b_a_prod_prod$ A_b_a_prod_prod_list$ )A_b_a_prod_prod_list$)
...
(assert (! (lfinite$a xs$ ):named a111 ))
