...
(declare-codatatypes ()((A_a_prod_llist$ (lNil$e )(lCons$e (lhd$e A_a_prod$ )(ltl$e A_a_prod_llist$ )))(A_b_prod_a_b_prod_prod_llist$ (lNil$f )(lCons$f (lhd$f A_b_prod_a_b_prod_prod$ )(ltl$f A_b_prod_a_b_prod_prod_llist$ )))(A_llist$ (lNil$g )(lCons$g (lhd$g A$ )(ltl$g A_llist$ )))(B_llist$ (lNil$h )(lCons$h (lhd$h B$ )(ltl$h B_llist$ )))))
