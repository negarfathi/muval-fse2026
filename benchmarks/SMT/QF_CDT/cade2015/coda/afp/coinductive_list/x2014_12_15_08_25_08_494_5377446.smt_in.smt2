...
(declare-codatatypes ()((A_c_prod_llist$ (lNil$ )(lCons$ (lhd$ A_c_prod$ )(ltl$ A_c_prod_llist$ )))(B_d_prod_llist$ (lNil$a )(lCons$a (lhd$a B_d_prod$ )(ltl$a B_d_prod_llist$ )))(A_llist$ (lNil$b )(lCons$b (lhd$b A$ )(ltl$b A_llist$ )))(C_llist$ (lNil$c )(lCons$c (lhd$c C$ )(ltl$c C_llist$ )))(B_llist$ (lNil$d )(lCons$d (lhd$d B$ )(ltl$d B_llist$ )))(D_llist$ (lNil$e )(lCons$e (lhd$e D$ )(ltl$e D_llist$ )))))
