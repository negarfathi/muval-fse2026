...
(assert (! (forall ((?v0 A_b_llist_fun$ ))(! (= (fun_app$ uu$ ?v0 )(lCons$a x$ (fun_app$ a$ ?v0 ))):pattern ((fun_app$ uu$ ?v0 )))):named a0 ))
...
(assert (! (not (monotone$ (fun_ord$ lprefix$ )lprefix$a uu$ )):named a20 ))
(assert (! (monotone$ (fun_ord$ lprefix$ )lprefix$a a$ ):named a21 ))
(assert (! (forall ((?v0 B_llist$ ))(fun_app$ab (fun_app$ac lprefix$ ?v0 )?v0 )):named a22 ))
(assert (! (forall ((?v0 C_llist$ ))(fun_app$ad (fun_app$ae lprefix$a ?v0 )?v0 )):named a23 ))
(assert (! (forall ((?v0 B_llist$ ))(fun_app$ab (fun_app$ac lprefix$ ?v0 )?v0 )):named a24 ))
(assert (! (forall ((?v0 C_llist$ ))(fun_app$ad (fun_app$ae lprefix$a ?v0 )?v0 )):named a25 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B$ )(?v3 B_llist$ ))(= (= (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a26 ))
(assert (! (forall ((?v0 C$ )(?v1 C_llist$ )(?v2 C$ )(?v3 C_llist$ ))(= (= (lCons$a ?v0 ?v1 )(lCons$a ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a27 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B$ )(?v3 B_llist$ ))(! (= (fun_app$ab (fun_app$ac lprefix$ (lCons$ ?v0 ?v1 ))(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(fun_app$ab (fun_app$ac lprefix$ ?v1 )?v3 ))):pattern ((fun_app$ab (fun_app$ac lprefix$ (lCons$ ?v0 ?v1 ))(lCons$ ?v2 ?v3 ))))):named a28 ))
(assert (! (forall ((?v0 C$ )(?v1 C_llist$ )(?v2 C$ )(?v3 C_llist$ ))(! (= (fun_app$ad (fun_app$ae lprefix$a (lCons$a ?v0 ?v1 ))(lCons$a ?v2 ?v3 ))(and (= ?v0 ?v2 )(fun_app$ad (fun_app$ae lprefix$a ?v1 )?v3 ))):pattern ((fun_app$ad (fun_app$ae lprefix$a (lCons$a ?v0 ?v1 ))(lCons$a ?v2 ?v3 ))))):named a29 ))
(assert (! (forall ((?v0 B$ )(?v1 B_llist$ )(?v2 B_llist$ ))(= (fun_app$ab (fun_app$ac lprefix$ (lCons$ ?v0 ?v1 ))?v2 )(exists ((?v3 B_llist$ ))(and (= ?v2 (lCons$ ?v0 ?v3 ))(fun_app$ab (fun_app$ac lprefix$ ?v1 )?v3 ))))):named a30 ))
(assert (! (forall ((?v0 C$ )(?v1 C_llist$ )(?v2 C_llist$ ))(= (fun_app$ad (fun_app$ae lprefix$a (lCons$a ?v0 ?v1 ))?v2 )(exists ((?v3 C_llist$ ))(and (= ?v2 (lCons$a ?v0 ?v3 ))(fun_app$ad (fun_app$ae lprefix$a ?v1 )?v3 ))))):named a31 ))
...
(assert (! (forall ((?v0 A_b_llist_fun$ )(?v1 A_b_llist_fun$ )(?v2 A_b_llist_fun$ ))(=> (and (fun_app$af (fun_app$ag (fun_ord$ lprefix$ )?v0 )?v1 )(fun_app$af (fun_app$ag (fun_ord$ lprefix$ )?v1 )?v2 ))(fun_app$af (fun_app$ag (fun_ord$ lprefix$ )?v0 )?v2 ))):named a35 ))
(assert (! (forall ((?v0 A_b_llist_fun$ )(?v1 A_b_llist_fun$ ))(=> (and (fun_app$af (fun_app$ag (fun_ord$ lprefix$ )?v0 )?v1 )(fun_app$af (fun_app$ag (fun_ord$ lprefix$ )?v1 )?v0 ))(= ?v0 ?v1 ))):named a36 ))
(assert (! (forall ((?v0 C_llist_c_llist_bool_fun_fun$ )(?v1 C_llist_a_b_llist_fun_fun$ )(?v2 B_llist_b_llist_bool_fun_fun$ )(?v3 B_llist_c_llist_fun$ ))(=> (and (monotone$c ?v0 (fun_ord$ lprefix$ )?v1 )(monotone$d ?v2 ?v0 ?v3 ))(monotone$e ?v2 (fun_ord$ lprefix$ )(fun_app$k (uua$ ?v1 )?v3 )))):named a37 ))
(assert (! (forall ((?v0 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v1 A_b_llist_fun_a_b_llist_fun_fun$ )(?v2 B_llist_b_llist_bool_fun_fun$ )(?v3 B_llist_a_b_llist_fun_fun$ ))(=> (and (monotone$a ?v0 (fun_ord$ lprefix$ )?v1 )(monotone$e ?v2 ?v0 ?v3 ))(monotone$e ?v2 (fun_ord$ lprefix$ )(fun_app$z (uub$ ?v1 )?v3 )))):named a38 ))
(assert (! (forall ((?v0 B_llist_b_llist_bool_fun_fun$ )(?v1 B_llist_a_b_llist_fun_fun$ )(?v2 B_llist_b_llist_bool_fun_fun$ )(?v3 B_llist_b_llist_fun$ ))(=> (and (monotone$e ?v0 (fun_ord$ lprefix$ )?v1 )(monotone$f ?v2 ?v0 ?v3 ))(monotone$e ?v2 (fun_ord$ lprefix$ )(fun_app$u (uuc$ ?v1 )?v3 )))):named a39 ))
(assert (! (forall ((?v0 B_llist_b_llist_bool_fun_fun$ )(?v1 B_llist_a_b_llist_fun_fun$ )(?v2 C_llist_c_llist_bool_fun_fun$ )(?v3 C_llist_b_llist_fun$ ))(=> (and (monotone$e ?v0 (fun_ord$ lprefix$ )?v1 )(monotone$g ?v2 ?v0 ?v3 ))(monotone$c ?v2 (fun_ord$ lprefix$ )(fun_app$t (uud$ ?v1 )?v3 )))):named a40 ))
(assert (! (forall ((?v0 B_llist_b_llist_bool_fun_fun$ )(?v1 B_llist_a_b_llist_fun_fun$ )(?v2 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v3 A_b_llist_fun_b_llist_fun$ ))(=> (and (monotone$e ?v0 (fun_ord$ lprefix$ )?v1 )(monotone$b ?v2 ?v0 ?v3 ))(monotone$a ?v2 (fun_ord$ lprefix$ )(fun_app$v (uue$ ?v1 )?v3 )))):named a41 ))
(assert (! (forall ((?v0 C_llist_c_llist_bool_fun_fun$ )(?v1 C_llist_a_b_llist_fun_fun$ )(?v2 C_llist_c_llist_bool_fun_fun$ )(?v3 C_llist_c_llist_fun$ ))(=> (and (monotone$c ?v0 (fun_ord$ lprefix$ )?v1 )(monotone$h ?v2 ?v0 ?v3 ))(monotone$c ?v2 (fun_ord$ lprefix$ )(fun_app$i (uuf$ ?v1 )?v3 )))):named a42 ))
(assert (! (forall ((?v0 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v1 A_b_llist_fun_a_b_llist_fun_fun$ )(?v2 C_llist_c_llist_bool_fun_fun$ )(?v3 C_llist_a_b_llist_fun_fun$ ))(=> (and (monotone$a ?v0 (fun_ord$ lprefix$ )?v1 )(monotone$c ?v2 ?v0 ?v3 ))(monotone$c ?v2 (fun_ord$ lprefix$ )(fun_app$y (uug$ ?v1 )?v3 )))):named a43 ))
(assert (! (forall ((?v0 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v1 A_b_llist_fun_a_b_llist_fun_fun$ )(?v2 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v3 A_b_llist_fun_a_b_llist_fun_fun$ ))(=> (and (monotone$a ?v0 (fun_ord$ lprefix$ )?v1 )(monotone$a ?v2 ?v0 ?v3 ))(monotone$a ?v2 (fun_ord$ lprefix$ )(fun_app$aa (uuh$ ?v1 )?v3 )))):named a44 ))
(assert (! (forall ((?v0 C_llist_c_llist_bool_fun_fun$ )(?v1 C_llist_a_b_llist_fun_fun$ )(?v2 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v3 A_b_llist_fun_c_llist_fun$ ))(=> (and (monotone$c ?v0 (fun_ord$ lprefix$ )?v1 )(monotone$ ?v2 ?v0 ?v3 ))(monotone$a ?v2 (fun_ord$ lprefix$ )(fun_app$n (uui$ ?v1 )?v3 )))):named a45 ))
(assert (! (forall ((?v0 C_llist_c_llist_bool_fun_fun$ )(?v1 C_llist_b_llist_fun$ )(?v2 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v3 A_b_llist_fun_c_llist_fun$ ))(=> (and (monotone$g ?v0 lprefix$ ?v1 )(monotone$ ?v2 ?v0 ?v3 ))(monotone$b ?v2 lprefix$ (fun_app$g (uuj$ ?v1 )?v3 )))):named a46 ))
(assert (! (forall ((?v0 C_llist_c_llist_bool_fun_fun$ )(?v1 C_llist_c_llist_fun$ )(?v2 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v3 A_b_llist_fun_c_llist_fun$ ))(=> (and (monotone$h ?v0 lprefix$a ?v1 )(monotone$ ?v2 ?v0 ?v3 ))(monotone$ ?v2 lprefix$a (fun_app$c (uuk$ ?v1 )?v3 )))):named a47 ))
(assert (! (forall ((?v0 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v1 A_b_llist_fun_c_llist_fun$ )(?v2 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v3 A_b_llist_fun_a_b_llist_fun_fun$ ))(=> (and (monotone$ ?v0 lprefix$a ?v1 )(monotone$a ?v2 ?v0 ?v3 ))(monotone$ ?v2 lprefix$a (fun_app$w (uul$ ?v1 )?v3 )))):named a48 ))
(assert (! (forall ((?v0 B_llist_b_llist_bool_fun_fun$ )(?v1 B_llist_b_llist_fun$ )(?v2 C_llist_c_llist_bool_fun_fun$ )(?v3 C_llist_b_llist_fun$ ))(=> (and (monotone$f ?v0 lprefix$ ?v1 )(monotone$g ?v2 ?v0 ?v3 ))(monotone$g ?v2 lprefix$ (fun_app$q (uum$ ?v1 )?v3 )))):named a49 ))
(assert (! (forall ((?v0 C_llist_c_llist_bool_fun_fun$ )(?v1 C_llist_b_llist_fun$ )(?v2 C_llist_c_llist_bool_fun_fun$ )(?v3 C_llist_c_llist_fun$ ))(=> (and (monotone$g ?v0 lprefix$ ?v1 )(monotone$h ?v2 ?v0 ?v3 ))(monotone$g ?v2 lprefix$ (fun_app$e (uun$ ?v1 )?v3 )))):named a50 ))
(assert (! (forall ((?v0 B_llist_b_llist_bool_fun_fun$ )(?v1 B_llist_c_llist_fun$ )(?v2 C_llist_c_llist_bool_fun_fun$ )(?v3 C_llist_b_llist_fun$ ))(=> (and (monotone$d ?v0 lprefix$a ?v1 )(monotone$g ?v2 ?v0 ?v3 ))(monotone$h ?v2 lprefix$a (fun_app$o (uuo$ ?v1 )?v3 )))):named a51 ))
(assert (! (forall ((?v0 C_llist_c_llist_bool_fun_fun$ )(?v1 C_llist_c_llist_fun$ )(?v2 C_llist_c_llist_bool_fun_fun$ )(?v3 C_llist_c_llist_fun$ ))(=> (and (monotone$h ?v0 lprefix$a ?v1 )(monotone$h ?v2 ?v0 ?v3 ))(monotone$h ?v2 lprefix$a (fun_app$b (uup$ ?v1 )?v3 )))):named a52 ))
(assert (! (forall ((?v0 B_llist_b_llist_bool_fun_fun$ )(?v1 B_llist_b_llist_fun$ )(?v2 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v3 A_b_llist_fun_b_llist_fun$ ))(=> (and (monotone$f ?v0 lprefix$ ?v1 )(monotone$b ?v2 ?v0 ?v3 ))(monotone$b ?v2 lprefix$ (fun_app$s (uuq$ ?v1 )?v3 )))):named a53 ))
(assert (! (forall ((?v0 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v1 A_b_llist_fun_b_llist_fun$ )(?v2 C_llist_c_llist_bool_fun_fun$ )(?v3 C_llist_a_b_llist_fun_fun$ ))(=> (and (monotone$b ?v0 lprefix$ ?v1 )(monotone$c ?v2 ?v0 ?v3 ))(monotone$g ?v2 lprefix$ (fun_app$x (uur$ ?v1 )?v3 )))):named a54 ))
(assert (! (forall ((?v0 B_llist_b_llist_bool_fun_fun$ )(?v1 B_llist_c_llist_fun$ )(?v2 A_b_llist_fun_a_b_llist_fun_bool_fun_fun$ )(?v3 A_b_llist_fun_b_llist_fun$ ))(=> (and (monotone$d ?v0 lprefix$a ?v1 )(monotone$b ?v2 ?v0 ?v3 ))(monotone$ ?v2 lprefix$a (fun_app$p (uus$ ?v1 )?v3 )))):named a55 ))
(assert (! (forall ((?v0 B_llist$ )(?v1 B_llist$ ))(=> (and (fun_app$ab (fun_app$ac lprefix$ ?v0 )?v1 )(fun_app$ab (fun_app$ac lprefix$ ?v1 )?v0 ))(= ?v0 ?v1 ))):named a56 ))
(assert (! (forall ((?v0 C_llist$ )(?v1 C_llist$ ))(=> (and (fun_app$ad (fun_app$ae lprefix$a ?v0 )?v1 )(fun_app$ad (fun_app$ae lprefix$a ?v1 )?v0 ))(= ?v0 ?v1 ))):named a57 ))
...
(assert (! (forall ((?v0 B_llist$ )(?v1 B_llist$ )(?v2 B_llist$ ))(=> (and (fun_app$ab (fun_app$ac lprefix$ ?v0 )?v1 )(fun_app$ab (fun_app$ac lprefix$ ?v2 )?v1 ))(or (fun_app$ab (fun_app$ac lprefix$ ?v0 )?v2 )(fun_app$ab (fun_app$ac lprefix$ ?v2 )?v0 )))):named a60 ))
(assert (! (forall ((?v0 C_llist$ )(?v1 C_llist$ )(?v2 C_llist$ ))(=> (and (fun_app$ad (fun_app$ae lprefix$a ?v0 )?v1 )(fun_app$ad (fun_app$ae lprefix$a ?v2 )?v1 ))(or (fun_app$ad (fun_app$ae lprefix$a ?v0 )?v2 )(fun_app$ad (fun_app$ae lprefix$a ?v2 )?v0 )))):named a61 ))
(assert (! (forall ((?v0 B_llist$ )(?v1 B_llist$ )(?v2 B_llist$ ))(=> (and (fun_app$ab (fun_app$ac lprefix$ ?v0 )?v1 )(fun_app$ab (fun_app$ac lprefix$ ?v1 )?v2 ))(fun_app$ab (fun_app$ac lprefix$ ?v0 )?v2 ))):named a62 ))
(assert (! (forall ((?v0 C_llist$ )(?v1 C_llist$ )(?v2 C_llist$ ))(=> (and (fun_app$ad (fun_app$ae lprefix$a ?v0 )?v1 )(fun_app$ad (fun_app$ae lprefix$a ?v1 )?v2 ))(fun_app$ad (fun_app$ae lprefix$a ?v0 )?v2 ))):named a63 ))
...
(assert (! (forall ((?v0 B_llist$ )(?v1 B_llist$ )(?v2 B$ ))(=> (fun_app$ab (fun_app$ac lprefix$ ?v0 )?v1 )(fun_app$ab (fun_app$ac lprefix$ (lCons$ ?v2 ?v0 ))(lCons$ ?v2 ?v1 )))):named a66 ))
(assert (! (forall ((?v0 C_llist$ )(?v1 C_llist$ )(?v2 C$ ))(=> (fun_app$ad (fun_app$ae lprefix$a ?v0 )?v1 )(fun_app$ad (fun_app$ae lprefix$a (lCons$a ?v2 ?v0 ))(lCons$a ?v2 ?v1 )))):named a67 ))
(assert (! (forall ((?v0 A_b_llist_fun$ ))(fun_app$af (fun_app$ag (fun_ord$ lprefix$ )?v0 )?v0 )):named a68 ))
(check-sat )
;(get-unsat-core )
