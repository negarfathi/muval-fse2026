...
(declare-codatatypes ()((B_a_prod_llist$ (lNil$ )(lCons$ (lhd$ B_a_prod$ )(ltl$ B_a_prod_llist$ )))(B_llist$ (lNil$a )(lCons$a (lhd$a B$ )(ltl$a B_llist$ )))(A_llist$ (lNil$b )(lCons$b (lhd$b A$ )(ltl$b A_llist$ )))))
(declare-sort A_b_a_prod_prod$ 0)
(declare-fun fst$a (A_b_a_prod_prod$)A$)
(declare-fun snd$a (A_b_a_prod_prod$)B_a_prod$)
(declare-fun pair$a (A$ B_a_prod$ )A_b_a_prod_prod$)
(declare-codatatypes ()((A_b_a_prod_prod_llist$ (lNil$c )(lCons$c (lhd$c A_b_a_prod_prod$ )(ltl$c A_b_a_prod_prod_llist$ )))))
...
(declare-codatatypes ()((B_b_a_prod_prod_llist$ (lNil$f )(lCons$f (lhd$f B_b_a_prod_prod$ )(ltl$f B_b_a_prod_prod_llist$ )))))
(declare-sort B_b_prod$ 0)
(declare-fun fst$e (B_b_prod$)B$)
(declare-fun snd$e (B_b_prod$)B$)
(declare-fun pair$e (B$ B$ )B_b_prod$)
(declare-codatatypes ()((B_b_prod_llist$ (lNil$g )(lCons$g (lhd$g B_b_prod$ )(ltl$g B_b_prod_llist$ )))))
...
(declare-codatatypes ()((B_a_prod_a_prod_llist$ (lNil$h )(lCons$h (lhd$h B_a_prod_a_prod$ )(ltl$h B_a_prod_a_prod_llist$ )))))
...
(declare-codatatypes ()((B_a_prod_b_prod_llist$ (lNil$i )(lCons$i (lhd$i B_a_prod_b_prod$ )(ltl$i B_a_prod_b_prod_llist$ )))))
...
(declare-codatatypes ()((B_a_prod_b_a_prod_prod_llist$ (lNil$j )(lCons$j (lhd$j B_a_prod_b_a_prod_prod$ )(ltl$j B_a_prod_b_a_prod_prod_llist$ )))))
