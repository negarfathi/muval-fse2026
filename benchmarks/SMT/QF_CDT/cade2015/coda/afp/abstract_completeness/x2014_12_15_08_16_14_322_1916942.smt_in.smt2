...
(declare-codatatypes ()((State_rule_prod_stream$ (sCons$d (shd$d State_rule_prod$ )(stl$d State_rule_prod_stream$ )))(State_stream$ (sCons$e (shd$e State$ )(stl$e State_stream$ )))(Rule_rule_prod_stream$ (sCons$f (shd$f Rule_rule_prod$ )(stl$f Rule_rule_prod_stream$ )))))
