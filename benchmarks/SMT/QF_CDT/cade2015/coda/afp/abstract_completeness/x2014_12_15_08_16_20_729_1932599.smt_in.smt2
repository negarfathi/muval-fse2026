...
(declare-codatatypes ()((Rule_stream$ (sCons$ (shd$ Rule$ )(stl$ Rule_stream$ )))(State_stream$ (sCons$a (shd$a State$ )(stl$a State_stream$ )))))
...
(declare-codatatypes ()((Rule_rule_rule_prod_prod_stream$ (sCons$e (shd$e Rule_rule_rule_prod_prod$ )(stl$e Rule_rule_rule_prod_prod_stream$ )))(Rule_rule_prod_stream$ (sCons$f (shd$f Rule_rule_prod$ )(stl$f Rule_rule_prod_stream$ )))))
...
(declare-codatatypes ()((State_rule_rule_prod_prod_stream$ (sCons$j (shd$j State_rule_rule_prod_prod$ )(stl$j State_rule_rule_prod_prod_stream$ )))))
...
(declare-codatatypes ()((Rule_state_rule_prod_prod_stream$ (sCons$k (shd$k Rule_state_rule_prod_prod$ )(stl$k Rule_state_rule_prod_prod_stream$ )))))
(declare-sort Rule_rule_prod_state_prod$ 0)
(declare-fun fst$j (Rule_rule_prod_state_prod$)Rule_rule_prod$)
(declare-fun snd$j (Rule_rule_prod_state_prod$)State$)
(declare-fun pair$j (Rule_rule_prod$ State$ )Rule_rule_prod_state_prod$)
(declare-codatatypes ()((Rule_rule_prod_state_prod_stream$ (sCons$l (shd$l Rule_rule_prod_state_prod$ )(stl$l Rule_rule_prod_state_prod_stream$ )))))
