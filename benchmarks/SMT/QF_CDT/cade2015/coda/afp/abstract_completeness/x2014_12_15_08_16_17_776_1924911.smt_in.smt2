...
(declare-codatatypes ()((Rule_stream$ (sCons$ (shd$ Rule$ )(stl$ Rule_stream$ )))(State_stream$ (sCons$a (shd$a State$ )(stl$a State_stream$ )))(State_stream_stream$ (sCons$b (shd$b State_stream$ )(stl$b State_stream_stream$ )))(Rule_stream_stream$ (sCons$c (shd$c Rule_stream$ )(stl$c Rule_stream_stream$ )))(State_stream_stream_stream$ (sCons$d (shd$d State_stream_stream$ )(stl$d State_stream_stream_stream$ )))(Rule_stream_stream_stream$ (sCons$e (shd$e Rule_stream_stream$ )(stl$e Rule_stream_stream_stream$ )))))
(declare-fun r$ ()Rule$ )
(declare-fun s$ ()State$ )
