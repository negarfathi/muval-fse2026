...
(assert (! (not (and (= (fst$ (shd$ steps$ ))s$ )(and (epath$ eff$ rules$ steps$ )(saturated$ eff$ rules$ steps$ )))):named a0 ))
(assert (! (member$ s$ s$a ):named a1 ))
(assert (! (ipath$ (mkTree$ eff$ (fenum$ rules$ )s$ )steps$ ):named a2 ))
(assert (! (=> (forall ((?v0 State_rule_prod_stream$ ))(=> (ipath$ (mkTree$ eff$ (fenum$ rules$ )s$ )?v0 )false ))false ):named a3 ))
(assert (! (not (tfinite$ (mkTree$ eff$ (fenum$ rules$ )s$ ))):named a4 ))
...
(assert (! (forall ((?v0 State$ )(?v1 Rule_stream$ )(?v2 State_rule_prod_stream$ ))(=> (and (member$ ?v0 s$a )(and (fair$ rules$ ?v1 )(ipath$ (mkTree$ eff$ ?v1 ?v0 )?v2 )))(saturated$ eff$ rules$ ?v2 ))):named a7 ))
(assert (! (not (exists ((?v0 State_rule_prod_tree$ ))(and (= (fst$ (root$ ?v0 ))s$ )(and (wf$ eff$ rules$ ?v0 )(tfinite$ ?v0 ))))):named a8 ))
...
(assert (! (forall ((?v0 Rule$ ))(=> (member$a ?v0 (sset$ rules$ ))(per$ eff$ rules$ s$a ?v0 ))):named a13 ))
(assert (! (forall ((?v0 State$ )(?v1 Rule_stream$ ))(=> (and (member$ ?v0 s$a )(fair$ rules$ ?v1 ))(fair$ rules$ (trim$ eff$ ?v1 ?v0 )))):named a14 ))
(assert (! (forall ((?v0 State$ )(?v1 Rule_stream$ ))(=> (and (member$ ?v0 s$a )(fair$ rules$ ?v1 ))(wf$ eff$ rules$ (mkTree$ eff$ ?v1 ?v0 )))):named a15 ))
(assert (! (forall ((?v0 State$ )(?v1 Rule_stream$ )(?v2 State_rule_prod_stream$ )(?v3 Rule$ ))(=> (and (member$ ?v0 s$a )(and (fair$ rules$ ?v1 )(and (ipath$ (mkTree$ eff$ ?v1 ?v0 )?v2 )(member$a ?v3 (sset$ rules$ )))))(saturated$a eff$ ?v3 ?v2 ))):named a16 ))
