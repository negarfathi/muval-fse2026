...
(declare-codatatypes ()((Rule_rule_prod_stream$ (sCons$b (shd$b Rule_rule_prod$ )(stl$b Rule_rule_prod_stream$ )))(State_stream$ (sCons$c (shd$c State$ )(stl$c State_stream$ )))))
...
(declare-codatatypes ()((Rule_state_rule_prod_prod_stream$ (sCons$d (shd$d Rule_state_rule_prod_prod$ )(stl$d Rule_state_rule_prod_prod_stream$ )))))
...
(declare-codatatypes ()((State_rule_prod_rule_prod_stream$ (sCons$e (shd$e State_rule_prod_rule_prod$ )(stl$e State_rule_prod_rule_prod_stream$ )))))
...
(declare-codatatypes ()((Rule_rule_rule_prod_prod_stream$ (sCons$i (shd$i Rule_rule_rule_prod_prod$ )(stl$i Rule_rule_rule_prod_prod_stream$ )))))
...
(declare-codatatypes ()((State_rule_prod_state_prod_stream$ (sCons$j (shd$j State_rule_prod_state_prod$ )(stl$j State_rule_prod_state_prod_stream$ )))))
...
(declare-codatatypes ()((State_state_rule_prod_prod_stream$ (sCons$k (shd$k State_state_rule_prod_prod$ )(stl$k State_state_rule_prod_prod_stream$ )))))
(declare-fun n$ ()Nat$ )
