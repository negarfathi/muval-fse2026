...
(declare-codatatypes ()((Rule_stream$ (sCons$ (shd$ Rule$ )(stl$ Rule_stream$ )))(Rule_stream_stream$ (sCons$a (shd$a Rule_stream$ )(stl$a Rule_stream_stream$ )))(Rule_stream_stream_stream$ (sCons$b (shd$b Rule_stream_stream$ )(stl$b Rule_stream_stream_stream$ )))))
(declare-fun r$ ()Rule$ )
