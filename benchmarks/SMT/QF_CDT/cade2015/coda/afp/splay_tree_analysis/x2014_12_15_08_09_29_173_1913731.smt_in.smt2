...
(assert (! (not (<= (+ (- (+ (+ (log$ 2.0 (real$ (size1$ ll$ )))(log$ 2.0 (real$ (size1$ (node$ r$ b$ (node$ lr$ c$ r$a ))))))(log$ 2.0 (real$ (size1$ (node$ lr$ c$ r$a )))))(* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$ ))))))2.0 )(+ (- (+ (log$ 2.0 (real$ (size1$ (node$ r$ b$ (node$ lr$ c$ r$a )))))(* 2.0 (log$ 2.0 (real$ (size1$ (node$ l$ c$ r$a ))))))(* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$ ))))))1.0 ))):named a0 ))
...
(assert (! (=> (forall ((?v0 A_tree$ )(?v1 A$ )(?v2 A_tree$ ))(=> (= (splay$ aa$ ll$ )(node$ ?v0 ?v1 ?v2 ))false ))false ):named a5 ))
...
(assert (! (<= (a$ aa$ (node$ l$ c$ r$a ))(+ (- (+ (+ (log$ 2.0 (real$ (size1$ ll$ )))(log$ 2.0 (real$ (size1$ (node$ r$ b$ (node$ lr$ c$ r$a ))))))(log$ 2.0 (real$ (size1$ (node$ lr$ c$ r$a )))))(* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$ ))))))2.0 )):named a13 ))
(assert (! (<= (+ (- (- (+ (+ (a$ aa$ ll$ )(log$ 2.0 (real$ (size1$ (node$ r$ b$ (node$ lr$ c$ r$a ))))))(log$ 2.0 (real$ (size1$ (node$ lr$ c$ r$a )))))(log$ 2.0 (real$ (size1$ (node$ ll$ b$ lr$ )))))(log$ 2.0 (real$ (size1$ (node$ l$a u$ r$ )))))1.0 )(+ (- (- (- (+ (+ (* 3.0 (log$ 2.0 (real$ (size1$ ll$ ))))(log$ 2.0 (real$ (size1$ (node$ r$ b$ (node$ lr$ c$ r$a ))))))(log$ 2.0 (real$ (size1$ (node$ lr$ c$ r$a )))))(log$ 2.0 (real$ (size1$ (node$ ll$ b$ lr$ )))))(log$ 2.0 (real$ (size1$ (node$ l$a u$ r$ )))))(* 3.0 (log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$ ))))))2.0 )):named a14 ))
(assert (! (= (a$ aa$ (node$ l$ c$ r$a ))(+ (- (- (+ (+ (a$ aa$ ll$ )(log$ 2.0 (real$ (size1$ (node$ r$ b$ (node$ lr$ c$ r$a ))))))(log$ 2.0 (real$ (size1$ (node$ lr$ c$ r$a )))))(log$ 2.0 (real$ (size1$ (node$ ll$ b$ lr$ )))))(log$ 2.0 (real$ (size1$ (node$ l$a u$ r$ )))))1.0 )):named a15 ))
