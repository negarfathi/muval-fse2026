...
(assert (! (not (<= (a$ aa$ leaf$ )(+ (* 3.0 (- (log$ 2.0 (real$ (size1$ leaf$ )))(log$ 2.0 (real$ (size1$ (node$ la$ aa$ ra$ ))))))1.0 ))):named a0 ))
(assert (! (bst$ leaf$ ):named a1 ))
(assert (! (member$ (node$ la$ aa$ ra$ )(subtrees$ leaf$ )):named a2 ))
