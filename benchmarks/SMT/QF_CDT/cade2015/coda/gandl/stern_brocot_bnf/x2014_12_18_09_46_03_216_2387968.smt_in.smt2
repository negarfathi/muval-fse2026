...
(declare-codatatypes ()((Nat_nat_prod_tree$ (node$b (root$a Nat_nat_prod$ )(left$a Nat_nat_prod_tree$ )(right$a Nat_nat_prod_tree$ )))(Rat_rat_fun_tree$ (node$c (selectc$ Rat_rat_fun$ )(selectd$ Rat_rat_fun_tree$ )(selecte$ Rat_rat_fun_tree$ )))(Rat_rat_fun_rat_fun_tree$ (node$d (selectf$ Rat_rat_fun_rat_fun$ )(selectg$ Rat_rat_fun_rat_fun_tree$ )(selecth$ Rat_rat_fun_rat_fun_tree$ )))(Rat_rat_rat_fun_fun_tree$ (node$e (selecti$ Rat_rat_rat_fun_fun$ )(selectj$ Rat_rat_rat_fun_fun_tree$ )(selectk$ Rat_rat_rat_fun_fun_tree$ )))(Rat_nat_nat_prod_fun_tree$ (node$f (selectl$ Rat_nat_nat_prod_fun$ )(selectm$ Rat_nat_nat_prod_fun_tree$ )(selectn$ Rat_nat_nat_prod_fun_tree$ )))(Nat_nat_prod_rat_fun_rat_fun_tree$ (node$g (selecto$ Nat_nat_prod_rat_fun_rat_fun$ )(selectp$ Nat_nat_prod_rat_fun_rat_fun_tree$ )(selectq$ Nat_nat_prod_rat_fun_rat_fun_tree$ )))(Rat_rat_fun_rat_rat_fun_fun_tree$ (node$h (selectr$ Rat_rat_fun_rat_rat_fun_fun$ )(selects$ Rat_rat_fun_rat_rat_fun_fun_tree$ )(selectt$ Rat_rat_fun_rat_rat_fun_fun_tree$ )))(Nat_nat_prod_rat_rat_fun_fun_tree$ (node$i (selectu$ Nat_nat_prod_rat_rat_fun_fun$ )(selectv$ Nat_nat_prod_rat_rat_fun_fun_tree$ )(selectw$ Nat_nat_prod_rat_rat_fun_fun_tree$ )))(Rat_nat_nat_prod_rat_fun_fun_tree$ (node$j (selectx$ Rat_nat_nat_prod_rat_fun_fun$ )(selecty$ Rat_nat_nat_prod_rat_fun_fun_tree$ )(selectz$ Rat_nat_nat_prod_rat_fun_fun_tree$ )))(Rat_rat_fun_nat_nat_prod_fun_tree$ (node$k (selecua$ Rat_rat_fun_nat_nat_prod_fun$ )(selecub$ Rat_rat_fun_nat_nat_prod_fun_tree$ )(selecuc$ Rat_rat_fun_nat_nat_prod_fun_tree$ )))(Nat_tree$ (node$l (root$b Nat$ )(left$b Nat_tree$ )(right$b Nat_tree$ )))(Int_tree$ (node$m (root$c Int )(left$c Int_tree$ )(right$c Int_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_tree$ (node$n (selecud$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun$ )(selecue$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_tree$ )(selecuf$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_tree$ )))(Rat_nat_fun_tree$ (node$o (selecug$ Rat_nat_fun$ )(selecuh$ Rat_nat_fun_tree$ )(selecui$ Rat_nat_fun_tree$ )))(Rat_int_fun_tree$ (node$p (selecuj$ Rat_int_fun$ )(selecuk$ Rat_int_fun_tree$ )(selecul$ Rat_int_fun_tree$ )))(Nat_rat_fun_tree$ (node$q (selecum$ Nat_rat_fun$ )(selecun$ Nat_rat_fun_tree$ )(selecuo$ Nat_rat_fun_tree$ )))(Nat_nat_fun_tree$ (node$r (selecup$ Nat_nat_fun$ )(selecuq$ Nat_nat_fun_tree$ )(selecur$ Nat_nat_fun_tree$ )))(Nat_int_fun_tree$ (node$s (selecus$ Nat_int_fun$ )(selecut$ Nat_int_fun_tree$ )(selecuu$ Nat_int_fun_tree$ )))(Int_rat_fun_tree$ (node$t (selecuv$ Int_rat_fun$ )(selecuw$ Int_rat_fun_tree$ )(selecux$ Int_rat_fun_tree$ )))(Int_nat_fun_tree$ (node$u (selecuy$ Int_nat_fun$ )(selecuz$ Int_nat_fun_tree$ )(selecva$ Int_nat_fun_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$ (node$v (selecvb$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun$ )(selecvc$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$ )(selecvd$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$ (node$w (selecve$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun$ )(selecvf$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$ )(selecvg$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ (node$x (selecvh$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun$ )(selecvi$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ )(selecvj$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ (node$y (selecvk$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun$ )(selecvl$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ )(selecvm$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$ (node$z (selecvn$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun$ )(selecvo$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$ )(selecvp$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$ (node$aa (selecvq$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun$ )(selecvr$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$ )(selecvs$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ (node$ab (selecvt$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun$ )(selecvu$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ )(selecvv$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ (node$ac (selecvw$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun$ )(selecvx$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ )(selecvy$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ (node$ad (selecvz$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun$ )(selecwa$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ )(selecwb$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ )))(Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ (node$ae (selecwc$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun$ )(selecwd$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ )(selecwe$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ )))(Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$ (node$af (selecwf$ Nat_nat_prod_rat_fun_rat_fun_rat_fun$ )(selecwg$ Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$ )(selecwh$ Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$ )))(Nat_tree_tree$ (node$ag (root$d Nat_tree$ )(left$d Nat_tree_tree$ )(right$d Nat_tree_tree$ )))(Rat_tree_tree$ (node$ah (root$e Rat_tree$ )(left$e Rat_tree_tree$ )(right$e Rat_tree_tree$ )))(Int_tree_tree$ (node$ai (root$f Int_tree$ )(left$f Int_tree_tree$ )(right$f Int_tree_tree$ )))(Int_tree_tree_tree$ (node$aj (root$g Int_tree_tree$ )(left$g Int_tree_tree_tree$ )(right$g Int_tree_tree_tree$ )))(Nat_tree_tree_tree$ (node$ak (root$h Nat_tree_tree$ )(left$h Nat_tree_tree_tree$ )(right$h Nat_tree_tree_tree$ )))))
(declare-fun m$ ()Nat$ )
(declare-fun n$ ()Nat$ )
