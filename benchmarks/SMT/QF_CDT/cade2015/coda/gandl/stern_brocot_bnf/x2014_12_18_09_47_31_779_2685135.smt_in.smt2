...
(declare-codatatypes ()((A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(B_a_fun_stream$ (sCons$a (select$ B_a_fun$ )(selecta$ B_a_fun_stream$ )))(B_stream$ (sCons$b (shd$a B$ )(stl$a B_stream$ )))(B_a_fun_b_a_fun_fun_stream$ (sCons$c (selectb$ B_a_fun_b_a_fun_fun$ )(selectc$ B_a_fun_b_a_fun_fun_stream$ )))(B_b_fun_stream$ (sCons$d (selectd$ B_b_fun$ )(selecte$ B_b_fun_stream$ )))(A_b_fun_stream$ (sCons$e (selectf$ A_b_fun$ )(selectg$ A_b_fun_stream$ )))(A_a_fun_stream$ (sCons$f (selecth$ A_a_fun$ )(selecti$ A_a_fun_stream$ )))(B_a_fun_b_fun_stream$ (sCons$g (selectj$ B_a_fun_b_fun$ )(selectk$ B_a_fun_b_fun_stream$ )))(B_a_fun_a_fun_stream$ (sCons$h (selectl$ B_a_fun_a_fun$ )(selectm$ B_a_fun_a_fun_stream$ )))(A_b_a_fun_fun_stream$ (sCons$i (selectn$ A_b_a_fun_fun$ )(selecto$ A_b_a_fun_fun_stream$ )))(B_b_a_fun_fun_stream$ (sCons$j (selectp$ B_b_a_fun_fun$ )(selectq$ B_b_a_fun_fun_stream$ )))(B_b_b_a_fun_fun_fun_stream$ (sCons$k (selectr$ B_b_b_a_fun_fun_fun$ )(selects$ B_b_b_a_fun_fun_fun_stream$ )))(A_b_a_fun_b_a_fun_fun_fun_stream$ (sCons$l (selectt$ A_b_a_fun_b_a_fun_fun_fun$ )(selectu$ A_b_a_fun_b_a_fun_fun_fun_stream$ )))(A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun_stream$ (sCons$m (selectv$ A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun$ )(selectw$ A_b_a_fun_b_a_fun_fun_fun_a_b_a_fun_b_a_fun_fun_fun_fun_stream$ )))(A_b_b_a_fun_fun_fun_stream$ (sCons$n (selectx$ A_b_b_a_fun_fun_fun$ )(selecty$ A_b_b_a_fun_fun_fun_stream$ )))(A_b_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_stream$ (sCons$o (selectz$ A_b_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun$ )(selecua$ A_b_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_stream$ )))(A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$ (sCons$p (selecub$ A_b_a_fun_fun_a_b_a_fun_fun_fun$ )(selecuc$ A_b_a_fun_fun_a_b_a_fun_fun_fun_stream$ )))(A_b_fun_a_b_fun_fun_stream$ (sCons$q (selecud$ A_b_fun_a_b_fun_fun$ )(selecue$ A_b_fun_a_b_fun_fun_stream$ )))(A_a_fun_a_a_fun_fun_stream$ (sCons$r (selecuf$ A_a_fun_a_a_fun_fun$ )(selecug$ A_a_fun_a_a_fun_fun_stream$ )))(B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_stream$ (sCons$s (selecuh$ B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun$ )(selecui$ B_a_fun_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_stream$ )))(B_b_a_fun_fun_b_b_a_fun_fun_fun_stream$ (sCons$t (selecuj$ B_b_a_fun_fun_b_b_a_fun_fun_fun$ )(selecuk$ B_b_a_fun_fun_b_b_a_fun_fun_fun_stream$ )))(B_a_fun_b_a_fun_b_a_fun_fun_fun_stream$ (sCons$u (selecul$ B_a_fun_b_a_fun_b_a_fun_fun_fun$ )(selecum$ B_a_fun_b_a_fun_b_a_fun_fun_fun_stream$ )))))
