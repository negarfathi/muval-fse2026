...
(declare-codatatypes ()((A_a_fun_a_a_fun_fun_stream$ (sCons$a (selectb$ A_a_fun_a_a_fun_fun$ )(selectc$ A_a_fun_a_a_fun_fun_stream$ )))(A_a_fun_a_fun_stream$ (sCons$b (selectd$ A_a_fun_a_fun$ )(selecte$ A_a_fun_a_fun_stream$ )))(A_a_a_fun_fun_stream$ (sCons$c (selectf$ A_a_a_fun_fun$ )(selectg$ A_a_a_fun_fun_stream$ )))(A_stream_stream$ (sCons$d (shd$a A_stream$ )(stl$a A_stream_stream$ )))(A_a_fun_stream$ (sCons$e (selecth$ A_a_fun$ )(selecti$ A_a_fun_stream$ )))(A_a_stream_fun_stream$ (sCons$f (selectj$ A_a_stream_fun$ )(selectk$ A_a_stream_fun_stream$ )))(A_stream_a_fun_stream$ (sCons$g (selectl$ A_stream_a_fun$ )(selectm$ A_stream_a_fun_stream$ )))(A_stream_a_stream_fun_stream$ (sCons$h (selectn$ A_stream_a_stream_fun$ )(selecto$ A_stream_a_stream_fun_stream$ )))(A_a_fun_a_stream_fun_stream$ (sCons$i (selectp$ A_a_fun_a_stream_fun$ )(selectq$ A_a_fun_a_stream_fun_stream$ )))(A_stream_a_a_fun_fun_stream$ (sCons$j (selectr$ A_stream_a_a_fun_fun$ )(selects$ A_stream_a_a_fun_fun_stream$ )))(A_a_a_fun_a_fun_fun_stream$ (sCons$k (selectt$ A_a_a_fun_a_fun_fun$ )(selectu$ A_a_a_fun_a_fun_fun_stream$ )))(A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(A_tree_tree$ (node$a (root$a A_tree$ )(left$a A_tree_tree$ )(right$a A_tree_tree$ )))(A_tree_tree_stream$ (sCons$l (shd$b A_tree_tree$ )(stl$b A_tree_tree_stream$ )))(A_stream_stream_tree$ (node$b (root$b A_stream_stream$ )(left$b A_stream_stream_tree$ )(right$b A_stream_stream_tree$ )))(A_stream_stream_tree_stream$ (sCons$m (shd$c A_stream_stream_tree$ )(stl$c A_stream_stream_tree_stream$ )))(A_stream_tree$ (node$c (root$c A_stream$ )(left$c A_stream_tree$ )(right$c A_stream_tree$ )))(A_stream_tree_stream$ (sCons$n (shd$d A_stream_tree$ )(stl$d A_stream_tree_stream$ )))(A_stream_tree_stream_stream$ (sCons$o (shd$e A_stream_tree_stream$ )(stl$e A_stream_tree_stream_stream$ )))(A_tree_stream$ (sCons$p (shd$f A_tree$ )(stl$f A_tree_stream$ )))(A_tree_stream_stream$ (sCons$q (shd$g A_tree_stream$ )(stl$g A_tree_stream_stream$ )))(A_stream_stream_stream$ (sCons$r (shd$h A_stream_stream$ )(stl$h A_stream_stream_stream$ )))(A_stream_stream_stream_stream$ (sCons$s (shd$i A_stream_stream_stream$ )(stl$i A_stream_stream_stream_stream$ )))(A_a_fun_stream_stream$ (sCons$t (shd$j A_a_fun_stream$ )(stl$j A_a_fun_stream_stream$ )))(A_a_fun_a_a_fun_fun_tree$ (node$d (selectv$ A_a_fun_a_a_fun_fun$ )(selectw$ A_a_fun_a_a_fun_fun_tree$ )(selectx$ A_a_fun_a_a_fun_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$e (selecty$ A_a_fun_a_fun$ )(selectz$ A_a_fun_a_fun_tree$ )(selecua$ A_a_fun_a_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$f (selecub$ A_a_a_fun_fun$ )(selecuc$ A_a_a_fun_fun_tree$ )(selecud$ A_a_a_fun_fun_tree$ )))(A_a_fun_tree$ (node$g (selecue$ A_a_fun$ )(selecuf$ A_a_fun_tree$ )(selecug$ A_a_fun_tree$ )))(A_tree_tree_tree$ (node$h (root$d A_tree_tree$ )(left$d A_tree_tree_tree$ )(right$d A_tree_tree_tree$ )))(A_stream_stream_tree_tree$ (node$i (root$e A_stream_stream_tree$ )(left$e A_stream_stream_tree_tree$ )(right$e A_stream_stream_tree_tree$ )))(A_stream_tree_stream_tree$ (node$j (root$f A_stream_tree_stream$ )(left$f A_stream_tree_stream_tree$ )(right$f A_stream_tree_stream_tree$ )))(A_tree_stream_tree$ (node$k (root$g A_tree_stream$ )(left$g A_tree_stream_tree$ )(right$g A_tree_stream_tree$ )))(A_stream_stream_stream_tree$ (node$l (root$h A_stream_stream_stream$ )(left$h A_stream_stream_stream_tree$ )(right$h A_stream_stream_stream_tree$ )))(A_stream_tree_tree$ (node$m (root$i A_stream_tree$ )(left$i A_stream_tree_tree$ )(right$i A_stream_tree_tree$ )))))
(declare-fun n$ ()Num$ )
