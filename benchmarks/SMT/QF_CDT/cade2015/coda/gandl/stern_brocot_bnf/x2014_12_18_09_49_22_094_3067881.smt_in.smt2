...
(declare-codatatypes ()((Int_tree$ (node$ (root$ Int )(left$ Int_tree$ )(right$ Int_tree$ )))(Nat_tree$ (node$a (root$a Nat$ )(left$a Nat_tree$ )(right$a Nat_tree$ )))))
(declare-sort Num$ 0)
(declare-fun one$ ()Num$)
...
(declare-codatatypes ()((Nat_tree_tree$ (node$b (root$b Nat_tree$ )(left$b Nat_tree_tree$ )(right$b Nat_tree_tree$ )))(Nat_tree_tree_tree$ (node$c (root$c Nat_tree_tree$ )(left$c Nat_tree_tree_tree$ )(right$c Nat_tree_tree_tree$ )))(Int_tree_tree$ (node$d (root$d Int_tree$ )(left$d Int_tree_tree$ )(right$d Int_tree_tree$ )))(Int_tree_tree_tree$ (node$e (root$e Int_tree_tree$ )(left$e Int_tree_tree_tree$ )(right$e Int_tree_tree_tree$ )))(Nat_tree_tree_tree_tree$ (node$f (root$f Nat_tree_tree_tree$ )(left$f Nat_tree_tree_tree_tree$ )(right$f Nat_tree_tree_tree_tree$ )))(Int_tree_tree_tree_tree$ (node$g (root$g Int_tree_tree_tree$ )(left$g Int_tree_tree_tree_tree$ )(right$g Int_tree_tree_tree_tree$ )))))
(declare-sort Dir$ 0)
