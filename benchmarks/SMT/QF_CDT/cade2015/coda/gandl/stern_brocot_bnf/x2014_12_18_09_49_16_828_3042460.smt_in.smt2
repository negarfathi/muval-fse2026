...
(declare-codatatypes ()((A_bool_fun_tree$ (node$ (select$ A_bool_fun$ )(selecta$ A_bool_fun_tree$ )(selectb$ A_bool_fun_tree$ )))(A_tree$ (node$a (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(A_b_fun_a_bool_fun_fun_tree$ (node$b (selectc$ A_b_fun_a_bool_fun_fun$ )(selectd$ A_b_fun_a_bool_fun_fun_tree$ )(selecte$ A_b_fun_a_bool_fun_fun_tree$ )))(A_b_fun_tree$ (node$c (selectf$ A_b_fun$ )(selectg$ A_b_fun_tree$ )(selecth$ A_b_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$d (selecti$ A_b_fun_a_b_fun_a_bool_fun_fun_fun$ )(selectj$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )(selectk$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )))(Bool_bool_fun_tree$ (node$e (selectl$ Bool_bool_fun$ )(selectm$ Bool_bool_fun_tree$ )(selectn$ Bool_bool_fun_tree$ )))(Bool_a_fun_tree$ (node$f (selecto$ Bool_a_fun$ )(selectp$ Bool_a_fun_tree$ )(selectq$ Bool_a_fun_tree$ )))(A_a_fun_tree$ (node$g (selectr$ A_a_fun$ )(selects$ A_a_fun_tree$ )(selectt$ A_a_fun_tree$ )))(B_tree$ (node$h (root$a B$ )(left$a B_tree$ )(right$a B_tree$ )))(Bool_a_bool_fun_fun_tree$ (node$i (selectu$ Bool_a_bool_fun_fun$ )(selectv$ Bool_a_bool_fun_fun_tree$ )(selectw$ Bool_a_bool_fun_fun_tree$ )))(Bool_a_b_fun_fun_tree$ (node$j (selectx$ Bool_a_b_fun_fun$ )(selecty$ Bool_a_b_fun_fun_tree$ )(selectz$ Bool_a_b_fun_fun_tree$ )))(A_bool_fun_bool_fun_tree$ (node$k (selecua$ A_bool_fun_bool_fun$ )(selecub$ A_bool_fun_bool_fun_tree$ )(selecuc$ A_bool_fun_bool_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun_tree$ (node$l (selecud$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun$ )(selecue$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun_tree$ )(selecuf$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun_tree$ )))(Bool_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$m (selecug$ Bool_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(selecuh$ Bool_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(selecui$ Bool_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$n (selecuj$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(selecuk$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(selecul$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_fun_tree$ (node$o (selecum$ A_b_fun_a_b_fun_fun$ )(selecun$ A_b_fun_a_b_fun_fun_tree$ )(selecuo$ A_b_fun_a_b_fun_fun_tree$ )))(A_b_bool_fun_fun_tree$ (node$p (selecup$ A_b_bool_fun_fun$ )(selecuq$ A_b_bool_fun_fun_tree$ )(selecur$ A_b_bool_fun_fun_tree$ )))(A_bool_bool_fun_fun_tree$ (node$q (selecus$ A_bool_bool_fun_fun$ )(selecut$ A_bool_bool_fun_fun_tree$ )(selecuu$ A_bool_bool_fun_fun_tree$ )))(A_bool_bool_fun_fun_bool_bool_fun_fun_tree$ (node$r (selecuv$ A_bool_bool_fun_fun_bool_bool_fun_fun$ )(selecuw$ A_bool_bool_fun_fun_bool_bool_fun_fun_tree$ )(selecux$ A_bool_bool_fun_fun_bool_bool_fun_fun_tree$ )))(B_bool_fun_tree$ (node$s (selecuy$ B_bool_fun$ )(selecuz$ B_bool_fun_tree$ )(selecva$ B_bool_fun_tree$ )))(A_b_bool_fun_fun_b_bool_fun_fun_tree$ (node$t (selecvb$ A_b_bool_fun_fun_b_bool_fun_fun$ )(selecvc$ A_b_bool_fun_fun_b_bool_fun_fun_tree$ )(selecvd$ A_b_bool_fun_fun_b_bool_fun_fun_tree$ )))(A_a_bool_fun_fun_tree$ (node$u (selecve$ A_a_bool_fun_fun$ )(selecvf$ A_a_bool_fun_fun_tree$ )(selecvg$ A_a_bool_fun_fun_tree$ )))(A_a_bool_fun_fun_a_bool_fun_fun_tree$ (node$v (selecvh$ A_a_bool_fun_fun_a_bool_fun_fun$ )(selecvi$ A_a_bool_fun_fun_a_bool_fun_fun_tree$ )(selecvj$ A_a_bool_fun_fun_a_bool_fun_fun_tree$ )))(A_b_fun_b_fun_tree$ (node$w (selecvk$ A_b_fun_b_fun$ )(selecvl$ A_b_fun_b_fun_tree$ )(selecvm$ A_b_fun_b_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$x (selecvn$ A_a_fun_a_fun$ )(selecvo$ A_a_fun_a_fun_tree$ )(selecvp$ A_a_fun_a_fun_tree$ )))(A_b_fun_a_bool_fun_fun_a_bool_fun_fun_tree$ (node$y (selecvq$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun$ )(selecvr$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun_tree$ )(selecvs$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$z (selecvt$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun$ )(selecvu$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )(selecvv$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )))(A_b_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$aa (selecvw$ A_b_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun$ )(selecvx$ A_b_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )(selecvy$ A_b_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$ab (selecvz$ A_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun$ )(selecwa$ A_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )(selecwb$ A_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$ac (selecwc$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(selecwd$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(selecwe$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$ (node$ad (selecwf$ A_b_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun$ )(selecwg$ A_b_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$ )(selecwh$ A_b_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$ae (selecwi$ A_b_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(selecwj$ A_b_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(selecwk$ A_b_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_a_fun_a_bool_fun_fun_tree$ (node$af (selecwl$ A_a_fun_a_bool_fun_fun$ )(selecwm$ A_a_fun_a_bool_fun_fun_tree$ )(selecwn$ A_a_fun_a_bool_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ (node$ag (selecwo$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun$ )(selecwp$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )(selecwq$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_bool_fun_fun_tree$ (node$ah (selecwr$ A_bool_fun_a_bool_fun_fun$ )(selecws$ A_bool_fun_a_bool_fun_fun_tree$ )(selecwt$ A_bool_fun_a_bool_fun_fun_tree$ )))(A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$ai (selecwu$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun$ )(selecwv$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )(selecww$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_b_fun_fun_tree$ (node$aj (selecwx$ A_bool_fun_a_b_fun_fun$ )(selecwy$ A_bool_fun_a_b_fun_fun_tree$ )(selecwz$ A_bool_fun_a_b_fun_fun_tree$ )))(A_bool_b_fun_fun_a_bool_fun_a_b_fun_fun_fun_tree$ (node$ak (selecxa$ A_bool_b_fun_fun_a_bool_fun_a_b_fun_fun_fun$ )(selecxb$ A_bool_b_fun_fun_a_bool_fun_a_b_fun_fun_fun_tree$ )(selecxc$ A_bool_b_fun_fun_a_bool_fun_a_b_fun_fun_fun_tree$ )))(A_bool_b_fun_fun_tree$ (node$al (selecxd$ A_bool_b_fun_fun$ )(selecxe$ A_bool_b_fun_fun_tree$ )(selecxf$ A_bool_b_fun_fun_tree$ )))(A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ (node$am (selecxg$ A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun$ )(selecxh$ A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ )(selecxi$ A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ )))(A_b_b_fun_fun_tree$ (node$an (selecxj$ A_b_b_fun_fun$ )(selecxk$ A_b_b_fun_fun_tree$ )(selecxl$ A_b_b_fun_fun_tree$ )))(A_b_fun_bool_fun_tree$ (node$ao (selecxm$ A_b_fun_bool_fun$ )(selecxn$ A_b_fun_bool_fun_tree$ )(selecxo$ A_b_fun_bool_fun_tree$ )))(A_b_fun_a_fun_a_b_fun_bool_fun_fun_tree$ (node$ap (selecxp$ A_b_fun_a_fun_a_b_fun_bool_fun_fun$ )(selecxq$ A_b_fun_a_fun_a_b_fun_bool_fun_fun_tree$ )(selecxr$ A_b_fun_a_fun_a_b_fun_bool_fun_fun_tree$ )))(A_b_fun_a_fun_tree$ (node$aq (selecxs$ A_b_fun_a_fun$ )(selecxt$ A_b_fun_a_fun_tree$ )(selecxu$ A_b_fun_a_fun_tree$ )))(A_b_fun_a_bool_fun_fun_a_b_fun_a_fun_a_b_fun_bool_fun_fun_fun_tree$ (node$ar (selecxv$ A_b_fun_a_bool_fun_fun_a_b_fun_a_fun_a_b_fun_bool_fun_fun_fun$ )(selecxw$ A_b_fun_a_bool_fun_fun_a_b_fun_a_fun_a_b_fun_bool_fun_fun_fun_tree$ )(selecxx$ A_b_fun_a_bool_fun_fun_a_b_fun_a_fun_a_b_fun_bool_fun_fun_fun_tree$ )))(A_b_fun_a_fun_a_b_fun_b_fun_fun_tree$ (node$as (selecxy$ A_b_fun_a_fun_a_b_fun_b_fun_fun$ )(selecxz$ A_b_fun_a_fun_a_b_fun_b_fun_fun_tree$ )(selecya$ A_b_fun_a_fun_a_b_fun_b_fun_fun_tree$ )))(A_b_fun_a_b_fun_fun_a_b_fun_a_fun_a_b_fun_b_fun_fun_fun_tree$ (node$at (selecyb$ A_b_fun_a_b_fun_fun_a_b_fun_a_fun_a_b_fun_b_fun_fun_fun$ )(selecyc$ A_b_fun_a_b_fun_fun_a_b_fun_a_fun_a_b_fun_b_fun_fun_fun_tree$ )(selecyd$ A_b_fun_a_b_fun_fun_a_b_fun_a_fun_a_b_fun_b_fun_fun_fun_tree$ )))(A_b_bool_fun_fun_a_bool_fun_fun_tree$ (node$au (selecye$ A_b_bool_fun_fun_a_bool_fun_fun$ )(selecyf$ A_b_bool_fun_fun_a_bool_fun_fun_tree$ )(selecyg$ A_b_bool_fun_fun_a_bool_fun_fun_tree$ )))(A_b_bool_fun_bool_fun_fun_a_b_bool_fun_fun_a_bool_fun_fun_fun_tree$ (node$av (selecyh$ A_b_bool_fun_bool_fun_fun_a_b_bool_fun_fun_a_bool_fun_fun_fun$ )(selecyi$ A_b_bool_fun_bool_fun_fun_a_b_bool_fun_fun_a_bool_fun_fun_fun_tree$ )(selecyj$ A_b_bool_fun_bool_fun_fun_a_b_bool_fun_fun_a_bool_fun_fun_fun_tree$ )))(A_b_bool_fun_bool_fun_fun_tree$ (node$aw (selecyk$ A_b_bool_fun_bool_fun_fun$ )(selecyl$ A_b_bool_fun_bool_fun_fun_tree$ )(selecym$ A_b_bool_fun_bool_fun_fun_tree$ )))(A_b_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$ax (selecyn$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun$ )(selecyo$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )(selecyp$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )))(A_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$ay (selecyq$ A_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun$ )(selecyr$ A_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )(selecys$ A_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )))(A_b_fun_a_bool_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$az (selecyt$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(selecyu$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(selecyv$ A_b_fun_a_bool_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ (node$ba (selecyw$ A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun$ )(selecyx$ A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )(selecyy$ A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$bb (selecyz$ A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(selecza$ A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(seleczb$ A_b_fun_a_b_fun_a_bool_fun_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_b_fun_a_bool_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$bc (seleczc$ A_b_fun_a_bool_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(seleczd$ A_b_fun_a_bool_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(selecze$ A_b_fun_a_bool_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$bd (seleczf$ A_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(seleczg$ A_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(seleczh$ A_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_b_fun_a_bool_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$ (node$be (seleczi$ A_b_fun_a_bool_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun$ )(seleczj$ A_b_fun_a_bool_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$ )(seleczk$ A_b_fun_a_bool_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_bool_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$ )))(A_bool_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$bf (seleczl$ A_bool_fun_a_b_fun_a_bool_fun_fun_fun$ )(seleczm$ A_bool_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )(seleczn$ A_bool_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$bg (seleczo$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(seleczp$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(seleczq$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$bh (seleczr$ A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(seleczs$ A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(seleczt$ A_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$ (node$bi (seleczu$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun$ )(seleczv$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$ )(seleczw$ A_b_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_a_b_fun_a_b_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_fun_tree$ )))(B_bool_fun_a_b_bool_fun_fun_fun_tree$ (node$bj (seleczx$ B_bool_fun_a_b_bool_fun_fun_fun$ )(seleczy$ B_bool_fun_a_b_bool_fun_fun_fun_tree$ )(seleczz$ B_bool_fun_a_b_bool_fun_fun_fun_tree$ )))(B_a_b_fun_fun_tree$ (node$bk (seledaa$ B_a_b_fun_fun$ )(seledab$ B_a_b_fun_fun_tree$ )(seledac$ B_a_b_fun_fun_tree$ )))))
