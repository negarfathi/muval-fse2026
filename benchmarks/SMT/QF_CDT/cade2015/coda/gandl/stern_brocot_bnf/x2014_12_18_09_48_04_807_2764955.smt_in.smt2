...
(declare-codatatypes ()((A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(A_a_fun_nat_fun_stream$ (sCons$a (select$ A_a_fun_nat_fun$ )(selecta$ A_a_fun_nat_fun_stream$ )))(A_a_fun_a_a_fun_fun_stream$ (sCons$b (selectb$ A_a_fun_a_a_fun_fun$ )(selectc$ A_a_fun_a_a_fun_fun_stream$ )))(A_a_fun_a_fun_stream$ (sCons$c (selectd$ A_a_fun_a_fun$ )(selecte$ A_a_fun_a_fun_stream$ )))(A_nat_fun_stream$ (sCons$d (selectf$ A_nat_fun$ )(selectg$ A_nat_fun_stream$ )))(A_a_a_fun_fun_stream$ (sCons$e (selecth$ A_a_a_fun_fun$ )(selecti$ A_a_a_fun_fun_stream$ )))(Nat_stream$ (sCons$f (shd$a Nat$ )(stl$a Nat_stream$ )))(A_a_fun_stream$ (sCons$g (selectj$ A_a_fun$ )(selectk$ A_a_fun_stream$ )))(A_stream_stream$ (sCons$h (shd$b A_stream$ )(stl$b A_stream_stream$ )))(A_stream_stream_stream$ (sCons$i (shd$c A_stream_stream$ )(stl$c A_stream_stream_stream$ )))(Nat_stream_stream$ (sCons$j (shd$d Nat_stream$ )(stl$d Nat_stream_stream$ )))(Nat_stream_stream_stream$ (sCons$k (shd$e Nat_stream_stream$ )(stl$e Nat_stream_stream_stream$ )))(Nat_a_fun_stream$ (sCons$l (selectl$ Nat_a_fun$ )(selectm$ Nat_a_fun_stream$ )))(Nat_nat_fun_stream$ (sCons$m (selectn$ Nat_nat_fun$ )(selecto$ Nat_nat_fun_stream$ )))(Nat_a_a_fun_fun_stream$ (sCons$n (selectp$ Nat_a_a_fun_fun$ )(selectq$ Nat_a_a_fun_fun_stream$ )))(A_a_nat_fun_fun_stream$ (sCons$o (selectr$ A_a_nat_fun_fun$ )(selects$ A_a_nat_fun_fun_stream$ )))(A_a_fun_a_a_fun_nat_fun_fun_stream$ (sCons$p (selectt$ A_a_fun_a_a_fun_nat_fun_fun$ )(selectu$ A_a_fun_a_a_fun_nat_fun_fun_stream$ )))(A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$ (sCons$q (selectv$ A_a_fun_a_a_fun_a_a_fun_fun_fun$ )(selectw$ A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$ )))(A_a_fun_a_a_fun_a_fun_fun_stream$ (sCons$r (selectx$ A_a_fun_a_a_fun_a_fun_fun$ )(selecty$ A_a_fun_a_a_fun_a_fun_fun_stream$ )))(A_a_a_a_fun_fun_fun_stream$ (sCons$s (selectz$ A_a_a_a_fun_fun_fun$ )(selecua$ A_a_a_a_fun_fun_fun_stream$ )))(A_a_a_fun_nat_fun_fun_stream$ (sCons$t (selecub$ A_a_a_fun_nat_fun_fun$ )(selecuc$ A_a_a_fun_nat_fun_fun_stream$ )))(A_a_a_fun_a_fun_fun_stream$ (sCons$u (selecud$ A_a_a_fun_a_fun_fun$ )(selecue$ A_a_a_fun_a_fun_fun_stream$ )))(A_a_fun_a_nat_fun_fun_stream$ (sCons$v (selecuf$ A_a_fun_a_nat_fun_fun$ )(selecug$ A_a_fun_a_nat_fun_fun_stream$ )))(A_a_a_fun_a_a_fun_fun_fun_stream$ (sCons$w (selecuh$ A_a_a_fun_a_a_fun_fun_fun$ )(selecui$ A_a_a_fun_a_a_fun_fun_fun_stream$ )))))
