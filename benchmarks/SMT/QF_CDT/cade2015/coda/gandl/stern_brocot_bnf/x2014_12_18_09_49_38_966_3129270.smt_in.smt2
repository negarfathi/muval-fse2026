...
(declare-codatatypes ()((A_a_prod_stream$ (sCons$ (shd$ A_a_prod$ )(stl$ A_a_prod_stream$ )))(A_a_a_prod_fun_stream$ (sCons$a (select$ A_a_a_prod_fun$ )(selecta$ A_a_a_prod_fun_stream$ )))(A_stream$ (sCons$b (shd$a A$ )(stl$a A_stream$ )))(A_a_a_a_prod_fun_fun_stream$ (sCons$c (selectb$ A_a_a_a_prod_fun_fun$ )(selectc$ A_a_a_a_prod_fun_fun_stream$ )))))
(declare-sort Num$ 0)
(declare-fun one$ ()Num$)
...
(declare-codatatypes ()((A_a_a_fun_fun_stream$ (sCons$d (selectf$ A_a_a_fun_fun$ )(selectg$ A_a_a_fun_fun_stream$ )))(A_a_a_a_a_prod_fun_fun_fun_stream$ (sCons$e (selecth$ A_a_a_a_a_prod_fun_fun_fun$ )(selecti$ A_a_a_a_a_prod_fun_fun_fun_stream$ )))(A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ (sCons$f (selectj$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun$ )(selectk$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ )))(A_a_fun_stream$ (sCons$g (selectl$ A_a_fun$ )(selectm$ A_a_fun_stream$ )))(A_a_a_a_fun_fun_fun_stream$ (sCons$h (selectn$ A_a_a_a_fun_fun_fun$ )(selecto$ A_a_a_a_fun_fun_fun_stream$ )))(A_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ (sCons$i (selectp$ A_a_a_a_a_a_prod_fun_fun_fun_fun$ )(selectq$ A_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ )))(A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$ (sCons$j (selectr$ A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun$ )(selects$ A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$ )))(A_a_a_prod_fun_a_fun_stream$ (sCons$k (selectt$ A_a_a_prod_fun_a_fun$ )(selectu$ A_a_a_prod_fun_a_fun_stream$ )))(A_a_a_fun_fun_a_fun_stream$ (sCons$l (selectv$ A_a_a_fun_fun_a_fun$ )(selectw$ A_a_a_fun_fun_a_fun_stream$ )))(A_a_a_a_prod_fun_fun_a_fun_stream$ (sCons$m (selectx$ A_a_a_a_prod_fun_fun_a_fun$ )(selecty$ A_a_a_a_prod_fun_fun_a_fun_stream$ )))(A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$ (sCons$n (selectz$ A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun$ )(selecua$ A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$ )))(A_a_fun_a_fun_stream$ (sCons$o (selecub$ A_a_fun_a_fun$ )(selecuc$ A_a_fun_a_fun_stream$ )))(A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$ (sCons$p (selecud$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun$ )(selecue$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$ )))(A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ (sCons$q (selecuf$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun$ )(selecug$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ )))(A_a_fun_a_a_fun_a_fun_fun_stream$ (sCons$r (selecuh$ A_a_fun_a_a_fun_a_fun_fun$ )(selecui$ A_a_fun_a_a_fun_a_fun_fun_stream$ )))(A_a_a_a_a_fun_fun_fun_fun_stream$ (sCons$s (selecuj$ A_a_a_a_a_fun_fun_fun_fun$ )(selecuk$ A_a_a_a_a_fun_fun_fun_fun_stream$ )))(A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$ (sCons$t (selecul$ A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun$ )(selecum$ A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$ )))(A_stream_stream$ (sCons$u (shd$b A_stream$ )(stl$b A_stream_stream$ )))(A_stream_stream_stream$ (sCons$v (shd$c A_stream_stream$ )(stl$c A_stream_stream_stream$ )))(A_stream_stream_stream_stream$ (sCons$w (shd$d A_stream_stream_stream$ )(stl$d A_stream_stream_stream_stream$ )))(A_stream_stream_stream_a_stream_stream_stream_fun_stream$ (sCons$x (selecun$ A_stream_stream_stream_a_stream_stream_stream_fun$ )(selecuo$ A_stream_stream_stream_a_stream_stream_stream_fun_stream$ )))(A_stream_stream_stream_a_stream_stream_stream_a_stream_stream_stream_fun_fun_stream$ (sCons$y (selecup$ A_stream_stream_stream_a_stream_stream_stream_a_stream_stream_stream_fun_fun$ )(selecuq$ A_stream_stream_stream_a_stream_stream_stream_a_stream_stream_stream_fun_fun_stream$ )))(A_stream_stream_a_stream_stream_fun_stream$ (sCons$z (selecur$ A_stream_stream_a_stream_stream_fun$ )(selecus$ A_stream_stream_a_stream_stream_fun_stream$ )))(A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$ (sCons$aa (selecut$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun$ )(selecuu$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$ )))(A_stream_a_stream_fun_stream$ (sCons$ab (selecuv$ A_stream_a_stream_fun$ )(selecuw$ A_stream_a_stream_fun_stream$ )))(A_stream_a_stream_a_stream_fun_fun_stream$ (sCons$ac (selecux$ A_stream_a_stream_a_stream_fun_fun$ )(selecuy$ A_stream_a_stream_a_stream_fun_fun_stream$ )))(A_a_a_a_prod_fun_fun_a_a_prod_fun_stream$ (sCons$ad (selecuz$ A_a_a_a_prod_fun_fun_a_a_prod_fun$ )(selecva$ A_a_a_a_prod_fun_fun_a_a_prod_fun_stream$ )))(A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ (sCons$ae (selecvb$ A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun$ )(selecvc$ A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ )))(A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ (sCons$af (selecvd$ A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun$ )(selecve$ A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ )))(A_a_a_prod_fun_a_a_prod_fun_stream$ (sCons$ag (selecvf$ A_a_a_prod_fun_a_a_prod_fun$ )(selecvg$ A_a_a_prod_fun_a_a_prod_fun_stream$ )))(A_a_a_fun_fun_a_a_fun_fun_stream$ (sCons$ah (selecvh$ A_a_a_fun_fun_a_a_fun_fun$ )(selecvi$ A_a_a_fun_fun_a_a_fun_fun_stream$ )))(A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ (sCons$ai (selecvj$ A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun$ )(selecvk$ A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ )))(A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$ (sCons$aj (selecvl$ A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun$ )(selecvm$ A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$ )))(A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ (sCons$ak (selecvn$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun$ )(selecvo$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ )))(A_a_fun_a_fun_a_fun_stream$ (sCons$al (selecvp$ A_a_fun_a_fun_a_fun$ )(selecvq$ A_a_fun_a_fun_a_fun_stream$ )))(A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_stream$ (sCons$am (selecvr$ A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun$ )(selecvs$ A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_stream$ )))(A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ (sCons$an (selecvt$ A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun$ )(selecvu$ A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ )))(A_a_a_prod_fun_a_a_a_prod_fun_fun_stream$ (sCons$ao (selecvv$ A_a_a_prod_fun_a_a_a_prod_fun_fun$ )(selecvw$ A_a_a_prod_fun_a_a_a_prod_fun_fun_stream$ )))(A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$ (sCons$ap (selecvx$ A_a_a_fun_fun_a_a_a_fun_fun_fun$ )(selecvy$ A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$ )))(A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ (sCons$aq (selecvz$ A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun$ )(selecwa$ A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ )))(A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ (sCons$ar (selecwb$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun$ )(selecwc$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ )))(A_a_fun_a_a_fun_fun_stream$ (sCons$as (selecwd$ A_a_fun_a_a_fun_fun$ )(selecwe$ A_a_fun_a_a_fun_fun_stream$ )))(A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_stream$ (sCons$at (selecwf$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun$ )(selecwg$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_stream$ )))(A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$ (sCons$au (selecwh$ A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun$ )(selecwi$ A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$ )))(A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun_stream$ (sCons$av (selecwj$ A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun$ )(selecwk$ A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun_stream$ )))))
