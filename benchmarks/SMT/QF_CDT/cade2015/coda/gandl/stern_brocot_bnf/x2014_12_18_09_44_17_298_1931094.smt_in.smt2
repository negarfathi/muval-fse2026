...
(declare-codatatypes ()((A_b_fun_tree$ (node$ (select$ A_b_fun$ )(selecta$ A_b_fun_tree$ )(selectb$ A_b_fun_tree$ )))(B_a_b_fun_fun_tree$ (node$a (selectc$ B_a_b_fun_fun$ )(selectd$ B_a_b_fun_fun_tree$ )(selecte$ B_a_b_fun_fun_tree$ )))(B_tree$ (node$b (root$ B$ )(left$ B_tree$ )(right$ B_tree$ )))(B_a_b_fun_fun_a_b_fun_fun_tree$ (node$c (selectf$ B_a_b_fun_fun_a_b_fun_fun$ )(selectg$ B_a_b_fun_fun_a_b_fun_fun_tree$ )(selecth$ B_a_b_fun_fun_a_b_fun_fun_tree$ )))(B_b_fun_tree$ (node$d (selecti$ B_b_fun$ )(selectj$ B_b_fun_tree$ )(selectk$ B_b_fun_tree$ )))(B_b_fun_b_fun_tree$ (node$e (selectl$ B_b_fun_b_fun$ )(selectm$ B_b_fun_b_fun_tree$ )(selectn$ B_b_fun_b_fun_tree$ )))(B_a_fun_tree$ (node$f (selecto$ B_a_fun$ )(selectp$ B_a_fun_tree$ )(selectq$ B_a_fun_tree$ )))(A_tree$ (node$g (root$a A$ )(left$a A_tree$ )(right$a A_tree$ )))(B_a_fun_a_fun_tree$ (node$h (selectr$ B_a_fun_a_fun$ )(selects$ B_a_fun_a_fun_tree$ )(selectt$ B_a_fun_a_fun_tree$ )))(A_b_fun_b_fun_tree$ (node$i (selectu$ A_b_fun_b_fun$ )(selectv$ A_b_fun_b_fun_tree$ )(selectw$ A_b_fun_b_fun_tree$ )))(B_b_a_b_fun_fun_fun_tree$ (node$j (selectx$ B_b_a_b_fun_fun_fun$ )(selecty$ B_b_a_b_fun_fun_fun_tree$ )(selectz$ B_b_a_b_fun_fun_fun_tree$ )))(B_b_a_b_fun_fun_fun_b_a_b_fun_fun_fun_tree$ (node$k (selecua$ B_b_a_b_fun_fun_fun_b_a_b_fun_fun_fun$ )(selecub$ B_b_a_b_fun_fun_fun_b_a_b_fun_fun_fun_tree$ )(selecuc$ B_b_a_b_fun_fun_fun_b_a_b_fun_fun_fun_tree$ )))(B_a_b_fun_a_b_fun_fun_fun_tree$ (node$l (selecud$ B_a_b_fun_a_b_fun_fun_fun$ )(selecue$ B_a_b_fun_a_b_fun_fun_fun_tree$ )(selecuf$ B_a_b_fun_a_b_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_fun_tree$ (node$m (selecug$ A_b_fun_a_b_fun_fun$ )(selecuh$ A_b_fun_a_b_fun_fun_tree$ )(selecui$ A_b_fun_a_b_fun_fun_tree$ )))(B_a_b_fun_a_b_fun_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ (node$n (selecuj$ B_a_b_fun_a_b_fun_fun_fun_a_b_fun_a_b_fun_fun_fun$ )(selecuk$ B_a_b_fun_a_b_fun_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ )(selecul$ B_a_b_fun_a_b_fun_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ )))(A_a_fun_tree$ (node$o (selecum$ A_a_fun$ )(selecun$ A_a_fun_tree$ )(selecuo$ A_a_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$p (selecup$ A_a_fun_a_fun$ )(selecuq$ A_a_fun_a_fun_tree$ )(selecur$ A_a_fun_a_fun_tree$ )))(A_b_b_fun_fun_tree$ (node$q (selecus$ A_b_b_fun_fun$ )(selecut$ A_b_b_fun_fun_tree$ )(selecuu$ A_b_b_fun_fun_tree$ )))(A_b_b_fun_fun_b_b_fun_fun_tree$ (node$r (selecuv$ A_b_b_fun_fun_b_b_fun_fun$ )(selecuw$ A_b_b_fun_fun_b_b_fun_fun_tree$ )(selecux$ A_b_b_fun_fun_b_b_fun_fun_tree$ )))(A_b_a_fun_fun_tree$ (node$s (selecuy$ A_b_a_fun_fun$ )(selecuz$ A_b_a_fun_fun_tree$ )(selecva$ A_b_a_fun_fun_tree$ )))(A_b_a_fun_fun_b_a_fun_fun_tree$ (node$t (selecvb$ A_b_a_fun_fun_b_a_fun_fun$ )(selecvc$ A_b_a_fun_fun_b_a_fun_fun_tree$ )(selecvd$ A_b_a_fun_fun_b_a_fun_fun_tree$ )))(A_a_b_fun_fun_tree$ (node$u (selecve$ A_a_b_fun_fun$ )(selecvf$ A_a_b_fun_fun_tree$ )(selecvg$ A_a_b_fun_fun_tree$ )))(A_a_b_fun_fun_a_b_fun_fun_tree$ (node$v (selecvh$ A_a_b_fun_fun_a_b_fun_fun$ )(selecvi$ A_a_b_fun_fun_a_b_fun_fun_tree$ )(selecvj$ A_a_b_fun_fun_a_b_fun_fun_tree$ )))(A_b_fun_a_fun_tree$ (node$w (selecvk$ A_b_fun_a_fun$ )(selecvl$ A_b_fun_a_fun_tree$ )(selecvm$ A_b_fun_a_fun_tree$ )))(B_b_b_fun_fun_tree$ (node$x (selecvn$ B_b_b_fun_fun$ )(selecvo$ B_b_b_fun_fun_tree$ )(selecvp$ B_b_b_fun_fun_tree$ )))(B_b_fun_a_b_b_fun_fun_fun_tree$ (node$y (selecvq$ B_b_fun_a_b_b_fun_fun_fun$ )(selecvr$ B_b_fun_a_b_b_fun_fun_fun_tree$ )(selecvs$ B_b_fun_a_b_b_fun_fun_fun_tree$ )))(B_a_fun_a_b_a_fun_fun_fun_tree$ (node$z (selecvt$ B_a_fun_a_b_a_fun_fun_fun$ )(selecvu$ B_a_fun_a_b_a_fun_fun_fun_tree$ )(selecvv$ B_a_fun_a_b_a_fun_fun_fun_tree$ )))(A_b_fun_a_a_b_fun_fun_fun_tree$ (node$aa (selecvw$ A_b_fun_a_a_b_fun_fun_fun$ )(selecvx$ A_b_fun_a_a_b_fun_fun_fun_tree$ )(selecvy$ A_b_fun_a_a_b_fun_fun_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$ab (selecvz$ A_a_a_fun_fun$ )(selecwa$ A_a_a_fun_fun_tree$ )(selecwb$ A_a_a_fun_fun_tree$ )))(A_b_fun_a_b_fun_fun_b_a_b_fun_a_b_fun_fun_fun_fun_tree$ (node$ac (selecwc$ A_b_fun_a_b_fun_fun_b_a_b_fun_a_b_fun_fun_fun_fun$ )(selecwd$ A_b_fun_a_b_fun_fun_b_a_b_fun_a_b_fun_fun_fun_fun_tree$ )(selecwe$ A_b_fun_a_b_fun_fun_b_a_b_fun_a_b_fun_fun_fun_fun_tree$ )))(B_a_b_fun_fun_b_b_a_b_fun_fun_fun_fun_tree$ (node$ad (selecwf$ B_a_b_fun_fun_b_b_a_b_fun_fun_fun_fun$ )(selecwg$ B_a_b_fun_fun_b_b_a_b_fun_fun_fun_fun_tree$ )(selecwh$ B_a_b_fun_fun_b_b_a_b_fun_fun_fun_fun_tree$ )))(A_b_fun_b_a_b_fun_fun_fun_tree$ (node$ae (selecwi$ A_b_fun_b_a_b_fun_fun_fun$ )(selecwj$ A_b_fun_b_a_b_fun_fun_fun_tree$ )(selecwk$ A_b_fun_b_a_b_fun_fun_fun_tree$ )))(B_a_fun_b_b_fun_fun_tree$ (node$af (selecwl$ B_a_fun_b_b_fun_fun$ )(selecwm$ B_a_fun_b_b_fun_fun_tree$ )(selecwn$ B_a_fun_b_b_fun_fun_tree$ )))(B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ (node$ag (selecwo$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun$ )(selecwp$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ )(selecwq$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ )))(B_b_fun_b_a_b_fun_fun_fun_tree$ (node$ah (selecwr$ B_b_fun_b_a_b_fun_fun_fun$ )(selecws$ B_b_fun_b_a_b_fun_fun_fun_tree$ )(selecwt$ B_b_fun_b_a_b_fun_fun_fun_tree$ )))(B_b_a_b_fun_fun_fun_b_b_fun_b_a_b_fun_fun_fun_fun_tree$ (node$ai (selecwu$ B_b_a_b_fun_fun_fun_b_b_fun_b_a_b_fun_fun_fun_fun$ )(selecwv$ B_b_a_b_fun_fun_fun_b_b_fun_b_a_b_fun_fun_fun_fun_tree$ )(selecww$ B_b_a_b_fun_fun_fun_b_b_fun_b_a_b_fun_fun_fun_fun_tree$ )))(B_a_b_fun_fun_b_a_b_fun_fun_fun_tree$ (node$aj (selecwx$ B_a_b_fun_fun_b_a_b_fun_fun_fun$ )(selecwy$ B_a_b_fun_fun_b_a_b_fun_fun_fun_tree$ )(selecwz$ B_a_b_fun_fun_b_a_b_fun_fun_fun_tree$ )))(B_a_b_fun_a_b_fun_fun_fun_b_a_b_fun_fun_b_a_b_fun_fun_fun_fun_tree$ (node$ak (selecxa$ B_a_b_fun_a_b_fun_fun_fun_b_a_b_fun_fun_b_a_b_fun_fun_fun_fun$ )(selecxb$ B_a_b_fun_a_b_fun_fun_fun_b_a_b_fun_fun_b_a_b_fun_fun_fun_fun_tree$ )(selecxc$ B_a_b_fun_a_b_fun_fun_fun_b_a_b_fun_fun_b_a_b_fun_fun_fun_fun_tree$ )))(A_b_fun_a_a_fun_fun_tree$ (node$al (selecxd$ A_b_fun_a_a_fun_fun$ )(selecxe$ A_b_fun_a_a_fun_fun_tree$ )(selecxf$ A_b_fun_a_a_fun_fun_tree$ )))(A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$ (node$am (selecxg$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun$ )(selecxh$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$ )(selecxi$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$ )))(B_b_fun_b_b_fun_fun_tree$ (node$an (selecxj$ B_b_fun_b_b_fun_fun$ )(selecxk$ B_b_fun_b_b_fun_fun_tree$ )(selecxl$ B_b_fun_b_b_fun_fun_tree$ )))(B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$ (node$ao (selecxm$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun$ )(selecxn$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$ )(selecxo$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$ )))(B_a_a_fun_fun_tree$ (node$ap (selecxp$ B_a_a_fun_fun$ )(selecxq$ B_a_a_fun_fun_tree$ )(selecxr$ B_a_a_fun_fun_tree$ )))(B_a_fun_b_a_fun_fun_tree$ (node$aq (selecxs$ B_a_fun_b_a_fun_fun$ )(selecxt$ B_a_fun_b_a_fun_fun_tree$ )(selecxu$ B_a_fun_b_a_fun_fun_tree$ )))(B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$ar (selecxv$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun$ )(selecxw$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ )(selecxx$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ )))(B_b_a_fun_fun_tree$ (node$as (selecxy$ B_b_a_fun_fun$ )(selecxz$ B_b_a_fun_fun_tree$ )(selecya$ B_b_a_fun_fun_tree$ )))(B_b_fun_b_a_fun_fun_tree$ (node$at (selecyb$ B_b_fun_b_a_fun_fun$ )(selecyc$ B_b_fun_b_a_fun_fun_tree$ )(selecyd$ B_b_fun_b_a_fun_fun_tree$ )))(B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ (node$au (selecye$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun$ )(selecyf$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ )(selecyg$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ )))(A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ (node$av (selecyh$ A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun$ )(selecyi$ A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ )(selecyj$ A_b_b_fun_fun_a_b_fun_a_b_fun_fun_fun_tree$ )))(A_a_fun_a_b_fun_fun_tree$ (node$aw (selecyk$ A_a_fun_a_b_fun_fun$ )(selecyl$ A_a_fun_a_b_fun_fun_tree$ )(selecym$ A_a_fun_a_b_fun_fun_tree$ )))(A_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$ (node$ax (selecyn$ A_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun$ )(selecyo$ A_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$ )(selecyp$ A_a_b_fun_fun_a_a_fun_a_b_fun_fun_fun_tree$ )))(A_b_a_b_fun_fun_fun_tree$ (node$ay (selecyq$ A_b_a_b_fun_fun_fun$ )(selecyr$ A_b_a_b_fun_fun_fun_tree$ )(selecys$ A_b_a_b_fun_fun_fun_tree$ )))(A_b_a_b_fun_fun_fun_a_b_fun_a_a_b_fun_fun_fun_fun_tree$ (node$az (selecyt$ A_b_a_b_fun_fun_fun_a_b_fun_a_a_b_fun_fun_fun_fun$ )(selecyu$ A_b_a_b_fun_fun_fun_a_b_fun_a_a_b_fun_fun_fun_fun_tree$ )(selecyv$ A_b_a_b_fun_fun_fun_a_b_fun_a_a_b_fun_fun_fun_fun_tree$ )))))
(declare-fun c$ ()B$ )
