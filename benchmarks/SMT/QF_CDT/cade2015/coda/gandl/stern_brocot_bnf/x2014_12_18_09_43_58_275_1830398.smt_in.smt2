...
(declare-codatatypes ()((A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(B_a_fun_tree$ (node$a (select$ B_a_fun$ )(selecta$ B_a_fun_tree$ )(selectb$ B_a_fun_tree$ )))(B_tree$ (node$b (root$a B$ )(left$a B_tree$ )(right$a B_tree$ )))(B_a_fun_b_a_fun_fun_tree$ (node$c (selectc$ B_a_fun_b_a_fun_fun$ )(selectd$ B_a_fun_b_a_fun_fun_tree$ )(selecte$ B_a_fun_b_a_fun_fun_tree$ )))(B_b_a_fun_fun_tree$ (node$d (selectf$ B_b_a_fun_fun$ )(selectg$ B_b_a_fun_fun_tree$ )(selecth$ B_b_a_fun_fun_tree$ )))(B_b_fun_tree$ (node$e (selecti$ B_b_fun$ )(selectj$ B_b_fun_tree$ )(selectk$ B_b_fun_tree$ )))(A_b_a_fun_fun_tree$ (node$f (selectl$ A_b_a_fun_fun$ )(selectm$ A_b_a_fun_fun_tree$ )(selectn$ A_b_a_fun_fun_tree$ )))(A_b_fun_tree$ (node$g (selecto$ A_b_fun$ )(selectp$ A_b_fun_tree$ )(selectq$ A_b_fun_tree$ )))(A_a_fun_tree$ (node$h (selectr$ A_a_fun$ )(selects$ A_a_fun_tree$ )(selectt$ A_a_fun_tree$ )))))
