...
(declare-codatatypes ()((B_tree$ (node$ (root$ B$ )(left$ B_tree$ )(right$ B_tree$ )))(A_tree$ (node$a (root$a A$ )(left$a A_tree$ )(right$a A_tree$ )))(B_tree_tree$ (node$b (root$b B_tree$ )(left$b B_tree_tree$ )(right$b B_tree_tree$ )))))
