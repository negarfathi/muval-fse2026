...
(declare-codatatypes ()((A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(A_a_fun_a_a_fun_fun_tree$ (node$a (select$ A_a_fun_a_a_fun_fun$ )(selecta$ A_a_fun_a_a_fun_fun_tree$ )(selectb$ A_a_fun_a_a_fun_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$b (selectc$ A_a_fun_a_fun$ )(selectd$ A_a_fun_a_fun_tree$ )(selecte$ A_a_fun_a_fun_tree$ )))(A_tree_tree$ (node$c (root$a A_tree$ )(left$a A_tree_tree$ )(right$a A_tree_tree$ )))(A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ (node$d (selectf$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun$ )(selectg$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ )(selecth$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ )))(A_tree_a_tree_fun_tree$ (node$e (selecti$ A_tree_a_tree_fun$ )(selectj$ A_tree_a_tree_fun_tree$ )(selectk$ A_tree_a_tree_fun_tree$ )))(A_a_fun_tree$ (node$f (selectl$ A_a_fun$ )(selectm$ A_a_fun_tree$ )(selectn$ A_a_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$g (selecto$ A_a_a_fun_fun$ )(selectp$ A_a_a_fun_fun_tree$ )(selectq$ A_a_a_fun_fun_tree$ )))(A_tree_a_tree_a_tree_fun_fun_tree$ (node$h (selectr$ A_tree_a_tree_a_tree_fun_fun$ )(selects$ A_tree_a_tree_a_tree_fun_fun_tree$ )(selectt$ A_tree_a_tree_a_tree_fun_fun_tree$ )))(A_tree_tree_a_tree_tree_fun_tree$ (node$i (selectu$ A_tree_tree_a_tree_tree_fun$ )(selectv$ A_tree_tree_a_tree_tree_fun_tree$ )(selectw$ A_tree_tree_a_tree_tree_fun_tree$ )))(A_tree_tree_tree$ (node$j (root$b A_tree_tree$ )(left$b A_tree_tree_tree$ )(right$b A_tree_tree_tree$ )))(A_tree_a_tree_fun_a_fun_tree$ (node$k (selectx$ A_tree_a_tree_fun_a_fun$ )(selecty$ A_tree_a_tree_fun_a_fun_tree$ )(selectz$ A_tree_a_tree_fun_a_fun_tree$ )))(A_a_fun_a_fun_a_fun_tree$ (node$l (selecua$ A_a_fun_a_fun_a_fun$ )(selecub$ A_a_fun_a_fun_a_fun_tree$ )(selecuc$ A_a_fun_a_fun_a_fun_tree$ )))(A_a_a_fun_fun_a_fun_tree$ (node$m (selecud$ A_a_a_fun_fun_a_fun$ )(selecue$ A_a_a_fun_fun_a_fun_tree$ )(selecuf$ A_a_a_fun_fun_a_fun_tree$ )))(A_tree_tree_tree_tree$ (node$n (root$c A_tree_tree_tree$ )(left$c A_tree_tree_tree_tree$ )(right$c A_tree_tree_tree_tree$ )))(A_tree_tree_tree_a_tree_tree_tree_fun_tree$ (node$o (selecug$ A_tree_tree_tree_a_tree_tree_tree_fun$ )(selecuh$ A_tree_tree_tree_a_tree_tree_tree_fun_tree$ )(selecui$ A_tree_tree_tree_a_tree_tree_tree_fun_tree$ )))(A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$ (node$p (selecuj$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun$ )(selecuk$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$ )(selecul$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$ )))(A_a_tree_fun_tree$ (node$q (selecum$ A_a_tree_fun$ )(selecun$ A_a_tree_fun_tree$ )(selecuo$ A_a_tree_fun_tree$ )))(A_tree_a_fun_tree$ (node$r (selecup$ A_tree_a_fun$ )(selecuq$ A_tree_a_fun_tree$ )(selecur$ A_tree_a_fun_tree$ )))(A_a_fun_a_tree_fun_tree$ (node$s (selecus$ A_a_fun_a_tree_fun$ )(selecut$ A_a_fun_a_tree_fun_tree$ )(selecuu$ A_a_fun_a_tree_fun_tree$ )))(A_tree_a_a_fun_fun_tree$ (node$t (selecuv$ A_tree_a_a_fun_fun$ )(selecuw$ A_tree_a_a_fun_fun_tree$ )(selecux$ A_tree_a_a_fun_fun_tree$ )))(A_tree_a_tree_fun_a_tree_fun_tree$ (node$u (selecuy$ A_tree_a_tree_fun_a_tree_fun$ )(selecuz$ A_tree_a_tree_fun_a_tree_fun_tree$ )(selecva$ A_tree_a_tree_fun_a_tree_fun_tree$ )))(A_tree_a_tree_fun_a_tree_a_tree_fun_fun_tree$ (node$v (selecvb$ A_tree_a_tree_fun_a_tree_a_tree_fun_fun$ )(selecvc$ A_tree_a_tree_fun_a_tree_a_tree_fun_fun_tree$ )(selecvd$ A_tree_a_tree_fun_a_tree_a_tree_fun_fun_tree$ )))))
