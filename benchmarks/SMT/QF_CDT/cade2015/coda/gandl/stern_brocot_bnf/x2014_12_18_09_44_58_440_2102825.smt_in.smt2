...
(declare-codatatypes ()((A_bool_fun_tree$ (node$ (select$ A_bool_fun$ )(selecta$ A_bool_fun_tree$ )(selectb$ A_bool_fun_tree$ )))(A_tree$ (node$a (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(A_a_bool_fun_fun_tree$ (node$b (selectc$ A_a_bool_fun_fun$ )(selectd$ A_a_bool_fun_fun_tree$ )(selecte$ A_a_bool_fun_fun_tree$ )))(A_a_fun_tree$ (node$c (selectf$ A_a_fun$ )(selectg$ A_a_fun_tree$ )(selecth$ A_a_fun_tree$ )))(Bool_a_bool_fun_fun_tree$ (node$d (selecti$ Bool_a_bool_fun_fun$ )(selectj$ Bool_a_bool_fun_fun_tree$ )(selectk$ Bool_a_bool_fun_fun_tree$ )))(Bool_bool_fun_tree$ (node$e (selectl$ Bool_bool_fun$ )(selectm$ Bool_bool_fun_tree$ )(selectn$ Bool_bool_fun_tree$ )))(A_a_bool_fun_fun_bool_fun_tree$ (node$f (selecto$ A_a_bool_fun_fun_bool_fun$ )(selectp$ A_a_bool_fun_fun_bool_fun_tree$ )(selectq$ A_a_bool_fun_fun_bool_fun_tree$ )))(Bool_a_a_bool_fun_fun_fun_tree$ (node$g (selectr$ Bool_a_a_bool_fun_fun_fun$ )(selects$ Bool_a_a_bool_fun_fun_fun_tree$ )(selectt$ Bool_a_a_bool_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ (node$h (selectu$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun$ )(selectv$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ )(selectw$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ )))(Bool_a_fun_tree$ (node$i (selectx$ Bool_a_fun$ )(selecty$ Bool_a_fun_tree$ )(selectz$ Bool_a_fun_tree$ )))(Bool_a_a_fun_fun_tree$ (node$j (selecua$ Bool_a_a_fun_fun$ )(selecub$ Bool_a_a_fun_fun_tree$ )(selecuc$ Bool_a_a_fun_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$k (selecud$ A_a_a_fun_fun$ )(selecue$ A_a_a_fun_fun_tree$ )(selecuf$ A_a_a_fun_fun_tree$ )))(A_a_bool_fun_a_fun_fun_tree$ (node$l (selecug$ A_a_bool_fun_a_fun_fun$ )(selecuh$ A_a_bool_fun_a_fun_fun_tree$ )(selecui$ A_a_bool_fun_a_fun_fun_tree$ )))(A_a_a_bool_fun_fun_fun_tree$ (node$m (selecuj$ A_a_a_bool_fun_fun_fun$ )(selecuk$ A_a_a_bool_fun_fun_fun_tree$ )(selecul$ A_a_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_a_bool_fun_fun_fun_tree$ (node$n (selecum$ A_bool_fun_a_a_bool_fun_fun_fun$ )(selecun$ A_bool_fun_a_a_bool_fun_fun_fun_tree$ )(selecuo$ A_bool_fun_a_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_bool_a_bool_fun_fun_fun_tree$ (node$o (selecup$ A_bool_fun_bool_a_bool_fun_fun_fun$ )(selecuq$ A_bool_fun_bool_a_bool_fun_fun_fun_tree$ )(selecur$ A_bool_fun_bool_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_fun_tree$ (node$p (selecus$ A_bool_fun_a_fun$ )(selecut$ A_bool_fun_a_fun_tree$ )(selecuu$ A_bool_fun_a_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_fun_tree$ (node$q (selecuv$ A_a_fun_a_a_a_fun_fun_fun$ )(selecuw$ A_a_fun_a_a_a_fun_fun_fun_tree$ )(selecux$ A_a_fun_a_a_a_fun_fun_fun_tree$ )))(A_bool_fun_bool_fun_tree$ (node$r (selecuy$ A_bool_fun_bool_fun$ )(selecuz$ A_bool_fun_bool_fun_tree$ )(selecva$ A_bool_fun_bool_fun_tree$ )))(A_a_bool_fun_bool_fun_fun_tree$ (node$s (selecvb$ A_a_bool_fun_bool_fun_fun$ )(selecvc$ A_a_bool_fun_bool_fun_fun_tree$ )(selecvd$ A_a_bool_fun_bool_fun_fun_tree$ )))(A_bool_fun_bool_fun_a_a_bool_fun_bool_fun_fun_fun_tree$ (node$t (selecve$ A_bool_fun_bool_fun_a_a_bool_fun_bool_fun_fun_fun$ )(selecvf$ A_bool_fun_bool_fun_a_a_bool_fun_bool_fun_fun_fun_tree$ )(selecvg$ A_bool_fun_bool_fun_a_a_bool_fun_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_fun_a_a_bool_fun_a_fun_fun_fun_tree$ (node$u (selecvh$ A_bool_fun_a_fun_a_a_bool_fun_a_fun_fun_fun$ )(selecvi$ A_bool_fun_a_fun_a_a_bool_fun_a_fun_fun_fun_tree$ )(selecvj$ A_bool_fun_a_fun_a_a_bool_fun_a_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$v (selecvk$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun$ )(selecvl$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )(selecvm$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_fun_a_bool_fun_fun_tree$ (node$w (selecvn$ A_bool_fun_a_bool_fun_fun$ )(selecvo$ A_bool_fun_a_bool_fun_fun_tree$ )(selecvp$ A_bool_fun_a_bool_fun_fun_tree$ )))(A_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$x (selecvq$ A_a_bool_fun_a_bool_fun_fun_fun$ )(selecvr$ A_a_bool_fun_a_bool_fun_fun_fun_tree$ )(selecvs$ A_a_bool_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_bool_fun_fun_a_a_bool_fun_a_bool_fun_fun_fun_fun_tree$ (node$y (selecvt$ A_bool_fun_a_bool_fun_fun_a_a_bool_fun_a_bool_fun_fun_fun_fun$ )(selecvu$ A_bool_fun_a_bool_fun_fun_a_a_bool_fun_a_bool_fun_fun_fun_fun_tree$ )(selecvv$ A_bool_fun_a_bool_fun_fun_a_a_bool_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_a_a_a_fun_fun_fun_tree$ (node$z (selecvw$ A_a_a_a_fun_fun_fun$ )(selecvx$ A_a_a_a_fun_fun_fun_tree$ )(selecvy$ A_a_a_a_fun_fun_fun_tree$ )))(A_bool_bool_fun_fun_tree$ (node$aa (selecvz$ A_bool_bool_fun_fun$ )(selecwa$ A_bool_bool_fun_fun_tree$ )(selecwb$ A_bool_bool_fun_fun_tree$ )))(Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$ (node$ab (selecwc$ Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun$ )(selecwd$ Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$ )(selecwe$ Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$ )))(A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$ (node$ac (selecwf$ A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun$ )(selecwg$ A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$ )(selecwh$ A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ (node$ad (selecwi$ A_a_a_fun_fun_a_a_a_fun_fun_fun$ )(selecwj$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )(selecwk$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )))(A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$ae (selecwl$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun$ )(selecwm$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )(selecwn$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_a_bool_fun_fun_fun_tree$ (node$af (selecwo$ A_bool_a_bool_fun_fun_fun$ )(selecwp$ A_bool_a_bool_fun_fun_fun_tree$ )(selecwq$ A_bool_a_bool_fun_fun_fun_tree$ )))(A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$ (node$ag (selecwr$ A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun$ )(selecws$ A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$ )(selecwt$ A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$ )))(Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$ (node$ah (selecwu$ Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun$ )(selecwv$ Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$ )(selecww$ Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$ )))(Bool_bool_a_bool_fun_fun_fun_tree$ (node$ai (selecwx$ Bool_bool_a_bool_fun_fun_fun$ )(selecwy$ Bool_bool_a_bool_fun_fun_fun_tree$ )(selecwz$ Bool_bool_a_bool_fun_fun_fun_tree$ )))(Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$ (node$aj (selecxa$ Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun$ )(selecxb$ Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$ )(selecxc$ Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_fun_a_bool_fun_fun_a_a_bool_fun_bool_fun_fun_fun_tree$ (node$ak (selecxd$ A_bool_fun_a_bool_fun_fun_a_a_bool_fun_bool_fun_fun_fun$ )(selecxe$ A_bool_fun_a_bool_fun_fun_a_a_bool_fun_bool_fun_fun_fun_tree$ )(selecxf$ A_bool_fun_a_bool_fun_fun_a_a_bool_fun_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_a_fun_fun_tree$ (node$al (selecxg$ A_bool_fun_a_a_fun_fun$ )(selecxh$ A_bool_fun_a_a_fun_fun_tree$ )(selecxi$ A_bool_fun_a_a_fun_fun_tree$ )))(A_bool_fun_a_a_fun_fun_a_a_bool_fun_a_fun_fun_fun_tree$ (node$am (selecxj$ A_bool_fun_a_a_fun_fun_a_a_bool_fun_a_fun_fun_fun$ )(selecxk$ A_bool_fun_a_a_fun_fun_a_a_bool_fun_a_fun_fun_fun_tree$ )(selecxl$ A_bool_fun_a_a_fun_fun_a_a_bool_fun_a_fun_fun_fun_tree$ )))(Bool_a_fun_bool_bool_fun_fun_tree$ (node$an (selecxm$ Bool_a_fun_bool_bool_fun_fun$ )(selecxn$ Bool_a_fun_bool_bool_fun_fun_tree$ )(selecxo$ Bool_a_fun_bool_bool_fun_fun_tree$ )))(Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$ (node$ao (selecxp$ Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun$ )(selecxq$ Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$ )(selecxr$ Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$ )))(A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$ap (selecxs$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun$ )(selecxt$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )(selecxu$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )))(A_a_fun_a_bool_fun_fun_tree$ (node$aq (selecxv$ A_a_fun_a_bool_fun_fun$ )(selecxw$ A_a_fun_a_bool_fun_fun_tree$ )(selecxx$ A_a_fun_a_bool_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ (node$ar (selecxy$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun$ )(selecxz$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )(selecya$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_a_fun_fun_tree$ (node$as (selecyb$ A_bool_a_fun_fun$ )(selecyc$ A_bool_a_fun_fun_tree$ )(selecyd$ A_bool_a_fun_fun_tree$ )))(A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ (node$at (selecye$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun$ )(selecyf$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ )(selecyg$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_tree$ (node$au (selecyh$ A_a_fun_a_a_fun_fun$ )(selecyi$ A_a_fun_a_a_fun_fun_tree$ )(selecyj$ A_a_fun_a_a_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$av (selecyk$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$ )(selecyl$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(selecym$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_bool_fun_fun_tree$ (node$aw (selecyn$ A_a_bool_fun_fun_a_bool_fun_fun$ )(selecyo$ A_a_bool_fun_fun_a_bool_fun_fun_tree$ )(selecyp$ A_a_bool_fun_fun_a_bool_fun_fun_tree$ )))(A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ (node$ax (selecyq$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun$ )(selecyr$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )(selecys$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )))(A_a_fun_a_a_bool_fun_fun_fun_tree$ (node$ay (selecyt$ A_a_fun_a_a_bool_fun_fun_fun$ )(selecyu$ A_a_fun_a_a_bool_fun_fun_fun_tree$ )(selecyv$ A_a_fun_a_a_bool_fun_fun_fun_tree$ )))(A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$az (selecyw$ A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun$ )(selecyx$ A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ )(selecyy$ A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$ba (selecyz$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun$ )(selecza$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ )(seleczb$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_fun_fun_tree$ (node$bb (seleczc$ A_a_bool_fun_fun_a_a_fun_fun$ )(seleczd$ A_a_bool_fun_fun_a_a_fun_fun_tree$ )(selecze$ A_a_bool_fun_fun_a_a_fun_fun_tree$ )))(A_a_bool_fun_a_fun_fun_a_a_bool_fun_fun_a_a_fun_fun_fun_tree$ (node$bc (seleczf$ A_a_bool_fun_a_fun_fun_a_a_bool_fun_fun_a_a_fun_fun_fun$ )(seleczg$ A_a_bool_fun_a_fun_fun_a_a_bool_fun_fun_a_a_fun_fun_fun_tree$ )(seleczh$ A_a_bool_fun_a_fun_fun_a_a_bool_fun_fun_a_a_fun_fun_fun_tree$ )))(Bool_a_fun_bool_a_bool_fun_fun_fun_tree$ (node$bd (seleczi$ Bool_a_fun_bool_a_bool_fun_fun_fun$ )(seleczj$ Bool_a_fun_bool_a_bool_fun_fun_fun_tree$ )(seleczk$ Bool_a_fun_bool_a_bool_fun_fun_fun_tree$ )))(Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$ (node$be (seleczl$ Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun$ )(seleczm$ Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$ )(seleczn$ Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$ )))(Bool_a_a_bool_fun_fun_bool_fun_fun_tree$ (node$bf (seleczo$ Bool_a_a_bool_fun_fun_bool_fun_fun$ )(seleczp$ Bool_a_a_bool_fun_fun_bool_fun_fun_tree$ )(seleczq$ Bool_a_a_bool_fun_fun_bool_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$bg (seleczr$ A_a_bool_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun$ )(seleczs$ A_a_bool_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun_tree$ )(seleczt$ A_a_bool_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun_tree$ )))))
