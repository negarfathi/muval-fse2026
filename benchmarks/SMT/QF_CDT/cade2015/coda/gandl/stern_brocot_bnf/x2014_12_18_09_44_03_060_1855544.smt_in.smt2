...
(declare-codatatypes ()((A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(B_a_fun_tree$ (node$a (select$ B_a_fun$ )(selecta$ B_a_fun_tree$ )(selectb$ B_a_fun_tree$ )))(B_tree$ (node$b (root$a B$ )(left$a B_tree$ )(right$a B_tree$ )))(B_b_fun_tree$ (node$c (selectc$ B_b_fun$ )(selectd$ B_b_fun_tree$ )(selecte$ B_b_fun_tree$ )))(A_b_fun_tree$ (node$d (selectf$ A_b_fun$ )(selectg$ A_b_fun_tree$ )(selecth$ A_b_fun_tree$ )))(A_a_fun_tree$ (node$e (selecti$ A_a_fun$ )(selectj$ A_a_fun_tree$ )(selectk$ A_a_fun_tree$ )))(B_b_a_fun_fun_tree$ (node$f (selectl$ B_b_a_fun_fun$ )(selectm$ B_b_a_fun_fun_tree$ )(selectn$ B_b_a_fun_fun_tree$ )))(A_b_a_fun_fun_tree$ (node$g (selecto$ A_b_a_fun_fun$ )(selectp$ A_b_a_fun_fun_tree$ )(selectq$ A_b_a_fun_fun_tree$ )))(B_a_fun_b_fun_tree$ (node$h (selectr$ B_a_fun_b_fun$ )(selects$ B_a_fun_b_fun_tree$ )(selectt$ B_a_fun_b_fun_tree$ )))(B_a_fun_a_fun_tree$ (node$i (selectu$ B_a_fun_a_fun$ )(selectv$ B_a_fun_a_fun_tree$ )(selectw$ B_a_fun_a_fun_tree$ )))(B_a_fun_b_a_fun_fun_tree$ (node$j (selectx$ B_a_fun_b_a_fun_fun$ )(selecty$ B_a_fun_b_a_fun_fun_tree$ )(selectz$ B_a_fun_b_a_fun_fun_tree$ )))(B_b_b_fun_fun_tree$ (node$k (selecua$ B_b_b_fun_fun$ )(selecub$ B_b_b_fun_fun_tree$ )(selecuc$ B_b_b_fun_fun_tree$ )))))
