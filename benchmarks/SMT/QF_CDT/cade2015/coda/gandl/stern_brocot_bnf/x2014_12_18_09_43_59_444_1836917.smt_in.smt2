...
(declare-codatatypes ()((A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(B_a_fun_tree$ (node$a (select$ B_a_fun$ )(selecta$ B_a_fun_tree$ )(selectb$ B_a_fun_tree$ )))(B_tree$ (node$b (root$a B$ )(left$a B_tree$ )(right$a B_tree$ )))(A_a_fun_tree$ (node$c (selectc$ A_a_fun$ )(selectd$ A_a_fun_tree$ )(selecte$ A_a_fun_tree$ )))(A_b_fun_tree$ (node$d (selectf$ A_b_fun$ )(selectg$ A_b_fun_tree$ )(selecth$ A_b_fun_tree$ )))(A_b_a_fun_fun_tree$ (node$e (selecti$ A_b_a_fun_fun$ )(selectj$ A_b_a_fun_fun_tree$ )(selectk$ A_b_a_fun_fun_tree$ )))(B_b_fun_tree$ (node$f (selectl$ B_b_fun$ )(selectm$ B_b_fun_tree$ )(selectn$ B_b_fun_tree$ )))(B_a_fun_b_fun_tree$ (node$g (selecto$ B_a_fun_b_fun$ )(selectp$ B_a_fun_b_fun_tree$ )(selectq$ B_a_fun_b_fun_tree$ )))(B_a_fun_a_fun_tree$ (node$h (selectr$ B_a_fun_a_fun$ )(selects$ B_a_fun_a_fun_tree$ )(selectt$ B_a_fun_a_fun_tree$ )))(B_b_a_fun_fun_tree$ (node$i (selectu$ B_b_a_fun_fun$ )(selectv$ B_b_a_fun_fun_tree$ )(selectw$ B_b_a_fun_fun_tree$ )))(B_a_fun_b_a_fun_fun_tree$ (node$j (selectx$ B_a_fun_b_a_fun_fun$ )(selecty$ B_a_fun_b_a_fun_fun_tree$ )(selectz$ B_a_fun_b_a_fun_fun_tree$ )))(B_a_a_fun_fun_tree$ (node$k (selecua$ B_a_a_fun_fun$ )(selecub$ B_a_a_fun_fun_tree$ )(selecuc$ B_a_a_fun_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$l (selecud$ A_a_a_fun_fun$ )(selecue$ A_a_a_fun_fun_tree$ )(selecuf$ A_a_a_fun_fun_tree$ )))))
