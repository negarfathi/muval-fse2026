...
(declare-codatatypes ()((B_tree$ (node$ (root$ B$ )(left$ B_tree$ )(right$ B_tree$ )))(A_tree$ (node$a (root$a A$ )(left$a A_tree$ )(right$a A_tree$ )))(B_b_b_fun_fun_tree$ (node$b (select$ B_b_b_fun_fun$ )(selecta$ B_b_b_fun_fun_tree$ )(selectb$ B_b_b_fun_fun_tree$ )))(B_a_fun_tree$ (node$c (selectc$ B_a_fun$ )(selectd$ B_a_fun_tree$ )(selecte$ B_a_fun_tree$ )))(A_b_b_fun_fun_tree$ (node$d (selectf$ A_b_b_fun_fun$ )(selectg$ A_b_b_fun_fun_tree$ )(selecth$ A_b_b_fun_fun_tree$ )))(A_b_fun_tree$ (node$e (selecti$ A_b_fun$ )(selectj$ A_b_fun_tree$ )(selectk$ A_b_fun_tree$ )))(A_a_fun_tree$ (node$f (selectl$ A_a_fun$ )(selectm$ A_a_fun_tree$ )(selectn$ A_a_fun_tree$ )))(B_b_fun_tree$ (node$g (selecto$ B_b_fun$ )(selectp$ B_b_fun_tree$ )(selectq$ B_b_fun_tree$ )))(B_b_fun_b_fun_tree$ (node$h (selectr$ B_b_fun_b_fun$ )(selects$ B_b_fun_b_fun_tree$ )(selectt$ B_b_fun_b_fun_tree$ )))(B_b_fun_a_fun_tree$ (node$i (selectu$ B_b_fun_a_fun$ )(selectv$ B_b_fun_a_fun_tree$ )(selectw$ B_b_fun_a_fun_tree$ )))(B_b_fun_b_b_fun_fun_tree$ (node$j (selectx$ B_b_fun_b_b_fun_fun$ )(selecty$ B_b_fun_b_b_fun_fun_tree$ )(selectz$ B_b_fun_b_b_fun_fun_tree$ )))(B_b_a_fun_fun_tree$ (node$k (selecua$ B_b_a_fun_fun$ )(selecub$ B_b_a_fun_fun_tree$ )(selecuc$ B_b_a_fun_fun_tree$ )))))
