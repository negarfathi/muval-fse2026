...
(declare-codatatypes ()((A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))))
(declare-sort Num$ 0)
(declare-fun one$ ()Num$)
...
(declare-codatatypes ()((A_tree_tree$ (node$a (root$a A_tree$ )(left$a A_tree_tree$ )(right$a A_tree_tree$ )))(A_stream_tree$ (node$b (root$b A_stream$ )(left$b A_stream_tree$ )(right$b A_stream_tree$ )))(A_stream_tree_tree$ (node$c (root$c A_stream_tree$ )(left$c A_stream_tree_tree$ )(right$c A_stream_tree_tree$ )))(A_tree_tree_tree$ (node$d (root$d A_tree_tree$ )(left$d A_tree_tree_tree$ )(right$d A_tree_tree_tree$ )))(A_stream_stream$ (sCons$a (shd$a A_stream$ )(stl$a A_stream_stream$ )))(A_stream_stream_tree$ (node$e (root$e A_stream_stream$ )(left$e A_stream_stream_tree$ )(right$e A_stream_stream_tree$ )))(A_tree_stream$ (sCons$b (shd$b A_tree$ )(stl$b A_tree_stream$ )))(A_tree_stream_tree$ (node$f (root$f A_tree_stream$ )(left$f A_tree_stream_tree$ )(right$f A_tree_stream_tree$ )))(A_stream_stream_tree_tree$ (node$g (root$g A_stream_stream_tree$ )(left$g A_stream_stream_tree_tree$ )(right$g A_stream_stream_tree_tree$ )))(A_tree_tree_stream$ (sCons$c (shd$c A_tree_tree$ )(stl$c A_tree_tree_stream$ )))(A_tree_tree_stream_tree$ (node$h (root$h A_tree_tree_stream$ )(left$h A_tree_tree_stream_tree$ )(right$h A_tree_tree_stream_tree$ )))(A_stream_tree_stream$ (sCons$d (shd$d A_stream_tree$ )(stl$d A_stream_tree_stream$ )))(A_stream_tree_stream_tree$ (node$i (root$i A_stream_tree_stream$ )(left$i A_stream_tree_stream_tree$ )(right$i A_stream_tree_stream_tree$ )))(A_stream_stream_stream$ (sCons$e (shd$e A_stream_stream$ )(stl$e A_stream_stream_stream$ )))(A_tree_stream_stream$ (sCons$f (shd$f A_tree_stream$ )(stl$f A_tree_stream_stream$ )))(A_stream_stream_tree_stream$ (sCons$g (shd$g A_stream_stream_tree$ )(stl$g A_stream_stream_tree_stream$ )))(A_tree_tree_stream_stream$ (sCons$h (shd$h A_tree_tree_stream$ )(stl$h A_tree_tree_stream_stream$ )))(A_stream_tree_stream_stream$ (sCons$i (shd$i A_stream_tree_stream$ )(stl$i A_stream_tree_stream_stream$ )))(A_a_fun_tree$ (node$j (selectb$ A_a_fun$ )(selectc$ A_a_fun_tree$ )(selectd$ A_a_fun_tree$ )))(A_a_fun_stream$ (sCons$j (selecte$ A_a_fun$ )(selectf$ A_a_fun_stream$ )))(A_a_fun_a_fun_tree$ (node$k (selectg$ A_a_fun_a_fun$ )(selecth$ A_a_fun_a_fun_tree$ )(selecti$ A_a_fun_a_fun_tree$ )))(A_a_fun_a_fun_stream$ (sCons$k (selectj$ A_a_fun_a_fun$ )(selectk$ A_a_fun_a_fun_stream$ )))(A_a_a_fun_fun_tree$ (node$l (selectl$ A_a_a_fun_fun$ )(selectm$ A_a_a_fun_fun_tree$ )(selectn$ A_a_a_fun_fun_tree$ )))(A_a_a_fun_fun_stream$ (sCons$l (selecto$ A_a_a_fun_fun$ )(selectp$ A_a_a_fun_fun_stream$ )))(A_a_fun_a_a_fun_fun_tree$ (node$m (selectq$ A_a_fun_a_a_fun_fun$ )(selectr$ A_a_fun_a_a_fun_fun_tree$ )(selects$ A_a_fun_a_a_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_stream$ (sCons$m (selectt$ A_a_fun_a_a_fun_fun$ )(selectu$ A_a_fun_a_a_fun_fun_stream$ )))(A_a_tree_fun_tree$ (node$n (selectv$ A_a_tree_fun$ )(selectw$ A_a_tree_fun_tree$ )(selectx$ A_a_tree_fun_tree$ )))(A_a_tree_fun_stream$ (sCons$n (selecty$ A_a_tree_fun$ )(selectz$ A_a_tree_fun_stream$ )))(A_a_stream_fun_tree$ (node$o (selecua$ A_a_stream_fun$ )(selecub$ A_a_stream_fun_tree$ )(selecuc$ A_a_stream_fun_tree$ )))(A_a_stream_fun_stream$ (sCons$o (selecud$ A_a_stream_fun$ )(selecue$ A_a_stream_fun_stream$ )))(A_a_a_fun_fun_a_fun_tree$ (node$p (selecuf$ A_a_a_fun_fun_a_fun$ )(selecug$ A_a_a_fun_fun_a_fun_tree$ )(selecuh$ A_a_a_fun_fun_a_fun_tree$ )))(A_a_a_fun_fun_a_fun_stream$ (sCons$p (selecui$ A_a_a_fun_fun_a_fun$ )(selecuj$ A_a_a_fun_fun_a_fun_stream$ )))(A_a_fun_a_fun_a_fun_tree$ (node$q (selecuk$ A_a_fun_a_fun_a_fun$ )(selecul$ A_a_fun_a_fun_a_fun_tree$ )(selecum$ A_a_fun_a_fun_a_fun_tree$ )))(A_a_fun_a_fun_a_fun_stream$ (sCons$q (selecun$ A_a_fun_a_fun_a_fun$ )(selecuo$ A_a_fun_a_fun_a_fun_stream$ )))(A_a_a_a_fun_fun_fun_tree$ (node$r (selecup$ A_a_a_a_fun_fun_fun$ )(selecuq$ A_a_a_a_fun_fun_fun_tree$ )(selecur$ A_a_a_a_fun_fun_fun_tree$ )))(A_a_a_a_fun_fun_fun_stream$ (sCons$r (selecus$ A_a_a_a_fun_fun_fun$ )(selecut$ A_a_a_a_fun_fun_fun_stream$ )))(A_a_a_fun_a_fun_fun_tree$ (node$s (selecuu$ A_a_a_fun_a_fun_fun$ )(selecuv$ A_a_a_fun_a_fun_fun_tree$ )(selecuw$ A_a_a_fun_a_fun_fun_tree$ )))(A_a_a_fun_a_fun_fun_stream$ (sCons$s (selecux$ A_a_a_fun_a_fun_fun$ )(selecuy$ A_a_a_fun_a_fun_fun_stream$ )))(A_stream_a_fun_stream$ (sCons$t (selecuz$ A_stream_a_fun$ )(selecva$ A_stream_a_fun_stream$ )))(A_tree_a_fun_stream$ (sCons$u (selecvb$ A_tree_a_fun$ )(selecvc$ A_tree_a_fun_stream$ )))(A_stream_a_stream_fun_stream$ (sCons$v (selecvd$ A_stream_a_stream_fun$ )(selecve$ A_stream_a_stream_fun_stream$ )))(A_tree_a_stream_fun_stream$ (sCons$w (selecvf$ A_tree_a_stream_fun$ )(selecvg$ A_tree_a_stream_fun_stream$ )))(A_stream_a_tree_fun_stream$ (sCons$x (selecvh$ A_stream_a_tree_fun$ )(selecvi$ A_stream_a_tree_fun_stream$ )))(A_tree_a_tree_fun_stream$ (sCons$y (selecvj$ A_tree_a_tree_fun$ )(selecvk$ A_tree_a_tree_fun_stream$ )))(A_tree_a_fun_tree$ (node$t (selecvl$ A_tree_a_fun$ )(selecvm$ A_tree_a_fun_tree$ )(selecvn$ A_tree_a_fun_tree$ )))(A_stream_a_fun_tree$ (node$u (selecvo$ A_stream_a_fun$ )(selecvp$ A_stream_a_fun_tree$ )(selecvq$ A_stream_a_fun_tree$ )))(A_tree_a_tree_fun_tree$ (node$v (selecvr$ A_tree_a_tree_fun$ )(selecvs$ A_tree_a_tree_fun_tree$ )(selecvt$ A_tree_a_tree_fun_tree$ )))(A_stream_a_tree_fun_tree$ (node$w (selecvu$ A_stream_a_tree_fun$ )(selecvv$ A_stream_a_tree_fun_tree$ )(selecvw$ A_stream_a_tree_fun_tree$ )))(A_tree_a_stream_fun_tree$ (node$x (selecvx$ A_tree_a_stream_fun$ )(selecvy$ A_tree_a_stream_fun_tree$ )(selecvz$ A_tree_a_stream_fun_tree$ )))(A_stream_a_stream_fun_tree$ (node$y (selecwa$ A_stream_a_stream_fun$ )(selecwb$ A_stream_a_stream_fun_tree$ )(selecwc$ A_stream_a_stream_fun_tree$ )))))
(declare-fun n$ ()Num$ )
