...
(declare-codatatypes ()((Nat_stream$ (sCons$ (shd$ Nat$ )(stl$ Nat_stream$ )))(Nat_tree$ (node$ (root$ Nat$ )(left$ Nat_tree$ )(right$ Nat_tree$ )))(Nat_nat_fun_nat_nat_fun_fun_stream$ (sCons$a (select$ Nat_nat_fun_nat_nat_fun_fun$ )(selecta$ Nat_nat_fun_nat_nat_fun_fun_stream$ )))(Nat_nat_fun_nat_fun_stream$ (sCons$b (selectb$ Nat_nat_fun_nat_fun$ )(selectc$ Nat_nat_fun_nat_fun_stream$ )))(Nat_nat_nat_fun_fun_stream$ (sCons$c (selectd$ Nat_nat_nat_fun_fun$ )(selecte$ Nat_nat_nat_fun_fun_stream$ )))(Nat_nat_fun_stream$ (sCons$d (selectf$ Nat_nat_fun$ )(selectg$ Nat_nat_fun_stream$ )))(Nat_nat_nat_fun_nat_fun_fun_stream$ (sCons$e (selecth$ Nat_nat_nat_fun_nat_fun_fun$ )(selecti$ Nat_nat_nat_fun_nat_fun_fun_stream$ )))(Nat_nat_nat_nat_fun_fun_fun_stream$ (sCons$f (selectj$ Nat_nat_nat_nat_fun_fun_fun$ )(selectk$ Nat_nat_nat_nat_fun_fun_fun_stream$ )))(Nat_nat_fun_nat_fun_nat_fun_stream$ (sCons$g (selectl$ Nat_nat_fun_nat_fun_nat_fun$ )(selectm$ Nat_nat_fun_nat_fun_nat_fun_stream$ )))(Nat_nat_nat_fun_fun_nat_fun_stream$ (sCons$h (selectn$ Nat_nat_nat_fun_fun_nat_fun$ )(selecto$ Nat_nat_nat_fun_fun_nat_fun_stream$ )))(Nat_nat_nat_fun_nat_nat_fun_fun_fun_stream$ (sCons$i (selectp$ Nat_nat_nat_fun_nat_nat_fun_fun_fun$ )(selectq$ Nat_nat_nat_fun_nat_nat_fun_fun_fun_stream$ )))(Nat_nat_fun_nat_nat_fun_nat_fun_fun_stream$ (sCons$j (selectr$ Nat_nat_fun_nat_nat_fun_nat_fun_fun$ )(selects$ Nat_nat_fun_nat_nat_fun_nat_fun_fun_stream$ )))(Nat_tree_tree$ (node$a (root$a Nat_tree$ )(left$a Nat_tree_tree$ )(right$a Nat_tree_tree$ )))(Nat_tree_tree_tree$ (node$b (root$b Nat_tree_tree$ )(left$b Nat_tree_tree_tree$ )(right$b Nat_tree_tree_tree$ )))(Nat_tree_tree_tree_tree$ (node$c (root$c Nat_tree_tree_tree$ )(left$c Nat_tree_tree_tree_tree$ )(right$c Nat_tree_tree_tree_tree$ )))))
