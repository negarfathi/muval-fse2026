...
(declare-codatatypes ()((A_a_fun_stream$ (sCons$a (selectb$ A_a_fun$ )(selectc$ A_a_fun_stream$ )))(A_stream_stream$ (sCons$b (shd$a A_stream$ )(stl$a A_stream_stream$ )))(A_a_fun_a_fun_stream$ (sCons$c (selectd$ A_a_fun_a_fun$ )(selecte$ A_a_fun_a_fun_stream$ )))(A_a_a_fun_fun_stream$ (sCons$d (selectf$ A_a_a_fun_fun$ )(selectg$ A_a_a_fun_fun_stream$ )))(A_a_fun_a_a_fun_fun_stream$ (sCons$e (selecth$ A_a_fun_a_a_fun_fun$ )(selecti$ A_a_fun_a_a_fun_fun_stream$ )))(A_stream_a_fun_stream$ (sCons$f (selectj$ A_stream_a_fun$ )(selectk$ A_stream_a_fun_stream$ )))(A_a_stream_fun_stream$ (sCons$g (selectl$ A_a_stream_fun$ )(selectm$ A_a_stream_fun_stream$ )))(A_stream_a_stream_fun_stream$ (sCons$h (selectn$ A_stream_a_stream_fun$ )(selecto$ A_stream_a_stream_fun_stream$ )))(A_stream_a_a_fun_fun_stream$ (sCons$i (selectp$ A_stream_a_a_fun_fun$ )(selectq$ A_stream_a_a_fun_fun_stream$ )))(A_a_fun_a_stream_fun_stream$ (sCons$j (selectr$ A_a_fun_a_stream_fun$ )(selects$ A_a_fun_a_stream_fun_stream$ )))(A_a_a_fun_fun_a_fun_stream$ (sCons$k (selectt$ A_a_a_fun_fun_a_fun$ )(selectu$ A_a_a_fun_fun_a_fun_stream$ )))(A_stream_tree$ (node$ (root$ A_stream$ )(left$ A_stream_tree$ )(right$ A_stream_tree$ )))(A_stream_tree_tree$ (node$a (root$a A_stream_tree$ )(left$a A_stream_tree_tree$ )(right$a A_stream_tree_tree$ )))(A_stream_tree_tree_tree$ (node$b (root$b A_stream_tree_tree$ )(left$b A_stream_tree_tree_tree$ )(right$b A_stream_tree_tree_tree$ )))(A_tree$ (node$c (root$c A$ )(left$c A_tree$ )(right$c A_tree$ )))(A_tree_tree$ (node$d (root$d A_tree$ )(left$d A_tree_tree$ )(right$d A_tree_tree$ )))(A_tree_tree_tree$ (node$e (root$e A_tree_tree$ )(left$e A_tree_tree_tree$ )(right$e A_tree_tree_tree$ )))(A_a_fun_stream_stream$ (sCons$l (shd$b A_a_fun_stream$ )(stl$b A_a_fun_stream_stream$ )))(A_stream_stream_stream$ (sCons$m (shd$c A_stream_stream$ )(stl$c A_stream_stream_stream$ )))))
(declare-fun n$ ()Num$ )
