...
(declare-codatatypes ()((B_a_fun_tree$ (node$a (select$ B_a_fun$ )(selecta$ B_a_fun_tree$ )(selectb$ B_a_fun_tree$ )))(B_tree$ (node$b (root$a B$ )(left$a B_tree$ )(right$a B_tree$ )))(B_b_a_fun_fun_tree$ (node$c (selectc$ B_b_a_fun_fun$ )(selectd$ B_b_a_fun_fun_tree$ )(selecte$ B_b_a_fun_fun_tree$ )))(B_a_a_fun_fun_tree$ (node$d (selectf$ B_a_a_fun_fun$ )(selectg$ B_a_a_fun_fun_tree$ )(selecth$ B_a_a_fun_fun_tree$ )))(A_a_fun_tree$ (node$e (selecti$ A_a_fun$ )(selectj$ A_a_fun_tree$ )(selectk$ A_a_fun_tree$ )))(B_b_fun_tree$ (node$f (selectl$ B_b_fun$ )(selectm$ B_b_fun_tree$ )(selectn$ B_b_fun_tree$ )))(A_b_a_fun_fun_tree$ (node$g (selecto$ A_b_a_fun_fun$ )(selectp$ A_b_a_fun_fun_tree$ )(selectq$ A_b_a_fun_fun_tree$ )))(B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ (node$h (selectr$ B_a_a_fun_fun_a_b_a_fun_fun_fun$ )(selects$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ )(selectt$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_fun_tree$ (node$i (selectu$ B_b_b_a_fun_fun_fun$ )(selectv$ B_b_b_a_fun_fun_fun_tree$ )(selectw$ B_b_b_a_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ (node$j (selectx$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun$ )(selecty$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ )(selectz$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ )))(B_a_b_a_fun_fun_fun_tree$ (node$k (selecua$ B_a_b_a_fun_fun_fun$ )(selecub$ B_a_b_a_fun_fun_fun_tree$ )(selecuc$ B_a_b_a_fun_fun_fun_tree$ )))(A_b_b_a_fun_fun_fun_tree$ (node$l (selecud$ A_b_b_a_fun_fun_fun$ )(selecue$ A_b_b_a_fun_fun_fun_tree$ )(selecuf$ A_b_b_a_fun_fun_fun_tree$ )))(B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$ (node$m (selecug$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun$ )(selecuh$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$ )(selecui$ B_a_b_a_fun_fun_fun_a_b_b_a_fun_fun_fun_fun_tree$ )))(B_b_a_a_fun_fun_fun_tree$ (node$n (selecuj$ B_b_a_a_fun_fun_fun$ )(selecuk$ B_b_a_a_fun_fun_fun_tree$ )(selecul$ B_b_a_a_fun_fun_fun_tree$ )))(B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$ (node$o (selecum$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun$ )(selecun$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$ )(selecuo$ B_b_a_a_fun_fun_fun_b_b_a_a_fun_fun_fun_fun_tree$ )))(B_b_b_fun_fun_tree$ (node$p (selecup$ B_b_b_fun_fun$ )(selecuq$ B_b_b_fun_fun_tree$ )(selecur$ B_b_b_fun_fun_tree$ )))(B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ (node$q (selecus$ B_b_b_fun_fun_b_b_b_fun_fun_fun$ )(selecut$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ )(selecuu$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ )))(A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ (node$r (selecuv$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun$ )(selecuw$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ )(selecux$ A_b_b_a_fun_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ )))(A_a_b_a_fun_fun_fun_tree$ (node$s (selecuy$ A_a_b_a_fun_fun_fun$ )(selecuz$ A_a_b_a_fun_fun_fun_tree$ )(selecva$ A_a_b_a_fun_fun_fun_tree$ )))(A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$ (node$t (selecvb$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun$ )(selecvc$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$ )(selecvd$ A_a_b_a_fun_fun_fun_a_a_b_a_fun_fun_fun_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$u (selecve$ A_a_a_fun_fun$ )(selecvf$ A_a_a_fun_fun_tree$ )(selecvg$ A_a_a_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ (node$v (selecvh$ A_a_a_fun_fun_a_a_a_fun_fun_fun$ )(selecvi$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )(selecvj$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )))(A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$ (node$w (selecvk$ A_b_a_fun_fun_b_a_a_fun_fun_fun$ )(selecvl$ A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$ )(selecvm$ A_b_a_fun_fun_b_a_a_fun_fun_fun_tree$ )))(B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ (node$x (selecvn$ B_b_a_fun_fun_b_b_a_fun_fun_fun$ )(selecvo$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ )(selecvp$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ )))(B_a_fun_b_a_fun_fun_tree$ (node$y (selecvq$ B_a_fun_b_a_fun_fun$ )(selecvr$ B_a_fun_b_a_fun_fun_tree$ )(selecvs$ B_a_fun_b_a_fun_fun_tree$ )))(B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$z (selecvt$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun$ )(selecvu$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ )(selecvv$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ )))(B_b_fun_b_a_fun_fun_tree$ (node$aa (selecvw$ B_b_fun_b_a_fun_fun$ )(selecvx$ B_b_fun_b_a_fun_fun_tree$ )(selecvy$ B_b_fun_b_a_fun_fun_tree$ )))(B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ (node$ab (selecvz$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun$ )(selecwa$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ )(selecwb$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ )))(B_a_b_fun_fun_tree$ (node$ac (selecwc$ B_a_b_fun_fun$ )(selecwd$ B_a_b_fun_fun_tree$ )(selecwe$ B_a_b_fun_fun_tree$ )))(B_a_fun_b_b_fun_fun_tree$ (node$ad (selecwf$ B_a_fun_b_b_fun_fun$ )(selecwg$ B_a_fun_b_b_fun_fun_tree$ )(selecwh$ B_a_fun_b_b_fun_fun_tree$ )))(B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ (node$ae (selecwi$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun$ )(selecwj$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ )(selecwk$ B_a_b_fun_fun_b_a_fun_b_b_fun_fun_fun_tree$ )))(A_b_fun_tree$ (node$af (selecwl$ A_b_fun$ )(selecwm$ A_b_fun_tree$ )(selecwn$ A_b_fun_tree$ )))(B_b_fun_b_b_fun_fun_tree$ (node$ag (selecwo$ B_b_fun_b_b_fun_fun$ )(selecwp$ B_b_fun_b_b_fun_fun_tree$ )(selecwq$ B_b_fun_b_b_fun_fun_tree$ )))(B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$ (node$ah (selecwr$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun$ )(selecws$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$ )(selecwt$ B_b_b_fun_fun_b_b_fun_b_b_fun_fun_fun_tree$ )))(A_b_fun_a_a_fun_fun_tree$ (node$ai (selecwu$ A_b_fun_a_a_fun_fun$ )(selecwv$ A_b_fun_a_a_fun_fun_tree$ )(selecww$ A_b_fun_a_a_fun_fun_tree$ )))(A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$ (node$aj (selecwx$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun$ )(selecwy$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$ )(selecwz$ A_b_a_fun_fun_a_b_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_tree$ (node$ak (selecxa$ A_a_fun_a_a_fun_fun$ )(selecxb$ A_a_fun_a_a_fun_fun_tree$ )(selecxc$ A_a_fun_a_a_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$al (selecxd$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$ )(selecxe$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(selecxf$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(B_b_a_fun_a_fun_fun_tree$ (node$am (selecxg$ B_b_a_fun_a_fun_fun$ )(selecxh$ B_b_a_fun_a_fun_fun_tree$ )(selecxi$ B_b_a_fun_a_fun_fun_tree$ )))(B_b_a_fun_fun_b_a_fun_fun_tree$ (node$an (selecxj$ B_b_a_fun_fun_b_a_fun_fun$ )(selecxk$ B_b_a_fun_fun_b_a_fun_fun_tree$ )(selecxl$ B_b_a_fun_fun_b_a_fun_fun_tree$ )))(B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$ao (selecxm$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun$ )(selecxn$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )(selecxo$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )))(B_a_fun_a_fun_tree$ (node$ap (selecxp$ B_a_fun_a_fun$ )(selecxq$ B_a_fun_a_fun_tree$ )(selecxr$ B_a_fun_a_fun_tree$ )))(B_a_a_fun_a_fun_fun_tree$ (node$aq (selecxs$ B_a_a_fun_a_fun_fun$ )(selecxt$ B_a_a_fun_a_fun_fun_tree$ )(selecxu$ B_a_a_fun_a_fun_fun_tree$ )))(B_a_a_fun_fun_b_a_fun_fun_tree$ (node$ar (selecxv$ B_a_a_fun_fun_b_a_fun_fun$ )(selecxw$ B_a_a_fun_fun_b_a_fun_fun_tree$ )(selecxx$ B_a_a_fun_fun_b_a_fun_fun_tree$ )))(B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$ (node$as (selecxy$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun$ )(selecxz$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$ )(selecya$ B_a_a_fun_a_fun_fun_b_a_a_fun_fun_b_a_fun_fun_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$at (selecyb$ A_a_fun_a_fun$ )(selecyc$ A_a_fun_a_fun_tree$ )(selecyd$ A_a_fun_a_fun_tree$ )))(B_b_fun_b_b_a_fun_fun_fun_tree$ (node$au (selecye$ B_b_fun_b_b_a_fun_fun_fun$ )(selecyf$ B_b_fun_b_b_a_fun_fun_fun_tree$ )(selecyg$ B_b_fun_b_b_a_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$ (node$av (selecyh$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun$ )(selecyi$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$ )(selecyj$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$ )))(B_a_fun_b_b_a_fun_fun_fun_tree$ (node$aw (selecyk$ B_a_fun_b_b_a_fun_fun_fun$ )(selecyl$ B_a_fun_b_b_a_fun_fun_fun_tree$ )(selecym$ B_a_fun_b_b_a_fun_fun_fun_tree$ )))(B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ (node$ax (selecyn$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun$ )(selecyo$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ )(selecyp$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ )))(A_a_fun_b_a_a_fun_fun_fun_tree$ (node$ay (selecyq$ A_a_fun_b_a_a_fun_fun_fun$ )(selecyr$ A_a_fun_b_a_a_fun_fun_fun_tree$ )(selecys$ A_a_fun_b_a_a_fun_fun_fun_tree$ )))(B_a_fun_a_b_a_fun_fun_fun_tree$ (node$az (selecyt$ B_a_fun_a_b_a_fun_fun_fun$ )(selecyu$ B_a_fun_a_b_a_fun_fun_fun_tree$ )(selecyv$ B_a_fun_a_b_a_fun_fun_fun_tree$ )))(B_a_fun_b_fun_tree$ (node$ba (selecyw$ B_a_fun_b_fun$ )(selecyx$ B_a_fun_b_fun_tree$ )(selecyy$ B_a_fun_b_fun_tree$ )))))
