...
(declare-codatatypes ()((A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(A_tree_tree$ (node$a (root$a A_tree$ )(left$a A_tree_tree$ )(right$a A_tree_tree$ )))(A_stream_tree$ (node$b (root$b A_stream$ )(left$b A_stream_tree$ )(right$b A_stream_tree$ )))(A_stream_tree_tree$ (node$c (root$c A_stream_tree$ )(left$c A_stream_tree_tree$ )(right$c A_stream_tree_tree$ )))(A_tree_tree_tree$ (node$d (root$d A_tree_tree$ )(left$d A_tree_tree_tree$ )(right$d A_tree_tree_tree$ )))(A_stream_stream$ (sCons$a (shd$a A_stream$ )(stl$a A_stream_stream$ )))(A_stream_stream_tree$ (node$e (root$e A_stream_stream$ )(left$e A_stream_stream_tree$ )(right$e A_stream_stream_tree$ )))(A_tree_stream$ (sCons$b (shd$b A_tree$ )(stl$b A_tree_stream$ )))(A_tree_stream_tree$ (node$f (root$f A_tree_stream$ )(left$f A_tree_stream_tree$ )(right$f A_tree_stream_tree$ )))(A_a_fun_tree$ (node$g (select$ A_a_fun$ )(selecta$ A_a_fun_tree$ )(selectb$ A_a_fun_tree$ )))(A_stream_stream_tree_tree$ (node$h (root$g A_stream_stream_tree$ )(left$g A_stream_stream_tree_tree$ )(right$g A_stream_stream_tree_tree$ )))(A_tree_tree_stream$ (sCons$c (shd$c A_tree_tree$ )(stl$c A_tree_tree_stream$ )))(A_tree_tree_stream_tree$ (node$i (root$h A_tree_tree_stream$ )(left$h A_tree_tree_stream_tree$ )(right$h A_tree_tree_stream_tree$ )))(A_stream_tree_stream$ (sCons$d (shd$d A_stream_tree$ )(stl$d A_stream_tree_stream$ )))(A_stream_stream_stream$ (sCons$e (shd$e A_stream_stream$ )(stl$e A_stream_stream_stream$ )))(A_tree_stream_stream$ (sCons$f (shd$f A_tree_stream$ )(stl$f A_tree_stream_stream$ )))(A_a_fun_stream$ (sCons$g (selectc$ A_a_fun$ )(selectd$ A_a_fun_stream$ )))(A_stream_a_fun_stream$ (sCons$h (selecte$ A_stream_a_fun$ )(selectf$ A_stream_a_fun_stream$ )))(A_a_tree_fun_stream$ (sCons$i (selectg$ A_a_tree_fun$ )(selecth$ A_a_tree_fun_stream$ )))(A_a_fun_a_fun_tree$ (node$j (selecti$ A_a_fun_a_fun$ )(selectj$ A_a_fun_a_fun_tree$ )(selectk$ A_a_fun_a_fun_tree$ )))(A_a_fun_a_fun_stream$ (sCons$j (selectl$ A_a_fun_a_fun$ )(selectm$ A_a_fun_a_fun_stream$ )))(A_a_a_fun_fun_tree$ (node$k (selectn$ A_a_a_fun_fun$ )(selecto$ A_a_a_fun_fun_tree$ )(selectp$ A_a_a_fun_fun_tree$ )))(A_a_a_fun_fun_stream$ (sCons$k (selectq$ A_a_a_fun_fun$ )(selectr$ A_a_a_fun_fun_stream$ )))(A_a_fun_a_a_fun_fun_tree$ (node$l (selects$ A_a_fun_a_a_fun_fun$ )(selectt$ A_a_fun_a_a_fun_fun_tree$ )(selectu$ A_a_fun_a_a_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_stream$ (sCons$l (selectv$ A_a_fun_a_a_fun_fun$ )(selectw$ A_a_fun_a_a_fun_fun_stream$ )))(A_a_tree_fun_tree$ (node$m (selectx$ A_a_tree_fun$ )(selecty$ A_a_tree_fun_tree$ )(selectz$ A_a_tree_fun_tree$ )))(A_a_stream_fun_tree$ (node$n (selecua$ A_a_stream_fun$ )(selecub$ A_a_stream_fun_tree$ )(selecuc$ A_a_stream_fun_tree$ )))(A_a_stream_fun_stream$ (sCons$m (selecud$ A_a_stream_fun$ )(selecue$ A_a_stream_fun_stream$ )))(A_a_a_fun_fun_a_fun_tree$ (node$o (selecuf$ A_a_a_fun_fun_a_fun$ )(selecug$ A_a_a_fun_fun_a_fun_tree$ )(selecuh$ A_a_a_fun_fun_a_fun_tree$ )))(A_a_a_fun_fun_a_fun_stream$ (sCons$n (selecui$ A_a_a_fun_fun_a_fun$ )(selecuj$ A_a_a_fun_fun_a_fun_stream$ )))(A_a_fun_a_fun_a_fun_tree$ (node$p (selecuk$ A_a_fun_a_fun_a_fun$ )(selecul$ A_a_fun_a_fun_a_fun_tree$ )(selecum$ A_a_fun_a_fun_a_fun_tree$ )))(A_a_fun_a_fun_a_fun_stream$ (sCons$o (selecun$ A_a_fun_a_fun_a_fun$ )(selecuo$ A_a_fun_a_fun_a_fun_stream$ )))(A_a_a_a_fun_fun_fun_tree$ (node$q (selecup$ A_a_a_a_fun_fun_fun$ )(selecuq$ A_a_a_a_fun_fun_fun_tree$ )(selecur$ A_a_a_a_fun_fun_fun_tree$ )))(A_a_a_a_fun_fun_fun_stream$ (sCons$p (selecus$ A_a_a_a_fun_fun_fun$ )(selecut$ A_a_a_a_fun_fun_fun_stream$ )))(A_a_a_fun_a_fun_fun_tree$ (node$r (selecuu$ A_a_a_fun_a_fun_fun$ )(selecuv$ A_a_a_fun_a_fun_fun_tree$ )(selecuw$ A_a_a_fun_a_fun_fun_tree$ )))(A_a_a_fun_a_fun_fun_stream$ (sCons$q (selecux$ A_a_a_fun_a_fun_fun$ )(selecuy$ A_a_a_fun_a_fun_fun_stream$ )))(A_tree_a_fun_stream$ (sCons$r (selecuz$ A_tree_a_fun$ )(selecva$ A_tree_a_fun_stream$ )))(A_stream_a_stream_fun_stream$ (sCons$s (selecvb$ A_stream_a_stream_fun$ )(selecvc$ A_stream_a_stream_fun_stream$ )))(A_tree_a_stream_fun_stream$ (sCons$t (selecvd$ A_tree_a_stream_fun$ )(selecve$ A_tree_a_stream_fun_stream$ )))(A_stream_a_tree_fun_stream$ (sCons$u (selecvf$ A_stream_a_tree_fun$ )(selecvg$ A_stream_a_tree_fun_stream$ )))(A_tree_a_tree_fun_stream$ (sCons$v (selecvh$ A_tree_a_tree_fun$ )(selecvi$ A_tree_a_tree_fun_stream$ )))(A_tree_a_fun_tree$ (node$s (selecvj$ A_tree_a_fun$ )(selecvk$ A_tree_a_fun_tree$ )(selecvl$ A_tree_a_fun_tree$ )))(A_stream_a_fun_tree$ (node$t (selecvm$ A_stream_a_fun$ )(selecvn$ A_stream_a_fun_tree$ )(selecvo$ A_stream_a_fun_tree$ )))(A_tree_a_tree_fun_tree$ (node$u (selecvp$ A_tree_a_tree_fun$ )(selecvq$ A_tree_a_tree_fun_tree$ )(selecvr$ A_tree_a_tree_fun_tree$ )))(A_stream_a_tree_fun_tree$ (node$v (selecvs$ A_stream_a_tree_fun$ )(selecvt$ A_stream_a_tree_fun_tree$ )(selecvu$ A_stream_a_tree_fun_tree$ )))(A_tree_a_stream_fun_tree$ (node$w (selecvv$ A_tree_a_stream_fun$ )(selecvw$ A_tree_a_stream_fun_tree$ )(selecvx$ A_tree_a_stream_fun_tree$ )))(A_stream_a_stream_fun_tree$ (node$x (selecvy$ A_stream_a_stream_fun$ )(selecvz$ A_stream_a_stream_fun_tree$ )(selecwa$ A_stream_a_stream_fun_tree$ )))))
