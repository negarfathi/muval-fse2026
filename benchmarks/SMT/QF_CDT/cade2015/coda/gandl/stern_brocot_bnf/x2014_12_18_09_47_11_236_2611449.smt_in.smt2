...
(declare-codatatypes ()((Nat_tree$ (node$ (root$ Nat$ )(left$ Nat_tree$ )(right$ Nat_tree$ )))(Nat_tree_tree$ (node$a (root$a Nat_tree$ )(left$a Nat_tree_tree$ )(right$a Nat_tree_tree$ )))))
(declare-sort Dir$ 0)
...
(declare-codatatypes ()((Nat_nat_prod_nat_nat_prod_prod_tree$ (node$b (root$b Nat_nat_prod_nat_nat_prod_prod$ )(left$b Nat_nat_prod_nat_nat_prod_prod_tree$ )(right$b Nat_nat_prod_nat_nat_prod_prod_tree$ )))(Nat_tree_tree_tree$ (node$c (root$c Nat_tree_tree$ )(left$c Nat_tree_tree_tree$ )(right$c Nat_tree_tree_tree$ )))))
