...
(declare-codatatypes ()((Int_tree$ (node$c (root$a Int )(left$a Int_tree$ )(right$a Int_tree$ )))(Int_tree_tree$ (node$d (root$b Int_tree$ )(left$b Int_tree_tree$ )(right$b Int_tree_tree$ )))(Int_tree_tree_tree$ (node$e (root$c Int_tree_tree$ )(left$c Int_tree_tree_tree$ )(right$c Int_tree_tree_tree$ )))(Bool_tree_tree$ (node$f (root$d Bool_tree$ )(left$d Bool_tree_tree$ )(right$d Bool_tree_tree$ )))(Bool_tree_tree_tree$ (node$g (root$e Bool_tree_tree$ )(left$e Bool_tree_tree_tree$ )(right$e Bool_tree_tree_tree$ )))(Nat_tree_tree$ (node$h (root$f Nat_tree$ )(left$f Nat_tree_tree$ )(right$f Nat_tree_tree$ )))(Nat_tree_tree_tree$ (node$i (root$g Nat_tree_tree$ )(left$g Nat_tree_tree_tree$ )(right$g Nat_tree_tree_tree$ )))(Nat_tree_tree_tree_tree$ (node$j (root$h Nat_tree_tree_tree$ )(left$h Nat_tree_tree_tree_tree$ )(right$h Nat_tree_tree_tree_tree$ )))(Bool_bool_fun_tree$ (node$k (selecth$ Bool_bool_fun$ )(selecti$ Bool_bool_fun_tree$ )(selectj$ Bool_bool_fun_tree$ )))(Nat_nat_bool_fun_fun_bool_fun_tree$ (node$l (selectk$ Nat_nat_bool_fun_fun_bool_fun$ )(selectl$ Nat_nat_bool_fun_fun_bool_fun_tree$ )(selectm$ Nat_nat_bool_fun_fun_bool_fun_tree$ )))(Bool_nat_nat_bool_fun_fun_fun_tree$ (node$m (selectn$ Bool_nat_nat_bool_fun_fun_fun$ )(selecto$ Bool_nat_nat_bool_fun_fun_fun_tree$ )(selectp$ Bool_nat_nat_bool_fun_fun_fun_tree$ )))(Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_tree$ (node$n (selectq$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun$ )(selectr$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_tree$ )(selects$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_tree$ )))(Bool_bool_bool_fun_fun_tree$ (node$o (selectt$ Bool_bool_bool_fun_fun$ )(selectu$ Bool_bool_bool_fun_fun_tree$ )(selectv$ Bool_bool_bool_fun_fun_tree$ )))(Bool_nat_bool_fun_fun_tree$ (node$p (selectw$ Bool_nat_bool_fun_fun$ )(selectx$ Bool_nat_bool_fun_fun_tree$ )(selecty$ Bool_nat_bool_fun_fun_tree$ )))(Bool_bool_fun_bool_fun_tree$ (node$q (selectz$ Bool_bool_fun_bool_fun$ )(selecua$ Bool_bool_fun_bool_fun_tree$ )(selecub$ Bool_bool_fun_bool_fun_tree$ )))(Nat_bool_fun_bool_fun_tree$ (node$r (selecuc$ Nat_bool_fun_bool_fun$ )(selecud$ Nat_bool_fun_bool_fun_tree$ )(selecue$ Nat_bool_fun_bool_fun_tree$ )))(Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_bool_fun_fun_tree$ (node$s (selecuf$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_bool_fun_fun$ )(selecug$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_bool_fun_fun_tree$ )(selecuh$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_bool_fun_fun_tree$ )))(Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_nat_bool_fun_fun_tree$ (node$t (selecui$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_nat_bool_fun_fun$ )(selecuj$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_nat_bool_fun_fun_tree$ )(selecuk$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_nat_bool_fun_fun_tree$ )))(Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_nat_nat_bool_fun_fun_fun_tree$ (node$u (selecul$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_nat_nat_bool_fun_fun_fun$ )(selecum$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_nat_nat_bool_fun_fun_fun_tree$ )(selecun$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_nat_nat_bool_fun_fun_fun_tree$ )))(Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_bool_nat_nat_bool_fun_fun_fun_fun_tree$ (node$v (selecuo$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_bool_nat_nat_bool_fun_fun_fun_fun$ )(selecup$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_bool_nat_nat_bool_fun_fun_fun_fun_tree$ )(selecuq$ Nat_nat_bool_fun_fun_nat_nat_bool_fun_fun_fun_bool_nat_nat_bool_fun_fun_fun_fun_tree$ )))))
