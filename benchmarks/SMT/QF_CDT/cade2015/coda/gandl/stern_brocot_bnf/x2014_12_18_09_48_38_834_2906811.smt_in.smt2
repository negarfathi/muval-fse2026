...
(declare-codatatypes ()((Int_tree$ (node$ (root$ Int )(left$ Int_tree$ )(right$ Int_tree$ )))(Int_nat_fun_tree$ (node$a (select$ Int_nat_fun$ )(selecta$ Int_nat_fun_tree$ )(selectb$ Int_nat_fun_tree$ )))(Int_int_int_fun_fun_tree$ (node$b (selectc$ Int_int_int_fun_fun$ )(selectd$ Int_int_int_fun_fun_tree$ )(selecte$ Int_int_int_fun_fun_tree$ )))(Int_int_fun_nat_fun_tree$ (node$c (selectf$ Int_int_fun_nat_fun$ )(selectg$ Int_int_fun_nat_fun_tree$ )(selecth$ Int_int_fun_nat_fun_tree$ )))(Int_int_fun_int_fun_tree$ (node$d (selecti$ Int_int_fun_int_fun$ )(selectj$ Int_int_fun_int_fun_tree$ )(selectk$ Int_int_fun_int_fun_tree$ )))(Int_int_fun_int_int_fun_fun_tree$ (node$e (selectl$ Int_int_fun_int_int_fun_fun$ )(selectm$ Int_int_fun_int_int_fun_fun_tree$ )(selectn$ Int_int_fun_int_int_fun_fun_tree$ )))(Int_int_fun_tree$ (node$f (selecto$ Int_int_fun$ )(selectp$ Int_int_fun_tree$ )(selectq$ Int_int_fun_tree$ )))(Nat_tree$ (node$g (root$a Nat$ )(left$a Nat_tree$ )(right$a Nat_tree$ )))(Nat_int_fun_tree$ (node$h (selectr$ Nat_int_fun$ )(selects$ Nat_int_fun_tree$ )(selectt$ Nat_int_fun_tree$ )))(Nat_nat_fun_tree$ (node$i (selectu$ Nat_nat_fun$ )(selectv$ Nat_nat_fun_tree$ )(selectw$ Nat_nat_fun_tree$ )))(Nat_int_int_fun_fun_tree$ (node$j (selectx$ Nat_int_int_fun_fun$ )(selecty$ Nat_int_int_fun_fun_tree$ )(selectz$ Nat_int_int_fun_fun_tree$ )))(Int_nat_fun_int_fun_tree$ (node$k (selecua$ Int_nat_fun_int_fun$ )(selecub$ Int_nat_fun_int_fun_tree$ )(selecuc$ Int_nat_fun_int_fun_tree$ )))(Int_nat_fun_stream$ (sCons$ (selecud$ Int_nat_fun$ )(selecue$ Int_nat_fun_stream$ )))(Int_int_int_fun_fun_stream$ (sCons$a (selecuf$ Int_int_int_fun_fun$ )(selecug$ Int_int_int_fun_fun_stream$ )))(Int_int_fun_nat_fun_stream$ (sCons$b (selecuh$ Int_int_fun_nat_fun$ )(selecui$ Int_int_fun_nat_fun_stream$ )))(Int_int_fun_int_fun_stream$ (sCons$c (selecuj$ Int_int_fun_int_fun$ )(selecuk$ Int_int_fun_int_fun_stream$ )))(Int_int_fun_int_int_fun_fun_stream$ (sCons$d (selecul$ Int_int_fun_int_int_fun_fun$ )(selecum$ Int_int_fun_int_int_fun_fun_stream$ )))(Int_int_fun_stream$ (sCons$e (selecun$ Int_int_fun$ )(selecuo$ Int_int_fun_stream$ )))(Nat_stream$ (sCons$f (shd$ Nat$ )(stl$ Nat_stream$ )))(Int_stream$ (sCons$g (shd$a Int )(stl$a Int_stream$ )))))
