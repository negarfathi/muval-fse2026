...
(declare-codatatypes ()((A_bool_fun_tree$ (node$ (select$ A_bool_fun$ )(selecta$ A_bool_fun_tree$ )(selectb$ A_bool_fun_tree$ )))(A_tree$ (node$a (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(Bool_a_bool_fun_fun_tree$ (node$b (selectc$ Bool_a_bool_fun_fun$ )(selectd$ Bool_a_bool_fun_fun_tree$ )(selecte$ Bool_a_bool_fun_fun_tree$ )))(A_a_bool_fun_fun_tree$ (node$c (selectf$ A_a_bool_fun_fun$ )(selectg$ A_a_bool_fun_fun_tree$ )(selecth$ A_a_bool_fun_fun_tree$ )))(A_a_a_bool_fun_fun_fun_tree$ (node$d (selecti$ A_a_a_bool_fun_fun_fun$ )(selectj$ A_a_a_bool_fun_fun_fun_tree$ )(selectk$ A_a_a_bool_fun_fun_fun_tree$ )))(A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$e (selectl$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun$ )(selectm$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )(selectn$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$f (selecto$ A_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun$ )(selectp$ A_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )(selectq$ A_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$g (selectr$ A_a_a_fun_fun$ )(selects$ A_a_a_fun_fun_tree$ )(selectt$ A_a_a_fun_fun_tree$ )))(A_a_fun_a_a_bool_fun_fun_fun_a_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun_fun_tree$ (node$h (selectu$ A_a_fun_a_a_bool_fun_fun_fun_a_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun_fun$ )(selectv$ A_a_fun_a_a_bool_fun_fun_fun_a_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun_fun_tree$ )(selectw$ A_a_fun_a_a_bool_fun_fun_fun_a_a_a_fun_fun_a_a_a_bool_fun_fun_fun_fun_fun_tree$ )))(A_a_fun_a_a_bool_fun_fun_fun_tree$ (node$i (selectx$ A_a_fun_a_a_bool_fun_fun_fun$ )(selecty$ A_a_fun_a_a_bool_fun_fun_fun_tree$ )(selectz$ A_a_fun_a_a_bool_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$j (selecua$ A_a_bool_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun$ )(selecub$ A_a_bool_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ )(selecuc$ A_a_bool_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ )))(A_a_fun_tree$ (node$k (selecud$ A_a_fun$ )(selecue$ A_a_fun_tree$ )(selecuf$ A_a_fun_tree$ )))(A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ (node$l (selecug$ A_a_a_fun_fun_a_a_a_fun_fun_fun$ )(selecuh$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )(selecui$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )))(Bool_bool_fun_tree$ (node$m (selecuj$ Bool_bool_fun$ )(selecuk$ Bool_bool_fun_tree$ )(selecul$ Bool_bool_fun_tree$ )))(A_a_bool_fun_fun_bool_fun_tree$ (node$n (selecum$ A_a_bool_fun_fun_bool_fun$ )(selecun$ A_a_bool_fun_fun_bool_fun_tree$ )(selecuo$ A_a_bool_fun_fun_bool_fun_tree$ )))(Bool_a_a_bool_fun_fun_fun_tree$ (node$o (selecup$ Bool_a_a_bool_fun_fun_fun$ )(selecuq$ Bool_a_a_bool_fun_fun_fun_tree$ )(selecur$ Bool_a_a_bool_fun_fun_fun_tree$ )))(Bool_a_a_a_fun_fun_fun_tree$ (node$p (selecus$ Bool_a_a_a_fun_fun_fun$ )(selecut$ Bool_a_a_a_fun_fun_fun_tree$ )(selecuu$ Bool_a_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_fun_bool_fun_tree$ (node$q (selecuv$ A_a_a_fun_fun_bool_fun$ )(selecuw$ A_a_a_fun_fun_bool_fun_tree$ )(selecux$ A_a_a_fun_fun_bool_fun_tree$ )))(A_tree_tree$ (node$r (root$a A_tree$ )(left$a A_tree_tree$ )(right$a A_tree_tree$ )))(A_tree_tree_tree$ (node$s (root$b A_tree_tree$ )(left$b A_tree_tree_tree$ )(right$b A_tree_tree_tree$ )))(A_tree_tree_tree_tree$ (node$t (root$c A_tree_tree_tree$ )(left$c A_tree_tree_tree_tree$ )(right$c A_tree_tree_tree_tree$ )))(A_tree_tree_tree_a_tree_tree_tree_fun_tree$ (node$u (selecuy$ A_tree_tree_tree_a_tree_tree_tree_fun$ )(selecuz$ A_tree_tree_tree_a_tree_tree_tree_fun_tree$ )(selecva$ A_tree_tree_tree_a_tree_tree_tree_fun_tree$ )))(A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$ (node$v (selecvb$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun$ )(selecvc$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$ )(selecvd$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$ )))(A_tree_tree_a_tree_tree_fun_tree$ (node$w (selecve$ A_tree_tree_a_tree_tree_fun$ )(selecvf$ A_tree_tree_a_tree_tree_fun_tree$ )(selecvg$ A_tree_tree_a_tree_tree_fun_tree$ )))(A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ (node$x (selecvh$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun$ )(selecvi$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ )(selecvj$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ )))(A_tree_a_tree_fun_tree$ (node$y (selecvk$ A_tree_a_tree_fun$ )(selecvl$ A_tree_a_tree_fun_tree$ )(selecvm$ A_tree_a_tree_fun_tree$ )))(A_tree_a_tree_a_tree_fun_fun_tree$ (node$z (selecvn$ A_tree_a_tree_a_tree_fun_fun$ )(selecvo$ A_tree_a_tree_a_tree_fun_fun_tree$ )(selecvp$ A_tree_a_tree_a_tree_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ (node$aa (selecvq$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun$ )(selecvr$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ )(selecvs$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ )))(A_a_a_a_fun_fun_fun_tree$ (node$ab (selecvt$ A_a_a_a_fun_fun_fun$ )(selecvu$ A_a_a_a_fun_fun_fun_tree$ )(selecvv$ A_a_a_a_fun_fun_fun_tree$ )))(A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ (node$ac (selecvw$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun$ )(selecvx$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ )(selecvy$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ )))(A_a_a_a_bool_fun_fun_fun_fun_tree$ (node$ad (selecvz$ A_a_a_a_bool_fun_fun_fun_fun$ )(selecwa$ A_a_a_a_bool_fun_fun_fun_fun_tree$ )(selecwb$ A_a_a_a_bool_fun_fun_fun_fun_tree$ )))(A_a_a_a_bool_fun_fun_fun_fun_a_a_a_a_bool_fun_fun_fun_fun_fun_tree$ (node$ae (selecwc$ A_a_a_a_bool_fun_fun_fun_fun_a_a_a_a_bool_fun_fun_fun_fun_fun$ )(selecwd$ A_a_a_a_bool_fun_fun_fun_fun_a_a_a_a_bool_fun_fun_fun_fun_fun_tree$ )(selecwe$ A_a_a_a_bool_fun_fun_fun_fun_a_a_a_a_bool_fun_fun_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_tree$ (node$af (selecwf$ A_a_fun_a_a_fun_fun$ )(selecwg$ A_a_fun_a_a_fun_fun_tree$ )(selecwh$ A_a_fun_a_a_fun_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$ag (selecwi$ A_a_fun_a_fun$ )(selecwj$ A_a_fun_a_fun_tree$ )(selecwk$ A_a_fun_a_fun_tree$ )))(A_a_a_fun_a_fun_fun_tree$ (node$ah (selecwl$ A_a_a_fun_a_fun_fun$ )(selecwm$ A_a_a_fun_a_fun_fun_tree$ )(selecwn$ A_a_a_fun_a_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$ (node$ai (selecwo$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun$ )(selecwp$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$ )(selecwq$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$ )))(A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$aj (selecwr$ A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun$ )(selecws$ A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(selecwt$ A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_fun_tree$ (node$ak (selecwu$ A_a_fun_a_a_a_fun_fun_fun$ )(selecwv$ A_a_fun_a_a_a_fun_fun_fun_tree$ )(selecww$ A_a_fun_a_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_a_a_fun_fun_fun_tree$ (node$al (selecwx$ A_a_a_fun_a_a_fun_fun_fun$ )(selecwy$ A_a_a_fun_a_a_fun_fun_fun_tree$ )(selecwz$ A_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$am (selecxa$ A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun$ )(selecxb$ A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ )(selecxc$ A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ )))(A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ (node$an (selecxd$ A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun$ )(selecxe$ A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ )(selecxf$ A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ )))(A_a_a_a_fun_a_fun_fun_fun_tree$ (node$ao (selecxg$ A_a_a_a_fun_a_fun_fun_fun$ )(selecxh$ A_a_a_a_fun_a_fun_fun_fun_tree$ )(selecxi$ A_a_a_a_fun_a_fun_fun_fun_tree$ )))(A_a_a_a_fun_a_fun_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun_tree$ (node$ap (selecxj$ A_a_a_a_fun_a_fun_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun$ )(selecxk$ A_a_a_a_fun_a_fun_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun_tree$ )(selecxl$ A_a_a_a_fun_a_fun_fun_fun_a_a_a_a_fun_a_fun_fun_fun_fun_tree$ )))(A_bool_fun_a_bool_fun_fun_tree$ (node$aq (selecxm$ A_bool_fun_a_bool_fun_fun$ )(selecxn$ A_bool_fun_a_bool_fun_fun_tree$ )(selecxo$ A_bool_fun_a_bool_fun_fun_tree$ )))(Bool_bool_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$ar (selecxp$ Bool_bool_fun_a_bool_fun_a_bool_fun_fun_fun$ )(selecxq$ Bool_bool_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )(selecxr$ Bool_bool_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )))(A_a_fun_a_bool_fun_fun_tree$ (node$as (selecxs$ A_a_fun_a_bool_fun_fun$ )(selecxt$ A_a_fun_a_bool_fun_fun_tree$ )(selecxu$ A_a_fun_a_bool_fun_fun_tree$ )))(A_bool_fun_a_a_fun_a_bool_fun_fun_fun_tree$ (node$at (selecxv$ A_bool_fun_a_a_fun_a_bool_fun_fun_fun$ )(selecxw$ A_bool_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )(selecxx$ A_bool_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )))(Bool_a_fun_tree$ (node$au (selecxy$ Bool_a_fun$ )(selecxz$ Bool_a_fun_tree$ )(selecya$ Bool_a_fun_tree$ )))(A_bool_fun_a_a_fun_fun_tree$ (node$av (selecyb$ A_bool_fun_a_a_fun_fun$ )(selecyc$ A_bool_fun_a_a_fun_fun_tree$ )(selecyd$ A_bool_fun_a_a_fun_fun_tree$ )))(Bool_a_fun_a_bool_fun_a_a_fun_fun_fun_tree$ (node$aw (selecye$ Bool_a_fun_a_bool_fun_a_a_fun_fun_fun$ )(selecyf$ Bool_a_fun_a_bool_fun_a_a_fun_fun_fun_tree$ )(selecyg$ Bool_a_fun_a_bool_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$ax (selecyh$ A_a_fun_a_a_fun_a_a_fun_fun_fun$ )(selecyi$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(selecyj$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_bool_fun_bool_fun_tree$ (node$ay (selecyk$ A_bool_fun_bool_fun$ )(selecyl$ A_bool_fun_bool_fun_tree$ )(selecym$ A_bool_fun_bool_fun_tree$ )))(A_a_bool_fun_fun_a_bool_fun_fun_tree$ (node$az (selecyn$ A_a_bool_fun_fun_a_bool_fun_fun$ )(selecyo$ A_a_bool_fun_fun_a_bool_fun_fun_tree$ )(selecyp$ A_a_bool_fun_fun_a_bool_fun_fun_tree$ )))(A_bool_fun_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ (node$ba (selecyq$ A_bool_fun_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun$ )(selecyr$ A_bool_fun_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )(selecys$ A_bool_fun_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )))(A_a_fun_bool_fun_tree$ (node$bb (selecyt$ A_a_fun_bool_fun$ )(selecyu$ A_a_fun_bool_fun_tree$ )(selecyv$ A_a_fun_bool_fun_tree$ )))(A_a_a_fun_fun_a_bool_fun_fun_tree$ (node$bc (selecyw$ A_a_a_fun_fun_a_bool_fun_fun$ )(selecyx$ A_a_a_fun_fun_a_bool_fun_fun_tree$ )(selecyy$ A_a_a_fun_fun_a_bool_fun_fun_tree$ )))(A_a_fun_bool_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ (node$bd (selecyz$ A_a_fun_bool_fun_a_a_a_fun_fun_a_bool_fun_fun_fun$ )(selecza$ A_a_fun_bool_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ )(seleczb$ A_a_fun_bool_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_a_bool_fun_fun_fun_tree$ (node$be (seleczc$ A_bool_fun_a_a_bool_fun_fun_fun$ )(seleczd$ A_bool_fun_a_a_bool_fun_fun_fun_tree$ )(selecze$ A_bool_fun_a_a_bool_fun_fun_fun_tree$ )))(Bool_a_bool_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$bf (seleczf$ Bool_a_bool_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun$ )(seleczg$ Bool_a_bool_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ )(seleczh$ Bool_a_bool_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ )))(Bool_a_a_fun_fun_tree$ (node$bg (seleczi$ Bool_a_a_fun_fun$ )(seleczj$ Bool_a_a_fun_fun_tree$ )(seleczk$ Bool_a_a_fun_fun_tree$ )))(A_bool_fun_a_a_a_fun_fun_fun_tree$ (node$bh (seleczl$ A_bool_fun_a_a_a_fun_fun_fun$ )(seleczm$ A_bool_fun_a_a_a_fun_fun_fun_tree$ )(seleczn$ A_bool_fun_a_a_a_fun_fun_fun_tree$ )))(Bool_a_a_fun_fun_a_bool_fun_a_a_a_fun_fun_fun_fun_tree$ (node$bi (seleczo$ Bool_a_a_fun_fun_a_bool_fun_a_a_a_fun_fun_fun_fun$ )(seleczp$ Bool_a_a_fun_fun_a_bool_fun_a_a_a_fun_fun_fun_fun_tree$ )(seleczq$ Bool_a_a_fun_fun_a_bool_fun_a_a_a_fun_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ (node$bj (seleczr$ A_a_a_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun$ )(seleczs$ A_a_a_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ )(seleczt$ A_a_a_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ )))(A_bool_fun_a_fun_tree$ (node$bk (seleczu$ A_bool_fun_a_fun$ )(seleczv$ A_bool_fun_a_fun_tree$ )(seleczw$ A_bool_fun_a_fun_tree$ )))(A_a_bool_fun_fun_a_a_fun_fun_tree$ (node$bl (seleczx$ A_a_bool_fun_fun_a_a_fun_fun$ )(seleczy$ A_a_bool_fun_fun_a_a_fun_fun_tree$ )(seleczz$ A_a_bool_fun_fun_a_a_fun_fun_tree$ )))(A_bool_fun_a_fun_a_a_bool_fun_fun_a_a_fun_fun_fun_tree$ (node$bm (seledaa$ A_bool_fun_a_fun_a_a_bool_fun_fun_a_a_fun_fun_fun$ )(seledab$ A_bool_fun_a_fun_a_a_bool_fun_fun_a_a_fun_fun_fun_tree$ )(seledac$ A_bool_fun_a_fun_a_a_bool_fun_fun_a_a_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$bn (seledad$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun$ )(seledae$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )(seledaf$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )))(Bool_a_bool_fun_bool_fun_fun_tree$ (node$bo (seledag$ Bool_a_bool_fun_bool_fun_fun$ )(seledah$ Bool_a_bool_fun_bool_fun_fun_tree$ )(seledai$ Bool_a_bool_fun_bool_fun_fun_tree$ )))(A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ (node$bp (seledaj$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun$ )(seledak$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ )(seledal$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ (node$bq (seledam$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun$ )(seledan$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ )(seledao$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$br (seledap$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun$ )(seledaq$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ )(seledar$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ )))(A_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$bs (seledas$ A_a_a_fun_a_a_bool_fun_fun_fun_fun$ )(seledat$ A_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ )(seledau$ A_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_bool_fun_fun_tree$ (node$bt (seledav$ A_bool_bool_fun_fun$ )(seledaw$ A_bool_bool_fun_fun_tree$ )(seledax$ A_bool_bool_fun_fun_tree$ )))(A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$bu (seleday$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun$ )(seledaz$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )(seledba$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ (node$bv (seledbb$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun$ )(seledbc$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )(seledbd$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_a_fun_fun_tree$ (node$bw (seledbe$ A_bool_a_fun_fun$ )(seledbf$ A_bool_a_fun_fun_tree$ )(seledbg$ A_bool_a_fun_fun_tree$ )))(A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ (node$bx (seledbh$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun$ )(seledbi$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ )(seledbj$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$by (seledbk$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$ )(seledbl$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(seledbm$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_bool_fun_bool_fun_fun_tree$ (node$bz (seledbn$ A_a_bool_fun_bool_fun_fun$ )(seledbo$ A_a_bool_fun_bool_fun_fun_tree$ )(seledbp$ A_a_bool_fun_bool_fun_fun_tree$ )))(A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ (node$ca (seledbq$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun$ )(seledbr$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )(seledbs$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )))(A_a_a_fun_bool_fun_fun_tree$ (node$cb (seledbt$ A_a_a_fun_bool_fun_fun$ )(seledbu$ A_a_a_fun_bool_fun_fun_tree$ )(seledbv$ A_a_a_fun_bool_fun_fun_tree$ )))(A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ (node$cc (seledbw$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun$ )(seledbx$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ )(seledby$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_a_bool_fun_fun_fun_tree$ (node$cd (seledbz$ A_bool_a_bool_fun_fun_fun$ )(seledca$ A_bool_a_bool_fun_fun_fun_tree$ )(seledcb$ A_bool_a_bool_fun_fun_fun_tree$ )))(A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$ce (seledcc$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun$ )(seledcd$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ )(seledce$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ )))(A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$cf (seledcf$ A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun$ )(seledcg$ A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ )(seledch$ A_a_a_bool_fun_fun_fun_a_a_fun_a_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_a_a_fun_fun_fun_tree$ (node$cg (seledci$ A_bool_a_a_fun_fun_fun$ )(seledcj$ A_bool_a_a_fun_fun_fun_tree$ )(seledck$ A_bool_a_a_fun_fun_fun_tree$ )))(A_bool_a_a_fun_fun_fun_a_bool_fun_a_a_a_fun_fun_fun_fun_tree$ (node$ch (seledcl$ A_bool_a_a_fun_fun_fun_a_bool_fun_a_a_a_fun_fun_fun_fun$ )(seledcm$ A_bool_a_a_fun_fun_fun_a_bool_fun_a_a_a_fun_fun_fun_fun_tree$ )(seledcn$ A_bool_a_a_fun_fun_fun_a_bool_fun_a_a_a_fun_fun_fun_fun_tree$ )))(A_a_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ (node$ci (seledco$ A_a_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun$ )(seledcp$ A_a_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ )(seledcq$ A_a_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$cj (seledcr$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun$ )(seledcs$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(seledct$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ (node$ck (seledcu$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun$ )(seledcv$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ )(seledcw$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$cl (seledcx$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_fun$ )(seledcy$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ )(seledcz$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_fun_tree$ (node$cm (seledda$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_fun$ )(seleddb$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_fun_tree$ )(seleddc$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_a_fun_fun_a_a_fun_fun_tree$ (node$cn (seleddd$ A_a_a_fun_a_fun_fun_a_a_fun_fun$ )(seledde$ A_a_a_fun_a_fun_fun_a_a_fun_fun_tree$ )(seleddf$ A_a_a_fun_a_fun_fun_a_a_fun_fun_tree$ )))(A_a_a_fun_a_fun_a_fun_fun_a_a_a_fun_a_fun_fun_a_a_fun_fun_fun_tree$ (node$co (seleddg$ A_a_a_fun_a_fun_a_fun_fun_a_a_a_fun_a_fun_fun_a_a_fun_fun_fun$ )(seleddh$ A_a_a_fun_a_fun_a_fun_fun_a_a_a_fun_a_fun_fun_a_a_fun_fun_fun_tree$ )(seleddi$ A_a_a_fun_a_fun_a_fun_fun_a_a_a_fun_a_fun_fun_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_a_fun_a_fun_fun_tree$ (node$cp (seleddj$ A_a_a_fun_a_fun_a_fun_fun$ )(seleddk$ A_a_a_fun_a_fun_a_fun_fun_tree$ )(seleddl$ A_a_a_fun_a_fun_a_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_fun_fun_tree$ (node$cq (seleddm$ A_a_a_fun_fun_a_a_fun_fun$ )(seleddn$ A_a_a_fun_fun_a_a_fun_fun_tree$ )(seleddo$ A_a_a_fun_fun_a_a_fun_fun_tree$ )))(A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ (node$cr (seleddp$ A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun$ )(seleddq$ A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ )(seleddr$ A_a_a_fun_a_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$cs (seledds$ A_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun$ )(seleddt$ A_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(seleddu$ A_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$ct (seleddv$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_fun$ )(seleddw$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ )(seleddx$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_fun_a_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$cu (seleddy$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun$ )(seleddz$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun_tree$ )(seledea$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun_fun_tree$ (node$cv (seledeb$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun_fun$ )(seledec$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun_fun_tree$ )(seleded$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_a_a_bool_fun_fun_a_a_bool_fun_fun_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$cw (seledee$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_a_a_bool_fun_fun_fun_fun$ )(seledef$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_a_a_bool_fun_fun_fun_fun_tree$ )(seledeg$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_a_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_fun_a_a_bool_fun_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$cx (seledeh$ A_bool_fun_a_a_bool_fun_fun_fun_a_bool_fun_a_bool_fun_fun_fun$ )(seledei$ A_bool_fun_a_a_bool_fun_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )(seledej$ A_bool_fun_a_a_bool_fun_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_a_bool_fun_a_bool_fun_fun_fun_fun_tree$ (node$cy (seledek$ A_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_a_bool_fun_a_bool_fun_fun_fun_fun$ )(seledel$ A_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_a_bool_fun_a_bool_fun_fun_fun_fun_tree$ )(seledem$ A_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_a_bool_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ (node$cz (seleden$ A_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun$ )(seledeo$ A_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )(seledep$ A_bool_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )))(Bool_a_bool_fun_bool_fun_fun_bool_bool_fun_fun_tree$ (node$da (seledeq$ Bool_a_bool_fun_bool_fun_fun_bool_bool_fun_fun$ )(seleder$ Bool_a_bool_fun_bool_fun_fun_bool_bool_fun_fun_tree$ )(seledes$ Bool_a_bool_fun_bool_fun_fun_bool_bool_fun_fun_tree$ )))(Bool_a_bool_fun_bool_fun_bool_fun_fun_bool_a_bool_fun_bool_fun_fun_bool_bool_fun_fun_fun_tree$ (node$db (seledet$ Bool_a_bool_fun_bool_fun_bool_fun_fun_bool_a_bool_fun_bool_fun_fun_bool_bool_fun_fun_fun$ )(seledeu$ Bool_a_bool_fun_bool_fun_bool_fun_fun_bool_a_bool_fun_bool_fun_fun_bool_bool_fun_fun_fun_tree$ )(seledev$ Bool_a_bool_fun_bool_fun_bool_fun_fun_bool_a_bool_fun_bool_fun_fun_bool_bool_fun_fun_fun_tree$ )))(Bool_a_bool_fun_bool_fun_bool_fun_fun_tree$ (node$dc (seledew$ Bool_a_bool_fun_bool_fun_bool_fun_fun$ )(seledex$ Bool_a_bool_fun_bool_fun_bool_fun_fun_tree$ )(seledey$ Bool_a_bool_fun_bool_fun_bool_fun_fun_tree$ )))(Bool_a_bool_fun_fun_bool_bool_fun_fun_tree$ (node$dd (seledez$ Bool_a_bool_fun_fun_bool_bool_fun_fun$ )(seledfa$ Bool_a_bool_fun_fun_bool_bool_fun_fun_tree$ )(seledfb$ Bool_a_bool_fun_fun_bool_bool_fun_fun_tree$ )))(Bool_a_bool_fun_bool_fun_fun_bool_a_bool_fun_fun_bool_bool_fun_fun_fun_tree$ (node$de (seledfc$ Bool_a_bool_fun_bool_fun_fun_bool_a_bool_fun_fun_bool_bool_fun_fun_fun$ )(seledfd$ Bool_a_bool_fun_bool_fun_fun_bool_a_bool_fun_fun_bool_bool_fun_fun_fun_tree$ )(seledfe$ Bool_a_bool_fun_bool_fun_fun_bool_a_bool_fun_fun_bool_bool_fun_fun_fun_tree$ )))))
