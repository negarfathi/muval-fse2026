...
(declare-codatatypes ()((A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(A_a_fun_tree$ (node$a (select$ A_a_fun$ )(selecta$ A_a_fun_tree$ )(selectb$ A_a_fun_tree$ )))(A_tree_tree$ (node$b (root$a A_tree$ )(left$a A_tree_tree$ )(right$a A_tree_tree$ )))(A_a_fun_tree_tree$ (node$c (root$b A_a_fun_tree$ )(left$b A_a_fun_tree_tree$ )(right$b A_a_fun_tree_tree$ )))(A_tree_tree_tree$ (node$d (root$c A_tree_tree$ )(left$c A_tree_tree_tree$ )(right$c A_tree_tree_tree$ )))(A_a_fun_a_fun_tree$ (node$e (selectc$ A_a_fun_a_fun$ )(selectd$ A_a_fun_a_fun_tree$ )(selecte$ A_a_fun_a_fun_tree$ )))))
