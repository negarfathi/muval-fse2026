...
(declare-codatatypes ()((A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(B_a_fun_stream$ (sCons$a (select$ B_a_fun$ )(selecta$ B_a_fun_stream$ )))(B_stream$ (sCons$b (shd$a B$ )(stl$a B_stream$ )))(B_a_fun_a_fun_stream$ (sCons$c (selectb$ B_a_fun_a_fun$ )(selectc$ B_a_fun_a_fun_stream$ )))(B_b_fun_stream$ (sCons$d (selectd$ B_b_fun$ )(selecte$ B_b_fun_stream$ )))(B_b_a_fun_a_fun_fun_stream$ (sCons$e (selectf$ B_b_a_fun_a_fun_fun$ )(selectg$ B_b_a_fun_a_fun_fun_stream$ )))(B_a_fun_a_fun_b_fun_stream$ (sCons$f (selecth$ B_a_fun_a_fun_b_fun$ )(selecti$ B_a_fun_a_fun_b_fun_stream$ )))(B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$ (sCons$g (selectj$ B_a_fun_a_fun_b_a_fun_a_fun_fun$ )(selectk$ B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$ )))(A_b_fun_stream$ (sCons$h (selectl$ A_b_fun$ )(selectm$ A_b_fun_stream$ )))(A_a_fun_stream$ (sCons$i (selectn$ A_a_fun$ )(selecto$ A_a_fun_stream$ )))(B_b_b_fun_fun_stream$ (sCons$j (selectp$ B_b_b_fun_fun$ )(selectq$ B_b_b_fun_fun_stream$ )))(B_b_a_fun_fun_stream$ (sCons$k (selectr$ B_b_a_fun_fun$ )(selects$ B_b_a_fun_fun_stream$ )))(A_b_fun_a_b_fun_fun_stream$ (sCons$l (selectt$ A_b_fun_a_b_fun_fun$ )(selectu$ A_b_fun_a_b_fun_fun_stream$ )))(A_a_fun_a_a_fun_fun_stream$ (sCons$m (selectv$ A_a_fun_a_a_fun_fun$ )(selectw$ A_a_fun_a_a_fun_fun_stream$ )))(B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun_stream$ (sCons$n (selectx$ B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun$ )(selecty$ B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun_stream$ )))(B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun_stream$ (sCons$o (selectz$ B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun$ )(selecua$ B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun_stream$ )))(B_b_fun_b_b_fun_fun_stream$ (sCons$p (selecub$ B_b_fun_b_b_fun_fun$ )(selecuc$ B_b_fun_b_b_fun_fun_stream$ )))(B_a_fun_b_a_fun_fun_stream$ (sCons$q (selecud$ B_a_fun_b_a_fun_fun$ )(selecue$ B_a_fun_b_a_fun_fun_stream$ )))(B_a_fun_a_fun_stream_stream$ (sCons$r (shd$b B_a_fun_a_fun_stream$ )(stl$b B_a_fun_a_fun_stream_stream$ )))(B_stream_stream$ (sCons$s (shd$c B_stream$ )(stl$c B_stream_stream$ )))(B_a_fun_a_fun_b_fun_tree$ (node$ (selecuf$ B_a_fun_a_fun_b_fun$ )(selecug$ B_a_fun_a_fun_b_fun_tree$ )(selecuh$ B_a_fun_a_fun_b_fun_tree$ )))(B_b_a_fun_a_fun_fun_tree$ (node$a (selecui$ B_b_a_fun_a_fun_fun$ )(selecuj$ B_b_a_fun_a_fun_fun_tree$ )(selecuk$ B_b_a_fun_a_fun_fun_tree$ )))(B_b_fun_tree$ (node$b (selecul$ B_b_fun$ )(selecum$ B_b_fun_tree$ )(selecun$ B_b_fun_tree$ )))(B_a_fun_tree$ (node$c (selecuo$ B_a_fun$ )(selecup$ B_a_fun_tree$ )(selecuq$ B_a_fun_tree$ )))(A_tree$ (node$d (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(B_tree$ (node$e (root$a B$ )(left$a B_tree$ )(right$a B_tree$ )))(B_a_fun_a_fun_tree$ (node$f (selecur$ B_a_fun_a_fun$ )(selecus$ B_a_fun_a_fun_tree$ )(selecut$ B_a_fun_a_fun_tree$ )))))
