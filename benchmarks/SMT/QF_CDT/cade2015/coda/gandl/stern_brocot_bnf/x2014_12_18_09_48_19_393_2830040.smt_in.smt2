...
(declare-codatatypes ()((A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(A_tree_tree$ (node$a (root$a A_tree$ )(left$a A_tree_tree$ )(right$a A_tree_tree$ )))(A_stream_tree$ (node$b (root$b A_stream$ )(left$b A_stream_tree$ )(right$b A_stream_tree$ )))(A_stream_tree_tree$ (node$c (root$c A_stream_tree$ )(left$c A_stream_tree_tree$ )(right$c A_stream_tree_tree$ )))(A_tree_tree_tree$ (node$d (root$d A_tree_tree$ )(left$d A_tree_tree_tree$ )(right$d A_tree_tree_tree$ )))(A_stream_stream$ (sCons$a (shd$a A_stream$ )(stl$a A_stream_stream$ )))(A_stream_stream_tree$ (node$e (root$e A_stream_stream$ )(left$e A_stream_stream_tree$ )(right$e A_stream_stream_tree$ )))(A_tree_stream$ (sCons$b (shd$b A_tree$ )(stl$b A_tree_stream$ )))(A_tree_stream_tree$ (node$f (root$f A_tree_stream$ )(left$f A_tree_stream_tree$ )(right$f A_tree_stream_tree$ )))(A_stream_stream_tree_tree$ (node$g (root$g A_stream_stream_tree$ )(left$g A_stream_stream_tree_tree$ )(right$g A_stream_stream_tree_tree$ )))(A_tree_tree_stream$ (sCons$c (shd$c A_tree_tree$ )(stl$c A_tree_tree_stream$ )))(A_tree_tree_stream_tree$ (node$h (root$h A_tree_tree_stream$ )(left$h A_tree_tree_stream_tree$ )(right$h A_tree_tree_stream_tree$ )))(A_stream_tree_stream$ (sCons$d (shd$d A_stream_tree$ )(stl$d A_stream_tree_stream$ )))(A_stream_tree_stream_tree$ (node$i (root$i A_stream_tree_stream$ )(left$i A_stream_tree_stream_tree$ )(right$i A_stream_tree_stream_tree$ )))(A_stream_stream_stream$ (sCons$e (shd$e A_stream_stream$ )(stl$e A_stream_stream_stream$ )))(A_tree_stream_stream$ (sCons$f (shd$f A_tree_stream$ )(stl$f A_tree_stream_stream$ )))(A_stream_stream_tree_stream$ (sCons$g (shd$g A_stream_stream_tree$ )(stl$g A_stream_stream_tree_stream$ )))(A_tree_tree_stream_stream$ (sCons$h (shd$h A_tree_tree_stream$ )(stl$h A_tree_tree_stream_stream$ )))(A_stream_tree_stream_stream$ (sCons$i (shd$i A_stream_tree_stream$ )(stl$i A_stream_tree_stream_stream$ )))(A_a_fun_tree$ (node$j (select$ A_a_fun$ )(selecta$ A_a_fun_tree$ )(selectb$ A_a_fun_tree$ )))(A_a_fun_stream$ (sCons$j (selectc$ A_a_fun$ )(selectd$ A_a_fun_stream$ )))(A_a_fun_a_fun_tree$ (node$k (selecte$ A_a_fun_a_fun$ )(selectf$ A_a_fun_a_fun_tree$ )(selectg$ A_a_fun_a_fun_tree$ )))(A_a_fun_a_fun_stream$ (sCons$k (selecth$ A_a_fun_a_fun$ )(selecti$ A_a_fun_a_fun_stream$ )))(A_stream_a_stream_fun_tree$ (node$l (selectj$ A_stream_a_stream_fun$ )(selectk$ A_stream_a_stream_fun_tree$ )(selectl$ A_stream_a_stream_fun_tree$ )))(A_stream_a_stream_fun_stream$ (sCons$l (selectm$ A_stream_a_stream_fun$ )(selectn$ A_stream_a_stream_fun_stream$ )))(A_a_a_fun_fun_tree$ (node$m (selecto$ A_a_a_fun_fun$ )(selectp$ A_a_a_fun_fun_tree$ )(selectq$ A_a_a_fun_fun_tree$ )))(A_a_a_fun_fun_stream$ (sCons$m (selectr$ A_a_a_fun_fun$ )(selects$ A_a_a_fun_fun_stream$ )))(A_a_fun_a_a_fun_fun_tree$ (node$n (selectt$ A_a_fun_a_a_fun_fun$ )(selectu$ A_a_fun_a_a_fun_fun_tree$ )(selectv$ A_a_fun_a_a_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_stream$ (sCons$n (selectw$ A_a_fun_a_a_fun_fun$ )(selectx$ A_a_fun_a_a_fun_fun_stream$ )))(A_tree_a_tree_a_tree_fun_fun_tree$ (node$o (selecty$ A_tree_a_tree_a_tree_fun_fun$ )(selectz$ A_tree_a_tree_a_tree_fun_fun_tree$ )(selecua$ A_tree_a_tree_a_tree_fun_fun_tree$ )))(A_tree_a_tree_fun_stream$ (sCons$o (selecub$ A_tree_a_tree_fun$ )(selecuc$ A_tree_a_tree_fun_stream$ )))(A_tree_a_tree_fun_tree$ (node$p (selecud$ A_tree_a_tree_fun$ )(selecue$ A_tree_a_tree_fun_tree$ )(selecuf$ A_tree_a_tree_fun_tree$ )))(A_tree_a_tree_a_tree_fun_fun_stream$ (sCons$p (selecug$ A_tree_a_tree_a_tree_fun_fun$ )(selecuh$ A_tree_a_tree_a_tree_fun_fun_stream$ )))(A_stream_a_stream_a_stream_fun_fun_tree$ (node$q (selecui$ A_stream_a_stream_a_stream_fun_fun$ )(selecuj$ A_stream_a_stream_a_stream_fun_fun_tree$ )(selecuk$ A_stream_a_stream_a_stream_fun_fun_tree$ )))(A_stream_a_stream_a_stream_fun_fun_stream$ (sCons$q (selecul$ A_stream_a_stream_a_stream_fun_fun$ )(selecum$ A_stream_a_stream_a_stream_fun_fun_stream$ )))(A_a_tree_fun_tree$ (node$r (selecun$ A_a_tree_fun$ )(selecuo$ A_a_tree_fun_tree$ )(selecup$ A_a_tree_fun_tree$ )))(A_a_tree_fun_stream$ (sCons$r (selecuq$ A_a_tree_fun$ )(selecur$ A_a_tree_fun_stream$ )))(A_a_stream_fun_tree$ (node$s (selecus$ A_a_stream_fun$ )(selecut$ A_a_stream_fun_tree$ )(selecuu$ A_a_stream_fun_tree$ )))(A_a_stream_fun_stream$ (sCons$s (selecuv$ A_a_stream_fun$ )(selecuw$ A_a_stream_fun_stream$ )))(A_stream_a_stream_fun_a_fun_tree$ (node$t (selecux$ A_stream_a_stream_fun_a_fun$ )(selecuy$ A_stream_a_stream_fun_a_fun_tree$ )(selecuz$ A_stream_a_stream_fun_a_fun_tree$ )))(A_stream_a_stream_fun_a_fun_stream$ (sCons$t (selecva$ A_stream_a_stream_fun_a_fun$ )(selecvb$ A_stream_a_stream_fun_a_fun_stream$ )))(A_stream_tree_a_stream_tree_fun_tree$ (node$u (selecvc$ A_stream_tree_a_stream_tree_fun$ )(selecvd$ A_stream_tree_a_stream_tree_fun_tree$ )(selecve$ A_stream_tree_a_stream_tree_fun_tree$ )))(A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$ (node$v (selecvf$ A_stream_tree_a_stream_tree_a_stream_tree_fun_fun$ )(selecvg$ A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$ )(selecvh$ A_stream_tree_a_stream_tree_a_stream_tree_fun_fun_tree$ )))(A_tree_tree_a_tree_tree_fun_tree$ (node$w (selecvi$ A_tree_tree_a_tree_tree_fun$ )(selecvj$ A_tree_tree_a_tree_tree_fun_tree$ )(selecvk$ A_tree_tree_a_tree_tree_fun_tree$ )))(A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ (node$x (selecvl$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun$ )(selecvm$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ )(selecvn$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ )))(A_stream_stream_a_stream_stream_fun_tree$ (node$y (selecvo$ A_stream_stream_a_stream_stream_fun$ )(selecvp$ A_stream_stream_a_stream_stream_fun_tree$ )(selecvq$ A_stream_stream_a_stream_stream_fun_tree$ )))(A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$ (node$z (selecvr$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun$ )(selecvs$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$ )(selecvt$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_tree$ )))(A_tree_stream_a_tree_stream_fun_tree$ (node$aa (selecvu$ A_tree_stream_a_tree_stream_fun$ )(selecvv$ A_tree_stream_a_tree_stream_fun_tree$ )(selecvw$ A_tree_stream_a_tree_stream_fun_tree$ )))(A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$ (node$ab (selecvx$ A_tree_stream_a_tree_stream_a_tree_stream_fun_fun$ )(selecvy$ A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$ )(selecvz$ A_tree_stream_a_tree_stream_a_tree_stream_fun_fun_tree$ )))(A_stream_stream_tree_a_stream_stream_tree_fun_tree$ (node$ac (selecwa$ A_stream_stream_tree_a_stream_stream_tree_fun$ )(selecwb$ A_stream_stream_tree_a_stream_stream_tree_fun_tree$ )(selecwc$ A_stream_stream_tree_a_stream_stream_tree_fun_tree$ )))(A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$ (node$ad (selecwd$ A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun$ )(selecwe$ A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$ )(selecwf$ A_stream_stream_tree_a_stream_stream_tree_a_stream_stream_tree_fun_fun_tree$ )))(A_tree_tree_stream_a_tree_tree_stream_fun_tree$ (node$ae (selecwg$ A_tree_tree_stream_a_tree_tree_stream_fun$ )(selecwh$ A_tree_tree_stream_a_tree_tree_stream_fun_tree$ )(selecwi$ A_tree_tree_stream_a_tree_tree_stream_fun_tree$ )))(A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$ (node$af (selecwj$ A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun$ )(selecwk$ A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$ )(selecwl$ A_tree_tree_stream_a_tree_tree_stream_a_tree_tree_stream_fun_fun_tree$ )))(A_stream_tree_stream_a_stream_tree_stream_fun_tree$ (node$ag (selecwm$ A_stream_tree_stream_a_stream_tree_stream_fun$ )(selecwn$ A_stream_tree_stream_a_stream_tree_stream_fun_tree$ )(selecwo$ A_stream_tree_stream_a_stream_tree_stream_fun_tree$ )))(A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$ (node$ah (selecwp$ A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun$ )(selecwq$ A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$ )(selecwr$ A_stream_tree_stream_a_stream_tree_stream_a_stream_tree_stream_fun_fun_tree$ )))(A_a_a_fun_fun_a_fun_tree$ (node$ai (selecws$ A_a_a_fun_fun_a_fun$ )(selecwt$ A_a_a_fun_fun_a_fun_tree$ )(selecwu$ A_a_a_fun_fun_a_fun_tree$ )))(A_a_stream_a_stream_fun_fun_tree$ (node$aj (selecwv$ A_a_stream_a_stream_fun_fun$ )(selecww$ A_a_stream_a_stream_fun_fun_tree$ )(selecwx$ A_a_stream_a_stream_fun_fun_tree$ )))(A_a_a_a_fun_fun_fun_tree$ (node$ak (selecwy$ A_a_a_a_fun_fun_fun$ )(selecwz$ A_a_a_a_fun_fun_fun_tree$ )(selecxa$ A_a_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$ (node$al (selecxb$ A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun$ )(selecxc$ A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$ )(selecxd$ A_a_a_fun_fun_a_tree_a_tree_a_tree_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$ (node$am (selecxe$ A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun$ )(selecxf$ A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$ )(selecxg$ A_a_a_fun_fun_a_stream_a_stream_a_stream_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ (node$an (selecxh$ A_a_a_fun_fun_a_a_a_fun_fun_fun$ )(selecxi$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )(selecxj$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )))(A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$ (node$ao (selecxk$ A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun$ )(selecxl$ A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$ )(selecxm$ A_stream_a_stream_a_stream_fun_fun_a_a_a_fun_fun_fun_tree$ )))(A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$ (node$ap (selecxn$ A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun$ )(selecxo$ A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$ )(selecxp$ A_tree_a_tree_a_tree_fun_fun_a_a_a_fun_fun_fun_tree$ )))(A_stream_a_fun_stream$ (sCons$u (selecxq$ A_stream_a_fun$ )(selecxr$ A_stream_a_fun_stream$ )))(A_tree_a_fun_stream$ (sCons$v (selecxs$ A_tree_a_fun$ )(selecxt$ A_tree_a_fun_stream$ )))(A_tree_a_stream_fun_stream$ (sCons$w (selecxu$ A_tree_a_stream_fun$ )(selecxv$ A_tree_a_stream_fun_stream$ )))(A_stream_a_tree_fun_stream$ (sCons$x (selecxw$ A_stream_a_tree_fun$ )(selecxx$ A_stream_a_tree_fun_stream$ )))))
