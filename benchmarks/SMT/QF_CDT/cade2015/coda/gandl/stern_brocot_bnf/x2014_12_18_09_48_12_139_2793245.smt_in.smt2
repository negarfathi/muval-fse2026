...
(declare-codatatypes ()((B_b_fun_tree$ (node$b (select$ B_b_fun$ )(selecta$ B_b_fun_tree$ )(selectb$ B_b_fun_tree$ )))(A_b_fun_tree$ (node$c (selectc$ A_b_fun$ )(selectd$ A_b_fun_tree$ )(selecte$ A_b_fun_tree$ )))(B_a_fun_tree$ (node$d (selectf$ B_a_fun$ )(selectg$ B_a_fun_tree$ )(selecth$ B_a_fun_tree$ )))(A_a_fun_tree$ (node$e (selecti$ A_a_fun$ )(selectj$ A_a_fun_tree$ )(selectk$ A_a_fun_tree$ )))(B_a_a_fun_fun_tree$ (node$f (selectl$ B_a_a_fun_fun$ )(selectm$ B_a_a_fun_fun_tree$ )(selectn$ B_a_a_fun_fun_tree$ )))(A_b_b_fun_fun_tree$ (node$g (selecto$ A_b_b_fun_fun$ )(selectp$ A_b_b_fun_fun_tree$ )(selectq$ A_b_b_fun_fun_tree$ )))(A_b_a_fun_fun_tree$ (node$h (selectr$ A_b_a_fun_fun$ )(selects$ A_b_a_fun_fun_tree$ )(selectt$ A_b_a_fun_fun_tree$ )))(A_a_b_fun_fun_tree$ (node$i (selectu$ A_a_b_fun_fun$ )(selectv$ A_a_b_fun_fun_tree$ )(selectw$ A_a_b_fun_fun_tree$ )))(A_a_fun_b_fun_tree$ (node$j (selectx$ A_a_fun_b_fun$ )(selecty$ A_a_fun_b_fun_tree$ )(selectz$ A_a_fun_b_fun_tree$ )))(B_a_fun_b_fun_tree$ (node$k (selecua$ B_a_fun_b_fun$ )(selecub$ B_a_fun_b_fun_tree$ )(selecuc$ B_a_fun_b_fun_tree$ )))(A_b_fun_b_fun_tree$ (node$l (selecud$ A_b_fun_b_fun$ )(selecue$ A_b_fun_b_fun_tree$ )(selecuf$ A_b_fun_b_fun_tree$ )))(B_b_fun_b_fun_tree$ (node$m (selecug$ B_b_fun_b_fun$ )(selecuh$ B_b_fun_b_fun_tree$ )(selecui$ B_b_fun_b_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$n (selecuj$ A_a_fun_a_fun$ )(selecuk$ A_a_fun_a_fun_tree$ )(selecul$ A_a_fun_a_fun_tree$ )))(B_a_fun_a_fun_tree$ (node$o (selecum$ B_a_fun_a_fun$ )(selecun$ B_a_fun_a_fun_tree$ )(selecuo$ B_a_fun_a_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$p (selecup$ A_a_a_fun_fun$ )(selecuq$ A_a_a_fun_fun_tree$ )(selecur$ A_a_a_fun_fun_tree$ )))(B_b_b_fun_fun_tree$ (node$q (selecus$ B_b_b_fun_fun$ )(selecut$ B_b_b_fun_fun_tree$ )(selecuu$ B_b_b_fun_fun_tree$ )))(B_a_b_fun_fun_tree$ (node$r (selecuv$ B_a_b_fun_fun$ )(selecuw$ B_a_b_fun_fun_tree$ )(selecux$ B_a_b_fun_fun_tree$ )))(B_b_fun_a_fun_tree$ (node$s (selecuy$ B_b_fun_a_fun$ )(selecuz$ B_b_fun_a_fun_tree$ )(selecva$ B_b_fun_a_fun_tree$ )))(A_b_fun_a_fun_tree$ (node$t (selecvb$ A_b_fun_a_fun$ )(selecvc$ A_b_fun_a_fun_tree$ )(selecvd$ A_b_fun_a_fun_tree$ )))))
