...
(declare-codatatypes ()((A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(B_a_fun_tree$ (node$a (select$ B_a_fun$ )(selecta$ B_a_fun_tree$ )(selectb$ B_a_fun_tree$ )))(B_tree$ (node$b (root$a B$ )(left$a B_tree$ )(right$a B_tree$ )))(B_c_fun_b_a_fun_fun_tree$ (node$c (selectc$ B_c_fun_b_a_fun_fun$ )(selectd$ B_c_fun_b_a_fun_fun_tree$ )(selecte$ B_c_fun_b_a_fun_fun_tree$ )))(B_c_fun_tree$ (node$d (selectf$ B_c_fun$ )(selectg$ B_c_fun_tree$ )(selecth$ B_c_fun_tree$ )))(C_a_fun_b_c_fun_b_a_fun_fun_fun_tree$ (node$e (selecti$ C_a_fun_b_c_fun_b_a_fun_fun_fun$ )(selectj$ C_a_fun_b_c_fun_b_a_fun_fun_fun_tree$ )(selectk$ C_a_fun_b_c_fun_b_a_fun_fun_fun_tree$ )))(C_a_fun_tree$ (node$f (selectl$ C_a_fun$ )(selectm$ C_a_fun_tree$ )(selectn$ C_a_fun_tree$ )))(C_tree$ (node$g (root$b C$ )(left$b C_tree$ )(right$b C_tree$ )))(C_c_fun_tree$ (node$h (selecto$ C_c_fun$ )(selectp$ C_c_fun_tree$ )(selectq$ C_c_fun_tree$ )))(C_b_fun_tree$ (node$i (selectr$ C_b_fun$ )(selects$ C_b_fun_tree$ )(selectt$ C_b_fun_tree$ )))(B_b_fun_tree$ (node$j (selectu$ B_b_fun$ )(selectv$ B_b_fun_tree$ )(selectw$ B_b_fun_tree$ )))(A_c_fun_tree$ (node$k (selectx$ A_c_fun$ )(selecty$ A_c_fun_tree$ )(selectz$ A_c_fun_tree$ )))(A_b_fun_tree$ (node$l (selecua$ A_b_fun$ )(selecub$ A_b_fun_tree$ )(selecuc$ A_b_fun_tree$ )))))
