...
(declare-codatatypes ()((A_a_fun_tree$ (node$a (selectb$ A_a_fun$ )(selectc$ A_a_fun_tree$ )(selectd$ A_a_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$b (selecte$ A_a_a_fun_fun$ )(selectf$ A_a_a_fun_fun_tree$ )(selectg$ A_a_a_fun_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$c (selecth$ A_a_fun_a_fun$ )(selecti$ A_a_fun_a_fun_tree$ )(selectj$ A_a_fun_a_fun_tree$ )))(A_a_fun_a_a_fun_fun_tree$ (node$d (selectk$ A_a_fun_a_a_fun_fun$ )(selectl$ A_a_fun_a_a_fun_fun_tree$ )(selectm$ A_a_fun_a_a_fun_fun_tree$ )))(A_a_a_fun_fun_a_fun_tree$ (node$e (selectn$ A_a_a_fun_fun_a_fun$ )(selecto$ A_a_a_fun_fun_a_fun_tree$ )(selectp$ A_a_a_fun_fun_a_fun_tree$ )))(A_a_fun_a_fun_a_fun_tree$ (node$f (selectq$ A_a_fun_a_fun_a_fun$ )(selectr$ A_a_fun_a_fun_a_fun_tree$ )(selects$ A_a_fun_a_fun_a_fun_tree$ )))(A_a_a_a_fun_fun_fun_tree$ (node$g (selectt$ A_a_a_a_fun_fun_fun$ )(selectu$ A_a_a_a_fun_fun_fun_tree$ )(selectv$ A_a_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_a_fun_fun_tree$ (node$h (selectw$ A_a_a_fun_a_fun_fun$ )(selectx$ A_a_a_fun_a_fun_fun_tree$ )(selecty$ A_a_a_fun_a_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_a_fun_tree$ (node$i (selectz$ A_a_fun_a_a_fun_fun_a_fun$ )(selecua$ A_a_fun_a_a_fun_fun_a_fun_tree$ )(selecub$ A_a_fun_a_a_fun_fun_a_fun_tree$ )))(A_a_a_fun_fun_a_a_fun_fun_tree$ (node$j (selecuc$ A_a_a_fun_fun_a_a_fun_fun$ )(selecud$ A_a_a_fun_fun_a_a_fun_fun_tree$ )(selecue$ A_a_a_fun_fun_a_a_fun_fun_tree$ )))))
(declare-fun n$ ()Num$ )
