...
(declare-codatatypes ()((A_bool_fun_tree$ (node$ (select$ A_bool_fun$ )(selecta$ A_bool_fun_tree$ )(selectb$ A_bool_fun_tree$ )))(A_tree$ (node$a (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(Bool_a_bool_fun_fun_tree$ (node$b (selectc$ Bool_a_bool_fun_fun$ )(selectd$ Bool_a_bool_fun_fun_tree$ )(selecte$ Bool_a_bool_fun_fun_tree$ )))(A_a_bool_fun_fun_tree$ (node$c (selectf$ A_a_bool_fun_fun$ )(selectg$ A_a_bool_fun_fun_tree$ )(selecth$ A_a_bool_fun_fun_tree$ )))(A_a_fun_tree$ (node$d (selecti$ A_a_fun$ )(selectj$ A_a_fun_tree$ )(selectk$ A_a_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$e (selectl$ A_a_a_fun_fun$ )(selectm$ A_a_a_fun_fun_tree$ )(selectn$ A_a_a_fun_fun_tree$ )))(Bool_bool_fun_tree$ (node$f (selecto$ Bool_bool_fun$ )(selectp$ Bool_bool_fun_tree$ )(selectq$ Bool_bool_fun_tree$ )))(A_a_bool_fun_fun_bool_fun_tree$ (node$g (selectr$ A_a_bool_fun_fun_bool_fun$ )(selects$ A_a_bool_fun_fun_bool_fun_tree$ )(selectt$ A_a_bool_fun_fun_bool_fun_tree$ )))(Bool_a_a_bool_fun_fun_fun_tree$ (node$h (selectu$ Bool_a_a_bool_fun_fun_fun$ )(selectv$ Bool_a_a_bool_fun_fun_fun_tree$ )(selectw$ Bool_a_a_bool_fun_fun_fun_tree$ )))(Bool_a_a_a_fun_fun_fun_tree$ (node$i (selectx$ Bool_a_a_a_fun_fun_fun$ )(selecty$ Bool_a_a_a_fun_fun_fun_tree$ )(selectz$ Bool_a_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_fun_bool_fun_tree$ (node$j (selecua$ A_a_a_fun_fun_bool_fun$ )(selecub$ A_a_a_fun_fun_bool_fun_tree$ )(selecuc$ A_a_a_fun_fun_bool_fun_tree$ )))(A_a_a_fun_fun_a_a_bool_fun_fun_fun_tree$ (node$k (selecud$ A_a_a_fun_fun_a_a_bool_fun_fun_fun$ )(selecue$ A_a_a_fun_fun_a_a_bool_fun_fun_fun_tree$ )(selecuf$ A_a_a_fun_fun_a_a_bool_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ (node$l (selecug$ A_a_a_fun_fun_a_a_a_fun_fun_fun$ )(selecuh$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )(selecui$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_a_fun_fun_tree$ (node$m (selecuj$ A_a_a_fun_a_fun_fun$ )(selecuk$ A_a_a_fun_a_fun_fun_tree$ )(selecul$ A_a_a_fun_a_fun_fun_tree$ )))(A_a_a_bool_fun_fun_fun_tree$ (node$n (selecum$ A_a_a_bool_fun_fun_fun$ )(selecun$ A_a_a_bool_fun_fun_fun_tree$ )(selecuo$ A_a_a_bool_fun_fun_fun_tree$ )))(A_tree_tree$ (node$o (root$a A_tree$ )(left$a A_tree_tree$ )(right$a A_tree_tree$ )))(A_tree_tree_tree$ (node$p (root$b A_tree_tree$ )(left$b A_tree_tree_tree$ )(right$b A_tree_tree_tree$ )))(A_tree_tree_tree_tree$ (node$q (root$c A_tree_tree_tree$ )(left$c A_tree_tree_tree_tree$ )(right$c A_tree_tree_tree_tree$ )))(A_tree_tree_tree_a_tree_tree_tree_fun_tree$ (node$r (selecup$ A_tree_tree_tree_a_tree_tree_tree_fun$ )(selecuq$ A_tree_tree_tree_a_tree_tree_tree_fun_tree$ )(selecur$ A_tree_tree_tree_a_tree_tree_tree_fun_tree$ )))(A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$ (node$s (selecus$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun$ )(selecut$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$ )(selecuu$ A_tree_tree_tree_a_tree_tree_tree_a_tree_tree_tree_fun_fun_tree$ )))(A_tree_tree_a_tree_tree_fun_tree$ (node$t (selecuv$ A_tree_tree_a_tree_tree_fun$ )(selecuw$ A_tree_tree_a_tree_tree_fun_tree$ )(selecux$ A_tree_tree_a_tree_tree_fun_tree$ )))(A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ (node$u (selecuy$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun$ )(selecuz$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ )(selecva$ A_tree_tree_a_tree_tree_a_tree_tree_fun_fun_tree$ )))(A_tree_a_tree_fun_tree$ (node$v (selecvb$ A_tree_a_tree_fun$ )(selecvc$ A_tree_a_tree_fun_tree$ )(selecvd$ A_tree_a_tree_fun_tree$ )))(A_tree_a_tree_a_tree_fun_fun_tree$ (node$w (selecve$ A_tree_a_tree_a_tree_fun_fun$ )(selecvf$ A_tree_a_tree_a_tree_fun_fun_tree$ )(selecvg$ A_tree_a_tree_a_tree_fun_fun_tree$ )))(A_bool_fun_bool_a_bool_fun_fun_fun_tree$ (node$x (selecvh$ A_bool_fun_bool_a_bool_fun_fun_fun$ )(selecvi$ A_bool_fun_bool_a_bool_fun_fun_fun_tree$ )(selecvj$ A_bool_fun_bool_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_a_bool_fun_fun_fun_tree$ (node$y (selecvk$ A_bool_fun_a_a_bool_fun_fun_fun$ )(selecvl$ A_bool_fun_a_a_bool_fun_fun_fun_tree$ )(selecvm$ A_bool_fun_a_a_bool_fun_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_fun_tree$ (node$z (selecvn$ A_a_fun_a_a_a_fun_fun_fun$ )(selecvo$ A_a_fun_a_a_a_fun_fun_fun_tree$ )(selecvp$ A_a_fun_a_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$aa (selecvq$ A_a_fun_a_fun$ )(selecvr$ A_a_fun_a_fun_tree$ )(selecvs$ A_a_fun_a_fun_tree$ )))(A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ (node$ab (selecvt$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun$ )(selecvu$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ )(selecvv$ A_a_fun_a_fun_a_a_a_fun_a_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$ac (selecvw$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun$ )(selecvx$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )(selecvy$ A_a_bool_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )))(A_a_a_a_fun_fun_fun_tree$ (node$ad (selecvz$ A_a_a_a_fun_fun_fun$ )(selecwa$ A_a_a_a_fun_fun_fun_tree$ )(selecwb$ A_a_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ (node$ae (selecwc$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun$ )(selecwd$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ )(selecwe$ A_a_a_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ )))(A_a_fun_a_bool_fun_fun_tree$ (node$af (selecwf$ A_a_fun_a_bool_fun_fun$ )(selecwg$ A_a_fun_a_bool_fun_fun_tree$ )(selecwh$ A_a_fun_a_bool_fun_fun_tree$ )))(A_a_a_fun_a_bool_fun_fun_fun_tree$ (node$ag (selecwi$ A_a_a_fun_a_bool_fun_fun_fun$ )(selecwj$ A_a_a_fun_a_bool_fun_fun_fun_tree$ )(selecwk$ A_a_a_fun_a_bool_fun_fun_fun_tree$ )))(A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$ (node$ah (selecwl$ A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun$ )(selecwm$ A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$ )(selecwn$ A_a_fun_a_bool_fun_fun_a_a_a_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_a_a_fun_a_a_fun_fun_fun_tree$ (node$ai (selecwo$ A_a_a_fun_a_a_fun_fun_fun$ )(selecwp$ A_a_a_fun_a_a_fun_fun_fun_tree$ )(selecwq$ A_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_tree$ (node$aj (selecwr$ A_a_fun_a_a_fun_fun$ )(selecws$ A_a_fun_a_a_fun_fun_tree$ )(selecwt$ A_a_fun_a_a_fun_fun_tree$ )))(A_bool_bool_fun_fun_tree$ (node$ak (selecwu$ A_bool_bool_fun_fun$ )(selecwv$ A_bool_bool_fun_fun_tree$ )(selecww$ A_bool_bool_fun_fun_tree$ )))(Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$ (node$al (selecwx$ Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun$ )(selecwy$ Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$ )(selecwz$ Bool_a_bool_fun_fun_a_bool_bool_fun_fun_fun_tree$ )))(A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$ (node$am (selecxa$ A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun$ )(selecxb$ A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$ )(selecxc$ A_bool_bool_fun_fun_bool_a_bool_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ (node$an (selecxd$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun$ )(selecxe$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ )(selecxf$ A_a_bool_fun_fun_a_a_bool_fun_fun_fun_tree$ )))(Bool_bool_a_bool_fun_fun_fun_tree$ (node$ao (selecxg$ Bool_bool_a_bool_fun_fun_fun$ )(selecxh$ Bool_bool_a_bool_fun_fun_fun_tree$ )(selecxi$ Bool_bool_a_bool_fun_fun_fun_tree$ )))(Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$ (node$ap (selecxj$ Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun$ )(selecxk$ Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$ )(selecxl$ Bool_bool_a_bool_fun_fun_fun_bool_bool_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_a_bool_fun_fun_fun_tree$ (node$aq (selecxm$ A_bool_a_bool_fun_fun_fun$ )(selecxn$ A_bool_a_bool_fun_fun_fun_tree$ )(selecxo$ A_bool_a_bool_fun_fun_fun_tree$ )))(Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$ (node$ar (selecxp$ Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun$ )(selecxq$ Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$ )(selecxr$ Bool_a_a_bool_fun_fun_fun_a_bool_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$ (node$as (selecxs$ A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun$ )(selecxt$ A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$ )(selecxu$ A_bool_a_bool_fun_fun_fun_bool_a_a_bool_fun_fun_fun_fun_tree$ )))(A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ (node$at (selecxv$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun$ )(selecxw$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )(selecxx$ A_a_a_bool_fun_fun_fun_a_a_a_bool_fun_fun_fun_fun_tree$ )))(A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ (node$au (selecxy$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun$ )(selecxz$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ )(selecya$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$ (node$av (selecyb$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun$ )(selecyc$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$ )(selecyd$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$ )))(Bool_a_fun_tree$ (node$aw (selecye$ Bool_a_fun$ )(selecyf$ Bool_a_fun_tree$ )(selecyg$ Bool_a_fun_tree$ )))(Bool_a_fun_bool_bool_fun_fun_tree$ (node$ax (selecyh$ Bool_a_fun_bool_bool_fun_fun$ )(selecyi$ Bool_a_fun_bool_bool_fun_fun_tree$ )(selecyj$ Bool_a_fun_bool_bool_fun_fun_tree$ )))(Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$ (node$ay (selecyk$ Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun$ )(selecyl$ Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$ )(selecym$ Bool_a_bool_fun_fun_bool_a_fun_bool_bool_fun_fun_fun_tree$ )))(A_bool_fun_a_bool_fun_fun_tree$ (node$az (selecyn$ A_bool_fun_a_bool_fun_fun$ )(selecyo$ A_bool_fun_a_bool_fun_fun_tree$ )(selecyp$ A_bool_fun_a_bool_fun_fun_tree$ )))(A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ (node$ba (selecyq$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun$ )(selecyr$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )(selecys$ A_bool_bool_fun_fun_a_bool_fun_a_bool_fun_fun_fun_tree$ )))(A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ (node$bb (selecyt$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun$ )(selecyu$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )(selecyv$ A_a_bool_fun_fun_a_a_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_a_fun_fun_tree$ (node$bc (selecyw$ A_bool_a_fun_fun$ )(selecyx$ A_bool_a_fun_fun_tree$ )(selecyy$ A_bool_a_fun_fun_tree$ )))(A_bool_fun_a_a_fun_fun_tree$ (node$bd (selecyz$ A_bool_fun_a_a_fun_fun$ )(selecza$ A_bool_fun_a_a_fun_fun_tree$ )(seleczb$ A_bool_fun_a_a_fun_fun_tree$ )))(A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ (node$be (seleczc$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun$ )(seleczd$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ )(selecze$ A_bool_a_fun_fun_a_bool_fun_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$bf (seleczf$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$ )(seleczg$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(seleczh$ A_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_bool_fun_bool_fun_fun_tree$ (node$bg (seleczi$ A_a_bool_fun_bool_fun_fun$ )(seleczj$ A_a_bool_fun_bool_fun_fun_tree$ )(seleczk$ A_a_bool_fun_bool_fun_fun_tree$ )))(A_a_bool_fun_fun_a_bool_fun_fun_tree$ (node$bh (seleczl$ A_a_bool_fun_fun_a_bool_fun_fun$ )(seleczm$ A_a_bool_fun_fun_a_bool_fun_fun_tree$ )(seleczn$ A_a_bool_fun_fun_a_bool_fun_fun_tree$ )))(A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ (node$bi (seleczo$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun$ )(seleczp$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )(seleczq$ A_a_bool_fun_bool_fun_fun_a_a_bool_fun_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_bool_fun_tree$ (node$bj (seleczr$ A_bool_fun_bool_fun$ )(seleczs$ A_bool_fun_bool_fun_tree$ )(seleczt$ A_bool_fun_bool_fun_tree$ )))(A_a_a_fun_bool_fun_fun_tree$ (node$bk (seleczu$ A_a_a_fun_bool_fun_fun$ )(seleczv$ A_a_a_fun_bool_fun_fun_tree$ )(seleczw$ A_a_a_fun_bool_fun_fun_tree$ )))(A_a_a_fun_fun_a_bool_fun_fun_tree$ (node$bl (seleczx$ A_a_a_fun_fun_a_bool_fun_fun$ )(seleczy$ A_a_a_fun_fun_a_bool_fun_fun_tree$ )(seleczz$ A_a_a_fun_fun_a_bool_fun_fun_tree$ )))(A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ (node$bm (seledaa$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun$ )(seledab$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ )(seledac$ A_a_a_fun_bool_fun_fun_a_a_a_fun_fun_a_bool_fun_fun_fun_tree$ )))(A_a_fun_bool_fun_tree$ (node$bn (seledad$ A_a_fun_bool_fun$ )(seledae$ A_a_fun_bool_fun_tree$ )(seledaf$ A_a_fun_bool_fun_tree$ )))(Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$ (node$bo (seledag$ Bool_bool_fun_bool_a_bool_fun_fun_fun$ )(seledah$ Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$ )(seledai$ Bool_bool_fun_bool_a_bool_fun_fun_fun_tree$ )))(Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$ (node$bp (seledaj$ Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun$ )(seledak$ Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$ )(seledal$ Bool_bool_a_bool_fun_fun_fun_bool_bool_fun_bool_a_bool_fun_fun_fun_fun_tree$ )))(Bool_a_fun_bool_a_bool_fun_fun_fun_tree$ (node$bq (seledam$ Bool_a_fun_bool_a_bool_fun_fun_fun$ )(seledan$ Bool_a_fun_bool_a_bool_fun_fun_fun_tree$ )(seledao$ Bool_a_fun_bool_a_bool_fun_fun_fun_tree$ )))(Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$ (node$br (seledap$ Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun$ )(seledaq$ Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$ )(seledar$ Bool_a_a_bool_fun_fun_fun_bool_a_fun_bool_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ (node$bs (seledas$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun$ )(seledat$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ )(seledau$ A_bool_a_bool_fun_fun_fun_a_bool_fun_a_a_bool_fun_fun_fun_fun_tree$ )))(A_bool_fun_a_fun_tree$ (node$bt (seledav$ A_bool_fun_a_fun$ )(seledaw$ A_bool_fun_a_fun_tree$ )(seledax$ A_bool_fun_a_fun_tree$ )))))
