...
(declare-codatatypes ()((A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(A_a_fun_tree$ (node$a (select$ A_a_fun$ )(selecta$ A_a_fun_tree$ )(selectb$ A_a_fun_tree$ )))(A_tree_tree$ (node$b (root$a A_tree$ )(left$a A_tree_tree$ )(right$a A_tree_tree$ )))(A_a_a_fun_fun_tree$ (node$c (selectc$ A_a_a_fun_fun$ )(selectd$ A_a_a_fun_fun_tree$ )(selecte$ A_a_a_fun_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$d (selectf$ A_a_fun_a_fun$ )(selectg$ A_a_fun_a_fun_tree$ )(selecth$ A_a_fun_a_fun_tree$ )))(A_a_fun_a_a_fun_fun_tree$ (node$e (selecti$ A_a_fun_a_a_fun_fun$ )(selectj$ A_a_fun_a_a_fun_fun_tree$ )(selectk$ A_a_fun_a_a_fun_fun_tree$ )))(A_tree_a_tree_fun_tree$ (node$f (selectl$ A_tree_a_tree_fun$ )(selectm$ A_tree_a_tree_fun_tree$ )(selectn$ A_tree_a_tree_fun_tree$ )))(A_a_fun_tree_tree$ (node$g (root$b A_a_fun_tree$ )(left$b A_a_fun_tree_tree$ )(right$b A_a_fun_tree_tree$ )))(A_tree_tree_tree$ (node$h (root$c A_tree_tree$ )(left$c A_tree_tree_tree$ )(right$c A_tree_tree_tree$ )))))
