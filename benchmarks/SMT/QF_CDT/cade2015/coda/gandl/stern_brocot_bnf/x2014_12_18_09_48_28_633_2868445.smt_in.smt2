...
(declare-codatatypes ()((Nat_tree$ (node$ (root$ Nat$ )(left$ Nat_tree$ )(right$ Nat_tree$ )))(Nat_nat_fun_nat_nat_fun_fun_tree$ (node$a (select$ Nat_nat_fun_nat_nat_fun_fun$ )(selecta$ Nat_nat_fun_nat_nat_fun_fun_tree$ )(selectb$ Nat_nat_fun_nat_nat_fun_fun_tree$ )))(Nat_nat_nat_fun_fun_tree$ (node$b (selectc$ Nat_nat_nat_fun_fun$ )(selectd$ Nat_nat_nat_fun_fun_tree$ )(selecte$ Nat_nat_nat_fun_fun_tree$ )))(Nat_nat_fun_nat_fun_tree$ (node$c (selectf$ Nat_nat_fun_nat_fun$ )(selectg$ Nat_nat_fun_nat_fun_tree$ )(selecth$ Nat_nat_fun_nat_fun_tree$ )))(Nat_nat_fun_tree$ (node$d (selecti$ Nat_nat_fun$ )(selectj$ Nat_nat_fun_tree$ )(selectk$ Nat_nat_fun_tree$ )))(Nat_nat_nat_fun_fun_nat_fun_tree$ (node$e (selectl$ Nat_nat_nat_fun_fun_nat_fun$ )(selectm$ Nat_nat_nat_fun_fun_nat_fun_tree$ )(selectn$ Nat_nat_nat_fun_fun_nat_fun_tree$ )))(Nat_nat_fun_nat_fun_nat_fun_tree$ (node$f (selecto$ Nat_nat_fun_nat_fun_nat_fun$ )(selectp$ Nat_nat_fun_nat_fun_nat_fun_tree$ )(selectq$ Nat_nat_fun_nat_fun_nat_fun_tree$ )))(Nat_nat_nat_nat_fun_fun_fun_tree$ (node$g (selectr$ Nat_nat_nat_nat_fun_fun_fun$ )(selects$ Nat_nat_nat_nat_fun_fun_fun_tree$ )(selectt$ Nat_nat_nat_nat_fun_fun_fun_tree$ )))(Nat_nat_nat_fun_nat_fun_fun_tree$ (node$h (selectu$ Nat_nat_nat_fun_nat_fun_fun$ )(selectv$ Nat_nat_nat_fun_nat_fun_fun_tree$ )(selectw$ Nat_nat_nat_fun_nat_fun_fun_tree$ )))(Nat_nat_fun_nat_nat_fun_fun_nat_fun_tree$ (node$i (selectx$ Nat_nat_fun_nat_nat_fun_fun_nat_fun$ )(selecty$ Nat_nat_fun_nat_nat_fun_fun_nat_fun_tree$ )(selectz$ Nat_nat_fun_nat_nat_fun_fun_nat_fun_tree$ )))(Nat_nat_nat_fun_fun_nat_nat_fun_fun_tree$ (node$j (selecua$ Nat_nat_nat_fun_fun_nat_nat_fun_fun$ )(selecub$ Nat_nat_nat_fun_fun_nat_nat_fun_fun_tree$ )(selecuc$ Nat_nat_nat_fun_fun_nat_nat_fun_fun_tree$ )))(Nat_nat_fun_nat_nat_fun_fun_stream$ (sCons$ (selecud$ Nat_nat_fun_nat_nat_fun_fun$ )(selecue$ Nat_nat_fun_nat_nat_fun_fun_stream$ )))(Nat_nat_nat_fun_fun_stream$ (sCons$a (selecuf$ Nat_nat_nat_fun_fun$ )(selecug$ Nat_nat_nat_fun_fun_stream$ )))(Nat_nat_fun_nat_fun_stream$ (sCons$b (selecuh$ Nat_nat_fun_nat_fun$ )(selecui$ Nat_nat_fun_nat_fun_stream$ )))(Nat_nat_fun_stream$ (sCons$c (selecuj$ Nat_nat_fun$ )(selecuk$ Nat_nat_fun_stream$ )))(Nat_stream$ (sCons$d (shd$ Nat$ )(stl$ Nat_stream$ )))))
