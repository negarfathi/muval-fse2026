...
(declare-codatatypes ()((A_a_fun_tree$ (node$ (select$ A_a_fun$ )(selecta$ A_a_fun_tree$ )(selectb$ A_a_fun_tree$ )))(A_a_fun_a_a_fun_fun_tree$ (node$a (selectc$ A_a_fun_a_a_fun_fun$ )(selectd$ A_a_fun_a_a_fun_fun_tree$ )(selecte$ A_a_fun_a_a_fun_fun_tree$ )))(A_tree$ (node$b (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(A_a_fun_a_fun_tree$ (node$c (selectf$ A_a_fun_a_fun$ )(selectg$ A_a_fun_a_fun_tree$ )(selecth$ A_a_fun_a_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$d (selecti$ A_a_a_fun_fun$ )(selectj$ A_a_a_fun_fun_tree$ )(selectk$ A_a_a_fun_fun_tree$ )))(A_a_a_fun_a_a_fun_fun_fun_tree$ (node$e (selectl$ A_a_a_fun_a_a_fun_fun_fun$ )(selectm$ A_a_a_fun_a_a_fun_fun_fun_tree$ )(selectn$ A_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_a_fun_tree$ (node$f (selecto$ A_a_fun_a_a_fun_fun_a_fun$ )(selectp$ A_a_fun_a_a_fun_fun_a_fun_tree$ )(selectq$ A_a_fun_a_a_fun_fun_a_fun_tree$ )))(A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$g (selectr$ A_a_fun_a_a_fun_a_a_fun_fun_fun$ )(selects$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(selectt$ A_a_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$ (node$h (selectu$ A_a_fun_a_a_fun_fun_a_a_fun_fun$ )(selectv$ A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$ )(selectw$ A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$i (selectx$ A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun$ )(selecty$ A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(selectz$ A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_a_fun_a_fun_fun_tree$ (node$j (selecua$ A_a_a_fun_a_fun_fun$ )(selecub$ A_a_a_fun_a_fun_fun_tree$ )(selecuc$ A_a_a_fun_a_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_fun_fun_tree$ (node$k (selecud$ A_a_a_fun_fun_a_a_fun_fun$ )(selecue$ A_a_a_fun_fun_a_a_fun_fun_tree$ )(selecuf$ A_a_a_fun_fun_a_a_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ (node$l (selecug$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun$ )(selecuh$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ )(selecui$ A_a_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$m (selecuj$ A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun$ )(selecuk$ A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ )(selecul$ A_a_fun_a_a_fun_fun_a_a_fun_a_a_fun_a_a_fun_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ (node$n (selecum$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun$ )(selecun$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ )(selecuo$ A_a_fun_a_a_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$ )))(A_a_fun_a_a_a_fun_fun_fun_tree$ (node$o (selecup$ A_a_fun_a_a_a_fun_fun_fun$ )(selecuq$ A_a_fun_a_a_a_fun_fun_fun_tree$ )(selecur$ A_a_fun_a_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$p (selecus$ A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun$ )(selecut$ A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(selecuu$ A_a_fun_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_fun_a_fun_tree$ (node$q (selecuv$ A_a_fun_a_fun_a_fun$ )(selecuw$ A_a_fun_a_fun_a_fun_tree$ )(selecux$ A_a_fun_a_fun_a_fun_tree$ )))(A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ (node$r (selecuy$ A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun$ )(selecuz$ A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )(selecva$ A_a_a_fun_a_a_fun_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$ )))(A_a_fun_a_a_fun_fun_a_fun_a_fun_tree$ (node$s (selecvb$ A_a_fun_a_a_fun_fun_a_fun_a_fun$ )(selecvc$ A_a_fun_a_a_fun_fun_a_fun_a_fun_tree$ )(selecvd$ A_a_fun_a_a_fun_fun_a_fun_a_fun_tree$ )))(A_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_tree$ (node$t (selecve$ A_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun$ )(selecvf$ A_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_tree$ )(selecvg$ A_a_a_fun_fun_a_a_fun_fun_a_a_fun_fun_tree$ )))))
