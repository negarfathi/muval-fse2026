...
(declare-codatatypes ()((A_tree$ (node$ (root$ A$ )(left$ A_tree$ )(right$ A_tree$ )))(B_a_fun_tree$ (node$a (select$ B_a_fun$ )(selecta$ B_a_fun_tree$ )(selectb$ B_a_fun_tree$ )))(B_tree$ (node$b (root$a B$ )(left$a B_tree$ )(right$a B_tree$ )))(B_b_a_fun_fun_tree$ (node$c (selectc$ B_b_a_fun_fun$ )(selectd$ B_b_a_fun_fun_tree$ )(selecte$ B_b_a_fun_fun_tree$ )))(B_b_a_fun_fun_b_a_fun_fun_tree$ (node$d (selectf$ B_b_a_fun_fun_b_a_fun_fun$ )(selectg$ B_b_a_fun_fun_b_a_fun_fun_tree$ )(selecth$ B_b_a_fun_fun_b_a_fun_fun_tree$ )))(B_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$e (selecti$ B_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun$ )(selectj$ B_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )(selectk$ B_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )))(B_b_fun_tree$ (node$f (selectl$ B_b_fun$ )(selectm$ B_b_fun_tree$ )(selectn$ B_b_fun_tree$ )))(A_b_fun_tree$ (node$g (selecto$ A_b_fun$ )(selectp$ A_b_fun_tree$ )(selectq$ A_b_fun_tree$ )))(A_a_fun_tree$ (node$h (selectr$ A_a_fun$ )(selects$ A_a_fun_tree$ )(selectt$ A_a_fun_tree$ )))(B_a_fun_b_fun_tree$ (node$i (selectu$ B_a_fun_b_fun$ )(selectv$ B_a_fun_b_fun_tree$ )(selectw$ B_a_fun_b_fun_tree$ )))(B_a_fun_a_fun_tree$ (node$j (selectx$ B_a_fun_a_fun$ )(selecty$ B_a_fun_a_fun_tree$ )(selectz$ B_a_fun_a_fun_tree$ )))(B_a_a_fun_fun_tree$ (node$k (selecua$ B_a_a_fun_fun$ )(selecub$ B_a_a_fun_fun_tree$ )(selecuc$ B_a_a_fun_fun_tree$ )))(B_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_tree$ (node$l (selecud$ B_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun$ )(selecue$ B_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_tree$ )(selecuf$ B_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_tree$ )))(B_b_fun_b_fun_tree$ (node$m (selecug$ B_b_fun_b_fun$ )(selecuh$ B_b_fun_b_fun_tree$ )(selecui$ B_b_fun_b_fun_tree$ )))(A_a_fun_a_fun_tree$ (node$n (selecuj$ A_a_fun_a_fun$ )(selecuk$ A_a_fun_a_fun_tree$ )(selecul$ A_a_fun_a_fun_tree$ )))(B_a_a_fun_fun_a_a_fun_fun_tree$ (node$o (selecum$ B_a_a_fun_fun_a_a_fun_fun$ )(selecun$ B_a_a_fun_fun_a_a_fun_fun_tree$ )(selecuo$ B_a_a_fun_fun_a_a_fun_fun_tree$ )))(A_b_a_fun_fun_tree$ (node$p (selecup$ A_b_a_fun_fun$ )(selecuq$ A_b_a_fun_fun_tree$ )(selecur$ A_b_a_fun_fun_tree$ )))(A_b_a_fun_fun_b_a_fun_fun_tree$ (node$q (selecus$ A_b_a_fun_fun_b_a_fun_fun$ )(selecut$ A_b_a_fun_fun_b_a_fun_fun_tree$ )(selecuu$ A_b_a_fun_fun_b_a_fun_fun_tree$ )))(B_a_b_a_fun_fun_fun_tree$ (node$r (selecuv$ B_a_b_a_fun_fun_fun$ )(selecuw$ B_a_b_a_fun_fun_fun_tree$ )(selecux$ B_a_b_a_fun_fun_fun_tree$ )))(B_a_b_a_fun_fun_fun_a_b_a_fun_fun_fun_tree$ (node$s (selecuy$ B_a_b_a_fun_fun_fun_a_b_a_fun_fun_fun$ )(selecuz$ B_a_b_a_fun_fun_fun_a_b_a_fun_fun_fun_tree$ )(selecva$ B_a_b_a_fun_fun_fun_a_b_a_fun_fun_fun_tree$ )))(A_b_fun_b_fun_tree$ (node$t (selecvb$ A_b_fun_b_fun$ )(selecvc$ A_b_fun_b_fun_tree$ )(selecvd$ A_b_fun_b_fun_tree$ )))(A_a_a_fun_fun_tree$ (node$u (selecve$ A_a_a_fun_fun$ )(selecvf$ A_a_a_fun_fun_tree$ )(selecvg$ A_a_a_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_fun_fun_tree$ (node$v (selecvh$ A_a_a_fun_fun_a_a_fun_fun$ )(selecvi$ A_a_a_fun_fun_a_a_fun_fun_tree$ )(selecvj$ A_a_a_fun_fun_a_a_fun_fun_tree$ )))(B_b_a_fun_a_fun_fun_tree$ (node$w (selecvk$ B_b_a_fun_a_fun_fun$ )(selecvl$ B_b_a_fun_a_fun_fun_tree$ )(selecvm$ B_b_a_fun_a_fun_fun_tree$ )))(B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$x (selecvn$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun$ )(selecvo$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )(selecvp$ B_b_a_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )))(B_b_a_fun_fun_a_fun_tree$ (node$y (selecvq$ B_b_a_fun_fun_a_fun$ )(selecvr$ B_b_a_fun_fun_a_fun_tree$ )(selecvs$ B_b_a_fun_fun_a_fun_tree$ )))(B_b_a_fun_fun_b_fun_b_b_a_fun_fun_a_fun_fun_tree$ (node$z (selecvt$ B_b_a_fun_fun_b_fun_b_b_a_fun_fun_a_fun_fun$ )(selecvu$ B_b_a_fun_fun_b_fun_b_b_a_fun_fun_a_fun_fun_tree$ )(selecvv$ B_b_a_fun_fun_b_fun_b_b_a_fun_fun_a_fun_fun_tree$ )))(B_b_a_fun_fun_b_fun_tree$ (node$aa (selecvw$ B_b_a_fun_fun_b_fun$ )(selecvx$ B_b_a_fun_fun_b_fun_tree$ )(selecvy$ B_b_a_fun_fun_b_fun_tree$ )))(B_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_fun_b_b_a_fun_fun_a_fun_fun_fun_tree$ (node$ab (selecvz$ B_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_fun_b_b_a_fun_fun_a_fun_fun_fun$ )(selecwa$ B_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_fun_b_b_a_fun_fun_a_fun_fun_fun_tree$ )(selecwb$ B_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_fun_b_b_a_fun_fun_a_fun_fun_fun_tree$ )))(B_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ (node$ac (selecwc$ B_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun$ )(selecwd$ B_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ )(selecwe$ B_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ )))(B_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$ad (selecwf$ B_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun$ )(selecwg$ B_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ )(selecwh$ B_b_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ )))(B_a_fun_b_a_fun_fun_tree$ (node$ae (selecwi$ B_a_fun_b_a_fun_fun$ )(selecwj$ B_a_fun_b_a_fun_fun_tree$ )(selecwk$ B_a_fun_b_a_fun_fun_tree$ )))(B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ (node$af (selecwl$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun$ )(selecwm$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ )(selecwn$ B_a_a_fun_fun_b_a_fun_b_a_fun_fun_fun_tree$ )))(B_b_fun_b_a_fun_fun_tree$ (node$ag (selecwo$ B_b_fun_b_a_fun_fun$ )(selecwp$ B_b_fun_b_a_fun_fun_tree$ )(selecwq$ B_b_fun_b_a_fun_fun_tree$ )))(B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ (node$ah (selecwr$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun$ )(selecws$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ )(selecwt$ B_b_a_fun_fun_b_b_fun_b_a_fun_fun_fun_tree$ )))(B_b_fun_b_b_a_fun_fun_fun_tree$ (node$ai (selecwu$ B_b_fun_b_b_a_fun_fun_fun$ )(selecwv$ B_b_fun_b_b_a_fun_fun_fun_tree$ )(selecww$ B_b_fun_b_b_a_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$ (node$aj (selecwx$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun$ )(selecwy$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$ )(selecwz$ B_b_b_a_fun_fun_fun_b_b_fun_b_b_a_fun_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_fun_tree$ (node$ak (selecxa$ B_b_b_a_fun_fun_fun$ )(selecxb$ B_b_b_a_fun_fun_fun_tree$ )(selecxc$ B_b_b_a_fun_fun_fun_tree$ )))(B_a_fun_b_b_a_fun_fun_fun_tree$ (node$al (selecxd$ B_a_fun_b_b_a_fun_fun_fun$ )(selecxe$ B_a_fun_b_b_a_fun_fun_fun_tree$ )(selecxf$ B_a_fun_b_b_a_fun_fun_fun_tree$ )))(B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ (node$am (selecxg$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun$ )(selecxh$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ )(selecxi$ B_a_b_a_fun_fun_fun_b_a_fun_b_b_a_fun_fun_fun_fun_tree$ )))(B_a_fun_b_b_a_fun_a_fun_fun_fun_tree$ (node$an (selecxj$ B_a_fun_b_b_a_fun_a_fun_fun_fun$ )(selecxk$ B_a_fun_b_b_a_fun_a_fun_fun_fun_tree$ )(selecxl$ B_a_fun_b_b_a_fun_a_fun_fun_fun_tree$ )))(B_a_b_a_fun_a_fun_fun_fun_b_a_fun_b_b_a_fun_a_fun_fun_fun_fun_tree$ (node$ao (selecxm$ B_a_b_a_fun_a_fun_fun_fun_b_a_fun_b_b_a_fun_a_fun_fun_fun_fun$ )(selecxn$ B_a_b_a_fun_a_fun_fun_fun_b_a_fun_b_b_a_fun_a_fun_fun_fun_fun_tree$ )(selecxo$ B_a_b_a_fun_a_fun_fun_fun_b_a_fun_b_b_a_fun_a_fun_fun_fun_fun_tree$ )))(B_a_b_a_fun_a_fun_fun_fun_tree$ (node$ap (selecxp$ B_a_b_a_fun_a_fun_fun_fun$ )(selecxq$ B_a_b_a_fun_a_fun_fun_fun_tree$ )(selecxr$ B_a_b_a_fun_a_fun_fun_fun_tree$ )))(B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ (node$aq (selecxs$ B_b_a_fun_fun_b_b_a_fun_fun_fun$ )(selecxt$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ )(selecxu$ B_b_a_fun_fun_b_b_a_fun_fun_fun_tree$ )))(B_b_a_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_fun_fun_tree$ (node$ar (selecxv$ B_b_a_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_fun_fun$ )(selecxw$ B_b_a_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_fun_fun_tree$ )(selecxx$ B_b_a_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_fun_fun_tree$ )))(B_b_a_fun_b_a_fun_fun_fun_tree$ (node$as (selecxy$ B_b_a_fun_b_a_fun_fun_fun$ )(selecxz$ B_b_a_fun_b_a_fun_fun_fun_tree$ )(selecya$ B_b_a_fun_b_a_fun_fun_fun_tree$ )))(B_b_a_fun_a_fun_fun_b_a_fun_fun_tree$ (node$at (selecyb$ B_b_a_fun_a_fun_fun_b_a_fun_fun$ )(selecyc$ B_b_a_fun_a_fun_fun_b_a_fun_fun_tree$ )(selecyd$ B_b_a_fun_a_fun_fun_b_a_fun_fun_tree$ )))(B_b_a_fun_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_b_a_fun_fun_fun_tree$ (node$au (selecye$ B_b_a_fun_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_b_a_fun_fun_fun$ )(selecyf$ B_b_a_fun_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_b_a_fun_fun_fun_tree$ )(selecyg$ B_b_a_fun_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_b_a_fun_fun_fun_tree$ )))(B_b_a_fun_a_fun_a_fun_fun_tree$ (node$av (selecyh$ B_b_a_fun_a_fun_a_fun_fun$ )(selecyi$ B_b_a_fun_a_fun_a_fun_fun_tree$ )(selecyj$ B_b_a_fun_a_fun_a_fun_fun_tree$ )))(B_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$aw (selecyk$ B_b_b_a_fun_fun_b_a_fun_fun_fun$ )(selecyl$ B_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )(selecym$ B_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_fun_b_b_a_fun_fun_fun_tree$ (node$ax (selecyn$ B_b_b_a_fun_fun_fun_b_b_a_fun_fun_fun$ )(selecyo$ B_b_b_a_fun_fun_fun_b_b_a_fun_fun_fun_tree$ )(selecyp$ B_b_b_a_fun_fun_fun_b_b_a_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_b_b_a_fun_fun_fun_fun_tree$ (node$ay (selecyq$ B_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_b_b_a_fun_fun_fun_fun$ )(selecyr$ B_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_b_b_a_fun_fun_fun_fun_tree$ )(selecys$ B_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_b_b_a_fun_fun_fun_fun_tree$ )))(B_b_a_fun_fun_b_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$az (selecyt$ B_b_a_fun_fun_b_fun_b_b_a_fun_fun_b_a_fun_fun_fun$ )(selecyu$ B_b_a_fun_fun_b_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )(selecyv$ B_b_a_fun_fun_b_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )))(B_b_a_fun_fun_b_b_a_fun_fun_fun_b_b_a_fun_fun_b_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ (node$ba (selecyw$ B_b_a_fun_fun_b_b_a_fun_fun_fun_b_b_a_fun_fun_b_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun$ )(selecyx$ B_b_a_fun_fun_b_b_a_fun_fun_fun_b_b_a_fun_fun_b_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ )(selecyy$ B_b_a_fun_fun_b_b_a_fun_fun_fun_b_b_a_fun_fun_b_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ )))(B_a_fun_a_fun_b_b_a_fun_a_fun_fun_fun_tree$ (node$bb (selecyz$ B_a_fun_a_fun_b_b_a_fun_a_fun_fun_fun$ )(selecza$ B_a_fun_a_fun_b_b_a_fun_a_fun_fun_fun_tree$ )(seleczb$ B_a_fun_a_fun_b_b_a_fun_a_fun_fun_fun_tree$ )))(B_a_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$bc (seleczc$ B_a_fun_b_b_a_fun_fun_b_a_fun_fun_fun$ )(seleczd$ B_a_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )(selecze$ B_a_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ (node$bd (seleczf$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun$ )(seleczg$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ )(seleczh$ B_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_a_fun_fun_tree$ (node$be (seleczi$ B_b_b_a_fun_fun_a_fun_fun$ )(seleczj$ B_b_b_a_fun_fun_a_fun_fun_tree$ )(seleczk$ B_b_b_a_fun_fun_a_fun_fun_tree$ )))(B_b_a_fun_fun_b_a_fun_fun_b_b_b_a_fun_fun_a_fun_fun_fun_tree$ (node$bf (seleczl$ B_b_a_fun_fun_b_a_fun_fun_b_b_b_a_fun_fun_a_fun_fun_fun$ )(seleczm$ B_b_a_fun_fun_b_a_fun_fun_b_b_b_a_fun_fun_a_fun_fun_fun_tree$ )(seleczn$ B_b_a_fun_fun_b_a_fun_fun_b_b_b_a_fun_fun_a_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$bg (seleczo$ B_b_b_a_fun_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun$ )(seleczp$ B_b_b_a_fun_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )(seleczq$ B_b_b_a_fun_fun_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )))(B_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_fun_fun_tree$ (node$bh (seleczr$ B_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_fun_fun$ )(seleczs$ B_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_fun_fun_tree$ )(seleczt$ B_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_fun_fun_tree$ )))(B_b_a_fun_fun_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ (node$bi (seleczu$ B_b_a_fun_fun_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_b_a_fun_fun_fun_fun$ )(seleczv$ B_b_a_fun_fun_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ )(seleczw$ B_b_a_fun_fun_b_b_a_fun_fun_fun_b_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ )))(B_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ (node$bj (seleczx$ B_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun$ )(seleczy$ B_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )(seleczz$ B_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_tree$ )))(B_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ (node$bk (seledaa$ B_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun$ )(seledab$ B_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ )(seledac$ B_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_b_b_a_fun_fun_b_b_a_fun_fun_b_a_fun_fun_fun_fun_tree$ )))(B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ (node$bl (seledad$ B_a_a_fun_fun_a_b_a_fun_fun_fun$ )(seledae$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ )(seledaf$ B_a_a_fun_fun_a_b_a_fun_fun_fun_tree$ )))(B_b_b_fun_fun_tree$ (node$bm (seledag$ B_b_b_fun_fun$ )(seledah$ B_b_b_fun_fun_tree$ )(seledai$ B_b_b_fun_fun_tree$ )))(B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ (node$bn (seledaj$ B_b_b_fun_fun_b_b_b_fun_fun_fun$ )(seledak$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ )(seledal$ B_b_b_fun_fun_b_b_b_fun_fun_fun_tree$ )))(A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ (node$bo (seledam$ A_a_a_fun_fun_a_a_a_fun_fun_fun$ )(seledan$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )(seledao$ A_a_a_fun_fun_a_a_a_fun_fun_fun_tree$ )))(A_b_a_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ (node$bp (seledap$ A_b_a_fun_fun_b_a_b_a_fun_fun_fun_fun$ )(seledaq$ A_b_a_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ )(seledar$ A_b_a_fun_fun_b_a_b_a_fun_fun_fun_fun_tree$ )))(A_a_fun_b_a_a_fun_fun_fun_tree$ (node$bq (seledas$ A_a_fun_b_a_a_fun_fun_fun$ )(seledat$ A_a_fun_b_a_a_fun_fun_fun_tree$ )(seledau$ A_a_fun_b_a_a_fun_fun_fun_tree$ )))(B_a_fun_a_b_a_fun_fun_fun_tree$ (node$br (seledav$ B_a_fun_a_b_a_fun_fun_fun$ )(seledaw$ B_a_fun_a_b_a_fun_fun_fun_tree$ )(seledax$ B_a_fun_a_b_a_fun_fun_fun_tree$ )))))
