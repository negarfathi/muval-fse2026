...
(declare-codatatypes ()((B_tree$ (node$ (root$ B$ )(left$ B_tree$ )(right$ B_tree$ )))(A_b_fun_tree$ (node$a (select$ A_b_fun$ )(selecta$ A_b_fun_tree$ )(selectb$ A_b_fun_tree$ )))(A_tree$ (node$b (root$a A$ )(left$a A_tree$ )(right$a A_tree$ )))(A_bool_fun_tree$ (node$c (selectc$ A_bool_fun$ )(selectd$ A_bool_fun_tree$ )(selecte$ A_bool_fun_tree$ )))(A_b_fun_a_bool_fun_fun_tree$ (node$d (selectf$ A_b_fun_a_bool_fun_fun$ )(selectg$ A_b_fun_a_bool_fun_fun_tree$ )(selecth$ A_b_fun_a_bool_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$e (selecti$ A_b_fun_a_b_fun_a_bool_fun_fun_fun$ )(selectj$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )(selectk$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )))(Bool_bool_fun_tree$ (node$f (selectl$ Bool_bool_fun$ )(selectm$ Bool_bool_fun_tree$ )(selectn$ Bool_bool_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun_tree$ (node$g (selecto$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun$ )(selectp$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun_tree$ )(selectq$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_bool_fun_tree$ )))(Bool_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$h (selectr$ Bool_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(selects$ Bool_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(selectt$ Bool_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ (node$i (selectu$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun$ )(selectv$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )(selectw$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_b_fun_a_bool_fun_fun_fun_fun_tree$ )))(Bool_b_fun_tree$ (node$j (selectx$ Bool_b_fun$ )(selecty$ Bool_b_fun_tree$ )(selectz$ Bool_b_fun_tree$ )))(Bool_a_fun_tree$ (node$k (selecua$ Bool_a_fun$ )(selecub$ Bool_a_fun_tree$ )(selecuc$ Bool_a_fun_tree$ )))(A_b_fun_b_fun_tree$ (node$l (selecud$ A_b_fun_b_fun$ )(selecue$ A_b_fun_b_fun_tree$ )(selecuf$ A_b_fun_b_fun_tree$ )))(A_b_fun_a_bool_fun_fun_a_bool_fun_fun_tree$ (node$m (selecug$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun$ )(selecuh$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun_tree$ )(selecui$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun_tree$ )))(A_b_fun_a_bool_fun_fun_a_bool_fun_fun_a_bool_fun_fun_tree$ (node$n (selecuj$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun_a_bool_fun_fun$ )(selecuk$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun_a_bool_fun_fun_tree$ )(selecul$ A_b_fun_a_bool_fun_fun_a_bool_fun_fun_a_bool_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$o (selecum$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun$ )(selecun$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )(selecuo$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )))(A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ (node$p (selecup$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun$ )(selecuq$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )(selecur$ A_b_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_a_b_fun_a_bool_fun_fun_fun_tree$ )))(A_bool_fun_bool_fun_tree$ (node$q (selecus$ A_bool_fun_bool_fun$ )(selecut$ A_bool_fun_bool_fun_tree$ )(selecuu$ A_bool_fun_bool_fun_tree$ )))(A_bool_fun_bool_fun_bool_fun_tree$ (node$r (selecuv$ A_bool_fun_bool_fun_bool_fun$ )(selecuw$ A_bool_fun_bool_fun_bool_fun_tree$ )(selecux$ A_bool_fun_bool_fun_bool_fun_tree$ )))(A_b_fun_b_fun_b_fun_tree$ (node$s (selecuy$ A_b_fun_b_fun_b_fun$ )(selecuz$ A_b_fun_b_fun_b_fun_tree$ )(selecva$ A_b_fun_b_fun_b_fun_tree$ )))(B_b_fun_tree$ (node$t (selecvb$ B_b_fun$ )(selecvc$ B_b_fun_tree$ )(selecvd$ B_b_fun_tree$ )))(B_b_fun_b_fun_tree$ (node$u (selecve$ B_b_fun_b_fun$ )(selecvf$ B_b_fun_b_fun_tree$ )(selecvg$ B_b_fun_b_fun_tree$ )))(B_a_fun_tree$ (node$v (selecvh$ B_a_fun$ )(selecvi$ B_a_fun_tree$ )(selecvj$ B_a_fun_tree$ )))(A_a_fun_tree$ (node$w (selecvk$ A_a_fun$ )(selecvl$ A_a_fun_tree$ )(selecvm$ A_a_fun_tree$ )))(A_bool_fun_b_fun_tree$ (node$x (selecvn$ A_bool_fun_b_fun$ )(selecvo$ A_bool_fun_b_fun_tree$ )(selecvp$ A_bool_fun_b_fun_tree$ )))))
