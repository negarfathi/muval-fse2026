...
(declare-codatatypes ()((A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(A_a_fun_a_a_fun_fun_stream$ (sCons$a (select$ A_a_fun_a_a_fun_fun$ )(selecta$ A_a_fun_a_a_fun_fun_stream$ )))(A_a_fun_a_fun_stream$ (sCons$b (selectb$ A_a_fun_a_fun$ )(selectc$ A_a_fun_a_fun_stream$ )))(A_a_a_fun_fun_stream$ (sCons$c (selectd$ A_a_a_fun_fun$ )(selecte$ A_a_a_fun_fun_stream$ )))(A_stream_stream$ (sCons$d (shd$a A_stream$ )(stl$a A_stream_stream$ )))(A_a_fun_stream$ (sCons$e (selectf$ A_a_fun$ )(selectg$ A_a_fun_stream$ )))(A_a_stream_fun_stream$ (sCons$f (selecth$ A_a_stream_fun$ )(selecti$ A_a_stream_fun_stream$ )))(A_stream_a_fun_stream$ (sCons$g (selectj$ A_stream_a_fun$ )(selectk$ A_stream_a_fun_stream$ )))(A_stream_a_stream_fun_stream$ (sCons$h (selectl$ A_stream_a_stream_fun$ )(selectm$ A_stream_a_stream_fun_stream$ )))(A_a_fun_a_stream_fun_stream$ (sCons$i (selectn$ A_a_fun_a_stream_fun$ )(selecto$ A_a_fun_a_stream_fun_stream$ )))(A_stream_a_a_fun_fun_stream$ (sCons$j (selectp$ A_stream_a_a_fun_fun$ )(selectq$ A_stream_a_a_fun_fun_stream$ )))(A_a_a_fun_a_fun_fun_stream$ (sCons$k (selectr$ A_a_a_fun_a_fun_fun$ )(selects$ A_a_a_fun_a_fun_fun_stream$ )))(A_a_fun_stream_stream$ (sCons$l (shd$b A_a_fun_stream$ )(stl$b A_a_fun_stream_stream$ )))(A_stream_stream_stream$ (sCons$m (shd$c A_stream_stream$ )(stl$c A_stream_stream_stream$ )))(A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$ (sCons$n (selectt$ A_a_fun_a_a_fun_a_a_fun_fun_fun$ )(selectu$ A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$ )))(A_a_fun_a_a_fun_a_fun_fun_stream$ (sCons$o (selectv$ A_a_fun_a_a_fun_a_fun_fun$ )(selectw$ A_a_fun_a_a_fun_a_fun_fun_stream$ )))(A_a_a_a_fun_fun_fun_stream$ (sCons$p (selectx$ A_a_a_a_fun_fun_fun$ )(selecty$ A_a_a_a_fun_fun_fun_stream$ )))(A_a_a_fun_a_a_fun_fun_fun_stream$ (sCons$q (selectz$ A_a_a_fun_a_a_fun_fun_fun$ )(selecua$ A_a_a_fun_a_a_fun_fun_fun_stream$ )))(A_a_fun_a_a_a_fun_fun_fun_stream$ (sCons$r (selecub$ A_a_fun_a_a_a_fun_fun_fun$ )(selecuc$ A_a_fun_a_a_a_fun_fun_fun_stream$ )))))
