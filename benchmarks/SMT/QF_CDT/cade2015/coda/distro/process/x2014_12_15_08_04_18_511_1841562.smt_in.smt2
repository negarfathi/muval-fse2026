...
(declare-codatatypes ()((A_b_process_term_process$ (action$a (prefOf$a A_b_process_term$ )(contOf$a A_b_process_term_process$ ))(choice$a (ch1Of$a A_b_process_term_process$ )(ch2Of$a A_b_process_term_process$ )))(A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(A_process_process$ (action$b (prefOf$b A_process$ )(contOf$b A_process_process$ ))(choice$b (ch1Of$b A_process_process$ )(ch2Of$b A_process_process$ )))))
