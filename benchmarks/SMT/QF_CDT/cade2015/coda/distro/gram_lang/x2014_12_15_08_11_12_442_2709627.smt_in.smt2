...
(declare-fun projl$c (T_set_T_sum$)T_set$)
(declare-fun inl$c (T_set$ )T_set_T_sum$)
(declare-fun projr$c (T_set_T_sum$)T$)
(declare-fun inr$c (T$ )T_set_T_sum$)
(declare-fun projl$d (T_set_T_set_sum$)T_set$)
(declare-fun inl$d (T_set$ )T_set_T_set_sum$)
(declare-fun projr$d (T_set_T_set_sum$)T_set$)
(declare-fun inr$d (T_set$ )T_set_T_set_sum$)
(declare-fun projl$e (T_set_T_T_sum_sum$)T_set$)
(declare-fun inl$e (T_set$ )T_set_T_T_sum_sum$)
(declare-fun projr$e (T_set_T_T_sum_sum$)T_T_sum$)
(declare-fun inr$e (T_T_sum$ )T_set_T_T_sum_sum$)
(declare-fun projl$f (T_T_sum_T_sum$)T_T_sum$)
(declare-fun inl$f (T_T_sum$ )T_T_sum_T_sum$)
(declare-fun projr$f (T_T_sum_T_sum$)T$)
(declare-fun inr$f (T$ )T_T_sum_T_sum$)
(declare-fun projl$g (T_T_sum_T_set_sum$)T_T_sum$)
(declare-fun inl$g (T_T_sum$ )T_T_sum_T_set_sum$)
(declare-fun projr$g (T_T_sum_T_set_sum$)T_set$)
(declare-fun inr$g (T_set$ )T_T_sum_T_set_sum$)
(declare-fun projl$h (T_T_sum_T_T_sum_sum$)T_T_sum$)
(declare-fun inl$h (T_T_sum$ )T_T_sum_T_T_sum_sum$)
(declare-fun projr$h (T_T_sum_T_T_sum_sum$)T_T_sum$)
(declare-fun inr$h (T_T_sum$ )T_T_sum_T_T_sum_sum$)
