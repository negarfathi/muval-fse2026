...
(declare-codatatypes ()((A_list_list_stream$ (sCons$b (shd$b A_list_list$ )(stl$b A_list_list_stream$ )))(A_list_list_list_stream$ (sCons$c (shd$c A_list_list_list$ )(stl$c A_list_list_list_stream$ )))(A_list_stream_stream$ (sCons$d (shd$d A_list_stream$ )(stl$d A_list_stream_stream$ )))))
...
(declare-codatatypes ()((A_list_list_list_list_stream$ (sCons$e (shd$e A_list_list_list_list$ )(stl$e A_list_list_list_list_stream$ )))(A_list_stream_list_stream$ (sCons$f (shd$f A_list_stream_list$ )(stl$f A_list_stream_list_stream$ )))(A_list_list_stream_stream$ (sCons$g (shd$g A_list_list_stream$ )(stl$g A_list_list_stream_stream$ )))(A_stream_stream$ (sCons$h (shd$h A_stream$ )(stl$h A_stream_stream$ )))(A_list_stream_stream_stream$ (sCons$i (shd$i A_list_stream_stream$ )(stl$i A_list_stream_stream_stream$ )))))
