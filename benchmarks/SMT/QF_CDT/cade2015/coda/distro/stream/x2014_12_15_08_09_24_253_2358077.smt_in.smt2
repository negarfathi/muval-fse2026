...
(declare-codatatypes ()((B_c_prod_stream$ (sCons$a (shd$a B_c_prod$ )(stl$a B_c_prod_stream$ )))(B_stream$ (sCons$b (shd$b B$ )(stl$b B_stream$ )))(C_stream$ (sCons$c (shd$c C$ )(stl$c C_stream$ )))(B_stream_stream$ (sCons$d (shd$d B_stream$ )(stl$d B_stream_stream$ )))(A_stream_stream$ (sCons$e (shd$e A_stream$ )(stl$e A_stream_stream$ )))))
