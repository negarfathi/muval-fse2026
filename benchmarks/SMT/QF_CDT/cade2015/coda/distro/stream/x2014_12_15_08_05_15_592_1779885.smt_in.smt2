...
(declare-codatatypes ()((A_stream_stream$ (sCons$a (shd$a A_stream$ )(stl$a A_stream_stream$ )))(A_list_stream$ (sCons$b (shd$b A_list$ )(stl$b A_list_stream$ )))(A_list_stream_stream$ (sCons$c (shd$c A_list_stream$ )(stl$c A_list_stream_stream$ )))(A_stream_stream_stream$ (sCons$d (shd$d A_stream_stream$ )(stl$d A_stream_stream_stream$ )))))
...
(declare-codatatypes ()((A_stream_list_stream$ (sCons$f (shd$f A_stream_list$ )(stl$f A_stream_list_stream$ )))(A_list_list_stream_stream$ (sCons$g (shd$g A_list_list_stream$ )(stl$g A_list_list_stream_stream$ )))))
