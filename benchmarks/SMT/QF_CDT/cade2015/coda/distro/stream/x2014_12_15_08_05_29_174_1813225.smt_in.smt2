...
(declare-codatatypes ()((A_stream_list_stream$ (sCons$b (shd$b A_stream_list$ )(stl$b A_stream_list_stream$ )))(A_stream_stream_stream$ (sCons$c (shd$c A_stream_stream$ )(stl$c A_stream_stream_stream$ )))(A_stream_stream_stream_stream$ (sCons$d (shd$d A_stream_stream_stream$ )(stl$d A_stream_stream_stream_stream$ )))(A_list_stream$ (sCons$e (shd$e A_list$ )(stl$e A_list_stream$ )))(A_list_stream_stream$ (sCons$f (shd$f A_list_stream$ )(stl$f A_list_stream_stream$ )))))
