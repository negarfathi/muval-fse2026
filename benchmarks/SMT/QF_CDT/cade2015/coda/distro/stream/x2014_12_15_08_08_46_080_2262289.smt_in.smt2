...
(declare-codatatypes ()((A_list_stream$ (sCons$b (shd$b A_list$ )(stl$b A_list_stream$ )))(Nat_stream$ (sCons$c (shd$c Nat$ )(stl$c Nat_stream$ )))))
...
(declare-codatatypes ()((A_stream_stream_stream$ (sCons$d (shd$d A_stream_stream$ )(stl$d A_stream_stream_stream$ )))(A_stream_list_stream$ (sCons$e (shd$e A_stream_list$ )(stl$e A_stream_list_stream$ )))(Nat_stream_stream$ (sCons$f (shd$f Nat_stream$ )(stl$f Nat_stream_stream$ )))(Nat_list_stream$ (sCons$g (shd$g Nat_list$ )(stl$g Nat_list_stream$ )))(A_list_stream_stream$ (sCons$h (shd$h A_list_stream$ )(stl$h A_list_stream_stream$ )))(A_list_list_stream$ (sCons$i (shd$i A_list_list$ )(stl$i A_list_list_stream$ )))(A_stream_stream_stream_stream$ (sCons$j (shd$j A_stream_stream_stream$ )(stl$j A_stream_stream_stream_stream$ )))(A_stream_list_stream_stream$ (sCons$k (shd$k A_stream_list_stream$ )(stl$k A_stream_list_stream_stream$ )))))
(declare-sort A_stream_list_list$ 0)
(declare-fun nil$d ()A_stream_list_list$)
(declare-fun hd$d (A_stream_list_list$)A_stream_list$)
(declare-fun tl$d (A_stream_list_list$)A_stream_list_list$)
(declare-fun cons$d (A_stream_list$ A_stream_list_list$ )A_stream_list_list$)
(declare-codatatypes ()((A_stream_list_list_stream$ (sCons$l (shd$l A_stream_list_list$ )(stl$l A_stream_list_list_stream$ )))))
(declare-sort A_stream_list_stream_list$ 0)
(declare-fun nil$e ()A_stream_list_stream_list$)
(declare-fun hd$e (A_stream_list_stream_list$)A_stream_list_stream$)
(declare-fun tl$e (A_stream_list_stream_list$)A_stream_list_stream_list$)
(declare-fun cons$e (A_stream_list_stream$ A_stream_list_stream_list$ )A_stream_list_stream_list$)
(declare-codatatypes ()((A_stream_stream_stream_stream_stream$ (sCons$m (shd$m A_stream_stream_stream_stream$ )(stl$m A_stream_stream_stream_stream_stream$ )))))
(declare-sort A_stream_stream_stream_list$ 0)
(declare-fun nil$f ()A_stream_stream_stream_list$)
(declare-fun hd$f (A_stream_stream_stream_list$)A_stream_stream_stream$)
(declare-fun tl$f (A_stream_stream_stream_list$)A_stream_stream_stream_list$)
(declare-fun cons$f (A_stream_stream_stream$ A_stream_stream_stream_list$ )A_stream_stream_stream_list$)
(declare-codatatypes ()((A_stream_stream_stream_list_stream$ (sCons$n (shd$n A_stream_stream_stream_list$ )(stl$n A_stream_stream_stream_list_stream$ )))))
(declare-sort A_stream_stream_stream_stream_list$ 0)
(declare-fun nil$g ()A_stream_stream_stream_stream_list$)
(declare-fun hd$g (A_stream_stream_stream_stream_list$)A_stream_stream_stream_stream$)
(declare-fun tl$g (A_stream_stream_stream_stream_list$)A_stream_stream_stream_stream_list$)
(declare-fun cons$g (A_stream_stream_stream_stream$ A_stream_stream_stream_stream_list$ )A_stream_stream_stream_stream_list$)
(declare-codatatypes ()((Nat_stream_stream_stream$ (sCons$o (shd$o Nat_stream_stream$ )(stl$o Nat_stream_stream_stream$ )))))
(declare-sort Nat_stream_list$ 0)
(declare-fun nil$h ()Nat_stream_list$)
(declare-fun hd$h (Nat_stream_list$)Nat_stream$)
(declare-fun tl$h (Nat_stream_list$)Nat_stream_list$)
(declare-fun cons$h (Nat_stream$ Nat_stream_list$ )Nat_stream_list$)
(declare-codatatypes ()((Nat_stream_list_stream$ (sCons$p (shd$p Nat_stream_list$ )(stl$p Nat_stream_list_stream$ )))))
(declare-sort Nat_stream_stream_list$ 0)
(declare-fun nil$i ()Nat_stream_stream_list$)
(declare-fun hd$i (Nat_stream_stream_list$)Nat_stream_stream$)
(declare-fun tl$i (Nat_stream_stream_list$)Nat_stream_stream_list$)
(declare-fun cons$i (Nat_stream_stream$ Nat_stream_stream_list$ )Nat_stream_stream_list$)
(declare-codatatypes ()((A_list_stream_stream_stream$ (sCons$q (shd$q A_list_stream_stream$ )(stl$q A_list_stream_stream_stream$ )))))
(declare-sort A_list_stream_list$ 0)
(declare-fun nil$j ()A_list_stream_list$)
(declare-fun hd$j (A_list_stream_list$)A_list_stream$)
(declare-fun tl$j (A_list_stream_list$)A_list_stream_list$)
(declare-fun cons$j (A_list_stream$ A_list_stream_list$ )A_list_stream_list$)
(declare-codatatypes ()((A_list_stream_list_stream$ (sCons$r (shd$r A_list_stream_list$ )(stl$r A_list_stream_list_stream$ )))))
(declare-sort A_list_stream_stream_list$ 0)
(declare-sort A_stream_stream_list$ 0)
(declare-fun nil$k ()A_list_stream_stream_list$)
(declare-fun hd$k (A_list_stream_stream_list$)A_list_stream_stream$)
(declare-fun tl$k (A_list_stream_stream_list$)A_list_stream_stream_list$)
(declare-fun cons$k (A_list_stream_stream$ A_list_stream_stream_list$ )A_list_stream_stream_list$)
(declare-fun nil$l ()A_stream_stream_list$)
(declare-fun hd$l (A_stream_stream_list$)A_stream_stream$)
(declare-fun tl$l (A_stream_stream_list$)A_stream_stream_list$)
(declare-fun cons$l (A_stream_stream$ A_stream_stream_list$ )A_stream_stream_list$)
(declare-codatatypes ()((A_stream_stream_list_stream$ (sCons$s (shd$s A_stream_stream_list$ )(stl$s A_stream_stream_list_stream$ )))))
(declare-fun m$ ()Nat$ )
(declare-fun n$ ()Nat$ )
