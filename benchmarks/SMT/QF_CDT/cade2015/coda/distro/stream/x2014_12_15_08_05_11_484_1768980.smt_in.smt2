...
(assert (! (=> (and (member$a (shd$ s$ )a$ )(member$ (stl$ s$ )(streams$ a$ )))p$ ):named a2 ))
...
(assert (! (forall ((?v0 A_stream_stream_stream_stream$ )(?v1 A_stream_stream_stream_set$ ))(=> (and (member$b (stl$c ?v0 )(streams$a ?v1 ))(member$c (shd$c ?v0 )?v1 ))(member$b ?v0 (streams$a ?v1 )))):named a6 ))
(assert (! (forall ((?v0 A_stream_stream_stream$ )(?v1 A_stream_stream_set$ ))(=> (and (member$c (stl$b ?v0 )(streams$b ?v1 ))(member$d (shd$b ?v0 )?v1 ))(member$c ?v0 (streams$b ?v1 )))):named a7 ))
(assert (! (forall ((?v0 A_stream_stream$ )(?v1 A_stream_set$ ))(=> (and (member$d (stl$a ?v0 )(streams$c ?v1 ))(member$ (shd$a ?v0 )?v1 ))(member$d ?v0 (streams$c ?v1 )))):named a8 ))
(assert (! (forall ((?v0 A_stream$ )(?v1 A_set$ ))(=> (and (member$ (stl$ ?v0 )(streams$ ?v1 ))(member$a (shd$ ?v0 )?v1 ))(member$ ?v0 (streams$ ?v1 )))):named a9 ))
...
(assert (! (forall ((?v0 A_stream_a_stream_bool_fun_fun$ )(?v1 A_stream$ )(?v2 A_stream$ ))(=> (and (fun_app$d (fun_app$e ?v0 ?v1 )?v2 )(forall ((?v3 A_stream$ )(?v4 A_stream$ ))(=> (fun_app$d (fun_app$e ?v0 ?v3 )?v4 )(and (= (shd$ ?v3 )(shd$ ?v4 ))(or (fun_app$d (fun_app$e ?v0 (stl$ ?v3 ))(stl$ ?v4 ))(= (stl$ ?v3 )(stl$ ?v4 )))))))(= ?v1 ?v2 ))):named a12 ))
...
(assert (! (forall ((?v0 A_stream_stream_a_stream_stream_bool_fun_fun$ )(?v1 A_stream_stream$ )(?v2 A_stream_stream$ ))(=> (and (fun_app$b (fun_app$c ?v0 ?v1 )?v2 )(forall ((?v3 A_stream_stream$ )(?v4 A_stream_stream$ ))(=> (fun_app$b (fun_app$c ?v0 ?v3 )?v4 )(and (= (shd$a ?v3 )(shd$a ?v4 ))(fun_app$b (fun_app$c ?v0 (stl$a ?v3 ))(stl$a ?v4 ))))))(= ?v1 ?v2 ))):named a14 ))
...
(assert (! (forall ((?v0 A_stream_stream_stream$ ))(= (sCons$b (shd$b ?v0 )(stl$b ?v0 ))?v0 )):named a16 ))
...
(assert (! (forall ((?v0 A_stream_stream_stream$ )(?v1 A_stream_stream_stream_stream$ )(?v2 A_stream_stream_stream_a_stream_stream_stream_stream_bool_fun_fun$ ))(=> (and (member$c ?v0 (sset$ ?v1 ))(and (forall ((?v3 A_stream_stream_stream_stream$ ))(fun_app$f (fun_app$g ?v2 (shd$c ?v3 ))?v3 ))(forall ((?v3 A_stream_stream_stream_stream$ )(?v4 A_stream_stream_stream$ ))(=> (and (member$c ?v4 (sset$ (stl$c ?v3 )))(fun_app$f (fun_app$g ?v2 ?v4 )(stl$c ?v3 )))(fun_app$f (fun_app$g ?v2 ?v4 )?v3 )))))(fun_app$f (fun_app$g ?v2 ?v0 )?v1 ))):named a19 ))
(assert (! (forall ((?v0 A_stream_stream$ )(?v1 A_stream_stream_stream$ )(?v2 A_stream_stream_a_stream_stream_stream_bool_fun_fun$ ))(=> (and (member$d ?v0 (sset$a ?v1 ))(and (forall ((?v3 A_stream_stream_stream$ ))(fun_app$ (fun_app$h ?v2 (shd$b ?v3 ))?v3 ))(forall ((?v3 A_stream_stream_stream$ )(?v4 A_stream_stream$ ))(=> (and (member$d ?v4 (sset$a (stl$b ?v3 )))(fun_app$ (fun_app$h ?v2 ?v4 )(stl$b ?v3 )))(fun_app$ (fun_app$h ?v2 ?v4 )?v3 )))))(fun_app$ (fun_app$h ?v2 ?v0 )?v1 ))):named a20 ))
(assert (! (forall ((?v0 A_stream$ )(?v1 A_stream_stream$ )(?v2 A_stream_a_stream_stream_bool_fun_fun$ ))(=> (and (member$ ?v0 (sset$b ?v1 ))(and (forall ((?v3 A_stream_stream$ ))(fun_app$b (fun_app$i ?v2 (shd$a ?v3 ))?v3 ))(forall ((?v3 A_stream_stream$ )(?v4 A_stream$ ))(=> (and (member$ ?v4 (sset$b (stl$a ?v3 )))(fun_app$b (fun_app$i ?v2 ?v4 )(stl$a ?v3 )))(fun_app$b (fun_app$i ?v2 ?v4 )?v3 )))))(fun_app$b (fun_app$i ?v2 ?v0 )?v1 ))):named a21 ))
(assert (! (forall ((?v0 A$ )(?v1 A_stream$ )(?v2 A_a_stream_bool_fun_fun$ ))(=> (and (member$a ?v0 (sset$c ?v1 ))(and (forall ((?v3 A_stream$ ))(fun_app$d (fun_app$j ?v2 (shd$ ?v3 ))?v3 ))(forall ((?v3 A_stream$ )(?v4 A$ ))(=> (and (member$a ?v4 (sset$c (stl$ ?v3 )))(fun_app$d (fun_app$j ?v2 ?v4 )(stl$ ?v3 )))(fun_app$d (fun_app$j ?v2 ?v4 )?v3 )))))(fun_app$d (fun_app$j ?v2 ?v0 )?v1 ))):named a22 ))
(assert (! (forall ((?v0 A_stream_stream_stream$ ))(=> (=> (= ?v0 (sCons$b (shd$b ?v0 )(stl$b ?v0 )))false )false )):named a23 ))
(assert (! (forall ((?v0 A_stream_stream$ ))(=> (=> (= ?v0 (sCons$a (shd$a ?v0 )(stl$a ?v0 )))false )false )):named a24 ))
(assert (! (forall ((?v0 A_stream$ ))(=> (=> (= ?v0 (sCons$ (shd$ ?v0 )(stl$ ?v0 )))false )false )):named a25 ))
(assert (! (forall ((?v0 A_a_stream_stream_bool_fun_fun$ )(?v1 A_stream$ )(?v2 A_stream_stream_stream$ ))(= (fun_app$ (stream_all2$ ?v0 ?v1 )?v2 )(and (fun_app$b (fun_app$k ?v0 (shd$ ?v1 ))(shd$b ?v2 ))(fun_app$ (stream_all2$ ?v0 (stl$ ?v1 ))(stl$b ?v2 ))))):named a26 ))
(assert (! (forall ((?v0 A_stream_a_stream_stream_bool_fun_fun$ )(?v1 A_stream_stream$ )(?v2 A_stream_stream_stream$ ))(= (fun_app$ (stream_all2$a ?v0 ?v1 )?v2 )(and (fun_app$b (fun_app$i ?v0 (shd$a ?v1 ))(shd$b ?v2 ))(fun_app$ (stream_all2$a ?v0 (stl$a ?v1 ))(stl$b ?v2 ))))):named a27 ))
(assert (! (forall ((?v0 A_stream_stream_a_bool_fun_fun$ )(?v1 A_stream_stream_stream$ )(?v2 A_stream$ ))(= (fun_app$d (stream_all2$b ?v0 ?v1 )?v2 )(and (fun_app$l (fun_app$m ?v0 (shd$b ?v1 ))(shd$ ?v2 ))(fun_app$d (stream_all2$b ?v0 (stl$b ?v1 ))(stl$ ?v2 ))))):named a28 ))
(assert (! (forall ((?v0 A_stream_stream_a_stream_bool_fun_fun$ )(?v1 A_stream_stream_stream$ )(?v2 A_stream_stream$ ))(= (fun_app$b (stream_all2$c ?v0 ?v1 )?v2 )(and (fun_app$d (fun_app$n ?v0 (shd$b ?v1 ))(shd$a ?v2 ))(fun_app$b (stream_all2$c ?v0 (stl$b ?v1 ))(stl$a ?v2 ))))):named a29 ))
(assert (! (forall ((?v0 A_stream_stream_a_stream_stream_bool_fun_fun$ )(?v1 A_stream_stream_stream$ )(?v2 A_stream_stream_stream$ ))(= (fun_app$ (stream_all2$d ?v0 ?v1 )?v2 )(and (fun_app$b (fun_app$c ?v0 (shd$b ?v1 ))(shd$b ?v2 ))(fun_app$ (stream_all2$d ?v0 (stl$b ?v1 ))(stl$b ?v2 ))))):named a30 ))
(assert (! (forall ((?v0 A_a_stream_bool_fun_fun$ )(?v1 A_stream$ )(?v2 A_stream_stream$ ))(= (fun_app$b (stream_all2$e ?v0 ?v1 )?v2 )(and (fun_app$d (fun_app$j ?v0 (shd$ ?v1 ))(shd$a ?v2 ))(fun_app$b (stream_all2$e ?v0 (stl$ ?v1 ))(stl$a ?v2 ))))):named a31 ))
(assert (! (forall ((?v0 A_stream_a_bool_fun_fun$ )(?v1 A_stream_stream$ )(?v2 A_stream$ ))(= (fun_app$d (stream_all2$f ?v0 ?v1 )?v2 )(and (fun_app$l (fun_app$o ?v0 (shd$a ?v1 ))(shd$ ?v2 ))(fun_app$d (stream_all2$f ?v0 (stl$a ?v1 ))(stl$ ?v2 ))))):named a32 ))
(assert (! (forall ((?v0 A_stream_a_stream_bool_fun_fun$ )(?v1 A_stream_stream$ )(?v2 A_stream_stream$ ))(= (fun_app$b (stream_all2$g ?v0 ?v1 )?v2 )(and (fun_app$d (fun_app$e ?v0 (shd$a ?v1 ))(shd$a ?v2 ))(fun_app$b (stream_all2$g ?v0 (stl$a ?v1 ))(stl$a ?v2 ))))):named a33 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A_stream$ )(?v2 A_stream$ ))(= (fun_app$d (stream_all2$h ?v0 ?v1 )?v2 )(and (fun_app$l (fun_app$p ?v0 (shd$ ?v1 ))(shd$ ?v2 ))(fun_app$d (stream_all2$h ?v0 (stl$ ?v1 ))(stl$ ?v2 ))))):named a34 ))
...
(assert (! (forall ((?v0 A_stream_stream_a_fun$ )(?v1 A_stream_stream_stream$ ))(= (shd$ (smap$ ?v0 ?v1 ))(fun_app$t ?v0 (shd$b ?v1 )))):named a44 ))
(assert (! (forall ((?v0 A_stream_stream_a_stream_fun$ )(?v1 A_stream_stream_stream$ ))(= (shd$a (smap$a ?v0 ?v1 ))(fun_app$u ?v0 (shd$b ?v1 )))):named a45 ))
(assert (! (forall ((?v0 A_a_stream_stream_fun$ )(?v1 A_stream$ ))(= (shd$b (smap$b ?v0 ?v1 ))(fun_app$v ?v0 (shd$ ?v1 )))):named a46 ))
(assert (! (forall ((?v0 A_stream_a_stream_stream_fun$ )(?v1 A_stream_stream$ ))(= (shd$b (smap$c ?v0 ?v1 ))(fun_app$w ?v0 (shd$a ?v1 )))):named a47 ))
(assert (! (forall ((?v0 A_stream_stream_a_stream_stream_fun$ )(?v1 A_stream_stream_stream$ ))(= (shd$b (smap$d ?v0 ?v1 ))(fun_app$x ?v0 (shd$b ?v1 )))):named a48 ))
(assert (! (forall ((?v0 A_stream_a_fun$ )(?v1 A_stream_stream$ ))(= (shd$ (fun_app$u (smap$e ?v0 )?v1 ))(fun_app$y ?v0 (shd$a ?v1 )))):named a49 ))
(assert (! (forall ((?v0 A_a_stream_fun$ )(?v1 A_stream$ ))(= (shd$a (fun_app$w (smap$f ?v0 )?v1 ))(fun_app$z ?v0 (shd$ ?v1 )))):named a50 ))
(assert (! (forall ((?v0 A_stream_a_stream_fun$ )(?v1 A_stream_stream$ ))(= (shd$a (fun_app$x (smap$g ?v0 )?v1 ))(fun_app$aa ?v0 (shd$a ?v1 )))):named a51 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A_stream$ ))(= (shd$ (fun_app$aa (smap$h ?v0 )?v1 ))(fun_app$ab ?v0 (shd$ ?v1 )))):named a52 ))
(assert (! (forall ((?v0 A_stream_stream_a_fun$ )(?v1 A_stream_stream_stream$ ))(= (stl$ (smap$ ?v0 ?v1 ))(smap$ ?v0 (stl$b ?v1 )))):named a53 ))
(assert (! (forall ((?v0 A_stream_stream_a_stream_fun$ )(?v1 A_stream_stream_stream$ ))(= (stl$a (smap$a ?v0 ?v1 ))(smap$a ?v0 (stl$b ?v1 )))):named a54 ))
(assert (! (forall ((?v0 A_a_stream_stream_fun$ )(?v1 A_stream$ ))(= (stl$b (smap$b ?v0 ?v1 ))(smap$b ?v0 (stl$ ?v1 )))):named a55 ))
(assert (! (forall ((?v0 A_stream_a_stream_stream_fun$ )(?v1 A_stream_stream$ ))(= (stl$b (smap$c ?v0 ?v1 ))(smap$c ?v0 (stl$a ?v1 )))):named a56 ))
(assert (! (forall ((?v0 A_stream_stream_a_stream_stream_fun$ )(?v1 A_stream_stream_stream$ ))(= (stl$b (smap$d ?v0 ?v1 ))(smap$d ?v0 (stl$b ?v1 )))):named a57 ))
(assert (! (forall ((?v0 A_stream_a_fun$ )(?v1 A_stream_stream$ ))(= (stl$ (fun_app$u (smap$e ?v0 )?v1 ))(fun_app$u (smap$e ?v0 )(stl$a ?v1 )))):named a58 ))
(assert (! (forall ((?v0 A_a_stream_fun$ )(?v1 A_stream$ ))(= (stl$a (fun_app$w (smap$f ?v0 )?v1 ))(fun_app$w (smap$f ?v0 )(stl$ ?v1 )))):named a59 ))
(assert (! (forall ((?v0 A_stream_a_stream_fun$ )(?v1 A_stream_stream$ ))(= (stl$a (fun_app$x (smap$g ?v0 )?v1 ))(fun_app$x (smap$g ?v0 )(stl$a ?v1 )))):named a60 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A_stream$ ))(= (stl$ (fun_app$aa (smap$h ?v0 )?v1 ))(fun_app$aa (smap$h ?v0 )(stl$ ?v1 )))):named a61 ))
(assert (! (forall ((?v0 A_stream_stream_stream_stream$ )(?v1 A_stream_stream_stream_set$ ))(= (member$b ?v0 (streams$a ?v1 ))(exists ((?v2 A_stream_stream_stream$ )(?v3 A_stream_stream_stream_stream$ ))(and (= ?v0 (sCons$c ?v2 ?v3 ))(and (member$c ?v2 ?v1 )(member$b ?v3 (streams$a ?v1 ))))))):named a62 ))
(assert (! (forall ((?v0 A_stream_stream_stream$ )(?v1 A_stream_stream_set$ ))(= (member$c ?v0 (streams$b ?v1 ))(exists ((?v2 A_stream_stream$ )(?v3 A_stream_stream_stream$ ))(and (= ?v0 (sCons$b ?v2 ?v3 ))(and (member$d ?v2 ?v1 )(member$c ?v3 (streams$b ?v1 ))))))):named a63 ))
(assert (! (forall ((?v0 A_stream_stream$ )(?v1 A_stream_set$ ))(= (member$d ?v0 (streams$c ?v1 ))(exists ((?v2 A_stream$ )(?v3 A_stream_stream$ ))(and (= ?v0 (sCons$a ?v2 ?v3 ))(and (member$ ?v2 ?v1 )(member$d ?v3 (streams$c ?v1 ))))))):named a64 ))
(assert (! (forall ((?v0 A_stream$ )(?v1 A_set$ ))(= (member$ ?v0 (streams$ ?v1 ))(exists ((?v2 A$ )(?v3 A_stream$ ))(and (= ?v0 (sCons$ ?v2 ?v3 ))(and (member$a ?v2 ?v1 )(member$ ?v3 (streams$ ?v1 ))))))):named a65 ))
(assert (! (forall ((?v0 A_stream_stream_stream_stream$ )(?v1 A_stream_stream_stream_set$ ))(=> (and (member$b ?v0 (streams$a ?v1 ))(forall ((?v2 A_stream_stream_stream$ )(?v3 A_stream_stream_stream_stream$ ))(=> (and (= ?v0 (sCons$c ?v2 ?v3 ))(and (member$c ?v2 ?v1 )(member$b ?v3 (streams$a ?v1 ))))false )))false )):named a66 ))
(assert (! (forall ((?v0 A_stream_stream_stream$ )(?v1 A_stream_stream_set$ ))(=> (and (member$c ?v0 (streams$b ?v1 ))(forall ((?v2 A_stream_stream$ )(?v3 A_stream_stream_stream$ ))(=> (and (= ?v0 (sCons$b ?v2 ?v3 ))(and (member$d ?v2 ?v1 )(member$c ?v3 (streams$b ?v1 ))))false )))false )):named a67 ))
(assert (! (forall ((?v0 A_stream_stream$ )(?v1 A_stream_set$ ))(=> (and (member$d ?v0 (streams$c ?v1 ))(forall ((?v2 A_stream$ )(?v3 A_stream_stream$ ))(=> (and (= ?v0 (sCons$a ?v2 ?v3 ))(and (member$ ?v2 ?v1 )(member$d ?v3 (streams$c ?v1 ))))false )))false )):named a68 ))
(assert (! (forall ((?v0 A_stream$ )(?v1 A_set$ ))(=> (and (member$ ?v0 (streams$ ?v1 ))(forall ((?v2 A$ )(?v3 A_stream$ ))(=> (and (= ?v0 (sCons$ ?v2 ?v3 ))(and (member$a ?v2 ?v1 )(member$ ?v3 (streams$ ?v1 ))))false )))false )):named a69 ))
(assert (! (forall ((?v0 A_stream_stream$ )(?v1 A_stream_stream_stream$ )(?v2 A_stream_stream$ )(?v3 A_stream_stream_stream$ ))(= (= (sCons$b ?v0 ?v1 )(sCons$b ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a70 ))
(assert (! (forall ((?v0 A$ )(?v1 A_stream$ )(?v2 A$ )(?v3 A_stream$ ))(= (= (sCons$ ?v0 ?v1 )(sCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a71 ))
(assert (! (forall ((?v0 A_stream$ )(?v1 A_stream_stream$ )(?v2 A_stream$ )(?v3 A_stream_stream$ ))(= (= (sCons$a ?v0 ?v1 )(sCons$a ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a72 ))
(check-sat )
;(get-unsat-core )
