...
(declare-codatatypes ()((A_stream$ (sCons$ (shd$ A$ )(stl$ A_stream$ )))(Nat_stream$ (sCons$a (shd$a Nat$ )(stl$a Nat_stream$ )))(Nat_stream_stream$ (sCons$b (shd$b Nat_stream$ )(stl$b Nat_stream_stream$ )))(A_stream_stream$ (sCons$c (shd$c A_stream$ )(stl$c A_stream_stream$ )))))
