...
(declare-codatatypes ()((A_list_stream$ (sCons$a (shd$a A_list$ )(stl$a A_list_stream$ )))(A_list_stream_stream$ (sCons$b (shd$b A_list_stream$ )(stl$b A_list_stream_stream$ )))(A_list_stream_stream_stream$ (sCons$c (shd$c A_list_stream_stream$ )(stl$c A_list_stream_stream_stream$ )))(A_stream_stream$ (sCons$d (shd$d A_stream$ )(stl$d A_stream_stream$ )))(A_stream_stream_stream$ (sCons$e (shd$e A_stream_stream$ )(stl$e A_stream_stream_stream$ )))))
