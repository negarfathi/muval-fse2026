...
(declare-codatatypes ()((B_c_prod_stream$ (sCons$ (shd$ B_c_prod$ )(stl$ B_c_prod_stream$ )))(B_stream$ (sCons$a (shd$a B$ )(stl$a B_stream$ )))(C_stream$ (sCons$b (shd$b C$ )(stl$b C_stream$ )))(A_stream$ (sCons$c (shd$c A$ )(stl$c A_stream$ )))))
...
(declare-codatatypes ()((A_b_a_prod_prod_stream$ (sCons$n (shd$n A_b_a_prod_prod$ )(stl$n A_b_a_prod_prod_stream$ )))(A_stream_stream$ (sCons$o (shd$o A_stream$ )(stl$o A_stream_stream$ )))(A_stream_set_stream$ (sCons$p (shd$p A_stream_set$ )(stl$p A_stream_set_stream$ )))(B_c_prod_set_stream$ (sCons$q (shd$q B_c_prod_set$ )(stl$q B_c_prod_set_stream$ )))(C_set_stream$ (sCons$r (shd$r C_set$ )(stl$r C_set_stream$ )))(B_set_stream$ (sCons$s (shd$s B_set$ )(stl$s B_set_stream$ )))(A_set_stream$ (sCons$t (shd$t A_set$ )(stl$t A_set_stream$ )))))
