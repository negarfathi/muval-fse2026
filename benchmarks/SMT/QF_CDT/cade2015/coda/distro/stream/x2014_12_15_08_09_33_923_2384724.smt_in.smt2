...
(declare-codatatypes ()((B_b_prod_stream$ (sCons$c (shd$c B_b_prod$ )(stl$c B_b_prod_stream$ )))))
...
(declare-codatatypes ()((A_a_prod_stream$ (sCons$g (shd$g A_a_prod$ )(stl$g A_a_prod_stream$ )))(B_stream_stream$ (sCons$h (shd$h B_stream$ )(stl$h B_stream_stream$ )))(A_stream_stream$ (sCons$i (shd$i A_stream$ )(stl$i A_stream_stream$ )))(B_stream_stream_stream$ (sCons$j (shd$j B_stream_stream$ )(stl$j B_stream_stream_stream$ )))(A_stream_stream_stream$ (sCons$k (shd$k A_stream_stream$ )(stl$k A_stream_stream_stream$ )))(B_b_prod_stream_stream$ (sCons$l (shd$l B_b_prod_stream$ )(stl$l B_b_prod_stream_stream$ )))(B_a_prod_stream_stream$ (sCons$m (shd$m B_a_prod_stream$ )(stl$m B_a_prod_stream_stream$ )))(A_c_prod_stream_stream$ (sCons$n (shd$n A_c_prod_stream$ )(stl$n A_c_prod_stream_stream$ )))(A_b_prod_stream_stream$ (sCons$o (shd$o A_b_prod_stream$ )(stl$o A_b_prod_stream_stream$ )))(A_a_prod_stream_stream$ (sCons$p (shd$p A_a_prod_stream$ )(stl$p A_a_prod_stream_stream$ )))(C_stream_stream$ (sCons$q (shd$q C_stream$ )(stl$q C_stream_stream$ )))))
(declare-sort B_c_prod$ 0)
(declare-fun fst$e (B_c_prod$)B$)
(declare-fun snd$e (B_c_prod$)C$)
(declare-fun pair$e (B$ C$ )B_c_prod$)
(declare-codatatypes ()((B_c_prod_stream$ (sCons$r (shd$r B_c_prod$ )(stl$r B_c_prod_stream$ )))))
(declare-sort C_a_prod$ 0)
(declare-fun fst$f (C_a_prod$)C$)
(declare-fun snd$f (C_a_prod$)A$)
(declare-fun pair$f (C$ A$ )C_a_prod$)
(declare-codatatypes ()((C_a_prod_stream$ (sCons$s (shd$s C_a_prod$ )(stl$s C_a_prod_stream$ )))))
(declare-sort C_b_prod$ 0)
(declare-fun fst$g (C_b_prod$)C$)
(declare-fun snd$g (C_b_prod$)B$)
(declare-fun pair$g (C$ B$ )C_b_prod$)
(declare-codatatypes ()((C_b_prod_stream$ (sCons$t (shd$t C_b_prod$ )(stl$t C_b_prod_stream$ )))))
(declare-sort C_c_prod$ 0)
(declare-fun fst$h (C_c_prod$)C$)
(declare-fun snd$h (C_c_prod$)C$)
(declare-fun pair$h (C$ C$ )C_c_prod$)
(declare-codatatypes ()((C_c_prod_stream$ (sCons$u (shd$u C_c_prod$ )(stl$u C_c_prod_stream$ )))))
...
(declare-codatatypes ()((A_b_b_prod_prod_stream$ (sCons$v (shd$v A_b_b_prod_prod$ )(stl$v A_b_b_prod_prod_stream$ )))))
