...
(declare-codatatypes ()((A_treeFI_treeFI_stream$ (sCons$b (shd$b A_treeFI_treeFI$ )(stl$b A_treeFI_treeFI_stream$ )))(A_stream_stream$ (sCons$c (shd$c A_stream$ )(stl$c A_stream_stream$ )))(A_treeFI_stream_stream$ (sCons$d (shd$d A_treeFI_stream$ )(stl$d A_treeFI_stream_stream$ )))))
