...
(assert (! (not (and (= (shd$ (run_nu$ (sp_nu_comp$ spa$ sp_a$ )sa$ ))(shd$ (run_nu$a spa$ (run_nu$b sp_a$ sa$ ))))(exists ((?v0 C_b_sp_nu$ )(?v1 A_c_sp_nu$ )(?v2 A_stream$ ))(and (= (stl$ (run_nu$ (sp_nu_comp$ spa$ sp_a$ )sa$ ))(run_nu$ (sp_nu_comp$ ?v0 ?v1 )?v2 ))(= (stl$ (run_nu$a spa$ (run_nu$b sp_a$ sa$ )))(run_nu$a ?v0 (run_nu$b ?v1 ?v2 ))))))):named a0 ))
