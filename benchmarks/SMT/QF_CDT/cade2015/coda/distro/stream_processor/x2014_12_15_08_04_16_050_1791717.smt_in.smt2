...
(declare-codatatypes ()((B_b_prod_stream$ (sCons$f (shd$f B_b_prod$ )(stl$f B_b_prod_stream$ )))(B_stream_stream$ (sCons$g (shd$g B_stream$ )(stl$g B_stream_stream$ )))(A_stream_stream$ (sCons$h (shd$h A_stream$ )(stl$h A_stream_stream$ )))))
