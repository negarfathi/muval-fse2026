...
(declare-fun fst$c (A_stream_b_c_prod_prod$)A_stream$)
(declare-fun snd$c (A_stream_b_c_prod_prod$)B_c_prod$)
(declare-fun pair$c (A_stream$ B_c_prod$ )A_stream_b_c_prod_prod$)
(declare-fun fst$d (C_b_prod$)C$)
(declare-fun snd$d (C_b_prod$)B$)
(declare-fun pair$d (C$ B$ )C_b_prod$)
