...
(declare-fun projl$b (T_T_dtree_dtree_prod_sum_sum$)T$)
(declare-fun inl$b (T$ )T_T_dtree_dtree_prod_sum_sum$)
(declare-fun projr$b (T_T_dtree_dtree_prod_sum_sum$)T_dtree_dtree_prod_sum$)
(declare-fun inr$b (T_dtree_dtree_prod_sum$ )T_T_dtree_dtree_prod_sum_sum$)
