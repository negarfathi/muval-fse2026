...
(assert (! (not (and (= (fun_app$i (sup$ (vimage$ uu$ tns$ ))(sup$a (collect$ uua$ )))(fun_app$i (sup$ (vimage$ uu$ tns$ ))(sup$a (collect$ uua$ ))))(and (member$a (pair$ na$ tns$ )p$ )(forall ((?v0 N$ ))(=> (member$ (inr$ ?v0 )tns$ )(member$b (k$ ?v0 )(ll$ (minus$ nsa$ (insert$ na$ bot$ ))?v0 ))))))):named a18 ))
(assert (! (member$a (pair$ na$ tns$ )p$ ):named a19 ))
(assert (! (forall ((?v0 N$ ))(=> (member$ (inr$ ?v0 )tns$ )(member$b (k$ ?v0 )(lr$ (minus$ nsa$ (insert$ na$ bot$ ))?v0 )))):named a20 ))
(assert (! (member$c na$ nsa$ ):named a21 ))
(assert (! (forall ((?v0 N_set$ ))(=> (less$ (card$ ?v0 )(card$ nsa$ ))(forall ((?v1 N$ ))(less_eq$ (lr$ ?v0 ?v1 )(ll$ ?v0 ?v1 ))))):named a22 ))
(assert (! (member$a (pair$ na$ tns$ )p$ ):named a23 ))
(assert (! (less$ (card$ (minus$ nsa$ (insert$ na$ bot$ )))(card$ nsa$ )):named a24 ))
(assert (! (forall ((?v0 N$ ))(=> (member$ (inr$ ?v0 )tns$ )(member$b (k$ ?v0 )(lr$ (minus$ nsa$ (insert$ na$ bot$ ))?v0 )))):named a25 ))
