...
(assert (! (not (subtr$ ns_a$ tr$ tr$ )):named a0 ))
(assert (! (member$ (root$ tr$ )nsa$ ):named a1 ))
(assert (! (less_eq$ nsa$ ns_a$ ):named a2 ))
(assert (! (forall ((?v0 Dtree$ )(?v1 N_set$ ))(=> (member$ (root$ ?v0 )?v1 )(subtr$ ?v1 ?v0 ?v0 ))):named a3 ))
(assert (! (forall ((?v0 Dtree$ )(?v1 N_set$ )(?v2 Dtree$ )(?v3 Dtree$ ))(=> (and (member$ (root$ ?v0 )?v1 )(and (subtr$ ?v1 ?v2 ?v3 )(member$a (inr$ ?v3 )(cont$ ?v0 ))))(subtr$ ?v1 ?v2 ?v0 ))):named a4 ))
(assert (! (less_eq$ ns$ ns$a ):named a5 ))
(assert (! (subtr$ ns$ tr1$ tr2$ ):named a6 ))
