...
(declare-fun projl$f (Dtree_dtree_sum$)Dtree$)
(declare-fun inl$f (Dtree$ )Dtree_dtree_sum$)
(declare-fun projr$f (Dtree_dtree_sum$)Dtree$)
(declare-fun inr$f (Dtree$ )Dtree_dtree_sum$)
