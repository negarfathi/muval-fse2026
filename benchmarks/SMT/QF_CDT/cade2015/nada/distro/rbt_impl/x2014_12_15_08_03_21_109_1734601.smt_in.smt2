...
(declare-fun nil$d ()A_b_prod_list_a_b_prod_list_prod_list$)
(declare-fun hd$d (A_b_prod_list_a_b_prod_list_prod_list$)A_b_prod_list_a_b_prod_list_prod$)
(declare-fun tl$d (A_b_prod_list_a_b_prod_list_prod_list$)A_b_prod_list_a_b_prod_list_prod_list$)
(declare-fun cons$d (A_b_prod_list_a_b_prod_list_prod$ A_b_prod_list_a_b_prod_list_prod_list$ )A_b_prod_list_a_b_prod_list_prod_list$)
...
(declare-fun hd$i (B_list$)B$)
(declare-fun tl$i (B_list$)B_list$)
...
(declare-fun nil$k ()A_a_prod_list$)
(declare-fun hd$k (A_a_prod_list$)A_a_prod$)
(declare-fun tl$k (A_a_prod_list$)A_a_prod_list$)
(declare-fun cons$k (A_a_prod$ A_a_prod_list$ )A_a_prod_list$)
...
(declare-fun nil$p ()A_a_prod_a_a_prod_prod_list$)
(declare-fun hd$p (A_a_prod_a_a_prod_prod_list$)A_a_prod_a_a_prod_prod$)
(declare-fun tl$p (A_a_prod_a_a_prod_prod_list$)A_a_prod_a_a_prod_prod_list$)
(declare-fun cons$p (A_a_prod_a_a_prod_prod$ A_a_prod_a_a_prod_prod_list$ )A_a_prod_a_a_prod_prod_list$)
(declare-fun k$ ()A$ )
