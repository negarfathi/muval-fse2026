...
(assert (! (not (= (minus$ (plus$ k$ (minus$ n$ (fun_app$ (div$ n$ )(numeral$ (bit0$ one$ )))))(fun_app$ (div$ n$ )(numeral$ (bit0$ one$ ))))(plus$ (minus$ k$a n$ )(minus$ n$ (fun_app$ (div$ n$ )(numeral$ (bit0$ one$ ))))))):named a0 ))
