...
(assert (! (fun_app$ (rbt_greater$ less$ k$ )t$ ):named a1 ))
...
(assert (! (forall ((?v0 A$ )(?v1 A_b_rbt$ ))(! (=> (rbt_less$ less$ ?v0 ?v1 )(= (rbt_lookup$ less$ ?v1 ?v0 )none$ )):pattern ((rbt_lookup$ less$ ?v1 ?v0 )))):named a5 ))
...
(assert (! (forall ((?v0 A$ ))(! (= (fun_app$ (rbt_greater$ less$ ?v0 )empty$ )true ):pattern ((rbt_greater$ less$ ?v0 )))):named a9 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A$ )(?v2 A_b_rbt$ ))(! (=> (rbt_less$ ?v0 ?v1 ?v2 )(= (rbt_lookup$ ?v0 ?v2 ?v1 )none$ )):pattern ((rbt_lookup$ ?v0 ?v2 ?v1 )))):named a10 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ ))(= (member$ ?v0 (lessThan$ less$ ?v1 ))(fun_app$a (fun_app$b less$ ?v0 )?v1 ))):named a11 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ ))(= (member$ ?v0 (greaterThan$ less$ ?v1 ))(fun_app$a (fun_app$b less$ ?v1 )?v0 ))):named a12 ))
(assert (! (forall ((?v0 A$ )(?v1 Color$ )(?v2 A_b_rbt$ )(?v3 A$ )(?v4 B$ )(?v5 A_b_rbt$ ))(! (= (fun_app$ (rbt_greater$ less$ ?v0 )(branch$ ?v1 ?v2 ?v3 ?v4 ?v5 ))(and (fun_app$a (fun_app$b less$ ?v0 )?v3 )(and (fun_app$ (rbt_greater$ less$ ?v0 )?v2 )(fun_app$ (rbt_greater$ less$ ?v0 )?v5 )))):pattern ((fun_app$ (rbt_greater$ less$ ?v0 )(branch$ ?v1 ?v2 ?v3 ?v4 ?v5 ))))):named a13 ))
(assert (! (forall ((?v0 B_option$ ))(=> (and (=> (= ?v0 none$ )false )(=> (not (= ?v0 none$ ))false ))false )):named a14 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A$ ))(! (= (rbt_lookup$ ?v0 empty$ ?v1 )none$ ):pattern ((rbt_lookup$ ?v0 empty$ ?v1 )))):named a15 ))
...
(assert (! (forall ((?v0 A$ )(?v1 Color$ )(?v2 A_b_rbt$ )(?v3 A$ )(?v4 B$ )(?v5 A_b_rbt$ ))(! (= (rbt_less$ less$ ?v0 (branch$ ?v1 ?v2 ?v3 ?v4 ?v5 ))(and (fun_app$a (fun_app$b less$ ?v3 )?v0 )(and (rbt_less$ less$ ?v0 ?v2 )(rbt_less$ less$ ?v0 ?v5 )))):pattern ((rbt_less$ less$ ?v0 (branch$ ?v1 ?v2 ?v3 ?v4 ?v5 ))))):named a18 ))
(check-sat )
;(get-unsat-core )
