...
(declare-fun shd$f (C_b_sp_nu_stream$)C_b_sp_nu$)
(declare-fun stl$f (C_b_sp_nu_stream$)C_b_sp_nu_stream$)
(declare-fun sCons$f (C_b_sp_nu$ C_b_sp_nu_stream$ )C_b_sp_nu_stream$)
