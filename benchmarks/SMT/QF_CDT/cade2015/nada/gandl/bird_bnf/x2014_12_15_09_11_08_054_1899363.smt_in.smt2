...
(assert (! (not (= (fun_app$f (comp$ (fun_app$f (comp$ (fun_app$f (comp$ (fun_app$f (comp$ (fun_app$f (comp$ (case_prod$ uu$ ))(case_prod$ uua$ )))(case_prod$ uu$ )))(case_prod$ uu$ )))(case_prod$ uua$ )))(case_prod$ uu$ ))(fun_app$f (comp$ (fun_app$f (comp$ (fun_app$f (comp$ (case_prod$ uu$ ))(case_prod$ uua$ )))(case_prod$ uua$ )))(case_prod$ uu$ )))):named a8 ))
(assert (! (= (fun_app$f (comp$ (fun_app$f (comp$ (case_prod$ uu$ ))(case_prod$ uua$ )))(case_prod$ uu$ ))(case_prod$ uub$ )):named a9 ))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun$ )(?v1 Nat_nat_prod_nat_nat_prod_fun$ )(?v2 Nat_nat_prod$ ))(! (= (fun_app$b (fun_app$f (comp$ ?v0 )?v1 )?v2 )(fun_app$b ?v0 (fun_app$b ?v1 ?v2 ))):pattern ((fun_app$b (fun_app$f (comp$ ?v0 )?v1 )?v2 )))):named a10 ))
(assert (! (forall ((?v0 Nat_nat_bool_fun_fun$ )(?v1 Nat_nat_nat_nat_prod_fun_fun$ )(?v2 Nat_nat_prod$ ))(= (fun_app$e (case_prod$a ?v0 )(fun_app$b (case_prod$ ?v1 )?v2 ))(fun_app$e (case_prod$a (uuc$ ?v0 ?v1 ))?v2 ))):named a11 ))
(assert (! (forall ((?v0 Nat_nat_nat_nat_prod_fun_fun$ )(?v1 Nat_nat_nat_nat_prod_fun_fun$ )(?v2 Nat_nat_prod$ ))(= (fun_app$b (case_prod$ ?v0 )(fun_app$b (case_prod$ ?v1 )?v2 ))(fun_app$b (case_prod$ (uud$ ?v0 ?v1 ))?v2 ))):named a12 ))
...
(assert (! (forall ((?v0 Nat_nat_prod$ ))(! (= (fun_app$b (case_prod$ uue$ )?v0 )?v0 ):pattern ((fun_app$b (case_prod$ uue$ )?v0 )))):named a15 ))
...
(assert (! (forall ((?v0 Nat_nat_prod_bool_fun$ ))(= (case_prod$a (uuf$ ?v0 ))?v0 )):named a18 ))
(assert (! (forall ((?v0 Nat_nat_prod_nat_nat_prod_fun$ ))(= (case_prod$ (uug$ ?v0 ))?v0 )):named a19 ))
...
(assert (! (forall ((?v0 Nat_nat_bool_fun_fun$ )(?v1 Nat$ )(?v2 Nat$ ))(! (= (fun_app$e (case_prod$a ?v0 )(pair$ ?v1 ?v2 ))(fun_app$c (fun_app$d ?v0 ?v1 )?v2 )):pattern ((fun_app$e (case_prod$a ?v0 )(pair$ ?v1 ?v2 ))))):named a22 ))
(assert (! (forall ((?v0 Nat_nat_nat_nat_prod_fun_fun$ )(?v1 Nat$ )(?v2 Nat$ ))(! (= (fun_app$b (case_prod$ ?v0 )(pair$ ?v1 ?v2 ))(fun_app$ (fun_app$a ?v0 ?v1 )?v2 )):pattern ((fun_app$b (case_prod$ ?v0 )(pair$ ?v1 ?v2 ))))):named a23 ))
(assert (! (forall ((?v0 Nat_nat_bool_fun_fun$ )(?v1 Nat$ )(?v2 Nat$ ))(! (= (fun_app$e (case_prod$a ?v0 )(pair$ ?v1 ?v2 ))(fun_app$c (fun_app$d ?v0 ?v1 )?v2 )):pattern ((fun_app$e (case_prod$a ?v0 )(pair$ ?v1 ?v2 ))))):named a24 ))
(assert (! (forall ((?v0 Nat_nat_nat_nat_prod_fun_fun$ )(?v1 Nat$ )(?v2 Nat$ ))(! (= (fun_app$b (case_prod$ ?v0 )(pair$ ?v1 ?v2 ))(fun_app$ (fun_app$a ?v0 ?v1 )?v2 )):pattern ((fun_app$b (case_prod$ ?v0 )(pair$ ?v1 ?v2 ))))):named a25 ))
(assert (! (forall ((?v0 Nat_nat_bool_fun_fun$ )(?v1 Nat$ )(?v2 Nat$ ))(=> (fun_app$c (fun_app$d ?v0 ?v1 )?v2 )(fun_app$e (case_prod$a ?v0 )(pair$ ?v1 ?v2 )))):named a26 ))
...
(assert (! (forall ((?v0 Nat_nat_prod$ )(?v1 Nat_nat_bool_fun_fun$ ))(=> (forall ((?v2 Nat$ )(?v3 Nat$ ))(=> (= ?v0 (pair$ ?v2 ?v3 ))(fun_app$c (fun_app$d ?v1 ?v2 )?v3 )))(fun_app$e (case_prod$a ?v1 )?v0 ))):named a28 ))
(check-sat )
;(get-unsat-core )
