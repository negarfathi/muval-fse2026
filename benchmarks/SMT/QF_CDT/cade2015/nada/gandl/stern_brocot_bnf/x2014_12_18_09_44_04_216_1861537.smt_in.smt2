...
(declare-fun selectc$ (B_a_fun_a_fun_tree$)B_a_fun_a_fun$)
(declare-fun selectd$ (B_a_fun_a_fun_tree$)B_a_fun_a_fun_tree$)
(declare-fun selecte$ (B_a_fun_a_fun_tree$)B_a_fun_a_fun_tree$)
(declare-fun node$c (B_a_fun_a_fun$ B_a_fun_a_fun_tree$ B_a_fun_a_fun_tree$ )B_a_fun_a_fun_tree$)
...
(declare-fun selecti$ (B_b_a_fun_a_fun_fun_tree$)B_b_a_fun_a_fun_fun$)
(declare-fun selectj$ (B_b_a_fun_a_fun_fun_tree$)B_b_a_fun_a_fun_fun_tree$)
(declare-fun selectk$ (B_b_a_fun_a_fun_fun_tree$)B_b_a_fun_a_fun_fun_tree$)
(declare-fun node$e (B_b_a_fun_a_fun_fun$ B_b_a_fun_a_fun_fun_tree$ B_b_a_fun_a_fun_fun_tree$ )B_b_a_fun_a_fun_fun_tree$)
(declare-fun selectl$ (B_a_fun_a_fun_b_fun_tree$)B_a_fun_a_fun_b_fun$)
(declare-fun selectm$ (B_a_fun_a_fun_b_fun_tree$)B_a_fun_a_fun_b_fun_tree$)
(declare-fun selectn$ (B_a_fun_a_fun_b_fun_tree$)B_a_fun_a_fun_b_fun_tree$)
(declare-fun node$f (B_a_fun_a_fun_b_fun$ B_a_fun_a_fun_b_fun_tree$ B_a_fun_a_fun_b_fun_tree$ )B_a_fun_a_fun_b_fun_tree$)
(declare-fun selecto$ (B_a_fun_a_fun_b_a_fun_a_fun_fun_tree$)B_a_fun_a_fun_b_a_fun_a_fun_fun$)
(declare-fun selectp$ (B_a_fun_a_fun_b_a_fun_a_fun_fun_tree$)B_a_fun_a_fun_b_a_fun_a_fun_fun_tree$)
(declare-fun selectq$ (B_a_fun_a_fun_b_a_fun_a_fun_fun_tree$)B_a_fun_a_fun_b_a_fun_a_fun_fun_tree$)
(declare-fun node$g (B_a_fun_a_fun_b_a_fun_a_fun_fun$ B_a_fun_a_fun_b_a_fun_a_fun_fun_tree$ B_a_fun_a_fun_b_a_fun_a_fun_fun_tree$ )B_a_fun_a_fun_b_a_fun_a_fun_fun_tree$)
...
(declare-fun selectx$ (B_b_b_fun_fun_tree$)B_b_b_fun_fun$)
(declare-fun selecty$ (B_b_b_fun_fun_tree$)B_b_b_fun_fun_tree$)
(declare-fun selectz$ (B_b_b_fun_fun_tree$)B_b_b_fun_fun_tree$)
(declare-fun node$j (B_b_b_fun_fun$ B_b_b_fun_fun_tree$ B_b_b_fun_fun_tree$ )B_b_b_fun_fun_tree$)
...
(declare-fun selecud$ (B_a_fun_b_fun_tree$)B_a_fun_b_fun$)
(declare-fun selecue$ (B_a_fun_b_fun_tree$)B_a_fun_b_fun_tree$)
(declare-fun selecuf$ (B_a_fun_b_fun_tree$)B_a_fun_b_fun_tree$)
(declare-fun node$l (B_a_fun_b_fun$ B_a_fun_b_fun_tree$ B_a_fun_b_fun_tree$ )B_a_fun_b_fun_tree$)
(declare-fun selecug$ (A_b_a_fun_fun_tree$)A_b_a_fun_fun$)
(declare-fun selecuh$ (A_b_a_fun_fun_tree$)A_b_a_fun_fun_tree$)
(declare-fun selecui$ (A_b_a_fun_fun_tree$)A_b_a_fun_fun_tree$)
(declare-fun node$m (A_b_a_fun_fun$ A_b_a_fun_fun_tree$ A_b_a_fun_fun_tree$ )A_b_a_fun_fun_tree$)
(declare-fun selecuj$ (B_a_fun_b_a_fun_fun_tree$)B_a_fun_b_a_fun_fun$)
(declare-fun selecuk$ (B_a_fun_b_a_fun_fun_tree$)B_a_fun_b_a_fun_fun_tree$)
(declare-fun selecul$ (B_a_fun_b_a_fun_fun_tree$)B_a_fun_b_a_fun_fun_tree$)
(declare-fun node$n (B_a_fun_b_a_fun_fun$ B_a_fun_b_a_fun_fun_tree$ B_a_fun_b_a_fun_fun_tree$ )B_a_fun_b_a_fun_fun_tree$)
(declare-fun selecum$ (A_b_a_fun_a_fun_fun_tree$)A_b_a_fun_a_fun_fun$)
(declare-fun selecun$ (A_b_a_fun_a_fun_fun_tree$)A_b_a_fun_a_fun_fun_tree$)
(declare-fun selecuo$ (A_b_a_fun_a_fun_fun_tree$)A_b_a_fun_a_fun_fun_tree$)
(declare-fun node$o (A_b_a_fun_a_fun_fun$ A_b_a_fun_a_fun_fun_tree$ A_b_a_fun_a_fun_fun_tree$ )A_b_a_fun_a_fun_fun_tree$)
