...
(declare-sort C_b_a_fun_fun_stream$ 0)
(declare-sort C_stream$ 0)
(declare-sort C_a_fun_stream$ 0)
(declare-sort C_b_a_fun_fun_b_a_fun_fun_stream$ 0)
(declare-sort C_a_fun_c_b_a_fun_fun_fun_stream$ 0)
(declare-sort C_a_fun_c_a_fun_fun_stream$ 0)
(declare-sort C_a_fun_a_fun_stream$ 0)
(declare-sort B_a_fun_a_fun_stream$ 0)
(declare-sort C_b_a_fun_fun_c_a_fun_fun_stream$ 0)
(declare-sort C_b_a_fun_fun_c_b_a_fun_fun_fun_stream$ 0)
(declare-sort C_c_fun_stream$ 0)
(declare-sort C_b_fun_stream$ 0)
(declare-sort B_c_fun_stream$ 0)
(declare-sort C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_stream$ 0)
(declare-sort C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_stream$ 0)
(declare-sort C_a_fun_c_a_fun_fun_c_a_fun_fun_stream$ 0)
(declare-sort C_a_fun_a_fun_a_fun_stream$ 0)
...
(declare-sort C_a_fun_stream_stream$ 0)
(declare-sort C_b_a_fun_fun_stream_stream$ 0)
...
(declare-fun selectb$ (C_b_a_fun_fun_stream$)C_b_a_fun_fun$)
(declare-fun selectc$ (C_b_a_fun_fun_stream$)C_b_a_fun_fun_stream$)
(declare-fun sCons$c (C_b_a_fun_fun$ C_b_a_fun_fun_stream$ )C_b_a_fun_fun_stream$)
(declare-fun shd$b (C_stream$)C$)
(declare-fun stl$b (C_stream$)C_stream$)
(declare-fun sCons$d (C$ C_stream$ )C_stream$)
(declare-fun selectd$ (C_a_fun_stream$)C_a_fun$)
(declare-fun selecte$ (C_a_fun_stream$)C_a_fun_stream$)
(declare-fun sCons$e (C_a_fun$ C_a_fun_stream$ )C_a_fun_stream$)
(declare-fun selectf$ (C_b_a_fun_fun_b_a_fun_fun_stream$)C_b_a_fun_fun_b_a_fun_fun$)
(declare-fun selectg$ (C_b_a_fun_fun_b_a_fun_fun_stream$)C_b_a_fun_fun_b_a_fun_fun_stream$)
(declare-fun sCons$f (C_b_a_fun_fun_b_a_fun_fun$ C_b_a_fun_fun_b_a_fun_fun_stream$ )C_b_a_fun_fun_b_a_fun_fun_stream$)
(declare-fun selecth$ (C_a_fun_c_b_a_fun_fun_fun_stream$)C_a_fun_c_b_a_fun_fun_fun$)
(declare-fun selecti$ (C_a_fun_c_b_a_fun_fun_fun_stream$)C_a_fun_c_b_a_fun_fun_fun_stream$)
(declare-fun sCons$g (C_a_fun_c_b_a_fun_fun_fun$ C_a_fun_c_b_a_fun_fun_fun_stream$ )C_a_fun_c_b_a_fun_fun_fun_stream$)
(declare-fun selectj$ (C_a_fun_c_a_fun_fun_stream$)C_a_fun_c_a_fun_fun$)
(declare-fun selectk$ (C_a_fun_c_a_fun_fun_stream$)C_a_fun_c_a_fun_fun_stream$)
(declare-fun sCons$h (C_a_fun_c_a_fun_fun$ C_a_fun_c_a_fun_fun_stream$ )C_a_fun_c_a_fun_fun_stream$)
(declare-fun selectl$ (C_a_fun_a_fun_stream$)C_a_fun_a_fun$)
(declare-fun selectm$ (C_a_fun_a_fun_stream$)C_a_fun_a_fun_stream$)
(declare-fun sCons$i (C_a_fun_a_fun$ C_a_fun_a_fun_stream$ )C_a_fun_a_fun_stream$)
(declare-fun selectn$ (B_a_fun_a_fun_stream$)B_a_fun_a_fun$)
(declare-fun selecto$ (B_a_fun_a_fun_stream$)B_a_fun_a_fun_stream$)
(declare-fun sCons$j (B_a_fun_a_fun$ B_a_fun_a_fun_stream$ )B_a_fun_a_fun_stream$)
(declare-fun selectp$ (C_b_a_fun_fun_c_a_fun_fun_stream$)C_b_a_fun_fun_c_a_fun_fun$)
(declare-fun selectq$ (C_b_a_fun_fun_c_a_fun_fun_stream$)C_b_a_fun_fun_c_a_fun_fun_stream$)
(declare-fun sCons$k (C_b_a_fun_fun_c_a_fun_fun$ C_b_a_fun_fun_c_a_fun_fun_stream$ )C_b_a_fun_fun_c_a_fun_fun_stream$)
(declare-fun selectr$ (C_b_a_fun_fun_c_b_a_fun_fun_fun_stream$)C_b_a_fun_fun_c_b_a_fun_fun_fun$)
(declare-fun selects$ (C_b_a_fun_fun_c_b_a_fun_fun_fun_stream$)C_b_a_fun_fun_c_b_a_fun_fun_fun_stream$)
(declare-fun sCons$l (C_b_a_fun_fun_c_b_a_fun_fun_fun$ C_b_a_fun_fun_c_b_a_fun_fun_fun_stream$ )C_b_a_fun_fun_c_b_a_fun_fun_fun_stream$)
(declare-fun selectt$ (C_c_fun_stream$)C_c_fun$)
(declare-fun selectu$ (C_c_fun_stream$)C_c_fun_stream$)
(declare-fun sCons$m (C_c_fun$ C_c_fun_stream$ )C_c_fun_stream$)
(declare-fun selectv$ (C_b_fun_stream$)C_b_fun$)
(declare-fun selectw$ (C_b_fun_stream$)C_b_fun_stream$)
(declare-fun sCons$n (C_b_fun$ C_b_fun_stream$ )C_b_fun_stream$)
(declare-fun selectx$ (B_c_fun_stream$)B_c_fun$)
(declare-fun selecty$ (B_c_fun_stream$)B_c_fun_stream$)
(declare-fun sCons$o (B_c_fun$ B_c_fun_stream$ )B_c_fun_stream$)
(declare-fun selectz$ (C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_stream$)C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun$)
(declare-fun selecua$ (C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_stream$)C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_stream$)
(declare-fun sCons$p (C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun$ C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_stream$ )C_b_a_fun_fun_b_a_fun_fun_b_a_fun_fun_stream$)
(declare-fun selecub$ (C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_stream$)C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun$)
(declare-fun selecuc$ (C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_stream$)C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_stream$)
(declare-fun sCons$q (C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun$ C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_stream$ )C_a_fun_c_b_a_fun_fun_fun_c_b_a_fun_fun_fun_stream$)
(declare-fun selecud$ (C_a_fun_c_a_fun_fun_c_a_fun_fun_stream$)C_a_fun_c_a_fun_fun_c_a_fun_fun$)
(declare-fun selecue$ (C_a_fun_c_a_fun_fun_c_a_fun_fun_stream$)C_a_fun_c_a_fun_fun_c_a_fun_fun_stream$)
(declare-fun sCons$r (C_a_fun_c_a_fun_fun_c_a_fun_fun$ C_a_fun_c_a_fun_fun_c_a_fun_fun_stream$ )C_a_fun_c_a_fun_fun_c_a_fun_fun_stream$)
(declare-fun selecuf$ (C_a_fun_a_fun_a_fun_stream$)C_a_fun_a_fun_a_fun$)
(declare-fun selecug$ (C_a_fun_a_fun_a_fun_stream$)C_a_fun_a_fun_a_fun_stream$)
(declare-fun sCons$s (C_a_fun_a_fun_a_fun$ C_a_fun_a_fun_a_fun_stream$ )C_a_fun_a_fun_a_fun_stream$)
(declare-fun selecuh$ (B_a_fun_a_fun_a_fun_stream$)B_a_fun_a_fun_a_fun$)
(declare-fun selecui$ (B_a_fun_a_fun_a_fun_stream$)B_a_fun_a_fun_a_fun_stream$)
(declare-fun sCons$t (B_a_fun_a_fun_a_fun$ B_a_fun_a_fun_a_fun_stream$ )B_a_fun_a_fun_a_fun_stream$)
(declare-fun selecuj$ (B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$)B_a_fun_a_fun_b_a_fun_a_fun_fun$)
(declare-fun selecuk$ (B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$)B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$)
(declare-fun sCons$u (B_a_fun_a_fun_b_a_fun_a_fun_fun$ B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$ )B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$)
(declare-fun selecul$ (B_a_fun_b_a_fun_fun_stream$)B_a_fun_b_a_fun_fun$)
(declare-fun selecum$ (B_a_fun_b_a_fun_fun_stream$)B_a_fun_b_a_fun_fun_stream$)
(declare-fun sCons$v (B_a_fun_b_a_fun_fun$ B_a_fun_b_a_fun_fun_stream$ )B_a_fun_b_a_fun_fun_stream$)
(declare-fun selecun$ (B_b_fun_stream$)B_b_fun$)
(declare-fun selecuo$ (B_b_fun_stream$)B_b_fun_stream$)
(declare-fun sCons$w (B_b_fun$ B_b_fun_stream$ )B_b_fun_stream$)
(declare-fun selecup$ (A_a_fun_stream$)A_a_fun$)
(declare-fun selecuq$ (A_a_fun_stream$)A_a_fun_stream$)
(declare-fun sCons$x (A_a_fun$ A_a_fun_stream$ )A_a_fun_stream$)
(declare-fun shd$c (C_a_fun_stream_stream$)C_a_fun_stream$)
(declare-fun stl$c (C_a_fun_stream_stream$)C_a_fun_stream_stream$)
(declare-fun sCons$y (C_a_fun_stream$ C_a_fun_stream_stream$ )C_a_fun_stream_stream$)
(declare-fun shd$d (C_b_a_fun_fun_stream_stream$)C_b_a_fun_fun_stream$)
(declare-fun stl$d (C_b_a_fun_fun_stream_stream$)C_b_a_fun_fun_stream_stream$)
(declare-fun sCons$z (C_b_a_fun_fun_stream$ C_b_a_fun_fun_stream_stream$ )C_b_a_fun_fun_stream_stream$)
(declare-fun selecur$ (B_a_fun_tree$)B_a_fun$)
(declare-fun selecus$ (B_a_fun_tree$)B_a_fun_tree$)
(declare-fun selecut$ (B_a_fun_tree$)B_a_fun_tree$)
(declare-fun node$ (B_a_fun$ B_a_fun_tree$ B_a_fun_tree$ )B_a_fun_tree$)
(declare-fun root$ (C_tree$)C$)
(declare-fun left$ (C_tree$)C_tree$)
(declare-fun right$ (C_tree$)C_tree$)
(declare-fun node$a (C$ C_tree$ C_tree$ )C_tree$)
...
(declare-fun root$b (A_tree$)A$)
(declare-fun left$b (A_tree$)A_tree$)
(declare-fun right$b (A_tree$)A_tree$)
(declare-fun node$c (A$ A_tree$ A_tree$ )A_tree$)
(declare-fun selecuu$ (C_b_a_fun_fun_tree$)C_b_a_fun_fun$)
(declare-fun selecuv$ (C_b_a_fun_fun_tree$)C_b_a_fun_fun_tree$)
(declare-fun selecuw$ (C_b_a_fun_fun_tree$)C_b_a_fun_fun_tree$)
(declare-fun node$d (C_b_a_fun_fun$ C_b_a_fun_fun_tree$ C_b_a_fun_fun_tree$ )C_b_a_fun_fun_tree$)
(declare-fun selecux$ (C_a_fun_tree$)C_a_fun$)
(declare-fun selecuy$ (C_a_fun_tree$)C_a_fun_tree$)
(declare-fun selecuz$ (C_a_fun_tree$)C_a_fun_tree$)
(declare-fun node$e (C_a_fun$ C_a_fun_tree$ C_a_fun_tree$ )C_a_fun_tree$)
