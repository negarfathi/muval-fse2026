...
(declare-sort B_a_fun_a_fun_b_fun_stream$ 0)
...
(declare-sort B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun_stream$ 0)
(declare-sort B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun_stream$ 0)
(declare-sort B_b_fun_b_b_fun_fun_stream$ 0)
(declare-sort B_a_fun_b_a_fun_fun_stream$ 0)
(declare-sort B_a_fun_a_fun_stream_stream$ 0)
...
(declare-fun selectb$ (B_a_fun_a_fun_stream$)B_a_fun_a_fun$)
(declare-fun selectc$ (B_a_fun_a_fun_stream$)B_a_fun_a_fun_stream$)
(declare-fun sCons$c (B_a_fun_a_fun$ B_a_fun_a_fun_stream$ )B_a_fun_a_fun_stream$)
...
(declare-fun selectf$ (B_b_a_fun_a_fun_fun_stream$)B_b_a_fun_a_fun_fun$)
(declare-fun selectg$ (B_b_a_fun_a_fun_fun_stream$)B_b_a_fun_a_fun_fun_stream$)
(declare-fun sCons$e (B_b_a_fun_a_fun_fun$ B_b_a_fun_a_fun_fun_stream$ )B_b_a_fun_a_fun_fun_stream$)
(declare-fun selecth$ (B_a_fun_a_fun_b_fun_stream$)B_a_fun_a_fun_b_fun$)
(declare-fun selecti$ (B_a_fun_a_fun_b_fun_stream$)B_a_fun_a_fun_b_fun_stream$)
(declare-fun sCons$f (B_a_fun_a_fun_b_fun$ B_a_fun_a_fun_b_fun_stream$ )B_a_fun_a_fun_b_fun_stream$)
(declare-fun selectj$ (B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$)B_a_fun_a_fun_b_a_fun_a_fun_fun$)
(declare-fun selectk$ (B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$)B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$)
(declare-fun sCons$g (B_a_fun_a_fun_b_a_fun_a_fun_fun$ B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$ )B_a_fun_a_fun_b_a_fun_a_fun_fun_stream$)
(declare-fun selectl$ (A_b_fun_stream$)A_b_fun$)
(declare-fun selectm$ (A_b_fun_stream$)A_b_fun_stream$)
(declare-fun sCons$h (A_b_fun$ A_b_fun_stream$ )A_b_fun_stream$)
(declare-fun selectn$ (A_a_fun_stream$)A_a_fun$)
(declare-fun selecto$ (A_a_fun_stream$)A_a_fun_stream$)
(declare-fun sCons$i (A_a_fun$ A_a_fun_stream$ )A_a_fun_stream$)
(declare-fun selectp$ (B_b_b_fun_fun_stream$)B_b_b_fun_fun$)
(declare-fun selectq$ (B_b_b_fun_fun_stream$)B_b_b_fun_fun_stream$)
(declare-fun sCons$j (B_b_b_fun_fun$ B_b_b_fun_fun_stream$ )B_b_b_fun_fun_stream$)
...
(declare-fun selectt$ (A_b_fun_a_b_fun_fun_stream$)A_b_fun_a_b_fun_fun$)
(declare-fun selectu$ (A_b_fun_a_b_fun_fun_stream$)A_b_fun_a_b_fun_fun_stream$)
(declare-fun sCons$l (A_b_fun_a_b_fun_fun$ A_b_fun_a_b_fun_fun_stream$ )A_b_fun_a_b_fun_fun_stream$)
...
(declare-fun selectx$ (B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun_stream$)B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun$)
(declare-fun selecty$ (B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun_stream$)B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun_stream$)
(declare-fun sCons$n (B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun$ B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun_stream$ )B_a_fun_a_fun_b_fun_b_a_fun_a_fun_b_fun_fun_stream$)
(declare-fun selectz$ (B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun_stream$)B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun$)
(declare-fun selecua$ (B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun_stream$)B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun_stream$)
(declare-fun sCons$o (B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun$ B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun_stream$ )B_b_a_fun_a_fun_fun_b_b_a_fun_a_fun_fun_fun_stream$)
(declare-fun selecub$ (B_b_fun_b_b_fun_fun_stream$)B_b_fun_b_b_fun_fun$)
(declare-fun selecuc$ (B_b_fun_b_b_fun_fun_stream$)B_b_fun_b_b_fun_fun_stream$)
(declare-fun sCons$p (B_b_fun_b_b_fun_fun$ B_b_fun_b_b_fun_fun_stream$ )B_b_fun_b_b_fun_fun_stream$)
(declare-fun selecud$ (B_a_fun_b_a_fun_fun_stream$)B_a_fun_b_a_fun_fun$)
(declare-fun selecue$ (B_a_fun_b_a_fun_fun_stream$)B_a_fun_b_a_fun_fun_stream$)
(declare-fun sCons$q (B_a_fun_b_a_fun_fun$ B_a_fun_b_a_fun_fun_stream$ )B_a_fun_b_a_fun_fun_stream$)
(declare-fun shd$b (B_a_fun_a_fun_stream_stream$)B_a_fun_a_fun_stream$)
(declare-fun stl$b (B_a_fun_a_fun_stream_stream$)B_a_fun_a_fun_stream_stream$)
(declare-fun sCons$r (B_a_fun_a_fun_stream$ B_a_fun_a_fun_stream_stream$ )B_a_fun_a_fun_stream_stream$)
(declare-fun shd$c (B_stream_stream$)B_stream$)
(declare-fun stl$c (B_stream_stream$)B_stream_stream$)
(declare-fun sCons$s (B_stream$ B_stream_stream$ )B_stream_stream$)
(declare-fun selecuf$ (B_a_fun_a_fun_b_fun_tree$)B_a_fun_a_fun_b_fun$)
(declare-fun selecug$ (B_a_fun_a_fun_b_fun_tree$)B_a_fun_a_fun_b_fun_tree$)
(declare-fun selecuh$ (B_a_fun_a_fun_b_fun_tree$)B_a_fun_a_fun_b_fun_tree$)
(declare-fun node$ (B_a_fun_a_fun_b_fun$ B_a_fun_a_fun_b_fun_tree$ B_a_fun_a_fun_b_fun_tree$ )B_a_fun_a_fun_b_fun_tree$)
(declare-fun selecui$ (B_b_a_fun_a_fun_fun_tree$)B_b_a_fun_a_fun_fun$)
(declare-fun selecuj$ (B_b_a_fun_a_fun_fun_tree$)B_b_a_fun_a_fun_fun_tree$)
(declare-fun selecuk$ (B_b_a_fun_a_fun_fun_tree$)B_b_a_fun_a_fun_fun_tree$)
(declare-fun node$a (B_b_a_fun_a_fun_fun$ B_b_a_fun_a_fun_fun_tree$ B_b_a_fun_a_fun_fun_tree$ )B_b_a_fun_a_fun_fun_tree$)
(declare-fun selecul$ (B_b_fun_tree$)B_b_fun$)
(declare-fun selecum$ (B_b_fun_tree$)B_b_fun_tree$)
(declare-fun selecun$ (B_b_fun_tree$)B_b_fun_tree$)
(declare-fun node$b (B_b_fun$ B_b_fun_tree$ B_b_fun_tree$ )B_b_fun_tree$)
(declare-fun selecuo$ (B_a_fun_tree$)B_a_fun$)
(declare-fun selecup$ (B_a_fun_tree$)B_a_fun_tree$)
(declare-fun selecuq$ (B_a_fun_tree$)B_a_fun_tree$)
...
(declare-fun node$d (A$ A_tree$ A_tree$ )A_tree$)
(declare-fun root$a (B_tree$)B$)
(declare-fun left$a (B_tree$)B_tree$)
(declare-fun right$a (B_tree$)B_tree$)
(declare-fun node$e (B$ B_tree$ B_tree$ )B_tree$)
(declare-fun selecur$ (B_a_fun_a_fun_tree$)B_a_fun_a_fun$)
(declare-fun selecus$ (B_a_fun_a_fun_tree$)B_a_fun_a_fun_tree$)
(declare-fun selecut$ (B_a_fun_a_fun_tree$)B_a_fun_a_fun_tree$)
(declare-fun node$f (B_a_fun_a_fun$ B_a_fun_a_fun_tree$ B_a_fun_a_fun_tree$ )B_a_fun_a_fun_tree$)
