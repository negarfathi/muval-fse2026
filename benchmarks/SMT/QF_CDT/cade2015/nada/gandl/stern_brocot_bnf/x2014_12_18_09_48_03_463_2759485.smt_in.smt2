...
(declare-fun select$ (A_a_fun_a_tree_fun_stream$)A_a_fun_a_tree_fun$)
(declare-fun selecta$ (A_a_fun_a_tree_fun_stream$)A_a_fun_a_tree_fun_stream$)
(declare-fun sCons$a (A_a_fun_a_tree_fun$ A_a_fun_a_tree_fun_stream$ )A_a_fun_a_tree_fun_stream$)
...
(declare-fun selectf$ (A_a_tree_fun_stream$)A_a_tree_fun$)
(declare-fun selectg$ (A_a_tree_fun_stream$)A_a_tree_fun_stream$)
...
(declare-fun selectl$ (A_tree_a_fun_stream$)A_tree_a_fun$)
(declare-fun selectm$ (A_tree_a_fun_stream$)A_tree_a_fun_stream$)
(declare-fun sCons$h (A_tree_a_fun$ A_tree_a_fun_stream$ )A_tree_a_fun_stream$)
(declare-fun selectn$ (A_tree_a_tree_fun_stream$)A_tree_a_tree_fun$)
(declare-fun selecto$ (A_tree_a_tree_fun_stream$)A_tree_a_tree_fun_stream$)
(declare-fun sCons$i (A_tree_a_tree_fun$ A_tree_a_tree_fun_stream$ )A_tree_a_tree_fun_stream$)
(declare-fun selectp$ (A_tree_a_a_fun_fun_stream$)A_tree_a_a_fun_fun$)
(declare-fun selectq$ (A_tree_a_a_fun_fun_stream$)A_tree_a_a_fun_fun_stream$)
(declare-fun sCons$j (A_tree_a_a_fun_fun$ A_tree_a_a_fun_fun_stream$ )A_tree_a_a_fun_fun_stream$)
...
(declare-fun root$b (A_stream_tree_tree$)A_stream_tree$)
(declare-fun left$b (A_stream_tree_tree$)A_stream_tree_tree$)
(declare-fun right$b (A_stream_tree_tree$)A_stream_tree_tree$)
(declare-fun node$b (A_stream_tree$ A_stream_tree_tree$ A_stream_tree_tree$ )A_stream_tree_tree$)
(declare-fun root$c (A_stream_tree_tree_tree$)A_stream_tree_tree$)
(declare-fun left$c (A_stream_tree_tree_tree$)A_stream_tree_tree_tree$)
(declare-fun right$c (A_stream_tree_tree_tree$)A_stream_tree_tree_tree$)
(declare-fun node$c (A_stream_tree_tree$ A_stream_tree_tree_tree$ A_stream_tree_tree_tree$ )A_stream_tree_tree_tree$)
...
(declare-fun node$f (A_a_fun_a_tree_fun$ A_a_fun_a_tree_fun_tree$ A_a_fun_a_tree_fun_tree$ )A_a_fun_a_tree_fun_tree$)
