...
(declare-sort Nat_tree_stream_stream$ 0)
(declare-sort Nat_tree_stream_stream_stream$ 0)
...
(declare-fun sCons$l (Nat_stream_stream$ Nat_stream_stream_stream$ )Nat_stream_stream_stream$)
(declare-fun shd$c (Nat_tree_stream$)Nat_tree$)
(declare-fun stl$c (Nat_tree_stream$)Nat_tree_stream$)
(declare-fun sCons$m (Nat_tree$ Nat_tree_stream$ )Nat_tree_stream$)
(declare-fun shd$d (Nat_tree_stream_stream$)Nat_tree_stream$)
(declare-fun stl$d (Nat_tree_stream_stream$)Nat_tree_stream_stream$)
(declare-fun sCons$n (Nat_tree_stream$ Nat_tree_stream_stream$ )Nat_tree_stream_stream$)
(declare-fun shd$e (Nat_tree_stream_stream_stream$)Nat_tree_stream_stream$)
(declare-fun stl$e (Nat_tree_stream_stream_stream$)Nat_tree_stream_stream_stream$)
(declare-fun sCons$o (Nat_tree_stream_stream$ Nat_tree_stream_stream_stream$ )Nat_tree_stream_stream_stream$)
(declare-fun selecuz$ (Nat_nat_nat_fun_nat_nat_fun_fun_fun_stream$)Nat_nat_nat_fun_nat_nat_fun_fun_fun$)
(declare-fun selecva$ (Nat_nat_nat_fun_nat_nat_fun_fun_fun_stream$)Nat_nat_nat_fun_nat_nat_fun_fun_fun_stream$)
(declare-fun sCons$p (Nat_nat_nat_fun_nat_nat_fun_fun_fun$ Nat_nat_nat_fun_nat_nat_fun_fun_fun_stream$ )Nat_nat_nat_fun_nat_nat_fun_fun_fun_stream$)
(declare-fun selecvb$ (Nat_nat_fun_nat_nat_fun_nat_fun_fun_stream$)Nat_nat_fun_nat_nat_fun_nat_fun_fun$)
(declare-fun selecvc$ (Nat_nat_fun_nat_nat_fun_nat_fun_fun_stream$)Nat_nat_fun_nat_nat_fun_nat_fun_fun_stream$)
(declare-fun sCons$q (Nat_nat_fun_nat_nat_fun_nat_fun_fun$ Nat_nat_fun_nat_nat_fun_nat_fun_fun_stream$ )Nat_nat_fun_nat_nat_fun_nat_fun_fun_stream$)
