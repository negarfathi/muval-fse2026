...
(declare-fun selecth$ (A_a_stream_fun_stream$)A_a_stream_fun$)
(declare-fun selecti$ (A_a_stream_fun_stream$)A_a_stream_fun_stream$)
...
(declare-fun selectl$ (A_stream_a_stream_fun_stream$)A_stream_a_stream_fun$)
(declare-fun selectm$ (A_stream_a_stream_fun_stream$)A_stream_a_stream_fun_stream$)
(declare-fun sCons$h (A_stream_a_stream_fun$ A_stream_a_stream_fun_stream$ )A_stream_a_stream_fun_stream$)
(declare-fun selectn$ (A_a_fun_a_stream_fun_stream$)A_a_fun_a_stream_fun$)
(declare-fun selecto$ (A_a_fun_a_stream_fun_stream$)A_a_fun_a_stream_fun_stream$)
...
(declare-fun selectt$ (A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$)A_a_fun_a_a_fun_a_a_fun_fun_fun$)
(declare-fun selectu$ (A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$)A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$)
(declare-fun sCons$n (A_a_fun_a_a_fun_a_a_fun_fun_fun$ A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$ )A_a_fun_a_a_fun_a_a_fun_fun_fun_stream$)
(declare-fun selectv$ (A_a_fun_a_a_fun_a_fun_fun_stream$)A_a_fun_a_a_fun_a_fun_fun$)
(declare-fun selectw$ (A_a_fun_a_a_fun_a_fun_fun_stream$)A_a_fun_a_a_fun_a_fun_fun_stream$)
(declare-fun sCons$o (A_a_fun_a_a_fun_a_fun_fun$ A_a_fun_a_a_fun_a_fun_fun_stream$ )A_a_fun_a_a_fun_a_fun_fun_stream$)
(declare-fun selectx$ (A_a_a_a_fun_fun_fun_stream$)A_a_a_a_fun_fun_fun$)
(declare-fun selecty$ (A_a_a_a_fun_fun_fun_stream$)A_a_a_a_fun_fun_fun_stream$)
(declare-fun sCons$p (A_a_a_a_fun_fun_fun$ A_a_a_a_fun_fun_fun_stream$ )A_a_a_a_fun_fun_fun_stream$)
(declare-fun selectz$ (A_a_a_fun_a_a_fun_fun_fun_stream$)A_a_a_fun_a_a_fun_fun_fun$)
(declare-fun selecua$ (A_a_a_fun_a_a_fun_fun_fun_stream$)A_a_a_fun_a_a_fun_fun_fun_stream$)
(declare-fun sCons$q (A_a_a_fun_a_a_fun_fun_fun$ A_a_a_fun_a_a_fun_fun_fun_stream$ )A_a_a_fun_a_a_fun_fun_fun_stream$)
(declare-fun selecub$ (A_a_fun_a_a_a_fun_fun_fun_stream$)A_a_fun_a_a_a_fun_fun_fun$)
(declare-fun selecuc$ (A_a_fun_a_a_a_fun_fun_fun_stream$)A_a_fun_a_a_a_fun_fun_fun_stream$)
(declare-fun sCons$r (A_a_fun_a_a_a_fun_fun_fun$ A_a_fun_a_a_a_fun_fun_fun_stream$ )A_a_fun_a_a_a_fun_fun_fun_stream$)
