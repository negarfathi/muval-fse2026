...
(declare-fun selecud$ (A_a_b_fun_a_b_fun_fun_fun_tree$)A_a_b_fun_a_b_fun_fun_fun$)
(declare-fun selecue$ (A_a_b_fun_a_b_fun_fun_fun_tree$)A_a_b_fun_a_b_fun_fun_fun_tree$)
(declare-fun selecuf$ (A_a_b_fun_a_b_fun_fun_fun_tree$)A_a_b_fun_a_b_fun_fun_fun_tree$)
(declare-fun node$l (A_a_b_fun_a_b_fun_fun_fun$ A_a_b_fun_a_b_fun_fun_fun_tree$ A_a_b_fun_a_b_fun_fun_fun_tree$ )A_a_b_fun_a_b_fun_fun_fun_tree$)
(declare-fun x$ ()A$ )
...
(assert (! (not (= (fun_app$ (root$b fa$ )x$ )(fun_app$ (root$b ga$ )x$ ))):named a0 ))
