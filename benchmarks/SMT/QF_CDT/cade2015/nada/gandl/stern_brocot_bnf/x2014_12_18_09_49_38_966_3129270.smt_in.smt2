...
(declare-sort A_a_a_a_prod_fun_fun_stream$ 0)
(declare-fun shd$ (A_a_prod_stream$)A_a_prod$)
(declare-fun stl$ (A_a_prod_stream$)A_a_prod_stream$)
(declare-fun sCons$ (A_a_prod$ A_a_prod_stream$ )A_a_prod_stream$)
(declare-fun select$ (A_a_a_prod_fun_stream$)A_a_a_prod_fun$)
(declare-fun selecta$ (A_a_a_prod_fun_stream$)A_a_a_prod_fun_stream$)
(declare-fun sCons$a (A_a_a_prod_fun$ A_a_a_prod_fun_stream$ )A_a_a_prod_fun_stream$)
(declare-fun shd$a (A_stream$)A$)
(declare-fun stl$a (A_stream$)A_stream$)
(declare-fun sCons$b (A$ A_stream$ )A_stream$)
(declare-fun selectb$ (A_a_a_a_prod_fun_fun_stream$)A_a_a_a_prod_fun_fun$)
(declare-fun selectc$ (A_a_a_a_prod_fun_fun_stream$)A_a_a_a_prod_fun_fun_stream$)
(declare-fun sCons$c (A_a_a_a_prod_fun_fun$ A_a_a_a_prod_fun_fun_stream$ )A_a_a_a_prod_fun_fun_stream$)
(declare-sort Num$ 0)
(declare-fun one$ ()Num$)
...
(declare-sort A_a_a_a_a_prod_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ 0)
(declare-sort A_a_fun_stream$ 0)
(declare-sort A_a_a_a_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_prod_fun_a_fun_stream$ 0)
(declare-sort A_a_a_fun_fun_a_fun_stream$ 0)
(declare-sort A_a_a_a_prod_fun_fun_a_fun_stream$ 0)
(declare-sort A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$ 0)
(declare-sort A_a_fun_a_fun_stream$ 0)
(declare-sort A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ 0)
(declare-sort A_a_fun_a_a_fun_a_fun_fun_stream$ 0)
(declare-sort A_a_a_a_a_fun_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$ 0)
...
(declare-sort A_a_a_a_prod_fun_fun_a_a_prod_fun_stream$ 0)
(declare-sort A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_prod_fun_a_a_prod_fun_stream$ 0)
(declare-sort A_a_a_fun_fun_a_a_fun_fun_stream$ 0)
(declare-sort A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$ 0)
(declare-sort A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ 0)
(declare-sort A_a_fun_a_fun_a_fun_stream$ 0)
(declare-sort A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_prod_fun_a_a_a_prod_fun_fun_stream$ 0)
(declare-sort A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ 0)
(declare-sort A_a_fun_a_a_fun_fun_stream$ 0)
(declare-sort A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$ 0)
(declare-sort A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun_stream$ 0)
...
(declare-fun selecth$ (A_a_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_fun$)
(declare-fun selecti$ (A_a_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun sCons$e (A_a_a_a_a_prod_fun_fun_fun$ A_a_a_a_a_prod_fun_fun_fun_stream$ )A_a_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun selectj$ (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun$)
(declare-fun selectk$ (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun sCons$f (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ )A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)
...
(declare-fun selectn$ (A_a_a_a_fun_fun_fun_stream$)A_a_a_a_fun_fun_fun$)
(declare-fun selecto$ (A_a_a_a_fun_fun_fun_stream$)A_a_a_a_fun_fun_fun_stream$)
(declare-fun sCons$h (A_a_a_a_fun_fun_fun$ A_a_a_a_fun_fun_fun_stream$ )A_a_a_a_fun_fun_fun_stream$)
(declare-fun selectp$ (A_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_a_a_prod_fun_fun_fun_fun$)
(declare-fun selectq$ (A_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun sCons$i (A_a_a_a_a_a_prod_fun_fun_fun_fun$ A_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ )A_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun selectr$ (A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun$)
(declare-fun selects$ (A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun sCons$j (A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun$ A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$ )A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun selectt$ (A_a_a_prod_fun_a_fun_stream$)A_a_a_prod_fun_a_fun$)
(declare-fun selectu$ (A_a_a_prod_fun_a_fun_stream$)A_a_a_prod_fun_a_fun_stream$)
(declare-fun sCons$k (A_a_a_prod_fun_a_fun$ A_a_a_prod_fun_a_fun_stream$ )A_a_a_prod_fun_a_fun_stream$)
...
(declare-fun sCons$l (A_a_a_fun_fun_a_fun$ A_a_a_fun_fun_a_fun_stream$ )A_a_a_fun_fun_a_fun_stream$)
(declare-fun selectx$ (A_a_a_a_prod_fun_fun_a_fun_stream$)A_a_a_a_prod_fun_fun_a_fun$)
(declare-fun selecty$ (A_a_a_a_prod_fun_fun_a_fun_stream$)A_a_a_a_prod_fun_fun_a_fun_stream$)
(declare-fun sCons$m (A_a_a_a_prod_fun_fun_a_fun$ A_a_a_a_prod_fun_fun_a_fun_stream$ )A_a_a_a_prod_fun_fun_a_fun_stream$)
(declare-fun selectz$ (A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun$)
(declare-fun selecua$ (A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$)
(declare-fun sCons$n (A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun$ A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$ )A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$)
(declare-fun selecub$ (A_a_fun_a_fun_stream$)A_a_fun_a_fun$)
(declare-fun selecuc$ (A_a_fun_a_fun_stream$)A_a_fun_a_fun_stream$)
(declare-fun sCons$o (A_a_fun_a_fun$ A_a_fun_a_fun_stream$ )A_a_fun_a_fun_stream$)
(declare-fun selecud$ (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun$)
(declare-fun selecue$ (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun sCons$p (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$ )A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun selecuf$ (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun$)
(declare-fun selecug$ (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun sCons$q (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ )A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun selecuh$ (A_a_fun_a_a_fun_a_fun_fun_stream$)A_a_fun_a_a_fun_a_fun_fun$)
(declare-fun selecui$ (A_a_fun_a_a_fun_a_fun_fun_stream$)A_a_fun_a_a_fun_a_fun_fun_stream$)
(declare-fun sCons$r (A_a_fun_a_a_fun_a_fun_fun$ A_a_fun_a_a_fun_a_fun_fun_stream$ )A_a_fun_a_a_fun_a_fun_fun_stream$)
(declare-fun selecuj$ (A_a_a_a_a_fun_fun_fun_fun_stream$)A_a_a_a_a_fun_fun_fun_fun$)
(declare-fun selecuk$ (A_a_a_a_a_fun_fun_fun_fun_stream$)A_a_a_a_a_fun_fun_fun_fun_stream$)
(declare-fun sCons$s (A_a_a_a_a_fun_fun_fun_fun$ A_a_a_a_a_fun_fun_fun_fun_stream$ )A_a_a_a_a_fun_fun_fun_fun_stream$)
(declare-fun selecul$ (A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$)A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun$)
(declare-fun selecum$ (A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$)A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$)
(declare-fun sCons$t (A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun$ A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$ )A_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$)
(declare-fun shd$b (A_stream_stream$)A_stream$)
(declare-fun stl$b (A_stream_stream$)A_stream_stream$)
(declare-fun sCons$u (A_stream$ A_stream_stream$ )A_stream_stream$)
(declare-fun shd$c (A_stream_stream_stream$)A_stream_stream$)
(declare-fun stl$c (A_stream_stream_stream$)A_stream_stream_stream$)
(declare-fun sCons$v (A_stream_stream$ A_stream_stream_stream$ )A_stream_stream_stream$)
...
(declare-fun sCons$w (A_stream_stream_stream$ A_stream_stream_stream_stream$ )A_stream_stream_stream_stream$)
(declare-fun selecun$ (A_stream_stream_stream_a_stream_stream_stream_fun_stream$)A_stream_stream_stream_a_stream_stream_stream_fun$)
(declare-fun selecuo$ (A_stream_stream_stream_a_stream_stream_stream_fun_stream$)A_stream_stream_stream_a_stream_stream_stream_fun_stream$)
(declare-fun sCons$x (A_stream_stream_stream_a_stream_stream_stream_fun$ A_stream_stream_stream_a_stream_stream_stream_fun_stream$ )A_stream_stream_stream_a_stream_stream_stream_fun_stream$)
(declare-fun selecup$ (A_stream_stream_stream_a_stream_stream_stream_a_stream_stream_stream_fun_fun_stream$)A_stream_stream_stream_a_stream_stream_stream_a_stream_stream_stream_fun_fun$)
(declare-fun selecuq$ (A_stream_stream_stream_a_stream_stream_stream_a_stream_stream_stream_fun_fun_stream$)A_stream_stream_stream_a_stream_stream_stream_a_stream_stream_stream_fun_fun_stream$)
(declare-fun sCons$y (A_stream_stream_stream_a_stream_stream_stream_a_stream_stream_stream_fun_fun$ A_stream_stream_stream_a_stream_stream_stream_a_stream_stream_stream_fun_fun_stream$ )A_stream_stream_stream_a_stream_stream_stream_a_stream_stream_stream_fun_fun_stream$)
(declare-fun selecur$ (A_stream_stream_a_stream_stream_fun_stream$)A_stream_stream_a_stream_stream_fun$)
(declare-fun selecus$ (A_stream_stream_a_stream_stream_fun_stream$)A_stream_stream_a_stream_stream_fun_stream$)
(declare-fun sCons$z (A_stream_stream_a_stream_stream_fun$ A_stream_stream_a_stream_stream_fun_stream$ )A_stream_stream_a_stream_stream_fun_stream$)
(declare-fun selecut$ (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$)A_stream_stream_a_stream_stream_a_stream_stream_fun_fun$)
(declare-fun selecuu$ (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$)A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$)
(declare-fun sCons$aa (A_stream_stream_a_stream_stream_a_stream_stream_fun_fun$ A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$ )A_stream_stream_a_stream_stream_a_stream_stream_fun_fun_stream$)
(declare-fun selecuv$ (A_stream_a_stream_fun_stream$)A_stream_a_stream_fun$)
(declare-fun selecuw$ (A_stream_a_stream_fun_stream$)A_stream_a_stream_fun_stream$)
(declare-fun sCons$ab (A_stream_a_stream_fun$ A_stream_a_stream_fun_stream$ )A_stream_a_stream_fun_stream$)
(declare-fun selecux$ (A_stream_a_stream_a_stream_fun_fun_stream$)A_stream_a_stream_a_stream_fun_fun$)
(declare-fun selecuy$ (A_stream_a_stream_a_stream_fun_fun_stream$)A_stream_a_stream_a_stream_fun_fun_stream$)
(declare-fun sCons$ac (A_stream_a_stream_a_stream_fun_fun$ A_stream_a_stream_a_stream_fun_fun_stream$ )A_stream_a_stream_a_stream_fun_fun_stream$)
(declare-fun selecuz$ (A_a_a_a_prod_fun_fun_a_a_prod_fun_stream$)A_a_a_a_prod_fun_fun_a_a_prod_fun$)
(declare-fun selecva$ (A_a_a_a_prod_fun_fun_a_a_prod_fun_stream$)A_a_a_a_prod_fun_fun_a_a_prod_fun_stream$)
(declare-fun sCons$ad (A_a_a_a_prod_fun_fun_a_a_prod_fun$ A_a_a_a_prod_fun_fun_a_a_prod_fun_stream$ )A_a_a_a_prod_fun_fun_a_a_prod_fun_stream$)
(declare-fun selecvb$ (A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun$)
(declare-fun selecvc$ (A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun sCons$ae (A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun$ A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ )A_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun selecvd$ (A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun$)
(declare-fun selecve$ (A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun sCons$af (A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun$ A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ )A_a_a_a_prod_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun selecvf$ (A_a_a_prod_fun_a_a_prod_fun_stream$)A_a_a_prod_fun_a_a_prod_fun$)
(declare-fun selecvg$ (A_a_a_prod_fun_a_a_prod_fun_stream$)A_a_a_prod_fun_a_a_prod_fun_stream$)
(declare-fun sCons$ag (A_a_a_prod_fun_a_a_prod_fun$ A_a_a_prod_fun_a_a_prod_fun_stream$ )A_a_a_prod_fun_a_a_prod_fun_stream$)
(declare-fun selecvh$ (A_a_a_fun_fun_a_a_fun_fun_stream$)A_a_a_fun_fun_a_a_fun_fun$)
(declare-fun selecvi$ (A_a_a_fun_fun_a_a_fun_fun_stream$)A_a_a_fun_fun_a_a_fun_fun_stream$)
(declare-fun sCons$ah (A_a_a_fun_fun_a_a_fun_fun$ A_a_a_fun_fun_a_a_fun_fun_stream$ )A_a_a_fun_fun_a_a_fun_fun_stream$)
(declare-fun selecvj$ (A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun$)
(declare-fun selecvk$ (A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun sCons$ai (A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun$ A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ )A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun selecvl$ (A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun$)
(declare-fun selecvm$ (A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$)
(declare-fun sCons$aj (A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun$ A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$ )A_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_stream$)
(declare-fun selecvn$ (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun$)
(declare-fun selecvo$ (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun sCons$ak (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$ )A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_fun_stream$)
(declare-fun selecvp$ (A_a_fun_a_fun_a_fun_stream$)A_a_fun_a_fun_a_fun$)
(declare-fun selecvq$ (A_a_fun_a_fun_a_fun_stream$)A_a_fun_a_fun_a_fun_stream$)
(declare-fun sCons$al (A_a_fun_a_fun_a_fun$ A_a_fun_a_fun_a_fun_stream$ )A_a_fun_a_fun_a_fun_stream$)
(declare-fun selecvr$ (A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_stream$)A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun$)
(declare-fun selecvs$ (A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_stream$)A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_stream$)
(declare-fun sCons$am (A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun$ A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_stream$ )A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_stream$)
(declare-fun selecvt$ (A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun$)
(declare-fun selecvu$ (A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun sCons$an (A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun$ A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ )A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun selecvv$ (A_a_a_prod_fun_a_a_a_prod_fun_fun_stream$)A_a_a_prod_fun_a_a_a_prod_fun_fun$)
(declare-fun selecvw$ (A_a_a_prod_fun_a_a_a_prod_fun_fun_stream$)A_a_a_prod_fun_a_a_a_prod_fun_fun_stream$)
(declare-fun sCons$ao (A_a_a_prod_fun_a_a_a_prod_fun_fun$ A_a_a_prod_fun_a_a_a_prod_fun_fun_stream$ )A_a_a_prod_fun_a_a_a_prod_fun_fun_stream$)
(declare-fun selecvx$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$)A_a_a_fun_fun_a_a_a_fun_fun_fun$)
(declare-fun selecvy$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$)A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$)
(declare-fun sCons$ap (A_a_a_fun_fun_a_a_a_fun_fun_fun$ A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$ )A_a_a_fun_fun_a_a_a_fun_fun_fun_stream$)
(declare-fun selecvz$ (A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun$)
(declare-fun selecwa$ (A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun sCons$aq (A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun$ A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$ )A_a_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun selecwb$ (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun$)
(declare-fun selecwc$ (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun sCons$ar (A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun$ A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$ )A_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_a_a_a_a_prod_fun_fun_a_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun selecwd$ (A_a_fun_a_a_fun_fun_stream$)A_a_fun_a_a_fun_fun$)
(declare-fun selecwe$ (A_a_fun_a_a_fun_fun_stream$)A_a_fun_a_a_fun_fun_stream$)
(declare-fun sCons$as (A_a_fun_a_a_fun_fun$ A_a_fun_a_a_fun_fun_stream$ )A_a_fun_a_a_fun_fun_stream$)
(declare-fun selecwf$ (A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_stream$)A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun$)
(declare-fun selecwg$ (A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_stream$)A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_stream$)
(declare-fun sCons$at (A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun$ A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_stream$ )A_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_fun_fun_stream$)
(declare-fun selecwh$ (A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$)A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun$)
(declare-fun selecwi$ (A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$)A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$)
(declare-fun sCons$au (A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun$ A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$ )A_a_a_a_a_a_prod_fun_fun_fun_fun_a_a_a_a_a_a_prod_fun_fun_fun_fun_fun_stream$)
(declare-fun selecwj$ (A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun$)
(declare-fun selecwk$ (A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun_stream$)A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun_stream$)
(declare-fun sCons$av (A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun$ A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun_stream$ )A_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_a_a_a_a_a_prod_fun_fun_a_a_a_prod_fun_fun_fun_fun_stream$)
