...
(declare-fun selecti$ (A_a_a_fun_a_fun_fun_tree$)A_a_a_fun_a_fun_fun$)
(declare-fun selectj$ (A_a_a_fun_a_fun_fun_tree$)A_a_a_fun_a_fun_fun_tree$)
(declare-fun selectk$ (A_a_a_fun_a_fun_fun_tree$)A_a_a_fun_a_fun_fun_tree$)
(declare-fun node$d (A_a_a_fun_a_fun_fun$ A_a_a_fun_a_fun_fun_tree$ A_a_a_fun_a_fun_fun_tree$ )A_a_a_fun_a_fun_fun_tree$)
...
(declare-fun selectr$ (A_a_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun$)
(declare-fun selects$ (A_a_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun selectt$ (A_a_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun node$g (A_a_fun_a_a_fun_a_fun_fun$ A_a_fun_a_a_fun_a_fun_fun_tree$ A_a_fun_a_a_fun_a_fun_fun_tree$ )A_a_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun selectu$ (A_a_fun_a_fun_a_a_fun_fun_tree$)A_a_fun_a_fun_a_a_fun_fun$)
(declare-fun selectv$ (A_a_fun_a_fun_a_a_fun_fun_tree$)A_a_fun_a_fun_a_a_fun_fun_tree$)
(declare-fun selectw$ (A_a_fun_a_fun_a_a_fun_fun_tree$)A_a_fun_a_fun_a_a_fun_fun_tree$)
(declare-fun node$h (A_a_fun_a_fun_a_a_fun_fun$ A_a_fun_a_fun_a_a_fun_fun_tree$ A_a_fun_a_fun_a_a_fun_fun_tree$ )A_a_fun_a_fun_a_a_fun_fun_tree$)
...
(declare-fun selecua$ (A_a_fun_a_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_fun_a_a_fun_a_fun_fun$)
(declare-fun selecub$ (A_a_fun_a_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun selecuc$ (A_a_fun_a_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun node$j (A_a_fun_a_fun_a_a_fun_a_fun_fun$ A_a_fun_a_fun_a_a_fun_a_fun_fun_tree$ A_a_fun_a_fun_a_a_fun_a_fun_fun_tree$ )A_a_fun_a_fun_a_a_fun_a_fun_fun_tree$)
...
(declare-fun selecug$ (A_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_a_a_fun_fun_fun$)
(declare-fun selecuh$ (A_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecui$ (A_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)
(declare-fun node$l (A_a_a_a_fun_fun_a_a_fun_fun_fun$ A_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ A_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ )A_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecuj$ (A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun$)
(declare-fun selecuk$ (A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecul$ (A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)
(declare-fun node$m (A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun$ A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$ )A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecum$ (A_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)A_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun$)
(declare-fun selecun$ (A_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)A_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun selecuo$ (A_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)A_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun node$n (A_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun$ A_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$ A_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$ )A_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)
...
(declare-fun node$o (A_a_a_a_fun_fun_fun$ A_a_a_a_fun_fun_fun_tree$ A_a_a_a_fun_fun_fun_tree$ )A_a_a_a_fun_fun_fun_tree$)
(declare-fun selecus$ (A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun$)
(declare-fun selecut$ (A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecuu$ (A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun node$p (A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun$ A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$ A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$ )A_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecuv$ (A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun$)
(declare-fun selecuw$ (A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun selecux$ (A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun node$q (A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun$ A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$ A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$ )A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun selecuy$ (A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun_a_a_fun_fun$)
(declare-fun selecuz$ (A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$)
(declare-fun selecva$ (A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$)
(declare-fun node$r (A_a_fun_a_a_fun_fun_a_a_fun_fun$ A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$ A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$ )A_a_fun_a_a_fun_fun_a_a_fun_fun_tree$)
(declare-fun selecvb$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun$)
(declare-fun selecvc$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecvd$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun node$s (A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun$ A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$ A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$ )A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecve$ (A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun$)
(declare-fun selecvf$ (A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecvg$ (A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_fun_fun_tree$)
...
(declare-fun selecvh$ (A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun$)
(declare-fun selecvi$ (A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)
(declare-fun selecvj$ (A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_a_fun_fun_a_a_a_fun_a_fun_fun_fun_tree$)
...
(declare-fun selecvn$ (A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_a_fun_fun_fun$)
(declare-fun selecvo$ (A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_a_fun_fun_fun_tree$)
(declare-fun selecvp$ (A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_a_fun_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun_a_a_fun_a_a_fun_a_fun_fun_fun_tree$)
...
(declare-fun selecvq$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_a_a_fun_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_a_a_fun_fun_fun_fun$)
(declare-fun selecvr$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_a_a_fun_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecvs$ (A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_a_a_fun_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_a_a_fun_fun_fun_fun_tree$)
(declare-fun node$x (A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_a_a_fun_fun_fun_fun$ A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_a_a_fun_fun_fun_fun_tree$ A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_a_a_fun_fun_fun_fun_tree$ )A_a_a_fun_fun_a_a_a_fun_fun_fun_a_a_a_a_fun_fun_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecvt$ (A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun$)
(declare-fun selecvu$ (A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecvv$ (A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)
(declare-fun node$y (A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun$ A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$ A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$ )A_a_a_a_fun_fun_a_a_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecvw$ (A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun$)
(declare-fun selecvx$ (A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecvy$ (A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)
(declare-fun node$z (A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun$ A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$ A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$ )A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecvz$ (A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_fun$)
(declare-fun selecwa$ (A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_fun_tree$)
(declare-fun selecwb$ (A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_fun_tree$)A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_fun_tree$)
(declare-fun node$aa (A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_fun$ A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_fun_tree$ A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_fun_tree$ )A_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_a_a_a_fun_fun_fun_fun_fun_tree$)
(declare-fun selecwc$ (A_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_a_fun_fun_fun$)
(declare-fun selecwd$ (A_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_a_fun_fun_fun_tree$)
(declare-fun selecwe$ (A_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_a_fun_fun_fun_tree$)
...
(declare-fun selecwf$ (A_a_fun_a_a_a_fun_fun_fun_tree$)A_a_fun_a_a_a_fun_fun_fun$)
(declare-fun selecwg$ (A_a_fun_a_a_a_fun_fun_fun_tree$)A_a_fun_a_a_a_fun_fun_fun_tree$)
(declare-fun selecwh$ (A_a_fun_a_a_a_fun_fun_fun_tree$)A_a_fun_a_a_a_fun_fun_fun_tree$)
...
(declare-fun selecwl$ (A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$)A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun$)
(declare-fun selecwm$ (A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$)A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$)
(declare-fun selecwn$ (A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$)A_a_fun_a_a_a_fun_fun_fun_a_a_a_fun_a_a_fun_fun_fun_fun_tree$)
