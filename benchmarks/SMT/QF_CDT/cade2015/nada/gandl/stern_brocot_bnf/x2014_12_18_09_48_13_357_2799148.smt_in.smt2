...
(declare-fun selectf$ (A_a_fun_stream$)A_a_fun$)
(declare-fun selectg$ (A_a_fun_stream$)A_a_fun_stream$)
(declare-fun sCons$e (A_a_fun$ A_a_fun_stream$ )A_a_fun_stream$)
(declare-fun selecth$ (A_a_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun$)
(declare-fun selecti$ (A_a_fun_a_a_fun_fun_tree$)A_a_fun_a_a_fun_fun_tree$)
...
(declare-fun selectk$ (A_a_fun_a_fun_tree$)A_a_fun_a_fun$)
(declare-fun selectl$ (A_a_fun_a_fun_tree$)A_a_fun_a_fun_tree$)
...
(declare-fun selectq$ (A_a_fun_tree$)A_a_fun$)
(declare-fun selectr$ (A_a_fun_tree$)A_a_fun_tree$)
(declare-fun selects$ (A_a_fun_tree$)A_a_fun_tree$)
(declare-fun node$d (A_a_fun$ A_a_fun_tree$ A_a_fun_tree$ )A_a_fun_tree$)
(declare-fun selectt$ (A_a_stream_fun_stream$)A_a_stream_fun$)
(declare-fun selectu$ (A_a_stream_fun_stream$)A_a_stream_fun_stream$)
(declare-fun sCons$f (A_a_stream_fun$ A_a_stream_fun_stream$ )A_a_stream_fun_stream$)
(declare-fun selectv$ (A_stream_a_fun_stream$)A_stream_a_fun$)
(declare-fun selectw$ (A_stream_a_fun_stream$)A_stream_a_fun_stream$)
(declare-fun sCons$g (A_stream_a_fun$ A_stream_a_fun_stream$ )A_stream_a_fun_stream$)
(declare-fun selectx$ (A_stream_a_stream_fun_stream$)A_stream_a_stream_fun$)
(declare-fun selecty$ (A_stream_a_stream_fun_stream$)A_stream_a_stream_fun_stream$)
(declare-fun sCons$h (A_stream_a_stream_fun$ A_stream_a_stream_fun_stream$ )A_stream_a_stream_fun_stream$)
(declare-fun selectz$ (A_a_fun_a_stream_fun_stream$)A_a_fun_a_stream_fun$)
(declare-fun selecua$ (A_a_fun_a_stream_fun_stream$)A_a_fun_a_stream_fun_stream$)
(declare-fun sCons$i (A_a_fun_a_stream_fun$ A_a_fun_a_stream_fun_stream$ )A_a_fun_a_stream_fun_stream$)
(declare-fun selecub$ (A_stream_a_a_fun_fun_stream$)A_stream_a_a_fun_fun$)
(declare-fun selecuc$ (A_stream_a_a_fun_fun_stream$)A_stream_a_a_fun_fun_stream$)
...
(declare-fun selecuf$ (A_a_a_fun_a_fun_fun_tree$)A_a_a_fun_a_fun_fun$)
(declare-fun selecug$ (A_a_a_fun_a_fun_fun_tree$)A_a_a_fun_a_fun_fun_tree$)
...
(declare-fun selecui$ (A_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun$)
(declare-fun selecuj$ (A_a_a_a_fun_fun_fun_tree$)A_a_a_a_fun_fun_fun_tree$)
...
(declare-fun selecul$ (A_a_fun_a_fun_a_fun_tree$)A_a_fun_a_fun_a_fun$)
(declare-fun selecum$ (A_a_fun_a_fun_a_fun_tree$)A_a_fun_a_fun_a_fun_tree$)
(declare-fun selecun$ (A_a_fun_a_fun_a_fun_tree$)A_a_fun_a_fun_a_fun_tree$)
(declare-fun node$g (A_a_fun_a_fun_a_fun$ A_a_fun_a_fun_a_fun_tree$ A_a_fun_a_fun_a_fun_tree$ )A_a_fun_a_fun_a_fun_tree$)
(declare-fun selecuo$ (A_a_a_fun_fun_a_fun_tree$)A_a_a_fun_fun_a_fun$)
(declare-fun selecup$ (A_a_a_fun_fun_a_fun_tree$)A_a_a_fun_fun_a_fun_tree$)
(declare-fun selecuq$ (A_a_a_fun_fun_a_fun_tree$)A_a_a_fun_fun_a_fun_tree$)
(declare-fun node$h (A_a_a_fun_fun_a_fun$ A_a_a_fun_fun_a_fun_tree$ A_a_a_fun_fun_a_fun_tree$ )A_a_a_fun_fun_a_fun_tree$)
(declare-fun selecur$ (A_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_a_fun_fun_fun$)
(declare-fun selecus$ (A_a_a_fun_a_a_fun_fun_fun_tree$)A_a_a_fun_a_a_fun_fun_fun_tree$)
...
(declare-fun selecuu$ (A_a_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun$)
(declare-fun selecuv$ (A_a_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun_tree$)
(declare-fun selecuw$ (A_a_fun_a_a_fun_a_fun_fun_tree$)A_a_fun_a_a_fun_a_fun_fun_tree$)
