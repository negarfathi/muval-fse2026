...
(declare-sort Rat_nat_fun_tree$ 0)
(declare-sort Rat_int_fun_tree$ 0)
(declare-sort Nat_rat_fun_tree$ 0)
...
(declare-sort Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$ 0)
...
(declare-sort Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$ 0)
...
(declare-sort Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ 0)
(declare-sort Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ 0)
...
(declare-fun selectf$ (Rat_rat_fun_rat_fun_tree$)Rat_rat_fun_rat_fun$)
(declare-fun selectg$ (Rat_rat_fun_rat_fun_tree$)Rat_rat_fun_rat_fun_tree$)
(declare-fun selecth$ (Rat_rat_fun_rat_fun_tree$)Rat_rat_fun_rat_fun_tree$)
(declare-fun node$d (Rat_rat_fun_rat_fun$ Rat_rat_fun_rat_fun_tree$ Rat_rat_fun_rat_fun_tree$ )Rat_rat_fun_rat_fun_tree$)
(declare-fun selecti$ (Rat_rat_rat_fun_fun_tree$)Rat_rat_rat_fun_fun$)
(declare-fun selectj$ (Rat_rat_rat_fun_fun_tree$)Rat_rat_rat_fun_fun_tree$)
(declare-fun selectk$ (Rat_rat_rat_fun_fun_tree$)Rat_rat_rat_fun_fun_tree$)
(declare-fun node$e (Rat_rat_rat_fun_fun$ Rat_rat_rat_fun_fun_tree$ Rat_rat_rat_fun_fun_tree$ )Rat_rat_rat_fun_fun_tree$)
(declare-fun selectl$ (Rat_nat_nat_prod_fun_tree$)Rat_nat_nat_prod_fun$)
(declare-fun selectm$ (Rat_nat_nat_prod_fun_tree$)Rat_nat_nat_prod_fun_tree$)
(declare-fun selectn$ (Rat_nat_nat_prod_fun_tree$)Rat_nat_nat_prod_fun_tree$)
(declare-fun node$f (Rat_nat_nat_prod_fun$ Rat_nat_nat_prod_fun_tree$ Rat_nat_nat_prod_fun_tree$ )Rat_nat_nat_prod_fun_tree$)
(declare-fun selecto$ (Nat_nat_prod_rat_fun_rat_fun_tree$)Nat_nat_prod_rat_fun_rat_fun$)
(declare-fun selectp$ (Nat_nat_prod_rat_fun_rat_fun_tree$)Nat_nat_prod_rat_fun_rat_fun_tree$)
(declare-fun selectq$ (Nat_nat_prod_rat_fun_rat_fun_tree$)Nat_nat_prod_rat_fun_rat_fun_tree$)
(declare-fun node$g (Nat_nat_prod_rat_fun_rat_fun$ Nat_nat_prod_rat_fun_rat_fun_tree$ Nat_nat_prod_rat_fun_rat_fun_tree$ )Nat_nat_prod_rat_fun_rat_fun_tree$)
(declare-fun selectr$ (Rat_rat_fun_rat_rat_fun_fun_tree$)Rat_rat_fun_rat_rat_fun_fun$)
(declare-fun selects$ (Rat_rat_fun_rat_rat_fun_fun_tree$)Rat_rat_fun_rat_rat_fun_fun_tree$)
(declare-fun selectt$ (Rat_rat_fun_rat_rat_fun_fun_tree$)Rat_rat_fun_rat_rat_fun_fun_tree$)
(declare-fun node$h (Rat_rat_fun_rat_rat_fun_fun$ Rat_rat_fun_rat_rat_fun_fun_tree$ Rat_rat_fun_rat_rat_fun_fun_tree$ )Rat_rat_fun_rat_rat_fun_fun_tree$)
(declare-fun selectu$ (Nat_nat_prod_rat_rat_fun_fun_tree$)Nat_nat_prod_rat_rat_fun_fun$)
(declare-fun selectv$ (Nat_nat_prod_rat_rat_fun_fun_tree$)Nat_nat_prod_rat_rat_fun_fun_tree$)
(declare-fun selectw$ (Nat_nat_prod_rat_rat_fun_fun_tree$)Nat_nat_prod_rat_rat_fun_fun_tree$)
(declare-fun node$i (Nat_nat_prod_rat_rat_fun_fun$ Nat_nat_prod_rat_rat_fun_fun_tree$ Nat_nat_prod_rat_rat_fun_fun_tree$ )Nat_nat_prod_rat_rat_fun_fun_tree$)
(declare-fun selectx$ (Rat_nat_nat_prod_rat_fun_fun_tree$)Rat_nat_nat_prod_rat_fun_fun$)
(declare-fun selecty$ (Rat_nat_nat_prod_rat_fun_fun_tree$)Rat_nat_nat_prod_rat_fun_fun_tree$)
(declare-fun selectz$ (Rat_nat_nat_prod_rat_fun_fun_tree$)Rat_nat_nat_prod_rat_fun_fun_tree$)
...
(declare-fun selecua$ (Rat_rat_fun_nat_nat_prod_fun_tree$)Rat_rat_fun_nat_nat_prod_fun$)
(declare-fun selecub$ (Rat_rat_fun_nat_nat_prod_fun_tree$)Rat_rat_fun_nat_nat_prod_fun_tree$)
(declare-fun selecuc$ (Rat_rat_fun_nat_nat_prod_fun_tree$)Rat_rat_fun_nat_nat_prod_fun_tree$)
(declare-fun node$k (Rat_rat_fun_nat_nat_prod_fun$ Rat_rat_fun_nat_nat_prod_fun_tree$ Rat_rat_fun_nat_nat_prod_fun_tree$ )Rat_rat_fun_nat_nat_prod_fun_tree$)
(declare-fun root$b (Nat_tree$)Nat$)
(declare-fun left$b (Nat_tree$)Nat_tree$)
(declare-fun right$b (Nat_tree$)Nat_tree$)
(declare-fun node$l (Nat$ Nat_tree$ Nat_tree$ )Nat_tree$)
(declare-fun root$c (Int_tree$)Int)
(declare-fun left$c (Int_tree$)Int_tree$)
(declare-fun right$c (Int_tree$)Int_tree$)
(declare-fun node$m (Int Int_tree$ Int_tree$ )Int_tree$)
...
(declare-fun node$n (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_tree$)
(declare-fun selecug$ (Rat_nat_fun_tree$)Rat_nat_fun$)
(declare-fun selecuh$ (Rat_nat_fun_tree$)Rat_nat_fun_tree$)
(declare-fun selecui$ (Rat_nat_fun_tree$)Rat_nat_fun_tree$)
(declare-fun node$o (Rat_nat_fun$ Rat_nat_fun_tree$ Rat_nat_fun_tree$ )Rat_nat_fun_tree$)
...
(declare-fun node$p (Rat_int_fun$ Rat_int_fun_tree$ Rat_int_fun_tree$ )Rat_int_fun_tree$)
(declare-fun selecum$ (Nat_rat_fun_tree$)Nat_rat_fun$)
(declare-fun selecun$ (Nat_rat_fun_tree$)Nat_rat_fun_tree$)
(declare-fun selecuo$ (Nat_rat_fun_tree$)Nat_rat_fun_tree$)
(declare-fun node$q (Nat_rat_fun$ Nat_rat_fun_tree$ Nat_rat_fun_tree$ )Nat_rat_fun_tree$)
(declare-fun selecup$ (Nat_nat_fun_tree$)Nat_nat_fun$)
(declare-fun selecuq$ (Nat_nat_fun_tree$)Nat_nat_fun_tree$)
(declare-fun selecur$ (Nat_nat_fun_tree$)Nat_nat_fun_tree$)
(declare-fun node$r (Nat_nat_fun$ Nat_nat_fun_tree$ Nat_nat_fun_tree$ )Nat_nat_fun_tree$)
(declare-fun selecus$ (Nat_int_fun_tree$)Nat_int_fun$)
(declare-fun selecut$ (Nat_int_fun_tree$)Nat_int_fun_tree$)
(declare-fun selecuu$ (Nat_int_fun_tree$)Nat_int_fun_tree$)
(declare-fun node$s (Nat_int_fun$ Nat_int_fun_tree$ Nat_int_fun_tree$ )Nat_int_fun_tree$)
(declare-fun selecuv$ (Int_rat_fun_tree$)Int_rat_fun$)
(declare-fun selecuw$ (Int_rat_fun_tree$)Int_rat_fun_tree$)
(declare-fun selecux$ (Int_rat_fun_tree$)Int_rat_fun_tree$)
(declare-fun node$t (Int_rat_fun$ Int_rat_fun_tree$ Int_rat_fun_tree$ )Int_rat_fun_tree$)
(declare-fun selecuy$ (Int_nat_fun_tree$)Int_nat_fun$)
(declare-fun selecuz$ (Int_nat_fun_tree$)Int_nat_fun_tree$)
(declare-fun selecva$ (Int_nat_fun_tree$)Int_nat_fun_tree$)
(declare-fun node$u (Int_nat_fun$ Int_nat_fun_tree$ Int_nat_fun_tree$ )Int_nat_fun_tree$)
(declare-fun selecvb$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun$)
(declare-fun selecvc$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$)
(declare-fun selecvd$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$)
(declare-fun node$v (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_tree$)
(declare-fun selecve$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun$)
(declare-fun selecvf$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$)
(declare-fun selecvg$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$)
(declare-fun node$w (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_tree$)
(declare-fun selecvh$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun$)
(declare-fun selecvi$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)
(declare-fun selecvj$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)
(declare-fun node$x (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)
(declare-fun selecvk$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun$)
(declare-fun selecvl$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)
(declare-fun selecvm$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)
(declare-fun node$y (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)
(declare-fun selecvn$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun$)
(declare-fun selecvo$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$)
(declare-fun selecvp$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$)
(declare-fun node$z (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_fun_nat_fun_tree$)
(declare-fun selecvq$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun$)
(declare-fun selecvr$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$)
(declare-fun selecvs$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$)
(declare-fun node$aa (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_int_fun_int_fun_tree$)
(declare-fun selecvt$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun$)
(declare-fun selecvu$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)
(declare-fun selecvv$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)
(declare-fun node$ab (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_fun_tree$)
(declare-fun selecvw$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun$)
(declare-fun selecvx$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)
(declare-fun selecvy$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)
(declare-fun node$ac (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_nat_nat_prod_rat_fun_rat_fun_fun_tree$)
(declare-fun selecvz$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun$)
(declare-fun selecwa$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)
(declare-fun selecwb$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)
(declare-fun node$ad (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)
(declare-fun selecwc$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun$)
(declare-fun selecwd$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)
(declare-fun selecwe$ (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)
(declare-fun node$ae (Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$ )Nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_nat_nat_prod_rat_fun_nat_nat_prod_rat_fun_fun_fun_tree$)
(declare-fun selecwf$ (Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$)Nat_nat_prod_rat_fun_rat_fun_rat_fun$)
(declare-fun selecwg$ (Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$)Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$)
(declare-fun selecwh$ (Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$)Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$)
(declare-fun node$af (Nat_nat_prod_rat_fun_rat_fun_rat_fun$ Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$ Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$ )Nat_nat_prod_rat_fun_rat_fun_rat_fun_tree$)
...
(declare-fun node$ag (Nat_tree$ Nat_tree_tree$ Nat_tree_tree$ )Nat_tree_tree$)
...
(declare-fun node$ah (Rat_tree$ Rat_tree_tree$ Rat_tree_tree$ )Rat_tree_tree$)
(declare-fun root$f (Int_tree_tree$)Int_tree$)
(declare-fun left$f (Int_tree_tree$)Int_tree_tree$)
(declare-fun right$f (Int_tree_tree$)Int_tree_tree$)
(declare-fun node$ai (Int_tree$ Int_tree_tree$ Int_tree_tree$ )Int_tree_tree$)
...
(declare-fun root$h (Nat_tree_tree_tree$)Nat_tree_tree$)
(declare-fun left$h (Nat_tree_tree_tree$)Nat_tree_tree_tree$)
(declare-fun right$h (Nat_tree_tree_tree$)Nat_tree_tree_tree$)
(declare-fun node$ak (Nat_tree_tree$ Nat_tree_tree_tree$ Nat_tree_tree_tree$ )Nat_tree_tree_tree$)
(declare-fun m$ ()Nat$ )
(declare-fun n$ ()Nat$ )
