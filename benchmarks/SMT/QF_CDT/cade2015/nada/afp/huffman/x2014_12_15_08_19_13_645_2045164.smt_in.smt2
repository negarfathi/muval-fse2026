...
(assert (! (not (and (not (member$ aa$ (alphabet$ t_1$ )))(and (not (member$ (sibling$ t_2$ aa$ )(alphabet$ t_1$ )))(and (member$ aa$ (alphabet$ t_2$ ))(member$ (sibling$ t_2$ aa$ )(alphabet$ t_2$ )))))):named a0 ))
...
(assert (! (=> (and (member$ (sibling$ t_1$ aa$ )(alphabet$ t_1$ ))(member$ aa$ (alphabet$ t_1$ )))(or (member$ aa$ (alphabet$ t_2$ ))(member$ (sibling$ t_1$ aa$ )(alphabet$ t_2$ )))):named a5 ))
(assert (! (or (member$ aa$ (alphabet$ t_1$ ))(member$ aa$ (alphabet$ t_2$ ))):named a6 ))
(assert (! (or (fun_app$ (less$ zero$ )(height$ t_1$ ))(fun_app$ (less$ zero$ )(height$ t_2$ ))):named a7 ))
