...
(assert (! (= (height$ t_1$ )zero$ ):named a3 ))
...
(assert (! (=> (and (consistent$ t_1$ )(and (not (= (sibling$ t_1$ b$ )b$ ))(not (= a$ b$ ))))(= (sibling$ (swapLeaves$ t_1$ w_a$ a$ w_s$ (sibling$ t_1$ b$ ))a$ )b$ )):named a8 ))
...
(assert (! (= t_1$ (leaf$ w_c$ c$ )):named a12 ))
...
(assert (! (forall ((?v0 Nat$ )(?v1 A_tree$ )(?v2 A_tree$ ))(! (= (cachedWeight$ (innerNode$ ?v0 ?v1 ?v2 ))?v0 ):pattern ((innerNode$ ?v0 ?v1 ?v2 )))):named a15 ))
