...
(assert (! (=> (and (consistent$ t_1$ )(and (not (= (sibling$ t_1$ b$ )b$ ))(not (= a$ b$ ))))(= (sibling$ (fun_app$ (swapLeaves$ t_1$ w_a$ a$ w_s$ )(sibling$ t_1$ b$ ))a$ )b$ )):named a8 ))
(assert (! (=> (and (consistent$ t_2$ )(and (not (= (sibling$ t_2$ b$ )b$ ))(not (= a$ b$ ))))(= (sibling$ (fun_app$ (swapLeaves$ t_2$ w_a$ a$ w_s$ )(sibling$ t_2$ b$ ))a$ )b$ )):named a9 ))
...
(assert (! (forall ((?v0 A_tree$ )(?v1 A$ ))(=> (consistent$ ?v0 )(= (sibling$ ?v0 (sibling$ ?v0 ?v1 ))?v1 ))):named a11 ))
(assert (! (forall ((?v0 A_tree$ )(?v1 Nat$ )(?v2 A$ )(?v3 Nat$ )(?v4 A$ ))(= (height$ (fun_app$ (swapLeaves$ ?v0 ?v1 ?v2 ?v3 )?v4 ))(height$ ?v0 ))):named a12 ))
...
(assert (! (forall ((?v0 A_tree$ )(?v1 Nat$ )(?v2 A$ )(?v3 Nat$ )(?v4 A$ ))(=> (consistent$ ?v0 )(consistent$ (fun_app$ (swapLeaves$ ?v0 ?v1 ?v2 ?v3 )?v4 )))):named a17 ))
(check-sat )
;(get-unsat-core )
