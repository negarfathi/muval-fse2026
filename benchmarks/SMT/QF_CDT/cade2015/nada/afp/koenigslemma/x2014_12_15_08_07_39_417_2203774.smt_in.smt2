...
(declare-sort Node_node_sum_node_node_prod_sum$ 0)
(declare-sort Node_node_sum_node_node_sum_sum$ 0)
(declare-sort Node_node_sum_node_sum$ 0)
(declare-sort Node_node_node_prod_sum$ 0)
...
(declare-fun projl$a (Node_node_sum_node_node_prod_sum$)Node_node_sum$)
(declare-fun inl$a (Node_node_sum$ )Node_node_sum_node_node_prod_sum$)
(declare-fun projr$a (Node_node_sum_node_node_prod_sum$)Node_node_prod$)
(declare-fun inr$a (Node_node_prod$ )Node_node_sum_node_node_prod_sum$)
...
(declare-fun projl$d (Node_node_node_prod_sum$)Node$)
(declare-fun inl$d (Node$ )Node_node_node_prod_sum$)
(declare-fun projr$d (Node_node_node_prod_sum$)Node_node_prod$)
(declare-fun inr$d (Node_node_prod$ )Node_node_node_prod_sum$)
