...
(declare-fun lNil$e ()A_llist_bool_fun_llist$)
(declare-fun select$ (A_llist_bool_fun_llist$)A_llist_bool_fun$)
(declare-fun selecta$ (A_llist_bool_fun_llist$)A_llist_bool_fun_llist$)
(declare-fun lCons$e (A_llist_bool_fun$ A_llist_bool_fun_llist$ )A_llist_bool_fun_llist$)
