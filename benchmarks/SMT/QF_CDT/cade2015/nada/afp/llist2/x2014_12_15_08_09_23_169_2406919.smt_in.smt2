...
(assert (! (not (= (fun_app$ (ll2f$ t$ )(suc$ i$ ))none$ )):named a0 ))
(assert (! (= (fun_app$ (ll2f$ t$ )i$ )none$ ):named a1 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 Nat$ )(?v2 A$ ))(=> (and (= (fun_app$ (ll2f$ ?v0 )(suc$ ?v1 ))(some$ ?v2 ))(forall ((?v3 A$ ))(=> (= (fun_app$ (ll2f$ ?v0 )?v1 )(some$ ?v3 ))false )))false )):named a8 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 Nat$ )(?v2 A$ ))(=> (= (fun_app$ (ll2f$ ?v0 )(suc$ ?v1 ))(some$ ?v2 ))(exists ((?v3 A$ ))(= (fun_app$ (ll2f$ ?v0 )?v1 )(some$ ?v3 ))))):named a9 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (lset$ ?v0 )(ran$ (ll2f$ ?v0 ))):pattern ((lset$ ?v0 )))):named a10 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_set$ ))(=> (member$ ?v0 (finlsts$ ?v1 ))(= (fun_app$ (ll2f$ ?v0 )(llength$ ?v0 ))none$ ))):named a11 ))
(assert (! (forall ((?v0 A_option$ ))(! (= (is_none$ ?v0 )(= ?v0 none$ )):pattern ((is_none$ ?v0 )))):named a12 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ ))(= (= (some$ ?v0 )(some$ ?v1 ))(= ?v0 ?v1 ))):named a13 ))
(assert (! (forall ((?v0 A_option$ ))(= (forall ((?v1 A$ ))(not (= ?v0 (some$ ?v1 ))))(= ?v0 none$ ))):named a14 ))
(assert (! (forall ((?v0 A_option$ ))(= (not (= ?v0 none$ ))(exists ((?v1 A$ ))(= ?v0 (some$ ?v1 ))))):named a15 ))
(assert (! (forall ((?v0 A$ ))(! (= (is_none$ (some$ ?v0 ))false ):pattern ((some$ ?v0 )))):named a16 ))
