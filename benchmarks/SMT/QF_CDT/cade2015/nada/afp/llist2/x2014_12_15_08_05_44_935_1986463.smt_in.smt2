...
(declare-sort B_b_llist_b_llist_prod_prod$ 0)
...
(declare-fun fst$a (B_b_llist_b_llist_prod_prod$)B$)
(declare-fun snd$a (B_b_llist_b_llist_prod_prod$)B_llist_b_llist_prod$)
(declare-fun pair$a (B$ B_llist_b_llist_prod$ )B_b_llist_b_llist_prod_prod$)
(declare-sort B_b_llist_b_llist_prod_prod_llist$ 0)
(declare-fun lNil$a ()B_b_llist_b_llist_prod_prod_llist$)
(declare-fun lhd$a (B_b_llist_b_llist_prod_prod_llist$)B_b_llist_b_llist_prod_prod$)
(declare-fun ltl$a (B_b_llist_b_llist_prod_prod_llist$)B_b_llist_b_llist_prod_prod_llist$)
(declare-fun lCons$a (B_b_llist_b_llist_prod_prod$ B_b_llist_b_llist_prod_prod_llist$ )B_b_llist_b_llist_prod_prod_llist$)
...
(declare-fun lNil$b ()B_b_b_prod_prod_llist$)
(declare-fun lhd$b (B_b_b_prod_prod_llist$)B_b_b_prod_prod$)
(declare-fun ltl$b (B_b_b_prod_prod_llist$)B_b_b_prod_prod_llist$)
(declare-fun lCons$b (B_b_b_prod_prod$ B_b_b_prod_prod_llist$ )B_b_b_prod_prod_llist$)
(declare-sort B_llist_b_llist_prod_b_llist_b_llist_prod_prod$ 0)
(declare-fun fst$d (B_llist_b_llist_prod_b_llist_b_llist_prod_prod$)B_llist_b_llist_prod$)
(declare-fun snd$d (B_llist_b_llist_prod_b_llist_b_llist_prod_prod$)B_llist_b_llist_prod$)
(declare-fun pair$d (B_llist_b_llist_prod$ B_llist_b_llist_prod$ )B_llist_b_llist_prod_b_llist_b_llist_prod_prod$)
(declare-sort B_llist_b_llist_prod_b_llist_b_llist_prod_prod_llist$ 0)
(declare-sort B_llist_b_llist_prod_llist$ 0)
(declare-sort B_llist_b_llist_prod_llist_llist$ 0)
(declare-sort B_b_prod_llist$ 0)
(declare-sort B_llist_llist$ 0)
(declare-fun lNil$c ()B_llist_b_llist_prod_b_llist_b_llist_prod_prod_llist$)
(declare-fun lhd$c (B_llist_b_llist_prod_b_llist_b_llist_prod_prod_llist$)B_llist_b_llist_prod_b_llist_b_llist_prod_prod$)
(declare-fun ltl$c (B_llist_b_llist_prod_b_llist_b_llist_prod_prod_llist$)B_llist_b_llist_prod_b_llist_b_llist_prod_prod_llist$)
(declare-fun lCons$c (B_llist_b_llist_prod_b_llist_b_llist_prod_prod$ B_llist_b_llist_prod_b_llist_b_llist_prod_prod_llist$ )B_llist_b_llist_prod_b_llist_b_llist_prod_prod_llist$)
...
(declare-fun lNil$e ()B_llist_b_llist_prod_llist_llist$)
(declare-fun lhd$e (B_llist_b_llist_prod_llist_llist$)B_llist_b_llist_prod_llist$)
(declare-fun ltl$e (B_llist_b_llist_prod_llist_llist$)B_llist_b_llist_prod_llist_llist$)
(declare-fun lCons$e (B_llist_b_llist_prod_llist$ B_llist_b_llist_prod_llist_llist$ )B_llist_b_llist_prod_llist_llist$)
