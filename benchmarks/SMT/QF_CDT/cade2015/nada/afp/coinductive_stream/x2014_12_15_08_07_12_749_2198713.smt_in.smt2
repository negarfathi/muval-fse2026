...
(declare-fun lhd$c (A_stream_llist$)A_stream$)
(declare-fun ltl$c (A_stream_llist$)A_stream_llist$)
...
(declare-fun fst$d (A_b_stream_prod$)A$)
(declare-fun snd$d (A_b_stream_prod$)B_stream$)
(declare-fun pair$d (A$ B_stream$ )A_b_stream_prod$)
(declare-sort A_b_stream_prod_stream$ 0)
(declare-fun shd$h (A_b_stream_prod_stream$)A_b_stream_prod$)
(declare-fun stl$h (A_b_stream_prod_stream$)A_b_stream_prod_stream$)
(declare-fun sCons$h (A_b_stream_prod$ A_b_stream_prod_stream$ )A_b_stream_prod_stream$)
(declare-sort B_b_stream_prod$ 0)
(declare-fun fst$e (B_b_stream_prod$)B$)
(declare-fun snd$e (B_b_stream_prod$)B_stream$)
(declare-fun pair$e (B$ B_stream$ )B_b_stream_prod$)
(declare-sort B_b_stream_prod_stream$ 0)
(declare-fun shd$i (B_b_stream_prod_stream$)B_b_stream_prod$)
(declare-fun stl$i (B_b_stream_prod_stream$)B_b_stream_prod_stream$)
(declare-fun sCons$i (B_b_stream_prod$ B_b_stream_prod_stream$ )B_b_stream_prod_stream$)
...
(declare-fun shd$j (B_a_a_prod_prod_stream$)B_a_a_prod_prod$)
(declare-fun stl$j (B_a_a_prod_prod_stream$)B_a_a_prod_prod_stream$)
(declare-fun sCons$j (B_a_a_prod_prod$ B_a_a_prod_prod_stream$ )B_a_a_prod_prod_stream$)
...
(declare-fun shd$k (B_a_b_prod_prod_stream$)B_a_b_prod_prod$)
(declare-fun stl$k (B_a_b_prod_prod_stream$)B_a_b_prod_prod_stream$)
(declare-fun sCons$k (B_a_b_prod_prod$ B_a_b_prod_prod_stream$ )B_a_b_prod_prod_stream$)
(declare-sort B_b_a_prod_prod$ 0)
(declare-fun fst$h (B_b_a_prod_prod$)B$)
(declare-fun snd$h (B_b_a_prod_prod$)B_a_prod$)
(declare-fun pair$h (B$ B_a_prod$ )B_b_a_prod_prod$)
(declare-sort B_b_a_prod_prod_stream$ 0)
(declare-fun shd$l (B_b_a_prod_prod_stream$)B_b_a_prod_prod$)
(declare-fun stl$l (B_b_a_prod_prod_stream$)B_b_a_prod_prod_stream$)
(declare-fun sCons$l (B_b_a_prod_prod$ B_b_a_prod_prod_stream$ )B_b_a_prod_prod_stream$)
...
(declare-fun shd$n (A_a_a_prod_prod_stream$)A_a_a_prod_prod$)
(declare-fun stl$n (A_a_a_prod_prod_stream$)A_a_a_prod_prod_stream$)
(declare-fun sCons$n (A_a_a_prod_prod$ A_a_a_prod_prod_stream$ )A_a_a_prod_prod_stream$)
...
(declare-fun shd$o (A_a_b_prod_prod_stream$)A_a_b_prod_prod$)
(declare-fun stl$o (A_a_b_prod_prod_stream$)A_a_b_prod_prod_stream$)
(declare-fun sCons$o (A_a_b_prod_prod$ A_a_b_prod_prod_stream$ )A_a_b_prod_prod_stream$)
