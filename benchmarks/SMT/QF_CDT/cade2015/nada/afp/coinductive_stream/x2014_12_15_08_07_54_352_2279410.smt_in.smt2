...
(declare-sort A_stream_stream_llist$ 0)
...
(declare-fun lNil$b ()A_stream_stream_llist$)
(declare-fun lhd$b (A_stream_stream_llist$)A_stream_stream$)
(declare-fun ltl$b (A_stream_stream_llist$)A_stream_stream_llist$)
(declare-fun lCons$b (A_stream_stream$ A_stream_stream_llist$ )A_stream_stream_llist$)
