...
(declare-fun fst$c (A_b_a_prod_prod$)A$)
(declare-fun snd$c (A_b_a_prod_prod$)B_a_prod$)
(declare-fun pair$c (A$ B_a_prod$ )A_b_a_prod_prod$)
(declare-sort A_b_a_prod_prod_stream$ 0)
(declare-fun shd$e (A_b_a_prod_prod_stream$)A_b_a_prod_prod$)
(declare-fun stl$e (A_b_a_prod_prod_stream$)A_b_a_prod_prod_stream$)
(declare-fun sCons$e (A_b_a_prod_prod$ A_b_a_prod_prod_stream$ )A_b_a_prod_prod_stream$)
...
(declare-fun shd$g (B_a_prod_a_prod_stream$)B_a_prod_a_prod$)
(declare-fun stl$g (B_a_prod_a_prod_stream$)B_a_prod_a_prod_stream$)
(declare-fun sCons$g (B_a_prod_a_prod$ B_a_prod_a_prod_stream$ )B_a_prod_a_prod_stream$)
...
(declare-fun shd$h (B_a_prod_b_a_prod_prod_stream$)B_a_prod_b_a_prod_prod$)
(declare-fun stl$h (B_a_prod_b_a_prod_prod_stream$)B_a_prod_b_a_prod_prod_stream$)
(declare-fun sCons$h (B_a_prod_b_a_prod_prod$ B_a_prod_b_a_prod_prod_stream$ )B_a_prod_b_a_prod_prod_stream$)
...
(declare-sort B_a_prod_b_prod_stream$ 0)
(declare-fun shd$i (B_a_prod_b_prod_stream$)B_a_prod_b_prod$)
(declare-fun stl$i (B_a_prod_b_prod_stream$)B_a_prod_b_prod_stream$)
(declare-fun sCons$i (B_a_prod_b_prod$ B_a_prod_b_prod_stream$ )B_a_prod_b_prod_stream$)
(declare-sort B_b_b_a_prod_prod_prod$ 0)
(declare-fun fst$h (B_b_b_a_prod_prod_prod$)B$)
(declare-fun snd$h (B_b_b_a_prod_prod_prod$)B_b_a_prod_prod$)
(declare-fun pair$h (B$ B_b_a_prod_prod$ )B_b_b_a_prod_prod_prod$)
(declare-sort B_b_b_a_prod_prod_prod_stream$ 0)
(declare-fun shd$j (B_b_b_a_prod_prod_prod_stream$)B_b_b_a_prod_prod_prod$)
(declare-fun stl$j (B_b_b_a_prod_prod_prod_stream$)B_b_b_a_prod_prod_prod_stream$)
(declare-fun sCons$j (B_b_b_a_prod_prod_prod$ B_b_b_a_prod_prod_prod_stream$ )B_b_b_a_prod_prod_prod_stream$)
(declare-sort A_b_b_a_prod_prod_prod$ 0)
(declare-fun fst$i (A_b_b_a_prod_prod_prod$)A$)
(declare-fun snd$i (A_b_b_a_prod_prod_prod$)B_b_a_prod_prod$)
(declare-fun pair$i (A$ B_b_a_prod_prod$ )A_b_b_a_prod_prod_prod$)
(declare-sort A_b_b_a_prod_prod_prod_stream$ 0)
(declare-fun shd$k (A_b_b_a_prod_prod_prod_stream$)A_b_b_a_prod_prod_prod$)
(declare-fun stl$k (A_b_b_a_prod_prod_prod_stream$)A_b_b_a_prod_prod_prod_stream$)
(declare-fun sCons$k (A_b_b_a_prod_prod_prod$ A_b_b_a_prod_prod_prod_stream$ )A_b_b_a_prod_prod_prod_stream$)
...
(declare-fun shd$l (A_b_prod_stream$)A_b_prod$)
(declare-fun stl$l (A_b_prod_stream$)A_b_prod_stream$)
(declare-fun sCons$l (A_b_prod$ A_b_prod_stream$ )A_b_prod_stream$)
