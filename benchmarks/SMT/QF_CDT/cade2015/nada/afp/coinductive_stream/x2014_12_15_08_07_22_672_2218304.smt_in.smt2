...
(declare-fun fst$a (A_b_prod_llist_a_llist_prod$)A_b_prod_llist$)
(declare-fun snd$a (A_b_prod_llist_a_llist_prod$)A_llist$)
(declare-fun pair$a (A_b_prod_llist$ A_llist$ )A_b_prod_llist_a_llist_prod$)
(declare-sort A_b_prod_llist_a_llist_prod_llist$ 0)
(declare-sort A_b_prod_llist_a_llist_prod_stream$ 0)
(declare-fun lNil$c ()A_b_prod_llist_a_llist_prod_llist$)
(declare-fun lhd$c (A_b_prod_llist_a_llist_prod_llist$)A_b_prod_llist_a_llist_prod$)
(declare-fun ltl$c (A_b_prod_llist_a_llist_prod_llist$)A_b_prod_llist_a_llist_prod_llist$)
(declare-fun lCons$c (A_b_prod_llist_a_llist_prod$ A_b_prod_llist_a_llist_prod_llist$ )A_b_prod_llist_a_llist_prod_llist$)
(declare-fun shd$c (A_b_prod_llist_a_llist_prod_stream$)A_b_prod_llist_a_llist_prod$)
(declare-fun stl$c (A_b_prod_llist_a_llist_prod_stream$)A_b_prod_llist_a_llist_prod_stream$)
(declare-fun sCons$c (A_b_prod_llist_a_llist_prod$ A_b_prod_llist_a_llist_prod_stream$ )A_b_prod_llist_a_llist_prod_stream$)
(declare-sort A_b_prod_llist_b_llist_prod$ 0)
(declare-fun fst$b (A_b_prod_llist_b_llist_prod$)A_b_prod_llist$)
(declare-fun snd$b (A_b_prod_llist_b_llist_prod$)B_llist$)
(declare-fun pair$b (A_b_prod_llist$ B_llist$ )A_b_prod_llist_b_llist_prod$)
(declare-sort A_b_prod_llist_b_llist_prod_llist$ 0)
(declare-sort A_b_prod_llist_b_llist_prod_stream$ 0)
(declare-fun lNil$d ()A_b_prod_llist_b_llist_prod_llist$)
(declare-fun lhd$d (A_b_prod_llist_b_llist_prod_llist$)A_b_prod_llist_b_llist_prod$)
(declare-fun ltl$d (A_b_prod_llist_b_llist_prod_llist$)A_b_prod_llist_b_llist_prod_llist$)
(declare-fun lCons$d (A_b_prod_llist_b_llist_prod$ A_b_prod_llist_b_llist_prod_llist$ )A_b_prod_llist_b_llist_prod_llist$)
(declare-fun shd$d (A_b_prod_llist_b_llist_prod_stream$)A_b_prod_llist_b_llist_prod$)
(declare-fun stl$d (A_b_prod_llist_b_llist_prod_stream$)A_b_prod_llist_b_llist_prod_stream$)
(declare-fun sCons$d (A_b_prod_llist_b_llist_prod$ A_b_prod_llist_b_llist_prod_stream$ )A_b_prod_llist_b_llist_prod_stream$)
(declare-sort A_b_prod_stream_a_stream_prod$ 0)
(declare-fun fst$c (A_b_prod_stream_a_stream_prod$)A_b_prod_stream$)
(declare-fun snd$c (A_b_prod_stream_a_stream_prod$)A_stream$)
(declare-fun pair$c (A_b_prod_stream$ A_stream$ )A_b_prod_stream_a_stream_prod$)
(declare-sort A_b_prod_stream_a_stream_prod_llist$ 0)
(declare-sort A_b_prod_stream_a_stream_prod_stream$ 0)
(declare-fun lNil$e ()A_b_prod_stream_a_stream_prod_llist$)
(declare-fun lhd$e (A_b_prod_stream_a_stream_prod_llist$)A_b_prod_stream_a_stream_prod$)
(declare-fun ltl$e (A_b_prod_stream_a_stream_prod_llist$)A_b_prod_stream_a_stream_prod_llist$)
(declare-fun lCons$e (A_b_prod_stream_a_stream_prod$ A_b_prod_stream_a_stream_prod_llist$ )A_b_prod_stream_a_stream_prod_llist$)
(declare-fun shd$e (A_b_prod_stream_a_stream_prod_stream$)A_b_prod_stream_a_stream_prod$)
(declare-fun stl$e (A_b_prod_stream_a_stream_prod_stream$)A_b_prod_stream_a_stream_prod_stream$)
(declare-fun sCons$e (A_b_prod_stream_a_stream_prod$ A_b_prod_stream_a_stream_prod_stream$ )A_b_prod_stream_a_stream_prod_stream$)
(declare-sort A_b_prod_stream_b_stream_prod$ 0)
(declare-fun fst$d (A_b_prod_stream_b_stream_prod$)A_b_prod_stream$)
(declare-fun snd$d (A_b_prod_stream_b_stream_prod$)B_stream$)
(declare-fun pair$d (A_b_prod_stream$ B_stream$ )A_b_prod_stream_b_stream_prod$)
...
(declare-fun lNil$f ()A_b_prod_stream_b_stream_prod_llist$)
(declare-fun lhd$f (A_b_prod_stream_b_stream_prod_llist$)A_b_prod_stream_b_stream_prod$)
(declare-fun ltl$f (A_b_prod_stream_b_stream_prod_llist$)A_b_prod_stream_b_stream_prod_llist$)
(declare-fun lCons$f (A_b_prod_stream_b_stream_prod$ A_b_prod_stream_b_stream_prod_llist$ )A_b_prod_stream_b_stream_prod_llist$)
(declare-fun shd$f (A_b_prod_stream_b_stream_prod_stream$)A_b_prod_stream_b_stream_prod$)
(declare-fun stl$f (A_b_prod_stream_b_stream_prod_stream$)A_b_prod_stream_b_stream_prod_stream$)
(declare-fun sCons$f (A_b_prod_stream_b_stream_prod$ A_b_prod_stream_b_stream_prod_stream$ )A_b_prod_stream_b_stream_prod_stream$)
...
(declare-fun lhd$g (A_stream_llist$)A_stream$)
(declare-fun ltl$g (A_stream_llist$)A_stream_llist$)
(declare-fun lCons$g (A_stream$ A_stream_llist$ )A_stream_llist$)
(declare-fun shd$h (A_b_prod_stream_stream$)A_b_prod_stream$)
(declare-fun stl$h (A_b_prod_stream_stream$)A_b_prod_stream_stream$)
(declare-fun sCons$h (A_b_prod_stream$ A_b_prod_stream_stream$ )A_b_prod_stream_stream$)
...
(declare-fun shd$j (A_b_prod_llist_stream$)A_b_prod_llist$)
(declare-fun stl$j (A_b_prod_llist_stream$)A_b_prod_llist_stream$)
(declare-fun sCons$j (A_b_prod_llist$ A_b_prod_llist_stream$ )A_b_prod_llist_stream$)
(declare-fun shd$k (B_llist_stream$)B_llist$)
(declare-fun stl$k (B_llist_stream$)B_llist_stream$)
(declare-fun sCons$k (B_llist$ B_llist_stream$ )B_llist_stream$)
(declare-fun shd$l (A_llist_stream$)A_llist$)
(declare-fun stl$l (A_llist_stream$)A_llist_stream$)
(declare-fun sCons$l (A_llist$ A_llist_stream$ )A_llist_stream$)
(declare-sort A_b_prod_llist_a_llist_prod_stream_a_llist_stream_prod$ 0)
...
(declare-fun fst$e (A_b_prod_llist_a_llist_prod_stream_a_llist_stream_prod$)A_b_prod_llist_a_llist_prod_stream$)
(declare-fun snd$e (A_b_prod_llist_a_llist_prod_stream_a_llist_stream_prod$)A_llist_stream$)
(declare-fun pair$e (A_b_prod_llist_a_llist_prod_stream$ A_llist_stream$ )A_b_prod_llist_a_llist_prod_stream_a_llist_stream_prod$)
(declare-fun fst$f (A_b_prod_stream_b_stream_prod_stream_a_b_prod_stream_stream_prod$)A_b_prod_stream_b_stream_prod_stream$)
(declare-fun snd$f (A_b_prod_stream_b_stream_prod_stream_a_b_prod_stream_stream_prod$)A_b_prod_stream_stream$)
(declare-fun pair$f (A_b_prod_stream_b_stream_prod_stream$ A_b_prod_stream_stream$ )A_b_prod_stream_b_stream_prod_stream_a_b_prod_stream_stream_prod$)
(declare-fun fst$g (A_b_prod_stream_b_stream_prod_stream_b_stream_stream_prod$)A_b_prod_stream_b_stream_prod_stream$)
(declare-fun snd$g (A_b_prod_stream_b_stream_prod_stream_b_stream_stream_prod$)B_stream_stream$)
(declare-fun pair$g (A_b_prod_stream_b_stream_prod_stream$ B_stream_stream$ )A_b_prod_stream_b_stream_prod_stream_b_stream_stream_prod$)
(declare-fun fst$h (A_b_prod_stream_a_stream_prod_stream_a_b_prod_stream_stream_prod$)A_b_prod_stream_a_stream_prod_stream$)
(declare-fun snd$h (A_b_prod_stream_a_stream_prod_stream_a_b_prod_stream_stream_prod$)A_b_prod_stream_stream$)
(declare-fun pair$h (A_b_prod_stream_a_stream_prod_stream$ A_b_prod_stream_stream$ )A_b_prod_stream_a_stream_prod_stream_a_b_prod_stream_stream_prod$)
(declare-fun fst$i (A_b_prod_stream_a_stream_prod_stream_a_stream_stream_prod$)A_b_prod_stream_a_stream_prod_stream$)
(declare-fun snd$i (A_b_prod_stream_a_stream_prod_stream_a_stream_stream_prod$)A_stream_stream$)
(declare-fun pair$i (A_b_prod_stream_a_stream_prod_stream$ A_stream_stream$ )A_b_prod_stream_a_stream_prod_stream_a_stream_stream_prod$)
