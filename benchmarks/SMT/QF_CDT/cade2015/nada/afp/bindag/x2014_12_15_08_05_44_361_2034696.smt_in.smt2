...
(assert (! (not (subdag$ t$ lt$ )):named a0 ))
(assert (! (= t$ lt$ ):named a1 ))
(assert (! (forall ((?v0 Dag$ )(?v1 Dag$ )(?v2 Dag$ ))(=> (and (subdag$ ?v0 ?v1 )(subdag$ ?v1 ?v2 ))(subdag$ ?v0 ?v2 ))):named a2 ))
(assert (! (forall ((?v0 Dag$ )(?v1 Dag$ ))(=> (and (subdag$ ?v0 ?v1 )(subdag$ ?v1 ?v0 ))false )):named a3 ))
(assert (! (forall ((?v0 Dag$ )(?v1 Dag$ ))(=> (subdag$ ?v0 ?v1 )(not (= ?v0 ?v1 )))):named a4 ))
(assert (! (subdag$ t$ (node$ lt$ p$ rt$ )):named a5 ))
(assert (! (forall ((?v0 Dag$ )(?v1 Dag$ ))(=> (= t$ (node$ ?v0 p$ ?v1 ))false )):named a6 ))
(assert (! (forall ((?v0 Dag$ ))(! (= (subdag$ tip$ ?v0 )false ):pattern ((subdag$ tip$ ?v0 )))):named a7 ))
...
(assert (! (dag$ (fun_app$ l$ p$ )l$ r$ t$ ):named a11 ))
(assert (! (forall ((?v0 Dag$ )(?v1 Dag$ ))(! (= (less$ ?v0 ?v1 )(subdag$ ?v1 ?v0 )):pattern ((less$ ?v0 ?v1 )))):named a12 ))
(assert (! (dag$ (fun_app$ l$ p$ )l$ r$ lt$ ):named a13 ))
(assert (! (forall ((?v0 Ref$ )(?v1 Dag$ ))(= (member$ ?v0 (set_of$ ?v1 ))(exists ((?v2 Dag$ )(?v3 Dag$ ))(or (= ?v1 (node$ ?v2 ?v0 ?v3 ))(subdag$ ?v1 (node$ ?v2 ?v0 ?v3 )))))):named a14 ))
(assert (! (forall ((?v0 Dag$ )(?v1 Dag$ ))(=> (subdag$ ?v0 ?v1 )(less$a (size$ ?v1 )(size$ ?v0 )))):named a15 ))
(assert (! (dag$ q$ l$ r$ (node$ lt$ p$ rt$ )):named a16 ))
