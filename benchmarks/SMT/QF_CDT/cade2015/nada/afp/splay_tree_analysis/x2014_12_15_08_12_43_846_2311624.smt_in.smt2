...
(assert (! (=> (and (forall ((?v0 Real )(?v1 Real ))(=> (<= ?v0 ?v1 )(<= (+ (+ ?v0 (log$ 2.0 (+ (real$ (size1$ l$ ))1.0 )))(log$ 2.0 (+ 1.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ ))))))(+ (+ ?v1 (log$ 2.0 (+ (real$ (size1$ l$ ))1.0 )))(log$ 2.0 (+ 1.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))))))(and (forall ((?v0 Real )(?v1 Real ))(=> (<= ?v0 ?v1 )(<= (+ (+ (+ (* 2.0 (log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))1.0 )?v0 )(log$ 2.0 (+ 1.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ ))))))(+ (+ (+ (* 2.0 (log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))1.0 )?v1 )(log$ 2.0 (+ 1.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))))))(forall ((?v0 Real )(?v1 Real ))(=> (<= ?v0 ?v1 )(<= (+ (+ (+ (* 2.0 (log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))1.0 )(log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))?v0 )(+ (+ (+ (* 2.0 (log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))1.0 )(log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))?v1 ))))))(<= (- (+ (t_s_t$ f$ s$ )(phi$ (nxt_s_t$ f$ s$ )))(phi$ s$ ))(+ (+ (+ (* 2.0 (log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))1.0 )(log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))(+ (log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ ))))1.0 )))):named a6 ))
(assert (! (<= (log$ 2.0 (+ (real$ (size1$ l$ ))1.0 ))(log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ ))))):named a7 ))
(assert (! (<= (log$ 2.0 (+ 1.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ )))))(+ (log$ 2.0 (+ (real$ (size1$ l$ ))(real$ (size1$ r$ ))))1.0 )):named a8 ))
...
(assert (! (forall ((?v0 Num$ )(?v1 Real )(?v2 Real ))(= (times$ (numeral$ ?v0 )(+ ?v1 ?v2 ))(+ (times$ (numeral$ ?v0 )?v1 )(times$ (numeral$ ?v0 )?v2 )))):named a18 ))
(assert (! (forall ((?v0 Num$ ))(= (= (bit1$ ?v0 )one$ )false )):named a19 ))
(assert (! (forall ((?v0 Num$ ))(= (= one$ (bit1$ ?v0 ))false )):named a20 ))
(check-sat )
;(get-unsat-core )
