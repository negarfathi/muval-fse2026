...
(assert (! (not (= (lCons$ (lnth$ xsa$ (suc$ na$ ))(ldropn$ (suc$ (suc$ na$ ))xsa$ ))(ldropn$ (suc$ na$ )xsa$ ))):named a0 ))
(assert (! (= (lCons$ (lnth$ xs$ na$ )(ldropn$ (suc$ na$ )xs$ ))(ldropn$ na$ xs$ )):named a1 ))
(assert (! (=> (forall ((?v0 A$ )(?v1 A_llist$ ))(=> (= xsa$ (lCons$ ?v0 ?v1 ))false ))false ):named a2 ))
...
(assert (! (forall ((?v0 A_llist$ ))(=> (less$ (enat$ na$ )(llength$ ?v0 ))(= (lCons$ (lnth$ ?v0 na$ )(ldropn$ (suc$ na$ )?v0 ))(ldropn$ na$ ?v0 )))):named a11 ))
...
(assert (! (less$ (enat$ (suc$ na$ ))(llength$ xsa$ )):named a15 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A$ ))(= (iterates$ ?v0 ?v1 )(lCons$ ?v1 (iterates$ ?v0 (fun_app$a ?v0 ?v1 ))))):named a16 ))
(check-sat )
;(get-unsat-core )
