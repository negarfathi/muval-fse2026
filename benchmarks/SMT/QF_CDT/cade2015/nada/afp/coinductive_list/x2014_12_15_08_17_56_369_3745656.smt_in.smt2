...
(assert (! (not (= (lnth$ lNil$ n$ )(undefined$ n$ ))):named a0 ))
...
(assert (! (forall ((?v0 Nat$ ))(! (= (fun_app$b (ldropn$ ?v0 )lNil$ )lNil$ ):pattern ((ldropn$ ?v0 )))):named a6 ))
(assert (! (forall ((?v0 Enat$ ))(! (= (fun_app$b (ldrop$ ?v0 )lNil$ )lNil$ ):pattern ((ldrop$ ?v0 )))):named a7 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (lprefix$ lNil$ ?v0 )true ):pattern ((lprefix$ lNil$ ?v0 )))):named a8 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A_llist$ ))(= (fun_app$b (lappend$ (fun_app$b (lappend$ ?v0 )?v1 ))?v2 )(fun_app$b (lappend$ ?v0 )(fun_app$b (lappend$ ?v1 )?v2 )))):named a13 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (and (lprefix$ ?v0 ?v1 )(lprefix$ ?v1 ?v0 ))(= ?v0 ?v1 ))):named a14 ))
(check-sat )
;(get-unsat-core )
