...
(declare-sort Nat_b_fun_llist$ 0)
...
(declare-fun lNil$d ()Nat_b_fun_llist$)
(declare-fun selectb$ (Nat_b_fun_llist$)Nat_b_fun$)
(declare-fun selectc$ (Nat_b_fun_llist$)Nat_b_fun_llist$)
(declare-fun lCons$d (Nat_b_fun$ Nat_b_fun_llist$ )Nat_b_fun_llist$)
