...
(assert (! (fun_app$ (fun_app$a (llist_all2$ p$ )ys$ )zs$ ):named a3 ))
(assert (! (transp$ p$ ):named a4 ))
(assert (! (less$ (enat$ n$ )(llength$ xs$ )):named a5 ))
(assert (! (= (llength$ xs$ )(llength$ ys$ )):named a6 ))
(assert (! (fun_app$b (fun_app$c p$ (lnth$ xs$ n$ ))(lnth$ ys$ n$ )):named a7 ))
