...
(declare-fun nil$c ()B_a_b_prod_prod_list$)
(declare-fun hd$c (B_a_b_prod_prod_list$)B_a_b_prod_prod$)
(declare-fun tl$c (B_a_b_prod_prod_list$)B_a_b_prod_prod_list$)
(declare-fun cons$c (B_a_b_prod_prod$ B_a_b_prod_prod_list$ )B_a_b_prod_prod_list$)
