...
(assert (! (forall ((?v0 Enat$ )(?v1 Enat_enat_fun$ )(?v2 Enat$ )(?v3 Enat$ ))(=> (and (= ?v0 (fun_app$d ?v1 ?v2 ))(and (less_eq$ ?v2 ?v3 )(forall ((?v4 Enat$ )(?v5 Enat$ ))(=> (less_eq$ ?v4 ?v5 )(less_eq$ (fun_app$d ?v1 ?v4 )(fun_app$d ?v1 ?v5 ))))))(less_eq$ ?v0 (fun_app$d ?v1 ?v3 )))):named a8 ))
...
(assert (! (forall ((?v0 Enat$ )(?v1 Enat$ )(?v2 Enat_enat_fun$ )(?v3 Enat$ ))(=> (and (less_eq$ ?v0 ?v1 )(and (= (fun_app$d ?v2 ?v1 )?v3 )(forall ((?v4 Enat$ )(?v5 Enat$ ))(=> (less_eq$ ?v4 ?v5 )(less_eq$ (fun_app$d ?v2 ?v4 )(fun_app$d ?v2 ?v5 ))))))(less_eq$ (fun_app$d ?v2 ?v0 )?v3 ))):named a11 ))
