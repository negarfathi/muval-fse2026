...
(declare-fun fst$m (A_c_prod$)A$)
(declare-fun snd$m (A_c_prod$)C$)
(declare-fun pair$m (A$ C$ )A_c_prod$)
(declare-fun fst$n (C_a_prod$)C$)
(declare-fun snd$n (C_a_prod$)A$)
(declare-fun pair$n (C$ A$ )C_a_prod$)
