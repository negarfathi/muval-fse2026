...
(assert (! (not (compact$ lSup$ lprefix$ (lCons$ x$ xs$ ))):named a1 ))
...
(assert (! (compact$ lSup$ lprefix$ xs$ ):named a5 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(! (= (fun_app$a (fun_app$b lprefix$ (lCons$ ?v0 ?v1 ))(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(fun_app$a (fun_app$b lprefix$ ?v1 )?v3 ))):pattern ((fun_app$a (fun_app$b lprefix$ (lCons$ ?v0 ?v1 ))(lCons$ ?v2 ?v3 ))))):named a6 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist$ ))(= (fun_app$a (fun_app$b lprefix$ (lCons$ ?v0 ?v1 ))?v2 )(exists ((?v3 A_llist$ ))(and (= ?v2 (lCons$ ?v0 ?v3 ))(fun_app$a (fun_app$b lprefix$ ?v1 )?v3 ))))):named a7 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A$ ))(= (fun_app$c (lsetp$ ?v0 )?v1 )(or (exists ((?v2 A$ )(?v3 A_llist$ ))(and (= ?v0 (lCons$ ?v2 ?v3 ))(= ?v1 ?v2 )))(exists ((?v2 A_llist$ )(?v3 A$ )(?v4 A$ ))(and (= ?v0 (lCons$ ?v4 ?v2 ))(and (= ?v1 ?v3 )(fun_app$c (lsetp$ ?v2 )?v3 ))))))):named a18 ))
(check-sat )
;(get-unsat-core )
