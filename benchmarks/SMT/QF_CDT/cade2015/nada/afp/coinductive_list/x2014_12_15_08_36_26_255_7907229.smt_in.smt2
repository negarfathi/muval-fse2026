...
(declare-sort C_llist_llist_llist$ 0)
...
(declare-fun lNil$d ()C_llist_llist_llist$)
(declare-fun lhd$d (C_llist_llist_llist$)C_llist_llist$)
(declare-fun ltl$d (C_llist_llist_llist$)C_llist_llist_llist$)
(declare-fun lCons$d (C_llist_llist$ C_llist_llist_llist$ )C_llist_llist_llist$)
(declare-fun lNil$e ()D_llist_llist_llist$)
(declare-fun lhd$e (D_llist_llist_llist$)D_llist_llist$)
(declare-fun ltl$e (D_llist_llist_llist$)D_llist_llist_llist$)
(declare-fun lCons$e (D_llist_llist$ D_llist_llist_llist$ )D_llist_llist_llist$)
