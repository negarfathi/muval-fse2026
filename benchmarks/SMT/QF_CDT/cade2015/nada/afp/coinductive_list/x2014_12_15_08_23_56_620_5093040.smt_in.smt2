...
(assert (! (not (fun_app$ (fun_app$a lprefix$ (ldropWhile$ p$ xs$ ))(ldrop$ (llength$ (ltakeWhile$ p$ xs$ ))xs$ ))):named a0 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (and (fun_app$ (fun_app$a lprefix$ ?v0 )?v1 )(= (llength$ ?v0 )(llength$ ?v1 )))(= ?v0 ?v1 ))):named a4 ))
...
(assert (! (forall ((?v0 A_bool_fun$ )(?v1 A_llist$ ))(fun_app$ (fun_app$a lprefix$ (ltakeWhile$ ?v0 ?v1 ))?v1 )):named a10 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(! (=> (fun_app$ (fun_app$a lprefix$ ?v0 )?v1 )(= (fun_app$b (llcp$ ?v1 )?v0 )(llength$ ?v0 ))):pattern ((fun_app$b (llcp$ ?v1 )?v0 )))):named a11 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(! (=> (fun_app$ (fun_app$a lprefix$ ?v0 )?v1 )(= (fun_app$b (llcp$ ?v0 )?v1 )(llength$ ?v0 ))):pattern ((fun_app$b (llcp$ ?v0 )?v1 )))):named a12 ))
(assert (! (= finite_lprefix$ lprefix$ ):named a13 ))
(assert (! (forall ((?v0 A_bool_fun$ )(?v1 A_llist$ ))(= (lappend$ (ltakeWhile$ ?v0 ?v1 )(ldropWhile$ ?v0 ?v1 ))?v1 )):named a14 ))
(assert (! (forall ((?v0 A_bool_fun$ )(?v1 A_llist$ ))(less_eq$ (llength$ (ltakeWhile$ ?v0 ?v1 ))(llength$ ?v1 ))):named a15 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (fun_app$ (fun_app$a lprefix$ ?v0 )?v1 )(less_eq$ (llength$ ?v0 )(llength$ ?v1 )))):named a16 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$b (llcp$ ?v0 )?v0 )(llength$ ?v0 )):pattern ((llcp$ ?v0 )))):named a17 ))
(check-sat )
;(get-unsat-core )
