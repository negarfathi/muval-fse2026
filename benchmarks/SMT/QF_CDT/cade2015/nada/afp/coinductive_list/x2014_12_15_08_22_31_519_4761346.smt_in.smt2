...
(declare-fun fst$j (B_c_prod$)B$)
(declare-fun snd$j (B_c_prod$)C$)
(declare-fun pair$j (B$ C$ )B_c_prod$)
(declare-sort B_c_prod_llist$ 0)
(declare-fun lNil$m ()B_c_prod_llist$)
(declare-fun lhd$m (B_c_prod_llist$)B_c_prod$)
(declare-fun ltl$m (B_c_prod_llist$)B_c_prod_llist$)
(declare-fun lCons$m (B_c_prod$ B_c_prod_llist$ )B_c_prod_llist$)
(declare-sort C_b_prod$ 0)
(declare-fun fst$k (C_b_prod$)C$)
(declare-fun snd$k (C_b_prod$)B$)
(declare-fun pair$k (C$ B$ )C_b_prod$)
(declare-sort C_b_prod_llist$ 0)
(declare-fun lNil$n ()C_b_prod_llist$)
(declare-fun lhd$n (C_b_prod_llist$)C_b_prod$)
(declare-fun ltl$n (C_b_prod_llist$)C_b_prod_llist$)
(declare-fun lCons$n (C_b_prod$ C_b_prod_llist$ )C_b_prod_llist$)
(declare-sort B_a_prod$ 0)
(declare-sort A_a_prod$ 0)
(declare-sort B_a_c_prod_prod$ 0)
...
(declare-fun fst$n (B_a_c_prod_prod$)B$)
(declare-fun snd$n (B_a_c_prod_prod$)A_c_prod$)
(declare-fun pair$n (B$ A_c_prod$ )B_a_c_prod_prod$)
