...
(assert (! (not (fun_app$ (fun_app$a lprefix$ ys$ )xs$ )):named a0 ))
...
(assert (! (not (fun_app$ (fun_app$a lprefix$ xs$ )ys$ )):named a4 ))
(assert (! (not (fun_app$ (fun_app$a lprefix$ ys$ )xs$ )):named a5 ))
...
(assert (! (fun_app$ (fun_app$a lprefix$ xs$ )(lappend$ ys$ zs$ )):named a11 ))
(assert (! (= (lappend$ xs$ xs$a )(lappend$ ys$ zs$ )):named a12 ))
(assert (! (=> (forall ((?v0 A_llist$ ))(=> (= (lappend$ xs$ ?v0 )(lappend$ ys$ zs$ ))false ))false ):named a13 ))
(assert (! (less_eq$ (llength$ ys$ )(llength$ xs$ )):named a14 ))
(assert (! (= ys$ (ltake$ (llength$ ys$ )xs$ )):named a15 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(! (= (lstrict_prefix$ ?v0 ?v1 )(and (fun_app$ (fun_app$a lprefix$ ?v0 )?v1 )(not (= ?v0 ?v1 )))):pattern ((lstrict_prefix$ ?v0 ?v1 )))):named a16 ))
