...
(assert (! (not (= (lnth$ (lconcat$ (lappend$ (llist_of$ xss$ )(lCons$a (lCons$ x$ xs$ )xss$a )))(suc$ na$ ))(lnth$ (lnth$a (lappend$ (llist_of$ xss$ )(lCons$a (lCons$ x$ xs$ )xss$a ))(plus$ m$ (size$ xss$ )))n$ ))):named a0 ))
(assert (! (lnull$ (lconcat$ (llist_of$ xss$ ))):named a1 ))
(assert (! (=> (forall ((?v0 Nat$ ))(=> (= m$ (suc$ ?v0 ))false ))false ):named a2 ))
(assert (! (= na$ (plus$ n$a n$ )):named a3 ))
(assert (! (forall ((?v0 A_llist_llist$ )(?v1 A_llist_llist_llist$ )(?v2 A_llist_llist$ )(?v3 A_llist_llist_llist$ ))(= (= (lCons$b ?v0 ?v1 )(lCons$b ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a4 ))
...
(assert (! (forall ((?v0 A_llist_list$ )(?v1 A_llist_list$ ))(= (= (llist_of$ ?v0 )(llist_of$ ?v1 ))(= ?v0 ?v1 ))):named a7 ))
...
(assert (! (forall ((?v0 A_llist_llist$ )(?v1 A_llist_llist_llist$ )(?v2 Nat$ ))(! (= (lnth$b (lCons$b ?v0 ?v1 )(suc$ ?v2 ))(lnth$b ?v1 ?v2 )):pattern ((lnth$b (lCons$b ?v0 ?v1 )(suc$ ?v2 ))))):named a12 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist_llist$ )(?v2 Nat$ ))(! (= (lnth$a (lCons$a ?v0 ?v1 )(suc$ ?v2 ))(lnth$a ?v1 ?v2 )):pattern ((lnth$a (lCons$a ?v0 ?v1 )(suc$ ?v2 ))))):named a13 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 Nat$ ))(! (= (lnth$ (lCons$ ?v0 ?v1 )(suc$ ?v2 ))(lnth$ ?v1 ?v2 )):pattern ((lnth$ (lCons$ ?v0 ?v1 )(suc$ ?v2 ))))):named a14 ))
...
(assert (! (= xssa$ (lappend$ (llist_of$ xss$ )(lCons$a (lCons$ x$ xs$ )xss$a ))):named a18 ))
(assert (! (= xs$a (lconcat$ (lCons$a xs$ xss$a ))):named a19 ))
(assert (! (forall ((?v0 A_llist_llist_llist$ )(?v1 A_llist_llist_llist$ )(?v2 A_llist_llist_llist$ ))(= (lappend$a (lappend$a ?v0 ?v1 )?v2 )(lappend$a ?v0 (lappend$a ?v1 ?v2 )))):named a20 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ )(?v2 A_llist$ ))(= (lappend$b (lappend$b ?v0 ?v1 )?v2 )(lappend$b ?v0 (lappend$b ?v1 ?v2 )))):named a21 ))
(assert (! (forall ((?v0 A_llist_llist$ )(?v1 A_llist_llist$ )(?v2 A_llist_llist$ ))(= (lappend$ (lappend$ ?v0 ?v1 )?v2 )(lappend$ ?v0 (lappend$ ?v1 ?v2 )))):named a22 ))
(assert (! (= (lconcat$ xssa$ )(lCons$ x$ xs$a )):named a23 ))
(assert (! (= m$ (suc$ m$a )):named a24 ))
(assert (! (=> (forall ((?v0 A$ )(?v1 A_llist$ ))(=> (= (lconcat$ xssa$ )(lCons$ ?v0 ?v1 ))false ))false ):named a25 ))
(assert (! (forall ((?v0 Nat$ )(?v1 Nat$ ))(! (= (plus$ ?v0 (suc$ ?v1 ))(suc$ (plus$ ?v0 ?v1 ))):pattern ((plus$ ?v0 (suc$ ?v1 ))))):named a26 ))
(assert (! (forall ((?v0 A_llist_llist_llist$ )(?v1 A_llist_llist_llist$ ))(= (not (lnull$a (lappend$a ?v0 ?v1 )))(or (not (lnull$a ?v0 ))(not (lnull$a ?v1 ))))):named a27 ))
(assert (! (forall ((?v0 A_llist_llist$ )(?v1 A_llist_llist$ ))(= (not (lnull$b (lappend$ ?v0 ?v1 )))(or (not (lnull$b ?v0 ))(not (lnull$b ?v1 ))))):named a28 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (not (lnull$ (lappend$b ?v0 ?v1 )))(or (not (lnull$ ?v0 ))(not (lnull$ ?v1 ))))):named a29 ))
(check-sat )
;(get-unsat-core )
