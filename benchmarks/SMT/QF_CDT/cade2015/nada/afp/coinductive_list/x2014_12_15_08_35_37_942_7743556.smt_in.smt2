...
(assert (! (not (not (lfinite$ (inf_llist$ f$ )))):named a0 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_llist$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(=> (lstrict_prefix$ ?v0 ?v1 )(lfinite$a ?v0 ))):named a1 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$ )(?v1 A_a_prod_a_prod_llist$ ))(=> (lstrict_prefix$a ?v0 ?v1 )(lfinite$b ?v0 ))):named a2 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$ )(?v1 A_a_a_prod_prod_llist$ ))(=> (lstrict_prefix$b ?v0 ?v1 )(lfinite$c ?v0 ))):named a3 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_llist$ ))(=> (lstrict_prefix$c ?v0 ?v1 )(lfinite$d ?v0 ))):named a4 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (lstrict_prefix$d ?v0 ?v1 )(lfinite$ ?v0 ))):named a5 ))
(assert (! (forall ((?v0 Nat_a_a_prod_fun$ ))(not (= (inf_llist$a ?v0 )lNil$d ))):named a6 ))
...
(assert (! (= (lfinite$b lNil$b )true ):named a15 ))
(assert (! (= (lfinite$c lNil$c )true ):named a16 ))
(assert (! (= (lfinite$d lNil$d )true ):named a17 ))
(assert (! (= (lfinite$ lNil$ )true ):named a18 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (lfinite$d (lzip$ ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$ ?v1 )))):named a19 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_a_prod_llist$ ))(= (lfinite$c (lzip$a ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$d ?v1 )))):named a20 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_llist$ ))(= (lfinite$b (lzip$b ?v0 ?v1 ))(or (lfinite$d ?v0 )(lfinite$ ?v1 )))):named a21 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_llist$ ))(= (lfinite$a (lzip$c ?v0 ?v1 ))(or (lfinite$d ?v0 )(lfinite$d ?v1 )))):named a22 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$e (lzip$d ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$b ?v1 )))):named a23 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_a_a_prod_prod_llist$ ))(= (lfinite$f (lzip$e ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$c ?v1 )))):named a24 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$ )(?v1 A_llist$ ))(= (lfinite$g (lzip$f ?v0 ?v1 ))(or (lfinite$b ?v0 )(lfinite$ ?v1 )))):named a25 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$ )(?v1 A_llist$ ))(= (lfinite$h (lzip$g ?v0 ?v1 ))(or (lfinite$c ?v0 )(lfinite$ ?v1 )))):named a26 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(= (lfinite$i (lzip$h ?v0 ?v1 ))(or (lfinite$ ?v0 )(lfinite$a ?v1 )))):named a27 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$j (lzip$i ?v0 ?v1 ))(or (lfinite$d ?v0 )(lfinite$b ?v1 )))):named a28 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun$ )(?v1 A_a_prod_a_a_prod_prod$ ))(not (lfinite$a (iterates$ ?v0 ?v1 )))):named a29 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_a_a_prod_a_prod_fun$ )(?v1 A_a_prod_a_prod$ ))(not (lfinite$b (iterates$a ?v0 ?v1 )))):named a30 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_a_a_a_prod_prod_fun$ )(?v1 A_a_a_prod_prod$ ))(not (lfinite$c (iterates$b ?v0 ?v1 )))):named a31 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_fun$ )(?v1 A_a_prod$ ))(not (lfinite$d (iterates$c ?v0 ?v1 )))):named a32 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A$ ))(not (lfinite$ (iterates$d ?v0 ?v1 )))):named a33 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(! (= (lfinite$a (lCons$a ?v0 ?v1 ))(lfinite$a ?v1 )):pattern ((lCons$a ?v0 ?v1 )))):named a34 ))
(assert (! (forall ((?v0 A_a_prod_a_prod$ )(?v1 A_a_prod_a_prod_llist$ ))(! (= (lfinite$b (lCons$b ?v0 ?v1 ))(lfinite$b ?v1 )):pattern ((lCons$b ?v0 ?v1 )))):named a35 ))
(assert (! (forall ((?v0 A_a_a_prod_prod$ )(?v1 A_a_a_prod_prod_llist$ ))(! (= (lfinite$c (lCons$c ?v0 ?v1 ))(lfinite$c ?v1 )):pattern ((lCons$c ?v0 ?v1 )))):named a36 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ ))(! (= (lfinite$d (lCons$d ?v0 ?v1 ))(lfinite$d ?v1 )):pattern ((lCons$d ?v0 ?v1 )))):named a37 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ ))(! (= (lfinite$ (lCons$ ?v0 ?v1 ))(lfinite$ ?v1 )):pattern ((lCons$ ?v0 ?v1 )))):named a38 ))
...
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_llist$ ))(= (lfinite$a (ltl$a ?v0 ))(lfinite$a ?v0 ))):named a44 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_llist$ ))(= (lfinite$b (ltl$b ?v0 ))(lfinite$b ?v0 ))):named a45 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_llist$ ))(= (lfinite$c (ltl$c ?v0 ))(lfinite$c ?v0 ))):named a46 ))
(assert (! (forall ((?v0 A_a_prod_llist$ ))(= (lfinite$d (ltl$d ?v0 ))(lfinite$d ?v0 ))):named a47 ))
(assert (! (forall ((?v0 A_llist$ ))(= (lfinite$ (ltl$ ?v0 ))(lfinite$ ?v0 ))):named a48 ))
...
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_list$ ))(lfinite$a (llist_of$ ?v0 ))):named a54 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_list$ ))(lfinite$b (llist_of$a ?v0 ))):named a55 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_list$ ))(lfinite$c (llist_of$b ?v0 ))):named a56 ))
(assert (! (forall ((?v0 A_a_prod_list$ ))(lfinite$d (llist_of$c ?v0 ))):named a57 ))
(assert (! (forall ((?v0 A_list$ ))(lfinite$ (llist_of$d ?v0 ))):named a58 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ )(?v2 A_a_prod$ )(?v3 A_a_prod_llist$ ))(= (= (lCons$d ?v0 ?v1 )(lCons$d ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a59 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(= (= (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a60 ))
(assert (! (forall ((?v0 A_a_prod_list$ )(?v1 A_a_prod_list$ ))(= (= (llist_of$c ?v0 )(llist_of$c ?v1 ))(= ?v0 ?v1 ))):named a61 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_list$ ))(= (= (llist_of$d ?v0 )(llist_of$d ?v1 ))(= ?v0 ?v1 ))):named a62 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ )(?v2 A_a_prod_llist$ ))(! (= (lappend$c (lCons$d ?v0 ?v1 )?v2 )(lCons$d ?v0 (lappend$c ?v1 ?v2 ))):pattern ((lappend$c (lCons$d ?v0 ?v1 )?v2 )))):named a63 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist$ ))(! (= (lappend$d (lCons$ ?v0 ?v1 )?v2 )(lCons$ ?v0 (lappend$d ?v1 ?v2 ))):pattern ((lappend$d (lCons$ ?v0 ?v1 )?v2 )))):named a64 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_llist$ ))(= (not (lnull$a (lappend$c ?v0 ?v1 )))(or (not (lnull$a ?v0 ))(not (lnull$a ?v1 ))))):named a65 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (not (lnull$ (lappend$d ?v0 ?v1 )))(or (not (lnull$ ?v0 ))(not (lnull$ ?v1 ))))):named a66 ))
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_llist$ ))(= (lnull$a (lappend$c ?v0 ?v1 ))(and (lnull$a ?v0 )(lnull$a ?v1 )))):named a67 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (lnull$ (lappend$d ?v0 ?v1 ))(and (lnull$ ?v0 )(lnull$ ?v1 )))):named a68 ))
(check-sat )
;(get-unsat-core )
