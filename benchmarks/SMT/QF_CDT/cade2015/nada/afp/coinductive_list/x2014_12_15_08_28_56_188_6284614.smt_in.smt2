...
(assert (! (and (less_eq$ (llength$ xs$ )(llength$ ys$ ))(= (ltake$ (llength$ xs$ )ys$ )xs$ )):named a1 ))
...
(assert (! (or (and (less_eq$ (llength$ xs$ )(llength$ ys$ ))(= (ltake$ (llength$ xs$ )ys$ )xs$ ))(exists ((?v0 Nat$ ))(and (less$ (enat$ ?v0 )(min$ (llength$ xs$ )(llength$ ys$ )))(and (= (ltake$ (enat$ ?v0 )xs$ )(ltake$ (enat$ ?v0 )ys$ ))(fun_app$ (fun_app$a r$ (lnth$ xs$ ?v0 ))(lnth$ ys$ ?v0 )))))):named a6 ))
(assert (! (forall ((?v0 A_a_bool_fun_fun$ )(?v1 A_llist$ ))(! (= (llexord$ ?v0 lNil$ ?v1 )true ):pattern ((llexord$ ?v0 lNil$ ?v1 )))):named a7 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 A_a_bool_fun_fun$ )(?v2 A_llist$ ))(! (=> (lnull$ ?v0 )(= (llexord$ ?v1 ?v2 ?v0 )(lnull$ ?v2 ))):pattern ((llexord$ ?v1 ?v2 ?v0 )))):named a9 ))
