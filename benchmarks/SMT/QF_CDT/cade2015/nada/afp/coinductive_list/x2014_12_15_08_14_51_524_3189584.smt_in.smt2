...
(assert (! (not (= (ltl$ (fun_app$ (ltake$ n$ )xs$ ))(fun_app$ (ltake$ (epred$ n$ ))(ltl$ xs$ )))):named a1 ))
(assert (! (forall ((?v0 A_llist$ ))(= (epred$ (llength$ ?v0 ))(llength$ (ltl$ ?v0 )))):named a2 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A$ ))(= (ltl$ (iterates$ ?v0 ?v1 ))(iterates$ ?v0 (fun_app$a ?v0 ?v1 )))):named a3 ))
(assert (! (forall ((?v0 Enat$ )(?v1 A_llist$ ))(=> (and (not (= ?v0 zero$ ))(not (lnull$ ?v1 )))(= (ltl$ (fun_app$ (ltake$ ?v0 )?v1 ))(fun_app$ (ltake$ (epred$ ?v0 ))(ltl$ ?v1 ))))):named a4 ))
...
(assert (! (forall ((?v0 Nat$ )(?v1 A_llist$ ))(! (= (ldropn$ ?v0 ?v1 )(compow$ ?v0 uu$ ?v1 )):pattern ((ldropn$ ?v0 ?v1 )))):named a11 ))
