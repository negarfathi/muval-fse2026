...
(assert (! (not (lsorted$ less_eq$ (ldrop$ n$ xs$ ))):named a0 ))
...
(assert (! (forall ((?v0 A_llist$ )(?v1 Nat$ ))(=> (lsorted$ less_eq$ ?v0 )(lsorted$ less_eq$ (ldropn$ ?v1 ?v0 )))):named a7 ))
(assert (! (lsorted$ less_eq$ lNil$ ):named a8 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(=> (and (lprefix$ ?v0 ?v1 )(lsorted$ less_eq$ ?v1 ))(lsorted$ less_eq$ ?v0 ))):named a9 ))
...
(assert (! (forall ((?v0 A_llist$ ))(=> (lsorted$ less_eq$ ?v0 )(lsorted$ less_eq$ (ltl$ ?v0 )))):named a11 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 Enat$ ))(=> (lsorted$ less_eq$ ?v0 )(lsorted$ less_eq$ (ltake$ ?v1 ?v0 )))):named a12 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ ))(= (member$ ?v0 (atMost$ less_eq$ ?v1 ))(fun_app$ (fun_app$a less_eq$ ?v0 )?v1 ))):named a13 ))
(assert (! (forall ((?v0 A$ )(?v1 A$ ))(= (member$ ?v0 (atLeast$ less_eq$ ?v1 ))(fun_app$ (fun_app$a less_eq$ ?v1 )?v0 ))):named a14 ))
