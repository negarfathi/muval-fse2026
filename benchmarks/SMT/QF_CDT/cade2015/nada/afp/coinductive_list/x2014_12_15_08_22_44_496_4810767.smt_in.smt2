...
(assert (! (not (mcont$ lSup$ lprefix$ lSup$ lprefix$ (ltakeWhile$ p$ ))):named a2 ))
...
(assert (! (forall ((?v0 Enat$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (ldrop$ ?v0 ))):named a10 ))
(assert (! (forall ((?v0 Nat$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (ldropn$ ?v0 ))):named a11 ))
(assert (! (forall ((?v0 A_llist_set_a_llist_fun$ )(?v1 A_llist_a_llist_bool_fun_fun$ )(?v2 A_llist_set_a_llist_fun$ )(?v3 A_llist_a_llist_bool_fun_fun$ )(?v4 A_llist_a_llist_fun$ )(?v5 A_llist$ )(?v6 A_llist$ ))(=> (and (mcont$ ?v0 ?v1 ?v2 ?v3 ?v4 )(fun_app$a (fun_app$b ?v1 ?v5 )?v6 ))(fun_app$a (fun_app$b ?v3 (fun_app$ ?v4 ?v5 ))(fun_app$ ?v4 ?v6 )))):named a12 ))
(assert (! (forall ((?v0 A$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (uu$ ?v0 ))):named a13 ))
(assert (! (forall ((?v0 A_a_fun$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (lmap$ ?v0 ))):named a14 ))
(assert (! (forall ((?v0 Enat$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (ltake$ ?v0 ))):named a15 ))
(assert (! (forall ((?v0 A_llist$ ))(mcont$ lSup$ lprefix$ lSup$ lprefix$ (lappend$ ?v0 ))):named a16 ))
