...
(assert (! (not (fun_app$ (fun_app$a lprefix$ (fun_app$b (ltakeWhile$ p$ )xs$ ))xs$ )):named a0 ))
...
(assert (! (forall ((?v0 A_bool_fun$ ))(monotone$ lprefix$ lprefix$ (ltakeWhile$ ?v0 ))):named a9 ))
...
(assert (! (forall ((?v0 A_bool_fun$ ))(! (= (fun_app$b (ltakeWhile$ ?v0 )lNil$ )lNil$ ):pattern ((ltakeWhile$ ?v0 )))):named a11 ))
