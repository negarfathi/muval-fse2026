...
(assert (! (not (= (llast$ xs$ )undefined$ )):named a0 ))
(assert (! (not (lfinite$ xs$ )):named a1 ))
(assert (! (= (llast$a lNil$a )undefined$a ):named a2 ))
(assert (! (= (llast$ lNil$ )undefined$ ):named a3 ))
...
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_a_a_prod_a_a_prod_prod_fun$ )(?v1 A_a_prod_a_a_prod_prod$ ))(not (lfinite$a (iterates$ ?v0 ?v1 )))):named a19 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_a_a_prod_a_prod_fun$ )(?v1 A_a_prod_a_prod$ ))(not (lfinite$b (iterates$a ?v0 ?v1 )))):named a20 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_a_a_a_prod_prod_fun$ )(?v1 A_a_a_prod_prod$ ))(not (lfinite$c (iterates$b ?v0 ?v1 )))):named a21 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_fun$ )(?v1 A_a_prod$ ))(not (lfinite$d (iterates$c ?v0 ?v1 )))):named a22 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A$ ))(not (lfinite$ (iterates$d ?v0 ?v1 )))):named a23 ))
...
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(! (= (lfinite$a (lCons$b ?v0 ?v1 ))(lfinite$a ?v1 )):pattern ((lCons$b ?v0 ?v1 )))):named a34 ))
(assert (! (forall ((?v0 A_a_prod_a_prod$ )(?v1 A_a_prod_a_prod_llist$ ))(! (= (lfinite$b (lCons$c ?v0 ?v1 ))(lfinite$b ?v1 )):pattern ((lCons$c ?v0 ?v1 )))):named a35 ))
(assert (! (forall ((?v0 A_a_a_prod_prod$ )(?v1 A_a_a_prod_prod_llist$ ))(! (= (lfinite$c (lCons$d ?v0 ?v1 ))(lfinite$c ?v1 )):pattern ((lCons$d ?v0 ?v1 )))):named a36 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ ))(! (= (lfinite$d (lCons$a ?v0 ?v1 ))(lfinite$d ?v1 )):pattern ((lCons$a ?v0 ?v1 )))):named a37 ))
...
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_list$ ))(lfinite$a (llist_of$ ?v0 ))):named a44 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_list$ ))(lfinite$b (llist_of$a ?v0 ))):named a45 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_list$ ))(lfinite$c (llist_of$b ?v0 ))):named a46 ))
(assert (! (forall ((?v0 A_a_prod_list$ ))(lfinite$d (llist_of$c ?v0 ))):named a47 ))
(assert (! (forall ((?v0 A_list$ ))(lfinite$ (llist_of$d ?v0 ))):named a48 ))
...
(assert (! (forall ((?v0 A_a_prod_llist$ ))(= (lfinite$d (ltl$a ?v0 ))(lfinite$d ?v0 ))):named a52 ))
...
(assert (! (forall ((?v0 A_a_prod_llist$ )(?v1 A_a_prod_llist$ ))(= (lfinite$d (fun_app$ (lappend$c ?v0 )?v1 ))(and (lfinite$d ?v0 )(lfinite$d ?v1 )))):named a57 ))
(assert (! (forall ((?v0 A_llist$ )(?v1 A_llist$ ))(= (lfinite$ (fun_app$a (lappend$d ?v0 )?v1 ))(and (lfinite$ ?v0 )(lfinite$ ?v1 )))):named a58 ))
(assert (! (forall ((?v0 A_a_fun$ )(?v1 A_llist$ ))(= (lfinite$ (lmap$ ?v0 ?v1 ))(lfinite$ ?v1 ))):named a59 ))
(assert (! (forall ((?v0 A_a_prod_a_fun$ )(?v1 A_a_prod_llist$ ))(= (lfinite$ (lmap$a ?v0 ?v1 ))(lfinite$d ?v1 ))):named a60 ))
(assert (! (forall ((?v0 A_a_a_prod_fun$ )(?v1 A_llist$ ))(= (lfinite$d (lmap$b ?v0 ?v1 ))(lfinite$ ?v1 ))):named a61 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_fun$ )(?v1 A_a_prod_llist$ ))(= (lfinite$d (lmap$c ?v0 ?v1 ))(lfinite$d ?v1 ))):named a62 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_a_fun$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$ (lmap$d ?v0 ?v1 ))(lfinite$b ?v1 ))):named a63 ))
(assert (! (forall ((?v0 A_a_a_prod_prod_a_fun$ )(?v1 A_a_a_prod_prod_llist$ ))(= (lfinite$ (lmap$e ?v0 ?v1 ))(lfinite$c ?v1 ))):named a64 ))
(assert (! (forall ((?v0 A_a_a_prod_a_prod_fun$ )(?v1 A_llist$ ))(= (lfinite$b (lmap$f ?v0 ?v1 ))(lfinite$ ?v1 ))):named a65 ))
(assert (! (forall ((?v0 A_a_a_a_prod_prod_fun$ )(?v1 A_llist$ ))(= (lfinite$c (lmap$g ?v0 ?v1 ))(lfinite$ ?v1 ))):named a66 ))
(assert (! (forall ((?v0 A_a_prod_a_a_prod_prod_a_fun$ )(?v1 A_a_prod_a_a_prod_prod_llist$ ))(= (lfinite$ (lmap$h ?v0 ?v1 ))(lfinite$a ?v1 ))):named a67 ))
(assert (! (forall ((?v0 A_a_prod_a_prod_a_a_prod_fun$ )(?v1 A_a_prod_a_prod_llist$ ))(= (lfinite$d (lmap$i ?v0 ?v1 ))(lfinite$b ?v1 ))):named a68 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ )(?v2 A_a_prod$ )(?v3 A_a_prod_llist$ ))(= (= (lCons$a ?v0 ?v1 )(lCons$a ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a69 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A$ )(?v3 A_llist$ ))(= (= (lCons$ ?v0 ?v1 )(lCons$ ?v2 ?v3 ))(and (= ?v0 ?v2 )(= ?v1 ?v3 )))):named a70 ))
(assert (! (forall ((?v0 A_a_prod_list$ )(?v1 A_a_prod_list$ ))(= (= (llist_of$c ?v0 )(llist_of$c ?v1 ))(= ?v0 ?v1 ))):named a71 ))
(assert (! (forall ((?v0 A_list$ )(?v1 A_list$ ))(= (= (llist_of$d ?v0 )(llist_of$d ?v1 ))(= ?v0 ?v1 ))):named a72 ))
(assert (! (forall ((?v0 A_a_prod$ )(?v1 A_a_prod_llist$ )(?v2 A_a_prod_llist$ ))(! (= (fun_app$ (lappend$c (lCons$a ?v0 ?v1 ))?v2 )(lCons$a ?v0 (fun_app$ (lappend$c ?v1 )?v2 ))):pattern ((fun_app$ (lappend$c (lCons$a ?v0 ?v1 ))?v2 )))):named a73 ))
(assert (! (forall ((?v0 A$ )(?v1 A_llist$ )(?v2 A_llist$ ))(! (= (fun_app$a (lappend$d (lCons$ ?v0 ?v1 ))?v2 )(lCons$ ?v0 (fun_app$a (lappend$d ?v1 )?v2 ))):pattern ((fun_app$a (lappend$d (lCons$ ?v0 ?v1 ))?v2 )))):named a74 ))
(assert (! (forall ((?v0 A_a_prod_llist$ ))(! (= (fun_app$ (lappend$c ?v0 )lNil$a )?v0 ):pattern ((lappend$c ?v0 )))):named a75 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$a (lappend$d ?v0 )lNil$ )?v0 ):pattern ((lappend$d ?v0 )))):named a76 ))
(assert (! (forall ((?v0 A_a_prod_llist$ ))(! (= (fun_app$ (lappend$c lNil$a )?v0 )?v0 ):pattern ((fun_app$ (lappend$c lNil$a )?v0 )))):named a77 ))
(assert (! (forall ((?v0 A_llist$ ))(! (= (fun_app$a (lappend$d lNil$ )?v0 )?v0 ):pattern ((fun_app$a (lappend$d lNil$ )?v0 )))):named a78 ))
(check-sat )
;(get-unsat-core )
