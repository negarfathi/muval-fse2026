...
(declare-sort Rule_rule_sum_stream$ 0)
(declare-fun shd$a (Rule_rule_sum_stream$)Rule_rule_sum$)
(declare-fun stl$a (Rule_rule_sum_stream$)Rule_rule_sum_stream$)
(declare-fun sCons$a (Rule_rule_sum$ Rule_rule_sum_stream$ )Rule_rule_sum_stream$)
...
(declare-sort Rule_list_rule_sum$ 0)
(declare-sort Rule_rule_rule_sum_sum$ 0)
(declare-sort Rule_rule_list_sum$ 0)
(declare-sort Rule_rule_sum_list$ 0)
(declare-sort Rule_list_list$ 0)
(declare-fun projl$a (Rule_list_rule_sum$)Rule_list$)
(declare-fun inl$a (Rule_list$ )Rule_list_rule_sum$)
(declare-fun projr$a (Rule_list_rule_sum$)Rule$)
(declare-fun inr$a (Rule$ )Rule_list_rule_sum$)
(declare-fun projl$b (Rule_rule_rule_sum_sum$)Rule$)
(declare-fun inl$b (Rule$ )Rule_rule_rule_sum_sum$)
(declare-fun projr$b (Rule_rule_rule_sum_sum$)Rule_rule_sum$)
(declare-fun inr$b (Rule_rule_sum$ )Rule_rule_rule_sum_sum$)
(declare-fun projl$c (Rule_rule_list_sum$)Rule$)
(declare-fun inl$c (Rule$ )Rule_rule_list_sum$)
(declare-fun projr$c (Rule_rule_list_sum$)Rule_list$)
(declare-fun inr$c (Rule_list$ )Rule_rule_list_sum$)
(declare-fun nil$a ()Rule_rule_sum_list$)
(declare-fun hd$a (Rule_rule_sum_list$)Rule_rule_sum$)
(declare-fun tl$a (Rule_rule_sum_list$)Rule_rule_sum_list$)
(declare-fun cons$a (Rule_rule_sum$ Rule_rule_sum_list$ )Rule_rule_sum_list$)
