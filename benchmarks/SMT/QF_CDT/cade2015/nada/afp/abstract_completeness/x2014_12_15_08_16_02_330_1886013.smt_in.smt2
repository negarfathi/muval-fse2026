...
(declare-fun shd$b (Rule_stream_stream_stream$)Rule_stream_stream$)
(declare-fun stl$b (Rule_stream_stream_stream$)Rule_stream_stream_stream$)
(declare-fun sCons$b (Rule_stream_stream$ Rule_stream_stream_stream$ )Rule_stream_stream_stream$)
(declare-fun r$ ()Rule$ )
