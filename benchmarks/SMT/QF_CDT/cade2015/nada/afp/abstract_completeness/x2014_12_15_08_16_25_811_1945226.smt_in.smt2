...
(declare-fun fst$b (Rule_rule_prod_rule_rule_prod_prod$)Rule_rule_prod$)
(declare-fun snd$b (Rule_rule_prod_rule_rule_prod_prod$)Rule_rule_prod$)
(declare-fun pair$b (Rule_rule_prod$ Rule_rule_prod$ )Rule_rule_prod_rule_rule_prod_prod$)
...
(declare-fun fst$d (Rule_rule_rule_prod_prod$)Rule$)
(declare-fun snd$d (Rule_rule_rule_prod_prod$)Rule_rule_prod$)
(declare-fun pair$d (Rule$ Rule_rule_prod$ )Rule_rule_rule_prod_prod$)
...
(declare-fun fst$g (State_state_rule_prod_prod$)State$)
(declare-fun snd$g (State_state_rule_prod_prod$)State_rule_prod$)
(declare-fun pair$g (State$ State_rule_prod$ )State_state_rule_prod_prod$)
...
(declare-fun fst$h (Rule_state_rule_prod_prod$)Rule$)
(declare-fun snd$h (Rule_state_rule_prod_prod$)State_rule_prod$)
(declare-fun pair$h (Rule$ State_rule_prod$ )Rule_state_rule_prod_prod$)
(declare-sort Rule_state_rule_prod_prod_stream$ 0)
(declare-fun shd$j (Rule_state_rule_prod_prod_stream$)Rule_state_rule_prod_prod$)
(declare-fun stl$j (Rule_state_rule_prod_prod_stream$)Rule_state_rule_prod_prod_stream$)
(declare-fun sCons$j (Rule_state_rule_prod_prod$ Rule_state_rule_prod_prod_stream$ )Rule_state_rule_prod_prod_stream$)
...
(declare-fun pair$i (Rule_rule_prod$ State$ )Rule_rule_prod_state_prod$)
(declare-sort Rule_rule_prod_state_prod_stream$ 0)
(declare-fun shd$k (Rule_rule_prod_state_prod_stream$)Rule_rule_prod_state_prod$)
(declare-fun stl$k (Rule_rule_prod_state_prod_stream$)Rule_rule_prod_state_prod_stream$)
(declare-fun sCons$k (Rule_rule_prod_state_prod$ Rule_rule_prod_state_prod_stream$ )Rule_rule_prod_state_prod_stream$)
(declare-sort State_rule_rule_prod_prod$ 0)
(declare-fun fst$j (State_rule_rule_prod_prod$)State$)
(declare-fun snd$j (State_rule_rule_prod_prod$)Rule_rule_prod$)
(declare-fun pair$j (State$ Rule_rule_prod$ )State_rule_rule_prod_prod$)
(declare-sort State_rule_rule_prod_prod_stream$ 0)
(declare-fun shd$l (State_rule_rule_prod_prod_stream$)State_rule_rule_prod_prod$)
(declare-fun stl$l (State_rule_rule_prod_prod_stream$)State_rule_rule_prod_prod_stream$)
(declare-fun sCons$l (State_rule_rule_prod_prod$ State_rule_rule_prod_prod_stream$ )State_rule_rule_prod_prod_stream$)
(declare-sort State_rule_prod_rule_prod$ 0)
(declare-fun fst$k (State_rule_prod_rule_prod$)State_rule_prod$)
(declare-fun snd$k (State_rule_prod_rule_prod$)Rule$)
(declare-fun pair$k (State_rule_prod$ Rule$ )State_rule_prod_rule_prod$)
...
(declare-fun fst$l (State_rule_prod_state_prod$)State_rule_prod$)
(declare-fun snd$l (State_rule_prod_state_prod$)State$)
(declare-fun pair$l (State_rule_prod$ State$ )State_rule_prod_state_prod$)
...
(declare-fun fst$m (State_rule_prod_state_rule_prod_prod$)State_rule_prod$)
(declare-fun snd$m (State_rule_prod_state_rule_prod_prod$)State_rule_prod$)
(declare-fun pair$m (State_rule_prod$ State_rule_prod$ )State_rule_prod_state_rule_prod_prod$)
...
(declare-sort Rule_state_state_prod_prod$ 0)
(declare-fun fst$n (Rule_state_state_prod_prod$)Rule$)
(declare-fun snd$n (Rule_state_state_prod_prod$)State_state_prod$)
(declare-fun pair$n (Rule$ State_state_prod$ )Rule_state_state_prod_prod$)
