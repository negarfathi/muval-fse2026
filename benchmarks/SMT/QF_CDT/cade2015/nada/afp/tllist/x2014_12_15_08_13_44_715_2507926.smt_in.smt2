...
(declare-sort B_llist_llist_llist_d_tllist$ 0)
(declare-sort A_llist_llist_llist$ 0)
(declare-sort A_llist_llist_llist_c_tllist$ 0)
...
(declare-fun terminal$b (B_llist_llist_d_tllist$)D$)
(declare-fun tNil$b (D$ )B_llist_llist_d_tllist$)
(declare-fun thd$b (B_llist_llist_d_tllist$)B_llist_llist$)
(declare-fun ttl$b (B_llist_llist_d_tllist$)B_llist_llist_d_tllist$)
(declare-fun tCons$b (B_llist_llist$ B_llist_llist_d_tllist$ )B_llist_llist_d_tllist$)
...
(declare-fun terminal$c (A_llist_llist_c_tllist$)C$)
(declare-fun tNil$c (C$ )A_llist_llist_c_tllist$)
(declare-fun thd$c (A_llist_llist_c_tllist$)A_llist_llist$)
(declare-fun ttl$c (A_llist_llist_c_tllist$)A_llist_llist_c_tllist$)
(declare-fun tCons$c (A_llist_llist$ A_llist_llist_c_tllist$ )A_llist_llist_c_tllist$)
(declare-fun terminal$d (A_llist_c_tllist$)C$)
(declare-fun tNil$d (C$ )A_llist_c_tllist$)
(declare-fun thd$d (A_llist_c_tllist$)A_llist$)
(declare-fun ttl$d (A_llist_c_tllist$)A_llist_c_tllist$)
(declare-fun tCons$d (A_llist$ A_llist_c_tllist$ )A_llist_c_tllist$)
...
(declare-fun terminal$f (B_llist_llist_llist_d_tllist$)D$)
(declare-fun tNil$f (D$ )B_llist_llist_llist_d_tllist$)
(declare-fun thd$f (B_llist_llist_llist_d_tllist$)B_llist_llist_llist$)
(declare-fun ttl$f (B_llist_llist_llist_d_tllist$)B_llist_llist_llist_d_tllist$)
(declare-fun tCons$f (B_llist_llist_llist$ B_llist_llist_llist_d_tllist$ )B_llist_llist_llist_d_tllist$)
...
(declare-fun terminal$g (A_llist_llist_llist_c_tllist$)C$)
(declare-fun tNil$g (C$ )A_llist_llist_llist_c_tllist$)
(declare-fun thd$g (A_llist_llist_llist_c_tllist$)A_llist_llist_llist$)
(declare-fun ttl$g (A_llist_llist_llist_c_tllist$)A_llist_llist_llist_c_tllist$)
(declare-fun tCons$g (A_llist_llist_llist$ A_llist_llist_llist_c_tllist$ )A_llist_llist_llist_c_tllist$)
(declare-fun b$ ()D$ )
