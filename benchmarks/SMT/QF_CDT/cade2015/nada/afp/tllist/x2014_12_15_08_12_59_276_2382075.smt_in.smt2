...
(declare-fun terminal$c (Natural_natural_prod_natural_natural_prod_tllist$)Natural_natural_prod$)
(declare-fun tNil$c (Natural_natural_prod$ )Natural_natural_prod_natural_natural_prod_tllist$)
(declare-fun thd$c (Natural_natural_prod_natural_natural_prod_tllist$)Natural_natural_prod$)
(declare-fun ttl$c (Natural_natural_prod_natural_natural_prod_tllist$)Natural_natural_prod_natural_natural_prod_tllist$)
(declare-fun tCons$c (Natural_natural_prod$ Natural_natural_prod_natural_natural_prod_tllist$ )Natural_natural_prod_natural_natural_prod_tllist$)
