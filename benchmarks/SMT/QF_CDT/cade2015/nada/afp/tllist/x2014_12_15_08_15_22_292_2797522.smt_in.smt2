...
(declare-fun fun_app$h (B_a_llist_llist_b_tllist_fun_a_llist_llist_b_tllist_fun$ B_a_llist_llist_b_tllist_fun$ )A_llist_llist_b_tllist$ )
(declare-fun fun_app$i (Unit_b_fun$ Unit$ )B$ )
...
(assert (! (not (= (tdropn$ n$ (tNil$ b$ ))(tNil$ b$ ))):named a3 ))
...
(assert (! (forall ((?v0 Unit_b_fun$ )(?v1 B$ ))(! (= (fun_app$d (tconcat$d ?v0 )(tNil$a ?v1 ))(tNil$b ?v1 )):pattern ((fun_app$d (tconcat$d ?v0 )(tNil$a ?v1 ))))):named a14 ))
(assert (! (forall ((?v0 Unit_b_fun$ )(?v1 B$ ))(! (= (fun_app$e (tconcat$e ?v0 )(tNil$b ?v1 ))(tNil$ ?v1 )):pattern ((fun_app$e (tconcat$e ?v0 )(tNil$b ?v1 ))))):named a15 ))
...
(assert (! (forall ((?v0 B$ )(?v1 A_llist_llist_bool_fun$ )(?v2 B$ ))(! (= (tfilter$c ?v0 ?v1 (tNil$a ?v2 ))(tNil$a ?v2 )):pattern ((tfilter$c ?v0 ?v1 (tNil$a ?v2 ))))):named a19 ))
(assert (! (forall ((?v0 B$ )(?v1 A_llist_bool_fun$ )(?v2 B$ ))(! (= (tfilter$d ?v0 ?v1 (tNil$b ?v2 ))(tNil$b ?v2 )):pattern ((tfilter$d ?v0 ?v1 (tNil$b ?v2 ))))):named a20 ))
(assert (! (forall ((?v0 B$ )(?v1 A_bool_fun$ )(?v2 B$ ))(! (= (tfilter$e ?v0 ?v1 (tNil$ ?v2 ))(tNil$ ?v2 )):pattern ((tfilter$e ?v0 ?v1 (tNil$ ?v2 ))))):named a21 ))
(assert (! (forall ((?v0 A_b_tllist$ ))(! (= (tdropn$ zero$ ?v0 )?v0 ):pattern ((tdropn$ zero$ ?v0 )))):named a22 ))
(assert (! (forall ((?v0 B$ )(?v1 B_a_llist_b_tllist_fun$ ))(! (= (fun_app$f (tappend$ (tNil$b ?v0 ))?v1 )(fun_app$a ?v1 ?v0 )):pattern ((fun_app$f (tappend$ (tNil$b ?v0 ))?v1 )))):named a23 ))
(assert (! (forall ((?v0 B$ )(?v1 B_a_b_tllist_fun$ ))(! (= (fun_app$g (tappend$a (tNil$ ?v0 ))?v1 )(fun_app$b ?v1 ?v0 )):pattern ((fun_app$g (tappend$a (tNil$ ?v0 ))?v1 )))):named a24 ))
(assert (! (forall ((?v0 A_llist_llist_b_tllist$ ))(! (= (fun_app$h (tappend$b ?v0 )uu$ )?v0 ):pattern ((tappend$b ?v0 )))):named a25 ))
(assert (! (forall ((?v0 A_llist_b_tllist$ ))(! (= (fun_app$f (tappend$ ?v0 )uua$ )?v0 ):pattern ((tappend$ ?v0 )))):named a26 ))
(assert (! (forall ((?v0 A_b_tllist$ ))(! (= (fun_app$g (tappend$a ?v0 )uub$ )?v0 ):pattern ((tappend$a ?v0 )))):named a27 ))
(assert (! (forall ((?v0 Unit_b_fun$ ))(! (= (tconcat$d ?v0 )(tconcat$a (fun_app$i ?v0 unity$ ))):pattern ((tconcat$d ?v0 )))):named a28 ))
(assert (! (forall ((?v0 Unit_b_fun$ ))(! (= (tconcat$e ?v0 )(tconcat$b (fun_app$i ?v0 unity$ ))):pattern ((tconcat$e ?v0 )))):named a29 ))
(assert (! (= zero$ zero$ ):named a30 ))
(check-sat )
;(get-unsat-core )
