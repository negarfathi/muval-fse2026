...
(declare-fun terminal$b (A_llist_llist_c_tllist$)C$)
(declare-fun tNil$b (C$ )A_llist_llist_c_tllist$)
(declare-fun thd$b (A_llist_llist_c_tllist$)A_llist_llist$)
(declare-fun ttl$b (A_llist_llist_c_tllist$)A_llist_llist_c_tllist$)
(declare-fun tCons$b (A_llist_llist$ A_llist_llist_c_tllist$ )A_llist_llist_c_tllist$)
...
(declare-fun terminal$c (B_llist_llist_d_tllist$)D$)
(declare-fun tNil$c (D$ )B_llist_llist_d_tllist$)
(declare-fun thd$c (B_llist_llist_d_tllist$)B_llist_llist$)
(declare-fun ttl$c (B_llist_llist_d_tllist$)B_llist_llist_d_tllist$)
(declare-fun tCons$c (B_llist_llist$ B_llist_llist_d_tllist$ )B_llist_llist_d_tllist$)
...
(declare-fun terminal$e (A_llist_c_tllist$)C$)
(declare-fun tNil$e (C$ )A_llist_c_tllist$)
(declare-fun thd$e (A_llist_c_tllist$)A_llist$)
(declare-fun ttl$e (A_llist_c_tllist$)A_llist_c_tllist$)
(declare-fun tCons$e (A_llist$ A_llist_c_tllist$ )A_llist_c_tllist$)
...
(declare-fun terminal$f (A_llist_llist_llist_c_tllist$)C$)
(declare-fun tNil$f (C$ )A_llist_llist_llist_c_tllist$)
(declare-fun thd$f (A_llist_llist_llist_c_tllist$)A_llist_llist_llist$)
(declare-fun ttl$f (A_llist_llist_llist_c_tllist$)A_llist_llist_llist_c_tllist$)
(declare-fun tCons$f (A_llist_llist_llist$ A_llist_llist_llist_c_tllist$ )A_llist_llist_llist_c_tllist$)
...
(declare-fun terminal$g (B_llist_llist_llist_d_tllist$)D$)
(declare-fun tNil$g (D$ )B_llist_llist_llist_d_tllist$)
(declare-fun thd$g (B_llist_llist_llist_d_tllist$)B_llist_llist_llist$)
(declare-fun ttl$g (B_llist_llist_llist_d_tllist$)B_llist_llist_llist_d_tllist$)
(declare-fun tCons$g (B_llist_llist_llist$ B_llist_llist_llist_d_tllist$ )B_llist_llist_llist_d_tllist$)
(declare-fun b$ ()C$ )
