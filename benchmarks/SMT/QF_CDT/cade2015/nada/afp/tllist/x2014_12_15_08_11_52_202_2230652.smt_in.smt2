...
(declare-fun fst$d (A_b_prod_llist_a_llist_prod$)A_b_prod_llist$)
(declare-fun snd$d (A_b_prod_llist_a_llist_prod$)A_llist$)
(declare-fun pair$d (A_b_prod_llist$ A_llist$ )A_b_prod_llist_a_llist_prod$)
(declare-fun fst$e (A_b_prod_llist_b_llist_prod$)A_b_prod_llist$)
(declare-fun snd$e (A_b_prod_llist_b_llist_prod$)B_llist$)
(declare-fun pair$e (A_b_prod_llist$ B_llist$ )A_b_prod_llist_b_llist_prod$)
...
(declare-fun fst$g (A_b_prod_c_d_prod_tllist_b_d_tllist_prod$)A_b_prod_c_d_prod_tllist$)
(declare-fun snd$g (A_b_prod_c_d_prod_tllist_b_d_tllist_prod$)B_d_tllist$)
(declare-fun pair$g (A_b_prod_c_d_prod_tllist$ B_d_tllist$ )A_b_prod_c_d_prod_tllist_b_d_tllist_prod$)
...
(declare-fun terminal$z (A_llist_a_llist_tllist$)A_llist$)
(declare-fun tNil$z (A_llist$ )A_llist_a_llist_tllist$)
(declare-fun thd$z (A_llist_a_llist_tllist$)A_llist$)
(declare-fun ttl$z (A_llist_a_llist_tllist$)A_llist_a_llist_tllist$)
(declare-fun tCons$z (A_llist$ A_llist_a_llist_tllist$ )A_llist_a_llist_tllist$)
(declare-fun terminal$aa (A_b_prod_llist_a_b_prod_llist_tllist$)A_b_prod_llist$)
(declare-fun tNil$aa (A_b_prod_llist$ )A_b_prod_llist_a_b_prod_llist_tllist$)
(declare-fun thd$aa (A_b_prod_llist_a_b_prod_llist_tllist$)A_b_prod_llist$)
(declare-fun ttl$aa (A_b_prod_llist_a_b_prod_llist_tllist$)A_b_prod_llist_a_b_prod_llist_tllist$)
(declare-fun tCons$aa (A_b_prod_llist$ A_b_prod_llist_a_b_prod_llist_tllist$ )A_b_prod_llist_a_b_prod_llist_tllist$)
(declare-fun terminal$ab (A_llist_a_c_tllist_tllist$)A_c_tllist$)
(declare-fun tNil$ab (A_c_tllist$ )A_llist_a_c_tllist_tllist$)
(declare-fun thd$ab (A_llist_a_c_tllist_tllist$)A_llist$)
(declare-fun ttl$ab (A_llist_a_c_tllist_tllist$)A_llist_a_c_tllist_tllist$)
(declare-fun tCons$ab (A_llist$ A_llist_a_c_tllist_tllist$ )A_llist_a_c_tllist_tllist$)
(declare-fun terminal$ac (A_b_prod_llist_a_b_prod_c_d_prod_tllist_tllist$)A_b_prod_c_d_prod_tllist$)
(declare-fun tNil$ac (A_b_prod_c_d_prod_tllist$ )A_b_prod_llist_a_b_prod_c_d_prod_tllist_tllist$)
(declare-fun thd$ac (A_b_prod_llist_a_b_prod_c_d_prod_tllist_tllist$)A_b_prod_llist$)
(declare-fun ttl$ac (A_b_prod_llist_a_b_prod_c_d_prod_tllist_tllist$)A_b_prod_llist_a_b_prod_c_d_prod_tllist_tllist$)
(declare-fun tCons$ac (A_b_prod_llist$ A_b_prod_llist_a_b_prod_c_d_prod_tllist_tllist$ )A_b_prod_llist_a_b_prod_c_d_prod_tllist_tllist$)
(declare-fun terminal$ad (A_c_tllist_a_llist_tllist$)A_llist$)
(declare-fun tNil$ad (A_llist$ )A_c_tllist_a_llist_tllist$)
(declare-fun thd$ad (A_c_tllist_a_llist_tllist$)A_c_tllist$)
(declare-fun ttl$ad (A_c_tllist_a_llist_tllist$)A_c_tllist_a_llist_tllist$)
(declare-fun tCons$ad (A_c_tllist$ A_c_tllist_a_llist_tllist$ )A_c_tllist_a_llist_tllist$)
(declare-fun terminal$ae (A_b_prod_c_d_prod_tllist_a_b_prod_llist_tllist$)A_b_prod_llist$)
(declare-fun tNil$ae (A_b_prod_llist$ )A_b_prod_c_d_prod_tllist_a_b_prod_llist_tllist$)
(declare-fun thd$ae (A_b_prod_c_d_prod_tllist_a_b_prod_llist_tllist$)A_b_prod_c_d_prod_tllist$)
(declare-fun ttl$ae (A_b_prod_c_d_prod_tllist_a_b_prod_llist_tllist$)A_b_prod_c_d_prod_tllist_a_b_prod_llist_tllist$)
(declare-fun tCons$ae (A_b_prod_c_d_prod_tllist$ A_b_prod_c_d_prod_tllist_a_b_prod_llist_tllist$ )A_b_prod_c_d_prod_tllist_a_b_prod_llist_tllist$)
(declare-fun terminal$af (A_c_tllist_a_c_tllist_tllist$)A_c_tllist$)
(declare-fun tNil$af (A_c_tllist$ )A_c_tllist_a_c_tllist_tllist$)
(declare-fun thd$af (A_c_tllist_a_c_tllist_tllist$)A_c_tllist$)
(declare-fun ttl$af (A_c_tllist_a_c_tllist_tllist$)A_c_tllist_a_c_tllist_tllist$)
(declare-fun tCons$af (A_c_tllist$ A_c_tllist_a_c_tllist_tllist$ )A_c_tllist_a_c_tllist_tllist$)
(declare-fun terminal$ag (A_b_prod_c_d_prod_tllist_a_b_prod_c_d_prod_tllist_tllist$)A_b_prod_c_d_prod_tllist$)
(declare-fun tNil$ag (A_b_prod_c_d_prod_tllist$ )A_b_prod_c_d_prod_tllist_a_b_prod_c_d_prod_tllist_tllist$)
(declare-fun thd$ag (A_b_prod_c_d_prod_tllist_a_b_prod_c_d_prod_tllist_tllist$)A_b_prod_c_d_prod_tllist$)
(declare-fun ttl$ag (A_b_prod_c_d_prod_tllist_a_b_prod_c_d_prod_tllist_tllist$)A_b_prod_c_d_prod_tllist_a_b_prod_c_d_prod_tllist_tllist$)
(declare-fun tCons$ag (A_b_prod_c_d_prod_tllist$ A_b_prod_c_d_prod_tllist_a_b_prod_c_d_prod_tllist_tllist$ )A_b_prod_c_d_prod_tllist_a_b_prod_c_d_prod_tllist_tllist$)
(declare-fun terminal$ah (B_llist_b_llist_tllist$)B_llist$)
(declare-fun tNil$ah (B_llist$ )B_llist_b_llist_tllist$)
(declare-fun thd$ah (B_llist_b_llist_tllist$)B_llist$)
(declare-fun ttl$ah (B_llist_b_llist_tllist$)B_llist_b_llist_tllist$)
(declare-fun tCons$ah (B_llist$ B_llist_b_llist_tllist$ )B_llist_b_llist_tllist$)
(declare-fun terminal$ai (B_llist_b_d_tllist_tllist$)B_d_tllist$)
(declare-fun tNil$ai (B_d_tllist$ )B_llist_b_d_tllist_tllist$)
(declare-fun thd$ai (B_llist_b_d_tllist_tllist$)B_llist$)
(declare-fun ttl$ai (B_llist_b_d_tllist_tllist$)B_llist_b_d_tllist_tllist$)
(declare-fun tCons$ai (B_llist$ B_llist_b_d_tllist_tllist$ )B_llist_b_d_tllist_tllist$)
(declare-fun terminal$aj (B_d_tllist_b_llist_tllist$)B_llist$)
(declare-fun tNil$aj (B_llist$ )B_d_tllist_b_llist_tllist$)
(declare-fun thd$aj (B_d_tllist_b_llist_tllist$)B_d_tllist$)
(declare-fun ttl$aj (B_d_tllist_b_llist_tllist$)B_d_tllist_b_llist_tllist$)
(declare-fun tCons$aj (B_d_tllist$ B_d_tllist_b_llist_tllist$ )B_d_tllist_b_llist_tllist$)
(declare-fun terminal$ak (B_d_tllist_b_d_tllist_tllist$)B_d_tllist$)
(declare-fun tNil$ak (B_d_tllist$ )B_d_tllist_b_d_tllist_tllist$)
(declare-fun thd$ak (B_d_tllist_b_d_tllist_tllist$)B_d_tllist$)
(declare-fun ttl$ak (B_d_tllist_b_d_tllist_tllist$)B_d_tllist_b_d_tllist_tllist$)
(declare-fun tCons$ak (B_d_tllist$ B_d_tllist_b_d_tllist_tllist$ )B_d_tllist_b_d_tllist_tllist$)
