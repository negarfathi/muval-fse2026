...
(declare-fun terminal$b (D_b_tllist$)B$)
(declare-fun tNil$b (B$ )D_b_tllist$)
(declare-fun thd$b (D_b_tllist$)D$)
(declare-fun ttl$b (D_b_tllist$)D_b_tllist$)
(declare-fun tCons$b (D$ D_b_tllist$ )D_b_tllist$)
(declare-fun terminal$c (A_c_tllist$)C$)
(declare-fun tNil$c (C$ )A_c_tllist$)
(declare-fun thd$c (A_c_tllist$)A$)
(declare-fun ttl$c (A_c_tllist$)A_c_tllist$)
(declare-fun tCons$c (A$ A_c_tllist$ )A_c_tllist$)
