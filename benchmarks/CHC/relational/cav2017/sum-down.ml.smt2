(set-logic HORN)
(set-info :source |
  Benchmark: ./benchmarks/Table1/sum-down.ml
...
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(x4 Int)) (=> (and (|$P1| x2 x3 x4) (and (or (< x1 x2) (> x1 x2)) (and (= x1 (+ 1 x3)) (= x0 (+ x1 x4))))) (|$P1| x2 x1 x0))))
(assert (not (exists ((x1 Int)(x0 Int)(x2 Int)) (and (|$P0| x1 x0) (and (|$P1| 0 x1 x2) (and (>= x1 0) (or (< x0 x2) (> x0 x2))))))))
(check-sat)
