(set-logic HORN)
(set-info :source |
  Benchmark: ./benchmarks/Table1/sum-nonlin.ml
...
(assert (not (exists ((x3 Int)(x0 Int)(x1 Int)(x4 Int)(x2 Int)) (and (|$P0| x3 x4) (and (and (>= x3 0) (or (< x0 x1) (> x0 x1))) (and (= x0 (* 2 x4)) (and (= x2 (+ 1 x3)) (= x1 (* x3 x2)))))))))
(check-sat)
