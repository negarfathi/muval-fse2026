...
(assert (forall ((A Bool)
         ...
         (Y3 Bool)
         (Z3 Bool))
  (let ((a!1 (or (and (= M3 true) (not (= I1 true))) (not (= L3 true))))
           (a!2 (or (not (= N3 true)) (and (= N2 true) (not (= W1 true)))))
           (a!3 (or (= P2 true)
                    (and (not (= P2 true)) (not (= I2 true)) (= C true))
                    (not (= G2 true))))
           (a!4 (or (and (= K3 true) (not (= F1 true))) (not (= I3 true))))
           (a!5 (and (not (= P2 true))
           ...
           (a!8 (or (and (= N2 true) (not (= Y2 true)))
                    (not (= K2 true))
                    (= W3 true)))
           (a!9 (or (and (= G3 true) (not (= C1 true))) (not (= F3 true))))
           (a!10 (or (or (not (= X3 true)) (= J3 true)) (= Q2 true)))
           (a!11 (or (and (= J3 true) (not (= Y1 true))) (not (= E3 true))))
           (a!12 (or (and (= O2 true) (not (= J true))) (not (= M2 true))))
           (a!13 (or (= U2 true)
     ...
     (let ((a!21 (and (str_invariant Z1
                                     ...
                                     U3
                                     T3)
                      (or (= N3 true) (not (= N2 true)) (= W1 true))
                      ...
                      a!4
                      (or (not (= M3 true)) (= I1 true) (= L3 true))
                      (not (= D3 true))
                      ...
                      (or (not (= K3 true)) (= F1 true) (= I3 true))
                      (not (= C3 true))
                      ...
                      (not (= V2 true))
                      a!11
                      (or (not (= G3 true)) (= C1 true) (= F3 true))
                      (not (= A3 true))
                      (not (= G3 J3))
                      ...
                      (or (not (= J3 true)) (= Y1 true) (= E3 true))
                      (not (= Z2 true))
                      (not (= K3 Y2))
                      (or (= P3 true) (not (= K true)))
                      a!14
                      (or (= L2 true) (not (= W1 true)))
                      (or (not (= O2 true)) (= J true) (= M2 true))
                      (not (= D2 true))
                      (or a!15 (= T2 true))
                      a!16
                      a!17
