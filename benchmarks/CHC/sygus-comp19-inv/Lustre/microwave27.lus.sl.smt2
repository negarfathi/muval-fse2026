...
(assert (forall ((A Int)
  ...
  (let ((a!1 (>= (ite (not (= K1 true)) 0 1) 0))
     ...
     (let ((a!16 (and (or (= A1 true) (not (= K true)))
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (not (= O2 true))
           ...
           (a!36 (and (= 1 C)
                      ...
                      (not (= (- Q2 A1) 0))))
           (a!37 (div (+ T1 (* (- 60) (div T1 60))) 10))
           (a!40 (or (and (not (= H true)) (= G true)) (not (= W1 true))))
           (a!41 (or (not (= S2 true))
                     (not (= 1 C))
                     (= M2 true)
                     ...
                     (= (- Q2 A1) 0)))
           (a!44 (ite (and (= C2 true) (not (= O2 true)))
                      0
                      (ite (= O2 true) (+ (* 60 A2) (* 10 Z1) Y1) Z)))
           (a!45 (ite (= F3 true) (ite (= (+ (- 2) E3) 0) 1 E3) E3))
           (a!46 (and (= (+ (- 2) E3) 0)
                      (or (not (= D4 0)) (= O3 0))
                      (not (= J4 true))
                      (not (= I4 true))))
           (a!47 (ite (not (= (+ (- 2) Z2) 0)) 2 Z2))
           (a!48 (ite (not (= (+ (- 2) Z2) 0)) 2 C3))
           (a!49 (ite (not (= (+ (- 4) F4) 0)) 1 B3))
           (a!50 (ite (not (= (+ (- 2) Z3) 0)) 2 A3))
           (a!51 (ite (not (= (+ (- 4) W3) 0)) 1 Y2))
           (a!52 (ite (= J4 true) (ite (= (+ (- 2) G4) 0) 1 G4) G4))
           (a!53 (ite (not (= (+ (- 3) Q3) 0)) 3 K4))
           (a!55 (ite (not (= (+ (- 2) M3) 0)) 2 E))
           (a!56 (= J4
                    (and (= (+ (- 2) G4) 0)
                         (>= (+ (- 1) H4) 0)
                         (not (= I4 true)))))
           (a!57 (ite (not (= (+ (- 4) F4) 0)) 4 F4))
           (a!58 (ite (and (>= (+ (- 1) A4) 0) (>= (- 3 A4) 0)) 0 A4))
           (a!59 (= E4
                    (and (= (+ (- 3) A4) 0)
                         (not (= D4 0))
                         (not (= B4 true))
                         (= (+ (- 3) A4) 0)
                         (not (= B4 true)))))
           (a!60 (= D4 (ite (not (= C4 true)) 0 1)))
           (a!61 (= C4 (and (= M2 true) (not (= P1 true)))))
           (a!62 (ite (not (= (+ (- 2) Z3) 0)) 2 Z3))
           (a!63 (ite (= Y3 true) (ite (= (+ (- 3) X3) 0) 1 X3) X3))
           (a!64 (= Y3
                    (and (= (+ (- 3) X3) 0)
                         (not (= J3 0))
                         (not (= O3 0))
                         (not (= V3 true)))))
           (a!65 (ite (not (= (+ (- 4) W3) 0)) 4 W3))
           (a!66 (= V3
                    (and (= (+ (- 2) T3) 0) (>= (- U3) 0) (= (+ (- 2) T3) 0))))
           (a!67 (ite (not (= (+ (- 3) Q3) 0)) 3 Q3))
           (a!68 (= R3
                    (and (= N3 true)
                         (>= (+ (- 1) Q3) 0)
                         (>= (- 3 Q3) 0)
                         (not (= P3 true)))))
           (a!69 (ite (not (= (+ (- 2) M3) 0)) 2 M3))
           (a!70 (and (>= (+ (- 1) M3) 0) (>= (- 3 M3) 0)))
           (a!72 (= O3 (ite (not (= T2 true)) 0 1)))
           (a!73 (or (< (+ (- 1) L3) 0) (< (- 3 L3) 0)))
           (a!74 (ite (= K3 true) (ite (= (+ (- 4) F) 0) 0 F) F))
           (a!75 (= (ite (>= (- P2) 0) 0 1) 0))
           (a!77 (= J3 (ite (not (= I3 true)) 0 1)))
           (a!78 (= I3 (and (= X2 true) (not (= R1 true))))))
     (let ((a!6 (ite (and (not (= K3 true)) a!4) (ite (= F3 true) a!5 G3) T3))
           ...
           (a!42 (ite (and (not (= K3 true)) a!4)
                      (ite (= J4 true) (+ (- 1) H4) H4)
                      U3))
           (a!54 (= Y2 (ite (= K3 true) (ite (= R3 true) a!53 K4) E)))
           (a!71 (= P3 (and (= N3 true) a!70 (not (= O3 0)))))
           (a!76 (= K3
                    (and (= H3 true)
                         (= (+ (- 4) F) 0)
                         (not (= J3 0))
     ...
     (let ((a!7 (- V1 (ite (= X1 true) (ite (= W1 true) a!3 a!6) F)))
           ...
           (a!43 (- T1 (ite (= X1 true) (ite (= W1 true) D a!42) D))))
     ...
     (let ((a!79 (and (str_invariant R1
                      ...
                      (= G3 a!45)
                      (= F3 a!46)
                      (= E3 (ite (= J4 true) a!47 Z2))
                      (= D3 (ite (= J4 true) a!48 C3))
                      (= C3 (ite (= E4 true) a!49 B3))
                      (= B3 (ite (= Y3 true) a!50 A3))
                      (= A3 (ite (= V3 true) a!51 Y2))
                      (= Z2 a!52)
                      a!54
                      (= K4 (ite (= P3 true) a!55 E))
                      a!56
                      (= I4 (or (= E4 true) (= B4 true)))
                      (= H4 (ite (= E4 true) 0 U3))
                      (= G4 (ite (= E4 true) a!57 F4))
                      (= F4 (ite (= E4 true) a!58 A4))
                      a!59
                      a!60
                      a!61
                      (= B4 (or (= Y3 true) (= V3 true)))
                      (= A4 (ite (= Y3 true) a!62 Z3))
                      (= Z3 a!63)
                      a!64
                      (= X3 (ite (= V3 true) a!65 W3))
                      (= W3 (ite (= V3 true) (ite a!4 0 T3) T3))
                      a!66
                      (= U3 (ite (= H3 true) P2 D))
                      (= T3 (ite (= K3 true) S3 L3))
                      (= S3 (ite (= R3 true) a!67 Q3))
                      a!68
                      (= Q3 (ite (= P3 true) a!69 M3))
                      a!71
                      a!72
                      (= N3 (and a!73 a!70))
                      (= M3 (ite a!73 1 L3))
