...
(assert (forall ((A Int)
  ...
  (let ((a!1 (>= (ite (not (= J1 true)) 0 1) 0))
           ...
           (a!13 (and (= J1 true) (not (= (div B 60) 0))))
     ...
     (let ((a!16 (and (or (= Z true) (not (= K true)))
                      ...
                      (>= a!14 0)
                      (= (- A C) 0)
                      (or (not (= X true)) (not (= J1 true)) (= (div B 60) 0))
                      (= B 0)
                      (= (- V a!15) 0)
                      (= J true)
                      (= E true)
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (not (= N2 true))
           ...
           (a!36 (and (= 1 C) (= K2 true) (not (= (div S1 60) 0))))
           ...
           (a!44 (and (= (+ (- 2) A3) 0)
                      ...
                      (not (= F4 true))
                      (not (= E4 true))))
           (a!45 (ite (not (= (+ (- 2) I4) 0)) 2 I4))
           (a!46 (ite (not (= (+ (- 2) I4) 0)) 2 Y2))
           (a!47 (ite (not (= (+ (- 4) B4) 0)) 1 X2))
           (a!48 (ite (not (= (+ (- 2) V3) 0)) 2 W2))
           (a!49 (ite (not (= (+ (- 4) S3) 0)) 1 H4))
           (a!50 (ite (= F4 true) (ite (= (+ (- 2) C4) 0) 1 C4) C4))
           (a!51 (ite (not (= (+ (- 3) M3) 0)) 3 G4))
           (a!53 (ite (not (= (+ (- 2) I3) 0)) 2 E))
           (a!54 (= F4
                    (and (= (+ (- 2) C4) 0)
                         (>= (+ (- 1) D4) 0)
                         (not (= E4 true)))))
           (a!55 (ite (not (= (+ (- 4) B4) 0)) 4 B4))
           (a!56 (ite (and (>= (+ (- 1) W3) 0) (>= (- 3 W3) 0)) 0 W3))
           (a!57 (= A4
                    (and (= (+ (- 3) W3) 0)
                         (not (= Z3 0))
                         (not (= X3 true))
                         (= (+ (- 3) W3) 0)
                         (not (= X3 true)))))
           (a!58 (= Z3 (ite (not (= Y3 true)) 0 1)))
           (a!59 (= Y3 (and (= K2 true) (not (= P1 true)))))
           (a!60 (ite (not (= (+ (- 2) V3) 0)) 2 V3))
           (a!61 (ite (= U3 true) (ite (= (+ (- 3) T3) 0) 1 T3) T3))
           (a!62 (= U3
                    (and (= (+ (- 3) T3) 0)
                         (not (= F3 0))
                         (not (= K3 0))
                         (not (= R3 true)))))
           (a!63 (ite (not (= (+ (- 4) S3) 0)) 4 S3))
           (a!64 (= R3
                    (and (= (+ (- 2) P3) 0) (>= (- Q3) 0) (= (+ (- 2) P3) 0))))
           (a!65 (ite (not (= (+ (- 3) M3) 0)) 3 M3))
           (a!66 (= N3
                    (and (= J3 true)
                         (>= (+ (- 1) M3) 0)
                         (>= (- 3 M3) 0)
                         (not (= L3 true)))))
           (a!67 (ite (not (= (+ (- 2) I3) 0)) 2 I3))
           (a!68 (and (>= (+ (- 1) I3) 0) (>= (- 3 I3) 0)))
           (a!70 (= K3 (ite (not (= R2 true)) 0 1)))
           (a!71 (or (< (+ (- 1) H3) 0) (< (- 3 H3) 0)))
           (a!72 (ite (= G3 true) (ite (= (+ (- 4) F) 0) 0 F) F))
           (a!73 (= (ite (>= (- O2) 0) 0 1) 0))
           (a!75 (= F3 (ite (not (= E3 true)) 0 1)))
           (a!76 (= E3 (and (= V2 true) (not (= Q1 true))))))
     (let ((a!6 (ite (and (not (= G3 true)) a!4) (ite (= B3 true) a!5 C3) P3))
           ...
           (a!40 (ite (and (not (= G3 true)) a!4)
                      (ite (= F4 true) (+ (- 1) D4) D4)
                      Q3))
           (a!52 (= H4 (ite (= G3 true) (ite (= N3 true) a!51 G4) E)))
           (a!69 (= L3 (and (= J3 true) a!68 (not (= K3 0)))))
           (a!74 (= G3
                    (and (= D3 true)
                         (= (+ (- 4) F) 0)
                         (not (= F3 0))
     ...
     (let ((a!77 (and (str_invariant Q1
                      ...
                      (= C3 a!43)
                      (= B3 a!44)
                      (= A3 (ite (= F4 true) a!45 I4))
                      (= Z2 (ite (= F4 true) a!46 Y2))
                      (= Y2 (ite (= A4 true) a!47 X2))
                      (= X2 (ite (= U3 true) a!48 W2))
                      (= W2 (ite (= R3 true) a!49 H4))
                      (= I4 a!50)
                      a!52
                      (= G4 (ite (= L3 true) a!53 E))
                      a!54
                      (= E4 (or (= A4 true) (= X3 true)))
                      (= D4 (ite (= A4 true) 0 Q3))
                      (= C4 (ite (= A4 true) a!55 B4))
                      (= B4 (ite (= A4 true) a!56 W3))
                      a!57
                      a!58
                      a!59
                      (= X3 (or (= U3 true) (= R3 true)))
                      (= W3 (ite (= U3 true) a!60 V3))
                      (= V3 a!61)
                      a!62
                      (= T3 (ite (= R3 true) a!63 S3))
                      (= S3 (ite (= R3 true) (ite a!4 0 P3) P3))
                      a!64
                      (= Q3 (ite (= D3 true) O2 D))
                      (= P3 (ite (= G3 true) O3 H3))
                      (= O3 (ite (= N3 true) a!65 M3))
                      a!66
                      (= M3 (ite (= L3 true) a!67 I3))
                      a!69
                      a!70
                      (= J3 (and a!71 a!68))
                      (= I3 (ite a!71 1 H3))
