...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (ite (>= (+ (- 1) O) 0) (+ (- 1) O) O))
           ...
           (a!33 (or (and (not (= P1 true)) (not (= H true))) (= O1 true)))
           (a!34 (and (and (not (= H2 true)) (not (= W1 true)))
                      (not (= L1 true))))
           (a!39 (and (and (not (= H2 true)) (not (= W1 true)))
                      (= L1 true)
                      (not (= A1 true))
                      (not (= P true))
                      (not (= E true))
     ...
     (let ((a!2 (ite (= C true) a!1 (ite (= B true) a!1 (ite (= A true) a!1 O))))
           ...
           (a!29 (or (or (or a!25 (= A1 true)) (= P true))
                     ...
                     (= F2 true)
                     (= E2 true)))
           (a!35 (and (and a!34 (not (= A1 true))) (not (= P true))))
           (a!40 (and (and a!34 (not (= A1 true)))
                      (= P true)
                      (not (= E true))
                      (not (= C true))
                      (not (= B true))
     ...
     (let ((a!3 (ite (= E true) (ite (>= (+ (- 1) Q) 0) (+ 1 O) O) a!2))
           ...
           (a!30 (or (or (or a!26 (= C true)) (= B true))
                     ...
                     (= F2 true)
                     (= E2 true)))
           (a!36 (and (and a!35 (not (= E true))) (not (= C true))))
           (a!41 (and (and a!35 (not (= E true)))
                      (= C true)
                      (not (= B true))
                      (not (= A true))
                      (not (= G2 true))
     ...
     (let ((a!18 (ite (= C true) (ite (>= (+ (- 1) O) 0) (+ 1 L) L) a!17))
           ...
           (a!37 (and (and a!36 (not (= B true))) (not (= A true))))
           (a!42 (and (and a!36 (not (= B true)))
                      (= A true)
                      (not (= G2 true))
                      (not (= F2 true))
                      (not (= E2 true)))))
     (let ((a!19 (ite (= P true) (ite (>= (+ (- 1) R) 0) (+ 1 L) L) a!18))
           (a!32 (and a!28
                      ...
                      a!31))
           (a!38 (and (and a!37 (not (= G2 true))) (not (= F2 true))))
           (a!43 (and (and a!37 (not (= G2 true)))
                      (= F2 true)
                      (not (= E2 true)))))
     (let ((a!44 (or (not (= Q1 true))
                     (and a!38 (not (= E2 true)))
                     (and (= H2 true)
                          (not (= W1 true))
                          (not (= L1 true))
                          (not (= A1 true))
