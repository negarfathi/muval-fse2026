...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (and (and (not (= S3 true)) (not (= R3 true))) (= Q3 true)))
           ...
           (a!9 (or (and (= J2 true) (= X2 true))
                    (and (not (= J2 true)) (= X2 true) (= D true))
                    (not (= I2 true))))
           (a!10 (and (and (not (= S3 true)) (not (= R3 true)))
                      (not (= Q3 true))))
           (a!11 (and (or (not (= W2 true)) (not (= Z2 true)))
                      (or (and (= W2 true) (= Z2 true))
                          (not (= Z2 true))
                          (not (= E1 true)))))
           (a!12 (or (and (= L3 true) (not (= F1 true))) (not (= J2 true))))
           (a!13 (and (or (not (= J2 true)) (not (= X2 true)))
                      (or (= J2 true) (not (= X2 true)) (not (= D true)))))
           (a!14 (or (not (= B3 true)) (and (= Y2 true) (not (= W1 true)))))
           (a!15 (and (or (not (= U true)) (not (= B3 true))) (= F1 true)))
           (a!17 (and (or (not (= U true)) (not (= B3 true)))
                      (or (and (= U true) (= B3 true)) (not (= F1 true)))))
           (a!18 (or (and (= M3 true) (not (= H1 true))) (not (= I3 true))))
           (a!19 (or (and (= I3 true) (or (= H3 true) (= G3 true) (= F3 true)))
                     (not (= I3 true))
                     (not (= O3 true))))
           (a!20 (or (not (= I3 true))
                     (and (not (= H3 true)) (not (= G3 true)) (not (= F3 true)))))
           (a!21 (or (and (= S3 true) (not (= N1 true))) (not (= H3 true))))
           (a!22 (or (and (= R3 true) (not (= M1 true))) (not (= G3 true))))
           (a!23 (or (and (= Q3 true) (not (= L1 true))) (not (= F3 true)))))
     (let ((a!2 (or (and (= S3 true) (not (= R3 true)) (not (= Q3 true)))
                    (and (not (= S3 true)) (= R3 true) (not (= Q3 true)))
                    a!1
                    (not (= K2 true))))
           (a!16 (and (not (= C3 true))
                      (not (= J3 true))
                      (or (not (= F1 true)) (not (= B3 true)))
                      (or (and (= U true) (= B3 true)) a!15))))
     (let ((a!24 (and (str_invariant Y1
                                     X1
                                     W1
                                     V1
                                     U1
