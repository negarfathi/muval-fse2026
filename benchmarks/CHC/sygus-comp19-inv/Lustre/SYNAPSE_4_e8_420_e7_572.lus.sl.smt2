...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (and (= D true) (< (- H) 0) (< (- I) 0)) (= L true)))
     ...
     (let ((a!3 (and (= (- G M) 0)
                     ...
                     a!1
                     (or (= F true)
                         (and (= P true) (= O true) (= P true) (= N true))
                         (and (= O true) (= N true)))
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (ite (= J true)
           ...
           (a!11 (or (and (not (= C1 true)) (not (= K true))) (= B1 true)))
           (a!12 (and (or (not (= F1 true))
                          (not (= U true))
                          (not (= F1 true))
                          (not (= J true)))
     ...
     (let ((a!13 (and (str_invariant X W V T S R Q P O N M L K I H G)
                      (= (- C a!3) 0)
                      (= (- B a!6) 0)
                      (= (- A a!9) 0)
                      (or (not (= B1 true))
                      ...
                      a!10
                      (or (= D1 true)
                          (and (= F1 true) (= U true) (= F1 true) (= J true))
                          (and (= U true) (= J true)))
                      a!11
                      (not (= A1 true))
                      (or (not (= D1 true)) a!12)
                      ...
                      (not (= D true)))))
       (=> a!13 (str_invariant F1 U J F E D C B A E1 D1 C1 B1 A1 Z Y))))))
    ))
