...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (- B (ite (= C true) E (ite (= D true) (+ E F) E))))
           (a!2 (or (and (not (= N true)) (not (= M true))) (= D true)))
           (a!3 (ite (or (= M true) (not (= N true))) 2 0)))
     (let ((a!4 (ite (or (= N true) (not (= M true))) 1 a!3)))
     (let ((a!5 (and (not (= I true))
                     ...
                     (= L true)
                     (= K true))))
       (=> a!5 (str_invariant N M L K J I H G F E D C B A)))))
    ))
(assert (forall ((A Int)
         (B Bool)
         (C Bool)
  ...
  (let ((a!1 (or (and (= P true) (< X 0))
           ...
           (a!6 (or (and (not (= B1 true)) (not (= Q true))) (= Z true)))
           (a!7 (ite (or (= Q true) (not (= B1 true))) 2 0)))
     (let ((a!8 (ite (or (= B1 true) (not (= Q true))) 1 a!7)))
     (let ((a!9 (and (str_invariant V U T S R P O N M L K J I H)
                     ...
                     (not (= W true))
                     a!6
                     (or (= G true) (and (= R true) (= D true)))
                     (>= A 0)
                     (>= (- A1) 0)
                     (= A1 0)
                     (or (= E true) (not (= C true)))
                     (or (not (= G true)) (not (= R true)) (not (= D true)))
                     (>= (- 2 A) 0)
                     (= (- A a!8) 0)
