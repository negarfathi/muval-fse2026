...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (and (or (not (= Q true))
     ...
     (let ((a!2 (and (= (- H N) 0)
                     ...
                     (= (- D (+ I K J)) 0)
                     (or (= G true)
                         (and (= Q true) (= P true) (= Q true) (= O true))
                         (and (= P true) (= O true)))
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (ite (= L true)
           ...
           (a!11 (not (= (- (+ A B C) J) 0)))
           (a!12 (or (and (not (= E1 true)) (not (= K true))) (= D1 true)))
           (a!13 (and (or (not (= H1 true))
                          (not (= W true))
                          (not (= H1 true))
                          (not (= L true)))
                      (or (not (= W true)) (not (= L true))))))
     (let ((a!2 (ite (= W true)
                     (ite (>= (+ (- 1) Q) 0) (+ (+ (- 1) R) Q P) R)
                     a!1))
     ...
     (let ((a!14 (and (str_invariant Y X V U T S R Q P O N M K J I H G)
                      (= (- C a!3) 0)
                      (= (- B a!6) 0)
                      a!7
                      (= (- A a!10) 0)
                      (or (and (= D1 true) a!11) (= E true))
                      (or (= E1 true) (= K true) (not (= D1 true)))
                      (= (- G1 O) 0)
                      (= (- C1 (+ A B C)) 0)
                      (or (= F1 true)
                          (and (= H1 true) (= W true) (= H1 true) (= L true))
                          (and (= W true) (= L true)))
                      a!12
                      (not (= B1 true))
                      (or (not (= F1 true)) a!13)
                      ...
                      (not (= D true)))))
       (=> a!14 (str_invariant H1 W L F E D C B A G1 F1 E1 D1 C1 B1 A1 Z))))))
    ))
