...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (ite (and (= (+ (- 1) R) 0) (>= (- O S1) 0)) 2 R))
           ...
           (a!20 (and (= O1 true) (or (< Z1 0) (< (- 3 Z1) 0))))
           (a!21 (or (or (= H2 true) (= W1 true)) (= L1 true)))
           (a!27 (or (and (not (= P1 true)) (not (= H true))) (= O1 true)))
           (a!28 (and (and (not (= H2 true)) (not (= W1 true)))
                      (not (= L1 true))))
     ...
     (let ((a!3 (- Y1
           ...
           (a!24 (or (or (or a!21 (= A1 true)) (= P true))
                     ...
                     (= B true)
                     (= A true)))
           (a!29 (and (and a!28 (not (= A1 true))) (not (= P true))))
           (a!33 (and (and a!28 (not (= A1 true)))
                      (= P true)
                      (not (= E true))
                      (not (= C true))
                      (not (= B true))
     ...
     (let ((a!15 (ite (= L1 true) (ite (= (+ (- 2) T) 0) (+ 1 O) O) a!14))
           ...
           (a!30 (and (and a!29 (not (= E true))) (not (= C true))))
           (a!34 (and (and a!29 (not (= E true)))
                      (= C true)
                      (not (= B true))
                      (not (= A true)))))
     (let ((a!26 (and a!23
                      ...
                      a!25))
           (a!31 (and (and a!30 (not (= B true))) (not (= A true))))
           (a!35 (and (and a!30 (not (= B true))) (= A true))))
     (let ((a!36 (or (not (= Q1 true))
                     a!31
                     (and (= H2 true)
                          (not (= W1 true))
                          (not (= L1 true))
                     ...
                     (and a!29
                          ...
                          (not (= A true)))
                     a!34
                     (and a!30 (= B true) (not (= A true)))
                     a!35)))
     (let ((a!37 (and (str_invariant J1
                                     I1
                                     H1
                                     G1
                                     F1
