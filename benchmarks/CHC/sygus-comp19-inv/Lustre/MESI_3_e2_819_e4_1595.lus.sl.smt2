...
(assert (forall ((A Bool)
         ...
         (A1 Bool))
  (let ((a!1 (- (- (- (- 3 K) J) I) H))
           (a!2 (and (or (not (= A1 true)) (not (= Z true)))
                     (or (not (= A1 true)) (not (= Y true)))
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (- (- (- (- 3 T1) S1) R1) P1))
           ...
           (a!5 (ite (= D2 true) (+ (+ (+ (- 1) W) V T) S) S))
           (a!6 (ite (= C2 true) (+ (+ (+ (- 1) W) V T) S) S))
           (a!9 (and (or (not (= B2 true)) (not (= Q1 true)))
                     (or (not (= B2 true)) (not (= F1 true)))
           ...
           (a!13 (- T1 (ite (>= (- (- 1) C) 0) (- C) C)))
           (a!14 (ite (= F1 true)
                      (ite (= D2 true) 0 T)
                      (ite (= U true) (ite (= C2 true) 0 T) T)))
           (a!16 (- S1 (ite (>= (- (- 1) B) 0) (- B) B)))
           (a!17 (- R1 (ite (>= (- (- 1) A) 0) (- A) A)))
           (a!18 (- P1 (ite (>= (- (- 1) A2) 0) (- A2) A2))))
     (let ((a!3 (ite (= Q1 true) (ite (>= (+ (- 1) V) 0) (+ (- 1) W) W) a!2))
           (a!7 (ite (= Q1 true) S (ite (= F1 true) a!5 (ite (= U true) a!6 S))))
           (a!11 (ite (= Q1 true) (ite (>= (+ (- 1) V) 0) (+ (- 1) V) V) a!10))
           (a!15 (ite (= B2 true)
                      (ite (= E2 true) (+ (+ (- 1) W) V T) T)
                      (ite (= Q1 true) T a!14))))
     (let ((a!4 (- Z1 (ite (= B2 true) (ite (= E2 true) 0 W) a!3)))
           (a!8 (- W1 (ite (= B2 true) (ite (= E2 true) (+ (- 1) S) S) a!7)))
           (a!12 (- Y1 (ite (= B2 true) (ite (= E2 true) 0 V) a!11))))
     (let ((a!19 (and (str_invariant H1
                                     G1
                                     E1
                                     D1
                                     C1
