...
(assert (forall ((A Int)
  ...
  (let ((a!1 (or (not (= A1 true)) (>= (- (+ C B) A) 0) (not (= E true))))
           (a!2 (and (= A1 true) (< (- (+ C B) A) 0)))
           (a!3 (= (- A (ite (= U true) (+ (- 1) N) 0)) 0))
           (a!4 (= (- C1 (ite (= T true) (+ (- 1) M) 0)) 0))
           (a!5 (and (>= (+ (- 1) C) 0)
                     (>= (+ (- 1) B) 0)
                     (or (< (- A C) 0) (= F true))
                     (>= (- B C1) 0)))
           (a!6 (or (< (+ (- 1) C) 0)
                    ...
                    (< (- B C1) 0)
                    (= B1 true))))
     (let ((a!7 (and (str_invariant W V U T R Q P O N M L K J I G)
                     ...
                     a!6
                     (not (= D true)))))
       (=> a!7 (str_invariant D1 S H F E D C B A C1 B1 A1 Z Y X))))
    ))
