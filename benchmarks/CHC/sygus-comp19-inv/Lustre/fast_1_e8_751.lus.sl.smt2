...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (and (and (not (= S3 true)) (not (= R3 true))) (= Q3 true)))
           ...
           (a!13 (or (= J2 true) (and (not (= X2 true)) (not (= D true)))))
           (a!15 (or (not (= B3 true)) (and (= Y2 true) (not (= W1 true)))))
           (a!16 (and (or (not (= U true)) (not (= B3 true))) (= F1 true)))
           (a!18 (and (or (not (= U true)) (not (= B3 true)))
                      (or (and (= U true) (= B3 true)) (not (= F1 true)))))
           (a!19 (or (and (= M3 true) (not (= H1 true))) (not (= I3 true))))
           (a!20 (or (and (= I3 true) (or (= H3 true) (= G3 true) (= F3 true)))
                     (not (= I3 true))
                     (not (= O3 true))))
           (a!21 (or (not (= I3 true))
                     (and (not (= H3 true)) (not (= G3 true)) (not (= F3 true)))))
           (a!22 (or (and (= S3 true) (not (= N1 true))) (not (= H3 true))))
           (a!23 (or (and (= R3 true) (not (= M1 true))) (not (= G3 true))))
           (a!24 (or (and (= Q3 true) (not (= L1 true))) (not (= F3 true)))))
     (let ((a!2 (or (and (= S3 true) (not (= R3 true)) (not (= Q3 true)))
                    (and (not (= S3 true)) (= R3 true) (not (= Q3 true)))
                    a!1
                    (not (= K2 true))))
           (a!14 (and (or (not (= J2 true)) (not (= X2 true))) a!13))
           (a!17 (and (not (= C3 true))
                      (not (= J3 true))
                      (or (not (= F1 true)) (not (= B3 true)))
                      (or (and (= U true) (= B3 true)) a!16))))
     (let ((a!25 (and (str_invariant Y1
                                     X1
                                     W1
                                     V1
                                     U1
