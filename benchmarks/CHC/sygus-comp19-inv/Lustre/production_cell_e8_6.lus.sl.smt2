...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (= F1 true) (and (not (= W true)) (not (= V true))))))
     (let ((a!2 (and (or (= B1 true) (not (= A1 true)))
                     ...
                     (not (= A K1))
                     (= D true)
                     (or (and (= A1 true) (= X true)) (not (= E1 true)))
                     ...
                     (= B true)
                     (or (not (= A1 true)) (not (= X true)) (= E1 true))
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (and (not (= V2 true)) (not (= S2 true)))
           ...
           (a!2 (or (or (not (= V2 true)) (not (= S2 true))) (not (= B true))))
           (a!4 (and (or (not (= Y2 true)) (not (= Z2 true))) (= Y2 true)))
           (a!7 (or (= A true)
                    (and (not (= A true)) (not (= B true)) (= I1 true))
                    (not (= Y2 true))))
           (a!8 (and (not (= A true))
                     (or (= A true) (= B true) (not (= I1 true)))))
           (a!9 (or (or (not (= V2 true)) (not (= S2 true))) (= A true)))
           (a!10 (or (and (not (= R2 true)) (not (= Q2 true))) (= B true))))
     (let ((a!3 (and (or (not (= P2 true)) (not (= N2 true)))
                     a!1
                     a!2
                     (or (and (= Y2 true) (= Z2 true)) (not (= Y2 true)))))
           (a!5 (or (and (= P2 true) (= N2 true))
                    (and (or (= V2 true) (= S2 true))
                         (or (= S2 true) (= B true))
                         (or (= V2 true) (= B true)))
                    (and (and (= V2 true) (= S2 true)) (= B true))
                    a!4)))
     (let ((a!6 (and a!5 (or (not (= P2 true)) (not (= N2 true))))))
     (let ((a!11 (and (str_invariant R1
                                     Q1
                                     P1
                                     O1
                                     N1
                                     ...
                                     D
                                     C)
                      (or a!3 (and (= P2 true) (= N2 true)) (not (= S1 true)))
                      ...
                      (not (= V1 O2))
                      (not (= X1 true))
                      (or (and (= V2 true) (= S2 true)) (not (= A true)))
