...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (and (and (not (= P4 true)) (not (= E4 true))) (= T3 true)))
           ...
           (a!10 (or (and (= E2 true) (= S2 true))
                     (and (not (= E2 true)) (= S2 true) (= J4 true))
                     (not (= D2 true))))
           ...
           (a!17 (and (or (not (= E2 true)) (not (= S2 true)))
                      (or (= E2 true) (not (= S2 true)) (not (= J4 true)))))
           (a!18 (or (or (not (= Y2 true)) (= H1 true)) (= V2 true)))
           (a!19 (and (or (not (= A true)) (not (= V2 true))) (= G true)))
           (a!21 (and (or (not (= A true)) (not (= V2 true)))
                      (or (and (= A true) (= V2 true)) (not (= G true)))))
           (a!22 (or (and (= L3 true) (not (= Q true))) (not (= K3 true))))
           (a!23 (or (and (not (= F3 true)) (not (= L3 true))) (= F3 true)))
           (a!24 (or (and (= D3 true) (not (= L3 true))) (not (= D3 true))))
           (a!25 (and (or (not (= D3 true)) (= L3 true)) (= D3 true)))
           (a!27 (or (and (= P4 true) (not (= Y true))) (not (= I3 true))))
           (a!28 (or (= S1 true) (or (not (= A1 true)) (not (= K true)))))
           (a!29 (or (and (= M3 true)
                          (not (= N2 true))
                          (= R1 true)
                          (= G1 true)
                          ...
                          (not (= C2 true)))
                     (not (= F3 true))))
           (a!30 (or (and (= E4 true) (not (= X true))) (not (= H3 true))))
           (a!31 (or (= N1 true) (or (not (= Z true)) (not (= A5 true)))))
           (a!32 (or (and (= T3 true) (not (= W true))) (not (= G3 true))))
           (a!33 (or (and (= M3 true) (not (= R true))) (not (= E3 true))))
           (a!34 (or (= C3 true) (or (not (= Y2 true)) (= H1 true))))
           (a!35 (or (not (= C3 true)) (and (= Y2 true) (not (= H1 true)))))
           (a!36 (= D5
                    (ite (= K3 true)
     ...
     (let ((a!2 (or (and (= P4 true) (not (= E4 true)) (not (= T3 true)))
                    ...
                    a!1
                    (not (= F2 true))))
           (a!20 (and (not (= W2 true))
                      (not (= J3 true))
                      (or (not (= G true)) (not (= V2 true)))
                      (or (and (= A true) (= V2 true)) a!19)))
           (a!26 (or (not (= D5 true))
                     (and (or (= F3 true) (= L3 true)) (not (= F3 true)))
                     (not (= C5 true))
                     a!25
                     (= O3 true))))
     (let ((a!38 (and (str_invariant J1
                                     I1
                                     H1
                                     F1
                                     E1
                      ...
                      (or (= W2 true)
                          ...
                          (= B3 true))
                      a!22
                      (or (and (= D5 true) a!23 (= C5 true) a!24)
                          (not (= O3 true)))
                      (not (= X1 true))
                      (not (= O2 true))
