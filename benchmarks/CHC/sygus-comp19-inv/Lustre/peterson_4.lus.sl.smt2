...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (or (= H1 true) (= G1 true)) (= F1 true)))
           ...
           (a!14 (and (and (not (= H1 true)) (not (= G1 true)))
                      ...
                      (not (= X true))
                      (not (= W true))))
           (a!20 (or (and (= F true) (>= (- 32766 Q) 0)) (not (= E true)))))
     ...
     (let ((a!21 (and (= L 0)
                      ...
                      a!20
                      (= A true)
                      (or (not (= F true)) (< (- 32766 Q) 0) (= E true))
                      (= U true))))
       (=> a!21
           (str_invariant H1
                          G1
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (ite (= N2 true)
           ...
           (a!34 (and (and (not (= P2 true)) (not (= E2 true)))
                      ...
                      (not (= N2 true))
                      (not (= M2 true))))
           (a!40 (or (and (= U1 true) (>= (- 32766 G2) 0)) (not (= S1 true))))
     ...
     (let ((a!53 (and (str_invariant N1
                      ...
                      (= (- H2 a!9) 0)
                      (= (- J2 a!10) 0)
                      (or (not (= R1 true)) (>= G2 0) (not (= L2 true)))
                      ...
                      a!40
                      (not (= O1 true))
                      (or (not (= U1 true)) (< (- 32766 G2) 0) (= S1 true))
                      a!41
                      a!42
                      a!43
                      a!44
