...
(assert (forall ((A Int)
  ...
  (let ((a!1 (>= (ite (not (= J1 true)) 0 1) 0))
           ...
           (a!13 (or (and (>= L1 0) (>= (- 256 L1) 0)) (not (= X true))))
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (not (= N2 true))
           ...
           (a!36 (or (and (>= I4 0) (>= (- 256 I4) 0)) (not (= Q2 true))))
           (a!39 (or (and (not (= I true)) (= G true)) (not (= V1 true))))
           (a!42 (ite (and (= B2 true) (not (= N2 true)))
                      0
                      (ite (= N2 true) (+ (* 60 A2) (* 10 Y1) X1) Z)))
           (a!43 (ite (= D3 true) (ite (= (+ (- 2) C3) 0) 1 C3) C3))
           (a!44 (and (= (+ (- 2) C3) 0)
                      (or (not (= B4 0)) (= M3 0))
                      (not (= H4 true))
                      (not (= G4 true))))
           (a!45 (ite (not (= (+ (- 2) X2) 0)) 2 X2))
           (a!46 (ite (not (= (+ (- 2) X2) 0)) 2 A3))
           (a!47 (ite (not (= (+ (- 4) D4) 0)) 1 Z2))
           (a!48 (ite (not (= (+ (- 2) X3) 0)) 2 Y2))
           (a!49 (ite (not (= (+ (- 4) U3) 0)) 1 W2))
           (a!50 (ite (= H4 true) (ite (= (+ (- 2) E4) 0) 1 E4) E4))
           (a!51 (ite (not (= (+ (- 3) O3) 0)) 3 J4))
           (a!53 (ite (not (= (+ (- 2) K3) 0)) 2 E))
           (a!54 (div (+ S1 (* (- 60) (div S1 60))) 10))
           (a!56 (= H4
                    (and (= (+ (- 2) E4) 0)
                         (>= (+ (- 1) F4) 0)
                         (not (= G4 true)))))
           (a!57 (ite (not (= (+ (- 4) D4) 0)) 4 D4))
           (a!58 (ite (and (>= (+ (- 1) Y3) 0) (>= (- 3 Y3) 0)) 0 Y3))
           (a!59 (= C4
                    (and (= (+ (- 3) Y3) 0)
                         (not (= B4 0))
                         (not (= Z3 true))
                         (= (+ (- 3) Y3) 0)
                         (not (= Z3 true)))))
           (a!60 (= B4 (ite (not (= A4 true)) 0 1)))
           (a!61 (= A4 (and (= K2 true) (not (= P1 true)))))
           (a!62 (ite (not (= (+ (- 2) X3) 0)) 2 X3))
           (a!63 (ite (= W3 true) (ite (= (+ (- 3) V3) 0) 1 V3) V3))
           (a!64 (= W3
                    (and (= (+ (- 3) V3) 0)
                         (not (= H3 0))
                         (not (= M3 0))
                         (not (= T3 true)))))
           (a!65 (ite (not (= (+ (- 4) U3) 0)) 4 U3))
           (a!66 (= T3
                    (and (= (+ (- 2) R3) 0) (>= (- S3) 0) (= (+ (- 2) R3) 0))))
           (a!67 (ite (not (= (+ (- 3) O3) 0)) 3 O3))
           (a!68 (= P3
                    (and (= L3 true)
                         (>= (+ (- 1) O3) 0)
                         (>= (- 3 O3) 0)
                         (not (= N3 true)))))
           (a!69 (ite (not (= (+ (- 2) K3) 0)) 2 K3))
           (a!70 (and (>= (+ (- 1) K3) 0) (>= (- 3 K3) 0)))
           (a!72 (= M3 (ite (not (= R2 true)) 0 1)))
           (a!73 (or (< (+ (- 1) J3) 0) (< (- 3 J3) 0)))
           (a!74 (ite (= I3 true) (ite (= (+ (- 4) F) 0) 0 F) F))
           (a!75 (= (ite (>= (- O2) 0) 0 1) 0))
           (a!77 (= H3 (ite (not (= G3 true)) 0 1)))
           (a!78 (= G3 (and (= V2 true) (not (= Q1 true))))))
     (let ((a!6 (ite (and (not (= I3 true)) a!4) (ite (= D3 true) a!5 E3) R3))
           ...
           (a!40 (ite (and (not (= I3 true)) a!4)
                      (ite (= H4 true) (+ (- 1) F4) F4)
                      S3))
           (a!52 (= W2 (ite (= I3 true) (ite (= P3 true) a!51 J4) E)))
           (a!55 (= I4 (+ S1 (* (- 10) a!54) (* (- 60) (div S1 60)))))
           (a!71 (= N3 (and (= L3 true) a!70 (not (= M3 0)))))
           (a!76 (= I3
                    (and (= F3 true)
                         (= (+ (- 4) F) 0)
                         (not (= H3 0))
     ...
     (let ((a!79 (and (str_invariant Q1
                      ...
                      (>= (- 1 H3) 0)
                      (= (- R1 T1) 0)
                      (or (< I4 0) (< (- 256 I4) 0) (= Q2 true))
                      (= a!41 0)
                      (= (- O2 a!42) 0)
                      (or (= I true) (not (= G true)) (= V1 true))
                      (= E3 a!43)
                      (= D3 a!44)
                      (= C3 (ite (= H4 true) a!45 X2))
                      (= B3 (ite (= H4 true) a!46 A3))
                      (= A3 (ite (= C4 true) a!47 Z2))
                      (= Z2 (ite (= W3 true) a!48 Y2))
                      (= Y2 (ite (= T3 true) a!49 W2))
                      (= X2 a!50)
                      a!52
                      (= J4 (ite (= N3 true) a!53 E))
                      a!55
                      a!56
                      (= G4 (or (= C4 true) (= Z3 true)))
                      (= F4 (ite (= C4 true) 0 S3))
                      (= E4 (ite (= C4 true) a!57 D4))
                      (= D4 (ite (= C4 true) a!58 Y3))
                      a!59
                      a!60
                      a!61
                      (= Z3 (or (= W3 true) (= T3 true)))
                      (= Y3 (ite (= W3 true) a!62 X3))
                      (= X3 a!63)
                      a!64
                      (= V3 (ite (= T3 true) a!65 U3))
                      (= U3 (ite (= T3 true) (ite a!4 0 R3) R3))
                      a!66
                      (= S3 (ite (= F3 true) O2 D))
                      (= R3 (ite (= I3 true) Q3 J3))
                      (= Q3 (ite (= P3 true) a!67 O3))
                      a!68
                      (= O3 (ite (= N3 true) a!69 K3))
                      a!71
                      a!72
                      (= L3 (and a!73 a!70))
                      (= K3 (ite a!73 1 J3))
