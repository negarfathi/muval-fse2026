...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (- B (ite (= C true) E (ite (= D true) (+ E F) E))))
     ...
     (let ((a!3 (ite (or (= N true) (not (= M true))) 1 a!2)))
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (or (and (= P true) (< X 0))
           ...
           (a!6 (ite (and (= Q true) (not (= B1 true))) 2 0)))
     (let ((a!7 (ite (or (= B1 true) (not (= Q true))) 1 a!6)))
     (let ((a!8 (and (str_invariant V U T S R P O N M L K J I H)
                     a!1
                     a!2
                     (or a!3 (= D true))
                     (= a!4 0)
                     ...
                     (not (= B true))
                     (not (= F true)))))
       (=> a!8 (str_invariant B1 Q G F E D C B A A1 Z Y X W)))))
    ))
