...
(assert (forall ((A Int)
  ...
  (let ((a!1 (ite (= E true)
     ...
     (let ((a!2 (ite (= K true) (ite (>= (+ (- 1) O) 0) (+ (- 1) O) O) a!1))
           ...
           (a!12 (ite (= V true)
                      (ite (= W1 true) (+ (- 1) Q) Q)
                      (ite (= D true) (ite (= V1 true) (+ (- 1) Q) Q) a!11)))
     ...
     (let ((a!3 (ite (= R1 true)
           ...
           (a!6 (ite (= V true) (ite (= W1 true) (+ (+ 1 O) N) N) a!5))
           (a!10 (- N1 (ite (= G1 true) (ite (= X1 true) (+ (- 1) P) P) a!9)))
           (a!13 (ite (= R1 true)
                      (ite (= Y1 true) (+ (- 1) Q) Q)
                      (ite (= G1 true) (ite (= X1 true) (+ (- 1) Q) Q) a!12)))
     ...
     (let ((a!7 (- L1 (ite (= G1 true) (ite (= X1 true) (+ 2 N) N) a!6)))
           (a!24 (or (not (= K1 true))
                     (and a!20 (not (= B true)))
                     (and (= R1 true)
                          (not (= G1 true))
