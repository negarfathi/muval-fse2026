...
(assert (forall ((A Bool)
         ...
         (T Bool)
         (U Bool))
  (let ((a!1 (= U (or (not (= G true)) (>= (- 1 K) 0))))
           (a!2 (or (not (= G true)) (= (- (+ K L M) E) 0))))
     (let ((a!3 (and (= (- J P) 0)
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (ite (= P true)
           ...
           (a!10 (= O1 (or (not (= H1 true)) (>= (- 1 A) 0))))
           (a!11 (or (not (= H1 true)) (= (- (+ A B C) L) 0)))
           (a!12 (or (not (= H1 true)) (= (- (+ A B C) F1) 0))))
     (let ((a!2 (ite (= A1 true)
                     (ite (>= (+ (- 1) S) 0) (+ (+ (- 1) T) S R) T)
                     a!1))
     ...
     (let ((a!13 (and (str_invariant Z Y X W V U T S R Q O N M L K J I H G)
                      (= (- C a!3) 0)
                      (= (- B a!6) 0)
