...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (or (= B1 true) (= A1 true)) (= Z true)))
     ...
     (let ((a!21 (and (= L 0)
                      ...
                      (= (- C P) 0)
                      (= K 0)
                      (or (not (= E true)) (>= J 0) (not (= O true)))
                      (or (= F true) (not (= E true)))
                      (or (< (+ (- 2) M) 0) (= H true))
                      (= (- I C) 0)
                      (= J 0)
                      (= M 0)
                      (or (and (= E true) (< J 0)) (= O true))
                      (or (= G true) a!8)
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (ite (= A true) (ite (>= (+ (- 1) O) 0) (+ (- 1) O) O) O))
           ...
           (a!29 (and (and (not (= D2 true)) (not (= S1 true)))
                      (not (= H1 true))))
           (a!34 (and (and (not (= D2 true)) (not (= S1 true)))
                      (= H1 true)
                      (not (= W true))
                      (not (= L true))
                      (not (= D true))
                      ...
                      (not (= B2 true))
                      (not (= A2 true))))
           (a!40 (or (and (= P1 true) (>= (+ (- 1) Z1) 0)) (not (= O1 true))))
           (a!41 (and (>= (+ (- 1) N) 0) (= O 0) (= Q 0) (= R 0) (= P 0)))
           (a!42 (= I2 (and (= (+ (- 1) P) 0) (= Q 0))))
           (a!43 (= H2 (and (= P 0) (= (+ (- 1) Q) 0))))
           (a!44 (and (>= (+ (- 1) N) 0) (>= (+ (+ (- 1) R) Q P O) 0))))
     (let ((a!2 (ite (= C true)
                     (ite (= J2 true) (+ 1 O) O)
           ...
           (a!25 (or (or (or a!21 (= W true)) (= L true))
                     ...
                     (= B2 true)
                     (= A2 true)))
           (a!30 (and (and a!29 (not (= W true))) (not (= L true))))
           (a!35 (and (and a!29 (not (= W true)))
                      (= L true)
                      (not (= D true))
                      (not (= C true))
                      (not (= B true))
     ...
     (let ((a!5 (- T1 (ite (= S1 true) (ite (= F2 true) 0 O) a!4)))
           ...
           (a!28 (and a!24
                      ...
                      a!27))
           (a!33 (and (and a!32 (not (= C2 true))) (not (= B2 true))))
           (a!38 (and (and a!32 (not (= C2 true)))
                      (= B2 true)
                      (not (= A2 true)))))
     (let ((a!11 (ite (= D2 true)
           ...
           (a!39 (or (not (= P1 true))
                     ...
                     (and a!31
                          ...
                          (not (= A2 true)))
                     a!37
                     (and a!32 (= C2 true) (not (= B2 true)) (not (= A2 true)))
                     a!38
                     (and a!33 (= A2 true)))))
     (let ((a!45 (and (str_invariant I1
                                     G1
                                     F1
                                     E1
                                     D1
                      ...
                      (= (- L1 G) 0)
                      (or (not (= N1 true)) (>= T1 0) (not (= Y1 true)))
                      (or (and (= O1 true) (= I true)) (not (= N1 true)))
                      (or (< (+ (- 2) W1) 0) (= Q1 true))
                      (= (- U1 a!14) 0)
                      (= (- V1 a!17) 0)
                      (= (- W1 a!20) 0)
                      (or (and (= N1 true) (< T1 0)) (= Y1 true))
                      (or (= P1 true) a!28)
