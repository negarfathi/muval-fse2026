...
(assert (forall ((A Int)
  ...
  (let ((a!1 (= (- N2 (ite (= T1 true) (+ 1 C1) C1)) 0))
           (a!2 (= (- A (ite (= P2 true) (+ 1 E1) E1)) 0))
           (a!3 (= (- O2 (ite (= E2 true) (+ 1 D1) D1)) 0))
           (a!4 (or (and (= W true) (not (= T1 true))) (not (= W true))))
           (a!5 (or (and (>= I 9) (not (= P2 true))) (< I 9)))
           (a!6 (or (and (not (= P true)) (>= B2 10))
                    (and (= P true) (> B2 0))
                    (not (= A2 true))))
           (a!7 (and (or (not (= W true)) (= T1 true)) (= W true)))
           (a!9 (or (and (= V true) (not (= T1 true))) (not (= V true))))
           (a!10 (or (and (>= F 9) (not (= E2 true))) (< F 9)))
           (a!11 (or (and (not (= O true)) (<= B2 (- 10)))
                     (and (= O true) (< B2 0))
                     (not (= Z1 true))))
           (a!12 (and (or (= P true) (< B2 10)) (or (not (= P true)) (<= B2 0))))
           (a!13 (- U1
                    (ite (and (= Z true) (= K2 true))
                         (ite (= P2 true) (+ 2 I) I)
                         0)))
           (a!14 (or (and (not (= L true)) (>= Y1 10))
                     (and (= L true) (> Y1 0))
                     (not (= X1 true))))
           (a!15 (and (or (not (= V true)) (= T1 true)) (= V true)))
           (a!17 (and (or (= O true) (> B2 (- 10)))
                      (or (not (= O true)) (>= B2 0))))
           (a!18 (or (and (not (= K true)) (<= Y1 (- 10)))
                     (and (= K true) (< Y1 0))
                     (not (= W1 true))))
           (a!19 (and (or (= L true) (< Y1 10)) (or (not (= L true)) (<= Y1 0))))
           (a!20 (- Q1
           ...
           (a!21 (or (not (= G2 true))
                     (and (>= (+ 10 H1) 0) (>= (- 20 H1) 0))
                     (not (= I1 true))))
           (a!22 (and (or (= K true) (> Y1 (- 10)))
                      (or (not (= K true)) (>= Y1 0))))
           (a!23 (and (= G2 true) (or (< (+ 10 H1) 0) (< (- 20 H1) 0)))))
     (let ((a!8 (or a!7 (and (or (< I 9) (= P2 true)) (>= I 9)) (= D2 true)))
           (a!16 (or a!15 (and (or (< F 9) (= E2 true)) (>= F 9)) (= C2 true))))
     (let ((a!24 (and (str_invariant N1
                                     M1
                                     L1
                                     K1
                                     J1
                      ...
                      (or (and a!4 a!5) (not (= D2 true)))
                      (or (not (= H2 true)) (= W1 true))
                      a!6
                      (= (- (+ N2 B2) A) 0)
                      a!8
                      (= (- M2 B2) 0)
                      (or (and a!9 a!10) (not (= C2 true)))
                      a!11
                      (or a!12 (= A2 true))
                      (= a!13 0)
                      (= (- L2 Y1) 0)
