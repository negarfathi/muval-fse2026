...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (- B (ite (= C true) E (ite (= D true) (+ E F) E))))
           (a!2 (or (and (not (= M true)) (not (= L true))) (= D true)))
           (a!3 (ite (and (= L true) (not (= M true))) 2 0)))
     (let ((a!4 (ite (and (= M true) (not (= L true))) 1 a!3)))
     (let ((a!5 (and (not (= I true))
                     (= a!1 0)
                     (not (= H true))
                     ...
                     (= G true)
                     (= J true))))
       (=> a!5 (str_invariant M L K J I H G F E D C B A)))))
    ))
(assert (forall ((A Int)
         (B Int)
         (C Bool)
  ...
  (let ((a!1 (or (and (= Q true) (< W 0))
           ...
           (a!6 (or (and (not (= Z true)) (not (= O true))) (= Y true)))
           (a!7 (ite (and (= O true) (not (= Z true))) 2 0)))
     (let ((a!8 (ite (and (= Z true) (not (= O true))) 1 a!7)))
     (let ((a!9 (and (str_invariant U T S R Q P N M L K J I H)
                     a!1
                     a!2
                     (or a!3 (= E true))
                     (= a!4 0)
                     ...
                     (not (= C true))
                     (not (= F true)))))
       (=> a!9 (str_invariant Z O G F E D C B A Y X W V)))))
    ))
