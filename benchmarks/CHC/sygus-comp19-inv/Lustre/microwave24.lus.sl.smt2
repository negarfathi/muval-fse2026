...
(assert (forall ((A Int)
  ...
  (let ((a!1 (>= (ite (not (= J1 true)) 0 1) 0))
           ...
           (a!13 (or (= X true) (and (= J1 true) (not (= L1 0)))))
     ...
     (let ((a!17 (and (or (= Z true) (not (= K true)))
                      ...
                      (>= a!14 0)
                      (= (- A C) 0)
                      (or (not (= X true)) (not (= J1 true)) (= L1 0))
                      (= B 0)
                      (= (- V a!15) 0)
                      (= J true)
                      (= E true)
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (not (= N2 true))
           ...
           (a!36 (or (= Q2 true) (and (= 1 C) (= K2 true) (not (= G4 0)))))
           ...
           (a!55 (= F4
                    (and (= (+ (- 2) C4) 0)
                         (>= (+ (- 1) D4) 0)
                         (not (= E4 true)))))
           (a!56 (ite (not (= (+ (- 4) B4) 0)) 4 B4))
           (a!57 (ite (and (>= (+ (- 1) W3) 0) (>= (- 3 W3) 0)) 0 W3))
           (a!58 (= A4
                    (and (= (+ (- 3) W3) 0)
                         (not (= Z3 0))
                         (not (= X3 true))
                         (= (+ (- 3) W3) 0)
                         (not (= X3 true)))))
           (a!59 (= Z3 (ite (not (= Y3 true)) 0 1)))
           (a!60 (= Y3 (and (= K2 true) (not (= P1 true)))))
           (a!61 (ite (not (= (+ (- 2) V3) 0)) 2 V3))
           (a!62 (ite (= U3 true) (ite (= (+ (- 3) T3) 0) 1 T3) T3))
           (a!63 (= U3
                    (and (= (+ (- 3) T3) 0)
                         (not (= F3 0))
                         (not (= K3 0))
                         (not (= R3 true)))))
           (a!64 (ite (not (= (+ (- 4) S3) 0)) 4 S3))
           (a!65 (= R3
                    (and (= (+ (- 2) P3) 0) (>= (- Q3) 0) (= (+ (- 2) P3) 0))))
           (a!66 (ite (not (= (+ (- 3) M3) 0)) 3 M3))
           (a!67 (= N3
                    (and (= J3 true)
                         (>= (+ (- 1) M3) 0)
                         (>= (- 3 M3) 0)
                         (not (= L3 true)))))
           (a!68 (ite (not (= (+ (- 2) I3) 0)) 2 I3))
           (a!69 (and (>= (+ (- 1) I3) 0) (>= (- 3 I3) 0)))
           (a!71 (= K3 (ite (not (= R2 true)) 0 1)))
           (a!72 (or (< (+ (- 1) H3) 0) (< (- 3 H3) 0)))
           (a!73 (ite (= G3 true) (ite (= (+ (- 4) F) 0) 0 F) F))
           (a!74 (= (ite (>= (- O2) 0) 0 1) 0))
           (a!76 (= F3 (ite (not (= E3 true)) 0 1)))
           (a!77 (= E3 (and (= V2 true) (not (= Q1 true))))))
     (let ((a!6 (ite (and (not (= G3 true)) a!4) (ite (= B3 true) a!5 C3) P3))
           ...
           (a!70 (= L3 (and (= J3 true) a!69 (not (= K3 0)))))
           (a!75 (= G3
                    (and (= D3 true)
                         (= (+ (- 4) F) 0)
                         (not (= F3 0))
     ...
     (let ((a!78 (and (str_invariant Q1
                      ...
                      (= D4 (ite (= A4 true) 0 Q3))
                      (= C4 (ite (= A4 true) a!56 B4))
                      (= B4 (ite (= A4 true) a!57 W3))
                      a!58
                      a!59
                      a!60
                      (= X3 (or (= U3 true) (= R3 true)))
                      (= W3 (ite (= U3 true) a!61 V3))
                      (= V3 a!62)
                      a!63
                      (= T3 (ite (= R3 true) a!64 S3))
                      (= S3 (ite (= R3 true) (ite a!4 0 P3) P3))
                      a!65
                      (= Q3 (ite (= D3 true) O2 D))
                      (= P3 (ite (= G3 true) O3 H3))
                      (= O3 (ite (= N3 true) a!66 M3))
                      a!67
                      (= M3 (ite (= L3 true) a!68 I3))
                      a!70
                      a!71
                      (= J3 (and a!72 a!69))
                      (= I3 (ite a!72 1 H3))
