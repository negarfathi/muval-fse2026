...
(assert (forall ((A Int)
  ...
  (let ((a!1 (- D (ite (= F true) (ite (= E true) 4 0) 0)))
           ...
           (a!10 (- C (ite (= F true) (ite (= E true) 1 0) 0)))
           (a!11 (- 1 (ite (not (= K1 true)) 0 1)))
           (a!12 (and (not (= (+ (- 2) O1) 0)) (not (= (+ (- 3) O1) 0))))
           (a!13 (ite (and (= J true) (not (= U true)))
                      0
                      (+ (* 60 I) (* 10 H) G)))
           (a!14 (ite (not (= (+ (- 3) M1) 0)) 3 M1))
           (a!15 (= N1 (and (>= (+ (- 1) M1) 0) (>= (- 3 M1) 0) (= L1 0))))
           (a!16 (= M1 (ite (not (= L1 0)) 2 1)))
           (a!17 (= L1 (ite (not (= Y true)) 0 1))))
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (not (= N2 true))
           ...
           (a!34 (ite (not (= (+ (- 4) F) 0)) 1 E))
           (a!35 (ite (not (= (+ (- 3) G3) 0)) 3 D3))
           (a!38 (or (and (not (= I true)) (= G true)) (not (= V1 true))))
           (a!41 (and (not (= (+ (- 2) S3) 0)) (not (= (+ (- 3) S3) 0))))
           ...
           (a!62 (ite (not (= (+ (- 3) Q3) 0)) 3 T3))
           (a!64 (ite (not (= (+ (- 2) M3) 0)) 2 E))
           (a!65 (ite (not (= (+ (- 3) Q3) 0)) 3 Q3))
           (a!66 (= R3
                    (and (= N3 true)
                         (>= (+ (- 1) Q3) 0)
                         (>= (- 3 Q3) 0)
     ...
     (let ((a!6 (ite (and (not (= K3 true)) a!4) (ite (= F3 true) a!5 G3) V3))
           ...
           (a!36 (ite (and (not (= K3 true)) a!4) (ite (= F3 true) a!35 D3) U3))
           (a!63 (= U3 (ite (= K3 true) (ite (= R3 true) a!62 T3) E)))
     ...
     (let ((a!7 (- U1 (ite (= W1 true) (ite (= V1 true) a!3 a!6) F)))
           ...
           (a!37 (- T1 (ite (= W1 true) (ite (= V1 true) a!34 a!36) E))))
     ...
     (let ((a!25 (ite (and (= H2 true) (not (= T true))) 4 a!24))
           ...
           (a!39 (ite (= K2 true) 0 (ite (>= (- 9 a!19) 0) K L))))
     ...
     (let ((a!77 (and (str_invariant Q1
                      ...
                      a!61
                      (= W3 (ite (= H3 true) O2 D))
                      (= V3 (ite (= K3 true) S3 L3))
                      a!63
                      (= T3 (ite (= P3 true) a!64 E))
                      (= S3 (ite (= R3 true) a!65 Q3))
                      a!66
