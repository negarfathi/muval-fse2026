...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (= (- (+ K L M N O) F) 0))
     ...
     (let ((a!22 (and (= N 0)
                      ...
                      (= (- D R) 0)
                      (= M 0)
                      (or (not (= G true)) a!1 (not (= Q true)))
                      (or (= H true) (not (= G true)))
                      (or (< (+ (- 2) O) 0) (= J true))
                      (= (- K D) 0)
                      (= L 0)
                      (= O 0)
                      (or (and (= G true) (not a!1)) (= Q true))
                      (or (= I true) a!9)
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (ite (= A true) (ite (>= (+ (- 1) Q) 0) (+ (- 1) Q) Q) Q))
           ...
           (a!12 (= (- (+ V1 X1 Y1 Z1 A2) Q1) 0))
           (a!13 (ite (= F2 true) (ite (>= (+ (- 1) R) 0) (+ (- 1) R) R) R))
           (a!16 (ite (= G2 true) (ite (>= (+ (- 1) S) 0) (+ (- 1) S) S) S))
           (a!19 (ite (>= (+ (- 1) T) 0) (+ (- 1) T) T))
     ...
     (let ((a!2 (ite (= C true)
           ...
           (a!14 (ite (= E true)
                      (ite (>= (+ (- 2) S R) 0) 1 R)
                      (ite (= B true) (ite (= I2 true) 1 R) a!13)))
           (a!17 (ite (= E true)
                      (ite (>= (+ (- 2) S R) 0) (+ (+ (- 1) S) R) S)
                      (ite (= B true) (ite (= I2 true) (+ T S R Q) S) a!16)))
           (a!20 (ite (= L1 true)
                      a!19
                      (ite (= B true)
                           (ite (= I2 true) 0 T)
     ...
     (let ((a!3 (ite (= A1 true)
           ...
           (a!15 (ite (= W1 true)
                      (ite (= J2 true) (+ R Q) R)
                      (ite (= A1 true) (ite (= M2 true) 0 R) a!14)))
           (a!18 (ite (= W1 true)
                      (ite (= J2 true) (+ (+ 1 T) S) S)
                      (ite (= P true) (ite (= L2 true) 0 S) a!17)))
           (a!21 (ite (= H2 true)
                      (ite (= K2 true) (+ 1 T) T)
                      (ite (= W1 true) (ite (= J2 true) 0 T) a!20)))
     ...
     (let ((a!48 (and (str_invariant J1
                      ...
                      (= (- O1 H) 0)
                      (or (not (= R1 true)) a!12 (not (= C2 true)))
                      (or (and (= S1 true) (= K true)) (not (= R1 true)))
                      (or (< (+ (- 2) A2) 0) (= U1 true))
                      (= (- Y1 a!15) 0)
                      (= (- Z1 a!18) 0)
                      (= (- A2 a!21) 0)
                      (or (and (= R1 true) (not a!12)) (= C2 true))
                      (or (= T1 true) a!29)
