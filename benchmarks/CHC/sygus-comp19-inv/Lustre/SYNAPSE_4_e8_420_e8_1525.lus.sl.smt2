...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (and (= D true) (< (- H) 0) (< (- I) 0)) (= L true))))
     (let ((a!2 (and (= (- G M) 0)
                     ...
                     (= K true))))
       (=> a!2 (str_invariant P O N M L K J I H G F E D C B A))))
    ))
(assert (forall ((A Int)
         (B Int)
         (C Int)
  ...
  (let ((a!1 (ite (= J true)
     ...
     (let ((a!11 (and (str_invariant X W V T S R Q P O N M L K I H G)
                      (= (- C a!3) 0)
                      (= (- B a!6) 0)
                      (= (- A a!9) 0)
                      (or (not (= B1 true))
                      ...
                      (not (= D true)))))
       (=> a!11 (str_invariant F1 U J F E D C B A E1 D1 C1 B1 A1 Z Y))))))
    ))
