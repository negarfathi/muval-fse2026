  ...
  (let ((a!1 (ite (and (= (+ (- 1) R) 0) (>= (- O S1) 0)) 2 R))
     ...
     (let ((a!3 (- Y1
           ...
           (a!26 (or (or (or a!23 (= A1 true)) (= P true))
                     ...
                     (= B true)
                     (= A true)))
           (a!30 (and (and a!29 (not (= A1 true))) (not (= P true))))
           (a!34 (and (and a!29 (not (= A1 true)))
                      (= P true)
                      (not (= E true))
                      (not (= C true))
                      (not (= B true))
     ...
     (let ((a!16 (ite (= L1 true) (ite (= (+ (- 2) T) 0) (+ 1 O) O) a!15))
           ...
           (a!31 (and (and a!30 (not (= E true))) (not (= C true))))
           (a!35 (and (and a!30 (not (= E true)))
                      (= C true)
                      (not (= B true))
                      (not (= A true)))))
     (let ((a!28 (and a!25
