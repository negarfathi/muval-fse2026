...
(assert (forall ((A Bool)
         ...
         (T Bool)
         (U Bool))
  (let ((a!1 (and (or (not (= S true)) (not (= R true)))
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (ite (= P true)
           ...
           (a!10 (and (or (not (= L1 true)) (not (= A1 true)))
                      (or (not (= L1 true)) (not (= P true)))
                      (or (not (= A1 true)) (not (= P true)))))
           (a!11 (= O1 (or (not (= H1 true)) (>= (- 1 A) 0))))
           (a!12 (or (not (= H1 true)) (= (- (+ A B C) L) 0)))
           (a!13 (or (not (= H1 true)) (= (- (+ A B C) F1) 0))))
     (let ((a!2 (ite (= A1 true)
                     (ite (>= (+ (- 1) S) 0) (+ (+ (- 1) T) S R) T)
                     a!1))
     ...
     (let ((a!14 (and (str_invariant Z Y X W V U T S R Q O N M L K J I H G)
                      (= (- C a!3) 0)
                      (= (- B a!6) 0)
