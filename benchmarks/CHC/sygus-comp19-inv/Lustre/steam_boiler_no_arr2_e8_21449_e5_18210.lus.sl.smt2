...
(assert (forall ((A Int)
  ...
  (let ((a!1 (or (= T2 true)
           ...
           (a!10 (and (or (not (= T1 true)) (not (= S1 true)))
                      (not (= R1 true))
                      (not (= Q1 true))))
           (a!11 (or (>= (- 150 I) 0) (>= (+ (- 850) I) 0)))
           (a!12 (and (< (- 150 I) 0) (< (+ (- 850) I) 0)))
           (a!13 (and (or (not (= O1 true)) (not (= N1 true)))
                      (not (= M1 true))
                      (not (= L1 true))))
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (or (= Z2 true)
           ...
           (a!10 (and (or (not (= W1 true)) (not (= V1 true)))
                      (not (= U1 true))
                      (not (= T1 true))))
           (a!11 (or (>= (- 150 T3) 0) (>= (+ (- 850) T3) 0)))
           (a!12 (and (< (- 150 T3) 0) (< (+ (- 850) T3) 0)))
           (a!13 (and (or (not (= Q1 true)) (not (= P1 true)))
                      (not (= O1 true))
                      (not (= N1 true))))
