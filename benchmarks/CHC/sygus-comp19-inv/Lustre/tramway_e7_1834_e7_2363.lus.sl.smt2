...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (= K true)
           ...
           (a!4 (or (not (= G true)) (and (not (= C true)) (not (= I true)))))
           (a!5 (or (and (= V1 true) (not (= U1 true))) (not (= L true))))
           (a!6 (or (and (= S1 true) (not (= T1 true)))
                    (not (= G true))
                    (= M1 true)))
           (a!7 (or (or (not (= V1 true)) (= U1 true)) (= L true)))
           (a!8 (or (= P true)
                    (and (not (= P true)) (not (= S1 true)) (= Q true))
                    (not (= O true))))
           (a!9 (or (and (= V1 true) (not (= U1 true))) (not (= P true))))
           (a!10 (or (and (= L1 true) (not (= M1 true))) (= R1 true)))
           (a!11 (and (not (= P true))
                      (or (= P true) (= S1 true) (not (= Q true)))))
           (a!12 (or (not (= I1 true)) (and (not (= S1 true)) (= U1 true))))
           (a!13 (or (or (not (= V1 true)) (= U1 true)) (= P true)))
           (a!14 (and (or (not (= E1 true)) (= O1 true))
           ...
           (a!15 (or (and (= C1 true) (= Z true))
                     (and (not (= C1 true)) (not (= Z true))))))
     (let ((a!16 (and (or (= A2 true) (not (= L1 true)))
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (= N3 true) (and (not (= N2 true)) (= W1 true))))
           (a!2 (or (= P2 true)
                    ...
                    (not (= G2 true))))
           (a!3 (or (not (= K2 true)) (and (not (= G2 true)) (not (= M2 true)))))
           (a!4 (or (and (not (= M3 true)) (= I1 true)) (= L3 true)))
           (a!5 (and (not (= P2 true))
                     (or (= P2 true) (= I2 true) (not (= C true)))))
           (a!6 (and (or (not (= N2 true)) (= Y2 true)) (= K2 true)))
           (a!7 (or (and (not (= K3 true)) (= F1 true)) (= I3 true)))
           (a!8 (or (and (= X3 true) (not (= J3 true))) (not (= Q2 true))))
           (a!9 (or (and (= N2 true) (not (= Y2 true)))
                    (not (= K2 true))
                    (= W3 true)))
           (a!10 (or (or (not (= X3 true)) (= J3 true)) (= Q2 true)))
           (a!11 (or (and (not (= G3 true)) (= C1 true)) (= F3 true)))
           (a!12 (or (= U2 true)
                     (and (not (= U2 true)) (not (= N2 true)) (= P true))
                     (not (= T2 true))))
           (a!13 (or (and (not (= J3 true)) (= Y1 true)) (= E3 true)))
           (a!14 (or (and (= S3 true) (not (= W3 true))) (= C2 true)))
           (a!15 (or (and (not (= O2 true)) (= J true)) (= M2 true)))
           (a!16 (and (not (= U2 true))
                      (or (= U2 true) (= N2 true) (not (= P true)))))
           (a!17 (or (not (= P3 true)) (and (not (= N2 true)) (= J3 true))))
           (a!18 (or (and (= X3 true) (not (= J3 true))) (not (= U2 true))))
           (a!19 (or (or (not (= X3 true)) (= J3 true)) (= U2 true)))
           (a!20 (and (or (not (= L3 true)) (= V true))
                      (or (not (= N3 true)) (= G1 true))
                      (or (not (= I3 true)) (= H3 true))
                      (= Y3 true)
                      (or (not (= J3 true)) (= Y2 true))
                      (or (not (= E3 true)) (not (= G1 true)))))
           (a!21 (or (and (= I3 true) (= F3 true))
                     (and (not (= I3 true)) (not (= F3 true))))))
     (let ((a!22 (and (str_invariant Z1
                                     Y1
                                     X1
                                     W1
                                     V1
