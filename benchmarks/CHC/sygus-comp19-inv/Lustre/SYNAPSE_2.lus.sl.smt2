...
(assert (forall ((A Bool)
         ...
         (P Bool)
         (Q Bool))
  (let ((a!1 (and (or (not (= Q true)) (not (= P true)))
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (ite (= L true)
           ...
           (a!11 (not (= (- (+ A B C) J) 0)))
           (a!12 (and (or (not (= H1 true)) (not (= W true)))
                      (or (not (= H1 true)) (not (= L true)))
     ...
     (let ((a!13 (and (str_invariant Y X V U T S R Q P O N M K J I H G)
                      (= (- C a!3) 0)
                      (= (- B a!6) 0)
                      a!7
                      (= (- A a!10) 0)
                      ...
                      (not (= D true)))))
       (=> a!13 (str_invariant H1 W L F E D C B A G1 F1 E1 D1 C1 B1 A1 Z))))))
    ))
