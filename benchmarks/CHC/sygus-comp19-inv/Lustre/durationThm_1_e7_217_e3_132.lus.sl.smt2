...
(assert (forall ((A Int)
  ...
  (let ((a!1 (or (not (= B1 true))
                    ...
                    (= E true)
                    (not (= D true))))
           (a!2 (or (and (not (= C1 true)) (not (= K true))) (= B1 true)))
           (a!3 (and (= B1 true) (>= (- (- E1 B) A) 0) (not (= E true))))
           (a!4 (= (- E1 (ite (= V true) (+ (- 1) N) 0)) 0))
           (a!5 (= (- D1 (ite (= T true) (+ (- 1) M) 0)) 0))
           (a!6 (and (>= (+ (- 1) B) 0)
                     (>= (+ (- 1) A) 0)
                     (or (< (- E1 B) 0) (= F true))
                     (or (< (- D1 A) 0) (= E true))))
           (a!7 (or (< (+ (- 1) B) 0)
                    ...
                    (= C1 true))))
     (let ((a!8 (and (str_invariant X W V T S R Q P O N M L K I H G)
                     ...
                     a!7
                     (not (= C true)))))
       (=> a!8 (str_invariant F1 U J F E D C B A E1 D1 C1 B1 A1 Z Y))))
    ))
