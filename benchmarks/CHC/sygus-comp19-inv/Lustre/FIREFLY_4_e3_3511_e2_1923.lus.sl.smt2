...
(assert (forall ((A Int)
  ...
  (let ((a!1 (ite (= E true)
     ...
     (let ((a!3 (ite (= V1 true)
           ...
           (a!6 (ite (= K1 true)
                     (ite (= A2 true) (+ 2 P) P)
                     (ite (= Z true) (ite (= Z1 true) (- P Q) P) a!5)))
     ...
     (let ((a!29 (and (str_invariant E1
                      ...
                      (= (- Q1 a!3) 0)
                      (= (- P1 a!6) 0)
                      (or (not (= M1 true)) (>= a!7 0) (not (= U1 true)))
                      (or (and (= N1 true) (= L true)) (not (= M1 true)))
                      (= (- I1 I) 0)
                      (= a!10 0)
                      (= (- S1 a!13) 0)
                      (or (and (= M1 true) (< a!7 0)) (= U1 true))
                      (or (= O1 true) a!17)
