...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (or (= W true) (= V true)) (= U true)))
     ...
     (let ((a!12 (and (= (- C O) 0)
                      ...
                      (= N true)
                      (= M true))))
       (=> a!12 (str_invariant W V U T S R Q P O N M L K J I H G F E D C B A)))))))
    ))
(assert (forall ((A Int)
         (B Bool)
         (C Bool)
  ...
  (let ((a!1 (ite (= E true)
           ...
           (a!23 (and (and (not (= T1 true)) (not (= I1 true)))
                      ...
                      (not (= C true))
                      (not (= B true))))
           (a!27 (and (>= (+ (- 1) R) 0) (= Q 0) (= O 0) (= P 0)))
           (a!28 (and (>= (+ (- 1) R) 0) (>= (+ (- 1) Q) 0)))
           (a!29 (and (>= (+ (- 1) R) 0) (>= (+ (+ (- 1) P) O) 0))))
     ...
     (let ((a!30 (and (str_invariant D1
                      ...
                      a!26
                      (not (= F1 true))
                      (or (and (= M1 true) (>= A 0)) (not (= L1 true)))
                      (not (= E1 true))
                      (or (not (= M1 true)) (< A 0) (= L1 true))
                      (= Z1 a!27)
                      (= Y1 a!28)
                      (= X1 a!29)
                      (= W1 a!27)
