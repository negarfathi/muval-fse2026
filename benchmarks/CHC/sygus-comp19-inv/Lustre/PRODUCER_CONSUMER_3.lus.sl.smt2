...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (and (or (not (= W true)) (not (= V true)))
     ...
     (let ((a!5 (and (= M 0)
                     ...
                     a!4
                     (= R true))))
       (=> a!5 (str_invariant W V U T S R Q P O N M L K J I H G F E D C B A)))))
    ))
(assert (forall ((A Int)
         (B Int)
         (C Int)
  ...
  (let ((a!1 (ite (= T1 true)
           ...
           (a!6 (not (= (+ (- (- 1) W) C) 0)))
           (a!8 (ite (= X true) (ite (>= (+ (- 1) U) 0) (+ 1 R) R) R))
           (a!9 (and (not (= T1 true)) (not (= I1 true)) (not (= X true))))
           (a!10 (and (or (not (= T1 true)) (not (= I1 true)))
                      (or (not (= T1 true)) (not (= X true)))
                      (or (not (= I1 true)) (not (= X true)))))
           (a!12 (= U1 (and (= N1 true) (= L1 true) (>= (+ (- 1) K1) 0)))))
     (let ((a!7 (and (= U1 true)
                     (= D1 true)
                     (= I1 true)
                     a!6
                     (not (= (- C W) 0))))
           (a!11 (or (and (not (= P1 true)) a!5) (= O1 true))))
     (let ((a!13 (and (str_invariant D1
                                     C1
                                     B1
                                     A1
                                     Z
