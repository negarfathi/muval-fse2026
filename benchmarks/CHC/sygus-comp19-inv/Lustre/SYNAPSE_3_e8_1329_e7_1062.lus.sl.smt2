...
(assert (forall ((A Bool)
         ...
         (Q Bool)
         (R Bool))
  (let ((a!1 (or (not (= F true)) (= (- (+ K L J) E) 0) (not (= N true))))
           (a!2 (not (= (- (+ K L J) E) 0)))
           (a!3 (and (or (not (= R true))
                         (not (= Q true))
                         (not (= R true))
                         (not (= P true)))
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (ite (= N true)
           ...
           (a!10 (or (not (= F1 true)) (= (- (+ A B C) E1) 0) (not (= E true))))
           (a!11 (not (= (- (+ A B C) E1) 0)))
           (a!12 (or (and (not (= G1 true)) (not (= L true))) (= F1 true)))
           (a!13 (and (or (not (= J1 true))
                          (not (= Y true))
                          (not (= J1 true))
                          (not (= N true)))
     ...
     (let ((a!14 (and (str_invariant Z X W V U T S R Q P O M L K J I H G)
                      (= (- C a!3) 0)
                      (= (- B a!6) 0)
                      (= (- A a!9) 0)
                      a!10
                      (or (= G1 true) (= L true) (not (= F1 true)))
                      (= (- I1 P) 0)
                      (or (and (= F1 true) a!11) (= E true))
                      (or (= H1 true)
                          (and (= J1 true) (= Y true) (= J1 true) (= N true))
                          (and (= Y true) (= N true)))
                      a!12
                      (not (= D1 true))
                      (or (not (= H1 true)) a!13)
                      ...
                      (not (= D true)))))
       (=> a!14 (str_invariant J1 Y N F E D C B A I1 H1 G1 F1 E1 D1 C1 B1 A1))))))
    ))
