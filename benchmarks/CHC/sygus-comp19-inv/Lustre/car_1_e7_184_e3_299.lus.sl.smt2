...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (not (= (+ (- 10) M) 0)) (= N true)))
           (a!2 (or (and (= J true)
                         ...
                         (not (= N true)))
                    (not (= C true))))
           (a!3 (or (and (= G true) (>= (- 32766 M) 0)) (not (= F true)))))
     (let ((a!4 (and (or (>= (+ (- 3) L) 0) (not (= P true)))
                     (= L 0)
                     (or (< (+ (- 3) L) 0) (= P true))
                     (= J true)
                     (= K 0)
                     ...
                     (or (not (= J true))
                         ...
                         (= C true))
                     (not (= I true))
                     (or (not (= E true)) (>= M 0) (not (= R true)))
                     (or (= F true) (not (= E true)))
                     (not (= H true))
                     (or (and (= E true) (< M 0)) (= R true))
                     ...
                     (= Q true))))
       (=> a!4 (str_invariant T S R Q P O N M L K J I H G F E D C B A))))
    ))
(assert (forall ((A Int)
         (B Int)
         (C Bool)
  ...
  (let ((a!1 (or (and (= N1 true) (not (= C1 true))) (not (= J1 true))))
           (a!2 (ite (or (not (= L1 true)) (= K1 true))
                     0
           ...
           (a!6 (or (and (= L1 true)
                         ...
                         (not (= C true)))
                    (not (= E1 true))))
           (a!7 (or (and (not (= H1 true)) (not (= K true))) (= G1 true)))
           (a!8 (or (and (= I1 true) (>= (- 32766 B) 0)) (not (= H1 true)))))
     (let ((a!9 (and (str_invariant A1 Z Y X W V U T S Q P O N M L K J I H F)
                     a!1
