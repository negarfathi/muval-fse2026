...
(assert (forall ((A Int)
  ...
  (let ((a!1 (>= (ite (not (= J1 true)) 0 1) 0))
           ...
           (a!13 (not (= (- (div B 60) (div V 60)) 0)))
           (a!15 (- 1 (ite (not (= K1 true)) 0 1)))
           (a!16 (or (not (= X true))
                     (= J1 true)
                     (and (not (= H1 true))
                          (not (= G1 true))
                          ...
                          (not (= I1 true)))
                     (= (- (div B 60) (div V 60)) 0)))
           (a!17 (ite (and (= J true) (not (= U true)))
                      0
                      (+ (* 60 I) (* 10 H) G))))
...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (not (= N2 true))
           ...
           (a!36 (or (and (= O1 true) (not (= M1 true)))
                     (and (= D1 true) (not (= L1 true)))
                     (and (= S true) (not (= K1 true)))
                     (and (= H true) (not (= J1 true)))
                     (and (= B true) (not (= I1 true)))
                     (and (= A true) (not (= H1 true)))
                     (and (= U2 true) (not (= G1 true)))
                     (and (= T2 true) (not (= F1 true)))
                     (and (= S2 true) (not (= E1 true)))
                     (and (= Z1 true) (not (= N1 true)))))
           (a!37 (not (= (- (div S1 60) (div O2 60)) 0)))
           (a!41 (or (and (not (= I true)) (= G true)) (not (= V1 true))))
           (a!42 (and (or (not (= O1 true)) (= M1 true))
                      (or (not (= D1 true)) (= L1 true))
                      (or (not (= S true)) (= K1 true))
                      (or (not (= H true)) (= J1 true))
                      (or (not (= B true)) (= I1 true))
                      (or (not (= A true)) (= H1 true))
                      (or (not (= U2 true)) (= G1 true))
                      (or (not (= T2 true)) (= F1 true))
                      (or (not (= S2 true)) (= E1 true))
                      (or (not (= Z1 true)) (= N1 true))))
           (a!46 (ite (and (= B2 true) (not (= N2 true)))
                      0
                      (ite (= N2 true) (+ (* 60 A2) (* 10 Y1) X1) Z)))
           (a!47 (ite (= B3 true) (ite (= (+ (- 2) A3) 0) 1 A3) A3))
           (a!48 (and (= (+ (- 2) A3) 0)
                      (or (not (= Z3 0)) (= K3 0))
                      (not (= F4 true))
                      (not (= E4 true))))
           (a!49 (ite (not (= (+ (- 2) I4) 0)) 2 I4))
           (a!50 (ite (not (= (+ (- 2) I4) 0)) 2 Y2))
           (a!51 (ite (not (= (+ (- 4) B4) 0)) 1 X2))
           (a!52 (ite (not (= (+ (- 2) V3) 0)) 2 W2))
           (a!53 (ite (not (= (+ (- 4) S3) 0)) 1 H4))
           (a!54 (ite (= F4 true) (ite (= (+ (- 2) C4) 0) 1 C4) C4))
           (a!55 (ite (not (= (+ (- 3) M3) 0)) 3 G4))
           (a!57 (ite (not (= (+ (- 2) I3) 0)) 2 E))
           (a!58 (= F4
                    (and (= (+ (- 2) C4) 0)
                         (>= (+ (- 1) D4) 0)
                         (not (= E4 true)))))
           (a!59 (ite (not (= (+ (- 4) B4) 0)) 4 B4))
           (a!60 (ite (and (>= (+ (- 1) W3) 0) (>= (- 3 W3) 0)) 0 W3))
           (a!61 (= A4
                    (and (= (+ (- 3) W3) 0)
                         (not (= Z3 0))
                         (not (= X3 true))
                         (= (+ (- 3) W3) 0)
                         (not (= X3 true)))))
           (a!62 (= Z3 (ite (not (= Y3 true)) 0 1)))
           (a!63 (= Y3 (and (= K2 true) (not (= P1 true)))))
           (a!64 (ite (not (= (+ (- 2) V3) 0)) 2 V3))
           (a!65 (ite (= U3 true) (ite (= (+ (- 3) T3) 0) 1 T3) T3))
           (a!66 (= U3
                    (and (= (+ (- 3) T3) 0)
                         (not (= F3 0))
                         (not (= K3 0))
                         (not (= R3 true)))))
           (a!67 (ite (not (= (+ (- 4) S3) 0)) 4 S3))
           (a!68 (= R3
                    (and (= (+ (- 2) P3) 0) (>= (- Q3) 0) (= (+ (- 2) P3) 0))))
           (a!69 (ite (not (= (+ (- 3) M3) 0)) 3 M3))
           (a!70 (= N3
                    (and (= J3 true)
                         (>= (+ (- 1) M3) 0)
                         (>= (- 3 M3) 0)
                         (not (= L3 true)))))
           (a!71 (ite (not (= (+ (- 2) I3) 0)) 2 I3))
           (a!72 (and (>= (+ (- 1) I3) 0) (>= (- 3 I3) 0)))
           (a!74 (= K3 (ite (not (= R2 true)) 0 1)))
           (a!75 (or (< (+ (- 1) H3) 0) (< (- 3 H3) 0)))
           (a!76 (ite (= G3 true) (ite (= (+ (- 4) F) 0) 0 F) F))
           (a!77 (= (ite (>= (- O2) 0) 0 1) 0))
           (a!79 (= F3 (ite (not (= E3 true)) 0 1)))
           (a!80 (= E3 (and (= V2 true) (not (= Q1 true))))))
     (let ((a!6 (ite (and (not (= G3 true)) a!4) (ite (= B3 true) a!5 C3) P3))
           ...
           (a!34 (ite (and (not (= G3 true)) a!4) (ite (= B3 true) a!33 Z2) H4))
           (a!38 (or (= Q2 true) (and (= 1 C) (not (= K2 true)) a!36 a!37)))
           (a!43 (or (not (= Q2 true))
                     (not (= 1 C))
                     (= K2 true)
                     a!42
                     (= (- (div S1 60) (div O2 60)) 0)))
           (a!44 (ite (and (not (= G3 true)) a!4)
                      (ite (= F4 true) (+ (- 1) D4) D4)
                      Q3))
           (a!56 (= H4 (ite (= G3 true) (ite (= N3 true) a!55 G4) E)))
           (a!73 (= L3 (and (= J3 true) a!72 (not (= K3 0)))))
           (a!78 (= G3
                    (and (= D3 true)
                         (= (+ (- 4) F) 0)
                         (not (= F3 0))
     ...
     (let ((a!7 (- U1 (ite (= W1 true) (ite (= V1 true) a!3 a!6) F)))
           ...
           (a!45 (- S1 (ite (= W1 true) (ite (= V1 true) D a!44) D))))
     ...
     (let ((a!81 (and (str_invariant Q1
                      ...
                      (= C3 a!47)
                      (= B3 a!48)
                      (= A3 (ite (= F4 true) a!49 I4))
                      (= Z2 (ite (= F4 true) a!50 Y2))
                      (= Y2 (ite (= A4 true) a!51 X2))
                      (= X2 (ite (= U3 true) a!52 W2))
                      (= W2 (ite (= R3 true) a!53 H4))
                      (= I4 a!54)
                      a!56
                      (= G4 (ite (= L3 true) a!57 E))
                      a!58
                      (= E4 (or (= A4 true) (= X3 true)))
                      (= D4 (ite (= A4 true) 0 Q3))
                      (= C4 (ite (= A4 true) a!59 B4))
                      (= B4 (ite (= A4 true) a!60 W3))
                      a!61
                      a!62
                      a!63
                      (= X3 (or (= U3 true) (= R3 true)))
                      (= W3 (ite (= U3 true) a!64 V3))
                      (= V3 a!65)
                      a!66
                      (= T3 (ite (= R3 true) a!67 S3))
                      (= S3 (ite (= R3 true) (ite a!4 0 P3) P3))
                      a!68
                      (= Q3 (ite (= D3 true) O2 D))
                      (= P3 (ite (= G3 true) O3 H3))
                      (= O3 (ite (= N3 true) a!69 M3))
                      a!70
                      (= M3 (ite (= L3 true) a!71 I3))
                      a!73
                      a!74
                      (= J3 (and a!75 a!72))
                      (= I3 (ite a!75 1 H3))
