...
(assert (forall ((A Bool)
         ...
         (W Bool)
         (X Bool))
  (let ((a!1 (or (not (= G true)) (= (- (+ J K L M) F) 0) (not (= O true))))
           (a!2 (not (= (- (+ J K L M) F) 0)))
           (a!3 (or (or (= X true) (= W true)) (= V true)))
           (a!7 (and (and (not (= X true)) (not (= W true))) (not (= V true))))
           (a!10 (and (and (not (= X true)) (not (= W true)))
                      (= V true)
                      (not (= U true))
                      (not (= T true))
                      (not (= S true))
     ...
     (let ((a!4 (or (or (or a!3 (= U true)) (= T true)) (= S true)))
           (a!5 (or (or (or a!3 (= U true)) (= T true))
                    (not (= S true))
                    (= R true)
                    (= Q true)))
           (a!8 (and (and a!7 (not (= U true))) (not (= T true))))
           (a!11 (and (and a!7 (not (= U true)))
                      (= T true)
                      (not (= S true))
                      (not (= R true))
                      (not (= Q true)))))
     (let ((a!6 (and (or (or a!4 (= R true)) (= Q true))
                     (or (not (= X true))
                         (= W true)
                         (= V true)
                         (= U true)
                     ...
                     (or (or a!3 (= U true))
                         ...
                         (= Q true))
                     a!5
                     (or a!4 (not (= R true)) (= Q true))
                     (or (or a!4 (= R true)) (not (= Q true)))))
           (a!9 (and (and a!8 (not (= S true))) (not (= R true))))
           (a!12 (and (and a!8 (not (= S true))) (= R true) (not (= Q true)))))
     (let ((a!13 (or (not (= I true))
                     (and a!9 (not (= Q true)))
                     (and (= X true)
                          (not (= W true))
                          (not (= V true))
                     ...
                     (and a!7
                          ...
                          (not (= Q true)))
                     a!11
                     (and a!8 (= S true) (not (= R true)) (not (= Q true)))
                     a!12
                     (and a!9 (= Q true)))))
     (let ((a!14 (and (= (- D P) 0)
                      a!1
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (ite (= E true)
           ...
           (a!15 (not (= (- (+ P1 Q1 R1 S1) L1) 0)))
           (a!16 (or (or (= V1 true) (= K1 true)) (= Z true)))
           ...
           (a!23 (and (and (not (= V1 true)) (not (= K1 true)))
                      ...
                      (not (= C true))
                      (not (= B true))))
           (a!27 (and (>= (+ (- 1) S) 0) (= R 0) (= P 0) (= Q 0)))
           (a!28 (and (>= (+ (- 1) S) 0) (>= (+ (- 1) R) 0)))
           (a!29 (and (>= (+ (- 1) S) 0) (>= (+ (+ (- 1) Q) P) 0))))
     (let ((a!2 (ite (= O true) (ite (>= (+ (- 1) Q) 0) (+ (- 1) Q) Q) a!1))
           ...
           (a!13 (ite (= Z true)
                      (ite (= Z1 true) (+ (- 1) S) S)
                      (ite (= D true) (ite (= Y1 true) (+ (- 1) S) S) a!12)))
           (a!17 (or (or (or a!16 (= O true)) (= E true)) (= D true)))
           (a!18 (or (or (or a!16 (= O true)) (= E true))
                     (not (= D true))
                     (= C true)
                     (= B true)))
     ...
     (let ((a!3 (ite (= V1 true)
           ...
           (a!11 (- R1 (ite (= K1 true) (ite (= A2 true) (+ (- 1) R) R) a!10)))
           (a!14 (ite (= V1 true)
                      (ite (= B2 true) (+ (- 1) S) S)
                      (ite (= K1 true) (ite (= A2 true) (+ (- 1) S) S) a!13)))
