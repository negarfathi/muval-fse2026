...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (or (not (= (+ (- 10) M) 0)) (= N true)))
           ...
           (a!5 (or (not (= G true)) (and (not (= T true)) (not (= S true)))))
           (a!6 (or (and (= G true) (>= (- 32766 M) 0)) (not (= F true)))))
     (let ((a!7 (and (or (>= (+ (- 3) L) 0) (not (= P true)))
                     (= L 0)
                     (or (< (+ (- 3) L) 0) (= P true))
                     (= J true)
                     (= K 0)
                     ...
                     (= Q true))))
       (=> a!7 (str_invariant T S R Q P O N M L K J I H G F E D C B A))))
    ))
(assert (forall ((A Int)
         (B Int)
         (C Bool)
  ...
  (let ((a!1 (or (and (= N1 true) (not (= C1 true))) (not (= J1 true))))
           ...
           (a!10 (or (not (= I1 true))
                     (and (not (= N1 true)) (not (= C1 true)))))
           (a!11 (or (and (= I1 true) (>= (- 32766 B) 0)) (not (= H1 true)))))
     (let ((a!12 (and (str_invariant A1 Z Y X W V U T S Q P O N M L K J I H F)
                      a!1
