...
(assert (forall ((A Bool)
  ...
  (let ((a!1 (and (or (not (= O true)) (not (= N true)))
     ...
     (let ((a!2 (and (= (+ (- 3) F) 0)
                     (or (not (= D true)) (>= G 0) (not (= K true)))
                     (or (= E true) (not (= D true)))
                     (= G 0)
                     (= H 0)
                     (= I 0)
                     (or (and (= D true) (< G 0)) (= K true))
                     (or (= E true)
                         (and (= O true) (= N true))
                         (and (= O true) (= M true))
                         (and (= O true) (= L true))
...
(assert (forall ((A Int)
  ...
  (let ((a!1 (ite (= H true)
           ...
           (a!12 (and (or (not (= D1 true)) (not (= S true)))
     ...
     (let ((a!13 (and (str_invariant W V U T R Q P O N M L K J I G)
                      (= a!3 0)
                      (= a!6 0)
                      (= a!9 0)
                      (or (not (= A1 true)) (>= A 0) (not (= E true)))
                      (or (and (= B1 true) (= K true)) (not (= A1 true)))
                      (= a!11 0)
                      (or (and (= A1 true) (< A 0)) (= E true))
                      (or (= B1 true)
                          (and (= D1 true) (= S true))
                          (and (= D1 true) (= H true))
                          (and (= D1 true) (= F true))
                      ...
                      (= E1 (>= (+ (- 1) M) 0))
                      (not (= D true)))))
       (=> a!13 (str_invariant D1 S H F E D C B A C1 B1 A1 Z Y X))))))
    ))
