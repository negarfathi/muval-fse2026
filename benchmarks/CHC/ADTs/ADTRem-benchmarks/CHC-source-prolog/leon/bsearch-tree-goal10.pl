...
ff :-    B=:=1, A=:=0,  I-J>=1,    tmember(X,J,A),  tinsert(X,I,F), tmember(F,J,B).
ff :-    B=:=1, A=:=0,  I-J=< -1,  tmember(X,J,A),  tinsert(X,I,F), tmember(F,J,B).
ff :-    B=:=0, A=:=1,             tmember(X,J,A),  tinsert(X,I,F), tmember(F,J,B).
ff :-    B=:=0, I=J,               tmember(X,J,A),  tinsert(X,I,F), tmember(F,J,B).
