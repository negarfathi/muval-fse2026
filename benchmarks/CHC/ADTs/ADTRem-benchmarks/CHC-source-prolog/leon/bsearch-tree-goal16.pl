...
ff :-  MXY=:=1, MX=:=0, MY=:=0, append(X,Y,XY), mem(I,XY,MXY), mem(I,X,MX), mem(I,Y,MY).
ff :-  MXY=:=0, MX=:=1, append(X,Y,XY), mem(I,XY,MXY), mem(I,X,MX).
ff :-  MXY=:=0, MY=:=1, append(X,Y,XY), mem(I,XY,MXY), mem(I,Y,MY).
