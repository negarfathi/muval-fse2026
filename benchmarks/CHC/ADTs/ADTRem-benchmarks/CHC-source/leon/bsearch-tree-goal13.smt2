...
(assert
  (forall ( (A Bool) )
    (=>
      (= A true)
      (adt_equaltrees leaf-treeOfInt leaf-treeOfInt A)
    )
  )
)
(assert
  (forall ( (A Int) (B treeOfInt) (C treeOfInt) (D Bool) )
    (=>
      (= D false)
      (adt_equaltrees leaf-treeOfInt (node-treeOfInt A B C)  D)
    )
  )
)
(assert
  (forall ( (A Int) (B treeOfInt) (C treeOfInt) (D Bool) )
    (=>
      (= D false)
      (adt_equaltrees (node-treeOfInt A B C)  leaf-treeOfInt D)
    )
  )
)
(assert
  (forall ( (A Int) (B treeOfInt) (C treeOfInt) (D Int) (E treeOfInt) (F treeOfInt) (G Bool) )
    (=>
      ...
      (adt_equaltrees (node-treeOfInt A B C)  (node-treeOfInt D E F)  G)
    )
  )
)
(assert
  (forall ( (A Int) (B treeOfInt) (C treeOfInt) (D treeOfInt) (E treeOfInt) (F Bool) )
    (=>
      ...
      (adt_equaltrees (node-treeOfInt A B C)  (node-treeOfInt A D E)  F)
    )
  )
)
(assert
