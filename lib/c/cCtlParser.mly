%{
  ...
  let mk_fun_nondet_int funname params =
    FunDecl.mk_fun_nondet_int funname params
    (* FunDecl.mk_fun_int funname params (Statement.mk_return_nondet_int ()) *)
  let _mk_fun_nondet_real funname params =
    FunDecl.mk_fun_nondet_real funname params
    (* FunDecl.mk_fun_real funname params (Statement.mk_return_nondet_real ()) *)
%}
...
Decl:
  ...
  | VOID BODY LPAREN RPAREN LBLOCK stmts=Statements RBLOCK { None, [], None, Some (Statement.of_statements stmts), [], [] }
  | INT BODY LPAREN RPAREN LBLOCK stmts=Statements RBLOCK { None, [], None, Some (Statement.of_statements stmts), [], [] }
  /* int main() {} */
  ...
  | INT funname=ID LPAREN params=Parameters RPAREN LBLOCK RETURN NONDET LPAREN RPAREN SEMI RBLOCK {
    None, [], None, None, [], [mk_fun_nondet_int funname params]
  }
  /* TODO */
  ...
  | SHARPDEFINE funname=ID LPAREN RPAREN NONDET LPAREN RPAREN {
    None, [], None, None, [], [mk_fun_nondet_int(*ToDo*) funname []]
  }
