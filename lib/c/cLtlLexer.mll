...
(*| "__VERIFIER_nondet_char" { CLtlParser.NONDET_INT }
| "__VERIFIER_nondet_short" { CLtlParser.NONDET_INT }*)
| "__VERIFIER_nondet_int" { CLtlParser.NONDET_INT }
(*| "__VERIFIER_nondet_long" { CLtlParser.NONDET_INT }
| "__VERIFIER_nondet_uchar" { CLtlParser.NONDET_INT }
| "__VERIFIER_nondet_ushort" { CLtlParser.NONDET_INT }
| "__VERIFIER_nondet_uint" { CLtlParser.NONDET_INT }
| "__VERIFIER_nondet_ulong" { CLtlParser.NONDET_INT }*)
